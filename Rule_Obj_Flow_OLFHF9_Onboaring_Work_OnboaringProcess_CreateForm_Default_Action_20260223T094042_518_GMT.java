...
import java.util.*;
public class Rule_Obj_Flow_OLFHF9_Onboaring_Work_OnboaringProcess_CreateForm_Default_Action_20260223T094042_518_GMT  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Flow.CreateForm_Default.OLFHF9_Onboaring_Work_OnboaringProcess.Action");
	public Rule_Obj_Flow_OLFHF9_Onboaring_Work_OnboaringProcess_CreateForm_Default_Action_20260223T094042_518_GMT(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
public void perform() {
		mTraceInfo = null;
		mRuleSet = "OnboaringProcess";
		mFlowHandle = "RULE-OBJ-FLOW OLFHF9-ONBOARING-WORK-ONBOARINGPROCESS CREATEFORM_DEFAULT #20260223T094042.518 GMT";
...
// Expression: pyStepRoutedConfirmation
	...
	private void GetOrderedFlowSteps_circum0(String stepPageName) {
		...
		pgStep.putString(".pyCoordX", "4.272");
		pgStep.putString(".pyCoordY", "0");
	...
	private void GetNavigationPath_circum0(String pageName, String parentFlowPath, boolean deferredLoad)
	{
		...
		pgNavPath.putString("pyClassName", "OLFHF9-Onboaring-Work-OnboaringProcess");
	...
	private boolean CheckFlowSecurity_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "OLFHF9-Onboaring-Work-OnboaringProcess";
		 }
		...
		if (!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools, "",primaryPageClassName, interestPage)) 
			 hasSecurity = true;
			 if(!hasSecurity) {
			 if(tools.getAuthorizationHandle().havePrivilege(tools,  "",primaryPageClassName, interestPage,true))
			 isAllowedAccess = true;
			 else return false;
		}
			 if(isAllowedAccess && !hasSecurity) {		com.pega.pegarules.priv.tracer.RuleTraceInfo ruleTraceInfo = new com.pega.pegarules.priv.tracer.RuleTraceInfo                                                                   ("","","OnboaringProcess","","");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OLFHF9-Onboaring-Work-OnboaringProcess CreateForm_Default", "OnboaringProcess", "01-01-01", null);
}
