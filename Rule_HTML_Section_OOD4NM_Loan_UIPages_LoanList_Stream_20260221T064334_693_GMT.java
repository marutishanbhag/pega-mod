 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Section_OOD4NM_Loan_UIPages_LoanList_Stream_20260221T064334_693_GMT extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.LoanList.OOD4NM_Loan_UIPages.Stream");
 ...
 */
	public Rule_HTML_Section_OOD4NM_Loan_UIPages_LoanList_Stream_20260221T064334_693_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("LoanList",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXCREATEDATETIME","Rule-Obj-Property","WORK-",true,"OOD4NM-Loan-Work-Loan","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY WORK- PXCREATEDATETIME #20180713T131935.660 GMT","!PXCREATEDATETIME",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYSTATUSWORK","Rule-Obj-Property","WORK-",true,"OOD4NM-Loan-Work-Loan","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY WORK- PYSTATUSWORK #20180713T131937.564 GMT","!PYSTATUSWORK",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PXCREATEOPNAME","Rule-Obj-Property","@BASECLASS",true,"OOD4NM-Loan-Work-Loan","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PXCREATEOPNAME #20180713T131841.211 GMT","!PXCREATEOPNAME",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYID","Rule-Obj-Property","WORK-COVER-",true,"OOD4NM-Loan-Work-Loan","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY WORK-COVER- PYID #20180713T131935.559 GMT","!PYID",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("LoanList",1,"Rule-HTML-Section","{'type':'Section','ruleName':'LoanList','insKey':'null','sectionType':'standard'}");
pzLayout_1();
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_LoanList.pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","32","","","Text","true","59"};oCellRuntimeParamsMap.put("59||",paramValues);oControlPathsMap.put("59||",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(5)");}
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_LoanList.pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","T","true","0","","","Text","true","58"};oCellRuntimeParamsMap.put("58||",paramValues);oControlPathsMap.put("58||",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(4)");}
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_LoanList.pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","32","","","Text","true","56"};oCellRuntimeParamsMap.put("56||",paramValues);oControlPathsMap.put("56||",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)");}
...
try {
	...
	modePage2.put("pyName","LoanList_$CTX$_55");
		String repeatIndx = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='LoanList_"+ referenceString+ "_55'";
	 String securedPropValue = null;
...
public void repeatingHeaderCell_5() {
	...
	int lastDotIndex = 0;
	dataPropClass = "OOD4NM-Loan-Work-Loan";
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_LoanListPpxResults1colWidthCache5").equals("")) { tools.appendParamCSF("D_LoanListPpxResults1colWidthCache5");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									...
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc1734878418'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_LoanListPpxResults1colWidthCache5' id='D_LoanListPpxResults1colWidthCache5' value='" + tools.getParamValueCSF("D_LoanListPpxResults1colWidthCache5") + "' />");
...
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc1734878418' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc1734878418' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc1734878418' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
								...
								ClipboardPage gFCritPageD_LoanList_pxResultsL7 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyStatusWork5").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle1734878418\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyStatusWork5").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle1734878418\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyStatusWork5").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyStatusWork5").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_LoanListPpxResults1colWidthCache4").equals("")) { tools.appendParamCSF("D_LoanListPpxResults1colWidthCache4");} else { tools.appendString("14.912280701754385"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:21px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc1664804616'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_LoanListPpxResults1colWidthCache4' id='D_LoanListPpxResults1colWidthCache4' value='" + tools.getParamValueCSF("D_LoanListPpxResults1colWidthCache4") + "' />");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc1664804616' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc1664804616' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc1664804616' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_LoanList_pxResultsL7 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle1664804616\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle1664804616\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_LoanListPpxResults1colWidthCache3").equals("")) { tools.appendParamCSF("D_LoanListPpxResults1colWidthCache3");} else { tools.appendString("28.947368421052634"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:21px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc1183219716'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_LoanListPpxResults1colWidthCache3' id='D_LoanListPpxResults1colWidthCache3' value='" + tools.getParamValueCSF("D_LoanListPpxResults1colWidthCache3") + "' />");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc1183219716' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc1183219716' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc1183219716' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_LoanList_pxResultsL7 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle1183219716\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle1183219716\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_LoanListPpxResults1colWidthCache2").equals("")) { tools.appendParamCSF("D_LoanListPpxResults1colWidthCache2");} else { tools.appendString("12.280701754385964"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:21px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc1660327879'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_LoanListPpxResults1colWidthCache2' id='D_LoanListPpxResults1colWidthCache2' value='" + tools.getParamValueCSF("D_LoanListPpxResults1colWidthCache2") + "' />");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc1660327879' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc1660327879' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc1660327879' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_LoanList_pxResultsL7 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle1660327879\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle1660327879\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  style='");
		tools.appendString("height:23px;");tools.appendString("width:"); if(!tools.getParamValueCSF("D_LoanListPpxResults1colWidthCache1").equals("")) { tools.appendParamCSF("D_LoanListPpxResults1colWidthCache1");} else { tools.appendString("28.947368421052634"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:21px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc1834522553'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_LoanListPpxResults1colWidthCache1' id='D_LoanListPpxResults1colWidthCache1' value='" + tools.getParamValueCSF("D_LoanListPpxResults1colWidthCache1") + "' />");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc1834522553' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc1834522553' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc1834522553' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_LoanList_pxResultsL7 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle1834522553\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle1834522553\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_LoanList_pxResultsL7!=null && !gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_LoanList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
public void pxDisplayText_7() {	String key="56||";
	...
	static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_LoanList.pxResults","","","false","FREEFORM","REPEATING","",""," cffalse","T","false","32","","","Text","true","56"};oCellRuntimeParamsMap.put("56||",paramValues);oControlPathsMap.put("56||",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)");}
...
public void pxDisplayText_9() {	String key="58||";
	...
	static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_LoanList.pxResults","","","false","FREEFORM","REPEATING","",""," cffalse","T","true","0","","","Text","true","58"};oCellRuntimeParamsMap.put("58||",paramValues);oControlPathsMap.put("58||",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(4)");}
...
public void pxDisplayText_10() {	String key="59||";
	...
	static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_LoanList.pxResults","","","false","FREEFORM","REPEATING","",""," cffalse","T","false","32","","","Text","true","59"};oCellRuntimeParamsMap.put("59||",paramValues);oControlPathsMap.put("59||",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(5)");}
...
modesList.add("<?xml version=\"1.0\"?><pagedata><pyObfuscatedNew>false</pyObfuscatedNew><pyModeType>Read-Only</pyModeType><pyMediaAutoplay>false</pyMediaAutoplay><pyHighlightMatch>true</pyHighlightMatch><pyMinSearchChars>2</pyMinSearchChars><pyRunOnClient>false</pyRunOnClient><pySpecifySize>auto</pySpecifySize><pyDisplayFullScreen>true</pyDisplayFullScreen><pyType>M</pyType><pyReadonlyValidation>false</pyReadonlyValidation><pyFalseLabel>False</pyFalseLabel><pyUIElement>label</pyUIElement><pyObfuscated>false</pyObfuscated><pyTrueLabel>True</pyTrueLabel><pyFormatType>datetime</pyFormatType><pyMediaMuted>true</pyMediaMuted><pyMediaLoop>false</pyMediaLoop><pyDateTimeHourFormat>false</pyDateTimeHourFormat><pyCannedIcon>pxIcon</pyCannedIcon><pyMediaPreload>auto</pyMediaPreload><pyDisabled>false</pyDisabled><pyDirection>vertical</pyDirection><pySeparators>true</pySeparators><pyDateTimeSecondCutoff>3</pyDateTimeSecondCutoff><pyIconShow>false</pyIconShow><pyDisplayCurrencyAs>currencySymbol</pyDisplayCurrencyAs><pyDateTimeFormat>DateTime-Frame</pyDateTimeFormat><pyEllipsis>true</pyEllipsis><pyAttachContentFormat>button</pyAttachContentFormat><pyHelperTextType>none</pyHelperTextType><pyImageSize>auto</pyImageSize><pyLabelPosition>right</pyLabelPosition><pxObjClass>Embed-Control-Mode</pxObjClass><pyDisplayAsComboBox>false</pyDisplayAsComboBox><pyActionImagePosition>left</pyActionImagePosition><pyNegativeFormatStyle>NegativeNumber</pyNegativeFormatStyle><pyDecimalPlaces>2</pyDecimalPlaces><pyMediaControls>true</pyMediaControls><pySymbolPosition>left</pySymbolPosition><pyCannedIconNew>pxIcon</pyCannedIconNew><pyTextAlign>Left</pyTextAlign><pyContent>localizevalue</pyContent><pyBehaviors REPEATINGTYPE=\"PageList\"/><pyListDataSource><pxObjClass>Embed-Control-Mode-ListDefinition</pxObjClass><pyListSource>associated</pyListSource></pyListDataSource></pagedata>"); 
...
public void D_LoanList_pxResults_2() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
gridWrapper.put("DPName","D_LoanList.pxResults");
gridWrapper.put("propType","Data Object");
gridWrapper.put("resultsClass","OOD4NM-Loan-Work-Loan");
...
gridWrapper.put("sectionName","LoanList");
gridWrapper.put("sectionClass","OOD4NM-Loan-UIPages");
...
gridMetadataPage.putString(".pySectionClass","OOD4NM-Loan-UIPages");
gridMetadataPage.putString(".pySectionName","LoanList");
configMap.put("pxGridMetadataPage", gridMetadataPage); 
...
pzSection.getLayout().setExpandParam("SubSectionLoanListB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionLoanListB";
...
if (tmpDeclarePageParams != null && tmpDeclarePageParams.getProperty("D_LoanList_pxResults_LoanList_1") != null) {
ClipboardPage paramList = tmpDeclarePageParams.getProperty("D_LoanList_pxResults_LoanList_1").getPageValue();
...
oLog.error("ReloadSections:Expection : "+e.getMessage());
 ...
 ClipboardPage gFCritPageD_LoanList_pxResultsL7=null;

 Map selUniqMapD_LoanList_pxResultsL7 = null;

 Set filteredIndicesSetD_LoanList_pxResultsL7 = null;

	 String strFCPage = "pyFilterCriteria_D_LoanList.pxResults_LoanList_1";
...
gFCritPageD_LoanList_pxResultsL7=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));

  selUniqMapD_LoanList_pxResultsL7 = null; // reset the variable

 if(gFCritPageD_LoanList_pxResultsL7 != null){ 

 		 filteredIndicesSetD_LoanList_pxResultsL7 = pega_uiengine_uiengine.pzPopulateFilteredindicesMap(gFCritPageD_LoanList_pxResultsL7, "D_LoanList.pxResults");

 		 tools.getParameterPage().put("filteredIndicesSet", filteredIndicesSetD_LoanList_pxResultsL7);

 tools.putParamValue("populateSelectedUIValues", "true");

 		 selUniqMapD_LoanList_pxResultsL7 = pega_uiengine_uiengine.pzPopulateSelectedValues(gFCritPageD_LoanList_pxResultsL7); 

 		 tools.getParameterPage().put("selUniqMapD_LoanList_pxResultsL7", selUniqMapD_LoanList_pxResultsL7);

 tools.putParamValue("populateSelectedUIValues", "");

 }
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_LoanList.pxResults").getReference());tools.appendString("_LoanList_1'");
tools.appendString(" hashed-dp-page='");
if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_LoanList.pxResults").getReference());tools.appendString("' bRowHovering='false' deferLoadAct='' class=\"");
...
tools.appendString(" bRangeFilterByFormat='false' DPSectionID=\"SubSectionLoanListB\"  OAFunc='openWorkByHandle' ");
D_LoanList_pxResults_1();
tools.appendString(">");
...
if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) {
 ...
 pageListProp = tools.getProperty("D_LoanList.pxResults"); 
...
if(startIndex<=0) { startIndex = 1; }
 ...
 tools.putParamValue("PageListProperty","D_LoanList.pxResults");}
...
ClipboardProperty propActivePrev = tools.getActive(); 
	...
	Iterator itr = tools.getProperty("D_LoanList.pxResults").iterator();
		Set filteredResultsSet = new HashSet();
			while(itr.hasNext()){
				...
				if(gFCritPageD_LoanList_pxResultsL7!= null){
				bFilterResult = pega_uiengine_uiengine.pzMatchesGridFilterCriteria(gFCritPageD_LoanList_pxResultsL7, selUniqMapD_LoanList_pxResultsL7);
				}
				if(bFilterResult){
 			 ...
 			 if (gFCritPageD_LoanList_pxResultsL7== null || bFilterResult) {
...
public void gridCentreLayout_1() {/*gridCentreLayout*/
					...
					selUniqMapD_LoanList_pxResultsL7 = null; // reset the variable
					gFCritPageD_LoanList_pxResultsL7=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));
							 selUniqMapD_LoanList_pxResultsL7 = (Map)tools.getParameterPage().getObject("selUniqMapD_LoanList_pxResultsL7");
					...
					ClipboardProperty prop = tools.getProperty("D_LoanList.pxResults");
					...
					tools.appendString("' gPropIndex='D_LoanListPpxResults1' editRowIndex='");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"D_LoanListPpxResults1colWidthGBL\" id=\"D_LoanListPpxResults1colWidthGBL\" value=\"");
					...
					tools.appendString(tools.getParamValueCSF("D_LoanListPpxResults1colWidthGBL"));tools.appendString("\" />");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"D_LoanListPpxResults1colWidthGBR\" id=\"D_LoanListPpxResults1colWidthGBR\" value=\"");
					...
					tools.appendString(tools.getParamValueCSF("D_LoanListPpxResults1colWidthGBR"));
					...
					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");
					 ...
					 if(!("".equals(tools.getParamValue("D_LoanListPpxResults1colWidthGBR") ))) { tools.appendString("resizedTable"); } 
					...
					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='' bColumnResize=\"true\" PL_PROP='D_LoanList.pxResults' PL_PROP_CLASS='OOD4NM-Loan-Work-Loan' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
					...
					if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) {
								 ...
								 itr_3 = tools.getProperty("D_LoanList.pxResults").iterator(); 
					...
					Set filteredResultsSet = (HashSet)tools.getParameterPage().getObject("filteredResultsSet");boolean bFilterResult = false;
										 ...
										 } else if(gFCritPageD_LoanList_pxResultsL7!= null){ 
													 bFilterResult = pega_uiengine_uiengine.pzMatchesGridFilterCriteria(gFCritPageD_LoanList_pxResultsL7, selUniqMapD_LoanList_pxResultsL7);
										 }
										 if (gFCritPageD_LoanList_pxResultsL7== null || 
					...
					tools.appendString(" ng-repeat=\"Item in rootData.D_LoanList.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals("D_LoanList.pxResults")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodesD_LoanList.pxResults1") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 
					...
					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle("D_LoanList.pxResults"); } catch (Exception ex) { }
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"5\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("OOD4NM-Loan-Work-Loan", "tempNoRespg");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodesD_LoanList.pxResults1") && tools.getParamValue("partialRefresh").equals("false")) {
...
gridEndLayout_1
 ...
 tools.getParameterPage().remove("pyGridFilterCriteriaPage"); 
					...
					String paramName = "EXPANDEDSubSectionLoanListB";
...
public void D_LoanList_pxResults_1() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendToD_LoanList.pxResults1")|| tools.getParamValue("partialTrigger").equals("editRowD_LoanList.pxResults1") ){
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData.D_LoanList.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdropD_LoanList.pxResults1")) {
 ...
 if(tools.getParamValue("partialTrigger").equals("filterpopupD_LoanList.pxResults1")) { 
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendToD_LoanList.pxResults1") ){
...
static {
	...
	oStreamProperties_1.put("pyClassName", "OOD4NM-Loan-UIPages");
	...
	oStreamProperties_1.put("pyRuleSet", "Loan");
	oStreamProperties_1.put("pyCorrType", "");
	oStreamProperties_1.put("pyStreamName", "LoanList");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OOD4NM-Loan-UIPages LoanList", "Loan", "01-01-01", "20210506T204028.374 GMT");
}
