...
public class ra_model__baseclass_pydisplaypalettesetcontext_840227529 extends AbstractDataTransform {

    private final PropertyQuery propertyQuery_2;

    private static final String [] pRef_1 = new String[] { "", "", "pyDisplayReuseGadget", "" };

    private static final RuleTraceInfo ruleTracer = new RuleTraceInfo("RULE-OBJ-MODEL @BASECLASS PYDISPLAYPALETTESETCONTEXT #20180713T141228.123 GMT", "@baseclass pyDisplayPaletteSetContext", "Pega-ProcessArchitect", "08-01-01", "20180713T141228.123 GMT");

    public ra_model__baseclass_pydisplaypalettesetcontext_840227529(final Loadtime loadtime) {
