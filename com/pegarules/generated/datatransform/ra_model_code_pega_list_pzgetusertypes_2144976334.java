...
public class ra_model_code_pega_list_pzgetusertypes_2144976334 extends AbstractDataTransform {
    ...
    private static final String [] pRef_14 = new String[] { "", "", "pxResults", "7", "pyDescription", "" };

    private static final String [] pRef_13 = new String[] { "", "", "pxResults", "7", "pyLabel", "" };
    ...
    private static final RuleTraceInfo ruleTracer = new RuleTraceInfo("RULE-OBJ-MODEL CODE-PEGA-LIST PZGETUSERTYPES #20181121T090150.611 GMT", "Code-Pega-List pzGetUserTypes", "Pega-AppDefinition", "08-02-01", "20181121T090150.611 GMT");

    public ra_model_code_pega_list_pzgetusertypes_2144976334(final Loadtime loadtime) {
    ...
    protected Object evaluate(final Runtime runtime, ClipboardPage myStepPage, final ParameterPage params) {
        ...
        try {
            ...
            pega.setViaPropRef(".pxResults(1).pyLabel", pRef_1, myStepPage, "Operator", "sTN64", false, true);
            ...
            pega.setViaPropRef(".pxResults(1).pyDescription", pRef_2, myStepPage, "Operator", "sTN", false, true);
            ...
            pega.setViaPropRef(".pxResults(2).pyLabel", pRef_3, myStepPage, "External Person", "sTN64", false, true);
            ...
            pega.setViaPropRef(".pxResults(2).pyDescription", pRef_4, myStepPage, "External Person", "sTN", false, true);
            ...
            pega.setViaPropRef(".pxResults(3).pyLabel", pRef_5, myStepPage, "Company", "sTN64", false, true);
            ...
            pega.setViaPropRef(".pxResults(3).pyDescription", pRef_6, myStepPage, "Company", "sTN", false, true);
            ...
            pega.setViaPropRef(".pxResults(4).pyLabel", pRef_7, myStepPage, "Non-Profit/Org", "sTN64", false, true);
            ...
            pega.setViaPropRef(".pxResults(4).pyDescription", pRef_8, myStepPage, "Non-Profit/Org", "sTN", false, true);
            ...
            pega.setViaPropRef(".pxResults(5).pyLabel", pRef_9, myStepPage, "Gov't Agency", "sTN64", false, true);
            ...
            pega.setViaPropRef(".pxResults(5).pyDescription", pRef_10, myStepPage, "Gov't Agency", "sTN", false, true);
            ...
            pega.setViaPropRef(".pxResults(6).pyLabel", pRef_11, myStepPage, "External System", "sTN64", false, true);
            ...
            pega.setViaPropRef(".pxResults(6).pyDescription", pRef_12, myStepPage, "External System", "sTN", false, true);
            actionEpilog(runtime, "12", "Set .pxResults(6).pyDescription", null, null, runtimeTraceContext);
            actionProlog(runtime, "13", "Set .pxResults(7).pyLabel", null, null, runtimeTraceContext);
            pega.setViaPropRef(".pxResults(7).pyLabel", pRef_13, myStepPage, "This System", "sTN64", false, true);
            actionEpilog(runtime, "13", "Set .pxResults(7).pyLabel", null, null, runtimeTraceContext);
            actionProlog(runtime, "14", "Set .pxResults(7).pyDescription", null, null, runtimeTraceContext);
            pega.setViaPropRef(".pxResults(7).pyDescription", pRef_14, myStepPage, "This System", "sTN", false, true);
            actionEpilog(runtime, "14", "Set .pxResults(7).pyDescription", null, null, runtimeTraceContext);
            return null;
        } catch (Exception e_1) {
