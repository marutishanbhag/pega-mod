...
public class ra_model_embed_stageprocess_pydisplaypalettesetcontext__1471782398 extends AbstractDataTransform {

    private final PropertyQuery propertyQuery_2;

    private static final String [] pRef_1 = new String[] { "", "", "pyDisplayReuseGadget", "" };

    private static final RuleTraceInfo ruleTracer = new RuleTraceInfo("RULE-OBJ-MODEL EMBED-STAGEPROCESS PYDISPLAYPALETTESETCONTEXT #20180713T141238.857 GMT", "Embed-StageProcess pyDisplayPaletteSetContext", "Pega-ProcessArchitect", "08-01-01", "20180713T141238.857 GMT");

    public ra_model_embed_stageprocess_pydisplaypalettesetcontext__1471782398(final Loadtime loadtime) {
