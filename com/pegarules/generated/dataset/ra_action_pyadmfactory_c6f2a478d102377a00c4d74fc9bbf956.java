...
import java.util.*;
public class ra_action_pyadmfactory_c6f2a478d102377a00c4d74fc9bbf956  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Decision_DataSet.pyADMFactory.Data_Decision_ADM_DB_Factory.Action");
	public ra_action_pyadmfactory_c6f2a478d102377a00c4d74fc9bbf956(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
/* Instance RULE-DECISION-DATASET DATA-DECISION-ADM-DB-FACTORY PYADMFACTORY #20190329T085713.863 GMT	Pega-DecisionEngine:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
}
...
java.lang.String GET_DATA_SET_OPERATION = "GetDataSet";
  ...
  dataSet = new com.pega.dsm.dnode.api.dataset.database.DatabaseDataSetFactory().createFromKey("RULE-DECISION-DATASET DATA-DECISION-ADM-DB-FACTORY PYADMFACTORY #20190329T085713.863 GMT", tools);
return dataSet;
	}
...
private static final String oDependencies [] = {
	...
	"Rule-Decision-DataSet:PYADMFACTORY"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYADMFACTORY","Rule-Decision-DataSet","DATA-DECISION-ADM-DB-FACTORY",false,"","Pega-DecisionEngine","08-03-01","RULE-DECISION-DATASET DATA-DECISION-ADM-DB-FACTORY PYADMFACTORY #20190329T085713.863 GMT","!PYADMFACTORY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-798897449)
	};
...
//	RULE-DECISION-DATASET DATA-DECISION-ADM-DB-FACTORY PYADMFACTORY #20190329T085713.863 GMT:20190423T103906.900 GMT
...
//	RULE-UTILITY-FUNCTION DSMFUAUTILS TRANSFORMTEMPLATE #20201103T143139.590 GMT:20201103T143139.590 GMT
	...
	public static String getFUAContentHash() {
		return "9f0748a5f76741e5cc5ff210987cdbe7";
	}

	public String getDefinitionAppliesToClass() {
		return "Data-Decision-ADM-DB-Factory";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-DECISION-DATASET DATA-DECISION-ADM-DB-FACTORY PYADMFACTORY #20190329T085713.863 GMT", "Data-Decision-ADM-DB-Factory pyADMFactory", "Pega-DecisionEngine", "08-03-01", "20190423T103906.900 GMT");
}
