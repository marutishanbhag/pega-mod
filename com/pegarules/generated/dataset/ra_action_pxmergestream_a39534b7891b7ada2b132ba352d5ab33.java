...
import java.util.*;
public class ra_action_pxmergestream_a39534b7891b7ada2b132ba352d5ab33  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Decision_DataSet.pxMergeStream.Data_Decision_Profile_MergeRequest.Action");
	public ra_action_pxmergestream_a39534b7891b7ada2b132ba352d5ab33(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
/* Instance RULE-DECISION-DATASET DATA-DECISION-PROFILE-MERGEREQUEST PXMERGESTREAM #20230618T003547.674 GMT	Pega-DecisionEngine:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
}
...
java.lang.String GET_DATA_SET_OPERATION = "GetDataSet";
  ...
  dataSet = new com.pega.dsm.dnode.api.dataset.stream.StreamDataSetFactory().createFromKey("RULE-DECISION-DATASET DATA-DECISION-PROFILE-MERGEREQUEST PXMERGESTREAM #20230618T003547.674 GMT", tools);
return dataSet;
	}
...
private static final String oDependencies [] = {
	...
	"Rule-Decision-DataSet:PXMERGESTREAM"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXMERGESTREAM","Rule-Decision-DataSet","DATA-DECISION-PROFILE-MERGEREQUEST",false,"","Pega-DecisionEngine","08-23-01","RULE-DECISION-DATASET DATA-DECISION-PROFILE-MERGEREQUEST PXMERGESTREAM #20230618T003547.674 GMT","!PXMERGESTREAM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-268811659)
	};
...
//	RULE-DECISION-DATASET DATA-DECISION-PROFILE-MERGEREQUEST PXMERGESTREAM #20230618T003547.674 GMT:20230618T003547.674 GMT
...
//	RULE-UTILITY-FUNCTION DSMFUAUTILS TRANSFORMTEMPLATE #20201103T143139.590 GMT:20201103T143139.590 GMT
	...
	public static String getFUAContentHash() {
		return "11757d248ca3099792a694acdb71c152";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-DECISION-DATASET DATA-DECISION-PROFILE-MERGEREQUEST PXMERGESTREAM #20230618T003547.674 GMT", "Data-Decision-Profile-MergeRequest pxMergeStream", "Pega-DecisionEngine", "08-23-01", "20230618T003547.674 GMT");
}
