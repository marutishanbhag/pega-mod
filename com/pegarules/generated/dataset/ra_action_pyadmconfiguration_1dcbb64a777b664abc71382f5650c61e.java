...
import java.util.*;
public class ra_action_pyadmconfiguration_1dcbb64a777b664abc71382f5650c61e  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Decision_DataSet.pyADMConfiguration.Data_Decision_ADM_DB_Configuration.Action");
	public ra_action_pyadmconfiguration_1dcbb64a777b664abc71382f5650c61e(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
/* Instance RULE-DECISION-DATASET DATA-DECISION-ADM-DB-CONFIGURATION PYADMCONFIGURATION #20180713T140141.439 GMT	Pega-DecisionEngine:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
}
...
java.lang.String GET_DATA_SET_OPERATION = "GetDataSet";
  ...
  dataSet = new com.pega.dsm.dnode.api.dataset.database.DatabaseDataSetFactory().createFromKey("RULE-DECISION-DATASET DATA-DECISION-ADM-DB-CONFIGURATION PYADMCONFIGURATION #20180713T140141.439 GMT", tools);
return dataSet;
	}
...
private static final String oDependencies [] = {
	...
	"Rule-Decision-DataSet:PYADMCONFIGURATION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYADMCONFIGURATION","Rule-Decision-DataSet","DATA-DECISION-ADM-DB-CONFIGURATION",false,"","Pega-DecisionEngine","08-01-01","RULE-DECISION-DATASET DATA-DECISION-ADM-DB-CONFIGURATION PYADMCONFIGURATION #20180713T140141.439 GMT","!PYADMCONFIGURATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1753521232)
	};
...
//	RULE-DECISION-DATASET DATA-DECISION-ADM-DB-CONFIGURATION PYADMCONFIGURATION #20180713T140141.439 GMT:20180713T140141.439 GMT
...
//	RULE-UTILITY-FUNCTION DSMFUAUTILS TRANSFORMTEMPLATE #20201103T143139.590 GMT:20201103T143139.590 GMT
	...
	public static String getFUAContentHash() {
		return "6fe2c5a2f2853dd4e295d65563583803";
	}

	public String getDefinitionAppliesToClass() {
		return "Data-Decision-ADM-DB-Configuration";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-DECISION-DATASET DATA-DECISION-ADM-DB-CONFIGURATION PYADMCONFIGURATION #20180713T140141.439 GMT", "Data-Decision-ADM-DB-Configuration pyADMConfiguration", "Pega-DecisionEngine", "08-01-01", "20180713T140141.439 GMT");
}
