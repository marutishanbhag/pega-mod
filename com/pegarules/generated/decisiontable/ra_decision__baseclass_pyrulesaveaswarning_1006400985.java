...
public class ra_decision__baseclass_pyrulesaveaswarning_1006400985 extends AbstractDecisionTable {

    private final ScalarValueQuery scalarValueQuery_1;

    private static final RuleTraceInfo ruleTracer = new RuleTraceInfo("RULE-DECLARE-DECISIONTABLE @BASECLASS PYRULESAVEASWARNING #20180713T135044.453 GMT", "@baseclass pyRuleSaveAsWarning", "Pega-Desktop", "08-01-01", "20180713T135044.453 GMT");

    public ra_decision__baseclass_pyrulesaveaswarning_1006400985(final Loadtime loadtime) {
        super(ruleTracer);
    ...
    protected String evaluate(final Runtime runtime, final ClipboardPage myStepPage, final ParameterPage params) {
        ...
        if ((var0.equals("Rule-Agent-Queue"))) {
