...
public class ra_action_publishdecisionsmetrics_00e0d436d404638506de8aeca4030717 extends com.pega.pegarules.pub.runtime.AbstractActivity implements com.pega.pegarules.pub.runtime.Activity, FUAReusable, FUASupport, WebAllowable, com.pega.pegarules.priv.runtime.ITracerMetaData {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Activity.PublishDecisionsMetrics.PegaAESRemote_Interface_CDHMetricsInfo.Action");
	public ra_action_publishdecisionsmetrics_00e0d436d404638506de8aeca4030717(PegaAPI aContext) {
...
{
/* Instance RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-CDHMETRICSINFO PUBLISHDECISIONSMETRICS #20230619T005635.133 GMT	PegaAESRemote:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
try {
pz_CurrentRuleKey = "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-CDHMETRICSINFO PUBLISHDECISIONSMETRICS #20230619T005635.133 GMT";
...
PRStackFrame pz_StackFrame1_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-CDHMETRICSINFO PUBLISHDECISIONSMETRICS #20230619T005635.133 GMT Step: 1 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame2_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-CDHMETRICSINFO PUBLISHDECISIONSMETRICS #20230619T005635.133 GMT Step: 2 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame3_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-CDHMETRICSINFO PUBLISHDECISIONSMETRICS #20230619T005635.133 GMT Step: 3 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame4_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-CDHMETRICSINFO PUBLISHDECISIONSMETRICS #20230619T005635.133 GMT Step: 4 Circum: 0" );
try {
...
private static final String oDependencies [] = {
	"Rule-Obj-Activity:PUBLISHDECISIONSMETRICS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		new DependentRuleInfo("PUBLISHDECISIONSMETRICS","Rule-Obj-Activity","PEGAAESREMOTE-INTERFACE-CDHMETRICSINFO",false,"","PegaAESRemote","08-23-01","RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-CDHMETRICSINFO PUBLISHDECISIONSMETRICS #20230619T005635.133 GMT","!PUBLISHDECISIONSMETRICS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",358031418)
	};
...
//	RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-CDHMETRICSINFO PUBLISHDECISIONSMETRICS #20230619T005635.133 GMT:20230619T005635.133 GMT
	...
	public static String getFUAContentHash() {
		return "5c0d6a79c97c67bfb97c62fe5632ff56";
	}
...
/**
 * Check if its a production system.
 * <p>
...
tools.getStepStatus().set(ProcessingStatus.SEVERITY_GOOD, "PublishDecisionsMetrics - Precondition", null);
...
// Expression: "PegaAESRemote : PublishDecisionsMetrics Invoked for prod system"
if( oLog.isInfoEnabled() ){
oLog.info("PegaAESRemote : PublishDecisionsMetrics Invoked for prod system");
}
} finally {
	try{
...
pz_AttemptedStep = true;
try {	// Method:  Log-Message
// Expression: "PegaAESRemote : PublishDecisionsMetrics Invoked for staging system"
if( oLog.isInfoEnabled() ){
oLog.info("PegaAESRemote : PublishDecisionsMetrics Invoked for staging system");
}
} finally {
	try{
		infEngine.forwardChain(tools);
...
/**
 * Queue the SendDecisionsMetricsAsync activity because any failure on data push, agent never stop.
 * <p>
 * Step 3 [SEND] <code>Queue SendDecisionsMetricsAsync</code><br>
 */
...
boolean pz_CheckMessage = true; 
boolean pz_AttemptedStep = false; 
pega.activityStepProlog(snapshotLocalVariables(), pz_CurrentTraceInfo, pz_CurrentStepNum, "Queue SendDecisionsMetricsAsync");
try {
try {
final PRStackFrame  methodFrame = pega.pushStackFrame("Queue SendDecisionsMetricsAsync", null, false, true);
pz_AttemptedStep = true;
try {	// Method:  Queue SendDecisionsMetricsAsync
if (myStepPage == null) {
}
// Queuing Activity : SendDecisionsMetricsAsync
...
tools.getRequestor().queueBatchActivity(activityClass,"SendDecisionsMetricsAsync",newParamsPage);
} finally {
	try{
		infEngine.forwardChain(tools);
}
...
pz_CurrentStepNum = "3";
pega.activityStepEpilog(snapshotLocalVariables(), pz_CurrentTraceInfo, pz_CurrentStepNum, "Queue SendDecisionsMetricsAsync",pz_AttemptedStep);
}	// end try block for prolog/epilog
return pz_StepStat;
...
private static final com.pega.pegarules.priv.tracer.ActivityTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.ActivityTraceInfo("RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-CDHMETRICSINFO PUBLISHDECISIONSMETRICS #20230619T005635.133 GMT", "PegaAESRemote-Interface-CDHMetricsInfo PublishDecisionsMetrics", "PegaAESRemote", "08-23-01", false, true, "", "ACTIVITY", "20230619T005635.133 GMT" ,"Rule-Obj-Activity"); }
