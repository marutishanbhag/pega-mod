...
public class ra_action_pzgetchannelsconfigurationsbyclass_db55739d54c58aeb447569c24c02787b extends com.pega.pegarules.pub.runtime.AbstractActivity implements com.pega.pegarules.pub.runtime.Activity, FUAReusable, FUASupport, WebAllowable, com.pega.pegarules.priv.runtime.ITracerMetaData {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Activity.pzGetChannelsConfigurationsByClass.Code_Pega_List.Action");
	public ra_action_pzgetchannelsconfigurationsbyclass_db55739d54c58aeb447569c24c02787b(PegaAPI aContext) {
...
{
/* Instance RULE-OBJ-ACTIVITY CODE-PEGA-LIST PZGETCHANNELSCONFIGURATIONSBYCLASS #20180713T134844.873 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
try {
pz_CurrentRuleKey = "RULE-OBJ-ACTIVITY CODE-PEGA-LIST PZGETCHANNELSCONFIGURATIONSBYCLASS #20180713T134844.873 GMT";
...
PRStackFrame pz_StackFrame1_circum0 = pega.pushStackFrame( null, thisStepPage, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY CODE-PEGA-LIST PZGETCHANNELSCONFIGURATIONSBYCLASS #20180713T134844.873 GMT Step: 1 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame2_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY CODE-PEGA-LIST PZGETCHANNELSCONFIGURATIONSBYCLASS #20180713T134844.873 GMT Step: 2 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame3_circum0 = pega.pushStackFrame( null, thisStepPage, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY CODE-PEGA-LIST PZGETCHANNELSCONFIGURATIONSBYCLASS #20180713T134844.873 GMT Step: 3 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame4_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY CODE-PEGA-LIST PZGETCHANNELSCONFIGURATIONSBYCLASS #20180713T134844.873 GMT Step: 4 Circum: 0" );
try {
...
private static final String oDependencies [] = {
	"Rule-Obj-Activity:PZGETCHANNELSCONFIGURATIONSBYCLASS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		new DependentRuleInfo("PZGETCHANNELSCONFIGURATIONSBYCLASS","Rule-Obj-Activity","CODE-PEGA-LIST",false,"","Pega-EndUserUI","08-01-01","RULE-OBJ-ACTIVITY CODE-PEGA-LIST PZGETCHANNELSCONFIGURATIONSBYCLASS #20180713T134844.873 GMT","!PZGETCHANNELSCONFIGURATIONSBYCLASS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",2049087400)
	};
...
//	RULE-OBJ-ACTIVITY CODE-PEGA-LIST PZGETCHANNELSCONFIGURATIONSBYCLASS #20180713T134844.873 GMT:20180713T134844.873 GMT
	...
	public static String getFUAContentHash() {
		return "7281277821ade608fe1323423083de9e";
	}
...
browsePage.putString(".pyMapping(1).pyPropertyName", ".pyClassName");
...
selectPage.putString("pySort", "");
contentPage.getProperty("pySelectFields").add(selectPage);
browsePage.putString(".pyMapping(2).pyPropertyName", ".pyRuleSet");
...
selectPage.putString("pySort", "");
contentPage.getProperty("pySelectFields").add(selectPage);
browsePage.putString(".pyMapping(3).pyPropertyName", ".pyClassType");
...
pz_AttemptedStep = true;
try {	// Method:  java
boolean vForCurrentApp = false;
ParameterPage pp = tools.getParameterPage();
if(pp != null) {
  vForCurrentApp = pp.getAsBoolean("forCurrentApplication");
}
String vAppName = "";
ClipboardPage appPage = tools.findPage("Application");
if(appPage != null) {
  vAppName = appPage.getString("pyProductName");
}
ClipboardPage classes = tools.findPage("Classes");
ClipboardProperty result = classes.getProperty("pxResults(1)");
ClipboardProperty channels = myStepPage.getProperty("pxResults");
...
if (rulesets.contains(page.getString("pyRuleSet"))) {
    String className = page.getString("pyClassName");
    ClipboardPage obj = tools.createPage("Code-Pega-List", "");
    obj.putString("pyObjClass", className);
    obj.putString("pyMaxRecords", Integer.toString(Integer.MAX_VALUE));
    try {
      tools.getDatabase().list(obj, false);
      java.util.Iterator iter2 = obj.getProperty("pxResults").iterator();
      while (iter2.hasNext()) {
        
        ClipboardProperty channelProperty = (ClipboardProperty)iter2.next();
        ClipboardPage channelPage = channelProperty.getPageValue();
        //-- calculate list of email addresses, suggested cases
        StringMap  keys = new HashStringMap();
        keys.putString("pxObjClass", "Rule-Obj-Activity");
        keys.putString("pyClassName", channelPage.getClassName());
        keys.putString("pyActivityName", "pyOnTileLoad");
        tools.doActivity(keys, channelPage, tools.getParameterPage());
        
        if(vForCurrentApp) {
         
          if(vAppName.equals(channelPage.getString("pyProductName"))) {
            channels.add(channelPage);
          }
        } else {
          channels.add(channelPage);
        }
...
/**
 * Sort as per channel label.
 * <p>
 * Step 4 <code>Obj-Sort</code><br>
 */
...
private static final com.pega.pegarules.priv.tracer.ActivityTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.ActivityTraceInfo("RULE-OBJ-ACTIVITY CODE-PEGA-LIST PZGETCHANNELSCONFIGURATIONSBYCLASS #20180713T134844.873 GMT", "Code-Pega-List pzGetChannelsConfigurationsByClass", "Pega-EndUserUI", "08-01-01", false, true, "", "ACTIVITY", "20180713T134844.873 GMT" ,"Rule-Obj-Activity"); }
