...
public class ra_action_pushindexusedinfo_b6c4f2ff5485945989619b7c91a1078a extends com.pega.pegarules.pub.runtime.AbstractActivity implements com.pega.pegarules.pub.runtime.Activity, FUAReusable, FUASupport, WebAllowable, com.pega.pegarules.priv.runtime.ITracerMetaData {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Activity.PushIndexUsedInfo.PegaAESRemote_Interface_IndexUsedInfo.Action");
	public ra_action_pushindexusedinfo_b6c4f2ff5485945989619b7c91a1078a(PegaAPI aContext) {
...
{
/* Instance RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT	PegaAESRemote:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
try {
pz_CurrentRuleKey = "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT";
...
PRStackFrame pz_StackFrame1_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 1 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame2_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 2 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame3_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 3 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame4_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 4 Circum: 0" );
try {
...
String pz_5 = "IndexUsedInfo";
thisStepPage = tools.findPage(pz_5, true);
PRStackFrame pz_StackFrame5_circum0 = pega.pushStackFrame( null, thisStepPage, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 5 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame6_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 6 Circum: 0" );
try {
...
ClipboardPage  myStepPage = tools.getStepPage();
String pz_8 = "IndexUsedInfo";
thisStepPage = tools.findPage(pz_8, true);
if (thisStepPage == null) {
thisStepPage = tools.findPage(pz_8, false);
thisStepPage.putString("pxObjClass", "PegaAESRemote-Interface-IndexUsedInfo");
}
PRStackFrame pz_StackFrame7_circum0 = pega.pushStackFrame( null, thisStepPage, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 7 Circum: 0" );
try {
...
ClipboardPage  myStepPage = tools.getStepPage();
String pz_13 = "IndexUsedInfo";
thisStepPage = tools.findPage(pz_13, true);
PRStackFrame pz_StackFrame8_circum0 = pega.pushStackFrame( null, thisStepPage, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 8 Circum: 0" );
try {
...
ClipboardPage  myStepPage = tools.getStepPage();
String pz_15 = "IndexUsedInfo";
thisStepPage = tools.findPage(pz_15, true);
PRStackFrame pz_StackFrame9_circum0 = pega.pushStackFrame( null, thisStepPage, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 9 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame10_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 10 Circum: 0" );
try {
...
ClipboardPage  myStepPage = tools.getStepPage();
String pz_21 = "IndexUsedInfo";
thisStepPage = tools.findPage(pz_21, true);
PRStackFrame pz_StackFrame11_circum0 = pega.pushStackFrame( null, thisStepPage, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 11 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame12_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 12 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame13_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 13 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame14_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 14 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame15_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT Step: 15 Circum: 0" );
try {
...
private static final String oDependencies [] = {
	"Rule-Obj-Activity:PUSHINDEXUSEDINFO"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		new DependentRuleInfo("PUSHINDEXUSEDINFO","Rule-Obj-Activity","PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO",false,"","PegaAESRemote","08-23-01","RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT","!PUSHINDEXUSEDINFO",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",505595627)
	};
...
//	RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT:20230619T005636.406 GMT
	...
	public static String getFUAContentHash() {
		return "720b202ab928a710ea6776a44a1b24fe";
	}

	public String getDefinitionAppliesToClass() {
		return "PegaAESRemote-Interface-IndexUsedInfo";
	}
...
// Expression: "PegaAESRemote : Push Index Used Info Invoked"
if( oLog.isInfoEnabled() ){
oLog.info("PegaAESRemote : Push Index Used Info Invoked");
}
} finally {
	try{
...
{
    tools.putParamValue("pdcServiceURL", PropertyInfo.TYPE_TEXT, "PegaAES/v2/LogIndexUsedInfo");
}
{
    tools.putParamValue("servicename", PropertyInfo.TYPE_TEXT, "PushIndexUsedInfo");
}
{
    tools.putParamValue("message", PropertyInfo.TYPE_TEXT, "PegaAESRemote : Push Index Used Info message is");
}
} finally {
	try{
		infEngine.forwardChain(tools);
...
pega.invokeActivity(myStepPage, newParamsPage, "CheckAESConnection", "PegaAESRemote-Interface-IndexUsedInfo", "");
} finally {
	try{
		infEngine.forwardChain(tools);
}
 ...
 * <p>
 * Step 5 <code>Page-New</code> [on page IndexUsedInfo] <br>
 */
...
tools.getStepStatus().set(ProcessingStatus.SEVERITY_GOOD, "PushIndexUsedInfo - Precondition", null);
...
pz_AttemptedStep = true;
try {	// Method:  Page-New
String pz_7 = "IndexUsedInfo";
myStepPage = tools.findPage(pz_7, true);
	 myStepPage = ((com.pega.pegarules.priv.context.PegaThread)tools.getThread()).createPageForPageNew("PegaAESRemote-Interface-IndexUsedInfo","IndexUsedInfo",false); 
// primary page will not be added to PageList
	 pega.setStepPage("IndexUsedInfo", myStepPage);
} finally {
	try{
		infEngine.forwardChain(tools);
}
...
pz_AttemptedStep = true;
try {	// Method:  RDB-List
// Expression: PopulateIndexUsedInfo
// Expression: PostgreSQL
// Expression: PegaAESRemote-Interface-IndexUsedInfo
// Expression: 
// Expression: IndexUsedInfo
ClipboardPage myBrowseSQLPage = tools.getThread().createPage("Code-Pega-List", "IndexUsedInfo");
...
var_pySQLBrowse_pyObjClass.setValue("PegaAESRemote-Interface-IndexUsedInfo");
...
try {
tools.getDatabase().listRDB(myBrowseSQLPage, "PopulateIndexUsedInfo", "PostgreSQL", true);
...
PRStackFrame pz_tranStackFrame = pega.pushStackFrame(null, false, true, PRStackFrame.Type.TRANSITIONS );
try {	// Transitions
boolean pz__1 = pega.invokeWhen("StepStatusGood", "PegaAESRemote-Interface-IndexUsedInfo", "PegaAESRemote-Interface-IndexUsedInfo");
if (!pz__1) {
 ...
 * <p>
 * Step 7 <code>Property-Set</code> [on page IndexUsedInfo] <br>
 */
 ...
 * <p>
 * Step 8 <code>Page-Change-Class</code> [on page IndexUsedInfo] <br>
 */
...
// Expression: PegaAESRemote-Interface-IndexUsedInfo
// Change the page class to : PegaAESRemote-Interface-IndexUsedInfo
// Keep parameter is : 
// Expression: 
ClipboardPage  newPage = tools.getThread().createPage("PegaAESRemote-Interface-IndexUsedInfo", "");
String pz_14 = "IndexUsedInfo";
myStepPage = tools.findPage(pz_14, true);
if (myStepPage == null) {
pega.setStepPage("IndexUsedInfo", newPage);
} else {
ClipboardPage  tempPage = tools.getThread().createPage("PegaAESRemote-Interface-IndexUsedInfo", "");
 ...
 * Map the XML Stream.
 * <p>
 * Step 9 <code>Property-Set-XML</code> [on page IndexUsedInfo] <br>
 */
...
// Expression: IndexUsedInfoUsage
// Expression: MAPFROM
StringMap  keys = new HashStringMap();
keys.putString("pxObjClass", "Rule-Obj-XML");
keys.putString("pyStreamName", "IndexUsedInfoUsage");
if (myStepPage == null || myStepPage.getClassName().length() == 0) {
keys.putString("pyClassName", "PegaAESRemote-Interface-IndexUsedInfo");
}
...
try {	// Method:  Property-Set
{
    pega.setViaPropRef(".pyNote", pRef_19, pega.findPageWithException("IndexUsedInfo", "PegaAESRemote-Interface-IndexUsedInfo"), pega.<String>resolveMethodCall("CompressEncodeString--(String)", "CompressEncodeString", null, null, new Object[] { scalarValueQuery_20.resolveToString(tools, pega.findPageWithException("IndexUsedInfo", "PegaAESRemote-Interface-IndexUsedInfo"), ImmutablePropertyInfo.TYPE_TEXT) }), "sTN", false, true);
}
} finally {
	try{
		infEngine.forwardChain(tools);
 ...
 * Push to AES/PDC.
 * <p>
 * Step 11 <code>Call PDCRestPush</code> [on page IndexUsedInfo] <br>
 */
...
if (myStepPage == null) {
String pz_22 = "IndexUsedInfo";
myStepPage = tools.findPage(pz_22, true);
if (myStepPage == null) {
myStepPage = tools.findPage(pz_22, false);
myStepPage.putString("pxObjClass", "PegaAESRemote-Interface-IndexUsedInfo");
}
}
// Calling Activity : PDCRestPush
ParameterPage newParamsPage = null;
pega.invokeActivity(myStepPage, newParamsPage, "PDCRestPush", "PegaAESRemote-Interface-IndexUsedInfo", "");
} finally {
	try{
		infEngine.forwardChain(tools);
}
...
pz_AttemptedStep = true;
try {	// Method:  Log-Message
// Expression: "Failed to fetch records in activity PushIndexUsedInfo"
if( oLog.isDebugEnabled() ){
oLog.debug("Failed to fetch records in activity PushIndexUsedInfo");
}
} finally {
	try{
		infEngine.forwardChain(tools);
...
// Expression: IndexUsedInfo
pageRemove(tools.findPage("IndexUsedInfo"));
} finally {
	try{
		infEngine.forwardChain(tools);
}
...
/**
 * Call Index Definition Info.
 * <p>
 * Step 15 <code>Call PegaAESRemote-Interface-IndexDefinition.PushIndexDefinitionInfo</code><br>
 */
...
boolean pz_CheckMessage = true; 
boolean pz_AttemptedStep = false; 
pega.activityStepProlog(snapshotLocalVariables(), pz_CurrentTraceInfo, pz_CurrentStepNum, "Call PegaAESRemote-Interface-IndexDefinition.PushIndexDefinitionInfo");
try {
final PRStackFrame  methodFrame = pega.pushStackFrame("Call PegaAESRemote-Interface-IndexDefinition.PushIndexDefinitionInfo", null, false, true);
pz_AttemptedStep = true;
try {	// Method:  Call PegaAESRemote-Interface-IndexDefinition.PushIndexDefinitionInfo
if (myStepPage == null) {
}
// Calling Activity : PegaAESRemote-Interface-IndexDefinition.PushIndexDefinitionInfo
...
pega.invokeActivity(myStepPage, newParamsPage, "PushIndexDefinitionInfo", "PegaAESRemote-Interface-IndexUsedInfo", "PegaAESRemote-Interface-IndexDefinition");
} finally {
	try{
		infEngine.forwardChain(tools);
}
...
pz_CurrentStepNum = "15";
pega.activityStepEpilog(snapshotLocalVariables(), pz_CurrentTraceInfo, pz_CurrentStepNum, "Call PegaAESRemote-Interface-IndexDefinition.PushIndexDefinitionInfo",pz_AttemptedStep);
}	// end try block for prolog/epilog
return pz_StepStat;
...
private static final com.pega.pegarules.priv.tracer.ActivityTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.ActivityTraceInfo("RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-INDEXUSEDINFO PUSHINDEXUSEDINFO #20230619T005636.406 GMT", "PegaAESRemote-Interface-IndexUsedInfo PushIndexUsedInfo", "PegaAESRemote", "08-23-01", false, true, "", "ACTIVITY", "20230619T005636.406 GMT" ,"Rule-Obj-Activity"); }
