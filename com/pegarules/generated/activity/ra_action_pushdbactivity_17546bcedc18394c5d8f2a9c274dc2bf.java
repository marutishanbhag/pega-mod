...
public class ra_action_pushdbactivity_17546bcedc18394c5d8f2a9c274dc2bf extends com.pega.pegarules.pub.runtime.AbstractActivity implements com.pega.pegarules.pub.runtime.Activity, FUAReusable, FUASupport, WebAllowable, com.pega.pegarules.priv.runtime.ITracerMetaData {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Activity.PushDBActivity.PegaAESRemote_Interface_DBActivity.Action");
	public ra_action_pushdbactivity_17546bcedc18394c5d8f2a9c274dc2bf(PegaAPI aContext) {
...
{
/* Instance RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT	PegaAESRemote:08-07-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
try {
pz_CurrentRuleKey = "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT";
...
PRStackFrame pz_StackFrame1_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT Step: 1 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame2_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT Step: 2 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame3_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT Step: 3 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame4_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT Step: 4 Circum: 0" );
try {
...
String pz_5 = "DBActivityInfo";
thisStepPage = tools.findPage(pz_5, true);
PRStackFrame pz_StackFrame5_circum0 = pega.pushStackFrame( null, thisStepPage, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT Step: 5 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame6_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT Step: 6 Circum: 0" );
try {
...
ClipboardPage  myStepPage = tools.getStepPage();
String pz_9 = "DBActivityInfo";
thisStepPage = tools.findPage(pz_9, true);
if (thisStepPage == null) {
thisStepPage = tools.findPage(pz_9, false);
thisStepPage.putString("pxObjClass", "PegaAESRemote-Interface-DBActivity");
}
PRStackFrame pz_StackFrame7_circum0 = pega.pushStackFrame( null, thisStepPage, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT Step: 7 Circum: 0" );
try {
...
ClipboardPage  myStepPage = tools.getStepPage();
String pz_14 = "DBActivityInfo";
thisStepPage = tools.findPage(pz_14, true);
PRStackFrame pz_StackFrame8_circum0 = pega.pushStackFrame( null, thisStepPage, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT Step: 8 Circum: 0" );
try {
...
ClipboardPage  myStepPage = tools.getStepPage();
String pz_16 = "DBActivityInfo";
thisStepPage = tools.findPage(pz_16, true);
PRStackFrame pz_StackFrame9_circum0 = pega.pushStackFrame( null, thisStepPage, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT Step: 9 Circum: 0" );
try {
...
ClipboardPage  myStepPage = tools.getStepPage();
String pz_20 = "DBActivityInfo";
thisStepPage = tools.findPage(pz_20, true);
PRStackFrame pz_StackFrame10_circum0 = pega.pushStackFrame( null, thisStepPage, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT Step: 10 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame11_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT Step: 11 Circum: 0" );
try {
...
PRStackFrame pz_StackFrame12_circum0 = pega.pushStackFrame( null, false, false, PRStackFrame.Type.ACTIVITY_STEP, "RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT Step: 12 Circum: 0" );
try {
...
private static final String oDependencies [] = {
	"Rule-Obj-Activity:PUSHDBACTIVITY"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		new DependentRuleInfo("PUSHDBACTIVITY","Rule-Obj-Activity","PEGAAESREMOTE-INTERFACE-DBACTIVITY",false,"","PegaAESRemote","08-07-01","RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT","!PUSHDBACTIVITY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1502573547)
	};
...
//	RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT:20210604T130152.478 GMT
	...
	public static String getFUAContentHash() {
		return "1169f7e2926125f057efb85cd5721784";
	}

	public String getDefinitionAppliesToClass() {
		return "PegaAESRemote-Interface-DBActivity";
	}
...
// Expression: "PegaAESRemote : Push Database Activity Info Invoked"
if( oLog.isInfoEnabled() ){
oLog.info("PegaAESRemote : Push Database Activity Info Invoked");
}
} finally {
	try{
...
{
    tools.putParamValue("pdcServiceURL", PropertyInfo.TYPE_TEXT, "PegaAES/v1/LogDBActivity");
}
{
    tools.putParamValue("servicename", PropertyInfo.TYPE_TEXT, "PushDBActivityUsage");
}
{
    tools.putParamValue("message", PropertyInfo.TYPE_TEXT, "PegaAESRemote : Push DB Activity message is");
}
} finally {
	try{
		infEngine.forwardChain(tools);
...
pega.invokeActivity(myStepPage, newParamsPage, "CheckAESConnection", "PegaAESRemote-Interface-DBActivity", "");
} finally {
	try{
		infEngine.forwardChain(tools);
}
...
/**
 * Create New DBActivityInfo Page.
 * <p>
 * Step 5 <code>Page-New</code> [on page DBActivityInfo] <br>
 */
...
tools.getStepStatus().set(ProcessingStatus.SEVERITY_GOOD, "PushDBActivity - Precondition", null);
...
pz_AttemptedStep = true;
try {	// Method:  Page-New
String pz_7 = "DBActivityInfo";
myStepPage = tools.findPage(pz_7, true);
	 myStepPage = ((com.pega.pegarules.priv.context.PegaThread)tools.getThread()).createPageForPageNew("PegaAESRemote-Interface-DBActivity","DBActivityInfo",false); 
// primary page will not be added to PageList
	 pega.setStepPage("DBActivityInfo", myStepPage);
} finally {
	try{
		infEngine.forwardChain(tools);
}
...
pz_AttemptedStep = true;
try {	// Method:  RDB-List
// Expression: PopulateDBActivityInfo
// Expression: PostgreSQL
// Expression: PegaAESRemote-Interface-DBActivity
// Expression: 1000
String pz_8 = Integer.toString(1000);
// Expression: DBActivityInfo
ClipboardPage myBrowseSQLPage = tools.getThread().createPage("Code-Pega-List", "DBActivityInfo");
...
var_pySQLBrowse_pyObjClass.setValue("PegaAESRemote-Interface-DBActivity");
...
try {
tools.getDatabase().listRDB(myBrowseSQLPage, "PopulateDBActivityInfo", "PostgreSQL", true);
 ...
 * <p>
 * Step 7 <code>Property-Set</code> [on page DBActivityInfo] <br>
 */
 ...
 * <p>
 * Step 8 <code>Page-Change-Class</code> [on page DBActivityInfo] <br>
 */
...
// Expression: PegaAESRemote-Interface-DBActivity
// Change the page class to : PegaAESRemote-Interface-DBActivity
// Keep parameter is : 
// Expression: 
ClipboardPage  newPage = tools.getThread().createPage("PegaAESRemote-Interface-DBActivity", "");
String pz_15 = "DBActivityInfo";
myStepPage = tools.findPage(pz_15, true);
if (myStepPage == null) {
pega.setStepPage("DBActivityInfo", newPage);
} else {
ClipboardPage  tempPage = tools.getThread().createPage("PegaAESRemote-Interface-DBActivity", "");
 ...
 * Map the XML Stream.
 * <p>
 * Step 9 <code>Property-Set-XML</code> [on page DBActivityInfo] <br>
 */
 ...
 * Push to AES/PDC.
 * <p>
 * Step 10 <code>Call PDCRestPush</code> [on page DBActivityInfo] <br>
 */
...
if (myStepPage == null) {
String pz_21 = "DBActivityInfo";
myStepPage = tools.findPage(pz_21, true);
if (myStepPage == null) {
myStepPage = tools.findPage(pz_21, false);
myStepPage.putString("pxObjClass", "PegaAESRemote-Interface-DBActivity");
}
}
// Calling Activity : PDCRestPush
ParameterPage newParamsPage = null;
pega.invokeActivity(myStepPage, newParamsPage, "PDCRestPush", "PegaAESRemote-Interface-DBActivity", "");
} finally {
	try{
		infEngine.forwardChain(tools);
}
...
// Expression: DBActivityInfo
pageRemove(tools.findPage("DBActivityInfo"));
} finally {
	try{
		infEngine.forwardChain(tools);
}
...
private static final com.pega.pegarules.priv.tracer.ActivityTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.ActivityTraceInfo("RULE-OBJ-ACTIVITY PEGAAESREMOTE-INTERFACE-DBACTIVITY PUSHDBACTIVITY #20210604T130152.478 GMT", "PegaAESRemote-Interface-DBActivity PushDBActivity", "PegaAESRemote", "08-07-01", false, true, "", "ACTIVITY", "20210604T130152.478 GMT" ,"Rule-Obj-Activity"); }
