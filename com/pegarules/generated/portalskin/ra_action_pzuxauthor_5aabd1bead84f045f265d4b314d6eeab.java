...
import java.util.*;
public class ra_action_pzuxauthor_5aabd1bead84f045f265d4b314d6eeab  extends com.pega.pegarules.priv.runtime.AbstractSkin implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_PortalSkin.pzUXAuthor.Action");
	public ra_action_pzuxauthor_5aabd1bead84f045f265d4b314d6eeab(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
static final String skinName = "pzUXAuthor";
static final String skinLabel = "UX Author";
...
static {
	workStyleBases.put("appWorkStyle", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pzuxauthor");
	workStyleBases.put("appWorkStyle_rtl", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pzuxauthor_rtl_");
	workStyleBases.put("appWorkStyle_legacy", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pzuxauthor_legacy_");
	workStyleBases.put("appWorkStyle_workform", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pzuxauthor_workform_");
	workStyleBases.put("appWorkStyle_workform_legacy", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pzuxauthor_workform_legacy_");
}
...
{
/* Instance RULE-PORTALSKIN PZUXAUTHOR #20180926T141314.920 GMT	Pega-Desktop:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		oLog.debug("pzSkinMethodBody FUA execution for '" + "RULE-PORTALSKIN PZUXAUTHOR #20180926T141314.920 GMT" + "' - pyAction='" + action + "'");
		}
		...
		skinRefPage.putString("pzRefInsKey","RULE-PORTALSKIN PZUXAUTHOR #20180926T141314.920 GMT");
		...
		IsCSSAsJSON = true;
		workStyleBases.put("appWorkStyle_json", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pzuxauthor_json_");
		}
		...
		protected String getThemeName(String themeFormat) {
			...
			protected List<String> getFormats(String key) {
				...
				formats.put("Embed-Skin-Component-Themecustom", new ArrayList(Arrays.asList("Action Standard","Action border","Menu Active","Link")));
				formats.put("Embed-Skin-Componentcustom", new ArrayList(Arrays.asList("")));
				formats.put("Embed-Skin-Component-Headercustom", new ArrayList(Arrays.asList("Fat list item","Simple combo group child","Distinguished","Landing page content")));
				formats.put("Embed-Skin-Component-Buttonstandard", new ArrayList(Arrays.asList("Standard","Simple")));
				formats.put("Embed-Skin-Component-Buttoncustom", new ArrayList(Arrays.asList("Property panel actions","Standard full width","Split button")));
				formats.put("Embed-Skin-Component-ButtonnonLegacyFormats", new ArrayList(Arrays.asList("Property panel actions","Standard","Simple","Standard full width","Split button")));
				formats.put("Embed-Skin-Component-Inputcustom", new ArrayList(Arrays.asList("Overflow text")));
				formats.put("Embed-Skin-Component-Linkstandard", new ArrayList(Arrays.asList("Standard","Simple","Strong")));
				formats.put("Embed-Skin-Component-Linkcustom", new ArrayList(Arrays.asList("Disabled","Disabled list item","Help link","Standard Ellipsis","Standard label link")));
				formats.put("Embed-Skin-Component-MenuBarcustom", new ArrayList(Arrays.asList("Channels")));
				formats.put("Embed-Skin-Componentstandard", new ArrayList(Arrays.asList("")));
				formats.put("Embed-Skin-Component-ModalDialogcustom", new ArrayList(Arrays.asList("ActionSet")));
				formats.put("Embed-Skin-Componentstandard", new ArrayList(Arrays.asList("")));
				formats.put("Embed-Skin-Componentstandard", new ArrayList(Arrays.asList("")));
				formats.put("Embed-Skin-Componentstandard", new ArrayList(Arrays.asList("")));
				...
				formats.put("Embed-Skin-Component-ScreenLayoutdisabledInherited", new ArrayList(Arrays.asList("Header","Header Right","Header Footer","Header Footer Right","Header Left Right","Header Footer Left Right","Left","Content Only","Footer")));
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZUXAUTHOR","Rule-PortalSkin","",false,"","Pega-Desktop","08-02-01","RULE-PORTALSKIN PZUXAUTHOR #20180926T141314.920 GMT","PZUXAUTHOR",true,false,"ABSOLUTE_CLASSLESS",-131685367)
	};
...
//	RULE-PORTALSKIN PZUXAUTHOR #20180926T141314.920 GMT:20180926T141314.920 GMT
//	getParentSkinName(
...
//	RULE-UTILITY-FUNCTION PAGE PAGEEXISTSWITHCLASS #20180713T131441.343 GMT:20180713T131441.343 GMT
	...
	public static String getFUAContentHash() {
		return "828dbd99e7369c51f634968e3cf5322d";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-PORTALSKIN PZUXAUTHOR #20180926T141314.920 GMT", "pzUXAuthor", "Pega-Desktop", "08-02-01", "20180926T141314.920 GMT");
}
