...
import java.util.*;
public class ra_action_cosmosskin_74c494114e4a4fe63dc72af6ebdb02f4  extends com.pega.pegarules.priv.runtime.AbstractSkin implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_PortalSkin.CosmosSkin.Action");
	public ra_action_cosmosskin_74c494114e4a4fe63dc72af6ebdb02f4(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
static final String skinName = "CosmosSkin";
static final String skinLabel = "CosmosSkin";
...
static {
	workStyleBases.put("appWorkStyle", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"cosmosskin");
	workStyleBases.put("appWorkStyle_rtl", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"cosmosskin_rtl_");
	workStyleBases.put("appWorkStyle_legacy", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"cosmosskin_legacy_");
	workStyleBases.put("appWorkStyle_workform", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"cosmosskin_workform_");
	workStyleBases.put("appWorkStyle_workform_legacy", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"cosmosskin_workform_legacy_");
}
protected List<String> getAdditionalCSS() {
	 List<String> additionalCSS = new ArrayList<String>(4);
	additionalCSS.add("py-cosmos-portal");
	additionalCSS.add("py-cosmos-workarea");
	additionalCSS.add("py-cosmos-utilities");
	additionalCSS.add("px-pega-default-icons");
	additionalCSS.add("py-apps-logo");
	additionalCSS.add("py-cosmos-social");
	additionalCSS.add("py-cosmos-control");
	additionalCSS.add("py-design-template-styles");
	additionalCSS.add("py-cosmos-ui-templates");
	additionalCSS.add("py-dashboard-personalization");
	additionalCSS.add("py-cosmos-responsive");
	additionalCSS.add("py-cosmos-mobile");
	additionalCSS.add("py-mobile-behaviors");
	additionalCSS.add("pzpega-scorecard-template-style");
	additionalCSS.add("py-cosmos-scorecard-overrides");
	additionalCSS.add("py-cosmos-skeleton");
	additionalCSS.add("py-cosmos-reports");
	additionalCSS.add("py-cosmos-helper-classes");
	additionalCSS.add("py-cosmos-runtime-tools");
...
{
/* Instance RULE-PORTALSKIN COSMOSSKIN #20210506T204033.512 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		oLog.debug("pzSkinMethodBody FUA execution for '" + "RULE-PORTALSKIN COSMOSSKIN #20210506T204033.512 GMT" + "' - pyAction='" + action + "'");
		}
		...
		skinRefPage.putString("pzRefRuleSet","Theme-Cosmos");
		skinRefPage.putString("pzRefInsKey","RULE-PORTALSKIN COSMOSSKIN #20210506T204033.512 GMT");
		...
		IsCSSAsJSON = true;
		workStyleBases.put("appWorkStyle_json", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"cosmosskin_json_");
		}
		...
		protected String getThemeName(String themeFormat) {
			...
			protected List<String> getFormats(String key) {
				...
				formats.put("Embed-Skin-Component-Themecustom", new ArrayList(Arrays.asList("Error","Borders","Column headings","Menu active","Menu Inactive","General","Link","Strong Link","Menu","Primary navigation","Page background","Work area background","Overlays and modals and menus","Inactive","Table row odd","Table row even","Instruction Text","Heading 1","Heading 2","Heading 3","Field","Notifications","Status warning","Status error","Border thick","Grid row hover background","Selected item background","Selected item text","Strong text","Information","Heading 4","Row banding","Input error text","Action area menus","Action area background","Action area borders","Heading 5","Heading 6","Standard Active","Action Standard","Badges","Empty state icon","Action border","Strong action background","Standard action background","Action border focus","Link focus","Action background hover","Strong action focus background","Status OK","Labels","Medium urgency text","Low urgency text","Required","High urgency text","Secondary","Utils collapsed","Utils expanded","Badge bad","Badge good","Badge info","Badge offline","Badge old","Badge wait","Badge warn","Light Link","Secondary background","Mobile bottom navigation","Nav separator","Primary swipe action","Secondary swipe action","Tertiary swipe action","Urgency text","Badge counter","Badge counter horizontal tabs","Badge counter preview panel","Banner Info","Banner Success","Banner Urgent","Banner Warn","Active navigation text","Active navigation background","Case Header","Portal header bar","Focus shadow","Inactive navigation text")));
				...
				formats.put("Embed-Skin-Component-Labelscustom", new ArrayList(Arrays.asList("Heading 1","Heading 2","Heading 3","Heading 4","Helper text","General","Supporting text")));
				...
				formats.put("Embed-Skin-Component-Headercustom", new ArrayList(Arrays.asList("Utility","Warnings","Notifications","Errors","Information","Mobile header","Case icon")));
				...
				formats.put("Embed-Skin-Component-Repeatingstandard", new ArrayList(Arrays.asList("Default")));
				...
				formats.put("Embed-Skin-Component-Buttoncustom", new ArrayList(Arrays.asList("Icon","Header icon","Primary swipe action","Secondary swipe action","Tertiary swipe action","Link")));
				formats.put("Embed-Skin-Component-ButtonnonLegacyFormats", new ArrayList(Arrays.asList("Standard","Simple","Strong","Icon","Header icon","Primary swipe action","Secondary swipe action","Tertiary swipe action","Link")));
				formats.put("Embed-Skin-Component-Inputstandard", new ArrayList(Arrays.asList("Standard")));
				formats.put("Embed-Skin-Component-Inputcustom", new ArrayList(Arrays.asList("Heading 2","Heading 3","Case title","Case Description","Badge text","Supporting text","Primary search","Table search","Critical detail")));
				formats.put("Embed-Skin-Component-Linkstandard", new ArrayList(Arrays.asList("Standard","Simple","Strong")));
				formats.put("Embed-Skin-Component-Linkcustom", new ArrayList(Arrays.asList("Breadcrumbs")));
				...
				formats.put("Embed-Skin-Component-MenuBarcustom", new ArrayList(Arrays.asList("Primary navigation","Create case menu","Case details","Mobile bottom navigation","Mobile actions sheet","Mobile swipe actions","Fixed navigation")));
				...
				formats.put("Embed-Skin-Component-ModalDialogcustom", new ArrayList(Arrays.asList("Fixed sized","Large fixed","Fixed list","Full screen")));
				...
				formats.put("Embed-Skin-Component-Overlaycustom", new ArrayList(Arrays.asList("Fixed size","List","Fluid","Fixed position","More menu","Fixed bottom","Fixed top")));
				...
				formats.put("Embed-Skin-Component-SimpleLayoutcustom", new ArrayList(Arrays.asList("Inline middle","Stacked with labels left","Simple list","Inline labels left","Mimic a sentence","Simple list with labels left","Inline grid quadruple","Inline middle labels left")));
				formats.put("Embed-Skin-Component-ColumnLayouttemplatetwo-col-sidebar-main",new ArrayList(Arrays.asList("Two Column (Sidebar - Main)")));
				formats.put("Embed-Skin-Component-ColumnLayouttemplatethree-col-sidebar-main-sidebar",new ArrayList(Arrays.asList("Three Column (Sidebar - Main - Sidebar)")));
				formats.put("Embed-Skin-Component-ColumnLayouttemplatetwo-col-main-sidebar",new ArrayList(Arrays.asList("Two Column (Main - Sidebar)")));
				...
				formats.put("Embed-Skin-Component-ScreenLayoutstandard", new ArrayList(Arrays.asList("Header Left","Footer")));
				formats.put("Embed-Skin-Component-LayoutGroupstandard", new ArrayList(Arrays.asList("Default","Accordion","Menu","Stacked","Tab")));
				formats.put("Embed-Skin-Component-LayoutGroupcustom", new ArrayList(Arrays.asList("Mobile menu")));
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("COSMOSSKIN","Rule-PortalSkin","",false,"","Theme-Cosmos","04-01-01","RULE-PORTALSKIN COSMOSSKIN #20210506T204033.512 GMT","COSMOSSKIN",true,false,"ABSOLUTE_CLASSLESS",-484555005)
	};
...
//	RULE-PORTALSKIN COSMOSSKIN #20210506T204033.512 GMT:20231110T115553.138 GMT
//	getParentSkinName(
...
//	RULE-UTILITY-FUNCTION PAGE PAGEEXISTSWITHCLASS #20180713T131441.343 GMT:20180713T131441.343 GMT
	...
	public static String getFUAContentHash() {
		return "df25536967a5f15a4ec3c3d07a80b876";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-PORTALSKIN COSMOSSKIN #20210506T204033.512 GMT", "CosmosSkin", "Theme-Cosmos", "04-01-01", "20231110T115553.138 GMT");
}
