...
import java.util.*;
public class ra_action_pyenduser_a178b387e0af1337a762f85e7033fd5f  extends com.pega.pegarules.priv.runtime.AbstractSkin implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_PortalSkin.pyEndUser.Action");
	public ra_action_pyenduser_a178b387e0af1337a762f85e7033fd5f(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
static final String skinName = "pyEndUser";
static final String skinLabel = "pyEndUser";
...
static {
	workStyleBases.put("appWorkStyle", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pyenduser");
	workStyleBases.put("appWorkStyle_rtl", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pyenduser_rtl_");
	workStyleBases.put("appWorkStyle_legacy", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pyenduser_legacy_");
	workStyleBases.put("appWorkStyle_workform", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pyenduser_workform_");
	workStyleBases.put("appWorkStyle_workform_legacy", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pyenduser_workform_legacy_");
}
protected List<String> getAdditionalCSS() {
	 List<String> additionalCSS = new ArrayList<String>(4);
	additionalCSS.add("py-enduser71-workarea-overrides");
	additionalCSS.add("py-portal-stages");
	additionalCSS.add("py-tables-overrides");
	additionalCSS.add("pyscreenflow71");
	additionalCSS.add("py-case-manager-header-overrides");
	additionalCSS.add("px-pega-default-icons");
	additionalCSS.add("py-responsive-overrides");
	additionalCSS.add("py-mobile-controls");
	additionalCSS.add("py-dashboard-personalization");
	additionalCSS.add("py-helper-classes");
	additionalCSS.add("py-common-helper-classes");
	additionalCSS.add("pypega-appcontent-skeleton");
	additionalCSS.add("pyGroups");
	additionalCSS.add("py-mobile-behaviors");
	additionalCSS.add("py-design-template-styles");
...
{
/* Instance RULE-PORTALSKIN PYENDUSER #20210920T102235.745 GMT	Pega-EndUserUI:08-07-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		...
		oLog.debug("pzSkinMethodBody FUA execution for '" + "RULE-PORTALSKIN PYENDUSER #20210920T102235.745 GMT" + "' - pyAction='" + action + "'");
		}
		...
		skinRefPage.putString("pzRefRuleSet","Pega-EndUserUI");
		skinRefPage.putString("pzRefInsKey","RULE-PORTALSKIN PYENDUSER #20210920T102235.745 GMT");
		...
		IsCSSAsJSON = true;
		workStyleBases.put("appWorkStyle_json", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pyenduser_json_");
		}
		...
		protected String getThemeName(String themeFormat) {
			...
			protected List<String> getFormats(String key) {
				...
				formats.put("Embed-Skin-Component-Themecustom", new ArrayList(Arrays.asList("Error","Borders","Column headings","Menu active","Menu Inactive","General","Link","Strong Link","Header Text","Header background","Menu","Primary navigation","Page background","Work area background","Overlays and modals and menus","Inactive","Table row odd","Table row even","Instruction Text","Heading 1","Heading 2","Heading 3","Field","Notifications","Status warning","Status error","Border thick","Focus background","Grid row hover background","Selected item background","Focus","Hover text","Selected item text","Strong text","Information","Heading 4","Workarea header background","Row banding","Input error text","Action menu background","Action area menus","Content emphasis","Action area background","Action area borders","Application name","Heading 5","Heading 6","Breadcrumbs","Active menu item","Standard Active","Action Standard","Button Text","System message","Badges","Badge info","Badge old","Badge wait","Mobile Header Text","Badge warn","Badge good","Badge bad","Badge offline","Mobile header background","Empty state icon","Action border","Strong action background","Standard action background","Action border focus","Link focus","Action background hover","Strong action focus background","Mobile icon hover background","Mobile icon focus background","Status OK","Header metadata","Border bottom","Labels","Secondary background","Medium urgency text","Low urgency text","Completed text","High urgency border","Low urgency border","Medium urgency border","Required","Match page background","Data callout","Aside menus","Primary swipe action","Secondary swipe action","Tertiary swipe action")));
				...
				formats.put("Embed-Skin-Component-Labelscustom", new ArrayList(Arrays.asList("Heading 1","Heading 2","Heading 3","Heading 4","Explorer heading","SLA display","Secondary information","Announcement","Helper text","Status complete","Status inprogress","Status failure","Status unavailable","Application name","Scorecard Label","Badge text")));
				...
				formats.put("Embed-Skin-Component-Headercustom", new ArrayList(Arrays.asList("Nested","Combo group","Workarea header","Notifications","Warnings","Errors","Explorer","Information","Drop zone","Fat list item","Alternate","Section divider","Portal header","Action area","Workarea","Column","Modal buttons","Column list","Modal button array","Case secondary content","Assignment supporting","Child element","Action area header","Nested information","Row divider","Default for nesting","Dashboard gadget","Default with no padding","System message","Mobile header","Mobile case subheader","Mobile Action area","Mobile Action area header","Accordion","Sidebar gadget","Mobile card")));
				formats.put("Embed-Skin-Component-Tabstandard", new ArrayList(Arrays.asList("Standard","Sub","Repeating")));
				formats.put("Embed-Skin-Component-Tabcustom", new ArrayList(Arrays.asList("Sidebar modal tabs","Page level tabs")));
				...
				formats.put("Embed-Skin-Component-Repeatingcustom", new ArrayList(Arrays.asList("Fat list")));
				...
				formats.put("Embed-Skin-Component-Buttoncustom", new ArrayList(Arrays.asList("Light","Full width","Dashboard","Standard full width","Secondary","Icon","Large tile","System message","Header Icon","Icon overlays","Primary swipe action","Secondary swipe action","Tertiary swipe action")));
				formats.put("Embed-Skin-Component-ButtonnonLegacyFormats", new ArrayList(Arrays.asList("Standard","Simple","Strong","Light","Full width","Dashboard","Standard full width","Secondary","Icon","Large tile","System message","Header Icon","Icon overlays","Primary swipe action","Secondary swipe action","Tertiary swipe action")));
				formats.put("Embed-Skin-Component-Inputstandard", new ArrayList(Arrays.asList("Standard")));
				formats.put("Embed-Skin-Component-Inputcustom", new ArrayList(Arrays.asList("Workarea header titles","Work identifier","On time display text","Past goal display text","Supporting text","Grid display text","Primary search","Assignment title","Work grid item","Heading 2","Heading 3","Case ID","Case title","Workarea header ID","Case Description","Scorecard","Subtitle","Badge text","Page level","Data callout")));
				formats.put("Embed-Skin-Component-Linkstandard", new ArrayList(Arrays.asList("Standard","Simple","Strong")));
				formats.put("Embed-Skin-Component-Linkcustom", new ArrayList(Arrays.asList("Header nav","Horizontal menu items","List link","Work grid item","Case tools","workarea header highlight","Breadcrumbs")));
				...
				formats.put("Embed-Skin-Component-MenuBarcustom", new ArrayList(Arrays.asList("Header Menu","Primary navigation","Case actions","Icon toolbar","Alternate Navigation","Mobile menu","Mobile bottom navigation","Mobile Primary Navigation","Create case menu")));
				...
				formats.put("Embed-Skin-Component-ModalDialogcustom", new ArrayList(Arrays.asList("Fixed sized","Video","Large fixed","Fixed list","Full screen")));
				...
				formats.put("Embed-Skin-Component-CheckBoxcustom", new ArrayList(Arrays.asList("charts","lists","summaries","Radio")));
				formats.put("Embed-Skin-Component-RadioButtonstandard", new ArrayList(Arrays.asList("Standard","Segmented")));
				formats.put("Embed-Skin-Component-RadioButtonradio", new ArrayList(Arrays.asList("Standard")));
				...
				formats.put("Embed-Skin-Component-Overlaycustom", new ArrayList(Arrays.asList("Fixed size","List","Fluid","Mobile menu","Standard no padding")));
				formats.put("Embed-Skin-Component-SmartTipstandard", new ArrayList(Arrays.asList("Standard")));
				formats.put("Embed-Skin-Component-SmartTipcustom", new ArrayList(Arrays.asList("Tour stop")));
				formats.put("Embed-Skin-Component-Dropdownstandard", new ArrayList(Arrays.asList("Standard")));
				formats.put("Embed-Skin-Component-Dropdowncustom", new ArrayList(Arrays.asList("Transparent")));
				...
				formats.put("Embed-Skin-Component-SimpleLayoutcustom", new ArrayList(Arrays.asList("Inline middle","Portal header group primary","Stacked with labels left","Simple list","Inline labels left","split button","Mimic a sentence","Portal header group secondary","Action area","Simple list with labels left","Header details","Inline grid 30 70","Inline grid 70 30","Inline grid quadruple","Grid filter panel")));
				formats.put("Embed-Skin-Component-ColumnLayouttemplatetwo-col-sidebar-main",new ArrayList(Arrays.asList("Two Column (Sidebar - Main)","Profile display","Icon content")));
				formats.put("Embed-Skin-Component-ColumnLayouttemplatethree-col-sidebar-main-sidebar",new ArrayList(Arrays.asList("Three Column (Sidebar - Main - Sidebar)","Secondary content three col")));
				formats.put("Embed-Skin-Component-ColumnLayouttemplatetwo-col-main-sidebar",new ArrayList(Arrays.asList("Two Column (Main - Sidebar)","Secondary content two col")));
				...
				formats.put("Embed-Skin-Component-ColumnLayoutcustom", new ArrayList(Arrays.asList("Profile display","Secondary content three col","Secondary content two col","Icon content")));
				formats.put("Embed-Skin-Component-ScreenLayouttemplateHeader",new ArrayList(Arrays.asList("Header")));
				formats.put("Embed-Skin-Component-ScreenLayouttemplateHeader Footer",new ArrayList(Arrays.asList("Header Footer")));
				formats.put("Embed-Skin-Component-ScreenLayouttemplateHeader Footer Left Right",new ArrayList(Arrays.asList("Header Footer Left Right")));
				formats.put("Embed-Skin-Component-ScreenLayouttemplateFooter",new ArrayList(Arrays.asList("Footer")));
				formats.put("Embed-Skin-Component-ScreenLayouttemplateHeader Left",new ArrayList(Arrays.asList("Header Left")));
				formats.put("Embed-Skin-Component-ScreenLayoutstandard", new ArrayList(Arrays.asList("Header","Header Left","Header Footer","Header Footer Left Right","Footer")));
				formats.put("Embed-Skin-Component-LayoutGroupstandard", new ArrayList(Arrays.asList("Default","Accordion","Menu","Stacked","Tab")));
				formats.put("Embed-Skin-Component-LayoutGroupcustom", new ArrayList(Arrays.asList("Mobile tabs","Page level")));
			...
			protected ArrayList<HashMap<String,String>> getExpressThemes() {
				...
				expressThemes.add(new HashMap<String,String>(){{put("pyName","Page background");
					...
					expressThemes.add(new HashMap<String,String>(){{put("pyName","Header background");
						put("pyLabel","Header background");
						put("parentName","Colors");
						put("parentLabel","Colors");
						put("pxObjClass","Embed-Skin-Background");
						put("pyElementRef","1");
													...
													expressThemes.add(new HashMap<String,String>(){{put("pyName","Link");
														...
														expressThemes.add(new HashMap<String,String>(){{put("pyName","Base settings");
															...
															expressThemes.add(new HashMap<String,String>(){{put("pyName","General");
																...
																expressThemes.add(new HashMap<String,String>(){{put("pyName","Header Text");
																	put("pyLabel","Title");
																	put("parentName","TextFamily");
																	put("parentLabel","Text");
																	put("pxObjClass","Embed-Skin-Font");
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYENDUSER","Rule-PortalSkin","",false,"","Pega-EndUserUI","08-07-01","RULE-PORTALSKIN PYENDUSER #20210920T102235.745 GMT","PYENDUSER",true,false,"ABSOLUTE_CLASSLESS",1408983298)
	};
...
//	RULE-PORTALSKIN PYENDUSER #20210920T102235.745 GMT:20211007T164715.991 GMT
//	getParentSkinName(
...
//	RULE-UTILITY-FUNCTION PAGE PAGEEXISTSWITHCLASS #20180713T131441.343 GMT:20180713T131441.343 GMT
	...
	public static String getFUAContentHash() {
		return "428ecbd02a4cc2523662d4860ca5d30a";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-PORTALSKIN PYENDUSER #20210920T102235.745 GMT", "pyEndUser", "Pega-EndUserUI", "08-07-01", "20211007T164715.991 GMT");
}
