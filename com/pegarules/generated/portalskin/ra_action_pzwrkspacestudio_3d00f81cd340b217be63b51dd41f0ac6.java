...
import java.util.*;
public class ra_action_pzwrkspacestudio_3d00f81cd340b217be63b51dd41f0ac6  extends com.pega.pegarules.priv.runtime.AbstractSkin implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_PortalSkin.pzWrkSpaceStudio.Action");
	public ra_action_pzwrkspacestudio_3d00f81cd340b217be63b51dd41f0ac6(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
static final String skinName = "pzWrkSpaceStudio";
static final String skinLabel = "pzWrkSpaceStudio";
...
static {
	workStyleBases.put("appWorkStyle", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pzwrkspacestudio");
	workStyleBases.put("appWorkStyle_rtl", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pzwrkspacestudio_rtl_");
	workStyleBases.put("appWorkStyle_legacy", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pzwrkspacestudio_legacy_");
	workStyleBases.put("appWorkStyle_workform", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pzwrkspacestudio_workform_");
	workStyleBases.put("appWorkStyle_workform_legacy", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pzwrkspacestudio_workform_legacy_");
}
protected List<String> getAdditionalCSS() {
	 List<String> additionalCSS = new ArrayList<String>(4);
	additionalCSS.add("pz-wrkspace-studio-screenflow");
	additionalCSS.add("pz-deploymentmanager-studio");
...
{
/* Instance RULE-PORTALSKIN PZWRKSPACESTUDIO #20210610T062942.559 GMT	Pega-Desktop:08-07-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		oLog.debug("pzSkinMethodBody FUA execution for '" + "RULE-PORTALSKIN PZWRKSPACESTUDIO #20210610T062942.559 GMT" + "' - pyAction='" + action + "'");
		}
		...
		skinRefPage.putString("pzRefInsKey","RULE-PORTALSKIN PZWRKSPACESTUDIO #20210610T062942.559 GMT");
		...
		IsCSSAsJSON = true;
		workStyleBases.put("appWorkStyle_json", com.pega.pegarules.priv.web.StaticContentConstants.SKIN_GENERATED_CSS_STARTWITH+"pzwrkspacestudio_json_");
		}
		...
		protected String getThemeName(String themeFormat) {
			switch (themeFormat) {
				case "lineChartWithoutCircles":
					return "lineChartWithoutCircles";
				default:
					return null;
				}
			}
			...
			protected String getFileWithThemeJson(String themeFormat) {
				switch (themeFormat) {
					case "lineChartWithoutCircles":
						return "pyFusionchartsThemeDefaultOverridden.js";
					default:return null;}
			}
			protected List<String> getFormats(String key) {
				 Map<String, List<String>> formats = new HashMap<String, List<String>>(50);
				formats.put("Embed-Skin-Component-Themecustom", new ArrayList(Arrays.asList("Action Standard","Action border")));
				formats.put("Embed-Skin-Component-Labelscustom", new ArrayList(Arrays.asList("green background label","red background label","AdminStudioOverridden","dashboard count caution text","dashboard count font","dashboard count helper text","AdminStudioStandard label count")));
				formats.put("Embed-Skin-Component-LabelsdisabledInherited", new ArrayList(Arrays.asList("Uber readable","Standard italic","Rule keys","Popover title gray standard","Overriding","Overridden","Mobile Build Message","heading for fat list","explorer secondary","Explorer heading","Disabled","dark background label large","dark background label","Announcement","Alert")));
				formats.put("Embed-Skin-Component-Headerstandard", new ArrayList(Arrays.asList("Default")));
				formats.put("Embed-Skin-Component-Headercustom", new ArrayList(Arrays.asList("Explorer header","Fit2Content","Workarea header","AdminOuterContainer","DefaultWith05MargPadd","AdminStudioAlternate","AdminOuterContainerWithoutBackground","adminstudio notice")));
				formats.put("Embed-Skin-Component-HeaderdisabledInherited", new ArrayList(Arrays.asList("Action set","Action tile selected","Action tile unselected","Breadcrumb","Case designer process","Case details","Case secondary content","Column","Column divider left","Column divider right","Column emphasis","Combo group","Content emphasis","Content emphasis standard","Content emphasis table standard","Dashboard","Dashboard fat list item","Dashboard row label","Default with padding top","Dependency Warnings","Distinguished","Drop zone","Embedded explorer","Explorer list item","Fat list item","header mobile build","Information mobile","Modal group","Overrides border","Radio button left","Radio button right","Row divider","Selected list item","Simple combo group","Simple combo group child","Skin override","Skinrule warning","Square 160","System message","Tile","Vertical separator")));
				formats.put("Embed-Skin-Component-Repeatingcustom", new ArrayList(Arrays.asList("Adminstudiodefault")));
				formats.put("Embed-Skin-Component-RepeatingdisabledInherited", new ArrayList(Arrays.asList("Transparent Inactive Label","Standard tree","Search Grid","Feature Tree","Fat list","Explorer Tree","Explorer List","Default Multi Breakpoint","Column navigation","Column fat list")));
				formats.put("Embed-Skin-Component-Buttonstandard", new ArrayList(Arrays.asList("Simple","Standard","Strong")));
				formats.put("Embed-Skin-Component-Buttoncustom", new ArrayList(Arrays.asList("Icon light")));
				formats.put("Embed-Skin-Component-ButtondisabledInherited", new ArrayList(Arrays.asList("Banner","Bold","Channel tile","Demure","Dropdown","Error","Inline task","Secondary","Standard full width","Success","Split button")));
				formats.put("Embed-Skin-Component-ButtonnonLegacyFormats", new ArrayList(Arrays.asList("Simple","Standard","Strong","Icon light")));
				formats.put("Embed-Skin-Component-Inputstandard", new ArrayList(Arrays.asList("Standard")));
				formats.put("Embed-Skin-Component-Inputcustom", new ArrayList(Arrays.asList("Information 1","Information 2","Information 4","Information 3","Information 5","Primary heading")));
				formats.put("Embed-Skin-Component-InputdisabledInherited", new ArrayList(Arrays.asList("Warning small","Success small","Success","Strong","Secondary header","Scorecard","Primary search","Overflow text","Info small","Info heading","Icon font big","Icon font","Heading supporting","Explorer secondary","Explorer search","Explorer ruletype family","Explorer primary","Explorer heading","Explorer category","Disabled Link","Description secondary","Description primary","Deleted","Code","Bugs severity","Bold","Badge","Article heading","Always Active","Alert small","Alert")));
				formats.put("Embed-Skin-Component-Linkstandard", new ArrayList(Arrays.asList("Standard","Simple","Strong")));
				formats.put("Embed-Skin-Component-Linkcustom", new ArrayList(Arrays.asList("Adminstudiodefault")));
				formats.put("Embed-Skin-Component-LinkdisabledInherited", new ArrayList(Arrays.asList("workarea header secondary","Alert","Article heading","Disabled","Disabled list item","Explorer action","Explorer heading action","explorer primary","explorer secondary","Express mobile external","Footer nav","Help link","Horizontal menu items","list link","Project work alert","Recents rule type","Selected list item","Standard Ellipsis","Standard label link","Strong article heading","Success","workarea header highlight","workarea header primary")));
				formats.put("Embed-Skin-Component-MenuBarcustom", new ArrayList(Arrays.asList("Transparent")));
				formats.put("Embed-Skin-Component-OverlaydisabledInherited", new ArrayList(Arrays.asList("Template controls palette","No padding","Header nav","DT Exp Builder","Case designer")));
				formats.put("Embed-Skin-Component-DropdowndisabledInherited", new ArrayList(Arrays.asList("Status list")));
				formats.put("Embed-Skin-Component-SimpleLayoutcustom", new ArrayList(Arrays.asList("Inline right","inline grid 25 75","inline grid double dashboard","inline grid triple dashboard")));
				formats.put("Embed-Skin-Component-SimpleLayoutdisabledInherited", new ArrayList(Arrays.asList("Work area","Stacked title and description","Simple list margin","Simple Inline","QR code display","Inline top no spacing","Inline middle no spacing","Inline text","Inline list","Inline labels with space","Inline grid sextuple","Inline grid quadruple","Inline grid double no spacing","Inline grid double no spacing 2","Inline grid 30","Inline grid 20 80","Header menu secondary","Header menu primary","Footer menu","Bulleted list")));
				formats.put("Embed-Skin-Component-ColumnLayoutdisabledInherited", new ArrayList(Arrays.asList("System message","Skin styles menu","Skin styles and preview","Skin mixins","Secondary content three col","Ruleform header","Profile display","Mobile settings","Icon content","Icon and field","Guardrail warnings chart","Field and icon","Explorer","Checkbox Row","Action set columns")));
				formats.put("Embed-Skin-Component-ScreenLayouttemplateHeader Left",new ArrayList(Arrays.asList("Header Left")));
				formats.put("Embed-Skin-Component-ScreenLayoutstandard", new ArrayList(Arrays.asList("Header Left")));
				formats.put("Embed-Skin-Component-ScreenLayoutdisabledInherited", new ArrayList(Arrays.asList("Header","Header Right","Header Footer","Header Footer Left","Header Footer Right","Header Left Right","Header Footer Left Right","Left","Content Only","Footer")));
				formats.put("Embed-Skin-Component-LayoutGroupstandard", new ArrayList(Arrays.asList("Tab")));
				formats.put("Embed-Skin-Component-LayoutGroupcustom", new ArrayList(Arrays.asList("Rule tabs")));
				formats.put("Embed-Skin-Component-LayoutGroupdisabledInherited", new ArrayList(Arrays.asList("Split button tab left","Split button tab")));
				formats.put("Embed-Skin-Component-Chartcustom", new ArrayList(Arrays.asList("lineChartWithoutCircles")));
...
private static final String oDependencies [] = {
	...
	"Rule-PortalSkin:PZWRKSPACESTUDIO"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZWRKSPACESTUDIO","Rule-PortalSkin","",false,"","Pega-Desktop","08-07-01","RULE-PORTALSKIN PZWRKSPACESTUDIO #20210610T062942.559 GMT","PZWRKSPACESTUDIO",true,false,"ABSOLUTE_CLASSLESS",625380689)
	};
...
//	RULE-PORTALSKIN PZWRKSPACESTUDIO #20210610T062942.559 GMT:20210701T065537.258 GMT
//	getParentSkinName(
...
//	RULE-UTILITY-FUNCTION PAGE PAGEEXISTSWITHCLASS #20180713T131441.343 GMT:20180713T131441.343 GMT
	...
	public static String getFUAContentHash() {
		return "8b89dc00c148a7057fa3cc9e17acba60";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-PORTALSKIN PZWRKSPACESTUDIO #20210610T062942.559 GMT", "pzWrkSpaceStudio", "Pega-Desktop", "08-07-01", "20210701T065537.258 GMT");
}
