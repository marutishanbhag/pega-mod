...
public class ra_when_pegagadget_feed_pzispulsesearchresultsfound__79366591 extends AbstractWhen {
    ...
    private static final RuleTraceInfo ruleTracer = new RuleTraceInfo("RULE-OBJ-WHEN PEGAGADGET-FEED PZISPULSESEARCHRESULTSFOUND #20200506T075455.836 GMT", "PegaGadget-Feed pzIsPulseSearchResultsFound", "Pega-Social", "08-05-01", "20200506T075455.836 GMT");

    public ra_when_pegagadget_feed_pzispulsesearchresultsfound__79366591(final Loadtime loadtime) {
        super(ruleTracer);
