...
public class ra_when_data_mo_pzischangestageapi__1575690907 extends AbstractWhen {

    private final ScalarValueQuery scalarValueQuery_1;

    private final RuleHandle rule0;

    private static final RuleTraceInfo ruleTracer = new RuleTraceInfo("RULE-OBJ-WHEN DATA-MO PZISCHANGESTAGEAPI #20180713T141307.522 GMT", "Data-MO pzIsChangeStageAPI", "Pega-ProcessArchitect", "08-01-01", "20180713T141307.522 GMT");

    public ra_when_data_mo_pzischangestageapi__1575690907(final Loadtime loadtime) {
        super(ruleTracer);
        final RuleHandleFactory ruleHandleFactory = loadtime.get(RuleHandleFactory.class);
        rule0 = ruleHandleFactory.create("Rule-Obj-When", "!PZISAPI", "pzIsAPI");
