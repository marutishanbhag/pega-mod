...
public class ra_when_rule_obj_flow_pzshowquestionshape__1849577795 extends AbstractWhen {

    private final RuleHandle rule1;

    private final RuleHandle rule0;

    private static final RuleTraceInfo ruleTracer = new RuleTraceInfo("RULE-OBJ-WHEN RULE-OBJ-FLOW PZSHOWQUESTIONSHAPE #20210818T110635.188 GMT", "Rule-Obj-Flow pzShowQuestionShape", "Pega-Survey", "08-07-01", "20210818T110635.188 GMT");

    public ra_when_rule_obj_flow_pzshowquestionshape__1849577795(final Loadtime loadtime) {
        super(ruleTracer);
