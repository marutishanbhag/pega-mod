...
public class ra_when_pegaaccel_task_buildapplication_pzcancreatenewapplication_933158714 extends AbstractWhen {

    private static final RuleTraceInfo ruleTracer = new RuleTraceInfo("RULE-OBJ-WHEN PEGAACCEL-TASK-BUILDAPPLICATION PZCANCREATENEWAPPLICATION #20210910T145256.834 GMT", "PegaAccel-Task-BuildApplication pzCanCreateNewApplication", "Pega-ProcessArchitect", "08-07-01", "20210910T145256.834 GMT");

    public ra_when_pegaaccel_task_buildapplication_pzcancreatenewapplication_933158714(final Loadtime loadtime) {
        super(ruleTracer);
    }
