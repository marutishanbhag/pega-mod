...
import java.util.*;
public class ra_action_pydefault_f6eea8dfeb1f02ad8bd187035e508859  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_CaseType.pyDefault.OOD4NM_Loan_Work_Loan.Action");
	public ra_action_pydefault_f6eea8dfeb1f02ad8bd187035e508859(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-CASETYPE OOD4NM-LOAN-WORK-LOAN PYDEFAULT #20260221T064320.702 GMT	Loan:01-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Loan";
		mCaseTypeHandle = "RULE-OBJ-CASETYPE OOD4NM-LOAN-WORK-LOAN PYDEFAULT #20260221T064320.702 GMT";
...
return;}
		...
		else if (purpose.equals("GETAPPCONCLUSIONDATA"))		{			casePage = tools.createPage("OOD4NM-Loan-Work-Loan", "pyTempCallCasePage");
			startFlowKeys.putString("pxObjClass", "Rule-Obj-CaseType");
			startFlowKeys.putString("pyPurpose", "pyDefault");
			startFlowKeys.putString("pyClassName","OOD4NM-Loan-Work-Loan");
		...
		else if (purpose.equals("GETSTARTINGFLOWS"))		{				tools.putParamValue("CaseLabel","Loan");
				fetchCaseCreationInfo();
		}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDEFAULT","Rule-Obj-CaseType","OOD4NM-LOAN-WORK-LOAN",false,"","Loan","01-01-01","RULE-OBJ-CASETYPE OOD4NM-LOAN-WORK-LOAN PYDEFAULT #20260221T064320.702 GMT","!PYDEFAULT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",160867292)
	};
...
//	RULE-OBJ-CASETYPE OOD4NM-LOAN-WORK-LOAN PYDEFAULT #20260221T064320.702 GMT:20260221T064835.838 GMT
...
//	RULE-UTILITY-FUNCTION WORKUTILITIES PZPAGENAMECLEAN #20180713T133140.771 GMT:20180713T133140.771 GMT
	...
	public static String getFUAContentHash() {
		return "5d936ade2e7c1bf84ba1e53e766e3efc";
	}
...
return "Action";
	...
	private void PRIM0_getStageProcessList_circum0() {
		...
		pgStageProcess.putString("pyLabel", "GetUserDetails");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-CASETYPE OOD4NM-LOAN-WORK-LOAN PYDEFAULT #20260221T064320.702 GMT", "OOD4NM-Loan-Work-Loan pyDefault", "Loan", "01-01-01", "20260221T064835.838 GMT");
}
