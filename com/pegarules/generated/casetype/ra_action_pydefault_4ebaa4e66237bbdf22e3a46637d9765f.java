...
import java.util.*;
public class ra_action_pydefault_4ebaa4e66237bbdf22e3a46637d9765f  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_CaseType.pyDefault.OLFHF9_Onboaring_Work_Onboarding.Action");
	public ra_action_pydefault_4ebaa4e66237bbdf22e3a46637d9765f(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-CASETYPE OLFHF9-ONBOARING-WORK-ONBOARDING PYDEFAULT #20260223T091515.258 GMT	Onboaring:01-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Onboaring";
		mCaseTypeHandle = "RULE-OBJ-CASETYPE OLFHF9-ONBOARING-WORK-ONBOARDING PYDEFAULT #20260223T091515.258 GMT";
...
return;}
		...
		else if (purpose.equals("GETAPPCONCLUSIONDATA"))		{			casePage = tools.createPage("OLFHF9-Onboaring-Work-Onboarding", "pyTempCallCasePage");
			startFlowKeys.putString("pxObjClass", "Rule-Obj-CaseType");
			startFlowKeys.putString("pyPurpose", "pyDefault");
			startFlowKeys.putString("pyClassName","OLFHF9-Onboaring-Work-Onboarding");
		...
		{
			 tools.putParamValue("LocaleReference","OLFHF9-ONBOARING-WORK-ONBOARDING!CASE!ONBOARDING");
		}
		...
		String type = tools.getParamValue("type");
			...
			if(type.equalsIgnoreCase("FLOW") && currentStageId.equalsIgnoreCase("PRIM1") && currentStageFlowID.equalsIgnoreCase("FLOW0")){
				tools.putParamValue("ShowBackButton","false");
				return;
			}
			if(type.equalsIgnoreCase("FLOW") && currentStageId.equalsIgnoreCase("PRIM2") && currentStageFlowID.equalsIgnoreCase("FLOW0")){
				tools.putParamValue("ShowBackButton","false");
				return;
			}
		}
...
LogTraceMessage("Child class: " + sWorkClass);
		...
		{ClipboardPage pgPersonaToAdd = null;
		pgPersonaToAdd = tools.createPage("Embed-CasePersona","");
		pgPersonaToAdd.putString(".pyCaseType", "OLFHF9-ONBOARING-WORK-ONBOARDING!PYDEFAULT");
		pgPersonaToAdd.putString(".pyStageID", "PRIM0");
		pgPersonaToAdd.putString(".pyPersona", "Users");
		pgPersonaToAdd.putString(".pyChannelID", "WebPortal");
		pgPersonaToAdd.putString(".pyRelease", "");
		pgPersonaToAdd.putString(".pyNote","" );
		pgPersonaToAdd.putString(".pyIsDone", "");
		pgPersonaToAdd.putString(".pyInventoryComplexity", "Medium");
		pxResults.add(pgPersonaToAdd);
}		{ClipboardPage pgPersonaToAdd = null;
		pgPersonaToAdd = tools.createPage("Embed-CasePersona","");
		pgPersonaToAdd.putString(".pyCaseType", "OLFHF9-ONBOARING-WORK-ONBOARDING!PYDEFAULT");
		pgPersonaToAdd.putString(".pyStageID", "PRIM1");
		pgPersonaToAdd.putString(".pyPersona", "Users");
		pgPersonaToAdd.putString(".pyChannelID", "WebPortal");
		pgPersonaToAdd.putString(".pyRelease", "");
		pgPersonaToAdd.putString(".pyNote","" );
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDEFAULT","Rule-Obj-CaseType","OLFHF9-ONBOARING-WORK-ONBOARDING",false,"","Onboaring","01-01-01","RULE-OBJ-CASETYPE OLFHF9-ONBOARING-WORK-ONBOARDING PYDEFAULT #20260223T091515.258 GMT","!PYDEFAULT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-371750469)
	};
...
//	RULE-OBJ-CASETYPE OLFHF9-ONBOARING-WORK-ONBOARDING PYDEFAULT #20260223T091515.258 GMT:20260223T092622.905 GMT
...
//	RULE-UTILITY-FUNCTION WORKUTILITIES PZPAGENAMECLEAN #20180713T133140.771 GMT:20180713T133140.771 GMT
	...
	public static String getFUAContentHash() {
		return "33b11c765358570b7cd6c77e07ba5723";
	}
...
return "Action";
	...
	private void getStages_circum0(){
		...
		pgStageToAdd.putString(".pyStageName", "Stage 1");
		pgStageToAdd.putString(".pyStageTransition", "automatic");
		pgStageToAdd.putString(".pyStageWorkStatus", "");
		pgStageToAdd.putString(".pyCleanupProcess", "");
		pgStageToAdd.putString(".pyResolveChildCases", "");
		...
		pxResults.add(pgStageToAdd);
		pgStageToAdd = tools.createPage("Embed-Stage","");
		pgStageToAdd.putString(".pyStageID", "PRIM2");
		pgStageToAdd.putString(".pyStageName", "Resolution");
		pgStageToAdd.putString(".pyStageTransition", "automatic");
		pgStageToAdd.putString(".pyStageWorkStatus", "");
		pgStageToAdd.putString(".pyCleanupProcess", "");
		pgStageToAdd.putString(".pyResolveChildCases", "");
	...
	private void getNextStage_circum0(){
		...
		if (!currentStage.equals("")) {
			if(currentStage.equals("PRIM0")) {
				...
				tools.putParamValue("NextStage","PRIM2");
				foundNext = true;
			}
		}
		if (!foundNext) {
	...
	private void getStageName_circum0(){
		...
		if (!currentStageID.equals("")) {
			if(currentStageID.equals("PRIM0")) {
				...
				tools.putParamValue("StageName","Stage 1");
				foundNext = true;
			}
			else if(currentStageID.equals("PRIM2")) {
				tools.putParamValue("StageName","Resolution");
				foundNext = true;
			}
		}
		if (!foundNext) {
	...
	private void getStageID_circum0(){
		...
		if (!currentStageName.equals("")) {
			...
			else if(currentStageName.equals("Stage 1")) {
				tools.putParamValue("StageID","PRIM1");
				foundNext = true;
			}
			else if(currentStageName.equals("Resolution")) {
				tools.putParamValue("StageID","PRIM2");
				foundNext = true;
			}
		}
		if (!foundNext) {
	...
	private void PRIM1_getStageProcessList_circum0() {
		...
		ClipboardPage pgStageProcess;
		pgStageProcess = tools.createPage("Embed-StageProcess", "");
		pgStageProcess.putString("pyFlowName", "Stage1_Flow");
		pgStageProcess.putString("pxFlowID", "FLOW0");
		pgStageProcess.putString("pyStartWhen", "");
		pgStageProcess.putString("pyLabel", "Stage 1");
		pgStageProcess.putString("pyStartType", "PARALLEL");
	...
	private void PRIM2_getStageProcessList_circum0() {
		String pageName = tools.getParamValue("pyProcessPageName");
		ClipboardPage pyProcessPage = tools.createPage("Code-Pega-List", pageName);
		pyProcessPage.putString("pyObjClass", "Rule-Obj-Flow");
		ClipboardProperty pxResults = pyProcessPage.getProperty(".pxResults");
		ClipboardPage pgStageProcess;
		pgStageProcess = tools.createPage("Embed-StageProcess", "");
		pgStageProcess.putString("pyFlowName", "Resolution_Flow");
		pgStageProcess.putString("pxFlowID", "FLOW0");
		pgStageProcess.putString("pyStartWhen", "");
		pgStageProcess.putString("pyLabel", "Resolution");
		pgStageProcess.putString("pyStartType", "PARALLEL");
		pgStageProcess.putString("pyLaunchOnReentry", "true");
		pgStageProcess.putString("pyStepSLA", "");
		pxResults.add(pgStageProcess);
	...
	private boolean getStageProcessList_circum0(){
		...
		if (!currentStage.equals("")) {
			...
			else if(currentStage.equals("PRIM2")) {
			PRIM2_getStageProcessList_circum0();
			stageFound = true;
			}
		}
		return stageFound;
	...
	private void startStageProcesses_circum0(){
		...
		if ("PRIM0".equals(currentStageID)) {
			tools.putParamValue("AutomaticTransition", PropertyInfo.TYPE_TRUEFALSE, true);
			PRIM0_start_circum0();
		} else if ("PRIM1".equals(currentStageID)) {
			tools.putParamValue("AutomaticTransition", PropertyInfo.TYPE_TRUEFALSE, true);
			PRIM1_start_circum0();
		} else if ("PRIM2".equals(currentStageID)) {
...
// Expression: 
	...
	private void PRIM1_start_circum0() {
		...
		tools.getPrimaryPage().getProperty("pzStageStartInProgress").setValue(false);
		if (!pega_processengine_workutilities.pzCheckForAndDoAutomaticStageTransition(tools.getPrimaryPage())) {
		if ("PRIM1".equals(tools.getPrimaryPage().getString("pxCurrentStage"))) {
			pega_procom_flow.RemoveFlow(tools.getPrimaryPage(), "pzInternalStageFlow", tools);
// Expression: 
		}
			pega_rules_utilities.callActivity(tools.getPrimaryPage(), "RecalculateAndSave", tools.getParameterPage());
	...
	private void PRIM2_start_circum0() {
		tools.getPrimaryPage().getProperty("pzStageStartInProgress").setValue(true);
		ParameterPage params = new ParameterPage();
		params.putParamValue("StatusWork", PropertyInfo.TYPE_TEXT, "Resolved-Completed" );
		pega_rules_utilities.callActivity(tools.getPrimaryPage(), "UpdateStatus", params);
		PRIM2_FLOW0_start_circum0();
		tools.getPrimaryPage().getProperty("pzStageStartInProgress").setValue(false);
		if (!pega_processengine_workutilities.pzCheckForAndDoAutomaticStageTransition(tools.getPrimaryPage())) {
		if ("PRIM2".equals(tools.getPrimaryPage().getString("pxCurrentStage"))) {
			pega_procom_flow.RemoveFlow(tools.getPrimaryPage(), "pzInternalStageFlow", tools);
// Expression: 
		}
			pega_rules_utilities.callActivity(tools.getPrimaryPage(), "RecalculateAndSave", tools.getParameterPage());
...
// Expression: 
			//set parameters
			pega_processengine_workutilities.pzStartStageFlow(tools.getPrimaryPage(), "Stage1_Flow", "FLOW0", "", "");
	}
	...
	private void PRIM2_FLOW0_start_circum0() {
	ClipboardPage myStepPage = tools.getPrimaryPage();
// Expression: 
// Expression: 
			//set parameters
			pega_processengine_workutilities.pzStartStageFlow(tools.getPrimaryPage(), "Resolution_Flow", "FLOW0", "", "");
	}
	
	private void PRIM2_FLOW0_end_circum0() {
		pega_processengine_workutilities.pzCheckForAndDoAutomaticStageTransition(tools.getPrimaryPage());
	}
	...
	private void onProcessEnd_circum0() {
		...
		} else if ("PRIM2".equals(stageID)) {
			tools.putParamValue("AutomaticTransition", PropertyInfo.TYPE_TRUEFALSE, false);
			PRIM2_processEnd_circum0();
		} else {
...
;			tools.putParamValue("ErrorMessage", "FlowProblemMissingStageFlow\t" + tools.getParamValue("CurrentProcess"));
	...
	private void PRIM2_processEnd_circum0() {
		String endingFlowID = tools.getParamValue("StageFlowID");
		if ("FLOW0".equals(endingFlowID)) {
			PRIM2_FLOW0_end_circum0();
		} else if ("true".equals(tools.getParamValue("ProcessIsOptional"))) {
			pega_processengine_workutilities.pzCheckForAndDoAutomaticStageTransition(tools.getPrimaryPage());
		} else {
			pega_rules_utilities.callActivity(tools.getPrimaryPage(), "getFlowProblemOperator", tools.getParameterPage())
;			tools.putParamValue("ErrorMessage", "FlowProblemMissingStageFlow\t" + tools.getParamValue("CurrentProcess"));
	...
	private void PRIM2_end_circum0() {
			tools.putParamValue("AutomaticTransition", PropertyInfo.TYPE_TRUEFALSE, false);
		ParameterPage paramsPage = new ParameterPage();
	...
	private void PRIM2_getOptionalProcessList_circum0() {
	}
	...
	private void getOptionalProcessList_circum0(){
		...
		if (!currentStage.equals("")) {
			...
			PRIM2_getOptionalProcessList_circum0();
			}
		}
	}
	...
	private void PRIM2_validate_circum0() {
	}
	...
	if (!nextStage.equals("")) {
		...
		else if(nextStage.equals("PRIM1")) {
		}
	...
	private void PRIM2_getActionsList_circum0() {
	ClipboardPage myStepPage = tools.getPrimaryPage();
	String pageName = "pyActionsList";
	ClipboardPage actionsPage = tools.createPage("Code-Pega-List", pageName);
	ClipboardProperty pxResults = actionsPage.getProperty("pxResults");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-CASETYPE OLFHF9-ONBOARING-WORK-ONBOARDING PYDEFAULT #20260223T091515.258 GMT", "OLFHF9-Onboaring-Work-Onboarding pyDefault", "Onboaring", "01-01-01", "20260223T092622.905 GMT");
}
