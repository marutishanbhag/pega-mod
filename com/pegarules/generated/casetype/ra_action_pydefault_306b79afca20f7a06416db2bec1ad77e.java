...
import java.util.*;
public class ra_action_pydefault_306b79afca20f7a06416db2bec1ad77e  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_CaseType.pyDefault.OLFHF9_Onboaring_Work_OnboaringProcess.Action");
	public ra_action_pydefault_306b79afca20f7a06416db2bec1ad77e(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-CASETYPE OLFHF9-ONBOARING-WORK-ONBOARINGPROCESS PYDEFAULT #20260223T094042.480 GMT	OnboaringProcess:01-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "OnboaringProcess";
		mCaseTypeHandle = "RULE-OBJ-CASETYPE OLFHF9-ONBOARING-WORK-ONBOARINGPROCESS PYDEFAULT #20260223T094042.480 GMT";
...
return;}
		...
		else if (purpose.equals("GETAPPCONCLUSIONDATA"))		{			casePage = tools.createPage("OLFHF9-Onboaring-Work-OnboaringProcess", "pyTempCallCasePage");
			startFlowKeys.putString("pxObjClass", "Rule-Obj-CaseType");
			startFlowKeys.putString("pyPurpose", "pyDefault");
			startFlowKeys.putString("pyClassName","OLFHF9-Onboaring-Work-OnboaringProcess");
		...
		else if (purpose.equals("GETSTARTINGFLOWS"))		{				tools.putParamValue("CaseLabel","OnboaringProcess");
				fetchCaseCreationInfo();
		}
		...
		{
			 tools.putParamValue("LocaleReference","OLFHF9-ONBOARING-WORK-ONBOARINGPROCESS!CASE!ONBOARINGPROCESS");
		}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDEFAULT","Rule-Obj-CaseType","OLFHF9-ONBOARING-WORK-ONBOARINGPROCESS",false,"","OnboaringProcess","01-01-01","RULE-OBJ-CASETYPE OLFHF9-ONBOARING-WORK-ONBOARINGPROCESS PYDEFAULT #20260223T094042.480 GMT","!PYDEFAULT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1247314935)
	};
...
//	RULE-OBJ-CASETYPE OLFHF9-ONBOARING-WORK-ONBOARINGPROCESS PYDEFAULT #20260223T094042.480 GMT:20260223T094043.377 GMT
...
//	RULE-UTILITY-FUNCTION WORKUTILITIES PZPAGENAMECLEAN #20180713T133140.771 GMT:20180713T133140.771 GMT
	...
	public static String getFUAContentHash() {
		return "ab08030269f4847da8581e7dba15c296";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-CASETYPE OLFHF9-ONBOARING-WORK-ONBOARINGPROCESS PYDEFAULT #20260223T094042.480 GMT", "OLFHF9-Onboaring-Work-OnboaringProcess pyDefault", "OnboaringProcess", "01-01-01", "20260223T094043.377 GMT");
}
