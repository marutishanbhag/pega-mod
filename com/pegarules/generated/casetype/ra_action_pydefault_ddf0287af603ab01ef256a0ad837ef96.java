...
import java.util.*;
public class ra_action_pydefault_ddf0287af603ab01ef256a0ad837ef96  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_CaseType.pyDefault.LTM_Enrollment_Work_Enrollment.Action");
	public ra_action_pydefault_ddf0287af603ab01ef256a0ad837ef96(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-CASETYPE LTM-ENROLLMENT-WORK-ENROLLMENT PYDEFAULT #20260221T185851.497 GMT	Enrollment:01-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Enrollment";
		mCaseTypeHandle = "RULE-OBJ-CASETYPE LTM-ENROLLMENT-WORK-ENROLLMENT PYDEFAULT #20260221T185851.497 GMT";
...
return;}
		...
		else if (purpose.equals("GETAPPCONCLUSIONDATA"))		{			casePage = tools.createPage("LTM-Enrollment-Work-Enrollment", "pyTempCallCasePage");
			startFlowKeys.putString("pxObjClass", "Rule-Obj-CaseType");
			startFlowKeys.putString("pyPurpose", "pyDefault");
			startFlowKeys.putString("pyClassName","LTM-Enrollment-Work-Enrollment");
		...
		else if (purpose.equals("GETSTARTINGFLOWS"))		{				tools.putParamValue("CaseLabel","Enrollment");
				fetchCaseCreationInfo();
		}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDEFAULT","Rule-Obj-CaseType","LTM-ENROLLMENT-WORK-ENROLLMENT",false,"","Enrollment","01-01-01","RULE-OBJ-CASETYPE LTM-ENROLLMENT-WORK-ENROLLMENT PYDEFAULT #20260221T185851.497 GMT","!PYDEFAULT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-608245911)
	};
...
//	RULE-OBJ-CASETYPE LTM-ENROLLMENT-WORK-ENROLLMENT PYDEFAULT #20260221T185851.497 GMT:20260221T185852.114 GMT
...
//	RULE-UTILITY-FUNCTION WORKUTILITIES PZPAGENAMECLEAN #20180713T133140.771 GMT:20180713T133140.771 GMT
	...
	public static String getFUAContentHash() {
		return "4d2aa0b1a505957478a82dbdf6589a84";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-CASETYPE LTM-ENROLLMENT-WORK-ENROLLMENT PYDEFAULT #20260221T185851.497 GMT", "LTM-Enrollment-Work-Enrollment pyDefault", "Enrollment", "01-01-01", "20260221T185852.114 GMT");
}
