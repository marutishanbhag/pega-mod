...
import java.util.*;
public class ra_action_pydefault_f949534796442a80e0c165aa4e6936fe  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_CaseType.pyDefault.OFON2J_ProcessO_Work_Onboarding.Action");
	public ra_action_pydefault_f949534796442a80e0c165aa4e6936fe(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDEFAULT","Rule-Obj-CaseType","OFON2J-PROCESSO-WORK-ONBOARDING",false,"","ProcessO","01-01-01","RULE-OBJ-CASETYPE OFON2J-PROCESSO-WORK-ONBOARDING PYDEFAULT #20260223T094402.277 GMT","!PYDEFAULT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",2066960475)
	};
...
//	RULE-OBJ-CASETYPE OFON2J-PROCESSO-WORK-ONBOARDING PYDEFAULT #20260223T094402.277 GMT:20260223T095005.556 GMT
...
//	RULE-UTILITY-FUNCTION WORKUTILITIES PZPAGENAMECLEAN #20180713T133140.771 GMT:20180713T133140.771 GMT
	...
	public static String getFUAContentHash() {
		return "3226092c3edc4bdb443f112cb608e95e";
	}
...
return "Action";
	...
	private void getStages_circum0(){
		...
		pgStageToAdd.putString(".pyStageName", "Collect Information");
		pgStageToAdd.putString(".pyStageTransition", "automatic");
		pgStageToAdd.putString(".pyStageWorkStatus", "");
		pgStageToAdd.putString(".pyCleanupProcess", "");
		pgStageToAdd.putString(".pyResolveChildCases", "");
	...
	private void getStageName_circum0(){
		...
		if (!currentStageID.equals("")) {
			if(currentStageID.equals("PRIM0")) {
				...
				tools.putParamValue("StageName","Collect Information");
				foundNext = true;
			}
	...
	private void getStageID_circum0(){
		...
		if (!currentStageName.equals("")) {
			...
			else if(currentStageName.equals("Collect Information")) {
	...
	private void PRIM1_getStageProcessList_circum0() {
		...
		ClipboardPage pgStageProcess;
		pgStageProcess = tools.createPage("Embed-StageProcess", "");
		pgStageProcess.putString("pyFlowName", "CollectInformation_Flow");
		pgStageProcess.putString("pxFlowID", "FLOW0");
		pgStageProcess.putString("pyStartWhen", "");
		pgStageProcess.putString("pyLabel", "Collect Information");
		pgStageProcess.putString("pyStartType", "PARALLEL");
...
// Expression: 
	...
	private void PRIM1_start_circum0() {
		...
		params.putParamValue("StatusWork", PropertyInfo.TYPE_TEXT, "New" );
...
// Expression: 
			//set parameters
			pega_processengine_workutilities.pzStartStageFlow(tools.getPrimaryPage(), "CollectInformation_Flow", "FLOW0", "", "");
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-CASETYPE OFON2J-PROCESSO-WORK-ONBOARDING PYDEFAULT #20260223T094402.277 GMT", "OFON2J-ProcessO-Work-Onboarding pyDefault", "ProcessO", "01-01-01", "20260223T095005.556 GMT");
}
