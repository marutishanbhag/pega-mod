 ...
 */
public class ra_stream_collectinformation_729904a4e4c66fe994551f1e5d216a70 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.CollectInformation.OFON2J_ProcessO_Work_Onboarding.Stream");
 ...
 */
	public ra_stream_collectinformation_729904a4e4c66fe994551f1e5d216a70(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "721cfca9b228bffd36cdd6b3c6bbf6a6a76bba9c";
...
{
/* Instance RULE-OBJ-FLOWACTION OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION #20260223T094638.614 GMT	ProcessO:01-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
/*
 * Begin RULE-OBJ-FLOWACTION OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION #20260223T094638.614 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-OBJ-FLOWACTION OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION #20260223T094638.614 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-OBJ-FLOWACTION OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION #20260223T094638.614 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:COLLECTINFORMATION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("COLLECTINFORMATION","Rule-Obj-FlowAction","OFON2J-PROCESSO-WORK-ONBOARDING",false,"","ProcessO","01-01-01","RULE-OBJ-FLOWACTION OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION #20260223T094638.614 GMT","!COLLECTINFORMATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1688264383)
	};
...
//	RULE-OBJ-FLOWACTION OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION #20260223T094638.614 GMT:20260223T094651.528 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "b20e4a4418a47f0137f8e1c6dd9aa1f1";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_1","CollectInformation", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "CollectInformation";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
tools.putParamValue("flowActionUIRef","CollectInformation"); 
tools.appendString(" ");
...
out.print( pzAuto.getInpectorData("FlowAction", "", "","CollectInformation","Rule-Obj-FlowAction","OFON2J-ProcessO-Work-Onboarding") );
tools.appendString(" >");
 } 
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
pzPackageRuntime.packageSection("CollectInformation",tools.getStepPage().getReference(), null);
tools.appendString("<div id='section-placeholder' data-class='");
out.print(tools.getStepPage().getString("pxObjClass"));
tools.appendString("' data-section='CollectInformation'></div> ");
} else {
includeSectionBody_1();
}
tools.appendString("<span style=\"display: none;\" uitype=\"Rule-HTML-Section\" id=\"pzFlowActionUITypeRef\" uiref=\"CollectInformation\"></span> ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-OBJ-FLOWACTION OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION #20260223T094638.614 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION #20260223T094638.614 GMT", "OFON2J-ProcessO-Work-Onboarding CollectInformation", "ProcessO", "01-01-01", "20260223T094651.528 GMT");
}
