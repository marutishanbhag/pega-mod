...
import java.util.*;
public class ra_action_pzpropertypanelmodal_53b4d429d3ec2d532e3f76e9162603b1  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzPropertyPanelModal.Data_MO_Connector_Transition.Action");
	public ra_action_pzpropertypanelmodal_53b4d429d3ec2d532e3f76e9162603b1(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION DATA-MO-CONNECTOR-TRANSITION PZPROPERTYPANELMODAL #20180713T141209.950 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-MO-CONNECTOR-TRANSITION PZPROPERTYPANELMODAL #20180713T141209.950 GMT";
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "0a3c1c282eaee62929b2eeaa9502b1b7";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-MO-Connector-Transition";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-MO-CONNECTOR-TRANSITION!PZPROPERTYPANELMODAL",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzSetupTransition";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzRemoveTempFlowModel";
			if (actType.equals("POSTCONNECTOR"))
			{
