...
/**
 * Builds JSP stream WORK-!PYRESOLVEANDCLOSECASE.
 */
public class ra_stream_pyresolveandclosecase_327ec8866ac61acda54ae12c55dcf041 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pyResolveAndCloseCase.OFON2J_ProcessO_Work_Onboarding.Stream");
 ...
 */
	public ra_stream_pyresolveandclosecase_327ec8866ac61acda54ae12c55dcf041(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "2cca39f0eb872000fbf85b4fa7b1a0a70127a2ca";
...
/*
 * Begin RULE-OBJ-FLOWACTION WORK- PYRESOLVEANDCLOSECASE #20200318T183139.712 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-OBJ-FLOWACTION WORK- PYRESOLVEANDCLOSECASE #20200318T183139.712 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-OBJ-FLOWACTION WORK- PYRESOLVEANDCLOSECASE #20200318T183139.712 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "f573aec744b066b973491bbaf190f836";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_1","pySetStatusResolved", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pySetStatusResolved";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
tools.putParamValue("flowActionUIRef","pySetStatusResolved"); 
tools.appendString(" ");
...
out.print( pzAuto.getInpectorData("FlowAction", "", "","pyResolveAndCloseCase","Rule-Obj-FlowAction","Work-") );
tools.appendString(" >");
 } 
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
pzPackageRuntime.packageSection("pySetStatusResolved",tools.getStepPage().getReference(), null);
tools.appendString("<div id='section-placeholder' data-class='");
out.print(tools.getStepPage().getString("pxObjClass"));
tools.appendString("' data-section='pySetStatusResolved'></div> ");
} else {
includeSectionBody_1();
}
tools.appendString("<span style=\"display: none;\" uitype=\"Rule-HTML-Section\" id=\"pzFlowActionUITypeRef\" uiref=\"pySetStatusResolved\"></span> ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-OBJ-FLOWACTION WORK- PYRESOLVEANDCLOSECASE #20200318T183139.712 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyResolveAndCloseCase");
