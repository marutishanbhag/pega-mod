...
import java.util.*;
public class ra_action_pyreopen_5868f284c5af18bb9e01027ed543f000  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pyReopen.Work_.Action");
	public ra_action_pyreopen_5868f284c5af18bb9e01027ed543f000(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION WORK- PYREOPEN #20211123T095230.485 GMT	Pega-EndUserUI:08-08-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-EndUserUI";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION WORK- PYREOPEN #20211123T095230.485 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Reopen");
		}
		...
		else if (purpose.equals("VALIDATE"))
		{
			...
			tools.putParamValue("keepWorkingOnSameFlow", "true");
			tools.putParamValue("keepWorkingOnSameCover", "true");
		...
		{
			tools.putParamValue("pzFALabel", "Reopen");
		}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYREOPEN","Rule-Obj-FlowAction","WORK-",false,"","Pega-EndUserUI","08-08-01","RULE-OBJ-FLOWACTION WORK- PYREOPEN #20211123T095230.485 GMT","!PYREOPEN",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1986898435)
	};
...
//	RULE-OBJ-FLOWACTION WORK- PYREOPEN #20211123T095230.485 GMT:20211123T095230.485 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "a4e10cc4d5d74bc9b8a221de14ce8534";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Work-";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:WORK-!PYREOPEN",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		// When populating the bulk action dropdown, we don't run the whens
		tools.putParamValue("bUsesWhenSecurity", "true");
		if (tools.getParamValue("PopulateForBulk").equals("true"))
			return true;
		
		// Now perform when checks
		StringMap params = new HashStringMap();
		params.putString("pxObjClass", "Rule-Obj-When");
		params.putString("pyClassName", interestPage.getClassName());
		params.putString("pyBlockName", "Resolved");
		try {
			if (!tools.evaluateWhen(params))
				return false;
		} catch (IndeterminateConditionalException ide) {
			interestPage.addMessage(ide.getMessage());
			return false;
		}
	...
	private boolean AddFlowAction_circum0(String strActionType, ClipboardPage newAssignPage, boolean isSelectedAction, boolean displaySeparatorAbove)
	{
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Reopen");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Reopen");
		...
		AssignActionPage.putString(".pySectionReference", "pyReopen");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION WORK- PYREOPEN #20211123T095230.485 GMT", "Work- pyReopen", "Pega-EndUserUI", "08-08-01", "20211123T095230.485 GMT");
}
