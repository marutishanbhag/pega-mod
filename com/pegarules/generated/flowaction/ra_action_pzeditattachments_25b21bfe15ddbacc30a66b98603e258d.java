...
import java.util.*;
public class ra_action_pzeditattachments_25b21bfe15ddbacc30a66b98603e258d  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzEditAttachments.Rule_.Action");
	public ra_action_pzeditattachments_25b21bfe15ddbacc30a66b98603e258d(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE- PZEDITATTACHMENTS #20180713T141220.253 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE- PZEDITATTACHMENTS #20180713T141220.253 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Attachments");
		}
		...
		else if (purpose.equals("VALIDATE"))
		{
			...
			if (newAssignPage == null || (newAssignPage != null && !pega_procom_pegaprocomutilities.determineDeferErrors(newAssignPage, workPage)))
			{
				...
				if (!workPageName.equals("TempPrimaryPage"))
				{
					otherPageInTransaction = tools.findPage("TempPrimaryPage");
			...
			if (!workPageName.equals("TempPrimaryPage"))
			{
				...
				if (otherPageInTransaction != null && otherPageInTransaction.hasMessages())
				{
					...
					newParamsPage.putString("pagename", "TempPrimaryPage");
		...
		{
			tools.putParamValue("pzFALabel", "Attachments");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZEDITATTACHMENTS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZEDITATTACHMENTS","Rule-Obj-FlowAction","RULE-",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-FLOWACTION RULE- PZEDITATTACHMENTS #20180713T141220.253 GMT","!PZEDITATTACHMENTS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-785920833)
	};
...
//	RULE-OBJ-FLOWACTION RULE- PZEDITATTACHMENTS #20180713T141220.253 GMT:20180713T141220.253 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "3a89d80b9e635c835ab65bee5e59ed0f";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-!PZEDITATTACHMENTS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzEditAttachments";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Attachments");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Attachments");
		...
		AssignActionPage.putString(".pySectionReference", "pzAttachMultipleFilesWrapper");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzEditAttachmentsPreProcessing";
// Expression: 
			newParamsPage.putString("primaryPageName", "");
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzEditAttachmentsPostProcessing";
			if (actType.equals("POSTCONNECTOR"))
			{
...
// Expression: Param.pzPrimaryPageName
			newParamsPage.putString("primaryPageName", tools.getParamValue("pzPrimaryPageName"));
			try {
				pega_rules_utilities.callActivity(interestPage, strActivityToRun, newParamsPage);
			} catch (ActivityTerminateException e) {
				throw e;
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE- PZEDITATTACHMENTS #20180713T141220.253 GMT", "Rule- pzEditAttachments", "Pega-ProcessArchitect", "08-01-01", "20180713T141220.253 GMT");
}
