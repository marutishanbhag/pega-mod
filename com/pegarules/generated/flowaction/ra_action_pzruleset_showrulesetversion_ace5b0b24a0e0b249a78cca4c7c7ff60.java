...
import java.util.*;
public class ra_action_pzruleset_showrulesetversion_ace5b0b24a0e0b249a78cca4c7c7ff60  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzRuleset_ShowRuleSetVersion.Rule_RuleSet_Version.Action");
	public ra_action_pzruleset_showrulesetversion_ace5b0b24a0e0b249a78cca4c7c7ff60(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION RULE-RULESET-VERSION PZRULESET_SHOWRULESETVERSION #20180713T135723.740 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-RULESET-VERSION PZRULESET_SHOWRULESETVERSION #20180713T135723.740 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzRuleset_ShowRuleSetVersion");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzRuleset_ShowRuleSetVersion");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "df51255db95bfe9066c94c887b5f1260";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-RuleSet-Version";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-RULESET-VERSION!PZRULESET_SHOWRULESETVERSION",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzRuleset_ShowRuleSetVersion";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzRuleset_ShowRuleSetVersion");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzRuleset_ShowRuleSetVersion");
		...
		AssignActionPage.putString(".pySectionReference", "pzRuleset_ShowRuleSetVersion");
