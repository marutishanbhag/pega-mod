 ...
 */
public class ra_stream_pxserviceslp_b3c27a9ceca4d7c343c8af846a7b8f0c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pxServicesLP.Pega_Landing_Decision_Services.Stream");
 ...
 */
	public ra_stream_pxserviceslp_b3c27a9ceca4d7c343c8af846a7b8f0c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "28616efaa53ff2014de7902cdcb89250ec2202b";
...
{
/* Instance RULE-OBJ-FLOWACTION PEGA-LANDING-DECISION-SERVICES PXSERVICESLP #20180713T143450.662 GMT	Pega-DecisionArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-OBJ-FLOWACTION PEGA-LANDING-DECISION-SERVICES PXSERVICESLP #20180713T143450.662 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-OBJ-FLOWACTION PEGA-LANDING-DECISION-SERVICES PXSERVICESLP #20180713T143450.662 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-OBJ-FLOWACTION PEGA-LANDING-DECISION-SERVICES PXSERVICESLP #20180713T143450.662 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PXSERVICESLP"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXSERVICESLP","Rule-Obj-FlowAction","PEGA-LANDING-DECISION-SERVICES",false,"","Pega-DecisionArchitect","08-01-01","RULE-OBJ-FLOWACTION PEGA-LANDING-DECISION-SERVICES PXSERVICESLP #20180713T143450.662 GMT","!PXSERVICESLP",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1822870969)
	};
...
//	RULE-OBJ-FLOWACTION PEGA-LANDING-DECISION-SERVICES PXSERVICESLP #20180713T143450.662 GMT:20180713T143450.662 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "053c6df7bb5b3668dbfbc70b35493399";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_1","pxServicesLP", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pxServicesLP";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
tools.putParamValue("flowActionUIRef","pxServicesLP"); 
tools.appendString(" ");
...
out.print( pzAuto.getInpectorData("FlowAction", "", "","pxServicesLP","Rule-Obj-FlowAction","Pega-Landing-Decision-Services") );
tools.appendString(" >");
 } 
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
pzPackageRuntime.packageSection("pxServicesLP",tools.getStepPage().getReference(), null);
tools.appendString("<div id='section-placeholder' data-class='");
out.print(tools.getStepPage().getString("pxObjClass"));
tools.appendString("' data-section='pxServicesLP'></div> ");
} else {
includeSectionBody_1();
}
tools.appendString("<span style=\"display: none;\" uitype=\"Rule-HTML-Section\" id=\"pzFlowActionUITypeRef\" uiref=\"pxServicesLP\"></span> ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-OBJ-FLOWACTION PEGA-LANDING-DECISION-SERVICES PXSERVICESLP #20180713T143450.662 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGA-LANDING-DECISION-SERVICES PXSERVICESLP #20180713T143450.662 GMT", "Pega-Landing-Decision-Services pxServicesLP", "Pega-DecisionArchitect", "08-01-01", "20180713T143450.662 GMT");
}
