...
import java.util.*;
public class ra_action_pzeditclasslabel_481aad399e722c1417596955e453ce73  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzEditClassLabel.Rule_Obj_Class.Action");
	public ra_action_pzeditclasslabel_481aad399e722c1417596955e453ce73(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-OBJ-CLASS PZEDITCLASSLABEL #20180713T141220.012 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-OBJ-CLASS PZEDITCLASSLABEL #20180713T141220.012 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzEditClassLabel");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzEditClassLabel");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZEDITCLASSLABEL"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZEDITCLASSLABEL","Rule-Obj-FlowAction","RULE-OBJ-CLASS",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-FLOWACTION RULE-OBJ-CLASS PZEDITCLASSLABEL #20180713T141220.012 GMT","!PZEDITCLASSLABEL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-707119236)
	};
...
//	RULE-OBJ-FLOWACTION RULE-OBJ-CLASS PZEDITCLASSLABEL #20180713T141220.012 GMT:20180713T141220.012 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "739278cd09473241c45a210bf38ea18c";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Obj-Class";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-OBJ-CLASS!PZEDITCLASSLABEL",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzEditClassLabel";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzEditClassLabel");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzEditClassLabel");
		...
		AssignActionPage.putString(".pySectionReference", "pzEditLabel");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzSetCaseTypeLabel";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-OBJ-CLASS PZEDITCLASSLABEL #20180713T141220.012 GMT", "Rule-Obj-Class pzEditClassLabel", "Pega-ProcessArchitect", "08-01-01", "20180713T141220.012 GMT");
}
