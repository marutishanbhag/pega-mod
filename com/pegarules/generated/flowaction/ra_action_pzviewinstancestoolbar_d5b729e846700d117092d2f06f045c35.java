...
import java.util.*;
public class ra_action_pzviewinstancestoolbar_d5b729e846700d117092d2f06f045c35  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzViewInstancesToolbar._baseclass.Action");
	public ra_action_pzviewinstancestoolbar_d5b729e846700d117092d2f06f045c35(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135447.680 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135447.680 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzViewInstancesToolbar");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzViewInstancesToolbar");
		}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXOBJCLASS","Rule-Obj-Property","@BASECLASS",true,"@baseclass","Pega-SystemArchitect","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PXOBJCLASS #20180713T135622.443 GMT","!PXOBJCLASS",true,false,"ABSOLUTE_IS_NOT_PRIMARY",0)
	};
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "887c14650ad9b6d8cfca74a5889203f9";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZVIEWINSTANCESTOOLBAR",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzViewInstancesToolbar";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzViewInstancesToolbar");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzViewInstancesToolbar");
		...
		AssignActionPage.putString(".pySectionReference", "pzViewInstancesToolbar");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzIsClassDeprecated";
// Expression: false
String pz_1 = String.valueOf(false);
			newParamsPage.putString("isDeprecated", pz_1);
			
// Expression: .pxObjClass
			newParamsPage.putString("className", scalarValueQuery_2.resolveToString(tools, myStepPage, ImmutablePropertyInfo.TYPE_TEXT));
			...
			strActivityToRun = "pzViewInstancesToolbarSettings";
			try {
