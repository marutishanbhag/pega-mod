...
import java.util.*;
public class ra_action_pzdisplayactionsteppalette_00ff368c1b09525364beba37d2cafcb3  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzDisplayActionStepPalette._baseclass.Action");
	public ra_action_pzdisplayactionsteppalette_00ff368c1b09525364beba37d2cafcb3(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZDISPLAYACTIONSTEPPALETTE #20180713T141209.707 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZDISPLAYACTIONSTEPPALETTE #20180713T141209.707 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzDisplayActionStepPalette");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzDisplayActionStepPalette");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZDISPLAYACTIONSTEPPALETTE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZDISPLAYACTIONSTEPPALETTE","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-FLOWACTION @BASECLASS PZDISPLAYACTIONSTEPPALETTE #20180713T141209.707 GMT","!PZDISPLAYACTIONSTEPPALETTE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1529098547)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZDISPLAYACTIONSTEPPALETTE #20180713T141209.707 GMT:20180713T141209.707 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "98b90469ff861ae56ff1a1c3c8f8967a";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZDISPLAYACTIONSTEPPALETTE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzDisplayActionStepPalette";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzDisplayActionStepPalette");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzDisplayActionStepPalette");
		...
		AssignActionPage.putString(".pySectionReference", "pzDisplayActionStepPalette");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pyDisplayPaletteSetContext";
				try{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZDISPLAYACTIONSTEPPALETTE #20180713T141209.707 GMT", "@baseclass pzDisplayActionStepPalette", "Pega-ProcessArchitect", "08-01-01", "20180713T141209.707 GMT");
}
