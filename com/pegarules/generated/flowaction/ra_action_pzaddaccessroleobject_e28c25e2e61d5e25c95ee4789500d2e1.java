...
import java.util.*;
public class ra_action_pzaddaccessroleobject_e28c25e2e61d5e25c95ee4789500d2e1  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAddAccessRoleObject.Rule_Access_Role_Obj.Action");
	public ra_action_pzaddaccessroleobject_e28c25e2e61d5e25c95ee4789500d2e1(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-OBJ PZADDACCESSROLEOBJECT #20180713T135452.750 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-OBJ PZADDACCESSROLEOBJECT #20180713T135452.750 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Add access Role Object");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Add access Role Object");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZADDACCESSROLEOBJECT"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZADDACCESSROLEOBJECT","Rule-Obj-FlowAction","RULE-ACCESS-ROLE-OBJ",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-OBJ PZADDACCESSROLEOBJECT #20180713T135452.750 GMT","!PZADDACCESSROLEOBJECT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1289629386)
	};
...
//	RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-OBJ PZADDACCESSROLEOBJECT #20180713T135452.750 GMT:20180713T135452.750 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "3f332d044d9c1ba26953df533428d7f4";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Access-Role-Obj";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-ACCESS-ROLE-OBJ!PZADDACCESSROLEOBJECT",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzAddAccessRoleObject";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Add access Role Object");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Add access Role Object");
		...
		AssignActionPage.putString(".pySectionReference", "pzAddModifyRoleDetails");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzPopulateBackup";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzValidateAndAddRARO";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-OBJ PZADDACCESSROLEOBJECT #20180713T135452.750 GMT", "Rule-Access-Role-Obj pzAddAccessRoleObject", "Pega-Desktop", "08-01-01", "20180713T135452.750 GMT");
}
