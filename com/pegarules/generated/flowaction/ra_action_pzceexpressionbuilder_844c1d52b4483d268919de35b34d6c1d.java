...
import java.util.*;
public class ra_action_pzceexpressionbuilder_844c1d52b4483d268919de35b34d6c1d  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzCEExpressionBuilder.PegaGadget_ExpressionBuilder.Action");
	public ra_action_pzceexpressionbuilder_844c1d52b4483d268919de35b34d6c1d(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION PEGAGADGET-EXPRESSIONBUILDER PZCEEXPRESSIONBUILDER #20180713T133519.807 GMT	Pega-Gadgets:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Gadgets";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGAGADGET-EXPRESSIONBUILDER PZCEEXPRESSIONBUILDER #20180713T133519.807 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Expression Builder");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Expression Builder");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZCEEXPRESSIONBUILDER"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCEEXPRESSIONBUILDER","Rule-Obj-FlowAction","PEGAGADGET-EXPRESSIONBUILDER",false,"","Pega-Gadgets","08-01-01","RULE-OBJ-FLOWACTION PEGAGADGET-EXPRESSIONBUILDER PZCEEXPRESSIONBUILDER #20180713T133519.807 GMT","!PZCEEXPRESSIONBUILDER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1034210516)
	};
...
//	RULE-OBJ-FLOWACTION PEGAGADGET-EXPRESSIONBUILDER PZCEEXPRESSIONBUILDER #20180713T133519.807 GMT:20180713T133519.807 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "2a7c666a4c7def08d93ee5d5aa3b2773";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "PegaGadget-ExpressionBuilder";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGAGADGET-EXPRESSIONBUILDER!PZCEEXPRESSIONBUILDER",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzCEExpressionBuilder";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Expression Builder");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Expression Builder");
		...
		AssignActionPage.putString(".pySectionReference", "pzCEExpressionBuilder");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGAGADGET-EXPRESSIONBUILDER PZCEEXPRESSIONBUILDER #20180713T133519.807 GMT", "PegaGadget-ExpressionBuilder pzCEExpressionBuilder", "Pega-Gadgets", "08-01-01", "20180713T133519.807 GMT");
}
