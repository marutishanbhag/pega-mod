...
import java.util.*;
public class ra_action_pzeditrecordname_5b1c705663e313fa977b18c8d1c4edfa  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzEditRecordName.Rule_.Action");
	public ra_action_pzeditrecordname_5b1c705663e313fa977b18c8d1c4edfa(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE- PZEDITRECORDNAME #20180713T135456.803 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE- PZEDITRECORDNAME #20180713T135456.803 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Edit Record Name");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Edit Record Name");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZEDITRECORDNAME"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZEDITRECORDNAME","Rule-Obj-FlowAction","RULE-",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION RULE- PZEDITRECORDNAME #20180713T135456.803 GMT","!PZEDITRECORDNAME",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1253584585)
	};
...
//	RULE-OBJ-FLOWACTION RULE- PZEDITRECORDNAME #20180713T135456.803 GMT:20180713T135456.803 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "bc7b354ed28b6200c7134b0a0dc5d123";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-!PZEDITRECORDNAME",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzEditRecordName";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Edit Record Name");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Edit Record Name");
		...
		AssignActionPage.putString(".pySectionReference", "pzEditRuleName");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzIsRuleNameValidPre";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzIsRuleNameValidPost";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE- PZEDITRECORDNAME #20180713T135456.803 GMT", "Rule- pzEditRecordName", "Pega-Desktop", "08-01-01", "20180713T135456.803 GMT");
}
