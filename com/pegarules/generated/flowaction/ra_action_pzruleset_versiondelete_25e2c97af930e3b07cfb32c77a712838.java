...
import java.util.*;
public class ra_action_pzruleset_versiondelete_25e2c97af930e3b07cfb32c77a712838  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzRuleSet_VersionDelete.Rule_RuleSet_Version.Action");
	public ra_action_pzruleset_versiondelete_25e2c97af930e3b07cfb32c77a712838(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION RULE-RULESET-VERSION PZRULESET_VERSIONDELETE #20180713T135723.746 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-RULESET-VERSION PZRULESET_VERSIONDELETE #20180713T135723.746 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Delete RuleSet version");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Delete RuleSet version");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "fe35ff28e61b172d1ec44eee759d4334";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-RuleSet-Version";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-RULESET-VERSION!PZRULESET_VERSIONDELETE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzRuleSet_VersionDelete";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Delete RuleSet version");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Delete RuleSet version");
		...
		AssignActionPage.putString(".pySectionReference", "pzRuleSet_VersionDelete");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzRuleSet_VersionDelete";
			if (actType.equals("POSTCONNECTOR"))
			{
