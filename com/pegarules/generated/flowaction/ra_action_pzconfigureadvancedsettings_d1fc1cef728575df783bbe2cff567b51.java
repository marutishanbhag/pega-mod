...
import java.util.*;
public class ra_action_pzconfigureadvancedsettings_d1fc1cef728575df783bbe2cff567b51  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzConfigureAdvancedSettings.PegaAccel_Task_BuildApplication.Action");
	public ra_action_pzconfigureadvancedsettings_d1fc1cef728575df783bbe2cff567b51(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION PEGAACCEL-TASK-BUILDAPPLICATION PZCONFIGUREADVANCEDSETTINGS #20180713T141216.329 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGAACCEL-TASK-BUILDAPPLICATION PZCONFIGUREADVANCEDSETTINGS #20180713T141216.329 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Advanced configuration");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Advanced configuration");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "b4e7a4b63d0d955fb16d6bd47f6748dd";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "PegaAccel-Task-BuildApplication";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGAACCEL-TASK-BUILDAPPLICATION!PZCONFIGUREADVANCEDSETTINGS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzConfigureAdvancedSettings";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Advanced configuration");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Advanced configuration");
		...
		AssignActionPage.putString(".pySectionReference", "pzConfigureAdvancedSettings");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzValidateAdvancedSettings";
			if (actType.equals("POSTCONNECTOR"))
			{
