...
import java.util.*;
public class ra_action_pzrecordmanagementsettings_72f5f399eea4f6fa622416d5f01d96bb  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzRecordManagementSettings.Pega_Preference_RecordManagement.Action");
	public ra_action_pzrecordmanagementsettings_72f5f399eea4f6fa622416d5f01d96bb(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION PEGA-PREFERENCE-RECORDMANAGEMENT PZRECORDMANAGEMENTSETTINGS #20190206T152849.976 GMT	Pega-ProcessArchitect:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-PREFERENCE-RECORDMANAGEMENT PZRECORDMANAGEMENTSETTINGS #20190206T152849.976 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Branch development preferences");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Branch development preferences");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZRECORDMANAGEMENTSETTINGS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRECORDMANAGEMENTSETTINGS","Rule-Obj-FlowAction","PEGA-PREFERENCE-RECORDMANAGEMENT",false,"","Pega-ProcessArchitect","08-03-01","RULE-OBJ-FLOWACTION PEGA-PREFERENCE-RECORDMANAGEMENT PZRECORDMANAGEMENTSETTINGS #20190206T152849.976 GMT","!PZRECORDMANAGEMENTSETTINGS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-216779758)
	};
...
//	RULE-OBJ-FLOWACTION PEGA-PREFERENCE-RECORDMANAGEMENT PZRECORDMANAGEMENTSETTINGS #20190206T152849.976 GMT:20190206T152849.976 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "f8d262b0827a2e3fc19c6c4bfeb2bb46";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-Preference-RecordManagement";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-PREFERENCE-RECORDMANAGEMENT!PZRECORDMANAGEMENTSETTINGS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzRecordManagementSettings";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Branch development preferences");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Branch development preferences");
		...
		AssignActionPage.putString(".pySectionReference", "pzRecordManagementPreferences");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzCheckForInvalidPreferences";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pxSetRecordManagementPreferences";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGA-PREFERENCE-RECORDMANAGEMENT PZRECORDMANAGEMENTSETTINGS #20190206T152849.976 GMT", "Pega-Preference-RecordManagement pzRecordManagementSettings", "Pega-ProcessArchitect", "08-03-01", "20190206T152849.976 GMT");
}
