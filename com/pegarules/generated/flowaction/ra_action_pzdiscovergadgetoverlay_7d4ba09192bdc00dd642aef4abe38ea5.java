...
import java.util.*;
public class ra_action_pzdiscovergadgetoverlay_7d4ba09192bdc00dd642aef4abe38ea5  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzDiscoverGadgetOverlay.Pega_DiscoverLayerCake.Action");
	public ra_action_pzdiscovergadgetoverlay_7d4ba09192bdc00dd642aef4abe38ea5(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGETOVERLAY #20181016T180712.562 GMT	Pega-ProcessArchitect:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGETOVERLAY #20181016T180712.562 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Discover gadget overlay");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Discover gadget overlay");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZDISCOVERGADGETOVERLAY"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZDISCOVERGADGETOVERLAY","Rule-Obj-FlowAction","PEGA-DISCOVERLAYERCAKE",false,"","Pega-ProcessArchitect","08-02-01","RULE-OBJ-FLOWACTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGETOVERLAY #20181016T180712.562 GMT","!PZDISCOVERGADGETOVERLAY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1521126853)
	};
...
//	RULE-OBJ-FLOWACTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGETOVERLAY #20181016T180712.562 GMT:20181016T180712.562 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "20c369da8b7d5c67fc8f7959ff6df389";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-DiscoverLayerCake";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-DISCOVERLAYERCAKE!PZDISCOVERGADGETOVERLAY",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzDiscoverGadgetOverlay";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Discover gadget overlay");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Discover gadget overlay");
		...
		AssignActionPage.putString(".pySectionReference", "pzDiscoverGadgetSection");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGETOVERLAY #20181016T180712.562 GMT", "Pega-DiscoverLayerCake pzDiscoverGadgetOverlay", "Pega-ProcessArchitect", "08-02-01", "20181016T180712.562 GMT");
}
