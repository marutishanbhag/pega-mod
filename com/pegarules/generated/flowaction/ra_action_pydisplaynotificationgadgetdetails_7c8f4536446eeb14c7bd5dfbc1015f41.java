...
import java.util.*;
public class ra_action_pydisplaynotificationgadgetdetails_7c8f4536446eeb14c7bd5dfbc1015f41  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pyDisplayNotificationGadgetDetails._baseclass.Action");
	public ra_action_pydisplaynotificationgadgetdetails_7c8f4536446eeb14c7bd5dfbc1015f41(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PYDISPLAYNOTIFICATIONGADGETDETAILS #20180713T133114.308 GMT	Pega-ProcessEngine:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessEngine";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PYDISPLAYNOTIFICATIONGADGETDETAILS #20180713T133114.308 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pyDisplayNotificationGadgetDetails");
		}
		...
		else if (purpose.equals("VALIDATE"))
		{
			...
			if (newAssignPage == null || (newAssignPage != null && !pega_procom_pegaprocomutilities.determineDeferErrors(newAssignPage, workPage)))
			{
				...
				if (!workPageName.equals("TempNotificationPage"))
				{
					otherPageInTransaction = tools.findPage("TempNotificationPage");
			...
			if (!workPageName.equals("TempNotificationPage"))
			{
				...
				if (otherPageInTransaction != null && otherPageInTransaction.hasMessages())
				{
					...
					newParamsPage.putString("pagename", "TempNotificationPage");
		...
		{
			tools.putParamValue("pzFALabel", "pyDisplayNotificationGadgetDetails");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PYDISPLAYNOTIFICATIONGADGETDETAILS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDISPLAYNOTIFICATIONGADGETDETAILS","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-ProcessEngine","08-01-01","RULE-OBJ-FLOWACTION @BASECLASS PYDISPLAYNOTIFICATIONGADGETDETAILS #20180713T133114.308 GMT","!PYDISPLAYNOTIFICATIONGADGETDETAILS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",34024025)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PYDISPLAYNOTIFICATIONGADGETDETAILS #20180713T133114.308 GMT:20180713T133114.308 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "9371669ada4ea0b79cedf79d08b9f08a";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PYDISPLAYNOTIFICATIONGADGETDETAILS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pyDisplayNotificationGadgetDetails";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pyDisplayNotificationGadgetDetails");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pyDisplayNotificationGadgetDetails");
		...
		AssignActionPage.putString(".pySectionReference", "pyDisplayNotificationGadgetDetails");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PYDISPLAYNOTIFICATIONGADGETDETAILS #20180713T133114.308 GMT", "@baseclass pyDisplayNotificationGadgetDetails", "Pega-ProcessEngine", "08-01-01", "20180713T133114.308 GMT");
}
