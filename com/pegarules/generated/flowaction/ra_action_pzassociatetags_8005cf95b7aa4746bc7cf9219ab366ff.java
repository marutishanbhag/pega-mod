...
import java.util.*;
public class ra_action_pzassociatetags_8005cf95b7aa4746bc7cf9219ab366ff  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAssociateTags._baseclass.Action");
	public ra_action_pzassociatetags_8005cf95b7aa4746bc7cf9219ab366ff(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZASSOCIATETAGS #20201116T124944.859 GMT	Pega-EndUserUI:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-EndUserUI";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZASSOCIATETAGS #20201116T124944.859 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Manage tags");
		}
		...
		else if (purpose.equals("VALIDATE"))
		{
			...
			if (newAssignPage == null || (newAssignPage != null && !pega_procom_pegaprocomutilities.determineDeferErrors(newAssignPage, workPage)))
			{
				...
				if (!workPageName.equals("ManageAssociatedTags"))
				{
					otherPageInTransaction = tools.findPage("ManageAssociatedTags");
			...
			if (!workPageName.equals("ManageAssociatedTags"))
			{
				...
				if (otherPageInTransaction != null && otherPageInTransaction.hasMessages())
				{
					...
					newParamsPage.putString("pagename", "ManageAssociatedTags");
		...
		{
			tools.putParamValue("pzFALabel", "Manage tags");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZASSOCIATETAGS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZASSOCIATETAGS","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-EndUserUI","08-06-01","RULE-OBJ-FLOWACTION @BASECLASS PZASSOCIATETAGS #20201116T124944.859 GMT","!PZASSOCIATETAGS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1690558257)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZASSOCIATETAGS #20201116T124944.859 GMT:20201116T124944.859 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "784a6e2836f05270d522547fe51379e6";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZASSOCIATETAGS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzAssociateTags";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Manage tags");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Manage tags");
		...
		AssignActionPage.putString(".pySectionReference", "pyAssociatedTags");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzGetAssociatedTags";
// Expression: 
			newParamsPage.putString("PulsePage", "");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZASSOCIATETAGS #20201116T124944.859 GMT", "@baseclass pzAssociateTags", "Pega-EndUserUI", "08-06-01", "20201116T124944.859 GMT");
}
