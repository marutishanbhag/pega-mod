...
import java.util.*;
public class ra_action_pzrepeat_3c3267ebefb000c0c1771141159b6c16  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzRepeat.Embed_ActivitySteps.Action");
	public ra_action_pzrepeat_3c3267ebefb000c0c1771141159b6c16(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZREPEAT #20180713T135448.087 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZREPEAT #20180713T135448.087 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Loop");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Loop");
		}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZREPEAT","Rule-Obj-FlowAction","EMBED-ACTIVITYSTEPS",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZREPEAT #20180713T135448.087 GMT","!PZREPEAT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1257396047)
	};
...
//	RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZREPEAT #20180713T135448.087 GMT:20180713T135448.087 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "5f616269cae8f9aac1a8730621e3b862";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Embed-ActivitySteps";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:EMBED-ACTIVITYSTEPS!PZREPEAT",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	private boolean AddFlowAction_circum0(String strActionType, ClipboardPage newAssignPage, boolean isSelectedAction, boolean displaySeparatorAbove)
	{
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Loop");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Loop");
		...
		AssignActionPage.putString(".pySectionReference", "pzRepeat");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZREPEAT #20180713T135448.087 GMT", "Embed-ActivitySteps pzRepeat", "Pega-Desktop", "08-01-01", "20180713T135448.087 GMT");
}
