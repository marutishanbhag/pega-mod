...
import java.util.*;
public class ra_action_pzcreatepersonaforaccessgroup_7ba2d6cf37efccfc383d4d80bdbe2126  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzCreatePersonaForAccessGroup.Rule_Persona.Action");
	public ra_action_pzcreatepersonaforaccessgroup_7ba2d6cf37efccfc383d4d80bdbe2126(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-PERSONA PZCREATEPERSONAFORACCESSGROUP #20200504T123201.853 GMT	Pega-AppDefinition:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-AppDefinition";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-PERSONA PZCREATEPERSONAFORACCESSGROUP #20200504T123201.853 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Create persona?");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Create persona?");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZCREATEPERSONAFORACCESSGROUP"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCREATEPERSONAFORACCESSGROUP","Rule-Obj-FlowAction","RULE-PERSONA",false,"","Pega-AppDefinition","08-05-01","RULE-OBJ-FLOWACTION RULE-PERSONA PZCREATEPERSONAFORACCESSGROUP #20200504T123201.853 GMT","!PZCREATEPERSONAFORACCESSGROUP",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",385548404)
	};
...
//	RULE-OBJ-FLOWACTION RULE-PERSONA PZCREATEPERSONAFORACCESSGROUP #20200504T123201.853 GMT:20200504T123201.853 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "72ac426ab1bdbab3e4b1c8ef43081f16";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Persona";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-PERSONA!PZCREATEPERSONAFORACCESSGROUP",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzCreatePersonaForAccessGroup";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Create persona?");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Create persona?");
		...
		AssignActionPage.putString(".pySectionReference", "pzCreatePersonaForAccessGroup");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzCreatePersonaForAccessGroup";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-PERSONA PZCREATEPERSONAFORACCESSGROUP #20200504T123201.853 GMT", "Rule-Persona pzCreatePersonaForAccessGroup", "Pega-AppDefinition", "08-05-01", "20200504T123201.853 GMT");
}
