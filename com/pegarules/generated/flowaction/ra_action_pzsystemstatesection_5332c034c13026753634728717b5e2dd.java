...
import java.util.*;
public class ra_action_pzsystemstatesection_5332c034c13026753634728717b5e2dd  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzSystemStateSection.Log_System_State_.Action");
	public ra_action_pzsystemstatesection_5332c034c13026753634728717b5e2dd(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION LOG-SYSTEM-STATE- PZSYSTEMSTATESECTION #20180713T142429.293 GMT	Pega-SystemOperations:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-SystemOperations";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION LOG-SYSTEM-STATE- PZSYSTEMSTATESECTION #20180713T142429.293 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Download system state");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Download system state");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZSYSTEMSTATESECTION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSYSTEMSTATESECTION","Rule-Obj-FlowAction","LOG-SYSTEM-STATE-",false,"","Pega-SystemOperations","08-01-01","RULE-OBJ-FLOWACTION LOG-SYSTEM-STATE- PZSYSTEMSTATESECTION #20180713T142429.293 GMT","!PZSYSTEMSTATESECTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-899735023)
	};
...
//	RULE-OBJ-FLOWACTION LOG-SYSTEM-STATE- PZSYSTEMSTATESECTION #20180713T142429.293 GMT:20180713T142429.293 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "a12882c0fe28c4f4cc58df1ec8f5e078";
	}

	public String getDefinitionAppliesToClass() {
		return "Log-System-State-";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Log-System-State-";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:LOG-SYSTEM-STATE-!PZSYSTEMSTATESECTION",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzSystemStateSection";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Download system state");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Download system state");
		...
		AssignActionPage.putString(".pySectionReference", "pzSystemStateSection");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION LOG-SYSTEM-STATE- PZSYSTEMSTATESECTION #20180713T142429.293 GMT", "Log-System-State- pzSystemStateSection", "Pega-SystemOperations", "08-01-01", "20180713T142429.293 GMT");
}
