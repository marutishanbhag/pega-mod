...
import java.util.*;
public class ra_action_pzshowtableinst_056cfc753dfc67cd118aed5ff99d9d21  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzShowTableInst.Pega_UI_Component_Grid_Filter.Action");
	public ra_action_pzshowtableinst_056cfc753dfc67cd118aed5ff99d9d21(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION PEGA-UI-COMPONENT-GRID-FILTER PZSHOWTABLEINST #20230704T053042.231 GMT	Pega-UIEngine:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-UIEngine";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-UI-COMPONENT-GRID-FILTER PZSHOWTABLEINST #20230704T053042.231 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "ShowTableInst");
		}
		...
		{
			tools.putParamValue("pzFALabel", "ShowTableInst");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZSHOWTABLEINST"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSHOWTABLEINST","Rule-Obj-FlowAction","PEGA-UI-COMPONENT-GRID-FILTER",false,"","Pega-UIEngine","08-23-01","RULE-OBJ-FLOWACTION PEGA-UI-COMPONENT-GRID-FILTER PZSHOWTABLEINST #20230704T053042.231 GMT","!PZSHOWTABLEINST",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1977225570)
	};
...
//	RULE-OBJ-FLOWACTION PEGA-UI-COMPONENT-GRID-FILTER PZSHOWTABLEINST #20230704T053042.231 GMT:20230704T053042.231 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "469722ef360d8f6f97811d645239aefe";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-UI-Component-Grid-Filter";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-UI-COMPONENT-GRID-FILTER!PZSHOWTABLEINST",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzShowTableInst";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "ShowTableInst");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "ShowTableInst");
		...
		AssignActionPage.putString(".pySectionReference", "pzTableSmartInfoSection");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGA-UI-COMPONENT-GRID-FILTER PZSHOWTABLEINST #20230704T053042.231 GMT", "Pega-UI-Component-Grid-Filter pzShowTableInst", "Pega-UIEngine", "08-23-01", "20230704T053042.231 GMT");
}
