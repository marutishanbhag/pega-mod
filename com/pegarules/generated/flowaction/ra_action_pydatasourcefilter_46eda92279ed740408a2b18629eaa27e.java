...
import java.util.*;
public class ra_action_pydatasourcefilter_46eda92279ed740408a2b18629eaa27e  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pyDataSourceFilter.PegaGadget_Feed.Action");
	public ra_action_pydatasourcefilter_46eda92279ed740408a2b18629eaa27e(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION PEGAGADGET-FEED PYDATASOURCEFILTER #20190424T070047.660 GMT	Pega-Social:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Social";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGAGADGET-FEED PYDATASOURCEFILTER #20190424T070047.660 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pyDataSourceFilter");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pyDataSourceFilter");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PYDATASOURCEFILTER"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDATASOURCEFILTER","Rule-Obj-FlowAction","PEGAGADGET-FEED",false,"","Pega-Social","08-03-01","RULE-OBJ-FLOWACTION PEGAGADGET-FEED PYDATASOURCEFILTER #20190424T070047.660 GMT","!PYDATASOURCEFILTER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1318858602)
	};
...
//	RULE-OBJ-FLOWACTION PEGAGADGET-FEED PYDATASOURCEFILTER #20190424T070047.660 GMT:20190424T070047.660 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "b310ffaa4c736af0ff84628748357c5f";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "PegaGadget-Feed";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGAGADGET-FEED!PYDATASOURCEFILTER",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pyDataSourceFilter";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pyDataSourceFilter");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pyDataSourceFilter");
		...
		AssignActionPage.putString(".pySectionReference", "pyDataSourceFilters");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strTransform = "pzDataSourceFiltersPost";
			if (actType.equals("POSTCONNECTOR"))
			{
				// Trace Post-Processing transform
				LogTraceEvent("Rule-Obj-Model " + interestPage.getClassName() + "." + strTransform,
					strActionName,
					"Flow Action Data Transform");
			}
			
// Expression: .pxDPParameters.FeedLabel
			newParamsPage.putString("FeedLabel", scalarValueQuery_1.resolveToString(tools, myStepPage, ImmutablePropertyInfo.TYPE_TEXT));
			
// Expression: false
String pz_3 = String.valueOf(false);
			newParamsPage.putString("bClearParams", pz_3);
				...
				IsPostProcessingSuccess = false;				workPage.addMessage("Flow_PostTransformProcessFail\t" + strTransform + "\t" + e.getMessage(), "pyMessageLabel", "@baseclass");
...
public static final String[] pRef_2 = new String[] { "", "", "pxDPParameters", "", "FeedLabel", "" };
private static final ScalarValueQuery scalarValueQuery_1 = FUAUtil.createQueryBuilder().allowMissingPropertyException().page("pxDPParameters").scalarProperty("FeedLabel").buildScalarValueQuery();

private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGAGADGET-FEED PYDATASOURCEFILTER #20190424T070047.660 GMT", "PegaGadget-Feed pyDataSourceFilter", "Pega-Social", "08-03-01", "20190424T070047.660 GMT");
}
