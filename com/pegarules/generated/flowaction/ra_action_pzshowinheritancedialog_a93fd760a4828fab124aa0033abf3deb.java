...
import java.util.*;
public class ra_action_pzshowinheritancedialog_a93fd760a4828fab124aa0033abf3deb  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzShowInheritanceDialog._baseclass.Action");
	public ra_action_pzshowinheritancedialog_a93fd760a4828fab124aa0033abf3deb(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZSHOWINHERITANCEDIALOG #20180713T135447.628 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZSHOWINHERITANCEDIALOG #20180713T135447.628 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Class Inheritance Diagram");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Class Inheritance Diagram");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZSHOWINHERITANCEDIALOG"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSHOWINHERITANCEDIALOG","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION @BASECLASS PZSHOWINHERITANCEDIALOG #20180713T135447.628 GMT","!PZSHOWINHERITANCEDIALOG",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1281525384)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZSHOWINHERITANCEDIALOG #20180713T135447.628 GMT:20180713T135447.628 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "6bb0808df891811027e058b4dab1772f";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZSHOWINHERITANCEDIALOG",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzShowInheritanceDialog";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Class Inheritance Diagram");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Class Inheritance Diagram");
		...
		AssignActionPage.putString(".pySectionReference", "pzShowInheritanceGrid");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZSHOWINHERITANCEDIALOG #20180713T135447.628 GMT", "@baseclass pzShowInheritanceDialog", "Pega-Desktop", "08-01-01", "20180713T135447.628 GMT");
}
