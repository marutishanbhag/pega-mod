...
import java.util.*;
public class ra_action_pzshowwarnings_4d490a272ed12bbb7d6c7cc74c1d47d3  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzShowWarnings._baseclass.Action");
	public ra_action_pzshowwarnings_4d490a272ed12bbb7d6c7cc74c1d47d3(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZSHOWWARNINGS #20181119T214444.087 GMT	Pega-Desktop:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZSHOWWARNINGS #20181119T214444.087 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Guardrail warnings");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Guardrail warnings");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "0dc676238386d106a23295b956b4eb21";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZSHOWWARNINGS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzShowWarnings";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Guardrail warnings");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Guardrail warnings");
		...
		AssignActionPage.putString(".pySectionReference", "pzWarningsWrapper");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzMapWarningsWithIndex";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzJustifyWarnings";
			if (actType.equals("POSTCONNECTOR"))
			{
