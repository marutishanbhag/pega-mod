...
import java.util.*;
public class ra_action_pzchangeurlalias_36227c78a97558faca6b273b208a0244  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzChangeURLAlias.Rule_Application.Action");
	public ra_action_pzchangeurlalias_36227c78a97558faca6b273b208a0244(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZCHANGEURLALIAS #20190917T121243.675 GMT	Pega-ProcessArchitect:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZCHANGEURLALIAS #20190917T121243.675 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Change URL alias");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Change URL alias");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZCHANGEURLALIAS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCHANGEURLALIAS","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-ProcessArchitect","08-04-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZCHANGEURLALIAS #20190917T121243.675 GMT","!PZCHANGEURLALIAS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",213730700)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZCHANGEURLALIAS #20190917T121243.675 GMT:20190917T121243.675 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "84f80b9c6ff6ac143aa60ada9b4b6b70";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZCHANGEURLALIAS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzChangeURLAlias";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Change URL alias");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Change URL alias");
		...
		AssignActionPage.putString(".pySectionReference", "pzUpdateAlias");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzVerifyAlias";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZCHANGEURLALIAS #20190917T121243.675 GMT", "Rule-Application pzChangeURLAlias", "Pega-ProcessArchitect", "08-04-01", "20190917T121243.675 GMT");
}
