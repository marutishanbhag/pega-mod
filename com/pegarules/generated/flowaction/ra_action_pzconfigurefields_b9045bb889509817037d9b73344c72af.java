...
import java.util.*;
public class ra_action_pzconfigurefields_b9045bb889509817037d9b73344c72af  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzConfigureFields.Data_MO_Connector_Transition.Action");
	public ra_action_pzconfigurefields_b9045bb889509817037d9b73344c72af(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION DATA-MO-CONNECTOR-TRANSITION PZCONFIGUREFIELDS #20180713T141209.930 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-MO-CONNECTOR-TRANSITION PZCONFIGUREFIELDS #20180713T141209.930 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "View configuration");
		}
		...
		{
			tools.putParamValue("pzFALabel", "View configuration");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "b21481130fff5f46d0aabde37508d3fc";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-MO-Connector-Transition";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-MO-CONNECTOR-TRANSITION!PZCONFIGUREFIELDS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzConfigureFields";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "View configuration");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "View configuration");
		...
		AssignActionPage.putString(".pySectionReference", "pzShowConfigureForm");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzFieldsModalPreProcessing";
// Expression: 
			newParamsPage.putString("SectionName", "");
			
// Expression: SectionPage
			newParamsPage.putString("SectionPage", "SectionPage");
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzFieldsModalPostProcessing";
			if (actType.equals("POSTCONNECTOR"))
			{
...
String pz_1 = String.valueOf(false);
			newParamsPage.putString("bSkipCaseInfoCreation", pz_1);
// Expression: false
String pz_2 = String.valueOf(false);
			newParamsPage.putString("bSkipFlowActionCreation", pz_2);
// Expression: false
String pz_3 = String.valueOf(false);
			newParamsPage.putString("SkipMovingMessagesToPrimary", pz_3);
// Expression: false
String pz_4 = String.valueOf(false);
			newParamsPage.putString("CreateLocalStorage", pz_4);
// Expression: false
String pz_5 = String.valueOf(false);
			newParamsPage.putString("ClearMessagesOnSectionPage", pz_5);
// Expression: SectionPage
			newParamsPage.putString("SectionPage", "SectionPage");
			try {
				pega_rules_utilities.callActivity(interestPage, strActivityToRun, newParamsPage);
