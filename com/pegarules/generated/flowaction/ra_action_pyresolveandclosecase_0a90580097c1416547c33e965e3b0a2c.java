...
import java.util.*;
public class ra_action_pyresolveandclosecase_0a90580097c1416547c33e965e3b0a2c  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pyResolveAndCloseCase.Work_.Action");
	public ra_action_pyresolveandclosecase_0a90580097c1416547c33e965e3b0a2c(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION WORK- PYRESOLVEANDCLOSECASE #20200318T183139.712 GMT	Pega-ProcessArchitect:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION WORK- PYRESOLVEANDCLOSECASE #20200318T183139.712 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Resolve case");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Resolve case");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PYRESOLVEANDCLOSECASE", 
	"Rule-Obj-Property:PYRESOLVEDSTATUS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYRESOLVEANDCLOSECASE","Rule-Obj-FlowAction","WORK-",false,"","Pega-ProcessArchitect","08-05-01","RULE-OBJ-FLOWACTION WORK- PYRESOLVEANDCLOSECASE #20200318T183139.712 GMT","!PYRESOLVEANDCLOSECASE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1833953608), 
		new DependentRuleInfo("PYRESOLVEDSTATUS","Rule-Obj-Property","WORK-",true,"Work-","Pega-ProcessArchitect","08-01-01","RULE-OBJ-PROPERTY WORK- PYRESOLVEDSTATUS #20180713T140731.115 GMT","!PYRESOLVEDSTATUS",true,false,"ABSOLUTE_IS_NOT_PRIMARY",0)
	};
...
//	RULE-OBJ-FLOWACTION WORK- PYRESOLVEANDCLOSECASE #20200318T183139.712 GMT:20200318T183139.712 GMT
//	RULE-OBJ-PROPERTY WORK- PYRESOLVEDSTATUS #20180713T140731.115 GMT:20180713T140731.115 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "e0308c037e1c01e85465a087be5f0747";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Work-";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:WORK-!PYRESOLVEANDCLOSECASE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pyResolveAndCloseCase";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Resolve case");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Resolve case");
		...
		AssignActionPage.putString(".pySectionReference", "pySetStatusResolved");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pxForceCaseClose";
			if (actType.equals("POSTCONNECTOR"))
			{
...
// Expression: "User manually close case"
			newParamsPage.putString("AuditNote", "User manually close case");
// Expression: true
String pz_1 = String.valueOf(true);
			newParamsPage.putString("Commit", pz_1);
// Expression: true
String pz_2 = String.valueOf(true);
			newParamsPage.putString("CloseAllSubCases", pz_2);
// Expression: .pyResolvedStatus
			newParamsPage.putString("WorkStatus", scalarValueQuery_3.resolveToString(tools, myStepPage, ImmutablePropertyInfo.TYPE_TEXT));
// Expression: true
String pz_4 = String.valueOf(true);
			newParamsPage.putString("CloseParentCase", pz_4);
// Expression: false
String pz_5 = String.valueOf(false);
			newParamsPage.putString("OnlyNonResolvedWOs", pz_5);
// Expression: true
String pz_6 = String.valueOf(true);
			newParamsPage.putString("CleanupAssignments", pz_6);
// Expression: false
String pz_7 = String.valueOf(false);
			newParamsPage.putString("UpdateHistory", pz_7);
			try {
...
private static final ScalarValueQuery scalarValueQuery_3 = FUAUtil.createQueryBuilder().allowMissingPropertyException().scalarProperty("pyResolvedStatus").buildScalarValueQuery();

private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION WORK- PYRESOLVEANDCLOSECASE #20200318T183139.712 GMT", "Work- pyResolveAndCloseCase", "Pega-ProcessArchitect", "08-05-01", "20200318T183139.712 GMT");
}
