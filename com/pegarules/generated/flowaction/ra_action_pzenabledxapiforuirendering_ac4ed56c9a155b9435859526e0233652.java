...
import java.util.*;
public class ra_action_pzenabledxapiforuirendering_ac4ed56c9a155b9435859526e0233652  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzEnableDXAPIForUIRendering.Rule_Application.Action");
	public ra_action_pzenabledxapiforuirendering_ac4ed56c9a155b9435859526e0233652(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZENABLEDXAPIFORUIRENDERING #20200605T155240.114 GMT	Pega-Desktop:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZENABLEDXAPIFORUIRENDERING #20200605T155240.114 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzEnableDXAPIForUIRendering");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzEnableDXAPIForUIRendering");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZENABLEDXAPIFORUIRENDERING"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZENABLEDXAPIFORUIRENDERING","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-Desktop","08-05-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZENABLEDXAPIFORUIRENDERING #20200605T155240.114 GMT","!PZENABLEDXAPIFORUIRENDERING",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1563170804)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZENABLEDXAPIFORUIRENDERING #20200605T155240.114 GMT:20200605T155240.114 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "1e5df6e08293aaee0eb9b51a2ea2ec25";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZENABLEDXAPIFORUIRENDERING",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzEnableDXAPIForUIRendering";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzEnableDXAPIForUIRendering");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzEnableDXAPIForUIRendering");
		...
		AssignActionPage.putString(".pySectionReference", "pzEnableDXAPIForUIRendering");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZENABLEDXAPIFORUIRENDERING #20200605T155240.114 GMT", "Rule-Application pzEnableDXAPIForUIRendering", "Pega-Desktop", "08-05-01", "20200605T155240.114 GMT");
}
