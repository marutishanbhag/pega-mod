...
import java.util.*;
public class ra_action_pzdisplaysteppalette_e530ff7cb54838eeb7dece1afd5abc94  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzDisplayStepPalette.Embed_StageProcess.Action");
	public ra_action_pzdisplaysteppalette_e530ff7cb54838eeb7dece1afd5abc94(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION EMBED-STAGEPROCESS PZDISPLAYSTEPPALETTE #20180713T141216.173 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION EMBED-STAGEPROCESS PZDISPLAYSTEPPALETTE #20180713T141216.173 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzDisplayStepPalette");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzDisplayStepPalette");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "afd8658132d09ce1dd413b6103912ff7";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Embed-StageProcess";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:EMBED-STAGEPROCESS!PZDISPLAYSTEPPALETTE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzDisplayStepPalette";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzDisplayStepPalette");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzDisplayStepPalette");
		...
		AssignActionPage.putString(".pySectionReference", "pzDisplayStepPalette");
