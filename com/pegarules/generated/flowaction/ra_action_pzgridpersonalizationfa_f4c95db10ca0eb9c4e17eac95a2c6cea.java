...
import java.util.*;
public class ra_action_pzgridpersonalizationfa_f4c95db10ca0eb9c4e17eac95a2c6cea  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzGridPersonalizationFA._baseclass.Action");
	public ra_action_pzgridpersonalizationfa_f4c95db10ca0eb9c4e17eac95a2c6cea(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZGRIDPERSONALIZATIONFA #20190311T175620.099 GMT	Pega-UIEngine:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-UIEngine";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZGRIDPERSONALIZATIONFA #20190311T175620.099 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Table personalization");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Table personalization");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZGRIDPERSONALIZATIONFA"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZGRIDPERSONALIZATIONFA","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-UIEngine","08-03-01","RULE-OBJ-FLOWACTION @BASECLASS PZGRIDPERSONALIZATIONFA #20190311T175620.099 GMT","!PZGRIDPERSONALIZATIONFA",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1457101051)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZGRIDPERSONALIZATIONFA #20190311T175620.099 GMT:20190311T175620.099 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "ef0baaa70d053ca87c8298db55a068f5";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZGRIDPERSONALIZATIONFA",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzGridPersonalizationFA";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Table personalization");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Table personalization");
		...
		AssignActionPage.putString(".pySectionReference", "pyGridPersonalization");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZGRIDPERSONALIZATIONFA #20190311T175620.099 GMT", "@baseclass pzGridPersonalizationFA", "Pega-UIEngine", "08-03-01", "20190311T175620.099 GMT");
}
