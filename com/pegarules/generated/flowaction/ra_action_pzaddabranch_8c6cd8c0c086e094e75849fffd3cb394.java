...
import java.util.*;
public class ra_action_pzaddabranch_8c6cd8c0c086e094e75849fffd3cb394  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAddABranch.Rule_Application.Action");
	public ra_action_pzaddabranch_8c6cd8c0c086e094e75849fffd3cb394(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZADDABRANCH #20180713T135723.614 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-SystemArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZADDABRANCH #20180713T135723.614 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Add a Branch ID");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Add a Branch ID");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZADDABRANCH"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZADDABRANCH","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-SystemArchitect","08-01-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZADDABRANCH #20180713T135723.614 GMT","!PZADDABRANCH",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",764187468)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZADDABRANCH #20180713T135723.614 GMT:20180713T135723.614 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "27b6cfe2c658070fcb538c17c28b74b9";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZADDABRANCH",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzAddABranch";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Add a Branch ID");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Add a Branch ID");
		...
		AssignActionPage.putString(".pySectionReference", "pzAddABranch");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzAddNewBranchToApp";
				try{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzPreExistingBranchCheck";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZADDABRANCH #20180713T135723.614 GMT", "Rule-Application pzAddABranch", "Pega-SystemArchitect", "08-01-01", "20180713T135723.614 GMT");
}
