...
import java.util.*;
public class ra_action_pzfilterpanelfa_96d08567f750dfbcc89b0389ff0fb85c  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzFilterPanelFA.Pega_UI_Component_Grid_Filter.Action");
	public ra_action_pzfilterpanelfa_96d08567f750dfbcc89b0389ff0fb85c(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION PEGA-UI-COMPONENT-GRID-FILTER PZFILTERPANELFA #20230618T001617.814 GMT	Pega-UIEngine:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-UIEngine";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-UI-COMPONENT-GRID-FILTER PZFILTERPANELFA #20230618T001617.814 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Filter panel");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Filter panel");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZFILTERPANELFA"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZFILTERPANELFA","Rule-Obj-FlowAction","PEGA-UI-COMPONENT-GRID-FILTER",false,"","Pega-UIEngine","08-23-01","RULE-OBJ-FLOWACTION PEGA-UI-COMPONENT-GRID-FILTER PZFILTERPANELFA #20230618T001617.814 GMT","!PZFILTERPANELFA",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1779058063)
	};
...
//	RULE-OBJ-FLOWACTION PEGA-UI-COMPONENT-GRID-FILTER PZFILTERPANELFA #20230618T001617.814 GMT:20230618T001617.814 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "3a34c832a0452c0ea75fcb5c534f92ff";
	}

	public String getDefinitionAppliesToClass() {
		return "Pega-UI-Component-Grid-Filter";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-UI-Component-Grid-Filter";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-UI-COMPONENT-GRID-FILTER!PZFILTERPANELFA",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzFilterPanelFA";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Filter panel");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Filter panel");
		...
		AssignActionPage.putString(".pySectionReference", "pzFilterPanelMobile");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzGridFilterPanelMobilePA";
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGA-UI-COMPONENT-GRID-FILTER PZFILTERPANELFA #20230618T001617.814 GMT", "Pega-UI-Component-Grid-Filter pzFilterPanelFA", "Pega-UIEngine", "08-23-01", "20230618T001617.814 GMT");
}
