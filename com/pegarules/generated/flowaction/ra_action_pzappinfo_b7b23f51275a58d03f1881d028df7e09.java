...
import java.util.*;
public class ra_action_pzappinfo_b7b23f51275a58d03f1881d028df7e09  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAppInfo.Rule_Application.Action");
	public ra_action_pzappinfo_b7b23f51275a58d03f1881d028df7e09(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPINFO #20201028T080713.542 GMT	Pega-LP:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mRuleSet = "Pega-LP";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPINFO #20201028T080713.542 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzAppInfo");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzAppInfo");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "b8d51c5ad26c5db5e2ecc1934aa956be";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZAPPINFO",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzAppInfo";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzAppInfo");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzAppInfo");
		...
		AssignActionPage.putString(".pySectionReference", "pzAppInfo");
