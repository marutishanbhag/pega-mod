...
import java.util.*;
public class ra_action_pzruleformruleseteditfa_7329b55b29aad0cfab52b4c7734e35e3  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzRuleFormRulesetEditFA._baseclass.Action");
	public ra_action_pzruleformruleseteditfa_7329b55b29aad0cfab52b4c7734e35e3(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZRULEFORMRULESETEDITFA #20180713T135447.605 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZRULEFORMRULESETEDITFA #20180713T135447.605 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzRuleFormRulesetEditFA");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzRuleFormRulesetEditFA");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZRULEFORMRULESETEDITFA"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMRULESETEDITFA","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION @BASECLASS PZRULEFORMRULESETEDITFA #20180713T135447.605 GMT","!PZRULEFORMRULESETEDITFA",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1516545017)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZRULEFORMRULESETEDITFA #20180713T135447.605 GMT:20180713T135447.605 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "0d047191aace5dcebdece71792b079a7";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZRULEFORMRULESETEDITFA",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzRuleFormRulesetEditFA";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzRuleFormRulesetEditFA");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzRuleFormRulesetEditFA");
		...
		AssignActionPage.putString(".pySectionReference", "pzRuleFormRulesetEditFA");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzCopyAppRulesetToTempPage";
				try{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzCopyTempAppRuleset";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZRULEFORMRULESETEDITFA #20180713T135447.605 GMT", "@baseclass pzRuleFormRulesetEditFA", "Pega-Desktop", "08-01-01", "20180713T135447.605 GMT");
}
