...
import java.util.*;
public class ra_action_pzmydelegates_d3ad9cc1c17e8b1f4aef017cdea44e51  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzMyDelegates.Rule_.Action");
	public ra_action_pzmydelegates_d3ad9cc1c17e8b1f4aef017cdea44e51(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE- PZMYDELEGATES #20180713T135456.816 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE- PZMYDELEGATES #20180713T135456.816 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Delegate Rule");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Delegate Rule");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZMYDELEGATES"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZMYDELEGATES","Rule-Obj-FlowAction","RULE-",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION RULE- PZMYDELEGATES #20180713T135456.816 GMT","!PZMYDELEGATES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-333161906)
	};
...
//	RULE-OBJ-FLOWACTION RULE- PZMYDELEGATES #20180713T135456.816 GMT:20180713T135456.816 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "3bdd29a99e8b5743bd8b9d58ea10cddd";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-!PZMYDELEGATES",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzMyDelegates";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Delegate Rule");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Delegate Rule");
		...
		AssignActionPage.putString(".pySectionReference", "pzMyDelegates");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzResetDelegateInputFields";
// Expression: 
			newParamsPage.putString("pyRuleSet", "");
			
// Expression: 
			newParamsPage.putString("pyRuleSetVersion", "");
			...
			strActivityToRun = "pzGetValidEditingExperiences";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzAddRulesToDelegate";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE- PZMYDELEGATES #20180713T135456.816 GMT", "Rule- pzMyDelegates", "Pega-Desktop", "08-01-01", "20180713T135456.816 GMT");
}
