...
import java.util.*;
public class ra_action_pzpropertypanelmodal_1fbc6f02cae7b96143f5eae776ccb475  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzPropertyPanelModal.Data_MO_Activity_Assignment.Action");
	public ra_action_pzpropertypanelmodal_1fbc6f02cae7b96143f5eae776ccb475(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION DATA-MO-ACTIVITY-ASSIGNMENT PZPROPERTYPANELMODAL #20180713T141209.820 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-MO-ACTIVITY-ASSIGNMENT PZPROPERTYPANELMODAL #20180713T141209.820 GMT";
		...
		if (purpose.equals("ADD"))
		{
			...
			tools.putParamValue("pyUsedAs", "LOCALACTION");
		}
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Properties");
		}
		...
		else if (purpose.equals("VALIDATE"))
		{
			...
			if (newAssignPage == null || (newAssignPage != null && !pega_procom_pegaprocomutilities.determineDeferErrors(newAssignPage, workPage)))
			{
				...
				if (!workPageName.equals("tempUCPage"))
				{
					otherPageInTransaction = tools.findPage("tempUCPage");
			...
			if (!workPageName.equals("tempUCPage"))
			{
				...
				if (otherPageInTransaction != null && otherPageInTransaction.hasMessages())
				{
					...
					newParamsPage.putString("pagename", "tempUCPage");
			...
			tools.putParamValue("keepWorkingOnSame", "false");
			tools.putParamValue("keepWorkingOnSameFlow", "");
			tools.putParamValue("keepWorkingOnSameCover", "");
			tools.putParamValue("keepWorkingOnSameWorkBasket", "");
			tools.putParamValue("confirmHarness", "");
		}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZPROPERTYPANELMODAL","Rule-Obj-FlowAction","DATA-MO-ACTIVITY-ASSIGNMENT",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-FLOWACTION DATA-MO-ACTIVITY-ASSIGNMENT PZPROPERTYPANELMODAL #20180713T141209.820 GMT","!PZPROPERTYPANELMODAL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1724361274)
	};
...
//	RULE-OBJ-FLOWACTION DATA-MO-ACTIVITY-ASSIGNMENT PZPROPERTYPANELMODAL #20180713T141209.820 GMT:20180713T141209.820 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "8e330c29355e2008b3113816ada74f89";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-MO-Activity-Assignment";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-MO-ACTIVITY-ASSIGNMENT!PZPROPERTYPANELMODAL",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzPropertyPanelModal";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Properties");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Properties");
		AssignActionPage.putString(".pyActionName", strActionName);
		AssignActionPage.putString(".pyActionNextAssignment", "false");
		AssignActionPage.putString(".pyActionType", strActionType);
		AssignActionPage.putString(".pyHelpType", "DEFINE");
		AssignActionPage.putString(".pySectionReference", "pzPropertyPanelWrapper");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzSetupModal";
// Expression: 
			newParamsPage.putString("flowPage", "");
...
// Expression: 
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzPropertyPanelPostWrapper";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION DATA-MO-ACTIVITY-ASSIGNMENT PZPROPERTYPANELMODAL #20180713T141209.820 GMT", "Data-MO-Activity-Assignment pzPropertyPanelModal", "Pega-ProcessArchitect", "08-01-01", "20180713T141209.820 GMT");
}
