...
import java.util.*;
public class ra_action_pyconfiguration_ec1ab70d2f56b676bbe8e719fde0d346  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pyConfiguration.Data_Decision_Service.Action");
	public ra_action_pyconfiguration_ec1ab70d2f56b676bbe8e719fde0d346(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION DATA-DECISION-SERVICE PYCONFIGURATION #20180713T143446.712 GMT	Pega-DecisionArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-DecisionArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-DECISION-SERVICE PYCONFIGURATION #20180713T143446.712 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Configuration");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Configuration");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PYCONFIGURATION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCONFIGURATION","Rule-Obj-FlowAction","DATA-DECISION-SERVICE",false,"","Pega-DecisionArchitect","08-01-01","RULE-OBJ-FLOWACTION DATA-DECISION-SERVICE PYCONFIGURATION #20180713T143446.712 GMT","!PYCONFIGURATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2016303233)
	};
...
//	RULE-OBJ-FLOWACTION DATA-DECISION-SERVICE PYCONFIGURATION #20180713T143446.712 GMT:20180713T143446.712 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "a0409f90999e25ecbace88b6ae1bb441";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-Decision-Service";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-DECISION-SERVICE!PYCONFIGURATION",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pyConfiguration";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Configuration");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Configuration");
		...
		AssignActionPage.putString(".pySectionReference", "pzConfiguration");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzReloadConfiguration";
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION DATA-DECISION-SERVICE PYCONFIGURATION #20180713T143446.712 GMT", "Data-Decision-Service pyConfiguration", "Pega-DecisionArchitect", "08-01-01", "20180713T143446.712 GMT");
}
