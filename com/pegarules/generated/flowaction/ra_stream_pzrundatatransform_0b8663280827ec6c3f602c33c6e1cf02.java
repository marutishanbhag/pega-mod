...
/**
 * Builds JSP stream WORK-!PZRUNDATATRANSFORM.
 */
public class ra_stream_pzrundatatransform_0b8663280827ec6c3f602c33c6e1cf02 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzRunDataTransform.OLFHF9_Onboaring_Work_Onboarding.Stream");
 ...
 */
	public ra_stream_pzrundatatransform_0b8663280827ec6c3f602c33c6e1cf02(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a8951e7bd6ed8ee797518fa4e7a75f4199386e98";
...
/*
 * Begin RULE-OBJ-FLOWACTION WORK- PZRUNDATATRANSFORM #20230618T001814.056 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-OBJ-FLOWACTION WORK- PZRUNDATATRANSFORM #20230618T001814.056 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-OBJ-FLOWACTION WORK- PZRUNDATATRANSFORM #20230618T001814.056 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
//	RULE-UTILITY-FUNCTION UTILITIES GETRULESYSTEMSETTING #20180713T131444.340 GMT:20180713T131444.340 GMT
	...
	public static String getFUAContentHash() {
		return "8c370e1407a5e8851c7bf376080cee2e";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_1","pzRunDataTransform", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzRunDataTransform";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
tools.putParamValue("flowActionUIRef","pzRunDataTransform"); 
tools.appendString(" ");
...
out.print( pzAuto.getInpectorData("FlowAction", "", "","pzRunDataTransform","Rule-Obj-FlowAction","Work-") );
tools.appendString(" >");
 } 
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
pzPackageRuntime.packageSection("pzRunDataTransform",tools.getStepPage().getReference(), null);
tools.appendString("<div id='section-placeholder' data-class='");
out.print(tools.getStepPage().getString("pxObjClass"));
tools.appendString("' data-section='pzRunDataTransform'></div> ");
} else {
includeSectionBody_1();
}
tools.appendString("<span style=\"display: none;\" uitype=\"Rule-HTML-Section\" id=\"pzFlowActionUITypeRef\" uiref=\"pzRunDataTransform\"></span> ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-OBJ-FLOWACTION WORK- PZRUNDATATRANSFORM #20230618T001814.056 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzRunDataTransform");
