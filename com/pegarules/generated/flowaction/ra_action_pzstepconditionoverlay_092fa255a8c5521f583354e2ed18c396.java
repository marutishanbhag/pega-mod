...
import java.util.*;
public class ra_action_pzstepconditionoverlay_092fa255a8c5521f583354e2ed18c396  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzStepConditionOverlay.Embed_StageProcess.Action");
	public ra_action_pzstepconditionoverlay_092fa255a8c5521f583354e2ed18c396(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION EMBED-STAGEPROCESS PZSTEPCONDITIONOVERLAY #20180924T105538.371 GMT	Pega-ProcessArchitect:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION EMBED-STAGEPROCESS PZSTEPCONDITIONOVERLAY #20180924T105538.371 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Step Condition Overlay");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Step Condition Overlay");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZSTEPCONDITIONOVERLAY"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSTEPCONDITIONOVERLAY","Rule-Obj-FlowAction","EMBED-STAGEPROCESS",false,"","Pega-ProcessArchitect","08-02-01","RULE-OBJ-FLOWACTION EMBED-STAGEPROCESS PZSTEPCONDITIONOVERLAY #20180924T105538.371 GMT","!PZSTEPCONDITIONOVERLAY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1446419801)
	};
...
//	RULE-OBJ-FLOWACTION EMBED-STAGEPROCESS PZSTEPCONDITIONOVERLAY #20180924T105538.371 GMT:20180924T105538.371 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "814405e533b0eb0afea45f71cc26d423";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Embed-StageProcess";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:EMBED-STAGEPROCESS!PZSTEPCONDITIONOVERLAY",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzStepConditionOverlay";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Step Condition Overlay");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Step Condition Overlay");
		...
		AssignActionPage.putString(".pySectionReference", "pzStepConditionOverlay");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pySetWhenGadgetContext";
				try{
			...
			strActivityToRun = "pzPopulateWhenGadgetPage";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzGenerateWhenGadget";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION EMBED-STAGEPROCESS PZSTEPCONDITIONOVERLAY #20180924T105538.371 GMT", "Embed-StageProcess pzStepConditionOverlay", "Pega-ProcessArchitect", "08-02-01", "20180924T105538.371 GMT");
}
