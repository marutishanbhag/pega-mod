...
/**
 * Builds JSP stream DATA-PORTAL!PZSEARCH.
 */
public class ra_stream_pzsearch_9b462b0136982ff02da115eb532e64ba extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzSearch.Data_Portal_DesignerStudio.Stream");
 ...
 */
	public ra_stream_pzsearch_9b462b0136982ff02da115eb532e64ba(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "6e5d09e74156c3fde667a75f8d9cfc501365d576";
...
/*
 * Begin RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCH #20180713T135447.970 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCH #20180713T135447.970 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCH #20180713T135447.970 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "cf8d3931a7d7da950e6bac88b5742d38";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_1","pzSearch", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzSearch";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
tools.putParamValue("flowActionUIRef","pzSearch"); 
tools.appendString(" ");
...
out.print( pzAuto.getInpectorData("FlowAction", "", "","pzSearch","Rule-Obj-FlowAction","Data-Portal") );
tools.appendString(" >");
 } 
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
pzPackageRuntime.packageSection("pzSearch",tools.getStepPage().getReference(), null);
tools.appendString("<div id='section-placeholder' data-class='");
out.print(tools.getStepPage().getString("pxObjClass"));
tools.appendString("' data-section='pzSearch'></div> ");
} else {
includeSectionBody_1();
}
tools.appendString("<span style=\"display: none;\" uitype=\"Rule-HTML-Section\" id=\"pzFlowActionUITypeRef\" uiref=\"pzSearch\"></span> ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCH #20180713T135447.970 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzSearch");
