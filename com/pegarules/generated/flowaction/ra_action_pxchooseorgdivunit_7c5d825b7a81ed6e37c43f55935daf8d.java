...
import java.util.*;
public class ra_action_pxchooseorgdivunit_7c5d825b7a81ed6e37c43f55935daf8d  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pxChooseOrgDivUnit.Data_Admin_Operator_ID.Action");
	public ra_action_pxchooseorgdivunit_7c5d825b7a81ed6e37c43f55935daf8d(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION DATA-ADMIN-OPERATOR-ID PXCHOOSEORGDIVUNIT #20200529T162240.161 GMT	Pega-Desktop:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-ADMIN-OPERATOR-ID PXCHOOSEORGDIVUNIT #20200529T162240.161 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Update Organizational Unit");
		}
		...
		else if (purpose.equals("VALIDATE"))
		{
			...
			if (newAssignPage == null || (newAssignPage != null && !pega_procom_pegaprocomutilities.determineDeferErrors(newAssignPage, workPage)))
			{
				...
				if (!workPageName.equals("ChooseOrgDivUnit"))
				{
					otherPageInTransaction = tools.findPage("ChooseOrgDivUnit");
			...
			if (!workPageName.equals("ChooseOrgDivUnit"))
			{
				...
				if (otherPageInTransaction != null && otherPageInTransaction.hasMessages())
				{
					...
					newParamsPage.putString("pagename", "ChooseOrgDivUnit");
		...
		{
			tools.putParamValue("pzFALabel", "Update Organizational Unit");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PXCHOOSEORGDIVUNIT"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXCHOOSEORGDIVUNIT","Rule-Obj-FlowAction","DATA-ADMIN-OPERATOR-ID",false,"","Pega-Desktop","08-05-01","RULE-OBJ-FLOWACTION DATA-ADMIN-OPERATOR-ID PXCHOOSEORGDIVUNIT #20200529T162240.161 GMT","!PXCHOOSEORGDIVUNIT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1105244406)
	};
...
//	RULE-OBJ-FLOWACTION DATA-ADMIN-OPERATOR-ID PXCHOOSEORGDIVUNIT #20200529T162240.161 GMT:20200529T162240.161 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "037bd2cb1a703089c74d853525677d2e";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-Admin-Operator-ID";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-ADMIN-OPERATOR-ID!PXCHOOSEORGDIVUNIT",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pxChooseOrgDivUnit";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Update Organizational Unit");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Update Organizational Unit");
		...
		AssignActionPage.putString(".pySectionReference", "pzChooseOrgDivUnit");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzChooseOrgDivUnitPreProcessing";
				try{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzChooseOrgDivUnitPostProcessing";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION DATA-ADMIN-OPERATOR-ID PXCHOOSEORGDIVUNIT #20200529T162240.161 GMT", "Data-Admin-Operator-ID pxChooseOrgDivUnit", "Pega-Desktop", "08-05-01", "20200529T162240.161 GMT");
}
