...
import java.util.*;
public class ra_action_pzselectvalues_pickerfa_5a71a4616d9e1738de0051bd4fdcc3c7  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzSelectValues_PickerFA.PegaGadget_SelectValues.Action");
	public ra_action_pzselectvalues_pickerfa_5a71a4616d9e1738de0051bd4fdcc3c7(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION PEGAGADGET-SELECTVALUES PZSELECTVALUES_PICKERFA #20180713T133520.019 GMT	Pega-Gadgets:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Gadgets";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGAGADGET-SELECTVALUES PZSELECTVALUES_PICKERFA #20180713T133520.019 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "SelectValues_PickerFA");
		}
		...
		{
			tools.putParamValue("pzFALabel", "SelectValues_PickerFA");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZSELECTVALUES_PICKERFA"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSELECTVALUES_PICKERFA","Rule-Obj-FlowAction","PEGAGADGET-SELECTVALUES",false,"","Pega-Gadgets","08-01-01","RULE-OBJ-FLOWACTION PEGAGADGET-SELECTVALUES PZSELECTVALUES_PICKERFA #20180713T133520.019 GMT","!PZSELECTVALUES_PICKERFA",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",525468621)
	};
...
//	RULE-OBJ-FLOWACTION PEGAGADGET-SELECTVALUES PZSELECTVALUES_PICKERFA #20180713T133520.019 GMT:20180713T133520.019 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "ec69fb7a89b4b079b64a3cee50a3ba78";
	}

	public String getDefinitionAppliesToClass() {
		return "PegaGadget-SelectValues";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "PegaGadget-SelectValues";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGAGADGET-SELECTVALUES!PZSELECTVALUES_PICKERFA",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzSelectValues_PickerFA";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "SelectValues_PickerFA");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "SelectValues_PickerFA");
		...
		AssignActionPage.putString(".pySectionReference", "pzSelectValues_PickerWrapper");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGAGADGET-SELECTVALUES PZSELECTVALUES_PICKERFA #20180713T133520.019 GMT", "PegaGadget-SelectValues pzSelectValues_PickerFA", "Pega-Gadgets", "08-01-01", "20180713T133520.019 GMT");
}
