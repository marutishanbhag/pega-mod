...
import java.util.*;
public class ra_action_pzshowconditionpreviewfa_ba72bcdbb6eb6d165b2d480e096d2b40  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzShowConditionPreviewFA._baseclass.Action");
	public ra_action_pzshowconditionpreviewfa_ba72bcdbb6eb6d165b2d480e096d2b40(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZSHOWCONDITIONPREVIEWFA #20190226T125818.311 GMT	Pega-ProcessArchitect:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZSHOWCONDITIONPREVIEWFA #20190226T125818.311 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "ShowConditionPreviewFA");
		}
		...
		{
			tools.putParamValue("pzFALabel", "ShowConditionPreviewFA");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZSHOWCONDITIONPREVIEWFA"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSHOWCONDITIONPREVIEWFA","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-ProcessArchitect","08-03-01","RULE-OBJ-FLOWACTION @BASECLASS PZSHOWCONDITIONPREVIEWFA #20190226T125818.311 GMT","!PZSHOWCONDITIONPREVIEWFA",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-342929014)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZSHOWCONDITIONPREVIEWFA #20190226T125818.311 GMT:20190226T125818.311 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "46bfdfe07e89cd39e99ccfa4af4a3a1b";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZSHOWCONDITIONPREVIEWFA",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzShowConditionPreviewFA";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "ShowConditionPreviewFA");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "ShowConditionPreviewFA");
		...
		AssignActionPage.putString(".pySectionReference", "pzShowConditionPreview");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZSHOWCONDITIONPREVIEWFA #20190226T125818.311 GMT", "@baseclass pzShowConditionPreviewFA", "Pega-ProcessArchitect", "08-03-01", "20190226T125818.311 GMT");
}
