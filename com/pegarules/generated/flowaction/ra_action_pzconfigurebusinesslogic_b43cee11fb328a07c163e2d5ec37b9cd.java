...
import java.util.*;
public class ra_action_pzconfigurebusinesslogic_b43cee11fb328a07c163e2d5ec37b9cd  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzConfigureBusinessLogic._baseclass.Action");
	public ra_action_pzconfigurebusinesslogic_b43cee11fb328a07c163e2d5ec37b9cd(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZCONFIGUREBUSINESSLOGIC #20220228T160351.061 GMT	Pega-ProcessArchitect:08-08-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZCONFIGUREBUSINESSLOGIC #20220228T160351.061 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Business logic");
		}
		...
		else if (purpose.equals("VALIDATE"))
		{
			...
			if (newAssignPage == null || (newAssignPage != null && !pega_procom_pegaprocomutilities.determineDeferErrors(newAssignPage, workPage)))
			{
				...
				if (!workPageName.equals("DecisionTreePageBackup"))
				{
					otherPageInTransaction = tools.findPage("DecisionTreePageBackup");
			...
			if (!workPageName.equals("DecisionTreePageBackup"))
			{
				...
				if (otherPageInTransaction != null && otherPageInTransaction.hasMessages())
				{
					...
					newParamsPage.putString("pagename", "DecisionTreePageBackup");
		...
		{
			tools.putParamValue("pzFALabel", "Business logic");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZCONFIGUREBUSINESSLOGIC", 
	"Rule-Obj-Property:PYTARGETPROPERTYLABEL"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCONFIGUREBUSINESSLOGIC","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-ProcessArchitect","08-08-01","RULE-OBJ-FLOWACTION @BASECLASS PZCONFIGUREBUSINESSLOGIC #20220228T160351.061 GMT","!PZCONFIGUREBUSINESSLOGIC",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1877567632), 
		new DependentRuleInfo("PYTARGETPROPERTYLABEL","Rule-Obj-Property","@BASECLASS",true,"@baseclass","Pega-ProcessArchitect","08-06-01","RULE-OBJ-PROPERTY @BASECLASS PYTARGETPROPERTYLABEL #20201218T230950.631 GMT","!PYTARGETPROPERTYLABEL",true,false,"ABSOLUTE_IS_NOT_PRIMARY",0)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZCONFIGUREBUSINESSLOGIC #20220228T160351.061 GMT:20220228T160351.061 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTARGETPROPERTYLABEL #20201218T230950.631 GMT:20201218T230950.631 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "11cad183d09c1714c5b8f2fbc5df64ac";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZCONFIGUREBUSINESSLOGIC",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzConfigureBusinessLogic";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Business logic");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Business logic");
		...
		AssignActionPage.putString(".pySectionReference", "pzBusinessLogicConditions");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzPreprocessingForBusinessLogic";
				try{
					tools.applyModel(tools.getStepPage(), newParamsPage, strTransform);
				...
				workPage.addMessage("Flow_PreTransformProcessFail\t" + strTransform + "\t" + e.getMessage(), "pyMessageLabel", "@baseclass");
				tools.putParamValue("pyErrorMessage", errorMessage);
				tools.putParamValue("pyStackTrace", pega_rules_utilities.getStackTrace(e));
				}
				
			strActivityToRun = "pzPreprocessingForBusinessLogic";
// Expression: .pyTargetPropertyLabel
			newParamsPage.putString("BusinessLogicRuleName", scalarValueQuery_1.resolveToString(tools, myStepPage, ImmutablePropertyInfo.TYPE_TEXT));
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzPostprocessingForBusinessLogic";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final ScalarValueQuery scalarValueQuery_1 = FUAUtil.createQueryBuilder().allowMissingPropertyException().scalarProperty("pyTargetPropertyLabel").buildScalarValueQuery();

private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZCONFIGUREBUSINESSLOGIC #20220228T160351.061 GMT", "@baseclass pzConfigureBusinessLogic", "Pega-ProcessArchitect", "08-08-01", "20220228T160351.061 GMT");
}
