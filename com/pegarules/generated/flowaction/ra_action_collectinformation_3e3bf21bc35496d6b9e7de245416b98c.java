...
import java.util.*;
public class ra_action_collectinformation_3e3bf21bc35496d6b9e7de245416b98c  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.CollectInformation.OFON2J_ProcessO_Work_Onboarding.Action");
	public ra_action_collectinformation_3e3bf21bc35496d6b9e7de245416b98c(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION #20260223T094638.614 GMT	ProcessO:01-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		...
		mRuleSet = "ProcessO";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION #20260223T094638.614 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Collect Information");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Collect Information");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "b09cd732a787ff3023155544a3136121";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "OFON2J-ProcessO-Work-Onboarding";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:OFON2J-PROCESSO-WORK-ONBOARDING!COLLECTINFORMATION",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "CollectInformation";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Collect Information");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Collect Information");
		...
		AssignActionPage.putString(".pySectionReference", "CollectInformation");
