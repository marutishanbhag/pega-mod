...
import java.util.*;
public class ra_action_pzconfigurepicklistoptions_deb8ca7bf9c9cf864e03ad2113cfe957  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzConfigurePicklistOptions.Embed_Fields.Action");
	public ra_action_pzconfigurepicklistoptions_deb8ca7bf9c9cf864e03ad2113cfe957(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION EMBED-FIELDS PZCONFIGUREPICKLISTOPTIONS #20180713T141210.305 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION EMBED-FIELDS PZCONFIGUREPICKLISTOPTIONS #20180713T141210.305 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Configure picklist options in fields modal");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Configure picklist options in fields modal");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZCONFIGUREPICKLISTOPTIONS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCONFIGUREPICKLISTOPTIONS","Rule-Obj-FlowAction","EMBED-FIELDS",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-FLOWACTION EMBED-FIELDS PZCONFIGUREPICKLISTOPTIONS #20180713T141210.305 GMT","!PZCONFIGUREPICKLISTOPTIONS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1696393839)
	};
...
//	RULE-OBJ-FLOWACTION EMBED-FIELDS PZCONFIGUREPICKLISTOPTIONS #20180713T141210.305 GMT:20180713T141210.305 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "c64e81f3deb6826c7626f22228cb6484";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Embed-Fields";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:EMBED-FIELDS!PZCONFIGUREPICKLISTOPTIONS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzConfigurePicklistOptions";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Configure picklist options in fields modal");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Configure picklist options in fields modal");
		...
		AssignActionPage.putString(".pySectionReference", "pzConfigurePicklistOptions");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzConfigurePicklistOptionsPreProcessing";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzConfigurePicklistOptionsPostProcessing";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION EMBED-FIELDS PZCONFIGUREPICKLISTOPTIONS #20180713T141210.305 GMT", "Embed-Fields pzConfigurePicklistOptions", "Pega-ProcessArchitect", "08-01-01", "20180713T141210.305 GMT");
}
