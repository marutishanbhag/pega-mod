...
import java.util.*;
public class ra_action_pxrefactorrulesetstools_0a24615f9d1e22bc9af3e1f01ecccddd  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pxRefactorRulesetsTools.Pega_Landing_System_RefactorRulesets.Action");
	public ra_action_pxrefactorrulesetstools_0a24615f9d1e22bc9af3e1f01ecccddd(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION PEGA-LANDING-SYSTEM-REFACTORRULESETS PXREFACTORRULESETSTOOLS #20180713T142957.584 GMT	Pega-LP-SystemSettings:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-LANDING-SYSTEM-REFACTORRULESETS PXREFACTORRULESETSTOOLS #20180713T142957.584 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pxRefactorRulesetsTools");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pxRefactorRulesetsTools");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "3a1ac769ad29b3c02c1ec1ee4d070cb6";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-Landing-System-RefactorRulesets";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-LANDING-SYSTEM-REFACTORRULESETS!PXREFACTORRULESETSTOOLS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pxRefactorRulesetsTools";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pxRefactorRulesetsTools");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pxRefactorRulesetsTools");
		...
		AssignActionPage.putString(".pySectionReference", "pxLPSystemRefactorRulesets");
