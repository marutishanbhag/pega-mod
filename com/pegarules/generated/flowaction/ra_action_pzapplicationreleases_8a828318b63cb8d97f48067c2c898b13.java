...
import java.util.*;
public class ra_action_pzapplicationreleases_8a828318b63cb8d97f48067c2c898b13  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzApplicationReleases.Rule_Application.Action");
	public ra_action_pzapplicationreleases_8a828318b63cb8d97f48067c2c898b13(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONRELEASES #20180713T142626.580 GMT	Pega-LP-Application:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-LP-Application";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONRELEASES #20180713T142626.580 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Releases");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Releases");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZAPPLICATIONRELEASES"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPLICATIONRELEASES","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-LP-Application","08-01-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONRELEASES #20180713T142626.580 GMT","!PZAPPLICATIONRELEASES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",902870824)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONRELEASES #20180713T142626.580 GMT:20180713T142626.580 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "89094b15acfc6abf832ae92ed8842621";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZAPPLICATIONRELEASES",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzApplicationReleases";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Releases");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Releases");
		...
		AssignActionPage.putString(".pySectionReference", "pzReleasesContainer");
...
// Expression: "Releases"
			newParamsPage.putString("editedSection", "Releases");
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONRELEASES #20180713T142626.580 GMT", "Rule-Application pzApplicationReleases", "Pega-LP-Application", "08-01-01", "20180713T142626.580 GMT");
}
