...
import java.util.*;
public class ra_action_pzdisablemodelrow_ad0afbee4994d647ae57bf28f5994aee  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzDisableModelRow.Embed_ModelParams.Action");
	public ra_action_pzdisablemodelrow_ad0afbee4994d647ae57bf28f5994aee(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION EMBED-MODELPARAMS PZDISABLEMODELROW #20180713T135451.806 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION EMBED-MODELPARAMS PZDISABLEMODELROW #20180713T135451.806 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzTestertestlytest");
		}
		...
		{
			tools.putParamValue("StreamType", "NO_UI");
			tools.putParamValue("pyUsedAs", "LOCALANDCONNECTOR");
		}
		else if (purpose.equals("GETLABEL"))
		{
			tools.putParamValue("pzFALabel", "pzTestertestlytest");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZDISABLEMODELROW"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZDISABLEMODELROW","Rule-Obj-FlowAction","EMBED-MODELPARAMS",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION EMBED-MODELPARAMS PZDISABLEMODELROW #20180713T135451.806 GMT","!PZDISABLEMODELROW",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1743021376)
	};
...
//	RULE-OBJ-FLOWACTION EMBED-MODELPARAMS PZDISABLEMODELROW #20180713T135451.806 GMT:20180713T135451.806 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "4275ef499abd67dff7fc32d512b5402d";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Embed-ModelParams";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:EMBED-MODELPARAMS!PZDISABLEMODELROW",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzDisableModelRow";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzTestertestlytest");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzTestertestlytest");
		...
		AssignActionPage.putString(".pyStreamType", "NO_UI");
		AssignActionPage.putString(".pyOldStreamType", "NO_UI");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzEnableDisableModelRow";
// Expression: true
String pz_1 = String.valueOf(true);
			newParamsPage.putString("disableRow", pz_1);
	...
	{
		// This FlowAction uses a separate html rule; nothing to validate here
		return true;
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION EMBED-MODELPARAMS PZDISABLEMODELROW #20180713T135451.806 GMT", "Embed-ModelParams pzDisableModelRow", "Pega-Desktop", "08-01-01", "20180713T135451.806 GMT");
}
