...
import java.util.*;
public class ra_action_pyworkgroupbasketsshowall_0c76755a055943c99acd7d38cf86925e  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pyWorkGroupBasketsShowAll.Data_Portal.Action");
	public ra_action_pyworkgroupbasketsshowall_0c76755a055943c99acd7d38cf86925e(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION DATA-PORTAL PYWORKGROUPBASKETSSHOWALL #20180713T134919.602 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-EndUserUI";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-PORTAL PYWORKGROUPBASKETSSHOWALL #20180713T134919.602 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Work Group Baskets");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Work Group Baskets");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PYWORKGROUPBASKETSSHOWALL"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYWORKGROUPBASKETSSHOWALL","Rule-Obj-FlowAction","DATA-PORTAL",false,"","Pega-EndUserUI","08-01-01","RULE-OBJ-FLOWACTION DATA-PORTAL PYWORKGROUPBASKETSSHOWALL #20180713T134919.602 GMT","!PYWORKGROUPBASKETSSHOWALL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",984837115)
	};
...
//	RULE-OBJ-FLOWACTION DATA-PORTAL PYWORKGROUPBASKETSSHOWALL #20180713T134919.602 GMT:20180713T134919.602 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "9d82361adaa0966975e46c8642758f61";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-Portal";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-PORTAL!PYWORKGROUPBASKETSSHOWALL",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pyWorkGroupBasketsShowAll";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Work Group Baskets");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Work Group Baskets");
		...
		AssignActionPage.putString(".pySectionReference", "pyWorkGroupBasketsShowAll");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION DATA-PORTAL PYWORKGROUPBASKETSSHOWALL #20180713T134919.602 GMT", "Data-Portal pyWorkGroupBasketsShowAll", "Pega-EndUserUI", "08-01-01", "20180713T134919.602 GMT");
}
