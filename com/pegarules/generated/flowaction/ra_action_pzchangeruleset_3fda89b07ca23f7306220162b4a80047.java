...
import java.util.*;
public class ra_action_pzchangeruleset_3fda89b07ca23f7306220162b4a80047  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzChangeRuleset._baseclass.Action");
	public ra_action_pzchangeruleset_3fda89b07ca23f7306220162b4a80047(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZCHANGERULESET #20180713T135447.514 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZCHANGERULESET #20180713T135447.514 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Change Ruleset");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Change Ruleset");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZCHANGERULESET"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCHANGERULESET","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION @BASECLASS PZCHANGERULESET #20180713T135447.514 GMT","!PZCHANGERULESET",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1787791876)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZCHANGERULESET #20180713T135447.514 GMT:20180713T135447.514 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "37a5bd316d41f9cb1078fd9ee03beec6";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZCHANGERULESET",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzChangeRuleset";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Change Ruleset");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Change Ruleset");
		...
		AssignActionPage.putString(".pySectionReference", "pzChangeRuleset");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZCHANGERULESET #20180713T135447.514 GMT", "@baseclass pzChangeRuleset", "Pega-Desktop", "08-01-01", "20180713T135447.514 GMT");
}
