...
import java.util.*;
public class ra_action_pzattachmentsfa_e0b8a817d04f1c67026afe12b844c0e0  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAttachmentsFA.Rule_Application.Action");
	public ra_action_pzattachmentsfa_e0b8a817d04f1c67026afe12b844c0e0(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZATTACHMENTSFA #20180713T142626.592 GMT	Pega-LP-Application:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-LP-Application";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZATTACHMENTSFA #20180713T142626.592 GMT";
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZATTACHMENTSFA"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZATTACHMENTSFA","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-LP-Application","08-01-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZATTACHMENTSFA #20180713T142626.592 GMT","!PZATTACHMENTSFA",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1003877722)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZATTACHMENTSFA #20180713T142626.592 GMT:20180713T142626.592 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "d5fbbc043fd8bdbc51cf7167ca8909b1";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZATTACHMENTSFA",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzAttachmentsFA";
		...
		AssignActionPage.putString(".pySectionReference", "pzAttachmentsInnerSection");
...
// Expression: Attachments
			newParamsPage.putString("editedSection", "Attachments");
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZATTACHMENTSFA #20180713T142626.592 GMT", "Rule-Application pzAttachmentsFA", "Pega-LP-Application", "08-01-01", "20180713T142626.592 GMT");
}
