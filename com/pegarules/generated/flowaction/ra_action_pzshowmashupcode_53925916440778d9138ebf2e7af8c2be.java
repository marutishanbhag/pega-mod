...
import java.util.*;
public class ra_action_pzshowmashupcode_53925916440778d9138ebf2e7af8c2be  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzShowMashupCode.Data_Channel_Mashup.Action");
	public ra_action_pzshowmashupcode_53925916440778d9138ebf2e7af8c2be(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION DATA-CHANNEL-MASHUP PZSHOWMASHUPCODE #20190320T064539.222 GMT	Pega-ProcessCommander:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessCommander";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-CHANNEL-MASHUP PZSHOWMASHUPCODE #20190320T064539.222 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Mashup code");
		}
		...
		else if (purpose.equals("VALIDATE"))
		{
			...
			if (newAssignPage == null || (newAssignPage != null && !pega_procom_pegaprocomutilities.determineDeferErrors(newAssignPage, workPage)))
			{
				...
				if (!workPageName.equals("D_pzMashupChannel"))
				{
					otherPageInTransaction = tools.findPage("D_pzMashupChannel");
			...
			if (!workPageName.equals("D_pzMashupChannel"))
			{
				...
				if (otherPageInTransaction != null && otherPageInTransaction.hasMessages())
				{
					...
					newParamsPage.putString("pagename", "D_pzMashupChannel");
		...
		{
			tools.putParamValue("pzFALabel", "Mashup code");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZSHOWMASHUPCODE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSHOWMASHUPCODE","Rule-Obj-FlowAction","DATA-CHANNEL-MASHUP",false,"","Pega-ProcessCommander","08-03-01","RULE-OBJ-FLOWACTION DATA-CHANNEL-MASHUP PZSHOWMASHUPCODE #20190320T064539.222 GMT","!PZSHOWMASHUPCODE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",65871128)
	};
...
//	RULE-OBJ-FLOWACTION DATA-CHANNEL-MASHUP PZSHOWMASHUPCODE #20190320T064539.222 GMT:20190417T154434.091 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "aa23f9f44c89fec6249fa09dea319312";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-Channel-Mashup";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-CHANNEL-MASHUP!PZSHOWMASHUPCODE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzShowMashupCode";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Mashup code");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Mashup code");
		...
		AssignActionPage.putString(".pySectionReference", "pzDisplayMashupCode");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzRegenerateMashupFromPreview";
// Expression: 
			newParamsPage.putString("contextPage", "");
			
// Expression: false
String pz_1 = String.valueOf(false);
			newParamsPage.putString("PreviewOnly", pz_1);
			
// Expression: 
			newParamsPage.putString("ActStepPage", "");
			
// Expression: 
			newParamsPage.putString("myvalue", "");
			
// Expression: 
			newParamsPage.putString("channelID", "");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION DATA-CHANNEL-MASHUP PZSHOWMASHUPCODE #20190320T064539.222 GMT", "Data-Channel-Mashup pzShowMashupCode", "Pega-ProcessCommander", "08-03-01", "20190417T154434.091 GMT");
}
