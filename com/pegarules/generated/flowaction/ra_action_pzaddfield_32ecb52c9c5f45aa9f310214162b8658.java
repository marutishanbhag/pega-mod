...
import java.util.*;
public class ra_action_pzaddfield_32ecb52c9c5f45aa9f310214162b8658  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAddField.Pega_DataModel_Manage.Action");
	public ra_action_pzaddfield_32ecb52c9c5f45aa9f310214162b8658(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION PEGA-DATAMODEL-MANAGE PZADDFIELD #20200303T234426.760 GMT	Pega-ProcessArchitect:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-DATAMODEL-MANAGE PZADDFIELD #20200303T234426.760 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Add field");
		}
		...
		else if (purpose.equals("VALIDATE"))
		{
			...
			if (newAssignPage == null || (newAssignPage != null && !pega_procom_pegaprocomutilities.determineDeferErrors(newAssignPage, workPage)))
			{
				...
				if (!workPageName.equals("pyTempFieldPageContainer"))
				{
					otherPageInTransaction = tools.findPage("pyTempFieldPageContainer");
			...
			if (!workPageName.equals("pyTempFieldPageContainer"))
			{
				...
				if (otherPageInTransaction != null && otherPageInTransaction.hasMessages())
				{
					...
					newParamsPage.putString("pagename", "pyTempFieldPageContainer");
		...
		{
			tools.putParamValue("pzFALabel", "Add field");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZADDFIELD"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZADDFIELD","Rule-Obj-FlowAction","PEGA-DATAMODEL-MANAGE",false,"","Pega-ProcessArchitect","08-05-01","RULE-OBJ-FLOWACTION PEGA-DATAMODEL-MANAGE PZADDFIELD #20200303T234426.760 GMT","!PZADDFIELD",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1824040233)
	};
...
//	RULE-OBJ-FLOWACTION PEGA-DATAMODEL-MANAGE PZADDFIELD #20200303T234426.760 GMT:20200605T124948.767 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "a3c96ac2eb6ca9f1fefafc0b00e786c8";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-DataModel-Manage";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-DATAMODEL-MANAGE!PZADDFIELD",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzAddField";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Add field");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Add field");
		...
		AssignActionPage.putString(".pySectionReference", "pzAddField");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzAddFieldPreProcessing";
// Expression: false
String pz_1 = String.valueOf(false);
			newParamsPage.putString("AddAnother", pz_1);
			
// Expression: 
			newParamsPage.putString("Mode", "");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGA-DATAMODEL-MANAGE PZADDFIELD #20200303T234426.760 GMT", "Pega-DataModel-Manage pzAddField", "Pega-ProcessArchitect", "08-05-01", "20200605T124948.767 GMT");
}
