...
import java.util.*;
public class ra_action_pzaccessgroupsroles_c2a82f655bf2fb9949ffeb96f696b927  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAccessGroupsRoles.Embed_Desktop_ValueList_AccessGroups.Action");
	public ra_action_pzaccessgroupsroles_c2a82f655bf2fb9949ffeb96f696b927(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION EMBED-DESKTOP-VALUELIST-ACCESSGROUPS PZACCESSGROUPSROLES #20180713T135448.127 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION EMBED-DESKTOP-VALUELIST-ACCESSGROUPS PZACCESSGROUPSROLES #20180713T135448.127 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzAccessGroupsRoles");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzAccessGroupsRoles");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "acfbeaf494b5fb4397fcc344c64b666b";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Embed-Desktop-ValueList-AccessGroups";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:EMBED-DESKTOP-VALUELIST-ACCESSGROUPS!PZACCESSGROUPSROLES",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzAccessGroupsRoles";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzAccessGroupsRoles");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzAccessGroupsRoles");
		...
		AssignActionPage.putString(".pySectionReference", "pzAccessGroupsRoles");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzAccessGroupRoles";
			try {
