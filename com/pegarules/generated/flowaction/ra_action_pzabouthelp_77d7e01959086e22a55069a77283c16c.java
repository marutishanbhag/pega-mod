...
import java.util.*;
public class ra_action_pzabouthelp_77d7e01959086e22a55069a77283c16c  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAboutHelp._baseclass.Action");
	public ra_action_pzabouthelp_77d7e01959086e22a55069a77283c16c(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZABOUTHELP #20180713T135447.494 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZABOUTHELP #20180713T135447.494 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "About Process Commander");
		}
		...
		{
			tools.putParamValue("pzFALabel", "About Process Commander");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "7749d12c2065e00f6b0ccbf6b8971c52";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZABOUTHELP",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzAboutHelp";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "About Process Commander");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "About Process Commander");
		...
		AssignActionPage.putString(".pySectionReference", "pzAboutHelp");
