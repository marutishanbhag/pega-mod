...
import java.util.*;
public class ra_action_pzappexplorerpinnedclasses_0ad1b652a884aa0f36243744dcf00192  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAppExplorerPinnedClasses.Code_Pega_List.Action");
	public ra_action_pzappexplorerpinnedclasses_0ad1b652a884aa0f36243744dcf00192(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION CODE-PEGA-LIST PZAPPEXPLORERPINNEDCLASSES #20180713T135447.738 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION CODE-PEGA-LIST PZAPPEXPLORERPINNEDCLASSES #20180713T135447.738 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Pin multiple classes");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Pin multiple classes");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZAPPEXPLORERPINNEDCLASSES"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPEXPLORERPINNEDCLASSES","Rule-Obj-FlowAction","CODE-PEGA-LIST",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION CODE-PEGA-LIST PZAPPEXPLORERPINNEDCLASSES #20180713T135447.738 GMT","!PZAPPEXPLORERPINNEDCLASSES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1216661720)
	};
...
//	RULE-OBJ-FLOWACTION CODE-PEGA-LIST PZAPPEXPLORERPINNEDCLASSES #20180713T135447.738 GMT:20180713T135447.738 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "7217879b0b668afe45a6c425d0a8a08d";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Code-Pega-List";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:CODE-PEGA-LIST!PZAPPEXPLORERPINNEDCLASSES",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzAppExplorerPinnedClasses";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Pin multiple classes");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Pin multiple classes");
		...
		AssignActionPage.putString(".pySectionReference", "pzAppExplorerPinnedClasses");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzPinnedClassesModalPreProcessing";
				try{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzPinnedClassesPostProcessing";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION CODE-PEGA-LIST PZAPPEXPLORERPINNEDCLASSES #20180713T135447.738 GMT", "Code-Pega-List pzAppExplorerPinnedClasses", "Pega-Desktop", "08-01-01", "20180713T135447.738 GMT");
}
