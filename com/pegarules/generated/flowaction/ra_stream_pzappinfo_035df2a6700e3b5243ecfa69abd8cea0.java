...
/**
 * Builds JSP stream RULE-APPLICATION!PZAPPINFO.
 */
public class ra_stream_pzappinfo_035df2a6700e3b5243ecfa69abd8cea0 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAppInfo.Rule_Application.Stream");
 ...
 */
	public ra_stream_pzappinfo_035df2a6700e3b5243ecfa69abd8cea0(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "86b17e2f802ddc5a257db1349947ad5c5c5d2c9f";
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPINFO #20201028T080713.542 GMT	Pega-LP:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPINFO #20201028T080713.542 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPINFO #20201028T080713.542 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPINFO #20201028T080713.542 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPINFO","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-LP","08-06-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPINFO #20201028T080713.542 GMT","!PZAPPINFO",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-821396894)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPINFO #20201028T080713.542 GMT:20201028T080713.542 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "10b9033d3d8494f25d3cb22c5738e9f4";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_1","pzAppInfo", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzAppInfo";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
tools.putParamValue("flowActionUIRef","pzAppInfo"); 
tools.appendString(" ");
...
out.print( pzAuto.getInpectorData("FlowAction", "", "","pzAppInfo","Rule-Obj-FlowAction","Rule-Application") );
tools.appendString(" >");
 } 
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
pzPackageRuntime.packageSection("pzAppInfo",tools.getStepPage().getReference(), null);
tools.appendString("<div id='section-placeholder' data-class='");
out.print(tools.getStepPage().getString("pxObjClass"));
tools.appendString("' data-section='pzAppInfo'></div> ");
} else {
includeSectionBody_1();
}
tools.appendString("<span style=\"display: none;\" uitype=\"Rule-HTML-Section\" id=\"pzFlowActionUITypeRef\" uiref=\"pzAppInfo\"></span> ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPINFO #20201028T080713.542 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzAppInfo");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPINFO #20201028T080713.542 GMT", "Rule-Application pzAppInfo", "Pega-LP", "08-06-01", "20201028T080713.542 GMT");
}
