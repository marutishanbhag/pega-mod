...
import java.util.*;
public class ra_action_pxserviceslp_c8bb0e17c9ba3a65035dbbdbac30de03  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pxServicesLP.Pega_Landing_Decision_Services.Action");
	public ra_action_pxserviceslp_c8bb0e17c9ba3a65035dbbdbac30de03(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION PEGA-LANDING-DECISION-SERVICES PXSERVICESLP #20180713T143450.662 GMT	Pega-DecisionArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mRuleSet = "Pega-DecisionArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-LANDING-DECISION-SERVICES PXSERVICESLP #20180713T143450.662 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Services LP");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Services LP");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "c6359992c889cf14c9a366766ba1b780";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-Landing-Decision-Services";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-LANDING-DECISION-SERVICES!PXSERVICESLP",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pxServicesLP";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Services LP");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Services LP");
		...
		AssignActionPage.putString(".pySectionReference", "pxServicesLP");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzLoadServicesLP";
			try {
