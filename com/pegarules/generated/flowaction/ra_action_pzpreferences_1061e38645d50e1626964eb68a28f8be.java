...
import java.util.*;
public class ra_action_pzpreferences_1061e38645d50e1626964eb68a28f8be  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzPreferences.Data_Portal.Action");
	public ra_action_pzpreferences_1061e38645d50e1626964eb68a28f8be(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION DATA-PORTAL PZPREFERENCES #20180713T135447.959 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-PORTAL PZPREFERENCES #20180713T135447.959 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Preferences");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Preferences");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZPREFERENCES"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZPREFERENCES","Rule-Obj-FlowAction","DATA-PORTAL",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION DATA-PORTAL PZPREFERENCES #20180713T135447.959 GMT","!PZPREFERENCES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",977931662)
	};
...
//	RULE-OBJ-FLOWACTION DATA-PORTAL PZPREFERENCES #20180713T135447.959 GMT:20180713T135447.959 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "5892c66c83c097a1fe1088860f17568d";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-Portal";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-PORTAL!PZPREFERENCES",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzPreferences";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Preferences");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Preferences");
		...
		AssignActionPage.putString(".pySectionReference", "pzPreferencesOuter");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzGetCurrentOperatorPreferences";
				try{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "SaveDeveloperPreferences";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION DATA-PORTAL PZPREFERENCES #20180713T135447.959 GMT", "Data-Portal pzPreferences", "Pega-Desktop", "08-01-01", "20180713T135447.959 GMT");
}
