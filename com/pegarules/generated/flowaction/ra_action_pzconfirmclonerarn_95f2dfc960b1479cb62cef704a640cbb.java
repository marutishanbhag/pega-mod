...
import java.util.*;
public class ra_action_pzconfirmclonerarn_95f2dfc960b1479cb62cef704a640cbb  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzConfirmCloneRARN.Rule_Access_Role_Name.Action");
	public ra_action_pzconfirmclonerarn_95f2dfc960b1479cb62cef704a640cbb(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-NAME PZCONFIRMCLONERARN #20180713T135452.732 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-NAME PZCONFIRMCLONERARN #20180713T135452.732 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Clone Access Role Name");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Clone Access Role Name");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZCONFIRMCLONERARN"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCONFIRMCLONERARN","Rule-Obj-FlowAction","RULE-ACCESS-ROLE-NAME",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-NAME PZCONFIRMCLONERARN #20180713T135452.732 GMT","!PZCONFIRMCLONERARN",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",367832855)
	};
...
//	RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-NAME PZCONFIRMCLONERARN #20180713T135452.732 GMT:20180713T135452.732 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "c9fa06da1034379a94279f8238393db7";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Access-Role-Name";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-ACCESS-ROLE-NAME!PZCONFIRMCLONERARN",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzConfirmCloneRARN";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Clone Access Role Name");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Clone Access Role Name");
		...
		AssignActionPage.putString(".pySectionReference", "pzRARNCloneConfirm");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzValidateCloneFrom";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzREPerformBulkSaveAs";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-NAME PZCONFIRMCLONERARN #20180713T135452.732 GMT", "Rule-Access-Role-Name pzConfirmCloneRARN", "Pega-Desktop", "08-01-01", "20180713T135452.732 GMT");
}
