...
import java.util.*;
public class ra_action_pzgeneratedocumentsinexpress_1b3a9c9652566840a92f6915a2171900  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzGenerateDocumentsInExpress.Rule_Application.Action");
	public ra_action_pzgeneratedocumentsinexpress_1b3a9c9652566840a92f6915a2171900(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZGENERATEDOCUMENTSINEXPRESS #20190325T110340.107 GMT	Pega-LP-Application:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-LP-Application";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZGENERATEDOCUMENTSINEXPRESS #20190325T110340.107 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Generate overview document");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Generate overview document");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZGENERATEDOCUMENTSINEXPRESS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZGENERATEDOCUMENTSINEXPRESS","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-LP-Application","08-03-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZGENERATEDOCUMENTSINEXPRESS #20190325T110340.107 GMT","!PZGENERATEDOCUMENTSINEXPRESS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",552132800)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZGENERATEDOCUMENTSINEXPRESS #20190325T110340.107 GMT:20190430T125119.932 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "14f34aeda6c094f9613a0a3cfc82fe21";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZGENERATEDOCUMENTSINEXPRESS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzGenerateDocumentsInExpress";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Generate overview document");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Generate overview document");
		...
		AssignActionPage.putString(".pySectionReference", "pzAppMenuActionModalExpress");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzInitializeAppActionMenuModalExpress";
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZGENERATEDOCUMENTSINEXPRESS #20190325T110340.107 GMT", "Rule-Application pzGenerateDocumentsInExpress", "Pega-LP-Application", "08-03-01", "20190430T125119.932 GMT");
}
