...
import java.util.*;
public class ra_action_pyclosecase_47f97bb10052aa55b270f797b082b742  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pyCloseCase.Work_.Action");
	public ra_action_pyclosecase_47f97bb10052aa55b270f797b082b742(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION WORK- PYCLOSECASE #20230618T002052.592 GMT	Pega-EndUserUI:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-EndUserUI";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION WORK- PYCLOSECASE #20230618T002052.592 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Close case");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Close case");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PYCLOSECASE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCLOSECASE","Rule-Obj-FlowAction","WORK-",false,"","Pega-EndUserUI","08-23-01","RULE-OBJ-FLOWACTION WORK- PYCLOSECASE #20230618T002052.592 GMT","!PYCLOSECASE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1214050266)
	};
...
//	RULE-OBJ-FLOWACTION WORK- PYCLOSECASE #20230618T002052.592 GMT:20230618T002052.592 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "260038ab25f337564c3c901a54935d76";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Work-";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:WORK-!PYCLOSECASE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pyCloseCase";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Close case");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Close case");
		...
		AssignActionPage.putString(".pySectionReference", "pyCloseCase");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION WORK- PYCLOSECASE #20230618T002052.592 GMT", "Work- pyCloseCase", "Pega-EndUserUI", "08-23-01", "20230618T002052.592 GMT");
}
