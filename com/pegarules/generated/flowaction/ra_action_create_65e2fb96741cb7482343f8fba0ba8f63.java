...
import java.util.*;
public class ra_action_create_65e2fb96741cb7482343f8fba0ba8f63  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.Create.Work_.Action");
	public ra_action_create_65e2fb96741cb7482343f8fba0ba8f63(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION WORK- CREATE #20210212T134036.356 GMT	Pega-EndUserUI:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION WORK- CREATE #20210212T134036.356 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Create");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Create");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "f30984f5589394e0cf421f68d1f4b181";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Work-";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:WORK-!CREATE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	private boolean AddFlowAction_circum0(String strActionType, ClipboardPage newAssignPage, boolean isSelectedAction, boolean displaySeparatorAbove)
	{
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Create");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Create");
		...
		AssignActionPage.putString(".pySectionReference", "Create");
