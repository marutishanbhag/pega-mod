...
import java.util.*;
public class ra_action_pzfeatureselectorforsearch_0a9295957bd16b4a6f62a92b9583af9a  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzFeatureSelectorForSearch.Rule_Application.Action");
	public ra_action_pzfeatureselectorforsearch_0a9295957bd16b4a6f62a92b9583af9a(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZFEATURESELECTORFORSEARCH #20180713T142026.916 GMT	Pega-AppDefinition:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-AppDefinition";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZFEATURESELECTORFORSEARCH #20180713T142026.916 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzFeatureSelectorForSearch");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzFeatureSelectorForSearch");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZFEATURESELECTORFORSEARCH"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZFEATURESELECTORFORSEARCH","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-AppDefinition","08-01-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZFEATURESELECTORFORSEARCH #20180713T142026.916 GMT","!PZFEATURESELECTORFORSEARCH",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1050598793)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZFEATURESELECTORFORSEARCH #20180713T142026.916 GMT:20180713T142026.916 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "b9e7da1fde472aaa60438fa3c24098b1";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZFEATURESELECTORFORSEARCH",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzFeatureSelectorForSearch";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzFeatureSelectorForSearch");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzFeatureSelectorForSearch");
		...
		AssignActionPage.putString(".pySectionReference", "pxContextualPrompt");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzInitializeContextualPromptWrapper";
// Expression: Data-Application-Feature
			newParamsPage.putString("classContext", "Data-Application-Feature");
			
// Expression: express
			newParamsPage.putString("sessionContext", "express");
			
// Expression: categorylist
			newParamsPage.putString("Usage", "categorylist");
			
// Expression: Data-Application-Feature
			newParamsPage.putString("appliesTo", "Data-Application-Feature");
			
// Expression: false
String pz_1 = String.valueOf(false);
			newParamsPage.putString("includeBestBets", pz_1);
			
// Expression: "AgileWorkbench"
			newParamsPage.putString("sourceContext", "AgileWorkbench");
			
// Expression: search
			newParamsPage.putString("actionContext", "search");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZFEATURESELECTORFORSEARCH #20180713T142026.916 GMT", "Rule-Application pzFeatureSelectorForSearch", "Pega-AppDefinition", "08-01-01", "20180713T142026.916 GMT");
}
