...
import java.util.*;
public class ra_action_pzrulelockedinfo_4bf6d09dfb90f91459f84426553d3b32  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzRuleLockedInfo.Rule_.Action");
	public ra_action_pzrulelockedinfo_4bf6d09dfb90f91459f84426553d3b32(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE- PZRULELOCKEDINFO #20180713T135456.850 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE- PZRULELOCKEDINFO #20180713T135456.850 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzRuleLockedInfo");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzRuleLockedInfo");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZRULELOCKEDINFO"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULELOCKEDINFO","Rule-Obj-FlowAction","RULE-",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION RULE- PZRULELOCKEDINFO #20180713T135456.850 GMT","!PZRULELOCKEDINFO",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1235418933)
	};
...
//	RULE-OBJ-FLOWACTION RULE- PZRULELOCKEDINFO #20180713T135456.850 GMT:20180713T135456.850 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "ac3628622f7f9a3e5dbf7d2f1d8a994c";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-!PZRULELOCKEDINFO",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzRuleLockedInfo";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzRuleLockedInfo");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzRuleLockedInfo");
		...
		AssignActionPage.putString(".pySectionReference", "pzRuleLockedInfo");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzPreRuleLockInfo";
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE- PZRULELOCKEDINFO #20180713T135456.850 GMT", "Rule- pzRuleLockedInfo", "Pega-Desktop", "08-01-01", "20180713T135456.850 GMT");
}
