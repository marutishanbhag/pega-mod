...
import java.util.*;
public class ra_action_pzcheckwarningmessages_767e9ec90f6ccb04bee65051a7274978  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzCheckWarningMessages.Rule_Obj_CaseType.Action");
	public ra_action_pzcheckwarningmessages_767e9ec90f6ccb04bee65051a7274978(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION RULE-OBJ-CASETYPE PZCHECKWARNINGMESSAGES #20200520T133429.570 GMT	Pega-ProcessArchitect:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-OBJ-CASETYPE PZCHECKWARNINGMESSAGES #20200520T133429.570 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Draft process warnings");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Draft process warnings");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "a1145340747b0a340ecc1ef16f57835f";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Obj-CaseType";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-OBJ-CASETYPE!PZCHECKWARNINGMESSAGES",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzCheckWarningMessages";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Draft process warnings");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Draft process warnings");
		...
		AssignActionPage.putString(".pySectionReference", "pzCheckWarningMessages");
