...
import java.util.*;
public class ra_action_pypulsesearchoptions_b7b4daacd69096b6cd510230cfb05097  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pyPulseSearchOptions.PegaGadget_Feed.Action");
	public ra_action_pypulsesearchoptions_b7b4daacd69096b6cd510230cfb05097(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION PEGAGADGET-FEED PYPULSESEARCHOPTIONS #20200506T075455.088 GMT	Pega-Social:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Social";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGAGADGET-FEED PYPULSESEARCHOPTIONS #20200506T075455.088 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Search");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Search");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PYPULSESEARCHOPTIONS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYPULSESEARCHOPTIONS","Rule-Obj-FlowAction","PEGAGADGET-FEED",false,"","Pega-Social","08-05-01","RULE-OBJ-FLOWACTION PEGAGADGET-FEED PYPULSESEARCHOPTIONS #20200506T075455.088 GMT","!PYPULSESEARCHOPTIONS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",337458691)
	};
...
//	RULE-OBJ-FLOWACTION PEGAGADGET-FEED PYPULSESEARCHOPTIONS #20200506T075455.088 GMT:20200506T075455.088 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "c27e8a6290ae40435c78d6671a73827e";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "PegaGadget-Feed";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGAGADGET-FEED!PYPULSESEARCHOPTIONS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pyPulseSearchOptions";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Search");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Search");
		...
		AssignActionPage.putString(".pySectionReference", "pyPulseSearchOptions");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGAGADGET-FEED PYPULSESEARCHOPTIONS #20200506T075455.088 GMT", "PegaGadget-Feed pyPulseSearchOptions", "Pega-Social", "08-05-01", "20200506T075455.088 GMT");
}
