...
import java.util.*;
public class ra_action_pzapplicationactors_e70ad9eaf291d2b804bb75d2ef92fd44  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzApplicationActors.Rule_Application.Action");
	public ra_action_pzapplicationactors_e70ad9eaf291d2b804bb75d2ef92fd44(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONACTORS #20180713T142626.544 GMT	Pega-LP-Application:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-LP-Application";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONACTORS #20180713T142626.544 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Actors");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Actors");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZAPPLICATIONACTORS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPLICATIONACTORS","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-LP-Application","08-01-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONACTORS #20180713T142626.544 GMT","!PZAPPLICATIONACTORS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1310568075)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONACTORS #20180713T142626.544 GMT:20180713T142626.544 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "fbcadae5a5c03e1490162e01e8850c20";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZAPPLICATIONACTORS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzApplicationActors";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Actors");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Actors");
		...
		AssignActionPage.putString(".pySectionReference", "pzActorsContainer");
...
// Expression: "Actors"
			newParamsPage.putString("editedSection", "Actors");
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONACTORS #20180713T142626.544 GMT", "Rule-Application pzApplicationActors", "Pega-LP-Application", "08-01-01", "20180713T142626.544 GMT");
}
