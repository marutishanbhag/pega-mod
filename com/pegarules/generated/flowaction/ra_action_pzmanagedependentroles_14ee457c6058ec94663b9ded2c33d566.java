...
import java.util.*;
public class ra_action_pzmanagedependentroles_14ee457c6058ec94663b9ded2c33d566  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzManageDependentRoles.Rule_Access_Role_Name.Action");
	public ra_action_pzmanagedependentroles_14ee457c6058ec94663b9ded2c33d566(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-NAME PZMANAGEDEPENDENTROLES #20180713T135452.737 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-NAME PZMANAGEDEPENDENTROLES #20180713T135452.737 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Manage dependent roles");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Manage dependent roles");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZMANAGEDEPENDENTROLES"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZMANAGEDEPENDENTROLES","Rule-Obj-FlowAction","RULE-ACCESS-ROLE-NAME",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-NAME PZMANAGEDEPENDENTROLES #20180713T135452.737 GMT","!PZMANAGEDEPENDENTROLES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-338923486)
	};
...
//	RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-NAME PZMANAGEDEPENDENTROLES #20180713T135452.737 GMT:20180713T135452.737 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "cbf7d3975a149763b5919f2c6f7cd88f";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Access-Role-Name";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-ACCESS-ROLE-NAME!PZMANAGEDEPENDENTROLES",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzManageDependentRoles";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Manage dependent roles");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Manage dependent roles");
		...
		AssignActionPage.putString(".pySectionReference", "pzManageDependentRoles");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzMaintainDependentsState";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzSubmitDependentRoles";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-ACCESS-ROLE-NAME PZMANAGEDEPENDENTROLES #20180713T135452.737 GMT", "Rule-Access-Role-Name pzManageDependentRoles", "Pega-Desktop", "08-01-01", "20180713T135452.737 GMT");
}
