...
import java.util.*;
public class ra_action_pzeditapplicationdetails_73057434f6f79cb1c045ad1386e1bbed  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzEditApplicationDetails.Rule_Application.Action");
	public ra_action_pzeditapplicationdetails_73057434f6f79cb1c045ad1386e1bbed(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZEDITAPPLICATIONDETAILS #20200914T112529.679 GMT	Pega-LP-Application:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZEDITAPPLICATIONDETAILS #20200914T112529.679 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Application details");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Application details");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "accdbad737fe08471e2aec52b62ac219";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZEDITAPPLICATIONDETAILS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzEditApplicationDetails";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Application details");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Application details");
		...
		AssignActionPage.putString(".pySectionReference", "pzEditApplicationDetails");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzPostEditApplicationDetails";
			if (actType.equals("POSTCONNECTOR"))
			{
