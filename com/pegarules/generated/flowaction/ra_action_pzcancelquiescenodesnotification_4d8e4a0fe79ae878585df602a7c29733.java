...
import java.util.*;
public class ra_action_pzcancelquiescenodesnotification_4d8e4a0fe79ae878585df602a7c29733  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzCancelQuiesceNodesNotification.Pega_Ext_AdminStudio_Explorer_Settings_System.Action");
	public ra_action_pzcancelquiescenodesnotification_4d8e4a0fe79ae878585df602a7c29733(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZCANCELQUIESCENODESNOTIFICATION #20180713T135452.602 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZCANCELQUIESCENODESNOTIFICATION #20180713T135452.602 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Cancel quiesce nodes notification");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Cancel quiesce nodes notification");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZCANCELQUIESCENODESNOTIFICATION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCANCELQUIESCENODESNOTIFICATION","Rule-Obj-FlowAction","PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZCANCELQUIESCENODESNOTIFICATION #20180713T135452.602 GMT","!PZCANCELQUIESCENODESNOTIFICATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1364283103)
	};
...
//	RULE-OBJ-FLOWACTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZCANCELQUIESCENODESNOTIFICATION #20180713T135452.602 GMT:20180713T135452.602 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "eea1f2b03d76a3abe61c67a184335e6f";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-Ext-AdminStudio-Explorer-Settings-System";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM!PZCANCELQUIESCENODESNOTIFICATION",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzCancelQuiesceNodesNotification";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Cancel quiesce nodes notification");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Cancel quiesce nodes notification");
		...
		AssignActionPage.putString(".pySectionReference", "pzCancelQuiesceNodesNotification");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzQuiesceNodesInCluster";
			if (actType.equals("POSTCONNECTOR"))
			{
...
String pz_1 = String.valueOf(false);
			newParamsPage.putString("QuiesceNodes", pz_1);
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZCANCELQUIESCENODESNOTIFICATION #20180713T135452.602 GMT", "Pega-Ext-AdminStudio-Explorer-Settings-System pzCancelQuiesceNodesNotification", "Pega-Desktop", "08-01-01", "20180713T135452.602 GMT");
}
