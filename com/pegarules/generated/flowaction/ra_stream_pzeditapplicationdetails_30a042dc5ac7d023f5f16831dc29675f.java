 ...
 */
public class ra_stream_pzeditapplicationdetails_30a042dc5ac7d023f5f16831dc29675f extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzEditApplicationDetails.Rule_Application.Stream");
 ...
 */
	public ra_stream_pzeditapplicationdetails_30a042dc5ac7d023f5f16831dc29675f(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "19a0cc57edcf7717cd5afe783e34ac2954c75178";
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZEDITAPPLICATIONDETAILS #20200914T112529.679 GMT	Pega-LP-Application:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-OBJ-FLOWACTION RULE-APPLICATION PZEDITAPPLICATIONDETAILS #20200914T112529.679 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZEDITAPPLICATIONDETAILS #20200914T112529.679 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-OBJ-FLOWACTION RULE-APPLICATION PZEDITAPPLICATIONDETAILS #20200914T112529.679 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZEDITAPPLICATIONDETAILS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZEDITAPPLICATIONDETAILS","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-LP-Application","08-06-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZEDITAPPLICATIONDETAILS #20200914T112529.679 GMT","!PZEDITAPPLICATIONDETAILS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",2015077947)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZEDITAPPLICATIONDETAILS #20200914T112529.679 GMT:20200914T112529.679 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "f5509583ff58028a9dc8cddc554e7e53";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_1","pzEditApplicationDetails", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzEditApplicationDetails";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
tools.putParamValue("flowActionUIRef","pzEditApplicationDetails"); 
tools.appendString(" ");
...
out.print( pzAuto.getInpectorData("FlowAction", "", "","pzEditApplicationDetails","Rule-Obj-FlowAction","Rule-Application") );
tools.appendString(" >");
 } 
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
pzPackageRuntime.packageSection("pzEditApplicationDetails",tools.getStepPage().getReference(), null);
tools.appendString("<div id='section-placeholder' data-class='");
out.print(tools.getStepPage().getString("pxObjClass"));
tools.appendString("' data-section='pzEditApplicationDetails'></div> ");
} else {
includeSectionBody_1();
}
tools.appendString("<span style=\"display: none;\" uitype=\"Rule-HTML-Section\" id=\"pzFlowActionUITypeRef\" uiref=\"pzEditApplicationDetails\"></span> ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-OBJ-FLOWACTION RULE-APPLICATION PZEDITAPPLICATIONDETAILS #20200914T112529.679 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZEDITAPPLICATIONDETAILS #20200914T112529.679 GMT", "Rule-Application pzEditApplicationDetails", "Pega-LP-Application", "08-06-01", "20200914T112529.679 GMT");
}
