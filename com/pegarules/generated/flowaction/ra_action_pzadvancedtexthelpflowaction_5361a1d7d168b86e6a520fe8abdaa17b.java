...
import java.util.*;
public class ra_action_pzadvancedtexthelpflowaction_5361a1d7d168b86e6a520fe8abdaa17b  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAdvancedTextHelpFlowAction.PegaSocial_Message.Action");
	public ra_action_pzadvancedtexthelpflowaction_5361a1d7d168b86e6a520fe8abdaa17b(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION PEGASOCIAL-MESSAGE PZADVANCEDTEXTHELPFLOWACTION #20180713T134540.342 GMT	Pega-Social:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Social";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGASOCIAL-MESSAGE PZADVANCEDTEXTHELPFLOWACTION #20180713T134540.342 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzAdvancedTextHelpFlowAction");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzAdvancedTextHelpFlowAction");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZADVANCEDTEXTHELPFLOWACTION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZADVANCEDTEXTHELPFLOWACTION","Rule-Obj-FlowAction","PEGASOCIAL-MESSAGE",false,"","Pega-Social","08-01-01","RULE-OBJ-FLOWACTION PEGASOCIAL-MESSAGE PZADVANCEDTEXTHELPFLOWACTION #20180713T134540.342 GMT","!PZADVANCEDTEXTHELPFLOWACTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2057659313)
	};
...
//	RULE-OBJ-FLOWACTION PEGASOCIAL-MESSAGE PZADVANCEDTEXTHELPFLOWACTION #20180713T134540.342 GMT:20180713T134540.342 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "7502f2aced4752f9f85d6eb1f205acb0";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "PegaSocial-Message";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGASOCIAL-MESSAGE!PZADVANCEDTEXTHELPFLOWACTION",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzAdvancedTextHelpFlowAction";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzAdvancedTextHelpFlowAction");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzAdvancedTextHelpFlowAction");
		...
		AssignActionPage.putString(".pySectionReference", "pzAdvancedTextHelp");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGASOCIAL-MESSAGE PZADVANCEDTEXTHELPFLOWACTION #20180713T134540.342 GMT", "PegaSocial-Message pzAdvancedTextHelpFlowAction", "Pega-Social", "08-01-01", "20180713T134540.342 GMT");
}
