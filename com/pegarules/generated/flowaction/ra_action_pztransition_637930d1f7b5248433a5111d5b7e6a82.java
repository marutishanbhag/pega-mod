...
import java.util.*;
public class ra_action_pztransition_637930d1f7b5248433a5111d5b7e6a82  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzTransition.Embed_ActivitySteps.Action");
	public ra_action_pztransition_637930d1f7b5248433a5111d5b7e6a82(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZTRANSITION #20180713T135448.100 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZTRANSITION #20180713T135448.100 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Jump");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Jump");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZTRANSITION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZTRANSITION","Rule-Obj-FlowAction","EMBED-ACTIVITYSTEPS",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZTRANSITION #20180713T135448.100 GMT","!PZTRANSITION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",746046483)
	};
...
//	RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZTRANSITION #20180713T135448.100 GMT:20180713T135448.100 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "1c52465a3551898fc36532e7cbd0dfde";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Embed-ActivitySteps";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:EMBED-ACTIVITYSTEPS!PZTRANSITION",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzTransition";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Jump");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Jump");
		...
		AssignActionPage.putString(".pySectionReference", "pzTransition");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZTRANSITION #20180713T135448.100 GMT", "Embed-ActivitySteps pzTransition", "Pega-Desktop", "08-01-01", "20180713T135448.100 GMT");
}
