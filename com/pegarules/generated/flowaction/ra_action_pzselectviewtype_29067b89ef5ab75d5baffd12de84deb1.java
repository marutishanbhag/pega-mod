...
import java.util.*;
public class ra_action_pzselectviewtype_29067b89ef5ab75d5baffd12de84deb1  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzSelectViewType._baseclass.Action");
	public ra_action_pzselectviewtype_29067b89ef5ab75d5baffd12de84deb1(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZSELECTVIEWTYPE #20191114T170959.600 GMT	Pega-AppDefinition:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-AppDefinition";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZSELECTVIEWTYPE #20191114T170959.600 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzSelectViewType");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzSelectViewType");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZSELECTVIEWTYPE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSELECTVIEWTYPE","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-AppDefinition","08-04-01","RULE-OBJ-FLOWACTION @BASECLASS PZSELECTVIEWTYPE #20191114T170959.600 GMT","!PZSELECTVIEWTYPE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",813260462)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZSELECTVIEWTYPE #20191114T170959.600 GMT:20191114T170959.600 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "8fe8822405bd781a8341935d427111dc";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZSELECTVIEWTYPE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzSelectViewType";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzSelectViewType");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzSelectViewType");
		...
		AssignActionPage.putString(".pySectionReference", "pzViewTypes");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZSELECTVIEWTYPE #20191114T170959.600 GMT", "@baseclass pzSelectViewType", "Pega-AppDefinition", "08-04-01", "20191114T170959.600 GMT");
}
