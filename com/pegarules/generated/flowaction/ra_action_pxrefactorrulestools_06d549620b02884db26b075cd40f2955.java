...
import java.util.*;
public class ra_action_pxrefactorrulestools_06d549620b02884db26b075cd40f2955  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pxRefactorRulesTools.Pega_Landing_System_RefactorRules.Action");
	public ra_action_pxrefactorrulestools_06d549620b02884db26b075cd40f2955(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION PEGA-LANDING-SYSTEM-REFACTORRULES PXREFACTORRULESTOOLS #20180713T142957.592 GMT	Pega-LP-SystemSettings:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-LANDING-SYSTEM-REFACTORRULES PXREFACTORRULESTOOLS #20180713T142957.592 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pxRefactorRulesTools");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pxRefactorRulesTools");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "26d08eebbd38f189e96b19699faebf5f";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-Landing-System-RefactorRules";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-LANDING-SYSTEM-REFACTORRULES!PXREFACTORRULESTOOLS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pxRefactorRulesTools";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pxRefactorRulesTools");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pxRefactorRulesTools");
		...
		AssignActionPage.putString(".pySectionReference", "pxLPSystemRefactorRules");
