...
import java.util.*;
public class ra_action_pzconfigurecalculation_4bfc3a1f21789485611d5990e61f16d6  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzConfigureCalculation.Embed_Fields.Action");
	public ra_action_pzconfigurecalculation_4bfc3a1f21789485611d5990e61f16d6(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION EMBED-FIELDS PZCONFIGURECALCULATION #20180713T141210.271 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION EMBED-FIELDS PZCONFIGURECALCULATION #20180713T141210.271 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Configure calculation");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Configure calculation");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZCONFIGURECALCULATION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCONFIGURECALCULATION","Rule-Obj-FlowAction","EMBED-FIELDS",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-FLOWACTION EMBED-FIELDS PZCONFIGURECALCULATION #20180713T141210.271 GMT","!PZCONFIGURECALCULATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-631107995)
	};
...
//	RULE-OBJ-FLOWACTION EMBED-FIELDS PZCONFIGURECALCULATION #20180713T141210.271 GMT:20180713T141210.271 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "b8e373673f2cdf7afb6342cf4e24a97b";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Embed-Fields";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:EMBED-FIELDS!PZCONFIGURECALCULATION",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzConfigureCalculation";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Configure calculation");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Configure calculation");
		...
		AssignActionPage.putString(".pySectionReference", "pzConfigureCalculation");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzOpenFieldsCalculatedValue";
// Expression: 
			newParamsPage.putString("PropertyName", "");
			
// Expression: 
			newParamsPage.putString("ClassName", "");
			
// Expression: 
			newParamsPage.putString("PropertyType", "");
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzCreateOrUpdateCalculation";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION EMBED-FIELDS PZCONFIGURECALCULATION #20180713T141210.271 GMT", "Embed-Fields pzConfigureCalculation", "Pega-ProcessArchitect", "08-01-01", "20180713T141210.271 GMT");
}
