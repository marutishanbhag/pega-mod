...
import java.util.*;
public class ra_action_pxchooseorgdivunit_33fb2cf073ab6635bde2995f6182ebb4  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pxChooseOrgDivUnit.Rule_Application.Action");
	public ra_action_pxchooseorgdivunit_33fb2cf073ab6635bde2995f6182ebb4(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PXCHOOSEORGDIVUNIT #20200529T162240.177 GMT	Pega-Desktop:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PXCHOOSEORGDIVUNIT #20200529T162240.177 GMT";
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXCHOOSEORGDIVUNIT","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-Desktop","08-05-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PXCHOOSEORGDIVUNIT #20200529T162240.177 GMT","!PXCHOOSEORGDIVUNIT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1519316970)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PXCHOOSEORGDIVUNIT #20200529T162240.177 GMT:20200529T162240.177 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "59e6cfcdae557638ab36c708f1ee8ab9";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PXCHOOSEORGDIVUNIT",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PXCHOOSEORGDIVUNIT #20200529T162240.177 GMT", "Rule-Application pxChooseOrgDivUnit", "Pega-Desktop", "08-05-01", "20200529T162240.177 GMT");
}
