...
import java.util.*;
public class ra_action_pzlpoperators_3b88c7fb0627d4d3174a5c4ac166209e  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzLPOperators.Pega_Landing_Org_Operators.Action");
	public ra_action_pzlpoperators_3b88c7fb0627d4d3174a5c4ac166209e(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION PEGA-LANDING-ORG-OPERATORS PZLPOPERATORS #20180713T142740.157 GMT	Pega-LP-OrgAndSecurity:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mRuleSet = "Pega-LP-OrgAndSecurity";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-LANDING-ORG-OPERATORS PZLPOPERATORS #20180713T142740.157 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzLPOperators");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzLPOperators");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "bf31167cf432c5b7e2821e740387cdb2";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-Landing-Org-Operators";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-LANDING-ORG-OPERATORS!PZLPOPERATORS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzLPOperators";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzLPOperators");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzLPOperators");
		...
		AssignActionPage.putString(".pySectionReference", "pzLPOperators");
