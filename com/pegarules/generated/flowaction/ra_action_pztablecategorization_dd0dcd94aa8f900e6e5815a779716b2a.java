...
import java.util.*;
public class ra_action_pztablecategorization_dd0dcd94aa8f900e6e5815a779716b2a  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzTableCategorization._baseclass.Action");
	public ra_action_pztablecategorization_dd0dcd94aa8f900e6e5815a779716b2a(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZTABLECATEGORIZATION #20231016T101003.766 GMT	Pega-UIEngine:08-23-02	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-UIEngine";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZTABLECATEGORIZATION #20231016T101003.766 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Table categorization");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Table categorization");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZTABLECATEGORIZATION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZTABLECATEGORIZATION","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-UIEngine","08-23-02","RULE-OBJ-FLOWACTION @BASECLASS PZTABLECATEGORIZATION #20231016T101003.766 GMT","!PZTABLECATEGORIZATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-733858655)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZTABLECATEGORIZATION #20231016T101003.766 GMT:20231016T101003.766 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "c41d2117c3b65b3a325f9414941e5f80";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZTABLECATEGORIZATION",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzTableCategorization";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Table categorization");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Table categorization");
		...
		AssignActionPage.putString(".pySectionReference", "pyGridCategorization");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZTABLECATEGORIZATION #20231016T101003.766 GMT", "@baseclass pzTableCategorization", "Pega-UIEngine", "08-23-02", "20231016T101003.766 GMT");
}
