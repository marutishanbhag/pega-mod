...
import java.util.*;
public class ra_action_pzdisplayappfilters_d36938971857a7afc419e2d9dc72d956  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzDisplayAppFilters.PegaGadget_Filter.Action");
	public ra_action_pzdisplayappfilters_d36938971857a7afc419e2d9dc72d956(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION PEGAGADGET-FILTER PZDISPLAYAPPFILTERS #20180713T133519.837 GMT	Pega-Gadgets:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Gadgets";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGAGADGET-FILTER PZDISPLAYAPPFILTERS #20180713T133519.837 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Application Stack");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Application Stack");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZDISPLAYAPPFILTERS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZDISPLAYAPPFILTERS","Rule-Obj-FlowAction","PEGAGADGET-FILTER",false,"","Pega-Gadgets","08-01-01","RULE-OBJ-FLOWACTION PEGAGADGET-FILTER PZDISPLAYAPPFILTERS #20180713T133519.837 GMT","!PZDISPLAYAPPFILTERS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1548362559)
	};
...
//	RULE-OBJ-FLOWACTION PEGAGADGET-FILTER PZDISPLAYAPPFILTERS #20180713T133519.837 GMT:20180713T133519.837 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "d5c4e5eab1b530b67dc046fd8bdc2775";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "PegaGadget-Filter";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGAGADGET-FILTER!PZDISPLAYAPPFILTERS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzDisplayAppFilters";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Application Stack");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Application Stack");
		...
		AssignActionPage.putString(".pySectionReference", "pzAppFilters");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION PEGAGADGET-FILTER PZDISPLAYAPPFILTERS #20180713T133519.837 GMT", "PegaGadget-Filter pzDisplayAppFilters", "Pega-Gadgets", "08-01-01", "20180713T133519.837 GMT");
}
