...
import java.util.*;
public class ra_action_pzrundatatransform_09a92f5297b81837877bff2a34be64e6  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzRunDataTransform.Work_.Action");
	public ra_action_pzrundatatransform_09a92f5297b81837877bff2a34be64e6(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION WORK- PZRUNDATATRANSFORM #20230618T001814.056 GMT	Pega-ProcessArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION WORK- PZRUNDATATRANSFORM #20230618T001814.056 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Run data transform");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Run data transform");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZRUNDATATRANSFORM", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRUNDATATRANSFORM","Rule-Obj-FlowAction","WORK-",false,"","Pega-ProcessArchitect","08-23-01","RULE-OBJ-FLOWACTION WORK- PZRUNDATATRANSFORM #20230618T001814.056 GMT","!PZRUNDATATRANSFORM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-376461958), 
		...
		new DependentRuleInfo("PXOBJCLASS","Rule-Obj-Property","@BASECLASS",true,"Work-","Pega-SystemArchitect","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PXOBJCLASS #20180713T135622.443 GMT","!PXOBJCLASS",true,false,"ABSOLUTE_IS_NOT_PRIMARY",0)
	};
...
//	RULE-OBJ-FLOWACTION WORK- PZRUNDATATRANSFORM #20230618T001814.056 GMT:20230618T001814.056 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "74d48f142ea8ad44da847e0f93de6d0f";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Work-";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:WORK-!PZRUNDATATRANSFORM",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzRunDataTransform";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Run data transform");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Run data transform");
		...
		AssignActionPage.putString(".pySectionReference", "pzRunDataTransform");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzSetDataTransformName";
// Expression: .pyRunDataTransform
			newParamsPage.putString("DTName", scalarValueQuery_1.resolveToString(tools, myStepPage, ImmutablePropertyInfo.TYPE_TEXT));
			
// Expression: .pxObjClass
			newParamsPage.putString("DTClass", scalarValueQuery_2.resolveToString(tools, myStepPage, ImmutablePropertyInfo.TYPE_TEXT));
			
// Expression: pyTempValue
			newParamsPage.putString("DTPropName", "pyTempValue");
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzValidateRunDataTransformParameters";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final ScalarValueQuery scalarValueQuery_1 = FUAUtil.createQueryBuilder().allowMissingPropertyException().scalarProperty("pyRunDataTransform").buildScalarValueQuery();
private static final ScalarValueQuery scalarValueQuery_2 = FUAUtil.createQueryBuilder().allowMissingPropertyException().scalarProperty("pxObjClass").buildScalarValueQuery();

private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION WORK- PZRUNDATATRANSFORM #20230618T001814.056 GMT", "Work- pzRunDataTransform", "Pega-ProcessArchitect", "08-23-01", "20230618T001814.056 GMT");
}
