...
import java.util.*;
public class ra_action_pzenvironmentgadget_7e0807ea9d467b060101c6c8b03c45ca  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzEnvironmentGadget.Data_Portal.Action");
	public ra_action_pzenvironmentgadget_7e0807ea9d467b060101c6c8b03c45ca(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION DATA-PORTAL PZENVIRONMENTGADGET #20181017T194556.578 GMT	Pega-UIDesign:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-UIDesign";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-PORTAL PZENVIRONMENTGADGET #20181017T194556.578 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzEnvironmentGadget");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzEnvironmentGadget");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZENVIRONMENTGADGET"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZENVIRONMENTGADGET","Rule-Obj-FlowAction","DATA-PORTAL",false,"","Pega-UIDesign","08-02-01","RULE-OBJ-FLOWACTION DATA-PORTAL PZENVIRONMENTGADGET #20181017T194556.578 GMT","!PZENVIRONMENTGADGET",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",829763382)
	};
...
//	RULE-OBJ-FLOWACTION DATA-PORTAL PZENVIRONMENTGADGET #20181017T194556.578 GMT:20181017T194556.578 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "3a5dac8a0928a536777a98cb65741e5a";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-Portal";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-PORTAL!PZENVIRONMENTGADGET",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzEnvironmentGadget";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzEnvironmentGadget");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzEnvironmentGadget");
		...
		AssignActionPage.putString(".pySectionReference", "pzEnvironmentGadget");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION DATA-PORTAL PZENVIRONMENTGADGET #20181017T194556.578 GMT", "Data-Portal pzEnvironmentGadget", "Pega-UIDesign", "08-02-01", "20181017T194556.578 GMT");
}
