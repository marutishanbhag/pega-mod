...
import java.util.*;
public class ra_action_pzcreatetoggle_89b474a0bcb3c3137f4dbe6086abbc03  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzCreateToggle.Data_Admin_Toggle.Action");
	public ra_action_pzcreatetoggle_89b474a0bcb3c3137f4dbe6086abbc03(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION DATA-ADMIN-TOGGLE PZCREATETOGGLE #20180713T135447.859 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-ADMIN-TOGGLE PZCREATETOGGLE #20180713T135447.859 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Create new toggle");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Create new toggle");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZCREATETOGGLE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCREATETOGGLE","Rule-Obj-FlowAction","DATA-ADMIN-TOGGLE",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION DATA-ADMIN-TOGGLE PZCREATETOGGLE #20180713T135447.859 GMT","!PZCREATETOGGLE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",541819434)
	};
...
//	RULE-OBJ-FLOWACTION DATA-ADMIN-TOGGLE PZCREATETOGGLE #20180713T135447.859 GMT:20180713T135447.859 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "9a7b5ac53ea1465d53aad770e50b2dc1";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-Admin-Toggle";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-ADMIN-TOGGLE!PZCREATETOGGLE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzCreateToggle";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Create new toggle");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Create new toggle");
		...
		AssignActionPage.putString(".pySectionReference", "pzUpdateToggleDetails");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzPopulateToggleData";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzToggleSubmitWrapper";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION DATA-ADMIN-TOGGLE PZCREATETOGGLE #20180713T135447.859 GMT", "Data-Admin-Toggle pzCreateToggle", "Pega-Desktop", "08-01-01", "20180713T135447.859 GMT");
}
