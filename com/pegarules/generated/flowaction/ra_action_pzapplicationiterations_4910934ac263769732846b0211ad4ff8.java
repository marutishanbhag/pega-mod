...
import java.util.*;
public class ra_action_pzapplicationiterations_4910934ac263769732846b0211ad4ff8  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzApplicationIterations.Rule_Application.Action");
	public ra_action_pzapplicationiterations_4910934ac263769732846b0211ad4ff8(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONITERATIONS #20180713T142626.562 GMT	Pega-LP-Application:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-LP-Application";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONITERATIONS #20180713T142626.562 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Iterations");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Iterations");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZAPPLICATIONITERATIONS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPLICATIONITERATIONS","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-LP-Application","08-01-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONITERATIONS #20180713T142626.562 GMT","!PZAPPLICATIONITERATIONS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1007782343)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONITERATIONS #20180713T142626.562 GMT:20180713T142626.562 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "23c9f42e33aa8097bb3cf954e7e120b6";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZAPPLICATIONITERATIONS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzApplicationIterations";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Iterations");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Iterations");
		...
		AssignActionPage.putString(".pySectionReference", "pzIterationsContainer");
...
// Expression: "Iterations"
			newParamsPage.putString("editedSection", "Iterations");
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONITERATIONS #20180713T142626.562 GMT", "Rule-Application pzApplicationIterations", "Pega-LP-Application", "08-01-01", "20180713T142626.562 GMT");
}
