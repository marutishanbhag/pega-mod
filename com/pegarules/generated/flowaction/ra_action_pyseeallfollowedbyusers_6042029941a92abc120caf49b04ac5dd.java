...
import java.util.*;
public class ra_action_pyseeallfollowedbyusers_6042029941a92abc120caf49b04ac5dd  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pySeeAllFollowedByUsers.Data_Admin_Operator_ID.Action");
	public ra_action_pyseeallfollowedbyusers_6042029941a92abc120caf49b04ac5dd(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION DATA-ADMIN-OPERATOR-ID PYSEEALLFOLLOWEDBYUSERS #20180713T134919.439 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-EndUserUI";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-ADMIN-OPERATOR-ID PYSEEALLFOLLOWEDBYUSERS #20180713T134919.439 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Followers");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Followers");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PYSEEALLFOLLOWEDBYUSERS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYSEEALLFOLLOWEDBYUSERS","Rule-Obj-FlowAction","DATA-ADMIN-OPERATOR-ID",false,"","Pega-EndUserUI","08-01-01","RULE-OBJ-FLOWACTION DATA-ADMIN-OPERATOR-ID PYSEEALLFOLLOWEDBYUSERS #20180713T134919.439 GMT","!PYSEEALLFOLLOWEDBYUSERS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",338147889)
	};
...
//	RULE-OBJ-FLOWACTION DATA-ADMIN-OPERATOR-ID PYSEEALLFOLLOWEDBYUSERS #20180713T134919.439 GMT:20180713T134919.439 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "37c5efbfee76e13a07ddbc85c6714bf1";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-Admin-Operator-ID";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-ADMIN-OPERATOR-ID!PYSEEALLFOLLOWEDBYUSERS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pySeeAllFollowedByUsers";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Followers");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Followers");
		...
		AssignActionPage.putString(".pySectionReference", "pySeeAllFollowedByUsersWrapper");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pySetTitle";
// Expression: "Followed by"
			newParamsPage.putString("context", "Followed by");
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzReloadFollowingUsersDataPage";
			if (actType.equals("POSTCONNECTOR"))
			{
...
// Expression: "FollowedBy"
			newParamsPage.putString("context", "FollowedBy");
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION DATA-ADMIN-OPERATOR-ID PYSEEALLFOLLOWEDBYUSERS #20180713T134919.439 GMT", "Data-Admin-Operator-ID pySeeAllFollowedByUsers", "Pega-EndUserUI", "08-01-01", "20180713T134919.439 GMT");
}
