...
import java.util.*;
public class ra_action_pzeditdefinition_d1f78e1960227db6292faa7be8364920  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzEditDefinition.Rule_Obj_Model.Action");
	public ra_action_pzeditdefinition_d1f78e1960227db6292faa7be8364920(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION RULE-OBJ-MODEL PZEDITDEFINITION #20230618T001813.899 GMT	Pega-ProcessArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-OBJ-MODEL PZEDITDEFINITION #20230618T001813.899 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Edit");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Edit");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "607942990a66570d68a4cb57e0856071";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Obj-Model";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-OBJ-MODEL!PZEDITDEFINITION",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzEditDefinition";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Edit");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Edit");
		...
		AssignActionPage.putString(".pySectionReference", "pzEditDefinition");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pxUpdateRecord";
			if (actType.equals("POSTCONNECTOR"))
			{
...
String pz_1 = String.valueOf(false);
			newParamsPage.putString("AcquireLock", pz_1);
// Expression: false
String pz_2 = String.valueOf(false);
			newParamsPage.putString("MarkAsRelevantRecord", pz_2);
// Expression: false
String pz_3 = String.valueOf(false);
			newParamsPage.putString("BypassBestRuleset", pz_3);
// Expression: false
String pz_4 = String.valueOf(false);
			newParamsPage.putString("Commit", pz_4);
// Expression: false
String pz_5 = String.valueOf(false);
			newParamsPage.putString("UpdateOnly", pz_5);
// Expression: true
String pz_6 = String.valueOf(true);
			newParamsPage.putString("WriteNow", pz_6);
// Expression: false
String pz_7 = String.valueOf(false);
			newParamsPage.putString("LeaveCheckedOut", pz_7);
			try {
