 ...
 */
public class ra_stream_create_4ed4861a14537bea1cea12058318b4d9 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.Create.OFON2J_ProcessO_Work_Onboarding.Stream");
 ...
 */
	public ra_stream_create_4ed4861a14537bea1cea12058318b4d9(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "493a891e698a79547b76c13bd3798261ce33091f";
...
{
/* Instance RULE-OBJ-FLOWACTION WORK- CREATE #20210212T134036.356 GMT	Pega-EndUserUI:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
/*
 * Begin RULE-OBJ-FLOWACTION WORK- CREATE #20210212T134036.356 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-OBJ-FLOWACTION WORK- CREATE #20210212T134036.356 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-OBJ-FLOWACTION WORK- CREATE #20210212T134036.356 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("CREATE","Rule-Obj-FlowAction","WORK-",false,"","Pega-EndUserUI","08-06-01","RULE-OBJ-FLOWACTION WORK- CREATE #20210212T134036.356 GMT","!CREATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-464052262)
	};
...
//	RULE-OBJ-FLOWACTION WORK- CREATE #20210212T134036.356 GMT:20210216T224002.108 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "475fbd77a55d1b6c4697408557ce6059";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_1","Create", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "Create";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
tools.putParamValue("flowActionUIRef","Create"); 
tools.appendString(" ");
...
out.print( pzAuto.getInpectorData("FlowAction", "", "","Create","Rule-Obj-FlowAction","Work-") );
tools.appendString(" >");
 } 
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
pzPackageRuntime.packageSection("Create",tools.getStepPage().getReference(), null);
tools.appendString("<div id='section-placeholder' data-class='");
out.print(tools.getStepPage().getString("pxObjClass"));
tools.appendString("' data-section='Create'></div> ");
} else {
includeSectionBody_1();
}
tools.appendString("<span style=\"display: none;\" uitype=\"Rule-HTML-Section\" id=\"pzFlowActionUITypeRef\" uiref=\"Create\"></span> ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-OBJ-FLOWACTION WORK- CREATE #20210212T134036.356 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION WORK- CREATE #20210212T134036.356 GMT", "Work- Create", "Pega-EndUserUI", "08-06-01", "20210216T224002.108 GMT");
}
