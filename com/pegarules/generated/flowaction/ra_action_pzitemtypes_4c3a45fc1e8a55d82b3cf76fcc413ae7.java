...
import java.util.*;
public class ra_action_pzitemtypes_4c3a45fc1e8a55d82b3cf76fcc413ae7  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzItemTypes.Rule_Application.Action");
	public ra_action_pzitemtypes_4c3a45fc1e8a55d82b3cf76fcc413ae7(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZITEMTYPES #20180713T142026.944 GMT	Pega-AppDefinition:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-AppDefinition";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZITEMTYPES #20180713T142026.944 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzItemTypes");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzItemTypes");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZITEMTYPES"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZITEMTYPES","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-AppDefinition","08-01-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZITEMTYPES #20180713T142026.944 GMT","!PZITEMTYPES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",336867997)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZITEMTYPES #20180713T142026.944 GMT:20180713T142026.944 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "01cdb477912966e8db11ae6a511cafa4";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZITEMTYPES",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzItemTypes";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzItemTypes");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzItemTypes");
		...
		AssignActionPage.putString(".pySectionReference", "pzItemTypes");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZITEMTYPES #20180713T142026.944 GMT", "Rule-Application pzItemTypes", "Pega-AppDefinition", "08-01-01", "20180713T142026.944 GMT");
}
