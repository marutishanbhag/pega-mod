...
import java.util.*;
public class ra_action_pzenterdatatransformname_fc2fe8a2c9d39f1586ef5ebda588fbb2  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzEnterDataTransformName.Rule_Obj_Model.Action");
	public ra_action_pzenterdatatransformname_fc2fe8a2c9d39f1586ef5ebda588fbb2(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001813.938 GMT	Pega-ProcessArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001813.938 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Enter data transform name");
		}
		...
		else if (purpose.equals("VALIDATE"))
		{
			...
			if (newAssignPage == null || (newAssignPage != null && !pega_procom_pegaprocomutilities.determineDeferErrors(newAssignPage, workPage)))
			{
				...
				if (!workPageName.equals("pyDefineNewDataTransform"))
				{
					otherPageInTransaction = tools.findPage("pyDefineNewDataTransform");
			...
			if (!workPageName.equals("pyDefineNewDataTransform"))
			{
				...
				if (otherPageInTransaction != null && otherPageInTransaction.hasMessages())
				{
					...
					newParamsPage.putString("pagename", "pyDefineNewDataTransform");
		...
		{
			tools.putParamValue("pzFALabel", "Enter data transform name");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZENTERDATATRANSFORMNAME"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZENTERDATATRANSFORMNAME","Rule-Obj-FlowAction","RULE-OBJ-MODEL",false,"","Pega-ProcessArchitect","08-23-01","RULE-OBJ-FLOWACTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001813.938 GMT","!PZENTERDATATRANSFORMNAME",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1132676904)
	};
...
//	RULE-OBJ-FLOWACTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001813.938 GMT:20230618T001813.938 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "2f150a8f05b7e5a69d3b7a69d04f1709";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Obj-Model";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-OBJ-MODEL!PZENTERDATATRANSFORMNAME",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzEnterDataTransformName";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Enter data transform name");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Enter data transform name");
		...
		AssignActionPage.putString(".pySectionReference", "pzEnterDataTransformName");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001813.938 GMT", "Rule-Obj-Model pzEnterDataTransformName", "Pega-ProcessArchitect", "08-23-01", "20230618T001813.938 GMT");
}
