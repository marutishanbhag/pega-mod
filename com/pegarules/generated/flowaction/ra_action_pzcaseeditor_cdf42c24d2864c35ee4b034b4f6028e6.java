...
import java.util.*;
public class ra_action_pzcaseeditor_cdf42c24d2864c35ee4b034b4f6028e6  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzCaseEditor.Pega_Designer_CaseType.Action");
	public ra_action_pzcaseeditor_cdf42c24d2864c35ee4b034b4f6028e6(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION PEGA-DESIGNER-CASETYPE PZCASEEDITOR #20180713T141216.616 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-DESIGNER-CASETYPE PZCASEEDITOR #20180713T141216.616 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Cases");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Cases");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "3ebb0537de7b38b7b4e4ae088d95772b";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-Designer-CaseType";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-DESIGNER-CASETYPE!PZCASEEDITOR",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzCaseEditor";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Cases");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Cases");
		...
		AssignActionPage.putString(".pySectionReference", "pzCaseTypeCreationWrapper");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzLoadCaseType";
// Expression: 
			newParamsPage.putString("CaseClassName", "");
