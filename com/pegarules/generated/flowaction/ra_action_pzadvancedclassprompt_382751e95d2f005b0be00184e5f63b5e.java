...
import java.util.*;
public class ra_action_pzadvancedclassprompt_382751e95d2f005b0be00184e5f63b5e  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAdvancedClassPrompt._baseclass.Action");
	public ra_action_pzadvancedclassprompt_382751e95d2f005b0be00184e5f63b5e(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZADVANCEDCLASSPROMPT #20180713T135447.500 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZADVANCEDCLASSPROMPT #20180713T135447.500 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Choose from all available classes");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Choose from all available classes");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZADVANCEDCLASSPROMPT"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZADVANCEDCLASSPROMPT","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION @BASECLASS PZADVANCEDCLASSPROMPT #20180713T135447.500 GMT","!PZADVANCEDCLASSPROMPT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",707088764)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZADVANCEDCLASSPROMPT #20180713T135447.500 GMT:20180713T135447.500 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "753d2aac21b5f62306bd9db034e53ffd";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZADVANCEDCLASSPROMPT",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzAdvancedClassPrompt";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Choose from all available classes");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Choose from all available classes");
		...
		AssignActionPage.putString(".pySectionReference", "pzApplyToPrompt");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzAdvancedClassPromptPreProcessing";
				try{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strTransform = "pzAdvancedClassPromptPostProcessing";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZADVANCEDCLASSPROMPT #20180713T135447.500 GMT", "@baseclass pzAdvancedClassPrompt", "Pega-Desktop", "08-01-01", "20180713T135447.500 GMT");
}
