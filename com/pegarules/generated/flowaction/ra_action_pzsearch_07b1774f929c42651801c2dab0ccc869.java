...
import java.util.*;
public class ra_action_pzsearch_07b1774f929c42651801c2dab0ccc869  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzSearch.Data_Portal.Action");
	public ra_action_pzsearch_07b1774f929c42651801c2dab0ccc869(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCH #20180713T135447.970 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCH #20180713T135447.970 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pySearchOverlay");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pySearchOverlay");
		}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSEARCH","Rule-Obj-FlowAction","DATA-PORTAL",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCH #20180713T135447.970 GMT","!PZSEARCH",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1800751659), 
...
//	RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCH #20180713T135447.970 GMT:20180713T135447.970 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "0a138a425645ae77bf14db4042377688";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-Portal";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-PORTAL!PZSEARCH",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	private boolean AddFlowAction_circum0(String strActionType, ClipboardPage newAssignPage, boolean isSelectedAction, boolean displaySeparatorAbove)
	{
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pySearchOverlay");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pySearchOverlay");
...
// Expression: 
			newParamsPage.putString("allResults", "");
			
// Expression: .pySearchText
			newParamsPage.putString("searchText", scalarValueQuery_1.resolveToString(tools, myStepPage, ImmutablePropertyInfo.TYPE_TEXT));
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCH #20180713T135447.970 GMT", "Data-Portal pzSearch", "Pega-Desktop", "08-01-01", "20180713T135447.970 GMT");
}
