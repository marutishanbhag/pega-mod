...
import java.util.*;
public class ra_action_pzeditlabel_3a9549f6f7ddb381ce389e0b68db4413  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzEditLabel.Rule_Obj_Class.Action");
	public ra_action_pzeditlabel_3a9549f6f7ddb381ce389e0b68db4413(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-OBJ-CLASS PZEDITLABEL #20180713T135456.668 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-OBJ-CLASS PZEDITLABEL #20180713T135456.668 GMT";
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZEDITLABEL","Rule-Obj-FlowAction","RULE-OBJ-CLASS",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION RULE-OBJ-CLASS PZEDITLABEL #20180713T135456.668 GMT","!PZEDITLABEL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",93785941)
	};
...
//	RULE-OBJ-FLOWACTION RULE-OBJ-CLASS PZEDITLABEL #20180713T135456.668 GMT:20180713T135456.668 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "20f88e28f8985d5ee7b34dc0d07694cb";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Obj-Class";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-OBJ-CLASS!PZEDITLABEL",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzUpdateDataClass";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-OBJ-CLASS PZEDITLABEL #20180713T135456.668 GMT", "Rule-Obj-Class pzEditLabel", "Pega-Desktop", "08-01-01", "20180713T135456.668 GMT");
}
