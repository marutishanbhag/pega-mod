...
import java.util.*;
public class ra_action_pzcurrentworkselector_9129206e0ec0232f37dd8bd39d4562cc  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzCurrentWorkSelector.Data_Preference_Operator.Action");
	public ra_action_pzcurrentworkselector_9129206e0ec0232f37dd8bd39d4562cc(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION DATA-PREFERENCE-OPERATOR PZCURRENTWORKSELECTOR #20180713T142022.617 GMT	Pega-AppDefinition:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-AppDefinition";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-PREFERENCE-OPERATOR PZCURRENTWORKSELECTOR #20180713T142022.617 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzCurrentWorkSelector");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzCurrentWorkSelector");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZCURRENTWORKSELECTOR"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCURRENTWORKSELECTOR","Rule-Obj-FlowAction","DATA-PREFERENCE-OPERATOR",false,"","Pega-AppDefinition","08-01-01","RULE-OBJ-FLOWACTION DATA-PREFERENCE-OPERATOR PZCURRENTWORKSELECTOR #20180713T142022.617 GMT","!PZCURRENTWORKSELECTOR",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",425672672)
	};
...
//	RULE-OBJ-FLOWACTION DATA-PREFERENCE-OPERATOR PZCURRENTWORKSELECTOR #20180713T142022.617 GMT:20180713T142022.617 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "8525d1388e139d4e29e4d736e06689f0";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-Preference-Operator";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-PREFERENCE-OPERATOR!PZCURRENTWORKSELECTOR",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzCurrentWorkSelector";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzCurrentWorkSelector");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzCurrentWorkSelector");
		...
		AssignActionPage.putString(".pySectionReference", "pzCurrentWorkSelector");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzSetCurrentWorkItemLabel";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzSetCurrentWorkItem";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION DATA-PREFERENCE-OPERATOR PZCURRENTWORKSELECTOR #20180713T142022.617 GMT", "Data-Preference-Operator pzCurrentWorkSelector", "Pega-AppDefinition", "08-01-01", "20180713T142022.617 GMT");
}
