...
import java.util.*;
public class ra_action_pzprecondition_160d01374db9fcc0dc0ff685793c7eb5  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzPreCondition.Embed_ActivitySteps.Action");
	public ra_action_pzprecondition_160d01374db9fcc0dc0ff685793c7eb5(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZPRECONDITION #20180713T135448.079 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZPRECONDITION #20180713T135448.079 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "When");
		}
		...
		{
			tools.putParamValue("pzFALabel", "When");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZPRECONDITION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZPRECONDITION","Rule-Obj-FlowAction","EMBED-ACTIVITYSTEPS",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZPRECONDITION #20180713T135448.079 GMT","!PZPRECONDITION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-928276115)
	};
...
//	RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZPRECONDITION #20180713T135448.079 GMT:20180713T135448.079 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "36a2968d0eb3317175dbc30f3624511e";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Embed-ActivitySteps";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:EMBED-ACTIVITYSTEPS!PZPRECONDITION",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzPreCondition";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "When");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "When");
		...
		AssignActionPage.putString(".pySectionReference", "pzPreCondition");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzPreModalActivityStep";
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION EMBED-ACTIVITYSTEPS PZPRECONDITION #20180713T135448.079 GMT", "Embed-ActivitySteps pzPreCondition", "Pega-Desktop", "08-01-01", "20180713T135448.079 GMT");
}
