...
/**
 * Builds JSP stream DATA-MO-ACTIVITY-ASSIGNMENT!PZPROPERTYPANELMODAL.
 */
public class ra_stream_pzpropertypanelmodal_26c1d0090c02690e57f26ba33f343ea0 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzPropertyPanelModal.Data_MO_Activity_Assignment_WorkAction.Stream");
 ...
 */
	public ra_stream_pzpropertypanelmodal_26c1d0090c02690e57f26ba33f343ea0(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "4d3980adc620819b8665512a38f19e3049acbd3f";
...
/*
 * Begin RULE-OBJ-FLOWACTION DATA-MO-ACTIVITY-ASSIGNMENT PZPROPERTYPANELMODAL #20180713T141209.820 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-OBJ-FLOWACTION DATA-MO-ACTIVITY-ASSIGNMENT PZPROPERTYPANELMODAL #20180713T141209.820 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-OBJ-FLOWACTION DATA-MO-ACTIVITY-ASSIGNMENT PZPROPERTYPANELMODAL #20180713T141209.820 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "3fa7c61314b05beb3c210a2e24c8f48a";
	}
...
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("StreamName", "pzPropertyPanelModal");
...
pega.getUIEngine().getUIAction("openRule", null).register();
config = new HashMap<String, String>();
config.put("pyPreDataTransform.pyName", "pyDoNotPerform");
...
pega.getUIEngine().getUIAction("openRule", null).register();
config = new HashMap<String, String>();
config.put("pyPreDataTransform.pyName", "pyUseCurOperIfBasketNotFound");
pega.getUIEngine().getUIAction("runDataTransform", config).register();
config = new HashMap<String, String>();
config.put("pyPreDataTransform.pyName", "pyDoNotPerform");
pega.getUIEngine().getUIAction("runDataTransform", config).register();
...
config.put("pyTarget", "thisSection");
config.put("pyPreDataTransform.pyName", "");
config.put("pyActivity", "pzSetUsage");
config.put("DeferLoadActivity", "");
pega.getUIEngine().getUIAction("refresh", config).register();
pega.getUIEngine().getUIAction("openruleAdvancedActions", null).register();
pega.getUIEngine().getUIAction("openRule", null).register();
...
pega.getUIEngine().getUIAction("openRule", null).register();
config = new HashMap<String, String>();
config.put("pyPreDataTransform.pyName", "pyWaitForAllCases");
pega.getUIEngine().getUIAction("runDataTransform", config).register();
pega.getUIEngine().getUIAction("openruleAdvancedActions", null).register();
pega.getUIEngine().getUIAction("openRule", null).register();
pega.getUIEngine().getUIAction("openruleAdvancedActions", null).register();
...
config.put("reloadType", "multipleSections");
config.put("pyActivity", "");
config.put("DeferLoadActivity", "pzGetConnectorFlowActions");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("pzActivity", "pzGetConnectorFlowActions");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
config.put("pyPreDataTransform.pyName", "pzPopulateWhen");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("StreamName", "pzPropertyPanelModal");
pega.getUIEngine().getUIAction("sort", config).register();
...
config.put("pySourceName", ".pyFlowActionsList");
...
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
config.put("pyPreDataTransform.pyName", "pzDefaultDisplayName");
config.put("pyActivity", "pyCreateTicket");
config.put("DeferLoadActivity", "");
pega.getUIEngine().getUIAction("refresh", config).register();
pega.getUIEngine().getUIAction("addRow", null).register();
config = new HashMap<String, String>();
...
out.print( pzAuto.getInpectorData("FlowAction", "", "","pzPropertyPanelModal","Rule-Obj-FlowAction","Data-MO-Activity-Assignment") );
tools.appendString(" >");
 } 
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-OBJ-FLOWACTION DATA-MO-ACTIVITY-ASSIGNMENT PZPROPERTYPANELMODAL #20180713T141209.820 GMT");
