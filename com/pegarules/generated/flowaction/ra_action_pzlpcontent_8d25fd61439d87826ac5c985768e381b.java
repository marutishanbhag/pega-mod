...
import java.util.*;
public class ra_action_pzlpcontent_8d25fd61439d87826ac5c985768e381b  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzLPContent.Pega_Landing_System_ToggleManagement.Action");
	public ra_action_pzlpcontent_8d25fd61439d87826ac5c985768e381b(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLPCONTENT #20180713T135452.661 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLPCONTENT #20180713T135452.661 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "LPContent");
		}
		...
		{
			tools.putParamValue("pzFALabel", "LPContent");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "635a3c592575b12be0fd1e8baeaef3ea";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-Landing-System-ToggleManagement";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT!PZLPCONTENT",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzLPContent";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "LPContent");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "LPContent");
		...
		AssignActionPage.putString(".pySectionReference", "pzListToggles");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzGetListOfAvailableToggles";
// Expression: 
			newParamsPage.putString("decoy", "");
