...
import java.util.*;
public class ra_action_pzcreatefeature_ad214838904ecb9057468fb9b5e2a979  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzCreateFeature.Rule_Application.Action");
	public ra_action_pzcreatefeature_ad214838904ecb9057468fb9b5e2a979(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZCREATEFEATURE #20180713T142626.597 GMT	Pega-LP-Application:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-LP-Application";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZCREATEFEATURE #20180713T142626.597 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Create feature");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Create feature");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZCREATEFEATURE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCREATEFEATURE","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-LP-Application","08-01-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZCREATEFEATURE #20180713T142626.597 GMT","!PZCREATEFEATURE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",793463858)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZCREATEFEATURE #20180713T142626.597 GMT:20180713T142626.597 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "ffb227e85b6eede00f08d5737bb6705d";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZCREATEFEATURE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzCreateFeature";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Create feature");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Create feature");
		...
		AssignActionPage.putString(".pySectionReference", "pzNewFeature");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzFeaturePageInit";
				try{
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzFeatureUtil";
			if (actType.equals("POSTCONNECTOR"))
			{
...
// Expression: create
			newParamsPage.putString("operation", "create");
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZCREATEFEATURE #20180713T142626.597 GMT", "Rule-Application pzCreateFeature", "Pega-LP-Application", "08-01-01", "20180713T142626.597 GMT");
}
