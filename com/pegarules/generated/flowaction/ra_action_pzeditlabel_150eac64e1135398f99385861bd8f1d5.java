...
import java.util.*;
public class ra_action_pzeditlabel_150eac64e1135398f99385861bd8f1d5  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzEditLabel._baseclass.Action");
	public ra_action_pzeditlabel_150eac64e1135398f99385861bd8f1d5(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZEDITLABEL #20180713T135447.551 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZEDITLABEL #20180713T135447.551 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pzEditLabel");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pzEditLabel");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZEDITLABEL"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZEDITLABEL","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION @BASECLASS PZEDITLABEL #20180713T135447.551 GMT","!PZEDITLABEL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1033345575)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZEDITLABEL #20180713T135447.551 GMT:20180713T135447.551 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "e04182312f662c434f324eb0342c3276";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZEDITLABEL",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzEditLabel";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pzEditLabel");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pzEditLabel");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZEDITLABEL #20180713T135447.551 GMT", "@baseclass pzEditLabel", "Pega-Desktop", "08-01-01", "20180713T135447.551 GMT");
}
