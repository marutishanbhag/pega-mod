...
import java.util.*;
public class ra_action_pxdisplaysteps_03f407de487b168e811e9883db41133d  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pxDisplaySteps.Work_.Action");
	public ra_action_pxdisplaysteps_03f407de487b168e811e9883db41133d(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION WORK- PXDISPLAYSTEPS #20210506T204032.473 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Theme-Cosmos";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION WORK- PXDISPLAYSTEPS #20210506T204032.473 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Case Lifecycle");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Case Lifecycle");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PXDISPLAYSTEPS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXDISPLAYSTEPS","Rule-Obj-FlowAction","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-OBJ-FLOWACTION WORK- PXDISPLAYSTEPS #20210506T204032.473 GMT","!PXDISPLAYSTEPS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1752198625)
	};
...
//	RULE-OBJ-FLOWACTION WORK- PXDISPLAYSTEPS #20210506T204032.473 GMT:20230530T103206.308 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "5349f222dd30c6a34b416523430171a4";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Work-";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:WORK-!PXDISPLAYSTEPS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pxDisplaySteps";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Case Lifecycle");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Case Lifecycle");
		...
		AssignActionPage.putString(".pySectionReference", "pxDisplaySteps");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION WORK- PXDISPLAYSTEPS #20210506T204032.473 GMT", "Work- pxDisplaySteps", "Theme-Cosmos", "04-01-01", "20230530T103206.308 GMT");
}
