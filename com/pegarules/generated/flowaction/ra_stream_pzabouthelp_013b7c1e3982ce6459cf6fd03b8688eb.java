...
/**
 * Builds JSP stream @BASECLASS!PZABOUTHELP.
 */
public class ra_stream_pzabouthelp_013b7c1e3982ce6459cf6fd03b8688eb extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzAboutHelp.Data_Portal_DesignerStudio.Stream");
 ...
 */
	public ra_stream_pzabouthelp_013b7c1e3982ce6459cf6fd03b8688eb(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "e7a732128a09e866db864a7628b1e28939806e00";
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZABOUTHELP #20180713T135447.494 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-OBJ-FLOWACTION @BASECLASS PZABOUTHELP #20180713T135447.494 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-OBJ-FLOWACTION @BASECLASS PZABOUTHELP #20180713T135447.494 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-OBJ-FLOWACTION @BASECLASS PZABOUTHELP #20180713T135447.494 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZABOUTHELP"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZABOUTHELP","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION @BASECLASS PZABOUTHELP #20180713T135447.494 GMT","!PZABOUTHELP",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1914827387)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZABOUTHELP #20180713T135447.494 GMT:20180713T135447.494 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "c877e7530c43724a7d61436cd1b7587c";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_1","pzAboutHelp", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzAboutHelp";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
tools.putParamValue("flowActionUIRef","pzAboutHelp"); 
tools.appendString(" ");
...
out.print( pzAuto.getInpectorData("FlowAction", "", "","pzAboutHelp","Rule-Obj-FlowAction","@baseclass") );
tools.appendString(" >");
 } 
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
pzPackageRuntime.packageSection("pzAboutHelp",tools.getStepPage().getReference(), null);
tools.appendString("<div id='section-placeholder' data-class='");
out.print(tools.getStepPage().getString("pxObjClass"));
tools.appendString("' data-section='pzAboutHelp'></div> ");
} else {
includeSectionBody_1();
}
tools.appendString("<span style=\"display: none;\" uitype=\"Rule-HTML-Section\" id=\"pzFlowActionUITypeRef\" uiref=\"pzAboutHelp\"></span> ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-OBJ-FLOWACTION @BASECLASS PZABOUTHELP #20180713T135447.494 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzAboutHelp");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZABOUTHELP #20180713T135447.494 GMT", "@baseclass pzAboutHelp", "Pega-Desktop", "08-01-01", "20180713T135447.494 GMT");
}
