...
import java.util.*;
public class ra_action_pxrefactorclassestools_627db7b621d89ac4d35b678c2e290fb3  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pxRefactorClassesTools.Pega_Landing_System_RefactorClasses.Action");
	public ra_action_pxrefactorclassestools_627db7b621d89ac4d35b678c2e290fb3(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION PEGA-LANDING-SYSTEM-REFACTORCLASSES PXREFACTORCLASSESTOOLS #20180713T142957.578 GMT	Pega-LP-SystemSettings:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mRuleSet = "Pega-LP-SystemSettings";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION PEGA-LANDING-SYSTEM-REFACTORCLASSES PXREFACTORCLASSESTOOLS #20180713T142957.578 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "pxRefactorClassesTools");
		}
		...
		{
			tools.putParamValue("pzFALabel", "pxRefactorClassesTools");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "4625ca55947b4b936816391f796b37a1";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-Landing-System-RefactorClasses";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:PEGA-LANDING-SYSTEM-REFACTORCLASSES!PXREFACTORCLASSESTOOLS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pxRefactorClassesTools";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "pxRefactorClassesTools");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "pxRefactorClassesTools");
		...
		AssignActionPage.putString(".pySectionReference", "pxLPSystemRefactorClasses");
