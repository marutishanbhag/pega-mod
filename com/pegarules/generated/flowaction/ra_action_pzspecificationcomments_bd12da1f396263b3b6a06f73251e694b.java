...
import java.util.*;
public class ra_action_pzspecificationcomments_bd12da1f396263b3b6a06f73251e694b  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzSpecificationComments.Rule_Application.Action");
	public ra_action_pzspecificationcomments_bd12da1f396263b3b6a06f73251e694b(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZSPECIFICATIONCOMMENTS #20180713T142027.021 GMT	Pega-AppDefinition:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-AppDefinition";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZSPECIFICATIONCOMMENTS #20180713T142027.021 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Post a pulse comment");
		}
		...
		else if (purpose.equals("VALIDATE"))
		{
			...
			if (newAssignPage == null || (newAssignPage != null && !pega_procom_pegaprocomutilities.determineDeferErrors(newAssignPage, workPage)))
			{
				...
				if (!workPageName.equals("Application"))
				{
					otherPageInTransaction = tools.findPage("Application");
			...
			if (!workPageName.equals("Application"))
			{
				...
				if (otherPageInTransaction != null && otherPageInTransaction.hasMessages())
				{
					...
					newParamsPage.putString("pagename", "Application");
		...
		{
			tools.putParamValue("pzFALabel", "Post a pulse comment");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZSPECIFICATIONCOMMENTS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSPECIFICATIONCOMMENTS","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-AppDefinition","08-01-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZSPECIFICATIONCOMMENTS #20180713T142027.021 GMT","!PZSPECIFICATIONCOMMENTS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1124828215)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZSPECIFICATIONCOMMENTS #20180713T142027.021 GMT:20180713T142027.021 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "b1a1660ca784de1cff2bcad3074794fd";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZSPECIFICATIONCOMMENTS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzSpecificationComments";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Post a pulse comment");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Post a pulse comment");
		...
		AssignActionPage.putString(".pySectionReference", "pxFeed");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZSPECIFICATIONCOMMENTS #20180713T142027.021 GMT", "Rule-Application pzSpecificationComments", "Pega-AppDefinition", "08-01-01", "20180713T142027.021 GMT");
}
