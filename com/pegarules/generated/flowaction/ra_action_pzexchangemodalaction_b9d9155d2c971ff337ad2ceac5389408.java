...
import java.util.*;
public class ra_action_pzexchangemodalaction_b9d9155d2c971ff337ad2ceac5389408  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzExchangeModalAction.Rule_Application.Action");
	public ra_action_pzexchangemodalaction_b9d9155d2c971ff337ad2ceac5389408(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZEXCHANGEMODALACTION #20180713T141219.563 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZEXCHANGEMODALACTION #20180713T141219.563 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "ExchangeModalAction");
		}
		...
		{
			tools.putParamValue("pzFALabel", "ExchangeModalAction");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZEXCHANGEMODALACTION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZEXCHANGEMODALACTION","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZEXCHANGEMODALACTION #20180713T141219.563 GMT","!PZEXCHANGEMODALACTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-907130425)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZEXCHANGEMODALACTION #20180713T141219.563 GMT:20180713T141219.563 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "594794b39c21e6ed78b43fe1bcb22197";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZEXCHANGEMODALACTION",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzExchangeModalAction";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "ExchangeModalAction");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "ExchangeModalAction");
		...
		AssignActionPage.putString(".pySectionReference", "pzPegaExchangeModalSection");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzDIsableProgressBar";
// Expression: false
String pz_1 = String.valueOf(false);
			newParamsPage.putString("summaryTrueFalse", pz_1);
			
// Expression: ""
			newParamsPage.putString("errorType", "");
			
// Expression: false
String pz_2 = String.valueOf(false);
			newParamsPage.putString("tempTrueFalse", pz_2);
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzUpdateDependsOnList";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZEXCHANGEMODALACTION #20180713T141219.563 GMT", "Rule-Application pzExchangeModalAction", "Pega-ProcessArchitect", "08-01-01", "20180713T141219.563 GMT");
}
