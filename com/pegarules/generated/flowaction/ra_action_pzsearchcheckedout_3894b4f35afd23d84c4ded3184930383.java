...
import java.util.*;
public class ra_action_pzsearchcheckedout_3894b4f35afd23d84c4ded3184930383  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzSearchCheckedOut.Data_Portal.Action");
	public ra_action_pzsearchcheckedout_3894b4f35afd23d84c4ded3184930383(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCHCHECKEDOUT #20180713T135447.985 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-Desktop";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCHCHECKEDOUT #20180713T135447.985 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Checked out rules overlay");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Checked out rules overlay");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZSEARCHCHECKEDOUT", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSEARCHCHECKEDOUT","Rule-Obj-FlowAction","DATA-PORTAL",false,"","Pega-Desktop","08-01-01","RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCHCHECKEDOUT #20180713T135447.985 GMT","!PZSEARCHCHECKEDOUT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1078778582), 
		new DependentRuleInfo("PYSEARCHTEXT","Rule-Obj-Property","DATA-PORTAL",true,"Data-Portal","Pega-Desktop","08-01-01","RULE-OBJ-PROPERTY DATA-PORTAL PYSEARCHTEXT #20180713T135018.378 GMT","!PYSEARCHTEXT",true,false,"ABSOLUTE_IS_NOT_PRIMARY",0)
	};
...
//	RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCHCHECKEDOUT #20180713T135447.985 GMT:20180713T135447.985 GMT
//	RULE-OBJ-PROPERTY DATA-PORTAL PYSEARCHTEXT #20180713T135018.378 GMT:20180713T135018.378 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "58f20b9779b81c1cdcc572bcb5e2a3b0";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Data-Portal";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:DATA-PORTAL!PZSEARCHCHECKEDOUT",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzSearchCheckedOut";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Checked out rules overlay");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Checked out rules overlay");
		...
		AssignActionPage.putString(".pySectionReference", "pzSearch");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzSearchRunActivity";
// Expression: false
String pz_1 = String.valueOf(false);
			newParamsPage.putString("allResults", pz_1);
			
// Expression: 
			newParamsPage.putString("pxObjClass", "");
			
// Expression: .pySearchText
			newParamsPage.putString("searchText", scalarValueQuery_2.resolveToString(tools, myStepPage, ImmutablePropertyInfo.TYPE_TEXT));
			
// Expression: true
String pz_3 = String.valueOf(true);
			newParamsPage.putString("useCheckedOut", pz_3);
...
private static final ScalarValueQuery scalarValueQuery_2 = FUAUtil.createQueryBuilder().allowMissingPropertyException().scalarProperty("pySearchText").buildScalarValueQuery();

private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION DATA-PORTAL PZSEARCHCHECKEDOUT #20180713T135447.985 GMT", "Data-Portal pzSearchCheckedOut", "Pega-Desktop", "08-01-01", "20180713T135447.985 GMT");
}
