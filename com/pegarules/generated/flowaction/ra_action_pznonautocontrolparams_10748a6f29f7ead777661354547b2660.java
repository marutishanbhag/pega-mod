...
import java.util.*;
public class ra_action_pznonautocontrolparams_10748a6f29f7ead777661354547b2660  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzNonAutoControlParams.Rule_Obj_Property.Action");
	public ra_action_pznonautocontrolparams_10748a6f29f7ead777661354547b2660(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-OBJ-PROPERTY PZNONAUTOCONTROLPARAMS #20180713T135723.713 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-SystemArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-OBJ-PROPERTY PZNONAUTOCONTROLPARAMS #20180713T135723.713 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Parameters");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Parameters");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZNONAUTOCONTROLPARAMS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZNONAUTOCONTROLPARAMS","Rule-Obj-FlowAction","RULE-OBJ-PROPERTY",false,"","Pega-SystemArchitect","08-01-01","RULE-OBJ-FLOWACTION RULE-OBJ-PROPERTY PZNONAUTOCONTROLPARAMS #20180713T135723.713 GMT","!PZNONAUTOCONTROLPARAMS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-495853152)
	};
...
//	RULE-OBJ-FLOWACTION RULE-OBJ-PROPERTY PZNONAUTOCONTROLPARAMS #20180713T135723.713 GMT:20180713T135723.713 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "92b963e94a6491fad404f476195021de";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Obj-Property";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-OBJ-PROPERTY!PZNONAUTOCONTROLPARAMS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzNonAutoControlParams";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Parameters");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Parameters");
		...
		AssignActionPage.putString(".pySectionReference", "pzNonAutoPropPanel_ParamTab");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzNonAutoGenControl_PreProc";
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-OBJ-PROPERTY PZNONAUTOCONTROLPARAMS #20180713T135723.713 GMT", "Rule-Obj-Property pzNonAutoControlParams", "Pega-SystemArchitect", "08-01-01", "20180713T135723.713 GMT");
}
