...
import java.util.*;
public class ra_action_pzcosmosuiunsupported_3dc2be75b3770e44ae11373b3a106cbe  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzCosmosUIUnsupported._baseclass.Action");
	public ra_action_pzcosmosuiunsupported_3dc2be75b3770e44ae11373b3a106cbe(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZCOSMOSUIUNSUPPORTED #20200817T150639.357 GMT	Pega-UIEngine:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		...
		mFlowActionHandle = "RULE-OBJ-FLOWACTION @BASECLASS PZCOSMOSUIUNSUPPORTED #20200817T150639.357 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Cosmos UI Unsupported");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Cosmos UI Unsupported");
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "28659475221e6bad2a6d4a39c5efc00b";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "@baseclass";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:@BASECLASS!PZCOSMOSUIUNSUPPORTED",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzCosmosUIUnsupported";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Cosmos UI Unsupported");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Cosmos UI Unsupported");
		...
		AssignActionPage.putString(".pySectionReference", "pzCosmosUIUnsupported");
