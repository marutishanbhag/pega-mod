...
import java.util.*;
public class ra_action_pzapplicationassumptions_ed6c67c466c96391195721e1bbdfc715  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzApplicationAssumptions.Rule_Application.Action");
	public ra_action_pzapplicationassumptions_ed6c67c466c96391195721e1bbdfc715(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONASSUMPTIONS #20180713T142626.553 GMT	Pega-LP-Application:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-LP-Application";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONASSUMPTIONS #20180713T142626.553 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Assumptions");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Assumptions");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZAPPLICATIONASSUMPTIONS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPLICATIONASSUMPTIONS","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-LP-Application","08-01-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONASSUMPTIONS #20180713T142626.553 GMT","!PZAPPLICATIONASSUMPTIONS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1507694285)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONASSUMPTIONS #20180713T142626.553 GMT:20180713T142626.553 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "de1895201a417bbab1a89586ad15668d";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZAPPLICATIONASSUMPTIONS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzApplicationAssumptions";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Assumptions");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Assumptions");
		...
		AssignActionPage.putString(".pySectionReference", "pzAssumptionsContainer");
...
String pz_1 = String.valueOf(false);
			newParamsPage.putString("EditMode", pz_1);
...
// Expression: "Assumptions"
			newParamsPage.putString("editedSection", "Assumptions");
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONASSUMPTIONS #20180713T142626.553 GMT", "Rule-Application pzApplicationAssumptions", "Pega-LP-Application", "08-01-01", "20180713T142626.553 GMT");
}
