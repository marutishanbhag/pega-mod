...
import java.util.*;
public class ra_action_pzruleset_popupversioninterface_5a653545ff5204be692d323d40459111  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzRuleSet_PopupVersionInterface.Rule_RuleSet_Version.Action");
	public ra_action_pzruleset_popupversioninterface_5a653545ff5204be692d323d40459111(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-RULESET-VERSION PZRULESET_POPUPVERSIONINTERFACE #20180713T135723.734 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-SystemArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-RULESET-VERSION PZRULESET_POPUPVERSIONINTERFACE #20180713T135723.734 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Interface Details");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Interface Details");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZRULESET_POPUPVERSIONINTERFACE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULESET_POPUPVERSIONINTERFACE","Rule-Obj-FlowAction","RULE-RULESET-VERSION",false,"","Pega-SystemArchitect","08-01-01","RULE-OBJ-FLOWACTION RULE-RULESET-VERSION PZRULESET_POPUPVERSIONINTERFACE #20180713T135723.734 GMT","!PZRULESET_POPUPVERSIONINTERFACE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-764271011)
	};
...
//	RULE-OBJ-FLOWACTION RULE-RULESET-VERSION PZRULESET_POPUPVERSIONINTERFACE #20180713T135723.734 GMT:20180713T135723.734 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "cfa4275cbf63ea0d0e2d6e2f1858fd17";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-RuleSet-Version";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-RULESET-VERSION!PZRULESET_POPUPVERSIONINTERFACE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzRuleSet_PopupVersionInterface";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Interface Details");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Interface Details");
		...
		AssignActionPage.putString(".pySectionReference", "pzRuleSet_RuleSetVersionInterface");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzRuleSet_SetComponentDefaults";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzRuleSet_ValidateVersionComponent";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-RULESET-VERSION PZRULESET_POPUPVERSIONINTERFACE #20180713T135723.734 GMT", "Rule-RuleSet-Version pzRuleSet_PopupVersionInterface", "Pega-SystemArchitect", "08-01-01", "20180713T135723.734 GMT");
}
