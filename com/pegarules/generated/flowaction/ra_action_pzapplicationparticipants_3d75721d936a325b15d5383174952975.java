...
import java.util.*;
public class ra_action_pzapplicationparticipants_3d75721d936a325b15d5383174952975  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzApplicationParticipants.Rule_Application.Action");
	public ra_action_pzapplicationparticipants_3d75721d936a325b15d5383174952975(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONPARTICIPANTS #20180713T142626.571 GMT	Pega-LP-Application:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-LP-Application";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONPARTICIPANTS #20180713T142626.571 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Participants");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Participants");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZAPPLICATIONPARTICIPANTS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPLICATIONPARTICIPANTS","Rule-Obj-FlowAction","RULE-APPLICATION",false,"","Pega-LP-Application","08-01-01","RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONPARTICIPANTS #20180713T142626.571 GMT","!PZAPPLICATIONPARTICIPANTS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-285721366)
	};
...
//	RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONPARTICIPANTS #20180713T142626.571 GMT:20180713T142626.571 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "e9be4ad1b8cdcec8d178039a2f699a31";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Application";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-APPLICATION!PZAPPLICATIONPARTICIPANTS",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzApplicationParticipants";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Participants");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Participants");
		...
		AssignActionPage.putString(".pySectionReference", "pzParticipantsContainer");
		...
		AssignActionPage.putString(".pyDisqualifyAction", "false");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strTransform = "pzSetRightLayoutEditMode";
// Expression: 
			newParamsPage.putString("EditMode", "");
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzLPSaveAppWrapper";
			if (actType.equals("POSTCONNECTOR"))
			{
...
// Expression: Participants
			newParamsPage.putString("editedSection", "Participants");
			try {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-APPLICATION PZAPPLICATIONPARTICIPANTS #20180713T142626.571 GMT", "Rule-Application pzApplicationParticipants", "Pega-LP-Application", "08-01-01", "20180713T142626.571 GMT");
}
