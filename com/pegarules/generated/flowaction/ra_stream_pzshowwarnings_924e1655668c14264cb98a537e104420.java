...
/**
 * Builds JSP stream @BASECLASS!PZSHOWWARNINGS.
 */
public class ra_stream_pzshowwarnings_924e1655668c14264cb98a537e104420 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzShowWarnings.Rule_.Stream");
 ...
 */
	public ra_stream_pzshowwarnings_924e1655668c14264cb98a537e104420(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a93fb396a05fd1ba5677c2383392f6bb50ff37c2";
...
{
/* Instance RULE-OBJ-FLOWACTION @BASECLASS PZSHOWWARNINGS #20181119T214444.087 GMT	Pega-Desktop:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-OBJ-FLOWACTION @BASECLASS PZSHOWWARNINGS #20181119T214444.087 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-OBJ-FLOWACTION @BASECLASS PZSHOWWARNINGS #20181119T214444.087 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-OBJ-FLOWACTION @BASECLASS PZSHOWWARNINGS #20181119T214444.087 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZSHOWWARNINGS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSHOWWARNINGS","Rule-Obj-FlowAction","@BASECLASS",false,"","Pega-Desktop","08-02-01","RULE-OBJ-FLOWACTION @BASECLASS PZSHOWWARNINGS #20181119T214444.087 GMT","!PZSHOWWARNINGS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",688895385)
	};
...
//	RULE-OBJ-FLOWACTION @BASECLASS PZSHOWWARNINGS #20181119T214444.087 GMT:20181119T214444.087 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES GETRULESYSTEMSETTING #20180713T131444.340 GMT:20180713T131444.340 GMT
	...
	public static String getFUAContentHash() {
		return "124f3be9a923c6d762ee0c0bd8fcd148";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_1","pzWarningsWrapper", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzWarningsWrapper";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
tools.putParamValue("flowActionUIRef","pzWarningsWrapper"); 
tools.appendString(" ");
...
out.print( pzAuto.getInpectorData("FlowAction", "", "","pzShowWarnings","Rule-Obj-FlowAction","@baseclass") );
tools.appendString(" >");
 } 
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
pzPackageRuntime.packageSection("pzWarningsWrapper",tools.getStepPage().getReference(), null);
tools.appendString("<div id='section-placeholder' data-class='");
out.print(tools.getStepPage().getString("pxObjClass"));
tools.appendString("' data-section='pzWarningsWrapper'></div> ");
} else {
includeSectionBody_1();
}
tools.appendString("<span style=\"display: none;\" uitype=\"Rule-HTML-Section\" id=\"pzFlowActionUITypeRef\" uiref=\"pzWarningsWrapper\"></span> ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-OBJ-FLOWACTION @BASECLASS PZSHOWWARNINGS #20181119T214444.087 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzShowWarnings");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION @BASECLASS PZSHOWWARNINGS #20181119T214444.087 GMT", "@baseclass pzShowWarnings", "Pega-Desktop", "08-02-01", "20181119T214444.087 GMT");
}
