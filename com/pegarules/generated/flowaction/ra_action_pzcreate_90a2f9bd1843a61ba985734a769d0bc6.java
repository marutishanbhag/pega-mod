...
import java.util.*;
public class ra_action_pzcreate_90a2f9bd1843a61ba985734a769d0bc6  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzCreate.Rule_Persona.Action");
	public ra_action_pzcreate_90a2f9bd1843a61ba985734a769d0bc6(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION RULE-PERSONA PZCREATE #20191112T133933.442 GMT	Pega-AppDefinition:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-AppDefinition";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION RULE-PERSONA PZCREATE #20191112T133933.442 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "New persona");
		}
		...
		{
			tools.putParamValue("pzFALabel", "New persona");
		}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCREATE","Rule-Obj-FlowAction","RULE-PERSONA",false,"","Pega-AppDefinition","08-04-01","RULE-OBJ-FLOWACTION RULE-PERSONA PZCREATE #20191112T133933.442 GMT","!PZCREATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1473822752)
	};
...
//	RULE-OBJ-FLOWACTION RULE-PERSONA PZCREATE #20191112T133933.442 GMT:20191123T144855.455 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "6d48e3d31153c1668c9064bbfaacba87";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Rule-Persona";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:RULE-PERSONA!PZCREATE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	private boolean AddFlowAction_circum0(String strActionType, ClipboardPage newAssignPage, boolean isSelectedAction, boolean displaySeparatorAbove)
	{
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "New persona");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "New persona");
		...
		AssignActionPage.putString(".pySectionReference", "pzPersonaDetails");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzCreatePersonaInit";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzEditPersonaWrapper";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION RULE-PERSONA PZCREATE #20191112T133933.442 GMT", "Rule-Persona pzCreate", "Pega-AppDefinition", "08-04-01", "20191123T144855.455 GMT");
}
