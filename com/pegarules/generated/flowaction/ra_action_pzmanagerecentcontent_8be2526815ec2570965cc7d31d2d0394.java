...
import java.util.*;
public class ra_action_pzmanagerecentcontent_8be2526815ec2570965cc7d31d2d0394  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzManageRecentContent.Work_.Action");
	public ra_action_pzmanagerecentcontent_8be2526815ec2570965cc7d31d2d0394(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION WORK- PZMANAGERECENTCONTENT #20181120T090540.311 GMT	Pega-EndUserUI:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-EndUserUI";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION WORK- PZMANAGERECENTCONTENT #20181120T090540.311 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Manage content");
		}
		...
		else if (purpose.equals("VALIDATE"))
		{
			...
			if (newAssignPage == null || (newAssignPage != null && !pega_procom_pegaprocomutilities.determineDeferErrors(newAssignPage, workPage)))
			{
				...
				if (!workPageName.equals("AddRecentContent"))
				{
					otherPageInTransaction = tools.findPage("AddRecentContent");
			...
			if (!workPageName.equals("AddRecentContent"))
			{
				...
				if (otherPageInTransaction != null && otherPageInTransaction.hasMessages())
				{
					...
					newParamsPage.putString("pagename", "AddRecentContent");
		...
		{
			tools.putParamValue("pzFALabel", "Manage content");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZMANAGERECENTCONTENT"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZMANAGERECENTCONTENT","Rule-Obj-FlowAction","WORK-",false,"","Pega-EndUserUI","08-02-01","RULE-OBJ-FLOWACTION WORK- PZMANAGERECENTCONTENT #20181120T090540.311 GMT","!PZMANAGERECENTCONTENT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-321322097)
	};
...
//	RULE-OBJ-FLOWACTION WORK- PZMANAGERECENTCONTENT #20181120T090540.311 GMT:20181120T090540.311 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "84e326585944fe22a704ce85945b8327";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Work-";
			 ...
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:WORK-!PZMANAGERECENTCONTENT",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzManageRecentContent";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Manage content");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Manage content");
		...
		AssignActionPage.putString(".pySectionReference", "pyEnterCaseDetails");
	...
	private void RunFlowActionActivity_circum0(String actType)
	{
		...
		{
			strActivityToRun = "pzManageRecentContentPreProcessing";
			try {
		...
		else if (actType.startsWith("POST"))
		{
			...
			strActivityToRun = "pzManageContentPostProcessing";
			if (actType.equals("POSTCONNECTOR"))
			{
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION WORK- PZMANAGERECENTCONTENT #20181120T090540.311 GMT", "Work- pzManageRecentContent", "Pega-EndUserUI", "08-02-01", "20181120T090540.311 GMT");
}
