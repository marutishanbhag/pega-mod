...
import java.util.*;
public class ra_action_pzswitchharnesstemplate_ea4c952bcc2662d43ab678ca5947496f  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_FlowAction.pzSwitchHarnessTemplate.Embed_TemplateHarness.Action");
	public ra_action_pzswitchharnesstemplate_ea4c952bcc2662d43ab678ca5947496f(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOWACTION EMBED-TEMPLATEHARNESS PZSWITCHHARNESSTEMPLATE #20181017T165451.607 GMT	Pega-ProcessArchitect:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-ProcessArchitect";
		mFlowActionHandle = "RULE-OBJ-FLOWACTION EMBED-TEMPLATEHARNESS PZSWITCHHARNESSTEMPLATE #20181017T165451.607 GMT";
		...
		else if (purpose.equals("ACTIVITY"))
		{
			...
			tools.putParamValue("pyActionLabel", "Select a template");
		}
		...
		{
			tools.putParamValue("pzFALabel", "Select a template");
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-FlowAction:PZSWITCHHARNESSTEMPLATE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSWITCHHARNESSTEMPLATE","Rule-Obj-FlowAction","EMBED-TEMPLATEHARNESS",false,"","Pega-ProcessArchitect","08-02-01","RULE-OBJ-FLOWACTION EMBED-TEMPLATEHARNESS PZSWITCHHARNESSTEMPLATE #20181017T165451.607 GMT","!PZSWITCHHARNESSTEMPLATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",2110972358)
	};
...
//	RULE-OBJ-FLOWACTION EMBED-TEMPLATEHARNESS PZSWITCHHARNESSTEMPLATE #20181017T165451.607 GMT:20181017T165451.607 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ESCAPESPECIALCHARSANDQUOTE #20180713T131443.047 GMT:20180713T131443.047 GMT
	...
	public static String getFUAContentHash() {
		return "24800e536f2a148ec757aec29e42ed14";
	}
...
return "Action";
	...
	private boolean CheckPrivileges_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Embed-TemplateHarness";
		 }
			 if(!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOWACTION:EMBED-TEMPLATEHARNESS!PZSWITCHHARNESSTEMPLATE",primaryPageClassName, interestPage,true))
			 hasSecurity = true;
		if (!hasSecurity)
			return false;
	...
	{
		String strActionName = "pzSwitchHarnessTemplate";
		...
		String strActionLabel = tools.getLocalizedTextForString("pyCaption", "Select a template");
		AssignActionPage.putString(".pyActionLabel", strActionLabel);
		AssignActionPage.putString(".pyLabel", "Select a template");
		...
		AssignActionPage.putString(".pySectionReference", "pzSwitchHarnessTemplate");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOWACTION EMBED-TEMPLATEHARNESS PZSWITCHHARNESSTEMPLATE #20181017T165451.607 GMT", "Embed-TemplateHarness pzSwitchHarnessTemplate", "Pega-ProcessArchitect", "08-02-01", "20181017T165451.607 GMT");
}
