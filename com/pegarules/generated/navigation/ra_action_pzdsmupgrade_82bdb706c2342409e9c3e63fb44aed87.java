...
import java.util.*;
public class ra_action_pzdsmupgrade_82bdb706c2342409e9c3e63fb44aed87  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzDSMUpgrade.Pega_Landing.Action");
	public ra_action_pzdsmupgrade_82bdb706c2342409e9c3e63fb44aed87(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION PEGA-LANDING PZDSMUPGRADE #20220715T114757.438 GMT	Pega-DecisionArchitect:08-08-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "pzDSMUpgrade"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("pzDSMUpgrade");
	}
}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZDSMUPGRADE","Rule-Navigation","PEGA-LANDING",false,"","Pega-DecisionArchitect","08-08-01","RULE-NAVIGATION PEGA-LANDING PZDSMUPGRADE #20220715T114757.438 GMT","!PZDSMUPGRADE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",55290072)
	};
...
//	RULE-NAVIGATION PEGA-LANDING PZDSMUPGRADE #20220715T114757.438 GMT:20220715T114757.438 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "3e3a673876542fc5910eefa0c059f032";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"pzDSMUpgrade" */
...
if( processAction ||(processShortcut && "ID1406105837700000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1406105837700000")){
return;}
if(processShortcut &&"ID1406105837700000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","ID1406105837700000");actionPage1.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Migration"));actionPage1.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage1.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage1.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","20171120163201024421");}actionPage1.putString( "pyBadgeFormat","Standard (label)");actionPage1.putString( "pyDeferLoad","false");actionPage1.putString( "pyImage","");if (!hideElement) { 
...
deferLoad = false;
if((!deferLoad && StringUtils.isBlank(deferLoadPath)) || (!StringUtils.isBlank(deferLoadPath) && ( deferIndex>=deferPathArr.length || deferPathArr[deferIndex].equalsIgnoreCase("ID1406105837700000")))){
deferIndex ++;
...
if(processAction||("ID1405437458776000".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
...
/*Node Generated for caption -  and Name - ID1405437458776000*/
...
actionPage2.putString("pyHidden",String.valueOf(hideElement));actionPage2.putString("pyDisabled",String.valueOf(disableElement));actionPage2.putString( "pyName","ID1405437458776000");actionPage2.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Adaptive Model Schema Migration"));actionPage2.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage2.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage2.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage2.putString( "pyAutomationID","201711201632000834687");}actionPage2.putString( "pyBadgeFormat","Standard (label)");actionPage2.putString( "pyDeferLoad","false");actionPage2.putString( "pyImage","");actionPage2.putString("pyType","Action");
...
commandPage2.putString( "pyClass","PegaAccel-Management-Decision-ADMSchemaMigration");commandPage2.putString( "pywizardLabel","Adaptive Model Schema Migration");executePage.putPage("pyOpenWizard",commandPage2);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION PEGA-LANDING PZDSMUPGRADE #20220715T114757.438 GMT", "Pega-Landing pzDSMUpgrade", "Pega-DecisionArchitect", "08-08-01", "20220715T114757.438 GMT");
}
