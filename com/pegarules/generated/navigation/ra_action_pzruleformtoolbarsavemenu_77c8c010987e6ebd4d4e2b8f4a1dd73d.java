...
import java.util.*;
public class ra_action_pzruleformtoolbarsavemenu_77c8c010987e6ebd4d4e2b8f4a1dd73d  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzRuleFormToolbarSaveMenu._baseclass.Action");
	public ra_action_pzruleformtoolbarsavemenu_77c8c010987e6ebd4d4e2b8f4a1dd73d(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARSAVEMENU #20180713T135314.126 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMTOOLBARSAVEMENU","Rule-Navigation","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARSAVEMENU #20180713T135314.126 GMT","!PZRULEFORMTOOLBARSAVEMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-194353270)
	};
...
//	RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARSAVEMENU #20180713T135314.126 GMT:20180713T135314.126 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "d21ef9a211f2bdd8895334497fbd1349";
	}
...
if( processAction ||(processShortcut && "ID1365706626383001".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1365706626383001")){
return;}
if(processShortcut &&"ID1365706626383001".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
commandPage3.putString( "pyFunctionName","postRuleFormValues");behaviorPage3.putPage("pyActionAPI",commandPage3);
((PegaAPI)tools).getUIEngine().getUIAction(actionPage1.getPage("pyBehaviors(<LAST>)")).register();
...
commandPage6.putString( "pyFunctionName","onAfterExecuteSaveAs");behaviorPage6.putPage("pyActionAPI",commandPage6);
((PegaAPI)tools).getUIEngine().getUIAction(actionPage1.getPage("pyBehaviors(<LAST>)")).register();
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARSAVEMENU #20180713T135314.126 GMT", "@baseclass pzRuleFormToolbarSaveMenu", "Pega-Desktop", "08-01-01", "20180713T135314.126 GMT");
}
