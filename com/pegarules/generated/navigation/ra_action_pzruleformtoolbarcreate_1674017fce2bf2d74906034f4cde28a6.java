...
import java.util.*;
public class ra_action_pzruleformtoolbarcreate_1674017fce2bf2d74906034f4cde28a6  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzRuleFormToolbarCreate._baseclass.Action");
	public ra_action_pzruleformtoolbarcreate_1674017fce2bf2d74906034f4cde28a6(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARCREATE #20180713T135314.098 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "pzRuleFormToolbarCreate"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("pzRuleFormToolbarCreate");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZRULEFORMTOOLBARCREATE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMTOOLBARCREATE","Rule-Navigation","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARCREATE #20180713T135314.098 GMT","!PZRULEFORMTOOLBARCREATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1782627268)
	};
...
//	RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARCREATE #20180713T135314.098 GMT:20180713T135314.098 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "3ca9b9cb8d4e18ce53394e231868d80f";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"pzRuleFormToolbarCreate" */
...
if( processAction ||(processShortcut && "ID1494534934331000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1494534934331000")){
return;}
if(processShortcut &&"ID1494534934331000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
String whenResolved ="pzShowNewMenu";
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","ID1494534934331000");actionPage1.putString( "pyImageSource","styleclass");actionPage1.putString( "pyIconStyle","hotkey-ruleform-new");actionPage1.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Create"));actionPage1.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage1.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage1.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","20180626032418005524");}actionPage1.putString( "pyBadgeFormat","Standard (label)");actionPage1.putString( "pyDeferLoad","false");actionPage1.putString( "pyImage","hotkey-ruleform-new");if (!hideElement) { 
...
propertyValue = ".pxObjClass";
propertyValue = tools.getParamValue("ApplyToPage")+".pxObjClass";commandPage1.getProperty("pyParameters").getPageValue(1).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage1.getProperty("pyParameters").getPageValue(1).putString( "pyName","");commandPage1.getProperty("pyParameters").getPageValue(2).putString( "pyValue","");commandPage1.getProperty("pyParameters").getPageValue(2).putString( "pyName","");propertyValue = ".pyClassName";
propertyValue = tools.getParamValue("ApplyToPage")+".pyClassName";commandPage1.getProperty("pyParameters").getPageValue(3).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage1.getProperty("pyParameters").getPageValue(3).putString( "pyName","");commandPage1.getProperty("pyParameters").getPageValue(4).putString( "pyValue","true");commandPage1.getProperty("pyParameters").getPageValue(4).putString( "pyName","");commandPage1.putString( "pyFunctionName","OpenRuleInPortal");executePage.putPage("pyCustom",commandPage1);
...
behaviorPage2.putString("pyAction","createWork");ClipboardPage commandPage2 = tools.createPage("Embed-DesktopAPI-CreateNewWork","commandType");
commandPage2.putString( "pyClassName","Work-ProjectManagement-New");commandPage2.putString( "pyFlowName","NewModalFlow");commandPage2.putString( "pyElementName","");commandPage2.putString( "pyTargetElement","");commandPage2.putString( "pyIsTargetMicroDC","false");commandPage2.putString( "pyACName","");commandPage2.putString( "pySelectedMobileTransitionType","pega.mobile.transitions.NONE");propertyValue = ".pxObjClass";
propertyValue = tools.getParamValue("ApplyToPage")+".pxObjClass";commandPage2.getProperty("pyFlowParameters").getPageValue(1).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage2.getProperty("pyFlowParameters").getPageValue(1).putString( "pyName","newObjClass");commandPage2.getProperty("pyFlowParameters").getPageValue(1).putString( "pxObjClass","Embed-MethodParams");propertyValue = ".pyClassName";
propertyValue = tools.getParamValue("ApplyToPage")+".pyClassName";commandPage2.getProperty("pyFlowParameters").getPageValue(2).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage2.getProperty("pyFlowParameters").getPageValue(2).putString( "pyName","newClassName");commandPage2.getProperty("pyFlowParameters").getPageValue(2).putString( "pxObjClass","Embed-MethodParams");propertyValue = ".pyRuleSet";
propertyValue = tools.getParamValue("ApplyToPage")+".pyRuleSet";commandPage2.getProperty("pyFlowParameters").getPageValue(3).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage2.getProperty("pyFlowParameters").getPageValue(3).putString( "pyName","RuleSetName");commandPage2.getProperty("pyFlowParameters").getPageValue(3).putString( "pxObjClass","Embed-MethodParams");commandPage2.getProperty("pyFlowParameters").getPageValue(4).putString( "pyValue","");commandPage2.getProperty("pyFlowParameters").getPageValue(4).putString( "pyName","targetProperty");commandPage2.getProperty("pyFlowParameters").getPageValue(4).putString( "pxObjClass","Embed-MethodParams");commandPage2.getProperty("pyFlowParameters").getPageValue(5).putString( "pyValue","");commandPage2.getProperty("pyFlowParameters").getPageValue(5).putString( "pyName","pageContext");commandPage2.getProperty("pyFlowParameters").getPageValue(5).putString( "pxObjClass","Embed-MethodParams");commandPage2.getProperty("pyFlowParameters").getPageValue(6).putString( "pyValue","");commandPage2.getProperty("pyFlowParameters").getPageValue(6).putString( "pyName","newLabel");commandPage2.getProperty("pyFlowParameters").getPageValue(6).putString( "pxObjClass","Embed-MethodParams");commandPage2.getProperty("pyFlowParameters").getPageValue(7).putString( "pyValue","");commandPage2.getProperty("pyFlowParameters").getPageValue(7).putString( "pyName","newExpression");commandPage2.getProperty("pyFlowParameters").getPageValue(7).putString( "pxObjClass","Embed-MethodParams");commandPage2.getProperty("pyFlowParameters").getPageValue(8).putString( "pyValue","false");commandPage2.getProperty("pyFlowParameters").getPageValue(8).putString( "pyName","jumpToCreateAndOpen");commandPage2.getProperty("pyFlowParameters").getPageValue(8).putString( "pxObjClass","Embed-MethodParams");behaviorPage2.putPage("pyActionAPI",commandPage2);
((PegaAPI)tools).getUIEngine().getUIAction(actionPage1.getPage("pyBehaviors(<LAST>)")).register();
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARCREATE #20180713T135314.098 GMT", "@baseclass pzRuleFormToolbarCreate", "Pega-Desktop", "08-01-01", "20180713T135314.098 GMT");
}
