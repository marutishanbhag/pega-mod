...
import java.util.*;
public class ra_action_pzruleformtoolbarsearchrule_2730876f5e6e87fc1f3aed219faf1b4e  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzRuleFormToolbarSearchRule._baseclass.Action");
	public ra_action_pzruleformtoolbarsearchrule_2730876f5e6e87fc1f3aed219faf1b4e(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARSEARCHRULE #20180713T135314.131 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(false){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "pzRuleFormToolbarSearchRule"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("pzRuleFormToolbarSearchRule");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZRULEFORMTOOLBARSEARCHRULE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMTOOLBARSEARCHRULE","Rule-Navigation","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARSEARCHRULE #20180713T135314.131 GMT","!PZRULEFORMTOOLBARSEARCHRULE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1391763775)
	};
...
//	RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARSEARCHRULE #20180713T135314.131 GMT:20180713T135314.131 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "6f2292cc748d5477452004fa4e6699b5";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"pzRuleFormToolbarSearchRule" */
...
if( processAction ||(processShortcut && "ID1435339363721000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1435339363721000")){
return;}
if(processShortcut &&"ID1435339363721000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
String whenResolved ="pyHighlightRuleSearchEnabled";
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","ID1435339363721000");actionPage1.putString( "pyImageSource","styleclass");actionPage1.putString( "pyIconStyle","hotkey-ruleform-ruleSearch");actionPage1.putString( "pyCaption","Search rule");actionPage1.putString( "pySummary","");actionPage1.putString( "pyBadgeProperty","");actionPage1.putString( "pyToolTip","");if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","");}actionPage1.putString( "pyBadgeFormat","Standard (label)");actionPage1.putString( "pyDeferLoad","false");actionPage1.putString( "pyImage","hotkey-ruleform-ruleSearch");if (!hideElement) { 
...
commandPage1.putString( "pyFunctionName","pega.desktop.search.show");executePage.putPage("pyCustom",commandPage1);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARSEARCHRULE #20180713T135314.131 GMT", "@baseclass pzRuleFormToolbarSearchRule", "Pega-Desktop", "08-01-01", "20180713T135314.131 GMT");
}
