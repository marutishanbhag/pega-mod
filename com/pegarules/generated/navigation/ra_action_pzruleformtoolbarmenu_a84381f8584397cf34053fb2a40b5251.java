...
import java.util.*;
public class ra_action_pzruleformtoolbarmenu_a84381f8584397cf34053fb2a40b5251  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzRuleFormToolbarMenu.Rule_Obj_Property.Action");
	public ra_action_pzruleformtoolbarmenu_a84381f8584397cf34053fb2a40b5251(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION RULE-OBJ-PROPERTY PZRULEFORMTOOLBARMENU #20180713T135317.464 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZRULEFORMTOOLBARMENU"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMTOOLBARMENU","Rule-Navigation","RULE-OBJ-PROPERTY",false,"","Pega-Desktop","08-01-01","RULE-NAVIGATION RULE-OBJ-PROPERTY PZRULEFORMTOOLBARMENU #20180713T135317.464 GMT","!PZRULEFORMTOOLBARMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1807744463)
	};
...
//	RULE-NAVIGATION RULE-OBJ-PROPERTY PZRULEFORMTOOLBARMENU #20180713T135317.464 GMT:20180713T135317.464 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "745afac7b44a725cac9bbbabc430c573";
	}
...
pega_uiengine_pznavigation.pzProcessNavigationNode("Rule-Obj-Property","pzRuleFormToolbarActionsMenu",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
...
actionPage2.putString("pyHidden",String.valueOf(hideElement));actionPage2.putString("pyDisabled",String.valueOf(disableElement));actionPage2.putString( "pyName","");actionPage2.putString( "pyCaption","------------------");actionPage2.putString( "pySummary","");actionPage2.putString( "pyBadgeProperty","");actionPage2.putString( "pyToolTip","");actionPage2.putString( "pyBadgeFormat","");actionPage2.putString( "pyDeferLoad","");actionPage2.putString( "pyImage","");actionPage2.putString("pyType","Separator");
if(!processShortcut){
}else {
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1527655347325000".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1527655347325000")){
return;}
if(processShortcut &&"ID1527655347325000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
String whenResolved ="pzDisplayMarkAsRelevantAtRuleActions";
...
if (!hideElement) {
enableWhenCondition = pega_uiengine_pznavigation.evaluateWhen("pzEnableMarkAsRelevantRecordAction",tools.getStepPage().getClassName(),tools);
disableElement = !enableWhenCondition;
if(!disableElement) {
}
}
actionPage3.putString("pyHidden",String.valueOf(hideElement));actionPage3.putString("pyDisabled",String.valueOf(disableElement));actionPage3.putString( "pyName","ID1527655347325000");actionPage3.putString( "pyCaption","Mark as relevant record");actionPage3.putString( "pySummary","");actionPage3.putString( "pyBadgeProperty","");actionPage3.putString( "pyToolTip","Mark as relevant record");if(testIDWhen || functionalTestingWhen){actionPage3.putString( "pyAutomationID","201805300042270148286");}actionPage3.putString( "pyBadgeFormat","Standard (label)");actionPage3.putString( "pyDeferLoad","false");actionPage3.putString( "pyImage","");if (!hideElement) { 
...
commandPage3.putString( "pyActivity","pxSetRelevantRecord");commandPage3.putString( "pyUsingPage", tools.getStepPage().getReference());propertyValue = ".pyClassName";
propertyValue = tools.getParamValue("ApplyToPage")+".pyClassName";commandPage3.getProperty("pyActivityParameters").getPageValue(1).putString("pyValue",java.net.URLEncoder.encode(tools.getProperty(propertyValue).getStringValue()));commandPage3.getProperty("pyActivityParameters").getPageValue(1).putString( "pyName","ContextClass");commandPage3.getProperty("pyActivityParameters").getPageValue(1).putString( "pxObjClass","Embed-NameValuePair");propertyValue = ".pxObjClass";
propertyValue = tools.getParamValue("ApplyToPage")+".pxObjClass";commandPage3.getProperty("pyActivityParameters").getPageValue(2).putString("pyValue",java.net.URLEncoder.encode(tools.getProperty(propertyValue).getStringValue()));commandPage3.getProperty("pyActivityParameters").getPageValue(2).putString( "pyName","RecordType");commandPage3.getProperty("pyActivityParameters").getPageValue(2).putString( "pxObjClass","Embed-NameValuePair");propertyValue = ".pxInsId";
propertyValue = tools.getParamValue("ApplyToPage")+".pxInsId";commandPage3.getProperty("pyActivityParameters").getPageValue(3).putString("pyValue",java.net.URLEncoder.encode(tools.getProperty(propertyValue).getStringValue()));commandPage3.getProperty("pyActivityParameters").getPageValue(3).putString( "pyName","RecordIdentifier");commandPage3.getProperty("pyActivityParameters").getPageValue(3).putString( "pxObjClass","Embed-NameValuePair");commandPage3.getProperty("pyActivityParameters").getPageValue(4).putString( "pyValue","true");commandPage3.getProperty("pyActivityParameters").getPageValue(4).putString( "pyName","Commit");commandPage3.getProperty("pyActivityParameters").getPageValue(4).putString( "pxObjClass","Embed-NameValuePair");commandPage3.getProperty("pyActivityParameters").getPageValue(5).putString( "pyValue","false");commandPage3.getProperty("pyActivityParameters").getPageValue(5).putString( "pyName","InitializeWhenMissing");commandPage3.getProperty("pyActivityParameters").getPageValue(5).putString( "pxObjClass","Embed-NameValuePair");executePage.putPage("pyRunActivity",commandPage3);
...
commandPage4.putString( "pyTarget","otherSection");commandPage4.putString( "pyUsingPage","");commandPage4.putString( "pyActivity","pzSetConfirmationMessageVisibility");commandPage4.putString( "pySection","pyRuleFormHeaderMessagesInner");commandPage4.putString( "pyDisableSubmit","false");commandPage4.getProperty("pyPreDataTransform").getPageValue().putString( "pyName","");commandPage4.getProperty("pyActivityParameters").getPageValue(1).putString( "pyValue","pzDisplayMarkedRelevantCnfMsg");commandPage4.getProperty("pyActivityParameters").getPageValue(1).putString( "pyName","PropertyToSet");commandPage4.getProperty("pyActivityParameters").getPageValue(1).putString( "pxObjClass","Embed-NameValuePair");commandPage4.getProperty("pyActivityParameters").getPageValue(2).putString( "pyValue","true");commandPage4.getProperty("pyActivityParameters").getPageValue(2).putString( "pyName","ValueToSet");commandPage4.getProperty("pyActivityParameters").getPageValue(2).putString( "pxObjClass","Embed-NameValuePair");commandPage4.getPage("pyPreDataTransform").getProperty("pyDataTransformParams").getPageValue(1).putString( "pyValue","");commandPage4.getPage("pyPreDataTransform").getProperty("pyDataTransformParams").getPageValue(1).putString( "pyName","");behaviorPage4.putPage("pyActionAPI",commandPage4);
((PegaAPI)tools).getUIEngine().getUIAction(actionPage3.getPage("pyBehaviors(<LAST>)")).register();
...
actionPage5.putString("pyHidden",String.valueOf(hideElement));actionPage5.putString("pyDisabled",String.valueOf(disableElement));actionPage5.putString( "pyName","");actionPage5.putString( "pyCaption","------------------");actionPage5.putString( "pySummary","");actionPage5.putString( "pyBadgeProperty","");actionPage5.putString( "pyToolTip","");actionPage5.putString( "pyBadgeFormat","Standard (label)");actionPage5.putString( "pyDeferLoad","false");actionPage5.putString( "pyImage","");if (!hideElement) { 
actionPage5.putString("pyType","Separator");
if(!processShortcut){
}else {
if(!(nodePath.indexOf("/")!=-1))
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("Rule-Obj-Property","pzRuleFormToolbarViewMenu",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
tools.putParamValue("deferLoadPath", deferLoadPath);
}//end of if for pxProcessShortcut
}//end of method
/* Method generated for Top Level Node -"------------------" for Navigation Rule :"Ruleform Toolbar Menu" */
...
actionPage7.putString("pyHidden",String.valueOf(hideElement));actionPage7.putString("pyDisabled",String.valueOf(disableElement));actionPage7.putString( "pyName","");actionPage7.putString( "pyCaption","------------------");actionPage7.putString( "pySummary","");actionPage7.putString( "pyBadgeProperty","");actionPage7.putString( "pyToolTip","");actionPage7.putString( "pyBadgeFormat","");actionPage7.putString( "pyDeferLoad","");actionPage7.putString( "pyImage","");actionPage7.putString("pyType","Separator");
if(!processShortcut){
}else {
if(!(nodePath.indexOf("/")!=-1))
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1386866314168000".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1386866314168000")){
return;}
if(processShortcut &&"ID1386866314168000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
showWhenCondition = true;
String whenResolved ="pzShowPropertyOptimization";
if (!whenResolved.isEmpty()) {
try{showWhenCondition = pega_uiengine_pznavigation.evaluateWhen(whenResolved,tools.getStepPage().getClassName(),tools);
}catch(Exception e){oLog.error("Failed to resolve when rule:" + e);}
}
...
actionPage8.putString("pyHidden",String.valueOf(hideElement));actionPage8.putString("pyDisabled",String.valueOf(disableElement));actionPage8.putString( "pyName","ID1386866314168000");actionPage8.putString( "pyCaption","Optimize for reporting");actionPage8.putString( "pySummary","");actionPage8.putString( "pyBadgeProperty","");actionPage8.putString( "pyToolTip","");if(testIDWhen || functionalTestingWhen){actionPage8.putString( "pyAutomationID","201803011759170918428");}actionPage8.putString( "pyBadgeFormat","");actionPage8.putString( "pyDeferLoad","");actionPage8.putString( "pyImage","");if (!hideElement) { 
...
behaviorPage8.putString("pyAction","openWizard");ClipboardPage commandPage8 = tools.createPage("Embed-DesktopAPI-OpenWizard","commandType");
commandPage8.putString( "pyClass","PegaAccel-Task-OptimizeProperty");commandPage8.putString( "pywizardLabel","Property Optimization");commandPage8.getProperty("pyParameters").getPageValue(1).putString( "pyValue","PegaAccel-Task-OptimizeProperty.pzBulkOptimization");commandPage8.getProperty("pyParameters").getPageValue(1).putString( "pyName","pyActivity");propertyValue = ".pyRuleName";
propertyValue = tools.getParamValue("ApplyToPage")+".pyRuleName";commandPage8.getProperty("pyParameters").getPageValue(2).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage8.getProperty("pyParameters").getPageValue(2).putString( "pyName","PropertyName");propertyValue = ".pyClassName";
propertyValue = tools.getParamValue("ApplyToPage")+".pyClassName";commandPage8.getProperty("pyParameters").getPageValue(3).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage8.getProperty("pyParameters").getPageValue(3).putString( "pyName","PropertyClass");propertyValue = ".pyClassName";
propertyValue = tools.getParamValue("ApplyToPage")+".pyClassName";commandPage8.getProperty("pyParameters").getPageValue(4).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage8.getProperty("pyParameters").getPageValue(4).putString( "pyName","ClassName");propertyValue = ".pyPropertyMode";
propertyValue = tools.getParamValue("ApplyToPage")+".pyPropertyMode";commandPage8.getProperty("pyParameters").getPageValue(5).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage8.getProperty("pyParameters").getPageValue(5).putString( "pyName","PropertyMode");propertyValue = ".pyRuleName";
propertyValue = tools.getParamValue("ApplyToPage")+".pyRuleName";commandPage8.getProperty("pyParameters").getPageValue(6).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage8.getProperty("pyParameters").getPageValue(6).putString( "pyName","PropertyPath");executePage.putPage("pyOpenWizard",commandPage8);
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("Rule-Obj-Property","pzRuleFormToolbarHelpMenu",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
tools.putParamValue("deferLoadPath", deferLoadPath);
}//end of if for pxProcessShortcut
}//end of method
/* Method generated for Top Level Node -"" for Navigation Rule :"Ruleform Toolbar Menu" */
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("Rule-Obj-Property","pzRuleFormToolbarCreate",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
tools.putParamValue("deferLoadPath", deferLoadPath);
}//end of if for pxProcessShortcut
}//end of method
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION RULE-OBJ-PROPERTY PZRULEFORMTOOLBARMENU #20180713T135317.464 GMT", "Rule-Obj-Property pzRuleFormToolbarMenu", "Pega-Desktop", "08-01-01", "20180713T135317.464 GMT");
}
