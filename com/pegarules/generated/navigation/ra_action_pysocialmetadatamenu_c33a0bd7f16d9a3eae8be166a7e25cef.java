...
import java.util.*;
public class ra_action_pysocialmetadatamenu_c33a0bd7f16d9a3eae8be166a7e25cef  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pySocialMetadataMenu.Pega_Landing.Action");
	public ra_action_pysocialmetadatamenu_c33a0bd7f16d9a3eae8be166a7e25cef(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION PEGA-LANDING PYSOCIALMETADATAMENU #20180713T140444.407 GMT	Pega-NLP:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "pySocialMetadataMenu"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("pySocialMetadataMenu");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PYSOCIALMETADATAMENU"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYSOCIALMETADATAMENU","Rule-Navigation","PEGA-LANDING",false,"","Pega-NLP","08-01-01","RULE-NAVIGATION PEGA-LANDING PYSOCIALMETADATAMENU #20180713T140444.407 GMT","!PYSOCIALMETADATAMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-985070334)
	};
...
//	RULE-NAVIGATION PEGA-LANDING PYSOCIALMETADATAMENU #20180713T140444.407 GMT:20180807T084748.796 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "d664305fdeabd1ffd4fc2aea267cf64d";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"pySocialMetadataMenu" */
...
if( processAction ||(processShortcut && "ID1448008435756000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1448008435756000")){
return;}
if(processShortcut &&"ID1448008435756000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","ID1448008435756000");actionPage1.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Social Media Metadata"));actionPage1.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage1.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage1.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","201808070306130149134");}actionPage1.putString( "pyBadgeFormat","Standard (label)");actionPage1.putString( "pyDeferLoad","false");actionPage1.putString( "pyImage","");actionPage1.putString("pyType","Action");
...
commandPage1.putString( "pyAction","Display");commandPage1.putString( "pyName","Social Media Metadata");commandPage1.putString( "pyClassName","Pega-Landing-Decision-TextAnalytics");commandPage1.putString( "pyLevelA","");commandPage1.putString( "pyLevelB","");commandPage1.putString( "pyLevelC","");commandPage1.putString( "pyElementName","");commandPage1.putString( "pyTargetElement","");commandPage1.putString( "pyIsTargetMicroDC","");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzSocialMetadata");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage1);
...
deferLoad = false;
if((!deferLoad && StringUtils.isBlank(deferLoadPath)) || (!StringUtils.isBlank(deferLoadPath) && ( deferIndex>=deferPathArr.length || deferPathArr[deferIndex].equalsIgnoreCase("ID1448008435756000")))){
deferIndex ++;
...
if(processAction||("ID1448010843645001".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
...
/*Node Generated for caption -  and Name - ID1448010843645001*/
...
actionPage2.putString("pyHidden",String.valueOf(hideElement));actionPage2.putString("pyDisabled",String.valueOf(disableElement));actionPage2.putString( "pyName","ID1448010843645001");actionPage2.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Facebook"));actionPage2.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage2.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage2.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage2.putString( "pyAutomationID","20180807030612030838");}actionPage2.putString( "pyBadgeFormat","Standard (label)");actionPage2.putString( "pyDeferLoad","false");actionPage2.putString( "pyImage","");actionPage2.putString("pyType","Action");
...
commandPage2.putString( "pyAction","Display");commandPage2.putString( "pyName","Decisioning: Social Media Metadata");commandPage2.putString( "pyClassName","Pega-Landing-Decision-TextAnalytics");commandPage2.putString( "pyLevelA","");commandPage2.putString( "pyLevelB","FacebookMetadata");commandPage2.putString( "pyLevelC","");commandPage2.putString( "pyElementName","");commandPage2.putString( "pyTargetElement","");commandPage2.putString( "pyIsTargetMicroDC","");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzSocialMetadata");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage2);
...
if(processAction||("ID1453988080810000".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
if(processShortcut && !isNodePathEmpty && dontExitNow ){ 
if(nodeDepth==nodePathArr.length){ 
nodePathValidated=true;
...
if(dontExitNow){ //start of dnt exit now condition
/*Node Generated for caption -  and Name - ID1453988080810000*/
...
commandPage4.putString( "pyAction","Display");commandPage4.putString( "pyName","Decisioning: Social Media Metadata");commandPage4.putString( "pyClassName","Pega-Landing-Decision-TextAnalytics");commandPage4.putString( "pyLevelA","");commandPage4.putString( "pyLevelB","TwitterMetadata");commandPage4.putString( "pyLevelC","");commandPage4.putString( "pyElementName","");commandPage4.putString( "pyTargetElement","");commandPage4.putString( "pyIsTargetMicroDC","false");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzSocialMetadata");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage4);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION PEGA-LANDING PYSOCIALMETADATAMENU #20180713T140444.407 GMT", "Pega-Landing pySocialMetadataMenu", "Pega-NLP", "08-01-01", "20180807T084748.796 GMT");
}
