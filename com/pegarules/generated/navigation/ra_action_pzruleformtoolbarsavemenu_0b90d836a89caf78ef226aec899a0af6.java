...
import java.util.*;
public class ra_action_pzruleformtoolbarsavemenu_0b90d836a89caf78ef226aec899a0af6  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzRuleFormToolbarSaveMenu.Rule_.Action");
	public ra_action_pzruleformtoolbarsavemenu_0b90d836a89caf78ef226aec899a0af6(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION RULE- PZRULEFORMTOOLBARSAVEMENU #20190726T174647.740 GMT	Pega-Desktop:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(false){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "pzRuleFormToolbarSaveMenu"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("pzRuleFormToolbarSaveMenu");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZRULEFORMTOOLBARSAVEMENU"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMTOOLBARSAVEMENU","Rule-Navigation","RULE-",false,"","Pega-Desktop","08-04-01","RULE-NAVIGATION RULE- PZRULEFORMTOOLBARSAVEMENU #20190726T174647.740 GMT","!PZRULEFORMTOOLBARSAVEMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",81837524)
	};
...
//	RULE-NAVIGATION RULE- PZRULEFORMTOOLBARSAVEMENU #20190726T174647.740 GMT:20190726T174647.740 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "044804260daf51fbeeebc369877615d3";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"pzRuleFormToolbarSaveMenu" */
...
if( processAction ||(processShortcut && "ID1376281823714000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1376281823714000")){
return;}
if(processShortcut &&"ID1376281823714000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
String whenResolved ="pzRuleFormToolbarShowSaveAs";
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","ID1376281823714000");actionPage1.putString( "pyImageSource","styleclass");actionPage1.putString( "pyIconStyle","hotkey-ruleform-saveas");actionPage1.putString( "pyCaption","Save as");actionPage1.putString( "pySummary","");actionPage1.putString( "pyBadgeProperty","");actionPage1.putString( "pyToolTip","Keep the same name");if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","201905030243160832107");}actionPage1.putString( "pyBadgeFormat","Standard (label)");actionPage1.putString( "pyDeferLoad","false");actionPage1.putString( "pyImage","hotkey-ruleform-saveas");if (!hideElement) { 
...
commandPage5.putString( "pyClassName","Work-ProjectManagement-SaveAs");commandPage5.putString( "pyFlowName","SaveAsModalFlow");commandPage5.putString( "pyElementName","");commandPage5.putString( "pyTargetElement","");commandPage5.putString( "pyIsTargetMicroDC","");commandPage5.putString( "pyACName","");commandPage5.putString( "pySelectedMobileTransitionType","");propertyValue = "pxThread.pxThreadName";
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1402914934850000".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1402914934850000")){
return;}
if(processShortcut &&"ID1402914934850000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
showWhenCondition = true;
String whenResolved ="pzHideSplitIcon";
if (!whenResolved.isEmpty()) {
try{showWhenCondition = pega_uiengine_pznavigation.evaluateWhen(whenResolved,tools.getStepPage().getClassName(),tools);
}catch(Exception e){oLog.error("Failed to resolve when rule:" + e);}
}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION RULE- PZRULEFORMTOOLBARSAVEMENU #20190726T174647.740 GMT", "Rule- pzRuleFormToolbarSaveMenu", "Pega-Desktop", "08-04-01", "20190726T174647.740 GMT");
}
