...
import java.util.*;
public class ra_action_mainnavigation_15ad70af4a4c1465462e3ef08a8e88c3  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.MainNavigation.Data_Portal.Action");
	public ra_action_mainnavigation_15ad70af4a4c1465462e3ef08a8e88c3(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION DATA-PORTAL MAINNAVIGATION #20210506T204031.292 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "Main Navigation"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("Main Navigation");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:MAINNAVIGATION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("MAINNAVIGATION","Rule-Navigation","DATA-PORTAL",false,"","Theme-Cosmos","04-01-01","RULE-NAVIGATION DATA-PORTAL MAINNAVIGATION #20210506T204031.292 GMT","!MAINNAVIGATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-672116480)
	};
...
//	RULE-NAVIGATION DATA-PORTAL MAINNAVIGATION #20210506T204031.292 GMT:20210506T204031.292 GMT
...
//	RULE-UTILITY-FUNCTION NAVIGATIONFUA PZPROCESSCHILDELEMENTS--(CLIPBOABE009C16A86AE05EC07E24EF860BEDEA #20180713T133341.590 GMT:20180713T133341.590 GMT
	...
	public static String getFUAContentHash() {
		return "2b4c3276489d1e2914956e034c720612";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"Main Navigation" */
...
pega_uiengine_pznavigation.pzProcessNavigationNode("Data-Portal","pyDynamicNavigation",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION DATA-PORTAL MAINNAVIGATION #20210506T204031.292 GMT", "Data-Portal MainNavigation", "Theme-Cosmos", "04-01-01", "20210506T204031.292 GMT");
}
