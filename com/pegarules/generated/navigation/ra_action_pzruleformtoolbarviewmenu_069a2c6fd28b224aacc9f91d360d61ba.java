...
import java.util.*;
public class ra_action_pzruleformtoolbarviewmenu_069a2c6fd28b224aacc9f91d360d61ba  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzRuleFormToolbarViewMenu._baseclass.Action");
	public ra_action_pzruleformtoolbarviewmenu_069a2c6fd28b224aacc9f91d360d61ba(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARVIEWMENU #20180713T135314.145 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(false){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "pzRuleFormToolbarViewMenu"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("pzRuleFormToolbarViewMenu");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZRULEFORMTOOLBARVIEWMENU"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMTOOLBARVIEWMENU","Rule-Navigation","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARVIEWMENU #20180713T135314.145 GMT","!PZRULEFORMTOOLBARVIEWMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1221565320)
	};
...
//	RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARVIEWMENU #20180713T135314.145 GMT:20180713T135314.145 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "9323250bcd20c154a49c6a3c39e1b90c";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"pzRuleFormToolbarViewMenu" */
...
if( processAction ||(processShortcut && "ID1360598344269000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1360598344269000")){
return;}
if(processShortcut &&"ID1360598344269000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
}
showWhenCondition = pega_uiengine_pznavigation.evaluateWhen("pzRuleFormToolbarShowReferences",tools.getStepPage().getClassName(),tools);
...
pega_uiengine_pznavigation.pzProcessNavigationNode("@baseclass","pzRuleFormToolbarReferencingRules",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1360598344269001".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1360598344269001")){
return;}
if(processShortcut &&"ID1360598344269001".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("@baseclass","pzRuleFormToolbarSiblings",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
tools.putParamValue("deferLoadPath", deferLoadPath);
}
}//end of if for pxProcessShortcut
}//end of method
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1371745946653000".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1371745946653000")){
return;}
if(processShortcut &&"ID1371745946653000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("@baseclass","pzRuleFormToolbarVersions",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
tools.putParamValue("deferLoadPath", deferLoadPath);
}
}//end of if for pxProcessShortcut
}//end of method
...
showWhenCondition = pega_uiengine_pznavigation.evaluateWhen("pyRuleCompareEnabled",tools.getStepPage().getClassName(),tools);
hideElement = !showWhenCondition;
if (!hideElement) { 
currentDeferPath="";
for(int i=deferIndex; i<deferPathArr.length; i++){
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("@baseclass","pzRuleFormToolbarCompareWith",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
tools.putParamValue("deferLoadPath", deferLoadPath);
}
}//end of if for pxProcessShortcut
}//end of method
...
String whenResolved ="pzRuleFormToolbarShowViewXMLSeparator";
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1360359312962002".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1360359312962002")){
return;}
if(processShortcut &&"ID1360359312962002".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
showWhenCondition = true;
String whenResolved ="pzRuleFormToolbarShowRuleData";
if (!whenResolved.isEmpty()) {
try{showWhenCondition = pega_uiengine_pznavigation.evaluateWhen(whenResolved,tools.getStepPage().getClassName(),tools);
}catch(Exception e){oLog.error("Failed to resolve when rule:" + e);}
}
...
actionPage6.putString("pyHidden",String.valueOf(hideElement));actionPage6.putString("pyDisabled",String.valueOf(disableElement));actionPage6.putString( "pyName","ID1360359312962002");actionPage6.putString( "pyCaption","View XML");actionPage6.putString( "pySummary","");actionPage6.putString( "pyBadgeProperty","");actionPage6.putString( "pyToolTip","View the XML metadata");if(testIDWhen || functionalTestingWhen){actionPage6.putString( "pyAutomationID","");}actionPage6.putString( "pyBadgeFormat","");actionPage6.putString( "pyDeferLoad","");actionPage6.putString( "pyImage","hotkey-ruleform-viewxml");if (!hideElement) { 
...
commandPage6.putString( "pyWindowName","");commandPage6.putString( "pyOptions","location=0,menubar=0,toolbar=0,status=0,resizable=1,location=0,scrollbars=1");commandPage6.putString( "pyReplace","false");commandPage6.putString( "pyUseAlternateUrlBase","false");commandPage6.putString( "pyNoEncodingUrl","");commandPage6.putString( "pyUrl",tools.findPage("pxThread").getString("pxReqURI"));commandPage6 .putString( "pyActivity", tools.getProperty(".pxObjClass").getStringValue() + ".ShowXMLOfPage");
 commandPage6.getProperty("pyQueryString").getPageValue(1).putString( "pyValue","Primary");commandPage6.getProperty("pyQueryString").getPageValue(1).putString( "pyName","PageName");String strPrimaryPageName = tools.getParamValue("pzPrimaryPageName");
if(strPrimaryPageName !=null && !"".equals(strPrimaryPageName) ) {
commandPage6.getProperty("pyQueryString").getPageValue(2).putString("pyValue",strPrimaryPageName);
commandPage6.getProperty("pyQueryString").getPageValue(2).putString("pyName","pzPrimaryPageName");
} else {
commandPage6.getProperty("pyQueryString").getPageValue(2).putString("pyValue", tools.getStepPage().getReference() );
commandPage6.getProperty("pyQueryString").getPageValue(2).putString("pyName","pzPrimaryPageName");
}
executePage.putPage("pyOpenUrlInWindow",commandPage6);
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1360359312962003".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1360359312962003")){
return;}
if(processShortcut &&"ID1360359312962003".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
showWhenCondition = true;
String whenResolved ="pzRuleFormToolbarShowJava";
if (!whenResolved.isEmpty()) {
try{showWhenCondition = pega_uiengine_pznavigation.evaluateWhen(whenResolved,tools.getStepPage().getClassName(),tools);
}catch(Exception e){oLog.error("Failed to resolve when rule:" + e);}
}
...
actionPage7.putString("pyHidden",String.valueOf(hideElement));actionPage7.putString("pyDisabled",String.valueOf(disableElement));actionPage7.putString( "pyName","ID1360359312962003");actionPage7.putString( "pyCaption","View Java");actionPage7.putString( "pySummary","");actionPage7.putString( "pyBadgeProperty","");actionPage7.putString( "pyToolTip","View the generated Java");if(testIDWhen || functionalTestingWhen){actionPage7.putString( "pyAutomationID","");}actionPage7.putString( "pyBadgeFormat","");actionPage7.putString( "pyDeferLoad","");actionPage7.putString( "pyImage","hotkey-ruleform-viewjava");if (!hideElement) { 
...
behaviorPage7.putString("pyAction","showHarness");ClipboardPage commandPage7 = tools.createPage("Embed-DesktopAPI-ShowHarness","commandType");
commandPage7.putString( "pyTarget","popup");commandPage7.putString( "pyTitle","");commandPage7.putString( "pyActivityClass","@baseclass");commandPage7.putString( "pyHarnessName","pzGeneratedJava");commandPage7.putString( "pyReadOnly","No");commandPage7.putString( "pyKey","");commandPage7.putString( "pyActivity","pzShowJava");commandPage7.getProperty("pyPreDataTransform").getPageValue().putString( "pyName","");commandPage7.putString( "pyUsingPage","");commandPage7.putString( "pyElementName","");commandPage7.putString( "pyTargetElement","");commandPage7.putString( "pySelectedMobileTransitionType","");commandPage7.putString( "pyActivityClass","@baseclass");if(tools !=null && tools.getPrimaryPage() != null){  strPageName = tools.getPrimaryPage().getReference();}commandPage7.putString("pzPrimaryPage",strPageName);propertyValue = ".pyShowJavaWindowName";
propertyValue = tools.getParamValue("ApplyToPage")+".pyShowJavaWindowName";commandPage7.putString("pyWindowName",tools.getProperty(propertyValue).getStringValue());commandPage7.putString( "pyWidth","");commandPage7.putString( "pyHeight","");commandPage7.getProperty("pyActivityParams").getPageValue(1).putString( "pyValue","");commandPage7.getProperty("pyActivityParams").getPageValue(1).putString( "pyName","");commandPage7.getPage("pyPreDataTransform").getProperty("pyDataTransformParams").getPageValue(1).putString( "pyValue","");commandPage7.getPage("pyPreDataTransform").getProperty("pyDataTransformParams").getPageValue(1).putString( "pyName","");commandPage7.putString( "pyAlwaysRenderFromServer","");executePage.putPage("pyShowHarness",commandPage7);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARVIEWMENU #20180713T135314.145 GMT", "@baseclass pzRuleFormToolbarViewMenu", "Pega-Desktop", "08-01-01", "20180713T135314.145 GMT");
}
