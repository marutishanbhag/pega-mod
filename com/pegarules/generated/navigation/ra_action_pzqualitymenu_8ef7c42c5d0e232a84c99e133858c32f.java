...
import java.util.*;
public class ra_action_pzqualitymenu_8ef7c42c5d0e232a84c99e133858c32f  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzQualityMenu.Pega_Landing.Action");
	public ra_action_pzqualitymenu_8ef7c42c5d0e232a84c99e133858c32f(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION PEGA-LANDING PZQUALITYMENU #20190611T092410.803 GMT	Pega-LP:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "pzQualityMenu"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("pzQualityMenu");
	}
}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZQUALITYMENU","Rule-Navigation","PEGA-LANDING",false,"","Pega-LP","08-04-01","RULE-NAVIGATION PEGA-LANDING PZQUALITYMENU #20190611T092410.803 GMT","!PZQUALITYMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1494481703)
	};
...
//	RULE-NAVIGATION PEGA-LANDING PZQUALITYMENU #20190611T092410.803 GMT:20191125T195528.861 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "4264c560c7845ea719a10b515fa39ff0";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"pzQualityMenu" */
...
if( processAction ||(processShortcut && "ID1522395349679000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1522395349679000")){
return;}
if(processShortcut &&"ID1522395349679000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","ID1522395349679000");actionPage1.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Quality"));actionPage1.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage1.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage1.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","201803300935490645668");}actionPage1.putString( "pyBadgeFormat","Standard (label)");actionPage1.putString( "pyDeferLoad","false");actionPage1.putString( "pyImage","");actionPage1.putString("pyType","Action");
...
commandPage1.putString( "pyAction","Display");commandPage1.putString( "pyName","Application Quality");commandPage1.putString( "pyClassName","Pega-Landing-Application-Quality");commandPage1.putString( "pyLevelA","");commandPage1.putString( "pyLevelB","");commandPage1.putString( "pyLevelC","");commandPage1.putString( "pyElementName","");commandPage1.putString( "pyTargetElement","");commandPage1.putString( "pyIsTargetMicroDC","false");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzAppQualityDashboard");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage1);
...
deferLoad = false;
if((!deferLoad && StringUtils.isBlank(deferLoadPath)) || (!StringUtils.isBlank(deferLoadPath) && ( deferIndex>=deferPathArr.length || deferPathArr[deferIndex].equalsIgnoreCase("ID1522395349679000")))){
deferIndex ++;
...
if(processAction||("ID1522395352280000".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
...
/*Node Generated for caption -  and Name - ID1522395352280000*/
...
actionPage2.putString("pyHidden",String.valueOf(hideElement));actionPage2.putString("pyDisabled",String.valueOf(disableElement));actionPage2.putString( "pyName","ID1522395352280000");actionPage2.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Dashboard"));actionPage2.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage2.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage2.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage2.putString( "pyAutomationID","201803300935520263184");}actionPage2.putString( "pyBadgeFormat","Standard (label)");actionPage2.putString( "pyDeferLoad","false");actionPage2.putString( "pyImage","");actionPage2.putString("pyType","Action");
...
commandPage2.putString( "pyAction","Display");commandPage2.putString( "pyName","Application Quality");commandPage2.putString( "pyClassName","Pega-Landing-Application-Quality");commandPage2.putString( "pyLevelA","");commandPage2.putString( "pyLevelB","");commandPage2.putString( "pyLevelC","");commandPage2.putString( "pyElementName","");commandPage2.putString( "pyTargetElement","");commandPage2.putString( "pyIsTargetMicroDC","false");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzAppQualityDashboard");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage2);
...
pega_uiengine_pznavigation.pzProcessNavigationNode("Pega-Landing","pzApplicationGuardrailsMenu",commonPrefix,uniqueSuffix,actionPage1, tools, "actionPage1","false",actionPage1);
...
if(processAction||("ID1522398777787000".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
if(processShortcut && !isNodePathEmpty && dontExitNow ){ 
if(nodeDepth==nodePathArr.length){ 
nodePathValidated=true;
...
if(dontExitNow){ //start of dnt exit now condition
/*Node Generated for caption -  and Name - ID1522398777787000*/
...
actionPage6.putString("pyHidden",String.valueOf(hideElement));actionPage6.putString("pyDisabled",String.valueOf(disableElement));actionPage6.putString( "pyName","ID1522398777787000");actionPage6.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Test Coverage"));actionPage6.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage6.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage6.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage6.putString( "pyAutomationID","201803301032570724453");}actionPage6.putString( "pyBadgeFormat","Standard (label)");actionPage6.putString( "pyDeferLoad","false");actionPage6.putString( "pyImage","");actionPage6.putString("pyType","Action");
...
if(processAction||("ID1522398777787001".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
if(processShortcut && !isNodePathEmpty && dontExitNow ){ 
if(nodeDepth==nodePathArr.length){ 
nodePathValidated=true;
...
if(dontExitNow){ //start of dnt exit now condition
/*Node Generated for caption -  and Name - ID1522398777787001*/
...
actionPage8.putString("pyHidden",String.valueOf(hideElement));actionPage8.putString("pyDisabled",String.valueOf(disableElement));actionPage8.putString( "pyName","ID1522398777787001");actionPage8.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Automated testing"));actionPage8.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage8.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage8.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage8.putString( "pyAutomationID","201803301032570759827");}actionPage8.putString( "pyBadgeFormat","Standard (label)");actionPage8.putString( "pyDeferLoad","false");actionPage8.putString( "pyImage","");actionPage8.putString("pyType","Action");
executePage=actionPage8.getProperty("pyExecute").getPageValue();
executePage.putString("pyRefreshLayout","false");
executePage.putString("pyCommand","");
}
deferLoad = false;
if((!deferLoad && StringUtils.isBlank(deferLoadPath)) || (!StringUtils.isBlank(deferLoadPath) && ( deferIndex>=deferPathArr.length || deferPathArr[deferIndex].equalsIgnoreCase("ID1522398777787001")))){
deferIndex ++;
if(!isNodePathEmpty && matchFound){ 
if(currentElement < nodePathArr.length-1)
currentElement++;
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("Pega-Landing","pzUnitTestingMenu",commonPrefix,uniqueSuffix,actionPage8, tools, "actionPage8","false",actionPage8);
tools.putParamValue("deferLoadPath", deferLoadPath);
}//end of dnt exit now condition
}//end of condition
deferIndex --;
...
if(processAction||("ID1528370231944000".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
if(processShortcut && !isNodePathEmpty && dontExitNow ){ 
if(nodeDepth==nodePathArr.length){ 
nodePathValidated=true;
...
if(dontExitNow){ //start of dnt exit now condition
/*Node Generated for caption -  and Name - ID1528370231944000*/
...
actionPage12.putString("pyHidden",String.valueOf(hideElement));actionPage12.putString("pyDisabled",String.valueOf(disableElement));actionPage12.putString( "pyName","ID1528370231944000");actionPage12.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Settings"));actionPage12.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage12.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage12.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage12.putString( "pyAutomationID","201806070817110916678");}actionPage12.putString( "pyBadgeFormat","Standard (label)");actionPage12.putString( "pyDeferLoad","false");actionPage12.putString( "pyImage","");actionPage12.putString("pyType","Action");
...
commandPage12.putString( "pyAction","Display");commandPage12.putString( "pyName","Application: Quality Settings");commandPage12.putString( "pyClassName","Pega-Landing-Application-QualitySettings");commandPage12.putString( "pyLevelA","");commandPage12.putString( "pyLevelB","");commandPage12.putString( "pyLevelC","");commandPage12.putString( "pyElementName","");commandPage12.putString( "pyTargetElement","");commandPage12.putString( "pyIsTargetMicroDC","false");commandPage12.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzAppQualitySettings");commandPage12.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage12.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage12.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage12);
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("Pega-Landing","pzPreflightValidation",commonPrefix,uniqueSuffix,actionPage1, tools, "actionPage1","false",actionPage1);
tools.putParamValue("deferLoadPath", deferLoadPath);
}//end of dnt exit now condition
}//end of condition
deferIndex --;
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION PEGA-LANDING PZQUALITYMENU #20190611T092410.803 GMT", "Pega-Landing pzQualityMenu", "Pega-LP", "08-04-01", "20191125T195528.861 GMT");
}
