...
import java.util.*;
public class ra_action_pzappmenuforappstudio_40c43e0a3ea1c18c59d0a6dc64bdfa8a  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzAppMenuForAppStudio.Data_Portal_PegaExpress.Action");
	public ra_action_pzappmenuforappstudio_40c43e0a3ea1c18c59d0a6dc64bdfa8a(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION DATA-PORTAL-PEGAEXPRESS PZAPPMENUFORAPPSTUDIO #20210927T131613.151 GMT	Pega-Desktop:08-07-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZAPPMENUFORAPPSTUDIO"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPMENUFORAPPSTUDIO","Rule-Navigation","DATA-PORTAL-PEGAEXPRESS",false,"","Pega-Desktop","08-07-01","RULE-NAVIGATION DATA-PORTAL-PEGAEXPRESS PZAPPMENUFORAPPSTUDIO #20210927T131613.151 GMT","!PZAPPMENUFORAPPSTUDIO",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1466546901)
	};
...
//	RULE-NAVIGATION DATA-PORTAL-PEGAEXPRESS PZAPPMENUFORAPPSTUDIO #20210927T131613.151 GMT:20210927T150940.398 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "81ea7c58c3c9cedd9c10e9f794cb140e";
	}
...
preActParamMap.put("pyClassName","Data-Portal-PegaExpress");
...
String actionListParentPage2 = tools.getParamValue("ApplyToPage");	Iterator actionListIter2 = nodePageList.iterator();
	while (actionListIter2.hasNext()) {		iterListResult = (ClipboardProperty)actionListIter2.next();
		...
		if(strChildListPageRef2.lastIndexOf(".") == 0) {
			strChildListPageRef2 = "SwitchAppList" + strChildListPageRef2;
		}
...
actionPage2.getProperty("pyChecked").setValue(pega_uiengine_pznavigation.evaluateWhen("pzIsCurrentApplication",tools.getStepPage().getClassName(),tools));
actionPage2.getProperty("pyGroup").getPageValue().putString("pyGroupID","ApplicationGroup");
actionPage2.getProperty("pyGroup").getPageValue().putString("pyIsGroup","true");
actionPage2.putString("pyHidden",String.valueOf(hideElement));actionPage2.putString("pyDisabled",String.valueOf(disableElement));actionPage2.putString( "pyName","");propertyValue = ".pxApplicationLabel";
propertyValue = tools.getParamValue("ApplyToPage")+".pxApplicationLabel";if(!isDynamicFieldNameForMenu){actionPage2.putString("pyCaption",tools.getLocalizedTextForString("pyCaption", tools.getProperty(propertyValue).getStringValue()));}else{actionPage2.putString("pyCaption",tools.getLocalizedTextForString(".pxApplicationLabel", "\t["+tools.getProperty(tools.getParamValue("ApplyToPage")+".pxObjClass").getStringValue()+".pxApplicationLabel]"+tools.getProperty(propertyValue).getStringValue()));}actionPage2.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage2.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage2.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));actionPage2.putString( "pyBadgeFormat","Standard (label)");actionPage2.putString( "pyDeferLoad","");propertyValue = ".pxListSubscript";
propertyValue = tools.getParamValue("ApplyToPage")+".pxListSubscript";actionPage2.putString("pySubscript",tools.getProperty(propertyValue).getStringValue());if(testIDWhen || functionalTestingWhen){if(!"".equals(tools.getProperty(tools.getParamValue("ApplyToPage")+".pxListSubscript").getStringValue())) {actionPage2.putString("pyAutomationID","201806131013430021349" + "_" + tools.getProperty(tools.getParamValue("ApplyToPage")+".pxListSubscript").getStringValue());}else if (!"".equals(tools.getProperty(tools.getParamValue("ApplyToPage")+".pxSubscript").getStringValue())) {actionPage2.putString("pyAutomationID","201806131013430021349" + "_" + tools.getProperty(tools.getParamValue("ApplyToPage")+".pxSubscript").getStringValue());}else {actionPage2.putString( "pyAutomationID","201806131013430021349");}}actionPage2.putString( "pyImage","");actionPage2.putString("pyType","Action");
...
propertyValue = tools.getParamValue("ApplyToPage")+".pxAccessGroup";commandPage2.getProperty("pyParameters").getPageValue(1).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage2.getProperty("pyParameters").getPageValue(1).putString( "pyName","AccessGroup");commandPage2.putString( "pyFunctionName","switchApplication");executePage.putPage("pyCustom",commandPage2);
...
actionPage4.putString("pyHidden",String.valueOf(hideElement));actionPage4.putString("pyDisabled",String.valueOf(disableElement));actionPage4.putString( "pyName","");actionPage4.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "------------------"));actionPage4.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage4.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage4.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));actionPage4.putString( "pyBadgeFormat","");actionPage4.putString( "pyDeferLoad","");actionPage4.putString( "pyImage","");actionPage4.putString("pyType","Separator");
}
deferLoad = false;
}//end of dnt exit now condition
}//end of condition
...
if(processAction||("ID1632231368624000".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
if(processShortcut && !isNodePathEmpty && dontExitNow ){ 
if(nodeDepth==nodePathArr.length){ 
nodePathValidated=true;
...
if(dontExitNow){ //start of dnt exit now condition
/*Node Generated for caption -  and Name - ID1632231368624000*/
...
actionPage6.putString("pyHidden",String.valueOf(hideElement));actionPage6.putString("pyDisabled",String.valueOf(disableElement));actionPage6.putString( "pyName","ID1632231368624000");actionPage6.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "New Application"));actionPage6.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage6.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage6.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage6.putString( "pyAutomationID","202109210936080535720");}actionPage6.putString( "pyBadgeFormat","Standard (label)");actionPage6.putString( "pyDeferLoad","false");actionPage6.putString( "pyImage","");if (!hideElement) { 
...
commandPage6.putString( "pyTarget","newDocument");commandPage6.putString( "pyTitle","New app wizard");commandPage6.putString( "pyActivityClass","Pega-Ext-ExpExplorer-NewAppWizard");commandPage6.putString( "pyHarnessName","pzExpressLPHarness");commandPage6.putString( "pyReadOnly","No");commandPage6.putString( "pyKey","");commandPage6.putString( "pyActivity","");commandPage6.getProperty("pyPreDataTransform").getPageValue().putString( "pyName","pzSetupPages");commandPage6.putString( "pyUsingPage","D_pxSingleExtension_Thread_ReadOnly");commandPage6.putString( "pyElementName","");commandPage6.putString( "pyTargetElement","");commandPage6.putString( "pySelectedMobileTransitionType","pega.mobile.transitions.NONE");if(tools !=null && tools.getPrimaryPage() != null){  strPageName = tools.getPrimaryPage().getReference();}commandPage6.putString("pzPrimaryPage",strPageName);commandPage6.putString( "pyKey","");commandPage6.getPage("pyPreDataTransform").getProperty("pyDataTransformParams").getPageValue(1).putString( "pyValue","");commandPage6.getPage("pyPreDataTransform").getProperty("pyDataTransformParams").getPageValue(1).putString( "pyName","");commandPage6.putString( "pyAlwaysRenderFromServer","false");executePage.putPage("pyShowHarness",commandPage6);
...
actionPage8.putString("pyHidden",String.valueOf(hideElement));actionPage8.putString("pyDisabled",String.valueOf(disableElement));actionPage8.putString( "pyName","ID1567697161680000");actionPage8.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "New Application"));actionPage8.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage8.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage8.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", "Application creation is disabled"));if(testIDWhen || functionalTestingWhen){actionPage8.putString( "pyAutomationID","201909051126010634853");}actionPage8.putString( "pyBadgeFormat","Standard (label)");actionPage8.putString( "pyDeferLoad","false");actionPage8.putString( "pyImage","");if (!hideElement) { 
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION DATA-PORTAL-PEGAEXPRESS PZAPPMENUFORAPPSTUDIO #20210927T131613.151 GMT", "Data-Portal-PegaExpress pzAppMenuForAppStudio", "Pega-Desktop", "08-07-01", "20210927T150940.398 GMT");
}
