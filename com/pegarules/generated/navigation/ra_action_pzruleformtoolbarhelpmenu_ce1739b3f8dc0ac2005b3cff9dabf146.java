...
import java.util.*;
public class ra_action_pzruleformtoolbarhelpmenu_ce1739b3f8dc0ac2005b3cff9dabf146  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzRuleFormToolbarHelpMenu._baseclass.Action");
	public ra_action_pzruleformtoolbarhelpmenu_ce1739b3f8dc0ac2005b3cff9dabf146(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARHELPMENU #20200203T122416.840 GMT	Pega-Desktop:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "RuleForm Toolbar Help Menu"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("RuleForm Toolbar Help Menu");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZRULEFORMTOOLBARHELPMENU"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMTOOLBARHELPMENU","Rule-Navigation","@BASECLASS",false,"","Pega-Desktop","08-05-01","RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARHELPMENU #20200203T122416.840 GMT","!PZRULEFORMTOOLBARHELPMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1817337031)
	};
...
//	RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARHELPMENU #20200203T122416.840 GMT:20200203T122416.840 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "9eb80f1bf048b65674721690492bff61";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"RuleForm Toolbar Help Menu" */
...
if( processAction ||(processShortcut && "ID1370551260647000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1370551260647000")){
return;}
if(processShortcut &&"ID1370551260647000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","ID1370551260647000");actionPage1.putString( "pyImageSource","styleclass");actionPage1.putString( "pyIconStyle","hotkey-ruleform-help");actionPage1.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Get help"));actionPage1.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage1.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage1.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","hotkey-ruleform-help");}actionPage1.putString( "pyBadgeFormat","Standard (label)");actionPage1.putString( "pyDeferLoad","false");actionPage1.putString( "pyImage","hotkey-ruleform-help");if (!hideElement) { 
...
commandPage1.putString( "pyWindowName","Pega Help");commandPage1.putString( "pyOptions","height=780,width=960,top=0,left=0,location=0,menubar=0,toolbar=0,status=0,resizable=1,location=0,scrollbars=1");commandPage1.putString( "pyReplace","false");commandPage1.putString( "pyUseAlternateUrlBase","true");commandPage1.putString( "pyNoEncodingUrl","false");propertyValue = ".pyToolBarSettings.pyHelpURI";
propertyValue = tools.getParamValue("ApplyToPage")+".pyToolBarSettings.pyHelpURI";commandPage1.putString("pyUrl",tools.getProperty(propertyValue).getStringValue());executePage.putPage("pyOpenUrlInWindow",commandPage1);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARHELPMENU #20200203T122416.840 GMT", "@baseclass pzRuleFormToolbarHelpMenu", "Pega-Desktop", "08-05-01", "20200203T122416.840 GMT");
}
