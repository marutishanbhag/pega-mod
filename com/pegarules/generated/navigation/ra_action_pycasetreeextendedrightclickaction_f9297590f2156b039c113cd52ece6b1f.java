...
import java.util.*;
public class ra_action_pycasetreeextendedrightclickaction_f9297590f2156b039c113cd52ece6b1f  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pyCaseTreeExtendedRightClickAction.Rule_Obj_Class.Action");
	public ra_action_pycasetreeextendedrightclickaction_f9297590f2156b039c113cd52ece6b1f(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION RULE-OBJ-CLASS PYCASETREEEXTENDEDRIGHTCLICKACTION #20180713T140947.109 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(false){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "Navigation rule extension for main menu in Case Tree"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("Navigation rule extension for main menu in Case Tree");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PYCASETREEEXTENDEDRIGHTCLICKACTION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCASETREEEXTENDEDRIGHTCLICKACTION","Rule-Navigation","RULE-OBJ-CLASS",false,"","Pega-ProcessArchitect","08-01-01","RULE-NAVIGATION RULE-OBJ-CLASS PYCASETREEEXTENDEDRIGHTCLICKACTION #20180713T140947.109 GMT","!PYCASETREEEXTENDEDRIGHTCLICKACTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1558357928)
	};
...
//	RULE-NAVIGATION RULE-OBJ-CLASS PYCASETREEEXTENDEDRIGHTCLICKACTION #20180713T140947.109 GMT:20180713T140947.109 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "7be4a0c4b39a93e6039591ff55a822c5";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"Navigation rule extension for main menu in Case Tree" */
...
if( processAction ||(processShortcut && "ID1294729722916000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1294729722916000")){
return;}
if(processShortcut &&"ID1294729722916000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION RULE-OBJ-CLASS PYCASETREEEXTENDEDRIGHTCLICKACTION #20180713T140947.109 GMT", "Rule-Obj-Class pyCaseTreeExtendedRightClickAction", "Pega-ProcessArchitect", "08-01-01", "20180713T140947.109 GMT");
}
