...
import java.util.*;
public class ra_action_pzmainmenu_740fae69aa99b1bbb9edb0fc7746b8ec  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzMainMenu.Pega_Landing.Action");
	public ra_action_pzmainmenu_740fae69aa99b1bbb9edb0fc7746b8ec(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION PEGA-LANDING PZMAINMENU #20180713T142501.514 GMT	Pega-LP:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(false){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "pzMainMenu"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("pzMainMenu");
	}
}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZMAINMENU","Rule-Navigation","PEGA-LANDING",false,"","Pega-LP","08-01-01","RULE-NAVIGATION PEGA-LANDING PZMAINMENU #20180713T142501.514 GMT","!PZMAINMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1787859632)
	};
...
//	RULE-NAVIGATION PEGA-LANDING PZMAINMENU #20180713T142501.514 GMT:20180723T184439.138 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "1fb773e8c56cf02069a24a5de73fa196";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"pzMainMenu" */
...
if( processAction ||(processShortcut && "designer-studio-menu".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("designer-studio-menu")){
return;}
if(processShortcut &&"designer-studio-menu".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","designer-studio-menu");actionPage1.putString( "pyCaption","");actionPage1.putString( "pySummary","");actionPage1.putString( "pyBadgeProperty","");actionPage1.putString( "pyToolTip","");if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","201807191249140474791");}actionPage1.putString( "pyBadgeFormat","");actionPage1.putString( "pyDeferLoad","");actionPage1.putString( "pyImage","designer-studio-logo");actionPage1.putString("pyType","Action");
...
deferLoad = false;
if((!deferLoad && StringUtils.isBlank(deferLoadPath)) || (!StringUtils.isBlank(deferLoadPath) && ( deferIndex>=deferPathArr.length || deferPathArr[deferIndex].equalsIgnoreCase("designer-studio-menu")))){
deferIndex ++;
...
pega_uiengine_pznavigation.pzProcessNavigationNode("Pega-Landing","pyMainMenu",commonPrefix,uniqueSuffix,actionPage1, tools, "actionPage1","false",actionPage1);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION PEGA-LANDING PZMAINMENU #20180713T142501.514 GMT", "Pega-Landing pzMainMenu", "Pega-LP", "08-01-01", "20180723T184439.138 GMT");
}
