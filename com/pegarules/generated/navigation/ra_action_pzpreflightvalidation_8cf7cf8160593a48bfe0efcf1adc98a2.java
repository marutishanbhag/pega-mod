...
import java.util.*;
public class ra_action_pzpreflightvalidation_8cf7cf8160593a48bfe0efcf1adc98a2  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzPreflightValidation.Pega_Landing.Action");
	public ra_action_pzpreflightvalidation_8cf7cf8160593a48bfe0efcf1adc98a2(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION PEGA-LANDING PZPREFLIGHTVALIDATION #20191219T214424.160 GMT	Pega-Desktop:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "Preflight Validation"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("Preflight Validation");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZPREFLIGHTVALIDATION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZPREFLIGHTVALIDATION","Rule-Navigation","PEGA-LANDING",false,"","Pega-Desktop","08-05-01","RULE-NAVIGATION PEGA-LANDING PZPREFLIGHTVALIDATION #20191219T214424.160 GMT","!PZPREFLIGHTVALIDATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1946310287)
	};
...
//	RULE-NAVIGATION PEGA-LANDING PZPREFLIGHTVALIDATION #20191219T214424.160 GMT:20191219T214424.160 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "b33e7b68d3351caf60c6b7f60d6304c6";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"Preflight Validation" */
...
commandPage1.putString( "pyAction","Display");commandPage1.putString( "pyName","App Studio Compliance: User Interface");commandPage1.putString( "pyClassName","Pega-Landing-Application");commandPage1.putString( "pyLevelA","");commandPage1.putString( "pyLevelB","");commandPage1.putString( "pyLevelC","Compliance");commandPage1.putString( "pyElementName","");commandPage1.putString( "pyTargetElement","");commandPage1.putString( "pyIsTargetMicroDC","");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzLPApplicationUIGuardrails");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyModel","pzPopulateListOfApplicationsForEval");executePage.putPage("pyOpenLanding",commandPage1);
...
if(processAction||("ID1571152600394000".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
...
/*Node Generated for caption -  and Name - ID1571152600394000*/
...
actionPage2.putString("pyHidden",String.valueOf(hideElement));actionPage2.putString("pyDisabled",String.valueOf(disableElement));actionPage2.putString( "pyName","ID1571152600394000");actionPage2.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "User Interface"));actionPage2.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage2.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage2.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage2.putString( "pyAutomationID","guardrail-LP");}actionPage2.putString( "pyBadgeFormat","Standard (label)");actionPage2.putString( "pyDeferLoad","false");actionPage2.putString( "pyImage","");actionPage2.putString("pyType","Action");
...
commandPage2.putString( "pyAction","Display");commandPage2.putString( "pyName","App Studio Compliance: User Interface");commandPage2.putString( "pyClassName","Pega-Landing-Application");commandPage2.putString( "pyLevelA","");commandPage2.putString( "pyLevelB","");commandPage2.putString( "pyLevelC","");commandPage2.putString( "pyElementName","");commandPage2.putString( "pyTargetElement","");commandPage2.putString( "pyIsTargetMicroDC","");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzLPApplicationUIGuardrails");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyModel","pzPopulateListOfApplicationsForEval");executePage.putPage("pyOpenLanding",commandPage2);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION PEGA-LANDING PZPREFLIGHTVALIDATION #20191219T214424.160 GMT", "Pega-Landing pzPreflightValidation", "Pega-Desktop", "08-05-01", "20191219T214424.160 GMT");
}
