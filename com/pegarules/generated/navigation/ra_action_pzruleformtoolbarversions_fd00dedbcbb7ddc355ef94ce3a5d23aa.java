...
import java.util.*;
public class ra_action_pzruleformtoolbarversions_fd00dedbcbb7ddc355ef94ce3a5d23aa  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzRuleFormToolbarVersions._baseclass.Action");
	public ra_action_pzruleformtoolbarversions_fd00dedbcbb7ddc355ef94ce3a5d23aa(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARVERSIONS #20180713T135314.141 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(false){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "pzRuleFormToolbarVersions"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("pzRuleFormToolbarVersions");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZRULEFORMTOOLBARVERSIONS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMTOOLBARVERSIONS","Rule-Navigation","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARVERSIONS #20180713T135314.141 GMT","!PZRULEFORMTOOLBARVERSIONS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-448279345)
	};
...
//	RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARVERSIONS #20180713T135314.141 GMT:20180713T135314.141 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "99100b01be88b17b395ff8491e17f641";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"pzRuleFormToolbarVersions" */
...
nodePageList = tools.getIfPresent(".pyRuleVersionsList");
...
propertyValue = tools.getParamValue("ApplyToPage")+".pyLabel";actionPage2.putString("pyCaption",tools.getProperty(propertyValue).getStringValue());actionPage2.putString( "pySummary","");actionPage2.putString( "pyBadgeProperty","");propertyValue = ".pyMenuTooltip";
propertyValue = tools.getParamValue("ApplyToPage")+".pyMenuTooltip";actionPage2.putString("pyToolTip",tools.getProperty(propertyValue).getStringValue());actionPage2.putString( "pyBadgeFormat","");actionPage2.putString( "pyDeferLoad","");propertyValue = ".pxListSubscript";
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARVERSIONS #20180713T135314.141 GMT", "@baseclass pzRuleFormToolbarVersions", "Pega-Desktop", "08-01-01", "20180713T135314.141 GMT");
}
