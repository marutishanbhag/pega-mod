...
import java.util.*;
public class ra_action_pzmainexplorer_16ebe976fb3e8dd5b3f2f86b19c84698  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzMainExplorer.Pega_Ext_AdminStudio_Explorer.Action");
	public ra_action_pzmainexplorer_16ebe976fb3e8dd5b3f2f86b19c84698(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION PEGA-EXT-ADMINSTUDIO-EXPLORER PZMAINEXPLORER #20180713T135317.159 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "MainExplorer"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("MainExplorer");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZMAINEXPLORER"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZMAINEXPLORER","Rule-Navigation","PEGA-EXT-ADMINSTUDIO-EXPLORER",false,"","Pega-Desktop","08-01-01","RULE-NAVIGATION PEGA-EXT-ADMINSTUDIO-EXPLORER PZMAINEXPLORER #20180713T135317.159 GMT","!PZMAINEXPLORER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",985942211)
	};
...
//	RULE-NAVIGATION PEGA-EXT-ADMINSTUDIO-EXPLORER PZMAINEXPLORER #20180713T135317.159 GMT:20180713T135317.159 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "0873ed012493e2e25f7b81ad775796f4";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"MainExplorer" */
...
return;}
nodePageList = tools.getIfPresent(".pxResults");
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","");actionPage1.putString( "pyImageSource","styleclass");propertyValue = ".pyIconClass";
propertyValue = tools.getParamValue("ApplyToPage")+".pyIconClass";actionPage1.putString("pyIconStyle",tools.getProperty(propertyValue).getStringValue());propertyValue = ".pyLabel";
propertyValue = tools.getParamValue("ApplyToPage")+".pyLabel";if(!isDynamicFieldNameForMenu){actionPage1.putString("pyCaption",tools.getLocalizedTextForString("pyCaption", tools.getProperty(propertyValue).getStringValue()));}else{actionPage1.putString("pyCaption",tools.getLocalizedTextForString(".pyLabel", "\t["+tools.getProperty(tools.getParamValue("ApplyToPage")+".pxObjClass").getStringValue()+".pyLabel]"+tools.getProperty(propertyValue).getStringValue()));}actionPage1.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage1.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));propertyValue = ".pyLabel";
propertyValue = tools.getParamValue("ApplyToPage")+".pyLabel";if(!isDynamicFieldNameForMenu){actionPage1.putString("pyToolTip",tools.getLocalizedTextForString("pyToolTip", tools.getProperty(propertyValue).getStringValue()));}else{actionPage1.putString("pyToolTip",tools.getLocalizedTextForString(".pyLabel", "\t["+tools.getProperty(tools.getParamValue("ApplyToPage")+".pxObjClass").getStringValue()+".pyLabel]"+tools.getProperty(propertyValue).getStringValue()));}actionPage1.putString( "pyBadgeFormat","Standard (label)");actionPage1.putString( "pyDeferLoad","false");propertyValue = ".pxListSubscript";
propertyValue = tools.getParamValue("ApplyToPage")+".pxListSubscript";actionPage1.putString("pySubscript",tools.getProperty(propertyValue).getStringValue());if(testIDWhen || functionalTestingWhen){if(!"".equals(tools.getProperty(tools.getParamValue("ApplyToPage")+".pxListSubscript").getStringValue())) {actionPage1.putString("pyAutomationID","201801221117400179311" + "_" + tools.getProperty(tools.getParamValue("ApplyToPage")+".pxListSubscript").getStringValue());}else if (!"".equals(tools.getProperty(tools.getParamValue("ApplyToPage")+".pxSubscript").getStringValue())) {actionPage1.putString("pyAutomationID","201801221117400179311" + "_" + tools.getProperty(tools.getParamValue("ApplyToPage")+".pxSubscript").getStringValue());}else {actionPage1.putString( "pyAutomationID","201801221117400179311");}}propertyValue = ".pyIconClass";
propertyValue = tools.getParamValue("ApplyToPage")+".pyIconClass";actionPage1.putString("pyImage",tools.getProperty(propertyValue).getStringValue());actionPage1.putString("pyType","Action");
...
commandPage1.putString( "pyTarget","otherSection");commandPage1.putString( "pyUsingPage","");commandPage1.putString( "pyActivity","");commandPage1.putString( "pySection","pzAdminStudioExplorerPanel");commandPage1.putString( "pyDisableSubmit","true");commandPage1.getProperty("pyPreDataTransform").getPageValue().putString( "pyName","pzSetRowContext");commandPage1.getProperty("pyActivityParameters").getPageValue(1).putString( "pyValue","");commandPage1.getProperty("pyActivityParameters").getPageValue(1).putString( "pyName","");commandPage1.getProperty("pyActivityParameters").getPageValue(1).putString( "pxObjClass","Embed-NameValuePair");propertyValue = ".pyUsingPage";
propertyValue = tools.getParamValue("ApplyToPage")+".pyUsingPage";commandPage1.getPage("pyPreDataTransform").getProperty("pyDataTransformParams").getPageValue(1).putString("pyValue",java.net.URLEncoder.encode(tools.getProperty(propertyValue).getStringValue()));commandPage1.getPage("pyPreDataTransform").getProperty("pyDataTransformParams").getPageValue(1).putString( "pyName","context");executePage.putPage("pyRefresh",commandPage1);
...
propertyValue = ".pyRank";
propertyValue = tools.getParamValue("ApplyToPage")+".pyRank";commandPage2.getProperty("pyParameters").getPageValue(1).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage2.getProperty("pyParameters").getPageValue(1).putString( "pyName","rank");commandPage2.putString( "pyFunctionName","pega.u.d.showExplorerPanel");behaviorPage2.putPage("pyActionAPI",commandPage2);
((PegaAPI)tools).getUIEngine().getUIAction(actionPage1.getPage("pyBehaviors(<LAST>)")).register();
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION PEGA-EXT-ADMINSTUDIO-EXPLORER PZMAINEXPLORER #20180713T135317.159 GMT", "Pega-Ext-AdminStudio-Explorer pzMainExplorer", "Pega-Desktop", "08-01-01", "20180713T135317.159 GMT");
}
