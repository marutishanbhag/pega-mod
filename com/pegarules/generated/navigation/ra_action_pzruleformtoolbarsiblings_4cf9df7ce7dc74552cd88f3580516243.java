...
import java.util.*;
public class ra_action_pzruleformtoolbarsiblings_4cf9df7ce7dc74552cd88f3580516243  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzRuleFormToolbarSiblings._baseclass.Action");
	public ra_action_pzruleformtoolbarsiblings_4cf9df7ce7dc74552cd88f3580516243(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARSIBLINGS #20180713T135314.135 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZRULEFORMTOOLBARSIBLINGS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMTOOLBARSIBLINGS","Rule-Navigation","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARSIBLINGS #20180713T135314.135 GMT","!PZRULEFORMTOOLBARSIBLINGS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1473609809)
	};
...
//	RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARSIBLINGS #20180713T135314.135 GMT:20180713T135314.135 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "2ca5806299d3369c49d10bf917647dd9";
	}
...
if( processAction ||(processShortcut && "ID1345467522229000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1345467522229000")){
return;}
if(processShortcut &&"ID1345467522229000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","ID1345467522229000");actionPage1.putString( "pyCaption","View siblings");actionPage1.putString( "pySummary","");actionPage1.putString( "pyBadgeProperty","");actionPage1.putString( "pyToolTip","View siblings of this item");if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","");}actionPage1.putString( "pyBadgeFormat","");actionPage1.putString( "pyDeferLoad","");actionPage1.putString( "pyImage","hotkey-ruleform-siblings");actionPage1.putString("pyType","Action");
...
commandPage1.putString( "pyWindowName","Siblings");commandPage1.putString( "pyOptions","height=500,width=800,location=0,menubar=0,toolbar=0,status=0,resizable=1,location=0,scrollbars=1");commandPage1.putString( "pyReplace","false");commandPage1.putString( "pyUseAlternateUrlBase","false");commandPage1.putString( "pyNoEncodingUrl","");commandPage1.putString( "pyUrl",tools.findPage("pxThread").getString("pxReqURI"));commandPage1 .putString( "pyActivity","Rule-.GetSiblings");
 propertyValue = ".pxObjClass";
propertyValue = tools.getParamValue("ApplyToPage")+".pxObjClass";commandPage1.getProperty("pyQueryString").getPageValue(1).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage1.getProperty("pyQueryString").getPageValue(1).putString( "pyName","pxObjClass");propertyValue = ".pxInsId";
propertyValue = tools.getParamValue("ApplyToPage")+".pxInsId";commandPage1.getProperty("pyQueryString").getPageValue(2).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage1.getProperty("pyQueryString").getPageValue(2).putString( "pyName","pxInsId");propertyValue = ".pyClassName";
propertyValue = tools.getParamValue("ApplyToPage")+".pyClassName";commandPage1.getProperty("pyQueryString").getPageValue(3).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage1.getProperty("pyQueryString").getPageValue(3).putString( "pyName","pyClassName");propertyValue = ".pyRuleSet";
propertyValue = tools.getParamValue("ApplyToPage")+".pyRuleSet";commandPage1.getProperty("pyQueryString").getPageValue(4).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage1.getProperty("pyQueryString").getPageValue(4).putString( "pyName","pyRuleSet");propertyValue = ".pyRuleSetVersion";
propertyValue = tools.getParamValue("ApplyToPage")+".pyRuleSetVersion";commandPage1.getProperty("pyQueryString").getPageValue(5).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage1.getProperty("pyQueryString").getPageValue(5).putString( "pyName","pyRuleSetVersion");propertyValue = ".pzInsKey";
propertyValue = tools.getParamValue("ApplyToPage")+".pzInsKey";commandPage1.getProperty("pyQueryString").getPageValue(6).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage1.getProperty("pyQueryString").getPageValue(6).putString( "pyName","pzInsKey");executePage.putPage("pyOpenUrlInWindow",commandPage1);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION @BASECLASS PZRULEFORMTOOLBARSIBLINGS #20180713T135314.135 GMT", "@baseclass pzRuleFormToolbarSiblings", "Pega-Desktop", "08-01-01", "20180713T135314.135 GMT");
}
