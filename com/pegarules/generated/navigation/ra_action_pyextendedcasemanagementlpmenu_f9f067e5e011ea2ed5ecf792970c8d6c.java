...
import java.util.*;
public class ra_action_pyextendedcasemanagementlpmenu_f9f067e5e011ea2ed5ecf792970c8d6c  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pyExtendedCaseManagementLPMenu.Pega_Landing.Action");
	public ra_action_pyextendedcasemanagementlpmenu_f9f067e5e011ea2ed5ecf792970c8d6c(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION PEGA-LANDING PYEXTENDEDCASEMANAGEMENTLPMENU #20180713T143058.573 GMT	Pega-LP-ProcessAndRules:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(false){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "LP navigation rule extension for Case Management"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("LP navigation rule extension for Case Management");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PYEXTENDEDCASEMANAGEMENTLPMENU"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYEXTENDEDCASEMANAGEMENTLPMENU","Rule-Navigation","PEGA-LANDING",false,"","Pega-LP-ProcessAndRules","08-01-01","RULE-NAVIGATION PEGA-LANDING PYEXTENDEDCASEMANAGEMENTLPMENU #20180713T143058.573 GMT","!PYEXTENDEDCASEMANAGEMENTLPMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1605802313)
	};
...
//	RULE-NAVIGATION PEGA-LANDING PYEXTENDEDCASEMANAGEMENTLPMENU #20180713T143058.573 GMT:20180713T143058.573 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "71cdfc1446810b3c5dae4bda006f9a11";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"LP navigation rule extension for Case Management" */
...
if( processAction ||(processShortcut && "ID1294729513331000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1294729513331000")){
return;}
if(processShortcut &&"ID1294729513331000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION PEGA-LANDING PYEXTENDEDCASEMANAGEMENTLPMENU #20180713T143058.573 GMT", "Pega-Landing pyExtendedCaseManagementLPMenu", "Pega-LP-ProcessAndRules", "08-01-01", "20180713T143058.573 GMT");
}
