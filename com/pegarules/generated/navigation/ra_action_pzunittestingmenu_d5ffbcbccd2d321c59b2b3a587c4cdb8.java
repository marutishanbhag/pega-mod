...
import java.util.*;
public class ra_action_pzunittestingmenu_d5ffbcbccd2d321c59b2b3a587c4cdb8  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzUnitTestingMenu.Pega_Landing.Action");
	public ra_action_pzunittestingmenu_d5ffbcbccd2d321c59b2b3a587c4cdb8(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION PEGA-LANDING PZUNITTESTINGMENU #20200520T120616.550 GMT	Pega-Desktop:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "Unit Testing Menu"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("Unit Testing Menu");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZUNITTESTINGMENU"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZUNITTESTINGMENU","Rule-Navigation","PEGA-LANDING",false,"","Pega-Desktop","08-05-01","RULE-NAVIGATION PEGA-LANDING PZUNITTESTINGMENU #20200520T120616.550 GMT","!PZUNITTESTINGMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",117069386)
	};
...
//	RULE-NAVIGATION PEGA-LANDING PZUNITTESTINGMENU #20200520T120616.550 GMT:20200520T120616.550 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "d5dde28b9db5876a435303e4720e7712";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"Unit Testing Menu" */
...
String whenResolved ="pzPegaUnitEnabled";
...
commandPage1.putString( "pyAction","Display");commandPage1.putString( "pyName","Application: Unit Testing");commandPage1.putString( "pyClassName","Rule-Test-Unit-Case");commandPage1.putString( "pyLevelA","");commandPage1.putString( "pyLevelB","");commandPage1.putString( "pyLevelC","Test Cases");commandPage1.putString( "pyElementName","");commandPage1.putString( "pyTargetElement","");commandPage1.putString( "pyIsTargetMicroDC","false");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzApplicationTestCasesLP");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage1);
...
if(processAction||("ID1530006721863000".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
...
/*Node Generated for caption -  and Name - ID1530006721863000*/
...
actionPage2.putString("pyHidden",String.valueOf(hideElement));actionPage2.putString("pyDisabled",String.valueOf(disableElement));actionPage2.putString( "pyName","ID1530006721863000");actionPage2.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Test cases"));actionPage2.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage2.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage2.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage2.putString( "pyAutomationID","201806260552010838569");}actionPage2.putString( "pyBadgeFormat","Standard (label)");actionPage2.putString( "pyDeferLoad","false");actionPage2.putString( "pyImage","");actionPage2.putString("pyType","Action");
...
commandPage2.putString( "pyAction","Display");commandPage2.putString( "pyName","Application: Unit Testing");commandPage2.putString( "pyClassName","Rule-Test-Unit-Case");commandPage2.putString( "pyLevelA","");commandPage2.putString( "pyLevelB","");commandPage2.putString( "pyLevelC","Test Cases");commandPage2.putString( "pyElementName","");commandPage2.putString( "pyTargetElement","");commandPage2.putString( "pyIsTargetMicroDC","false");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzApplicationTestCasesLP");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage2);
...
commandPage4.putString( "pyAction","Display");commandPage4.putString( "pyName","Application: Unit Testing");commandPage4.putString( "pyClassName","Rule-Test-Unit-Case");commandPage4.putString( "pyLevelA","");commandPage4.putString( "pyLevelB","");commandPage4.putString( "pyLevelC","Test Suites");commandPage4.putString( "pyElementName","");commandPage4.putString( "pyTargetElement","");commandPage4.putString( "pyIsTargetMicroDC","false");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzApplicationTestCasesLP");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage4);
...
commandPage6.putString( "pyAction","Display");commandPage6.putString( "pyName","Application: Unit Testing");commandPage6.putString( "pyClassName","Rule-Test-Unit-Case");commandPage6.putString( "pyLevelA","");commandPage6.putString( "pyLevelB","");commandPage6.putString( "pyLevelC","Reports");commandPage6.putString( "pyElementName","");commandPage6.putString( "pyTargetElement","");commandPage6.putString( "pyIsTargetMicroDC","false");commandPage6.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzApplicationTestCasesLP");commandPage6.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage6.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage6.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage6);
...
pega_uiengine_pznavigation.pzProcessNavigationNode("Pega-Landing","pzScenarioTestingMenu",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION PEGA-LANDING PZUNITTESTINGMENU #20200520T120616.550 GMT", "Pega-Landing pzUnitTestingMenu", "Pega-Desktop", "08-05-01", "20200520T120616.550 GMT");
}
