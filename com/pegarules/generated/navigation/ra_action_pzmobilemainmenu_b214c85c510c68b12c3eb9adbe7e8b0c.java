...
import java.util.*;
public class ra_action_pzmobilemainmenu_b214c85c510c68b12c3eb9adbe7e8b0c  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzMobileMainMenu.Pega_Landing.Action");
	public ra_action_pzmobilemainmenu_b214c85c510c68b12c3eb9adbe7e8b0c(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION PEGA-LANDING PZMOBILEMAINMENU #20191016T120236.280 GMT	Pega-LP:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(false){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "pzMobileMainMenu"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("pzMobileMainMenu");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZMOBILEMAINMENU"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZMOBILEMAINMENU","Rule-Navigation","PEGA-LANDING",false,"","Pega-LP","08-04-01","RULE-NAVIGATION PEGA-LANDING PZMOBILEMAINMENU #20191016T120236.280 GMT","!PZMOBILEMAINMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-563274979)
	};
...
//	RULE-NAVIGATION PEGA-LANDING PZMOBILEMAINMENU #20191016T120236.280 GMT:20191016T120236.280 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "8fd29f7f4b200c5e5d01624db6ab6ebb";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"pzMobileMainMenu" */
...
if( processAction ||(processShortcut && "mobile".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("mobile")){
return;}
if(processShortcut &&"mobile".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","mobile");actionPage1.putString( "pyCaption","Mobile");actionPage1.putString( "pySummary","");actionPage1.putString( "pyBadgeProperty","");actionPage1.putString( "pyToolTip","");if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","201811190319140782184");}actionPage1.putString( "pyBadgeFormat","Standard (label)");actionPage1.putString( "pyDeferLoad","");actionPage1.putString( "pyImage","");actionPage1.putString("pyType","Action");
...
deferLoad = false;
if((!deferLoad && StringUtils.isBlank(deferLoadPath)) || (!StringUtils.isBlank(deferLoadPath) && ( deferIndex>=deferPathArr.length || deferPathArr[deferIndex].equalsIgnoreCase("mobile")))){
deferIndex ++;
...
if(processAction||("ID1542616916571000".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
...
/*Node Generated for caption -  and Name - ID1542616916571000*/
...
actionPage2.putString("pyHidden",String.valueOf(hideElement));actionPage2.putString("pyDisabled",String.valueOf(disableElement));actionPage2.putString( "pyName","ID1542616916571000");actionPage2.putString( "pyCaption","Certificates");actionPage2.putString( "pySummary","");actionPage2.putString( "pyBadgeProperty","");actionPage2.putString( "pyToolTip","");if(testIDWhen || functionalTestingWhen){actionPage2.putString( "pyAutomationID","201811190341560562390");}actionPage2.putString( "pyBadgeFormat","Standard (label)");actionPage2.putString( "pyDeferLoad","false");actionPage2.putString( "pyImage","");actionPage2.putString("pyType","Action");
...
commandPage2.putString( "pyAction","Display");commandPage2.putString( "pyName","Mobile: Certificates");commandPage2.putString( "pyClassName","Pega-Landing-Mobile-Configuration");commandPage2.putString( "pyLevelA","");commandPage2.putString( "pyLevelB","");commandPage2.putString( "pyLevelC","");commandPage2.putString( "pyElementName","");commandPage2.putString( "pyTargetElement","");commandPage2.putString( "pyIsTargetMicroDC","");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzLPMobileConfiguration");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage2);
...
if(processAction||("ID1568959042558000".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
if(processShortcut && !isNodePathEmpty && dontExitNow ){ 
if(nodeDepth==nodePathArr.length){ 
nodePathValidated=true;
...
if(dontExitNow){ //start of dnt exit now condition
/*Node Generated for caption -  and Name - ID1568959042558000*/
...
actionPage4.putString("pyHidden",String.valueOf(hideElement));actionPage4.putString("pyDisabled",String.valueOf(disableElement));actionPage4.putString( "pyName","ID1568959042558000");actionPage4.putString( "pyCaption","Offline Configuration");actionPage4.putString( "pySummary","");actionPage4.putString( "pyBadgeProperty","");actionPage4.putString( "pyToolTip","");if(testIDWhen || functionalTestingWhen){actionPage4.putString( "pyAutomationID","201909200157220552655");}actionPage4.putString( "pyBadgeFormat","Standard (label)");actionPage4.putString( "pyDeferLoad","false");actionPage4.putString( "pyImage","");actionPage4.putString("pyType","Action");
...
commandPage4.putString( "pyAction","Display");commandPage4.putString( "pyName","Offline Configuration");commandPage4.putString( "pyClassName","Pega-Landing-Mobile-OfflineConfig");commandPage4.putString( "pyLevelA","");commandPage4.putString( "pyLevelB","");commandPage4.putString( "pyLevelC","");commandPage4.putString( "pyElementName","");commandPage4.putString( "pyTargetElement","");commandPage4.putString( "pyIsTargetMicroDC","");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzLPMobileOfflineConfiguration");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage4);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION PEGA-LANDING PZMOBILEMAINMENU #20191016T120236.280 GMT", "Pega-Landing pzMobileMainMenu", "Pega-LP", "08-04-01", "20191016T120236.280 GMT");
}
