...
import java.util.*;
public class ra_action_pzruleformtoolbarviewmenu_bcdb8a578ed6707a4d17f7d582e12e07  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzRuleFormToolbarViewMenu.Rule_.Action");
	public ra_action_pzruleformtoolbarviewmenu_bcdb8a578ed6707a4d17f7d582e12e07(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION RULE- PZRULEFORMTOOLBARVIEWMENU #20180713T135317.638 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMTOOLBARVIEWMENU","Rule-Navigation","RULE-",false,"","Pega-Desktop","08-01-01","RULE-NAVIGATION RULE- PZRULEFORMTOOLBARVIEWMENU #20180713T135317.638 GMT","!PZRULEFORMTOOLBARVIEWMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1157102322)
	};
...
//	RULE-NAVIGATION RULE- PZRULEFORMTOOLBARVIEWMENU #20180713T135317.638 GMT:20180713T135317.638 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "4a19424d4e8c55cce522fe9964a5f013";
	}
...
pega_uiengine_pznavigation.pzProcessNavigationNode("Rule-","pzRuleFormToolbarReferencingRules",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("Rule-","pzRuleFormToolbarSiblings",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
tools.putParamValue("deferLoadPath", deferLoadPath);
}//end of if for pxProcessShortcut
}//end of method
/* Method generated for Top Level Node -"" for Navigation Rule :"pzRuleFormToolbarViewMenu" */
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("Rule-","pzRuleFormToolbarVersions",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
tools.putParamValue("deferLoadPath", deferLoadPath);
}
}//end of if for pxProcessShortcut
}//end of method
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("Rule-","pzRuleFormToolbarCompareWith",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
tools.putParamValue("deferLoadPath", deferLoadPath);
}
}//end of if for pxProcessShortcut
}//end of method
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1371237004661000".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1371237004661000")){
return;}
if(processShortcut &&"ID1371237004661000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
commandPage7.putString( "pyTarget","popup");commandPage7.putString( "pyTitle","");commandPage7.putString( "pyActivityClass","Rule-");commandPage7.putString( "pyHarnessName","pzGeneratedJava");commandPage7.putString( "pyReadOnly","No");commandPage7.putString( "pyKey","");commandPage7.putString( "pyActivity","pzShowJava");commandPage7.getProperty("pyPreDataTransform").getPageValue().putString( "pyName","");commandPage7.putString( "pyUsingPage","");commandPage7.putString( "pyElementName","");commandPage7.putString( "pyTargetElement","");commandPage7.putString( "pySelectedMobileTransitionType","");commandPage7.putString( "pyActivityClass","Rule-");if(tools !=null && tools.getPrimaryPage() != null){  strPageName = tools.getPrimaryPage().getReference();}commandPage7.putString("pzPrimaryPage",strPageName);propertyValue = ".pyShowJavaWindowName";
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION RULE- PZRULEFORMTOOLBARVIEWMENU #20180713T135317.638 GMT", "Rule- pzRuleFormToolbarViewMenu", "Pega-Desktop", "08-01-01", "20180713T135317.638 GMT");
}
