...
import java.util.*;
public class ra_action_pyflowshapesextension_e627bac596f6ceff2b3c3cc11c76a2aa  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pyFlowShapesExtension.Rule_Obj_Flow.Action");
	public ra_action_pyflowshapesextension_e627bac596f6ceff2b3c3cc11c76a2aa(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION RULE-OBJ-FLOW PYFLOWSHAPESEXTENSION #20190927T061843.743 GMT	Pega-DecisionArchitect:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "Menu items for Run Strategy and Capture Response"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("Menu items for Run Strategy and Capture Response");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PYFLOWSHAPESEXTENSION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYFLOWSHAPESEXTENSION","Rule-Navigation","RULE-OBJ-FLOW",false,"","Pega-DecisionArchitect","08-04-01","RULE-NAVIGATION RULE-OBJ-FLOW PYFLOWSHAPESEXTENSION #20190927T061843.743 GMT","!PYFLOWSHAPESEXTENSION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1995582294)
	};
...
//	RULE-NAVIGATION RULE-OBJ-FLOW PYFLOWSHAPESEXTENSION #20190927T061843.743 GMT:20190927T061843.743 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "af7a44eceb97657c5a10fb678a901b2e";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"Menu items for Run Strategy and Capture Response" */
...
if( processAction ||(processShortcut && "ID1366966646355000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1366966646355000")){
return;}
if(processShortcut &&"ID1366966646355000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","ID1366966646355000");actionPage1.putString( "pyImageSource","styleclass");actionPage1.putString( "pyIconStyle","pzRunStrategyIcon");actionPage1.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Run Strategy"));actionPage1.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage1.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage1.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","201811190708000231139");}actionPage1.putString( "pyBadgeFormat","Standard (label)");actionPage1.putString( "pyDeferLoad","false");actionPage1.putString( "pyImage","pzRunStrategyIcon");if (!hideElement) { 
...
commandPage1.getProperty("pyParameters").getPageValue(1).putString( "pyValue","Script:{name:\\u0022addNode\\u0022,type:\\u0022MakeDecision\\u0022}");commandPage1.getProperty("pyParameters").getPageValue(1).putString( "pyName","");commandPage1.putString( "pyFunctionName","ViewerManager.executeAction");executePage.putPage("pyCustom",commandPage1);
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1363939464581000".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1363939464581000")){
return;}
if(processShortcut &&"ID1363939464581000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
actionPage2.putString("pyHidden",String.valueOf(hideElement));actionPage2.putString("pyDisabled",String.valueOf(disableElement));actionPage2.putString( "pyName","ID1363939464581000");actionPage2.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Capture Response"));actionPage2.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage2.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage2.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage2.putString( "pyAutomationID","201811190708000236254");}actionPage2.putString( "pyBadgeFormat","");actionPage2.putString( "pyDeferLoad","");actionPage2.putString( "pyImage","pzCaptureResponseIcon");if (!hideElement) { 
...
commandPage2.getProperty("pyParameters").getPageValue(1).putString( "pyValue","Script:{name:\\u0022addNode\\u0022,type:\\u0022DecisionSetResponse\\u0022}");commandPage2.getProperty("pyParameters").getPageValue(1).putString( "pyName","");commandPage2.putString( "pyFunctionName","ViewerManager.executeAction");executePage.putPage("pyCustom",commandPage2);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION RULE-OBJ-FLOW PYFLOWSHAPESEXTENSION #20190927T061843.743 GMT", "Rule-Obj-Flow pyFlowShapesExtension", "Pega-DecisionArchitect", "08-04-01", "20190927T061843.743 GMT");
}
