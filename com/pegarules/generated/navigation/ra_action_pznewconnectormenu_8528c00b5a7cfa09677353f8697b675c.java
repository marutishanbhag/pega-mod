...
import java.util.*;
public class ra_action_pznewconnectormenu_8528c00b5a7cfa09677353f8697b675c  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzNewConnectorMenu._baseclass.Action");
	public ra_action_pznewconnectormenu_8528c00b5a7cfa09677353f8697b675c(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION @BASECLASS PZNEWCONNECTORMENU #20180713T135929.004 GMT	Pega-IntegrationArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(false){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "New Connector Menu"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("New Connector Menu");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZNEWCONNECTORMENU"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZNEWCONNECTORMENU","Rule-Navigation","@BASECLASS",false,"","Pega-IntegrationArchitect","08-01-01","RULE-NAVIGATION @BASECLASS PZNEWCONNECTORMENU #20180713T135929.004 GMT","!PZNEWCONNECTORMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1162942494)
	};
...
//	RULE-NAVIGATION @BASECLASS PZNEWCONNECTORMENU #20180713T135929.004 GMT:20180713T135929.004 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "e37cf4de8c6f52ca1f5849965065a689";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"New Connector Menu" */
...
if( processAction ||(processShortcut && "ID1363911490949000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1363911490949000")){
return;}
if(processShortcut &&"ID1363911490949000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","ID1363911490949000");actionPage1.putString( "pyCaption","Create SOAP Integration");actionPage1.putString( "pySummary","");actionPage1.putString( "pyBadgeProperty","");actionPage1.putString( "pyToolTip","");if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","");}actionPage1.putString( "pyBadgeFormat","");actionPage1.putString( "pyDeferLoad","");actionPage1.putString( "pyImage","");actionPage1.putString("pyType","Action");
...
behaviorPage1.putString("pyAction","openWizard");ClipboardPage commandPage1 = tools.createPage("Embed-DesktopAPI-OpenWizard","commandType");
commandPage1.putString( "pyClass","Pega-DataModel-DataSources-SOAP");commandPage1.putString( "pywizardLabel","New SOAP Integration");executePage.putPage("pyOpenWizard",commandPage1);
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1363911490949001".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1363911490949001")){
return;}
if(processShortcut &&"ID1363911490949001".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
behaviorPage2.putString("pyAction","openWizard");ClipboardPage commandPage2 = tools.createPage("Embed-DesktopAPI-OpenWizard","commandType");
commandPage2.putString( "pyClass","Pega-DataModel-DataSources-REST");commandPage2.putString( "pywizardLabel","New REST Integration");executePage.putPage("pyOpenWizard",commandPage2);
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1366370723644000".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1366370723644000")){
return;}
if(processShortcut &&"ID1366370723644000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
behaviorPage3.putString("pyAction","openWizard");ClipboardPage commandPage3 = tools.createPage("Embed-DesktopAPI-OpenWizard","commandType");
commandPage3.putString( "pyClass","Pega-DataModel-DataSources-SAP");commandPage3.putString( "pywizardLabel","New SAP Integration");executePage.putPage("pyOpenWizard",commandPage3);
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1363911490949002".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1363911490949002")){
return;}
if(processShortcut &&"ID1363911490949002".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
actionPage4.putString("pyHidden",String.valueOf(hideElement));actionPage4.putString("pyDisabled",String.valueOf(disableElement));actionPage4.putString( "pyName","ID1363911490949002");actionPage4.putString( "pyCaption","Connector and Metadata Wizard (legacy)");actionPage4.putString( "pySummary","");actionPage4.putString( "pyBadgeProperty","");actionPage4.putString( "pyToolTip","Integrate data requiring another type of connector");if(testIDWhen || functionalTestingWhen){actionPage4.putString( "pyAutomationID","");}actionPage4.putString( "pyBadgeFormat","Standard (label)");actionPage4.putString( "pyDeferLoad","false");actionPage4.putString( "pyImage","");actionPage4.putString("pyType","Action");
...
behaviorPage4.putString("pyAction","openWizard");ClipboardPage commandPage4 = tools.createPage("Embed-DesktopAPI-OpenWizard","commandType");
commandPage4.putString( "pyClass","PegaAccel-Integration-Connectors");commandPage4.putString( "pywizardLabel","Connector and Metadata Wizard");commandPage4.getProperty("pyParameters").getPageValue(1).putString( "pyValue","true");commandPage4.getProperty("pyParameters").getPageValue(1).putString( "pyName","SkipList");executePage.putPage("pyOpenWizard",commandPage4);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION @BASECLASS PZNEWCONNECTORMENU #20180713T135929.004 GMT", "@baseclass pzNewConnectorMenu", "Pega-IntegrationArchitect", "08-01-01", "20180713T135929.004 GMT");
}
