...
import java.util.*;
public class ra_action_pzcaseexplorertoolbarmenupe_f9085436f61d95da16a65a7262ede3c5  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzCaseExplorerToolbarMenuPE.Rule_Obj_CaseType.Action");
	public ra_action_pzcaseexplorertoolbarmenupe_f9085436f61d95da16a65a7262ede3c5(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION RULE-OBJ-CASETYPE PZCASEEXPLORERTOOLBARMENUPE #20200511T132719.350 GMT	Pega-ProcessArchitect:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "Ruleform Toolbar Menu PE"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("Ruleform Toolbar Menu PE");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZCASEEXPLORERTOOLBARMENUPE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCASEEXPLORERTOOLBARMENUPE","Rule-Navigation","RULE-OBJ-CASETYPE",false,"","Pega-ProcessArchitect","08-05-01","RULE-NAVIGATION RULE-OBJ-CASETYPE PZCASEEXPLORERTOOLBARMENUPE #20200511T132719.350 GMT","!PZCASEEXPLORERTOOLBARMENUPE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1679716915)
	};
...
//	RULE-NAVIGATION RULE-OBJ-CASETYPE PZCASEEXPLORERTOOLBARMENUPE #20200511T132719.350 GMT:20200511T132719.350 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "bcaee35290eccdf7a3b7a655cf9190db";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"Ruleform Toolbar Menu PE" */
...
commandPage1.putString( "pyTarget","currentharness");commandPage1.putString( "pyUsingPage","");commandPage1.putString( "pyActivity","pyRefreshFromCollaboration");commandPage1.putString( "pySection","");commandPage1.putString( "pyDisableSubmit","true");commandPage1.getProperty("pyPreDataTransform").getPageValue().putString( "pyName","");commandPage1.getProperty("pyActivityParameters").getPageValue(1).putString( "pyValue","");commandPage1.getProperty("pyActivityParameters").getPageValue(1).putString( "pyName","");commandPage1.getProperty("pyActivityParameters").getPageValue(1).putString( "pxObjClass","Embed-NameValuePair");commandPage1.getPage("pyPreDataTransform").getProperty("pyDataTransformParams").getPageValue(1).putString( "pyValue","");commandPage1.getPage("pyPreDataTransform").getProperty("pyDataTransformParams").getPageValue(1).putString( "pyName","");executePage.putPage("pyRefresh",commandPage1);
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1588770785535000".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1588770785535000")){
return;}
if(processShortcut &&"ID1588770785535000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
actionPage2.putString("pyHidden",String.valueOf(hideElement));actionPage2.putString("pyDisabled",String.valueOf(disableElement));actionPage2.putString( "pyName","ID1588770785535000");actionPage2.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Add create stage"));actionPage2.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage2.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage2.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage2.putString( "pyAutomationID","202005060913050528376");}actionPage2.putString( "pyBadgeFormat","Standard (label)");actionPage2.putString( "pyDeferLoad","false");actionPage2.putString( "pyImage","");if (!hideElement) { 
...
commandPage2Map.putString("pyActionName","pzAddInitStage");
commandPage2Map.putString("pyClassName", "Rule-Obj-CaseType");
...
commandPage2.putString("pyLocalAction", "pzAddInitStage");}else {
...
commandPage2.putString("pyUsingPage","CaseTypeStages");
...
commandPage3.putString( "pyTarget","otherSection");commandPage3.putString( "pyUsingPage","");commandPage3.putString( "pyActivity","");commandPage3.putString( "pySection","pzDisplayCaseTypeLifeCycle");commandPage3.putString( "pyDisableSubmit","true");commandPage3.getProperty("pyPreDataTransform").getPageValue().putString( "pyName","");commandPage3.getProperty("pyActivityParameters").getPageValue(1).putString( "pyValue","");commandPage3.getProperty("pyActivityParameters").getPageValue(1).putString( "pyName","");commandPage3.getProperty("pyActivityParameters").getPageValue(1).putString( "pxObjClass","Embed-NameValuePair");commandPage3.getPage("pyPreDataTransform").getProperty("pyDataTransformParams").getPageValue(1).putString( "pyValue","");commandPage3.getPage("pyPreDataTransform").getProperty("pyDataTransformParams").getPageValue(1).putString( "pyName","");behaviorPage3.putPage("pyActionAPI",commandPage3);
((PegaAPI)tools).getUIEngine().getUIAction(actionPage2.getPage("pyBehaviors(<LAST>)")).register();
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION RULE-OBJ-CASETYPE PZCASEEXPLORERTOOLBARMENUPE #20200511T132719.350 GMT", "Rule-Obj-CaseType pzCaseExplorerToolbarMenuPE", "Pega-ProcessArchitect", "08-05-01", "20200511T132719.350 GMT");
}
