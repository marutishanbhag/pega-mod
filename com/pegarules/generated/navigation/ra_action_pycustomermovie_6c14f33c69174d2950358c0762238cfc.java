...
import java.util.*;
public class ra_action_pycustomermovie_6c14f33c69174d2950358c0762238cfc  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pyCustomerMovie.Pega_Landing.Action");
	public ra_action_pycustomermovie_6c14f33c69174d2950358c0762238cfc(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION PEGA-LANDING PYCUSTOMERMOVIE #20180713T143336.153 GMT	Pega-DecisionArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "pyCustomerMovie"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("pyCustomerMovie");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PYCUSTOMERMOVIE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCUSTOMERMOVIE","Rule-Navigation","PEGA-LANDING",false,"","Pega-DecisionArchitect","08-01-01","RULE-NAVIGATION PEGA-LANDING PYCUSTOMERMOVIE #20180713T143336.153 GMT","!PYCUSTOMERMOVIE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-121766155)
	};
...
//	RULE-NAVIGATION PEGA-LANDING PYCUSTOMERMOVIE #20180713T143336.153 GMT:20180713T143336.153 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "5a1654ba968ef2679c830d5f0ac8ca4d";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"pyCustomerMovie" */
...
if( processAction ||(processShortcut && "ID1455705657635000".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1455705657635000")){
return;}
if(processShortcut &&"ID1455705657635000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
commandPage1.putString( "pyAction","Display");commandPage1.putString( "pyName","Decisioning: Event catalog");commandPage1.putString( "pyClassName","Pega-Landing-Decision-EventCatalog");commandPage1.putString( "pyLevelA","");commandPage1.putString( "pyLevelB","");commandPage1.putString( "pyLevelC","");commandPage1.putString( "pyElementName","");commandPage1.putString( "pyTargetElement","");commandPage1.putString( "pyIsTargetMicroDC","");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pxEventCatalog");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage1);
...
deferLoad = false;
if((!deferLoad && StringUtils.isBlank(deferLoadPath)) || (!StringUtils.isBlank(deferLoadPath) && ( deferIndex>=deferPathArr.length || deferPathArr[deferIndex].equalsIgnoreCase("ID1455705657635000")))){
deferIndex ++;
...
if(processAction||("ID1455705657632000".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
...
/*Node Generated for caption -  and Name - ID1455705657632000*/
...
actionPage2.putString("pyHidden",String.valueOf(hideElement));actionPage2.putString("pyDisabled",String.valueOf(disableElement));actionPage2.putString( "pyName","ID1455705657632000");actionPage2.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Event Catalog"));actionPage2.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage2.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage2.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage2.putString( "pyAutomationID","");}actionPage2.putString( "pyBadgeFormat","Standard (label)");actionPage2.putString( "pyDeferLoad","false");actionPage2.putString( "pyImage","");actionPage2.putString("pyType","Action");
...
commandPage2.putString( "pyAction","Display");commandPage2.putString( "pyName","Decisioning: Customer Movie");commandPage2.putString( "pyClassName","Pega-Landing-Decision-EventCatalog");commandPage2.putString( "pyLevelA","");commandPage2.putString( "pyLevelB","");commandPage2.putString( "pyLevelC","");commandPage2.putString( "pyElementName","");commandPage2.putString( "pyTargetElement","");commandPage2.putString( "pyIsTargetMicroDC","");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pxEventCatalog");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyModel","pySelectAllEvents");executePage.putPage("pyOpenLanding",commandPage2);
...
if(processAction||("ID1489555844746000".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
if(processShortcut && !isNodePathEmpty && dontExitNow ){ 
if(nodeDepth==nodePathArr.length){ 
nodePathValidated=true;
...
if(dontExitNow){ //start of dnt exit now condition
/*Node Generated for caption -  and Name - ID1489555844746000*/
...
actionPage4.putString("pyHidden",String.valueOf(hideElement));actionPage4.putString("pyDisabled",String.valueOf(disableElement));actionPage4.putString( "pyName","ID1489555844746000");actionPage4.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Event Browser"));actionPage4.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage4.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage4.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage4.putString( "pyAutomationID","");}actionPage4.putString( "pyBadgeFormat","Standard (label)");actionPage4.putString( "pyDeferLoad","false");actionPage4.putString( "pyImage","");actionPage4.putString("pyType","Action");
...
commandPage4.putString( "pyAction","Display");commandPage4.putString( "pyName","Decisioning: Customer Movie");commandPage4.putString( "pyClassName","Pega-Landing-Decision-EventCatalog");commandPage4.putString( "pyLevelA","");commandPage4.putString( "pyLevelB","");commandPage4.putString( "pyLevelC","");commandPage4.putString( "pyElementName","");commandPage4.putString( "pyTargetElement","");commandPage4.putString( "pyIsTargetMicroDC","");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pxEventCatalog");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyModel","pyEventBrowser");executePage.putPage("pyOpenLanding",commandPage4);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION PEGA-LANDING PYCUSTOMERMOVIE #20180713T143336.153 GMT", "Pega-Landing pyCustomerMovie", "Pega-DecisionArchitect", "08-01-01", "20180713T143336.153 GMT");
}
