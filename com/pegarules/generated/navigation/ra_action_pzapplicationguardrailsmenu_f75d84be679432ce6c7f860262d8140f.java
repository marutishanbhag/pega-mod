...
import java.util.*;
public class ra_action_pzapplicationguardrailsmenu_f75d84be679432ce6c7f860262d8140f  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzApplicationGuardrailsMenu.Pega_Landing.Action");
	public ra_action_pzapplicationguardrailsmenu_f75d84be679432ce6c7f860262d8140f(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION PEGA-LANDING PZAPPLICATIONGUARDRAILSMENU #20191021T150345.668 GMT	Pega-Desktop:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "Guardrails Menu"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("Guardrails Menu");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZAPPLICATIONGUARDRAILSMENU"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPLICATIONGUARDRAILSMENU","Rule-Navigation","PEGA-LANDING",false,"","Pega-Desktop","08-04-01","RULE-NAVIGATION PEGA-LANDING PZAPPLICATIONGUARDRAILSMENU #20191021T150345.668 GMT","!PZAPPLICATIONGUARDRAILSMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1825023665)
	};
...
//	RULE-NAVIGATION PEGA-LANDING PZAPPLICATIONGUARDRAILSMENU #20191021T150345.668 GMT:20191126T174936.457 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "63aa7c36b62d070047ab2fd1b3516886";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"Guardrails Menu" */
...
if( processAction ||(processShortcut && "applicationGuardrails".equals(nodePathArr[0])  && !isNodePathEmpty)){
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("applicationGuardrails")){
return;}
if(processShortcut &&"applicationGuardrails".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","applicationGuardrails");actionPage1.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Guardrails"));actionPage1.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage1.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage1.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","201910151046260850111");}actionPage1.putString( "pyBadgeFormat","");actionPage1.putString( "pyDeferLoad","");actionPage1.putString( "pyImage","lpiBase lpiApplicationGuardrails");actionPage1.putString("pyType","Action");
...
commandPage1.putString( "pyAction","Display");commandPage1.putString( "pyName","Application: Guardrails");commandPage1.putString( "pyClassName","Pega-Landing-Application");commandPage1.putString( "pyLevelA","");commandPage1.putString( "pyLevelB","");commandPage1.putString( "pyLevelC","Compliance");commandPage1.putString( "pyElementName","");commandPage1.putString( "pyTargetElement","");commandPage1.putString( "pyIsTargetMicroDC","");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzLPApplicationGuardrails");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage1.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage1);
...
deferLoad = false;
if((!deferLoad && StringUtils.isBlank(deferLoadPath)) || (!StringUtils.isBlank(deferLoadPath) && ( deferIndex>=deferPathArr.length || deferPathArr[deferIndex].equalsIgnoreCase("applicationGuardrails")))){
deferIndex ++;
...
if(processAction||("guardrailsWarningCompliance".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
...
/*Node Generated for caption -  and Name - guardrailsWarningCompliance*/
...
commandPage2.putString( "pyAction","Display");commandPage2.putString( "pyName","Application: Guardrails");commandPage2.putString( "pyClassName","Pega-Landing-Application");commandPage2.putString( "pyLevelA","");commandPage2.putString( "pyLevelB","");commandPage2.putString( "pyLevelC","Compliance");commandPage2.putString( "pyElementName","");commandPage2.putString( "pyTargetElement","");commandPage2.putString( "pyIsTargetMicroDC","");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzLPApplicationGuardrails");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage2.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage2);
...
if(processAction||("guardrailsWarningComplianceDetails".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
if(processShortcut && !isNodePathEmpty && dontExitNow ){ 
if(nodeDepth==nodePathArr.length){ 
nodePathValidated=true;
...
if(dontExitNow){ //start of dnt exit now condition
/*Node Generated for caption -  and Name - guardrailsWarningComplianceDetails*/
...
commandPage4.putString( "pyAction","Display");commandPage4.putString( "pyName","Application: Guardrails");commandPage4.putString( "pyClassName","Pega-Landing-Application");commandPage4.putString( "pyLevelA","");commandPage4.putString( "pyLevelB","");commandPage4.putString( "pyLevelC","ComplianceDetails");commandPage4.putString( "pyElementName","");commandPage4.putString( "pyTargetElement","");commandPage4.putString( "pyIsTargetMicroDC","");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzLPApplicationGuardrails");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage4.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage4);
...
if(processAction||("guardrailsWarningSummary".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
if(processShortcut && !isNodePathEmpty && dontExitNow ){ 
if(nodeDepth==nodePathArr.length){ 
nodePathValidated=true;
...
if(dontExitNow){ //start of dnt exit now condition
/*Node Generated for caption -  and Name - guardrailsWarningSummary*/
...
actionPage6.putString("pyHidden",String.valueOf(hideElement));actionPage6.putString("pyDisabled",String.valueOf(disableElement));actionPage6.putString( "pyName","guardrailsWarningSummary");actionPage6.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Warning Summary"));actionPage6.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage6.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage6.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage6.putString( "pyAutomationID","201910151046260834269");}actionPage6.putString( "pyBadgeFormat","Standard (label)");actionPage6.putString( "pyDeferLoad","false");actionPage6.putString( "pyImage","");actionPage6.putString("pyType","Action");
...
commandPage6.putString( "pyAction","Display");commandPage6.putString( "pyName","Application: Guardrails");commandPage6.putString( "pyClassName","Pega-Landing-Application");commandPage6.putString( "pyLevelA","");commandPage6.putString( "pyLevelB","");commandPage6.putString( "pyLevelC","Summary");commandPage6.putString( "pyElementName","");commandPage6.putString( "pyTargetElement","");commandPage6.putString( "pyIsTargetMicroDC","");commandPage6.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzLPApplicationGuardrails");commandPage6.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage6.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage6.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage6);
...
if(processAction||("guardrailsWarningDetails".equals(nodePathArr[currentElement])&& processShortcut && !isNodePathEmpty)){ 
matchFound=true;
if(processShortcut && !isNodePathEmpty && dontExitNow ){ 
if(nodeDepth==nodePathArr.length){ 
nodePathValidated=true;
...
if(dontExitNow){ //start of dnt exit now condition
/*Node Generated for caption -  and Name - guardrailsWarningDetails*/
...
actionPage8.putString("pyHidden",String.valueOf(hideElement));actionPage8.putString("pyDisabled",String.valueOf(disableElement));actionPage8.putString( "pyName","guardrailsWarningDetails");actionPage8.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Warning Details"));actionPage8.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage8.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage8.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage8.putString( "pyAutomationID","201910151046260844894");}actionPage8.putString( "pyBadgeFormat","Standard (label)");actionPage8.putString( "pyDeferLoad","false");actionPage8.putString( "pyImage","");actionPage8.putString("pyType","Action");
...
commandPage8.putString( "pyAction","Display");commandPage8.putString( "pyName","Application: Guardrails");commandPage8.putString( "pyClassName","Pega-Landing-Application");commandPage8.putString( "pyLevelA","");commandPage8.putString( "pyLevelB","");commandPage8.putString( "pyLevelC","Details");commandPage8.putString( "pyElementName","");commandPage8.putString( "pyTargetElement","");commandPage8.putString( "pyIsTargetMicroDC","");commandPage8.getProperty("pyDisplay").getPageValue().putString( "pyHarnessName","pzLPApplicationGuardrails");commandPage8.getProperty("pyDisplay").getPageValue().putString( "pyPage","");commandPage8.getProperty("pyDisplay").getPageValue().putString( "pyReadOnly","false");commandPage8.getProperty("pyDisplay").getPageValue().putString( "pyModel","");executePage.putPage("pyOpenLanding",commandPage8);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION PEGA-LANDING PZAPPLICATIONGUARDRAILSMENU #20191021T150345.668 GMT", "Pega-Landing pzApplicationGuardrailsMenu", "Pega-Desktop", "08-04-01", "20191126T174936.457 GMT");
}
