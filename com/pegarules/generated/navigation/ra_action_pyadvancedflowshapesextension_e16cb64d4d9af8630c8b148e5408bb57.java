...
import java.util.*;
public class ra_action_pyadvancedflowshapesextension_e16cb64d4d9af8630c8b148e5408bb57  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pyAdvancedFlowShapesExtension.Rule_Obj_Flow.Action");
	public ra_action_pyadvancedflowshapesextension_e16cb64d4d9af8630c8b148e5408bb57(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION RULE-OBJ-FLOW PYADVANCEDFLOWSHAPESEXTENSION #20190823T063610.382 GMT	Pega-ProcessArchitect:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "extend advanced flow shapes"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("extend advanced flow shapes");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PYADVANCEDFLOWSHAPESEXTENSION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYADVANCEDFLOWSHAPESEXTENSION","Rule-Navigation","RULE-OBJ-FLOW",false,"","Pega-ProcessArchitect","08-04-01","RULE-NAVIGATION RULE-OBJ-FLOW PYADVANCEDFLOWSHAPESEXTENSION #20190823T063610.382 GMT","!PYADVANCEDFLOWSHAPESEXTENSION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",168555731)
	};
...
//	RULE-NAVIGATION RULE-OBJ-FLOW PYADVANCEDFLOWSHAPESEXTENSION #20190823T063610.382 GMT:20190927T061843.829 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "dda2a0942458c1fe783b91ac01ceb966";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"extend advanced flow shapes" */
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","ID1363939464581000");actionPage1.putString( "pyImageSource","styleclass");actionPage1.putString( "pyIconStyle","pzRunStrategyIcon");actionPage1.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Run Data Flow"));actionPage1.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage1.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage1.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","201907220455490090969");}actionPage1.putString( "pyBadgeFormat","Standard (label)");actionPage1.putString( "pyDeferLoad","false");actionPage1.putString( "pyImage","pzRunStrategyIcon");actionPage1.putString("pyType","Action");
...
commandPage1.getProperty("pyParameters").getPageValue(1).putString( "pyValue","Script:{name:\\u0022addNode\\u0022,type:\\u0022RunDataFlow\\u0022}");commandPage1.getProperty("pyParameters").getPageValue(1).putString( "pyName","");commandPage1.putString( "pyFunctionName","ViewerManager.executeAction");executePage.putPage("pyCustom",commandPage1);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION RULE-OBJ-FLOW PYADVANCEDFLOWSHAPESEXTENSION #20190823T063610.382 GMT", "Rule-Obj-Flow pyAdvancedFlowShapesExtension", "Pega-ProcessArchitect", "08-04-01", "20190927T061843.829 GMT");
}
