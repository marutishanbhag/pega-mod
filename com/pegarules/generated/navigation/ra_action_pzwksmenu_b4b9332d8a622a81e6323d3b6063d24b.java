...
import java.util.*;
public class ra_action_pzwksmenu_b4b9332d8a622a81e6323d3b6063d24b  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzWksMenu.Data_Portal.Action");
	public ra_action_pzwksmenu_b4b9332d8a622a81e6323d3b6063d24b(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION DATA-PORTAL PZWKSMENU #20180713T135314.477 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "pzWksMenu"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("pzWksMenu");
	}
}
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZWKSMENU","Rule-Navigation","DATA-PORTAL",false,"","Pega-Desktop","08-01-01","RULE-NAVIGATION DATA-PORTAL PZWKSMENU #20180713T135314.477 GMT","!PZWKSMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1733161639)
	};
...
//	RULE-NAVIGATION DATA-PORTAL PZWKSMENU #20180713T135314.477 GMT:20180713T135314.477 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "fe6478958d9ef8dbed607d0a5802e3f5";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"pzWksMenu" */
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","ID1358184853338000");actionPage1.putString( "pyImageSource","styleclass");actionPage1.putString( "pyIconStyle","hotkey-logoff");actionPage1.putString("pyCaption", tools.getLocalizedTextForString("pyCaption", "Log off"));actionPage1.putString("pySummary", tools.getLocalizedTextForString("pySummary", ""));actionPage1.putString("pyBadgeProperty", tools.getLocalizedTextForString("pyBadgeProperty", ""));actionPage1.putString("pyToolTip", tools.getLocalizedTextForString("pyToolTip", ""));if(testIDWhen || functionalTestingWhen){actionPage1.putString( "pyAutomationID","20180710104136068614");}actionPage1.putString( "pyBadgeFormat","Standard (label)");actionPage1.putString( "pyDeferLoad","false");actionPage1.putString( "pyImage","hotkey-logoff");if (!hideElement) { 
...
commandPage1.putString( "pyFunctionName","closeWindows");executePage.putPage("pyCustom",commandPage1);
...
behaviorPage2.putString("pyAction","logOff");((PegaAPI)tools).getUIEngine().getUIAction(actionPage1.getPage("pyBehaviors(<LAST>)")).register();
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION DATA-PORTAL PZWKSMENU #20180713T135314.477 GMT", "Data-Portal pzWksMenu", "Pega-Desktop", "08-01-01", "20180713T135314.477 GMT");
}
