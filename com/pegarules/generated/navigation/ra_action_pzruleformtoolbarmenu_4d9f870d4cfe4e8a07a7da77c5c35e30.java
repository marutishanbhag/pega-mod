...
import java.util.*;
public class ra_action_pzruleformtoolbarmenu_4d9f870d4cfe4e8a07a7da77c5c35e30  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzRuleFormToolbarMenu.Rule_Obj_Flow.Action");
	public ra_action_pzruleformtoolbarmenu_4d9f870d4cfe4e8a07a7da77c5c35e30(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION RULE-OBJ-FLOW PZRULEFORMTOOLBARMENU #20180713T135317.452 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMTOOLBARMENU","Rule-Navigation","RULE-OBJ-FLOW",false,"","Pega-Desktop","08-01-01","RULE-NAVIGATION RULE-OBJ-FLOW PZRULEFORMTOOLBARMENU #20180713T135317.452 GMT","!PZRULEFORMTOOLBARMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-103605313)
	};
...
//	RULE-NAVIGATION RULE-OBJ-FLOW PZRULEFORMTOOLBARMENU #20180713T135317.452 GMT:20180713T135317.452 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "5b8650e6dea5d266b9ec1201aba793a8";
	}
...
pega_uiengine_pznavigation.pzProcessNavigationNode("Rule-Obj-Flow","pzRuleFormToolbarActionsMenu",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
...
boolean matchFound=true;
int currentElement=0;
if( processAction ||(processShortcut && "ID1527752707387000".equals(nodePathArr[0])  && !isNodePathEmpty)){
String uniqueSuffix = new Long(tools.getDateTimeUtils().currentTimeUnique()).toString();
String commonPrefix = "Nav_";
boolean showWhenCondition = true;
boolean isActiveNavItem = false;
...
int deferIndex = 0;
int nodeDepth=0;
if(!StringUtils.isBlank(deferLoadPath) && deferPathArr.length>0 && !deferPathArr[deferIndex].equalsIgnoreCase("ID1527752707387000")){
return;}
if(processShortcut &&"ID1527752707387000".equals(nodePathArr[0]) && !isNodePathEmpty){
nodeDepth++;
if(nodeDepth==nodePathArr.length){
nodePathValidated=true;
}
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("Rule-Obj-Flow","pzRuleFormToolbarViewMenu",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
tools.putParamValue("deferLoadPath", deferLoadPath);
}//end of if for pxProcessShortcut
}//end of method
/* Method generated for Top Level Node -"------------------" for Navigation Rule :"Ruleform Toolbar Menu" */
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("Rule-Obj-Flow","pzRuleFormToolbarHelpMenu",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
tools.putParamValue("deferLoadPath", deferLoadPath);
}//end of if for pxProcessShortcut
}//end of method
/* Method generated for Top Level Node -"" for Navigation Rule :"Ruleform Toolbar Menu" */
...
tools.putParamValue("deferLoadPath", currentDeferPath);
pega_uiengine_pznavigation.pzProcessNavigationNode("Rule-Obj-Flow","pzRuleFormToolbarCreate",commonPrefix,uniqueSuffix,outputPage,tools, tools.getParamValue("PageName"),"true" ,null);
tools.putParamValue("deferLoadPath", deferLoadPath);
}//end of if for pxProcessShortcut
}//end of method
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION RULE-OBJ-FLOW PZRULEFORMTOOLBARMENU #20180713T135317.452 GMT", "Rule-Obj-Flow pzRuleFormToolbarMenu", "Pega-Desktop", "08-01-01", "20180713T135317.452 GMT");
}
