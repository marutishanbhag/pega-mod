...
import java.util.*;
public class ra_action_pzworkspacemenu_9bfe3cd740053f3329b329d91282afc7  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Navigation.pzWorkspaceMenu.Data_Portal.Action");
	public ra_action_pzworkspacemenu_9bfe3cd740053f3329b329d91282afc7(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-NAVIGATION DATA-PORTAL PZWORKSPACEMENU #20180713T135314.485 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardPage fOutputPage = null;if (StringUtils.isBlank(tools.getParamValue("deferPagePath")) && !tools.getParamValue("usingPageRef").equals("true")) {
	...
	if(true){
		fOutputPage.putString("pyLabel", tools.getLocalizedTextForString("pyLabel", "WorkspaceMenu"));
	}else{
		fOutputPage.getProperty("pyLabel").setValue("WorkspaceMenu");
	}
}
...
private static final String oDependencies [] = {
	...
	"Rule-Navigation:PZWORKSPACEMENU"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZWORKSPACEMENU","Rule-Navigation","DATA-PORTAL",false,"","Pega-Desktop","08-01-01","RULE-NAVIGATION DATA-PORTAL PZWORKSPACEMENU #20180713T135314.485 GMT","!PZWORKSPACEMENU",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1942070640)
	};
...
//	RULE-NAVIGATION DATA-PORTAL PZWORKSPACEMENU #20180713T135314.485 GMT:20180723T184438.399 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISINTEGER #20180713T131441.652 GMT:20180713T131441.652 GMT
	...
	public static String getFUAContentHash() {
		return "58e18de39d1dc9655afae7e2c3c04faa";
	}
...
/* Method generated for Top Level Node -"" for Navigation Rule :"WorkspaceMenu" */
...
String actionListParentPage1 = tools.getParamValue("ApplyToPage");	Iterator actionListIter1 = nodePageList.iterator();
	while (actionListIter1.hasNext()) {		iterListResult = (ClipboardProperty)actionListIter1.next();
		...
		if(strChildListPageRef1.lastIndexOf(".") == 0) {
			strChildListPageRef1 = "pxThread" + strChildListPageRef1;
		}
...
actionPage1.putString("pyHidden",String.valueOf(hideElement));actionPage1.putString("pyDisabled",String.valueOf(disableElement));actionPage1.putString( "pyName","");actionPage1.putString( "pyImageSource","styleclass");propertyValue = ".pyPortalLayout";
propertyValue = tools.getParamValue("ApplyToPage")+".pyPortalLayout";actionPage1.putString("pyIconStyle",tools.getProperty(propertyValue).getStringValue());propertyValue = ".pyLabel";
...
propertyValue = ".pyPortalLayout";
propertyValue = tools.getParamValue("ApplyToPage")+".pyPortalLayout";commandPage1.getProperty("pyParameters").getPageValue(1).putString("pyValue",tools.getProperty(propertyValue).getStringValue());commandPage1.getProperty("pyParameters").getPageValue(1).putString( "pyName","portalName");commandPage1.putString( "pyFunctionName","pega.desktop.wks.switchWorkspace");executePage.putPage("pyCustom",commandPage1);
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-NAVIGATION DATA-PORTAL PZWORKSPACEMENU #20180713T135314.485 GMT", "Data-Portal pzWorkspaceMenu", "Pega-Desktop", "08-01-01", "20180723T184438.399 GMT");
}
