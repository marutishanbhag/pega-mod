...
/**
 * Builds JSP stream PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT!PZLISTTOGGLESFILTER.
 */
public class ra_stream_pzlisttogglesfilter_d3138428d550403cdff7127b9e09b87c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzListTogglesFilter.Pega_Landing_System_ToggleManagement.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -2010060360;
 ...
 */
	public ra_stream_pzlisttogglesfilter_d3138428d550403cdff7127b9e09b87c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "fc6ddfbc57afb60a8a709c3a1b396451fc2b6268";
...
{
/* Instance RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLESFILTER #20231113T211337.055 GMT	Pega-Desktop:08-23-02	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "fc6ddfbc57afb60a8a709c3a1b396451fc2b6268";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzListTogglesFilter",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLESFILTER #20231113T211337.055 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLESFILTER #20231113T211337.055 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLESFILTER #20231113T211337.055 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYDESIGNTEMPLATEINLINEWRAPPING", 
	"Rule-HTML-Section:PZLISTTOGGLESFILTER", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDESIGNTEMPLATEINLINEWRAPPING","Rule-HTML-Section","@BASECLASS",false,"","Pega-EndUserUI","08-02-01","RULE-HTML-SECTION @BASECLASS PYDESIGNTEMPLATEINLINEWRAPPING #20180822T112056.907 GMT","!PYDESIGNTEMPLATEINLINEWRAPPING",false,false,"MISSING",-1462245345), 
		new DependentRuleInfo("PZLISTTOGGLESFILTER","Rule-HTML-Section","PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT",false,"","Pega-Desktop","08-23-02","RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLESFILTER #20231113T211337.055 GMT","!PZLISTTOGGLESFILTER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2010060360), 
		new DependentRuleInfo("PYSEARCHTEXT","Rule-Obj-Property","@BASECLASS",true,"Pega-Landing-System-ToggleManagement","Pega-EndUserUI","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYSEARCHTEXT #20180713T134648.480 GMT","!PYSEARCHTEXT",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLESFILTER #20231113T211337.055 GMT:20231113T211337.055 GMT
//	RULE-HTML-SECTION @BASECLASS PYDESIGNTEMPLATEINLINEWRAPPING #20180822T112056.907 GMT:20180822T112056.907 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "1f7799d5d1c091e8c60ea82211df43e5";
	}
...
config.put("pyTarget", "currentHarness");
config.put("pyPreDataTransform.pyName", "pxLPRefreshTransform");
config.put("pyActivity", "pyLPRefreshActivity");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("pyTarget", "currentHarness");
config.put("pyPreDataTransform.pyName", "pxLPRefreshTransform");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			...
			refreshActionRequest.registerFixedParameter("PreActivity", "pyLPRefreshActivity");
			refreshActionRequest.registerFixedParameter("PreDataTransform", "pxLPRefreshTransform");
			tools.appendString("[\"refresh\", [\"currentharness\",\"\", \"pyLPRefreshActivity\", \"");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202310171033040323476") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzListTogglesFilter_$CTX$_b74c91c3-4b77-4113-83e2-de4f52edc1df");
		String repeatIndx = "";
	String pyTooltip = "";
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Clear search\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Clear search", ".pyButtonLabel");
	}
	pyLabel = "Clear search";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzListTogglesFilter_"+ referenceString+ "_b74c91c3-4b77-4113-83e2-de4f52edc1df'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202310171033040323476") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		tools.appendString("]' ");
			...
			String repeatIndx = "";tools.appendString("class='Demure pzhc pzbutton");tools.appendString("'");if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		tools.appendString(" >");
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202310131753580946199") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzListTogglesFilter_$CTX$_480650d0-ba9b-4d1b-b632-e1fa40fa2e1b");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzListTogglesFilter_"+ referenceString+ "_480650d0-ba9b-4d1b-b632-e1fa40fa2e1b'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202310131753580946199") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
...
public void pxTextInput_1() {String key="2d9308d1-bfcb-4fdf-b46c-ac12a4cbe1ab||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLESFILTER #20231113T211337.055 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","2d9308d1-bfcb-4fdf-b46c-ac12a4cbe1ab"};oCellRuntimeParamsMap.put("2d9308d1-bfcb-4fdf-b46c-ac12a4cbe1ab||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLESFILTER #20231113T211337.055 GMT",paramValues);oControlPathsMap.put("2d9308d1-bfcb-4fdf-b46c-ac12a4cbe1ab||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLESFILTER #20231113T211337.055 GMT",".pyRegions(1).pyCells(1)||.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput",".pySearchText",".pyRegions(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202310131806170977697-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextInput",".pySearchText",".pyRegions(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pyRegions(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202310131753580946199-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pyRegions(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pyRegions(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202310171033040323476-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	pxButton_2();labelName = "Text Input";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzListTogglesFilterB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)','region':'A'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzListTogglesFilterB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLESFILTER #20231113T211337.055 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzListTogglesFilter");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLESFILTER #20231113T211337.055 GMT", "Pega-Landing-System-ToggleManagement pzListTogglesFilter", "Pega-Desktop", "08-23-02", "20231113T211337.055 GMT");
}
