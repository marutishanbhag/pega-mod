...
/**
 * Builds JSP stream WORK-!PZVIEWINSTANCES.
 */
public class ra_stream_pzviewinstances_e4c9fd05c7520f0d6c13ae21da58a067 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzViewInstances.LTM_BFS_Work_Enrollment.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1694563641;
 ...
 */
	public ra_stream_pzviewinstances_e4c9fd05c7520f0d6c13ae21da58a067(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "90d433d70cd5a7c83e51d48e745e4c355ba89309";
...
{
/* Instance RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "90d433d70cd5a7c83e51d48e745e4c355ba89309";
...
/*
 * Begin RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZVIEWINSTANCES","Rule-HTML-Section","WORK-",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT","!PZVIEWINSTANCES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1694563641), 
		new DependentRuleInfo("PYTEMPLATEDISPLAYTEXT","Rule-Obj-Property","@BASECLASS",true,"Work-","Pega-UIDesign","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEDISPLAYTEXT #20180713T133539.875 GMT","!PYTEMPLATEDISPLAYTEXT",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYSELECTEDCLASS","Rule-Obj-Property","@BASECLASS",true,"Work-","Pega-LP-DataModel","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYSELECTEDCLASS #20180713T142654.813 GMT","!PYSELECTEDCLASS",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1)
	};
...
//	RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT:20180713T135308.634 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "0c1383a039ed4f8b01bb751c068e9c0c";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzViewInstances",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzViewInstances','insKey':'RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT','sectionType':'standard'}");
...
public void pxDisplayText_5() {String key="83||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","false","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","83"};oCellRuntimeParamsMap.put("83||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT",paramValues);oControlPathsMap.put("83||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(5)");}


public void pxDisplayText_4() {String key="82||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","false");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","false","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","82"};oCellRuntimeParamsMap.put("82||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT",paramValues);oControlPathsMap.put("82||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");}


public void pxDisplayText_3() {String key="81||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","false");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","false","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","81"};oCellRuntimeParamsMap.put("81||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT",paramValues);oControlPathsMap.put("81||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");}


public void pxDisplayText_2() {String key="80||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","false");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","false","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","80"};oCellRuntimeParamsMap.put("80||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT",paramValues);oControlPathsMap.put("80||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
...
public void pxDisplayText_1() {String key="79||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","false");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","false","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","79"};oCellRuntimeParamsMap.put("79||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT",paramValues);oControlPathsMap.put("79||RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateDisplayText",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateDisplayText",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateDisplayText",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	isCellReadOnly = true;
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateDisplayText",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pySelectedClass",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	isCellReadOnly = true;
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pySelectedClass",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateDisplayText",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	isCellReadOnly = true;
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateDisplayText",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
public int simpleLayoutCell_5( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateDisplayText",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(5)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	isCellReadOnly = true;
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateDisplayText",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(5)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201807110313370421338") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + " content  layout-content-inline content-inline " + "'  ");
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" rx.pzViewInstanceOfClassNotExists", pxUniqueStreamHash+"_16");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if(pzAuto.handleEvaluateWhen(" rx.pzViewInstanceOfClassNotExists",".pzViewInstanceOfClassNotExists", "layout", "visible" )) {pzSetExpandParam_2();
...
throw new RuntimeException("Problem in JSP fragment", t);
	 ...
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("",strPropName, ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		if(null != headerCellSection) {StringMap keys = new HashStringMap();keys.putString("pxObjClass", "Rule-HTML-Section");keys.putString("pyStreamName", headerCellSection);tools.appendString(tools.getStream(keys, null));tools.appendString("</th>");return;}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									...
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc1968075093'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
...
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc1968075093' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc1968075093' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc1968075093' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
								...
								ClipboardPage gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13!=null && !gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13.getProperty("pyColumnFilterCriteria").getPageValue(tools.getParamValue("RDColumnName")).isEmpty() && gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13.getProperty("pyColumnFilterCriteria").getPropertyValue(tools.getParamValue("RDColumnName")).getStringValue("pyFilterCriteriaType")!="" && gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13.getProperty("pyColumnFilterCriteria").getPropertyValue(tools.getParamValue("RDColumnName")).getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle1968075093\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13!=null && !gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13.getProperty("pyColumnFilterCriteria").getPageValue(tools.getParamValue("RDColumnName")).isEmpty() && gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13.getProperty("pyColumnFilterCriteria").getPropertyValue(tools.getParamValue("RDColumnName")).getStringValue("pyFilterCriteriaType")!="" && gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13.getProperty("pyColumnFilterCriteria").getPropertyValue(tools.getParamValue("RDColumnName")).getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType="+filterType+"></span><span id=\"filterTitle1968075093\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13!=null && !gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13.getProperty("pyColumnFilterCriteria").getPageValue(tools.getParamValue("RDColumnName")).isEmpty() && gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13.getProperty("pyColumnFilterCriteria").getPropertyValue(tools.getParamValue("RDColumnName")).getStringValue("pyFilterCriteriaType")!="" && gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13.getProperty("pyColumnFilterCriteria").getPropertyValue(tools.getParamValue("RDColumnName")).getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType="+filterType+"></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13!=null && !gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13.getProperty("pyColumnFilterCriteria").getPageValue(tools.getParamValue("RDColumnName")).isEmpty() && gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13.getProperty("pyColumnFilterCriteria").getPropertyValue(tools.getParamValue("RDColumnName")).getStringValue("pyFilterCriteriaType")!="" && gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13.getProperty("pyColumnFilterCriteria").getPropertyValue(tools.getParamValue("RDColumnName")).getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType="+filterType+"></span></span>");}else{
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "width:33%;",false,"","");tools.appendString("<nobr>");
	...
	tools.appendString("</nobr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("SUB_SECTION","pyGridPaginator",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead gridActionAlignRight","dataLabelWrite gridActionAlignRight"), "width:33%;",false,"","");sectionIncludeInCell_pyGridPaginator_1(); pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>\n\n\t\t\t\t\t\t</div>");
 } 
...
String expandParameter = "EXPANDEDSubSectionpzViewInstancesB";
...
String reportContPageName = pega_uiengine_grid.pzResolveReportPageName("pgRepPgSubSectionpzViewInstancesB", false);
 ...
 if(!bSkipRemoveClipboard){ ClipboardPage oldPage = tools.findPage(pega_uiengine_grid.pzResolveReportPageName("pgRepPgSubSectionpzViewInstancesB", false));
if(oldPage != null) {oldPage.removeFromClipboard();}}

 newParams.putString("pyPageName",pega_uiengine_grid.pzResolveReportPageName("pgRepPgSubSectionpzViewInstancesB", false));

 ClipboardPage pg = tools.createPage("@baseclass","");

 String paramPg = "paramPage";

 if("pgRepPgSubSectionpzViewInstancesB".indexOf("pgRepPg") > -1){

 	paramPg+= "pgRepPgSubSectionpzViewInstancesB".substring(7);

 }else {

 	paramPg+= pega_uiengine_grid.pzResolveReportPageName("pgRepPgSubSectionpzViewInstancesB", false).replace(".","__1_");
 ...
 ClipboardPage pgRepContPageWithResults = tools.findPage(pega_uiengine_grid.pzResolveReportPageName("pgRepPgSubSectionpzViewInstancesB", false));
...
tools.putParamValue("morePages",pgRepContPageWithResults.getProperty("pxMore").getStringValue());
 ...
 ClipboardPage gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13=null;

 Map selUniqMappgRepPgSubSectionpzViewInstancesB_pxResultsL13 = null;

	 String strFCPage = "pyFilterCriteria_pgRepPgSubSectionpzViewInstancesB.pxResults_pzViewInstances_1";
...
gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));

  selUniqMappgRepPgSubSectionpzViewInstancesB_pxResultsL13 = null; // reset the variable

 if(gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13 != null){ 

 tools.putParamValue("populateSelectedUIValues", "true");

 		 selUniqMappgRepPgSubSectionpzViewInstancesB_pxResultsL13 = pega_uiengine_uiengine.pzPopulateSelectedValues(gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13); 

 		 tools.getParameterPage().put("selUniqMappgRepPgSubSectionpzViewInstancesB_pxResultsL13", selUniqMappgRepPgSubSectionpzViewInstancesB_pxResultsL13);

 tools.putParamValue("populateSelectedUIValues", "");

 }
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");tools.appendString("pgRepPgSubSectionpzViewInstancesB.pxResults");tools.appendString("_pzViewInstances_1'");
...
tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201807110313370419497") + " ");
...
tools.appendString(pega_uiengine_grid.pzResolveReportPageName("pgRepPgSubSectionpzViewInstancesB", false));tools.appendString("' gridLayoutID=\"SubSectionpzViewInstancesB\"  openOnDblClick='false'");
String OAFunc = ""; 
...
tools.appendString(" ");
pgRepPgSubSectionpzViewInstancesB_pxResults_1();
tools.appendString(">");
...
if(tools.findPage("pgRepPgSubSectionpzViewInstancesB", true)!=null) {
pageListProp = tools.getProperty("pgRepPgSubSectionpzViewInstancesB.pxResults");
}
 ...
 tools.putParamValue("PageListProperty","pgRepPgSubSectionpzViewInstancesB.pxResults");}
...
String resultsPage = "" ;
resultsPage = "pgRepPgSubSectionpzViewInstancesB";
...
tools.putParamValue("pyPageName","pgRepPgSubSectionpzViewInstancesBMETADATA");
...
pg_metaDataPage = tools.findPage("pgRepPgSubSectionpzViewInstancesBMETADATA");
...
selUniqMappgRepPgSubSectionpzViewInstancesB_pxResultsL13 = null; // reset the variable
gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));
		 selUniqMappgRepPgSubSectionpzViewInstancesB_pxResultsL13 = (Map)tools.getParameterPage().getObject("selUniqMappgRepPgSubSectionpzViewInstancesB_pxResultsL13");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getProperty("pgRepPgSubSectionpzViewInstancesB.pxResults");
					...
					functionsMap = pega_uiengine_uiengine.pzGetRDFunctionsMap(tools.findPage("pgRepPgSubSectionpzViewInstancesB"));

					classesMap = pega_uiengine_uiengine.pzGetRDClassesMap(tools.findPage("pgRepPgSubSectionpzViewInstancesB"));
					...
					tools.appendString("' gPropIndex='pgRepPgSubSectionpzViewInstancesBPpxResults1' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201807110313370419497-layout") + " ");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"pgRepPgSubSectionpzViewInstancesBPpxResults1colWidthGBL\" id=\"pgRepPgSubSectionpzViewInstancesBPpxResults1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("pgRepPgSubSectionpzViewInstancesBPpxResults1colWidthGBL"));tools.appendString("\" />");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"pgRepPgSubSectionpzViewInstancesBPpxResults1colWidthGBR\" id=\"pgRepPgSubSectionpzViewInstancesBPpxResults1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("pgRepPgSubSectionpzViewInstancesBPpxResults1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("pgRepPgSubSectionpzViewInstancesBPpxResults1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='' PL_PROP='");

					
tools.appendString("pgRepPgSubSectionpzViewInstancesB.pxResults");
...
int prevCategoryLastRowIndex = 0;
								 ...
								 itr_3 = tools.getProperty("pgRepPgSubSectionpzViewInstancesB.pxResults").iterator(); 
...
Set filteredResultsSet = (HashSet)tools.getParameterPage().getObject("filteredResultsSet");boolean bFilterResult = false;
										 ...
										 } else if(gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13!= null){ 
													 bFilterResult = pega_uiengine_uiengine.pzMatchesGridFilterCriteria(gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13, selUniqMappgRepPgSubSectionpzViewInstancesB_pxResultsL13);
										 }
										 if (gFCritPagepgRepPgSubSectionpzViewInstancesB_pxResultsL13== null || 
...
tools.appendString(" ng-repeat=\"Item in rootData.pgRepPgSubSectionpzViewInstancesB.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
...
tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201807110313370419497-" + rowTestID) + " ");
}
...
tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' id='categoryCounts' categoryCountsJSON='" + countStrJson.toString() + "' ></div>");
 ...
 { if(tools.getSaveValue("bUseMenuInline").equals("true")){ tools.findPage("pgRepPgSubSectionpzViewInstancesB").removeFromClipboard(); }}
 tools.putSaveValue("bUseMenuInline", "false");
 if( tools.getParamValue("partialTrigger").equals("getChildNodespgRepPgSubSectionpzViewInstancesB.pxResults1") && tools.getParamValue("partialRefresh").equals("false")) {
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2== rx.pzViewInstanceOfClassNotExists cffalse",".pzViewInstanceOfClassNotExists = false", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
...
public void pgRepPgSubSectionpzViewInstancesB_pxResults_1() {
...
String strPropReference61 = "#~.pzInsKey$0$~#";
...
tools.appendString(")\"]");
	...
	tools.appendString("],[\"openWorkByHandle\",[\"");
		...
		tools.appendString("#~.pzInsKey$0$~#");	tools.appendString("\",\"\",\"");

		tools.appendFormatted("",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");

		tools.appendFormatted("",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"false\",\"false\",{}]");
	}
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTopgRepPgSubSectionpzViewInstancesB.pxResults1")|| tools.getParamValue("partialTrigger").equals("editRowpgRepPgSubSectionpzViewInstancesB.pxResults1") ){
					...
					ClipboardProperty pageListProp = tools.getProperty("pgRepPgSubSectionpzViewInstancesB.pxResults");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData.pgRepPgSubSectionpzViewInstancesB.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdroppgRepPgSubSectionpzViewInstancesB.pxResults1")) {
 ...
 if(tools.getParamValue("partialTrigger").equals("filterpopuppgRepPgSubSectionpzViewInstancesB.pxResults1")) { 
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTopgRepPgSubSectionpzViewInstancesB.pxResults1") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PZVIEWINSTANCES #20180713T135308.634 GMT", "Work- pzViewInstances", "Pega-Desktop", "08-01-01", "20180713T135308.634 GMT");
}
