...
/**
 * Builds JSP stream RULE-APPLICATION!PZAPPLICATIONWIZARD.
 */
public class ra_stream_pzapplicationwizard_c9d7d70b36b7ab56e4cc4784b2945b08 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzApplicationWizard.Rule_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1271672597;
 ...
 */
	public ra_stream_pzapplicationwizard_c9d7d70b36b7ab56e4cc4784b2945b08(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "20f5f0a0e2fdefca1dace29e8f26ba76fd0cc4f1";
...
{
/* Instance RULE-HTML-SECTION RULE-APPLICATION PZAPPLICATIONWIZARD #20180713T141804.545 GMT	Pega-AppDefinition:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "20f5f0a0e2fdefca1dace29e8f26ba76fd0cc4f1";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzApplicationWizard",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-APPLICATION PZAPPLICATIONWIZARD #20180713T141804.545 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-APPLICATION PZAPPLICATIONWIZARD #20180713T141804.545 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-APPLICATION PZAPPLICATIONWIZARD #20180713T141804.545 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZAPPLICATIONWIZARD", 
	"Rule-Obj-Property:PXOBJCLASS", 
	"Rule-Obj-Property:PYAPPTEMPLATELABEL", 
	"Rule-Obj-Property:PYUSEGRAPH", 
	"Rule-Obj-Property:PYAPPTEMPLATEDESCRIPTION", 
	"Rule-Obj-Property:PYACCESSGROUPFORADMINISTRATOR", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPLICATIONWIZARD","Rule-HTML-Section","RULE-APPLICATION",false,"","Pega-AppDefinition","08-01-01","RULE-HTML-SECTION RULE-APPLICATION PZAPPLICATIONWIZARD #20180713T141804.545 GMT","!PZAPPLICATIONWIZARD",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1271672597), 
		new DependentRuleInfo("PXOBJCLASS","Rule-Obj-Property","@BASECLASS",true,"Rule-Application","Pega-SystemArchitect","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PXOBJCLASS #20180713T135622.443 GMT","!PXOBJCLASS",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYAPPTEMPLATELABEL","Rule-Obj-Property","RULE-APPLICATION",false,"","Pega-RulesEngine","08-01-01","RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATELABEL #20180713T132557.485 GMT","!PYAPPTEMPLATELABEL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
		new DependentRuleInfo("PYUSEGRAPH","Rule-Obj-Property","RULE-APPLICATION",true,"Rule-Application","Pega-AppDefinition","08-01-01","RULE-OBJ-PROPERTY RULE-APPLICATION PYUSEGRAPH #20180713T141637.259 GMT","!PYUSEGRAPH",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYAPPTEMPLATEDESCRIPTION","Rule-Obj-Property","RULE-APPLICATION",false,"","Pega-RulesEngine","08-01-01","RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATEDESCRIPTION #20180713T132557.478 GMT","!PYAPPTEMPLATEDESCRIPTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
		new DependentRuleInfo("PYACCESSGROUPFORADMINISTRATOR","Rule-Obj-Property","RULE-APPLICATION",true,"Rule-Application","Pega-RulesEngine","08-01-01","RULE-OBJ-PROPERTY RULE-APPLICATION PYACCESSGROUPFORADMINISTRATOR #20180713T132557.376 GMT","!PYACCESSGROUPFORADMINISTRATOR",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE-APPLICATION PZAPPLICATIONWIZARD #20180713T141804.545 GMT:20180713T141804.545 GMT
...
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYUSEGRAPH #20180713T141637.259 GMT:20180713T141637.259 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATELABEL #20180713T132557.485 GMT:20180713T132557.485 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATELABEL #20180713T132557.485 GMT:20180713T132557.485 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATELABEL #20180713T132557.485 GMT:20180713T132557.485 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATELABEL #20180713T132557.485 GMT:20180713T132557.485 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATELABEL #20180713T132557.485 GMT:20180713T132557.485 GMT
...
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYACCESSGROUPFORADMINISTRATOR #20180713T132557.376 GMT:20180713T132557.376 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATELABEL #20180713T132557.485 GMT:20180713T132557.485 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATELABEL #20180713T132557.485 GMT:20180713T132557.485 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATELABEL #20180713T132557.485 GMT:20180713T132557.485 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATELABEL #20180713T132557.485 GMT:20180713T132557.485 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "bfc98cd5422b4dc374823a65c95694d5";
	}
...
config.put("pyPreDataTransform.pyName", "pzSetDefaultAppTemplateTileImages");
...
getControlMarkup_1() {
try {
if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyAppTemplateLabel").getEntryHandle())){

/*
 * reference tag
 * Cannot inline because: included stream is too big: 38240 bytes
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyAppTemplateLabel", "input", "OpenRuleAdvanced")) {
	return;
}
}
else if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyAppTemplateLabel").getEntryHandle())){
...
else if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyAppTemplateDescription").getEntryHandle())){

/*
 * reference tag
 * Cannot inline because: included stream is too big: 38240 bytes
 */
if (_jspx_meth_pega_reference__2(pageContext, ".pyAppTemplateDescription", "input", "OpenRuleAdvanced")) {
	return;
}
}
else if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyAppTemplateDescription").getEntryHandle())){
...
else if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyAccessGroupForAdministrator").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
	pzAuto.getUIComponentRuntime().setTemplatingUIStatus('Y');
}pxDropdown_1(".pyAccessGroupForAdministrator",0,"","","Text");pzAuto.getUIComponentRuntime().insertTemplateScripts();}
} catch(Throwable t) {
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzApplicationWizardB"));
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("New Application wizard settings", "pyCaption");
...
metadataPage.put("title","New Application wizard settings");
metadataPage.put("uniqueid", "202602211403210837");
...
tools.appendString("<div class='layout layout-noheader layout-noheader-column_divider_left'>");
 String clsScroll= "";tools.appendString("<div section_index='1' class='" + clsScroll + " layout-body clearfix'>");
tools.putParamValue("LAYOUT_METHOD_NAME","simpleLayout_5");simpleLayout_5();
tools.appendString("</div></div>");
tools.putSaveValue("rowClass","");
...
public void buildSection_6() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_75","pzAppTemplateDescription", secInfo);
}
...
public void sectionBodyIncludeInCell_6() { 
	...
	String sectionName = "pzAppTemplateDescription"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzApplicationWizard9","",false);
}
...
public void buildSection_5() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_72","pzAppTemplateDescription", secInfo);
}
...
public void buildSection_4() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_71","pzAppTemplateLabel", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pzAppTemplateLabel"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpzApplicationWizard912","",false);
}
...
public void buildSection_3() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_68","pzAppTemplateLabel", secInfo);
}
...
public void buildSection_2() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_67","pzAppTemplateBadge", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzAppTemplateBadge"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpzApplicationWizard416","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_64","pzAppTemplateBadge", secInfo);
}
...
public int simpleLayoutCell_13( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzAppTemplateBadge",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_13( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzAppTemplateBadge",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_14( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzAppTemplateLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_14( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzAppTemplateLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
public int simpleLayoutCell_15( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzAppTemplateDescription",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_15( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzAppTemplateDescription",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzApplicationWizardBBBBBBBB","",false);
}
...
public void simpleLayout_5() {
	...
	String paramName = "EXPANDEDSubSectionpzApplicationWizardBBBBBBBB";
	...
	metadataPage.put("prefix","-column_divider_left");
	metadataPage.put("sectionIndex","168");
...
IUIComponentMetadata metadataPage = pzAuto.getUIComponentRuntime().createMetadata();
IUIComponent headerComponent = pzAuto.getUIComponent();
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzApplicationWizardBBBBBBB"));
String sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
if(!"".equals(sectionTitleFVMeta)){
metadataPage.put("fieldValueMeta",sectionTitleFVMeta);
}
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("New application access", "pyCaption");
String inspectorFVData = pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData();
if(!"".equals(inspectorFVData)){
metadataPage.put("fieldValueInspectorData",inspectorFVData);
}
metadataPage.put("title","New application access");
metadataPage.put("uniqueid", "202602211403210795");
metadataPage.put("automationId", "");
headerComponent.beginComponent("pxLayoutHeader",metadataPage);
headerComponent.endComponent();
}
...
public void inclFormattedVal_4(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {if (isSecuredProp) { tools.putParamValue("proSecurity_isSecuredProp", isSecuredProp);tools.putParamValue("proSecurity_activePropValue", activePropValue);}
		...
		tools.appendString(pega_uiengine_formatter.pxFormatText(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzAccessGroupsByApplicationWithPortal","","","D_pzAccessGroupsByApplicationWithPortal:AppName$.pyProductName~AppVersion$.pyProductVersion~PortalName$Developer",".pyAccessGroup",".pyAccessGroup",true,(PegaStreamAPI)tools),false,"","",true,"caption"));
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzAccessGroupsByApplicationWithPortal","","","D_pzAccessGroupsByApplicationWithPortal:AppName$.pyProductName~AppVersion$.pyProductVersion~PortalName$Developer",".pyAccessGroup",".pyAccessGroup",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("isControlEditableOriginal"))) {
...
tools.appendString("</P>");
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("201608301747140614213349",true));
	cellPage.put("pyValue",".pyAccessGroupForAdministrator");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyAccessGroupForAdministrator");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyAccessGroupForAdministrator", ".pyCaption");
	String pyTooltip="";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyTooltip","pyAccessGroupForAdministrator\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("pyAccessGroupForAdministrator", ".pyTooltip");
	}
	pyTooltip = "pyAccessGroupForAdministrator";
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyAccessGroupForAdministrator",pxUniqueStreamHash+"_47");
	...
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_47");
	modePage1.put("clintValidAttrs",clientValidationAttributes);
	modePage1.put("pyID","pyAccessGroupForAdministrator");
	...
	if(listProperties.containsKey(".pyAccessGroup")){
	Set<String> currentPropFieldNames = (Set<String>)listProperties.get(".pyAccessGroup");
	currentPropFieldNames.add("pyCaption");
	listProperties.put(".pyAccessGroup",currentPropFieldNames);
	}else{
	Set<String> fieldNames = new HashSet<String>();
	fieldNames.add("pyCaption");
	listProperties.put(".pyAccessGroup",fieldNames);
	}
	if(listProperties.containsKey(".pyAccessGroup")){
	Set<String> currentPropFieldNames = (Set<String>)listProperties.get(".pyAccessGroup");
	listProperties.put(".pyAccessGroup",currentPropFieldNames);
	...
	modePage1.put("pyResultsUniqueID",pxUniqueStreamHash+"_48");
	tools.putParamValue("AppName", 
	tools.getProperty(".pyProductName").getStringValue()
	);
	tools.putParamValue("AppVersion", 
	tools.getProperty(".pyProductVersion").getStringValue()
	);
	tools.putParamValue("PortalName", 
	"Developer"
	);
	Map<String, String> sourceDPParams = new HashMap<String, String>();
	sourceDPParams.put("AppName", ".pyProductName");
	sourceDPParams.put("AppVersion", ".pyProductVersion");
	sourceDPParams.put("PortalName", "Developer");
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
	tools.findPage("D_pzAccessGroupsByApplicationWithPortal");
	}
	tools.putParamValue("bListOptionsLocalize","true");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadDataPage("D_pzAccessGroupsByApplicationWithPortal", listProperties, pxUniqueStreamHash+"_48", sourceDPParams);
	...
	pyDataPageParams.put("pyName","AppName");
	pyDataPageParams.put("pyValue","#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyProductName")+"~#");
	pyDataPage.addMetadataInArray("pyDataPageParams",pyDataPageParams);
	pyDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();  
	pyDataPageParams.put("pyName","AppVersion");
	pyDataPageParams.put("pyValue","#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyProductVersion")+"~#");
	pyDataPage.addMetadataInArray("pyDataPageParams",pyDataPageParams);
	pyDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();  
	pyDataPageParams.put("pyName","PortalName");
	pyDataPageParams.put("pyValue","Developer");
	pyDataPage.addMetadataInArray("pyDataPageParams",pyDataPageParams);
	pyListDataSource.putMetadata("pyDataPage",pyDataPage);
	modePage1.putMetadata("pyListDataSource",pyListDataSource);
	String pageName = "D_pzAccessGroupsByApplicationWithPortal";
	String dataPageName = "D_pzAccessGroupsByApplicationWithPortal";
	if(tools.findPage("D_pzAccessGroupsByApplicationWithPortal") != null){
	pageName = tools.findPage("D_pzAccessGroupsByApplicationWithPortal").getReference();
	}
	modePage1.put("pySourceName",dataPageName);
	modePage1.put("pyHashedDataPage",pageName);
	pageName = "D_pzAccessGroupsByApplicationWithPortal";
	cellPage.put("pyCellId","166");
	...
	try{
		if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){ 
			...
			changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyProductName", -1);
			changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyProductVersion", -1);
		}
		 ...
		 expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("cellRefreshWhen",  ".pyProductName Changes || .pyProductVersion Changes", expressionId);
	...
	modePage1.put("pyValue",".pyAccessGroup");
	modePage1.put("pyPrompt",".pyAccessGroup");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen("pzHasNoAccessGroupWithDeveloperPortal",pxUniqueStreamHash+"_50");
	...
	pxWhenIdentifiers.put("pyDisabledWhenId",pxUniqueStreamHash+"_50");
	pxWhenIdentifiers.put("pyDisabledWhenName","pzHasNoAccessGroupWithDeveloperPortal");
	...
	modePage2.put("pySourceName","D_pzAccessGroupsByApplicationWithPortal");
	modePage2.put("pyPrompt",".pyAccessGroup");
	modePage2.put("pyValue",".pyAccessGroup");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("201608301747140614213349",true));
	String pyValueR = "";
	String pyValueOrig = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyAccessGroupForAdministrator");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyAccessGroupForAdministrator", ".pyCaption");
	pyValueR = ".pyAccessGroupForAdministrator";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyAccessGroupForAdministrator");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyAccessGroupForAdministrator", ".pyCaption");
	pyValueOrig = ".pyAccessGroupForAdministrator";
	...
	String disabled_ctrl = "";
		...
		if(com.pega.pegarules.jsptags.WhenTag.evaluateWhen(pega, "pzHasNoAccessGroupWithDeveloperPortal", null, false))
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_53");}if(beginNonTemplate){			HashStringMap params = new HashStringMap();
			tools.putParamValue("AppName", 
			tools.getProperty(".pyProductName").getStringValue()
			);
			tools.putParamValue("AppVersion", 
	...
	pageName = tools.getStepPage().getName()+pageName;
			...
			tools.appendString("<div id='CT'  RCW = '.pyProductName,.pyProductVersion' RC = '.pyProductName Changes || .pyProductVersion Changes' CellId = '166");
	...
	if(tools.getThread().getName().indexOf("/$WorkProcessing") != -1 || tools.getThread().getName().indexOf("/$FlowModalProcess") != -1 ) {
			...
			try{
				if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
					...
					cellChangeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyProductName", -1);
					cellChangeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyProductVersion", -1);
				}
			}catch(Exception e){}
		...
		String strActiveValue = isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true);			String strValue = isSecuredProp ? activePropValue : tools.getProperty(ddPropRef).getStringValue();
			...
			if(!isAccessible) {
				...
				tools.appendString(" " + pzCell.getTestIdIfEnabled("201608301747140614213349") + " ");
...
tools.appendString(" data-bindprops='value' ");} else{			tools.appendString(ddPropEntryHandle);
		...
		tools.appendString("aria-describedby='"+dropdownName+"Error'");			tools.appendString(" ");
			...
			if(isAccessible) {
				...
				if("".equals(strValue) && cbpResults != null && cbpResults.size() > 0) {
					String pyValueProp = ".pyAccessGroup";
		...
		tools.appendString(tools.getLocalizedTextForString(".pyToolTip","pyAccessGroupForAdministrator",StreamBuilder.FMT_NORMAL));
		...
		if (cbpResults != null && cbpResults.size() > 0) {
			...
			while(resIter.hasNext()) {
				...
				displayString = cbpRow.getStringIfPresent(".pyAccessGroup");
				valueString = cbpRow.getStringIfPresent(".pyAccessGroup");
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("201608301747140614213349") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_54")){inclFormattedVal_4(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
if(pegaValidation != null) {
	...
	tools.putActive(propActivePrev); } catch (Exception e) {
	 ...
	 if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'&& pzAuto.getUIComponentRuntime().getRuntimeContextTree().isLiveDesignViewMode()){
		...
		IUIComponent ctrlComponent = pzAuto.getUIComponent();
		metadata.put("cellInfo", "Access group to add to the application creator&#39;s operator record");
...
public int simpleLayoutCell_9( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDropdown",".pyAccessGroupForAdministrator",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(6).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing   flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("201608301747140614213349-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	
	ClipboardProperty propActivePrev = tools.getActive();
	tools.putActive(tools.getStepPage().getProperty(".pyAccessGroupForAdministrator"));
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Access group to add to the application creator\'s operator record") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("201608301747140614213349-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Access group to add to the application creator\'s operator record") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");pxDropdown_1(".pyAccessGroupForAdministrator",0,"","","Text");
...
public int simpleLayoutTemplateCell_9( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201608301747140614213349-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDropdown");
	pgCells.put("forLabel",".pyAccessGroupForAdministrator");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDropdown",".pyAccessGroupForAdministrator",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(6).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDropdown_1(".pyAccessGroupForAdministrator",0,"","","Text");labelName = "Access group to add to the application creator's operator record";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_10( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpzHasNoAccessGroupWithDeveloperPortal","pzHasNoAccessGroupWithDeveloperPortal","cell", "visible" )) {
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(6).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","helper_text_dataLabelRead","helper_text_dataLabelWrite")  + " ");
	...
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("20160929120704011864691")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","No Developer AG Available") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_10( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","remove-bottom-spacing remove-right-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20160929120704011864691")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzHasNoAccessGroupWithDeveloperPortal",pxUniqueStreamHash+"_58");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_58");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzHasNoAccessGroupWithDeveloperPortal");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzHasNoAccessGroupWithDeveloperPortal", pxUniqueStreamHash+"_58"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(6).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	}
	...
	labelName = "No Developer AG Available";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzApplicationWizardBBBBBBB","",true);
}
public void LayoutWrapperTableStart_2() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(6).pySections(1)'}") + " class='layout layout-outline layout-outline-combo_group' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpzApplicationWizardBBBBBBB";
...
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","New application access");
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel4155' data-layout-id='202602211403210779" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel4155'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzApplicationWizardBBBBBBB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_3() {
	...
	String paramName = "EXPANDEDSubSectionpzApplicationWizardBBBBBBB";
	metadataPage.put("paramName", paramName);
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(6).pySections(1)'}");
	if(!inspectorLayoutData.isEmpty()) {
	metadataPage.put("liveUI", inspectorLayoutData);
	}
	String pyPrefix = null;
	metadataPage.put("prefix","-combo_group");
	metadataPage.put("sectionIndex","160");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
...
tools.putParamValue("isControlEditableOriginal", true);
	...
	String repeatIndx = "";
	IUIComponentMetadata pyUserData = pzAuto.getUIComponentRuntime().createMetadata();
	cellPage.put("pyValue",".pxObjClass");
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	cellPage.put("pyID","pxObjClass");
	modePage2.put("pyContent","associated");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2016041312503508373856",true));
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pxObjClass");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pxObjClass", ".pyCaption");
...
boolean bUITemplatized = pzAuto.getUIComponentRuntime().isTemplateRendering();pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);
	tools.appendString("<input  type=\"hidden\"  " + pzCell.getTestIdIfEnabled("2016041312503508373856") + "  id=\"");
		tools.appendString(tools.getHTMLIDForProperty(true,"hidden"));
tools.appendString("\" value=\"");if(bUITemplatized){
	tools.appendString(pzAuto.getUIComponentRuntime().getRuntimeContextTree().generateContextToken("pxObjClass"));}else {
...
public void field_pzGetLocalizedValue_4() { 
try {
...
_jspx_th_pega_reference__4.setName(".pyAppTemplateDescription");
_jspx_th_pega_reference__4.setMode("display");
_jspx_th_pega_reference__4.setFormat("pzGetLocalizedValue");
...
public void field_pzGetLocalizedValue_3() { 
try {
...
_jspx_th_pega_reference__3.setName(".pyAppTemplateDescription");
_jspx_th_pega_reference__3.setMode("display");
_jspx_th_pega_reference__3.setFormat("pzGetLocalizedValue");
...
public int simpleLayoutCell_6( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzGetLocalizedValue",".pyAppTemplateDescription",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing remove-bottom-spacing remove-right-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_34")) {	field_pzGetLocalizedValue_3();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2016072710233201724698-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzGetLocalizedValue");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pzGetLocalizedValue",".pyAppTemplateDescription",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_37")) {	field_pzGetLocalizedValue_4();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzApplicationWizardBBBBBB","",false);
}
...
public void simpleLayout_2() {
	...
	refreshAttributes +="\""; 
	refreshAttributes += " RWP=\".pyAppTemplateDescription\" RW=\".pyAppTemplateDescription Changes\" ";
	...
	try{
		if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
			com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyAppTemplateDescription"), -1);
		}
	}catch(Exception e){}
	IUIComponent cc_dl = null;
	boolean bIsIe = (pzAuto.getBrowserUtils().isIE());
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		try{
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  ".pyAppTemplateDescription Changes", expressionId);
		...
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("format","default");
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1)'}") + "").append("\"").toString();
		if(!inspectorData.equals("\"\"")) {
		pg_dlmeta.put("liveUI",inspectorData);
		}
		pg_dlmeta.put("isDLChild","true");
	...
	String expressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
	expressionId = pxUniqueStreamHash+"_38";
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen", ".pyAppTemplateDescription != \'\'", expressionId);
	expressionId = expression.getId();
	String expressionId_BV = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression_BV = null;
	if(!StringUtils.isBlank(expressionId)) {
	...
	String paramName = "EXPANDEDSubSectionpzApplicationWizardBBBBBB";
	metadataPage.put("paramName", paramName);
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1)'}");
	if(!inspectorLayoutData.isEmpty()) {
	metadataPage.put("liveUI", inspectorLayoutData);
	}
	String pyPrefix = null;
	metadataPage.put("sectionIndex","156");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyAppTemplateDescription\"  SHOW_WHEN=\".pyAppTemplateDescription != ''\"");
if(pzAuto.evaluateWhen(".pyAppTemplateDescription != ''",null,true)){
	if(currentTemplatingStatus =='N')
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyAppTemplateDescription", -1);
	}
}catch(Exception e){}
}
/**
...
if (_jspx_meth_pega_param__1(pageContext, "OtherKeyValuePairs", "pyFieldName=\'pyCaption\' pyFieldValue=\'[pyAppTemplateDescription]\'")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "DisableInputBox", "0")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "AdditionalParams", "pyFieldName=pyCaption")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "NoOpenRule", "0")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "ApplyTo", "pxObjClass")) {
	return true;
}
...
tools.putSaveValue("attributes", " PN =.pyAppTemplateDescription ONCHANGE= \"handleClientEvent(\'POSTCELL\', \'\',\'\' ");
...
public void field_pzGetLocalizedValue_2() { 
try {
...
_jspx_th_pega_reference__2.setName(".pyAppTemplateLabel");
_jspx_th_pega_reference__2.setMode("display");
_jspx_th_pega_reference__2.setFormat("pzGetLocalizedValue");
...
public void field_pzGetLocalizedValue_1() { 
try {
...
_jspx_th_pega_reference__1.setName(".pyAppTemplateLabel");
_jspx_th_pega_reference__1.setMode("display");
_jspx_th_pega_reference__1.setFormat("pzGetLocalizedValue");
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzGetLocalizedValue",".pyAppTemplateLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing remove-bottom-spacing remove-right-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_20")) {	field_pzGetLocalizedValue_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-top-spacing remove-left-spacing remove-bottom-spacing remove-right-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20160727100705079942436-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzGetLocalizedValue");
	pgCells.put("forLabel",".pyAppTemplateLabel");
	pgCells.put("pyAutoHTML","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	pgCells.put("pyReadOnlyWhenCond","readonlyAlways");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pzGetLocalizedValue",".pyAppTemplateLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_23")) {	field_pzGetLocalizedValue_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzApplicationWizardBBBBB","",false);
}
...
public void simpleLayout_1() {
	...
	refreshAttributes += strMethodName;
	refreshAttributes +="\""; 
	refreshAttributes += " RWP=\".pyAppTemplateLabel\" RW=\".pyAppTemplateLabel Changes\" ";
	...
	try{
		if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
			com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyAppTemplateLabel"), -1);
		}
	}catch(Exception e){}
	IUIComponent cc_dl = null;
	boolean bIsIe = (pzAuto.getBrowserUtils().isIE());
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  layout-content-inline content-inline " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		try{
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  ".pyAppTemplateLabel Changes", expressionId);
		expressionId = expression.getId();
		}
		catch(ClassCastException e){
		expressionId = "";
		...
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + "").append("\"").toString();
		if(!inspectorData.equals("\"\"")) {
		pg_dlmeta.put("liveUI",inspectorData);
		}
		pg_dlmeta.put("isDLChild","true");
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen", ".pyAppTemplateLabel != \'\'", expressionId);
	expressionId = expression.getId();
	String expressionId_BV = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression_BV = null;
	if(!StringUtils.isBlank(expressionId)) {
	...
	String paramName = "EXPANDEDSubSectionpzApplicationWizardBBBBB";
	metadataPage.put("paramName", paramName);
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}");
	if(!inspectorLayoutData.isEmpty()) {
	metadataPage.put("liveUI", inspectorLayoutData);
	}
	String pyPrefix = null;
	metadataPage.put("sectionIndex","152");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyAppTemplateLabel\"  SHOW_WHEN=\".pyAppTemplateLabel != ''\"");
if(pzAuto.evaluateWhen(".pyAppTemplateLabel != ''",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyAppTemplateLabel", -1);
	}
}catch(Exception e){}
}
/**
...
final Tag prevParentTag = mParentTag;
mParentTag = _jspx_th_pega_reference_;
if (_jspx_meth_pega_param__1(pageContext, "OtherKeyValuePairs", "pyFieldName=\'pyCaption\' pyFieldValue=\'[pyAppTemplateLabel]\'")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "DisableInputBox", "0")) {
	return true;
...
tools.putSaveValue("attributes", " PN =.pyAppTemplateLabel ONCHANGE= \"handleClientEvent(\'POSTCELL\', \'\',\'\' ");
pzAuto.putSaveValue("attributes", ", \'", IAutoStreamRuntime.SAVE_APPEND);
pzAuto.putSaveValue("attributes", "-1", IAutoStreamRuntime.SAVE_APPEND);
pzAuto.putSaveValue("attributes", "\', event)\"", IAutoStreamRuntime.SAVE_APPEND);
if (_jspx_meth_pega_param__2(pageContext, "pega_attributes", "$save(attributes)")) {
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyAppTemplateLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing   flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20160711143604023243345-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyAppTemplateLabel" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Short description") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20160711143604023243345-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyAppTemplateLabel" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Short description") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_14")) {field_OpenRuleAdvanced_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","remove-top-spacing remove-left-spacing flex");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20160711143604023243345-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyAppTemplateLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_17")) {	field_OpenRuleAdvanced_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "Short description";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_5( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyAppTemplateDescription",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + "   flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20160711143604023244133-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyAppTemplateDescription" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Application description") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20160711143604023244133-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyAppTemplateDescription" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Application description") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_28")) {field_OpenRuleAdvanced_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20160711143604023244133-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","OpenRuleAdvanced");
	pgCells.put("forLabel",".pyAppTemplateDescription");
	pgCells.put("pyAutoHTML","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyAppTemplateDescription",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_31")) {	field_OpenRuleAdvanced_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "Application description";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_8( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_1(".pxObjClass",0,"","","Identifier");
	return index;
}
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	String reqExpressionId = null;
	String disExpressionId = null;
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_2(".pxObjClass",0,"","","Identifier");
	index++;
	return index;
}
...
pzSection.getLayout().setExpandParam("SubSectionpzApplicationWizardBBBB","",false);
}
...
public void simpleLayout_4() {
	...
	String paramName = "EXPANDEDSubSectionpzApplicationWizardBBBB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("sectionIndex","149");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
...
pzSection.getLayout().setExpandParam("SubSectionpzApplicationWizardBBB","",false);
}
...
public void simpleLayout_6() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  layout-content-inline_grid_double content-inline_grid_double " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzApplicationWizardBBB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("sectionIndex","147");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
...
pzSection.getLayout().setExpandParam("SubSectionpzApplicationWizardBB","",false);
}
...
public void simpleLayout_7() {
	...
	String paramName = "EXPANDEDSubSectionpzApplicationWizardBB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("sectionIndex","145");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rx.pyUseGraph cttrue", pxUniqueStreamHash+"_80");metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2== rx.pyUseGraph cttrue",".pyUseGraph == true", "layout", "visible" )) {pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						pzPackageRuntime.packageSection("pzApplicationWizard",
						...
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzApplicationWizard"));
						staticURLStr.append("&PreDataTransform=pzSetDefaultAppTemplateTileImages");
						tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"\", \"");
						refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
						tools.appendString("=\", \"\", \"pzSetDefaultAppTemplateTileImages,");
						refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
						...
						if(!"".equals(preActParamStr.toString())) {
							...
							if(!"".equals(preDTParamStr.toString())) {
								...
								if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
								pzPackageRuntime.packageDataTransform(tools.getStepPage().getString("pxObjClass"), "pzSetDefaultAppTemplateTileImages");
								}
...
tools.appendString("</P>");
	...
	String repeatIndx = "";
	IUIComponentMetadata pyUserData = pzAuto.getUIComponentRuntime().createMetadata();
	pzAuto.getUIComponentRuntime().getExpressionEvaluator().addDefaultValue(".pyUseGraph",  "false");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20160726123556022949495",true));
	cellPage.put("pyValue",".pyUseGraph");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyUseGraph");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyUseGraph", ".pyCaption");
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyCaption","Application Template Selection\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Application Template Selection", ".pyCaption");
	}
	pyCheckboxCaption = "Application Template Selection";
	modePage1.put("pyCheckboxCaption",pyCheckboxCaption);
	cellPage.put("pyID","pyUseGraph");
	String clientValidationAttributes = pzAuto.getCell().getClientValidationAttributes(pyOnInput, pyEditValidate, pyStringType,pegaValidation.toString());
	modePage1.put("clintValidAttrs",clientValidationAttributes);
	modePage1.put("pyWrap","false");
	modePage1.put("pyCheckboxCaptionPosition","right");
	modePage1.put("styleOther","");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyUseGraph",pxUniqueStreamHash+"_6");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
...
pzStatic_pzCheckboxScripts.emitContent();
		...
		tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyUseGraph").getEntryHandle(),"entryHandle"));} else{
		tools.appendString(tools.getActive().getEntryHandle());}
		tools.appendString("' ");									tools.appendString(disabled_ctrl);

		tools.appendString(" />");
		String checkboxName = "";
		tools.appendString("<input type='checkbox'  " + pzCell.getTestIdIfEnabled("20160726123556022949495") + "  class='checkbox chkBxCtl"+errorClass+"' value='true' name='");if(bOptimizedMarkup){
		tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyUseGraph").getEntryHandle(),"entryHandle"));
		tools.appendString("' data-bindprops='value'");
		checkboxName = StringUtils.crossScriptingFilter(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyUseGraph").getEntryHandle(),"entryHandle"));} else{
		tools.appendString(tools.getActive().getEntryHandle());
		tools.appendString("'");
		...
		tools.appendString(propName.substring(propName.lastIndexOf(".")+1)+pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyUseGraph").getReference(),"",true)+"' ");} else{
		...
		tools.appendString(" />");
		tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20160726123556022949495-Label") + "  class=' cb_standard' for='");if(bOptimizedMarkup){
		tools.appendString(propName.substring(propName.lastIndexOf(".")+1)+pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyUseGraph").getReference(),"",true)+"' ");} else{
		tools.appendString(tools.getHTMLIDForProperty(true,"checkbox")+"' ");}
		tools.appendString("data-click='.' "); 
	tools.appendString("class='chkbxCaptionRight'>");
		tools.appendString(tools.getLocalizedTextForString(".pyCaption","Application Template Selection"));
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("20160726123556022949495") + " ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8")){inclFormattedVal_2(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20160726123556022949495-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxCheckbox");
	pgCells.put("forLabel",".pyUseGraph");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxCheckbox",".pyUseGraph",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxCheckbox_1(".pyUseGraph",0,"","","True-False");labelName = "Check Box";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_18( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyUseGraph cttrue",".pyUseGraph == true","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_18( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyUseGraph cttrue",pxUniqueStreamHash+"_82");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_82");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyUseGraph == true");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Application");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_82");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyUseGraph cttrue", pxUniqueStreamHash+"_82"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_10();
 tools.putSaveValue("ContainerID", "");}
...
pzSection.getLayout().setExpandParam("SubSectionpzApplicationWizardB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpzApplicationWizardB";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\">");
...
String l_sectionTitleFVMeta = "";
l_sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","New Application wizard settings");
String sectionImageTitle="";
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");


	/***-- Grid HeaderElements: Begin --**/
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel9893' data-layout-id='202602211403210731" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel9893'>" + l_sectionTitle + "</h2><nobr>");
pzHeaderCellContent_1();
tools.appendString("</nobr>");
boolean showContainerIcons=tools.getParamValue("showContainerIcons").equals("true")?true:false;
tools.appendString("<span class='header-element header-title-table'>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzApplicationWizardB","tdRightStyle");}
if(showContainerIcons){
tools.appendString("</tr></table>");
}
tools.appendString("</span>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div><div class='header-right'></div></div>");
...
public void simpleLayout_8() {
	...
	String paramName = "EXPANDEDSubSectionpzApplicationWizardB";
	metadataPage.put("paramName", paramName);
...
static {
	oPropDefinitions_1.put("Rule-Application.pyAppTemplateDescription", new LiteweightPropertyDefinition("Rule-Application", "pyAppTemplateDescription", "sTN", false, true, "pxTextInput", false));
	oPropDefinitions_1.put("Rule-Application.pyAppTemplateLabel", new LiteweightPropertyDefinition("Rule-Application", "pyAppTemplateLabel", "sTN", false, true, "pxTextInput", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-APPLICATION PZAPPLICATIONWIZARD #20180713T141804.545 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzApplicationWizard");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-APPLICATION PZAPPLICATIONWIZARD #20180713T141804.545 GMT", "Rule-Application pzApplicationWizard", "Pega-AppDefinition", "08-01-01", "20180713T141804.545 GMT");
}
