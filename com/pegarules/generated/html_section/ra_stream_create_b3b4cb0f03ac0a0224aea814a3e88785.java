 ...
 */
public class ra_stream_create_b3b4cb0f03ac0a0224aea814a3e88785 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.Create.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -663211954;
 ...
 */
	public ra_stream_create_b3b4cb0f03ac0a0224aea814a3e88785(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "5aff5560416c6fb0edd7c3eec008b9b0c4cfb0a2";
...
{
/* Instance RULE-HTML-SECTION WORK- CREATE #20210212T202033.340 GMT	Pega-EndUserUI:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "5aff5560416c6fb0edd7c3eec008b9b0c4cfb0a2";
...
/*
 * Begin RULE-HTML-SECTION WORK- CREATE #20210212T202033.340 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- CREATE #20210212T202033.340 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- CREATE #20210212T202033.340 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("CREATE","Rule-HTML-Section","WORK-",false,"","Pega-EndUserUI","08-06-01","RULE-HTML-SECTION WORK- CREATE #20210212T202033.340 GMT","!CREATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-663211954), 
...
//	RULE-HTML-SECTION WORK- CREATE #20210212T202033.340 GMT:20210218T184423.963 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "e3bf6479ed5e2318784cd426bf1deab6";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("Create",1,"Rule-HTML-Section","{'type':'Section','ruleName':'Create','insKey':'RULE-HTML-SECTION WORK- CREATE #20210212T202033.340 GMT','templated':'true','editable':'true','sectionType':'standard'}");
pzLayout_1();
...
public void pxTextInput_1() {String key="15604224-f17b-4781-ba0d-05c878d6550e||RULE-HTML-SECTION WORK- CREATE #20210212T202033.340 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","64","","","Text","true","15604224-f17b-4781-ba0d-05c878d6550e"};oCellRuntimeParamsMap.put("15604224-f17b-4781-ba0d-05c878d6550e||RULE-HTML-SECTION WORK- CREATE #20210212T202033.340 GMT",paramValues);oControlPathsMap.put("15604224-f17b-4781-ba0d-05c878d6550e||RULE-HTML-SECTION WORK- CREATE #20210212T202033.340 GMT",".pyRegions(1).pyCells(1)||.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- CREATE #20210212T202033.340 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- CREATE #20210212T202033.340 GMT", "Work- Create", "Pega-EndUserUI", "08-06-01", "20210218T184423.963 GMT");
}
