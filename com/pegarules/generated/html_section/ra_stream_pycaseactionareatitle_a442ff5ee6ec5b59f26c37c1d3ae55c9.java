...
/**
 * Builds JSP stream WORK-!PYCASEACTIONAREATITLE.
 */
public class ra_stream_pycaseactionareatitle_a442ff5ee6ec5b59f26c37c1d3ae55c9 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyCaseActionAreaTitle.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1842597084;
 ...
 */
	public ra_stream_pycaseactionareatitle_a442ff5ee6ec5b59f26c37c1d3ae55c9(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "6c6daa27a307f73583fdf10dad7672ea9c755a59";
...
{
/* Instance RULE-HTML-SECTION WORK- PYCASEACTIONAREATITLE #20210506T204028.243 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "6c6daa27a307f73583fdf10dad7672ea9c755a59";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyCaseActionAreaTitle",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- PYCASEACTIONAREATITLE #20210506T204028.243 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PYCASEACTIONAREATITLE #20210506T204028.243 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PYCASEACTIONAREATITLE #20210506T204028.243 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYCASEACTIONAREATITLE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCASEACTIONAREATITLE","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION WORK- PYCASEACTIONAREATITLE #20210506T204028.243 GMT","!PYCASEACTIONAREATITLE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1842597084), 
...
//	RULE-HTML-SECTION WORK- PYCASEACTIONAREATITLE #20210506T204028.243 GMT:20230324T060753.918 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "3636eb07c6b7df50898abf0b637682ba";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyCaseActionAreaTitle",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyCaseActionAreaTitle','insKey':'RULE-HTML-SECTION WORK- PYCASEACTIONAREATITLE #20210506T204028.243 GMT','sectionType':'standard'}");
pzLayout_3();
...
public void field_pzActionHelp_2() { 
try {
...
_jspx_th_pega_reference__2.setFormat("pzActionHelp");
...
public void field_pzActionHelp_1() { 
try {
...
_jspx_th_pega_reference__1.setFormat("pzActionHelp");
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyCaseActionAreaTitleBBB"));
...
metadataPage.put("uniqueid", "202602230450190006");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("202207141357010826784") + " ");
...
pzSection.getLayout().setExpandParam("SubSectionpyCaseActionAreaTitleBBB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpyCaseActionAreaTitleBBB";
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel3325' data-layout-id='202602230450180996" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel3325'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyCaseActionAreaTitleBBB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202207141357010826784") + " ");
	...
	String paramName = "EXPANDEDSubSectionpyCaseActionAreaTitleBBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2|| o2|| o2== rxnewAssignPage.pyDefaultTaskStatus cqActionStubDraftMode o2== rxnewAssignPage.pxFlowName rxnewAssignPage.pyCurrentActionLabel o2== rxnewAssignPage.pyCurrentActionLabel cq", pxUniqueStreamHash+"_8");metadataPage.put("dlChild","true");
...
if(pzAuto.handleEvaluateWhen(" o2|| o2|| o2== rxnewAssignPage.pyDefaultTaskStatus cqActionStubDraftMode o2== rxnewAssignPage.pxFlowName rxnewAssignPage.pyCurrentActionLabel o2== rxnewAssignPage.pyCurrentActionLabel cq","newAssignPage.pyDefaultTaskStatus == \'ActionStubDraftMode\' || newAssignPage.pxFlowName == newAssignPage.pyCurrentActionLabel || newAssignPage.pyCurrentActionLabel == \'\'", "layout", "visible" )) {pzSetExpandParam_3();
...
IUIComponentMetadata metadataPage = pzAuto.getUIComponentRuntime().createMetadata();
IUIComponent headerComponent = pzAuto.getUIComponent();
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyCaseActionAreaTitleBB"));
metadataPage.put("titleType","Property");
String sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
if(!"".equals(sectionTitleFVMeta)){
metadataPage.put("fieldValueMeta",sectionTitleFVMeta);
...
metadataPage.put("uniqueid", "202602230450180993");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("2022071414001008351000") + " ");
headerComponent.beginComponent("pxLayoutHeader",metadataPage);
headerComponent.endComponent();
}
...
pzSection.getLayout().setExpandParam("SubSectionpyCaseActionAreaTitleBB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpyCaseActionAreaTitleBB";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\">");
...
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");
	...
	/***-- Grid HeaderElements: Begin --**/
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel7905' data-layout-id='202602230450180984" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel7905'>" + l_sectionTitle + "</h2><nobr>");
pzHeaderCellContent_1();
tools.appendString("</nobr>");
boolean showContainerIcons=tools.getParamValue("showContainerIcons").equals("true")?true:false;
tools.appendString("<span class='header-element header-title-table'>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyCaseActionAreaTitleBB","tdRightStyle");}
if(showContainerIcons){
tools.appendString("</tr></table>");
}
tools.appendString("</span>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div><div class='header-right'></div></div>");
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("2022071414001008351000") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString(" class='" + "flex  content  layout-content-inline_middle content-inline_middle " + "'  " + "role='heading' tabindex='-1' ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpyCaseActionAreaTitleBB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2&& o2!= rxnewAssignPage.pyDefaultTaskStatus cqActionStubDraftMode o2!= rxnewAssignPage.pxFlowName rxnewAssignPage.pyCurrentActionLabel o2!= rxnewAssignPage.pyCurrentActionLabel cq", pxUniqueStreamHash+"_4");metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2&& o2!= rxnewAssignPage.pyDefaultTaskStatus cqActionStubDraftMode o2!= rxnewAssignPage.pxFlowName rxnewAssignPage.pyCurrentActionLabel o2!= rxnewAssignPage.pyCurrentActionLabel cq",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","newAssignPage.pyDefaultTaskStatus != 'ActionStubDraftMode' && newAssignPage.pxFlowName != newAssignPage.pyCurrentActionLabel && newAssignPage.pyCurrentActionLabel != ''");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2&& o2!= rxnewAssignPage.pyDefaultTaskStatus cqActionStubDraftMode o2!= rxnewAssignPage.pxFlowName rxnewAssignPage.pyCurrentActionLabel o2!= rxnewAssignPage.pyCurrentActionLabel cq", pxUniqueStreamHash+"_6"); 
	}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2|| o2|| o2== rxnewAssignPage.pyDefaultTaskStatus cqActionStubDraftMode o2== rxnewAssignPage.pxFlowName rxnewAssignPage.pyCurrentActionLabel o2== rxnewAssignPage.pyCurrentActionLabel cq",pxUniqueStreamHash+"_10");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2|| o2|| o2== rxnewAssignPage.pyDefaultTaskStatus cqActionStubDraftMode o2== rxnewAssignPage.pxFlowName rxnewAssignPage.pyCurrentActionLabel o2== rxnewAssignPage.pyCurrentActionLabel cq", pxUniqueStreamHash+"_10"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_2();
 tools.putSaveValue("ContainerID", "");}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015060216291103408287-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzActionHelp");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pzActionHelp",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_14")) {	field_pzActionHelp_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpyCaseActionAreaTitleB","",false);
}
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle focus-heading" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","focus-heading");
		pg_dlmeta.put("format","inline_middle");
	...
	String paramName = "EXPANDEDSubSectionpyCaseActionAreaTitleB";
...
static {
	oPropDefinitions_1.put("OFON2J-ProcessO-Work-Onboarding.pyTemplateInputBox", new LiteweightPropertyDefinition("OFON2J-ProcessO-Work-Onboarding", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- PYCASEACTIONAREATITLE #20210506T204028.243 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyCaseActionAreaTitle");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PYCASEACTIONAREATITLE #20210506T204028.243 GMT", "Work- pyCaseActionAreaTitle", "Theme-Cosmos", "04-01-01", "20230324T060753.918 GMT");
}
