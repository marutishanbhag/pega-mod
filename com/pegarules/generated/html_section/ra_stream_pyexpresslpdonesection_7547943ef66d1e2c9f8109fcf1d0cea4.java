...
/**
 * Builds JSP stream PEGA-EXT-EXPEXPLORER-CASE!PYEXPRESSLPDONESECTION.
 */
public class ra_stream_pyexpresslpdonesection_7547943ef66d1e2c9f8109fcf1d0cea4 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyExpressLPDoneSection.Pega_Ext_ExpExplorer_Case.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 869235166;
 ...
 */
	public ra_stream_pyexpresslpdonesection_7547943ef66d1e2c9f8109fcf1d0cea4(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "37752240afb0408aea6a8a44d0ea4606debfb614";
...
{
/* Instance RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-CASE PYEXPRESSLPDONESECTION #20191118T143106.253 GMT	Pega-EndUserUI:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "37752240afb0408aea6a8a44d0ea4606debfb614";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyExpressLPDoneSection",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-CASE PYEXPRESSLPDONESECTION #20191118T143106.253 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-CASE PYEXPRESSLPDONESECTION #20191118T143106.253 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-CASE PYEXPRESSLPDONESECTION #20191118T143106.253 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYEXPRESSLPDONESECTION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYEXPRESSLPDONESECTION","Rule-HTML-Section","PEGA-EXT-EXPEXPLORER-CASE",false,"","Pega-EndUserUI","08-04-01","RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-CASE PYEXPRESSLPDONESECTION #20191118T143106.253 GMT","!PYEXPRESSLPDONESECTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",869235166)
	};
...
//	RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-CASE PYEXPRESSLPDONESECTION #20191118T143106.253 GMT:20191118T143106.253 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "e2fa85c8c95cb9437610cf2f0b9b95fd";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyExpressLPDoneSection",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyExpressLPDoneSection','insKey':'RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-CASE PYEXPRESSLPDONESECTION #20191118T143106.253 GMT','sectionType':'standard'}");
pzLayout_2();
...
public void buildSection_2() { 
	...
	secParams.put("Context","Header");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzCreatNewCaseType", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	tools.putParamValue("Context","Header");tools.putParamValue("section_params","");
...
pzSection.getLayout().setExpandParam("SubSectionCellpyExpressLPDoneSection423","",false);
}
...
public void buildSection_1() { 
	...
	secParams.put("Context","Header");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzCreatNewCaseType", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzCreatNewCaseType",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzCanCreateWorkTypesForExplorer",pxUniqueStreamHash+"_5");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzCanCreateWorkTypesForExplorer", pxUniqueStreamHash+"_5"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzCreatNewCaseType",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpyExpressLPDoneSectionB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201911040452280366977") + " ");
	...
	String paramName = "EXPANDEDSubSectionpyExpressLPDoneSectionB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-CASE PYEXPRESSLPDONESECTION #20191118T143106.253 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyExpressLPDoneSection");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-CASE PYEXPRESSLPDONESECTION #20191118T143106.253 GMT", "Pega-Ext-ExpExplorer-Case pyExpressLPDoneSection", "Pega-EndUserUI", "08-04-01", "20191118T143106.253 GMT");
}
