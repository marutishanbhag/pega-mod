 ...
 */
public class ra_stream_pzeditdefinition_57158b6af00b15aca824cd8e4c232b42 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzEditDefinition.Rule_Obj_Model.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 622243010;
 ...
 */
	public ra_stream_pzeditdefinition_57158b6af00b15aca824cd8e4c232b42(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "18566f76f24cd012fbec83d7103b78258e84c88e";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-MODEL PZEDITDEFINITION #20230618T001712.755 GMT	Pega-SystemArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "18566f76f24cd012fbec83d7103b78258e84c88e";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzEditDefinition",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-MODEL PZEDITDEFINITION #20230618T001712.755 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-MODEL PZEDITDEFINITION #20230618T001712.755 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-MODEL PZEDITDEFINITION #20230618T001712.755 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZEDITDEFINITION", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZEDITDEFINITION","Rule-HTML-Section","RULE-OBJ-MODEL",false,"","Pega-SystemArchitect","08-23-01","RULE-HTML-SECTION RULE-OBJ-MODEL PZEDITDEFINITION #20230618T001712.755 GMT","!PZEDITDEFINITION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",622243010), 
...
//	RULE-HTML-SECTION RULE-OBJ-MODEL PZEDITDEFINITION #20230618T001712.755 GMT:20230618T001712.755 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "8278255cef66b9d720a8d2cf1495c29e";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzEditDefinition",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzEditDefinition','insKey':'RULE-HTML-SECTION RULE-OBJ-MODEL PZEDITDEFINITION #20230618T001712.755 GMT','templated':'true','editable':'true','sectionType':'standard'}");
pzLayout_4();
...
metadataPage.put("pyInspectorData",pzCell.getInspectorDataDynamic("pxLink","",".pyRegions(1).pyHeaderCells(1)"));
metadataPage.put("pyWrap","true");
metadataPage.put("pyRenderedStyle",pzSection.getCustomStyle(false, "", "", ""));
boolean pyVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxpzIsPegaExpress wxpxUserHasDeveloperPortalAccess", pxUniqueStreamHash+"_18");
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzEditDefinitionB"));
...
String sectionTitle = "pyEditDataTransform";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("pyEditDataTransform", "pyCaption");
...
String labelName = "pyEditDataTransform";
if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() !='N' ){
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addChangeTrackProperty(".pyLabel");
try{
...
com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_fieldValParam = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
	ct_fieldValParam.trackValueChanges(tools.getProperty(".pyLabel"), -1);
}}catch(Exception e){}
}
if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() !='N' ){
labelName = "pyEditDataTransform"+"\t"+"^~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyLabel")+"~^";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
}else{
tools.appendString(tools.getLocalizedTextForString(".pyCaption","pyEditDataTransform"+"\t"+tools.getProperty(".pyLabel").getStringValue()));
}
metadataPage.put("title", labelName);
metadataPage.put("uniqueid", "202602230418340615");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("201808120943310957798") + " ");
...
public void buildSection_6() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_17","pzIncludes", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzEditDefinition997","",false);
}
...
public void buildSection_5() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_14","pzIncludes", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzEditDefinition548","",false);
}
...
public void buildSection_3() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_10","pzDefinition", secInfo);
}
...
public void buildSection_2() { 
	...
	secInfo.put("packageSectionClass", "Rule-Obj-Model");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_9","RuleFormHeaderMessages", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	"RuleFormHeaderMessages", tools.getStepPage().getReference(),"Rule-Obj-Model");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	tools.putParamValue("section_params","");
	...
	String sectionName = "RuleFormHeaderMessages"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpzEditDefinition842","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("packageSection", true);
	secInfo.put("packageSectionClass", "Rule-Obj-Model");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_5","RuleFormHeaderMessages", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","RuleFormHeaderMessages",".pyRegions(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","min-height-0","min-height-0")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","RuleFormHeaderMessages",".pyRegions(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
		...
		tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzDefinition",".pyRegions(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
		String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_2( int index) {
		...
		boolean isOffline = false;
		cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
		String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzDefinition",".pyRegions(1).pyCells(2)");
		if(!inspectorData.isEmpty()) {
		pgCells.put("liveUI",inspectorData);
		}
		String tempRenderSingle = "";
...
public int simpleLayoutCell_3( int index) {
		...
		String baseRef ="";
		generateClientWhenDiv_2();
		tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzIncludes",".pyRegions(1).pyCells(3)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","min-height-0","min-height-0")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
		String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_3( int index) {
		...
		boolean isOffline = false;
		cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
		String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzIncludes",".pyRegions(1).pyCells(3)");
		if(!inspectorData.isEmpty()) {
		pgCells.put("liveUI",inspectorData);
		}
		String tempRenderSingle = "";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.wks.openRule(\\\"Developer\\\",\\\"Rule-Obj-Model\\\",");
	String strPropReference23 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyModelName")+"~#";
	...
	tools.appendString(",\\\"true\\\")\"]");
		...
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.wks.openRule(\\\"Developer\\\",\\\"Rule-Obj-Model\\\",");
	String strPropReference43 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyModelName")+"~#";
...
try {
	...
	modePage2.put("pyName","pzEditDefinition_$CTX$_aa443d32-15ba-42fc-b88f-1c427fa325d5");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","pyOpenDataTransformInDevStudio\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("pyOpenDataTransformInDevStudio", ".pyActionPrompt");
	}
	pyTooltip = "pyOpenDataTransformInDevStudio";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","pyOpenDataTransformInDevStudio\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("pyOpenDataTransformInDevStudio", ".pyButtonLabel");
	}
	pyLabel = "pyOpenDataTransformInDevStudio";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzEditDefinition_"+ referenceString+ "_aa443d32-15ba-42fc-b88f-1c427fa325d5'";
	...
	tools.appendString(",\\\"true\\\")\"]");
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","pyOpenDataTransformInDevStudio\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","pyOpenDataTransformInDevStudio",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
pzSection.getLayout().setExpandParam("SubSectionpzEditDefinitionB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)','region':'A'}") + " class='layout layout-outline layout-outline-default' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpzEditDefinitionB";
...
labelName = tools.getLocalizedTextForString(".pyCaption","pyEditDataTransform"+"\t"+tools.getProperty(".pyLabel").getStringValue());
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel8328' data-layout-id='202602230418340598" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel8328'>" + l_sectionTitle + "</h2>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzEditDefinitionB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString(" class='" + "flex  content  layout-content-stacked content-stacked content-items-maxwidth" + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzEditDefinitionB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-MODEL PZEDITDEFINITION #20230618T001712.755 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-MODEL PZEDITDEFINITION #20230618T001712.755 GMT", "Rule-Obj-Model pzEditDefinition", "Pega-SystemArchitect", "08-23-01", "20230618T001712.755 GMT");
}
