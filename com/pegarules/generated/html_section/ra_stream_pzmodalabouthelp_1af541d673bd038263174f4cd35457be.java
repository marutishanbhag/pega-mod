...
/**
 * Builds JSP stream @BASECLASS!PZMODALABOUTHELP.
 */
public class ra_stream_pzmodalabouthelp_1af541d673bd038263174f4cd35457be extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzModalAboutHelp.Data_Portal_DesignerStudio.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -477066774;
 ...
 */
	public ra_stream_pzmodalabouthelp_1af541d673bd038263174f4cd35457be(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "5635bd10e4d3f38b53e6298bf575004a9ac5851a";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZMODALABOUTHELP #20180713T133247.967 GMT	Pega-UIEngine:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "5635bd10e4d3f38b53e6298bf575004a9ac5851a";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzModalAboutHelp",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZMODALABOUTHELP #20180713T133247.967 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZMODALABOUTHELP #20180713T133247.967 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZMODALABOUTHELP #20180713T133247.967 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZMODALABOUTHELP", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZMODALABOUTHELP","Rule-HTML-Section","@BASECLASS",false,"","Pega-UIEngine","08-01-01","RULE-HTML-SECTION @BASECLASS PZMODALABOUTHELP #20180713T133247.967 GMT","!PZMODALABOUTHELP",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-477066774), 
...
//	RULE-HTML-SECTION @BASECLASS PZMODALABOUTHELP #20180713T133247.967 GMT:20180713T133247.967 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "06fecd79583299d85af3d456981d84be";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzModalAboutHelp",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzModalAboutHelp','insKey':'RULE-HTML-SECTION @BASECLASS PZMODALABOUTHELP #20180713T133247.967 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzModalAction", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzModalAction";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_2() {
pzSection.getLayout().setExpandParam("SubSectionpzModalAboutHelpBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzModalAboutHelpBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzModalAction'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzModalAction'}") + ">");
}
pzSetExpandParam_2();
...
try {
	...
	cellPage.put("pyStreamName","pzModalAboutHelp");
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Close this item\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Close this item", ".pyActionPrompt");
	}
	pyTooltip = "Close this item";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20171102134233070416549") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzModalAboutHelp_"+ referenceString+ "_1'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Close this item\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20171102134233070416549") + "  href='"+hrefValue+"' ");
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20171102134233070416549-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzModalAboutHelpB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzModalAboutHelpB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZMODALABOUTHELP #20180713T133247.967 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzModalAboutHelp");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZMODALABOUTHELP #20180713T133247.967 GMT", "@baseclass pzModalAboutHelp", "Pega-UIEngine", "08-01-01", "20180713T133247.967 GMT");
}
