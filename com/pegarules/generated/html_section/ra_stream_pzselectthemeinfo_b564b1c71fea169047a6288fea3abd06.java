...
/**
 * Builds JSP stream RULE-APPLICATION!PZSELECTTHEMEINFO.
 */
public class ra_stream_pzselectthemeinfo_b564b1c71fea169047a6288fea3abd06 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSelectThemeInfo.Rule_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 2012400214;
 ...
 */
	public ra_stream_pzselectthemeinfo_b564b1c71fea169047a6288fea3abd06(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "b2dbc43311c4e7a1423145acb817d6d9ca860fbc";
...
{
/* Instance RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT	Pega-ProcessArchitect:08-08-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "b2dbc43311c4e7a1423145acb817d6d9ca860fbc";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSelectThemeInfo",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT
 * Set up context.
 */
final String prevRuleKey_2 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT";final String prevClass_2 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-HTML-Section:PZSELECTTHEMEINFO", 
	"Rule-Obj-Property:PYLABEL", 
	"Rule-Obj-Property:PYTEMPLATEINPUTBOX", 
	"Rule-Obj-Property:PYAPPTEMPLATEDESCRIPTION", 
	"Rule-HTML-Property:PXBUTTON", 
	"Rule-HTML-Property:PXTHEMEIMAGE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSELECTTHEMEINFO","Rule-HTML-Section","RULE-APPLICATION",false,"","Pega-ProcessArchitect","08-08-01","RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT","!PZSELECTTHEMEINFO",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",2012400214), 
		...
		new DependentRuleInfo("PYAPPTEMPLATEDESCRIPTION","Rule-Obj-Property","RULE-APPLICATION",true,"Rule-Application","Pega-RulesEngine","08-01-01","RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATEDESCRIPTION #20180713T132557.478 GMT","!PYAPPTEMPLATEDESCRIPTION",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		...
		new DependentRuleInfo("PXTHEMEIMAGE","Rule-HTML-Property","",false,"","Pega-ProcessArchitect","08-07-01","RULE-HTML-PROPERTY PXTHEMEIMAGE #20210413T203307.325 GMT","PXTHEMEIMAGE",true,false,"ABSOLUTE_CLASSLESS",335158427)
	};
...
//	RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT:20220603T162213.930 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYLABEL #20180713T131156.327 GMT:20180713T131156.327 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYAPPTEMPLATEDESCRIPTION #20180713T132557.478 GMT:20180713T132557.478 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT:20180713T133539.879 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT:20180713T133539.879 GMT
//	RULE-HTML-PROPERTY PXTHEMEIMAGE #20210413T203307.325 GMT:20210413T203307.325 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "de5ae407c1e5d455b77503a677f36471";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSelectThemeInfo",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSelectThemeInfo','insKey':'RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT','sectionType':'standard'}");
pzLayout_2();
...
config.put("pyPreDataTransform.pyName", "pzSelectApplicationTemplate");
config.put("pyActivity", "pxPerformNavigationAction");
config.put("StaticActivityParams", "Direction=next");
...
tools.appendString("<div class='layout layout-noheader layout-noheader-learn_more has-action '>");
 String clsScroll= "";tools.appendString("<div section_index='1' class='" + clsScroll + " layout-body clearfix'>");
tools.putParamValue("LAYOUT_METHOD_NAME","simpleLayout_1");simpleLayout_1();
tools.appendString("</div></div>");
tools.putSaveValue("rowClass","");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202104051524510501385") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzSelectThemeInfo_$CTX$_6");
		String repeatIndx = "";
	String pyTooltip = "";
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Select\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Select", ".pyButtonLabel");
	}
	pyLabel = "Select";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzSelectThemeInfo_"+ referenceString+ "_6'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202104051524510501385") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Select".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		tools.appendString("<span class='pzbtn-label'  ");}if(bOptimizedMarkup && hasLineBreaks){
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Select",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutCell_4( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202104051524510501385-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzSelectThemeInfoBB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202104051525510080172") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1)'}") + " class='" + "flex  content  pointer  layout-content-stacked content-stacked centered" + "'  ");
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }			{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
				com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
					...
					refreshActionRequest.registerFixedParameter("StreamList", "pzAppConfigContent|Rule-HTML-Section|:");
					staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
					staticURLStr.append("&PreActivity=pxPerformNavigationAction");
					staticURLStr.append("&PreDataTransform=pzSelectApplicationTemplate");
					tools.appendString("[\"refresh\", [\"otherSection\",\"pzAppConfigContent\", \"pxPerformNavigationAction\", \"");
					refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
					preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"Direction\":\"next\"");
					refreshActionRequestD.registerFixedParameter("Direction","next");
					tools.appendString("\", \"\", \"pzSelectApplicationTemplate,");
					refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
					tools.appendString("selectedAppName=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyProductName")+"~#");					refreshActionRequestD.registerFixedParameter("selectedAppName",".pyProductName");
					tools.appendString("&selectedAppVersion=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyProductVersion")+"~#");					refreshActionRequestD.registerFixedParameter("selectedAppVersion",".pyProductVersion");
					tools.appendString("&selectedAppLabel=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyLabel")+"~#");					refreshActionRequestD.registerFixedParameter("selectedAppLabel",".pyLabel");
					tools.appendString("&selectedAppDescription=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyAppTemplateDescription")+"~#");					refreshActionRequestD.registerFixedParameter("selectedAppDescription",".pyAppTemplateDescription");
					tools.appendString("&selectedAppIcon=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyAppTemplateDescriptionImage")+"~#");					refreshActionRequestD.registerFixedParameter("selectedAppIcon",".pyAppTemplateDescriptionImage");
					tools.appendString("&selectedAppDesktopImage=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyAppTemplateLabelImage")+"~#");					refreshActionRequestD.registerFixedParameter("selectedAppDesktopImage",".pyAppTemplateLabelImage");
					tools.appendString("&selectedAppBadgeImage=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyAppTemplateBadgeImage")+"~#");					refreshActionRequestD.registerFixedParameter("selectedAppBadgeImage",".pyAppTemplateBadgeImage");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty(".pyProductName"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyProductVersion"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyLabel"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyAppTemplateDescription"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyAppTemplateDescriptionImage"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyAppTemplateLabelImage"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyAppTemplateBadgeImage"), -1);
		}}catch(Exception e){}							}
						...
						String paramName = "EXPANDEDSubSectionpzSelectThemeInfoBB";
						...
						metadataPage.put("prefix","-learn_more");
...
public void field_pxThemeImage_2() { 
...
params_2.putString("ImageURL", pega.getValue(".pyAppTemplateLabelImage"));
...
params_2.putString("bLocalize", "true");
	...
	if (currentProperty_2 != null && currentProperty_2.getParentPage().getClassName().equals("Rule-Application")) {
		...
		final PRStackFrame stack_2 = ((PegaAPI) tools).pushStackFrame( params_2, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pxThemeImage" );
		try {
...
property_Rule_Application_pxThemeImage();
			}
		} finally {
...
if (_jspx_meth_pega_reference__1(pageContext, ".pyTemplateInputBox", "input", "pxThemeImage")) {
	return;
}
	}} catch(Throwable t) {
...
if (_jspx_meth_pega_param__1(pageContext, "ImageURL", ".pyAppTemplateLabelImage")) {
	return true;
}
...
if (_jspx_meth_pega_contentURL__1(pageContext, "Param.ImageURL", "/applicationimages/", "Image", "false")) {
	return;
}
tools.appendString("\" />");
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-PROPERTY PXTHEMEIMAGE #20210413T203307.325 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pxThemeImage");
	oStreamProperties_1.put("pyRuleSetVersion", "08-07-01");
}
/**
 * Generates stream property_Rule_Application_pxThemeImage
 */
private void property_Rule_Application_pxThemeImage() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
/* Instance RULE-HTML-PROPERTY PXTHEMEIMAGE #20210413T203307.325 GMT	Pega-ProcessArchitect:08-07-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-PROPERTY PXTHEMEIMAGE #20210413T203307.325 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-PROPERTY PXTHEMEIMAGE #20210413T203307.325 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-PROPERTY PXTHEMEIMAGE #20210413T203307.325 GMT */
}
}


public void field_pxThemeImage_1() { 
String mode1 = getActionsForCustomControls_1();
tools.putSaveValue("mode1Action",mode1);
String mode2 = getActionsForCustomControls_1();
tools.putSaveValue("mode2Action",mode2);
...
params_1.putString("ImageURL", pega.getValue(".pyAppTemplateLabelImage"));
...
params_1.putString("bLocalize", "true");
	...
	if (currentProperty_1 != null && currentProperty_1.getParentPage().getClassName().equals("Rule-Application")) {
		...
		final PRStackFrame stack_1 = ((PegaAPI) tools).pushStackFrame( params_1, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pxThemeImage" );
		try {
...
public void pxDisplayText_2() {String key="2||RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","2"};oCellRuntimeParamsMap.put("2||RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT",paramValues);oControlPathsMap.put("2||RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
...
public void pxDisplayText_1() {String key="1||RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","64","","","Text","true","1"};oCellRuntimeParamsMap.put("1||RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT",paramValues);oControlPathsMap.put("1||RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
public int simpleLayoutCell_1( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= rx.pyLabel cq",".pyLabel!=\'\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   centered dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202104051524210281801-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pyLabel cq",pxUniqueStreamHash+"_4");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_4");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyLabel!=''");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pyLabel cq", pxUniqueStreamHash+"_4"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_1();}
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= rx.pyAppTemplateDescription cq",".pyAppTemplateDescription!=\'\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyAppTemplateDescription",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "   margin-b-1x dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202104051524340201787-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel",".pyAppTemplateDescription");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired _iconRequired");
	pgCells.put("labelReadClass","dataLabelForRead _dataLabelForRead");
	pgCells.put("labelWriteClass","dataLabelForWrite _dataLabelForWrite");
	pgCells.put("customROStyles","margin-b-1x");
	pgCells.put("customRWStyles","margin-b-1x");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	pgCells.put("pyReadOnlyWhenCond","readonlyAlways");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pyAppTemplateDescription cq",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyAppTemplateDescription!=''");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Application");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_6");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pyAppTemplateDescription cq", pxUniqueStreamHash+"_6"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyAppTemplateDescription",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_2();}
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxThemeImage",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_7")) {	field_pxThemeImage_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20160511122329000419452-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxThemeImage");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","false");
	pgCells.put("pyGenerateUniqueIdForLabel","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxThemeImage",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_10")) {	field_pxThemeImage_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzSelectThemeInfoB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202104051525430772694") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  pointer has-action layout-content-default content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			...
			ct_controlAction.trackValueChanges(tools.getProperty(".pyAppTemplateBadgeImage"), -1);
						...
						String paramName = "EXPANDEDSubSectionpzSelectThemeInfoB";
...
static {
	oPropDefinitions_2.put("Rule-Application.pyTemplateInputBox", new LiteweightPropertyDefinition("Rule-Application", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_2.put("pyClassName", "Rule-Application");
	oStreamProperties_2.put("pyCircumstanceProp", "");
	oStreamProperties_2.put("pzInsKey", "RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT");
	...
	oStreamProperties_2.put("pyStreamName", "pzSelectThemeInfo");
	oStreamProperties_2.put("pyRuleSetVersion", "08-08-01");
}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-APPLICATION PZSELECTTHEMEINFO #20211203T171502.747 GMT", "Rule-Application pzSelectThemeInfo", "Pega-ProcessArchitect", "08-08-01", "20220603T162213.930 GMT");
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_1 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY PXTHEMEIMAGE #20210413T203307.325 GMT", "pxThemeImage", "Pega-ProcessArchitect", "08-07-01", "20210413T203307.325 GMT");
}
