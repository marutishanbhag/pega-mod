...
/**
 * Builds JSP stream RULE-!PXRULEFORMSYSTEMVARIABLES.
 */
public class ra_stream_pxruleformsystemvariables_fd5e8c40a264e94e0795e99ef537ecaf extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pxRuleFormSystemVariables.Rule_Obj_Activity.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1954707241;
 ...
 */
	public ra_stream_pxruleformsystemvariables_fd5e8c40a264e94e0795e99ef537ecaf(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "be7d8acd2f30015835cc3dc055278111bcd6322";
...
{
/* Instance RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "be7d8acd2f30015835cc3dc055278111bcd6322";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pxRuleFormSystemVariables",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PXRULEFORMSYSTEMVARIABLES", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXRULEFORMSYSTEMVARIABLES","Rule-HTML-Section","RULE-",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT","!PXRULEFORMSYSTEMVARIABLES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1954707241), 
...
//	RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT:20180713T135257.710 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "0788e318d7617d5063d1e53a3f8d8b77";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pxRuleFormSystemVariables",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pxRuleFormSystemVariables','insKey':'RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT','sectionType':'standard'}");
...
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2015102217055104959551") + "  ");
...
String rlIndex=tools.getParamValueCSF("pega_RLindex");
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20151022170551049494939") + "  ");
if(!labelForAttribute.equals("")){tools.appendString(" for='" + labelForAttribute + rlIndex + "' ");
}String labelForError="";if(!propertyName.equals("")){try { labelForError = pzSection.getCell().getLabelForError(pageName,propertyName);}catch(Exception e) {} }tools.appendString(labelForError);
if(!accessKey.equals("")){tools.appendString(accessKey);
}else if(bRuntimeAccesskey){String aKey = pega_uiengine_harness.pzGetAKey(".pyCaption",labelValue,pega_procom_harness.IsParam(labelValue) );tools.appendString(aKey);
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("","",".pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "height:28px;width:12px;",false,"","");tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","ACTION");	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:28px;width:186px;",false,"","");tools.appendString("<nobr>");
	labelIncludeInCell_1("","","","",false,"",false,false,"Standard",false);
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(3)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:28px;width:186px;",false,"","");tools.appendString("<nobr>");
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "",".pySystemParameters","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","0","","","Text","false","23"};oCellRuntimeParamsMap.put("23||RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT",paramValues);oControlPathsMap.put("23||RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(3)");}
static{String[] paramValues = new String[]{"text", "pxTextInput", "",".pySystemParameters","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","0","","","Text","false","22"};oCellRuntimeParamsMap.put("22||RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT",paramValues);oControlPathsMap.put("22||RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)");}
static{String[] paramValues = new String[]{"text", "pxTextInput", "",".pySystemParameters","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","0","","pzValidParameterPageName","Text","false","21"};oCellRuntimeParamsMap.put("21||RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT",paramValues);oControlPathsMap.put("21||RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)");}
public void repeatingHeaderCell_3() {
	...
	String strFieldValue = "";
		...
		tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='DataType' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20151022170551048983265") + " ");
		...
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpySystemParameters1colWidthCache3").equals("")){ tools.appendParamCSF("PpySystemParameters1colWidthCache3"); } else { tools.appendString("192"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									...
									tools.appendString("style='height:29px;'"); } 
									tools.appendString(">"); } 
									...
									tools.appendString("DataType");if(!pzAuto.getBrowserUtils().isIE()){
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20151022170551048682206") + " ");
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpySystemParameters1colWidthCache2").equals("")){ tools.appendParamCSF("PpySystemParameters1colWidthCache2"); } else { tools.appendString("192"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:29px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont '");tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("Description");if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<span style='position:absolute; top:0px; right: 0px;'>&nbsp;</span>"); } if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20151022170551048581436") + " ");
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpySystemParameters1colWidthCache1").equals("")){ tools.appendParamCSF("PpySystemParameters1colWidthCache1"); } else { tools.appendString("192"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:29px;'"); } 
									tools.appendString(">"); } 
...
pzSection.getLayout().setExpandParam("SubSectionpxRuleFormSystemVariablesB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpxRuleFormSystemVariablesB";
...
l_sectionTitle="System-supplied parameters";
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel4803' data-layout-id='202602230422410821" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel4803'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpxRuleFormSystemVariablesB","tdRightStyle");}
if(showContainerIcons){
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pySystemParametersL3=null;

 Map selUniqMap_pySystemParametersL3 = null;
tools.appendString("<div ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pySystemParameters");tools.appendString("_pxRuleFormSystemVariables_1'");
...
tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201702170132120418915") + " ");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pySystemParameters");

					}

					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList='.pyParametersParamName .pyParametersParamDesc .pyParametersParamType  ' class='yui-skin-sam gPXAuto");

					if(pega_uiengine_harness.pzInStandardsMode()) {tools.appendString(" floated ");

					}tools.appendString("' style='");

					if(!pega_uiengine_harness.pzInStandardsMode()) {tools.appendString("display:"); if(pzAuto.getBrowserUtils().isIE()) {  tools.appendString(" inline; "); } else {  tools.appendString("inline-block;"); } }tools.appendString("' gPropIndex='PpySystemParameters1' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201702170132120418915-layout") + " ");

					tools.appendString(" class='gridTable ");

					tools.appendString(pzSection.getRepeatStyle());String strSummary = "Parameters of this activity";
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' ><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpySystemParameters1colWidthGBL\" id=\"PpySystemParameters1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpySystemParameters1colWidthGBL"));tools.appendString("\" />");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpySystemParameters1colWidthGBR\" id=\"PpySystemParameters1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpySystemParameters1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpySystemParameters1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' style='width:");

					 if(!tools.getParamValue("PpySystemParameters1colWidthGBL").equals("")) { tools.appendParamCSF("PpySystemParameters1colWidthGBL"); } else { 

					tools.appendString("603.0"); } 

					tools.appendString("px;' cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='Parameters of this activity' PL_PROP='");

					
tools.appendString(".pySystemParameters");
					...
					tools.appendString("'>\n\t\t\t\t\t\t\t\t\t\t<tr class='cellCont' ><td class='cellCont rowHandleHead  ' style='height:31px;'>");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pySystemParameters").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pySystemParameters\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals(".pySystemParameters")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodes.pySystemParameters1") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 

					if (tempTestID != null && !tempTestID.isEmpty() && !tempTestID.equals("")){

					String strEntryHandlePLProp = "";

					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle(".pySystemParameters"); } catch (Exception ex) { }
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201702170132120418915-" + rowTestID) + " ");
					...
					tools.appendString("rowHandle  ' style='height:38px;'>");
					...
					tools.appendString("style='height:38px;'");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pySystemParameters1") && tools.getParamValue("partialRefresh").equals("false")) {
...
if(pzAuto.handleEvaluateWhen(" wxpzShowSystemParameters","pzShowSystemParameters", "layout", "visible" )) {pzSetExpandParam_1();
...
public void pxTextInput_3() {String key="23||RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT";
...
public void repeatingDataCell_3() {
	...
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxTextInput",".pyParametersParamType", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(3)")); tools.appendString("headers='a3'");
...
public void pxTextInput_2() {String key="22||RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","true");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxTextInput", assemblyParams);
...
public void repeatingDataCell_2() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxTextInput",".pyParametersParamDesc", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)")); tools.appendString("headers='a2'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:34px;'");}tools.appendString("class='");
	tools.appendString(" gridCell");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
...
public void pxTextInput_1() {String key="21||RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","true");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxTextInput", assemblyParams);
...
public void repeatingDataCell_1() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxTextInput",".pyParametersParamName", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
...
public void pySystemParameters_1() {
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pySystemParameters1")|| tools.getParamValue("partialTrigger").equals("editRow.pySystemParameters1") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pySystemParameters");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pySystemParameters\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pySystemParameters1")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty(".pySystemParameters");
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pySystemParameters1") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pxRuleFormSystemVariables");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE- PXRULEFORMSYSTEMVARIABLES #20180713T135257.710 GMT", "Rule- pxRuleFormSystemVariables", "Pega-Desktop", "08-01-01", "20180713T135257.710 GMT");
}
