...
/**
 * Builds JSP stream PEGA-FIELDS-SCALAR-PICKLIST!PZADVANCEDFIELDINFO.
 */
public class ra_stream_pzadvancedfieldinfo_6cfc960ea9b4a9c6cfd856b7615bde3e extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzAdvancedFieldInfo.Pega_Fields_Scalar_Picklist.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1149495964;
 ...
 */
	public ra_stream_pzadvancedfieldinfo_6cfc960ea9b4a9c6cfd856b7615bde3e(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "e25e84ff8ff0e6dcf02b3232441485c843fe655d";
...
{
/* Instance RULE-HTML-SECTION PEGA-FIELDS-SCALAR-PICKLIST PZADVANCEDFIELDINFO #20230618T001733.645 GMT	Pega-ProcessArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "e25e84ff8ff0e6dcf02b3232441485c843fe655d";
...
/*
 * Begin RULE-HTML-SECTION PEGA-FIELDS-SCALAR-PICKLIST PZADVANCEDFIELDINFO #20230618T001733.645 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-FIELDS-SCALAR-PICKLIST PZADVANCEDFIELDINFO #20230618T001733.645 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-FIELDS-SCALAR-PICKLIST PZADVANCEDFIELDINFO #20230618T001733.645 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZADVANCEDFIELDINFO","Rule-HTML-Section","PEGA-FIELDS-SCALAR-PICKLIST",false,"","Pega-ProcessArchitect","08-23-01","RULE-HTML-SECTION PEGA-FIELDS-SCALAR-PICKLIST PZADVANCEDFIELDINFO #20230618T001733.645 GMT","!PZADVANCEDFIELDINFO",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1149495964)
	};
...
//	RULE-HTML-SECTION PEGA-FIELDS-SCALAR-PICKLIST PZADVANCEDFIELDINFO #20230618T001733.645 GMT:20230618T001733.645 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "cc993eed4a0f4b94f8d9844a777bee3b";
	}

	public String getDefinitionAppliesToClass() {
		return "Pega-Fields-Scalar-Picklist";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzAdvancedFieldInfo",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzAdvancedFieldInfo','insKey':'RULE-HTML-SECTION PEGA-FIELDS-SCALAR-PICKLIST PZADVANCEDFIELDINFO #20230618T001733.645 GMT','sectionType':'standard'}");
pzLayout_2();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzConfigureExpectedSize", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzAdvancedFieldInfo695","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzConfigureExpectedSize", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzConfigureExpectedSize",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzConfigureExpectedSize",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202109221508380124439") + " ");
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Pega-Fields-Scalar-Picklist");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-FIELDS-SCALAR-PICKLIST PZADVANCEDFIELDINFO #20230618T001733.645 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-FIELDS-SCALAR-PICKLIST PZADVANCEDFIELDINFO #20230618T001733.645 GMT", "Pega-Fields-Scalar-Picklist pzAdvancedFieldInfo", "Pega-ProcessArchitect", "08-23-01", "20230618T001733.645 GMT");
}
