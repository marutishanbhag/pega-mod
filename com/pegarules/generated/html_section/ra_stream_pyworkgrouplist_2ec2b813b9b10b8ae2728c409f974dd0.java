...
/**
 * Builds JSP stream DATA-PORTAL!PYWORKGROUPLIST.
 */
public class ra_stream_pyworkgrouplist_2ec2b813b9b10b8ae2728c409f974dd0 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyWorkGroupList.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1929370358;
 ...
 */
	public ra_stream_pyworkgrouplist_2ec2b813b9b10b8ae2728c409f974dd0(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "ab61367af0ed61827c36acdc674bc735dc0ee4b1";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPLIST #20180713T134755.681 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "ab61367af0ed61827c36acdc674bc735dc0ee4b1";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyWorkGroupList",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPLIST #20180713T134755.681 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPLIST #20180713T134755.681 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPLIST #20180713T134755.681 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYWORKGROUPLIST"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYWORKGROUPLIST","Rule-HTML-Section","DATA-PORTAL",false,"","Pega-EndUserUI","08-01-01","RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPLIST #20180713T134755.681 GMT","!PYWORKGROUPLIST",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1929370358)
	};
...
//	RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPLIST #20180713T134755.681 GMT:20180713T134755.681 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "23bff3c50215f9ff6fbea63402d9aa5b";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyWorkGroupList",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyWorkGroupList','insKey':'RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPLIST #20180713T134755.681 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_4();
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyWorkGroupListBB"));
if("".equals(tools.getParamValue("EXPANDEDSubSectionpyWorkGroupListBB"))) {
metadataPage.put("expanded",true);
} else {
metadataPage.put("expanded",Boolean.parseBoolean(tools.getParamValue("EXPANDEDSubSectionpyWorkGroupListBB")));
}
...
String sectionTitle = "Work baskets";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Work baskets", "pyCaption");
...
metadataPage.put("uniqueid", "202602210109360372");
...
expandedSecId="EXPANDEDSubSectionpyWorkGroupListBB" + expandRLExprValue;
...
tools.appendString("<div section_index='2' id='EXPAND-INNERDIV' class='layout-body clearfix'  >");
} else {
tools.appendString("<div section_index='2' id='EXPAND-INNERDIV' class='layout-body clearfix'  style='display:none'  >");
...
public void buildSection_4() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_12","pyWorkGroupBaskets", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pyWorkGroupBaskets"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpyWorkGroupList877","",false);
}
...
public void buildSection_3() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_9","pyWorkGroupBaskets", secInfo);
}
...
public int simpleLayoutCell_2( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyWorkGroupBaskets",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-bottom-spacing remove-left-spacing remove-right-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("partialClass","remove-bottom-spacing remove-left-spacing remove-right-spacing");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyWorkGroupBaskets",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkGroupListBB","",true);
}
public void LayoutWrapperTableStart_2() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='layout layout-outline layout-outline-case_secondary_content' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpyWorkGroupListBB";
...
l_sectionTitle=StringUtils.escapeIntoJavaString(tools.getLocalizedTextForParameterizedString("pyCaption","Work baskets"));
...
pzLayout.createECImgForDivHeader(true,"Expanded", l_sectionTitle, false,false,true,"",false,true,"202602210109360368","aria-level=2");
} else {
 tools.putSaveValue("EXPAND_COLLAPSE" ,"");
pzLayout.createECImgForDivHeader(false,"Collapsed", l_sectionTitle, false,false,true,"",false,true,"202602210109360368","aria-level=2");
}
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyWorkGroupListBB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpyWorkGroupListBB";
	...
	metadataPage.put("prefix","-case_secondary_content");
...
IUIComponent headerComponent = pzAuto.getUIComponent();
metadataPage.put("headerType","COLLAPSIBLE");
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyWorkGroupListB"));
if("".equals(tools.getParamValue("EXPANDEDSubSectionpyWorkGroupListB"))) {
metadataPage.put("expanded",true);
} else {
metadataPage.put("expanded",Boolean.parseBoolean(tools.getParamValue("EXPANDEDSubSectionpyWorkGroupListB")));
}
metadataPage.put("titleType","Field Value");
String sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
if(!"".equals(sectionTitleFVMeta)){
...
String sectionTitle = "Team members";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Team members", "pyCaption");
metadataPage.put("title", sectionTitle);
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Click to expand", "pyActionPrompt");
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Click to collapse", "pyActionPrompt");
String inspectorFVData = pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData();
...
metadataPage.put("uniqueid", "202602210109360367");
metadataPage.put("automationId", "");
headerComponent.beginComponent("pxLayoutHeader",metadataPage);
headerComponent.endComponent();
}
...
String param_Index=tools.getParamValue("index");
	String expandedSecId="";
String expandRLExprValue=(bExpandRL?param_Index:"");
expandedSecId="EXPANDEDSubSectionpyWorkGroupListB" + expandRLExprValue;
tools.putSaveValue("expandParam", expandedSecId);
pega_rules_utilities.pzRegisterActivity(tools, "Show-Harness");
if(pzSection.getLayout().loadLayoutHeader()) {
...
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2015011209251601689582") + "  ");
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:22px;width:130px;",false,"","");labelIncludeInCell_1("","","","",false,"",true,false,"Standard",false);
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>");
...
public void buildSection_2() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pyWorkGroupMembers", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pyWorkGroupMembers"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpyWorkGroupList404","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pyWorkGroupMembers", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyWorkGroupMembers",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-bottom-spacing remove-left-spacing remove-right-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyWorkGroupMembers",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkGroupListB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='layout layout-outline layout-outline-case_secondary_content' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpyWorkGroupListB";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\">");
...
String l_sectionTitleFVMeta = "";
l_sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
l_sectionTitle=StringUtils.escapeIntoJavaString(tools.getLocalizedTextForParameterizedString("pyCaption","Team members"));
String sectionImageTitle="";
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");
...
if(pzSection.getLayout().loadLayoutHeader()) {
tools.putSaveValue("EXPAND_COLLAPSE" ,"Expanded");
pzLayout.createECImgForDivHeader(true,"Expanded", l_sectionTitle, false,false,true,"",false,true,"202602210109360363","aria-level=2");
} else {
 tools.putSaveValue("EXPAND_COLLAPSE" ,"");
pzLayout.createECImgForDivHeader(false,"Collapsed", l_sectionTitle, false,false,true,"",false,true,"202602210109360363","aria-level=2");
}
tools.appendString("<div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id=''>" + l_sectionTitle + "</h2><nobr>");
pzHeaderCellContent_1();
tools.appendString("</nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyWorkGroupListB","tdRightStyle");}
if(showContainerIcons){
tools.appendString("</tr></table>");
}
tools.appendString("</span>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div><div class='header-right'></div></div></div>");
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpyWorkGroupListB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPLIST #20180713T134755.681 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyWorkGroupList");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPLIST #20180713T134755.681 GMT", "Data-Portal pyWorkGroupList", "Pega-EndUserUI", "08-01-01", "20180713T134755.681 GMT");
}
