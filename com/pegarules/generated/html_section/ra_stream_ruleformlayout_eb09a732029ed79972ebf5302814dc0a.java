...
/**
 * Builds JSP stream RULE-ACCESS-ROLE-NAME!RULEFORMLAYOUT.
 */
public class ra_stream_ruleformlayout_eb09a732029ed79972ebf5302814dc0a extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.RuleFormLayout.Rule_Access_Role_Name.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 918960272;
 ...
 */
	public ra_stream_ruleformlayout_eb09a732029ed79972ebf5302814dc0a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "3d2a50f620b830bef3dea11bdd5187bce3c8441c";
...
{
/* Instance RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME RULEFORMLAYOUT #20180713T135235.382 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "3d2a50f620b830bef3dea11bdd5187bce3c8441c";
...
/*
 * Begin RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME RULEFORMLAYOUT #20180713T135235.382 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME RULEFORMLAYOUT #20180713T135235.382 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME RULEFORMLAYOUT #20180713T135235.382 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("RULEFORMLAYOUT","Rule-HTML-Section","RULE-ACCESS-ROLE-NAME",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME RULEFORMLAYOUT #20180713T135235.382 GMT","!RULEFORMLAYOUT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",918960272)
	};
...
//	RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME RULEFORMLAYOUT #20180713T135235.382 GMT:20180713T135235.382 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "49d889ea8001fa4312dee69878ac1a28";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("RuleFormLayout",1,"Rule-HTML-Section","{'type':'Section','ruleName':'RuleFormLayout','insKey':'RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME RULEFORMLAYOUT #20180713T135235.382 GMT','sectionType':'standard'}");
pzLayout_1();
...
public void buildSection_4() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","RuleFormHistory", secInfo);
}
...
tabGroupName="";
elementName="";
tools.appendString("<li role=\"tab\"  aria-label=\"History\" title=\"History\"  aria-selected=\"false\" tabindex=\"-1\" elementName='" + elementName + "' tabGroupName = '" + tabGroupName + "' section-incl-id='-wrapper' section_index='4' id='Tab3' sel_prefix='tab-li-t-ns'");
 if(tools.getParamValue("pyPegaDesignMode").equals("true")) {
...
String rptDynamicIdx = tools.getParamValueCSF("pega_RLindex");
tools.appendString("<span  data-layout-id=\"202602230257510526" + rptDynamicIdx + "\" title=\"" + l_tabtooltip + "\" id=\"TABANCHOR\" tabTitle=\"" + l_title + "\"><span id=\"TABSPAN\" class=\"textOut tab-span tab-span-t tab-span-t-ns \">");
pzHeaderBody_3();
...
public void buildSection_3() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzSpecifications", secInfo);
}
...
String l_sectionTitleFVMeta = "";
l_sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","Specifications");
tools.appendString("<span class=\"textMiddle\"><span data-stl= \"1\" class=\"textIn\" inAnchor>" + l_sectionTitle + "</span></span>");
}
...
tools.appendString("<li role=\"tab\"  aria-label=\"Specifications\" title=\"Specifications\"  aria-selected=\"false\" tabindex=\"-1\" elementName='" + elementName + "' tabGroupName = '" + tabGroupName + "' section-incl-id='-wrapper' section_index='3' id='Tab2' sel_prefix='tab-li-t-ns'");
 if(tools.getParamValue("pyPegaDesignMode").equals("true")) {
tools.appendString(" class=\"tab-li tab-li-t tab-li-t-ns unselected\" ");
}else{
tools.appendString(" class=\"tab-li tab-li-t tab-li-t-ns \" ");
...
String l_tabtooltip = tools.getLocalizedTextForString(".pyCaption", "");
String rptDynamicIdx = tools.getParamValueCSF("pega_RLindex");
tools.appendString("<span  data-layout-id=\"202602230257510510" + rptDynamicIdx + "\" title=\"" + l_tabtooltip + "\" id=\"TABANCHOR\" tabTitle=\"" + l_title + "\"><span id=\"TABSPAN\" class=\"textOut tab-span tab-span-t tab-span-t-ns \">");
pzHeaderBody_2();
tools.appendString("</span></span>");
tools.appendString("</li>");
}
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_5","Role", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "Role";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
...
String l_sectionTitleFVMeta = "";
l_sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","Role");
tools.appendString("<span class=\"textMiddle\"><span data-stl= \"1\" class=\"textIn\" inAnchor>" + l_sectionTitle + "</span></span>");
}
...
tabGroupName="";
elementName="";
tools.appendString("<li role=\"tab\"  aria-label=\"Role\" title=\"Role\"  aria-selected=\"true\" tabindex=\"0\" elementName='" + elementName + "' tabGroupName = '" + tabGroupName + "' section-incl-id='-wrapper' section_index='2' id='Tab1' sel_prefix='tab-li-t-ns'");
 if(tools.getParamValue("pyPegaDesignMode").equals("true")) {
...
String l_tabtooltip = tools.getLocalizedTextForString(".pyCaption", "");
String rptDynamicIdx = tools.getParamValueCSF("pega_RLindex");
tools.appendString("<span  data-layout-id=\"202602230257510500" + rptDynamicIdx + "\" title=\"" + l_tabtooltip + "\" id=\"TABANCHOR\" tabTitle=\"" + l_title + "\"><span id=\"TABSPAN\" class=\"textOut tab-span tab-span-t tab-span-t-ns \">");
pzHeaderBody_1();
tools.appendString("</span></span>");
tools.appendString("</li>");
}
...
groupHeaderEnd_1();
	...
	boolean isParentTemplate = "true".equals(pzAuto.getUIComponentRuntime().getRuntimeContextTree().getSaveValue("TAB_PARENT_TEMPLATE"));
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().saveValue("TAB_PARENT_TEMPLATE",null);
	if(isParentTemplate){pzAuto.getUIComponentRuntime().getRuntimeContextTree().saveValue("TAB_PARENT_TEMPLATE", "true");}pzLayoutBodyWrapper_2();if(isParentTemplate){pzAuto.getUIComponentRuntime().getRuntimeContextTree().saveValue("TAB_PARENT_TEMPLATE", "true");} if(pzAuto.handleEvaluateWhen(" wxpzIsLinkableRuleType","pzIsLinkableRuleType", "layout", "visible" )) {pzLayoutBodyWrapper_3();}if(isParentTemplate){pzAuto.getUIComponentRuntime().getRuntimeContextTree().saveValue("TAB_PARENT_TEMPLATE", "true");}pzLayoutBodyWrapper_4();
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME RULEFORMLAYOUT #20180713T135235.382 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME RULEFORMLAYOUT #20180713T135235.382 GMT", "Rule-Access-Role-Name RuleFormLayout", "Pega-Desktop", "08-01-01", "20180713T135235.382 GMT");
}
