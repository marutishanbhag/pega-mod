...
/**
 * Builds JSP stream RULE-RULESET-VERSION!PYGRIDMODALTEMPLATE.
 */
public class ra_stream_pygridmodaltemplate_51fab1671e14df93c115c60434204116 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyGridModalTemplate.Rule_RuleSet_Version.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1358731055;
 ...
 */
	public ra_stream_pygridmodaltemplate_51fab1671e14df93c115c60434204116(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "44d64d89f007d599a22b4ced53364c7c2f83c1e7";
...
{
/* Instance RULE-HTML-SECTION RULE-RULESET-VERSION PYGRIDMODALTEMPLATE #20180713T135658.620 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "44d64d89f007d599a22b4ced53364c7c2f83c1e7";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyGridModalTemplate",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-RULESET-VERSION PYGRIDMODALTEMPLATE #20180713T135658.620 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-RULESET-VERSION PYGRIDMODALTEMPLATE #20180713T135658.620 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-RULESET-VERSION PYGRIDMODALTEMPLATE #20180713T135658.620 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYGRIDMODALTEMPLATE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYGRIDMODALTEMPLATE","Rule-HTML-Section","RULE-RULESET-VERSION",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION RULE-RULESET-VERSION PYGRIDMODALTEMPLATE #20180713T135658.620 GMT","!PYGRIDMODALTEMPLATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1358731055), 
...
//	RULE-HTML-SECTION RULE-RULESET-VERSION PYGRIDMODALTEMPLATE #20180713T135658.620 GMT:20180713T135658.620 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "43e0ddfb6a4b415f74547caf61d9c62e";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyGridModalTemplate",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyGridModalTemplate','insKey':'RULE-HTML-SECTION RULE-RULESET-VERSION PYGRIDMODALTEMPLATE #20180713T135658.620 GMT','sectionType':'standard'}");
...
if (_jspx_meth_pega_param__1(pageContext, "OnClick", "pega.u.d.activeGrid.cancelModal(event)")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "Caption", "Cancel")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "Name", "CancelButton")) {
	return true;
}
...
if (_jspx_meth_pega_param__1(pageContext, "ImageOnly", "0")) {
	return true;
}
 ...
 */
if (_jspx_meth_pega_reference__2(pageContext, ".pyTemplateButton", "input", "Button")) {
	return;
}
} catch(Throwable t) {
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140919092257053418887-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","Button");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("Button",".pyTemplateButton",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_16")) {	field_Button_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyGridModalTemplateBBBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpyGridModalTemplateBBBB";
...
if (_jspx_meth_pega_param__1(pageContext, "OnClick", "pega.u.d.activeGrid.submitModal(event)")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "Caption", "Submit")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "Name", "SubmitButton")) {
	return true;
}
 ...
 * Cannot inline because: included stream is too big: 8145 bytes
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyTemplateButton", "input", "Button")) {
	return;
}
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
public int simpleLayoutCell_1( int index) {
	...
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")) {	field_Button_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("localize","false");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140919092257053315209-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","Button");
	pgCells.put("forLabel",".pyTemplateButton");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("Button",".pyTemplateButton",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_9")) {	field_Button_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	pgCells.put("pyLabelValue",labelName);
	String uiFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData();
	if(!"".equals(uiFieldValueMeta)){
	pgCells.put("stopFV",uiFieldValueMeta);
...
pzSection.getLayout().setExpandParam("SubSectionpyGridModalTemplateBBB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpyGridModalTemplateBBB";
	metadataPage.put("paramName", paramName);
...
pzSection.getLayout().setExpandParam("SubSectionpyGridModalTemplateBB","",false);
}
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + " content  auto-width-column layout-content-default content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpyGridModalTemplateBB";
	metadataPage.put("paramName", paramName);
...
sectionBodyIncludeInCell_1(false,false,"","pzModalAction");elementModel_1("pzModalAction","pyGridModalTemplate","BAR","");
 } 
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("SUB_SECTION","pzModalAction",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"   ColSpan=5 ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:50px;width:561px;",false,"","");sectionIncludeInCell_pzModalAction_1(); pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>");
 } 
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpyGridModalTemplateB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpyGridModalTemplateB";
...
static {
	oPropDefinitions_1.put("Rule-RuleSet-Version.pyTemplateButton", new LiteweightPropertyDefinition("Rule-RuleSet-Version", "pyTemplateButton", "sTN", false, true, "Button", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-RULESET-VERSION PYGRIDMODALTEMPLATE #20180713T135658.620 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyGridModalTemplate");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-RULESET-VERSION PYGRIDMODALTEMPLATE #20180713T135658.620 GMT", "Rule-RuleSet-Version pyGridModalTemplate", "Pega-SystemArchitect", "08-01-01", "20180713T135658.620 GMT");
}
