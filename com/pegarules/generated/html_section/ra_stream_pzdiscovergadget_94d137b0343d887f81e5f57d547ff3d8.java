...
/**
 * Builds JSP stream PEGA-DISCOVERLAYERCAKE!PZDISCOVERGADGET.
 */
public class ra_stream_pzdiscovergadget_94d137b0343d887f81e5f57d547ff3d8 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzDiscoverGadget.Pega_DiscoverLayerCake.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1512598770;
 ...
 */
	public ra_stream_pzdiscovergadget_94d137b0343d887f81e5f57d547ff3d8(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "928d4ebeef7a321578c1cf49a0d5efe56d82d042";
...
{
/* Instance RULE-HTML-SECTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGET #20230618T001741.377 GMT	Pega-ProcessArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "928d4ebeef7a321578c1cf49a0d5efe56d82d042";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzDiscoverGadget",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGET #20230618T001741.377 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGET #20230618T001741.377 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGET #20230618T001741.377 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZDISCOVERGADGET", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZDISCOVERGADGET","Rule-HTML-Section","PEGA-DISCOVERLAYERCAKE",false,"","Pega-ProcessArchitect","08-23-01","RULE-HTML-SECTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGET #20230618T001741.377 GMT","!PZDISCOVERGADGET",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1512598770), 
...
//	RULE-HTML-SECTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGET #20230618T001741.377 GMT:20230618T001741.377 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "800bcf1f80fe9bd9e6dbec70374574f9";
	}

	public String getDefinitionAppliesToClass() {
		return "Pega-DiscoverLayerCake";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzDiscoverGadget",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzDiscoverGadget','insKey':'RULE-HTML-SECTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGET #20230618T001741.377 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("NewTaskStatus", "pzDiscoverGadgetOverlay");
...
public void field_pzDiscoverGadget_Includes_2() { 
...
_jspx_th_pega_reference__2.setFormat("pzDiscoverGadget_Includes");
...
public void field_pzDiscoverGadget_Includes_1() { 
String mode1 = getActionsForCustomControls_1();
tools.putSaveValue("mode1Action",mode1);
String mode2 = getActionsForCustomControls_1();
tools.putSaveValue("mode2Action",mode2);
...
_jspx_th_pega_reference__1.setFormat("pzDiscoverGadget_Includes");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		keyMap.putString("pyActionName", "pzDiscoverGadgetOverlay");
		String strLAClassName = "";
		String offlineUsingPage = ".pzDiscoverGadgetPage";
		strLAClassName = "Pega-DiscoverLayerCake";
		...
		try{
		pzPackageRuntime.packageLocalAction("pzDiscoverGadgetOverlay", offlineUsingPage , strLAClassName);
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("pzDiscoverGadget",
				...
				String usingPage = ".pzDiscoverGadgetPage";
				if(("").equals(usingPage)) { usingPage = tools.getStepPage().getReference(); }
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pzDiscoverGadgetOverlay\",\"overlay\",\":event\",\".pzDiscoverGadgetPage\",\""+streamType+"\",\"pz-po-c-discover_gadget\",\"pzModalTemplate\",\"%7B%22isCustomMobileAnim%22%3A%22false%22%2C%22desktop%22%3A%7B%22reveal%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22anim-fade-open%22%2C%22speed%22%3A%22default%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
					} else {
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("202303071332230368562",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzDiscoverGadget_$CTX$_29");
		String repeatIndx = "";
	...
	modePage2.put("image","pi pi-layers");
	modePage2.put("actionImgPos","left");
	String customStyles = null;
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Discover\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Discover", ".pyButtonLabel");
	}
	pyLabel = "Discover";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzDiscoverGadget_"+ referenceString+ "_29'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("202303071332230368562") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString(" >");
		String classProp = "";
		 classProp ="pi pi-layers";
		tools.appendString("<i aria-hidden='true'  data-click='.' class='" + classProp + "'></i>");
		boolean hasLineBreaks = false;
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Discover",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","discover-gadget-launch","discover-gadget-launch")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202303071332230368562-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxLink");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","discover-gadget-launch");
	pgCells.put("customRWStyles","discover-gadget-launch");
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzDiscoverGadget_Includes",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","hidden","hidden")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_7")) {	field_pzDiscoverGadget_Includes_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-all-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2018101016290002076da447a6-290b-43fb-b3b0-46ab354ada6f678-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzDiscoverGadget_Includes");
	pgCells.put("forLabel",".pyTemplateInputBox");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pzDiscoverGadget_Includes",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_10")) {	field_pzDiscoverGadget_Includes_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzDiscoverGadgetB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzDiscoverGadgetB";
...
static {
	oPropDefinitions_1.put("Pega-DiscoverLayerCake.pyTemplateInputBox", new LiteweightPropertyDefinition("Pega-DiscoverLayerCake", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Pega-DiscoverLayerCake");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGET #20230618T001741.377 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzDiscoverGadget");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-DISCOVERLAYERCAKE PZDISCOVERGADGET #20230618T001741.377 GMT", "Pega-DiscoverLayerCake pzDiscoverGadget", "Pega-ProcessArchitect", "08-23-01", "20230618T001741.377 GMT");
}
