...
/**
 * Builds JSP stream EMBED-EXPLORERNODE-RULETYPE!PZRULESEXPLORERNODE.
 */
public class ra_stream_pzrulesexplorernode_ffdccbfbcd0d658256f000da30c1939d extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzRulesExplorerNode.Embed_ExplorerNode_RuleType.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -2108917683;
 ...
 */
	public ra_stream_pzrulesexplorernode_ffdccbfbcd0d658256f000da30c1939d(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "af68bed491b8dcccc6273a548b58732338c1a0af";
...
{
/* Instance RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZRULESEXPLORERNODE #20180713T135213.962 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "af68bed491b8dcccc6273a548b58732338c1a0af";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzRulesExplorerNode",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZRULESEXPLORERNODE #20180713T135213.962 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZRULESEXPLORERNODE #20180713T135213.962 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZRULESEXPLORERNODE #20180713T135213.962 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZRULESEXPLORERNODE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULESEXPLORERNODE","Rule-HTML-Section","EMBED-EXPLORERNODE-RULETYPE",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZRULESEXPLORERNODE #20180713T135213.962 GMT","!PZRULESEXPLORERNODE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2108917683), 
...
//	RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZRULESEXPLORERNODE #20180713T135213.962 GMT:20180713T135213.962 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "7f9b9fd1dde45e878d8dfb0fdd9558b0";
	}

	public String getDefinitionAppliesToClass() {
		return "Embed-ExplorerNode-Ruletype";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzRulesExplorerNode",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzRulesExplorerNode','insKey':'RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZRULESEXPLORERNODE #20180713T135213.962 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("pyFunctionName", "pega.desktop.showHarnessWrapperForNoRefresh");
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015082505545203631273",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzRulesExplorerNode_$CTX$_1");
		String repeatIndx = "";
	modePage2.put("styles","explorer_primary");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","View the instance list for this item\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("View the instance list for this item", ".pyActionPrompt");
	}
	pyTooltip = "View the instance list for this item";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzRulesExplorerNode_"+ referenceString+ "_1'";
	 ...
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015082505545203631273") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","View the instance list for this item\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.showHarnessWrapperForNoRefresh(\\\"newDocument\\\",");
	String strPropReference22 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyLabel")+"~#";
	...
	tools.appendString(",\\\"@baseclass\\\",\\\"pzViewInstances\\\",\\\"false\\\",\\\"\\\",\\\"pzLoadViewInstances\\\",");
	String strPropReference28 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyClassName")+"~#";
	String strFormattedPropReference28 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference28);
	if(strPropReference28.equals(strFormattedPropReference28)) {
	tools.appendString("\\\"");
	tools.appendFormatted(strFormattedPropReference28.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
	tools.appendString("\\\"");
	} else {
	tools.appendFormatted(strFormattedPropReference28.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
	}
	tools.appendString(",");
	String strPropReference29 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyClassName")+"~#";
	String strFormattedPropReference29 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference29);
	if(strPropReference29.equals(strFormattedPropReference29)) {
	tools.appendString("\\\"");
	tools.appendFormatted(strFormattedPropReference29.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
	tools.appendString("\\\"");
	} else {
	tools.appendFormatted(strFormattedPropReference29.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
	}
	tools.appendString(",\\\"forcerun\\\",\\\"true\\\",\\\"Instances\\\",\\\"\\\")\"]");
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015082505545203631273-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzRulesExplorerNodeB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  pointer  layout-content-simple_list content-simple_list " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzRulesExplorerNodeB";
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Embed-ExplorerNode-Ruletype");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZRULESEXPLORERNODE #20180713T135213.962 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzRulesExplorerNode");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZRULESEXPLORERNODE #20180713T135213.962 GMT", "Embed-ExplorerNode-Ruletype pzRulesExplorerNode", "Pega-Desktop", "08-01-01", "20180713T135213.962 GMT");
}
