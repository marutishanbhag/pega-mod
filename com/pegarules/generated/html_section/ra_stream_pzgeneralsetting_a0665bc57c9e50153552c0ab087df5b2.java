...
/**
 * Builds JSP stream RULE-OBJ-CLASS!PZGENERALSETTING.
 */
public class ra_stream_pzgeneralsetting_a0665bc57c9e50153552c0ab087df5b2 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzGeneralSetting.Rule_Obj_Class.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -155529262;
 ...
 */
	public ra_stream_pzgeneralsetting_a0665bc57c9e50153552c0ab087df5b2(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "87ab96bd15e66f1459cfa39909049909ee9a7630";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-CLASS PZGENERALSETTING #20180713T135657.759 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "87ab96bd15e66f1459cfa39909049909ee9a7630";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzGeneralSetting",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-CLASS PZGENERALSETTING #20180713T135657.759 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-CLASS PZGENERALSETTING #20180713T135657.759 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-CLASS PZGENERALSETTING #20180713T135657.759 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZGENERALSETTING", 
	"Rule-Obj-Property:PYINITIALVERSION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZGENERALSETTING","Rule-HTML-Section","RULE-OBJ-CLASS",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION RULE-OBJ-CLASS PZGENERALSETTING #20180713T135657.759 GMT","!PZGENERALSETTING",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-155529262), 
		new DependentRuleInfo("PYINITIALVERSION","Rule-Obj-Property","RULE-OBJ-CLASS",false,"","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYINITIALVERSION #20180713T131301.536 GMT","!PYINITIALVERSION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0)
	};
...
//	RULE-HTML-SECTION RULE-OBJ-CLASS PZGENERALSETTING #20180713T135657.759 GMT:20180713T135657.759 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYINITIALVERSION #20180713T131301.536 GMT:20180713T131301.536 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYINITIALVERSION #20180713T131301.536 GMT:20180713T131301.536 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYINITIALVERSION #20180713T131301.536 GMT:20180713T131301.536 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYINITIALVERSION #20180713T131301.536 GMT:20180713T131301.536 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "10bbe8da1193baef0775151dbe88cc4c";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzGeneralSetting",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzGeneralSetting','insKey':'RULE-HTML-SECTION RULE-OBJ-CLASS PZGENERALSETTING #20180713T135657.759 GMT','sectionType':'null'}");
pzLayout_1();
pzLayout_2();
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzGeneralSettingBB"));
...
metadataPage.put("uniqueid", "202602230259060751");
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzGeneralSettingConcrete", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzGeneralSettingConcrete";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
pzSection.getLayout().setExpandParam("SubSectionpzGeneralSettingBB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzGeneralSettingConcrete'}") + " class='layout layout-outline layout-outline-nested' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpzGeneralSettingBB";
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel7510' data-layout-id='202602230259060745" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzGeneralSettingBB","tdRightStyle");}
if(showContainerIcons){
...
String paramName = "EXPANDEDSubSectionpzGeneralSettingBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzGeneralSettingConcrete'}");
...
if (_jspx_meth_pega_param__1(pageContext, "CustomQuery", "&pyActivity=Rule-RuleSet-Version.LookupList&p1=pyRuleSetName&v1=[pySPRuleSetName]&pyObjClass=Rule-RuleSet-Version")) {
	return true;
}
...
if (_jspx_meth_pega_param__1(pageContext, "ApplyTo", "pySPRuleSetName")) {
	return true;
}
...
if (_jspx_meth_pega_param__1(pageContext, "Class", "Rule-RuleSet-Version")) {
	return true;
}
 ...
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyInitialVersion", "input", "OpenRuleAdvanced")) {
	return;
}
} catch(Throwable t) {
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyInitialVersion",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyInitialVersion" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString("Created in version</span>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString("Created in version</label>");
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("forLabel",".pyInitialVersion");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyInitialVersion",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")) {	field_OpenRuleAdvanced_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "Created in version";
...
pzSection.getLayout().setExpandParam("SubSectionpzGeneralSettingB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzGeneralSettingB";
	metadataPage.put("paramName", paramName);
...
static {
	oPropDefinitions_1.put("Rule-Obj-Class.pyInitialVersion", new LiteweightPropertyDefinition("Rule-Obj-Class", "pyInitialVersion", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-CLASS PZGENERALSETTING #20180713T135657.759 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzGeneralSetting");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-CLASS PZGENERALSETTING #20180713T135657.759 GMT", "Rule-Obj-Class pzGeneralSetting", "Pega-SystemArchitect", "08-01-01", "20180713T135657.759 GMT");
}
