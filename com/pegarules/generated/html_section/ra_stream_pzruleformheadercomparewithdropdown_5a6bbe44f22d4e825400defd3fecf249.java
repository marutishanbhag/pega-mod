...
/**
 * Builds JSP stream @BASECLASS!PZRULEFORMHEADERCOMPAREWITHDROPDOWN.
 */
public class ra_stream_pzruleformheadercomparewithdropdown_5a6bbe44f22d4e825400defd3fecf249 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzRuleFormHeaderCompareWithDropDown.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1473050994;
 ...
 */
	public ra_stream_pzruleformheadercomparewithdropdown_5a6bbe44f22d4e825400defd3fecf249(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "6e6afd9b844cd5451380f75cbb1832e29378a664";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZRULEFORMHEADERCOMPAREWITHDROPDOWN #20180713T135138.562 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "6e6afd9b844cd5451380f75cbb1832e29378a664";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzRuleFormHeaderCompareWithDropDown",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZRULEFORMHEADERCOMPAREWITHDROPDOWN #20180713T135138.562 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZRULEFORMHEADERCOMPAREWITHDROPDOWN #20180713T135138.562 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZRULEFORMHEADERCOMPAREWITHDROPDOWN #20180713T135138.562 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZRULEFORMHEADERCOMPAREWITHDROPDOWN", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMHEADERCOMPAREWITHDROPDOWN","Rule-HTML-Section","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION @BASECLASS PZRULEFORMHEADERCOMPAREWITHDROPDOWN #20180713T135138.562 GMT","!PZRULEFORMHEADERCOMPAREWITHDROPDOWN",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1473050994), 
...
//	RULE-HTML-SECTION @BASECLASS PZRULEFORMHEADERCOMPAREWITHDROPDOWN #20180713T135138.562 GMT:20180713T135138.562 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "91b242e1c2b159535a7cb31e18be9846";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzRuleFormHeaderCompareWithDropDown",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzRuleFormHeaderCompareWithDropDown','insKey':'RULE-HTML-SECTION @BASECLASS PZRULEFORMHEADERCOMPAREWITHDROPDOWN #20180713T135138.562 GMT','sectionType':'standard'}");
pzLayout_1();
...
config = new HashMap<String, String>();
config.put("navName", "pzRuleFormHeaderCompareWith");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			pzPackageRuntime.packageSection("pzRuleFormHeaderCompareWithDropDown",
			...
			tools.appendString("[\"showMenu\",[{\"dataSource\":\"pzRuleFormHeaderCompareWith\", \"isNavNLDeferLoaded\":\"false\", \"isNavTypeCustom\":\"false\", \"className\":\"" + tools.getStepPage().getClassName());
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1768206443032");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzRuleFormHeaderCompareWith", "", "pyNavigation1768206443032","", false, false, false, false);
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("Compare_With_Header_Menu") + " ");
	if(false || (pzAuto.isOffline() && true) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzRuleFormHeaderCompareWithDropDown_$CTX$_2");
		String repeatIndx = "";
	String pyTooltip = "";
	...
	String pyIconStyle = "";
	pyIconStyle = "pi pi-caret-down pi-right";
	modePage2.put("image",pyIconStyle);
	modePage2.put("pyActionImagePosition","right");
	String customStyles = null;
	String pyLabel = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyToolBarSettings.pyCompareVersion");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyToolBarSettings.pyCompareVersion", ".pyButtonLabel");
	pyLabel = ".pyToolBarSettings.pyCompareVersion";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzRuleFormHeaderCompareWithDropDown_"+ referenceString+ "_2'";
	 String securedPropValue = null;
	 com.pega.pegarules.pub.security.PropertySecurityInfo propSecInfo = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().getPropertyInfoForDisplay(tools.getStepPage(),tools.getProperty(".pyToolBarSettings.pyCompareVersion"), tools);
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		 securedPropValue = tools.getProperty(".pyToolBarSettings.pyCompareVersion").getStringValue();
	  }
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("Compare_With_Header_Menu") + "  data-ctl='Button'  type='button' role='button' aria-haspopup='true' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1768206443035");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzRuleFormHeaderCompareWith", "", "pyNavigation1768206443035","", false, false, false, false);
			}catch(Exception e){oLog.error(e);}
			}
			tools.appendString("\"},\":event\"]");
		...
		tools.appendString(StringUtils.filterRichText(pzAuto.getUIComponentRuntime().getRuntimeContextTree().getDataBindingToken(tools.getProperty(".pyToolBarSettings.pyCompareVersion").getReference())));} else { checkForScriptTags_1(tools.getLocalizedTextForString(".pyButtonLabel",securedPropValue,StreamBuilder.FMT_LITERAL)); }
		if(hasLineBreaks) {
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","heading_1_dataLabelRead","heading_1_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("With_Label") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead heading_1_dataLabelRead","dataLabelWrite heading_1_dataLabelWrite") + "' >");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","With:") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("With_Label")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("Compare_With_Header_Menu-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyToolBarSettings.pyCompareMode\"  SHOW_WHEN=\".pyToolBarSettings.pyCompareMode\"");
if(currentTemplatingStatus =='N')
tools.appendString(" data-simplelayout = \"true\" ");
else
clientWhenAttr += "data-simplelayout=true ";
if(pzAuto.evaluateWhen(".pyToolBarSettings.pyCompareMode",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
pzSection.getLayout().setExpandParam("SubSectionpzRuleFormHeaderCompareWithDropDownB","",false);
}
...
public void simpleLayout_1() {
	...
	refreshAttributes +="\""; 
	refreshAttributes += " RWP=\".pyToolBarSettings.pyCompareInsHandle\" RW=\".pyToolBarSettings.pyCompareInsHandle Changes\" ";
	...
	try{
		if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
			com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyToolBarSettings.pyCompareInsHandle"), -1);
		}
	}catch(Exception e){}
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  layout-content-inline_labels_left content-inline_labels_left " + "'  ");
		...
		try{
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  ".pyToolBarSettings.pyCompareInsHandle Changes", expressionId);
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen", ".pyToolBarSettings.pyCompareMode", expressionId);
	expressionId = expression.getId();
	...
	String paramName = "EXPANDEDSubSectionpzRuleFormHeaderCompareWithDropDownB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZRULEFORMHEADERCOMPAREWITHDROPDOWN #20180713T135138.562 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzRuleFormHeaderCompareWithDropDown");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZRULEFORMHEADERCOMPAREWITHDROPDOWN #20180713T135138.562 GMT", "@baseclass pzRuleFormHeaderCompareWithDropDown", "Pega-Desktop", "08-01-01", "20180713T135138.562 GMT");
}
