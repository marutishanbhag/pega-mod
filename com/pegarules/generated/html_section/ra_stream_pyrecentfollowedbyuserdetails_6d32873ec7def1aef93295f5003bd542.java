...
/**
 * Builds JSP stream DATA-ADMIN-OPERATOR-ID!PYRECENTFOLLOWEDBYUSERDETAILS.
 */
public class ra_stream_pyrecentfollowedbyuserdetails_6d32873ec7def1aef93295f5003bd542 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyRecentFollowedByUserDetails.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -368306970;
 ...
 */
	public ra_stream_pyrecentfollowedbyuserdetails_6d32873ec7def1aef93295f5003bd542(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "b044e9eabe2979c44fa328286a1334109c60abfd";
...
{
/* Instance RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PYRECENTFOLLOWEDBYUSERDETAILS #20210506T204029.741 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "b044e9eabe2979c44fa328286a1334109c60abfd";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyRecentFollowedByUserDetails",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PYRECENTFOLLOWEDBYUSERDETAILS #20210506T204029.741 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PYRECENTFOLLOWEDBYUSERDETAILS #20210506T204029.741 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PYRECENTFOLLOWEDBYUSERDETAILS #20210506T204029.741 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYRECENTFOLLOWEDBYUSERDETAILS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYRECENTFOLLOWEDBYUSERDETAILS","Rule-HTML-Section","DATA-ADMIN-OPERATOR-ID",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PYRECENTFOLLOWEDBYUSERDETAILS #20210506T204029.741 GMT","!PYRECENTFOLLOWEDBYUSERDETAILS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-368306970)
	};
...
//	RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PYRECENTFOLLOWEDBYUSERDETAILS #20210506T204029.741 GMT:20211007T154924.340 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "45b2fb24d07ddf3906b9da160e99eaab";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyRecentFollowedByUserDetails",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyRecentFollowedByUserDetails','insKey':'RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PYRECENTFOLLOWEDBYUSERDETAILS #20210506T204029.741 GMT','sectionType':'standard'}");
pzLayout_2();
...
config.put("pySectionName", "pyRecentFollowedByUserDetails");
...
public void getNextPage_1(String listSource, int listStartIndex, int listEndIndex) {
	...
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201712261549540021242" ) + "");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_5","pyRecentFollowedByUserDetailsRow", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pyRecentFollowedByUserDetailsRow"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpyRecentFollowedByUserDetails880","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_2","pyRecentFollowedByUserDetailsRow", secInfo);
}
...
public int simpleLayoutCell_1(  int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyRecentFollowedByUserDetailsRow",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   flex flex-row ' ");
	...
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201712261549540021242-" + rowTestID) + " ");
	}else {
	...
	baseRef +="D_pzGetFollowedByUsers.pxResults(";
	 baseRef += strSub; 
	baseRef += ")";
	}else {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyRecentFollowedByUserDetailsRow",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
String pyInstanceId ="";
char mode = tools.getProperty("D_pzGetFollowedByUsers.pxResults").getMode();
...
ClipboardPage dummyPage = tools.createPage("Data-Admin-Operator-ID","NoDataPage");
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","UtilityNoResultsMessage", RDLNoRowMessageSectionParams);
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  "D_pzGetFollowedByUsers.pxResults AddDelete", expressionId, true);
expressionId = expression.getId();
}
ClipboardProperty rdlPageListProp = tools.getProperty("D_pzGetFollowedByUsers.pxResults");
String rdlPageListPropRef = "D_pzGetFollowedByUsers.pxResults";
if(rdlPageListProp != null) {
rdlPageListPropRef = rdlPageListProp.getReference();
}
String rdlRefreshWhenStr = "D_pzGetFollowedByUsers.pxResults AddDelete";
rdlRefreshWhenStr = rdlRefreshWhenStr.replace("D_pzGetFollowedByUsers.pxResults",rdlPageListPropRef);
if(!StringUtils.isBlank(expressionId)) {
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_9","pyProgressiveRDLPaginatorShowLess", RDLNoMoreDataMessageSectionParams);
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_10","pyProgressiveRDLPaginator", RDLPaginatorSectionParams);
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzGetFollowedByUsers.pxResults").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
} else {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzGetFollowedByUsers.pxResults").getReference(),"",false)); 
}
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pzPackageRuntime.packageProperty(tools.getProperty("D_pzGetFollowedByUsers.pxResults").getReference(), null);
}
...
pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201712261549540021242" ) + "");
...
map.put("pyContext", "D_pzGetFollowedByUsers.pxResults");
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzGetFollowedByUsers.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzGetFollowedByUsers.pxResults").getReference(),"", false),pyInstanceId);
}
tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
ClipboardProperty cpSource = tools.getProperty("D_pzGetFollowedByUsers.pxResults");
...
dummyPageName = "DummyD_pzGetFollowedByUsers_pxResults";
}
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzGetFollowedByUsers.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
itemPage = tools.createPage("Data-Admin-Operator-ID",dummyPageName);
PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
simpleLayoutCell_1(1);
	pega.popStackFrame(itemFrame, false);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzGetFollowedByUsers.pxResults").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
}
}else{
if(mode =='L' || mode =='G'){
Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzGetFollowedByUsers.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzGetFollowedByUsers.pxResults").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("pyRecentFollowedByUserDetails",
...
pzSection.getLayout().setExpandParam("SubSectionpyRecentFollowedByUserDetailsB","",false);
}
...
public void simpleLayout_1() {
	...
	tools.appendString(tools.getProperty("D_pzGetFollowedByUsers.pxResults").getReference()+ "' ");
	tools.appendString(" " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(1)'}") + "  class=' flex content   layout-content-default content-default   progressive-useraction' ");
	String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
	ClipboardProperty rdlPageListProperty = tools.getProperty("D_pzGetFollowedByUsers.pxResults");
	String rdlPageListPropRef = "D_pzGetFollowedByUsers.pxResults";
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201712261549540021242" ) + " ");
	tools.appendString(">");
	int index = 1;
	...
	rdlPageListProp = tools.getProperty("D_pzGetFollowedByUsers.pxResults");
...
String paramName = "EXPANDEDSubSectionpyRecentFollowedByUserDetailsB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PYRECENTFOLLOWEDBYUSERDETAILS #20210506T204029.741 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyRecentFollowedByUserDetails");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PYRECENTFOLLOWEDBYUSERDETAILS #20210506T204029.741 GMT", "Data-Admin-Operator-ID pyRecentFollowedByUserDetails", "Theme-Cosmos", "04-01-01", "20211007T154924.340 GMT");
}
