...
/**
 * Builds JSP stream RULE-OBJ-PROPERTY!ACTIONNEWTOP.
 */
public class ra_stream_actionnewtop_f09d788053929e68728fd8c878420bbf extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.ActionNewTop.Rule_Obj_Property.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1505643719;
 ...
 */
	public ra_stream_actionnewtop_f09d788053929e68728fd8c878420bbf(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "743070d31b5f714e6aca4af224fbedacba1094af";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-PROPERTY ACTIONNEWTOP #20180713T135657.948 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "743070d31b5f714e6aca4af224fbedacba1094af";
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-PROPERTY ACTIONNEWTOP #20180713T135657.948 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-PROPERTY ACTIONNEWTOP #20180713T135657.948 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-PROPERTY ACTIONNEWTOP #20180713T135657.948 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Property:PYRULEACCESSWHEN", 
	"Rule-Obj-Property:PYOPTIMIZEFORTHISCLASS", 
	"Rule-Obj-Property:PYOPTIMIZEFORDECENDENTS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("ACTIONNEWTOP","Rule-HTML-Section","RULE-OBJ-PROPERTY",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION RULE-OBJ-PROPERTY ACTIONNEWTOP #20180713T135657.948 GMT","!ACTIONNEWTOP",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1505643719), 
		new DependentRuleInfo("PYRULEACCESSWHEN","Rule-Obj-Property","RULE-OBJ-PROPERTY",false,"","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY RULE-OBJ-PROPERTY PYRULEACCESSWHEN #20180713T131303.993 GMT","!PYRULEACCESSWHEN",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
		new DependentRuleInfo("PYOPTIMIZEFORTHISCLASS","Rule-Obj-Property","RULE-OBJ-PROPERTY",true,"Rule-Obj-Property","Pega-Desktop","08-01-01","RULE-OBJ-PROPERTY RULE-OBJ-PROPERTY PYOPTIMIZEFORTHISCLASS #20180713T135039.325 GMT","!PYOPTIMIZEFORTHISCLASS",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYOPTIMIZEFORDECENDENTS","Rule-Obj-Property","RULE-OBJ-PROPERTY",true,"Rule-Obj-Property","Pega-Desktop","08-01-01","RULE-OBJ-PROPERTY RULE-OBJ-PROPERTY PYOPTIMIZEFORDECENDENTS #20180713T135039.322 GMT","!PYOPTIMIZEFORDECENDENTS",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE-OBJ-PROPERTY ACTIONNEWTOP #20180713T135657.948 GMT:20180713T135657.948 GMT
...
//	RULE-OBJ-PROPERTY RULE-OBJ-PROPERTY PYRULEACCESSWHEN #20180713T131303.993 GMT:20180713T131303.993 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-PROPERTY PYRULEACCESSWHEN #20180713T131303.993 GMT:20180713T131303.993 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-PROPERTY PYRULEACCESSWHEN #20180713T131303.993 GMT:20180713T131303.993 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-PROPERTY PYRULEACCESSWHEN #20180713T131303.993 GMT:20180713T131303.993 GMT
...
//	RULE-OBJ-PROPERTY RULE-OBJ-PROPERTY PYOPTIMIZEFORTHISCLASS #20180713T135039.325 GMT:20180713T135039.325 GMT
//	RULE-HTML-PROPERTY PXCHECKBOX #20190131T183501.527 GMT:20190131T183501.527 GMT
//	RULE-FILE-TEXT WEBWB PZPEGA_CONTROL_CHECKBOX!JS #20180713T133232.019 GMT:20180713T133232.019 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-PROPERTY PYOPTIMIZEFORDECENDENTS #20180713T135039.322 GMT:20180713T135039.322 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "e8b01fbaff0ab8760f7513cec73ee196";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("ActionNewTop",1,"Rule-HTML-Section","{'type':'Section','ruleName':'ActionNewTop','insKey':'RULE-HTML-SECTION RULE-OBJ-PROPERTY ACTIONNEWTOP #20180713T135657.948 GMT','sectionType':'null'}");
pzLayout_1();
pzLayout_2();
...
tools.appendString("</P>");
	...
	pzAuto.getUIComponentRuntime().getExpressionEvaluator().addDefaultValue(".pyOptimizeForDecendents",  "false");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("",true));
	cellPage.put("pyValue",".pyOptimizeForDecendents");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyOptimizeForDecendents");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyOptimizeForDecendents", ".pyCaption");
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyCaption","Optimize for reporting on descendant classes\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Optimize for reporting on descendant classes", ".pyCaption");
	}
	pyCheckboxCaption = "Optimize for reporting on descendant classes";
	modePage1.put("pyCheckboxCaption",pyCheckboxCaption);
	cellPage.put("pyID","pyOptimizeForDecendents");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyOptimizeForDecendents",pxUniqueStreamHash+"_29");
	...
	String pyValueOrig = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyOptimizeForDecendents");
	pyValueR = ".pyOptimizeForDecendents";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyOptimizeForDecendents");
	pyValueOrig = ".pyOptimizeForDecendents";
...
pzStatic_pzCheckboxScripts.emitContent();
		...
		tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOptimizeForDecendents").getEntryHandle(),"entryHandle"));} else{
		...
		tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOptimizeForDecendents").getEntryHandle(),"entryHandle"));
		tools.appendString("' data-bindprops='value'");
		checkboxName = StringUtils.crossScriptingFilter(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOptimizeForDecendents").getEntryHandle(),"entryHandle"));} else{
		tools.appendString(tools.getActive().getEntryHandle());
		tools.appendString("'");
		...
		tools.appendString(propName.substring(propName.lastIndexOf(".")+1)+pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOptimizeForDecendents").getReference(),"",true)+"' ");} else{
	...
	tools.appendString("class='chkbxCaptionRight'>");
		tools.appendString(tools.getLocalizedTextForString(".pyCaption","Optimize for reporting on descendant classes"));
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_31")){inclFormattedVal_4(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	...
	String repeatIndx = "";
	IUIComponentMetadata pyUserData = pzAuto.getUIComponentRuntime().createMetadata();
	pzAuto.getUIComponentRuntime().getExpressionEvaluator().addDefaultValue(".pyOptimizeForThisClass",  "false");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("",true));
	cellPage.put("pyValue",".pyOptimizeForThisClass");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyOptimizeForThisClass");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyOptimizeForThisClass", ".pyCaption");
	...
	String pyCheckboxCaption = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyCaption","Optimize for reporting\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Optimize for reporting", ".pyCaption");
	}
	pyCheckboxCaption = "Optimize for reporting";
	modePage1.put("pyCheckboxCaption",pyCheckboxCaption);
	cellPage.put("pyID","pyOptimizeForThisClass");
	String clientValidationAttributes = pzAuto.getCell().getClientValidationAttributes(pyOnInput, pyEditValidate, pyStringType,pegaValidation.toString());
	modePage1.put("clintValidAttrs",clientValidationAttributes);
	modePage1.put("pyWrap","false");
	modePage1.put("pyCheckboxCaptionPosition","right");
	modePage1.put("styleOther","");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyOptimizeForThisClass",pxUniqueStreamHash+"_21");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	...
	String pyValueOrig = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyOptimizeForThisClass");
	pyValueR = ".pyOptimizeForThisClass";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyOptimizeForThisClass");
	pyValueOrig = ".pyOptimizeForThisClass";
	cellPage.put("pyValue",pyValueOrig);
	cellPage.put("pyValueRO",pyValueR);
	modePage2.put("pyContent","associated");
	modePage2.put("styleOther","");
...
pzStatic_pzCheckboxScripts.emitContent();
		...
		tools.appendString(">");
		tools.appendString("<input type='hidden' value='false' ");if(bOptimizedMarkup){  tools.appendString(" data-bindprops='value' "); }tools.appendString(" name='");if(bOptimizedMarkup){
		tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOptimizeForThisClass").getEntryHandle(),"entryHandle"));} else{
		tools.appendString(tools.getActive().getEntryHandle());}
		tools.appendString("' ");		tools.appendString(disabled_ctrl);
		...
		String checkboxName = "";
		tools.appendString("<input type='checkbox'  class='checkbox chkBxCtl"+errorClass+"' value='true' name='");if(bOptimizedMarkup){
		tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOptimizeForThisClass").getEntryHandle(),"entryHandle"));
		tools.appendString("' data-bindprops='value'");
		checkboxName = StringUtils.crossScriptingFilter(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOptimizeForThisClass").getEntryHandle(),"entryHandle"));} else{
		tools.appendString(tools.getActive().getEntryHandle());
		tools.appendString("'");
		checkboxName = tools.getActive().getEntryHandle();}
		tools.appendString(" aria-describedby='"+checkboxName+"Error'");
		tools.appendString(" id='");if(bOptimizedMarkup){
		tools.appendString(propName.substring(propName.lastIndexOf(".")+1)+pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOptimizeForThisClass").getReference(),"",true)+"' ");} else{
		tools.appendString(tools.getHTMLIDForProperty(true,"checkbox")+"' ");}		tools.appendString(disabled_ctrl + " ");
		...
		tools.appendString(tools.getHTMLIDForProperty(true,"checkbox")+"' ");} 
	tools.appendString("class='chkbxCaptionRight'>");
		tools.appendString(tools.getLocalizedTextForString(".pyCaption","Optimize for reporting"));
		tools.appendString("</label>");
		tools.appendString("</span>");pega_uiengine_pzcontrol.pzAddMessages(tools,"SIMPLELAYOUT");		}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_23")){inclFormattedVal_4(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("forLabel",".pyOptimizeForThisClass");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxCheckBox",".pyOptimizeForThisClass",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxCheckBox_1(".pyOptimizeForThisClass",0,"","","True-False");labelName = "";
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("format","pxCheckBox");
	pgCells.put("forLabel",".pyOptimizeForDecendents");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxCheckBox",".pyOptimizeForDecendents",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxCheckBox_2(".pyOptimizeForDecendents",0,"","","True-False");labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionActionNewTopBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionActionNewTopBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzCanPropertyBeOptimized", pxUniqueStreamHash+"_34");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if(pzAuto.handleEvaluateWhen(" wxpzCanPropertyBeOptimized","pzCanPropertyBeOptimized", "layout", "visible" )) {pzSetExpandParam_2();
...
if (_jspx_meth_pega_param__1(pageContext, "Class", "Rule-Access-When")) {
	return true;
}
 ...
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyRuleAccessWhen", "input", "OpenRuleAdvanced")) {
	return;
}
} catch(Throwable t) {
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyStringType\"  SHOW_WHEN=\".pyStringType == 'TextEncrypted'\"");
if(pzAuto.evaluateWhen(".pyStringType == 'TextEncrypted'",null,true)){
	if(currentTemplatingStatus =='N')
...
tools.appendString("</P>");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyStringType", ".pyCaption");
	modePage1.put("pyHasNoSelection","false");
	String ddPropRef = tools.getActive().getReference();
	String clientValidationAttributes = pzAuto.getCell().getClientValidationAttributes(pyOnInput, pyEditValidate, pyStringType,pegaValidation.toString());
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyStringType",pxUniqueStreamHash+"_5");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
...
public int simpleLayoutCell_1( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Data type") + "</span>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Data type") + "</label>");
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDropdown",".pyStringType",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDropdown_1(".pyStringType",0,"","","Identifier");labelName = "Data type";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_2( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyRuleAccessWhen",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyRuleAccessWhen" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Access when") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Access when") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pyStringType == 'TextEncrypted'", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
	String dataFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
	...
	pgCells.put("forLabel",".pyRuleAccessWhen");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyRuleAccessWhen",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_16")) {	field_OpenRuleAdvanced_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "Access when";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
static {
	oPropDefinitions_1.put("Rule-Obj-Property.pyRuleAccessWhen", new LiteweightPropertyDefinition("Rule-Obj-Property", "pyRuleAccessWhen", "sIN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-PROPERTY ACTIONNEWTOP #20180713T135657.948 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-PROPERTY ACTIONNEWTOP #20180713T135657.948 GMT", "Rule-Obj-Property ActionNewTop", "Pega-SystemArchitect", "08-01-01", "20180713T135657.948 GMT");
}
