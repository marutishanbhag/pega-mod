...
/**
 * Builds JSP stream EMBED-EXPLORERNODE-RULETYPE!PZAPPEXPLORERNODE.
 */
public class ra_stream_pzappexplorernode_b8ffbe5242a3f64256decd40645338ca extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzAppExplorerNode.Embed_ExplorerNode_RuleType.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 526377159;
 ...
 */
	public ra_stream_pzappexplorernode_b8ffbe5242a3f64256decd40645338ca(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "7f7344c520c043f65dbe19db96a66c6a45128dda";
...
{
/* Instance RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZAPPEXPLORERNODE #20180713T135213.940 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "7f7344c520c043f65dbe19db96a66c6a45128dda";
...
/*
 * Begin RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZAPPEXPLORERNODE #20180713T135213.940 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZAPPEXPLORERNODE #20180713T135213.940 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZAPPEXPLORERNODE #20180713T135213.940 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPEXPLORERNODE","Rule-HTML-Section","EMBED-EXPLORERNODE-RULETYPE",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZAPPEXPLORERNODE #20180713T135213.940 GMT","!PZAPPEXPLORERNODE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",526377159), 
...
//	RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZAPPEXPLORERNODE #20180713T135213.940 GMT:20180713T135213.940 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "c432f7fc5898b13b34c22e21dc17c3d7";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzAppExplorerNode",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzAppExplorerNode','insKey':'RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZAPPEXPLORERNODE #20180713T135213.940 GMT','sectionType':'null'}");
pzLayout_1();
...
try {
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Open the instance list for this item\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Open the instance list for this item", ".pyActionPrompt");
	}
	pyTooltip = "Open the instance list for this item";
...
{com.google.gson.JsonObject jObject = new com.google.gson.JsonObject();com.google.gson.JsonObject propRefJSON = new com.google.gson.JsonObject();{propRefJSON.addProperty("RuleClass","#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyClassName")+"~#");}{propRefJSON.addProperty("AppliesToClass","#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyClass")+"~#");}{jObject.addProperty("Action", "forcerun");}{jObject.addProperty("ShowInstances", "");}{propRefJSON.addProperty("Label","#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyLabel")+"~#");}if(!"{}".equals(propRefJSON.toString())){jObject.add("preActivityDynamicParams",propRefJSON);}
	...
	,"Display","0");
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Open the instance list for this item\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZAPPEXPLORERNODE #20180713T135213.940 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-EXPLORERNODE-RULETYPE PZAPPEXPLORERNODE #20180713T135213.940 GMT", "Embed-ExplorerNode-Ruletype pzAppExplorerNode", "Pega-Desktop", "08-01-01", "20180713T135213.940 GMT");
}
