...
/**
 * Builds JSP stream WORK-!PYSETSTATUSRESOLVED.
 */
public class ra_stream_pysetstatusresolved_b61ed0e8207b0336631dbac367c464f0 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pySetStatusResolved.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1232102251;
 ...
 */
	public ra_stream_pysetstatusresolved_b61ed0e8207b0336631dbac367c464f0(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a7ba4471306a44288a4bd54c0fd9b36051ebd3e2";
...
{
/* Instance RULE-HTML-SECTION WORK- PYSETSTATUSRESOLVED #20180713T140940.761 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "a7ba4471306a44288a4bd54c0fd9b36051ebd3e2";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pySetStatusResolved",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- PYSETSTATUSRESOLVED #20180713T140940.761 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PYSETSTATUSRESOLVED #20180713T140940.761 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PYSETSTATUSRESOLVED #20180713T140940.761 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYSETSTATUSRESOLVED", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYSETSTATUSRESOLVED","Rule-HTML-Section","WORK-",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION WORK- PYSETSTATUSRESOLVED #20180713T140940.761 GMT","!PYSETSTATUSRESOLVED",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1232102251), 
		new DependentRuleInfo("PYRESOLVEDSTATUS","Rule-Obj-Property","WORK-",true,"Work-","Pega-ProcessArchitect","08-01-01","RULE-OBJ-PROPERTY WORK- PYRESOLVEDSTATUS #20180713T140731.115 GMT","!PYRESOLVEDSTATUS",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION WORK- PYSETSTATUSRESOLVED #20180713T140940.761 GMT:20180713T140940.761 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "7d88498ba8104fd96e666b2e861469ab";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pySetStatusResolved",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pySetStatusResolved','insKey':'RULE-HTML-SECTION WORK- PYSETSTATUSRESOLVED #20180713T140940.761 GMT','sectionType':'standard'}");
...
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2015072106064400614331") + "  ");
...
tools.appendString("</P>");
	...
	if(isEditable) {
		 ...
		 tools.putParamValue("REQUIRED_WHEN_ROC","");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_5")){String ddPropRef = tools.getActive().getReference();
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6");}if(beginNonTemplate){		HashStringMap params = new HashStringMap();
		ParameterPage paramPage = new ParameterPage();
		pega_rulesengine_utilities.pzRunActivity("pxGetResolvedStatuses",paramPage,tools.getStepPage(),tools);
		String pageName ="ResolvedStatuses";
	...
	pageName = tools.getStepPage().getName()+pageName;
		...
		if(!isAccessible) {
			...
			tools.appendString(" " + pzCell.getTestIdIfEnabled("2015072106064400635238") + " ");
...
tools.appendString(" data-bindprops='value' ");} else{		tools.appendString(ddPropEntryHandle);
	...
	if (cbpResults != null && cbpResults.size() > 0) {
		...
		while(resIter.hasNext()) {
			...
			displayString = cbpRow.getStringIfPresent(".pyFieldValue");
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead standard_dataLabelRead RL1","dataLabelWrite standard_dataLabelWrite RL1"), "",false,"","");labelIncludeInCell_1("","","","",false,"Set status:",true,false,"Standard",false);
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxDropdown",".pyResolvedStatus",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead RV1 dataValueRead RV1","dataValueWrite RV1 dataValueWrite RV1"), "",false,"","");tools.putSaveValue("parentLayouttype","");pxDropdown_1(".pyResolvedStatus",0,"","","Text");
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>");
...
pzSection.getLayout().setExpandParam("SubSectionpySetStatusResolvedB","",false);
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- PYSETSTATUSRESOLVED #20180713T140940.761 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pySetStatusResolved");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PYSETSTATUSRESOLVED #20180713T140940.761 GMT", "Work- pySetStatusResolved", "Pega-ProcessArchitect", "08-01-01", "20180713T140940.761 GMT");
}
