...
/**
 * Builds JSP stream DATA-DECISION-SERVICE!PYSELECTANINSTANCE.
 */
public class ra_stream_pyselectaninstance_cc9b1b83f7b2b618b8b19ee580a3ce3d extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pySelectAnInstance.Data_Decision_Service_StreamServer.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1291936270;
 ...
 */
	public ra_stream_pyselectaninstance_cc9b1b83f7b2b618b8b19ee580a3ce3d(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "5a2f6075bc280ae05b614717b30c4d314a92a2f";
...
{
/* Instance RULE-HTML-SECTION DATA-DECISION-SERVICE PYSELECTANINSTANCE #20180713T143222.957 GMT	Pega-DecisionArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "5a2f6075bc280ae05b614717b30c4d314a92a2f";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pySelectAnInstance",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-DECISION-SERVICE PYSELECTANINSTANCE #20180713T143222.957 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-DECISION-SERVICE PYSELECTANINSTANCE #20180713T143222.957 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-DECISION-SERVICE PYSELECTANINSTANCE #20180713T143222.957 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYSELECTANINSTANCE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYSELECTANINSTANCE","Rule-HTML-Section","DATA-DECISION-SERVICE",false,"","Pega-DecisionArchitect","08-01-01","RULE-HTML-SECTION DATA-DECISION-SERVICE PYSELECTANINSTANCE #20180713T143222.957 GMT","!PYSELECTANINSTANCE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1291936270), 
...
//	RULE-HTML-SECTION DATA-DECISION-SERVICE PYSELECTANINSTANCE #20180713T143222.957 GMT:20180713T143222.957 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "ed2c0d5f2663cf81986656b3bf22b449";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pySelectAnInstance",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pySelectAnInstance','insKey':'RULE-HTML-SECTION DATA-DECISION-SERVICE PYSELECTANINSTANCE #20180713T143222.957 GMT','sectionType':'standard'}");
pzLayout_2();
...
public int simpleLayoutCell_2( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","No service selected.") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2017112014475206427698")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","helper_text_dataLabelRead","helper_text_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("2017112014475206438564") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead helper_text_dataLabelRead","dataLabelWrite helper_text_dataLabelWrite") + "' >");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Select a service to display its details.") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2017112014475206438564")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("spanClass","iconRequired helper_text_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("labelReadClass","dataLabelRead helper_text_dataLabelRead");
	pgCells.put("labelWriteClass","dataLabelWrite helper_text_dataLabelWrite");
	...
	labelName = "Select a service to display its details.";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpySelectAnInstanceBB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + " content  layout-content-simple_list content-simple_list centered no-content" + "'  ");
		...
		pg_dlmeta.put("customClassName","centered no-content");
	...
	String paramName = "EXPANDEDSubSectionpySelectAnInstanceBB";
	...
	metadataPage.put("sectionIndex","81");
...
try {
	...
	cellPage.put("pyStreamName","pySelectAnInstance");
	cellPage.put("pyCellID","80");
	...
	String classProp = "";
	classProp ="pi-5x pi pi-tracer pi-grey";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2017112014420905434973") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pySelectAnInstance_"+ referenceString+ "_80'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		String classProp = "";
		 classProp ="pi-5x pi pi-tracer pi-grey";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("2017112014420905434973") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2017112014420905434973-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpySelectAnInstanceB","",false);
}
...
public void simpleLayout_2() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  layout-content-stacked content-stacked centered no-content" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpySelectAnInstanceB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-DECISION-SERVICE PYSELECTANINSTANCE #20180713T143222.957 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pySelectAnInstance");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-DECISION-SERVICE PYSELECTANINSTANCE #20180713T143222.957 GMT", "Data-Decision-Service pySelectAnInstance", "Pega-DecisionArchitect", "08-01-01", "20180713T143222.957 GMT");
}
