...
/**
 * Builds JSP stream RULE-OBJ-ACTIVITY!PZLOCALACTIONPROMPT.
 */
public class ra_stream_pzlocalactionprompt_ecde13a1592594db266361b5fe022026 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzLocalActionPrompt.Rule_Obj_Activity.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 552564313;
 ...
 */
	public ra_stream_pzlocalactionprompt_ecde13a1592594db266361b5fe022026(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "3f6bfab28ac3ff6a65933eb53b9f69e7a50959de";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZLOCALACTIONPROMPT #20181107T173011.866 GMT	Pega-Desktop:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "3f6bfab28ac3ff6a65933eb53b9f69e7a50959de";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzLocalActionPrompt",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZLOCALACTIONPROMPT #20181107T173011.866 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZLOCALACTIONPROMPT #20181107T173011.866 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZLOCALACTIONPROMPT #20181107T173011.866 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZLOCALACTIONPROMPT", 
	"Rule-Obj-Property:PYRULEPARAMSSTREAMNAME"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZLOCALACTIONPROMPT","Rule-HTML-Section","RULE-OBJ-ACTIVITY",false,"","Pega-Desktop","08-02-01","RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZLOCALACTIONPROMPT #20181107T173011.866 GMT","!PZLOCALACTIONPROMPT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",552564313), 
		new DependentRuleInfo("PYRULEPARAMSSTREAMNAME","Rule-Obj-Property","@BASECLASS",false,"","Pega-RulesEngine","08-05-01","RULE-OBJ-PROPERTY @BASECLASS PYRULEPARAMSSTREAMNAME #20200217T074804.758 GMT","!PYRULEPARAMSSTREAMNAME",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0)
	};
...
//	RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZLOCALACTIONPROMPT #20181107T173011.866 GMT:20181107T173011.866 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYRULEPARAMSSTREAMNAME #20200217T074804.758 GMT:20200217T074804.758 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYRULEPARAMSSTREAMNAME #20200217T074804.758 GMT:20200217T074804.758 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYRULEPARAMSSTREAMNAME #20200217T074804.758 GMT:20200217T074804.758 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYRULEPARAMSSTREAMNAME #20200217T074804.758 GMT:20200217T074804.758 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "555d855c182f447a24540007874718bd";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzLocalActionPrompt",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzLocalActionPrompt','insKey':'RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZLOCALACTIONPROMPT #20181107T173011.866 GMT','sectionType':'standard'}");
pzLayout_1();
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzLocalActionPromptB"));
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Local action for parameter display", "pyCaption");
...
metadataPage.put("title","Local action for parameter display");
metadataPage.put("uniqueid", "202602230422420371");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("2018110711194201074") + " ");
...
if (_jspx_meth_pega_param__1(pageContext, "Class", "Rule-Obj-FlowAction")) {
	return true;
}
 ...
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyRuleParamsStreamName", "input", "OpenRuleAdvanced")) {
	return;
}
} catch(Throwable t) {
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyRuleParamsStreamName",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201508200644090874144591-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","OpenRuleAdvanced");
	pgCells.put("forLabel",".pyRuleParamsStreamName");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyRuleParamsStreamName",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")) {	field_OpenRuleAdvanced_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzLocalActionPromptB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpzLocalActionPromptB";
...
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","Local action for parameter display");
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel2690' data-layout-id='202602230422420365" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel2690'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzLocalActionPromptB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("2018110711194201074") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzLocalActionPromptB";
...
static {
	oPropDefinitions_1.put("Rule-Obj-Activity.pyRuleParamsStreamName", new LiteweightPropertyDefinition("Rule-Obj-Activity", "pyRuleParamsStreamName", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZLOCALACTIONPROMPT #20181107T173011.866 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzLocalActionPrompt");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZLOCALACTIONPROMPT #20181107T173011.866 GMT", "Rule-Obj-Activity pzLocalActionPrompt", "Pega-Desktop", "08-02-01", "20181107T173011.866 GMT");
}
