...
/**
 * Builds JSP stream RULE-OBJ-CASETYPE!PZCHECKWARNINGMESSAGES.
 */
public class ra_stream_pzcheckwarningmessages_b28981e8ebb0ee88957ab4056b23dd50 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzCheckWarningMessages.Rule_Obj_CaseType.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1636418121;
 ...
 */
	public ra_stream_pzcheckwarningmessages_b28981e8ebb0ee88957ab4056b23dd50(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "b89d1b77261a16000f70e510c989a2af5ff7dc2f";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-CASETYPE PZCHECKWARNINGMESSAGES #20200520T133424.333 GMT	Pega-ProcessArchitect:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "b89d1b77261a16000f70e510c989a2af5ff7dc2f";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzCheckWarningMessages",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-CASETYPE PZCHECKWARNINGMESSAGES #20200520T133424.333 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-CASETYPE PZCHECKWARNINGMESSAGES #20200520T133424.333 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-CASETYPE PZCHECKWARNINGMESSAGES #20200520T133424.333 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZCHECKWARNINGMESSAGES", 
	"Rule-Obj-Property:PYMESSAGE", 
	"Rule-Obj-Property:PYFLOWNAME", 
	"Rule-Obj-Property:PYSTAGENAME", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCHECKWARNINGMESSAGES","Rule-HTML-Section","RULE-OBJ-CASETYPE",false,"","Pega-ProcessArchitect","08-05-01","RULE-HTML-SECTION RULE-OBJ-CASETYPE PZCHECKWARNINGMESSAGES #20200520T133424.333 GMT","!PZCHECKWARNINGMESSAGES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1636418121), 
		new DependentRuleInfo("PYMESSAGE","Rule-Obj-Property","EMBED-MO-WARNING",true,"Embed-MO-Warning","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY EMBED-MO-WARNING PYMESSAGE #20180713T131905.950 GMT","!PYMESSAGE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYFLOWNAME","Rule-Obj-Property","EMBED-MO-WARNING",true,"Embed-MO-Warning","Pega-ProcessArchitect","08-05-01","RULE-OBJ-PROPERTY EMBED-MO-WARNING PYFLOWNAME #20200520T133429.608 GMT","!PYFLOWNAME",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYSTAGENAME","Rule-Obj-Property","@BASECLASS",false,"","Pega-ProcessEngine","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYSTAGENAME #20180713T132856.712 GMT","!PYSTAGENAME",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
...
//	RULE-HTML-SECTION RULE-OBJ-CASETYPE PZCHECKWARNINGMESSAGES #20200520T133424.333 GMT:20200520T133424.333 GMT
//	RULE-HTML-PROPERTY PXTEXTINPUT #20190131T183501.688 GMT:20190131T183501.688 GMT
//	RULE-OBJ-PROPERTY EMBED-MO-WARNING PYMESSAGE #20180713T131905.950 GMT:20180713T131905.950 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYSTAGENAME #20180713T132856.712 GMT:20180713T132856.712 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYSTAGENAME #20180713T132856.712 GMT:20180713T132856.712 GMT
//	RULE-HTML-PROPERTY PXTEXTINPUT #20190131T183501.688 GMT:20190131T183501.688 GMT
//	RULE-OBJ-PROPERTY EMBED-MO-WARNING PYFLOWNAME #20200520T133429.608 GMT:20200520T133429.608 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYSTAGENAME #20180713T132856.712 GMT:20180713T132856.712 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYSTAGENAME #20180713T132856.712 GMT:20180713T132856.712 GMT
//	RULE-HTML-PROPERTY PXTEXTINPUT #20190131T183501.688 GMT:20190131T183501.688 GMT
//	RULE-OBJ-PROPERTY EMBED-MO-WARNING PYFLOWNAME #20200520T133429.608 GMT:20200520T133429.608 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "3a4bc32d0c07e3c3c059a7591dfc9655";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzCheckWarningMessages",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzCheckWarningMessages','insKey':'RULE-HTML-SECTION RULE-OBJ-CASETYPE PZCHECKWARNINGMESSAGES #20200520T133424.333 GMT','sectionType':'standard'}");
pzLayout_2();
...
tools.appendString("</P>");
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("202005180626460087923") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
...
tools.appendString(" data-importance='secondary' data-attribute-name='");
 String columnHeaderValue = "ProcessColumn"; if(!columnHeaderValue.contains(" ") && pega_procom_harness.IsParam(columnHeaderValue) && tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1)) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1))); }  else if(!columnHeaderValue.contains(" ") && columnHeaderValue.matches(".*[.][a-zA-Z]+.*") && !columnHeaderValue.endsWith(".") && tools.getIfPresent(columnHeaderValue) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getIfPresent(columnHeaderValue).getStringValue()); }  else { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", columnHeaderValue, StreamBuilder.FMT_NORMAL); }  tools.appendString(StringUtils.crossScriptingFilter(columnHeaderValue)); 
tools.appendString("' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxTextInput",".pyFlowName", ".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(3)")); tools.appendString("headers='a3'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:31px;'");}tools.appendString("class='");
	...
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");pxTextInput_7(".pyFlowName",0,"","","Text");
									tools.appendString("</DIV>"); } else { pxTextInput_7(".pyFlowName",0,"","","Text");}
...
try {
tools.appendString(" data-importance='secondary' data-attribute-name='");
 String columnHeaderValue = "ErrorColumn"; if(!columnHeaderValue.contains(" ") && pega_procom_harness.IsParam(columnHeaderValue) && tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1)) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1))); }  else if(!columnHeaderValue.contains(" ") && columnHeaderValue.matches(".*[.][a-zA-Z]+.*") && !columnHeaderValue.endsWith(".") && tools.getIfPresent(columnHeaderValue) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getIfPresent(columnHeaderValue).getStringValue()); }  else { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", columnHeaderValue, StreamBuilder.FMT_NORMAL); }  tools.appendString(StringUtils.crossScriptingFilter(columnHeaderValue)); 
tools.appendString("' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxTextInput",".pyMessage", ".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
	tools.appendString("height:33px;");tools.appendString(""); tools.appendString("'class='");
	tools.appendString(pzSection.getCustomStyle(true,"","dataValueRead",""));tools.appendString(" gridCell");tools.appendString("  wrapText");tools.appendString("  ");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:33px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div class='divCont'><span class='wspan'></span><div class='cellIn'>"); if(tools.getIfPresent("pyRowStatus") != null){ tools.appendProperty(tools.getProperty(".pyRowStatus"),"Messages",false); }pxTextInput_6(".pyMessage",0,"","","Text");
...
public void repeatingHeaderCell_3() {
	...
	int lastDotIndex = 0;
	dataPropClass = "Embed-MO-Warning";
	dataColumnProp = "pyFlowName";
	bSecured = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().isPropertySecured(dataPropClass, dataColumnProp,tools);
	
	String sortImgHTML = "";
	String sortNoHTML = "";
	String strFieldValue = ".pyFlowName";
		tools.appendString("<th title='");
		tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='ProcessColumn' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20200518062646008664") + " ");
try {
tools.appendString(" data-importance='secondary' data-attribute-name='");
 String columnHeaderValue = "ProcessColumn"; if(!columnHeaderValue.contains(" ") && pega_procom_harness.IsParam(columnHeaderValue) && tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1)) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1))); }  else if(!columnHeaderValue.contains(" ") && columnHeaderValue.matches(".*[.][a-zA-Z]+.*") && !columnHeaderValue.endsWith(".") && tools.getIfPresent(columnHeaderValue) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getIfPresent(columnHeaderValue).getStringValue()); }  else { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", columnHeaderValue, StreamBuilder.FMT_NORMAL); }  tools.appendString(StringUtils.crossScriptingFilter(columnHeaderValue)); 
tools.appendString("' ");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("");
		if(!bSecured){
		tools.appendString(" bSortable = 'false' sortField = '.pyFlowName' ");
		}
		if(!bSecured){
		tools.appendString(" pyShowFilterUIBy = 'value'  bformattedControl ='false'");
		}
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_pzFlowConfigurationMessagesPpxResults1colWidthCache3").equals("")){ tools.appendParamCSF("D_pzFlowConfigurationMessagesPpxResults1colWidthCache3"); } else { tools.appendString("162"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									...
									tools.appendString("class='divCont  filterapplied'");tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "ProcessColumn", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_pzFlowConfigurationMessages_pxResultsL68 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68!=null && !gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPageValue("pyFlowName3").isEmpty() && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyFlowName3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyFlowName3").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle448282448\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68!=null && !gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPageValue("pyFlowName3").isEmpty() && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyFlowName3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyFlowName3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle448282448\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68!=null && !gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPageValue("pyFlowName3").isEmpty() && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyFlowName3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyFlowName3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68!=null && !gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPageValue("pyFlowName3").isEmpty() && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyFlowName3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyFlowName3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
...
public void repeatingHeaderCell_2() {
	...
	int lastDotIndex = 0;
	dataPropClass = "Embed-MO-Warning";
	dataColumnProp = "pyStageName";
	bSecured = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().isPropertySecured(dataPropClass, dataColumnProp,tools);
	
	String sortImgHTML = "";
	String sortNoHTML = "";
	String strFieldValue = ".pyStageName";
		tools.appendString("<th title='");
		tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='StageColumn' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20200518062646008545") + " ");
try {
tools.appendString(" data-importance='secondary' data-attribute-name='");
 String columnHeaderValue = "StageColumn"; if(!columnHeaderValue.contains(" ") && pega_procom_harness.IsParam(columnHeaderValue) && tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1)) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1))); }  else if(!columnHeaderValue.contains(" ") && columnHeaderValue.matches(".*[.][a-zA-Z]+.*") && !columnHeaderValue.endsWith(".") && tools.getIfPresent(columnHeaderValue) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getIfPresent(columnHeaderValue).getStringValue()); }  else { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", columnHeaderValue, StreamBuilder.FMT_NORMAL); }  tools.appendString(StringUtils.crossScriptingFilter(columnHeaderValue)); 
tools.appendString("' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		...
		tools.appendString("");
		if(!bSecured){
		tools.appendString(" bSortable = 'false' sortField = '.pyStageName' ");
		}
		if(!bSecured){
		tools.appendString(" pyShowFilterUIBy = 'value'  bformattedControl ='true'");
		}
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_pzFlowConfigurationMessagesPpxResults1colWidthCache2").equals("")){ tools.appendParamCSF("D_pzFlowConfigurationMessagesPpxResults1colWidthCache2"); } else { tools.appendString("156"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:24px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "StageColumn", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_pzFlowConfigurationMessages_pxResultsL68 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68!=null && !gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPageValue("pyStageName2").isEmpty() && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStageName2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStageName2").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle1720423155\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68!=null && !gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPageValue("pyStageName2").isEmpty() && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStageName2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStageName2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle1720423155\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68!=null && !gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPageValue("pyStageName2").isEmpty() && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStageName2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStageName2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68!=null && !gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPageValue("pyStageName2").isEmpty() && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStageName2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStageName2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68!=null && !gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPageValue("pyStageName2").isEmpty() && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStageName2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_pzFlowConfigurationMessages_pxResultsL68.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStageName2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
public void repeatingHeaderCell_1() {
	...
	String sortImgHTML = "";
	String sortNoHTML = "";
	String strFieldValue = ".pyMessage";
		tools.appendString("<th title='");
		tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='ErrorColumn' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  data-alignWithData=\"true\"  ");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("height:26px;");tools.appendString("width:"); if(!tools.getParamValueCSF("D_pzFlowConfigurationMessagesPpxResults1colWidthCache1").equals("")){ tools.appendParamCSF("D_pzFlowConfigurationMessagesPpxResults1colWidthCache1"); } else { tools.appendString("588"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:24px;'"); } 
									tools.appendString(">"); } 
									...
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "ErrorColumn", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(pzAuto.getBrowserUtils().isIE()){ 
...
pzSection.getLayout().setExpandParam("SubSectionpzCheckWarningMessagesBB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpzCheckWarningMessagesBB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPageD_pzFlowConfigurationMessages_pxResultsL68=null;

 Map selUniqMapD_pzFlowConfigurationMessages_pxResultsL68 = null;

 Set filteredIndicesSetD_pzFlowConfigurationMessages_pxResultsL68 = null;

	 String strFCPage = "pyFilterCriteria_D_pzFlowConfigurationMessages.pxResults_pzCheckWarningMessages_1";
...
gFCritPageD_pzFlowConfigurationMessages_pxResultsL68=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));

  selUniqMapD_pzFlowConfigurationMessages_pxResultsL68 = null; // reset the variable

 if(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68 != null){ 

 		 filteredIndicesSetD_pzFlowConfigurationMessages_pxResultsL68 = pega_uiengine_uiengine.pzPopulateFilteredindicesMap(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68, "D_pzFlowConfigurationMessages.pxResults");

 		 tools.getParameterPage().put("filteredIndicesSet", filteredIndicesSetD_pzFlowConfigurationMessages_pxResultsL68);

 tools.putParamValue("populateSelectedUIValues", "true");

 		 selUniqMapD_pzFlowConfigurationMessages_pxResultsL68 = pega_uiengine_uiengine.pzPopulateSelectedValues(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68); 

 		 tools.getParameterPage().put("selUniqMapD_pzFlowConfigurationMessages_pxResultsL68", selUniqMapD_pzFlowConfigurationMessages_pxResultsL68);

 tools.putParamValue("populateSelectedUIValues", "");

 }
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_pzFlowConfigurationMessages.pxResults").getReference());tools.appendString("_pzCheckWarningMessages_1'");
...
tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("202005180626460084299") + " ");
...
D_pzFlowConfigurationMessages_pxResults_1();
...
selUniqMapD_pzFlowConfigurationMessages_pxResultsL68 = null; // reset the variable
gFCritPageD_pzFlowConfigurationMessages_pxResultsL68=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));
		 selUniqMapD_pzFlowConfigurationMessages_pxResultsL68 = (Map)tools.getParameterPage().getObject("selUniqMapD_pzFlowConfigurationMessages_pxResultsL68");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getProperty("D_pzFlowConfigurationMessages.pxResults");

					}

					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList='.pyMessage .pyStageName .pyFlowName  ' class='yui-skin-sam gPXFixed grid-responsive-default ");

					if(pega_uiengine_harness.pzInStandardsMode()) {tools.appendString(" floated ");

					}tools.appendString("' style='");

					if(!pega_uiengine_harness.pzInStandardsMode()) {tools.appendString("display:"); if(pzAuto.getBrowserUtils().isIE()) {  tools.appendString(" inline; "); } else {  tools.appendString("inline-block;"); } }tools.appendString("' gPropIndex='D_pzFlowConfigurationMessagesPpxResults1' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("202005180626460084299-layout") + " ");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' ><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"D_pzFlowConfigurationMessagesPpxResults1colWidthGBL\" id=\"D_pzFlowConfigurationMessagesPpxResults1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("D_pzFlowConfigurationMessagesPpxResults1colWidthGBL"));tools.appendString("\" />");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"D_pzFlowConfigurationMessagesPpxResults1colWidthGBR\" id=\"D_pzFlowConfigurationMessagesPpxResults1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("D_pzFlowConfigurationMessagesPpxResults1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ' style='width:");

					 if(!tools.getParamValue("D_pzFlowConfigurationMessagesPpxResults1colWidthGBL").equals("")) { tools.appendParamCSF("D_pzFlowConfigurationMessagesPpxResults1colWidthGBL"); } else { 

					tools.appendString("906.0"); } 

					tools.appendString("px;table-layout:fixed;' cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='' bRowResize=\"false\" PL_PROP='");

					
tools.appendString("D_pzFlowConfigurationMessages.pxResults");

					tools.appendString("' PL_PROP_CLASS='Embed-MO-Warning' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty("D_pzFlowConfigurationMessages.pxResults").iterator(); 
					...
					Set filteredResultsSet = (HashSet)tools.getParameterPage().getObject("filteredResultsSet");boolean bFilterResult = false;
										 ...
										 } else if(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68!= null){ 
													 bFilterResult = pega_uiengine_uiengine.pzMatchesGridFilterCriteria(gFCritPageD_pzFlowConfigurationMessages_pxResultsL68, selUniqMapD_pzFlowConfigurationMessages_pxResultsL68);
										 }
										 if (gFCritPageD_pzFlowConfigurationMessages_pxResultsL68== null || 
					...
					tools.appendString(" ng-repeat=\"Item in rootData.D_pzFlowConfigurationMessages.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("202005180626460084299-" + rowTestID) + " ");
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"3\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("Embed-MO-Warning", "tempNoRespg");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodesD_pzFlowConfigurationMessages.pxResults1") && tools.getParamValue("partialRefresh").equals("false")) {
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","margin-b-0","margin-b-0")  + " ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("202005130754070286992")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","ErrorPopUpDescription") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202005130754070286992")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pgCells.put("customROStyles","margin-b-0");
	pgCells.put("customRWStyles","margin-b-0");
	...
	labelName = "ErrorPopUpDescription";
...
if(( pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_21")) ){pzLayout_1();
}
pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
...
pzSection.getLayout().setExpandParam("SubSectionpzCheckWarningMessagesB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzCheckWarningMessagesB";
...
if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_17")){pzLayoutBodyWrapper_1();
}pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
tools.putSaveValue("rowClass","");
}
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");pxTextInput_5(".pyFlowName",0,"","","Text");
									tools.appendString("</DIV>"); } else { pxTextInput_5(".pyFlowName",0,"","","Text");}
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
} 
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	if(!pzAuto.getBrowserUtils().isIE()){ 
									...
									tools.appendString("style='height:33px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div class='divCont'><span class='wspan'></span><div class='cellIn'>"); if(tools.getIfPresent("pyRowStatus") != null){ tools.appendProperty(tools.getProperty(".pyRowStatus"),"Messages",false); }pxTextInput_4(".pyMessage",0,"","","Text");
									tools.appendString("</div></div>"); if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("</DIV>"); }
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");pxTextInput_2(".pyFlowName",0,"","","Text");
									tools.appendString("</DIV>"); } else { pxTextInput_2(".pyFlowName",0,"","","Text");}
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
} 
 ...
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyStageName", "display")) {
	return;
}
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
throw new RuntimeException("Problem in JSP fragment", t);
	 ...
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("",".pyStageName", ".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)")); tools.appendString("headers='a2'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:31px;'");}tools.appendString("class='");
	tools.appendString(pzSection.getCustomStyle(true,"","dataValueRead",""));tools.appendString(" gridCell");tools.appendString("  wrapText");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	if(!pzAuto.getBrowserUtils().isIE()){ 
									...
									tools.appendString("style='height:33px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div class='divCont'><span class='wspan'></span><div class='cellIn'>"); if(tools.getIfPresent("pyRowStatus") != null){ tools.appendProperty(tools.getProperty(".pyRowStatus"),"Messages",false); }pxTextInput_1(".pyMessage",0,"","","Text");
									tools.appendString("</div></div>"); if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("</DIV>"); }
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
...
public void D_pzFlowConfigurationMessages_pxResults_1() {
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendToD_pzFlowConfigurationMessages.pxResults1")|| tools.getParamValue("partialTrigger").equals("editRowD_pzFlowConfigurationMessages.pxResults1") ){
					...
					ClipboardProperty pageListProp = tools.getProperty("D_pzFlowConfigurationMessages.pxResults");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData.D_pzFlowConfigurationMessages.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdropD_pzFlowConfigurationMessages.pxResults1")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty("D_pzFlowConfigurationMessages.pxResults");
 ...
 if(tools.getParamValue("partialTrigger").equals("filterpopupD_pzFlowConfigurationMessages.pxResults1")) { 
			...
			int dynamicColumnIndex = tools.getParamAsInteger(ImmutablePropertyInfo.TYPE_INTEGER, "dynamicColumnIndex");
			 ...
			 if(subScriptForColumn.equals("pyStageName2") && strCellType.equals("static")) { 
...
_jspx_th_pega_reference__1.setName(".pyStageName");
...
throw new RuntimeException("Problem in JSP fragment", t);
			 ...
			 if(subScriptForColumn.equals("pyFlowName3") && strCellType.equals("static")) { 
				 ...
				 tools.putActive((ClipboardProperty)tools.getParameterPage().get("currentRowPage")); 
					...
					pxTextInput_3(".pyFlowName",0,"","","Text");
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendToD_pzFlowConfigurationMessages.pxResults1") ){
...
static {
	oPropDefinitions_1.put("Rule-Obj-CaseType.pyStageName", new LiteweightPropertyDefinition("Rule-Obj-CaseType", "pyStageName", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Rule-Obj-CaseType");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-CASETYPE PZCHECKWARNINGMESSAGES #20200520T133424.333 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzCheckWarningMessages");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-CASETYPE PZCHECKWARNINGMESSAGES #20200520T133424.333 GMT", "Rule-Obj-CaseType pzCheckWarningMessages", "Pega-ProcessArchitect", "08-05-01", "20200520T133424.333 GMT");
}
