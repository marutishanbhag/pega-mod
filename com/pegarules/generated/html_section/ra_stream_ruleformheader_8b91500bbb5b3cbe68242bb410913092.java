...
/**
 * Builds JSP stream RULE-OBJ-ACTIVITY!RULEFORMHEADER.
 */
public class ra_stream_ruleformheader_8b91500bbb5b3cbe68242bb410913092 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.RuleFormHeader.Rule_Obj_Activity.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1470382911;
 ...
 */
	public ra_stream_ruleformheader_8b91500bbb5b3cbe68242bb410913092(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "7d52270620110dbe6ed89fc41e84a007a54e619b";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-ACTIVITY RULEFORMHEADER #20190423T140521.840 GMT	Pega-Desktop:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "7d52270620110dbe6ed89fc41e84a007a54e619b";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("RuleFormHeader",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-ACTIVITY RULEFORMHEADER #20190423T140521.840 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-ACTIVITY RULEFORMHEADER #20190423T140521.840 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-ACTIVITY RULEFORMHEADER #20190423T140521.840 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:RULEFORMHEADER", 
	"Rule-Obj-Property:PYTEMPLATEINPUTBOX", 
	"Rule-Obj-Property:PYRULESEARCHQUERY", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("RULEFORMHEADER","Rule-HTML-Section","RULE-OBJ-ACTIVITY",false,"","Pega-Desktop","08-03-01","RULE-HTML-SECTION RULE-OBJ-ACTIVITY RULEFORMHEADER #20190423T140521.840 GMT","!RULEFORMHEADER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1470382911), 
		...
		new DependentRuleInfo("PYRULESEARCHQUERY","Rule-Obj-Property","@BASECLASS",true,"Rule-Obj-Activity","Pega-Desktop","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYRULESEARCHQUERY #20180713T135013.163 GMT","!PYRULESEARCHQUERY",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE-OBJ-ACTIVITY RULEFORMHEADER #20190423T140521.840 GMT:20190423T140521.840 GMT
...
//	RULE-OBJ-PROPERTY @BASECLASS PYRULESEARCHQUERY #20180713T135013.163 GMT:20180713T135013.163 GMT
//	RULE-HTML-PROPERTY PXICON #20190131T183501.575 GMT:20190131T183501.575 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "a1506e2212ed9032f7a650f727afa86c";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("RuleFormHeader",1,"Rule-HTML-Section","{'type':'Section','ruleName':'RuleFormHeader','insKey':'RULE-HTML-SECTION RULE-OBJ-ACTIVITY RULEFORMHEADER #20190423T140521.840 GMT','sectionType':'standard'}");
pzLayout_9();
pzLayout_10();
pzLayout_11();
...
getControlMarkup_1() {
try {
if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyRuleSearchQuery").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.search.hide()\"]");
...
try {
	...
	cellPage.put("pyStreamName","RuleFormHeader");
	cellPage.put("pyCellID","20");
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("RuleformSearchClose") + " ");
	String spxUniqueStreamHash64 = getUIActionsMetaData_6();
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='RuleFormHeader_"+ referenceString+ "_20'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		String classProp = "";
		 classProp ="pi pi-times";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("RuleformSearchClose") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
public void pxTextInput_1() {String key="19||RULE-HTML-SECTION RULE-OBJ-ACTIVITY RULEFORMHEADER #20190423T140521.840 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","19"};oCellRuntimeParamsMap.put("19||RULE-HTML-SECTION RULE-OBJ-ACTIVITY RULEFORMHEADER #20190423T140521.840 GMT",paramValues);oControlPathsMap.put("19||RULE-HTML-SECTION RULE-OBJ-ACTIVITY RULEFORMHEADER #20190423T140521.840 GMT",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
public String 
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.search.highlight(");
	String strPropReference21 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyRuleSearchQuery")+"~#";
...
try {
	...
	modePage1.put("iconSrc","styleclass");
	modePage1.put("pyFormatTypeActionable","none");
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("RuleformSearchSubmitIcon") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='RuleFormHeader_"+ referenceString+ "_18'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
		...
		String classProp = "";
		 classProp ="pi pi-search-2";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("RuleformSearchSubmitIcon") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
		tools.appendString(" icons "+classProp+"' ");
		tools.appendString("tabindex='0' role='link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" alt= ''");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
public int simpleLayoutCell_13( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","rSearchIcon","rSearchIcon")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
...
public int simpleLayoutTemplateCell_13( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("RuleformSearchSubmitIcon-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxIcon");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("customROStyles","rSearchIcon");
	pgCells.put("customRWStyles","rSearchIcon");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_14( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput",".pyRuleSearchQuery",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("RuleformSearchInput-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	
	ClipboardProperty propActivePrev = tools.getActive();
	tools.putActive(tools.getStepPage().getProperty(".pyRuleSearchQuery"));
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Search Rule") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("RuleformSearchInput-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Search Rule") + "</label>");
}
...
public int simpleLayoutTemplateCell_14( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("RuleformSearchInput-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxTextInput");
	pgCells.put("forLabel",".pyRuleSearchQuery");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextInput",".pyRuleSearchQuery",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxTextInput_1();labelName = "Search Rule";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_15( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","rSearchBarIcon","rSearchBarIcon")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_15( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("RuleformSearchClose-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxIcon");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("customROStyles","rSearchBarIcon");
	pgCells.put("customRWStyles","rSearchBarIcon");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
...
pzSection.getLayout().setExpandParam("SubSectionRuleFormHeaderBBBBBBB","",false);
}
...
public void simpleLayout_6() {
	...
	String spxUniqueStreamHash56 = "";
	if(currentTemplatingStatus != 'N'){
	spxUniqueStreamHash56 = getUIActionsMetaData_1();
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201804100712390933844") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3)'}") + " data-tour-id='RuleSearchBar' class='" + " content  set-width-auto layout-content-split_button content-split_button rSearchBar clearfix" + "'  ");
		...
		String expressionId = null;
		com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
		if(!tools.getParamValue("pyPegaDesignMode").equals("true") && spxUniqueStreamHash56 != null && !"".equals(spxUniqueStreamHash56)){
		pg_dlmeta.put("pyActionStringID",pxUniqueStreamHash+"_56");
		}
		if(!StringUtils.isBlank(expressionId)) {
		...
		pg_dlmeta.put("customClassName","rSearchBar");
		pg_dlmeta.put("class","set-width-auto clearfix");
		pg_dlmeta.put("format","split_button");
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3)'}") + " data-tour-id='RuleSearchBar'").append("\"").toString();
	...
	String paramName = "EXPANDEDSubSectionRuleFormHeaderBBBBBBB";
	...
	metadataPage.put("tourId"," data-tour-id='RuleSearchBar'");
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzHighlightRuleSearchEnabled", pxUniqueStreamHash+"_67");metadataPage.put("lMode","Inline-block");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pxWhenIdentifiers.put("pyVisibilityWhenId",pxUniqueStreamHash+"_67");
...
if(pzAuto.handleEvaluateWhen(" wxpzHighlightRuleSearchEnabled","pzHighlightRuleSearchEnabled", "layout", "visible" )) {pzSetExpandParam_11();
...
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pxUpdateDateTime\" RW=\".pxUpdateDateTime Changes\"");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
}
...
public void buildSection_9() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  ".pxUpdateDateTime Changes", expressionId);
		if(StringUtils.isBlank(expressionId)) {
			...
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_52","RuleFormHeaderMessages", secInfo);
		}
...
config.put("navName", "pzRuleformHeaderClassMenu");
...
config.put("DeferLoadActivity", "pzPrepopulateResource");
...
config.put("NewTaskStatus", "pzViewCategories");
...
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.desktop.search.highlight");
pega.getUIEngine().getUIAction("runScript", config).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.desktop.search.hide");
pega.getUIEngine().getUIAction("runScript", config).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.desktop.search.highlight");
pega.getUIEngine().getUIAction("runScript", config).register();
...
public void includeSectionBody_1() { 
	...
	"RuleFormHeaderMessages", tools.getStepPage().getReference(),"Rule-Obj-Activity");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	generateClientWhenDiv_4();
	tools.putParamValue("section_params","");
	
	String includedSectionName = "";includedSectionName = "RuleFormHeaderMessages";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
pzSection.getLayout().setExpandParam("SubSectionRuleFormHeaderBBBBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionRuleFormHeaderBBBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'RuleFormHeaderMessages'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'RuleFormHeaderMessages'}") + ">");
}
pzSetExpandParam_10();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
tools.appendString("<div class='layout layout-noheader layout-noheader-ruleform_header'>");
...
public void buildSection_8() { 
	...
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_49","pzRuleFormToolbarCompare", secInfo);
}
...
public void sectionBodyIncludeInCell_8() { 
	...
	String sectionName = "pzRuleFormToolbarCompare"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellRuleFormHeader51","",false);
}
...
public void buildSection_7() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_46","pzRuleFormToolbarCompare", secInfo);
}
...
public void buildSection_6() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_45","pzRuleFormToolbar", secInfo);
}
...
public void sectionBodyIncludeInCell_6() { 
	...
	String sectionName = "pzRuleFormToolbar"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellRuleFormHeader948","",false);
}
...
public void buildSection_5() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_41","pzRuleFormToolbar", secInfo);
}
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyToolBarSettings.pyCompareMode\"  SHOW_WHEN=\".pyToolBarSettings.pyCompareMode == '' || .pyToolBarSettings.pyCompareMode == 'false'\"");
if(pzAuto.evaluateWhen(".pyToolBarSettings.pyCompareMode == '' || .pyToolBarSettings.pyCompareMode == 'false'",null,true)){
	if(currentTemplatingStatus =='N')
...
public int simpleLayoutCell_10( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzRuleFormToolbar",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_10( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pyToolBarSettings.pyCompareMode == '' || .pyToolBarSettings.pyCompareMode == 'false'", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
	String baseRef ="";
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzRuleFormToolbar",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
public int simpleLayoutCell_11( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpyRuleCompareEnabled","pyRuleCompareEnabled","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzRuleFormToolbarCompare",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_11( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpyRuleCompareEnabled",pxUniqueStreamHash+"_48");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_48");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pyRuleCompareEnabled");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpyRuleCompareEnabled", pxUniqueStreamHash+"_48"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzRuleFormToolbarCompare",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionRuleFormHeaderBBBBB","",false);
}
...
public void simpleLayout_4() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201804100712390932781") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle flex-dir-row-reverse ruleform-header-actions" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","flex-dir-row-reverse ruleform-header-actions");
	...
	String paramName = "EXPANDEDSubSectionRuleFormHeaderBBBBB";
	metadataPage.put("paramName", paramName);
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		keyMap.putString("pyActionName", "pzViewCategories");
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
		pzPackageRuntime.packageLocalAction("pzViewCategories", offlineUsingPage , strLAClassName);
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("RuleFormHeader",
				...
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pzViewCategories\",\"overlay\",\":event\",\"\",\""+streamType+"\",\"\",\"pzModalTemplate\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-bottom%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"true\",\"false\",\"\",\"\"]");
					} else {
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("201801241506070186992",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","RuleFormHeader_$CTX$_12");
		String repeatIndx = "";
	...
	modePage2.put("image","pi pi-caret-down pi-right");
	modePage2.put("actionImgPos","right");
	String customStyles = null;
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","View Categories\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("View Categories", ".pyButtonLabel");
	}
	pyLabel = "View Categories";
	...
	String spxUniqueStreamHash32 = getUIActionsMetaData_4();
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='RuleFormHeader_"+ referenceString+ "_12'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("201801241506070186992") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString(" >");
		String classProp = "";
		 classProp ="pi pi-caret-down pi-right";
		boolean hasLineBreaks = false;
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","View Categories",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public void buildSection_4() { 
	...
	secInfo.put("packageSection", true);
	secInfo.put("packageSectionClass", "Rule-Obj-Activity");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_30","pzRuleFormRuleset", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	try{
	pzPackageRuntime.packageSection(
	"pzRuleFormRuleset", tools.getStepPage().getReference(),"Rule-Obj-Activity");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	...
	String sectionName = "pzRuleFormRuleset"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellRuleFormHeader899","",false);
}
...
public void buildSection_3() { 
	...
	secInfo.put("packageSection", true);
	secInfo.put("packageSectionClass", "Rule-Obj-Activity");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_26","pzRuleFormRuleset", secInfo);
}
...
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pyRuleSet,.pyRuleSetName\" RW=\".pyRuleSet Changes || .pyRuleSetName Changes\"");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
}
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyRuleSetName"), -1);
	}
}catch(Exception e){}
}


public void field_pzGetRuleKeysNoClass_2() { 
...
_jspx_th_pega_reference__2.setFormat("pzGetRuleKeysNoClass");
...
public void field_pzGetRuleKeysNoClass_1() { 
String mode1 = getActionsForCustomControls_1();
tools.putSaveValue("mode1Action",mode1);
String mode2 = getActionsForCustomControls_1();
tools.putSaveValue("mode2Action",mode2);
...
_jspx_th_pega_reference__1.setFormat("pzGetRuleKeysNoClass");
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_19", "pyLoadingMessage", loadingSectionInfo);
}
}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString("[\"showMenu\",[{\"dataSource\":\"pzRuleformHeaderClassMenu\", \"isNavNLDeferLoaded\":\"false\", \"isNavTypeCustom\":\"false\", \"className\":\"" + tools.getStepPage().getClassName());
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771838558205");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzRuleformHeaderClassMenu", "", "pyNavigation1771838558205","", false, false, false, false);
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20140904004930601",true));
	if(false || (pzAuto.isOffline() && true) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","RuleFormHeader_$CTX$_9");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyClassName");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyClassName", ".pyActionPrompt");
	pyTooltip = ".pyClassName";
	modePage2.put("tooltip",pyTooltip);
	...
	String customStyles = null;
	String pyLabel = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyResourceLabel");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyResourceLabel", ".pyButtonLabel");
	pyLabel = ".pyResourceLabel";
	modePage2.put("pyLabel",pyLabel);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='RuleFormHeader_"+ referenceString+ "_9'";
	 String securedPropValue = null;
	 com.pega.pegarules.pub.security.PropertySecurityInfo propSecInfo = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().getPropertyInfoForDisplay(tools.getStepPage(),tools.getProperty(".pyResourceLabel"), tools);
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		 securedPropValue = tools.getProperty(".pyResourceLabel").getStringValue();
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771838558208");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzRuleformHeaderClassMenu", "", "pyNavigation1771838558208","", false, false, false, false);
			}catch(Exception e){oLog.error(e);}
			}
			tools.appendString("\"},\":event\"]");
		...
		tools.appendString("  title= '");
		 toolTipVal = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt",tools.getProperty(".pyClassName").getStringValue()+"\t"+repeatIndx,StreamBuilder.FMT_LITERAL)) + "' ";
		...
		tools.appendString(StringUtils.filterRichText(pzAuto.getUIComponentRuntime().getRuntimeContextTree().getDataBindingToken(tools.getProperty(".pyResourceLabel").getReference())));} else { checkForScriptTags_1(tools.getLocalizedTextForString(".pyButtonLabel",securedPropValue,StreamBuilder.FMT_LITERAL)); }
		tools.appendString(" <i aria-hidden='true'  data-click='.' class='" + classProp  +"'></i>");
		tools.appendString("</a>");		}
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyResourceLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing remove-bottom-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","primary-navigation-links","primary-navigation-links")  + " flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20140904004930601-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead rule_keys_dataLabelForRead","dataLabelForWrite rule_keys_dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	
	ClipboardProperty propActivePrev = tools.getActive();
	tools.putActive(tools.getStepPage().getProperty(".pyResourceLabel"));
	tools.appendString("for='" + tools.getHTMLIDForProperty(true,"label") + "'");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20140904004930601-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead rule_keys_dataLabelForRead","dataLabelForWrite rule_keys_dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140904004930601-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxLink");
	pgCells.put("forLabel",".pyResourceLabel");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired rule_keys_iconRequired");
	pgCells.put("labelReadClass","dataLabelForRead rule_keys_dataLabelForRead");
	pgCells.put("labelWriteClass","dataLabelForWrite rule_keys_dataLabelForWrite");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyResourceLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_2();labelName = "Resource:";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionRuleFormHeaderBBBB","",false);
}
...
public void simpleLayout_1() {
	...
	String[] arReturn;
	strPropertyValue=".pyClassName";
	arReturn = new String[2];
	if (com.pegarules.generated.pega_rules_decision.EvaluateExpression(null,tools.getPrimaryPage(),".pyClassName",arReturn)){
	strPropertyValue = arReturn[0];
	}else {
	strPropertyValue = "";
	}
	newParamsPage.putString("className", strPropertyValue);
	...
	keys.putString("pyActivityName", "pzPrepopulateResource");
	try{
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201904230717400723325") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
	...
	String paramName = "EXPANDEDSubSectionRuleFormHeaderBBBB";
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& wxUsesInheritance o2== rx.pyActivityType cqAUTOMATION", pxUniqueStreamHash+"_18");metadataPage.put("dlChild","true");
	metadataPage.put("lMode","SimpleDiv");
	if("".equals(methodName)) {
	containerComponent.forceReload();
	}
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pxWhenIdentifiers.put("pyVisibilityWhenId",pxUniqueStreamHash+"_18");
	metadataPage.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
	if(pyVisibility) {
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& wxUsesInheritance o2== rx.pyActivityType cqAUTOMATION","UsesInheritance && .pyActivityType == \'AUTOMATION\'", "layout", "visible" )) {pzSetExpandParam_5();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771838558193");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzRuleformHeaderClassMenu", "", "pyNavigation1771838558193","", false, false, false, false);
			}catch(Exception e){oLog.error(e);}
			}
			tools.appendString("\"},\":event\"]");
...
try {
	...
	modePage2.put("pyName","RuleFormHeader_$CTX$_6");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
	...
	String pyLabel = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyClassName");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyClassName", ".pyButtonLabel");
	pyLabel = ".pyClassName";
	modePage2.put("pyLabel",pyLabel);
	modePage2.put("captionType","propertyReference");
	if(expressionId !=null && expressionId.length() > 0){
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='RuleFormHeader_"+ referenceString+ "_6'";
	 String securedPropValue = null;
	 com.pega.pegarules.pub.security.PropertySecurityInfo propSecInfo = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().getPropertyInfoForDisplay(tools.getStepPage(),tools.getProperty(".pyClassName"), tools);
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
		 securedPropValue = propSecInfo.getPropValue();
	 }
	  if(securedPropValue == null) {
		 securedPropValue = tools.getProperty(".pyClassName").getStringValue();
	  }String localizedValForMenu = ""; String ariaLabel = "";try {localizedValForMenu = tools.getLocalizedTextForString(".pyCaption","menu");ariaLabel = StringUtils.filterRichText(securedPropValue);} catch(Exception e) {}
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20140904004930601") + " role='link' aria-haspopup='true' href='"+hrefValue+"'");tools.appendString(" aria-label='"+localizedValForMenu+" "+ariaLabel+"' ");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771838558196");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzRuleformHeaderClassMenu", "", "pyNavigation1771838558196","", false, false, false, false);
			}catch(Exception e){oLog.error(e);}
			}
			tools.appendString("\"},\":event\"]");
		...
		boolean hasLineBreaks = false;
		tools.appendString("");if(bOptimizedMarkup){
		tools.appendString(StringUtils.filterRichText(pzAuto.getUIComponentRuntime().getRuntimeContextTree().getDataBindingToken(tools.getProperty(".pyClassName").getReference())));} else { checkForScriptTags_1(tools.getLocalizedTextForString(".pyButtonLabel",securedPropValue,StreamBuilder.FMT_LITERAL)); }
		tools.appendString(" <i aria-hidden='true'  data-click='.' class='" + classProp  +"'></i>");
		tools.appendString("</a>");		}
menubarIncludes_1();		if(pzAuto.doOnlyOnce("ControlMenu")){
			if (!pzAuto.hasStaticContentJSOptimization() ) {
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& wxUsesInheritance o2!= rx.pyActivityType cqAUTOMATION","UsesInheritance && .pyActivityType != \'AUTOMATION\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyClassName",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing    " + pzSection.getCustomStyle(false, "","primary-navigation-links","primary-navigation-links")  + " flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	boolean isCellReadOnly = false;
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	ClipboardProperty propActivePrev = tools.getActive();
	tools.putActive(tools.getStepPage().getProperty(".pyClassName"));
	tools.appendString("for='" + tools.getHTMLIDForProperty(true,"label") + "'");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","CL:") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20140904004930601-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead rule_keys_dataLabelForRead","dataLabelForWrite rule_keys_dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","CL:") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140904004930601-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxLink");
	pgCells.put("forLabel",".pyClassName");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired rule_keys_iconRequired");
	pgCells.put("labelReadClass","dataLabelForRead rule_keys_dataLabelForRead");
	pgCells.put("labelWriteClass","dataLabelForWrite rule_keys_dataLabelForWrite");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxUsesInheritance o2!= rx.pyActivityType cqAUTOMATION",pxUniqueStreamHash+"_12");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_12");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","UsesInheritance && .pyActivityType != 'AUTOMATION'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Obj-Activity");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_12");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxUsesInheritance o2!= rx.pyActivityType cqAUTOMATION", pxUniqueStreamHash+"_12"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyClassName",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_1();}
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxUsesInheritance o2== rx.pyActivityType cqAUTOMATION",pxUniqueStreamHash+"_21");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxUsesInheritance o2== rx.pyActivityType cqAUTOMATION", pxUniqueStreamHash+"_21"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_2();
 tools.putSaveValue("ContainerID", "");}
...
public int simpleLayoutCell_5( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzGetRuleKeysNoClass",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("2014091903324008059348-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead rule_keys_dataLabelForRead","dataLabelForWrite rule_keys_dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","ID:") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2014091903324008059348-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead rule_keys_dataLabelForRead","dataLabelForWrite rule_keys_dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyTemplateInputBox" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","ID:") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_22")) {field_pzGetRuleKeysNoClass_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2014091903324008059348-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzGetRuleKeysNoClass");
	pgCells.put("forLabel",".pyTemplateInputBox");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pzGetRuleKeysNoClass",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_25")) {	field_pzGetRuleKeysNoClass_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "ID:";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_6( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= rx.pxObjClass cqRule-RuleSet-Name",".pxObjClass!=\'Rule-RuleSet-Name\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_2();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzRuleFormRuleset",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   flex '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
	tools.appendString("<label  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead rule_keys_dataLabelForRead","dataLabelForWrite rule_keys_dataLabelForWrite") + "' >");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","RS:") + "</label>");
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  ".pyRuleSet Changes || .pyRuleSetName Changes",expressionId);
		 String pyCustomRequireFormat= "";
		pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
		String baseRef ="";
		boolean pyDLCellVisibility = false;
		...
		isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
		if (!isExpression && isOffline) {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pxObjClass cqRule-RuleSet-Name",pxUniqueStreamHash+"_28");
		pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_28");
		pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pxObjClass!='Rule-RuleSet-Name'");
		pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Obj-Activity");
		pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
		} else {
		pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_28");
		...
		pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pxObjClass cqRule-RuleSet-Name", pxUniqueStreamHash+"_28"); 
		}
		if(pyDLCellVisibility) {
		String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzRuleFormRuleset",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");
		if(!inspectorData.isEmpty()) {
		pgCells.put("liveUI",inspectorData);
		}
		String tempRenderSingle = "";
...
public int simpleLayoutCell_7( int index) {
		...
		String ariahiddenString = "";
		String baseRef ="";
		if(!pzAuto.handleEvaluateWhen(" wxpzIsEnableViewCategories","pzIsEnableViewCategories","cell", "visible" )) {
			pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
			return index;
		}
		generateClientWhenDiv_1();
		tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","primary-navigation-links","primary-navigation-links")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_7( int index) {
		...
		pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201801241506070186992-Label")).append(" ").toString().replace("data-test-id=","").trim());
		pgCells.put("format","pxLink");
		pgCells.put("forLabel",".pyTemplateInputBox");
		pgCells.put("pyAutoHTML","true");
		pgCells.put("spanClass","iconRequired rule_keys_iconRequired");
		...
		isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
		if (!isExpression && isOffline) {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzIsEnableViewCategories",pxUniqueStreamHash+"_34");
		pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_34");
		pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzIsEnableViewCategories");
		pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Obj-Activity");
		pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
		} else {
		pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_34");
		...
		pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzIsEnableViewCategories", pxUniqueStreamHash+"_34"); 
		}
		if(pyDLCellVisibility) {
		String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5)");
		if(!inspectorData.isEmpty()) {
		pgCells.put("liveUI",inspectorData);
		}
		pxLink_3();}
...
pzSection.getLayout().setExpandParam("SubSectionRuleFormHeaderBBB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201804100712390931254") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","rule-details");
		pg_dlmeta.put("format","inline_labels_left");
	...
	String paramName = "EXPANDEDSubSectionRuleFormHeaderBBB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpzDelegateHeader", pxUniqueStreamHash+"_35");metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpzDelegateHeader","!pzDelegateHeader", "layout", "visible" )) {pzSetExpandParam_4();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_2() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzRuleFormKeysAndDescription", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzRuleFormKeysAndDescription"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellRuleFormHeader772","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pzRuleFormKeysAndDescription", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzRuleFormKeysAndDescription",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzRuleFormKeysAndDescription",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
public int simpleLayoutCell_8( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o1! wxpzDelegateHeader","!pzDelegateHeader","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxpzDelegateHeader",pxUniqueStreamHash+"_37");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_37");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","!pzDelegateHeader");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Obj-Activity");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_37");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpzDelegateHeader", pxUniqueStreamHash+"_37"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_4();
 tools.putSaveValue("ContainerID", "");}
...
pzSection.getLayout().setExpandParam("SubSectionRuleFormHeaderBB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201804100712390930664") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-simple_list content-simple_list header-row" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","header-row");
	...
	String paramName = "EXPANDEDSubSectionRuleFormHeaderBB";
	metadataPage.put("paramName", paramName);
...
pzSection.getLayout().setExpandParam("SubSectionRuleFormHeaderB","",false);
}
...
public void simpleLayout_5() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20180410071239067337") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  auto-width-column layout-content-inline_middle content-inline_middle flex-grow-1-item-2" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","flex-grow-1-item-2");
	...
	String paramName = "EXPANDEDSubSectionRuleFormHeaderB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("prefix","-ruleform_header");
	metadataPage.put("sectionIndex","1");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	metadataPage.put("lMode","Flexbox");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-ACTIVITY RULEFORMHEADER #20190423T140521.840 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "RuleFormHeader");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-ACTIVITY RULEFORMHEADER #20190423T140521.840 GMT", "Rule-Obj-Activity RuleFormHeader", "Pega-Desktop", "08-03-01", "20190423T140521.840 GMT");
}
