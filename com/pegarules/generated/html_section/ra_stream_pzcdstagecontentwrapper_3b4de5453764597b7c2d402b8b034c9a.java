...
/**
 * Builds JSP stream EMBED-CASEPERSONA!PZCDSTAGECONTENTWRAPPER.
 */
public class ra_stream_pzcdstagecontentwrapper_3b4de5453764597b7c2d402b8b034c9a extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzCDStageContentWrapper.Embed_CasePersona.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1581970135;
 ...
 */
	public ra_stream_pzcdstagecontentwrapper_3b4de5453764597b7c2d402b8b034c9a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "102906c8f198a9ff345f21f939efefe3548496ea";
...
{
/* Instance RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENTWRAPPER #20200330T095422.509 GMT	Pega-AppDefinition:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "102906c8f198a9ff345f21f939efefe3548496ea";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzCDStageContentWrapper",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENTWRAPPER #20200330T095422.509 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENTWRAPPER #20200330T095422.509 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENTWRAPPER #20200330T095422.509 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZCDSTAGECONTENTWRAPPER"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCDSTAGECONTENTWRAPPER","Rule-HTML-Section","EMBED-CASEPERSONA",false,"","Pega-AppDefinition","08-05-01","RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENTWRAPPER #20200330T095422.509 GMT","!PZCDSTAGECONTENTWRAPPER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1581970135)
	};
...
//	RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENTWRAPPER #20200330T095422.509 GMT:20200612T144001.086 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "d79e6ce4933adb505141d78f5bdea3b9";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzCDStageContentWrapper",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzCDStageContentWrapper','insKey':'RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENTWRAPPER #20200330T095422.509 GMT','sectionType':'standard'}");
pzLayout_3();
...
tools.appendString("<div class='layout layout-noheader layout-noheader-case_designer_process'>");
...
public void buildSection_5() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_15","pzAddChannel", secInfo);
}
...
public void sectionIncludeInCell_pzAddChannel_1(){

sectionBodyIncludeInCell_5(false,false,"","pzAddChannel");elementModel_1("pzAddChannel","pzCDStageContentWrapper","","");
 } 
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("SUB_SECTION","pzAddChannel",".pySections(2).pySectionBody(3).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","addInnerElement","addInnerElement"), "width:100%;",false," o1! wxpzIsSelectedContextDisabled","!pzIsSelectedContextDisabled");if(pzAuto.handleEvaluateWhen(" o1! wxpzIsSelectedContextDisabled","!pzIsSelectedContextDisabled", "cell", "visible" )) {sectionIncludeInCell_pzAddChannel_1();}
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>\n\n\t\t\t\t\t\t</div>");
...
throw new RuntimeException("Problem in JSP fragment", t);
	 ...
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("SUB_SECTION","pzCDStepContentWrapper", ".pySections(2).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString(" class='");
	...
	tools.appendString("height:35px;");if(Integer.parseInt(tools.getSaveValue("rowsDisplayed")) == 1) {tools.appendString("width:"); if(!tools.getParamValueCSF("PpyChannels2colWidthCache1").equals("")) { tools.appendParamCSF("PpyChannels2colWidthCache1");} else { tools.appendString("auto;"); }}tools.appendString(""); tools.appendString("'>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("height:22px;");tools.appendString("width:"); if(!tools.getParamValueCSF("PpyChannels2colWidthCache1").equals("")) { tools.appendParamCSF("PpyChannels2colWidthCache1");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
...
pzSection.getLayout().setExpandParam("SubSectionpzCDStageContentWrapperBB","",false);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'REPEATGRID','pgRef':'.pySections(2)'}") + " class='layout layout-outline layout-outline-case_designer_process' id='EXPAND-OUTERFRAME' ");
String gridLayoutMethodName = tools.getParamValue("gridLayoutMethodName");
String expandParameter = "EXPANDEDSubSectionpzCDStageContentWrapperBB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pyChannelsL9=null;

 Map selUniqMap_pyChannelsL9 = null;

 Set filteredIndicesSet_pyChannelsL9 = null;

	 String strFCPage = "pyFilterCriteria_"+tools.getStepPage().getReference()+".pyChannels_pzCDStageContentWrapper_2";
...
if(tools.getParamValue("pyGridFilterCriteriaPage").equals("")){
	 ...
	 gFCritPage_pyChannelsL9 = tools.findPage(strFCPage, true);

	 if(gFCritPage_pyChannelsL9==null){gFCritPage_pyChannelsL9 = tools.createPage("Pega-GridFilterCriteria", strFCPage);}

tools.putParamValue("pyGridFilterCriteriaPage", strFCPage);

gFCritPage_pyChannelsL9.getProperty("pyRowVisibleWhenCondition").setValue("pzShowChannel");

  selUniqMap_pyChannelsL9 = null; // reset the variable

 if(gFCritPage_pyChannelsL9 != null){ 

 		 filteredIndicesSet_pyChannelsL9 = pega_uiengine_uiengine.pzPopulateFilteredindicesMap(gFCritPage_pyChannelsL9, ".pyChannels");

 		 tools.getParameterPage().put("filteredIndicesSet", filteredIndicesSet_pyChannelsL9);

 tools.putParamValue("populateSelectedUIValues", "true");

 		 selUniqMap_pyChannelsL9 = pega_uiengine_uiengine.pzPopulateSelectedValues(gFCritPage_pyChannelsL9); 

 		 tools.getParameterPage().put("selUniqMap_pyChannelsL9", selUniqMap_pyChannelsL9);

 tools.putParamValue("populateSelectedUIValues", "");

 }
tools.appendString("<div  section_index='2' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyChannels");tools.appendString("_pzCDStageContentWrapper_2'");
...
tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("202003310405250486669") + " ");
...
Map selUniqMap_pyChannelsL9 = null;
selUniqMap_pyChannelsL9 = null; // reset the variable
gFCritPage_pyChannelsL9=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));
		 selUniqMap_pyChannelsL9 = (Map)tools.getParameterPage().getObject("selUniqMap_pyChannelsL9");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pyChannels");
					...
					tools.appendString("' gPropIndex='PpyChannels2' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("202003310405250486669-layout") + " ");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpyChannels2colWidthGBL\" id=\"PpyChannels2colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyChannels2colWidthGBL"));tools.appendString("\" />");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpyChannels2colWidthGBR\" id=\"PpyChannels2colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyChannels2colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpyChannels2colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='' PL_PROP='");

					
tools.appendString(".pyChannels");

					tools.appendString("' PL_PROP_CLASS='Embed-CaseChannel' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pyChannels").iterator(); 
					...
					Set filteredResultsSet = (HashSet)tools.getParameterPage().getObject("filteredResultsSet");boolean bFilterResult = false;
										 ...
										 } else if(gFCritPage_pyChannelsL9!= null){ 
													 bFilterResult = pega_uiengine_uiengine.pzMatchesGridFilterCriteria(gFCritPage_pyChannelsL9, selUniqMap_pyChannelsL9);
										 }
										 if (gFCritPage_pyChannelsL9== null || 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pyChannels\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals(".pyChannels")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodes.pyChannels2") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 

					if (tempTestID != null && !tempTestID.isEmpty() && !tempTestID.equals("")){

					String strEntryHandlePLProp = "";

					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle(".pyChannels"); } catch (Exception ex) { }
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("202003310405250486669-" + rowTestID) + " ");
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"1\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("Embed-CaseChannel", "tempNoRespg");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pyChannels2") && tools.getParamValue("partialRefresh").equals("false")) {
...
public void buildSection_4() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_13","pzCDStageContent", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pzCDStageContent"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzCDStageContentWrapper9","",false);
}
...
public void buildSection_3() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_9","pzCDStageContent", secInfo);
}
...
public void buildSection_2() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_8","pzCDStageContent", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzCDStageContentWrapper509","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pzCDStageContent", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzCDStageContent",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","padding-lr-0_5x","padding-lr-0_5x")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("customROStyles","padding-lr-0_5x");
	pgCells.put("customRWStyles","padding-lr-0_5x");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzCDStageContent",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzCDStageContent",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","focusElement padding-lr-0_5x","focusElement padding-lr-0_5x")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","focusElement padding-lr-0_5x");
	pgCells.put("customRWStyles","focusElement padding-lr-0_5x");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzCDStageContent",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzCDStageContentWrapperB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202004010206050966568") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzCDStageContentWrapperB";
...
public void pzCDStepContentWrapper_1() {
pzAuto.emitIncludeStreamReference("pzCDStepContentWrapper", null, !tools.hasInputEnabled()?"NoInput":"Input", "Rule-HTML-Section", null);
}
...
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pyChannelID,.pyRelease,.pyIsDone\" RW=\".pyChannelID Changes || .pyRelease Changes || .pyIsDone Changes\"");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
}
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyChannelID"), -1);
		changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyRelease"), -1);
		changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyIsDone"), -1);
	}
}catch(Exception e){}
}
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyChannels2")|| tools.getParamValue("partialTrigger").equals("editRow.pyChannels2") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pyChannels");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pyChannels\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pyChannels2")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty(".pyChannels");
 ...
 if(tools.getParamValue("partialTrigger").equals("filterpopup.pyChannels2")) { 
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyChannels2") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENTWRAPPER #20200330T095422.509 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzCDStageContentWrapper");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENTWRAPPER #20200330T095422.509 GMT", "Embed-CasePersona pzCDStageContentWrapper", "Pega-AppDefinition", "08-05-01", "20200612T144001.086 GMT");
}
