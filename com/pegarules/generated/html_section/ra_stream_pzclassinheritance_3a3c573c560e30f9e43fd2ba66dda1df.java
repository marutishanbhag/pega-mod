...
/**
 * Builds JSP stream RULE-OBJ-CLASS!PZCLASSINHERITANCE.
 */
public class ra_stream_pzclassinheritance_3a3c573c560e30f9e43fd2ba66dda1df extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzClassInheritance.Rule_Obj_Class.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 263319336;
 ...
 */
	public ra_stream_pzclassinheritance_3a3c573c560e30f9e43fd2ba66dda1df(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "c6408debe92aad7adc49c9f3c352238fdcc6ae28";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-CLASS PZCLASSINHERITANCE #20180713T135652.583 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "c6408debe92aad7adc49c9f3c352238fdcc6ae28";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzClassInheritance",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-CLASS PZCLASSINHERITANCE #20180713T135652.583 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-CLASS PZCLASSINHERITANCE #20180713T135652.583 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-CLASS PZCLASSINHERITANCE #20180713T135652.583 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZCLASSINHERITANCE", 
	"Rule-Obj-Property:PYPATTERNINHERITANCE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCLASSINHERITANCE","Rule-HTML-Section","RULE-OBJ-CLASS",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION RULE-OBJ-CLASS PZCLASSINHERITANCE #20180713T135652.583 GMT","!PZCLASSINHERITANCE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",263319336), 
		new DependentRuleInfo("PYPATTERNINHERITANCE","Rule-Obj-Property","RULE-OBJ-CLASS",true,"Rule-Obj-Class","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYPATTERNINHERITANCE #20180713T131301.602 GMT","!PYPATTERNINHERITANCE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE-OBJ-CLASS PZCLASSINHERITANCE #20180713T135652.583 GMT:20180713T135652.583 GMT
...
//	RULE-FILE-BINARY WEBWB DHTMLX_ICONCHECKDIS!GIF #20180713T131519.859 GMT:20180713T131519.859 GMT
//	RULE-FILE-BINARY WEBWB DHTMLX_ICONUNCHECKDIS!GIF #20180713T131519.861 GMT:20180713T131519.861 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYPATTERNINHERITANCE #20180713T131301.602 GMT:20180713T131301.602 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "352ad39c30400f19e998dd8f12659d25";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzClassInheritance",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzClassInheritance','insKey':'RULE-HTML-SECTION RULE-OBJ-CLASS PZCLASSINHERITANCE #20180713T135652.583 GMT','sectionType':'null'}");
...
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pyDerivesFrom\" RW=\".pyDerivesFrom != ''\"");
} catch(Throwable t) {
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyDerivesFrom"), -1);
	}
}catch(Exception e){}
}
public void buildSection_1() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  ".pyDerivesFrom != \'\'", expressionId);
		if(StringUtils.isBlank(expressionId)) {
			...
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzParentClass", secInfo);
		}
...
public void includeSectionBody_1() { 
	...
	"pzParentClass", tools.getStepPage().getReference(),"Rule-Obj-Class");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	generateClientWhenDiv_1();
	tools.putParamValue("section_params","");
	
	String includedSectionName = "";includedSectionName = "pzParentClass";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
	tools.appendString("\n\t\t\t\t\t\t</div>");
	}
}
public void pzSetExpandParam_2() {
pzSection.getLayout().setExpandParam("SubSectionpzClassInheritanceBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzClassInheritanceBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzParentClass'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzParentClass'}") + ">");
}
pzSetExpandParam_2();
...
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2014092305483801375127") + "  ");
...
public void inclFormattedVal_2(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {
		...
		String formattedValue = pega_uiengine_formatter.pxFormatTrueFalse((isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true)),"True","False",false,"image","webwb/dhtmlx_iconcheckdis_13603858786.gif!!.gif","webwb/dhtmlx_iconuncheckdis_12084209932.gif!!.gif");
...
tools.putParamValue("isControlEditableOriginal", true);
	boolean isEditable = pzAuto.getSection().getControl().isControlEditable(true, "pzHasAClassGroup");
	boolean isControlEditable = isEditable;tools.putParamValue("isControlEditableOriginal", isEditable);
	if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y') {
		String strROWhenCode = " wxpzHasAClassGroup";
...
if (!"".equals(rptDynamicIdx)) {
	pegaRLindex += "_rdi_" + rptDynamicIdx;
		...
		tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyPatternInheritance").getEntryHandle(),"entryHandle"));} else{
		tools.appendString(tools.getActive().getEntryHandle());}
		tools.appendString("' ");tools.appendString(disabled_ctrl);

		tools.appendString(" /><input type='checkbox'  " + pzCell.getTestIdIfEnabled("2014092305483801364419") + "   class='checkbox chkBxCtl"+errorClass+"' value='true' ");if(bOptimizedMarkup){  tools.appendString(" data-bindprops='value' "); }
		String checkboxName = ""; tools.appendString(" name='");if(bOptimizedMarkup){
		tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyPatternInheritance").getEntryHandle(),"entryHandle"));
		checkboxName = StringUtils.crossScriptingFilter(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyPatternInheritance").getEntryHandle(),"entryHandle"));} else{
		tools.appendString(tools.getActive().getEntryHandle());
		...
		tools.appendString(propName.substring(propName.lastIndexOf(".")+1)+pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyPatternInheritance").getReference(),"",true)+"' data-ctl='Checkbox' ");} else{
		...
		tools.appendString(propName.substring(propName.lastIndexOf(".")+1)+pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyPatternInheritance").getReference(),"",true)+"' ");} else{
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2014092305483801364419") + " ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")){inclFormattedVal_2(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
public void layoutBody_1() { 
	tools.appendString("<table role='presentation' " + pzSection.getLayout().getInspectorData("true",".pySections(1)") + "  section_index='1'  cellpadding='0' cellspacing='0' ID='ClassInheritance'>");
	
	/*Row Begin*/
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxCheckbox",".pyPatternInheritance",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(true,"pzHasAClassGroup","dataValueRead",pzSection.getValueStyle()), "width:20px;",false,"","");tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","");	pxCheckbox_1(".pyPatternInheritance",0,"","","True-False");
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "width:169px;",false,"","");tools.appendString("<nobr>");
	labelIncludeInCell_1("","","","",false,"Find by name first (Pattern)",false,false,"Standard",false);
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
...
pzSection.getLayout().setExpandParam("SubSectionpzClassInheritanceB","",false);
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-CLASS PZCLASSINHERITANCE #20180713T135652.583 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzClassInheritance");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-CLASS PZCLASSINHERITANCE #20180713T135652.583 GMT", "Rule-Obj-Class pzClassInheritance", "Pega-SystemArchitect", "08-01-01", "20180713T135652.583 GMT");
}
