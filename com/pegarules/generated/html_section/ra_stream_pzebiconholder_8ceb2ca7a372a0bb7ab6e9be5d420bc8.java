...
/**
 * Builds JSP stream PEGAGADGET-EXPRESSIONBUILDER!PZEBICONHOLDER.
 */
public class ra_stream_pzebiconholder_8ceb2ca7a372a0bb7ab6e9be5d420bc8 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzEBIconHolder.PegaGadget_ExpressionBuilder.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1469555885;
 ...
 */
	public ra_stream_pzebiconholder_8ceb2ca7a372a0bb7ab6e9be5d420bc8(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "4d6af573de80d6a46df38994c79c34579fafd4fe";
...
{
/* Instance RULE-HTML-SECTION PEGAGADGET-EXPRESSIONBUILDER PZEBICONHOLDER #20180713T133454.834 GMT	Pega-Gadgets:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "4d6af573de80d6a46df38994c79c34579fafd4fe";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzEBIconHolder",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGAGADGET-EXPRESSIONBUILDER PZEBICONHOLDER #20180713T133454.834 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGAGADGET-EXPRESSIONBUILDER PZEBICONHOLDER #20180713T133454.834 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGAGADGET-EXPRESSIONBUILDER PZEBICONHOLDER #20180713T133454.834 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZEBICONHOLDER", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZEBICONHOLDER","Rule-HTML-Section","PEGAGADGET-EXPRESSIONBUILDER",false,"","Pega-Gadgets","08-01-01","RULE-HTML-SECTION PEGAGADGET-EXPRESSIONBUILDER PZEBICONHOLDER #20180713T133454.834 GMT","!PZEBICONHOLDER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1469555885), 
...
//	RULE-HTML-SECTION PEGAGADGET-EXPRESSIONBUILDER PZEBICONHOLDER #20180713T133454.834 GMT:20180713T133454.834 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "3da395a50a8efda9c0e904a066dee428";
	}

	public String getDefinitionAppliesToClass() {
		return "PegaGadget-ExpressionBuilder";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzEBIconHolder",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzEBIconHolder','insKey':'RULE-HTML-SECTION PEGAGADGET-EXPRESSIONBUILDER PZEBICONHOLDER #20180713T133454.834 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
...
public void field_pzEBHiddenElement_4() { 
try {

/*
 * reference tag
 * Cannot inline because: included stream is too big: 22689 bytes
 */
/* pega:reference */
...
_jspx_th_pega_reference__4.setFormat("pzEBHiddenElement");
...
public void field_pzEBHiddenElement_3() { 
try {
...
_jspx_th_pega_reference__3.setFormat("pzEBHiddenElement");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"showExpressionBuilderNewEB(event)\"]");
		...
		keyMap.putString("pyActionName", "pzCEExpressionBuilder");
		...
		try{
		pzPackageRuntime.packageLocalAction("pzCEExpressionBuilder", offlineUsingPage , strLAClassName);
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("pzEBIconHolder",
				...
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pzCEExpressionBuilder\",\"overlay\",\":event\",\"\",\""+streamType+"\",\"pz-po-c-dt_exp_builder\",\"pyEBModalTemplate\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-bottom%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"true\",\"true\",\"\",\"\"]");
					} else {
...
try {
	...
	cellPage.put("pyStreamName","pzEBIconHolder");
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Build an expression\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Build an expression", ".pyActionPrompt");
	}
	pyTooltip = "Build an expression";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2015010501231200418463") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzEBIconHolder_"+ referenceString+ "_4'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Build an expression\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015010501231200418463") + "  href='"+hrefValue+"' ");
		tools.appendString("onclick='pd(event);' ");
		tools.appendString("data-ctl='Icon'"); tools.appendString(" class='");
		tools.appendString("iconExplore' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015010501231200418463-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzEBHiddenElement",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20141106035424032111996-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20141106035424032111996-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyTemplateInputBox" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
...
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_17")) {field_pzEBHiddenElement_3();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20141106035424032111996-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzEBHiddenElement");
	pgCells.put("forLabel",".pyTemplateInputBox");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pzEBHiddenElement",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_20")) {	field_pzEBHiddenElement_4();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzEBIconHolderBB","",false);
}
...
public void simpleLayout_2() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + " content  set-width-auto layout-content-inline_middle content-inline_middle " + "'   style='height:22px;'");
		...
		pg_dlmeta.put("inlinestyle","height:22px;");
	...
	String paramName = "EXPANDEDSubSectionpzEBIconHolderBB";
	metadataPage.put("paramName", paramName);
	metadataPage.put("floatClass"," float-left set-width-auto");
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rx.pyIsLaunchAsOverlay cttrue", pxUniqueStreamHash+"_21");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if(pzAuto.handleEvaluateWhen(" o2== rx.pyIsLaunchAsOverlay cttrue",".pyIsLaunchAsOverlay == true", "layout", "visible" )) {pzSetExpandParam_2();
...
if(pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
tools.putParamValue("pyInlineStyleSec","height:22px;");
pzLayoutContainer_2();
...
public void field_pzEBHiddenElement_2() { 
try {
...
_jspx_th_pega_reference__2.setFormat("pzEBHiddenElement");
...
public void field_pzEBHiddenElement_1() { 
try {
...
_jspx_th_pega_reference__1.setFormat("pzEBHiddenElement");
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				...
				if(("").equals(usingPage)) { usingPage = tools.getStepPage().getReference(); }
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pzCEExpressionBuilder\",\"true\",\":event\",\"\",\""+streamType+"\",\"large_fixed_modal\",\"pzModalTemplate\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-bottom%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
					} else {
						tools.appendString("[\"processAction\", [\"You are not authorized to perform this Flow or Local action\"]");
						}
						}

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }						tools.appendString("[\"runScript\", [\"updateValueOnScreenFromEB()\"]");
...
try {
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzEBIconHolder_"+ referenceString+ "_1'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzEBHiddenElement",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
...
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_7")) {field_pzEBHiddenElement_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pzEBHiddenElement",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_10")) {	field_pzEBHiddenElement_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzEBIconHolderB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  set-width-auto layout-content-inline_middle content-inline_middle " + "'   style='height:22px;'");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzEBIconHolderB";
	metadataPage.put("paramName", paramName);
	metadataPage.put("floatClass"," float-left set-width-auto");
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= rx.pyIsLaunchAsOverlay cttrue", pxUniqueStreamHash+"_11");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= rx.pyIsLaunchAsOverlay cttrue",".pyIsLaunchAsOverlay!=true", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	oPropDefinitions_1.put("PegaGadget-ExpressionBuilder.pyTemplateInputBox", new LiteweightPropertyDefinition("PegaGadget-ExpressionBuilder", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pyClassName", "PegaGadget-ExpressionBuilder");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGAGADGET-EXPRESSIONBUILDER PZEBICONHOLDER #20180713T133454.834 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzEBIconHolder");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGAGADGET-EXPRESSIONBUILDER PZEBICONHOLDER #20180713T133454.834 GMT", "PegaGadget-ExpressionBuilder pzEBIconHolder", "Pega-Gadgets", "08-01-01", "20180713T133454.834 GMT");
}
