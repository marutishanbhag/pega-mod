...
/**
 * Builds JSP stream DATA-PORTAL-PEGAADMINSTUDIO-AGENTSWIDGET!PYDASHBOARDWIDGET.
 */
public class ra_stream_pydashboardwidget_cf6c4f08ba85c93a97daf94bf6f181d0 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyDashboardWidget.Data_Portal_PegaAdminStudio_AgentsWidget.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1442966848;
 ...
 */
	public ra_stream_pydashboardwidget_cf6c4f08ba85c93a97daf94bf6f181d0(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "8e3b98b6eec7a991bd2091db7c0f08939704e165";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-AGENTSWIDGET PYDASHBOARDWIDGET #20190327T100827.536 GMT	Pega-Desktop:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "8e3b98b6eec7a991bd2091db7c0f08939704e165";
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-AGENTSWIDGET PYDASHBOARDWIDGET #20190327T100827.536 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-AGENTSWIDGET PYDASHBOARDWIDGET #20190327T100827.536 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-AGENTSWIDGET PYDASHBOARDWIDGET #20190327T100827.536 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDASHBOARDWIDGET","Rule-HTML-Section","DATA-PORTAL-PEGAADMINSTUDIO-AGENTSWIDGET",false,"","Pega-Desktop","08-03-01","RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-AGENTSWIDGET PYDASHBOARDWIDGET #20190327T100827.536 GMT","!PYDASHBOARDWIDGET",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1442966848)
	};
...
//	RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-AGENTSWIDGET PYDASHBOARDWIDGET #20190327T100827.536 GMT:20190327T100827.536 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "0791ee27cc718843aa11910eb7d8c792";
	}

	public String getDefinitionAppliesToClass() {
		return "Data-Portal-PegaAdminStudio-AgentsWidget";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyDashboardWidget",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyDashboardWidget','insKey':'RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-AGENTSWIDGET PYDASHBOARDWIDGET #20190327T100827.536 GMT','sectionType':'standard'}");
pzLayout_3();
pzLayout_5();
...
config.put("harnessName", "pzAgentsMain");
config.put("className", "Pega-Ext-AdminStudio-Explorer-Resources-Agents");
config.put("preActivity", "pzCreateAgentManagementPage");
...
public int simpleLayoutCell_5( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Not privileged for Agents") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	labelName = "Not privileged for Agents";
...
public void simpleLayout_5() {
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpzCanManageAgents", pxUniqueStreamHash+"_20");metadataPage.put("lMode","Flexbox");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpzCanManageAgents","!pzCanManageAgents", "layout", "visible" )) {pzSetExpandParam_4();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public int simpleLayoutCell_2( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Agents") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("201805041107100557179219")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	try{
	tools.appendString(StringUtils.crossScriptingFilter(tools.getLocalizedTextForParameterizedString("pyCaption",tools.getProperty(".pyTotalAgents").getStringValue())));
	}catch(Exception ex){
	if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() !='N' ){
	labelName =  ".pyTotalAgents";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	}else{
	tools.appendString(tools.getLocalizedTextForString(".pyCaption",".pyTotalAgents"));
	}
	}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201805041107100557179219")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("spanClass","iconRequired _iconRequired");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	tools.appendString("],[\"showHarnessWrapper\",[\"newDocument\",\"");
		...
		tools.appendFormatted("Pega-Ext-AdminStudio-Explorer-Resources-Agents",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");

		tools.appendFormatted("pzAgentsMain",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");

		tools.appendFormatted("pzCreateAgentManagementPage",StreamBuilder.FMT_NORMAL);	tools.appendString("\",");
{com.google.gson.JsonObject jObject = new com.google.gson.JsonObject();com.google.gson.JsonObject propRefJSON = new com.google.gson.JsonObject();{jObject.addProperty("", "");}if(!"{}".equals(propRefJSON.toString())){jObject.add("preActivityDynamicParams",propRefJSON);}
		...
		tools.appendFormatted(tools.getLocalizedTextForString("pyCaption", "Agents"),StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzPackageRuntime.packageHarness("pzAgentsMain",
	"Pega-Ext-AdminStudio-Explorer-Resources-Agents"
	,"Display","0");
	}
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  pointer  layout-content-default content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
...
{com.google.gson.JsonObject jObject = new com.google.gson.JsonObject();com.google.gson.JsonObject propRefJSON = new com.google.gson.JsonObject();{jObject.addProperty("", "");}if(!"{}".equals(propRefJSON.toString())){jObject.add("preActivityDynamicParams",propRefJSON);}
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzCanManageAgents", pxUniqueStreamHash+"_13");metadataPage.put("lMode","Flexbox");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzCanManageAgents","pzCanManageAgents", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Data-Portal-PegaAdminStudio-AgentsWidget");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-AGENTSWIDGET PYDASHBOARDWIDGET #20190327T100827.536 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-AGENTSWIDGET PYDASHBOARDWIDGET #20190327T100827.536 GMT", "Data-Portal-PegaAdminStudio-AgentsWidget pyDashboardWidget", "Pega-Desktop", "08-03-01", "20190327T100827.536 GMT");
}
