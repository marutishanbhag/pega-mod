...
/**
 * Builds JSP stream DATA-PORTAL-PEGAADMINSTUDIO!PZADMINSTUDIOPANEL.
 */
public class ra_stream_pzadminstudiopanel_823d4b50b33460193f8e6b3c4a70124f extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzAdminStudioPanel.Data_Portal_PegaAdminStudio.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1063867657;
 ...
 */
	public ra_stream_pzadminstudiopanel_823d4b50b33460193f8e6b3c4a70124f(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "938917dc077438009fdf549cd52410b741cec63e";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PZADMINSTUDIOPANEL #20180713T135157.802 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "938917dc077438009fdf549cd52410b741cec63e";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzAdminStudioPanel",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PZADMINSTUDIOPANEL #20180713T135157.802 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PZADMINSTUDIOPANEL #20180713T135157.802 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PZADMINSTUDIOPANEL #20180713T135157.802 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZADMINSTUDIOPANEL", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZADMINSTUDIOPANEL","Rule-HTML-Section","DATA-PORTAL-PEGAADMINSTUDIO",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PZADMINSTUDIOPANEL #20180713T135157.802 GMT","!PZADMINSTUDIOPANEL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1063867657), 
...
//	RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PZADMINSTUDIOPANEL #20180713T135157.802 GMT:20180718T015644.619 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "9baf454ea11e1a972b35613103096aae";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzAdminStudioPanel",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzAdminStudioPanel','insKey':'RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PZADMINSTUDIOPANEL #20180713T135157.802 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
pzLayout_3();
...
if (_jspx_meth_pega_param__1(pageContext, "width", "28")) {
	return true;
}
if (_jspx_meth_pega_param__2(pageContext, "OperatorID", "OperatorID.pyUserIdentifier")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "height", "28")) {
	return true;
}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	tools.appendString("[\"showMenu\",[{\"dataSource\":\"pzWksMenu\", \"isNavNLDeferLoaded\":\"false\", \"isNavTypeCustom\":\"false\", \"className\":\"" + tools.getStepPage().getClassName());
	...
	tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1713510282638");
	if(pzAuto.isOffline() || false) {
	try{
	pega_uiengine_pzcontrol.pzGetMenu("pzWksMenu", "", "pyNavigation1713510282638","", false, false, false, false);
	...
	tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1713510282639");
	if(pzAuto.isOffline() || false) {
	try{
	pega_uiengine_pzcontrol.pzGetMenu("pzWksMenu", "", "pyNavigation1713510282639","", false, false, false, false);
	}catch(Exception e){oLog.error(e);}
	}
	tools.appendString("\"},\":event\"]");
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxOperatorImage",".pyTemplateInputBox",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " data-tour-id='20140927131516034856137' class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","operator-icon","operator-icon")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_5")) {	field_pxOperatorImage_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("tourId"," data-tour-id='20140927131516034856137'");
	pgCells.put("partialClass","remove-all-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20160307085828011768270-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxOperatorImage");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","operator-icon");
	pgCells.put("customRWStyles","operator-icon");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxOperatorImage",".pyTemplateInputBox",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8")) {	field_pxOperatorImage_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzAdminStudioPanelBBB","",false);
}
...
pzStatic_ControlMenu.emitContent();
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201801021024040334442") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3)'}") + " class='" + "flex  content  pointer has-action layout-content-simple_list content-simple_list explorer-bottom-icons" + "'  ");
		...
		tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1713510282640");
		if(pzAuto.isOffline() || false) {
		try{
		pega_uiengine_pzcontrol.pzGetMenu("pzWksMenu", "", "pyNavigation1713510282640","", false, false, false, false);
		}catch(Exception e){oLog.error(e);}
		}
		tools.appendString("\"},\":event\"]");
		...
		tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1713510282641");
		if(pzAuto.isOffline() || false) {
		try{
		pega_uiengine_pzcontrol.pzGetMenu("pzWksMenu", "", "pyNavigation1713510282641","", false, false, false, false);
		}catch(Exception e){oLog.error(e);}
		}
		tools.appendString("\"},\":event\"]");
		...
		pg_dlmeta.put("customClassName","explorer-bottom-icons");
	...
	String paramName = "EXPANDEDSubSectionpzAdminStudioPanelBBB";
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzAdminStudioPanelInc", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "pzAdminStudioPanelInc";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_2() {
pzSection.getLayout().setExpandParam("SubSectionpzAdminStudioPanelBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzAdminStudioPanelBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzAdminStudioPanelInc'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzAdminStudioPanelInc'}") + ">");
}
pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_1() { 
	Map<String, Object> secInfo = new HashMap<String, Object>();
	secInfo.put("usingPage","D_pzAdminStudioExplorer");
	secInfo.put("isUsingPagePropertyRef",false);
	secInfo.put("doNotConsiderDecParams",false);
	secInfo.put("keepStreamProperties",false);
	secInfo.put("preserveParamState",false);
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_2","pzAdminStudioExplorer", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String strSectionPageProp = "";
	tools.putParamValue("section_params","");
	{tools.putParamValue("decParamList","{}");tools.putParamValue("sectionPageNameBase","D_pzAdminStudioExplorer");}
	String includedSectionName = "";includedSectionName = "pzAdminStudioExplorer";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"D_pzAdminStudioExplorer",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzAdminStudioPanelB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzAdminStudioPanelB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzAdminStudioExplorer'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzAdminStudioExplorer'}") + ">");
}
pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	oPropDefinitions_1.put("Data-Portal-PegaAdminStudio.pyTemplateInputBox", new LiteweightPropertyDefinition("Data-Portal-PegaAdminStudio", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PZADMINSTUDIOPANEL #20180713T135157.802 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzAdminStudioPanel");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PZADMINSTUDIOPANEL #20180713T135157.802 GMT", "Data-Portal-PegaAdminStudio pzAdminStudioPanel", "Pega-Desktop", "08-01-01", "20180718T015644.619 GMT");
}
