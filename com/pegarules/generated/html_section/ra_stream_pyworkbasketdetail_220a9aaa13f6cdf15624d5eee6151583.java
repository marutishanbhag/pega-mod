...
/**
 * Builds JSP stream DATA-ADMIN-WORKBASKET!PYWORKBASKETDETAIL.
 */
public class ra_stream_pyworkbasketdetail_220a9aaa13f6cdf15624d5eee6151583 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyWorkBasketDetail.Data_Admin_WorkBasket.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1531356209;
 ...
 */
	public ra_stream_pyworkbasketdetail_220a9aaa13f6cdf15624d5eee6151583(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "75ea979284316fd1d40580b90304b59d98a0a868";
...
{
/* Instance RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETDETAIL #20180713T134746.345 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "75ea979284316fd1d40580b90304b59d98a0a868";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyWorkBasketDetail",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETDETAIL #20180713T134746.345 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETDETAIL #20180713T134746.345 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETDETAIL #20180713T134746.345 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYWORKBASKETDETAIL"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYWORKBASKETDETAIL","Rule-HTML-Section","DATA-ADMIN-WORKBASKET",false,"","Pega-EndUserUI","08-01-01","RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETDETAIL #20180713T134746.345 GMT","!PYWORKBASKETDETAIL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1531356209)
	};
...
//	RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETDETAIL #20180713T134746.345 GMT:20180713T134746.345 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "c647963a0cab9ab89622bc87cde726f8";
	}

	public String getDefinitionAppliesToClass() {
		return "Data-Admin-WorkBasket";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyWorkBasketDetail",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyWorkBasketDetail','insKey':'RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETDETAIL #20180713T134746.345 GMT','sectionType':'standard'}");
pzLayout_5();
...
tools.appendString("<div class='layout layout-noheader layout-noheader-fat_list_item'>");
...
public void buildSection_4() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_14","pyWorkBasketAssgnCount", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pyWorkBasketAssgnCount"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpyWorkBasketDetail287","",false);
}
...
public void buildSection_3() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pyWorkBasketAssgnCount", secInfo);
}
...
public int simpleLayoutCell_3( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyWorkBasketAssgnCount",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyWorkBasketAssgnCount",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkBasketDetailBBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpyWorkBasketDetailBBB";
...
public void buildSection_2() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pyCMDashboardDrag", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pyCMDashboardDrag"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpyWorkBasketDetail782","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pyCMDashboardDrag", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyCMDashboardDrag",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyCMDashboardDrag",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkBasketDetailBB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpyWorkBasketDetailBB";
	metadataPage.put("paramName", paramName);
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkBasketDetailB","",false);
}
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICCOLUMN','pgRef':'.pySections(1)'}") + " class='" + " content  two-col-main-sidebar two-col-main-sidebar_secondary_content_two_col layout-content-default " + hideColumn + "' data-hidecolumns=right ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		pg_dlmeta.put("class"," two-col-main-sidebar two-col-main-sidebar_secondary_content_two_col" + hideColumn);
	...
	String paramName = "EXPANDEDSubSectionpyWorkBasketDetailB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("prefix","-fat_list_item");
	metadataPage.put("sectionIndex","1");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
	pzLayoutBody_3();
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Data-Admin-WorkBasket");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETDETAIL #20180713T134746.345 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyWorkBasketDetail");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETDETAIL #20180713T134746.345 GMT", "Data-Admin-WorkBasket pyWorkBasketDetail", "Pega-EndUserUI", "08-01-01", "20180713T134746.345 GMT");
}
