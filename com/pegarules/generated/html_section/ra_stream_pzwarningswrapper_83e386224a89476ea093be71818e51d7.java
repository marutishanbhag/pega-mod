...
/**
 * Builds JSP stream @BASECLASS!PZWARNINGSWRAPPER.
 */
public class ra_stream_pzwarningswrapper_83e386224a89476ea093be71818e51d7 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzWarningsWrapper.Rule_.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -801034622;
 ...
 */
	public ra_stream_pzwarningswrapper_83e386224a89476ea093be71818e51d7(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "b10776382dfb8909373422ce3d40ce43cf1455fc";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZWARNINGSWRAPPER #20180713T135142.231 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "b10776382dfb8909373422ce3d40ce43cf1455fc";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzWarningsWrapper",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZWARNINGSWRAPPER #20180713T135142.231 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZWARNINGSWRAPPER #20180713T135142.231 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZWARNINGSWRAPPER #20180713T135142.231 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZWARNINGSWRAPPER", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZWARNINGSWRAPPER","Rule-HTML-Section","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION @BASECLASS PZWARNINGSWRAPPER #20180713T135142.231 GMT","!PZWARNINGSWRAPPER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-801034622), 
...
//	RULE-HTML-SECTION @BASECLASS PZWARNINGSWRAPPER #20180713T135142.231 GMT:20180713T135142.231 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "1928062b1c82eae8aef8d10101de6804";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzWarningsWrapper",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzWarningsWrapper','insKey':'RULE-HTML-SECTION @BASECLASS PZWARNINGSWRAPPER #20180713T135142.231 GMT','sectionType':'null'}");
pzLayout_2();
...
config.put("harnessName", "pzShowWarnings");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendFormatted("pzShowWarnings",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");
		...
		tools.appendFormatted("800",StreamBuilder.FMT_NORMAL);	tools.appendString(",height=");

		tools.appendFormatted("500",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");

		tools.appendFormatted("",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"\",\":event\",\"\",\"");
	...
	pzPackageRuntime.packageHarness("pzShowWarnings",
	"@baseclass"
	,"Display","-1");
	}
...
try {
	...
	modePage2.put("pyName","pzWarningsWrapper_$CTX$_2");
		String repeatIndx = "";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Open in window\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Open in window", ".pyButtonLabel");
	}
	pyLabel = "Open in window";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzWarningsWrapper_"+ referenceString+ "_2'";
	...
	,"Display","-1");
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Open in window",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzRuleFormWarningList", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzRuleFormWarningList"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzWarningsWrapper293","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzRuleFormWarningList", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzRuleFormWarningList",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzRuleFormWarningList",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxnever",pxUniqueStreamHash+"_10");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxnever", pxUniqueStreamHash+"_10"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzWarningsWrapperB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzWarningsWrapperB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZWARNINGSWRAPPER #20180713T135142.231 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzWarningsWrapper");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZWARNINGSWRAPPER #20180713T135142.231 GMT", "@baseclass pzWarningsWrapper", "Pega-Desktop", "08-01-01", "20180713T135142.231 GMT");
}
