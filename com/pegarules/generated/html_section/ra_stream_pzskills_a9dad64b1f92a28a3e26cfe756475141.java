...
/**
 * Builds JSP stream DATA-ADMIN-OPERATOR-ID!PZSKILLS.
 */
public class ra_stream_pzskills_a9dad64b1f92a28a3e26cfe756475141 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSkills.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1868868304;
 ...
 */
	public ra_stream_pzskills_a9dad64b1f92a28a3e26cfe756475141(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "65d843f4225c5b5d47ccd274cf60f8e2126da2ec";
...
{
/* Instance RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSKILLS #20180713T135640.917 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "65d843f4225c5b5d47ccd274cf60f8e2126da2ec";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSkills",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSKILLS #20180713T135640.917 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSKILLS #20180713T135640.917 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSKILLS #20180713T135640.917 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZSKILLS", 
	"Rule-Obj-Property:PYSKILLRATING", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSKILLS","Rule-HTML-Section","DATA-ADMIN-OPERATOR-ID",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSKILLS #20180713T135640.917 GMT","!PZSKILLS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1868868304), 
		new DependentRuleInfo("PYSKILLRATING","Rule-Obj-Property","EMBED-DATA-ADMIN-SKILL",true,"Embed-Data-Admin-Skill","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY EMBED-DATA-ADMIN-SKILL PYSKILLRATING #20180713T131231.926 GMT","!PYSKILLRATING",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSKILLS #20180713T135640.917 GMT:20180713T135640.917 GMT
//	RULE-HTML-PROPERTY PXINTEGER #20190131T183501.583 GMT:20190131T183501.583 GMT
//	RULE-OBJ-PROPERTY EMBED-DATA-ADMIN-SKILL PYSKILLRATING #20180713T131231.926 GMT:20180713T131231.926 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "f0d5ca6b87adde0a576adf95bb025a9f";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSkills",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSkills','insKey':'RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSKILLS #20180713T135640.917 GMT','sectionType':'null'}");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_19")){
		 ...
		 String buttonUID = "name='pzSkills_"+ referenceString+ "_43'";
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_18")){
		 String referenceString = tools.getStepPage().getReference();
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzSkills_"+ referenceString+ "_39'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
...
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);
		...
		tools.appendString(bOptimizedMarkup ? " data-cdb-value=\"" : " value=\"");String ref = tools.getProperty(".pySkillRating").getReference();
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_17")){
		textIncludes_1();
		tools.appendString("\n<span  data-ctl='Text' ");
...
public void repeatingDataCell_6() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxInteger",".pySkillRating", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)")); tools.appendString("headers='a2'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:24px;'");}tools.appendString("class='");
	tools.appendString(" gridCell");tools.appendString("  wrapText");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");pxInteger_3(".pySkillRating",0,"","","Integer");
									tools.appendString("</DIV>"); } else { pxInteger_3(".pySkillRating",0,"","","Integer");}
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
} 
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpySkills1colWidthCache3").equals("")){ tools.appendParamCSF("PpySkills1colWidthCache3"); } else { tools.appendString("4"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
...
public void repeatingHeaderCell_2() {
	...
	String strFieldValue = "";
		...
		tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='Rating' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  data-alignWithData=\"true\"  ");
		...
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									...
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "Rating", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<span style='position:absolute; top:0px; right: 0px;'>&nbsp;</span>"); } if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
...
public void repeatingHeaderCell_1() {
	...
	String strFieldValue = "";
		...
		tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='Skill' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  data-alignWithData=\"true\"  ");
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("height:22px;");tools.appendString("width:auto;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:20px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont wrapHeader '");tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "Skill", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<span style='position:absolute; top:0px; right: 0px;'>&nbsp;</span>"); } if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
...
pzSection.getLayout().setExpandParam("SubSectionpzSkillsB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpzSkillsB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pySkillsL7=null;

 Map selUniqMap_pySkillsL7 = null;
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pySkills");tools.appendString("_pzSkills_1'");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pySkills");

					}

					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList='.pySkillName .pySkillRating .pyTemplateInputBox  ' class='yui-skin-sam gPXAuto");

					if(pega_uiengine_harness.pzInStandardsMode()) {tools.appendString(" floated ");

					}tools.appendString("' style='");

					if(!pega_uiengine_harness.pzInStandardsMode()) {tools.appendString("display:"); if(pzAuto.getBrowserUtils().isIE()) {  tools.appendString(" inline; "); } else {  tools.appendString("inline-block;"); } }tools.appendString("' gPropIndex='PpySkills1' editRowIndex='");
					...
					tools.appendString(pzSection.getRepeatStyle());String strSummary = "pySkills";
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' ><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpySkills1colWidthGBL\" id=\"PpySkills1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpySkills1colWidthGBL"));tools.appendString("\" />");

					
						 tools.putParamValue("expandRL","false"); 

					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpySkills1colWidthGBR\" id=\"PpySkills1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpySkills1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpySkills1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' style='width:");

					 if(!tools.getParamValue("PpySkills1colWidthGBL").equals("")) { tools.appendParamCSF("PpySkills1colWidthGBL"); } else { 

					tools.appendString("327.0"); } 

					tools.appendString("px;' cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='pySkills' PL_PROP='");

					
tools.appendString(".pySkills");

					tools.appendString("' PL_PROP_CLASS='Embed-Data-Admin-Skill' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pySkills").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pySkills\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"3\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("Embed-Data-Admin-Skill", "tempNoRespg");
 ...
 tempNoRespg.removeFromClipboard();
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pySkills1") && tools.getParamValue("partialRefresh").equals("false")) {
...
public void repeatingDataCell_4() {
	...
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");pxInteger_2(".pySkillRating",0,"","","Integer");
									tools.appendString("</DIV>"); } else { pxInteger_2(".pySkillRating",0,"","","Integer");}
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
} 
...
public void repeatingDataCell_2() {
	...
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");pxInteger_1(".pySkillRating",0,"","","Integer");
									tools.appendString("</DIV>"); } else { pxInteger_1(".pySkillRating",0,"","","Integer");}
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
} 
...
if (_jspx_meth_pega_param__1(pageContext, "Class", "Rule-Admin-Skill")) {
	return true;
}
...
if (_jspx_meth_pega_param__1(pageContext, "TextBoxTooltip", "Select a Rule-Admin-Skill name")) {
	return true;
}
...
/*
 * reference tag
 * Cannot inline because: cannot identify property ".pySkillName" at assembly time
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pySkillName", "input", "openrule")) {
	return;
}
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
public void repeatingDataCell_1() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("openrule",".pySkillName", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pySkills1")|| tools.getParamValue("partialTrigger").equals("editRow.pySkills1") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pySkills");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pySkills\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pySkills1")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty(".pySkills");
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pySkills1") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSKILLS #20180713T135640.917 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzSkills");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSKILLS #20180713T135640.917 GMT", "Data-Admin-Operator-ID pzSkills", "Pega-SystemArchitect", "08-01-01", "20180713T135640.917 GMT");
}
