...
/**
 * Builds JSP stream EMBED-ACTIVITYSTEPS!PZPAGEPROMPT.
 */
public class ra_stream_pzpageprompt_921a2be838cc1abfc1cd1693ac8a9a0b extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzPagePrompt.Embed_ActivitySteps.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -719162786;
 ...
 */
	public ra_stream_pzpageprompt_921a2be838cc1abfc1cd1693ac8a9a0b(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "110af9910af0c57787618dd18c63a623f814e278";
...
{
/* Instance RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPAGEPROMPT #20180713T135208.848 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "110af9910af0c57787618dd18c63a623f814e278";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzPagePrompt",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPAGEPROMPT #20180713T135208.848 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPAGEPROMPT #20180713T135208.848 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPAGEPROMPT #20180713T135208.848 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZPAGEPROMPT"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZPAGEPROMPT","Rule-HTML-Section","EMBED-ACTIVITYSTEPS",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPAGEPROMPT #20180713T135208.848 GMT","!PZPAGEPROMPT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-719162786)
	};
...
//	RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPAGEPROMPT #20180713T135208.848 GMT:20180713T135208.848 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "a307b38db21d48c7e5409b0d14fe2442";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzPagePrompt",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzPagePrompt','insKey':'RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPAGEPROMPT #20180713T135208.848 GMT','sectionType':'null'}");
pzLayout_1();
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzPagePromptB"));
...
metadataPage.put("title","Indirect Pages");
metadataPage.put("uniqueid", "202602230423260919");
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_2","pzPagePromptCustom", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzPagePromptCustom";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzHeaderCellContent_1() {
}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzPagePromptB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzPagePromptCustom'}") + " class='layout layout-outline layout-outline-default' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpzPagePromptB";
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel6831' data-layout-id='202602230423260916" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel6831'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzPagePromptB","tdRightStyle");}
if(showContainerIcons){
...
String paramName = "EXPANDEDSubSectionpzPagePromptB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzPagePromptCustom'}");
...
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzHasIndirectPages", pxUniqueStreamHash+"_3");metadataPage.put("isSectionIncl","true");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzHasIndirectPages","pzHasIndirectPages", "layout", "visible" )) {pzSetExpandParam_1();
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPAGEPROMPT #20180713T135208.848 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzPagePrompt");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPAGEPROMPT #20180713T135208.848 GMT", "Embed-ActivitySteps pzPagePrompt", "Pega-Desktop", "08-01-01", "20180713T135208.848 GMT");
}
