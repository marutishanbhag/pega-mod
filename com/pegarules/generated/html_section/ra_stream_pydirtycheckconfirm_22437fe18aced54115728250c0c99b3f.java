 ...
 */
public class ra_stream_pydirtycheckconfirm_22437fe18aced54115728250c0c99b3f extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
...
private static final int pzChecksum = -1390530876;
 ...
 */
	public ra_stream_pydirtycheckconfirm_22437fe18aced54115728250c0c99b3f(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "287a0031a8a4aabb2acbfd271dceea14ef179581";
...
{
/* Instance RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20190430T225358.829 GMT	Theme-Cosmos:01-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "287a0031a8a4aabb2acbfd271dceea14ef179581";
...
/*
 * Begin RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20190430T225358.829 GMT
 * Set up context.
 */
final String prevRuleKey_2 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20190430T225358.829 GMT";final String prevClass_2 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20190430T225358.829 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDIRTYCHECKCONFIRM","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","01-01-01","RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20190430T225358.829 GMT","!PYDIRTYCHECKCONFIRM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1390530876), 
...
//	RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20190430T225358.829 GMT:20190430T225358.829 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "444e8740dd405829dfef96b780fe8e20";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyDirtyCheckConfirm",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyDirtyCheckConfirm','insKey':'RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20190430T225358.829 GMT','sectionType':'standard'}");
pzLayout_3();
...
config = new HashMap<String, String>();
config.put("CloseAfterSave", "true");
pega.getUIEngine().getUIAction("save", config).register();
pega.getUIEngine().getUIAction("cancel", null).register();
}
...
try {
	...
	modePage2.put("pyName","pyDirtyCheckConfirm_$CTX$_36");
		String repeatIndx = "";
	String pyTooltip = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyDirtyCheckConfirm_"+ referenceString+ "_36'";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"setUserStart\",[\"SAVE\"]],[\"doSave\",[true,\":event\",true]");
	{
		com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();
		actionRequest.registerFixedParameter("pyActivity", "SaveAndContinue");
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20140827063806434") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyDirtyCheckConfirm_$CTX$_35");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDirtyCheckConfirm_"+ referenceString+ "_35'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20140827063806434") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"setUserStart\",[\"SAVE\"]],[\"doSave\",[true,\":event\",true]");
	{
...
try {
	...
	modePage2.put("pyName","pyDirtyCheckConfirm_$CTX$_34");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDirtyCheckConfirm_"+ referenceString+ "_34'";
	 String securedPropValue = null;
...
try {
	...
	modePage2.put("pyName","pyDirtyCheckConfirm_$CTX$_33");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDirtyCheckConfirm_"+ referenceString+ "_33'";
	 String securedPropValue = null;
...
public int simpleLayoutCell_4( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpxShowSaveButton","pxShowSaveButton","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpxShowSaveButton",pxUniqueStreamHash+"_18");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_18");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pxShowSaveButton");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpxShowSaveButton", pxUniqueStreamHash+"_18"); 
	}
...
public int simpleLayoutCell_5( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140827063806434-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpxShowSaveButton",pxUniqueStreamHash+"_22");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpxShowSaveButton", pxUniqueStreamHash+"_22"); 
	}
	if(pyDLCellVisibility) {
...
public int simpleLayoutCell_6( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpxHideSaveButton","pxHideSaveButton","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpxHideSaveButton",pxUniqueStreamHash+"_26");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_26");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pxHideSaveButton");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Work-");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_26");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpxHideSaveButton", pxUniqueStreamHash+"_26"); 
	}
	if(pyDLCellVisibility) {
...
pzSection.getLayout().setExpandParam("SubSectionCellpyDirtyCheckConfirm57","",false);
}
...
static {
	...
	oStreamProperties_2.put("pzInsKey", "RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20190430T225358.829 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20190430T225358.829 GMT", "Work- pyDirtyCheckConfirm", "Theme-Cosmos", "01-01-01", "20190430T225358.829 GMT");
