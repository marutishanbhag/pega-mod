...
/**
 * Builds JSP stream DATA-PORTAL!PXDISPLAYSTAGESREPORT.
 */
public class ra_stream_pxdisplaystagesreport_6583a0de1b2e323da6c4bfbcf4e4f1f6 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pxDisplayStagesReport.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1521249017;
 ...
 */
	public ra_stream_pxdisplaystagesreport_6583a0de1b2e323da6c4bfbcf4e4f1f6(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "fdf2ef4297cae3a5198eb8bc7d15d8edb5d9780f";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PXDISPLAYSTAGESREPORT #20180713T134750.990 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "fdf2ef4297cae3a5198eb8bc7d15d8edb5d9780f";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pxDisplayStagesReport",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PXDISPLAYSTAGESREPORT #20180713T134750.990 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PXDISPLAYSTAGESREPORT #20180713T134750.990 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PXDISPLAYSTAGESREPORT #20180713T134750.990 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PXDISPLAYSTAGESREPORT", 
	"Rule-Obj-Property:PYCURRENTCASE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXDISPLAYSTAGESREPORT","Rule-HTML-Section","DATA-PORTAL",false,"","Pega-EndUserUI","08-01-01","RULE-HTML-SECTION DATA-PORTAL PXDISPLAYSTAGESREPORT #20180713T134750.990 GMT","!PXDISPLAYSTAGESREPORT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1521249017), 
		new DependentRuleInfo("PYCURRENTCASE","Rule-Obj-Property","DATA-PORTAL",true,"Data-Portal","Pega-EndUserUI","08-01-01","RULE-OBJ-PROPERTY DATA-PORTAL PYCURRENTCASE #20180713T134651.067 GMT","!PYCURRENTCASE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION DATA-PORTAL PXDISPLAYSTAGESREPORT #20180713T134750.990 GMT:20180713T134750.990 GMT
//	RULE-HTML-PROPERTY PXDROPDOWN #20191010T062311.436 GMT:20191010T062311.436 GMT
//	RULE-OBJ-PROPERTY DATA-PORTAL PYCURRENTCASE #20180713T134651.067 GMT:20180713T134651.067 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "a01df250f7e9ae6b7f3771f6741ad8f5";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pxDisplayStagesReport",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pxDisplayStagesReport','insKey':'RULE-HTML-SECTION DATA-PORTAL PXDISPLAYSTAGESREPORT #20180713T134750.990 GMT','sectionType':'null'}");
pzLayout_1();
pzLayout_3();
pzLayout_4();
...
config = new HashMap<String, String>();
config.put("pySectionName", "pxDisplayStagesReport");
...
public int simpleLayoutCell_4( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","heading_2_dataLabelRead","heading_2_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead heading_2_dataLabelRead","dataLabelWrite heading_2_dataLabelWrite") + "' >");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","There are no stages for this case.") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	labelName = "There are no stages for this case.";
...
pzSection.getLayout().setExpandParam("SubSectionpxDisplayStagesReportBBB","",false);
}
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3)'}") + " class='" + " content  layout-content-inline_middle content-inline_middle " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpxDisplayStagesReportBBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2== rxD_CaseStageCount.pxResultCount cq o2!= rxD_AllCasesInApp.pxScore cq0", pxUniqueStreamHash+"_27");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if(pzAuto.handleEvaluateWhen(" o2&& o2== rxD_CaseStageCount.pxResultCount cq o2!= rxD_AllCasesInApp.pxScore cq0","D_CaseStageCount.pxResultCount == \'\' && D_AllCasesInApp.pxScore != \'0\'", "layout", "visible" )) {pzSetExpandParam_4();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_18","pxDisplayStagesReportStages", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pxDisplayStagesReportStages"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpxDisplayStagesReport23","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_15","pxDisplayStagesReportStages", secInfo);
}
...
public int simpleLayoutCell_3(  int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pxDisplayStagesReportStages",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   ' ");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pxDisplayStagesReportStages",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
String pyInstanceId ="";
char mode = tools.getProperty("D_CaseStageCount.pxResults").getMode();
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
pgSection.put("class","content    layout-content-inline content-inline stages"); 
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  "D_CaseStageCount.pxResults AddDelete", expressionId, true);
expressionId = expression.getId();
}
ClipboardProperty rdlPageListProp = tools.getProperty("D_CaseStageCount.pxResults");
String rdlPageListPropRef = "D_CaseStageCount.pxResults";
if(rdlPageListProp != null) {
rdlPageListPropRef = rdlPageListProp.getReference();
}
String rdlRefreshWhenStr = "D_CaseStageCount.pxResults AddDelete";
rdlRefreshWhenStr = rdlRefreshWhenStr.replace("D_CaseStageCount.pxResults",rdlPageListPropRef);
if(!StringUtils.isBlank(expressionId)) {
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStageCount.pxResults").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
} else {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStageCount.pxResults").getReference(),"",false)); 
}
...
paramsMap.put("ObjClass", ".pyCurrentCase");
pyRDDataPageParams.put("pyName","ObjClass");
 { String propertyRef=".pyCurrentCase";if(propertyRef.startsWith(".")){		propertyRef = tools.getStepPage().getReference() + propertyRef;}
...
pgSectionBody.put("dpname","D_CaseStageCount");
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
...
map.put("pyContext", "D_CaseStageCount.pxResults");
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStageCount.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStageCount.pxResults").getReference(),"", false),pyInstanceId);
}
tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
ClipboardProperty cpSource = tools.getProperty("D_CaseStageCount.pxResults");
...
dummyPageName = "DummyD_CaseStageCount_pxResults";
}
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStageCount.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
itemPage = tools.createPage("Embed-Stage",dummyPageName);
PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
simpleLayoutCell_3(1);
	pega.popStackFrame(itemFrame, false);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStageCount.pxResults").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
}
}else{
if(mode =='L' || mode =='G'){
Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStageCount.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStageCount.pxResults").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("pxDisplayStagesReport",
...
pzSection.getLayout().setExpandParam("SubSectionpxDisplayStagesReportBB","",false);
}


public void putRDLDPParams_1() {
	if(tools.getIfPresent(".pyCurrentCase") != null)
	tools.putParamValue("ObjClass",tools.getProperty(".pyCurrentCase").getStringValue());
	}
...
public void simpleLayout_2() {
		...
		tools.appendString(tools.getProperty("D_CaseStageCount.pxResults").getReference()+ "' ");
		tools.appendString(" " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(2)'}") + "  class='content   layout-content-inline content-inline stages ' ");
		String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
		ClipboardProperty rdlPageListProperty = tools.getProperty("D_CaseStageCount.pxResults");
		String rdlPageListPropRef = "D_CaseStageCount.pxResults";
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		rdlPageListProp = tools.getProperty("D_CaseStageCount.pxResults");
	...
	String paramName = "EXPANDEDSubSectionpxDisplayStagesReportBB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= rx.pyCurrentCase cqNo results found", pxUniqueStreamHash+"_23");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= rx.pyCurrentCase cqNo results found",".pyCurrentCase != \'No results found\'", "layout", "visible" )) {pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void inclFormattedVal_2(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {if (isSecuredProp) { tools.putParamValue("proSecurity_isSecuredProp", isSecuredProp);tools.putParamValue("proSecurity_activePropValue", activePropValue);}
		...
		tools.appendString(pega_uiengine_formatter.pxFormatText(pega_uiengine_pzcontrol.pzGetCaptionValue("pageList","null","D_AllCasesInApp.pxResults","","pzSetCurrentCase","D_AllCasesInApp.pxResults",".pyLabel",".pyClassName",true,(PegaStreamAPI)tools),false,"","",true,"caption"));
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("pageList","null","D_AllCasesInApp.pxResults","","pzSetCurrentCase","D_AllCasesInApp.pxResults",".pyLabel",".pyClassName",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("isControlEditableOriginal"))) {
		...
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("pageList","null","D_AllCasesInApp.pxResults","","pzSetCurrentCase","D_AllCasesInApp.pxResults",".pyLabel",".pyClassName",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("FORMAT_PLAIN_TXT")) && ((pzAuto.getBrowserUtils().isIE() && !pega_uiengine_harness.pzInStandardsMode()) || "true".equals(tools.getParamValue("fromAPI"))) ){
			tools.appendString("&nbsp;");
			...
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						...
						refreshActionRequest.registerFixedParameter("SectionName", "pxDisplayStagesReportInner");
						staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pxDisplayStagesReport"));
						tools.appendString("[\"refresh\", [\"thisSection\",\"pxDisplayStagesReportInner\", \"\", \"");
...
if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y' && !isOffline){
	...
	cellPage.put("pyValue",".pyCurrentCase");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyCurrentCase");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyCurrentCase", ".pyCaption");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyCurrentCase",pxUniqueStreamHash+"_7");
	...
	modePage1.put("pyID","pyCurrentCase");
	...
	listSourceInfo.put("preDataTransform", "pzSetCurrentCase");
	listSourceInfo.put("preDataTransformParams", preDTParams);
	tools.putParamValue("bListOptionsLocalize","true");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadClipboardPage("D_AllCasesInApp.pxResults", listProperties, pxUniqueStreamHash+"_8", listSourceInfo);
	tools.putParamValue("bListOptionsLocalize","");
	String pageName = "D_AllCasesInApp.pxResults";
	if(tools.findPage("D_AllCasesInApp.pxResults") != null){
	pageName = tools.findPage("D_AllCasesInApp.pxResults").getReference();
	}
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyCurrentCase");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyCurrentCase", ".pyCaption");
	pyValueR = ".pyCurrentCase";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyCurrentCase");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyCurrentCase", ".pyCaption");
	pyValueOrig = ".pyCurrentCase";
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_11");}if(beginNonTemplate){			HashStringMap params = new HashStringMap();
			ParameterPage dtparamPage = new ParameterPage();
			pega_rulesengine_utilities.pzRunDataTransform("pzSetCurrentCase",dtparamPage,tools.getStepPage(),tools);
			String pageName ="D_AllCasesInApp.pxResults";
...
public int simpleLayoutCell_1( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Case stages for") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDropdown",".pyCurrentCase",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxDropdown_1(".pyCurrentCase",0,"","","Text");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("forLabel",".pyCurrentCase");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDropdown",".pyCurrentCase",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDropdown_1(".pyCurrentCase",0,"","","Text");labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpxDisplayStagesReportB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpxDisplayStagesReportB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PXDISPLAYSTAGESREPORT #20180713T134750.990 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pxDisplayStagesReport");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PXDISPLAYSTAGESREPORT #20180713T134750.990 GMT", "Data-Portal pxDisplayStagesReport", "Pega-EndUserUI", "08-01-01", "20180713T134750.990 GMT");
}
