...
/**
 * Builds JSP stream WORK-!EDITACTION.
 */
public class ra_stream_editaction_2d3b572bc13e860e04032cd97fdaff94 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.EditAction.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1079739146;
 ...
 */
	public ra_stream_editaction_2d3b572bc13e860e04032cd97fdaff94(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "27bcce62b3ca14591e0a23cd97a1dcf66bad703c";
...
{
/* Instance RULE-HTML-SECTION WORK- EDITACTION #20210506T204027.355 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "27bcce62b3ca14591e0a23cd97a1dcf66bad703c";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("EditAction",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- EDITACTION #20210506T204027.355 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- EDITACTION #20210506T204027.355 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- EDITACTION #20210506T204027.355 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:EDITACTION", 
	"Rule-Obj-Property:PYINTERNALASSIGNMENTHANDLE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("EDITACTION","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION WORK- EDITACTION #20210506T204027.355 GMT","!EDITACTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1079739146), 
		new DependentRuleInfo("PYINTERNALASSIGNMENTHANDLE","Rule-Obj-Property","WORK-",true,"Work-","Pega-ProcessEngine","08-01-01","RULE-OBJ-PROPERTY WORK- PYINTERNALASSIGNMENTHANDLE #20180713T132923.536 GMT","!PYINTERNALASSIGNMENTHANDLE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION WORK- EDITACTION #20210506T204027.355 GMT:20210506T204027.355 GMT
//	RULE-HTML-PROPERTY PXHIDDEN #20180713T133435.722 GMT:20180713T133435.722 GMT
//	RULE-OBJ-PROPERTY WORK- PYINTERNALASSIGNMENTHANDLE #20180713T132923.536 GMT:20180713T132923.536 GMT
//	RULE-HTML-PROPERTY PXHIDDEN #20180713T133435.722 GMT:20180713T133435.722 GMT
//	RULE-OBJ-PROPERTY WORK- PYINTERNALASSIGNMENTHANDLE #20180713T132923.536 GMT:20180713T132923.536 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "09ccef2466a377da97a9f6ea01f2362d";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("EditAction",1,"Rule-HTML-Section","{'type':'Section','ruleName':'EditAction','insKey':'RULE-HTML-SECTION WORK- EDITACTION #20210506T204027.355 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("pzActivity", "pyWorkActionsPopulateReview");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("pzActivityStaticParams", "flowName");
config.put("pzActivity", "GetFlowIndex");
config.put("flowName", "pyUpdateCaseDetails");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("insHandle", ".ActionFlowKey");
config.put("actionType", "DisplayAction");
config.put("isACTarget", "true");
config.put("pyFunctionName", "pega.ui.HarnessActions.handleMenuAction");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pyWorkActionsPopulateReview");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }			{
				StringBuffer ractURLStr = new StringBuffer();
				StringBuffer ractParamStr = new StringBuffer();
				ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=GetFlowIndex");
				tools.appendString("[\"runActivity\", [\"\", \"");
				ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"flowName\":\"pyUpdateCaseDetails\"");
				ractParamStr.append(!"".equals(ractParamStr.toString())? ",pyReturnsResponse:false": "pyReturnsResponse:false");
				tools.appendString("\", \"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \":event\", \"\", \"\", \"\", \"");
				if(!"".equals(ractParamStr.toString())) {
					ractURLStr.append("&pzActivityParamsEncrypted=" + pega_uiengine_pzcontrol.pzURLEncodeString("{" + ractParamStr.toString() + "}"));
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }					tools.appendString("[\"runScript\", [\"pega.ui.HarnessActions.handleMenuAction(\\\"DisplayAction\\\",\\\"5\\\",event,");
					String strPropReference44 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".ActionFlowIndex")+"~#";
					...
					tools.appendString(",");
					String strPropReference45 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".ActionFlowName")+"~#";
					String strFormattedPropReference45 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference45);
					if(strPropReference45.equals(strFormattedPropReference45)) {
					tools.appendString("\\\"");
					tools.appendFormatted(strFormattedPropReference45.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
					tools.appendString("\\\"");
					} else {
					tools.appendFormatted(strFormattedPropReference45.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
					}
					tools.appendString(",");
					String strPropReference46 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".ActionFlowKey")+"~#";
					String strFormattedPropReference46 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference46);
					if(strPropReference46.equals(strFormattedPropReference46)) {
					tools.appendString("\\\"");
					tools.appendFormatted(strFormattedPropReference46.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
					tools.appendString("\\\"");
					} else {
					tools.appendFormatted(strFormattedPropReference46.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
					}
					tools.appendString(",\\\"actertiary\\\")\"]");
		...
		tools.appendString(",\"enter\"");
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }									tools.appendString("[\"runScript\", [\"pega.ui.HarnessActions.handleMenuAction(\\\"DisplayAction\\\",\\\"5\\\",event,");
									String strPropReference84 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".ActionFlowIndex")+"~#";
									String strFormattedPropReference84 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference84);
									if(strPropReference84.equals(strFormattedPropReference84)) {
									tools.appendString("\\\"");
									tools.appendFormatted(strFormattedPropReference84.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
									tools.appendString("\\\"");
									} else {
									tools.appendFormatted(strFormattedPropReference84.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
									}
									tools.appendString(",");
									String strPropReference85 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".ActionFlowName")+"~#";
									String strFormattedPropReference85 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference85);
									if(strPropReference85.equals(strFormattedPropReference85)) {
									tools.appendString("\\\"");
									tools.appendFormatted(strFormattedPropReference85.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
									tools.appendString("\\\"");
									} else {
									tools.appendFormatted(strFormattedPropReference85.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
									}
									tools.appendString(",");
									String strPropReference86 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".ActionFlowKey")+"~#";
									String strFormattedPropReference86 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference86);
									if(strPropReference86.equals(strFormattedPropReference86)) {
									tools.appendString("\\\"");
									tools.appendFormatted(strFormattedPropReference86.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
									tools.appendString("\\\"");
									} else {
									tools.appendFormatted(strFormattedPropReference86.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
									}
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty(".ActionFlowIndex"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".ActionFlowName"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".ActionFlowKey"), -1);
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20151209120044090529605") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","EditAction_$CTX$_2");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Edit\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Edit", ".pyActionPrompt");
	}
	pyTooltip = "Edit";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='EditAction_"+ referenceString+ "_2'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20151209120044090529605") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Edit\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
...
tools.putParamValue("isControlEditableOriginal", true);
	...
	cellPage.put("pyValue",".pyInternalAssignmentHandle");
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	cellPage.put("pyID","pyInternalAssignmentHandle");
	modePage2.put("pyContent","associated");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20151209132237070547518",true));
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyInternalAssignmentHandle");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyInternalAssignmentHandle", ".pyCaption");
...
boolean bUITemplatized = pzAuto.getUIComponentRuntime().isTemplateRendering();pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);
	tools.appendString("<input  type=\"hidden\"  " + pzCell.getTestIdIfEnabled("20151209132237070547518") + "  id=\"");
		tools.appendString(tools.getHTMLIDForProperty(true,"hidden"));
tools.appendString("\" value=\"");if(bUITemplatized){
	tools.appendString(pzAuto.getUIComponentRuntime().getRuntimeContextTree().generateContextToken("pyInternalAssignmentHandle"));}else {
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_1(".pyInternalAssignmentHandle",0,"","","Text");
	return index;
}
...
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_2(".pyInternalAssignmentHandle",0,"","","Text");
	index++;
	return index;
}
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxDisplayEditAction","DisplayEditAction","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-right-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20151209120044090529605-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxDisplayEditAction",pxUniqueStreamHash+"_8");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_8");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","DisplayEditAction");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxDisplayEditAction", pxUniqueStreamHash+"_8"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionEditActionB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201901311459490401109") + " ");
	...
	String paramName = "EXPANDEDSubSectionEditActionB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- EDITACTION #20210506T204027.355 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "EditAction");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- EDITACTION #20210506T204027.355 GMT", "Work- EditAction", "Theme-Cosmos", "04-01-01", "20210506T204027.355 GMT");
}
