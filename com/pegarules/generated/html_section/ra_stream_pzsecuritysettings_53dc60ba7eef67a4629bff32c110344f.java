...
/**
 * Builds JSP stream DATA-ADMIN-OPERATOR-ID!PZSECURITYSETTINGS.
 */
public class ra_stream_pzsecuritysettings_53dc60ba7eef67a4629bff32c110344f extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSecuritySettings.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -483305684;
 ...
 */
	public ra_stream_pzsecuritysettings_53dc60ba7eef67a4629bff32c110344f(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "bc6d18c2b814714c182deb90ccbb9fde42854c27";
...
{
/* Instance RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSECURITYSETTINGS #20180713T135150.863 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "bc6d18c2b814714c182deb90ccbb9fde42854c27";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSecuritySettings",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSECURITYSETTINGS #20180713T135150.863 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSECURITYSETTINGS #20180713T135150.863 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSECURITYSETTINGS #20180713T135150.863 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZSECURITYSETTINGS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSECURITYSETTINGS","Rule-HTML-Section","DATA-ADMIN-OPERATOR-ID",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSECURITYSETTINGS #20180713T135150.863 GMT","!PZSECURITYSETTINGS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-483305684)
	};
...
//	RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSECURITYSETTINGS #20180713T135150.863 GMT:20180713T135150.863 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "35f42e3c00fe1a95fe307f4ea2596f91";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSecuritySettings",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSecuritySettings','insKey':'RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSECURITYSETTINGS #20180713T135150.863 GMT','sectionType':'null'}");
pzLayout_1();
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzSecuritySettingsB"));
...
metadataPage.put("title","Access Settings");
metadataPage.put("uniqueid", "202601120327360663");
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_2","pzAccessSettings", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzAccessSettings";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzHeaderCellContent_1() {
}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzSecuritySettingsB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzAccessSettings'}") + " class='layout layout-outline layout-outline-default' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpzSecuritySettingsB";
...
l_sectionTitle="Access Settings";
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel1902' data-layout-id='202601120327360660" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel1902'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzSecuritySettingsB","tdRightStyle");}
if(showContainerIcons){
...
String paramName = "EXPANDEDSubSectionpzSecuritySettingsB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzAccessSettings'}");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSECURITYSETTINGS #20180713T135150.863 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzSecuritySettings");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSECURITYSETTINGS #20180713T135150.863 GMT", "Data-Admin-Operator-ID pzSecuritySettings", "Pega-Desktop", "08-01-01", "20180713T135150.863 GMT");
}
