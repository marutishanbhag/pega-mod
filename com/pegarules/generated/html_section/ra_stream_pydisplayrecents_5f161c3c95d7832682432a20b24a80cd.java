...
/**
 * Builds JSP stream DATA-PORTAL!PYDISPLAYRECENTS.
 */
public class ra_stream_pydisplayrecents_5f161c3c95d7832682432a20b24a80cd extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyDisplayRecents.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -339694097;
 ...
 */
	public ra_stream_pydisplayrecents_5f161c3c95d7832682432a20b24a80cd(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "1cbac4986cc664ba2c9fe8a8fb07352c8f7cb95d";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PYDISPLAYRECENTS #20210506T204028.758 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "1cbac4986cc664ba2c9fe8a8fb07352c8f7cb95d";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyDisplayRecents",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PYDISPLAYRECENTS #20210506T204028.758 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PYDISPLAYRECENTS #20210506T204028.758 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PYDISPLAYRECENTS #20210506T204028.758 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYDISPLAYRECENTS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDISPLAYRECENTS","Rule-HTML-Section","DATA-PORTAL",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION DATA-PORTAL PYDISPLAYRECENTS #20210506T204028.758 GMT","!PYDISPLAYRECENTS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-339694097), 
...
//	RULE-HTML-SECTION DATA-PORTAL PYDISPLAYRECENTS #20210506T204028.758 GMT:20221122T130612.294 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "48f171a2336e6562a73f49bfceef307f";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyDisplayRecents",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyDisplayRecents','insKey':'RULE-HTML-SECTION DATA-PORTAL PYDISPLAYRECENTS #20210506T204028.758 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_4();
pzLayout_6();
...
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("pySectionName", "pyDisplayRecents");
...
metadataPage.put("headCustom","navigation-slidein-header padding-lr-2x");
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyDisplayRecentsBBBB"));
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Recently viewed items", "pyCaption");
...
metadataPage.put("title","Recently viewed items");
metadataPage.put("uniqueid", "202602210142200375");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("201902191012070101707") + " ");
...
public void getNextPage_2(String listSource, int listStartIndex, int listEndIndex) {
	...
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201902191012070101707" ) + "");
...
public void buildSection_4() { 
	...
	secInfo.put("pxGadgetClass", "PegaGadget-RecentList");
	Map<String, String> advanceParams = new HashMap<String, String>();
	advanceParams.put("pyListSize", "10");
	advanceParams.put("pxObjClass", "PegaGadget-RecentList");
	advanceParams.put("pxCreateOperator", "jalds");
	advanceParams.put("pxCreateDateTime", "20121227T075123.705 GMT");
	advanceParams.put("pxCreateSystemID", "sde");
	advanceParams.put("pyAppliesTo", "@baseclass");
	advanceParams.put("pxCreateOpName", "Sreekanth Jaldi");
	secInfo.put("advanceParams", advanceParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_22","pyRecentWorkContent", secInfo);
}
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	String sectionName = "pyRecentWorkContent"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpyDisplayRecents949","",false);
}
...
public void buildSection_3() { 
	...
	advanceParams.put("pxCreateOpName", "Sreekanth Jaldi");
	secInfo.put("advanceParams", advanceParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_19","pyRecentWorkContent", secInfo);
}
...
public int simpleLayoutCell_4(  int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& wxpyShowRecents o2!= rx.pyExecute.pyAction cqcreateWork","pyShowRecents && .pyExecute.pyAction != \'createWork\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyRecentWorkContent",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row ' ");
	...
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201902191012070101707-" + rowTestID) + " ");
	}else {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& axpyShowRecents o2!= rx.pyExecute.pyAction cqcreateWork",pxUniqueStreamHash+"_21");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_21");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pyShowRecents && .pyExecute.pyAction != 'createWork'");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& axpyShowRecents o2!= rx.pyExecute.pyAction cqcreateWork", pxUniqueStreamHash+"_21"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyRecentWorkContent",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
String pyInstanceId ="";
char mode = tools.getProperty("Declare_pxRecents.pxResults").getMode();
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
ClipboardPage dummyPage = tools.createPage("System-User-Recents","NoDataPage");
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_23","RDLNoResultsMessage", RDLNoRowMessageSectionParams);
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  "Declare_pxRecents.pxResults AddDelete", expressionId, true);
expressionId = expression.getId();
}
ClipboardProperty rdlPageListProp = tools.getProperty("Declare_pxRecents.pxResults");
String rdlPageListPropRef = "Declare_pxRecents.pxResults";
if(rdlPageListProp != null) {
rdlPageListPropRef = rdlPageListProp.getReference();
}
String rdlRefreshWhenStr = "Declare_pxRecents.pxResults AddDelete";
rdlRefreshWhenStr = rdlRefreshWhenStr.replace("Declare_pxRecents.pxResults",rdlPageListPropRef);
if(!StringUtils.isBlank(expressionId)) {
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("Declare_pxRecents.pxResults").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
} else {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("Declare_pxRecents.pxResults").getReference(),"",false)); 
}
pgSectionBody.put("sourcetype","Data Object");
Map map = new HashMap();
Map paramsMap = new HashMap();
map.put("params", paramsMap);
map.put("pxDataSourceId", pxUniqueStreamHash+"_26");
pgSectionBody.put("datasrcid",pxUniqueStreamHash+"_26");
pyRDDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();
paramsMap.put("Work", "true");
pyRDDataPageParams.put("pyName","Work");
pyRDDataPageParams.put("pyValue","{\"value\":\"true\",\"isLiteral\":true}");
pgSectionBody.addMetadataInArray("rdparamslst",pyRDDataPageParams);
pyRDDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();
paramsMap.put("Rule", "true");
pyRDDataPageParams.put("pyName","Rule");
pyRDDataPageParams.put("pyValue","{\"value\":\"true\",\"isLiteral\":true}");
pgSectionBody.addMetadataInArray("rdparamslst",pyRDDataPageParams);
pgSectionBody.put("dpname","Declare_pxRecents");
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
...
pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201902191012070101707" ) + "");
...
map.put("pyContext", "Declare_pxRecents.pxResults");
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("Declare_pxRecents.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("Declare_pxRecents.pxResults").getReference(),"", false),pyInstanceId);
}
tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
ClipboardProperty cpSource = tools.getProperty("Declare_pxRecents.pxResults");
...
dummyPageName = "DummyDeclare_pxRecents_pxResults";
}
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("Declare_pxRecents.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
itemPage = tools.createPage("System-User-Recents",dummyPageName);
PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
simpleLayoutCell_4(1);
	pega.popStackFrame(itemFrame, false);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("Declare_pxRecents.pxResults").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
}
}else{
if(mode =='L' || mode =='G'){
Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("Declare_pxRecents.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("Declare_pxRecents.pxResults").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("pyDisplayRecents",
...
pzSection.getLayout().setExpandParam("SubSectionpyDisplayRecentsBBBB","",true);
}
public void LayoutWrapperTableStart_3() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(3)'}") + " class='layout layout-outline layout-outline' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpyDisplayRecentsBBBB";
...
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","Recently viewed items");
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='4' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel8329' data-layout-id='202602210142200365" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h4  class='header-title' id='headerlabel8329'>" + l_sectionTitle + "</h4><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyDisplayRecentsBBBB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_4() {
		...
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplateComponent(pxUniqueStreamHash+"_27");
		}
		int totalRecords=0;
		...
		tools.appendString(tools.getProperty("Declare_pxRecents.pxResults").getReference()+ "' ");
		tools.appendString("   class=' flex content   layout-content-simple_list content-simple_list padding-lr-2x ' ");
		String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
		ClipboardProperty rdlPageListProperty = tools.getProperty("Declare_pxRecents.pxResults");
		String rdlPageListPropRef = "Declare_pxRecents.pxResults";
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201902191012070101707" ) + " ");
		tools.appendString(">");
		int index = 1;
		...
		rdlPageListProp = tools.getProperty("Declare_pxRecents.pxResults");
	...
	String paramName = "EXPANDEDSubSectionpyDisplayRecentsBBBB";
...
metadataPage.put("headingLevel","h4");
metadataPage.put("headCustom","navigation-slidein-header padding-lr-2x");
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyDisplayRecentsBBB"));
String sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
if(!"".equals(sectionTitleFVMeta)){
metadataPage.put("fieldValueMeta",sectionTitleFVMeta);
}
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Bookmarks", "pyCaption");
String inspectorFVData = pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData();
if(!"".equals(inspectorFVData)){
metadataPage.put("fieldValueInspectorData",inspectorFVData);
}
metadataPage.put("title","Bookmarks");
metadataPage.put("uniqueid", "202602210142200364");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("201907251915040582630") + " ");
headerComponent.beginComponent("pxLayoutHeader",metadataPage);
headerComponent.endComponent();
}
...
public void getNextPage_1(String listSource, int listStartIndex, int listEndIndex) {
	...
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201907251915040582630" ) + "");
	nextPageMetadata.put("pageListProp",listSource);
	nextPageMetadata.put("strtindx",Integer.toString(listStartIndex));
	nextPageMetadata.put("endindx",Integer.toString(listEndIndex));
	nextPageMetadata.put("processChildren","false");
...
public void buildSection_2() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_13","BookmarkItem", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "BookmarkItem"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpyDisplayRecents830","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_10","BookmarkItem", secInfo);
}
...
public int simpleLayoutCell_3(  int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","BookmarkItem",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row ' ");
	boolean prevState = (tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails")))  ? true : false ;
	tools.putParamValue("bRDLShowDetails","false");
	tools.appendString("NAME='BASE_REF' BASE_REF='");
	if( pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'N'){
	...
	tools.appendString(tools.getStepPage().getReference() + "' ");
	String rowTestID = tools.getParamValue("index");
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201907251915040582630-" + rowTestID) + " ");
	}else {
	tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getStepPage().getReference(),"") + "' ");
	}
	tools.appendString(" STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","BookmarkItem",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
IUIComponent cc = pzAuto.getUIComponent(IUIComponent.ComponentType.RDL);
String pyInstanceId ="";
char mode = tools.getProperty("D_WorkBookmarks.pxResults").getMode();
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
pgRDMetadata = pzAuto.getUIComponentRuntime().createMetadata();
pgRDMetadata.put("pyProcessChildren","false");
String strLayoutMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
ClipboardPage dummyPage = tools.createPage("Link-Association-WorkBookmark","NoDataPage");
PRStackFrame itemFrame1 = pega.pushStackFrame("NoResultsPage", null, dummyPage, true, false);
pgRDMetadata.put("noresulttype", "section");
Map<String, Object> RDLNoRowMessageSectionParams = new HashMap<>();
RDLNoRowMessageSectionParams.put("doNotAddToMetadataTree", true);
pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_14","RDLNoResultsMessage", RDLNoRowMessageSectionParams);
String pyNoDataReference = pzAuto.getUIComponentRuntime().getRuntimeContextTree().getLastAccesedSectionHash();
pgRDMetadata.put("nodatasec", pyNoDataReference);
pega.popStackFrame(itemFrame1, false);
dummyPage.removeFromClipboard();
...
pgSectionBody = pzAuto.getUIComponentRuntime().createMetadata();
pgCells = pzAuto.getUIComponentRuntime().createMetadata();
pgSection.put("class","content    flex  layout-content-simple_list content-simple_list notification-section-divider border-b-1x padding-lr-2x margin-b-1x"); 
pgSection.put("liveUI",""); 
pgRDMetadata.put("isformnavigation","false");
pgRDMetadata.put("rdlnavigationtype","tabkey");
String expressionId = null;
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  "D_WorkBookmarks.pxResults AddDelete", expressionId, true);
expressionId = expression.getId();
}
ClipboardProperty rdlPageListProp = tools.getProperty("D_WorkBookmarks.pxResults");
String rdlPageListPropRef = "D_WorkBookmarks.pxResults";
if(rdlPageListProp != null) {
rdlPageListPropRef = rdlPageListProp.getReference();
}
String rdlRefreshWhenStr = "D_WorkBookmarks.pxResults AddDelete";
rdlRefreshWhenStr = rdlRefreshWhenStr.replace("D_WorkBookmarks.pxResults",rdlPageListPropRef);
if(!StringUtils.isBlank(expressionId)) {
	pgRDMetadata.put("pyExpressionId", expressionId);
}
...
pgRDMetadata.put("pyenableswipe","false");
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_WorkBookmarks.pxResults").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
} else {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_WorkBookmarks.pxResults").getReference(),"",false)); 
}
pgSectionBody.put("sourcetype","Data Object");
Map map = new HashMap();
Map paramsMap = new HashMap();
...
pgSectionBody.put("dpname","D_WorkBookmarks");
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgRDMetadata.put("generatePath","true");
}
pgSectionBody.addMetadataInArray("cells",pgCells);
...
pyInstanceId =String.valueOf(System.currentTimeMillis());
pgRDMetadata.put("uniqueid", "RDL" + pyInstanceId);
pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201907251915040582630" ) + "");
cc.addDependentScripts("pzpega_ui_RDLTemplate.js");
cc.addDependentScripts("pzpega_ui_RDLRowTemplate.js");
cc.addAdditionalScripts("rdlincludes","pzpega_ui_rdl.js");
pgRDMetadata.put("rowmethod","GetRDLRow_1");
map.put("pyContext", "D_WorkBookmarks.pxResults");
cc.beginComponent("RepeatingDynamicLayout",pgRDMetadata,map);
Map<String,String> repeatMap  = null; if(tools.getParameterPage().getParameterValue("pzRepeatProperties")!=null){
repeatMap = (Map<String,String>)tools.getParameterPage().getParameterValue("pzRepeatProperties");
}else {
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_WorkBookmarks.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_WorkBookmarks.pxResults").getReference(),"", false),pyInstanceId);
}
tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
ClipboardProperty cpSource = tools.getProperty("D_WorkBookmarks.pxResults");
boolean bIsSourceEmpty = false;
ClipboardPage itemPage = null;
if(cpSource.size()==0){
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
...
dummyPageName = "DummyD_WorkBookmarks_pxResults";
}
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_WorkBookmarks.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
itemPage = tools.createPage("Link-Association-WorkBookmark",dummyPageName);
PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
simpleLayoutCell_3(1);
	pega.popStackFrame(itemFrame, false);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_WorkBookmarks.pxResults").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
}
}else{
if(mode =='L' || mode =='G'){
Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_WorkBookmarks.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_WorkBookmarks.pxResults").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
...
pzSection.getLayout().setExpandParam("SubSectionpyDisplayRecentsBBB","",true);
}
public void LayoutWrapperTableStart_2() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(2)'}") + " class='layout layout-outline layout-outline' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpyDisplayRecentsBBB";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\">");
...
String l_sectionTitleFVMeta = "";
l_sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","Bookmarks");
String sectionImageTitle="";
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");


	/***-- Grid HeaderElements: Begin --**/
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='4' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel6041' data-layout-id='202602210142200359" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h4  class='header-title' id='headerlabel6041'>" + l_sectionTitle + "</h4><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyDisplayRecentsBBB","tdRightStyle");}
if(showContainerIcons){
tools.appendString("</tr></table>");
}
tools.appendString("</span>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div><div class='header-right'></div></div>");
...
public void simpleLayout_3() {
		...
		tools.appendString("<div bSimpleLayout='true' " + "data-repeat-source= '");
		tools.appendString(tools.getProperty("D_WorkBookmarks.pxResults").getReference()+ "' ");
		tools.appendString("   class=' flex content   layout-content-simple_list content-simple_list notification-section-divider border-b-1x padding-lr-2x margin-b-1x ' ");
		String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
		ClipboardProperty rdlPageListProperty = tools.getProperty("D_WorkBookmarks.pxResults");
		String rdlPageListPropRef = "D_WorkBookmarks.pxResults";
		if(rdlPageListProperty != null) {
		rdlPageListPropRef = rdlPageListProperty.getReference();
		}
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201907251915040582630" ) + " ");
		tools.appendString(">");
		int index = 1;
		tools.putParamValue("bIsRDL","true");
		String rptDynamicIdx = tools.getParamValue("RepeatDynamicIndex");
		...
		ClipboardProperty rdlPageListProp =null;
		if (tools.getParamValue("pyPegaDesignMode").equals("true")) { return;}
		rdlPageListProp = tools.getProperty("D_WorkBookmarks.pxResults");
		totalRecords = rdlPageListProp.size();
		Iterator itemPages = rdlPageListProp.iterator();
		while(itemPages.hasNext()) {
			ClipboardPage itemPage = ((ClipboardProperty)itemPages.next()).getPageValue();
	...
	String paramName = "EXPANDEDSubSectionpyDisplayRecentsBBB";
	metadataPage.put("paramName", paramName);
...
IUIComponentMetadata metadataPage = pzAuto.getUIComponentRuntime().createMetadata();
IUIComponent headerComponent = pzAuto.getUIComponent();
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyDisplayRecentsBB"));
String sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
if(!"".equals(sectionTitleFVMeta)){
metadataPage.put("fieldValueMeta",sectionTitleFVMeta);
}
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Recents", "pyCaption");
String inspectorFVData = pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData();
if(!"".equals(inspectorFVData)){
metadataPage.put("fieldValueInspectorData",inspectorFVData);
}
metadataPage.put("title","Recents");
metadataPage.put("uniqueid", "202602210142200357");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("20221122075641015266") + " ");
headerComponent.beginComponent("pxLayoutHeader",metadataPage);
headerComponent.endComponent();
}
...
pzSection.getLayout().setExpandParam("SubSectionpyDisplayRecentsBB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpyDisplayRecentsBB";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\">");
...
String l_sectionTitleFVMeta = "";
l_sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","Recents");
String sectionImageTitle="";
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");


	/***-- Grid HeaderElements: Begin --**/
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel3017' data-layout-id='202602210142200356" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel3017'>" + l_sectionTitle + "</h2><nobr>");
pzHeaderCellContent_1();
tools.appendString("</nobr>");
boolean showContainerIcons=tools.getParamValue("showContainerIcons").equals("true")?true:false;
tools.appendString("<span class='header-element header-title-table'>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyDisplayRecentsBB","tdRightStyle");}
if(showContainerIcons){
tools.appendString("</tr></table>");
}
tools.appendString("</span>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div><div class='header-right'></div></div>");
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20221122075641015266") + " ");
	...
	String paramName = "EXPANDEDSubSectionpyDisplayRecentsBB";
	metadataPage.put("paramName", paramName);
...
try {
	...
	modePage2.put("pyName","pyDisplayRecents_$CTX$_1");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Close Recents\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Close Recents", ".pyActionPrompt");
	}
	pyTooltip = "Close Recents";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyDisplayRecents_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Close Recents\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
...
pzSection.getLayout().setExpandParam("SubSectionpyDisplayRecentsB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpyDisplayRecentsB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PYDISPLAYRECENTS #20210506T204028.758 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyDisplayRecents");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PYDISPLAYRECENTS #20210506T204028.758 GMT", "Data-Portal pyDisplayRecents", "Theme-Cosmos", "04-01-01", "20221122T130612.294 GMT");
}
