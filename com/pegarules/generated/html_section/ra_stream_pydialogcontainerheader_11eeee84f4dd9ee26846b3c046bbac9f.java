...
/**
 * Builds JSP stream WORK-!PYDIALOGCONTAINERHEADER.
 */
public class ra_stream_pydialogcontainerheader_11eeee84f4dd9ee26846b3c046bbac9f extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyDialogContainerHeader.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -133857158;
 ...
 */
	public ra_stream_pydialogcontainerheader_11eeee84f4dd9ee26846b3c046bbac9f(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "4fab580ee3ccf4d5bac98a6449f6f6ee90f4af09";
...
{
/* Instance RULE-HTML-SECTION WORK- PYDIALOGCONTAINERHEADER #20210506T204028.713 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "4fab580ee3ccf4d5bac98a6449f6f6ee90f4af09";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyDialogContainerHeader",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- PYDIALOGCONTAINERHEADER #20210506T204028.713 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PYDIALOGCONTAINERHEADER #20210506T204028.713 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PYDIALOGCONTAINERHEADER #20210506T204028.713 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYDIALOGCONTAINERHEADER", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDIALOGCONTAINERHEADER","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION WORK- PYDIALOGCONTAINERHEADER #20210506T204028.713 GMT","!PYDIALOGCONTAINERHEADER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-133857158), 
...
//	RULE-HTML-SECTION WORK- PYDIALOGCONTAINERHEADER #20210506T204028.713 GMT:20210506T204028.713 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "376fb7688c596cf00726f8fa27f48ff4";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyDialogContainerHeader",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyDialogContainerHeader','insKey':'RULE-HTML-SECTION WORK- PYDIALOGCONTAINERHEADER #20210506T204028.713 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
pzLayout_3();
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyDialogContainerHeaderBBB"));
...
metadataPage.put("title", "newAssignPage.pxTaskLabel");
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("newAssignPage.pxTaskLabel", "pyCaption");
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty("newAssignPage.pxTaskLabel");
...
metadataPage.put("uniqueid", "202602240939230863");
...
try {
	...
	modePage2.put("pyName","pyDialogContainerHeader_$CTX$_18");
		String repeatIndx = "";
	String pyTooltip = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyDialogContainerHeader_"+ referenceString+ "_18'";
...
pzSection.getLayout().setExpandParam("SubSectionpyDialogContainerHeaderBBB","",true);
}
public void LayoutWrapperTableStart_3() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3)'}") + " class='layout layout-outline layout-outline' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpyDialogContainerHeaderBBB";
...
l_sectionTitle=StringUtils.crossScriptingFilter(tools.getLocalizedTextForParameterizedString("pyCaption",tools.getProperty("newAssignPage.pxTaskLabel").getStringValue()));
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel6616' data-layout-id='202602240939230855" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel6616'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyDialogContainerHeaderBBB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString(" class='" + "flex  content  set-width-auto layout-content-inline_middle content-inline_middle " + "'  " + "role='dialog' tabindex='0' ");
	...
	String paramName = "EXPANDEDSubSectionpyDialogContainerHeaderBBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2|| o2|| o2&& wxpzIsPerform o2== rxnewAssignPage.pyDefaultTaskStatus cqActionStubDraftMode o2== rxnewAssignPage.pxFlowName rxnewAssignPage.pyCurrentActionLabel o2== rxnewAssignPage.pyCurrentActionLabel cq", pxUniqueStreamHash+"_23");metadataPage.put("lMode","Flexbox");
	metadataPage.put("contCustom","page-header padding-0");
...
if(pzAuto.handleEvaluateWhen(" o2|| o2|| o2&& wxpzIsPerform o2== rxnewAssignPage.pyDefaultTaskStatus cqActionStubDraftMode o2== rxnewAssignPage.pxFlowName rxnewAssignPage.pyCurrentActionLabel o2== rxnewAssignPage.pyCurrentActionLabel cq","pzIsPerform && newAssignPage.pyDefaultTaskStatus == \'ActionStubDraftMode\' || newAssignPage.pxFlowName == newAssignPage.pyCurrentActionLabel || newAssignPage.pyCurrentActionLabel == \'\'", "layout", "visible" )) {pzSetExpandParam_3();
...
IUIComponentMetadata metadataPage = pzAuto.getUIComponentRuntime().createMetadata();
IUIComponent headerComponent = pzAuto.getUIComponent();
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyDialogContainerHeaderBB"));
metadataPage.put("titleType","Property");
String sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
if(!"".equals(sectionTitleFVMeta)){
metadataPage.put("fieldValueMeta",sectionTitleFVMeta);
}
metadataPage.put("title", "newAssignPage.pyCurrentActionLabel");
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("newAssignPage.pyCurrentActionLabel", "pyCaption");
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty("newAssignPage.pyCurrentActionLabel");
String inspectorFVData = pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData();
if(!"".equals(inspectorFVData)){
metadataPage.put("fieldValueInspectorData",inspectorFVData);
}
metadataPage.put("uniqueid", "202602240939230854");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("20180814100925014850") + " ");
headerComponent.beginComponent("pxLayoutHeader",metadataPage);
headerComponent.endComponent();
}
...
try {
	...
	modePage2.put("pyName","pyDialogContainerHeader_$CTX$_12");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Close\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDialogContainerHeader_"+ referenceString+ "_12'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("201901261711080731178947") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
pzSection.getLayout().setExpandParam("SubSectionpyDialogContainerHeaderBB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpyDialogContainerHeaderBB";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\">");
...
String l_sectionTitleFVMeta = "";
l_sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
l_sectionTitle=StringUtils.crossScriptingFilter(tools.getLocalizedTextForParameterizedString("pyCaption",tools.getProperty("newAssignPage.pyCurrentActionLabel").getStringValue()));
String sectionImageTitle="";
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");


	/***-- Grid HeaderElements: Begin --**/
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel8171' data-layout-id='202602240939230845" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel8171'>" + l_sectionTitle + "</h2><nobr>");
pzHeaderCellContent_1();
tools.appendString("</nobr>");
boolean showContainerIcons=tools.getParamValue("showContainerIcons").equals("true")?true:false;
tools.appendString("<span class='header-element header-title-table'>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyDialogContainerHeaderBB","tdRightStyle");}
if(showContainerIcons){
tools.appendString("</tr></table>");
}
tools.appendString("</span>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div><div class='header-right'></div></div>");
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpyDialogContainerHeaderBB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2&& o2&& wxpzIsPerform o2!= rxnewAssignPage.pyDefaultTaskStatus cqActionStubDraftMode o2!= rxnewAssignPage.pxFlowName rxnewAssignPage.pyCurrentActionLabel o2!= rxnewAssignPage.pyCurrentActionLabel cq", pxUniqueStreamHash+"_17");metadataPage.put("lMode","Flexbox");
	metadataPage.put("contCustom","page-header padding-0");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2&& o2&& wxpzIsPerform o2!= rxnewAssignPage.pyDefaultTaskStatus cqActionStubDraftMode o2!= rxnewAssignPage.pxFlowName rxnewAssignPage.pyCurrentActionLabel o2!= rxnewAssignPage.pyCurrentActionLabel cq","pzIsPerform && newAssignPage.pyDefaultTaskStatus != \'ActionStubDraftMode\' && newAssignPage.pxFlowName != newAssignPage.pyCurrentActionLabel && newAssignPage.pyCurrentActionLabel != \'\'", "layout", "visible" )) {pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
tools.putParamValue("RWClasses","");
...
IUIComponentMetadata metadataPage = pzAuto.getUIComponentRuntime().createMetadata();
IUIComponent headerComponent = pzAuto.getUIComponent();
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyDialogContainerHeaderB"));
...
String labelName = "CreateNewHeader";
if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() !='N' ){
labelName = "CreateNewHeader"+"\t"+"";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
}else{
tools.appendString(tools.getLocalizedTextForString(".pyCaption","CreateNewHeader"+"\t"+""));
}
metadataPage.put("title", labelName);
metadataPage.put("uniqueid", "202602240939230843");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("20180814100925014850") + " ");
headerComponent.beginComponent("pxLayoutHeader",metadataPage);
headerComponent.endComponent();
}
...
try {
	...
	modePage2.put("pyName","pyDialogContainerHeader_$CTX$_6");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Close\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDialogContainerHeader_"+ referenceString+ "_6'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("201901261711080731178947") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
try {
	...
	modePage2.put("pyName","pyDialogContainerHeader_$CTX$_5");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDialogContainerHeader_"+ referenceString+ "_5'";
	 String securedPropValue = null;
...
pzSection.getLayout().setExpandParam("SubSectionpyDialogContainerHeaderB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpyDialogContainerHeaderB";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\">");
...
l_sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
String labelName = "CreateNewHeader";
labelName = tools.getLocalizedTextForString(".pyCaption","CreateNewHeader"+"\t"+"");
...
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");
	...
	/***-- Grid HeaderElements: Begin --**/
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel3664' data-layout-id='202602240939230822" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel3664'>" + l_sectionTitle + "</h2><nobr>");
pzHeaderCellContent_1();
tools.appendString("</nobr>");
boolean showContainerIcons=tools.getParamValue("showContainerIcons").equals("true")?true:false;
tools.appendString("<span class='header-element header-title-table'>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyDialogContainerHeaderB","tdRightStyle");}
if(showContainerIcons){
tools.appendString("</tr></table>");
}
tools.appendString("</span>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div><div class='header-right'></div></div>");
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpyDialogContainerHeaderB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpzIsPerform", pxUniqueStreamHash+"_11");metadataPage.put("lMode","Flexbox");
	metadataPage.put("contCustom","page-header padding-0");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpzIsPerform","!pzIsPerform", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
tools.putParamValue("RWClasses","");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- PYDIALOGCONTAINERHEADER #20210506T204028.713 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyDialogContainerHeader");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PYDIALOGCONTAINERHEADER #20210506T204028.713 GMT", "Work- pyDialogContainerHeader", "Theme-Cosmos", "04-01-01", "20210506T204028.713 GMT");
}
