...
/**
 * Builds JSP stream @BASECLASS!HOMEWORKLISTNORESULTS.
 */
public class ra_stream_homeworklistnoresults_d25414a3efbf478578612c9b8b3cf5a2 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.HomeWorklistNoResults.Assign_Worklist.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1390045894;
 ...
 */
	public ra_stream_homeworklistnoresults_d25414a3efbf478578612c9b8b3cf5a2(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "2421c78bfd93d14933413f6c9c9f1066ddde00fc";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS HOMEWORKLISTNORESULTS #20210506T204027.506 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "2421c78bfd93d14933413f6c9c9f1066ddde00fc";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("HomeWorklistNoResults",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS HOMEWORKLISTNORESULTS #20210506T204027.506 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS HOMEWORKLISTNORESULTS #20210506T204027.506 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS HOMEWORKLISTNORESULTS #20210506T204027.506 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:HOMEWORKLISTNORESULTS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("HOMEWORKLISTNORESULTS","Rule-HTML-Section","@BASECLASS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION @BASECLASS HOMEWORKLISTNORESULTS #20210506T204027.506 GMT","!HOMEWORKLISTNORESULTS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1390045894), 
...
//	RULE-HTML-SECTION @BASECLASS HOMEWORKLISTNORESULTS #20210506T204027.506 GMT:20210506T204027.506 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "08cd0942f2feba9c2b3db9435d6eb196";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("HomeWorklistNoResults",1,"Rule-HTML-Section","{'type':'Section','ruleName':'HomeWorklistNoResults','insKey':'RULE-HTML-SECTION @BASECLASS HOMEWORKLISTNORESULTS #20210506T204027.506 GMT','templated':'true','sectionType':'standard'}");
pzLayout_4();
...
pzSection.getLayout().setExpandParam("SubSectionHomeWorklistNoResultsBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	String paramName = "EXPANDEDSubSectionHomeWorklistNoResultsBBBB";
...
public void pxDisplayText_1() {String key="d25f75d3-8136-4f78-bd8d-ae7a076b7077||RULE-HTML-SECTION @BASECLASS HOMEWORKLISTNORESULTS #20210506T204027.506 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","d25f75d3-8136-4f78-bd8d-ae7a076b7077"};oCellRuntimeParamsMap.put("d25f75d3-8136-4f78-bd8d-ae7a076b7077||RULE-HTML-SECTION @BASECLASS HOMEWORKLISTNORESULTS #20210506T204027.506 GMT",paramValues);oControlPathsMap.put("d25f75d3-8136-4f78-bd8d-ae7a076b7077||RULE-HTML-SECTION @BASECLASS HOMEWORKLISTNORESULTS #20210506T204027.506 GMT",".pyRegions(2).pyCells(1)||.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
...
pzSection.getLayout().setExpandParam("SubSectionHomeWorklistNoResultsBBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionHomeWorklistNoResultsBBB";
	metadataPage.put("paramName", paramName);
...
try {
	...
	cellPage.put("pyStreamName","HomeWorklistNoResults");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='HomeWorklistNoResults_"+ referenceString+ "_21a0e0b6-2d37-493e-ac98-3efbf24b0022'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
...
pzSection.getLayout().setExpandParam("SubSectionHomeWorklistNoResultsBB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionHomeWorklistNoResultsBB";
	metadataPage.put("paramName", paramName);
...
pzSection.getLayout().setExpandParam("SubSectionHomeWorklistNoResultsB","",false);
}
...
public void simpleLayout_4() {
	...
	String paramName = "EXPANDEDSubSectionHomeWorklistNoResultsB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS HOMEWORKLISTNORESULTS #20210506T204027.506 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "HomeWorklistNoResults");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS HOMEWORKLISTNORESULTS #20210506T204027.506 GMT", "@baseclass HomeWorklistNoResults", "Theme-Cosmos", "04-01-01", "20210506T204027.506 GMT");
}
