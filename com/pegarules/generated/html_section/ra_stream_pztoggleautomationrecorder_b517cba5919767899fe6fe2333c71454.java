...
/**
 * Builds JSP stream DATA-PORTAL!PZTOGGLEAUTOMATIONRECORDER.
 */
public class ra_stream_pztoggleautomationrecorder_b517cba5919767899fe6fe2333c71454 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzToggleAutomationRecorder.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1355878864;
 ...
 */
	public ra_stream_pztoggleautomationrecorder_b517cba5919767899fe6fe2333c71454(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "8bfb1fb36a358fb5ff9c92858bf354f9c569359a";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PZTOGGLEAUTOMATIONRECORDER #20200518T131925.885 GMT	Pega-UIEngine:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "8bfb1fb36a358fb5ff9c92858bf354f9c569359a";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzToggleAutomationRecorder",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PZTOGGLEAUTOMATIONRECORDER #20200518T131925.885 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PZTOGGLEAUTOMATIONRECORDER #20200518T131925.885 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PZTOGGLEAUTOMATIONRECORDER #20200518T131925.885 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZTOGGLEAUTOMATIONRECORDER", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZTOGGLEAUTOMATIONRECORDER","Rule-HTML-Section","DATA-PORTAL",false,"","Pega-UIEngine","08-05-01","RULE-HTML-SECTION DATA-PORTAL PZTOGGLEAUTOMATIONRECORDER #20200518T131925.885 GMT","!PZTOGGLEAUTOMATIONRECORDER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1355878864), 
...
//	RULE-HTML-SECTION DATA-PORTAL PZTOGGLEAUTOMATIONRECORDER #20200518T131925.885 GMT:20200518T131925.885 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "c5e83923617a993c1cc3b3671dbff8f3";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzToggleAutomationRecorder",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzToggleAutomationRecorder','insKey':'RULE-HTML-SECTION DATA-PORTAL PZTOGGLEAUTOMATIONRECORDER #20200518T131925.885 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("pyFunctionName", "pega.ui.dataSourceInspector.stopLiveData");
pega.getUIEngine().getUIAction("runScript", config).register();
config = new HashMap<String, String>();
config.put("sectionName", "pxAutomationTestCasesList");
config.put("pzActivityStaticParams", "sectionName&isForceUpdate");
config.put("pzActivity", "pxSetAutomationEdgePaneSectionName");
config.put("isForceUpdate", "");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.ui.automation.recorder.toggle");
pega.getUIEngine().getUIAction("runScript", config).register();
}
...
tools.appendString("<div class='layout layout-noheader layout-noheader-pz-runtime-top-bar'>");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.ui.dataSourceInspector.stopLiveData()\"]");
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pxSetAutomationEdgePaneSectionName");
		tools.appendString("[\"runActivity\", [\"\", \"");
		ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"sectionName\":\"pxAutomationTestCasesList\"");
		ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"isForceUpdate\":\"\"");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }			tools.appendString("[\"runScript\", [\"pega.ui.automation.recorder.toggle()\"]");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2017121801430303316151") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzToggleAutomationRecorder_$CTX$_1");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Toggle Automation Recorder\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Toggle Automation Recorder", ".pyActionPrompt");
	}
	pyTooltip = "Toggle Automation Recorder";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","tooltip");
	modePage2.put("styles","pz-icon");
	modePage2.put("imgSrc","styleclass");
	String pyIconStyle = "";
	pyIconStyle = "pz-pi pi-potion";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzToggleAutomationRecorder_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2017121801430303316151") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Toggle Automation Recorder\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
		tools.appendString(toolTipVal);tools.appendString("class='pz-icon pzhc pzbutton");tools.appendString("'");if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		tools.appendString(" >");
		String classProp = "";
		 classProp ="pz-pi pi-potion";
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2&& o2== pxparam.isFunctionalTestingEnabled cqtrue o2!= rxpxRequestor.pxPortal cqpxAdminStudio o2!= rxpxThread.pxPortal cqpxAdminStudio","param.isFunctionalTestingEnabled=\'true\'  && pxRequestor.pxPortal != \'pxAdminStudio\' && pxThread.pxPortal != \'pxAdminStudio\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","automation-recorder","automation-recorder")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2017121801430303316151-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","automation-recorder");
	pgCells.put("customRWStyles","automation-recorder");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2&& o2== pxparam.isFunctionalTestingEnabled cqtrue o2!= rxpxRequestor.pxPortal cqpxAdminStudio o2!= rxpxThread.pxPortal cqpxAdminStudio",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","param.isFunctionalTestingEnabled='true'  && pxRequestor.pxPortal != 'pxAdminStudio' && pxThread.pxPortal != 'pxAdminStudio'");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2&& o2== pxparam.isFunctionalTestingEnabled cqtrue o2!= rxpxRequestor.pxPortal cqpxAdminStudio o2!= rxpxThread.pxPortal cqpxAdminStudio", pxUniqueStreamHash+"_6"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzToggleAutomationRecorderB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-pz-inline-middle content-pz-inline-middle content-items-maxwidth" + "'  ");
		...
		pg_dlmeta.put("format","pz-inline-middle");
	...
	String paramName = "EXPANDEDSubSectionpzToggleAutomationRecorderB";
	...
	metadataPage.put("prefix","-pz-runtime-top-bar");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PZTOGGLEAUTOMATIONRECORDER #20200518T131925.885 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzToggleAutomationRecorder");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PZTOGGLEAUTOMATIONRECORDER #20200518T131925.885 GMT", "Data-Portal pzToggleAutomationRecorder", "Pega-UIEngine", "08-05-01", "20200518T131925.885 GMT");
}
