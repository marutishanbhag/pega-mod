...
/**
 * Builds JSP stream RULE-APPLICATION!PRODUCTIONRULESETSSECTION.
 */
public class ra_stream_productionrulesetssection_ff7a3f0d5fdaff56e21b457c214307fe extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.ProductionRuleSetsSection.Rule_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1840443089;
 ...
 */
	public ra_stream_productionrulesetssection_ff7a3f0d5fdaff56e21b457c214307fe(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a8a9a9fcd18644b67d5ab45338af5016a66b53ac";
...
{
/* Instance RULE-HTML-SECTION RULE-APPLICATION PRODUCTIONRULESETSSECTION #20180713T135651.633 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "a8a9a9fcd18644b67d5ab45338af5016a66b53ac";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("ProductionRuleSetsSection",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-APPLICATION PRODUCTIONRULESETSSECTION #20180713T135651.633 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-APPLICATION PRODUCTIONRULESETSSECTION #20180713T135651.633 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-APPLICATION PRODUCTIONRULESETSSECTION #20180713T135651.633 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PRODUCTIONRULESETSSECTION", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PRODUCTIONRULESETSSECTION","Rule-HTML-Section","RULE-APPLICATION",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION RULE-APPLICATION PRODUCTIONRULESETSSECTION #20180713T135651.633 GMT","!PRODUCTIONRULESETSSECTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1840443089), 
...
//	RULE-HTML-SECTION RULE-APPLICATION PRODUCTIONRULESETSSECTION #20180713T135651.633 GMT:20180713T135651.633 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "b98d36f03fe35d0dd84d4681556978c7";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("ProductionRuleSetsSection",1,"Rule-HTML-Section","{'type':'Section','ruleName':'ProductionRuleSetsSection','insKey':'RULE-HTML-SECTION RULE-APPLICATION PRODUCTIONRULESETSSECTION #20180713T135651.633 GMT','sectionType':'null'}");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_7")){
		 ...
		 String buttonUID = "name='ProductionRuleSetsSection_"+ referenceString+ "_12'";
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20141014064306052512428") + "  href='"+hrefValue+"' ");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzCell.getTestIdIfEnabled("2014101406430605239705") + " ");
		...
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyProdRuleSetList1colWidthCache2").equals("")) { tools.appendParamCSF("PpyProdRuleSetList1colWidthCache2");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
...
public void repeatingHeaderCell_1() {
	...
	String strFieldValue = "";
		...
		tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='Production rulesets (customization)' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("2014101406430605238385") + " ");
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyProdRuleSetList1colWidthCache1").equals("")) { tools.appendParamCSF("PpyProdRuleSetList1colWidthCache1");} else { tools.appendString("87.10601719197709"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:22px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont '");tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "Production rulesets (customization)", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<span style='position:absolute; top:0px; right: 0px;'>&nbsp;</span>"); } if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='ProductionRuleSetsSection_"+ referenceString+ "_3'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20141014064306052616187") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Add production ruleset",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "width:100%;",false,"","");tools.putSaveValue("parentLayouttype","ACTION");pxLink_1();
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>\n\n\t\t\t\t\t\t</div>");
...
pzSection.getLayout().setExpandParam("SubSectionProductionRuleSetsSectionB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionProductionRuleSetsSectionB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pyProdRuleSetListL3=null;

 Map selUniqMap_pyProdRuleSetListL3 = null;
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyProdRuleSetList");tools.appendString("_ProductionRuleSetsSection_1'");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pyProdRuleSetList");

					}

					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList='.pyProdRuleSetList .pyTemplateInputBox  ' class='yui-skin-sam gPercent");

					if(pega_uiengine_harness.pzInStandardsMode()) {tools.appendString("  ");

					}tools.appendString("' style='");

					tools.appendString("' gPropIndex='PpyProdRuleSetList1' editRowIndex='");
					...
					tools.appendString(pzSection.getRepeatStyle());String strSummary = "pyProdRuleSetList";
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpyProdRuleSetList1colWidthGBL\" id=\"PpyProdRuleSetList1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyProdRuleSetList1colWidthGBL"));tools.appendString("\" />");

					
						 tools.putParamValue("expandRL","false"); 

					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpyProdRuleSetList1colWidthGBR\" id=\"PpyProdRuleSetList1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyProdRuleSetList1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpyProdRuleSetList1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='pyProdRuleSetList' PL_PROP='");

					
tools.appendString(".pyProdRuleSetList");
					...
					tools.appendString("'>\n\t\t\t\t\t\t\t\t\t\t<tr class='cellCont' ><td class='cellCont rowHandleHead  ' style='height:24px;width:1%'>");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pyProdRuleSetList").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pyProdRuleSetList\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					tools.appendString("draggableCell ");tools.appendString("rowHandle  ' style='height:32px;width:1%;'>");
 ...
 tempNoRespg.removeFromClipboard();
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pyProdRuleSetList1") && tools.getParamValue("partialRefresh").equals("false")) {
...
public void repeatingDataCell_1() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("",".pyProdRuleSetList", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
...
public void pyProdRuleSetList_1() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyProdRuleSetList1")|| tools.getParamValue("partialTrigger").equals("editRow.pyProdRuleSetList1") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pyProdRuleSetList");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pyProdRuleSetList\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pyProdRuleSetList1")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty(".pyProdRuleSetList");
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyProdRuleSetList1") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-APPLICATION PRODUCTIONRULESETSSECTION #20180713T135651.633 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "ProductionRuleSetsSection");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-APPLICATION PRODUCTIONRULESETSSECTION #20180713T135651.633 GMT", "Rule-Application ProductionRuleSetsSection", "Pega-SystemArchitect", "08-01-01", "20180713T135651.633 GMT");
}
