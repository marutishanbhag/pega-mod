...
/**
 * Builds JSP stream RULE-ACCESS-ROLE-NAME!PZDEPENDENTROLES.
 */
public class ra_stream_pzdependentroles_d195adc72b995bf3001f8c3a71e4db09 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzDependentRoles.Rule_Access_Role_Name.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1308856507;
 ...
 */
	public ra_stream_pzdependentroles_d195adc72b995bf3001f8c3a71e4db09(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "f7a8d98765ddf4aedfe720715a9cb5df781344ee";
...
{
/* Instance RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME PZDEPENDENTROLES #20180713T135235.338 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "f7a8d98765ddf4aedfe720715a9cb5df781344ee";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzDependentRoles",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME PZDEPENDENTROLES #20180713T135235.338 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME PZDEPENDENTROLES #20180713T135235.338 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME PZDEPENDENTROLES #20180713T135235.338 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZDEPENDENTROLES", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZDEPENDENTROLES","Rule-HTML-Section","RULE-ACCESS-ROLE-NAME",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME PZDEPENDENTROLES #20180713T135235.338 GMT","!PZDEPENDENTROLES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1308856507), 
...
//	RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME PZDEPENDENTROLES #20180713T135235.338 GMT:20180713T135235.338 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "5f246f137e81fc4427bf011fc38b9d80";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzDependentRoles",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzDependentRoles','insKey':'RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME PZDEPENDENTROLES #20180713T135235.338 GMT','sectionType':'standard'}");
pzLayout_1();
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		keyMap.putString("pyActionName", "pzManageDependentRoles");
		...
		try{
		pzPackageRuntime.packageLocalAction("pzManageDependentRoles", offlineUsingPage , strLAClassName);
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("pzDependentRoles",
				...
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pzManageDependentRoles\",\"true\",\":event\",\"\",\""+streamType+"\",\"\",\"\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-bottom%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"true\",\"false\",\"\",\"\"]");
					} else {
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20151027032304059256503") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzDependentRoles_$CTX$_1");
		String repeatIndx = "";
	String pyTooltip = "";
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Manage dependent roles\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Manage dependent roles", ".pyButtonLabel");
	}
	pyLabel = "Manage dependent roles";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzDependentRoles_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Manage dependent roles".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		...
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Manage dependent roles",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
pzSection.getLayout().setExpandParam("SubSectionpzDependentRolesB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzDependentRolesB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME PZDEPENDENTROLES #20180713T135235.338 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzDependentRoles");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-ACCESS-ROLE-NAME PZDEPENDENTROLES #20180713T135235.338 GMT", "Rule-Access-Role-Name pzDependentRoles", "Pega-Desktop", "08-01-01", "20180713T135235.338 GMT");
}
