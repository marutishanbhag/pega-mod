...
/**
 * Builds JSP stream EMBED-FIELDS!PZFIELDMODEDROPDOWN.
 */
public class ra_stream_pzfieldmodedropdown_8e9d9f876179179b70b5f37151595404 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzFieldModeDropdown.Embed_Fields.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1602098281;
 ...
 */
	public ra_stream_pzfieldmodedropdown_8e9d9f876179179b70b5f37151595404(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "df0c32cf4a12d72851541d9274f9fd1c22a88911";
...
{
/* Instance RULE-HTML-SECTION EMBED-FIELDS PZFIELDMODEDROPDOWN #20180713T140830.094 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "df0c32cf4a12d72851541d9274f9fd1c22a88911";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzFieldModeDropdown",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-FIELDS PZFIELDMODEDROPDOWN #20180713T140830.094 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-FIELDS PZFIELDMODEDROPDOWN #20180713T140830.094 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-FIELDS PZFIELDMODEDROPDOWN #20180713T140830.094 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZFIELDMODEDROPDOWN", 
	"Rule-Obj-Property:PYFIELDMODE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZFIELDMODEDROPDOWN","Rule-HTML-Section","EMBED-FIELDS",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION EMBED-FIELDS PZFIELDMODEDROPDOWN #20180713T140830.094 GMT","!PZFIELDMODEDROPDOWN",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1602098281), 
		new DependentRuleInfo("PYFIELDMODE","Rule-Obj-Property","EMBED-FIELDS",true,"Embed-Fields","Pega-ProcessArchitect","08-01-01","RULE-OBJ-PROPERTY EMBED-FIELDS PYFIELDMODE #20180713T140707.240 GMT","!PYFIELDMODE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION EMBED-FIELDS PZFIELDMODEDROPDOWN #20180713T140830.094 GMT:20180713T140830.094 GMT
//	RULE-HTML-PROPERTY PXDROPDOWN #20191010T062311.436 GMT:20191010T062311.436 GMT
//	RULE-OBJ-PROPERTY EMBED-FIELDS PYFIELDMODE #20180713T140707.240 GMT:20180713T140707.240 GMT
//	RULE-HTML-PROPERTY PXDROPDOWN #20191010T062311.436 GMT:20191010T062311.436 GMT
//	RULE-OBJ-PROPERTY EMBED-FIELDS PYFIELDMODE #20180713T140707.240 GMT:20180713T140707.240 GMT
//	RULE-OBJ-PROPERTY EMBED-FIELDS PYFIELDMODE #20180713T140707.240 GMT:20180713T140707.240 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "be595ecf048edeced871d98b26db907a";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzFieldModeDropdown",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzFieldModeDropdown','insKey':'RULE-HTML-SECTION EMBED-FIELDS PZFIELDMODEDROPDOWN #20180713T140830.094 GMT','sectionType':'standard'}");
...
public void pxDisplayText_1() {String key="4||RULE-HTML-SECTION EMBED-FIELDS PZFIELDMODEDROPDOWN #20180713T140830.094 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","4"};oCellRuntimeParamsMap.put("4||RULE-HTML-SECTION EMBED-FIELDS PZFIELDMODEDROPDOWN #20180713T140830.094 GMT",paramValues);oControlPathsMap.put("4||RULE-HTML-SECTION EMBED-FIELDS PZFIELDMODEDROPDOWN #20180713T140830.094 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
public void inclFormattedVal_3(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {if (isSecuredProp) { tools.putParamValue("proSecurity_isSecuredProp", isSecuredProp);tools.putParamValue("proSecurity_activePropValue", activePropValue);}
		...
		tools.appendString(pega_uiengine_formatter.pxFormatText(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzFieldModeOptions","","","D_pzFieldModeOptions:FieldModeRestriction$.pyFieldModeRestrictions~isInCaseForm$.pyIsInCaseForm",".pyDescription",".pyLabel",true,(PegaStreamAPI)tools),false,"","",true,"caption"));
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzFieldModeOptions","","","D_pzFieldModeOptions:FieldModeRestriction$.pyFieldModeRestrictions~isInCaseForm$.pyIsInCaseForm",".pyDescription",".pyLabel",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("isControlEditableOriginal"))) {
		...
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzFieldModeOptions","","","D_pzFieldModeOptions:FieldModeRestriction$.pyFieldModeRestrictions~isInCaseForm$.pyIsInCaseForm",".pyDescription",".pyLabel",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("FORMAT_PLAIN_TXT")) && ((pzAuto.getBrowserUtils().isIE() && !pega_uiengine_harness.pzInStandardsMode()) || "true".equals(tools.getParamValue("fromAPI"))) ){
			tools.appendString("&nbsp;");
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-change='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				refreshActionRequest.registerFixedParameter("StreamList", "pzFieldsEntryRow|Rule-HTML-Section|:");
				staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
				tools.appendString("[\"refresh\", [\"otherSection\",\"pzFieldsEntryRow\", \"\", \"");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }						tools.appendString("[\"setItemFocus\",[\"" + pzAuto.getUIComponentRuntime().generateActionToken(".pyFieldMode") + "\"]");
...
tools.appendString("</P>");
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2017031311222300933267",true));
	cellPage.put("pyValue",".pyFieldMode");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyFieldMode");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyFieldMode", ".pyCaption");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyFieldMode",pxUniqueStreamHash+"_16");
	...
	modePage1.put("pyID","pyFieldMode");
	...
	sourceDPParams.put("FieldModeRestriction", ".pyFieldModeRestrictions");
	sourceDPParams.put("isInCaseForm", ".pyIsInCaseForm");
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
	tools.findPage("D_pzFieldModeOptions");
	}
	tools.putParamValue("bListOptionsLocalize","true");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadDataPage("D_pzFieldModeOptions", listProperties, pxUniqueStreamHash+"_17", sourceDPParams);
	...
	pyDataPageParams.put("pyName","FieldModeRestriction");
	pyDataPageParams.put("pyValue","#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyFieldModeRestrictions")+"~#");
	pyDataPage.addMetadataInArray("pyDataPageParams",pyDataPageParams);
	pyDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();  
	pyDataPageParams.put("pyName","isInCaseForm");
	pyDataPageParams.put("pyValue","#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyIsInCaseForm")+"~#");
	pyDataPage.addMetadataInArray("pyDataPageParams",pyDataPageParams);
	pyListDataSource.putMetadata("pyDataPage",pyDataPage);
	modePage1.putMetadata("pyListDataSource",pyListDataSource);
	String pageName = "D_pzFieldModeOptions";
	String dataPageName = "D_pzFieldModeOptions";
	if(tools.findPage("D_pzFieldModeOptions") != null){
	pageName = tools.findPage("D_pzFieldModeOptions").getReference();
	}
	modePage1.put("pySourceName",dataPageName);
	modePage1.put("pyHashedDataPage",pageName);
	pageName = "D_pzFieldModeOptions";
	modePage1.put("tooltip","");
	modePage1.put("pyGroupLabel","");
	modePage1.put("pyValue",".pyLabel");
	modePage1.put("pyPrompt",".pyDescription");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen("pzIsFieldModeDisabled",pxUniqueStreamHash+"_18");
	...
	pxWhenIdentifiers.put("pyDisabledWhenId",pxUniqueStreamHash+"_18");
	pxWhenIdentifiers.put("pyDisabledWhenName","pzIsFieldModeDisabled");
	...
	modePage2.put("pySourceName","D_pzFieldModeOptions");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyFieldMode");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyFieldMode", ".pyCaption");
	pyValueR = ".pyFieldMode";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyFieldMode");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyFieldMode", ".pyCaption");
	pyValueOrig = ".pyFieldMode";
	...
	com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		ct_controlAction.trackValueChanges(tools.getProperty(".pyFieldModeRestrictions"), -1);
		ct_controlAction.trackValueChanges(tools.getProperty(".pyIsInCaseForm"), -1);
	}}catch(Exception e){}
	}
} else {
	...
	String disabled_ctrl = "";
		...
		if(com.pega.pegarules.jsptags.WhenTag.evaluateWhen(pega, "pzIsFieldModeDisabled", null, false))
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_21");}if(beginNonTemplate){			HashStringMap params = new HashStringMap();
			tools.putParamValue("FieldModeRestriction", 
			tools.getProperty(".pyFieldModeRestrictions").getStringValue()
			);
			tools.putParamValue("isInCaseForm", 
			tools.getProperty(".pyIsInCaseForm").getStringValue()
			);
			String pageName ="D_pzFieldModeOptions";
	...
	pageName = tools.getStepPage().getName()+pageName;
		...
		String strActiveValue = isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true);			String strValue = isSecuredProp ? activePropValue : tools.getProperty(ddPropRef).getStringValue();
			...
			if(!isAccessible) {
				...
				tools.appendString(" " + pzCell.getTestIdIfEnabled("2017031311222300933267") + " ");
...
tools.appendString(" data-bindprops='value' ");} else{			tools.appendString(ddPropEntryHandle);
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2017031311222300933267") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_22")){inclFormattedVal_3(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o1! wxpzIsUnsupportedFieldType","!pzIsUnsupportedFieldType","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDropdown",".pyFieldMode",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("2017031311222300933267-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	
	ClipboardProperty propActivePrev = tools.getActive();
	tools.putActive(tools.getStepPage().getProperty(".pyFieldMode"));
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Options") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2017031311222300933267-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Options") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");pxDropdown_2(".pyFieldMode",0,"","","Text");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2017031311222300933267-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDropdown");
	pgCells.put("forLabel",".pyFieldMode");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxpzIsUnsupportedFieldType",pxUniqueStreamHash+"_24");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_24");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","!pzIsUnsupportedFieldType");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpzIsUnsupportedFieldType", pxUniqueStreamHash+"_24"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDropdown",".pyFieldMode",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDropdown_2(".pyFieldMode",0,"","","Text");}
	if (!isExpression && isOffline) {
	// do nothing
	} else {
...
public int simpleLayoutCell_3( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpzIsUnsupportedFieldType","pzIsUnsupportedFieldType","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyFieldMode",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	isCellReadOnly = true;
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20150218172335075621600-Label") + "  class='field-caption dataLabelForRead' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20150218172335075621600-Label") + "  class='field-caption dataLabelForRead' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","remove-all-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20150218172335075621600-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzIsUnsupportedFieldType",pxUniqueStreamHash+"_26");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzIsUnsupportedFieldType", pxUniqueStreamHash+"_26"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyFieldMode",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_1();}
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldModeDropdownBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpzFieldModeDropdownBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpzIsPageListField", pxUniqueStreamHash+"_27");metadataPage.put("lMode","Inline-block");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if(pzAuto.handleEvaluateWhen(" o1! wxpzIsPageListField","!pzIsPageListField", "layout", "visible" )) {pzSetExpandParam_2();
...
tools.appendString("</P>");
	...
	String repeatIndx = "";
	IUIComponentMetadata pyUserData = pzAuto.getUIComponentRuntime().createMetadata();
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20170227175250001829939",true));
	cellPage.put("pyValue",".pyFieldMode");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyFieldMode");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyFieldMode", ".pyCaption");
	...
	String ddPropRef = tools.getActive().getReference();
	String clientValidationAttributes = pzAuto.getCell().getClientValidationAttributes(pyOnInput, pyEditValidate, pyStringType,pegaValidation.toString());
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyFieldMode",pxUniqueStreamHash+"_5");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8");}if(beginNonTemplate){			HashStringMap params = new HashStringMap();
		...
		String strActiveValue = isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true);			String strValue = isSecuredProp ? activePropValue : tools.getProperty(ddPropRef).getStringValue();
			...
			if(!isAccessible) {
				tools.appendString("<select data-ctl='[\"Dropdown\"]' ");
				tools.appendString(" " + pzCell.getTestIdIfEnabled("20170227175250001829939") + " ");
				tools.appendString(styleAttribute + disabled_ctrl + " id='");
				tools.appendString(tools.getHTMLIDForProperty(true,"dropdown"));
			tools.appendString("'");
			} else {
...
tools.appendString(" data-bindprops='value' ");			tools.appendString(" data-bindDefaultValue='Auto'");
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("20170227175250001829939") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDropdown",".pyFieldMode",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20170227175250001829939-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20170227175250001829939-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");pxDropdown_1(".pyFieldMode",0,"","","Text");
tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","remove-all-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20170227175250001829939-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDropdown");
	pgCells.put("forLabel",".pyFieldMode");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDropdown",".pyFieldMode",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDropdown_1(".pyFieldMode",0,"","","Text");labelName = "Options";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldModeDropdownB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzFieldModeDropdownB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzIsPageListField", pxUniqueStreamHash+"_12");metadataPage.put("lMode","Inline-block");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzIsPageListField","pzIsPageListField", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
sectionDefaultValues_1() {
	...
	if(pzAuto.handleEvaluateWhen(" o2== rx.pyFieldMode cq",".pyFieldMode", "cell", "active" )) {
		 tools.getProperty(".pyFieldMode").setValue("Auto");if (pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'){String tempDefault=tools.getProperty(".pyFieldMode").toString();
		 tools.getProperty(".pyFieldMode").setValue("");pzAuto.getUIComponentRuntime().getRuntimeContextTree().addDefaultValue(".pyFieldMode",tempDefault);}
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-FIELDS PZFIELDMODEDROPDOWN #20180713T140830.094 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzFieldModeDropdown");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-FIELDS PZFIELDMODEDROPDOWN #20180713T140830.094 GMT", "Embed-Fields pzFieldModeDropdown", "Pega-ProcessArchitect", "08-01-01", "20180713T140830.094 GMT");
}
