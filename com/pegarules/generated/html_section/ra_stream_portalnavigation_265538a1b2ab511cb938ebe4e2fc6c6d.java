 ...
 */
public class ra_stream_portalnavigation_265538a1b2ab511cb938ebe4e2fc6c6d extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
 ...
 */
	public ra_stream_portalnavigation_265538a1b2ab511cb938ebe4e2fc6c6d(com.pega.pegarules.priv.PegaAPI aContext) {
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "b8f31ead909e90107eebe2cd65a34a39";
	}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771700296303");
	if(pzAuto.isOffline() || false) {
	try{
	pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771700296303","", false, false, false, false);
	...
	tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771700296304");
	if(pzAuto.isOffline() || false) {
	try{
	pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771700296304","", false, false, false, false);
	}catch(Exception e){oLog.error(e);}
	}
	tools.appendString("\"},\":event\"]");
...
pzStatic_ControlMenu.emitContent();
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771700296305");
		if(pzAuto.isOffline() || false) {
		try{
		pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771700296305","", false, false, false, false);
		}catch(Exception e){oLog.error(e);}
		}
		tools.appendString("\"},\":event\"]");
		...
		tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771700296306");
		if(pzAuto.isOffline() || false) {
		try{
		pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771700296306","", false, false, false, false);
		}catch(Exception e){oLog.error(e);}
		}
		tools.appendString("\"},\":event\"]");
...
pzSection.getLayout().setExpandParam("SubSectionCellPortalNavigation402","",false);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellPortalNavigation984","",false);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellPortalNavigation931","",false);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellPortalNavigation320","",false);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellPortalNavigation428","",false);
}
