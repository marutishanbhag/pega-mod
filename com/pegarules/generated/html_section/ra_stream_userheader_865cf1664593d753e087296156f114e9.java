...
/**
 * Builds JSP stream DATA-PORTAL!USERHEADER.
 */
public class ra_stream_userheader_865cf1664593d753e087296156f114e9 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.UserHeader.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -384689758;
 ...
 */
	public ra_stream_userheader_865cf1664593d753e087296156f114e9(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "e2a808a62f2a27fdd6e0441f9ec3daa7e607a682";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "e2a808a62f2a27fdd6e0441f9ec3daa7e607a682";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("UserHeader",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:USERHEADER", 
	"Rule-HTML-Section:PZUSERHEADER", 
	"Rule-Obj-Property:PYLABEL", 
	"Rule-Obj-Property:PYHEADERTEXT", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("USERHEADER","Rule-HTML-Section","DATA-PORTAL",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT","!USERHEADER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-384689758), 
		new DependentRuleInfo("PZUSERHEADER","Rule-HTML-Section","DATA-PORTAL",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION DATA-PORTAL PZUSERHEADER #20210506T204030.790 GMT","!PZUSERHEADER",false,false,"MISSING",-1292173892), 
		new DependentRuleInfo("PYLABEL","Rule-Obj-Property","@BASECLASS",true,"Data-Portal","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYLABEL #20180713T131156.327 GMT","!PYLABEL",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYHEADERTEXT","Rule-Obj-Property","DATA-PORTAL",true,"Data-Portal","Pega-Desktop","08-01-01","RULE-OBJ-PROPERTY DATA-PORTAL PYHEADERTEXT #20180713T135018.293 GMT","!PYHEADERTEXT",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT:20210827T200724.857 GMT
//	RULE-HTML-SECTION DATA-PORTAL PZUSERHEADER #20210506T204030.790 GMT:20230721T113614.021 GMT
...
//	RULE-OBJ-PROPERTY DATA-PORTAL PYHEADERTEXT #20180713T135018.293 GMT:20180713T135018.293 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "7de5061e7a45eb7f27499e1d602608e3";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("UserHeader",1,"Rule-HTML-Section","{'type':'Section','ruleName':'UserHeader','insKey':'RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT','templated':'true','sectionType':'standard'}");
pzLayout_1();
pzLayout_5();
pzLayout_7();
...
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.u.d.skipToContent");
...
pzSection.getLayout().setExpandParam("SubSectionCellUserHeader118","",false);
}
...
public void buildSection_3() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_32","WorkList", secInfo);
}
...
ClipboardProperty cp_DCList = pg_displayTemp.getProperty("pyContainerList");
 ...
 cp_DCList.getPropertyValue(1).setValue(tgName);
	...
	pg_SectionTab = tools.findPage("pyDisplayTemp").getProperty("pyElements").getPageValue("UserHeader");
...
public int simpleLayoutCell_10( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","WorkList",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_10( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","WorkList",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	...
	tempRenderSingle = tools.getParamValue("RenderSingle");
	tools.putParamValue("RenderSingle", "");
	pzLayout_6();pzGeneratedMicroDCContent_1();
...
pzSection.getLayout().setExpandParam("SubSectionUserHeaderBBBBB","",false);
}
...
public void simpleLayout_5() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3)'}") + " class='" + "flex  content  layout-content-inline content-inline dialog-container" + "'  ");
	...
	String paramName = "EXPANDEDSubSectionUserHeaderBBBBB";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771700296076");
	if(pzAuto.isOffline() || false) {
	try{
	pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771700296076","", false, false, false, false);
	...
	tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771700296077");
	if(pzAuto.isOffline() || false) {
	try{
	pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771700296077","", false, false, false, false);
	}catch(Exception e){oLog.error(e);}
	}
	tools.appendString("\"},\":event\"]");
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxOperatorImage",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_27")) {	field_pxOperatorImage_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionUserHeaderBBBB","",false);
}
...
pzStatic_ControlMenu.emitContent();
	...
	if(currentTemplatingStatus != 'N'){
	spxUniqueStreamHash23 = getUIActionsMetaData_3();
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20230601060654044270") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + " class='" + "flex  content  pointer has-action layout-content-inline_middle content-inline_middle operator-image-avatar" + "'  " + "role='button' tabindex='0' ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		...
		tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771700296078");
		if(pzAuto.isOffline() || false) {
		try{
		pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771700296078","", false, false, false, false);
		}catch(Exception e){oLog.error(e);}
		}
		tools.appendString("\"},\":event\"]");
		...
		tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771700296079");
		if(pzAuto.isOffline() || false) {
		try{
		pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771700296079","", false, false, false, false);
		}catch(Exception e){oLog.error(e);}
		}
		tools.appendString("\"},\":event\"]");
		...
		pg_dlmeta.put("customClassName","operator-image-avatar");
	...
	String paramName = "EXPANDEDSubSectionUserHeaderBBBB";
...
public void buildSection_2() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_22","WorkSearchGadgetHeader", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "WorkSearchGadgetHeader"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellUserHeader149","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_19","WorkSearchGadgetHeader", secInfo);
}
...
public void pxDisplayText_2() {String key="7||RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","7"};oCellRuntimeParamsMap.put("7||RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT",paramValues);oControlPathsMap.put("7||RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");}


public void pxDisplayText_1() {String key="6||RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","64","","","Text","true","6"};oCellRuntimeParamsMap.put("6||RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT",paramValues);oControlPathsMap.put("6||RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");}
...
try {
	...
	cellPage.put("pyStreamName","UserHeader");
	...
	String classProp = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty("pyPortal.pyImage");
	classProp = "pyPortal.pyImage";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2019032707441901935650") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='UserHeader_"+ referenceString+ "_5'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String classProp = "";
		classProp = tools.getProperty("pyPortal.pyImage").getStringValue();
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("2019032707441901935650") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
try {
	...
	HashStringMap instanceKeys = new HashStringMap();
		...
		String proprefAttr = "";	String imgurl = tools.getProperty("pyPortal.pyImage").getStringValue();
	if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	String strEntryHandle = tools.getProperty("pyPortal.pyImage").getEntryHandle();
	proprefAttr = "data-propref='"+strEntryHandle+"'";
	}
	String pyIconProperty = "pyPortal.pyImage";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty("pyPortal.pyImage");
	pyIconProperty = "pyPortal.pyImage";
	modePage1.put("pyIconProperty",pyIconProperty);
	modePage1.put("proprefAttr",proprefAttr);
	java.net.URL imgurl_ext  = null;
	if(imgurl != null && imgurl.contains("://")){
	try{ imgurl_ext  = new java.net.URL(imgurl);
	isImgSrcUrl =true;}catch(Exception imge){}
	}
	if(isImgSrcUrl) {
	...
	String[] imgSrcSplit = imgurl.split("/");
	String appName = "webwb";
	if(imgurl.lastIndexOf("/") != -1){
	appName = imgSrcSplit[0];}
	try{
	String imageName = imgurl.substring(imgurl.lastIndexOf("/")+1,imgurl.lastIndexOf("."));
	String extension = imgurl.substring(imgurl.lastIndexOf(".")+1);
	instanceKeys.putString("pyFileName",imageName);
	instanceKeys.putString("pyFileType",extension);
	}catch(Exception e){}
	instanceKeys.putString("pyApplicationName", appName);
	instanceKeys.putString("pxObjClass","Rule-File-Binary");
	pyIconWidth = 40;
	pyIconHeight = 40;
	try{imagePage = tools.getDatabase().open(instanceKeys,false);}catch(Exception e){}
	if(imagePage != null) {
	byte[] imgBytes = Base64Util.decodeToByteArray(imagePage.getString("pyFileSource"));
	java.awt.image.BufferedImage iicon = null;
	}
	else{
	if(imgurl.indexOf(",") != -1){
	String slicedImgUrl = imgurl.substring(imgurl.indexOf(",")+1);
	byte[] imgBytes = Base64Util.decodeToByteArray(slicedImgUrl);
	java.awt.image.BufferedImage iicon = null;
	}
	}
	}
	...
	src = (tools.evaluateWhen(whenHc) || pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) ? pega_uiengine_offlinesupport.pzGetBase64Encoding(StringUtils.crossScriptingFilter(imgurl)) : StringUtils.crossScriptingFilter(imgurl);
	}
	modePage1.put("src",src);
	String style = "";
	if(pyIconWidth != 0 || pyIconHeight !=0){
	style = "style='width:"+pyIconWidth+"px;height:"+pyIconHeight+"px;'";
	}
	modePage1.put("style",style);
	if(disable){
	modePage1.put("pyDisabled",disable+"");
	}
	modePage1.put("iconSrc","property");
	modePage1.put("pyFormatTypeActionable","none");
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2019032707440904433327") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='UserHeader_"+ referenceString+ "_4'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
		...
		ClipboardPage imagePage = null;
		HashStringMap instanceKeys = new HashStringMap();
		String imgurl = tools.getProperty("pyPortal.pyImage").getStringValue();
		if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
			String strEntryHandle = tools.getProperty("pyPortal.pyImage").getEntryHandle();
			proprefAttr = "data-propref='"+strEntryHandle+"'";}
		java.net.URL imgurl_ext  = null;
		 try{ imgurl_ext  = new java.net.URL(imgurl);
		 isImgSrcUrl =true;}catch(Exception imge){}
		if(isImgSrcUrl) {java.awt.image.BufferedImage iicon = null;
		pyIconWidth = 40;
		pyIconHeight = 40;
		}
		else {
		...
		try{imagePage = tools.getDatabase().open(instanceKeys,false);}catch(Exception e){}
		if(imagePage != null) {
		byte[] imgBytes = Base64Util.decodeToByteArray(imagePage.getString("pyFileSource"));java.awt.image.BufferedImage iicon = null;
		}
		else{
			if(imgurl.indexOf(",") != -1){
		String slicedImgUrl = imgurl.substring(imgurl.indexOf(",")+1);
		byte[] imgBytes = Base64Util.decodeToByteArray(slicedImgUrl);java.awt.image.BufferedImage iicon = null;
		}
		}
		}
		if(pyIconWidth != 0 || pyIconHeight !=0){
		tools.appendString("<i class='icons' "+proprefAttr+" style='width:"+pyIconWidth+"px;height:"+pyIconHeight+"px;'><img  " + pzCell.getTestIdIfEnabled("2019032707440904433327") + "  data-ctl='Icon'  ");tools.appendString("src='");
		if(imgurl!=null && ("").equals(imgurl)){
	tools.appendString("'");
		}else{tools.appendString((pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) ? pega_uiengine_offlinesupport.pzGetBase64Encoding(StringUtils.crossScriptingFilter(imgurl)) : StringUtils.crossScriptingFilter(imgurl));tools.appendString("'");}if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		}
		else{
		tools.appendString("<i class='icons' "+proprefAttr+"><img  " + pzCell.getTestIdIfEnabled("2019032707440904433327") + "  data-ctl='Icon' "); tools.appendString(" src='");
		if(imgurl!=null && ("").equals(imgurl)){
	tools.appendString("'");
		}else{tools.appendString((pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) ? pega_uiengine_offlinesupport.pzGetBase64Encoding(imgurl) : StringUtils.crossScriptingFilter(imgurl));tools.appendString("'");}if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	tools.appendString("],[\"showHarnessWrapper\",[\"newDocument\",\"");
		...
		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken("D_pzDynamicNavigationPages.pxResults(1).pyClassName")+"~#");	tools.appendString("\",\"");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken("D_pzDynamicNavigationPages.pxResults(1).pyStreamName")+"~#");	tools.appendString("\",\"");
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzPackageRuntime.packageHarness("D_pzDynamicNavigationPages.pxResults(1).pyStreamName",
	"D_pzDynamicNavigationPages.pxResults(1).pyClassName"
	,"Display","-1");
	}

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.u.d.skipToContent(\\\"main\\\")\"]");

		tools.appendString("]");isBehaviorAdded = true;
		tools.appendString("]' ");isBehaviorAdded = false;
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"setMobileTransition\",[\"");
	...
	,"Display","-1");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty("D_pzDynamicNavigationPages.pxResults(1).pyClassName"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty("D_pzDynamicNavigationPages.pxResults(1).pyStreamName"), -1);
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& wxpzDisplayLogo wxpzShowAppLogo","pzDisplayLogo && pzShowAppLogo","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","AppIcon-color","AppIcon-color")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2019032707440904433327-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxIcon");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","AppIcon-color");
	pgCells.put("customRWStyles","AppIcon-color");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxpzDisplayLogo wxpzShowAppLogo",pxUniqueStreamHash+"_8");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_8");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzDisplayLogo && pzShowAppLogo");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxpzDisplayLogo wxpzShowAppLogo", pxUniqueStreamHash+"_8"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxIcon_1();}
...
public int simpleLayoutCell_3( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& wxpzDisplayLogo o1! wxpzShowAppLogo","pzDisplayLogo && !pzShowAppLogo","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","AppIcon-color","AppIcon-color")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2019032707441901935650-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxIcon");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxpzDisplayLogo o1! wxpzShowAppLogo",pxUniqueStreamHash+"_12");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxpzDisplayLogo o1! wxpzShowAppLogo", pxUniqueStreamHash+"_12"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxIcon_2();}
...
public int simpleLayoutCell_4( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2|| wxpzShowAppNameOnly wxpzShowChannelAndAppName","pzShowAppNameOnly || pzShowChannelAndAppName","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText","Application.pyLabel",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + "   infinity-app-title dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2014100609491604293426-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel","Application.pyLabel");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","infinity-app-title");
	pgCells.put("customRWStyles","infinity-app-title");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2|| wxpzShowAppNameOnly wxpzShowChannelAndAppName",pxUniqueStreamHash+"_14");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_14");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzShowAppNameOnly || pzShowChannelAndAppName");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Data-Portal");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_14");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2|| wxpzShowAppNameOnly wxpzShowChannelAndAppName", pxUniqueStreamHash+"_14"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText","Application.pyLabel",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_1();}
...
public int simpleLayoutCell_5( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2|| wxpzShowChannelNameOnly wxpzShowChannelAndAppName","pzShowChannelNameOnly || pzShowChannelAndAppName","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText","pyPortal.pyHeaderText",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-field item-" + Integer.toString(index) + "   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202004011448150197276-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel","pyPortal.pyHeaderText");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	pgCells.put("pyReadOnlyWhenCond","readonlyAlways");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2|| wxpzShowChannelNameOnly wxpzShowChannelAndAppName",pxUniqueStreamHash+"_16");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_16");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzShowChannelNameOnly || pzShowChannelAndAppName");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Data-Portal");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_16");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2|| wxpzShowChannelNameOnly wxpzShowChannelAndAppName", pxUniqueStreamHash+"_16"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText","pyPortal.pyHeaderText",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_2();}
...
pzSection.getLayout().setExpandParam("SubSectionUserHeaderBBB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201812112112330631863") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  pointer has-action layout-content-inline_middle content-inline_middle flex-nowrap" + "'  " + "role='link' tabindex='0' ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
	...
	String paramName = "EXPANDEDSubSectionUserHeaderBBB";
...
public int simpleLayoutCell_7( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","WorkSearchGadgetHeader",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","app-search flex-none","app-search flex-none")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","app-search flex-none");
	pgCells.put("customRWStyles","app-search flex-none");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","WorkSearchGadgetHeader",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionUserHeaderBB","",false);
}
...
public void simpleLayout_4() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201906141346540780863") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionUserHeaderBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rxpyPortal.pyShowAppHeaderBar cqtrue", pxUniqueStreamHash+"_30");metadataPage.put("lMode","SimpleDiv");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2== rxpyPortal.pyShowAppHeaderBar cqtrue","pyPortal.pyShowAppHeaderBar = \'true\'", "layout", "visible" )) {pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
pzSection.getLayout().setExpandParam("SubSectionUserHeaderB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)','region':'Header'}") + " class='" + "flex  content  layout-content-inline content-inline min-height-0" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","min-height-0");
		pg_dlmeta.put("format","inline");
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)','region':'Header'}") + "").append("\"").toString();
		if(!inspectorData.equals("\"\"")) {
		pg_dlmeta.put("liveUI",inspectorData);
		}
		pg_dlmeta.put("clear","false");
	...
	String paramName = "EXPANDEDSubSectionUserHeaderB";
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)','region':'Header'}");
	if(!inspectorLayoutData.isEmpty()) {
	metadataPage.put("liveUI", inspectorLayoutData);
	}
	String pyPrefix = null;
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "UserHeader");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL USERHEADER #20210506T204031.073 GMT", "Data-Portal UserHeader", "Theme-Cosmos", "04-01-01", "20210827T200724.857 GMT");
}
