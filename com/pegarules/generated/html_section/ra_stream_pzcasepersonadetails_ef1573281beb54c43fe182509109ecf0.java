...
/**
 * Builds JSP stream RULE-PERSONA!PZCASEPERSONADETAILS.
 */
public class ra_stream_pzcasepersonadetails_ef1573281beb54c43fe182509109ecf0 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzCasePersonaDetails.Rule_Persona.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1848680546;
 ...
 */
	public ra_stream_pzcasepersonadetails_ef1573281beb54c43fe182509109ecf0(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "c5202b3601bafb21c3a5812d84b97574fc4944ae";
...
{
/* Instance RULE-HTML-SECTION RULE-PERSONA PZCASEPERSONADETAILS #20210113T093432.505 GMT	Pega-AppDefinition:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "c5202b3601bafb21c3a5812d84b97574fc4944ae";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzCasePersonaDetails",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-PERSONA PZCASEPERSONADETAILS #20210113T093432.505 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-PERSONA PZCASEPERSONADETAILS #20210113T093432.505 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-PERSONA PZCASEPERSONADETAILS #20210113T093432.505 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZCASEPERSONADETAILS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCASEPERSONADETAILS","Rule-HTML-Section","RULE-PERSONA",false,"","Pega-AppDefinition","08-06-01","RULE-HTML-SECTION RULE-PERSONA PZCASEPERSONADETAILS #20210113T093432.505 GMT","!PZCASEPERSONADETAILS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1848680546), 
		new DependentRuleInfo("PYDESCRIPTION","Rule-Obj-Property","@BASECLASS",true,"Rule-Persona","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYDESCRIPTION #20180713T131156.222 GMT","!PYDESCRIPTION",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE-PERSONA PZCASEPERSONADETAILS #20210113T093432.505 GMT:20210113T093432.505 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "1fc34ef1164043c75ee381ab207af755";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzCasePersonaDetails",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzCasePersonaDetails','insKey':'RULE-HTML-SECTION RULE-PERSONA PZCASEPERSONADETAILS #20210113T093432.505 GMT','sectionType':'standard'}");
pzLayout_5();
pzLayout_6();
pzLayout_7();
pzLayout_8();
...
config.put("action", "ENABLE");
config.put("pzActivityStaticParams", "action");
config.put("pzActivity", "pzEnableDescription");
...
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
config.put("pyActivity", "pzEnableDescription");
config.put("StaticActivityParams", "action=DISABLE");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
config.put("pyActivity", "pzEditPersonaDescription");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
config.put("pyActivity", "pzEditPersonaDescription");
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						pzPackageRuntime.packageSection("pzCasePersonaDetails",
						...
						refreshActionRequest.registerFixedParameter("PreActivity", "pzEditPersonaDescription");
						staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzCasePersonaDetails"));
						staticURLStr.append("&PreActivity=pzEditPersonaDescription");
						tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"pzEditPersonaDescription\", \"");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202003300609520621636") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzCasePersonaDetails_$CTX$_14");
		String repeatIndx = "";
	String pyTooltip = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzCasePersonaDetails_"+ referenceString+ "_14'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202003300609520621636") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			...
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						...
						refreshActionRequest.registerFixedParameter("pyActivity", "ReloadSection");
						refreshActionRequest.registerFixedParameter("SectionName", "");
						refreshActionRequest.registerFixedParameter("PreActivity", "pzEnableDescription");
						staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzCasePersonaDetails"));
						staticURLStr.append("&PreActivity=pzEnableDescription");
						tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"pzEnableDescription\", \"");
						refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"action\":\"DISABLE\"");
						refreshActionRequestD.registerFixedParameter("action","DISABLE");
						tools.appendString("\", \"\", \",");
						refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202003300609520620665") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzCasePersonaDetails_$CTX$_13");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzCasePersonaDetails_"+ referenceString+ "_13'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202003300609520620665") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202003300609520620665-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(4).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_9( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(4).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_9( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202003300609520621636-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(4).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyIsEditEnabled\"  SHOW_WHEN=\".pyIsEditEnabled = true\"");
if(currentTemplatingStatus =='N')
tools.appendString(" data-simplelayout = \"true\" ");
else
clientWhenAttr += "data-simplelayout=true ";
if(pzAuto.evaluateWhen(".pyIsEditEnabled = true",null,true)){
	if(currentTemplatingStatus =='N')
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyIsEditEnabled", -1);
	}
}catch(Exception e){}
}
public void pzSetExpandParam_8() {
pzSection.getLayout().setExpandParam("SubSectionpzCasePersonaDetailsBBBBBB","",false);
}
...
public void simpleLayout_6() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202003300609520619875") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		if(StringUtils.isBlank(expressionId)) {
			...
			expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pyIsEditEnabled = true",expressionId);
		...
		String paramName = "EXPANDEDSubSectionpzCasePersonaDetailsBBBBBB";
...
tools.putParamValue("isControlEditableOriginal", true);
	boolean isEditable = pzAuto.getSection().getControl().isControlEditable(true, ".pyIsEditEnabled != true");
	boolean isControlEditable = isEditable;tools.putParamValue("isControlEditableOriginal", isEditable);
	if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y') {
		String strROWhenCode = " o2!= rx.pyIsEditEnabled cttrue";
...
tools.appendString("</P>");
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015032607124408945550",true));
	...
	modePage1.put("pySpecifyHeight","sizetocontent");
	modePage1.put("pyTAHeightUnits","rows");
	modePage1.put("pyHeight","5");
	modePage1.put("pyTAHeightUnits","rows");
	modePage1.put("pyMinHeight","3");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDescription",pxUniqueStreamHash+"_27");
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();
		...
		tools.appendString("<textarea  " + pzCell.getTestIdIfEnabled("2015032607124408945550") + "  id=\"");
		...
		tools.appendString("'");
		tools.appendString("style=\"overflow: hidden;\" ");
...
if(bOptimizedMarkup){
		...
		tools.appendString(" data-ctl='[\"TextArea\",{\"height\":\"content|3|rows\"}] ' ");if(bOptimizedMarkup){
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015032607124408945550") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_30")){inclFormattedVal_2(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
public int simpleLayoutCell_7( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextArea",".pyDescription",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   ");
	if(pzAuto.handleEvaluateWhen(" o2!= rx.pyIsEditEnabled cttrue",".pyIsEditEnabled != true","cell", "visible")) {
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015032607124408945550-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " o2!= rx.pyIsEditEnabled cttrue");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pyIsEditEnabled cttrue",pxUniqueStreamHash+"_33");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextArea",".pyDescription",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxTextArea_1(".pyDescription",0,"","","Text");labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzCasePersonaDetailsBBBBB","",false);
}
...
public void simpleLayout_5() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202003301006580052215") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3)'}") + " class='" + "flex  content  layout-content-stacked content-stacked padding-l-1x" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzCasePersonaDetailsBBBBB";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzEnableDescription");
		tools.appendString("[\"runActivity\", [\"\", \"");
		ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"action\":\"ENABLE\"");
...
try {
	...
	cellPage.put("pyStreamName","pzCasePersonaDetails");
	...
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Edit description\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Edit description", ".pyActionPrompt");
	}
	pyTooltip = "Edit description";
	...
	String classProp = "";
	classProp ="pi pi-pencil pi-link";
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzCasePersonaDetails_"+ referenceString+ "_9'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Edit description\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
		String alttempText = tools.getLocalizedTextForString(".pyActionPrompt","Edit description\t" + repeatIndx ,StreamBuilder.FMT_LITERAL);
		String classProp = "";
		 classProp ="pi pi-pencil pi-link";
...
public int simpleLayoutCell_5( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("20180926022037054220399")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Description") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20180926022037054220399")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pyIsEditEnabled cttrue",pxUniqueStreamHash+"_23");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_23");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyIsEditEnabled != true");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Persona");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pyIsEditEnabled cttrue", pxUniqueStreamHash+"_23"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzCasePersonaDetailsBBBB","",false);
}
...
public void simpleLayout_4() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201809260219050138281") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + "flex  content  layout-content-mimic_a_sentence content-mimic_a_sentence padding-l-1x" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzCasePersonaDetailsBBBB";
...
public void buildSection_4() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_14","pzPersonaName", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzCasePersonaDetails353","",false);
}
...
public void buildSection_3() { 
	...
	secParams.put("SkipEllipsis","true");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pzPersonaName", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionpzCasePersonaDetailsBBB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201911040233050998236") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
	...
	String paramName = "EXPANDEDSubSectionpzCasePersonaDetailsBBB";
...
public void buildSection_2() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzPersonaAvatar", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzCasePersonaDetails260","",false);
}
...
pzSection.getLayout().setExpandParam("SubSectionpzCasePersonaDetailsBB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20191104023106073343") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
	...
	String paramName = "EXPANDEDSubSectionpzCasePersonaDetailsBB";
...
pzSection.getLayout().setExpandParam("SubSectionpzCasePersonaDetailsB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201911040302590735251") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle padding-lr-1x margin-b-2x flex-nowrap flex-none-item-1" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","padding-lr-1x margin-b-2x flex-nowrap flex-none-item-1");
		pg_dlmeta.put("format","inline_middle");
	...
	String paramName = "EXPANDEDSubSectionpzCasePersonaDetailsB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-PERSONA PZCASEPERSONADETAILS #20210113T093432.505 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzCasePersonaDetails");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-PERSONA PZCASEPERSONADETAILS #20210113T093432.505 GMT", "Rule-Persona pzCasePersonaDetails", "Pega-AppDefinition", "08-06-01", "20210113T093432.505 GMT");
}
