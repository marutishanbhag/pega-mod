...
/**
 * Builds JSP stream @BASECLASS!PZGRIDCATEGORYHEADERFORAC.
 */
public class ra_stream_pzgridcategoryheaderforac_1223eb47b3591b1f01a09275742c8cc5 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzGridCategoryHeaderForAC.Rule_Obj_Class.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1386663808;
 ...
 */
	public ra_stream_pzgridcategoryheaderforac_1223eb47b3591b1f01a09275742c8cc5(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "d43a0ab7686772cc46e0c36a01f209605ed7a424";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZGRIDCATEGORYHEADERFORAC #20180713T133637.934 GMT	Pega-UIDesign:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "d43a0ab7686772cc46e0c36a01f209605ed7a424";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzGridCategoryHeaderForAC",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZGRIDCATEGORYHEADERFORAC #20180713T133637.934 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZGRIDCATEGORYHEADERFORAC #20180713T133637.934 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZGRIDCATEGORYHEADERFORAC #20180713T133637.934 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZGRIDCATEGORYHEADERFORAC", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZGRIDCATEGORYHEADERFORAC","Rule-HTML-Section","@BASECLASS",false,"","Pega-UIDesign","08-01-01","RULE-HTML-SECTION @BASECLASS PZGRIDCATEGORYHEADERFORAC #20180713T133637.934 GMT","!PZGRIDCATEGORYHEADERFORAC",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1386663808), 
...
//	RULE-HTML-SECTION @BASECLASS PZGRIDCATEGORYHEADERFORAC #20180713T133637.934 GMT:20180713T133637.934 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "03ae5517c4d89939c207840643a5d8a4";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzGridCategoryHeaderForAC",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzGridCategoryHeaderForAC','insKey':'RULE-HTML-SECTION @BASECLASS PZGRIDCATEGORYHEADERFORAC #20180713T133637.934 GMT','sectionType':'null'}");
...
public void layoutBody_3() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,""," grid-category-cell-value"," grid-category-cell-value"), "height:13px;",false,"","");tools.appendString("<nobr>");
	labelIncludeInCell_1("","","","",false,"Other Results",true,false,"Standard",false);
...
pzSection.getLayout().setExpandParam("SubSectionpzGridCategoryHeaderForACBBB","",false);
}
public void pzLayout_3() {
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzACWhenForOtherResults","pzACWhenForOtherResults", "layout", "visible" )) {pzSetExpandParam_3();
...
public void layoutBody_2() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,""," grid-category-cell-value"," grid-category-cell-value"), "height:13px;",false,"","");tools.appendString("<nobr>");
	labelIncludeInCell_1("","","","",false,"Best Bets",true,false,"Standard",false);
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
...
pzSection.getLayout().setExpandParam("SubSectionpzGridCategoryHeaderForACBB","",false);
}
public void pzLayout_2() {
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzACWhenForBestBets","pzACWhenForBestBets", "layout", "visible" )) {pzSetExpandParam_2();
...
public void field_DisplayACCategory_1() { 
try {
...
_jspx_th_pega_reference__1.setFormat("DisplayACCategory");
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("DisplayACCategory",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","grid-category-cell-value","grid-category-cell-value"), "height:13px;",false,"","");tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_3")) {	field_DisplayACCategory_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</nobr>");
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>");
...
pzSection.getLayout().setExpandParam("SubSectionpzGridCategoryHeaderForACB","",false);
}
public void pzLayout_1() {
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzACWhenForCategoryValue","pzACWhenForCategoryValue", "layout", "visible" )) {pzSetExpandParam_1();
...
static {
	oPropDefinitions_1.put("Rule-Obj-Class.pyTemplateInputBox", new LiteweightPropertyDefinition("Rule-Obj-Class", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZGRIDCATEGORYHEADERFORAC #20180713T133637.934 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzGridCategoryHeaderForAC");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZGRIDCATEGORYHEADERFORAC #20180713T133637.934 GMT", "@baseclass pzGridCategoryHeaderForAC", "Pega-UIDesign", "08-01-01", "20180713T133637.934 GMT");
}
