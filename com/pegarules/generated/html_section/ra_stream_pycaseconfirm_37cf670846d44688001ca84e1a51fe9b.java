...
/**
 * Builds JSP stream WORK-!PYCASECONFIRM.
 */
public class ra_stream_pycaseconfirm_37cf670846d44688001ca84e1a51fe9b extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyCaseConfirm.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 29940183;
 ...
 */
	public ra_stream_pycaseconfirm_37cf670846d44688001ca84e1a51fe9b(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "64f83e629607882f58a76bdaa8425d934618a457";
...
{
/* Instance RULE-HTML-SECTION WORK- PYCASECONFIRM #20210506T204028.291 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "64f83e629607882f58a76bdaa8425d934618a457";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyCaseConfirm",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- PYCASECONFIRM #20210506T204028.291 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PYCASECONFIRM #20210506T204028.291 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PYCASECONFIRM #20210506T204028.291 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYCASECONFIRM", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCASECONFIRM","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION WORK- PYCASECONFIRM #20210506T204028.291 GMT","!PYCASECONFIRM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",29940183), 
...
//	RULE-HTML-SECTION WORK- PYCASECONFIRM #20210506T204028.291 GMT:20210506T204028.291 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "25c3875673f28b4d1cde2a1e11931277";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyCaseConfirm",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyCaseConfirm','insKey':'RULE-HTML-SECTION WORK- PYCASECONFIRM #20210506T204028.291 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("pyFunctionName", "pega.desktop.infinity.closeToast");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.infinity.closeToast(event)\"]");
...
try {
	...
	modePage2.put("pyName","pyCaseConfirm_$CTX$_3");
		String repeatIndx = "";
	String pyTooltip = "";
	...
	String pyIconStyle = "";
	pyIconStyle = "pi pi-times pi-light";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyCaseConfirm_"+ referenceString+ "_3'";
	 String securedPropValue = null;
		...
		tools.appendString(" >");
		String classProp = "";
		 classProp ="pi pi-times pi-light";
...
public void pxDisplayText_1() {String key="2||RULE-HTML-SECTION WORK- PYCASECONFIRM #20210506T204028.291 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","2"};oCellRuntimeParamsMap.put("2||RULE-HTML-SECTION WORK- PYCASECONFIRM #20210506T204028.291 GMT",paramValues);oControlPathsMap.put("2||RULE-HTML-SECTION WORK- PYCASECONFIRM #20210506T204028.291 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }		tools.appendString("[\"runScript\", [\"pega.desktop.infinity.closeToast(event)\"]");
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20190128102052021877775",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pyCaseConfirm_$CTX$_1");
		String repeatIndx = "";
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyID", ".pyButtonLabel");
	pyLabel = ".pyID";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyCaseConfirm_"+ referenceString+ "_1'";
	 String securedPropValue = null;
	 com.pega.pegarules.pub.security.PropertySecurityInfo propSecInfo = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().getPropertyInfoForDisplay(tools.getStepPage(),tools.getProperty(".pyID"), tools);
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		 securedPropValue = tools.getProperty(".pyID").getStringValue();
	  }
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20190128102052021877775") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{
		com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		tools.appendString(""); checkForScriptTags_1(securedPropValue); 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyID",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing    " + pzSection.getCustomStyle(false, "","no-peek-preview","no-peek-preview")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20190128102052021877775-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxLink");
	pgCells.put("forLabel",".pyID");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","no-peek-preview");
	pgCells.put("customRWStyles","no-peek-preview");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyID",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateDisplayText",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20190130144819080740614-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpyCaseConfirmB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201802200512530530872") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle toast-container" + "'  ");
		...
		pg_dlmeta.put("customClassName","toast-container");
	...
	String paramName = "EXPANDEDSubSectionpyCaseConfirmB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- PYCASECONFIRM #20210506T204028.291 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyCaseConfirm");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PYCASECONFIRM #20210506T204028.291 GMT", "Work- pyCaseConfirm", "Theme-Cosmos", "04-01-01", "20210506T204028.291 GMT");
}
