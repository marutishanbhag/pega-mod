...
/**
 * Builds JSP stream DATA-ADMIN-OPERATOR-ID!PZSUBSTITUTEDETAILS.
 */
public class ra_stream_pzsubstitutedetails_f24ef9d643fe329634cc670136357ef4 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSubstituteDetails.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 394075727;
 ...
 */
	public ra_stream_pzsubstitutedetails_f24ef9d643fe329634cc670136357ef4(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "33093ebf6e8ef34a22b3cb74ca6eae9dbff4dc20";
...
{
/* Instance RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSUBSTITUTEDETAILS #20180713T135640.929 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "33093ebf6e8ef34a22b3cb74ca6eae9dbff4dc20";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSubstituteDetails",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSUBSTITUTEDETAILS #20180713T135640.929 GMT
 * Set up context.
 */
final String prevRuleKey_2 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSUBSTITUTEDETAILS #20180713T135640.929 GMT";final String prevClass_2 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSUBSTITUTEDETAILS #20180713T135640.929 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-HTML-Section:PZSUBSTITUTEDETAILS", 
	"Rule-Obj-Property:PXOBJCLASS", 
	"Rule-Obj-Property:PYDECISIONTREENAME", 
	"Rule-Obj-Property:PYSUBSTITUTEOPERATOR", 
	"Rule-Obj-Property:PYSUBSTITUTETYPE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSUBSTITUTEDETAILS","Rule-HTML-Section","DATA-ADMIN-OPERATOR-ID",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSUBSTITUTEDETAILS #20180713T135640.929 GMT","!PZSUBSTITUTEDETAILS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",394075727), 
		new DependentRuleInfo("PXOBJCLASS","Rule-Obj-Property","@BASECLASS",true,"Data-Admin-Operator-ID","Pega-SystemArchitect","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PXOBJCLASS #20180713T135622.443 GMT","!PXOBJCLASS",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYDECISIONTREENAME","Rule-Obj-Property","DATA-ADMIN-OPERATOR-ID",false,"","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYDECISIONTREENAME #20180713T131219.303 GMT","!PYDECISIONTREENAME",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
		new DependentRuleInfo("PYSUBSTITUTEOPERATOR","Rule-Obj-Property","DATA-ADMIN-OPERATOR-ID",false,"","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYSUBSTITUTEOPERATOR #20180713T131219.468 GMT","!PYSUBSTITUTEOPERATOR",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
		new DependentRuleInfo("PYSUBSTITUTETYPE","Rule-Obj-Property","DATA-ADMIN-OPERATOR-ID",true,"Data-Admin-Operator-ID","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYSUBSTITUTETYPE #20180713T131219.474 GMT","!PYSUBSTITUTETYPE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSUBSTITUTEDETAILS #20180713T135640.929 GMT:20180713T135640.929 GMT
...
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYSUBSTITUTETYPE #20180713T131219.474 GMT:20180713T131219.474 GMT
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYDECISIONTREENAME #20180713T131219.303 GMT:20180713T131219.303 GMT
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYDECISIONTREENAME #20180713T131219.303 GMT:20180713T131219.303 GMT
...
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYDECISIONTREENAME #20180713T131219.303 GMT:20180713T131219.303 GMT
//	RULE-HTML-PROPERTY OPENRULE #20180713T132012.839 GMT:20180713T132012.839 GMT
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYSUBSTITUTEOPERATOR #20180713T131219.468 GMT:20180713T131219.468 GMT
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYSUBSTITUTEOPERATOR #20180713T131219.468 GMT:20180713T131219.468 GMT
//	RULE-HTML-PROPERTY OPENRULE #20180713T132012.839 GMT:20180713T132012.839 GMT
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYSUBSTITUTEOPERATOR #20180713T131219.468 GMT:20180713T131219.468 GMT
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYSUBSTITUTEOPERATOR #20180713T131219.468 GMT:20180713T131219.468 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "220702350bb976d798be951e543ff8f7";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSubstituteDetails",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSubstituteDetails','insKey':'RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSUBSTITUTEDETAILS #20180713T135640.929 GMT','sectionType':'standard'}");
pzLayout_2();
...
public void field_openrule_6() { 
try {
final ParameterPage params_6 = new ParameterPage();
params_6.putString("NoOpenRule", "0");
params_6.putString("ApplyTo", "pxObjClass");
params_6.putString("Class", "Data-Admin-WorkBasket");
params_6.putString("OpenRuleTooltip", "Open");
params_6.putString("NoSmartPrompt", "0");
params_6.putString("TextBoxTooltip", "This work basket is used if the Decision Tree used above is not specified,not found, or does not return a value");
params_6.putString("AJAXTrackID", pega.getValue("param.AJAXTrackID"));
params_6.putString("bLocalize", "true");
	final ClipboardProperty currentProperty_6 = tools.getProperty(".pySubstituteOperator");
	if (currentProperty_6 != null && currentProperty_6.getParentPage().getClassName().equals("Data-Admin-Operator-ID")) {
		...
		final PRStackFrame stack_6 = ((PegaAPI) tools).pushStackFrame( params_6, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "openrule" );
		try {
...
property_Data_Admin_Operator_ID_OpenRule();
			}
		} finally {
...
if (_jspx_meth_pega_reference__3(pageContext, ".pySubstituteOperator", "input", "openrule")) {
	return;
}
	}} catch(Throwable t) {
...
if (_jspx_meth_pega_param__1(pageContext, "TextBoxTooltip", "This work basket is used if the Decision Tree used above is not specified,not found, or does not return a value")) {
	return true;
}
...
public void field_openrule_5() { 
try {
final ParameterPage params_5 = new ParameterPage();
params_5.putString("NoOpenRule", "0");
params_5.putString("ApplyTo", "pxObjClass");
params_5.putString("Class", "Data-Admin-WorkBasket");
params_5.putString("OpenRuleTooltip", "Open");
params_5.putString("NoSmartPrompt", "0");
params_5.putString("TextBoxTooltip", "This work basket is used if the Decision Tree used above is not specified,not found, or does not return a value");
params_5.putString("AJAXTrackID", pega.getValue("param.AJAXTrackID"));
params_5.putString("bLocalize", "true");
	final ClipboardProperty currentProperty_5 = tools.getProperty(".pySubstituteOperator");
	if (currentProperty_5 != null && currentProperty_5.getParentPage().getClassName().equals("Data-Admin-Operator-ID")) {
		...
		final PRStackFrame stack_5 = ((PegaAPI) tools).pushStackFrame( params_5, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "openrule" );
		try {
...
public void field_openrule_4() { 
try {
final ParameterPage params_4 = new ParameterPage();
params_4.putString("NoOpenRule", "0");
params_4.putString("ApplyTo", "pxObjClass");
params_4.putString("Class", "Data-Admin-Operator-ID");
params_4.putString("OpenRuleTooltip", "Open");
params_4.putString("NoSmartPrompt", "0");
params_4.putString("TextBoxTooltip", "this operator is used if the Decision Tree used above is not specified,not found, or does not return a value");
params_4.putString("AJAXTrackID", pega.getValue("param.AJAXTrackID"));
params_4.putString("bLocalize", "true");
	final ClipboardProperty currentProperty_4 = tools.getProperty(".pySubstituteOperator");
	if (currentProperty_4 != null && currentProperty_4.getParentPage().getClassName().equals("Data-Admin-Operator-ID")) {
		...
		final PRStackFrame stack_4 = ((PegaAPI) tools).pushStackFrame( params_4, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "openrule" );
		try {
...
if (_jspx_meth_pega_reference__2(pageContext, ".pySubstituteOperator", "input", "openrule")) {
	return;
}
	}} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
if (_jspx_meth_pega_param__1(pageContext, "Class", "Data-Admin-Operator-ID")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "OpenRuleTooltip", "Open")) {
	return true;
...
if (_jspx_meth_pega_param__1(pageContext, "TextBoxTooltip", "this operator is used if the Decision Tree used above is not specified,not found, or does not return a value")) {
	return true;
}
if (_jspx_meth_pega_param__2(pageContext, "AJAXTrackID", "param.AJAXTrackID")) {
	return true;
...
public void field_openrule_3() { 
try {
final ParameterPage params_3 = new ParameterPage();
params_3.putString("NoOpenRule", "0");
params_3.putString("ApplyTo", "pxObjClass");
params_3.putString("Class", "Data-Admin-Operator-ID");
params_3.putString("OpenRuleTooltip", "Open");
params_3.putString("NoSmartPrompt", "0");
params_3.putString("TextBoxTooltip", "this operator is used if the Decision Tree used above is not specified,not found, or does not return a value");
params_3.putString("AJAXTrackID", pega.getValue("param.AJAXTrackID"));
params_3.putString("bLocalize", "true");
	final ClipboardProperty currentProperty_3 = tools.getProperty(".pySubstituteOperator");
	if (currentProperty_3 != null && currentProperty_3.getParentPage().getClassName().equals("Data-Admin-Operator-ID")) {
		...
		final PRStackFrame stack_3 = ((PegaAPI) tools).pushStackFrame( params_3, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "openrule" );
		try {
...
params_2.putString("NoOpenRule", "0");
params_2.putString("ApplyTo", "pxObjClass");
params_2.putString("Class", "Rule-Declare-DecisionTree");
params_2.putString("OpenRuleTooltip", "Open");
params_2.putString("NoSmartPrompt", "0");
params_2.putString("TextBoxTooltip", "The primary page of the DecisionTree is this operator record");
params_2.putString("AJAXTrackID", pega.getValue("param.AJAXTrackID"));
params_2.putString("bLocalize", "true");
	final ClipboardProperty currentProperty_2 = tools.getProperty(".pyDecisionTreeName");
...
if (_jspx_meth_pega_reference__1(pageContext, ".pyDecisionTreeName", "input", "OpenRule")) {
	return;
}
	}} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
if (_jspx_meth_pega_param__1(pageContext, "Class", "Rule-Declare-DecisionTree")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "OpenRuleTooltip", "Open")) {
	return true;
...
if (_jspx_meth_pega_param__1(pageContext, "TextBoxTooltip", "The primary page of the DecisionTree is this operator record")) {
	return true;
}
if (_jspx_meth_pega_param__2(pageContext, "AJAXTrackID", "param.AJAXTrackID")) {
	return true;
...
/**
 * Generates stream property_Data_Admin_Operator_ID_OpenRule
 */
private void property_Data_Admin_Operator_ID_OpenRule() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
params_1.putString("NoOpenRule", "0");
params_1.putString("ApplyTo", "pxObjClass");
params_1.putString("Class", "Rule-Declare-DecisionTree");
params_1.putString("OpenRuleTooltip", "Open");
params_1.putString("NoSmartPrompt", "0");
params_1.putString("TextBoxTooltip", "The primary page of the DecisionTree is this operator record");
params_1.putString("AJAXTrackID", pega.getValue("param.AJAXTrackID"));
params_1.putString("bLocalize", "true");
	final ClipboardProperty currentProperty_1 = tools.getProperty(".pyDecisionTreeName");
		...
		tools.appendString(" data-change='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						pzPackageRuntime.packageSection("pzSubstituteDetails",
						...
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzSubstituteDetails"));
...
tools.appendString("</P>");
	...
	if(isEditable) {
		tools.putParamValue("pega_attributes"," PN='.pySubstituteType' ONCHANGE=\"handleClientEvent('CLIENT','','',-1,event);\"");
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20161116070827098412727",true));
	cellPage.put("pyValue",".pySubstituteType");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pySubstituteType");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pySubstituteType", ".pyCaption");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pySubstituteType",pxUniqueStreamHash+"_10");
	...
	modePage1.put("pyID","pySubstituteType");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pySubstituteType");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pySubstituteType", ".pyCaption");
	pyValueR = ".pySubstituteType";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pySubstituteType");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pySubstituteType", ".pyCaption");
	pyValueOrig = ".pySubstituteType";
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_13");}if(beginNonTemplate){			HashStringMap params = new HashStringMap();
		...
		String strActiveValue = isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true);			String strValue = isSecuredProp ? activePropValue : tools.getProperty(ddPropRef).getStringValue();
			...
			if(!isAccessible) {
				...
				tools.appendString(" " + pzCell.getTestIdIfEnabled("20161116070827098412727") + " ");
...
tools.appendString(" data-bindprops='value' ");} else{			tools.appendString(ddPropEntryHandle);
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("20161116070827098412727") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
...
if(pegaValidation != null) {
	...
	tools.putActive(propActivePrev); 							} catch (Exception e) {
	 ...
	 if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'							&& pzAuto.getUIComponentRuntime().getRuntimeContextTree().isLiveDesignViewMode()){
		...
		IUIComponent ctrlComponent = pzAuto.getUIComponent();
		metadata.put("cellInfo", "Substitute operator type");
...
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	cellPage.put("pyID","pxObjClass");
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20161116070827098311487",true));
...
boolean bUITemplatized = pzAuto.getUIComponentRuntime().isTemplateRendering();pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);
	tools.appendString("<input  type=\"hidden\"  " + pzCell.getTestIdIfEnabled("20161116070827098311487") + "  id=\"");
...
public int simpleLayoutCell_3( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDropdown",".pySubstituteType",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20161116070827098412727-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	
	ClipboardProperty propActivePrev = tools.getActive();
	tools.putActive(tools.getStepPage().getProperty(".pySubstituteType"));
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Substitute operator type") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20161116070827098412727-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Substitute operator type") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");pxDropdown_1(".pySubstituteType",0,"","","Text");
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20161116070827098412727-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDropdown");
	pgCells.put("forLabel",".pySubstituteType");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxDropdown",".pySubstituteType",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDropdown_1(".pySubstituteType",0,"","","Text");labelName = "Substitute operator type";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("OpenRule",".pyDecisionTreeName",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("2016111607082709841384-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyDecisionTreeName" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Decision tree to find substitute") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2016111607082709841384-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyDecisionTreeName" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Decision tree to find substitute") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_17")) {field_OpenRule_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("useLabel","true");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2016111607082709841384-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","OpenRule");
	pgCells.put("forLabel",".pyDecisionTreeName");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("OpenRule",".pyDecisionTreeName",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_20")) {	field_OpenRule_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "Decision tree to find substitute";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_5( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pySubstituteType cqOperator",".pySubstituteType==\'Operator\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("openrule",".pySubstituteOperator",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20161116070827098514952-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pySubstituteOperator" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Default to assignee") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20161116070827098514952-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pySubstituteOperator" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Default to assignee") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_21")) {field_openrule_3();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("useLabel","true");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20161116070827098514952-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","openrule");
	pgCells.put("forLabel",".pySubstituteOperator");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pySubstituteType cqOperator",pxUniqueStreamHash+"_23");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_23");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pySubstituteType=='Operator'");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pySubstituteType cqOperator", pxUniqueStreamHash+"_23"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("openrule",".pySubstituteOperator",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_24")) {	field_openrule_4();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();}
	if (!isExpression && isOffline) {
	// do nothing
	} else {
...
public int simpleLayoutCell_6( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pySubstituteType cqWorkbasket",".pySubstituteType==\'Workbasket\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("openrule",".pySubstituteOperator",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20161116070827098515465-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pySubstituteOperator" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20161116070827098515465-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pySubstituteOperator" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
...
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_25")) {field_openrule_5();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("useLabel","true");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20161116070827098515465-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","openrule");
	pgCells.put("forLabel",".pySubstituteOperator");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pySubstituteType cqWorkbasket",pxUniqueStreamHash+"_27");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_27");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pySubstituteType=='Workbasket'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Data-Admin-Operator-ID");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_27");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pySubstituteType cqWorkbasket", pxUniqueStreamHash+"_27"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("openrule",".pySubstituteOperator",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_28")) {	field_openrule_6();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();}
	if (!isExpression && isOffline) {
	// do nothing
	} else {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().endVisibleWhen();
...
pzSection.getLayout().setExpandParam("SubSectionpzSubstituteDetailsBB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + " content  layout-content-default content-default " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzSubstituteDetailsBB";
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("20170525050108069523368")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","When unavailable") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20170525050108069523368")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzSubstituteDetailsB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpzSubstituteDetailsB";
	metadataPage.put("paramName", paramName);
...
static {
	oPropDefinitions_2.put("Data-Admin-Operator-ID.pyDecisionTreeName", new LiteweightPropertyDefinition("Data-Admin-Operator-ID", "pyDecisionTreeName", "sTN", false, true, "SmartPromptRoutingDecisionTree", false));
	oPropDefinitions_2.put("Data-Admin-Operator-ID.pySubstituteOperator", new LiteweightPropertyDefinition("Data-Admin-Operator-ID", "pySubstituteOperator", "sTN", false, true, "PickOperator", false));
}
...
static {
	...
	oStreamProperties_2.put("pzInsKey", "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSUBSTITUTEDETAILS #20180713T135640.929 GMT");
	...
	oStreamProperties_2.put("pyRuleSet", "Pega-SystemArchitect");
	oStreamProperties_2.put("pyCorrType", "");
	oStreamProperties_2.put("pyStreamName", "pzSubstituteDetails");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSUBSTITUTEDETAILS #20180713T135640.929 GMT", "Data-Admin-Operator-ID pzSubstituteDetails", "Pega-SystemArchitect", "08-01-01", "20180713T135640.929 GMT");
