...
/**
 * Builds JSP stream DATA-PORTAL!PYPORTALPAGEHEADERTOP.
 */
public class ra_stream_pyportalpageheadertop_51811e3ce9fabc421c17f0db126e630a extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyPortalPageHeaderTop.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 330255425;
 ...
 */
	public ra_stream_pyportalpageheadertop_51811e3ce9fabc421c17f0db126e630a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "3412bd495b79e18c6c6c1d4b7f12457f6b870601";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PYPORTALPAGEHEADERTOP #20180713T134755.175 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "3412bd495b79e18c6c6c1d4b7f12457f6b870601";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyPortalPageHeaderTop",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PYPORTALPAGEHEADERTOP #20180713T134755.175 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PYPORTALPAGEHEADERTOP #20180713T134755.175 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PYPORTALPAGEHEADERTOP #20180713T134755.175 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYPORTALPAGEHEADERTOP", 
	"Rule-Obj-Property:PYWORKGROUPLABEL", 
	"Rule-Obj-Property:PYACTIVEWORKGROUP", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYPORTALPAGEHEADERTOP","Rule-HTML-Section","DATA-PORTAL",false,"","Pega-EndUserUI","08-01-01","RULE-HTML-SECTION DATA-PORTAL PYPORTALPAGEHEADERTOP #20180713T134755.175 GMT","!PYPORTALPAGEHEADERTOP",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",330255425), 
		new DependentRuleInfo("PYWORKGROUPLABEL","Rule-Obj-Property","INDEX-OPERATOR-WORKGROUPS",true,"Index-Operator-WorkGroups","Pega-ProcessEngine","08-01-01","RULE-OBJ-PROPERTY INDEX-OPERATOR-WORKGROUPS PYWORKGROUPLABEL #20180713T132912.479 GMT","!PYWORKGROUPLABEL",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYACTIVEWORKGROUP","Rule-Obj-Property","DATA-PORTAL",true,"Data-Portal","Pega-ProcessEngine","08-01-01","RULE-OBJ-PROPERTY DATA-PORTAL PYACTIVEWORKGROUP #20180713T132903.577 GMT","!PYACTIVEWORKGROUP",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION DATA-PORTAL PYPORTALPAGEHEADERTOP #20180713T134755.175 GMT:20180713T134755.175 GMT
//	RULE-HTML-PROPERTY PXDROPDOWN #20191010T062311.436 GMT:20191010T062311.436 GMT
//	RULE-OBJ-PROPERTY DATA-PORTAL PYACTIVEWORKGROUP #20180713T132903.577 GMT:20180713T132903.577 GMT
//	RULE-OBJ-PROPERTY INDEX-OPERATOR-WORKGROUPS PYWORKGROUPLABEL #20180713T132912.479 GMT:20180713T132912.479 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "8a3792dfa6420c3172067267f2dc476f";
	}
...
config.put("pyPreDataTransform.pyName", "pySetWorkGroupDetails");
...
getControlMarkup_1() {
try {
if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty("pyDisplayHarness.pyActiveWorkGroup").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
	pzAuto.getUIComponentRuntime().setTemplatingUIStatus('Y');
}pxDropdown_1("pyDisplayHarness.pyActiveWorkGroup",0,"","","Text");pzAuto.getUIComponentRuntime().insertTemplateScripts();}
} catch(Throwable t) {
...
public void pxTextInput_1() {String key="7||RULE-HTML-SECTION DATA-PORTAL PYPORTALPAGEHEADERTOP #20180713T134755.175 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","7"};oCellRuntimeParamsMap.put("7||RULE-HTML-SECTION DATA-PORTAL PYPORTALPAGEHEADERTOP #20180713T134755.175 GMT",paramValues);oControlPathsMap.put("7||RULE-HTML-SECTION DATA-PORTAL PYPORTALPAGEHEADERTOP #20180713T134755.175 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-change='[");if(isBehaviorAdded && true){ tools.appendString(","); }{String strStreamName="";String strPropertyTarget ="";String strPageName ="";strStreamName="pyPortalPageHeaderTop";if(tools.getPrimaryPage() != null){ strPageName = tools.getPrimaryPage().getName();}if(tools.getActive() != null){strPropertyTarget = tools.getActive().getEntryHandle();}com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();actionRequest.registerFixedParameter("pyActivity", "ReloadCell"); actionRequest.registerFixedParameter("pyPropertyTarget", strPropertyTarget ); actionRequest.registerFixedParameter("StreamName", strStreamName); actionRequest.registerFixedParameter("pzPrimaryPageName", strPageName); pzAuto.registerActionRequest(actionRequest);}	tools.appendString("[\"postValue\",[\":event\"]");
		...
		actionRequestD.registerFixedParameter("pyModelName","pySetWorkGroupDetails");
			String usingPageString = "";
			usingPageString = pzAuto.getUIComponentRuntime().generateActionTokenForPage();
			tools.appendString("[\"runDataTransform\", [\"pySetWorkGroupDetails\", \"=");
			...
			pzPackageRuntime.packageDataTransform(contextClass, "pySetWorkGroupDetails");
			}
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }					{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
						com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
							...
							refreshActionRequest.registerFixedParameter("StreamList", "pyWorkGroupList|Rule-HTML-Section|:");
							staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
							tools.appendString("[\"refresh\", [\"otherSection\",\"pyWorkGroupList\", \"\", \"");
...
if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y' && !isOffline){
	...
	cellPage.put("pyValue","pyDisplayHarness.pyActiveWorkGroup");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty("pyDisplayHarness.pyActiveWorkGroup");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("pyDisplayHarness.pyActiveWorkGroup", ".pyCaption");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors("pyDisplayHarness.pyActiveWorkGroup",pxUniqueStreamHash+"_11");
	...
	modePage1.put("pyID","pyActiveWorkGroup");
	...
	if(listProperties.containsKey(".pyWorkGroupLabel")){
	Set<String> currentPropFieldNames = (Set<String>)listProperties.get(".pyWorkGroupLabel");
	currentPropFieldNames.add("pyCaption");
	listProperties.put(".pyWorkGroupLabel",currentPropFieldNames);
	}else{
	Set<String> fieldNames = new HashSet<String>();
	fieldNames.add("pyCaption");
	listProperties.put(".pyWorkGroupLabel",fieldNames);
	}
	if(listProperties.containsKey(".pyWorkGroup")){
	Set<String> currentPropFieldNames = (Set<String>)listProperties.get(".pyWorkGroup");
	listProperties.put(".pyWorkGroup",currentPropFieldNames);
	}else{
	Set<String> fieldNames = new HashSet<String>();
	listProperties.put(".pyWorkGroup",fieldNames);
	}
	modePage1.put("pyResultsUniqueID",pxUniqueStreamHash+"_12");
	Map<String, Object> listSourceInfo = new HashMap<String, Object>();
	tools.putParamValue("bListOptionsLocalize","true");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadClipboardPage("D_ManagerWorkGroups.pxResults", listProperties, pxUniqueStreamHash+"_12", listSourceInfo);
	tools.putParamValue("bListOptionsLocalize","");
	String pageName = "D_ManagerWorkGroups.pxResults";
	if(tools.findPage("D_ManagerWorkGroups.pxResults") != null){
	pageName = tools.findPage("D_ManagerWorkGroups.pxResults").getReference();
	}
	modePage1.put("pySourceName",pageName);
	modePage1.put("tooltip","");
	modePage1.put("pyGroupLabel","");
	modePage1.put("pyValue",".pyWorkGroup");
	modePage1.put("pyPrompt",".pyWorkGroupLabel");
	...
	String pyValueOrig = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty("pyDisplayHarness.pyActiveWorkGroup");
	pyValueR = "pyDisplayHarness.pyActiveWorkGroup";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty("pyDisplayHarness.pyActiveWorkGroup");
	pyValueOrig = "pyDisplayHarness.pyActiveWorkGroup";
...
tools.appendString(" data-bindprops='value' ");} else{			tools.appendString(ddPropEntryHandle);
		...
		tools.appendString("]' ");
																						...
																						if("".equals(strValue) && cbpResults != null && cbpResults.size() > 0) {
																							String pyValueProp = ".pyWorkGroup";
																				...
																				if (cbpResults != null && cbpResults.size() > 0) {
																					...
																					while(resIter.hasNext()) {
																						...
																						displayString = cbpRow.getStringIfPresent(".pyWorkGroupLabel");
																						valueString = cbpRow.getStringIfPresent(".pyWorkGroup");
...
if(pegaValidation != null) {
	...
	tools.putActive(propActivePrev); 																		} catch (Exception e) {
	 ...
	 if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'																		&& pzAuto.getUIComponentRuntime().getRuntimeContextTree().isLiveDesignViewMode()){
		...
		IUIComponent ctrlComponent = pzAuto.getUIComponent();
		metadata.put("cellInfo", "Work Group");
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2> rxD_ManagerWorkGroups.pyCount ci1","D_ManagerWorkGroups.pyCount >1","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDropdown","pyDisplayHarness.pyActiveWorkGroup",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.putActive(tools.getStepPage().getProperty("pyDisplayHarness.pyActiveWorkGroup"));
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Work Group") + "</span>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Work Group") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");pxDropdown_1("pyDisplayHarness.pyActiveWorkGroup",0,"","","Text");
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("forLabel","pyDisplayHarness.pyActiveWorkGroup");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2> rxD_ManagerWorkGroups.pyCount ci1",pxUniqueStreamHash+"_18");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_18");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","D_ManagerWorkGroups.pyCount >1");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2> rxD_ManagerWorkGroups.pyCount ci1", pxUniqueStreamHash+"_18"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDropdown","pyDisplayHarness.pyActiveWorkGroup",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDropdown_1("pyDisplayHarness.pyActiveWorkGroup",0,"","","Text");}
	if (!isExpression && isOffline) {
	// do nothing
	} else {
...
public int simpleLayoutCell_4( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput","D_ManagerWorkGroups.pxResults(1).pyWorkGroupLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	isCellReadOnly = true;
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  class='field-caption dataLabelForRead' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	
	ClipboardProperty propActivePrev = tools.getActive();
	tools.putActive(tools.getStepPage().getProperty("D_ManagerWorkGroups.pxResults(1).pyWorkGroupLabel"));
	tools.appendString("for='" + tools.getHTMLIDForProperty(true,"label") + "'");
	...
	tools.appendString("<label  class='field-caption dataLabelForRead' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("forLabel","D_ManagerWorkGroups.pxResults(1).pyWorkGroupLabel");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rxD_ManagerWorkGroups.pyCount ci1",pxUniqueStreamHash+"_20");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rxD_ManagerWorkGroups.pyCount ci1", pxUniqueStreamHash+"_20"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextInput","D_ManagerWorkGroups.pxResults(1).pyWorkGroupLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxTextInput_1();}
...
pzSection.getLayout().setExpandParam("SubSectionpyPortalPageHeaderTopBBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpyPortalPageHeaderTopBBB";
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","heading_1_dataLabelRead","heading_1_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead heading_1_dataLabelRead","dataLabelWrite heading_1_dataLabelWrite") + "' >");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Summary for") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
pzSection.getLayout().setExpandParam("SubSectionpyPortalPageHeaderTopBB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpyPortalPageHeaderTopBB";
	metadataPage.put("paramName", paramName);
...
pzSection.getLayout().setExpandParam("SubSectionpyPortalPageHeaderTopB","",false);
}
...
public void simpleLayout_3() {
	...
	String paramName = "EXPANDEDSubSectionpyPortalPageHeaderTopB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PYPORTALPAGEHEADERTOP #20180713T134755.175 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyPortalPageHeaderTop");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PYPORTALPAGEHEADERTOP #20180713T134755.175 GMT", "Data-Portal pyPortalPageHeaderTop", "Pega-EndUserUI", "08-01-01", "20180713T134755.175 GMT");
}
