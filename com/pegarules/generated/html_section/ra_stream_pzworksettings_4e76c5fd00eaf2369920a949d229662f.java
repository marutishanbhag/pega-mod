...
/**
 * Builds JSP stream DATA-ADMIN-OPERATOR-ID!PZWORKSETTINGS.
 */
public class ra_stream_pzworksettings_4e76c5fd00eaf2369920a949d229662f extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzWorkSettings.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -681041306;
 ...
 */
	public ra_stream_pzworksettings_4e76c5fd00eaf2369920a949d229662f(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a0669d4e4098e9076382b8049bfb5a9089eb78b5";
...
{
/* Instance RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZWORKSETTINGS #20180713T135640.952 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "a0669d4e4098e9076382b8049bfb5a9089eb78b5";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzWorkSettings",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZWORKSETTINGS #20180713T135640.952 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZWORKSETTINGS #20180713T135640.952 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZWORKSETTINGS #20180713T135640.952 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZWORKSETTINGS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZWORKSETTINGS","Rule-HTML-Section","DATA-ADMIN-OPERATOR-ID",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZWORKSETTINGS #20180713T135640.952 GMT","!PZWORKSETTINGS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-681041306)
	};
...
//	RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZWORKSETTINGS #20180713T135640.952 GMT:20180713T135640.952 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "9de861ef47207793dfefb16588e822ad";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzWorkSettings",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzWorkSettings','insKey':'RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZWORKSETTINGS #20180713T135640.952 GMT','sectionType':'standard'}");
pzLayout_5();
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzWorkSettingsBBB"));
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Availability", "pyCaption");
...
metadataPage.put("title","Availability");
metadataPage.put("uniqueid", "202601120327310428");
...
public void buildSection_4() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_14","pzScheduling", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pzScheduling"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzWorkSettings518","",false);
}
...
public void buildSection_3() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pzScheduling", secInfo);
}
...
public int simpleLayoutCell_3( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzScheduling",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzScheduling",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzWorkSettingsBBB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpzWorkSettingsBBB";
...
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","Availability");
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel9841' data-layout-id='202601120327310419" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel9841'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzWorkSettingsBBB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpzWorkSettingsBBB";
...
IUIComponentMetadata metadataPage = pzAuto.getUIComponentRuntime().createMetadata();
IUIComponent headerComponent = pzAuto.getUIComponent();
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzWorkSettingsBB"));
String sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
if(!"".equals(sectionTitleFVMeta)){
metadataPage.put("fieldValueMeta",sectionTitleFVMeta);
}
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Routing", "pyCaption");
String inspectorFVData = pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData();
if(!"".equals(inspectorFVData)){
metadataPage.put("fieldValueInspectorData",inspectorFVData);
}
metadataPage.put("title","Routing");
metadataPage.put("uniqueid", "202601120327310417");
metadataPage.put("automationId", "");
headerComponent.beginComponent("pxLayoutHeader",metadataPage);
headerComponent.endComponent();
}
...
public void buildSection_2() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzRoutingSettings", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzRoutingSettings"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpzWorkSettings711","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pzRoutingSettings", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzRoutingSettings",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzRoutingSettings",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzWorkSettingsBB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpzWorkSettingsBB";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\">");
...
String l_sectionTitleFVMeta = "";
l_sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","Routing");
String sectionImageTitle="";
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");


	/***-- Grid HeaderElements: Begin --**/
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel9207' data-layout-id='202601120327310410" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel9207'>" + l_sectionTitle + "</h2><nobr>");
pzHeaderCellContent_1();
tools.appendString("</nobr>");
boolean showContainerIcons=tools.getParamValue("showContainerIcons").equals("true")?true:false;
tools.appendString("<span class='header-element header-title-table'>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzWorkSettingsBB","tdRightStyle");}
if(showContainerIcons){
tools.appendString("</tr></table>");
}
tools.appendString("</span>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div><div class='header-right'></div></div>");
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzWorkSettingsBB";
	metadataPage.put("paramName", paramName);
...
pzSection.getLayout().setExpandParam("SubSectionpzWorkSettingsB","",false);
}
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  layout-content-inline_grid_double content-inline_grid_double " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzWorkSettingsB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZWORKSETTINGS #20180713T135640.952 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzWorkSettings");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZWORKSETTINGS #20180713T135640.952 GMT", "Data-Admin-Operator-ID pzWorkSettings", "Pega-SystemArchitect", "08-01-01", "20180713T135640.952 GMT");
}
