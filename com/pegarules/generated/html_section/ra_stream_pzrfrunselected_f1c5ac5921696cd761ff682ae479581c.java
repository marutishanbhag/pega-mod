...
/**
 * Builds JSP stream RULE-!PZRFRUNSELECTED.
 */
public class ra_stream_pzrfrunselected_f1c5ac5921696cd761ff682ae479581c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzRFRunSelected.Rule_Test_Unit_Case.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 34253562;
 ...
 */
	public ra_stream_pzrfrunselected_f1c5ac5921696cd761ff682ae479581c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "92957574b9508b95329b57e4830cf541e43cdc98";
...
{
/* Instance RULE-HTML-SECTION RULE- PZRFRUNSELECTED #20180713T142202.773 GMT	Pega-AutoTest:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "92957574b9508b95329b57e4830cf541e43cdc98";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzRFRunSelected",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE- PZRFRUNSELECTED #20180713T142202.773 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE- PZRFRUNSELECTED #20180713T142202.773 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE- PZRFRUNSELECTED #20180713T142202.773 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZRFRUNSELECTED", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRFRUNSELECTED","Rule-HTML-Section","RULE-",false,"","Pega-AutoTest","08-01-01","RULE-HTML-SECTION RULE- PZRFRUNSELECTED #20180713T142202.773 GMT","!PZRFRUNSELECTED",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",34253562), 
...
//	RULE-HTML-SECTION RULE- PZRFRUNSELECTED #20180713T142202.773 GMT:20180713T142202.773 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "4199c61f811302c21d405ff481e2225c";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzRFRunSelected",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzRFRunSelected','insKey':'RULE-HTML-SECTION RULE- PZRFRUNSELECTED #20180713T142202.773 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("pyActivity", "pzRFRunTestCasesInBatch");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_3")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzRFRunSelected_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2015012105595101653881") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
			...
			refreshActionRequest.registerFixedParameter("StreamList", "pzRFProgressbarWrapper|Rule-HTML-Section|:");
			staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
			staticURLStr.append("&PreActivity=pzRFRunTestCasesInBatch");
			tools.appendString("[\"refresh\", [\"otherSection\",\"pzRFProgressbarWrapper\", \"pzRFRunTestCasesInBatch\", \"");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }						{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
							com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
								...
								StringBuffer preDTParamStr = new StringBuffer();
								refreshActionRequest.registerFixedParameter("pyActivity", "ReloadSection");
								refreshActionRequest.registerFixedParameter("StreamList", "pzRFSelectAllTestCases|Rule-HTML-Section|:");
								staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
								tools.appendString("[\"refresh\", [\"otherSection\",\"pzRFSelectAllTestCases\", \"\", \"");
								refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
								tools.appendString("=\", \"\", \",");
								refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
								tools.appendString("\",\":event\",\"\",[\"");
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Run selected".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		...
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Run selected",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015012105595101653881-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzRFRunSelectedB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzRFRunSelectedB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE- PZRFRUNSELECTED #20180713T142202.773 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzRFRunSelected");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE- PZRFRUNSELECTED #20180713T142202.773 GMT", "Rule- pzRFRunSelected", "Pega-AutoTest", "08-01-01", "20180713T142202.773 GMT");
}
