...
/**
 * Builds JSP stream PEGA-LANDING-ORG!PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER.
 */
public class ra_stream_pzlporganizationandsecurityorganizationinner_dcefff152759a915ce7f6af6af47e118 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzLPOrganizationAndSecurityOrganizationInner.Pega_Landing_Org.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 369530196;
 ...
 */
	public ra_stream_pzlporganizationandsecurityorganizationinner_dcefff152759a915ce7f6af6af47e118(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "8a91c70e87c93da78507e8f6a4f0bf4a739a773a";
...
{
/* Instance RULE-HTML-SECTION PEGA-LANDING-ORG PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER #20180713T142723.984 GMT	Pega-LP-OrgAndSecurity:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "8a91c70e87c93da78507e8f6a4f0bf4a739a773a";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzLPOrganizationAndSecurityOrganizationInner",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-LANDING-ORG PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER #20180713T142723.984 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-LANDING-ORG PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER #20180713T142723.984 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-LANDING-ORG PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER #20180713T142723.984 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER","Rule-HTML-Section","PEGA-LANDING-ORG",false,"","Pega-LP-OrgAndSecurity","08-01-01","RULE-HTML-SECTION PEGA-LANDING-ORG PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER #20180713T142723.984 GMT","!PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",369530196)
	};
...
//	RULE-HTML-SECTION PEGA-LANDING-ORG PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER #20180713T142723.984 GMT:20180713T142723.984 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "649d2c969a6a500a0ad63f610e3b7234";
	}

	public String getDefinitionAppliesToClass() {
		return "Pega-Landing-Org";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzLPOrganizationAndSecurityOrganizationInner",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzLPOrganizationAndSecurityOrganizationInner','insKey':'RULE-HTML-SECTION PEGA-LANDING-ORG PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER #20180713T142723.984 GMT','sectionType':'null'}");
...
pzSection.getLayout().setExpandParam("SubSectionpzLPOrganizationAndSecurityOrganizationInnerBB",null,false);
...
expandedSecId="EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerBB" + expandRLExprValue;
...
tools.appendString("<div section_index='2' id='INNERDIV-SubSectionpzLPOrganizationAndSecurityOrganizationInnerBB' class='tabbed_expandInnerDivStyle'  style=\"display:none\"  >");
...
public void buildSection_2() { 
	...
	secInfo.put("usingPage",".pyPages(1)");
	...
	secParams.put("actionClass","Pega-Landing-Org-OrgChart");
	secParams.put("actionName","pzLPOrgChart");
...
public void includeSectionBody_2() { 
	...
	try { ClipboardProperty cbSecPage = tools.getIfPresent(".pyPages(1)");if(cbSecPage != null && cbSecPage.isScalar()){ strSectionPageProp = cbSecPage.getStringValue(); } else { strSectionPageProp = ".pyPages(1)"; } }catch(Exception e){ strSectionPageProp = ".pyPages(1)"; }
	tools.putParamValue("showSubmit","false");tools.putParamValue("actionClass","Pega-Landing-Org-OrgChart");tools.putParamValue("actionName","pzLPOrgChart");tools.putParamValue("section_params","");
	String includedSectionName = "";includedSectionName = "pxLocalAction";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"".equals(strSectionPageProp)?"_":strSectionPageProp,false,""));
...
l_sectionTitle="Organizational Chart";
...
tabGroupName="";
elementName="";
tools.appendString("<li role=\"tab\"  aria-label=\"Organizational Chart\" title=\"Organizational Chart\"  aria-selected=\"false\" tabindex=\"-1\" elementName='" + elementName + "' tabGroupName = '" + tabGroupName + "' section-incl-id='-wrapper' section_index='2' id='Tab2' sel_prefix='tab-li-t-ns'");
 if(tools.getParamValue("pyPegaDesignMode").equals("true")) {
tools.appendString(" class=\"tab-li tab-li-t tab-li-t-ns unselected\" ");
}else{
tools.appendString(" class=\"tab-li tab-li-t tab-li-t-ns \" ");
}
 if(tools.getParamValue("EXPAND_ALL").equals("true") || (tools.getParamValue("EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerBB"+(tools.getParamAsBoolean(ImmutablePropertyInfo.TYPE_TRUEFALSE,"expandRL")?tools.getParamValue("index"):"")).equals("true") && tools.getParamValue("RenderSingle").equals(""))  ||tools.getParamValue("RenderSingle").equals("EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerBB"+(tools.getParamAsBoolean(ImmutablePropertyInfo.TYPE_TRUEFALSE,"expandRL")?tools.getParamValue("index"):""))){
tools.appendString(" isLoadDeferred='false' sectionBodyId='SubSectionpzLPOrganizationAndSecurityOrganizationInnerBB'");
}else{
tools.appendString(" isLoadDeferred='true' readonly='" + !tools.hasInputEnabled() + "' sectionBodyId='SubSectionpzLPOrganizationAndSecurityOrganizationInnerBB'");
}
tools.appendString(">");
String l_title="Organizational Chart";
String l_tabtooltip = tools.getLocalizedTextForString(".pyCaption", "");
String rptDynamicIdx = tools.getParamValueCSF("pega_RLindex");
tools.appendString("<span  data-layout-id=\"202601120327090292" + rptDynamicIdx + "\" title=\"" + l_tabtooltip + "\" id=\"TABANCHOR\" tabTitle=\"" + l_title + "\"><span id=\"TABSPAN\" class=\"textOut tab-span tab-span-t tab-span-t-ns \">");
pzHeaderBody_2();
...
pzSection.getLayout().setExpandParam("SubSectionpzLPOrganizationAndSecurityOrganizationInnerB",null,false);
boolean bExpandRL=tools.getParamAsBoolean(ImmutablePropertyInfo.TYPE_TRUEFALSE,"expandRL");
String param_Index=tools.getParamValue("index");
	String expandedSecId="";
String expandRLExprValue=(bExpandRL?param_Index:"");
expandedSecId="EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerB" + expandRLExprValue;
tools.putSaveValue("expandParam", expandedSecId);
pega_rules_utilities.pzRegisterActivity(tools, "Show-Harness");
if(pzSection.getLayout().loadLayoutHeader()) {
tools.appendString("<div section_index='1' id='INNERDIV-SubSectionpzLPOrganizationAndSecurityOrganizationInnerB' class='tabbed_expandInnerDivStyle'  >");
boolean isParentTemplate = "true".equals(pzAuto.getUIComponentRuntime().getRuntimeContextTree().getSaveValue("TAB_PARENT_TEMPLATE"));
if(isParentTemplate){
pzAuto.getUIComponentRuntime().getRuntimeContextTree().saveValue("TAB_PARENT_TEMPLATE",null);
pzAuto.getUIComponentRuntime().resetTemplatingUIStatus('Y');
}
tools.putParamValue("tempSecIDRL", "EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerB"+(tools.getParamAsBoolean(ImmutablePropertyInfo.TYPE_TRUEFALSE,"expandRL")?tools.getParamValue("index"):""));
...
if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate() && !"true".equals(tools.getParamValue("pyPegaDesignMode"))){tools.appendString("</div>");}
			tools.putParamValue("RenderSingle" , "EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerB"+(tools.getParamAsBoolean(ImmutablePropertyInfo.TYPE_TRUEFALSE,"expandRL")?tools.getParamValue("index"):""));
			 tools.putParamValue("lazyLoadId" , "EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerB"+(tools.getParamAsBoolean(ImmutablePropertyInfo.TYPE_TRUEFALSE,"expandRL")?tools.getParamValue("index"):""));
		}else{
		
			if(!tools.getParamValue("lazySection ").equals("pzLPOrganizationAndSecurityOrganizationInner")){
				 String readOnly = "-1".equals(tools.getParamValue("ReadOnly")) || "-1".equals(tools.getParamValue("SectionReadOnly")) || !tools.hasInputEnabled() ? "-1" : "0";
				   ...
				   tools.putParamValue("lazyLoadInfo" , lazyLoadInfoValue + tools.getSaveValue("lazyLoadDivId") + ",EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerB"+(tools.getParamAsBoolean(ImmutablePropertyInfo.TYPE_TRUEFALSE,"expandRL")?tools.getParamValue("index"):"")+",subscriptionId=" + tools.getParamValue("subscriptionId") + "ReadOnly=" + readOnly + getParamPage_1() + "~#LLDELIM#~");tools.appendString("<div style='display:block;' data-lazyloaddivid='" + lazyLoadDivIdSaveValue + "' data-layoutid='EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerB' class='lazyload-layout' data-parampage='"+tools.getParamValueCSF("lazyLoadInfo").replace("~#LLDELIM#~","")+"' >");if(tools.getParamValue("RenderSingle").equals("")){pzAuto.emitIncludeStreamReference("pyLoadingMessage",null,null,"Rule-HTML-Section",null); }tools.appendString("</div>");
			}
		}
	
} else {
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage("LazyLoad");
tools.appendString("<div section_index='1' id='INNERDIV-SubSectionpzLPOrganizationAndSecurityOrganizationInnerB' class='tabbed_expandInnerDivStyle'  style='display:none'  >");
if(true && (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()  || "true".equals(tools.getParamValue("pyPegaDesignMode")))){
includeSectionBody_1();
}
}
...
public void buildSection_1() { 
	Map<String, Object> secInfo = new HashMap<String, Object>();
	secInfo.put("usingPage",".pyPages(2)");
	secInfo.put("isUsingPagePropertyRef",false);
	secInfo.put("doNotConsiderDecParams",false);
	secInfo.put("keepStreamProperties",false);
	secInfo.put("preserveParamState",false);
	Map<String, String> secParams = new HashMap<String, String>();
	secParams.put("showSubmit","false");
	secParams.put("actionClass","Pega-Landing-Org-Operators");
	secParams.put("actionName","pzLPOperators");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	if(pzAuto.getUIComponentRuntime().isParentNonTemplate()) {
	String expressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
...
public void includeSectionBody_1() { 
	...
	String strSectionPageProp = "";
	try { ClipboardProperty cbSecPage = tools.getIfPresent(".pyPages(2)");if(cbSecPage != null && cbSecPage.isScalar()){ strSectionPageProp = cbSecPage.getStringValue(); } else { strSectionPageProp = ".pyPages(2)"; } }catch(Exception e){ strSectionPageProp = ".pyPages(2)"; }
	tools.putParamValue("showSubmit","false");tools.putParamValue("actionClass","Pega-Landing-Org-Operators");tools.putParamValue("actionName","pzLPOperators");tools.putParamValue("section_params","");
	String includedSectionName = "";includedSectionName = "pxLocalAction";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"".equals(strSectionPageProp)?"_":strSectionPageProp,false,""));
	}else{oLog.warn("Section name must be provided.");}}
...
tabGroupName="";
elementName="";
tools.appendString("<li role=\"tab\"  aria-label=\"Operators       \" title=\"Operators       \"  aria-selected=\"true\" tabindex=\"0\" elementName='" + elementName + "' tabGroupName = '" + tabGroupName + "' section-incl-id='-wrapper' section_index='1' id='Tab1' sel_prefix='tab-li-t-ns'");
 if(tools.getParamValue("pyPegaDesignMode").equals("true")) {
tools.appendString(" class=\"tab-li tab-li-t tab-li-t-ns selected\" ");
}else{
tools.appendString(" class=\"tab-li tab-li-t tab-li-t-ns \" ");
}
 if(tools.getParamValue("EXPAND_ALL").equals("true") || (tools.getParamValue("EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerB"+(tools.getParamAsBoolean(ImmutablePropertyInfo.TYPE_TRUEFALSE,"expandRL")?tools.getParamValue("index"):"")).equals("true") && tools.getParamValue("RenderSingle").equals(""))  ||tools.getParamValue("RenderSingle").equals("EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerB"+(tools.getParamAsBoolean(ImmutablePropertyInfo.TYPE_TRUEFALSE,"expandRL")?tools.getParamValue("index"):""))){
tools.appendString(" isLoadDeferred='false' sectionBodyId='SubSectionpzLPOrganizationAndSecurityOrganizationInnerB'");
}else{
tools.appendString(" isLoadDeferred='true' readonly='" + !tools.hasInputEnabled() + "' sectionBodyId='SubSectionpzLPOrganizationAndSecurityOrganizationInnerB'");
}
tools.appendString(">");
String l_title="Operators       ";
String l_tabtooltip = tools.getLocalizedTextForString(".pyCaption", "");
String rptDynamicIdx = tools.getParamValueCSF("pega_RLindex");
tools.appendString("<span  data-layout-id=\"202601120327090244" + rptDynamicIdx + "\" title=\"" + l_tabtooltip + "\" id=\"TABANCHOR\" tabTitle=\"" + l_title + "\"><span id=\"TABSPAN\" class=\"textOut tab-span tab-span-t tab-span-t-ns \">");
pzHeaderBody_1();
tools.appendString("</span></span>");
tools.appendString("</li>");
}
public void pzGroup_1() {
	String expandedGrpId=tools.getParamCSF("EXPANDEDTGpzLPOrganizationAndSecurityOrganizationInnerA");
	String activatedGrpId=tools.getParamCSF("ACTIVATEDTGpzLPOrganizationAndSecurityOrganizationInnerA");
	...
	if(pzAuto.handleEvaluateWhen(" o2== rx.pyLandingNavigation.pyLevelC cqOperators",".pyLandingNavigation.pyLevelC=\'Operators\'", "tab", "active" )) { 
	 tools.putParamValue("ACTIVATEDTGpzLPOrganizationAndSecurityOrganizationInnerA","1"); 
}if(pzAuto.handleEvaluateWhen(" o2== rx.pyLandingNavigation.pyLevelC cqOrganizationalChart",".pyLandingNavigation.pyLevelC=\'OrganizationalChart\'", "tab", "active" )) { 
	 tools.putParamValue("ACTIVATEDTGpzLPOrganizationAndSecurityOrganizationInnerA","2"); 
}
	activatedGrpId=tools.getParamCSF("ACTIVATEDTGpzLPOrganizationAndSecurityOrganizationInnerA");
	...
	tools.appendString("<div " + pzSection.getLayout().getInspectorData("TABGROUP", ".pySections(1)") + " id='PEGA_TABBED'   tabGroupId='TGpzLPOrganizationAndSecurityOrganizationInnerA' tabGroupName='' activeWhenTab = '" + activeTabSaveValue + "' defaultTab='" + defaultTabSaveValue + "' class= 'yui-navset pegaTabGrp yui-navset-top headerTabbed headerTabbed-t' data-taberror=\"" + tools.getLocalizedTextForString("pxRequestor.pyMessageLabel","TabErrorTooltip")  + " \"  data-pos=\"Top\">");
	if(!("true").equalsIgnoreCase(bIsScreenLayout) || !("true").equals(sectionHasDynamicLayout)){
	if(param_renderSingle.equals("")){
		boolean bExpandRL=tools.getParamAsBoolean(ImmutablePropertyInfo.TYPE_TRUEFALSE,"expandRL");
	 String param_Index=tools.getParamValue("index");
	String expandedSecId="";
	 String expandRLExprValue=(bExpandRL?param_Index:"");expandedSecId="EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerB"+ expandRLExprValue;if(defaultTabSaveValue.equals("1")){ 
		 tools.putParamValue(expandedSecId,"true");
	} else {
		tools.putParamValue(expandedSecId,"false");
}expandedSecId="EXPANDEDSubSectionpzLPOrganizationAndSecurityOrganizationInnerBB"+ expandRLExprValue;if(defaultTabSaveValue.equals("2")){ 
		 tools.putParamValue(expandedSecId,"true");
	} else {
		tools.putParamValue(expandedSecId,"false");
}
...
groupHeaderEnd_1();
	...
	boolean isParentTemplate = "true".equals(pzAuto.getUIComponentRuntime().getRuntimeContextTree().getSaveValue("TAB_PARENT_TEMPLATE"));
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().saveValue("TAB_PARENT_TEMPLATE",null);
	if(isParentTemplate){pzAuto.getUIComponentRuntime().getRuntimeContextTree().saveValue("TAB_PARENT_TEMPLATE", "true");}pzLayoutBodyWrapper_1();if(isParentTemplate){pzAuto.getUIComponentRuntime().getRuntimeContextTree().saveValue("TAB_PARENT_TEMPLATE", "true");}pzLayoutBodyWrapper_2();
	tools.appendString("</div><input type='hidden' name='EXPANDEDTGpzLPOrganizationAndSecurityOrganizationInnerA");
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Pega-Landing-Org");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-LANDING-ORG PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER #20180713T142723.984 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzLPOrganizationAndSecurityOrganizationInner");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-LANDING-ORG PZLPORGANIZATIONANDSECURITYORGANIZATIONINNER #20180713T142723.984 GMT", "Pega-Landing-Org pzLPOrganizationAndSecurityOrganizationInner", "Pega-LP-OrgAndSecurity", "08-01-01", "20180713T142723.984 GMT");
}
