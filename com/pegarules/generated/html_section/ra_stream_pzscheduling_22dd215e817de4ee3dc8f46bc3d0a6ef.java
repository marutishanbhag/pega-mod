...
/**
 * Builds JSP stream DATA-ADMIN-OPERATOR-ID!PZSCHEDULING.
 */
public class ra_stream_pzscheduling_22dd215e817de4ee3dc8f46bc3d0a6ef extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzScheduling.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 2121095315;
 ...
 */
	public ra_stream_pzscheduling_22dd215e817de4ee3dc8f46bc3d0a6ef(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "fcb37a9419c99b97259e6d8fe8e6b24888eed976";
...
{
/* Instance RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSCHEDULING #20180713T135640.910 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "fcb37a9419c99b97259e6d8fe8e6b24888eed976";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzScheduling",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSCHEDULING #20180713T135640.910 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSCHEDULING #20180713T135640.910 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSCHEDULING #20180713T135640.910 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZSCHEDULING", 
	"Rule-Obj-Property:PYOPAVAILABLE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSCHEDULING","Rule-HTML-Section","DATA-ADMIN-OPERATOR-ID",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSCHEDULING #20180713T135640.910 GMT","!PZSCHEDULING",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",2121095315), 
		new DependentRuleInfo("PYOPAVAILABLE","Rule-Obj-Property","DATA-ADMIN-OPERATOR-ID",true,"Data-Admin-Operator-ID","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYOPAVAILABLE #20180713T131844.888 GMT","!PYOPAVAILABLE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSCHEDULING #20180713T135640.910 GMT:20180713T135640.910 GMT
...
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYOPAVAILABLE #20180713T131844.888 GMT:20180713T131844.888 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "750651c634353f059e07c429c4e857a6";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzScheduling",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzScheduling','insKey':'RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSCHEDULING #20180713T135640.910 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
pzLayout_3();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_12","pzSubstituteDetails", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "pzSubstituteDetails";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_3() {
pzSection.getLayout().setExpandParam("SubSectionpzSchedulingBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzSchedulingBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(3)','clipboardPath':'pzSubstituteDetails'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(3)','clipboardPath':'pzSubstituteDetails'}") + ">");
}
pzSetExpandParam_3();
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pzCalendarSettings", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzCalendarSettings";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_2() {
pzSection.getLayout().setExpandParam("SubSectionpzSchedulingBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzSchedulingBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzCalendarSettings'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzCalendarSettings'}") + ">");
}
pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void inclFormattedVal_2(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {
		...
		String formattedValue = pega_uiengine_formatter.pxFormatTrueFalse((isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true)),"Yes","No",true,"text","","");
...
inclCalVal_1("pxCheckbox","TF&&text&&false&&Yes&&No","leftJustifyStyle");inclAction_1();
tools.appendString(">");
...
tools.appendString("</P>");
	...
	pzAuto.getUIComponentRuntime().getExpressionEvaluator().addDefaultValue(".pyOpAvailable",  "false");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20150907070324019455724",true));
	cellPage.put("pyValue",".pyOpAvailable");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyOpAvailable");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyOpAvailable", ".pyCaption");
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyCaption","Operator is available to receive work\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Operator is available to receive work", ".pyCaption");
	}
	pyCheckboxCaption = "Operator is available to receive work";
	modePage1.put("pyCheckboxCaption",pyCheckboxCaption);
	cellPage.put("pyID","pyOpAvailable");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyOpAvailable",pxUniqueStreamHash+"_6");
	...
	String pyValueOrig = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyOpAvailable");
	pyValueR = ".pyOpAvailable";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyOpAvailable");
	pyValueOrig = ".pyOpAvailable";
	...
	String pyFalseLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyCaption","Yes\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Yes", ".pyCaption");
	}
	pyTrueLabel = "Yes";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyCaption","No\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("No", ".pyCaption");
	}
	pyFalseLabel = "No";
...
pzStatic_pzCheckboxScripts.emitContent();
		...
		tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOpAvailable").getEntryHandle(),"entryHandle"));} else{
		tools.appendString(tools.getActive().getEntryHandle());}
		tools.appendString("' ");		tools.appendString(disabled_ctrl);

		tools.appendString(" />");
		String checkboxName = "";
		tools.appendString("<input type='checkbox'  " + pzCell.getTestIdIfEnabled("20150907070324019455724") + "  class='checkbox chkBxCtl"+errorClass+"' value='true' name='");if(bOptimizedMarkup){
		tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOpAvailable").getEntryHandle(),"entryHandle"));
		tools.appendString("' data-bindprops='value'");
		checkboxName = StringUtils.crossScriptingFilter(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOpAvailable").getEntryHandle(),"entryHandle"));} else{
		tools.appendString(tools.getActive().getEntryHandle());
		tools.appendString("'");
		...
		tools.appendString(propName.substring(propName.lastIndexOf(".")+1)+pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOpAvailable").getReference(),"",true)+"' ");} else{
		...
		tools.appendString(" />");
		tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20150907070324019455724-Label") + "  class=' cb_standard' for='");if(bOptimizedMarkup){
		tools.appendString(propName.substring(propName.lastIndexOf(".")+1)+pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyOpAvailable").getReference(),"",true)+"' ");} else{
		tools.appendString(tools.getHTMLIDForProperty(true,"checkbox")+"' ");} 
	tools.appendString("class='chkbxCaptionRight'>");
		tools.appendString(tools.getLocalizedTextForString(".pyCaption","Operator is available to receive work"));
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("20150907070324019455724") + " ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8")){inclFormattedVal_2(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxCheckbox",".pyOpAvailable",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxCheckbox_1(".pyOpAvailable",12,"","","True-False");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20150907070324019455724-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxCheckbox");
	pgCells.put("forLabel",".pyOpAvailable");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxCheckbox",".pyOpAvailable",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxCheckbox_1(".pyOpAvailable",12,"","","True-False");labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzSchedulingB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzSchedulingB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSCHEDULING #20180713T135640.910 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzScheduling");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZSCHEDULING #20180713T135640.910 GMT", "Data-Admin-Operator-ID pzScheduling", "Pega-SystemArchitect", "08-01-01", "20180713T135640.910 GMT");
}
