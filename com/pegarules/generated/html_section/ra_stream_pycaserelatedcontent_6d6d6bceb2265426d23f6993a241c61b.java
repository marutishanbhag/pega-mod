...
/**
 * Builds JSP stream WORK-!PYCASERELATEDCONTENT.
 */
public class ra_stream_pycaserelatedcontent_6d6d6bceb2265426d23f6993a241c61b extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyCaseRelatedContent.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 948110470;
 ...
 */
	public ra_stream_pycaserelatedcontent_6d6d6bceb2265426d23f6993a241c61b(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "7f75c4a32230db690cfc3a73a3aa35d2191583b4";
...
{
/* Instance RULE-HTML-SECTION WORK- PYCASERELATEDCONTENT #20210506T204028.591 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "7f75c4a32230db690cfc3a73a3aa35d2191583b4";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyCaseRelatedContent",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- PYCASERELATEDCONTENT #20210506T204028.591 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PYCASERELATEDCONTENT #20210506T204028.591 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PYCASERELATEDCONTENT #20210506T204028.591 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYCASERELATEDCONTENT", 
	"Rule-Obj-Property:DOCUMENTSANDFILESCOUNT", 
	"Rule-HTML-Property:PXBUTTON", 
	"Rule-File-Binary:WEBWB!ATTACHMENT!SVG"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCASERELATEDCONTENT","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION WORK- PYCASERELATEDCONTENT #20210506T204028.591 GMT","!PYCASERELATEDCONTENT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",948110470), 
		new DependentRuleInfo("DOCUMENTSANDFILESCOUNT","Rule-Obj-Property","WORK-",true,"Work-","Theme-Cosmos","04-01-01","RULE-OBJ-PROPERTY WORK- DOCUMENTSANDFILESCOUNT #20210506T204032.766 GMT","!DOCUMENTSANDFILESCOUNT",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		...
		new DependentRuleInfo("WEBWB!ATTACHMENT!SVG","Rule-File-Binary","",false,"","","","","WEBWB!ATTACHMENT!SVG",true,false,"ABSOLUTE_CLASSLESS",1)
	};
...
//	RULE-HTML-SECTION WORK- PYCASERELATEDCONTENT #20210506T204028.591 GMT:20230706T113328.484 GMT
//	RULE-HTML-PROPERTY PXBUTTON #20190131T183501.513 GMT:20190131T183501.513 GMT
//	RULE-OBJ-PROPERTY WORK- DOCUMENTSANDFILESCOUNT #20210506T204032.766 GMT:20210506T204032.766 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "0a3403a2ce70ada678bb368cade12440";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyCaseRelatedContent",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyCaseRelatedContent','insKey':'RULE-HTML-SECTION WORK- PYCASERELATEDCONTENT #20210506T204028.591 GMT','sectionType':'standard'}");
pzLayout_3();
...
config.put("pySectionName", "pyCaseRelatedContent");
...
config.put("NewTaskStatus", "pzManageRecentContent");
...
metadataPage.put("pyStyle","height:38px;width:100px;");
...
boolean pyVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxAttachmentsGearIconEnabled", pxUniqueStreamHash+"_21");
...
metadataPage.put("pyImage", "data:image/svg+xml;base64,");
}else{
metadataPage.put("pyImage", "webwb/attachment.svg");}
metadataPage.put("headingLevel","h3");
metadataPage.put("headCustom","flex-header");
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyCaseRelatedContentB"));
...
String sectionTitle = "FilesAndDocumentsGadgetHeading";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("FilesAndDocumentsGadgetHeading", "pyCaption");
...
metadataPage.put("uniqueid", "202602230450310672");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("201810250605180888507") + " ");
...
public void getNextPage_1(String listSource, int listStartIndex, int listEndIndex) {
	...
	nextPageMetadata.put("datasrcid",pxUniqueStreamHash+"_14");
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201801030904400319962" ) + "");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pyCaseRelatedContentItem", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pyCaseRelatedContentItem"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCaseRelatedContent999","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_8","pyCaseRelatedContentItem", secInfo);
}
...
public int simpleLayoutCell_2(  int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyCaseRelatedContentItem",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing remove-top-spacing remove-bottom-spacing   flex flex-row ' ");
	...
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201801030904400319962-" + rowTestID) + " ");
	}else {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyCaseRelatedContentItem",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
String pyInstanceId ="";
char mode = tools.getProperty(".pyCaseRelatedContent").getMode();
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
ClipboardPage dummyPage = tools.createPage("@baseclass","NoDataPage");
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_12","UtilityNoResultsMessage", RDLNoRowMessageSectionParams);
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  ".pyCaseRelatedContent AddDelete", expressionId, true);
expressionId = expression.getId();
}
ClipboardProperty rdlPageListProp = tools.getProperty(".pyCaseRelatedContent");
String rdlPageListPropRef = ".pyCaseRelatedContent";
if(rdlPageListProp != null) {
rdlPageListPropRef = rdlPageListProp.getReference();
}
String rdlRefreshWhenStr = ".pyCaseRelatedContent AddDelete";
rdlRefreshWhenStr = rdlRefreshWhenStr.replace(".pyCaseRelatedContent",rdlPageListPropRef);
if(!StringUtils.isBlank(expressionId)) {
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_15","pyProgressiveRDLPaginatorShowLess", RDLNoMoreDataMessageSectionParams);
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_16","pyProgressiveRDLPaginator", RDLPaginatorSectionParams);
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyCaseRelatedContent").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
} else {
pgSectionBody.put("pageListProp", ".pyCaseRelatedContent");
}
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pzPackageRuntime.packageProperty(tools.getProperty(".pyCaseRelatedContent").getReference(), null);
}
...
pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201801030904400319962" ) + "");
...
map.put("pyContext", ".pyCaseRelatedContent");
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyCaseRelatedContent").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyCaseRelatedContent").getReference(),"", false),pyInstanceId);
}
tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
ClipboardProperty cpSource = tools.getProperty(".pyCaseRelatedContent");
...
dummyPageName = "Dummy_pyCaseRelatedContent";
}
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyCaseRelatedContent").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
itemPage = tools.createPage("@baseclass",dummyPageName);
PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
simpleLayoutCell_2(1);
	pega.popStackFrame(itemFrame, false);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyCaseRelatedContent").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
}
}else{
if(mode =='L' || mode =='G'){
Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyCaseRelatedContent").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyCaseRelatedContent").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("pyCaseRelatedContent",
...
pzSection.getLayout().setExpandParam("SubSectionpyCaseRelatedContentBB","",false);
}
...
public void simpleLayout_1() {
	...
	tools.appendString(tools.getProperty(".pyCaseRelatedContent").getReference()+ "' ");
	tools.appendString(" " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + "  class=' flex content   layout-content-default content-default   progressive-useraction' ");
	String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
	ClipboardProperty rdlPageListProperty = tools.getProperty(".pyCaseRelatedContent");
	String rdlPageListPropRef = ".pyCaseRelatedContent";
...
try {
tools.appendString("RWP=\".pyCaseRelatedContent\" RW=\"");
tools.appendString(rdlRefreshWhenStr);
tools.appendString("\"");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
	tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201801030904400319962" ) + " ");
	tools.appendString(">");
	int index = 1;
	...
	rdlPageListProp = tools.getProperty(".pyCaseRelatedContent");
...
String paramName = "EXPANDEDSubSectionpyCaseRelatedContentBB";
...
public void pxDisplayText_1() {String key="5||RULE-HTML-SECTION WORK- PYCASERELATEDCONTENT #20210506T204028.591 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","N","false","0","","","Integer","true","5"};oCellRuntimeParamsMap.put("5||RULE-HTML-SECTION WORK- PYCASERELATEDCONTENT #20210506T204028.591 GMT",paramValues);oControlPathsMap.put("5||RULE-HTML-SECTION WORK- PYCASERELATEDCONTENT #20210506T204028.591 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
isBehaviorAdded = false;
		tools.appendString(" data-message='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				refreshActionRequest.registerFixedParameter("StreamList", "pyCaseRelatedContent|Rule-HTML-Section|:");
				staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
				tools.appendString("[\"refresh\", [\"otherSection\",\"pyCaseRelatedContent\", \"\", \"");
...
public int simpleLayoutCell_1( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxAttachmentsGearIconEnabled","AttachmentsGearIconEnabled","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".DocumentsAndFilesCount",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   utils-badge dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202006302358200695740-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel",".DocumentsAndFilesCount");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxAttachmentsGearIconEnabled",pxUniqueStreamHash+"_7");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_7");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","AttachmentsGearIconEnabled");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxAttachmentsGearIconEnabled", pxUniqueStreamHash+"_7"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".DocumentsAndFilesCount",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_1();}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		keyMap.putString("pyActionName", "pzManageRecentContent");
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
		pzPackageRuntime.packageLocalAction("pzManageRecentContent", offlineUsingPage , strLAClassName);
								...
								com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
									...
									if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
										try{
											...
											staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
											staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pyCaseRelatedContent"));
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202107261114190248526") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyCaseRelatedContent_$CTX$_3");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Manage files and documents\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Manage files and documents", ".pyActionPrompt");
	}
	pyTooltip = "Manage files and documents";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyCaseRelatedContent_"+ referenceString+ "_3'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202107261114190248526") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Manage files and documents\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
...
pzSection.getLayout().setExpandParam("SubSectionpyCaseRelatedContentB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='layout layout-outline layout-outline-utility has-action' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpyCaseRelatedContentB";
...
String labelName = "FilesAndDocumentsGadgetHeading";
labelName =  tools.getLocalizedTextForString(".pyCaption","FilesAndDocumentsGadgetHeading");
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='3' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel3051' data-layout-id='202602230450310628" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><span class='header-element'><img src='webwb/attachment.svg'  alt= '" + sectionImageTitle + "'  title= '" + sectionImageTitle + "'  /></span><h3  class='header-title' id='headerlabel3051'>" + l_sectionTitle + "</h3>");
if(pzAuto.handleEvaluateWhen(" wxAttachmentsGearIconEnabled","AttachmentsGearIconEnabled", "cell", "visible" )){
tools.appendString("<span class='header-element header-title-table " + pzSection.getCustomStyle(false, "", "", "") + "' style='");
try {
tools.appendString("height:38px;width:100px;");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyCaseRelatedContentB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_2() {
	...
	tools.putParamValue("var__channelName", "Documents");
	try{
	String channel = "PegaSocial-Document";
	String conditionProp = "pyCaseContext";
	String conditionVal = null;
	if(tools.getIfPresent(".pzInsKey") != null) {
		conditionVal = tools.getProperty(".pzInsKey").getStringValue(); 
	}
	if(!"".equals(conditionVal) && conditionVal.indexOf(",") != -1) {
		...
		if(currentTemplatingStatus == 'Y'){
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().addSubscriptionId(channel, conditionProp, conditionValList,pxUniqueStreamHash+"_5");
			...
			pxSubscriptionIdentifiers.put("pySubscriptionId",pxUniqueStreamHash+"_5");
		...
		if(currentTemplatingStatus == 'Y'){
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().addSubscriptionId(channel, conditionProp,".pzInsKey",pxUniqueStreamHash+"_5");
			IUIComponentMetadata pxSubscriptionIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
			pg_dlmeta.putMetadata("pxSubscriptionIdentifiers",pxSubscriptionIdentifiers);
			pxSubscriptionIdentifiers.put("pySubscriptionId",pxUniqueStreamHash+"_5");
			pxSubscriptionIdentifiers.put("pySubscriptionAck", ackEnabled);
		...
		if(currentTemplatingStatus != 'Y'){
			...
			tools.appendString(" class='" + "flex  content  layout-content-stacked content-stacked utility" + "'  " + "role='tab' tabindex='0' " + " aria-label = '"+tools.getLocalizedTextForString(".pyCaption", StringUtils.escapeCrossScriptingFilter("Files And Documents"))+"'" );
...
isBehaviorAdded = false;
		...
		tools.appendString("]' ");								}
								...
								pg_dlmeta.put("ariaLabel",""+tools.getLocalizedTextForString(".pyCaption", StringUtils.escapeCrossScriptingFilter("Files And Documents")));
							...
							String paramName = "EXPANDEDSubSectionpyCaseRelatedContentB";
							...
							boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpxIsOfflinePackaging", pxUniqueStreamHash+"_20");metadataPage.put("lMode","Flexbox");
							IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpxIsOfflinePackaging","!pxIsOfflinePackaging", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
tools.putParamValue("RWClasses","");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- PYCASERELATEDCONTENT #20210506T204028.591 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyCaseRelatedContent");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PYCASERELATEDCONTENT #20210506T204028.591 GMT", "Work- pyCaseRelatedContent", "Theme-Cosmos", "04-01-01", "20230706T113328.484 GMT");
}
