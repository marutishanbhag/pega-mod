...
/**
 * Builds JSP stream DATA-MO-CONNECTOR-TRANSITION!PZPROPERTYPANELINNER.
 */
public class ra_stream_pzpropertypanelinner_2ff5ad8edec612161a6bdc3c588e80f7 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzPropertyPanelInner.Data_MO_Connector_Transition.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 479772277;
 ...
 */
	public ra_stream_pzpropertypanelinner_2ff5ad8edec612161a6bdc3c588e80f7(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "33963e5c544c55ae49175aba95128dea7ce19cf9";
...
{
/* Instance RULE-HTML-SECTION DATA-MO-CONNECTOR-TRANSITION PZPROPERTYPANELINNER #20210331T114252.889 GMT	Pega-ProcessArchitect:08-07-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "33963e5c544c55ae49175aba95128dea7ce19cf9";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzPropertyPanelInner",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-MO-CONNECTOR-TRANSITION PZPROPERTYPANELINNER #20210331T114252.889 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-MO-CONNECTOR-TRANSITION PZPROPERTYPANELINNER #20210331T114252.889 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-MO-CONNECTOR-TRANSITION PZPROPERTYPANELINNER #20210331T114252.889 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZPROPERTYPANELINNER"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZPROPERTYPANELINNER","Rule-HTML-Section","DATA-MO-CONNECTOR-TRANSITION",false,"","Pega-ProcessArchitect","08-07-01","RULE-HTML-SECTION DATA-MO-CONNECTOR-TRANSITION PZPROPERTYPANELINNER #20210331T114252.889 GMT","!PZPROPERTYPANELINNER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",479772277)
	};
...
//	RULE-HTML-SECTION DATA-MO-CONNECTOR-TRANSITION PZPROPERTYPANELINNER #20210331T114252.889 GMT:20210331T114252.889 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "ff02bd94de9bd5cf9c56826eec86dd00";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzPropertyPanelInner",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzPropertyPanelInner','insKey':'RULE-HTML-SECTION DATA-MO-CONNECTOR-TRANSITION PZPROPERTYPANELINNER #20210331T114252.889 GMT','sectionType':'standard'}");
pzLayout_3();
pzLayout_4();
pzLayout_5();
...
public void buildSection_4() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		if(StringUtils.isBlank(expressionId)) {
			...
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_18","pzScreenFlowProperties", secInfo);
		}
...
public void includeSectionBody_2() { 
	...
	"pzScreenFlowProperties", tools.getStepPage().getReference(),"Data-MO-Connector-Transition");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	generateClientWhenDiv_3();
	tools.putParamValue("section_params","");
	
	String includedSectionName = "";includedSectionName = "pzScreenFlowProperties";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
pzSection.getLayout().setExpandParam("SubSectionpzPropertyPanelInnerBBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzPropertyPanelInnerBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(3)','clipboardPath':'pzScreenFlowProperties'}");
...
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& wxpzIsScreenFlow o1! o2&& wxpzIsConversationFlow wxpzIsPegaExpress", pxUniqueStreamHash+"_22");metadataPage.put("isSectionIncl","true");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& wxpzIsScreenFlow o1! o2&& wxpzIsConversationFlow wxpzIsPegaExpress","pzIsScreenFlow && !(pzIsConversationFlow && pzIsPegaExpress)", "layout", "visible" )) {boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(3)','clipboardPath':'pzScreenFlowProperties'}") + ">");
}
pzSetExpandParam_5();
...
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pyExpression\" RW=\".pyExpression Changes\"");
} catch(Throwable t) {
...
public void buildSection_3() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		if(StringUtils.isBlank(expressionId)) {
			...
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_13","pzStandardFlowProperties", secInfo);
		}
...
public void includeSectionBody_1() { 
	...
	try{
	pzPackageRuntime.packageSection(
	"pzStandardFlowProperties", tools.getStepPage().getReference(),"Data-MO-Connector-Transition");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	generateClientWhenDiv_3();
	tools.putParamValue("section_params","");
	
	String includedSectionName = "";includedSectionName = "pzStandardFlowProperties";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
	tools.appendString("\n\t\t\t\t\t\t</div>");
	}
}
public void pzSetExpandParam_4() {
pzSection.getLayout().setExpandParam("SubSectionpzPropertyPanelInnerBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzPropertyPanelInnerBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzStandardFlowProperties'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
IUIComponent containerComponent = pzAuto.getUIComponent();
com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o1! wxpzIsScreenFlow o1! o2&& wxpzIsConversationFlow wxpzIsPegaExpress", pxUniqueStreamHash+"_17");metadataPage.put("isSectionIncl","true");
metadataPage.put("lMode","Inline-block");
IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o1! wxpzIsScreenFlow o1! o2&& wxpzIsConversationFlow wxpzIsPegaExpress","!pzIsScreenFlow && !(pzIsConversationFlow && pzIsPegaExpress)", "layout", "visible" )) {boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzStandardFlowProperties'}") + ">");
}
pzSetExpandParam_4();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
tools.appendString("<div class='layout layout-noheader layout-noheader-dashboard_row_label'>");
...
public void buildSection_2() { 
	...
	secInfo.put("packageSection", true);
	secInfo.put("packageSectionClass", "Data-MO-Connector-Transition");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_10","pzPropertyPanelTitle", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	try{
	pzPackageRuntime.packageSection(
	"pzPropertyPanelTitle", tools.getStepPage().getReference(),"Data-MO-Connector-Transition");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	...
	String sectionName = "pzPropertyPanelTitle"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzPropertyPanelInner215","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("packageSection", true);
	secInfo.put("packageSectionClass", "Data-MO-Connector-Transition");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzPropertyPanelTitle", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","heading_1_dataLabelRead","heading_1_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("2017060808563501423657") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead heading_1_dataLabelRead","dataLabelWrite heading_1_dataLabelWrite") + "' >");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Connector:") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2017060808563501423657")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pgCells.put("customROStyles","heading_1_dataLabelRead");
	pgCells.put("customRWStyles","heading_1_dataLabelWrite");
...
public int simpleLayoutCell_2( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzPropertyPanelTitle",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		boolean isOffline = false;
		cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
		String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzPropertyPanelTitle",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
		if(!inspectorData.isEmpty()) {
		pgCells.put("liveUI",inspectorData);
		}
		String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzPropertyPanelInnerBB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202103170843500843722") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzPropertyPanelInnerBB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("sectionIndex","193");
	IUIComponent containerComponent = pzAuto.getUIComponent();
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " set-width-auto   '  STRING_TYPE='layout' RESERVE_SPACE='false'><div class='content-inner set-width-auto'>");
	pzLayout_2();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("partialClass","set-width-auto");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
...
pzSection.getLayout().setExpandParam("SubSectionpzPropertyPanelInnerB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202103170843500836622") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  auto-width-column layout-content-simple_list content-simple_list  clearfix" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzPropertyPanelInnerB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("prefix","-dashboard_row_label");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-MO-CONNECTOR-TRANSITION PZPROPERTYPANELINNER #20210331T114252.889 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzPropertyPanelInner");
