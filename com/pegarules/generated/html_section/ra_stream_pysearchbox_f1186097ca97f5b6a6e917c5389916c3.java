...
/**
 * Builds JSP stream @BASECLASS!PYSEARCHBOX.
 */
public class ra_stream_pysearchbox_f1186097ca97f5b6a6e917c5389916c3 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pySearchBox.Embed_Stage.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 499788405;
 ...
 */
	public ra_stream_pysearchbox_f1186097ca97f5b6a6e917c5389916c3(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "8c06cf746ce38e17e550c09feec839781bab8da6";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYSEARCHBOX #20180713T140801.588 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "8c06cf746ce38e17e550c09feec839781bab8da6";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pySearchBox",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYSEARCHBOX #20180713T140801.588 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYSEARCHBOX #20180713T140801.588 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYSEARCHBOX #20180713T140801.588 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYSEARCHBOX","Rule-HTML-Section","@BASECLASS",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION @BASECLASS PYSEARCHBOX #20180713T140801.588 GMT","!PYSEARCHBOX",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",499788405), 
		new DependentRuleInfo("PYSEARCHTEXT","Rule-Obj-Property","@BASECLASS",true,"Embed-ContextualPrompt","Pega-EndUserUI","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYSEARCHTEXT #20180713T134648.480 GMT","!PYSEARCHTEXT",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION @BASECLASS PYSEARCHBOX #20180713T140801.588 GMT:20180713T140801.588 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "8239d4bcf142309b824b57c3971e4d6a";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pySearchBox",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pySearchBox','insKey':'RULE-HTML-SECTION @BASECLASS PYSEARCHBOX #20180713T140801.588 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("pyActivity", "pzSearchContextualPrompt");
config.put("StaticActivityParams", "classContext=&contextPage=&nSearchLevels=");
...
getControlMarkup_1() {
try {
if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyContextInfo.pySearchText").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
	pzAuto.getUIComponentRuntime().setTemplatingUIStatus('Y');
}pxTextInput_1();pzAuto.getUIComponentRuntime().insertTemplateScripts();}
else if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyTemplateInputBox").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
	pzAuto.getUIComponentRuntime().setTemplatingUIStatus('Y');
}pxIcon_1();pzAuto.getUIComponentRuntime().insertTemplateScripts();}
} catch(Throwable t) {
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }{String strStreamName="";String strPropertyTarget ="";String strPageName ="";strStreamName="pySearchBox";if(tools.getPrimaryPage() != null){ strPageName = tools.getPrimaryPage().getName();}if(tools.getActive() != null){strPropertyTarget = tools.getActive().getEntryHandle();}com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();actionRequest.registerFixedParameter("pyActivity", "ReloadCell"); actionRequest.registerFixedParameter("pyPropertyTarget", strPropertyTarget ); actionRequest.registerFixedParameter("StreamName", strStreamName); actionRequest.registerFixedParameter("pzPrimaryPageName", strPageName); pzAuto.registerActionRequest(actionRequest);}	tools.appendString("[\"postValue\",[\":event\"]");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				staticURLStr.append("&PreActivity=pzSearchContextualPrompt");
				tools.appendString("[\"refresh\", [\"otherSection\",\"pzItemList\", \"pzSearchContextualPrompt\", \"");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
				tools.appendString("sessionContext=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyContextInfo.pySessionContext")+"~#");				refreshActionRequestD.registerFixedParameter("sessionContext",".pyContextInfo.pySessionContext");
				tools.appendString("&actionContext=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyContextInfo.pyActionContext")+"~#");				refreshActionRequestD.registerFixedParameter("actionContext",".pyContextInfo.pyActionContext");
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"classContext\":\"\"");
				tools.appendString("&includeBestBets=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyContextInfo.pyIncludeBestBets")+"~#");				refreshActionRequestD.registerFixedParameter("includeBestBets",".pyContextInfo.pyIncludeBestBets");
				tools.appendString("&searchString=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyContextInfo.pySearchText")+"~#");				refreshActionRequestD.registerFixedParameter("searchString",".pyContextInfo.pySearchText");
				tools.appendString("&categoryClassContext=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pxObjClass")+"~#");				refreshActionRequestD.registerFixedParameter("categoryClassContext",".pxObjClass");
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"contextPage\":\"\"");
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"nSearchLevels\":\"\"");
				tools.appendString("\", \"\", \",");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
		...
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }{String strStreamName="";String strPropertyTarget ="";String strPageName ="";strStreamName="pySearchBox";if(tools.getPrimaryPage() != null){ strPageName = tools.getPrimaryPage().getName();}if(tools.getActive() != null){strPropertyTarget = tools.getActive().getEntryHandle();}com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();actionRequest.registerFixedParameter("pyActivity", "ReloadCell"); actionRequest.registerFixedParameter("pyPropertyTarget", strPropertyTarget ); actionRequest.registerFixedParameter("StreamName", strStreamName); actionRequest.registerFixedParameter("pzPrimaryPageName", strPageName); pzAuto.registerActionRequest(actionRequest);}											tools.appendString("[\"postValue\",[\":event\"]");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty(".pyContextInfo.pySessionContext"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyContextInfo.pyActionContext"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyContextInfo.pyIncludeBestBets"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyContextInfo.pySearchText"), -1);
...
try {
	...
	cellPage.put("pyStreamName","pySearchBox");
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2014112702152903875463") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pySearchBox_"+ referenceString+ "_2'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		String classProp = "";
		 classProp ="pi pi-search";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("2014112702152903875463") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
public void pxTextInput_1() {String key="1||RULE-HTML-SECTION @BASECLASS PYSEARCHBOX #20180713T140801.588 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","1"};oCellRuntimeParamsMap.put("1||RULE-HTML-SECTION @BASECLASS PYSEARCHBOX #20180713T140801.588 GMT",paramValues);oControlPathsMap.put("1||RULE-HTML-SECTION @BASECLASS PYSEARCHBOX #20180713T140801.588 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput",".pyContextInfo.pySearchText",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","searchbar","searchbar")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20141112014509021959544-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxTextInput");
	pgCells.put("forLabel",".pyContextInfo.pySearchText");
	...
	pgCells.put("customROStyles","searchbar");
	pgCells.put("customRWStyles","searchbar");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextInput",".pyContextInfo.pySearchText",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2014112702152903875463-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpySearchBoxB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  set-width-auto layout-content-inline_middle content-inline_middle nowrap" + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpySearchBoxB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYSEARCHBOX #20180713T140801.588 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pySearchBox");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYSEARCHBOX #20180713T140801.588 GMT", "@baseclass pySearchBox", "Pega-ProcessArchitect", "08-01-01", "20180713T140801.588 GMT");
}
