...
/**
 * Builds JSP stream RULE-RULESET-VERSION!PZRULESET_SHOWRULESETLOCKVERSION.
 */
public class ra_stream_pzruleset_showrulesetlockversion_bd28ea8609282508c39a873f590360a8 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzRuleset_ShowRuleSetLockVersion.Rule_RuleSet_Version.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1489976192;
 ...
 */
	public ra_stream_pzruleset_showrulesetlockversion_bd28ea8609282508c39a873f590360a8(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "305360182800759583a8e54c7899433fcf5c6c6f";
...
{
/* Instance RULE-HTML-SECTION RULE-RULESET-VERSION PZRULESET_SHOWRULESETLOCKVERSION #20180713T135703.000 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "305360182800759583a8e54c7899433fcf5c6c6f";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzRuleset_ShowRuleSetLockVersion",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-RULESET-VERSION PZRULESET_SHOWRULESETLOCKVERSION #20180713T135703.000 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-RULESET-VERSION PZRULESET_SHOWRULESETLOCKVERSION #20180713T135703.000 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-RULESET-VERSION PZRULESET_SHOWRULESETLOCKVERSION #20180713T135703.000 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZRULESET_SHOWRULESETLOCKVERSION", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULESET_SHOWRULESETLOCKVERSION","Rule-HTML-Section","RULE-RULESET-VERSION",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION RULE-RULESET-VERSION PZRULESET_SHOWRULESETLOCKVERSION #20180713T135703.000 GMT","!PZRULESET_SHOWRULESETLOCKVERSION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1489976192), 
...
//	RULE-HTML-SECTION RULE-RULESET-VERSION PZRULESET_SHOWRULESETLOCKVERSION #20180713T135703.000 GMT:20180713T135703.000 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "15fd984ccd4b7b6bc016e6f4491d3d29";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzRuleset_ShowRuleSetLockVersion",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzRuleset_ShowRuleSetLockVersion','insKey':'RULE-HTML-SECTION RULE-RULESET-VERSION PZRULESET_SHOWRULESETLOCKVERSION #20180713T135703.000 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
...
config.put("NewTaskStatus", "pzRuleSet_PopLockVersion");
pega.getUIEngine().getUIAction("openLocalAction", config).register();
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("ActionSection", "pyNextGenGridModalTemplate");
config.put("ModalSection", "pyNextGenGridModalTemplate");
config.put("NewTaskStatus", "pzRuleSet_PopUnlockVersion");
pega.getUIEngine().getUIAction("openLocalAction", config).register();
}
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzRuleset_ShowRuleSetLockVersion_"+ referenceString+ "_3'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2015022306241801047100") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }tools.appendString("[\"doListAction\",[\":event\",\"FLOWACTION\",\"pzRuleSet_PopUnlockVersion\",{\"noThreadProcess\":\"false\",\"templateName\":\"pyNextGenGridModalTemplate\",\"overrideTemplate\":\"false\"},\"null\",\"false\"]");
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Unlock the version and Save\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
		tools.appendString(toolTipVal);
		if(com.pega.pegarules.jsptags.WhenTag.evaluateWhen(pega, "pzBranchIsLocked", null, false)){
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Unlock and Save".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		tools.appendString("<span class='pzbtn-label'  data-click='.....' ");}if(bOptimizedMarkup && hasLineBreaks){
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Unlock and Save",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015022306241801047100-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzRuleset_ShowRuleSetLockVersionBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpzRuleset_ShowRuleSetLockVersionBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rx.pyVersionSecure cttrue", pxUniqueStreamHash+"_11");metadataPage.put("lMode","Inline-block");
...
if(pzAuto.handleEvaluateWhen(" o2== rx.pyVersionSecure cttrue",".pyVersionSecure == true", "layout", "visible" )) {pzSetExpandParam_2();
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_3")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzRuleset_ShowRuleSetLockVersion_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2015022306241801033462") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }tools.appendString("[\"doListAction\",[\":event\",\"FLOWACTION\",\"pzRuleSet_PopLockVersion\",{\"noThreadProcess\":\"false\",\"templateName\":\"pyNextGenGridModalTemplate\",\"overrideTemplate\":\"false\"},\"null\",\"false\"]");
		...
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Lock the version and Save\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
		tools.appendString(toolTipVal);
		...
		tools.appendString(" ><div class='pzbtn-rgt'  data-click='...'><div class='pzbtn-mid' ");if(bOptimizedMarkup){tools.appendString("data-bindprops='innerHTML,title' ");}tools.appendString(" data-click='....'>");
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Lock and Save".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		tools.appendString("<span class='pzbtn-label'  data-click='.....' ");}if(bOptimizedMarkup && hasLineBreaks){
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Lock and Save",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString("<img alt='' src='webwb/zblankimage.gif' class='pzbtn-i'/>");
		tools.appendString("</div></div></div></div>");
		tools.appendString("</button>");}pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
		tools.putParamValue("pega_attributes","");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015022306241801033462-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
...
pzSection.getLayout().setExpandParam("SubSectionpzRuleset_ShowRuleSetLockVersionB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzRuleset_ShowRuleSetLockVersionB";
	metadataPage.put("paramName", paramName);
	metadataPage.put("floatClass"," float-right set-width-auto");
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rx.pyVersionSecure cffalse", pxUniqueStreamHash+"_6");metadataPage.put("lMode","Inline-block");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2== rx.pyVersionSecure cffalse",".pyVersionSecure == false", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-RULESET-VERSION PZRULESET_SHOWRULESETLOCKVERSION #20180713T135703.000 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzRuleset_ShowRuleSetLockVersion");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-RULESET-VERSION PZRULESET_SHOWRULESETLOCKVERSION #20180713T135703.000 GMT", "Rule-RuleSet-Version pzRuleset_ShowRuleSetLockVersion", "Pega-SystemArchitect", "08-01-01", "20180713T135703.000 GMT");
}
