...
/**
 * Builds JSP stream @BASECLASS!PZC11NPREVIEWSECTION.
 */
public class ra_stream_pzc11npreviewsection_e99760720bea07473ad1fe2a3faac692 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzC11nPreviewSection.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -224637130;
 ...
 */
	public ra_stream_pzc11npreviewsection_e99760720bea07473ad1fe2a3faac692(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "50b5f82cc46c081bed247e7e0c1a5b4f11746681";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZC11NPREVIEWSECTION #20230618T002048.384 GMT	Pega-EndUserUI:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "50b5f82cc46c081bed247e7e0c1a5b4f11746681";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzC11nPreviewSection",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZC11NPREVIEWSECTION #20230618T002048.384 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZC11NPREVIEWSECTION #20230618T002048.384 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZC11NPREVIEWSECTION #20230618T002048.384 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZC11NPREVIEWSECTION", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZC11NPREVIEWSECTION","Rule-HTML-Section","@BASECLASS",false,"","Pega-EndUserUI","08-23-01","RULE-HTML-SECTION @BASECLASS PZC11NPREVIEWSECTION #20230618T002048.384 GMT","!PZC11NPREVIEWSECTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-224637130), 
...
//	RULE-HTML-SECTION @BASECLASS PZC11NPREVIEWSECTION #20230618T002048.384 GMT:20230618T002048.384 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "1a972be506062e9171e7d4116ea7ef7c";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzC11nPreviewSection",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzC11nPreviewSection','insKey':'RULE-HTML-SECTION @BASECLASS PZC11NPREVIEWSECTION #20230618T002048.384 GMT','sectionType':'standard'}");
pzLayout_1();
...
if (_jspx_meth_pega_param__1(pageContext, "pyC11nCaseClass", ".pzPreviewCaseClassName")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "pyC11nCaseID", ".pzPreviewInsKey")) {
	return true;
}
if (_jspx_meth_pega_param__2(pageContext, "pyC11nActionType", "showCasePreview")) {
	return true;
}
...
public void field_pzConstellationControl_1() { 
...
/*
 * reference tag
 * Cannot inline because: included stream is too big: 16380 bytes
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyTemplateInputBox", "input", "pzConstellationControl")) {
	return;
}
} catch(Throwable t) {
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzConstellationControl",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_3")) {	field_pzConstellationControl_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202304190444410197460-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzConstellationControl");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pzConstellationControl",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")) {	field_pzConstellationControl_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzC11nPreviewSectionB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20230419044441019658") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzC11nPreviewSectionB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzIsThemeCosmosPortal", pxUniqueStreamHash+"_7");metadataPage.put("lMode","SimpleDiv");
...
if(pzAuto.handleEvaluateWhen(" wxpzIsThemeCosmosPortal","pzIsThemeCosmosPortal", "layout", "visible" )) {pzSetExpandParam_1();
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZC11NPREVIEWSECTION #20230618T002048.384 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzC11nPreviewSection");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZC11NPREVIEWSECTION #20230618T002048.384 GMT", "@baseclass pzC11nPreviewSection", "Pega-EndUserUI", "08-23-01", "20230618T002048.384 GMT");
}
