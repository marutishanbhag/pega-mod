...
/**
 * Builds JSP stream DATA-!PZRULEFORMRULESET.
 */
public class ra_stream_pzruleformruleset_c003846c1cae27ca644699b1e851fe1b extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzRuleFormRuleset.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1005883947;
 ...
 */
	public ra_stream_pzruleformruleset_c003846c1cae27ca644699b1e851fe1b(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "e62dbc880bbd3598db4f882a8a3aeeec06b66abe";
...
{
/* Instance RULE-HTML-SECTION DATA- PZRULEFORMRULESET #20180713T135203.631 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "e62dbc880bbd3598db4f882a8a3aeeec06b66abe";
...
/*
 * Begin RULE-HTML-SECTION DATA- PZRULEFORMRULESET #20180713T135203.631 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA- PZRULEFORMRULESET #20180713T135203.631 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA- PZRULEFORMRULESET #20180713T135203.631 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMRULESET","Rule-HTML-Section","DATA-",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION DATA- PZRULEFORMRULESET #20180713T135203.631 GMT","!PZRULEFORMRULESET",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1005883947), 
		new DependentRuleInfo("PYTEMPLATEINPUTBOX","Rule-Obj-Property","@BASECLASS",true,"Data-","Pega-UIDesign","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT","!PYTEMPLATEINPUTBOX",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION DATA- PZRULEFORMRULESET #20180713T135203.631 GMT:20180713T135203.631 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "bc0cfdc8170ff3f76479a25420baa07b";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzRuleFormRuleset",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzRuleFormRuleset','insKey':'RULE-HTML-SECTION DATA- PZRULEFORMRULESET #20180713T135203.631 GMT','sectionType':'standard'}");
pzLayout_2();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_12","pzRuleFormRuleSetEdit", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzRuleFormRuleset356","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_9","pzRuleFormRuleSetEdit", secInfo);
}
...
public void pxTextInput_1() {String key="2||RULE-HTML-SECTION DATA- PZRULEFORMRULESET #20180713T135203.631 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","false","2"};oCellRuntimeParamsMap.put("2||RULE-HTML-SECTION DATA- PZRULEFORMRULESET #20180713T135203.631 GMT",paramValues);oControlPathsMap.put("2||RULE-HTML-SECTION DATA- PZRULEFORMRULESET #20180713T135203.631 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyRuleSetName")+"~#");	tools.appendString("\",\"");
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("201502060227150731513",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzRuleFormRuleset_$CTX$_1");
		String repeatIndx = "";
	...
	String pyLabel = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyRuleSetName");
	pyLabel = ".pyRuleSetName";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzRuleFormRuleset_"+ referenceString+ "_1'";
	 String securedPropValue = null;
	 com.pega.pegarules.pub.security.PropertySecurityInfo propSecInfo = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().getPropertyInfoForDisplay(tools.getStepPage(),tools.getProperty(".pyRuleSetName"), tools);
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		 securedPropValue = tools.getProperty(".pyRuleSetName").getStringValue();
	  }
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("201502060227150731513") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= rx.pyRuleSetName cq",".pyRuleSetName != \'\'","cell", "visible" )) {
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201502060227150731513-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pyRuleSetName cq",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyRuleSetName != ''");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Data-");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pyRuleSetName cq", pxUniqueStreamHash+"_6"); 
	}
...
public int simpleLayoutCell_2( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   workarea_header_secondary_dataLabelRead workarea_header_secondary_dataLabelRead '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item dataValueRead'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("localize","false");
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201502060227150732668-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxTextInput");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired workarea_header_secondary_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("labelReadClass","dataLabelForRead workarea_header_secondary_dataLabelForRead");
	pgCells.put("labelWriteClass","dataLabelForWrite workarea_header_secondary_dataLabelForWrite");
	pgCells.put("customROStyles","workarea_header_secondary_dataLabelRead workarea_header_secondary_dataLabelRead");
	pgCells.put("customRWStyles","workarea_header_secondary_dataLabelWrite workarea_header_secondary_dataLabelWrite");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	pgCells.put("pyReadOnlyWhenCond","readonlyAlways");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyRuleSetName cq",pxUniqueStreamHash+"_8");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyRuleSetName cq", pxUniqueStreamHash+"_8"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextInput",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxTextInput_1();}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA- PZRULEFORMRULESET #20180713T135203.631 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA- PZRULEFORMRULESET #20180713T135203.631 GMT", "Data- pzRuleFormRuleset", "Pega-Desktop", "08-01-01", "20180713T135203.631 GMT");
}
