...
/**
 * Builds JSP stream PEGAACCEL-TASK-BUILDAPPLICATION!PZBUILDAPPLICATIONMODALTEMPLATE.
 */
public class ra_stream_pzbuildapplicationmodaltemplate_f19adc2b109d41519ecac1379245299b extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzBuildApplicationModalTemplate.PegaAccel_Task_BuildApplication.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1229635632;
 ...
 */
	public ra_stream_pzbuildapplicationmodaltemplate_f19adc2b109d41519ecac1379245299b(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "45218f4c8024d44a0afd38ed8f3968cf66aede09";
...
{
/* Instance RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZBUILDAPPLICATIONMODALTEMPLATE #20180713T140850.167 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "45218f4c8024d44a0afd38ed8f3968cf66aede09";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzBuildApplicationModalTemplate",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZBUILDAPPLICATIONMODALTEMPLATE #20180713T140850.167 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZBUILDAPPLICATIONMODALTEMPLATE #20180713T140850.167 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZBUILDAPPLICATIONMODALTEMPLATE #20180713T140850.167 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZBUILDAPPLICATIONMODALTEMPLATE", 
	"Rule-HTML-Property:PXMODALBUTTONSUBMIT", 
	"Rule-HTML-Property:PXMODALBUTTONCANCEL"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZBUILDAPPLICATIONMODALTEMPLATE","Rule-HTML-Section","PEGAACCEL-TASK-BUILDAPPLICATION",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZBUILDAPPLICATIONMODALTEMPLATE #20180713T140850.167 GMT","!PZBUILDAPPLICATIONMODALTEMPLATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1229635632), 
		new DependentRuleInfo("PXMODALBUTTONSUBMIT","Rule-HTML-Property","",false,"","Pega-Gadgets","08-01-01","RULE-HTML-PROPERTY PXMODALBUTTONSUBMIT #20180713T133435.831 GMT","PXMODALBUTTONSUBMIT",true,false,"ABSOLUTE_CLASSLESS",483650496), 
		new DependentRuleInfo("PXMODALBUTTONCANCEL","Rule-HTML-Property","",false,"","Pega-Gadgets","08-01-01","RULE-HTML-PROPERTY PXMODALBUTTONCANCEL #20180713T133435.827 GMT","PXMODALBUTTONCANCEL",true,false,"ABSOLUTE_CLASSLESS",-1307123574)
	};
...
//	RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZBUILDAPPLICATIONMODALTEMPLATE #20180713T140850.167 GMT:20180713T140850.167 GMT
//	RULE-HTML-PROPERTY PXMODALBUTTONCANCEL #20180713T133435.827 GMT:20180713T133435.827 GMT
//	RULE-HTML-PROPERTY PXMODALBUTTONSUBMIT #20180713T133435.831 GMT:20180713T133435.831 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "5cd5c1a7b86ac26cf8db93460a5a48d1";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzBuildApplicationModalTemplate",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzBuildApplicationModalTemplate','insKey':'RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZBUILDAPPLICATIONMODALTEMPLATE #20180713T140850.167 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_5();
...
config.put("pyFunctionName", "doModalAction");
pega.getUIEngine().getUIAction("runScript", config).register();
config = new HashMap<String, String>();
config.put("pyPreDataTransform.pyName", "pzResetAdvancedApplicationSettings");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"doModalAction(pega.u.d.submitModalDlgParam,\\\":event\\\")\"]");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				refreshActionRequest.registerFixedParameter("StreamList", "pzBuildApplicationError|Rule-HTML-Section|:");
				staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
				tools.appendString("[\"refresh\", [\"otherSection\",\"pzBuildApplicationError\", \"\", \"");
		...
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }						tools.appendString("[\"runScript\", [\"doModalAction(pega.u.d.submitModalDlgParam,\\\":event\\\")\"]");
...
public void pxModalButtonSubmit_1() {boolean isDisplayTextWithParam = false;
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20141008160437053510472") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzBuildApplicationModalTemplate_$CTX$_8");
		String repeatIndx = "";
	String pyTooltip = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzBuildApplicationModalTemplate_"+ referenceString+ "_8'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20141008160437053510472") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
...
public int simpleLayoutCell_4( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxModalButtonSubmit",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20141008160437053510472-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20141008160437053510472-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");pxModalButtonSubmit_1();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20141008160437053510472-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxModalButtonSubmit");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxModalButtonSubmit",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxModalButtonSubmit_1();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzBuildApplicationModalTemplateBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	String paramName = "EXPANDEDSubSectionpzBuildApplicationModalTemplateBBBB";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"doModalAction(\\\"\\\",\\\":event\\\")\"]");
		...
		actionRequestD.registerFixedParameter("pyModelName","pzResetAdvancedApplicationSettings");
			String usingPageString = "";
			usingPageString = pzAuto.getUIComponentRuntime().generateActionTokenForPage();
			tools.appendString("[\"runDataTransform\", [\"pzResetAdvancedApplicationSettings\", \"=");
			...
			pzPackageRuntime.packageDataTransform(contextClass, "pzResetAdvancedApplicationSettings");
			}
		...
		tools.appendString("]");isBehaviorAdded = true;
		tools.appendString("]' ");isBehaviorAdded = false;
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }				tools.appendString("[\"runScript\", [\"doModalAction(\\\"\\\",\\\":event\\\")\"]");
...
public void pxModalButtonCancel_1() {boolean isDisplayTextWithParam = false;
String displayTextParamName = "";
String displayTextParamValue = "";
...
try {
	...
	modePage2.put("pyName","pzBuildApplicationModalTemplate_$CTX$_5");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzBuildApplicationModalTemplate_"+ referenceString+ "_5'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2014100816043705347589") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"doModalAction(\\\"\\\",\\\":event\\\")\"]");
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxModalButtonCancel",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("2014100816043705347589-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2014100816043705347589-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");pxModalButtonCancel_1();
tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("format","pxModalButtonCancel");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxModalButtonCancel",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxModalButtonCancel_1();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzBuildApplicationModalTemplateBBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpzBuildApplicationModalTemplateBBB";
	metadataPage.put("paramName", paramName);
...
pzSection.getLayout().setExpandParam("SubSectionpzBuildApplicationModalTemplateBB","",false);
}
...
public void simpleLayout_4() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + " content  auto-width-column layout-content-inline_middle content-inline_middle " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzBuildApplicationModalTemplateBB";
	metadataPage.put("paramName", paramName);
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2== pxparam.includedStreamName cq o2!= pxparam.pyShowFAButtons cttrue", pxUniqueStreamHash+"_22");metadataPage.put("lMode","Inline-block");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2== pxparam.includedStreamName cq o2!= pxparam.pyShowFAButtons cttrue","param.includedStreamName == \'\' && param.pyShowFAButtons != true", "layout", "visible" )) {pzSetExpandParam_3();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
pzSection.getLayout().setExpandParam("SubSectionCellpzBuildApplicationModalTemplate16","",false);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzModalAction",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
pzSection.getLayout().setExpandParam("SubSectionpzBuildApplicationModalTemplateB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzBuildApplicationModalTemplateB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZBUILDAPPLICATIONMODALTEMPLATE #20180713T140850.167 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzBuildApplicationModalTemplate");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZBUILDAPPLICATIONMODALTEMPLATE #20180713T140850.167 GMT", "PegaAccel-Task-BuildApplication pzBuildApplicationModalTemplate", "Pega-ProcessArchitect", "08-01-01", "20180713T140850.167 GMT");
}
