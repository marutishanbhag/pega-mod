...
/**
 * Builds JSP stream RULE-HTML-SECTION!PZSHOWCONFIGUREFORM.
 */
public class ra_stream_pzshowconfigureform_3da211f713541dd4ec10b9eb48fcbd36 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzShowConfigureForm.Rule_HTML_Section.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1625966020;
 ...
 */
	public ra_stream_pzshowconfigureform_3da211f713541dd4ec10b9eb48fcbd36(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a2a64671f2a3f394a2d2a11e73c370f0a33515e4";
...
{
/* Instance RULE-HTML-SECTION RULE-HTML-SECTION PZSHOWCONFIGUREFORM #20180713T140911.322 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "a2a64671f2a3f394a2d2a11e73c370f0a33515e4";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzShowConfigureForm",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-HTML-SECTION PZSHOWCONFIGUREFORM #20180713T140911.322 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-HTML-SECTION PZSHOWCONFIGUREFORM #20180713T140911.322 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-HTML-SECTION PZSHOWCONFIGUREFORM #20180713T140911.322 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZSHOWCONFIGUREFORM"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSHOWCONFIGUREFORM","Rule-HTML-Section","RULE-HTML-SECTION",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION RULE-HTML-SECTION PZSHOWCONFIGUREFORM #20180713T140911.322 GMT","!PZSHOWCONFIGUREFORM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1625966020)
	};
...
//	RULE-HTML-SECTION RULE-HTML-SECTION PZSHOWCONFIGUREFORM #20180713T140911.322 GMT:20180713T140911.322 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "cf4324a9fd9767fdae06747d3f5fe8db";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzShowConfigureForm",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzShowConfigureForm','insKey':'RULE-HTML-SECTION RULE-HTML-SECTION PZSHOWCONFIGUREFORM #20180713T140911.322 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_4();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_16","pzSectionEditingView", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzSectionEditingView"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzShowConfigureForm592","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_13","pzSectionEditingView", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionpzShowConfigureFormBBB","",false);
}
...
public void simpleLayout_2() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + " content  set-width-auto layout-content-inline_middle content-inline_middle advance-config" + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzShowConfigureFormBBB";
	...
	metadataPage.put("sectionIndex","99");
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2== rxStepDetails.pyCategory cqEditInCase o2== rxSectionPage.pyDisplayWarningMessage cqFormStale", pxUniqueStreamHash+"_10");metadataPage.put("dlChild","true");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2== rxStepDetails.pyCategory cqEditInCase o2== rxSectionPage.pyDisplayWarningMessage cqFormStale","StepDetails.pyCategory = \'EditInCase\' && SectionPage.pyDisplayWarningMessage = \'FormStale\'", "layout", "visible" )) {pzSetExpandParam_3();
...
public int simpleLayoutCell_3( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2== rxStepDetails.pyCategory cqEditInCase o2== rxSectionPage.pyDisplayWarningMessage cqFormStale","StepDetails.pyCategory = \'EditInCase\' && SectionPage.pyDisplayWarningMessage = \'FormStale\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing set-width-auto   '  STRING_TYPE='layout' RESERVE_SPACE='false'><div class='content-inner set-width-auto'>");
	pzLayout_2();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing set-width-auto");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rxStepDetails.pyCategory cqEditInCase o2== rxSectionPage.pyDisplayWarningMessage cqFormStale",pxUniqueStreamHash+"_12");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_12");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","StepDetails.pyCategory = 'EditInCase' && SectionPage.pyDisplayWarningMessage = 'FormStale'");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rxStepDetails.pyCategory cqEditInCase o2== rxSectionPage.pyDisplayWarningMessage cqFormStale", pxUniqueStreamHash+"_12"); 
	}
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzSectionEditingView",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzShowConfigureFormBB","",false);
}
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + " content  auto-width-column layout-content-stacked content-stacked clear-bottom-spacing" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","clear-bottom-spacing");
	...
	String paramName = "EXPANDEDSubSectionpzShowConfigureFormBB";
	metadataPage.put("paramName", paramName);
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","standard_dataLabelRead","standard_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("2015071002423105774744") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + "' >");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
...
pzSection.getLayout().setExpandParam("SubSectionpzShowConfigureFormB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  set-width-auto layout-content-inline_middle content-inline_middle left-column-spacing advance-config" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","left-column-spacing advance-config");
		pg_dlmeta.put("class","set-width-auto");
		pg_dlmeta.put("format","inline_middle");
	...
	String paramName = "EXPANDEDSubSectionpzShowConfigureFormB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2== rxStepDetails.pyCategory cqEditFormInCD o2== rxSectionPage.pyDisplayWarningMessage cqFormStale", pxUniqueStreamHash+"_5");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2== rxStepDetails.pyCategory cqEditFormInCD o2== rxSectionPage.pyDisplayWarningMessage cqFormStale","StepDetails.pyCategory = \'EditFormInCD\' && SectionPage.pyDisplayWarningMessage = \'FormStale\'", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-HTML-SECTION PZSHOWCONFIGUREFORM #20180713T140911.322 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzShowConfigureForm");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-HTML-SECTION PZSHOWCONFIGUREFORM #20180713T140911.322 GMT", "Rule-HTML-Section pzShowConfigureForm", "Pega-ProcessArchitect", "08-01-01", "20180713T140911.322 GMT");
}
