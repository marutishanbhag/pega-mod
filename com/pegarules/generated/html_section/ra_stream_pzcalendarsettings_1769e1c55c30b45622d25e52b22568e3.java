...
/**
 * Builds JSP stream DATA-ADMIN-OPERATOR-ID!PZCALENDARSETTINGS.
 */
public class ra_stream_pzcalendarsettings_1769e1c55c30b45622d25e52b22568e3 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzCalendarSettings.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1840227911;
 ...
 */
	public ra_stream_pzcalendarsettings_1769e1c55c30b45622d25e52b22568e3(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "4fdf65ae9e2bb3efd3e1de02617242e14ac493d1";
...
{
/* Instance RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZCALENDARSETTINGS #20180713T135640.875 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "4fdf65ae9e2bb3efd3e1de02617242e14ac493d1";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzCalendarSettings",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZCALENDARSETTINGS #20180713T135640.875 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZCALENDARSETTINGS #20180713T135640.875 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZCALENDARSETTINGS #20180713T135640.875 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZCALENDARSETTINGS", 
	"Rule-Obj-Property:PYCALENDAR", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCALENDARSETTINGS","Rule-HTML-Section","DATA-ADMIN-OPERATOR-ID",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZCALENDARSETTINGS #20180713T135640.875 GMT","!PZCALENDARSETTINGS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1840227911), 
		new DependentRuleInfo("PYCALENDAR","Rule-Obj-Property","DATA-ADMIN-OPERATOR-ID",false,"","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYCALENDAR #20180713T131219.293 GMT","!PYCALENDAR",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
...
//	RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZCALENDARSETTINGS #20180713T135640.875 GMT:20180713T135640.875 GMT
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYCALENDAR #20180713T131219.293 GMT:20180713T131219.293 GMT
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYCALENDAR #20180713T131219.293 GMT:20180713T131219.293 GMT
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYCALENDAR #20180713T131219.293 GMT:20180713T131219.293 GMT
//	RULE-OBJ-PROPERTY DATA-ADMIN-OPERATOR-ID PYCALENDAR #20180713T131219.293 GMT:20180713T131219.293 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE #20180713T131446.065 GMT:20180713T131446.065 GMT
	...
	public static String getFUAContentHash() {
		return "df666d88ac031eab1a1d8f785b9658a4";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzCalendarSettings",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzCalendarSettings','insKey':'RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZCALENDARSETTINGS #20180713T135640.875 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_6();
...
config.put("pzActivity", "pzGetLatestCalendar");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("pxObjClass", "Data-Admin-Calendar");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_22","ScheduledAbsenceSection", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "ScheduledAbsenceSection"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzCalendarSettings90","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_19","ScheduledAbsenceSection", secInfo);
}
...
public int simpleLayoutCell_5( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","ScheduledAbsenceSection",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","ScheduledAbsenceSection",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzCalendarSettingsBBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + " content  layout-content-default content-default " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzCalendarSettingsBBBBB";
	...
	metadataPage.put("sectionIndex","88");
...
public int simpleLayoutCell_4( int index) {
	...
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("20170525045315095922390")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString("Scheduled absences" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20170525045315095922390")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzCalendarSettingsBBBB","",false);
}
...
public void simpleLayout_4() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  layout-content-stacked_with_labels_left content-stacked_with_labels_left " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzCalendarSettingsBBBB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("sectionIndex","85");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	metadataPage.put("dlChild","true");
...
pzSection.getLayout().setExpandParam("SubSectionpzCalendarSettingsBBB","",false);
}
...
public void simpleLayout_5() {
	...
	String paramName = "EXPANDEDSubSectionpzCalendarSettingsBBB";
	metadataPage.put("paramName", paramName);
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzGetLatestCalendar");
		tools.appendString("[\"runActivity\", [\"\", \"CalendarName=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyCalendar")+"~#");		ractParamStr.append(!"".equals(ractParamStr.toString())? ",pyReturnsResponse:false": "pyReturnsResponse:false");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }			tools.appendString("[\"openRuleByKey\",[\"Data-Admin-Calendar\",\"");

		tools.appendString(XMLUtils.encodeString("pyCalendar") + "=");
		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken("LatestCalendar.pyCalendar")+"~#");			tools.appendString("&amp;");

		tools.appendString(XMLUtils.encodeString("pyStartDate") + "=");
		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken("LatestCalendar.pyStartDate")+"~#");			tools.appendString("\",\"");

		tools.appendFormatted("fddd2fc2-ac05-4bdb-b370-5b67c4b3b40e",StreamBuilder.FMT_NORMAL);			tools.appendString("\",\"");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty(".pyCalendar"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty("LatestCalendar.pyCalendar"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty("LatestCalendar.pyStartDate"), -1);
...
try {
	...
	cellPage.put("pyStreamName","pzCalendarSettings");
	cellPage.put("pyCellID","83");
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("201611160622260833464") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzCalendarSettings_"+ referenceString+ "_83'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		String classProp = "";
		 classProp ="iconOpenRule";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("201611160622260833464") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
		...
		tools.appendString("tabindex='0' role='link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" title = 'Open Calendar"+ " "+repeatIndx+"' ");
			tools.appendString(" alt = 'Open Calendar"+ " "+repeatIndx+"' ");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{
			StringBuffer ractURLStr = new StringBuffer();
			StringBuffer ractParamStr = new StringBuffer();
		...
		tools.appendFormatted("636b6a78-21cb-4176-b92c-e791c777d498",StreamBuilder.FMT_NORMAL);				tools.appendString("\",\"");
...
if (_jspx_meth_pega_param__1(pageContext, "CustomQuery", "&pyActivity=Data-Admin-Calendar.getCalendarsOfTimeZone&TimeZone=[pyDefaultTimeZone]")) {
	return true;
}
...
if (_jspx_meth_pega_param__1(pageContext, "TextBoxTooltip", "This Calendar determines the work week and scheduled holidays for this operator")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "DisplayProperty", "pyCalendar")) {
	return true;
}
...
if (_jspx_meth_pega_param__1(pageContext, "Class", "Data-Admin-Calendar")) {
	return true;
}
 ...
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyCalendar", "input", "OpenRuleAdvanced")) {
	return;
}
} catch(Throwable t) {
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyCalendar",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("2016111606222608323157-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyCalendar" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString("Business Calendar</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2016111606222608323157-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyCalendar" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString("Business Calendar</label>");
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2016111606222608323157-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","OpenRuleAdvanced");
	pgCells.put("forLabel",".pyCalendar");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyCalendar",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_7")) {	field_OpenRuleAdvanced_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "Business Calendar";
	pgCells.put("pyLabelValue",labelName);
	String uiFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData();
	if(!"".equals(uiFieldValueMeta)){
	pgCells.put("stopFV",uiFieldValueMeta);
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","standard_dataLabelRead","standard_dataLabelWrite")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("201611160622260833464-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("201611160622260833464-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","remove-all-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201611160622260833464-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzCalendarSettingsBB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + " content  set-width-auto layout-content-inline content-inline " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzCalendarSettingsBB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("sectionIndex","80");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Inline-block");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
...
pzSection.getLayout().setExpandParam("SubSectionpzCalendarSettingsB","",false);
}
...
public void simpleLayout_2() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  auto-width-column layout-content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzCalendarSettingsB";
	metadataPage.put("paramName", paramName);
...
static {
	oPropDefinitions_1.put("Data-Admin-Operator-ID.pyCalendar", new LiteweightPropertyDefinition("Data-Admin-Operator-ID", "pyCalendar", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZCALENDARSETTINGS #20180713T135640.875 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzCalendarSettings");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ID PZCALENDARSETTINGS #20180713T135640.875 GMT", "Data-Admin-Operator-ID pzCalendarSettings", "Pega-SystemArchitect", "08-01-01", "20180713T135640.875 GMT");
}
