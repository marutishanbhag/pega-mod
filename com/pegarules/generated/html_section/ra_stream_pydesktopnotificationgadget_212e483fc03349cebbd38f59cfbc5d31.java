...
/**
 * Builds JSP stream @BASECLASS!PYDESKTOPNOTIFICATIONGADGET.
 */
public class ra_stream_pydesktopnotificationgadget_212e483fc03349cebbd38f59cfbc5d31 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyDesktopNotificationGadget.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -2038673799;
 ...
 */
	public ra_stream_pydesktopnotificationgadget_212e483fc03349cebbd38f59cfbc5d31(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "28b503b4b6f057bde5ab5fb0cfff2dc930ea33d3";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYDESKTOPNOTIFICATIONGADGET #20230618T002045.193 GMT	Pega-EndUserUI:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "28b503b4b6f057bde5ab5fb0cfff2dc930ea33d3";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyDesktopNotificationGadget",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYDESKTOPNOTIFICATIONGADGET #20230618T002045.193 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYDESKTOPNOTIFICATIONGADGET #20230618T002045.193 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYDESKTOPNOTIFICATIONGADGET #20230618T002045.193 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYDESKTOPNOTIFICATIONGADGET", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDESKTOPNOTIFICATIONGADGET","Rule-HTML-Section","@BASECLASS",false,"","Pega-EndUserUI","08-23-01","RULE-HTML-SECTION @BASECLASS PYDESKTOPNOTIFICATIONGADGET #20230618T002045.193 GMT","!PYDESKTOPNOTIFICATIONGADGET",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2038673799), 
...
//	RULE-HTML-SECTION @BASECLASS PYDESKTOPNOTIFICATIONGADGET #20230618T002045.193 GMT:20230618T002045.193 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "fae77e4fba8d0f1ab86c8aa837391d2d";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 ...
 pzSection.includeGadget("PegaGadget-Notifications","<?xml version=\"1.0\"?><pagedata><pyNotificationHeading/><pyCategoryList>Default</pyCategoryList><pxObjClass>PegaGadget-Notifications</pxObjClass><pxCreateOperator>pauls</pxCreateOperator><pxCreateDateTime>20160829T070421.967 GMT</pxCreateDateTime><pxCreateSystemID>pega</pxCreateSystemID><pyNotificationIconSelection>Icon Class</pyNotificationIconSelection><pxCreateOpName>Saikat Paul</pxCreateOpName><pySelected/><pyIconClass/><pyGadgetIconClass>pi pi-bell pi-white</pyGadgetIconClass></pagedata>",1,"{'type':'Section','ruleName':'pyDesktopNotificationGadget','insKey':'RULE-HTML-SECTION @BASECLASS PYDESKTOPNOTIFICATIONGADGET #20230618T002045.193 GMT','sectionType':'standard'}"); 
pzLayout_1();
pzLayout_3();
pzLayout_5();
 pzSection.endGadget(); 
...
public void buildSection_5() { 
	...
	declareParams.put("pyCategoryList","myParamPage.pyCategoryList");
	declareParams.put("recipientOperatorID","OperatorID.pyUserIdentifier");
	secInfo.put("decParamList","{'pyCategoryList':'"+ "#~"+pzAuto.getUIComponentRuntime().generateActionToken(tools.getProperty("myParamPage.pyCategoryList").getReference())+"~#" +"','recipientOperatorID':'"+ "#~"+pzAuto.getUIComponentRuntime().generateActionToken(tools.getProperty("OperatorID.pyUserIdentifier").getReference())+"~#" +"'}");
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  "myParamPage.pyCategoryList Changes || OperatorID.pyUserIdentifier Changes", expressionId);
		if(!StringUtils.isBlank(expressionId)) {
			secInfo.put("pyExpressionId", expressionId);
		}
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_46","pyUnreadNotificationsCount", secInfo);
	}
...
public void sectionBodyIncludeInCell_4() { 
	...
	"pyUnreadNotificationsCount", "D_pyGetNotificationsCountForOperator","");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	generateClientWhenDiv_5();
	
	{tools.putParamValue("pyCategoryList",tools.getProperty("myParamPage.pyCategoryList").getStringValue());tools.putParamValue("recipientOperatorID",tools.getProperty("OperatorID.pyUserIdentifier").getStringValue());tools.putParamValue("decParamList","{'pyCategoryList':'"+ "#~"+pzAuto.getUIComponentRuntime().generateActionToken("myParamPage.pyCategoryList")+"~#" +"','recipientOperatorID':'"+ "#~"+pzAuto.getUIComponentRuntime().generateActionToken("OperatorID.pyUserIdentifier")+"~#" +"'}");tools.putParamValue("sectionPageNameBase","D_pyGetNotificationsCountForOperator");}try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));	ct_controlAction.trackValueChanges(tools.getProperty("myParamPage.pyCategoryList"), -1);	ct_controlAction.trackValueChanges(tools.getProperty("OperatorID.pyUserIdentifier"), -1);}}catch(Exception e){}
	...
	String sectionName = "pyUnreadNotificationsCount"; 
	String usingPage = null;
	usingPage = "D_pyGetNotificationsCountForOperator";
...
pzSection.getLayout().setExpandParam("SubSectionCellpyDesktopNotificationGadget752","",false);
}
...
public void buildSection_4() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_42","pyUnreadNotificationsCount", secInfo);
	}
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2016082902530604545164",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pyDesktopNotificationGadget_$CTX$_8");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Notification Gadget tool tip\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Notification Gadget tool tip", ".pyActionPrompt");
	}
	pyTooltip = "Notification Gadget tool tip";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","tooltip");
	modePage2.put("imgSrc","styleclass");
	modePage2.put("image","pi pi-bell pi-white");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyDesktopNotificationGadget_"+ referenceString+ "_8'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2016082902530604545164") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Notification Gadget tool tip\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
		tools.appendString(toolTipVal);tools.appendString(" class='");tools.appendString("'");
		tools.appendString(" >");
		String classProp = "";
		 classProp ="pi pi-bell pi-white";
...
try {
	...
	modePage2.put("pyName","pyDesktopNotificationGadget_$CTX$_7");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
	...
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","tooltip");
	modePage2.put("imgSrc","property");
	String pyImageR = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty("myParamPage.pyIconClass");
	pyImageR = "myParamPage.pyIconClass";
	...
	String pyFormatValue = "";
	modePage2.put("pyFormatValue",pyFormatValue);
	String spxUniqueStreamHash33 = getUIActionsMetaData_2();
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDesktopNotificationGadget_"+ referenceString+ "_7'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2016082902530604545164") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
			String repeatIndx = "";if(bOptimizedMarkup){
		...
		tools.appendString(toolTipVal);tools.appendString(" class='");tools.appendString("'");
		tools.appendString(" >");
		tools.appendString("<img alt='"+toolTipVal+"' aria-hidden='true' src='");tools.appendCSF(tools.getProperty("myParamPage.pyIconClass").getStringValue());
	tools.appendString("'  class='pzbtn-img'/> ");
		boolean hasLineBreaks = false;
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString("</a>");}
...
try {
	...
	modePage2.put("pyName","pyDesktopNotificationGadget_$CTX$_6");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
	...
	modePage2.put("imgSrc","styleclass");
	String pyImageR = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty("myParamPage.pyGadgetIconClass");
	pyImageR = "myParamPage.pyGadgetIconClass";
	modePage2.put("image",pyImageR);
	modePage2.put("actionImgPos","left");
	String customStyles = null;
	String pyLabel = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDesktopNotificationGadget_"+ referenceString+ "_6'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2016082902530604545164") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
			String repeatIndx = "";if(bOptimizedMarkup){
		...
		tools.appendString(" >");
		String classProp = "";
		classProp = tools.getProperty("myParamPage.pyGadgetIconClass").getStringValue();
		tools.appendString("<i aria-hidden='true'  class='" + classProp + "'></i>");
		boolean hasLineBreaks = false;
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString("</a>");}
...
public int simpleLayoutCell_5( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","no-margin","no-margin")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  "myParamPage.pyGadgetIconClass!=''&& myParamPage.pyNotificationIconSelection=='Icon Class'", expressionId);
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2016082902530604545164-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxLink");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("customROStyles","no-margin");
	pgCells.put("customRWStyles","no-margin");
...
public int simpleLayoutCell_6( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","no-margin","no-margin")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  "myParamPage.pyIconClass!=''&& myParamPage.pyNotificationIconSelection=='Simple Image'", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
	String dataFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
...
public int simpleLayoutCell_7( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","no-margin","no-margin")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  "myParamPage.pyNotificationIconSelection==''", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
	String dataFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_6();labelName = "";
...
public int simpleLayoutCell_8( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyUnreadNotificationsCount",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyUnreadNotificationsCount",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyDesktopNotificationGadgetBBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201911290418590147307") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3)'}") + " class='" + " content  set-width-auto pointer  layout-content-mimic_a_sentence content-mimic_a_sentence notification-gadget-mobile clearfix" + "'  ");
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{
			...
			ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzInvalidateNotificationsForOperator");
			tools.appendString("[\"runActivity\", [\"\", \"recipientOperatorID=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken("OperatorID.pyUserIdentifier")+"~#");			ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"pyCategoryList\":\"").append(pega_uiengine_pzcontrol.pzURLEncodeString(tools.getParamValue(pzAuto.getUIComponentRuntime().generateActionToken("param.pyCategoryList")))).append("\"");
			ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"pyNotificationHeading\":\"").append(pega_uiengine_pzcontrol.pzURLEncodeString(tools.getParamValue(pzAuto.getUIComponentRuntime().generateActionToken("param.pyNotificationHeading")))).append("\"");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }				{
					...
					keyMap.putString("pyActionName", "pyDisplayNotificationGadgetDetails");
					String strLAClassName = "";
					String offlineUsingPage = "TempNotificationPage";
					...
					if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
					pzPackageRuntime.packageLocalAction("pyDisplayNotificationGadgetDetails", offlineUsingPage , strLAClassName);
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }							{
								StringBuffer ractURLStr = new StringBuffer();
								StringBuffer ractParamStr = new StringBuffer();
								ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzQueueForNotificationReadStatus");
								tools.appendString("[\"runActivity\", [\"\", \"recipientOperatorID=");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }										{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
											com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
												...
												refreshActionRequest.registerFixedParameter("StreamList", "pyUnreadNotificationsCount|Rule-HTML-Section|:");
												staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
												tools.appendString("[\"refresh\", [\"otherSection\",\"pyUnreadNotificationsCount\", \"\", \"");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty("OperatorID.pyUserIdentifier"), -1);
														...
														pg_dlmeta.put("customClassName","notification-gadget-mobile");
													...
													String paramName = "EXPANDEDSubSectionpyDesktopNotificationGadgetBBB";
													...
													boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpyIsMobile", pxUniqueStreamHash+"_48");metadataPage.put("lMode","Inline-block");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpyIsMobile","pyIsMobile", "layout", "visible" )) {pzSetExpandParam_4();
...
public void buildSection_3() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_23","pyUnreadNotificationsCount", secInfo);
	}
...
pzSection.getLayout().setExpandParam("SubSectionCellpyDesktopNotificationGadget357","",false);
}
...
if(currentTemplatingStatus =='N'){
try {
tools.appendString(" data-dprw=\"myParamPage.pyCategoryList Changes || OperatorID.pyUserIdentifier Changes\" ");
} catch(Throwable t) {
...
public void buildSection_2() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_19","pyUnreadNotificationsCount", secInfo);
	}
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyNotificationIconSelection\"  SHOW_WHEN=\"myParamPage.pyNotificationIconSelection==''\"");
if(pzAuto.evaluateWhen("myParamPage.pyNotificationIconSelection==''",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges("myParamPage.pyNotificationIconSelection", -1);
	}
}catch(Exception e){}
}
...
try {
	...
	modePage2.put("pyName","pyDesktopNotificationGadget_$CTX$_3");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDesktopNotificationGadget_"+ referenceString+ "_3'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2016082902530604545164") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
			String repeatIndx = "";if(bOptimizedMarkup){
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyNotificationIconSelection,.pyIconClass\"  SHOW_WHEN=\"myParamPage.pyIconClass!=''&& myParamPage.pyNotificationIconSelection=='Simple Image'\"");
if(pzAuto.evaluateWhen("myParamPage.pyIconClass!=''&& myParamPage.pyNotificationIconSelection=='Simple Image'",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges("myParamPage.pyNotificationIconSelection", -1);
		changeTracker.trackValueChanges("myParamPage.pyIconClass", -1);
	}
}catch(Exception e){}
}
...
try {
	...
	modePage2.put("pyName","pyDesktopNotificationGadget_$CTX$_2");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDesktopNotificationGadget_"+ referenceString+ "_2'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2016082902530604545164") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
			String repeatIndx = "";if(bOptimizedMarkup){
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyNotificationIconSelection,.pyGadgetIconClass\"  SHOW_WHEN=\"myParamPage.pyGadgetIconClass!=''&& myParamPage.pyNotificationIconSelection=='Icon Class'\"");
if(pzAuto.evaluateWhen("myParamPage.pyGadgetIconClass!=''&& myParamPage.pyNotificationIconSelection=='Icon Class'",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges("myParamPage.pyGadgetIconClass", -1);
		changeTracker.trackValueChanges("myParamPage.pyNotificationIconSelection", -1);
	}
}catch(Exception e){}
}
...
try {
	...
	modePage2.put("pyName","pyDesktopNotificationGadget_$CTX$_1");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDesktopNotificationGadget_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2016082902530604545164") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
			String repeatIndx = "";if(bOptimizedMarkup){
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","notification-icon-count","notification-icon-count")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("customROStyles","notification-icon-count");
	pgCells.put("customRWStyles","notification-icon-count");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_2();labelName = "";
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_3();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_3();labelName = "";
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_4();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyUnreadNotificationsCount",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyUnreadNotificationsCount",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyDesktopNotificationGadgetBB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201911290418590145977") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + " content  pointer  layout-content-mimic_a_sentence content-mimic_a_sentence notification-gadget clearfix" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty("OperatorID.pyUserIdentifier"), -1);
														...
														if(!"".equals(strMethodName))
														pg_dlmeta.put("methodnm",strMethodName);
														pg_dlmeta.put("customClassName","notification-gadget");
														pg_dlmeta.put("class","pointer  clearfix");
														pg_dlmeta.put("format","mimic_a_sentence");
													...
													String paramName = "EXPANDEDSubSectionpyDesktopNotificationGadgetBB";
													metadataPage.put("paramName", paramName);
													...
													IUIComponent containerComponent = pzAuto.getUIComponent();
													com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
													boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpyIsMobile", pxUniqueStreamHash+"_25");metadataPage.put("lMode","Inline-block");
													IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpyIsMobile","!pyIsMobile", "layout", "visible" )) {pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_1() { 
	...
	secParams.put("paramForOverlay","myParamPage.pyNotificationHeading");
	secParams.put("paramToSet","myParamPage.pyCategoryList");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_2","pzSetCategoryListParam", secInfo);
}
...
config.put("pzActivity", "pzInvalidateNotificationsForOperator");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("ActionSection", "pyOverlayTemplate");
config.put("NewTaskStatus", "pyDisplayNotificationGadgetDetails");
pega.getUIEngine().getUIAction("localAction", config).register();
config = new HashMap<String, String>();
config.put("pzActivity", "pzQueueForNotificationReadStatus");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
...
public void includeSectionBody_1() { 
	...
	String strSectionPageProp = "";
	if(tools.getIfPresent("myParamPage.pyNotificationHeading") != null){tools.putParamValue("paramForOverlay",tools.getIfPresent("myParamPage.pyNotificationHeading").getStringValue());}else{tools.putParamValue("paramForOverlay","myParamPage.pyNotificationHeading");}if(tools.getIfPresent("myParamPage.pyCategoryList") != null){tools.putParamValue("paramToSet",tools.getIfPresent("myParamPage.pyCategoryList").getStringValue());}else{tools.putParamValue("paramToSet","myParamPage.pyCategoryList");}
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty("myParamPage.pyNotificationHeading"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty("myParamPage.pyCategoryList"), -1);
		}}catch(Exception e){}tools.putParamValue("section_params","");
	
	String includedSectionName = "";includedSectionName = "pzSetCategoryListParam";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpyDesktopNotificationGadgetB","",false);
}
...
String paramName = "EXPANDEDSubSectionpyDesktopNotificationGadgetB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzSetCategoryListParam'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzSetCategoryListParam'}") + ">");
}
pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYDESKTOPNOTIFICATIONGADGET #20230618T002045.193 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyDesktopNotificationGadget");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYDESKTOPNOTIFICATIONGADGET #20230618T002045.193 GMT", "@baseclass pyDesktopNotificationGadget", "Pega-EndUserUI", "08-23-01", "20230618T002045.193 GMT");
}
