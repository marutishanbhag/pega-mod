...
/**
 * Builds JSP stream @BASECLASS!PZRULEFORMRULESETEDIT.
 */
public class ra_stream_pzruleformrulesetedit_4bb1a34dfe011749cbe87fd5a75e96b2 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzRuleFormRuleSetEdit.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 657805992;
 ...
 */
	public ra_stream_pzruleformrulesetedit_4bb1a34dfe011749cbe87fd5a75e96b2(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "ae66b5b4856ae44ab99f578a1f7e8f44623cd51d";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZRULEFORMRULESETEDIT #20180713T135138.642 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "ae66b5b4856ae44ab99f578a1f7e8f44623cd51d";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzRuleFormRulesetEdit",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZRULEFORMRULESETEDIT #20180713T135138.642 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZRULEFORMRULESETEDIT #20180713T135138.642 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZRULEFORMRULESETEDIT #20180713T135138.642 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZRULEFORMRULESETEDIT", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMRULESETEDIT","Rule-HTML-Section","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION @BASECLASS PZRULEFORMRULESETEDIT #20180713T135138.642 GMT","!PZRULEFORMRULESETEDIT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",657805992), 
...
//	RULE-HTML-SECTION @BASECLASS PZRULEFORMRULESETEDIT #20180713T135138.642 GMT:20180713T135138.642 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "351a0e4d15c145ec77b0cb9bac1665e6";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzRuleFormRulesetEdit",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzRuleFormRulesetEdit','insKey':'RULE-HTML-SECTION @BASECLASS PZRULEFORMRULESETEDIT #20180713T135138.642 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("NewTaskStatus", "pzRuleFormRulesetEditFA");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		keyMap.putString("pyActionName", "pzRuleFormRulesetEditFA");
		...
		try{
		pzPackageRuntime.packageLocalAction("pzRuleFormRulesetEditFA", offlineUsingPage , strLAClassName);
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("pzRuleFormRulesetEdit",
				...
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pzRuleFormRulesetEditFA\",\"overlay\",\":event\",\"\",\""+streamType+"\",\"\",\"\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-null%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22effect%22%3A%22anim-null%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
					} else {
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015020602234202583105",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzRuleFormRulesetEdit_$CTX$_1");
		String repeatIndx = "";
	modePage2.put("styles","workarea_header_secondary");
	String pyTooltip = "";
	pyTooltip = "Edit the associated Ruleset used for packaging";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzRuleFormRulesetEdit_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015020602234202583105") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("  title= '");
		 toolTipVal = "Edit the associated Ruleset used for packaging";
		tools.appendString(toolTipVal);
		tools.appendString("'");tools.appendString(" class='workarea_header_secondary");tools.appendString("'");
		tools.appendString(" >");
		boolean hasLineBreaks = false; checkForScriptTags_1("[Edit]"); 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item dataValueRead'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015020602234202583105-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzRuleFormRulesetEditB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzRuleFormRulesetEditB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZRULEFORMRULESETEDIT #20180713T135138.642 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzRuleFormRulesetEdit");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZRULEFORMRULESETEDIT #20180713T135138.642 GMT", "@baseclass pzRuleFormRulesetEdit", "Pega-Desktop", "08-01-01", "20180713T135138.642 GMT");
}
