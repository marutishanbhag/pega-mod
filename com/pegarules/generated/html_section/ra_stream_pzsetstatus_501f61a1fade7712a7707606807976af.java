...
/**
 * Builds JSP stream DATA-MO-ACTIVITY-ASSIGNMENT!PZSETSTATUS.
 */
public class ra_stream_pzsetstatus_501f61a1fade7712a7707606807976af extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSetStatus.Data_MO_Activity_Assignment_WorkAction.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -934181935;
 ...
 */
	public ra_stream_pzsetstatus_501f61a1fade7712a7707606807976af(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "240efd48d2d08f24dbf8e1aff16581d47ab3b8b8";
...
{
/* Instance RULE-HTML-SECTION DATA-MO-ACTIVITY-ASSIGNMENT PZSETSTATUS #20190206T051502.811 GMT	Pega-ProcessArchitect:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "240efd48d2d08f24dbf8e1aff16581d47ab3b8b8";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSetStatus",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-MO-ACTIVITY-ASSIGNMENT PZSETSTATUS #20190206T051502.811 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-MO-ACTIVITY-ASSIGNMENT PZSETSTATUS #20190206T051502.811 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-MO-ACTIVITY-ASSIGNMENT PZSETSTATUS #20190206T051502.811 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZSETSTATUS", 
	"Rule-Obj-Property:PYWORKSTATUS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSETSTATUS","Rule-HTML-Section","DATA-MO-ACTIVITY-ASSIGNMENT",false,"","Pega-ProcessArchitect","08-03-01","RULE-HTML-SECTION DATA-MO-ACTIVITY-ASSIGNMENT PZSETSTATUS #20190206T051502.811 GMT","!PZSETSTATUS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-934181935), 
		new DependentRuleInfo("PYWORKSTATUS","Rule-Obj-Property","DATA-MO",false,"","Pega-ProcessArchitect","08-05-01","RULE-OBJ-PROPERTY DATA-MO PYWORKSTATUS #20200511T061104.257 GMT","!PYWORKSTATUS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0)
	};
...
//	RULE-HTML-SECTION DATA-MO-ACTIVITY-ASSIGNMENT PZSETSTATUS #20190206T051502.811 GMT:20190206T051502.811 GMT
//	RULE-OBJ-PROPERTY DATA-MO PYWORKSTATUS #20200511T061104.257 GMT:20200511T061104.257 GMT
//	RULE-OBJ-PROPERTY DATA-MO PYWORKSTATUS #20200511T061104.257 GMT:20200511T061104.257 GMT
//	RULE-OBJ-PROPERTY DATA-MO PYWORKSTATUS #20200511T061104.257 GMT:20200511T061104.257 GMT
//	RULE-OBJ-PROPERTY DATA-MO PYWORKSTATUS #20200511T061104.257 GMT:20200511T061104.257 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "9b3a8504072106f23c8002fe3fd79130";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSetStatus",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSetStatus','insKey':'RULE-HTML-SECTION DATA-MO-ACTIVITY-ASSIGNMENT PZSETSTATUS #20190206T051502.811 GMT','sectionType':'standard'}");
...
getControlMarkup_1() {
try {
if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyWorkStatus").getEntryHandle())){

/*
 * reference tag
 * Cannot inline because: included stream is too big: 38240 bytes
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyWorkStatus", "input", "OpenRuleAdvanced")) {
	return;
}
}
} catch(Throwable t) {
...
if (_jspx_meth_pega_param__1(pageContext, "OtherKeyValuePairs", "pyFieldName=\'pyStatusWork\' pyFieldValue=\'[pyWorkStatus]\'")) {
	return true;
}
...
tools.putSaveValue("attributes", " PN =.pyWorkStatus ONCHANGE= \"handleClientEvent(\'POSTCELL\', \'\',\'\' ");
...
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2019010309150200224346") + "  ");
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead RLF RLF_property_panel_single","dataLabelWrite RLF RLF_property_panel_single"), "",false,"","");labelIncludeInCell_1("","","","",false,"Work status",false,false,"Standard",false);
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyWorkStatus",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)")," data-post   ",pzSection.getCustomStyle(false,"","dataValueRead RVF RVF_property_panel_single ","dataValueWrite RVF RVF_property_panel_single "), "",false,"","");tools.putSaveValue("parentLayouttype","");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_3")) {field_OpenRuleAdvanced_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent(); pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>");
 } 
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzSetStatusB","",false);
}
...
static {
	oPropDefinitions_1.put("Data-MO-Activity-Assignment-WorkAction.pyWorkStatus", new LiteweightPropertyDefinition("Data-MO-Activity-Assignment-WorkAction", "pyWorkStatus", "sTN", false, true, "pxTextInput", false));
}
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Data-MO-Activity-Assignment");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-MO-ACTIVITY-ASSIGNMENT PZSETSTATUS #20190206T051502.811 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzSetStatus");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-MO-ACTIVITY-ASSIGNMENT PZSETSTATUS #20190206T051502.811 GMT", "Data-MO-Activity-Assignment pzSetStatus", "Pega-ProcessArchitect", "08-03-01", "20190206T051502.811 GMT");
}
