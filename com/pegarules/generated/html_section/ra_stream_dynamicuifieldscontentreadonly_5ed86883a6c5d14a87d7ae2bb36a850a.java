...
/**
 * Builds JSP stream @BASECLASS!DYNAMICUIFIELDSCONTENTREADONLY.
 */
public class ra_stream_dynamicuifieldscontentreadonly_5ed86883a6c5d14a87d7ae2bb36a850a extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.DynamicUIFieldsContentReadOnly.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -197474961;
 ...
 */
	public ra_stream_dynamicuifieldscontentreadonly_5ed86883a6c5d14a87d7ae2bb36a850a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "581a1c2678b529f3594417408fd0b77d57c5698";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS DYNAMICUIFIELDSCONTENTREADONLY #20210506T204027.307 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "581a1c2678b529f3594417408fd0b77d57c5698";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("DynamicUIFieldsContentReadOnly",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS DYNAMICUIFIELDSCONTENTREADONLY #20210506T204027.307 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS DYNAMICUIFIELDSCONTENTREADONLY #20210506T204027.307 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS DYNAMICUIFIELDSCONTENTREADONLY #20210506T204027.307 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:DYNAMICUIFIELDSCONTENTREADONLY"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("DYNAMICUIFIELDSCONTENTREADONLY","Rule-HTML-Section","@BASECLASS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION @BASECLASS DYNAMICUIFIELDSCONTENTREADONLY #20210506T204027.307 GMT","!DYNAMICUIFIELDSCONTENTREADONLY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-197474961)
	};
...
//	RULE-HTML-SECTION @BASECLASS DYNAMICUIFIELDSCONTENTREADONLY #20210506T204027.307 GMT:20210506T204027.307 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "38fb8731f5d489fa7f9d144d8f0d81f6";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("DynamicUIFieldsContentReadOnly",1,"Rule-HTML-Section","{'type':'Section','ruleName':'DynamicUIFieldsContentReadOnly','insKey':'RULE-HTML-SECTION @BASECLASS DYNAMICUIFIELDSCONTENTREADONLY #20210506T204027.307 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_3();
...
config.put("pySectionName", "DynamicUIFieldsContentReadOnly");
...
public int simpleLayoutCell_2( int index) {
	...
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("202001031548310659182")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() !='N' ){
	labelName = "Casedoesnothavefieldvalues"+"\t"+"^~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyLabel")+"~^";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	}else{
	tools.appendString(tools.getLocalizedTextForString(".pyCaption","Casedoesnothavefieldvalues"+"\t"+tools.getProperty(".pyLabel").getStringValue()));
	}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202001031548310659182")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionDynamicUIFieldsContentReadOnlyBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201807191141480960461") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		pg_dlmeta.put("class","clear-floated-layouts");
	...
	String paramName = "EXPANDEDSubSectionDynamicUIFieldsContentReadOnlyBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpzHasDynamicFields", pxUniqueStreamHash+"_13");metadataPage.put("lMode","SimpleDiv");
...
if(pzAuto.handleEvaluateWhen(" o1! wxpzHasDynamicFields","!pzHasDynamicFields", "layout", "visible" )) {pzSetExpandParam_3();
...
public void getNextPage_1(String listSource, int listStartIndex, int listEndIndex) {
	...
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201807191141480943437" ) + "");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_5","DynamicUI", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellDynamicUIFieldsContentReadOnly530","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.READ_ONLY, true);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_2","DynamicUI", secInfo);
}
...
public int simpleLayoutCell_1(  int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","DynamicUI",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   text-word-break-all flex flex-row ' ");
	...
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201807191141480943437-" + rowTestID) + " ");
	}else {
	...
	pgCells.put("customROStyles","text-word-break-all");
	pgCells.put("customRWStyles","text-word-break-all");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","DynamicUI",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
String pyInstanceId ="";
char mode = tools.getProperty(".pyFields").getMode();
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  ".pyFields AddDelete", expressionId, true);
expressionId = expression.getId();
}
ClipboardProperty rdlPageListProp = tools.getProperty(".pyFields");
String rdlPageListPropRef = ".pyFields";
if(rdlPageListProp != null) {
rdlPageListPropRef = rdlPageListProp.getReference();
}
String rdlRefreshWhenStr = ".pyFields AddDelete";
rdlRefreshWhenStr = rdlRefreshWhenStr.replace(".pyFields",rdlPageListPropRef);
if(!StringUtils.isBlank(expressionId)) {
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyFields").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
} else {
pgSectionBody.put("pageListProp", ".pyFields");
}
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pzPackageRuntime.packageProperty(tools.getProperty(".pyFields").getReference(), null);
}
...
pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201807191141480943437" ) + "");
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyFields").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyFields").getReference(),"", false),pyInstanceId);
}
tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
ClipboardProperty cpSource = tools.getProperty(".pyFields");
...
dummyPageName = "Dummy_pyFields";
}
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyFields").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
itemPage = tools.createPage("Embed-Fields",dummyPageName);
PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
simpleLayoutCell_1(1);
	pega.popStackFrame(itemFrame, false);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyFields").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
}
}else{
if(mode =='L' || mode =='G'){
Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyFields").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyFields").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("DynamicUIFieldsContentReadOnly",
...
pzSection.getLayout().setExpandParam("SubSectionDynamicUIFieldsContentReadOnlyB","",false);
}
...
public void simpleLayout_1() {
	...
	tools.appendString(tools.getProperty(".pyFields").getReference()+ "' ");
	tools.appendString(" " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(1)'}") + "  class=' flex content   layout-content-simple_list content-simple_list  ' ");
	String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
	ClipboardProperty rdlPageListProperty = tools.getProperty(".pyFields");
	String rdlPageListPropRef = ".pyFields";
...
try {
tools.appendString("RWP=\".pyFields\" RW=\"");
tools.appendString(rdlRefreshWhenStr);
tools.appendString("\"");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
	tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201807191141480943437" ) + " ");
	tools.appendString(">");
	int index = 1;
	...
	rdlPageListProp = tools.getProperty(".pyFields");
...
String paramName = "EXPANDEDSubSectionDynamicUIFieldsContentReadOnlyB";
...
IUIComponent containerComponent = pzAuto.getUIComponent();
com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzHasDynamicFields", pxUniqueStreamHash+"_9");metadataPage.put("lMode","SimpleDiv");
IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzHasDynamicFields","pzHasDynamicFields", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS DYNAMICUIFIELDSCONTENTREADONLY #20210506T204027.307 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "DynamicUIFieldsContentReadOnly");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS DYNAMICUIFIELDSCONTENTREADONLY #20210506T204027.307 GMT", "@baseclass DynamicUIFieldsContentReadOnly", "Theme-Cosmos", "04-01-01", "20210506T204027.307 GMT");
}
