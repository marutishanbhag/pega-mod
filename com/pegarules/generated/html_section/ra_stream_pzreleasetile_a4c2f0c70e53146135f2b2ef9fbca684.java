...
/**
 * Builds JSP stream EMBED-!PZRELEASETILE.
 */
public class ra_stream_pzreleasetile_a4c2f0c70e53146135f2b2ef9fbca684 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzReleaseTile.Embed_CaseChannel.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1272389325;
 ...
 */
	public ra_stream_pzreleasetile_a4c2f0c70e53146135f2b2ef9fbca684(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "f1ee561018c40f6d7e8160ce3db799a502680d38";
...
{
/* Instance RULE-HTML-SECTION EMBED- PZRELEASETILE #20191114T170959.738 GMT	Pega-AppDefinition:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "f1ee561018c40f6d7e8160ce3db799a502680d38";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzReleaseTile",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED- PZRELEASETILE #20191114T170959.738 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED- PZRELEASETILE #20191114T170959.738 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED- PZRELEASETILE #20191114T170959.738 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZRELEASETILE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRELEASETILE","Rule-HTML-Section","EMBED-",false,"","Pega-AppDefinition","08-04-01","RULE-HTML-SECTION EMBED- PZRELEASETILE #20191114T170959.738 GMT","!PZRELEASETILE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1272389325)
	};
...
//	RULE-HTML-SECTION EMBED- PZRELEASETILE #20191114T170959.738 GMT:20191114T170959.738 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "9a93d20231b7e3191ef6faee4fa0907e";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzReleaseTile",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzReleaseTile','insKey':'RULE-HTML-SECTION EMBED- PZRELEASETILE #20191114T170959.738 GMT','sectionType':'standard'}");
pzLayout_2();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzRelease", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzReleaseTile227","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzRelease", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzRelease",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzRelease",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzReleaseTileB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzReleaseTileB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED- PZRELEASETILE #20191114T170959.738 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzReleaseTile");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED- PZRELEASETILE #20191114T170959.738 GMT", "Embed- pzReleaseTile", "Pega-AppDefinition", "08-04-01", "20191114T170959.738 GMT");
}
