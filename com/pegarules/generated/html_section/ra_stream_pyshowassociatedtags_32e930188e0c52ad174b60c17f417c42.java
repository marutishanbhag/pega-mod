...
/**
 * Builds JSP stream WORK-!PYSHOWASSOCIATEDTAGS.
 */
public class ra_stream_pyshowassociatedtags_32e930188e0c52ad174b60c17f417c42 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyShowAssociatedTags.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1044972209;
 ...
 */
	public ra_stream_pyshowassociatedtags_32e930188e0c52ad174b60c17f417c42(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "1d46fb27e8a48364d346db94b01d23e5f13185e1";
...
{
/* Instance RULE-HTML-SECTION WORK- PYSHOWASSOCIATEDTAGS #20210506T204030.010 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "1d46fb27e8a48364d346db94b01d23e5f13185e1";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyShowAssociatedTags",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- PYSHOWASSOCIATEDTAGS #20210506T204030.010 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PYSHOWASSOCIATEDTAGS #20210506T204030.010 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PYSHOWASSOCIATEDTAGS #20210506T204030.010 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYSHOWASSOCIATEDTAGS", 
	"Rule-Obj-Property:TAGSCOUNT", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYSHOWASSOCIATEDTAGS","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION WORK- PYSHOWASSOCIATEDTAGS #20210506T204030.010 GMT","!PYSHOWASSOCIATEDTAGS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1044972209), 
		new DependentRuleInfo("TAGSCOUNT","Rule-Obj-Property","WORK-",true,"Work-","Theme-Cosmos","04-01-01","RULE-OBJ-PROPERTY WORK- TAGSCOUNT #20210506T204032.974 GMT","!TAGSCOUNT",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION WORK- PYSHOWASSOCIATEDTAGS #20210506T204030.010 GMT:20220701T080202.694 GMT
//	RULE-HTML-PROPERTY PXDISPLAYTEXT #20190131T183501.550 GMT:20190131T183501.550 GMT
//	RULE-OBJ-PROPERTY WORK- TAGSCOUNT #20210506T204032.974 GMT:20210506T204032.974 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "e03bc3841253a5a42415acade993d9b6";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyShowAssociatedTags",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyShowAssociatedTags','insKey':'RULE-HTML-SECTION WORK- PYSHOWASSOCIATEDTAGS #20210506T204030.010 GMT','sectionType':'standard'}");
pzLayout_3();
...
config.put("pySectionName", "pyShowAssociatedTags");
...
public void getNextPage_1(String listSource, int listStartIndex, int listEndIndex) {
	...
	nextPageMetadata.put("datasrcid",pxUniqueStreamHash+"_16");
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201907080305060808932" ) + "");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_12","pyShowTags", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpyShowAssociatedTags936","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_9","pyShowTags", secInfo);
}
...
public int simpleLayoutCell_2(  int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyShowTags",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-bottom-spacing    " + pzSection.getCustomStyle(false, "","min-height-0 height-auto","min-height-0 height-auto")  + " flex flex-row ' ");
	...
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201907080305060808932-" + rowTestID) + " ");
	}else {
	...
	pgCells.put("customROStyles","min-height-0 height-auto");
	pgCells.put("customRWStyles","min-height-0 height-auto");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyShowTags",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
String pyInstanceId ="";
char mode = tools.getProperty("D_pxGetAssociatedTags.pxResults").getMode();
...
ClipboardPage dummyPage = tools.createPage("Link-Tag","NoDataPage");
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_13","UtilityNoResultsMessage", RDLNoRowMessageSectionParams);
...
pgSection.put("class","content    flex  layout-content-inline content-inline "); 
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  "D_pxGetAssociatedTags.pxResults AddDelete", expressionId, true);
expressionId = expression.getId();
}
if(StringUtils.isBlank(expressionId)) {
	expressionId = pxUniqueStreamHash+"_15";
}
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pzInsKey!=''",expressionId);
	ClipboardProperty rdlPageListProp = tools.getProperty("D_pxGetAssociatedTags.pxResults");
	String rdlPageListPropRef = "D_pxGetAssociatedTags.pxResults";
	if(rdlPageListProp != null) {
	rdlPageListPropRef = rdlPageListProp.getReference();
	}
	String rdlRefreshWhenStr = "D_pxGetAssociatedTags.pxResults AddDelete";
	rdlRefreshWhenStr = rdlRefreshWhenStr.replace("D_pxGetAssociatedTags.pxResults",rdlPageListPropRef);
	if(!StringUtils.isBlank(expressionId)) {
	...
	if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
	pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxGetAssociatedTags.pxResults").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
	} else {
	pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxGetAssociatedTags.pxResults").getReference(),"",false)); 
	}
	pgSectionBody.put("sourcetype","Data Object");
	Map map = new HashMap();
	Map paramsMap = new HashMap();
	map.put("params", paramsMap);
	map.put("pxDataSourceId", pxUniqueStreamHash+"_17");
	pgSectionBody.put("datasrcid",pxUniqueStreamHash+"_17");
	pyRDDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();
	paramsMap.put("TagContext", ".pzInsKey");
	pyRDDataPageParams.put("pyName","TagContext");
	 { String propertyRef=".pzInsKey";if(propertyRef.startsWith(".")){		propertyRef = tools.getStepPage().getReference() + propertyRef;}
	...
	pgSectionBody.put("dpname","D_pxGetAssociatedTags");
	if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
	...
	pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201907080305060808932" ) + "");
	...
	map.put("pyContext", "D_pxGetAssociatedTags.pxResults");
	...
	if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
	repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxGetAssociatedTags.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
	} else {
	repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxGetAssociatedTags.pxResults").getReference(),"", false),pyInstanceId);
	}
	tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
	ClipboardProperty cpSource = tools.getProperty("D_pxGetAssociatedTags.pxResults");
	...
	dummyPageName = "DummyD_pxGetAssociatedTags_pxResults";
	}
	if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
	repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxGetAssociatedTags.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
	itemPage = tools.createPage("Link-Tag",dummyPageName);
	PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
	simpleLayoutCell_2(1);
	pega.popStackFrame(itemFrame, false);
	} else {
	repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxGetAssociatedTags.pxResults").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
	}
	}else{
	if(mode =='L' || mode =='G'){
	Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxGetAssociatedTags.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxGetAssociatedTags.pxResults").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("pyShowAssociatedTags",
...
pzSection.getLayout().setExpandParam("SubSectionpyShowAssociatedTagsBB","",false);
}


public void putRDLDPParams_1() {
	if(tools.getIfPresent(".pzInsKey") != null)
	tools.putParamValue("TagContext",tools.getProperty(".pzInsKey").getStringValue());
	}
...
public void simpleLayout_1() {
		...
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplateComponent(pxUniqueStreamHash+"_18");
		}
		int totalRecords=0;
		...
		tools.appendString(tools.getProperty("D_pxGetAssociatedTags.pxResults").getReference()+ "' ");
		tools.appendString(" " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + "  class=' flex content   layout-content-inline content-inline  ' ");
		String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
		ClipboardProperty rdlPageListProperty = tools.getProperty("D_pxGetAssociatedTags.pxResults");
		String rdlPageListPropRef = "D_pxGetAssociatedTags.pxResults";
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201907080305060808932" ) + " ");
		tools.appendString(">");
		int index = 1;
		...
		rdlPageListProp = tools.getProperty("D_pxGetAssociatedTags.pxResults");
	...
	String paramName = "EXPANDEDSubSectionpyShowAssociatedTagsBB";
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pzInsKey\"  SHOW_WHEN=\".pzInsKey!=''\"");
if(pzAuto.evaluateWhen(".pzInsKey!=''",null,true)){
	if(currentTemplatingStatus =='N')
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pzInsKey", -1);
	}
}catch(Exception e){}
}
public void inclFormattedVal_2(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {
		pega.checkIfActivePropertyMissing();java.util.HashMap currencyParamsMap = new HashMap();currencyParamsMap.put("currencyType","");currencyParamsMap.put("otherCurrencySymbolValue","");currencyParamsMap.put("currencyPosition","left");currencyParamsMap.put("displayCurrencyAs","currencySymbol");currencyParamsMap.put("useTrailingIsoCode","false");currencyParamsMap.put("symbolPosition","left");
		String formattedValue = pega_uiengine_formatter.pxFormatNumber((isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true)),null, true,0,"none","none","NegativeNumber","none","null","","localizevalue",true,currencyParamsMap);
...
tools.putParamValue("isControlEditableOriginal", true);
	...
	sEntryHandle = tools.getActive().getEntryHandle(true, false);tools.putParamValue("isControlEditableOriginal", false);
	 ...
	 pega_rules_utilities.pzRegisterActivity(tools,"GetTargets");
		...
		textIncludes_1();
inclCalVal_1("pxDisplayText","N&&true&&0&&none&&none&&NegativeNumber&&none&&*&&*&&localizevalue&&true&&__left_currencySymbol_false_left","centerJustifyStyle");inclAction_1();
tools.appendString(">");
...
tools.appendString("</P>");
	...
	String repeatIndx = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".TagsCount",pxUniqueStreamHash+"_5");
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20190725094539066332283",true));
	String pyValueR = "";
	String pyValueOrig = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".TagsCount");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".TagsCount", ".pyCaption");
	pyValueR = ".TagsCount";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".TagsCount");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".TagsCount", ".pyCaption");
	pyValueOrig = ".TagsCount";
	...
	modePage2.put("pyReadonlyValidation",true);
	java.util.HashMap currencyParamsMap = new HashMap();
	currencyParamsMap.put("currencyType","");
	...
	pega_uiengine_formatter.pxFormatNumber("123450.6789", null,true,4,"none","none","NegativeNumber","none","null","null","associated",true,currencyParamsMap);
	...
	modePage2.put("pyTextAlign","Center");
	...
	ctrlComponent.endComponent();
		...
		textIncludes_1();	
		tools.appendString("\n<span  " + pzCell.getTestIdIfEnabled("20190725094539066332283") + "  data-ctl='Text' ");
...
inclAction_1();
		...
		tools.appendString(" class= 'centerJustifyStyle'");
	...
	tools.appendString("</span>");
		...
		pega_uiengine_pzcontrol.pzAddMessages(tools,"SIMPLELAYOUT","true");
}
...
public int simpleLayoutCell_1( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= rx.TagsCount cq",".TagsCount!=\'\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".TagsCount",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   utils-badge dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxDisplayText_1(".TagsCount",0,"","","Integer");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20190725094539066332283-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel",".TagsCount");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.TagsCount cq",pxUniqueStreamHash+"_8");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_8");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".TagsCount!=''");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.TagsCount cq", pxUniqueStreamHash+"_8"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".TagsCount",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_1(".TagsCount",0,"","","Integer");}
	if (!isExpression && isOffline) {
	// do nothing
	} else {
...
pzSection.getLayout().setExpandParam("SubSectionpyShowAssociatedTagsB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201909171056030736821") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-stacked content-stacked " + "'  " + " aria-label = '"+tools.getLocalizedTextForString(".pyCaption", StringUtils.escapeCrossScriptingFilter("Tags"))+"'" );
		...
		pg_dlmeta.put("ariaLabel",""+tools.getLocalizedTextForString(".pyCaption", StringUtils.escapeCrossScriptingFilter("Tags")));
	...
	String paramName = "EXPANDEDSubSectionpyShowAssociatedTagsB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- PYSHOWASSOCIATEDTAGS #20210506T204030.010 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyShowAssociatedTags");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PYSHOWASSOCIATEDTAGS #20210506T204030.010 GMT", "Work- pyShowAssociatedTags", "Theme-Cosmos", "04-01-01", "20220701T080202.694 GMT");
}
