...
/**
 * Builds JSP stream RULE-OBJ-CLASS!PZSELECTEDCASELPCONTAINER.
 */
public class ra_stream_pzselectedcaselpcontainer_1090fe1ce26ccc598c8091de8d6f0a1d extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSelectedCaseLPContainer.Rule_Obj_Class.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -28981606;
 ...
 */
	public ra_stream_pzselectedcaselpcontainer_1090fe1ce26ccc598c8091de8d6f0a1d(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "dbccb36ec6e57e961fd28068f026eca8e09c24fa";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-CLASS PZSELECTEDCASELPCONTAINER #20180713T140924.392 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "dbccb36ec6e57e961fd28068f026eca8e09c24fa";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSelectedCaseLPContainer",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-CLASS PZSELECTEDCASELPCONTAINER #20180713T140924.392 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-CLASS PZSELECTEDCASELPCONTAINER #20180713T140924.392 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-CLASS PZSELECTEDCASELPCONTAINER #20180713T140924.392 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZSELECTEDCASELPCONTAINER"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSELECTEDCASELPCONTAINER","Rule-HTML-Section","RULE-OBJ-CLASS",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION RULE-OBJ-CLASS PZSELECTEDCASELPCONTAINER #20180713T140924.392 GMT","!PZSELECTEDCASELPCONTAINER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-28981606)
	};
...
//	RULE-HTML-SECTION RULE-OBJ-CLASS PZSELECTEDCASELPCONTAINER #20180713T140924.392 GMT:20180713T140924.392 GMT
//	RULE-OBJ-ACTIVITY RULE-HTML-SECTION PZASSEMBLEPREPROCESS #20190207T102426.651 GMT:20190430T113026.575 GMT
//	pzLayoutContainer_1( {"methodName", "String", ""}
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "337bbbe42990f8bf87e1f0c9f43a0d41";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSelectedCaseLPContainer",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSelectedCaseLPContainer','insKey':'RULE-HTML-SECTION RULE-OBJ-CLASS PZSELECTEDCASELPCONTAINER #20180713T140924.392 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("DeferLoadActivity", "pzGetSelectedCaseTypeDetails");
...
String[] arReturn;
newParamsPage.putString("myPrimary", "");
...
keys.putString("pyActivityName", "pzGetSelectedCaseTypeDetails");
try{
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4", "pyLoadingMessage", loadingSectionInfo);
}
}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_2","pzShowSelectedCaseDetailsInLPWrapper", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzShowSelectedCaseDetailsInLPWrapper";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzSelectedCaseLPContainerB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzSelectedCaseLPContainerB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzShowSelectedCaseDetailsInLPWrapper'}");
...
if(!"".equals(methodName)) {
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addParameterPage(pxUniqueStreamHash+"_3");
metadataPage.put("parampg",pxUniqueStreamHash+"_3");
}
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzShowSelectedCaseDetailsInLPWrapper'}") + ">");
}
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()){
if(tools.getParamValue("lazyLoadId").equals("S112") || pega_uiengine_offlinesupport.pzIsForOfflineTemplate() || "true".equals(tools.getParamValue("pyPegaDesignMode"))){
...
if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate() && !"true".equals(tools.getParamValue("pyPegaDesignMode"))){tools.appendString("</div>");}
			 tools.putParamValue("RenderSingle" , "S112");
			 tools.putParamValue("lazyLoadId" , "S112");
		}else{
		
			if(!tools.getParamValue("lazySection ").equals("pzSelectedCaseLPContainer")){
				 String readOnly = "-1".equals(tools.getParamValue("ReadOnly")) || "-1".equals(tools.getParamValue("SectionReadOnly")) || !tools.hasInputEnabled() ? "-1" : "0";
				   ...
				   tools.putParamValue("lazyLoadInfo" , lazyLoadInfoValue + tools.getSaveValue("lazyLoadDivId") + ",S112,subscriptionId=" + tools.getParamValue("subscriptionId") + "ReadOnly=" + readOnly + getParamPage_1() + "~#LLDELIM#~");tools.appendString("<div style='display:block;' data-lazyloaddivid='" + lazyLoadDivIdSaveValue + "' data-layoutid='S112' class='lazyload-layout' data-parampage='"+tools.getParamValueCSF("lazyLoadInfo").replace("~#LLDELIM#~","")+"' >");if(tools.getParamValue("RenderSingle").equals("")){pzAuto.emitIncludeStreamReference("pyLoadingMessage",null,null,"Rule-HTML-Section",null); }tools.appendString("</div>");
			}
		}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-CLASS PZSELECTEDCASELPCONTAINER #20180713T140924.392 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzSelectedCaseLPContainer");
...
static {
pzExternalMethodMapping.put("pzLayoutContainer_1", new String[][] { {"methodName", "String", ""}});
}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-CLASS PZSELECTEDCASELPCONTAINER #20180713T140924.392 GMT", "Rule-Obj-Class pzSelectedCaseLPContainer", "Pega-ProcessArchitect", "08-01-01", "20180713T140924.392 GMT");
}
