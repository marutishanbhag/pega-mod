...
/**
 * Builds JSP stream EMBED-FIELDS!PZFIELDPROPERTYTYPE.
 */
public class ra_stream_pzfieldpropertytype_9bd3ce3bc301046e9ec9a0adca632fb5 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzFieldPropertyType.Embed_Fields.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -16174713;
 ...
 */
	public ra_stream_pzfieldpropertytype_9bd3ce3bc301046e9ec9a0adca632fb5(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "9a83aec57b1447a2d0ce56f8d61d4abe0688aec2";
...
{
/* Instance RULE-HTML-SECTION EMBED-FIELDS PZFIELDPROPERTYTYPE #20200605T124945.690 GMT	Pega-ProcessArchitect:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "9a83aec57b1447a2d0ce56f8d61d4abe0688aec2";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzFieldPropertyType",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-FIELDS PZFIELDPROPERTYTYPE #20200605T124945.690 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-FIELDS PZFIELDPROPERTYTYPE #20200605T124945.690 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-FIELDS PZFIELDPROPERTYTYPE #20200605T124945.690 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZFIELDPROPERTYTYPE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZFIELDPROPERTYTYPE","Rule-HTML-Section","EMBED-FIELDS",false,"","Pega-ProcessArchitect","08-05-01","RULE-HTML-SECTION EMBED-FIELDS PZFIELDPROPERTYTYPE #20200605T124945.690 GMT","!PZFIELDPROPERTYTYPE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-16174713), 
		new DependentRuleInfo("PYPROPERTYTYPE","Rule-Obj-Property","EMBED-FIELDS",true,"Embed-Fields","Pega-ProcessArchitect","08-04-01","RULE-OBJ-PROPERTY EMBED-FIELDS PYPROPERTYTYPE #20191029T180905.887 GMT","!PYPROPERTYTYPE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYSTRINGTYPE","Rule-Obj-Property","EMBED-FIELDS",true,"Embed-Fields","Pega-LP-Application","08-01-01","RULE-OBJ-PROPERTY EMBED-FIELDS PYSTRINGTYPE #20180713T142526.257 GMT","!PYSTRINGTYPE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION EMBED-FIELDS PZFIELDPROPERTYTYPE #20200605T124945.690 GMT:20200605T124945.690 GMT
//	RULE-HTML-PROPERTY PXDROPDOWN #20191010T062311.436 GMT:20191010T062311.436 GMT
//	RULE-OBJ-PROPERTY EMBED-FIELDS PYPROPERTYTYPE #20191029T180905.887 GMT:20191031T174358.939 GMT
//	RULE-OBJ-PROPERTY EMBED-FIELDS PYSTRINGTYPE #20180713T142526.257 GMT:20180713T142526.257 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "6c90e817f7877a3bab2e9a7cd033a501";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzFieldPropertyType",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzFieldPropertyType','insKey':'RULE-HTML-SECTION EMBED-FIELDS PZFIELDPROPERTYTYPE #20200605T124945.690 GMT','sectionType':'standard'}");
pzLayout_1();
...
pega.getUIEngine().getUIAction("runDataTransform", config).register();
config = new HashMap<String, String>();
config.put("pzActivity", "pzPropertyTypeOnChange");
...
getControlMarkup_1() {
try {
if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyPropertyType").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
...
public void pxTextInput_1() {String key="2||RULE-HTML-SECTION EMBED-FIELDS PZFIELDPROPERTYTYPE #20200605T124945.690 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","true"," cttrue"," cffalse","T","false","0","","","Text","true","2"};oCellRuntimeParamsMap.put("2||RULE-HTML-SECTION EMBED-FIELDS PZFIELDPROPERTYTYPE #20200605T124945.690 GMT",paramValues);oControlPathsMap.put("2||RULE-HTML-SECTION EMBED-FIELDS PZFIELDPROPERTYTYPE #20200605T124945.690 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
public void inclFormattedVal_2(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {if (isSecuredProp) { tools.putParamValue("proSecurity_isSecuredProp", isSecuredProp);tools.putParamValue("proSecurity_activePropValue", activePropValue);}
		...
		tools.appendString(pega_uiengine_formatter.pxFormatText(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzListOfPropertyTypes","","","D_pzListOfPropertyTypes:Mode$param.Mode~IsExpressMode$param.IsExpressMode~IsCaseType$.pyIsFieldForWorkClass~IsFormBuilder$true",".pyLabel",".pyDescription",true,(PegaStreamAPI)tools),false,"","",true,"caption"));
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzListOfPropertyTypes","","","D_pzListOfPropertyTypes:Mode$param.Mode~IsExpressMode$param.IsExpressMode~IsCaseType$.pyIsFieldForWorkClass~IsFormBuilder$true",".pyLabel",".pyDescription",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("isControlEditableOriginal"))) {
		...
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzListOfPropertyTypes","","","D_pzListOfPropertyTypes:Mode$param.Mode~IsExpressMode$param.IsExpressMode~IsCaseType$.pyIsFieldForWorkClass~IsFormBuilder$true",".pyLabel",".pyDescription",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("FORMAT_PLAIN_TXT")) && ((pzAuto.getBrowserUtils().isIE() && !pega_uiengine_harness.pzInStandardsMode()) || "true".equals(tools.getParamValue("fromAPI"))) ){
			tools.appendString("&nbsp;");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }{String strStreamName="";String strPropertyTarget ="";String strPageName ="";strStreamName="pzFieldPropertyType";if(tools.getPrimaryPage() != null){ strPageName = tools.getPrimaryPage().getName();}if(tools.getActive() != null){strPropertyTarget = tools.getActive().getEntryHandle();}com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();actionRequest.registerFixedParameter("pyActivity", "ReloadCell"); actionRequest.registerFixedParameter("pyPropertyTarget", strPropertyTarget ); actionRequest.registerFixedParameter("StreamName", strStreamName); actionRequest.registerFixedParameter("pzPrimaryPageName", strPageName); pzAuto.registerActionRequest(actionRequest);}							tools.appendString("[\"postValue\",[\":event\"]");

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }							{
								StringBuffer ractURLStr = new StringBuffer();
								StringBuffer ractParamStr = new StringBuffer();
								ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzPropertyTypeOnChange");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }														tools.appendString("[\"setItemFocus\",[\"" + pzAuto.getUIComponentRuntime().generateActionToken(".pyPropertyType") + "\"]");
...
tools.appendString("</P>");
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2014111115181206231654",true));
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyPropertyType",pxUniqueStreamHash+"_5");
	...
	modePage1.put("pyGroupOrder","desc");
	...
	if(listProperties.containsKey(".pyUsage")){
	Set<String> currentPropFieldNames = (Set<String>)listProperties.get(".pyUsage");
	currentPropFieldNames.add("pyCaption");
	listProperties.put(".pyUsage",currentPropFieldNames);
	}else{
	Set<String> fieldNames = new HashSet<String>();
	fieldNames.add("pyCaption");
	listProperties.put(".pyUsage",fieldNames);
	}
	modePage1.put("pyResultsUniqueID",pxUniqueStreamHash+"_6");
	tools.putParamValue("Mode", 
	tools.getParamValue("Mode").replaceAll("^\"|\"$", "")
	);
	tools.putParamValue("IsExpressMode", 
	tools.getParamValue("IsExpressMode").replaceAll("^\"|\"$", "")
	);
	tools.putParamValue("IsCaseType", 
	tools.getProperty(".pyIsFieldForWorkClass").getStringValue()
	);
	tools.putParamValue("IsFormBuilder", 
	"true"
	);
	Map<String, String> sourceDPParams = new HashMap<String, String>();
	sourceDPParams.put("Mode", "param.Mode");
	sourceDPParams.put("IsExpressMode", "param.IsExpressMode");
	sourceDPParams.put("IsCaseType", ".pyIsFieldForWorkClass");
	sourceDPParams.put("IsFormBuilder", "true");
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
	tools.findPage("D_pzListOfPropertyTypes");
	}
	tools.putParamValue("bListOptionsLocalize","true");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadDataPage("D_pzListOfPropertyTypes", listProperties, pxUniqueStreamHash+"_6", sourceDPParams);
	...
	pyDataPageParams.put("pyValue","#~"+pzAuto.getUIComponentRuntime().generateActionToken("param.Mode")+"~#");
	pyDataPage.addMetadataInArray("pyDataPageParams",pyDataPageParams);
	pyDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();  
	pyDataPageParams.put("pyName","IsExpressMode");
	pyDataPageParams.put("pyValue","#~"+pzAuto.getUIComponentRuntime().generateActionToken("param.IsExpressMode")+"~#");
	pyDataPage.addMetadataInArray("pyDataPageParams",pyDataPageParams);
	pyDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();  
	pyDataPageParams.put("pyName","IsCaseType");
	pyDataPageParams.put("pyValue","#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyIsFieldForWorkClass")+"~#");
	pyDataPage.addMetadataInArray("pyDataPageParams",pyDataPageParams);
	pyDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();  
	pyDataPageParams.put("pyName","IsFormBuilder");
	...
	String pageName = "D_pzListOfPropertyTypes";
	String dataPageName = "D_pzListOfPropertyTypes";
	if(tools.findPage("D_pzListOfPropertyTypes") != null){
	pageName = tools.findPage("D_pzListOfPropertyTypes").getReference();
	}
	modePage1.put("pySourceName",dataPageName);
	modePage1.put("pyHashedDataPage",pageName);
	pageName = "D_pzListOfPropertyTypes";
	...
	try{
		if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){ 
			...
			changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyIsFieldForWorkClass", -1);
		}
		 ...
		 expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("cellRefreshWhen",  ".pyIsFieldForWorkClass Changes", expressionId);
	...
	modePage1.put("pyGroupLabel",".pyUsage");
	...
	modePage2.put("pySourceName","D_pzListOfPropertyTypes");
	...
	com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		ct_controlAction.trackValueChanges(tools.getProperty("param.Mode"), -1);
		ct_controlAction.trackValueChanges(tools.getProperty("param.IsExpressMode"), -1);
		ct_controlAction.trackValueChanges(tools.getProperty(".pyIsFieldForWorkClass"), -1);
	}}catch(Exception e){}
	}
} else {
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_10");}if(beginNonTemplate){			HashStringMap params = new HashStringMap();
	...
	pageName = tools.getStepPage().getName()+pageName;
			...
			tools.appendString("<div id='CT'  RCW = '.pyIsFieldForWorkClass' RC = '.pyIsFieldForWorkClass Changes' CellId = '1");
	...
	if(tools.getThread().getName().indexOf("/$WorkProcessing") != -1 || tools.getThread().getName().indexOf("/$FlowModalProcess") != -1 ) {
			...
			try{
				if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
					...
					cellChangeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyIsFieldForWorkClass", -1);
				}
			}catch(Exception e){}
			pega_rulesengine_utilities.pxSortPageList(cbpResults,".pyUsage","desc");
		...
		String strActiveValue = isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true);			String strValue = isSecuredProp ? activePropValue : tools.getProperty(ddPropRef).getStringValue();
			...
			if(!isAccessible) {
				...
				tools.appendString(" " + pzCell.getTestIdIfEnabled("2014111115181206231654") + " ");
...
tools.appendString(" data-bindprops='value' ");} else{			tools.appendString(ddPropEntryHandle);
		...
		tools.appendString("]' ");
																	...
																	if("".equals(strValue) && cbpResults != null && cbpResults.size() > 0) {
																		String pyValueProp = ".pyDescription";
															...
															if (cbpResults != null && cbpResults.size() > 0) {
																...
																if(!groupPropValue.equals(cbpRow.getString(".pyUsage"))) {
																	groupPropValue = cbpRow.getString(".pyUsage");
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2014111115181206231654") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpzIsAFieldsAvailablePropertyType","pzIsAFieldsAvailablePropertyType","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDropdown",".pyPropertyType",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","form-field-type","form-field-type")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("2014111115181206231654-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2014111115181206231654-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2014111115181206231654-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzIsAFieldsAvailablePropertyType",pxUniqueStreamHash+"_13");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_13");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzIsAFieldsAvailablePropertyType");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzIsAFieldsAvailablePropertyType", pxUniqueStreamHash+"_13"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDropdown",".pyPropertyType",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o1! wxpzIsAFieldsAvailablePropertyType","!pzIsAFieldsAvailablePropertyType","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput",".pyStringType",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","form-field-type","form-field-type")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("2014111115181206243972-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2014111115181206243972-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","remove-all-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2014111115181206243972-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxpzIsAFieldsAvailablePropertyType",pxUniqueStreamHash+"_15");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpzIsAFieldsAvailablePropertyType", pxUniqueStreamHash+"_15"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextInput",".pyStringType",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxTextInput_1();}
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldPropertyTypeB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("2020052908382006231000") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  layout-content-inline content-inline  clearfix" + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzFieldPropertyTypeB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-FIELDS PZFIELDPROPERTYTYPE #20200605T124945.690 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzFieldPropertyType");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-FIELDS PZFIELDPROPERTYTYPE #20200605T124945.690 GMT", "Embed-Fields pzFieldPropertyType", "Pega-ProcessArchitect", "08-05-01", "20200605T124945.690 GMT");
}
