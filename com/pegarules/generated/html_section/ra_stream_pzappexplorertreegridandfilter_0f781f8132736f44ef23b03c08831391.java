...
/**
 * Builds JSP stream @BASECLASS!PZAPPEXPLORERTREEGRIDANDFILTER.
 */
public class ra_stream_pzappexplorertreegridandfilter_0f781f8132736f44ef23b03c08831391 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzAppExplorerTreeGridAndFilter.Code_Pega_List.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -406531075;
 ...
 */
	public ra_stream_pzappexplorertreegridandfilter_0f781f8132736f44ef23b03c08831391(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "12ef75f307489c4585e90411c1c7f72b7698ad30";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZAPPEXPLORERTREEGRIDANDFILTER #20180713T135134.122 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "12ef75f307489c4585e90411c1c7f72b7698ad30";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzAppExplorerTreeGridAndFilter",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZAPPEXPLORERTREEGRIDANDFILTER #20180713T135134.122 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZAPPEXPLORERTREEGRIDANDFILTER #20180713T135134.122 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZAPPEXPLORERTREEGRIDANDFILTER #20180713T135134.122 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZAPPEXPLORERTREEGRIDANDFILTER", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPEXPLORERTREEGRIDANDFILTER","Rule-HTML-Section","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION @BASECLASS PZAPPEXPLORERTREEGRIDANDFILTER #20180713T135134.122 GMT","!PZAPPEXPLORERTREEGRIDANDFILTER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-406531075), 
...
//	RULE-HTML-SECTION @BASECLASS PZAPPEXPLORERTREEGRIDANDFILTER #20180713T135134.122 GMT:20180713T135134.122 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "6fad29501d9f7423eae939d2bfda6733";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzAppExplorerTreeGridAndFilter",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzAppExplorerTreeGridAndFilter','insKey':'RULE-HTML-SECTION @BASECLASS PZAPPEXPLORERTREEGRIDANDFILTER #20180713T135134.122 GMT','sectionType':'standard'}");
pzLayout_2();
...
config.put("navName", "pzManageAppExplorer");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			pzPackageRuntime.packageSection("pzAppExplorerTreeGridAndFilter",
			...
			tools.appendString("[\"showMenu\",[{\"dataSource\":\"pzManageAppExplorer\", \"isNavNLDeferLoaded\":\"false\", \"isNavTypeCustom\":\"false\", \"className\":\"" + tools.getStepPage().getClassName());
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771593780843");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzManageAppExplorer", "", "pyNavigation1771593780843","", false, false, false, false);
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20141009131642034918994") + " ");
	if(false || (pzAuto.isOffline() && true) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzAppExplorerTreeGridAndFilter_$CTX$_3");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Options\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Options", ".pyActionPrompt");
	}
	pyTooltip = "Options";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzAppExplorerTreeGridAndFilter_"+ referenceString+ "_3'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20141009131642034918994") + "  data-ctl='Button'  type='button' role='button' aria-haspopup='true' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771593780846");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzManageAppExplorer", "", "pyNavigation1771593780846","", false, false, false, false);
			}catch(Exception e){oLog.error(e);}
			}
			tools.appendString("\"},\":event\"]");
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Options\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
...
tools.putParamValue("isControlEditableOriginal", true);
	...
	cellPage.put("pyValue",".pyTemplateInputBox");
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	cellPage.put("pyID","pyTemplateInputBox");
	modePage2.put("pyContent","associated");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20141009131642033815954",true));
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyTemplateInputBox");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyTemplateInputBox", ".pyCaption");
...
boolean bUITemplatized = pzAuto.getUIComponentRuntime().isTemplateRendering();pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);
	tools.appendString("<input  type=\"hidden\"  " + pzCell.getTestIdIfEnabled("20141009131642033815954") + "  id=\"");
...
if(pegaValidation != null) {
	...
	tools.putActive(propActivePrev); 		} catch (Exception e) {
	 ...
	 if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'		&& pzAuto.getUIComponentRuntime().getRuntimeContextTree().isLiveDesignViewMode()){
		...
		IUIComponentMetadata metadata = pzAuto.getUIComponentRuntime().createMetadata();
		IUIComponent ctrlComponent = pzAuto.getUIComponent();
		metadata.put("cellInfo", "pzAppExplorerInclude has a Param.pyUsedInApplicationExplorer which is set to true when it is included in pzAppExplorer");
		metadata.put("msgText", "config issue");
		ctrlComponent.addDependentScripts("pzpega_ui_template_designview.js");
		ctrlComponent.beginComponent("pxDesignViewError", metadata);
		tools.putParamValue("isControlEditableOriginal", true);
...
public void buildSection_2() { 
	...
	secInfo.put("pxGadgetClass", "PegaGadget-Filter");
	secInfo.put("paramxml","<?xml version=\"1.0\"?><pagedata><pyParamEnableSearchFilter>false</pyParamEnableSearchFilter><pyAppOrBuiltOn>Current Application and Built On Applications</pyAppOrBuiltOn><pyParamInitialAppList/><pyParamInitialClassList/><pyParamEnablePegaRULESFilter>true</pyParamEnablePegaRULESFilter><pyTemporaryObject>true</pyTemporaryObject><pyParamEnableClassFilter>false</pyParamEnableClassFilter><pyParamSearchResultsCount>Show Counts</pyParamSearchResultsCount><pyCallPostDataTransform>false</pyCallPostDataTransform><pyParamInitialSearchTerm/><pxObjClass>PegaGadget-Filter</pxObjClass><pyTemplateInputBox/><pxCreateOperator>yalav</pxCreateOperator><pyParamEnableApplicationFilter>true</pyParamEnableApplicationFilter><pxCreateDateTime>20130212T082324.128 GMT</pxCreateDateTime><pySearchFilterPosition>Filters on single line</pySearchFilterPosition><pxCreateSystemID>sde</pxCreateSystemID><pyDescription/><pyRefreshAppExplorer>true</pyRefreshAppExplorer><pyCallPreDataTransform>false</pyCallPreDataTransform><pxCreateOpName>Venkata Vineel</pxCreateOpName><pxWarningsToDisplay REPEATINGTYPE=\"PageList\"/></pagedata>");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pxFilterGadget", secInfo);
}
...
tools.appendString(" ");
{
								...
								ClipboardPage pyAdvParams = tools.createPage("PegaGadget-Filter","");
								pyAdvParams.adoptXMLForm("<?xml version=\"1.0\"?><pagedata><pyParamEnableSearchFilter>false</pyParamEnableSearchFilter><pyAppOrBuiltOn>Current Application and Built On Applications</pyAppOrBuiltOn><pyParamInitialAppList/><pyParamInitialClassList/><pyParamEnablePegaRULESFilter>true</pyParamEnablePegaRULESFilter><pyTemporaryObject>true</pyTemporaryObject><pyParamEnableClassFilter>false</pyParamEnableClassFilter><pyParamSearchResultsCount>Show Counts</pyParamSearchResultsCount><pyCallPostDataTransform>false</pyCallPostDataTransform><pyParamInitialSearchTerm/><pxObjClass>PegaGadget-Filter</pxObjClass><pyTemplateInputBox/><pxCreateOperator>yalav</pxCreateOperator><pyParamEnableApplicationFilter>true</pyParamEnableApplicationFilter><pxCreateDateTime>20130212T082324.128 GMT</pxCreateDateTime><pySearchFilterPosition>Filters on single line</pySearchFilterPosition><pxCreateSystemID>sde</pxCreateSystemID><pyDescription/><pyRefreshAppExplorer>true</pyRefreshAppExplorer><pyCallPreDataTransform>false</pyCallPreDataTransform><pxCreateOpName>Venkata Vineel</pxCreateOpName><pxWarningsToDisplay REPEATINGTYPE=\"PageList\"/></pagedata>");
								pyAdvParams.putString("SectionName","pxFilterGadget");
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	String sectionName = "pxFilterGadget"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzAppExplorerTreeGridAndFilter112","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("pxGadgetClass", "PegaGadget-Filter");
	secInfo.put("paramxml","<?xml version=\"1.0\"?><pagedata><pyParamEnableSearchFilter>false</pyParamEnableSearchFilter><pyAppOrBuiltOn>Current Application and Built On Applications</pyAppOrBuiltOn><pyParamInitialAppList/><pyParamInitialClassList/><pyParamEnablePegaRULESFilter>true</pyParamEnablePegaRULESFilter><pyTemporaryObject>true</pyTemporaryObject><pyParamEnableClassFilter>false</pyParamEnableClassFilter><pyParamSearchResultsCount>Show Counts</pyParamSearchResultsCount><pyCallPostDataTransform>false</pyCallPostDataTransform><pyParamInitialSearchTerm/><pxObjClass>PegaGadget-Filter</pxObjClass><pyTemplateInputBox/><pxCreateOperator>yalav</pxCreateOperator><pyParamEnableApplicationFilter>true</pyParamEnableApplicationFilter><pxCreateDateTime>20130212T082324.128 GMT</pxCreateDateTime><pySearchFilterPosition>Filters on single line</pySearchFilterPosition><pxCreateSystemID>sde</pxCreateSystemID><pyDescription/><pyRefreshAppExplorer>true</pyRefreshAppExplorer><pyCallPreDataTransform>false</pyCallPreDataTransform><pxCreateOpName>Venkata Vineel</pxCreateOpName><pxWarningsToDisplay REPEATINGTYPE=\"PageList\"/></pagedata>");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pxFilterGadget", secInfo);
}
...
String harnessID = tools.getParamValue("pzHarnessID");
 ...
 pg_Gadgets.remove(Key);
		...
		ClipboardPage pyAdvParams = tools.createPage("PegaGadget-Filter","");
		try{pyAdvParams.adoptXMLForm("<?xml version=\"1.0\"?><pagedata><pyParamEnableSearchFilter>false</pyParamEnableSearchFilter><pyAppOrBuiltOn>Current Application and Built On Applications</pyAppOrBuiltOn><pyParamInitialAppList/><pyParamInitialClassList/><pyParamEnablePegaRULESFilter>true</pyParamEnablePegaRULESFilter><pyTemporaryObject>true</pyTemporaryObject><pyParamEnableClassFilter>false</pyParamEnableClassFilter><pyParamSearchResultsCount>Show Counts</pyParamSearchResultsCount><pyCallPostDataTransform>false</pyCallPostDataTransform><pyParamInitialSearchTerm/><pxObjClass>PegaGadget-Filter</pxObjClass><pyTemplateInputBox/><pxCreateOperator>yalav</pxCreateOperator><pyParamEnableApplicationFilter>true</pyParamEnableApplicationFilter><pxCreateDateTime>20130212T082324.128 GMT</pxCreateDateTime><pySearchFilterPosition>Filters on single line</pySearchFilterPosition><pxCreateSystemID>sde</pxCreateSystemID><pyDescription/><pyRefreshAppExplorer>true</pyRefreshAppExplorer><pyCallPreDataTransform>false</pyCallPreDataTransform><pxCreateOpName>Venkata Vineel</pxCreateOpName><pxWarningsToDisplay REPEATINGTYPE=\"PageList\"/></pagedata>");
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pxFilterGadget",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pxFilterGadget",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_1(".pyTemplateInputBox",0,"","","Text");
	return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	String reqExpressionId = null;
	String disExpressionId = null;
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_2(".pyTemplateInputBox",0,"","","Text");
	index++;
	return index;
}
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing    " + pzSection.getCustomStyle(false, "","flex-grow-1 right-aligned","flex-grow-1 right-aligned")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing remove-left-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20141009131642034918994-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","flex-grow-1 right-aligned");
	pgCells.put("customRWStyles","flex-grow-1 right-aligned");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
...
pzSection.getLayout().setExpandParam("SubSectionpzAppExplorerTreeGridAndFilterB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle app-explorer-header" + "'  ");
		...
		pg_dlmeta.put("customClassName","app-explorer-header");
	...
	String paramName = "EXPANDEDSubSectionpzAppExplorerTreeGridAndFilterB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZAPPEXPLORERTREEGRIDANDFILTER #20180713T135134.122 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzAppExplorerTreeGridAndFilter");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZAPPEXPLORERTREEGRIDANDFILTER #20180713T135134.122 GMT", "@baseclass pzAppExplorerTreeGridAndFilter", "Pega-Desktop", "08-01-01", "20180713T135134.122 GMT");
}
