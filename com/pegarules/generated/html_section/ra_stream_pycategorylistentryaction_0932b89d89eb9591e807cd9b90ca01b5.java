...
/**
 * Builds JSP stream @BASECLASS!PYCATEGORYLISTENTRYACTION.
 */
public class ra_stream_pycategorylistentryaction_0932b89d89eb9591e807cd9b90ca01b5 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyCategoryListEntryAction.Embed_StageProcess_AddStep.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1224849395;
 ...
 */
	public ra_stream_pycategorylistentryaction_0932b89d89eb9591e807cd9b90ca01b5(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "d813e731b73d1fa40d6ceea7c21b7385972459fd";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYCATEGORYLISTENTRYACTION #20180713T140801.460 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "d813e731b73d1fa40d6ceea7c21b7385972459fd";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyCategoryListEntryAction",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYCATEGORYLISTENTRYACTION #20180713T140801.460 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYCATEGORYLISTENTRYACTION #20180713T140801.460 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYCATEGORYLISTENTRYACTION #20180713T140801.460 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYCATEGORYLISTENTRYACTION", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCATEGORYLISTENTRYACTION","Rule-HTML-Section","@BASECLASS",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION @BASECLASS PYCATEGORYLISTENTRYACTION #20180713T140801.460 GMT","!PYCATEGORYLISTENTRYACTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1224849395), 
...
//	RULE-HTML-SECTION @BASECLASS PYCATEGORYLISTENTRYACTION #20180713T140801.460 GMT:20180713T140801.460 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "eba0ee5d60b77b528548ff3d16925366";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyCategoryListEntryAction",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyCategoryListEntryAction','insKey':'RULE-HTML-SECTION @BASECLASS PYCATEGORYLISTENTRYACTION #20180713T140801.460 GMT','sectionType':'standard'}");
pzLayout_1();
...
try {
	...
	cellPage.put("pyStreamName","pyCategoryListEntryAction");
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("201510070450450020357") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pyCategoryListEntryAction_"+ referenceString+ "_1'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		String classProp = "";
		 classProp ="pi pi-caret-right";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("201510070450450020357") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201510070450450020357-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpyCategoryListEntryActionB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpyCategoryListEntryActionB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYCATEGORYLISTENTRYACTION #20180713T140801.460 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyCategoryListEntryAction");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYCATEGORYLISTENTRYACTION #20180713T140801.460 GMT", "@baseclass pyCategoryListEntryAction", "Pega-ProcessArchitect", "08-01-01", "20180713T140801.460 GMT");
}
