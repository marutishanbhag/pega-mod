...
/**
 * Builds JSP stream RULE-!PZRULEFORMTOOLBARLOCKEDICON.
 */
public class ra_stream_pzruleformtoolbarlockedicon_2d594ab886943d7c2ad33bc8e0e3b571 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzRuleFormToolbarLockedIcon.Rule_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1764613229;
 ...
 */
	public ra_stream_pzruleformtoolbarlockedicon_2d594ab886943d7c2ad33bc8e0e3b571(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "23db8871b661b175d837e22b9d7b25ec9b36207a";
...
{
/* Instance RULE-HTML-SECTION RULE- PZRULEFORMTOOLBARLOCKEDICON #20200203T122416.771 GMT	Pega-Desktop:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "23db8871b661b175d837e22b9d7b25ec9b36207a";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzRuleFormToolbarLockedIcon",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE- PZRULEFORMTOOLBARLOCKEDICON #20200203T122416.771 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE- PZRULEFORMTOOLBARLOCKEDICON #20200203T122416.771 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE- PZRULEFORMTOOLBARLOCKEDICON #20200203T122416.771 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZRULEFORMTOOLBARLOCKEDICON", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULEFORMTOOLBARLOCKEDICON","Rule-HTML-Section","RULE-",false,"","Pega-Desktop","08-05-01","RULE-HTML-SECTION RULE- PZRULEFORMTOOLBARLOCKEDICON #20200203T122416.771 GMT","!PZRULEFORMTOOLBARLOCKEDICON",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1764613229), 
...
//	RULE-HTML-SECTION RULE- PZRULEFORMTOOLBARLOCKEDICON #20200203T122416.771 GMT:20200203T122416.771 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "c4532ce454242556a5bfca4b0b3ed940";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzRuleFormToolbarLockedIcon",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzRuleFormToolbarLockedIcon','insKey':'RULE-HTML-SECTION RULE- PZRULEFORMTOOLBARLOCKEDICON #20200203T122416.771 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("NewTaskStatus", "pzRuleLockedInfo");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		keyMap.putString("pyActionName", "pzRuleLockedInfo");
		...
		try{
		pzPackageRuntime.packageLocalAction("pzRuleLockedInfo", offlineUsingPage , strLAClassName);
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("pzRuleFormToolbarLockedIcon",
				...
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pzRuleLockedInfo\",\"overlay\",\":event\",\"\",\""+streamType+"\",\"\",\"\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-null%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22effect%22%3A%22anim-null%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
					} else {
...
try {
	...
	cellPage.put("pyStreamName","pzRuleFormToolbarLockedIcon");
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Locked\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Locked", ".pyActionPrompt");
	}
	pyTooltip = "Locked";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20141210161219061319308") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzRuleFormToolbarLockedIcon_"+ referenceString+ "_1'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Locked\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
		String alttempText = tools.getLocalizedTextForString(".pyActionPrompt","Locked\t" + repeatIndx ,StreamBuilder.FMT_LITERAL);
		String classProp = "";
		 classProp ="pi pi-lock-closed";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("20141210161219061319308") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2!= rx.pyToolBarSettings.pySave cttrue o2!= rx.pyIsFromManageChangeLP cttrue",".pyToolBarSettings.pySave != true && .pyIsFromManageChangeLP != true","cell", "visible" )) {
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20141210161219061319308-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2!= rx.pyToolBarSettings.pySave cttrue o2!= rx.pyIsFromManageChangeLP cttrue",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyToolBarSettings.pySave != true && .pyIsFromManageChangeLP != true");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2!= rx.pyToolBarSettings.pySave cttrue o2!= rx.pyIsFromManageChangeLP cttrue", pxUniqueStreamHash+"_6"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzRuleFormToolbarLockedIconB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202002030030030882281") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  set-width-auto layout-content-inline_middle content-inline_middle " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzRuleFormToolbarLockedIconB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= rx.pyToolBarSettings.pySave cttrue", pxUniqueStreamHash+"_7");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if(pzAuto.handleEvaluateWhen(" o2!= rx.pyToolBarSettings.pySave cttrue",".pyToolBarSettings.pySave != true", "layout", "visible" )) {pzSetExpandParam_1();
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE- PZRULEFORMTOOLBARLOCKEDICON #20200203T122416.771 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzRuleFormToolbarLockedIcon");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE- PZRULEFORMTOOLBARLOCKEDICON #20200203T122416.771 GMT", "Rule- pzRuleFormToolbarLockedIcon", "Pega-Desktop", "08-05-01", "20200203T122416.771 GMT");
}
