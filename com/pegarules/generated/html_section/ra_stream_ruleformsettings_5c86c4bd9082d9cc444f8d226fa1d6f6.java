...
/**
 * Builds JSP stream RULE-OBJ-CLASS!RULEFORMSETTINGS.
 */
public class ra_stream_ruleformsettings_5c86c4bd9082d9cc444f8d226fa1d6f6 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.RuleFormSettings.Rule_Obj_Class.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 82882220;
 ...
 */
	public ra_stream_ruleformsettings_5c86c4bd9082d9cc444f8d226fa1d6f6(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "da9608a7ea38c73add9704e4e8ae70fb32cc2571";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-CLASS RULEFORMSETTINGS #20180713T135251.038 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "da9608a7ea38c73add9704e4e8ae70fb32cc2571";
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-CLASS RULEFORMSETTINGS #20180713T135251.038 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-CLASS RULEFORMSETTINGS #20180713T135251.038 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-CLASS RULEFORMSETTINGS #20180713T135251.038 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("RULEFORMSETTINGS","Rule-HTML-Section","RULE-OBJ-CLASS",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION RULE-OBJ-CLASS RULEFORMSETTINGS #20180713T135251.038 GMT","!RULEFORMSETTINGS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",82882220), 
		...
		new DependentRuleInfo("PYMETHODSTATUS","Rule-Obj-Property","RULE-OBJ-CLASS",false,"","Pega-Desktop","08-01-01","RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYMETHODSTATUS #20180713T135039.149 GMT","!PYMETHODSTATUS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
		...
		new DependentRuleInfo("PYCLASSNAME","Rule-Obj-Property","RULE-OBJ-CLASS",false,"","Pega-ProCom","08-08-01","RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYCLASSNAME #20220504T193113.758 GMT","!PYCLASSNAME",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0)
	};
...
//	RULE-HTML-SECTION RULE-OBJ-CLASS RULEFORMSETTINGS #20180713T135251.038 GMT:20180713T135251.038 GMT
...
//	RULE-OBJ-PROPERTY RULE- PYINTERFACE #20180713T131512.331 GMT:20180713T131512.331 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYMETHODSTATUS #20180713T135039.149 GMT:20180713T135039.149 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYMETHODSTATUS #20180713T135039.149 GMT:20180713T135039.149 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "cd615cabc2f684b17e94bd408d590c61";
	}
...
static {
	oPropDefinitions_2.put("Rule-Obj-Class.pzIsPrivateCheckOut", new LiteweightPropertyDefinition("Rule-Obj-Class", "pzIsPrivateCheckOut", "sTN", false, true, "pxTextInput", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pxInstanceLockedRuleSet", new LiteweightPropertyDefinition("Rule-Obj-Class", "pxInstanceLockedRuleSet", "sTY", true, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pyRuleName", new LiteweightPropertyDefinition("Rule-Obj-Class", "pyRuleName", "sTN255", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pxUpdateDateTime", new LiteweightPropertyDefinition("Rule-Obj-Class", "pxUpdateDateTime", "sMY", true, true, "DateTime-Long", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pyInterface", new LiteweightPropertyDefinition("Rule-Obj-Class", "pyInterface", "siN64", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pzDocumentKey", new LiteweightPropertyDefinition("Rule-Obj-Class", "pzDocumentKey", "sTN", false, true, "pxTextInput", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pyRuleSet", new LiteweightPropertyDefinition("Rule-Obj-Class", "pyRuleSet", "sTN", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pyRuleAvailable", new LiteweightPropertyDefinition("Rule-Obj-Class", "pyRuleAvailable", "siN", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pxInstanceLockedRuleSetVersion", new LiteweightPropertyDefinition("Rule-Obj-Class", "pxInstanceLockedRuleSetVersion", "sTY", true, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pyRuleSetVersion", new LiteweightPropertyDefinition("Rule-Obj-Class", "pyRuleSetVersion", "sTN", false, true, "RuleAttributes", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pyMethodStatus ", new LiteweightPropertyDefinition("Rule-Obj-Class", "pyMethodStatus ", "sTN", false, true, "pxTextInput", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pxCreateDateTime", new LiteweightPropertyDefinition("Rule-Obj-Class", "pxCreateDateTime", "sMY", true, true, "DateTime-Medium", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pyClassName", new LiteweightPropertyDefinition("Rule-Obj-Class", "pyClassName", "sIN", false, true, "OpenRuleAdvanced", false,"NoSmartPrompt,SkipClientValidation,DisableInputBox,Width,NoOpenRule,ClassGroupInstances,Class,NoEventOnPick,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null".split(","),"false,false,false,100%,false,false,Rule-Obj-Class,false,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null".split(",")));
	oPropDefinitions_2.put("Rule-Obj-Class.pxObjClass", new LiteweightPropertyDefinition("Rule-Obj-Class", "pxObjClass", "sIY", true, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Class.pyBaseRule", new LiteweightPropertyDefinition("Rule-Obj-Class", "pyBaseRule", "sSN", false, true, "Default", false));
}
...
tools.appendString(" </pagedata> </textarea > <script> ");

ClipboardPage cp_Primary = tools.getPrimaryPage();
String hasInstances = cp_Primary.getString("pyHasInstances");
String className = cp_Primary.getString("pyClassName");
String dateTime = cp_Primary.getString("pxUpdateDateTime");
String pageName = cp_Primary.getName();

tools.appendString("var varHasInstances = '" + hasInstances +"'; "); 
tools.appendString("var pyClassName = '" + className+"'; ");
tools.appendString("var dateTime = '" + dateTime +"'; ");
tools.appendString("var pageName = '" + pageName +"'; ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-CLASS RULEFORMSETTINGS #20180713T135251.038 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-CLASS RULEFORMSETTINGS #20180713T135251.038 GMT", "Rule-Obj-Class RuleFormSettings", "Pega-Desktop", "08-01-01", "20180713T135251.038 GMT");
