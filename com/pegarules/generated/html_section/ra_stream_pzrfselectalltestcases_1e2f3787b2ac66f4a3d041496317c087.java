...
/**
 * Builds JSP stream RULE-!PZRFSELECTALLTESTCASES.
 */
public class ra_stream_pzrfselectalltestcases_1e2f3787b2ac66f4a3d041496317c087 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzRFSelectAllTestCases.Rule_Obj_Activity.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -866628500;
 ...
 */
	public ra_stream_pzrfselectalltestcases_1e2f3787b2ac66f4a3d041496317c087(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "f16d1dd681561a3ebcd80e5baf9f1034058c5c95";
...
{
/* Instance RULE-HTML-SECTION RULE- PZRFSELECTALLTESTCASES #20180713T142202.780 GMT	Pega-AutoTest:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "f16d1dd681561a3ebcd80e5baf9f1034058c5c95";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzRFSelectAllTestCases",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE- PZRFSELECTALLTESTCASES #20180713T142202.780 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE- PZRFSELECTALLTESTCASES #20180713T142202.780 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE- PZRFSELECTALLTESTCASES #20180713T142202.780 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZRFSELECTALLTESTCASES", 
	"Rule-Obj-Property:PYSELECTEDTESTCASES", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRFSELECTALLTESTCASES","Rule-HTML-Section","RULE-",false,"","Pega-AutoTest","08-01-01","RULE-HTML-SECTION RULE- PZRFSELECTALLTESTCASES #20180713T142202.780 GMT","!PZRFSELECTALLTESTCASES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-866628500), 
		new DependentRuleInfo("PYSELECTEDTESTCASES","Rule-Obj-Property","RULE-",true,"Rule-","Pega-AutoTest","08-01-01","RULE-OBJ-PROPERTY RULE- PYSELECTEDTESTCASES #20180713T142143.143 GMT","!PYSELECTEDTESTCASES",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE- PZRFSELECTALLTESTCASES #20180713T142202.780 GMT:20180713T142202.780 GMT
//	RULE-HTML-PROPERTY PXLINK #20190131T183501.590 GMT:20190131T183501.590 GMT
//	RULE-OBJ-PROPERTY RULE- PYSELECTEDTESTCASES #20180713T142143.143 GMT:20180713T142143.143 GMT
//	RULE-HTML-PROPERTY PXLINK #20190131T183501.590 GMT:20190131T183501.590 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "f3cb7b469728671189f3df498aacb9d2";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzRFSelectAllTestCases",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzRFSelectAllTestCases','insKey':'RULE-HTML-SECTION RULE- PZRFSELECTALLTESTCASES #20180713T142202.780 GMT','sectionType':'standard'}");
pzLayout_3();
pzLayout_5();
...
config.put("pyActivity", "pzRFSelectAllTestCases");
config.put("StaticActivityParams", "isSelect=true");
...
config.put("pyTarget", "thisSection");
config.put("pyActivity", "pzRFSelectAllTestCases");
config.put("StaticActivityParams", "isSelect=false");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
pega.getUIEngine().getUIAction("refresh", config).register();
...
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
config.put("pyActivity", "pzSelectAllTestCases");
config.put("StaticActivityParams", "isSelect=false");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
...
public int simpleLayoutCell_7( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + "   '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("201501130302220905100101") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + "' >");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","No test cases selected.") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201501130302220905100101")).append(" ").toString().replace("data-test-id=","").trim());
	...
	labelName = "No test cases selected.";
...
pzSection.getLayout().setExpandParam("SubSectionpzRFSelectAllTestCasesBBBBB","",false);
}
...
public void simpleLayout_4() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + " content  layout-content-inline_middle content-inline_middle " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzRFSelectAllTestCasesBBBBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2== rxD_pzProgressUpdate.pyStatus cqShowWarning o2== rxD_pzUnitTestCase.pySelectedTestsCount ci0", pxUniqueStreamHash+"_28");metadataPage.put("dlChild","true");
...
if(pzAuto.handleEvaluateWhen(" o2&& o2== rxD_pzProgressUpdate.pyStatus cqShowWarning o2== rxD_pzUnitTestCase.pySelectedTestsCount ci0","D_pzProgressUpdate.pyStatus==\'ShowWarning\' && D_pzUnitTestCase.pySelectedTestsCount ==0", "layout", "visible" )) {pzSetExpandParam_5();
...
public int simpleLayoutCell_8( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2== rxD_pzProgressUpdate.pyStatus cqShowWarning o2== rxD_pzUnitTestCase.pySelectedTestsCount ci0","D_pzProgressUpdate.pyStatus==\'ShowWarning\' && D_pzUnitTestCase.pySelectedTestsCount ==0","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rxD_pzProgressUpdate.pyStatus cqShowWarning o2== rxD_pzUnitTestCase.pySelectedTestsCount ci0",pxUniqueStreamHash+"_30");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_30");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","D_pzProgressUpdate.pyStatus=='ShowWarning' && D_pzUnitTestCase.pySelectedTestsCount ==0");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rxD_pzProgressUpdate.pyStatus cqShowWarning o2== rxD_pzUnitTestCase.pySelectedTestsCount ci0", pxUniqueStreamHash+"_30"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzRFSelectAllTestCasesBBBB","",false);
}
...
public void simpleLayout_5() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + " content  layout-content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzRFSelectAllTestCasesBBBB";
	metadataPage.put("paramName", paramName);
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				refreshActionRequest.registerFixedParameter("StreamList", "pzUnitTestCases|Rule-HTML-Section|:");
				staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
				staticURLStr.append("&PreActivity=pzRFSelectAllTestCases");
				tools.appendString("[\"refresh\", [\"otherSection\",\"pzUnitTestCases\", \"pzRFSelectAllTestCases\", \"");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"isSelect\":\"false\"");
				refreshActionRequestD.registerFixedParameter("isSelect","false");
				tools.appendString("\", \"\", \",");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }							{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
								com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
									...
									StringBuffer preDTParamStr = new StringBuffer();
									refreshActionRequest.registerFixedParameter("pyActivity", "ReloadSection");
									refreshActionRequest.registerFixedParameter("StreamList", "pzRFRunSelected|Rule-HTML-Section|:");
									staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
									tools.appendString("[\"refresh\", [\"otherSection\",\"pzRFRunSelected\", \"\", \"");
									refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
									tools.appendString("=\", \"\", \",");
									refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
									tools.appendString("\",\":event\",\"\",[\"");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }												{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
													com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
														...
														if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
															try{
																pzPackageRuntime.packageSection("pzRFSelectAllTestCases",
																...
																staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
																staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzRFSelectAllTestCases"));
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015012209462901187479",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzRFSelectAllTestCases_$CTX$_8");
		String repeatIndx = "";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Clear selected\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Clear selected", ".pyButtonLabel");
	}
	pyLabel = "Clear selected";
	...
	String spxUniqueStreamHash17 = getUIActionsMetaData_3();
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzRFSelectAllTestCases_"+ referenceString+ "_8'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015012209462901187479") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Clear selected",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public void pxTextInput_1() {String key="7||RULE-HTML-SECTION RULE- PZRFSELECTALLTESTCASES #20180713T142202.780 GMT";
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput","D_pzUnitTestCase.pySelectedTestCases",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item dataValueRead'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015012209462901176713-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxTextInput");
	pgCells.put("forLabel","D_pzUnitTestCase.pySelectedTestCases");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextInput","D_pzUnitTestCase.pySelectedTestCases",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
public int simpleLayoutCell_5( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing remove-right-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015012209462901187479-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_2();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzRFSelectAllTestCasesBBB","",false);
}
...
public void simpleLayout_2() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + " content  layout-content-inline_middle content-inline_middle " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzRFSelectAllTestCasesBBB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2!= rxD_pzUnitTestCase.pyShowSelectAllLink cttrue o2!= rxD_pzUnitTestCase.pySelectedTestsCount ci0", pxUniqueStreamHash+"_20");metadataPage.put("dlChild","true");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2!= rxD_pzUnitTestCase.pyShowSelectAllLink cttrue o2!= rxD_pzUnitTestCase.pySelectedTestsCount ci0","D_pzUnitTestCase.pyShowSelectAllLink !=true && D_pzUnitTestCase.pySelectedTestsCount !=0", "layout", "visible" )) {pzSetExpandParam_3();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				tools.appendString("[\"refresh\", [\"otherSection\",\"pzUnitTestCases\", \"pzRFSelectAllTestCases\", \"");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"isSelect\":\"true\"");
				refreshActionRequestD.registerFixedParameter("isSelect","true");
				tools.appendString("\", \"\", \",");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
				tools.appendString("\",\":event\",\"\",[\"");
				if(!"".equals(preActParamStr.toString())) {
...
try {
	...
	modePage2.put("pyName","pzRFSelectAllTestCases_$CTX$_4");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
	...
	String customStyles = null;
	String pyLabel = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyRFSelectAllText");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyRFSelectAllText", ".pyButtonLabel");
	pyLabel = ".pyRFSelectAllText";
	modePage2.put("pyLabel",pyLabel);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzRFSelectAllTestCases_"+ referenceString+ "_4'";
	 String securedPropValue = null;
	 com.pega.pegarules.pub.security.PropertySecurityInfo propSecInfo = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().getPropertyInfoForDisplay(tools.getStepPage(),tools.getProperty(".pyRFSelectAllText"), tools);
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		 securedPropValue = tools.getProperty(".pyRFSelectAllText").getStringValue();
	  }
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015012209462901187479") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		...
		tools.appendString(StringUtils.filterRichText(pzAuto.getUIComponentRuntime().getRuntimeContextTree().getDataBindingToken(tools.getProperty(".pyRFSelectAllText").getReference())));} else { checkForScriptTags_1(tools.getLocalizedTextForString(".pyButtonLabel",securedPropValue,StreamBuilder.FMT_LITERAL)); }
		tools.appendString("</a>");										}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("2015012209462901176713") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + "' >");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","All tests on this page are selected.") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015012209462901176713")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("labelReadClass","dataLabelRead");
	pgCells.put("labelWriteClass","dataLabelWrite");
	...
	labelName = "All tests on this page are selected.";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpzShowSelectAllTextForDataPage","pzShowSelectAllTextForDataPage","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzShowSelectAllTextForDataPage",pxUniqueStreamHash+"_9");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_9");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzShowSelectAllTextForDataPage");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_9");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzShowSelectAllTextForDataPage", pxUniqueStreamHash+"_9"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_1();}
...
pzSection.getLayout().setExpandParam("SubSectionpzRFSelectAllTestCasesBB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + " content  layout-content-inline_middle content-inline_middle " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzRFSelectAllTestCasesBB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2== rxD_pzUnitTestCase.pyShowSelectAllLink cttrue o2!= rxD_pzUnitTestCase.pySelectedTestsCount ci0", pxUniqueStreamHash+"_10");metadataPage.put("dlChild","true");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2== rxD_pzUnitTestCase.pyShowSelectAllLink cttrue o2!= rxD_pzUnitTestCase.pySelectedTestsCount ci0","D_pzUnitTestCase.pyShowSelectAllLink =true && D_pzUnitTestCase.pySelectedTestsCount !=0", "layout", "visible" )) {pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public int simpleLayoutCell_3( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2== rxD_pzUnitTestCase.pyShowSelectAllLink cttrue o2!= rxD_pzUnitTestCase.pySelectedTestsCount ci0","D_pzUnitTestCase.pyShowSelectAllLink =true && D_pzUnitTestCase.pySelectedTestsCount !=0","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rxD_pzUnitTestCase.pyShowSelectAllLink cttrue o2!= rxD_pzUnitTestCase.pySelectedTestsCount ci0",pxUniqueStreamHash+"_12");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_12");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","D_pzUnitTestCase.pyShowSelectAllLink =true && D_pzUnitTestCase.pySelectedTestsCount !=0");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_12");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rxD_pzUnitTestCase.pyShowSelectAllLink cttrue o2!= rxD_pzUnitTestCase.pySelectedTestsCount ci0", pxUniqueStreamHash+"_12"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_1();
 tools.putSaveValue("ContainerID", "");}
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2!= rxD_pzUnitTestCase.pyShowSelectAllLink cttrue o2!= rxD_pzUnitTestCase.pySelectedTestsCount ci0",pxUniqueStreamHash+"_22");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2!= rxD_pzUnitTestCase.pyShowSelectAllLink cttrue o2!= rxD_pzUnitTestCase.pySelectedTestsCount ci0", pxUniqueStreamHash+"_22"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_2();
 tools.putSaveValue("ContainerID", "");}
...
pzSection.getLayout().setExpandParam("SubSectionpzRFSelectAllTestCasesB","",false);
}
...
public void simpleLayout_3() {
	...
	String paramName = "EXPANDEDSubSectionpzRFSelectAllTestCasesB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2> rxD_pzUnitTestCase.pySelectedTestsCount ci0", pxUniqueStreamHash+"_23");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2> rxD_pzUnitTestCase.pySelectedTestsCount ci0","D_pzUnitTestCase.pySelectedTestsCount >0", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE- PZRFSELECTALLTESTCASES #20180713T142202.780 GMT");
	...
	oStreamProperties_1.put("pyRuleSet", "Pega-AutoTest");
	oStreamProperties_1.put("pyCorrType", "");
	oStreamProperties_1.put("pyStreamName", "pzRFSelectAllTestCases");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE- PZRFSELECTALLTESTCASES #20180713T142202.780 GMT", "Rule- pzRFSelectAllTestCases", "Pega-AutoTest", "08-01-01", "20180713T142202.780 GMT");
}
