...
/**
 * Builds JSP stream DATA-PORTAL!PYFAVORITES.
 */
public class ra_stream_pyfavorites_b087505b1b1155e377216b7769247be6 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyFavorites.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -2026605419;
 ...
 */
	public ra_stream_pyfavorites_b087505b1b1155e377216b7769247be6(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "c89acd8cc2b19f9f2a72a134f5574c9eaec32efe";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PYFAVORITES #20180713T134754.838 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "c89acd8cc2b19f9f2a72a134f5574c9eaec32efe";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyFavorites",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PYFAVORITES #20180713T134754.838 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PYFAVORITES #20180713T134754.838 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PYFAVORITES #20180713T134754.838 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYFAVORITES","Rule-HTML-Section","DATA-PORTAL",false,"","Pega-EndUserUI","08-01-01","RULE-HTML-SECTION DATA-PORTAL PYFAVORITES #20180713T134754.838 GMT","!PYFAVORITES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2026605419)
	};
...
//	RULE-HTML-SECTION DATA-PORTAL PYFAVORITES #20180713T134754.838 GMT:20180713T134754.838 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "7ee4f6909c3729ec27f81a5e5ef70986";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyFavorites",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyFavorites','insKey':'RULE-HTML-SECTION DATA-PORTAL PYFAVORITES #20180713T134754.838 GMT','sectionType':'null'}");
...
config.put("StreamName", "pyFavorites");
...
pega.getUIEngine().getUIAction("openWorkItem", null).register();
pega.getUIEngine().getUIAction("refresh", null).register();
}
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyFavoritesBB"));
...
String sectionTitle = "Following";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Following", "pyCaption");
...
metadataPage.put("uniqueid", "202602210109220716");
...
public int simpleLayoutCell_1( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","No cases are being followed") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	labelName = "No cases are being followed";
...
pzSection.getLayout().setExpandParam("SubSectionpyFavoritesBB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpyFavoritesBB";
...
l_sectionTitle=StringUtils.escapeIntoJavaString(tools.getLocalizedTextForParameterizedString("pyCaption","Following"));
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel6073' data-layout-id='202602210109220706" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel6073'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyFavoritesBB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpyFavoritesBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rxD_pxFavorites.pxResultCount ci0", pxUniqueStreamHash+"_7");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if(pzAuto.handleEvaluateWhen(" o2== rxD_pxFavorites.pxResultCount ci0","D_pxFavorites.pxResultCount==0", "layout", "visible" )) {pzSetExpandParam_2();
...
public void repeatingDataCell_3() {
	...
	tools.appendString("'  ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("SUB_SECTION","pyFavDisplay", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString(" class='");
	tools.appendString(pzSection.getCustomStyle(true,"","dataLabelRead",""));tools.appendString(" gridCell");tools.appendString("  ");tools.appendString(" ' NAME='BASE_REF' BASE_REF='" + tools.getStepPage().getReference() + "' style='");
	tools.appendString("height:49px;");if(Integer.parseInt(tools.getSaveValue("rowsDisplayed")) == 1) {tools.appendString("width:"); if(!tools.getParamValueCSF("D_pxFavoritesPpxResults1colWidthCache1").equals("")) { tools.appendParamCSF("D_pxFavoritesPpxResults1colWidthCache1");} else { tools.appendString("auto;"); }}tools.appendString(""); tools.appendString("'>");
...
public void repeatingDataCell_2() {
	...
	String strFieldValue = "";
		...
		tools.appendString("  style='");
		tools.appendString("height:24px;");tools.appendString("width:"); if(!tools.getParamValueCSF("D_pxFavoritesPpxResults1colWidthCache1").equals("")) { tools.appendParamCSF("D_pxFavoritesPpxResults1colWidthCache1");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
...
pzSection.getLayout().setExpandParam("SubSectionpyFavoritesB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpyFavoritesB";
tools.appendString("PARAM_NAME=\"" + expandParameter);
...
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");
	...
	/***-- Grid HeaderElements: Begin --**/
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel7219' data-layout-id='202602210109220700" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel7219'>" + l_sectionTitle + "</h2><nobr>");
pzHeaderCellContent_1();
tools.appendString("</nobr>");
boolean showContainerIcons=tools.getParamValue("showContainerIcons").equals("true")?true:false;
tools.appendString("<span class='header-element header-title-table'>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyFavoritesB","tdRightStyle");}
if(showContainerIcons){
tools.appendString("</tr></table>");
}
tools.appendString("</span>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div><div class='header-right'></div></div>");
...
if (tmpDeclarePageParams != null && tmpDeclarePageParams.getProperty("D_pxFavorites_pxResults_pyFavorites_1") != null) {
ClipboardPage paramList = tmpDeclarePageParams.getProperty("D_pxFavorites_pxResults_pyFavorites_1").getPageValue();
...
oLog.error("ReloadSections:Expection : "+e.getMessage());
 ...
 ClipboardPage gFCritPageD_pxFavorites_pxResultsL3=null;

 Map selUniqMapD_pxFavorites_pxResultsL3 = null;
tools.appendString("<div ");
tools.appendString(" dataSource='");if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_pxFavorites.pxResults").getReference());tools.appendString("_pyFavorites_1'");
tools.appendString(" hashed-dp-page='");
if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_pxFavorites.pxResults").getReference());tools.appendString("' bRowHovering='false' deferLoadAct='' class=\"");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getProperty("D_pxFavorites.pxResults");
					...
					tools.appendString("' gPropIndex='D_pxFavoritesPpxResults1' editRowIndex='");
					...
					tools.appendString("pyTargetSection=\"\"  threadProcessing=\"false\" bFiltering=\"false\" bRODetails=\"false\" showExpandedAll=\"false\" focusibleGrid = \"true\" dpParams=\"\">");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"D_pxFavoritesPpxResults1colWidthGBL\" id=\"D_pxFavoritesPpxResults1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("D_pxFavoritesPpxResults1colWidthGBL"));tools.appendString("\" />");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"D_pxFavoritesPpxResults1colWidthGBR\" id=\"D_pxFavoritesPpxResults1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("D_pxFavoritesPpxResults1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("D_pxFavoritesPpxResults1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='' PL_PROP='D_pxFavorites.pxResults' PL_PROP_CLASS='Code-Pega-List' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
					...
					if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) {
								 ...
								 itr_3 = tools.getProperty("D_pxFavorites.pxResults").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData.D_pxFavorites.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodesD_pxFavorites.pxResults1") && tools.getParamValue("partialRefresh").equals("false")) {
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= rxD_pxFavorites.pxResultCount ci0","D_pxFavorites.pxResultCount!=0", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
...
public void pyFavDisplay_1() {
pzAuto.emitIncludeStreamReference("pyFavDisplay", null, !tools.hasInputEnabled()?"NoInput":"NoInput", "Rule-HTML-Section", null);
}
public void repeatingDataCell_1() {
	...
	tools.appendString("'  ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("SUB_SECTION","pyFavDisplay", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString(" class='");
	tools.appendString(pzSection.getCustomStyle(true,"","dataLabelRead",""));tools.appendString(" gridCell");tools.appendString("  ");tools.appendString(" ' NAME='BASE_REF' BASE_REF='" + tools.getStepPage().getReference() + "' style='");
	tools.appendString("height:49px;");tools.appendString(""); tools.appendString("'>");
	if(tools.getIfPresent("pyRowStatus") != null){ tools.appendProperty(tools.getProperty(".pyRowStatus"),"Messages",false); }
	{
	String tempRenderSingle = tools.getParamValueCSF("RenderSingle");
	String tempIndex= tools.getSaveValue("index");
...
public void D_pxFavorites_pxResults_1() {
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendToD_pxFavorites.pxResults1")|| tools.getParamValue("partialTrigger").equals("editRowD_pxFavorites.pxResults1") ){
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData.D_pxFavorites.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdropD_pxFavorites.pxResults1")) {
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendToD_pxFavorites.pxResults1") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PYFAVORITES #20180713T134754.838 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyFavorites");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PYFAVORITES #20180713T134754.838 GMT", "Data-Portal pyFavorites", "Pega-EndUserUI", "08-01-01", "20180713T134754.838 GMT");
}
