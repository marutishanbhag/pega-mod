...
/**
 * Builds JSP stream DATA-PORTAL!PYFOLLOWINGWIDGETACTIONS.
 */
public class ra_stream_pyfollowingwidgetactions_874940adb27a10a3200eca90ae7efc22 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyFollowingWidgetActions.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1974741211;
 ...
 */
	public ra_stream_pyfollowingwidgetactions_874940adb27a10a3200eca90ae7efc22(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "d9619a6da295ab1521fd6044284e67ce28e42ddb";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PYFOLLOWINGWIDGETACTIONS #20210506T204028.959 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "d9619a6da295ab1521fd6044284e67ce28e42ddb";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyFollowingWidgetActions",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PYFOLLOWINGWIDGETACTIONS #20210506T204028.959 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PYFOLLOWINGWIDGETACTIONS #20210506T204028.959 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PYFOLLOWINGWIDGETACTIONS #20210506T204028.959 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYFOLLOWINGWIDGETACTIONS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYFOLLOWINGWIDGETACTIONS","Rule-HTML-Section","DATA-PORTAL",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION DATA-PORTAL PYFOLLOWINGWIDGETACTIONS #20210506T204028.959 GMT","!PYFOLLOWINGWIDGETACTIONS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1974741211), 
...
//	RULE-HTML-SECTION DATA-PORTAL PYFOLLOWINGWIDGETACTIONS #20210506T204028.959 GMT:20210506T204028.959 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "393b0e60dd223fd4eca306f2fc620058";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyFollowingWidgetActions",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyFollowingWidgetActions','insKey':'RULE-HTML-SECTION DATA-PORTAL PYFOLLOWINGWIDGETACTIONS #20210506T204028.959 GMT','sectionType':'standard'}");
pzLayout_1();
...
config = new HashMap<String, String>();
config.put("navName", "ItemsIFollowMenu");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			pzPackageRuntime.packageSection("pyFollowingWidgetActions",
			...
			tools.appendString("[\"showMenu\",[{\"dataSource\":\"ItemsIFollowMenu\", \"isNavNLDeferLoaded\":\"false\", \"isNavTypeCustom\":\"false\", \"className\":\"" + tools.getStepPage().getClassName());
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771656157231");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("ItemsIFollowMenu", "", "pyNavigation1771656157231","", false, false, false, false);
		...
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }			if(pega_uiengine_pznavigation.pzUseNewMenu() && true) {
			...
			if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
				try{
					...
					tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771656157234");
					if(pzAuto.isOffline() || false) {
					try{
					pega_uiengine_pzcontrol.pzGetMenu("ItemsIFollowMenu", "", "pyNavigation1771656157234","", false, false, false, false);
					}catch(Exception e){oLog.error(e);}
					}
					tools.appendString("\"},\":event\"]");
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pxUserDashboardWidgetOptions.pyTempTrueFalse\"  SHOW_WHEN=\".pxUserDashboardWidgetOptions.pyTempTrueFalse != true\"");
if(pzAuto.evaluateWhen(".pxUserDashboardWidgetOptions.pyTempTrueFalse != true",null,true)){
	if(currentTemplatingStatus =='N')
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pxUserDashboardWidgetOptions.pyTempTrueFalse", -1);
	}
}catch(Exception e){}
}
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202004281449490803744") + " ");
	if(false || (pzAuto.isOffline() && true) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyFollowingWidgetActions_$CTX$_2");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","BulkUnfollowTooltip\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("BulkUnfollowTooltip", ".pyActionPrompt");
	}
	pyTooltip = "BulkUnfollowTooltip";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyFollowingWidgetActions_"+ referenceString+ "_2'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202004281449490803744") + "  data-ctl='Button'  type='button' role='button' aria-haspopup='true' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771656157237");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("ItemsIFollowMenu", "", "pyNavigation1771656157237","", false, false, false, false);
			}catch(Exception e){oLog.error(e);}
			}
			tools.appendString("\"},\":event\"]");
		...
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }			if(pega_uiengine_pznavigation.pzUseNewMenu() && true) {
			...
			if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
				try{
					...
					tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771656157240");
					if(pzAuto.isOffline() || false) {
					try{
					pega_uiengine_pzcontrol.pzGetMenu("ItemsIFollowMenu", "", "pyNavigation1771656157240","", false, false, false, false);
					}catch(Exception e){oLog.error(e);}
					}
					tools.appendString("\"},\":event\"]");
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","BulkUnfollowTooltip\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				refreshActionRequest.registerFixedParameter("StreamList", "pyFollowingWidget|Rule-HTML-Section|:");
				staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
				tools.appendString("[\"refresh\", [\"otherSection\",\"pyFollowingWidget\", \"\", \"");
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202004301106380708571") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyFollowingWidgetActions_$CTX$_1");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyFollowingWidgetActions_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202004301106380708571") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202004301106380708571-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pxUserDashboardWidgetOptions.pyTempTrueFalse != true", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
	String dataFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202004281449490803744-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
...
pzSection.getLayout().setExpandParam("SubSectionpyFollowingWidgetActionsB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201906180144020082978") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-inline_middle content-inline_middle " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpyFollowingWidgetActionsB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PYFOLLOWINGWIDGETACTIONS #20210506T204028.959 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyFollowingWidgetActions");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PYFOLLOWINGWIDGETACTIONS #20210506T204028.959 GMT", "Data-Portal pyFollowingWidgetActions", "Theme-Cosmos", "04-01-01", "20210506T204028.959 GMT");
}
