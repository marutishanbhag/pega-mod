...
/**
 * Builds JSP stream EMBED-DESKTOP-VALUELIST-ACCESSGROUPS!PZACCESSGROUPSROLES.
 */
public class ra_stream_pzaccessgroupsroles_a000629a70227088d4359c713db5687f extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzAccessGroupsRoles.Embed_Desktop_ValueList_AccessGroups.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -636560496;
 ...
 */
	public ra_stream_pzaccessgroupsroles_a000629a70227088d4359c713db5687f(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "9cf51ebbeee1d1b8eb045d7a00958c657f3d851f";
...
{
/* Instance RULE-HTML-SECTION EMBED-DESKTOP-VALUELIST-ACCESSGROUPS PZACCESSGROUPSROLES #20180713T135209.417 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "9cf51ebbeee1d1b8eb045d7a00958c657f3d851f";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzAccessGroupsRoles",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-DESKTOP-VALUELIST-ACCESSGROUPS PZACCESSGROUPSROLES #20180713T135209.417 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-DESKTOP-VALUELIST-ACCESSGROUPS PZACCESSGROUPSROLES #20180713T135209.417 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-DESKTOP-VALUELIST-ACCESSGROUPS PZACCESSGROUPSROLES #20180713T135209.417 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZACCESSGROUPSROLES", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZACCESSGROUPSROLES","Rule-HTML-Section","EMBED-DESKTOP-VALUELIST-ACCESSGROUPS",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION EMBED-DESKTOP-VALUELIST-ACCESSGROUPS PZACCESSGROUPSROLES #20180713T135209.417 GMT","!PZACCESSGROUPSROLES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-636560496), 
...
//	RULE-HTML-SECTION EMBED-DESKTOP-VALUELIST-ACCESSGROUPS PZACCESSGROUPSROLES #20180713T135209.417 GMT:20180713T135209.417 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "277b16f811cb63ba09d241fa94be221d";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzAccessGroupsRoles",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzAccessGroupsRoles','insKey':'RULE-HTML-SECTION EMBED-DESKTOP-VALUELIST-ACCESSGROUPS PZACCESSGROUPSROLES #20180713T135209.417 GMT','sectionType':'null'}");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzAccessGroupsRoles_"+ referenceString+ "_13'";
	 String securedPropValue = null;
	 com.pega.pegarules.pub.security.PropertySecurityInfo propSecInfo = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().getPropertyInfoForDisplay(tools.getStepPage(),tools.getProperty(".pyRuleName"), tools);
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		 securedPropValue = tools.getProperty(".pyRuleName").getStringValue();
	  }
		tools.appendString("<a href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendFormatted("Rule-Access-Role-Name",StreamBuilder.FMT_NORMAL);tools.appendString("\",\"");
...
public void repeatingDataCell_3() {
	...
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
...
public void repeatingHeaderCell_1() {
	...
	String strFieldValue = ".pyTemplateInputBox";
		...
		tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='ROLES' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("height:22px;");tools.appendString("width:"); if(!tools.getParamValueCSF("PpyUserRoles1colWidthCache1").equals("")) { tools.appendParamCSF("PpyUserRoles1colWidthCache1");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									...
									tools.appendString("ROLES");if(!pzAuto.getBrowserUtils().isIE()){
...
pzSection.getLayout().setExpandParam("SubSectionpzAccessGroupsRolesB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpzAccessGroupsRolesB";
...
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyUserRoles");tools.appendString("_pzAccessGroupsRoles_1'");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList='.pyTemplateInputBox  ' class='yui-skin-sam gPercent");

					if(pega_uiengine_harness.pzInStandardsMode()) {tools.appendString("  ");

					}tools.appendString("' style='");

					tools.appendString("' gPropIndex='PpyUserRoles1' editRowIndex='");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpyUserRoles1colWidthGBL\" id=\"PpyUserRoles1colWidthGBL\" value=\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='pyUserRoles' PL_PROP='");

					
tools.appendString(".pyUserRoles");

					tools.appendString("' PL_PROP_CLASS='Rule-Access-Role-Name' PRIM_PAGE='");
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"1\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("Rule-Access-Role-Name", "tempNoRespg");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-DESKTOP-VALUELIST-ACCESSGROUPS PZACCESSGROUPSROLES #20180713T135209.417 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzAccessGroupsRoles");
