...
/**
 * Builds JSP stream ASSIGN-!HOMEWORKLISTORQUEUEITEM.
 */
public class ra_stream_homeworklistorqueueitem_722fb651ef08719312f2f13fb403cb7e extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.HomeWorklistorQueueItem.Assign_Worklist.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 585495877;
 ...
 */
	public ra_stream_homeworklistorqueueitem_722fb651ef08719312f2f13fb403cb7e(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "6d23c8deee2184c138d3147dd793adc780bf16b3";
...
{
/* Instance RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "6d23c8deee2184c138d3147dd793adc780bf16b3";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("HomeWorklistorQueueItem",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:HOMEWORKLISTORQUEUEITEM", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("HOMEWORKLISTORQUEUEITEM","Rule-HTML-Section","ASSIGN-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT","!HOMEWORKLISTORQUEUEITEM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",585495877), 
		...
		new DependentRuleInfo("PXDEADLINETIME","Rule-Obj-Property","ASSIGN-",true,"Assign-","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY ASSIGN- PXDEADLINETIME #20180713T131151.746 GMT","!PXDEADLINETIME",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYTEMPLATEINPUTBOX","Rule-Obj-Property","@BASECLASS",true,"Assign-","Pega-UIDesign","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT","!PYTEMPLATEINPUTBOX",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYLABEL","Rule-Obj-Property","@BASECLASS",true,"Assign-","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYLABEL #20180713T131156.327 GMT","!PYLABEL",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PXTASKLABEL","Rule-Obj-Property","ASSIGN-",true,"Assign-","Pega-ProcessEngine","08-01-01","RULE-OBJ-PROPERTY ASSIGN- PXTASKLABEL #20180713T132856.101 GMT","!PXTASKLABEL",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT:20210506T204027.513 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "c62b4b8c681b25504072bcf835361df7";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("HomeWorklistorQueueItem",1,"Rule-HTML-Section","{'type':'Section','ruleName':'HomeWorklistorQueueItem','insKey':'RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT','templated':'true','sectionType':'standard'}");
pzLayout_6();
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendFormatted("a99a2cfe-f446-42b9-a831-91559f601000",StreamBuilder.FMT_NORMAL);		tools.appendString("\",\"");
...
try {
	...
	modePage2.put("pyName","HomeWorklistorQueueItem_$CTX$_cd64227c-06ca-4664-97d5-7b1aabbf286d");
		String repeatIndx = "";
	String pyTooltip = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='HomeWorklistorQueueItem_"+ referenceString+ "_cd64227c-06ca-4664-97d5-7b1aabbf286d'";
	 String securedPropValue = null;
		...
		tools.appendFormatted("d9394395-038c-42ea-9ca5-f1df3bad9507",StreamBuilder.FMT_NORMAL);		tools.appendString("\",\"");
...
public int simpleLayoutCell_11( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2&& o2&& wxpzCanPerformAssignment o2!= rx.pxAssignedOperatorID cq o2!= rx.pyAssignmentStatus cq o2!= rx.pyAssignmentStatus cqCompleted","pzCanPerformAssignment && (.pxAssignedOperatorID!=\'\') && .pyAssignmentStatus!=\'\' && .pyAssignmentStatus!=\'Completed\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pyRegions(4).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","right-aligned","right-aligned")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_11( int index) {
	...
	pgCells.put("customROStyles","right-aligned");
	pgCells.put("customRWStyles","right-aligned");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2&& o2&& wxpzCanPerformAssignment o2!= rx.pxAssignedOperatorID cq o2!= rx.pyAssignmentStatus cq o2!= rx.pyAssignmentStatus cqCompleted",pxUniqueStreamHash+"_36");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_36");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzCanPerformAssignment && (.pxAssignedOperatorID!='') && .pyAssignmentStatus!='' && .pyAssignmentStatus!='Completed'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Assign-");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2&& o2&& wxpzCanPerformAssignment o2!= rx.pxAssignedOperatorID cq o2!= rx.pyAssignmentStatus cq o2!= rx.pyAssignmentStatus cqCompleted", pxUniqueStreamHash+"_36"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionHomeWorklistorQueueItemBBBBBB","",false);
}
...
public void simpleLayout_5() {
	...
	String paramName = "EXPANDEDSubSectionHomeWorklistorQueueItemBBBBBB";
...
public void pxDisplayText_4() {String key="f24968e1-008b-43ab-bda7-e4e088e7b878||RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","f24968e1-008b-43ab-bda7-e4e088e7b878"};oCellRuntimeParamsMap.put("f24968e1-008b-43ab-bda7-e4e088e7b878||RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT",paramValues);oControlPathsMap.put("f24968e1-008b-43ab-bda7-e4e088e7b878||RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT",".pyRegions(3).pyCells(5)||.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5)");}


public void pxDisplayText_3() {String key="bc3d42ca-3e49-4a59-9e6c-26e072780490||RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","bc3d42ca-3e49-4a59-9e6c-26e072780490"};oCellRuntimeParamsMap.put("bc3d42ca-3e49-4a59-9e6c-26e072780490||RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT",paramValues);oControlPathsMap.put("bc3d42ca-3e49-4a59-9e6c-26e072780490||RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT",".pyRegions(3).pyCells(4)||.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");}
...
try {
	...
	modePage2.put("pyName","HomeWorklistorQueueItem_$CTX$_385900dd-e045-476d-a80c-8c4d8e53b46b");
		String repeatIndx = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='HomeWorklistorQueueItem_"+ referenceString+ "_385900dd-e045-476d-a80c-8c4d8e53b46b'";
	 String securedPropValue = null;
...
public void pxDisplayText_1() {String key="c37813dd-eed2-4a20-ad5d-a1f93e48b278||RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","64","","","Text","true","c37813dd-eed2-4a20-ad5d-a1f93e48b278"};oCellRuntimeParamsMap.put("c37813dd-eed2-4a20-ad5d-a1f93e48b278||RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT",paramValues);oControlPathsMap.put("c37813dd-eed2-4a20-ad5d-a1f93e48b278||RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT",".pyRegions(3).pyCells(1)||.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
...
public int simpleLayoutCell_4( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyLabel",".pyRegions(3).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pyLabel cq",pxUniqueStreamHash+"_14");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pyLabel cq", pxUniqueStreamHash+"_14"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyLabel",".pyRegions(3).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_1();}
...
public int simpleLayoutCell_5( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pxDeadlineTime",".pyRegions(3).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	...
	tools.putActive(tools.getStepPage().getProperty(".pxDeadlineTime"));
...
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");pxDisplayText_2(".pxDeadlineTime",0,"","","Date Time");
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel",".pxDeadlineTime");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pxDeadlineTime cq",pxUniqueStreamHash+"_19");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_19");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pxDeadlineTime!=''");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Assign-");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_19");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pxDeadlineTime cq", pxUniqueStreamHash+"_19"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pxDeadlineTime",".pyRegions(3).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_2(".pxDeadlineTime",0,"","","Date Time");}
	if (!isExpression && isOffline) {
	// do nothing
	} else {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().endVisibleWhen();
...
public int simpleLayoutCell_6( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pxRefObjectInsName",".pyRegions(3).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20190208082033073432148-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead supporting_text_dataLabelForRead","dataLabelForWrite supporting_text_dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	
	ClipboardProperty propActivePrev = tools.getActive();
	tools.putActive(tools.getStepPage().getProperty(".pxRefObjectInsName"));
	tools.appendString("for='" + tools.getHTMLIDForProperty(true,"label") + "'");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20190208082033073432148-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead supporting_text_dataLabelForRead","dataLabelForWrite supporting_text_dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	pgCells.put("forLabel",".pxRefObjectInsName");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired supporting_text_iconRequired");
	pgCells.put("labelReadClass","dataLabelForRead supporting_text_dataLabelForRead");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pxRefObjectInsName",".pyRegions(3).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_1();labelName = "Task in";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpyAssignUrgencyIsMedium",pxUniqueStreamHash+"_25");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpyAssignUrgencyIsMedium", pxUniqueStreamHash+"_25"); 
	}
	if(pyDLCellVisibility) {
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpyAssignUrgencyIsHigh",pxUniqueStreamHash+"_27");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpyAssignUrgencyIsHigh", pxUniqueStreamHash+"_27"); 
	}
	if(pyDLCellVisibility) {
...
pzSection.getLayout().setExpandParam("SubSectionHomeWorklistorQueueItemBBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	String paramName = "EXPANDEDSubSectionHomeWorklistorQueueItemBBBBB";
...
public void pxTextInput_1() {String key="6546794a-333d-4cc5-9536-15d789d0d76c||RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","true","128","","","Text","true","6546794a-333d-4cc5-9536-15d789d0d76c"};oCellRuntimeParamsMap.put("6546794a-333d-4cc5-9536-15d789d0d76c||RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT",paramValues);oControlPathsMap.put("6546794a-333d-4cc5-9536-15d789d0d76c||RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT",".pyRegions(2).pyCells(1)||.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= rx.pxTaskLabel cq",".pxTaskLabel!=\'\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput",".pxTaskLabel",".pyRegions(2).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing remove-bottom-spacing remove-right-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2019111509301600856546794a-333d-4cc5-9536-15d789d0d76c971-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pxTaskLabel cq",pxUniqueStreamHash+"_9");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_9");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pxTaskLabel!=''");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Assign-");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_9");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pxTaskLabel cq", pxUniqueStreamHash+"_9"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextInput",".pxTaskLabel",".pyRegions(2).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxTextInput_1();}
...
pzSection.getLayout().setExpandParam("SubSectionHomeWorklistorQueueItemBBBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionHomeWorklistorQueueItemBBBB";
...
pzSection.getLayout().setExpandParam("SubSectionHomeWorklistorQueueItemBBB","",false);
}
...
public void simpleLayout_4() {
	...
	String paramName = "EXPANDEDSubSectionHomeWorklistorQueueItemBBB";
...
pzSection.getLayout().setExpandParam("SubSectionHomeWorklistorQueueItemBB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionHomeWorklistorQueueItemBB";
...
pzSection.getLayout().setExpandParam("SubSectionHomeWorklistorQueueItemB","",false);
}
...
public void simpleLayout_6() {
	...
	String paramName = "EXPANDEDSubSectionHomeWorklistorQueueItemB";
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Assign-");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "HomeWorklistorQueueItem");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION ASSIGN- HOMEWORKLISTORQUEUEITEM #20210506T204027.513 GMT", "Assign- HomeWorklistorQueueItem", "Theme-Cosmos", "04-01-01", "20210506T204027.513 GMT");
}
