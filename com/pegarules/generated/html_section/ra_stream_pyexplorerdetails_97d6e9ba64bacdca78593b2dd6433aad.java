...
/**
 * Builds JSP stream PEGA-EXT-ADMINSTUDIO-EXPLORER!PYEXPLORERDETAILS.
 */
public class ra_stream_pyexplorerdetails_97d6e9ba64bacdca78593b2dd6433aad extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyExplorerDetails.Pega_Ext_AdminStudio_Explorer_Overview.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -10579157;
 ...
 */
	public ra_stream_pyexplorerdetails_97d6e9ba64bacdca78593b2dd6433aad(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "458f79b7cb008e240834000fb1c1c47bb7df5b58";
...
{
/* Instance RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYEXPLORERDETAILS #20190128T171652.209 GMT	Pega-Desktop:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "458f79b7cb008e240834000fb1c1c47bb7df5b58";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyExplorerDetails",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYEXPLORERDETAILS #20190128T171652.209 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYEXPLORERDETAILS #20190128T171652.209 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYEXPLORERDETAILS #20190128T171652.209 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYEXPLORERDETAILS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYEXPLORERDETAILS","Rule-HTML-Section","PEGA-EXT-ADMINSTUDIO-EXPLORER",false,"","Pega-Desktop","08-03-01","RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYEXPLORERDETAILS #20190128T171652.209 GMT","!PYEXPLORERDETAILS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-10579157), 
...
//	RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYEXPLORERDETAILS #20190128T171652.209 GMT:20190429T095333.098 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "54c73c118db9dfcbd7ca49fab2bb7fd5";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyExplorerDetails",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyExplorerDetails','insKey':'RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYEXPLORERDETAILS #20190128T171652.209 GMT','sectionType':'standard'}");
pzLayout_2();
...
config.put("pySectionName", "pyExplorerDetails");
pega.getUIEngine().getUIAction("rdlpagination", config).register();
pega.getUIEngine().getUIAction("refresh", null).register();
pega.getUIEngine().getUIAction("refresh", null).register();
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.u.d.hideExplorerPanel");
...
metadataPage.put("pyStyle","height:23px;width:23px;");
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyExplorerDetailsB"));
...
String sectionTitle = "ExtensionLabel";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("ExtensionLabel", "pyCaption");
...
metadataPage.put("uniqueid", "202404190304430786");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("201802281449350346397") + " ");
...
public void getNextPage_1(String listSource, int listStartIndex, int listEndIndex) {
	...
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201802281449350346397" ) + "");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pyExpExplorerSliderLabel", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pyExpExplorerSliderLabel"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpyExplorerDetails168","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pyExpExplorerSliderLabel", secInfo);
}
...
public int simpleLayoutCell_1(  int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyExpExplorerSliderLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   flex flex-row ' ");
	...
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201802281449350346397-" + rowTestID) + " ");
	}else {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyExpExplorerSliderLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
String pyInstanceId ="";
char mode = tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults").getMode();
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  "D_pxExtensions_Requestor_Editable.pxResults AddDelete", expressionId, true);
expressionId = expression.getId();
}
ClipboardProperty rdlPageListProp = tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults");
String rdlPageListPropRef = "D_pxExtensions_Requestor_Editable.pxResults";
if(rdlPageListProp != null) {
rdlPageListPropRef = rdlPageListProp.getReference();
}
String rdlRefreshWhenStr = "D_pxExtensions_Requestor_Editable.pxResults AddDelete";
rdlRefreshWhenStr = rdlRefreshWhenStr.replace("D_pxExtensions_Requestor_Editable.pxResults",rdlPageListPropRef);
if(!StringUtils.isBlank(expressionId)) {
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
} else {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults").getReference(),"",false)); 
}
...
paramsMap.put("extClass", ".pxObjClass");
pyRDDataPageParams.put("pyName","extClass");
 { String propertyRef=".pxObjClass";if(propertyRef.startsWith(".")){		propertyRef = tools.getStepPage().getReference() + propertyRef;}
...
pyRDDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();
paramsMap.put("sortByRank", "true");
pyRDDataPageParams.put("pyName","sortByRank");
pyRDDataPageParams.put("pyValue","{\"value\":\"true\",\"isLiteral\":true}");
pgSectionBody.addMetadataInArray("rdparamslst",pyRDDataPageParams);
pyRDDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();
paramsMap.put("filterOnLoad", "true");
pyRDDataPageParams.put("pyName","filterOnLoad");
pyRDDataPageParams.put("pyValue","{\"value\":\"true\",\"isLiteral\":true}");
pgSectionBody.addMetadataInArray("rdparamslst",pyRDDataPageParams);
pgSectionBody.put("dpname","D_pxExtensions_Requestor_Editable");
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
...
pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201802281449350346397" ) + "");
...
map.put("pyContext", "D_pxExtensions_Requestor_Editable.pxResults");
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults").getReference(),"", false),pyInstanceId);
}
tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
ClipboardProperty cpSource = tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults");
...
dummyPageName = "DummyD_pxExtensions_Requestor_Editable_pxResults";
}
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
itemPage = tools.createPage("Pega-Ext",dummyPageName);
PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
simpleLayoutCell_1(1);
	pega.popStackFrame(itemFrame, false);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
}
}else{
if(mode =='L' || mode =='G'){
Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("pyExplorerDetails",
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.u.d.hideExplorerPanel(\\\"\\\")\"]");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20180122155243077712675") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyExplorerDetails_$CTX$_9");
		String repeatIndx = "";
	String pyTooltip = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyExplorerDetails_"+ referenceString+ "_9'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20180122155243077712675") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
...
pzSection.getLayout().setExpandParam("SubSectionpyExplorerDetailsB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(1)'}") + " class='layout layout-outline layout-outline-explorer_header' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpyExplorerDetailsB";
...
l_sectionTitle=StringUtils.escapeIntoJavaString(tools.getLocalizedTextForParameterizedString("pyCaption","ExtensionLabel"));
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel3063' data-layout-id='202404190304430721" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel3063'>" + l_sectionTitle + "</h2><span class='header-element header-title-table " + pzSection.getCustomStyle(false, "", "", "") + "' style='");
try {
tools.appendString("height:23px;width:23px;");
} catch(Throwable t) {
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyExplorerDetailsB","tdRightStyle");}
if(showContainerIcons){
...
public void putRDLDPParams_1() {
	...
	tools.putParamValue("extClass",tools.getProperty(".pxObjClass").getStringValue());
	tools.putParamValue("sortByRank","true");
	tools.putParamValue("filterOnLoad","true");
	}
...
public void simpleLayout_1() {
		...
		tools.appendString(tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults").getReference()+ "' ");
		tools.appendString("   class=' flex content   layout-content-simple_list content-simple_list  ' ");
		String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
		ClipboardProperty rdlPageListProperty = tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults");
		String rdlPageListPropRef = "D_pxExtensions_Requestor_Editable.pxResults";
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201802281449350346397" ) + " ");
		tools.appendString(">");
		int index = 1;
		...
		rdlPageListProp = tools.getProperty("D_pxExtensions_Requestor_Editable.pxResults");
	...
	String paramName = "EXPANDEDSubSectionpyExplorerDetailsB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYEXPLORERDETAILS #20190128T171652.209 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyExplorerDetails");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYEXPLORERDETAILS #20190128T171652.209 GMT", "Pega-Ext-AdminStudio-Explorer pyExplorerDetails", "Pega-Desktop", "08-03-01", "20190429T095333.098 GMT");
}
