...
/**
 * Builds JSP stream EMBED-TEMPLATEHARNESS!PZHARNESSTEMPLATEEDITOR.
 */
public class ra_stream_pzharnesstemplateeditor_46536e2eca7ceb0f97f6d3e4820be322 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzHarnessTemplateEditor.Embed_TemplateHarness.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -53763177;
 ...
 */
	public ra_stream_pzharnesstemplateeditor_46536e2eca7ceb0f97f6d3e4820be322(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "18574e1345c301061dc237fabe0cb2bdfbb04802";
...
{
/* Instance RULE-HTML-SECTION EMBED-TEMPLATEHARNESS PZHARNESSTEMPLATEEDITOR #20181017T165451.512 GMT	Pega-ProcessArchitect:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "18574e1345c301061dc237fabe0cb2bdfbb04802";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzHarnessTemplateEditor",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-TEMPLATEHARNESS PZHARNESSTEMPLATEEDITOR #20181017T165451.512 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-TEMPLATEHARNESS PZHARNESSTEMPLATEEDITOR #20181017T165451.512 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-TEMPLATEHARNESS PZHARNESSTEMPLATEEDITOR #20181017T165451.512 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZHARNESSTEMPLATEEDITOR", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZHARNESSTEMPLATEEDITOR","Rule-HTML-Section","EMBED-TEMPLATEHARNESS",false,"","Pega-ProcessArchitect","08-02-01","RULE-HTML-SECTION EMBED-TEMPLATEHARNESS PZHARNESSTEMPLATEEDITOR #20181017T165451.512 GMT","!PZHARNESSTEMPLATEEDITOR",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-53763177), 
...
//	RULE-HTML-SECTION EMBED-TEMPLATEHARNESS PZHARNESSTEMPLATEEDITOR #20181017T165451.512 GMT:20181017T165451.512 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "cc6d59bf23439f88a20876e357917f08";
	}

	public String getDefinitionAppliesToClass() {
		return "Embed-TemplateHarness";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzHarnessTemplateEditor",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzHarnessTemplateEditor','insKey':'RULE-HTML-SECTION EMBED-TEMPLATEHARNESS PZHARNESSTEMPLATEEDITOR #20181017T165451.512 GMT','sectionType':'standard'}");
pzLayout_3();
pzLayout_4();
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_23","pzConfigureNotAllowed", secInfo);
}
...
config.put("ActionSection", "pzTemplatePickerModalTemplate");
config.put("NewTaskStatus", "pzSwitchHarnessTemplate");
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzConfigureNotAllowed";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyHasCustomFields\"  SHOW_WHEN=\".pyHasCustomFields == true\"");
if(pzAuto.evaluateWhen(".pyHasCustomFields == true",null,true)){
	if(currentTemplatingStatus =='N')
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyHasCustomFields", -1);
	}
}catch(Exception e){}
}
public void pzSetExpandParam_4() {
pzSection.getLayout().setExpandParam("SubSectionpzHarnessTemplateEditorBBBB","",false);
}
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen", ".pyHasCustomFields == true", expressionId);
...
String paramName = "EXPANDEDSubSectionpzHarnessTemplateEditorBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzConfigureNotAllowed'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzConfigureNotAllowed'}") + ">");
}
pzSetExpandParam_4();
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		keyMap.putString("pyActionName", "pzSwitchHarnessTemplate");
		...
		try{
		pzPackageRuntime.packageLocalAction("pzSwitchHarnessTemplate", offlineUsingPage , strLAClassName);
		pzPackageRuntime.packageSection("pzTemplatePickerModalTemplate", offlineUsingPage , strLAClassName, true);
		}catch(Exception e1){oLog.error("Error generating local action package - " + e1.getMessage());}
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("pzHarnessTemplateEditor",
				...
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pzSwitchHarnessTemplate\",\"true\",\":event\",\"\",\""+streamType+"\",\"\",\"pzTemplatePickerModalTemplate\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-bottom%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
					} else {
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("change-template-button") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzHarnessTemplateEditor_$CTX$_8");
		String repeatIndx = "";
	String pyTooltip = "";
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Change\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Change", ".pyButtonLabel");
	}
	pyLabel = "Change";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzHarnessTemplateEditor_"+ referenceString+ "_8'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("change-template-button") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Change".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		...
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Change",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutCell_3( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing    " + pzSection.getCustomStyle(false, "","layout-editor-template-label","layout-editor-template-label")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("design-template-name-panel") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + "' >");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	try{
	tools.appendString(StringUtils.crossScriptingFilter(tools.getLocalizedTextForParameterizedString("pyCaption",tools.getProperty(".pyLabel").getStringValue())));
	}catch(Exception ex){
	if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() !='N' ){
	labelName =  ".pyLabel";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	}else{
	tools.appendString(tools.getLocalizedTextForString(".pyCaption",".pyLabel"));
	}
	}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("partialClass","remove-top-spacing remove-left-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("design-template-name-panel")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pgCells.put("customROStyles","layout-editor-template-label");
	pgCells.put("customRWStyles","layout-editor-template-label");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-bottom-spacing remove-right-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("change-template-button-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzHarnessTemplateEditorBBB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201801091637030735424") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + " content  layout-content-simple_list content-simple_list margin-b-0_5x margin-l-0_5x" + "'  ");
		...
		pg_dlmeta.put("customClassName","margin-b-0_5x margin-l-0_5x");
	...
	String paramName = "EXPANDEDSubSectionpzHarnessTemplateEditorBBB";
	metadataPage.put("paramName", paramName);
	...
	metadataPage.put("contCustom","margin-b-0_5x margin-l-0_5x");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
	pzLayoutBody_1();
	containerComponent.endComponent();
	}
...
try {
	...
	cellPage.put("pyStreamName","pzHarnessTemplateEditor");
	...
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Change template\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Change template", ".pyActionPrompt");
	}
	pyTooltip = "Change template";
	...
	HashStringMap instanceKeys = new HashStringMap();
		...
		String proprefAttr = "";	String imgurl = tools.getProperty(".pyImage").getStringValue();
	if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	String strEntryHandle = tools.getProperty(".pyImage").getEntryHandle();
	proprefAttr = "data-propref='"+strEntryHandle+"'";
	}
	String pyIconProperty = ".pyImage";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyImage");
	pyIconProperty = ".pyImage";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("Design_Template_Icon") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzHarnessTemplateEditor_"+ referenceString+ "_4'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Change template\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
		String alttempText = tools.getLocalizedTextForString(".pyActionPrompt","Change template\t" + repeatIndx ,StreamBuilder.FMT_LITERAL);
		int pyIconWidth = 0;
		int pyIconHeight = 0;
		boolean isImgSrcUrl = false;
		ClipboardPage imagePage = null;
		HashStringMap instanceKeys = new HashStringMap();
		String imgurl = tools.getProperty(".pyImage").getStringValue();
		if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
			String strEntryHandle = tools.getProperty(".pyImage").getEntryHandle();
			proprefAttr = "data-propref='"+strEntryHandle+"'";}
		java.net.URL imgurl_ext  = null;
		...
		if(pyIconWidth != 0 || pyIconHeight !=0){
		tools.appendString("<i class='icons' "+proprefAttr+" style='width:"+pyIconWidth+"px;height:"+pyIconHeight+"px;'><img  " + pzCell.getTestIdIfEnabled("Design_Template_Icon") + "  data-ctl='Icon'  ");tools.appendString("src='");
		if(imgurl!=null && ("").equals(imgurl)){
	tools.appendString("'");
		...
		tools.appendString("<i class='icons' "+proprefAttr+"><img  " + pzCell.getTestIdIfEnabled("Design_Template_Icon") + "  data-ctl='Icon' "); tools.appendString(" src='");
		if(imgurl!=null && ("").equals(imgurl)){
	tools.appendString("'");
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("Design_Template_Icon-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxIcon_1();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzHarnessTemplateEditorBB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201801091637030734138") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  layout-content-simple_inline content-simple_inline template-controls-wrapper" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","template-controls-wrapper");
		pg_dlmeta.put("format","simple_inline");
	...
	String paramName = "EXPANDEDSubSectionpzHarnessTemplateEditorBB";
	metadataPage.put("paramName", paramName);
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","standard_dataLabelRead layout-editor-template-label","standard_dataLabelWrite layout-editor-template-label")  + " ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("2016072615120202671095753")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Template") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2016072615120202671095753")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("spanClass","iconRequired _iconRequired");
	pgCells.put("customROStyles","standard_dataLabelRead layout-editor-template-label");
	pgCells.put("customRWStyles","standard_dataLabelWrite layout-editor-template-label");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
...
pzSection.getLayout().setExpandParam("SubSectionpzHarnessTemplateEditorB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201810120537480805167") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-simple_list content-simple_list padding-l-0_5x" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(StringUtils.isBlank(expressionId)) {
			...
			if(!"".equals(strMethodName))
			pg_dlmeta.put("methodnm",strMethodName);
			pg_dlmeta.put("customClassName","padding-l-0_5x");
			pg_dlmeta.put("format","simple_list");
		...
		String paramName = "EXPANDEDSubSectionpzHarnessTemplateEditorB";
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Embed-TemplateHarness");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-TEMPLATEHARNESS PZHARNESSTEMPLATEEDITOR #20181017T165451.512 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzHarnessTemplateEditor");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-TEMPLATEHARNESS PZHARNESSTEMPLATEEDITOR #20181017T165451.512 GMT", "Embed-TemplateHarness pzHarnessTemplateEditor", "Pega-ProcessArchitect", "08-02-01", "20181017T165451.512 GMT");
}
