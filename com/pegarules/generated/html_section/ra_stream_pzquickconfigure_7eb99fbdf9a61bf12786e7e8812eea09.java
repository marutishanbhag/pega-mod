...
/**
 * Builds JSP stream RULE-OBJ-FLOWACTION!PZQUICKCONFIGURE.
 */
public class ra_stream_pzquickconfigure_7eb99fbdf9a61bf12786e7e8812eea09 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzQuickConfigure.Rule_Obj_FlowAction.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -2082195129;
 ...
 */
	public ra_stream_pzquickconfigure_7eb99fbdf9a61bf12786e7e8812eea09(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "91d7376adafe819eb09519a0a0fbd0c95e9fd948";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-FLOWACTION PZQUICKCONFIGURE #20180713T135251.176 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "91d7376adafe819eb09519a0a0fbd0c95e9fd948";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzQuickConfigure",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-FLOWACTION PZQUICKCONFIGURE #20180713T135251.176 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-FLOWACTION PZQUICKCONFIGURE #20180713T135251.176 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-FLOWACTION PZQUICKCONFIGURE #20180713T135251.176 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZQUICKCONFIGURE", 
	"Rule-Obj-Property:PZQUICKCONFIGURE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZQUICKCONFIGURE","Rule-HTML-Section","RULE-OBJ-FLOWACTION",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION RULE-OBJ-FLOWACTION PZQUICKCONFIGURE #20180713T135251.176 GMT","!PZQUICKCONFIGURE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2082195129), 
		new DependentRuleInfo("PZQUICKCONFIGURE","Rule-Obj-Property","@BASECLASS",true,"Rule-Obj-FlowAction","Pega-Desktop","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PZQUICKCONFIGURE #20180713T135013.512 GMT","!PZQUICKCONFIGURE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE-OBJ-FLOWACTION PZQUICKCONFIGURE #20180713T135251.176 GMT:20180713T135251.176 GMT
...
//	RULE-OBJ-PROPERTY @BASECLASS PZQUICKCONFIGURE #20180713T135013.512 GMT:20180713T135013.512 GMT
//	RULE-HTML-PROPERTY PXHIDDEN #20180713T133435.722 GMT:20180713T133435.722 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PZQUICKCONFIGURE #20180713T135013.512 GMT:20180713T135013.512 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "44832f1ef693ed4562ed72522cfa7789";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzQuickConfigure",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzQuickConfigure','insKey':'RULE-HTML-SECTION RULE-OBJ-FLOWACTION PZQUICKCONFIGURE #20180713T135251.176 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_3();
...
config.put("pyPreDataTransform.pyName", "pzToggleQuickConfigView");
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzQuickConfigureBB"));
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Additional creation options", "pyCaption");
...
metadataPage.put("title","Additional creation options");
metadataPage.put("uniqueid", "202602210150200643");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_19","ActionNewTop", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "ActionNewTop"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzQuickConfigure459","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_16","ActionNewTop", secInfo);
}
...
public int simpleLayoutCell_4( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","ActionNewTop",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","ActionNewTop",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzQuickConfigureBB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='layout layout-outline layout-outline-column_emphasis' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpzQuickConfigureBB";
...
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","Additional creation options");
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel358' data-layout-id='202602210150200640" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel358'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzQuickConfigureBB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpzQuickConfigureBB";
	...
	metadataPage.put("prefix","-column_emphasis");
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rx.pzQuickConfigure cttrue", pxUniqueStreamHash+"_20");metadataPage.put("lMode","Inline-block");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2== rx.pzQuickConfigure cttrue",".pzQuickConfigure==true", "layout", "visible" )) {pzSetExpandParam_2();
...
tools.putParamValue("isControlEditableOriginal", true);
	...
	cellPage.put("pyValue",".pzQuickConfigure");
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	cellPage.put("pyID","pzQuickConfigure");
	modePage2.put("pyContent","associated");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2016080516224407393717",true));
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pzQuickConfigure");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pzQuickConfigure", ".pyCaption");
...
boolean bUITemplatized = pzAuto.getUIComponentRuntime().isTemplateRendering();pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);
	tools.appendString("<input  type=\"hidden\"  " + pzCell.getTestIdIfEnabled("2016080516224407393717") + "  id=\"");
		tools.appendString(tools.getHTMLIDForProperty(true,"hidden"));
tools.appendString("\" value=\"");if(bUITemplatized){
	tools.appendString(pzAuto.getUIComponentRuntime().getRuntimeContextTree().generateContextToken("pzQuickConfigure"));}else {
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pzQuickConfigure\"  SHOW_WHEN=\".pzQuickConfigure==true\"");
if(pzAuto.evaluateWhen(".pzQuickConfigure==true",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pzQuickConfigure", -1);
	}
}catch(Exception e){}
}
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2016080516224407382505",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzQuickConfigure_$CTX$_2");
		String repeatIndx = "";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Remove additional configuration options\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Remove additional configuration options", ".pyButtonLabel");
	}
	pyLabel = "Remove additional configuration options";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzQuickConfigure_"+ referenceString+ "_2'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2016080516224407382505") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						pzPackageRuntime.packageSection("pzQuickConfigure",
						...
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzQuickConfigure"));
						staticURLStr.append("&PreDataTransform=pzToggleQuickConfigView");
						tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"\", \"");
						refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
						tools.appendString("=\", \"\", \"pzToggleQuickConfigView,");
						refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
						...
						if(!"".equals(preActParamStr.toString())) {
							...
							if(!"".equals(preDTParamStr.toString())) {
								...
								if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
								pzPackageRuntime.packageDataTransform(tools.getStepPage().getString("pxObjClass"), "pzToggleQuickConfigView");
								}
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Remove additional configuration options",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2016080516224407371430",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzQuickConfigure_$CTX$_1");
		String repeatIndx = "";
	modePage2.put("styles","Simple");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","View additional configuration options\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("View additional configuration options", ".pyButtonLabel");
	}
	pyLabel = "View additional configuration options";
	modePage2.put("pyLabel",pyLabel);
	modePage2.put("captionType","");
	if(expressionId !=null && expressionId.length() > 0){
	modePage2.put("pyExpressionId",expressionId);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzQuickConfigure_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2016080516224407371430") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","View additional configuration options",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString("</a>");												}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pzQuickConfigure!=true", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2016080516224407371430-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2016080516224407382505-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxLink");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
...
public int simpleLayoutCell_3( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_1(".pzQuickConfigure",0,"","","True-False");
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	String reqExpressionId = null;
	String disExpressionId = null;
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_2(".pzQuickConfigure",0,"","","True-False");
	index++;
	return index;
}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzQuickConfigureB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzQuickConfigureB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-FLOWACTION PZQUICKCONFIGURE #20180713T135251.176 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzQuickConfigure");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-FLOWACTION PZQUICKCONFIGURE #20180713T135251.176 GMT", "Rule-Obj-FlowAction pzQuickConfigure", "Pega-Desktop", "08-01-01", "20180713T135251.176 GMT");
}
