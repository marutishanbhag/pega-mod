...
/**
 * Builds JSP stream EMBED-PROPERTYPROMTVALUES!PZPICKLISTPROMPTTABLELISTINPUT.
 */
public class ra_stream_pzpicklistprompttablelistinput_796d289e1fad562c4fcd57e9a5e1a263 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzPicklistPromptTableListInput.Embed_PropertyPromtValues.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1252559754;
 ...
 */
	public ra_stream_pzpicklistprompttablelistinput_796d289e1fad562c4fcd57e9a5e1a263(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "e300ae0027bcf863e5643eb94b428ed34357b4ff";
...
{
/* Instance RULE-HTML-SECTION EMBED-PROPERTYPROMTVALUES PZPICKLISTPROMPTTABLELISTINPUT #20230618T001747.215 GMT	Pega-ProcessArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "e300ae0027bcf863e5643eb94b428ed34357b4ff";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzPicklistPromptTableListInput",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-PROPERTYPROMTVALUES PZPICKLISTPROMPTTABLELISTINPUT #20230618T001747.215 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-PROPERTYPROMTVALUES PZPICKLISTPROMPTTABLELISTINPUT #20230618T001747.215 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-PROPERTYPROMTVALUES PZPICKLISTPROMPTTABLELISTINPUT #20230618T001747.215 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZPICKLISTPROMPTTABLELISTINPUT", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZPICKLISTPROMPTTABLELISTINPUT","Rule-HTML-Section","EMBED-PROPERTYPROMTVALUES",false,"","Pega-ProcessArchitect","08-23-01","RULE-HTML-SECTION EMBED-PROPERTYPROMTVALUES PZPICKLISTPROMPTTABLELISTINPUT #20230618T001747.215 GMT","!PZPICKLISTPROMPTTABLELISTINPUT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1252559754), 
...
//	RULE-HTML-SECTION EMBED-PROPERTYPROMTVALUES PZPICKLISTPROMPTTABLELISTINPUT #20230618T001747.215 GMT:20230618T001747.215 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "0d4bf2ade04a1fe252022253a49659c3";
	}

	public String getDefinitionAppliesToClass() {
		return "Embed-PropertyPromtValues";
	}
...
config.put("pyPreDataTransform.pyName", "pzSetStandardValue");
...
getControlMarkup_1() {
try {
if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyLocalizedValue").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
...
tools.putParamValue("isControlEditableOriginal", true);
	...
	cellPage.put("pyValue",".pyStandardValue");
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	cellPage.put("pyID","pyStandardValue");
	modePage2.put("pyContent","associated");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("202007151509330848341",true));
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyStandardValue");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyStandardValue", ".pyCaption");
...
boolean bUITemplatized = pzAuto.getUIComponentRuntime().isTemplateRendering();pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);
	tools.appendString("<input  type=\"hidden\"  " + pzCell.getTestIdIfEnabled("202007151509330848341") + "  id=\"");
		tools.appendString(tools.getHTMLIDForProperty(true,"hidden"));
tools.appendString("\" value=\"");if(bUITemplatized){
	tools.appendString(pzAuto.getUIComponentRuntime().getRuntimeContextTree().generateContextToken("pyStandardValue"));}else {
...
public void pxTextInput_1() {String key="1||RULE-HTML-SECTION EMBED-PROPERTYPROMTVALUES PZPICKLISTPROMPTTABLELISTINPUT #20230618T001747.215 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","1"};oCellRuntimeParamsMap.put("1||RULE-HTML-SECTION EMBED-PROPERTYPROMTVALUES PZPICKLISTPROMPTTABLELISTINPUT #20230618T001747.215 GMT",paramValues);oControlPathsMap.put("1||RULE-HTML-SECTION EMBED-PROPERTYPROMTVALUES PZPICKLISTPROMPTTABLELISTINPUT #20230618T001747.215 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput",".pyLocalizedValue",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","width-100-pct padding-t-1x padding-r-0_5x","width-100-pct padding-t-1x padding-r-0_5x")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202007151509330848231-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxTextInput");
	pgCells.put("forLabel",".pyLocalizedValue");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","width-100-pct padding-t-1x padding-r-0_5x");
	pgCells.put("customRWStyles","width-100-pct padding-t-1x padding-r-0_5x");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextInput",".pyLocalizedValue",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_1(".pyStandardValue",0,"","","Text");
	return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	String reqExpressionId = null;
	String disExpressionId = null;
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_2(".pyStandardValue",0,"","","Text");
	index++;
	return index;
}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzPicklistPromptTableListInputB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzPicklistPromptTableListInputB";
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Embed-PropertyPromtValues");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-PROPERTYPROMTVALUES PZPICKLISTPROMPTTABLELISTINPUT #20230618T001747.215 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzPicklistPromptTableListInput");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-PROPERTYPROMTVALUES PZPICKLISTPROMPTTABLELISTINPUT #20230618T001747.215 GMT", "Embed-PropertyPromtValues pzPicklistPromptTableListInput", "Pega-ProcessArchitect", "08-23-01", "20230618T001747.215 GMT");
}
