...
/**
 * Builds JSP stream @BASECLASS!PYPROGRESSIVERDLPAGINATORSHOWLESS.
 */
public class ra_stream_pyprogressiverdlpaginatorshowless_60a515a45391d63de0bd79d75e6c2886 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyProgressiveRDLPaginatorShowLess.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1562831130;
 ...
 */
	public ra_stream_pyprogressiverdlpaginatorshowless_60a515a45391d63de0bd79d75e6c2886(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "7fef960705267bc47ae4ce65510d1872723cd8ff";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATORSHOWLESS #20210506T204029.645 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "7fef960705267bc47ae4ce65510d1872723cd8ff";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyProgressiveRDLPaginatorShowLess",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATORSHOWLESS #20210506T204029.645 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATORSHOWLESS #20210506T204029.645 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATORSHOWLESS #20210506T204029.645 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYPROGRESSIVERDLPAGINATORSHOWLESS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYPROGRESSIVERDLPAGINATORSHOWLESS","Rule-HTML-Section","@BASECLASS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATORSHOWLESS #20210506T204029.645 GMT","!PYPROGRESSIVERDLPAGINATORSHOWLESS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1562831130), 
...
//	RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATORSHOWLESS #20210506T204029.645 GMT:20210506T204029.645 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "b550205ab22212ecc03be1ce838d9024";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyProgressiveRDLPaginatorShowLess",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyProgressiveRDLPaginatorShowLess','insKey':'RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATORSHOWLESS #20210506T204029.645 GMT','templated':'true','sectionType':'standard'}");
pzLayout_1();
...
config.put("pyFunctionName", "pega.desktop.infinity.rdlShowLess");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.infinity.rdlShowLess(event)\"]");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2019031407413508163787") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyProgressiveRDLPaginatorShowLess_$CTX$_efe98670-4e42-4654-a5ad-dfdc3dff2f22");
		String repeatIndx = "";
	String pyTooltip = "";
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","View less\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("View less", ".pyButtonLabel");
	}
	pyLabel = "View less";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyProgressiveRDLPaginatorShowLess_"+ referenceString+ "_efe98670-4e42-4654-a5ad-dfdc3dff2f22'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2019031407413508163787") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="View less".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		...
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","View less",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2019031407413508163787-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","margin-auto");
	pgCells.put("customRWStyles","margin-auto");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pyRegions(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpyProgressiveRDLPaginatorShowLessB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpyProgressiveRDLPaginatorShowLessB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATORSHOWLESS #20210506T204029.645 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyProgressiveRDLPaginatorShowLess");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATORSHOWLESS #20210506T204029.645 GMT", "@baseclass pyProgressiveRDLPaginatorShowLess", "Theme-Cosmos", "04-01-01", "20210506T204029.645 GMT");
}
