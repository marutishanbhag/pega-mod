...
/**
 * Builds JSP stream PEGA-EXT-ADMINSTUDIO-EXPLORER!PYBACKCONTROL.
 */
public class ra_stream_pybackcontrol_e979b81e66a03b7041ffa555e52e9ebd extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyBackControl.Pega_Ext_AdminStudio_Explorer_Settings_System.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1193771243;
 ...
 */
	public ra_stream_pybackcontrol_e979b81e66a03b7041ffa555e52e9ebd(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "c122417b8f4911f31bd622458ddb759aca85e7c0";
...
{
/* Instance RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYBACKCONTROL #20190508T125132.305 GMT	Pega-Desktop:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "c122417b8f4911f31bd622458ddb759aca85e7c0";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyBackControl",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYBACKCONTROL #20190508T125132.305 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYBACKCONTROL #20190508T125132.305 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYBACKCONTROL #20190508T125132.305 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYBACKCONTROL", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYBACKCONTROL","Rule-HTML-Section","PEGA-EXT-ADMINSTUDIO-EXPLORER",false,"","Pega-Desktop","08-03-01","RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYBACKCONTROL #20190508T125132.305 GMT","!PYBACKCONTROL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1193771243), 
...
//	RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYBACKCONTROL #20190508T125132.305 GMT:20190508T125132.305 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "e15d0ac5f728ea69b47499039c41043d";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyBackControl",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyBackControl','insKey':'RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYBACKCONTROL #20190508T125132.305 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("pyFunctionName", "pega.u.d.clearDirtyState");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.u.d.clearDirtyState()\"]");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20180409131459002267102") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyBackControl_$CTX$_1");
		String repeatIndx = "";
	String pyTooltip = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyBackControl_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20180409131459002267102") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","express-back","express-back")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20180409131459002267102-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpyBackControlB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201905080756040387582") + " ");
	...
	String paramName = "EXPANDEDSubSectionpyBackControlB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYBACKCONTROL #20190508T125132.305 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyBackControl");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PYBACKCONTROL #20190508T125132.305 GMT", "Pega-Ext-AdminStudio-Explorer pyBackControl", "Pega-Desktop", "08-03-01", "20190508T125132.305 GMT");
}
