...
/**
 * Builds JSP stream PEGA-EXT-EXPEXPLORER-EXPLOREDATA!PYEXPRESSEXPLORERTABS.
 */
public class ra_stream_pyexpressexplorertabs_131a22a2d08260d6dde564955beddb9b extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyExpressExplorerTabs.Pega_Ext_ExpExplorer_ExploreData.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1281716394;
 ...
 */
	public ra_stream_pyexpressexplorertabs_131a22a2d08260d6dde564955beddb9b(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "b2b311d23aafbc17a93bd0962bd30389ed6ea997";
...
{
/* Instance RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-EXPLOREDATA PYEXPRESSEXPLORERTABS #20230618T002046.003 GMT	Pega-EndUserUI:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "b2b311d23aafbc17a93bd0962bd30389ed6ea997";
...
/*
 * Begin RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-EXPLOREDATA PYEXPRESSEXPLORERTABS #20230618T002046.003 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-EXPLOREDATA PYEXPRESSEXPLORERTABS #20230618T002046.003 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-EXPLOREDATA PYEXPRESSEXPLORERTABS #20230618T002046.003 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYEXPRESSEXPLORERTABS","Rule-HTML-Section","PEGA-EXT-EXPEXPLORER-EXPLOREDATA",false,"","Pega-EndUserUI","08-23-01","RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-EXPLOREDATA PYEXPRESSEXPLORERTABS #20230618T002046.003 GMT","!PYEXPRESSEXPLORERTABS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1281716394), 
...
//	RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-EXPLOREDATA PYEXPRESSEXPLORERTABS #20230618T002046.003 GMT:20230618T002046.003 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "0feef87510772ff22f0bf93e92b7c589";
	}

	public String getDefinitionAppliesToClass() {
		return "Pega-Ext-ExpExplorer-ExploreData";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyExpressExplorerTabs",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyExpressExplorerTabs','insKey':'RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-EXPLOREDATA PYEXPRESSEXPLORERTABS #20230618T002046.003 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("preActivity", "pyPreLPHarnessActivity");
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("express-tab-exploredata",true));
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
	 ...
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("express-tab-exploredata") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	tools.appendString("],[\"showHarnessWrapper\",[\"newDocument\",\"");
		...
		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pxObjClass")+"~#");	tools.appendString("\",\"");

		tools.appendFormatted("pzExpressLPHarness",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");

		tools.appendFormatted("pyPreLPHarnessActivity",StreamBuilder.FMT_NORMAL);	tools.appendString("\",");
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " data-tour-id='tour-exploredata' class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","no-menu icon-tile centered","no-menu icon-tile centered")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("tourId"," data-tour-id='tour-exploredata'");
	pgCells.put("partialClass","remove-left-spacing remove-right-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("express-tab-exploredata-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805160820580523596") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  set-width-auto pointer  layout-content-inline content-inline  clearfix" + "'  ");
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Pega-Ext-ExpExplorer-ExploreData");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-EXPLOREDATA PYEXPRESSEXPLORERTABS #20230618T002046.003 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-EXPLOREDATA PYEXPRESSEXPLORERTABS #20230618T002046.003 GMT", "Pega-Ext-ExpExplorer-ExploreData pyExpressExplorerTabs", "Pega-EndUserUI", "08-23-01", "20230618T002046.003 GMT");
}
