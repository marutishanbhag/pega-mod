...
/**
 * Builds JSP stream RULE-OBJ-CLASS!PZSIMPLECASESTAGEANDLABELDISPLAY.
 */
public class ra_stream_pzsimplecasestageandlabeldisplay_92f36a6655ea361acbc7ea40f1522f4a extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSimpleCaseStageAndLabelDisplay.Rule_Obj_Class.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1267362638;
 ...
 */
	public ra_stream_pzsimplecasestageandlabeldisplay_92f36a6655ea361acbc7ea40f1522f4a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "ece744a93221f39698994fe1ee6cbe8720eda2bc";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-CLASS PZSIMPLECASESTAGEANDLABELDISPLAY #20200804T075456.196 GMT	Pega-ProcessEngine:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "ece744a93221f39698994fe1ee6cbe8720eda2bc";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSimpleCaseStageAndLabelDisplay",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-CLASS PZSIMPLECASESTAGEANDLABELDISPLAY #20200804T075456.196 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-CLASS PZSIMPLECASESTAGEANDLABELDISPLAY #20200804T075456.196 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-CLASS PZSIMPLECASESTAGEANDLABELDISPLAY #20200804T075456.196 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZSIMPLECASESTAGEANDLABELDISPLAY", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSIMPLECASESTAGEANDLABELDISPLAY","Rule-HTML-Section","RULE-OBJ-CLASS",false,"","Pega-ProcessEngine","08-06-01","RULE-HTML-SECTION RULE-OBJ-CLASS PZSIMPLECASESTAGEANDLABELDISPLAY #20200804T075456.196 GMT","!PZSIMPLECASESTAGEANDLABELDISPLAY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1267362638), 
...
//	RULE-HTML-SECTION RULE-OBJ-CLASS PZSIMPLECASESTAGEANDLABELDISPLAY #20200804T075456.196 GMT:20200804T075456.196 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "20dd69f376e9f44d8c487c462dfab7ee";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSimpleCaseStageAndLabelDisplay",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSimpleCaseStageAndLabelDisplay','insKey':'RULE-HTML-SECTION RULE-OBJ-CLASS PZSIMPLECASESTAGEANDLABELDISPLAY #20200804T075456.196 GMT','templated':'true','editable':'true','sectionType':'standard'}");
pzLayout_2();
...
config.put("pyFunctionName", "ExpressExtSlider.closeSlider");
...
public void buildSection_2() { 
	...
	secInfo.put("usingPage","D_pxCaseType");
	...
	declareParams.put("InsKey",".pzInsKey");
	declareParams.put("ClassName",".pyClassName");
	secInfo.put("decParamList","{'InsKey':'"+ "#~"+pzAuto.getUIComponentRuntime().generateActionToken(tools.getProperty(".pzInsKey").getReference())+"~#" +"','ClassName':'"+ "#~"+pzAuto.getUIComponentRuntime().generateActionToken(tools.getProperty(".pyClassName").getReference())+"~#" +"'}");
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  ".pzInsKey Changes || .pyClassName Changes", expressionId);
		if(!StringUtils.isBlank(expressionId)) {
			secInfo.put("pyExpressionId", expressionId);
		}
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pzSimpleStageDisplay", secInfo);
	}
...
public void sectionBodyIncludeInCell_2() { 
	...
	"pzSimpleStageDisplay", "D_pxCaseType","");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	generateClientWhenDiv_2();
	
	{tools.putParamValue("InsKey",tools.getProperty(".pzInsKey").getStringValue());tools.putParamValue("ClassName",tools.getProperty(".pyClassName").getStringValue());tools.putParamValue("decParamList","{'InsKey':'"+ "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pzInsKey")+"~#" +"','ClassName':'"+ "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyClassName")+"~#" +"'}");tools.putParamValue("sectionPageNameBase","D_pxCaseType");}try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));	ct_controlAction.trackValueChanges(tools.getProperty(".pzInsKey"), -1);	ct_controlAction.trackValueChanges(tools.getProperty(".pyClassName"), -1);}}catch(Exception e){}
	...
	String sectionName = "pzSimpleStageDisplay"; 
	String usingPage = null;
	usingPage = "D_pxCaseType";
...
pzSection.getLayout().setExpandParam("SubSectionCellpzSimpleCaseStageAndLabelDisplay919","",false);
}
...
if(currentTemplatingStatus =='N'){
try {
tools.appendString(" data-dprw=\".pzInsKey Changes || .pyClassName Changes\" ");
} catch(Throwable t) {
...
public void buildSection_1() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzSimpleStageDisplay", secInfo);
	}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"ExpressExtSlider.closeSlider()\"]");
...
{com.google.gson.JsonObject jObject = new com.google.gson.JsonObject();com.google.gson.JsonObject propRefJSON = new com.google.gson.JsonObject();com.google.gson.JsonObject jObjectWithParam = new com.google.gson.JsonObject();if(!"{}".equals(propRefJSON.toString())){jObjectWithParam.add("pyDataTransformDynamicParams",propRefJSON);}jObjectWithParam.addProperty("pyDataTransform", "pzSetExpressSkinForEditMode");jObjectWithParam.add("pyDataTransformParams", jObject);
		...
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }			tools.appendString("[\"runScript\", [\"ExpressExtSlider.closeSlider()\"]");
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("201806181522270121484a5a65-4265-40a3-a1c5-52d4fd8193a5756",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzSimpleCaseStageAndLabelDisplay_$CTX$_484a5a65-4265-40a3-a1c5-52d4fd8193a5");
		String repeatIndx = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzSimpleCaseStageAndLabelDisplay_"+ referenceString+ "_484a5a65-4265-40a3-a1c5-52d4fd8193a5'";
	 ...
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("201806181522270121484a5a65-4265-40a3-a1c5-52d4fd8193a5756") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
...
{com.google.gson.JsonObject jObject = new com.google.gson.JsonObject();com.google.gson.JsonObject propRefJSON = new com.google.gson.JsonObject();com.google.gson.JsonObject jObjectWithParam = new com.google.gson.JsonObject();if(!"{}".equals(propRefJSON.toString())){jObjectWithParam.add("pyDataTransformDynamicParams",propRefJSON);}jObjectWithParam.addProperty("pyDataTransform", "pzSetExpressSkinForEditMode");jObjectWithParam.add("pyDataTransformParams", jObject);
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			...
			String repeatIndx = "";tools.appendString(" class='Strong");tools.appendString("'");
		tools.appendString(" >");
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyLabel",".pyRegions(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","stage-header text-bold","stage-header text-bold")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201806181522270121484a5a65-4265-40a3-a1c5-52d4fd8193a5756-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pgCells.put("customROStyles","stage-header text-bold");
	pgCells.put("customRWStyles","stage-header text-bold");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyLabel",".pyRegions(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzSimpleStageDisplay",".pyRegions(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzSimpleStageDisplay",".pyRegions(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzSimpleCaseStageAndLabelDisplayB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)','region':'A'}") + " class='" + "flex  content  layout-content-stacked content-stacked content-items-maxwidth" + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzSimpleCaseStageAndLabelDisplayB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-CLASS PZSIMPLECASESTAGEANDLABELDISPLAY #20200804T075456.196 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzSimpleCaseStageAndLabelDisplay");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-CLASS PZSIMPLECASESTAGEANDLABELDISPLAY #20200804T075456.196 GMT", "Rule-Obj-Class pzSimpleCaseStageAndLabelDisplay", "Pega-ProcessEngine", "08-06-01", "20200804T075456.196 GMT");
}
