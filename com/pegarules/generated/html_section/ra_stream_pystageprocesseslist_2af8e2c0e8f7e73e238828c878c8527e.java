...
/**
 * Builds JSP stream EMBED-STAGEPROCESSHISTORY!PYSTAGEPROCESSESLIST.
 */
public class ra_stream_pystageprocesseslist_2af8e2c0e8f7e73e238828c878c8527e extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyStageProcessesList.Embed_StageProcessHistory.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1135049905;
 ...
 */
	public ra_stream_pystageprocesseslist_2af8e2c0e8f7e73e238828c878c8527e(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "c3b262dbf7db9f9ae5ccea92b114f48598bd6bd8";
...
{
/* Instance RULE-HTML-SECTION EMBED-STAGEPROCESSHISTORY PYSTAGEPROCESSESLIST #20210506T204030.137 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "c3b262dbf7db9f9ae5ccea92b114f48598bd6bd8";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyStageProcessesList",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-STAGEPROCESSHISTORY PYSTAGEPROCESSESLIST #20210506T204030.137 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-STAGEPROCESSHISTORY PYSTAGEPROCESSESLIST #20210506T204030.137 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-STAGEPROCESSHISTORY PYSTAGEPROCESSESLIST #20210506T204030.137 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYSTAGEPROCESSESLIST"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYSTAGEPROCESSESLIST","Rule-HTML-Section","EMBED-STAGEPROCESSHISTORY",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION EMBED-STAGEPROCESSHISTORY PYSTAGEPROCESSESLIST #20210506T204030.137 GMT","!PYSTAGEPROCESSESLIST",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1135049905)
	};
...
//	RULE-HTML-SECTION EMBED-STAGEPROCESSHISTORY PYSTAGEPROCESSESLIST #20210506T204030.137 GMT:20230530T103205.367 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "60d352868991746fce1a9e637e04575c";
	}

	public String getDefinitionAppliesToClass() {
		return "Embed-StageProcessHistory";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyStageProcessesList",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyStageProcessesList','insKey':'RULE-HTML-SECTION EMBED-STAGEPROCESSHISTORY PYSTAGEPROCESSESLIST #20210506T204030.137 GMT','sectionType':'standard'}");
pzLayout_3();
...
config.put("pySectionName", "pyStageProcessesList");
...
public void getNextPage_1(String listSource, int listStartIndex, int listEndIndex) {
	...
	map.put("pxDataSourceId", pxUniqueStreamHash+"_8");
	...
	nextPageMetadata.put("datasrcid",pxUniqueStreamHash+"_8");
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201806191354100262223" ) + "");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pyStageStepList", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pyStageStepList"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpyStageProcessesList192","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pyStageStepList", secInfo);
}
...
public int simpleLayoutCell_1(  int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyStageStepList",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","margin-0","margin-0")  + " flex flex-row ' ");
	...
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201806191354100262223-" + rowTestID) + " ");
	}else {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyStageStepList",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
String pyInstanceId ="";
char mode = tools.getProperty(".pxSteps").getMode();
...
pgSection.put("liveUI","" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + ""); 
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  ".pxSteps AddDelete", expressionId, true);
expressionId = expression.getId();
}
ClipboardProperty rdlPageListProp = tools.getProperty(".pxSteps");
String rdlPageListPropRef = ".pxSteps";
if(rdlPageListProp != null) {
rdlPageListPropRef = rdlPageListProp.getReference();
}
String rdlRefreshWhenStr = ".pxSteps AddDelete";
rdlRefreshWhenStr = rdlRefreshWhenStr.replace(".pxSteps",rdlPageListPropRef);
if(!StringUtils.isBlank(expressionId)) {
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pxSteps").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
} else {
pgSectionBody.put("pageListProp", ".pxSteps");
}
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pzPackageRuntime.packageProperty(tools.getProperty(".pxSteps").getReference(), null);
}
...
pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201806191354100262223" ) + "");
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pxSteps").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pxSteps").getReference(),"", false),pyInstanceId);
}
tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
ClipboardProperty cpSource = tools.getProperty(".pxSteps");
...
dummyPageName = "Dummy_pxSteps";
}
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pxSteps").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
itemPage = tools.createPage("Embed-StageStepHistory",dummyPageName);
PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
simpleLayoutCell_1(1);
	pega.popStackFrame(itemFrame, false);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pxSteps").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
}
}else{
if(mode =='L' || mode =='G'){
Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pxSteps").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pxSteps").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("pyStageProcessesList",
...
pzSection.getLayout().setExpandParam("SubSectionpyStageProcessesListBB","",false);
}
...
public void simpleLayout_1() {
	...
	tools.appendString(tools.getProperty(".pxSteps").getReference()+ "' ");
	tools.appendString(" " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + "  class=' flex content   layout-content-stacked content-stacked  ' ");
	String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
	ClipboardProperty rdlPageListProperty = tools.getProperty(".pxSteps");
	String rdlPageListPropRef = ".pxSteps";
...
try {
tools.appendString("RWP=\".pxSteps\" RW=\"");
tools.appendString(rdlRefreshWhenStr);
tools.appendString("\"");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
	tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201806191354100262223" ) + " ");
	tools.appendString(">");
	int index = 1;
	...
	rdlPageListProp = tools.getProperty(".pxSteps");
...
String paramName = "EXPANDEDSubSectionpyStageProcessesListBB";
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}");
...
pzSection.getLayout().setExpandParam("SubSectionpyStageProcessesListB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202305290800480806946") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default " + "'  " + "role='list' tabindex='-1' ");
	...
	String paramName = "EXPANDEDSubSectionpyStageProcessesListB";
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Embed-StageProcessHistory");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-STAGEPROCESSHISTORY PYSTAGEPROCESSESLIST #20210506T204030.137 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyStageProcessesList");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-STAGEPROCESSHISTORY PYSTAGEPROCESSESLIST #20210506T204030.137 GMT", "Embed-StageProcessHistory pyStageProcessesList", "Theme-Cosmos", "04-01-01", "20230530T103205.367 GMT");
}
