...
/**
 * Builds JSP stream RULE-!PYGFWTOOLBARGUIDEMODE.
 */
public class ra_stream_pygfwtoolbarguidemode_3177bca900a7f3a1ed7672aa77c84dd3 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyGFWToolbarGuideMode.Rule_Obj_Flow.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1076354731;
 ...
 */
	public ra_stream_pygfwtoolbarguidemode_3177bca900a7f3a1ed7672aa77c84dd3(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "e9324c1a103930d915eb4cf28fcaa6f6ad49ee05";
...
{
/* Instance RULE-HTML-SECTION RULE- PYGFWTOOLBARGUIDEMODE #20180713T140935.737 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "e9324c1a103930d915eb4cf28fcaa6f6ad49ee05";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyGFWToolbarGuideMode",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE- PYGFWTOOLBARGUIDEMODE #20180713T140935.737 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE- PYGFWTOOLBARGUIDEMODE #20180713T140935.737 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE- PYGFWTOOLBARGUIDEMODE #20180713T140935.737 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYGFWTOOLBARGUIDEMODE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYGFWTOOLBARGUIDEMODE","Rule-HTML-Section","RULE-",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION RULE- PYGFWTOOLBARGUIDEMODE #20180713T140935.737 GMT","!PYGFWTOOLBARGUIDEMODE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1076354731), 
...
//	RULE-HTML-SECTION RULE- PYGFWTOOLBARGUIDEMODE #20180713T140935.737 GMT:20180713T140935.737 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "cb12717bc600d97b914757a6a8a5407e";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyGFWToolbarGuideMode",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyGFWToolbarGuideMode','insKey':'RULE-HTML-SECTION RULE- PYGFWTOOLBARGUIDEMODE #20180713T140935.737 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
...
config.put("pyActivity", "pzModelerToggleGuideMode");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-hover='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"changeStyle\",[\":event\",\"background-position:-546px -26px&#59;\", \"1\"]");

		tools.appendString("]");isBehaviorAdded = true;
		tools.appendString("]' ");isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"ViewerManager.executeAction({name:\\u0022guide\\u0022, state:\\u0022off\\u0022})\"]");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						pzPackageRuntime.packageSection("pyGFWToolbarGuideMode",
						...
						refreshActionRequest.registerFixedParameter("PreActivity", "pzModelerToggleGuideMode");
						staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pyGFWToolbarGuideMode"));
						staticURLStr.append("&PreActivity=pzModelerToggleGuideMode");
						tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"pzModelerToggleGuideMode\", \"");
...
try {
	...
	cellPage.put("pyStreamName","pyGFWToolbarGuideMode");
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Turn Alignment Snapping OFF\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Turn Alignment Snapping OFF", ".pyActionPrompt");
	}
	pyTooltip = "Turn Alignment Snapping OFF";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2015021809082603587967") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pyGFWToolbarGuideMode_"+ referenceString+ "_3'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Turn Alignment Snapping OFF\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
			if(com.pega.pegarules.jsptags.WhenTag.evaluateWhen(pega, "pyIsReadOnly", null, false)){
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015021809082603587967") + "  ");
		...
		tools.appendString(") no-repeat;background-position:-546px -52px; width:26px; height:26px;' ");
			tools.appendString(" title= '");
			tools.appendString(tempText+" ' ");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-hover='[");if(isBehaviorAdded && true){ tools.appendString(","); }		tools.appendString("[\"changeStyle\",[\":event\",\"background-position:-546px -26px&#59;\", \"1\"]");

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }		tools.appendString("[\"changeStyle\",[\":event\",\"background-position:-546px -26px&#59;\", \"1\"]");
		...
		tools.appendString(") no-repeat;background-position:-546px top; width:26px; height:26px;' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" title= '");
			tools.appendString(tempText+" ' ");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-hover='[");if(isBehaviorAdded && true){ tools.appendString(","); }									tools.appendString("[\"changeStyle\",[\":event\",\"background-position:-546px -26px&#59;\", \"1\"]");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015021809082603587967-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpyGFWToolbarGuideModeBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201807101426360081779") + " ");
	...
	String paramName = "EXPANDEDSubSectionpyGFWToolbarGuideModeBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rx.pyModelerGuideModeON cttrue", pxUniqueStreamHash+"_15");metadataPage.put("lMode","Inline-block");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if(pzAuto.handleEvaluateWhen(" o2== rx.pyModelerGuideModeON cttrue",".pyModelerGuideModeON == true", "layout", "visible" )) {pzSetExpandParam_2();
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }									{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
										com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
											...
											StringBuffer preDTParamStr = new StringBuffer();
											refreshActionRequest.registerFixedParameter("pyActivity", "ReloadSection");
											refreshActionRequest.registerFixedParameter("StreamList", "pyGFWToolbarGridMode|Rule-HTML-Section|:");
											staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
											tools.appendString("[\"refresh\", [\"otherSection\",\"pyGFWToolbarGridMode\", \"\", \"");
											refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
											tools.appendString("=\", \"\", \",");
											refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
											tools.appendString("\",\":event\",\"\",[\"");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }													tools.appendString("[\"runScript\", [\"ViewerManager.executeAction({name:\\u0022guide\\u0022, state:\\u0022on\\u0022})\"]");

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }													tools.appendString("[\"runScript\", [\"ViewerManager.executeAction({name:\\u0022grid\\u0022, state:\\u0022off\\u0022})\"]");
...
try {
	...
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Turn Alignment Snapping ON\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Turn Alignment Snapping ON", ".pyActionPrompt");
	}
	pyTooltip = "Turn Alignment Snapping ON";
	modePage1.put("tooltip",pyTooltip);
	modePage1.put("helpertype","tooltip");
	modePage1.put("isActionabale","true");
	modePage1.put("isClickable","true");
	...
	modePage1.put("iconSrc","image");
	modePage1.put("pyFormatTypeActionable","none");
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2015021809082603573545") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyGFWToolbarGuideMode_"+ referenceString+ "_1'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Turn Alignment Snapping ON\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
			if(com.pega.pegarules.jsptags.WhenTag.evaluateWhen(pega, "pyIsReadOnly", null, false)){
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015021809082603573545") + "  ");
		tools.appendString("onclick_func='pd(event);' href='' ");
		tools.appendString(" data-ctl='Icon' "); tools.appendString(" IsSprite='true' href_original='' class='cursordefault' disabled='disabled' style='overflow:hidden;background: url(");
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing remove-left-spacing remove-right-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015021809082603573545-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxIcon");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
...
pzSection.getLayout().setExpandParam("SubSectionpyGFWToolbarGuideModeB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201807101426360081496") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
	...
	String paramName = "EXPANDEDSubSectionpyGFWToolbarGuideModeB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= rx.pyModelerGuideModeON cttrue", pxUniqueStreamHash+"_8");metadataPage.put("lMode","Inline-block");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= rx.pyModelerGuideModeON cttrue",".pyModelerGuideModeON != true", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE- PYGFWTOOLBARGUIDEMODE #20180713T140935.737 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyGFWToolbarGuideMode");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE- PYGFWTOOLBARGUIDEMODE #20180713T140935.737 GMT", "Rule- pyGFWToolbarGuideMode", "Pega-ProcessArchitect", "08-01-01", "20180713T140935.737 GMT");
}
