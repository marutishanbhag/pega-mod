...
/**
 * Builds JSP stream EMBED-STAGE!PYPREVIEWPANEL.
 */
public class ra_stream_pypreviewpanel_84de8096c83a313e2cb6f855f479e864 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyPreviewPanel.Embed_Stage.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1837928590;
 ...
 */
	public ra_stream_pypreviewpanel_84de8096c83a313e2cb6f855f479e864(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "20ea6bc5c603e84f19505dd1657da7291570eab1";
...
{
/* Instance RULE-HTML-SECTION EMBED-STAGE PYPREVIEWPANEL #20180713T140844.657 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "20ea6bc5c603e84f19505dd1657da7291570eab1";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyPreviewPanel",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-STAGE PYPREVIEWPANEL #20180713T140844.657 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-STAGE PYPREVIEWPANEL #20180713T140844.657 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-STAGE PYPREVIEWPANEL #20180713T140844.657 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYPREVIEWPANEL", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYPREVIEWPANEL","Rule-HTML-Section","EMBED-STAGE",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION EMBED-STAGE PYPREVIEWPANEL #20180713T140844.657 GMT","!PYPREVIEWPANEL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1837928590), 
...
//	RULE-HTML-SECTION EMBED-STAGE PYPREVIEWPANEL #20180713T140844.657 GMT:20180713T140844.657 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "775dd1873d7eed5ac4a9775fd923be71";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyPreviewPanel",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyPreviewPanel','insKey':'RULE-HTML-SECTION EMBED-STAGE PYPREVIEWPANEL #20180713T140844.657 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_5();
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_12")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyPreviewPanel_"+ referenceString+ "_16'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20151006082514001966983") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
		...
		if((com.pega.pegarules.jsptags.WhenTag.evaluateWhen(pega,"!pzIsUserActionsTab",null,false)
			...
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				staticURLStr.append("&PreActivity=pzAddProcessDoStepPaletteAction");
				tools.appendString("[\"refresh\", [\"otherSection\",\"pzDisplayCaseTypeLifeCycle\", \"pzAddProcessDoStepPaletteAction\", \"");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
				tools.appendString("ContextReference=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pxPageReference")+"~#");				refreshActionRequestD.registerFixedParameter("ContextReference",".pxPageReference");
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"StepAction\":\"AddShape\"");
				refreshActionRequestD.registerFixedParameter("StepAction","AddShape");
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"ShapeType\":\"more\"");
				refreshActionRequestD.registerFixedParameter("ShapeType","more");
				tools.appendString("\", \"\", \",");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
		...
		if((com.pega.pegarules.jsptags.WhenTag.evaluateWhen(pega,"pzIsUserActionsTab",null,false)
								...
								com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
									...
									refreshActionRequest.registerFixedParameter("StreamList", "pzDisplayCaseTypeLifeCycle|Rule-HTML-Section|:");
									staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
									staticURLStr.append("&PreActivity=pzAddAUserActionOrAOptionalProcess");
									tools.appendString("[\"refresh\", [\"otherSection\",\"pzDisplayCaseTypeLifeCycle\", \"pzAddAUserActionOrAOptionalProcess\", \"");
									refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
									tools.appendString("ContextReference=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pxPageReference")+"~#");									refreshActionRequestD.registerFixedParameter("ContextReference",".pxPageReference");
									preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"Action\":\"AddUserAction\"");
									refreshActionRequestD.registerFixedParameter("Action","AddUserAction");
									preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"ShapeType\":\"more\"");
									refreshActionRequestD.registerFixedParameter("ShapeType","more");
									tools.appendString("\", \"\", \",");
									refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty(".pxPageReference"), -1);
		}}catch(Exception e){}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20151006082514001966983-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpyPreviewPanelBBBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpyPreviewPanelBBBB";
...
public void buildSection_3() { 
	...
	secInfo.put("usingPage","SelectedItemPage");
	secInfo.put("isUsingPagePropertyRef",false);
	secInfo.put("doNotConsiderDecParams",false);
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_8","pyPreviewButtonSection", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pyPreviewButtonSection"; 
	String usingPage = null;
	usingPage = "SelectedItemPage";
...
pzSection.getLayout().setExpandParam("SubSectionCellpyPreviewPanel217","",false);
}
...
public void buildSection_2() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_5","pyPreviewButtonSection", secInfo);
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyPreviewButtonSection",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyPreviewPanelBBB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpyPreviewPanelBBB";
	metadataPage.put("paramName", paramName);
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-bottom-spacing float-left set-width-auto   '  STRING_TYPE='layout' RESERVE_SPACE='false'><div class='content-inner set-width-auto'>");
	pzLayout_3();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("partialClass","remove-bottom-spacing float-left set-width-auto");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
...
pzSection.getLayout().setExpandParam("SubSectionpyPreviewPanelBB","",false);
}
...
public void simpleLayout_3() {
	...
	String paramName = "EXPANDEDSubSectionpyPreviewPanelBB";
	metadataPage.put("paramName", paramName);
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= rxSelectedItemPage.pyLabel cq", pxUniqueStreamHash+"_17");metadataPage.put("lMode","Inline-block");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= rxSelectedItemPage.pyLabel cq","SelectedItemPage.pyLabel != \'\'", "layout", "visible" )) {pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_2","pyPreviewPanelDetails", secInfo);
}
...
config.put("pyActivity", "pzAddProcessDoStepPaletteAction");
config.put("StaticActivityParams", "StepAction=AddShape&ShapeType=more");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
config.put("pyActivity", "pzAddAUserActionOrAOptionalProcess");
config.put("StaticActivityParams", "Action=AddUserAction&ShapeType=more");
pega.getUIEngine().getUIAction("refresh", config).register();
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pyPreviewPanelDetails";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"SelectedItemPage",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpyPreviewPanelB","",false);
}
...
String paramName = "EXPANDEDSubSectionpyPreviewPanelB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pyPreviewPanelDetails'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pyPreviewPanelDetails'}") + ">");
}
pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-STAGE PYPREVIEWPANEL #20180713T140844.657 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyPreviewPanel");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-STAGE PYPREVIEWPANEL #20180713T140844.657 GMT", "Embed-Stage pyPreviewPanel", "Pega-ProcessArchitect", "08-01-01", "20180713T140844.657 GMT");
}
