...
/**
 * Builds JSP stream RULE-!RULEFORMSETTINGS.
 */
public class ra_stream_ruleformsettings_25a88e28467422731e4edcc0b80ea85d extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.RuleFormSettings.Rule_RuleSet_Name.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1671580317;
 ...
 */
	public ra_stream_ruleformsettings_25a88e28467422731e4edcc0b80ea85d(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "33a9d6a2e12992f5895f49a657f9c8cb8f175e58";
...
{
/* Instance RULE-HTML-SECTION RULE- RULEFORMSETTINGS #20180713T135302.912 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "33a9d6a2e12992f5895f49a657f9c8cb8f175e58";
...
/*
 * Begin RULE-HTML-SECTION RULE- RULEFORMSETTINGS #20180713T135302.912 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE- RULEFORMSETTINGS #20180713T135302.912 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE- RULEFORMSETTINGS #20180713T135302.912 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("RULEFORMSETTINGS","Rule-HTML-Section","RULE-",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION RULE- RULEFORMSETTINGS #20180713T135302.912 GMT","!RULEFORMSETTINGS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1671580317), 
...
//	RULE-HTML-SECTION RULE- RULEFORMSETTINGS #20180713T135302.912 GMT:20180713T135302.912 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "3983275d24a908d457b618e806a2dcbe";
	}
...
static {
	oPropDefinitions_2.put("Rule-RuleSet-Name.pyMethodStatus ", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyMethodStatus ", "stN10", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pyBaseRule", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyBaseRule", "sSN", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pyRuleName", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyRuleName", "sTY255", true, true, "Default", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pyClassName", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyClassName", "siN", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pxUpdateDateTime", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pxUpdateDateTime", "sMY", true, true, "DateTime-Long", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pxInstanceLockedRuleSet", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pxInstanceLockedRuleSet", "sTY", true, true, "Default", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pxObjClass", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pxObjClass", "sIY", true, true, "Default", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pxCreateDateTime", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pxCreateDateTime", "sMY", true, true, "DateTime-Medium", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pyRuleSetVersion", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyRuleSetVersion", "sTN", false, true, "RuleAttributes", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pzDocumentKey", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pzDocumentKey", "sTN", false, true, "pxTextInput", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pyRuleAvailable", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyRuleAvailable", "siN", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pyInterface", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyInterface", "siN64", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pyRuleSet", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyRuleSet", "sTN", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pzIsPrivateCheckOut", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pzIsPrivateCheckOut", "sTN", false, true, "pxTextInput", false));
	oPropDefinitions_2.put("Rule-RuleSet-Name.pxInstanceLockedRuleSetVersion", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pxInstanceLockedRuleSetVersion", "sTY", true, true, "Default", false));
}
...
tools.appendString("<textarea id=\"PRXML\" name=\"PRXML\" style=\"display:none;\" > <?xml version=\"1.0\" ?> <pagedata> ");
...
tools.appendString("</pyCircumstanceDefinition> </pagedata> </textarea >");
}
private static final Map oPropDefinitions_1 = new HashMap();
static {
	oPropDefinitions_1.put("Rule-RuleSet-Name.pyCircumstanceDefinition", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyCircumstanceDefinition", "sTN", false, true, "SmartPromptForCirumDefintion", false));
	oPropDefinitions_1.put("Rule-RuleSet-Name.pyCircumstanceProp", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyCircumstanceProp", "sTN64", false, true, "Default", false));
	oPropDefinitions_1.put("Rule-RuleSet-Name.pyCircumstanceVal", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyCircumstanceVal", "sTN64", false, true, "Default", false));
	oPropDefinitions_1.put("Rule-RuleSet-Name.pyCircumstanceTemplate", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyCircumstanceTemplate", "sTN", false, true, "Default", false));
	oPropDefinitions_1.put("Rule-RuleSet-Name.pyCircumstanceDate", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyCircumstanceDate", "sMN", false, true, "Default", false));
	oPropDefinitions_1.put("Rule-RuleSet-Name.pyCircumstanceDateProp", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyCircumstanceDateProp", "sIN32", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE- RULEFORMSETTINGS #20180713T135302.912 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE- RULEFORMSETTINGS #20180713T135302.912 GMT", "Rule- RuleFormSettings", "Pega-Desktop", "08-01-01", "20180713T135302.912 GMT");
