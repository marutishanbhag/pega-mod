...
/**
 * Builds JSP stream DATA-ADMIN-OPERATOR-ACCESSGROUP!SECONDARYPORTALLAYOUTSSECTION.
 */
public class ra_stream_secondaryportallayoutssection_40c30914fe7d23a435adb1060b8e3650 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.SecondaryPortalLayoutsSection.Data_Admin_Operator_AccessGroup.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 61119081;
 ...
 */
	public ra_stream_secondaryportallayoutssection_40c30914fe7d23a435adb1060b8e3650(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "bc2c8c42798a83d32aa53ebd4d67b878dc184a0";
...
{
/* Instance RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ACCESSGROUP SECONDARYPORTALLAYOUTSSECTION #20180713T135640.853 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "bc2c8c42798a83d32aa53ebd4d67b878dc184a0";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("SecondaryPortalLayoutsSection",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ACCESSGROUP SECONDARYPORTALLAYOUTSSECTION #20180713T135640.853 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ACCESSGROUP SECONDARYPORTALLAYOUTSSECTION #20180713T135640.853 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ACCESSGROUP SECONDARYPORTALLAYOUTSSECTION #20180713T135640.853 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:SECONDARYPORTALLAYOUTSSECTION", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("SECONDARYPORTALLAYOUTSSECTION","Rule-HTML-Section","DATA-ADMIN-OPERATOR-ACCESSGROUP",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ACCESSGROUP SECONDARYPORTALLAYOUTSSECTION #20180713T135640.853 GMT","!SECONDARYPORTALLAYOUTSSECTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",61119081), 
...
//	RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ACCESSGROUP SECONDARYPORTALLAYOUTSSECTION #20180713T135640.853 GMT:20180807T181303.836 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "70cd4081c0027192a1c1d6ce13861c5b";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("SecondaryPortalLayoutsSection",1,"Rule-HTML-Section","{'type':'Section','ruleName':'SecondaryPortalLayoutsSection','insKey':'RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ACCESSGROUP SECONDARYPORTALLAYOUTSSECTION #20180713T135640.853 GMT','sectionType':'standard'}");
...
config.put("pySectionName", "SecondaryPortalLayoutsSection");
config.put("pySectionClass", "Data-Admin-Operator-AccessGroup");
...
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20150302092709001323794") + "  ");
...
String rlIndex=tools.getParamValueCSF("pega_RLindex");
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20150302092709001322373") + "  ");
if(!labelForAttribute.equals("")){tools.appendString(" for='" + labelForAttribute + rlIndex + "' ");
}String labelForError="";if(!propertyName.equals("")){try { labelForError = pzSection.getCell().getLabelForError(pageName,propertyName);}catch(Exception e) {} }tools.appendString(labelForError);
if(!accessKey.equals("")){tools.appendString(accessKey);
}else if(bRuntimeAccesskey){String aKey = pega_uiengine_harness.pzGetAKey(".pyCaption",labelValue,pega_procom_harness.IsParam(labelValue) );tools.appendString(aKey);
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_7")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='SecondaryPortalLayoutsSection_"+ referenceString+ "_21'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20150302092709001221740") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
			...
			if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
				try{
					pzPackageRuntime.packageSection("SecondaryPortalLayoutsSection",
					...
					staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"SecondaryPortalLayoutsSection"));
		...
		boolean hasLineBreaks = false; checkForScriptTags_1("Add portal"); 
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "width:182px;",false,"","");tools.putSaveValue("parentLayouttype","ACTION");pxLink_1();
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "width:38px;",false,"","");tools.appendString("<nobr>");
	labelIncludeInCell_1("","","","",false,"",false,false,"Standard",false);
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(3)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "width:100px;",false,"","");tools.appendString("<nobr>");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")){
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='SecondaryPortalLayoutsSection_"+ referenceString+ "_15'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20151215012934072024211") + "  href='"+hrefValue+"' ");
		...
		tools.appendString("iconDelete' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" title = 'Delete this row"+ " "+repeatIndx+"' ");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
public void repeatingDataCell_7() {
	...
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(3)")); tools.appendString("headers='a3'");
...
/*
 * reference tag
 * Cannot inline because: cannot identify property ".pyIsDefaultPortal" at assembly time
 */
/* pega:reference */
...
_jspx_th_pega_reference__3.setName(".pyIsDefaultPortal");
...
public void repeatingDataCell_6() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("RH_Radio",".pyIsDefaultPortal", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
	tools.appendString("height:37px;");tools.appendString(""); tools.appendString("'class='");
	tools.appendString(pzSection.getCustomStyle(false,"","centered","centered"));tools.appendString(" gridCell");tools.appendString("  ");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20150302092709000911746") + " ");
		...
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyUserPortals1colWidthCache3").equals("")){ tools.appendParamCSF("PpyUserPortals1colWidthCache3"); } else { tools.appendString("20"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20150302092709000810282") + " ");
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyUserPortals1colWidthCache2").equals("")){ tools.appendParamCSF("PpyUserPortals1colWidthCache2"); } else { tools.appendString("253"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:25px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont '");tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("Name");if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<span style='position:absolute; top:0px; right: 0px;'>&nbsp;</span>"); } if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
...
public void repeatingHeaderCell_1() {
	...
	String strFieldValue = "";
		...
		tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='Default' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("2015030209270900089347") + " ");
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("height:27px;");tools.appendString("width:"); if(!tools.getParamValueCSF("PpyUserPortals1colWidthCache1").equals("")){ tools.appendParamCSF("PpyUserPortals1colWidthCache1"); } else { tools.appendString("64"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:25px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont centerAlign'");tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("Default");if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<span style='position:absolute; top:0px; right: 0px;'>&nbsp;</span>"); } if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
...
pzSection.getLayout().setExpandParam("SubSectionSecondaryPortalLayoutsSectionB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionSecondaryPortalLayoutsSectionB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pyUserPortalsL3=null;

 Map selUniqMap_pyUserPortalsL3 = null;
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyUserPortals");tools.appendString("_SecondaryPortalLayoutsSection_1'");
...
tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201808041122400434782") + " ");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pyUserPortals");

					}

					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList='.pyIsDefaultPortal .pyPortalLayout .pyTemplateInputBox  ' class='yui-skin-sam gPXAuto");

					if(pega_uiengine_harness.pzInStandardsMode()) {tools.appendString(" floated ");

					}tools.appendString("' style='");

					if(!pega_uiengine_harness.pzInStandardsMode()) {tools.appendString("display:"); if(pzAuto.getBrowserUtils().isIE()) {  tools.appendString(" inline; "); } else {  tools.appendString("inline-block;"); } }tools.appendString("' gPropIndex='PpyUserPortals1' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201808041122400434782-layout") + " ");

					tools.appendString(" class='gridTable ");

					tools.appendString(pzSection.getRepeatStyle());String strSummary = "pyUserPortals";
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' ><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpyUserPortals1colWidthGBL\" id=\"PpyUserPortals1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyUserPortals1colWidthGBL"));tools.appendString("\" />");

					
						 tools.putParamValue("expandRL","false"); 

					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpyUserPortals1colWidthGBR\" id=\"PpyUserPortals1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyUserPortals1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpyUserPortals1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' style='width:");

					 if(!tools.getParamValue("PpyUserPortals1colWidthGBL").equals("")) { tools.appendParamCSF("PpyUserPortals1colWidthGBL"); } else { 

					tools.appendString("337.0"); } 

					tools.appendString("px;' cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='pyUserPortals' PL_PROP='");

					
tools.appendString(".pyUserPortals");

					tools.appendString("' PL_PROP_CLASS='Embed-PortalLayout' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pyUserPortals").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pyUserPortals\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals(".pyUserPortals")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodes.pyUserPortals1") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 

					if (tempTestID != null && !tempTestID.isEmpty() && !tempTestID.equals("")){

					String strEntryHandlePLProp = "";

					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle(".pyUserPortals"); } catch (Exception ex) { }
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201808041122400434782-" + rowTestID) + " ");
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"3\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("Embed-PortalLayout", "tempNoRespg");
 ...
 tempNoRespg.removeFromClipboard();
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pyUserPortals1") && tools.getParamValue("partialRefresh").equals("false")) {
...
_jspx_th_pega_reference__2.setName(".pyIsDefaultPortal");
...
if (_jspx_meth_pega_param__1(pageContext, "CustomQuery", "&pyActivity=Rule-Portal.LookupList&pyListName=PXSP&maxRecords=2000&pyObjClass=Rule-Portal&Action=classgroup&FilterInternalPortals=true")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "OpenRuleTooltip", "Open Rule")) {
	return true;
}
...
if (_jspx_meth_pega_param__1(pageContext, "ApplyTo", "Rule-Portal")) {
	return true;
}
...
if (_jspx_meth_pega_param__1(pageContext, "Class", "Rule-Portal")) {
	return true;
}
 ...
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyPortalLayout", "input", "OpenRuleAdvanced")) {
	return;
}
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
public void repeatingDataCell_2() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyPortalLayout", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)")); tools.appendString("headers='a2'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:35px;'");}tools.appendString("class='");
...
_jspx_th_pega_reference__1.setName(".pyIsDefaultPortal");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyUserPortals1")|| tools.getParamValue("partialTrigger").equals("editRow.pyUserPortals1") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pyUserPortals");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pyUserPortals\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pyUserPortals1")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty(".pyUserPortals");
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyUserPortals1") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ACCESSGROUP SECONDARYPORTALLAYOUTSSECTION #20180713T135640.853 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "SecondaryPortalLayoutsSection");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-ADMIN-OPERATOR-ACCESSGROUP SECONDARYPORTALLAYOUTSSECTION #20180713T135640.853 GMT", "Data-Admin-Operator-AccessGroup SecondaryPortalLayoutsSection", "Pega-SystemArchitect", "08-01-01", "20180807T181303.836 GMT");
}
