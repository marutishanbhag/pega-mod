...
/**
 * Builds JSP stream EMBED-FIELDS!DYNAMICUIFORCALCULATED.
 */
public class ra_stream_dynamicuiforcalculated_54cbb5a1cf360b85d199a5d028e4eb08 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.DynamicUIForCalculated.Embed_Fields.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1615314302;
 ...
 */
	public ra_stream_dynamicuiforcalculated_54cbb5a1cf360b85d199a5d028e4eb08(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "36be976d60e3a20dc8faf02b31b8e850a8576d73";
...
{
/* Instance RULE-HTML-SECTION EMBED-FIELDS DYNAMICUIFORCALCULATED #20210506T204027.314 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "36be976d60e3a20dc8faf02b31b8e850a8576d73";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("DynamicUIForCalculated",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-FIELDS DYNAMICUIFORCALCULATED #20210506T204027.314 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-FIELDS DYNAMICUIFORCALCULATED #20210506T204027.314 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-FIELDS DYNAMICUIFORCALCULATED #20210506T204027.314 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("DYNAMICUIFORCALCULATED","Rule-HTML-Section","EMBED-FIELDS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION EMBED-FIELDS DYNAMICUIFORCALCULATED #20210506T204027.314 GMT","!DYNAMICUIFORCALCULATED",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1615314302), 
		...
		new DependentRuleInfo("PYDYNAUILABEL","Rule-Obj-Property","EMBED-FIELDS",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-PROPERTY EMBED-FIELDS PYDYNAUILABEL #20180713T140707.146 GMT","!PYDYNAUILABEL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
...
//	RULE-HTML-SECTION EMBED-FIELDS DYNAMICUIFORCALCULATED #20210506T204027.314 GMT:20210506T204027.314 GMT
//	RULE-HTML-SECTION @BASECLASS PZREADONLYSINGLECOLUMN #20191216T234541.784 GMT:20191216T234541.784 GMT
//	RULE-OBJ-PROPERTY EMBED-FIELDS PYDYNAUILABEL #20180713T140707.146 GMT:20180713T140707.146 GMT
//	RULE-OBJ-PROPERTY EMBED-FIELDS PYDYNAUILABEL #20180713T140707.146 GMT:20180713T140707.146 GMT
//	RULE-OBJ-PROPERTY EMBED-FIELDS PYDYNAUILABEL #20180713T140707.146 GMT:20180713T140707.146 GMT
//	RULE-OBJ-PROPERTY EMBED-FIELDS PYDYNAUILABEL #20180713T140707.146 GMT:20180713T140707.146 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "511f62fe41aef701e8b865f866e8c364";
	}
...
config = new HashMap<String, String>();
config.put("StreamName", "DynamicUIForCalculated");
...
public void inclFormattedVal_33(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {if (isSecuredProp) { tools.putParamValue("proSecurity_isSecuredProp", isSecuredProp);tools.putParamValue("proSecurity_activePropValue", activePropValue);}
...
tools.appendString(">");
	if(securedPropValue == null){inclFormattedVal_22(isSecuredProp, activePropValue, isDisplayTextWithParam, displayTextParamName);
	  } else  { 
...
tools.appendString("</P>");
	  ...
	  if(securedPropValue != null && pzAuto.getUIComponentRuntime().getTemplatingUIStatus() != 'Y') { 
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_218")){
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReference",pxUniqueStreamHash+"_219");
	...
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_219");
	...
	modePage1.put("pyResultsUniqueID",pxUniqueStreamHash+"_220");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadDataPage("D_pzOperatorsByWorkGroup", listProperties, pxUniqueStreamHash+"_220", sourceDPParams);
	...
	try{
		if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){ 
		 ...
		 expressionId = pxUniqueStreamHash+"_221";
	...
	String spxUniqueStreamHash222 = getUIActionsMetaData_2();
	...
	modePage1.put("pyActionStringID",pxUniqueStreamHash+"_222");
	}
	...
	String spxUniqueStreamHash223 = getUIActionsMetaData_1();
	if(spxUniqueStreamHash223 != null && !"".equals(spxUniqueStreamHash223)){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addActionString(spxUniqueStreamHash223,pxUniqueStreamHash+"_223");
	modePage2.put("pyActionStringID",pxUniqueStreamHash+"_223");
	}
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_224");}if(beginNonTemplate){			HashStringMap params = new HashStringMap();
			tools.putParamValue("WorkGroup", 
			tools.getProperty("pxRequestor.pxWorkGroup").getStringValue()
			);
			String pageName ="D_pzOperatorsByWorkGroup";
...
tools.appendString(" data-bindprops='value' ");} else{			tools.appendString(ddPropEntryHandle);
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_225")){inclFormattedVal_33(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	  ...
	  if(securedPropValue != null && pzAuto.getUIComponentRuntime().getTemplatingUIStatus() != 'Y') { 
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_209")){
		 tools.appendString("<span>" + securedPropValue + "</span>");
			 }pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	  } else { 
	if(isEditable) {
		 tools.putParamValue("REQUIRED_WHEN","");
		 tools.putParamValue("REQUIRED_WHEN_ROC","");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_210")){
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_211")){inclFormattedVal_27(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	  ...
	  if(securedPropValue != null && pzAuto.getUIComponentRuntime().getTemplatingUIStatus() != 'Y') { 
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_205")){
		 tools.appendString("<span>" + securedPropValue + "</span>");
			 }pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	  } else { 
	if(isEditable) {
		 tools.putParamValue("REQUIRED_WHEN","");
		 tools.putParamValue("REQUIRED_WHEN_ROC","");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_206")){
		textInputIncludes_1();boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering(); boolean doAutoFormatting = false;
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_207")){inclFormattedVal_27(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	  ...
	  if(securedPropValue != null && pzAuto.getUIComponentRuntime().getTemplatingUIStatus() != 'Y') { 
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_201")){
		 tools.appendString("<span>" + securedPropValue + "</span>");
			 }pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	  } else { 
	if(isEditable) {
		 tools.putParamValue("REQUIRED_WHEN","");
		 tools.putParamValue("REQUIRED_WHEN_ROC","");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_202")){
		textInputIncludes_1();boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering(); boolean doAutoFormatting = false;
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_203")){inclFormattedVal_27(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
gridBeginLayout_3
 ...
 String returnTotalCount = ""; 
					...
					if (tmpDeclarePageParams != null && tmpDeclarePageParams.getProperty("D_pzOperatorsByWorkGroup_pxResults_DynamicUIForCalculated_2") != null) {

					
					ClipboardPage paramList = tmpDeclarePageParams.getProperty("D_pzOperatorsByWorkGroup_pxResults_DynamicUIForCalculated_2").getPageValue();
 ...
 Set filteredIndicesSetD_pzOperatorsByWorkGroup_pxResultsL7 = null;
	 ...
	 String strFCPage = "pyFilterCriteria_D_pzOperatorsByWorkGroup.pxResults_DynamicUIForCalculated_2";
...
gFCritPageD_pzOperatorsByWorkGroup_pxResultsL7.getProperty("pyRowVisibleWhenCondition").setValue("pzACRowVisibleWhen");
 ...
 tools.putParamValue("populateSelectedUIValues", "");
					...
					tools.appendString(" dataSource='");if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_pzOperatorsByWorkGroup.pxResults").getReference());tools.appendString("_DynamicUIForCalculated_2'");
					...
					tools.appendString(" bRangeFilterByFormat='false' bRowVisibleWhen = 'true' DPSectionID=\"SubSectionDynamicUIForCalculatedca156706_7f53_42db_a41e_c1ccd7d608a0_pyDynaUIPropertyReference\"  openOnDblClick='false' OAFunc='openRuleByKeys' ");
...
String expandParameter = "EXPANDEDSubSectionDynamicUIForCalculatedca156706_7f53_42db_a41e_c1ccd7d608a0_pyDynaUIPropertyReference";
...
if(!actionName.equals("PostValue") && !actionName.equals("ReadonlyFormat")){tools.putSaveValue("sectionUniqueID", "SID" + (((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique())+ "");
	pzSection.includeExpressions();
	  pzSection.beginSection("DynamicUIForCalculated",1,"Rule-HTML-Section","{'type':'Section','ruleName':'DynamicUIForCalculated','insKey':'RULE-HTML-SECTION EMBED-FIELDS DYNAMICUIFORCALCULATED #20210506T204027.314 GMT','templated':'true','sectionType':'standard'}");
...
tools.appendString("<div style=\"display:none;\" data-postvalue-url=\"" + StringUtils.escapeIntoJSONString(pega_rules_utilities.pzEncryptURLActionString(tools, "Thread", "pyActivity=ReloadCell&StreamName=DynamicUIForCalculated")) + "\"></div>");
}
...
tools.appendString("</P>");
	...
	String clientValidationAttributes = pzAuto.getCell().getClientValidationAttributes(pyOnInput, pyEditValidate, pyStringType,pegaValidation.toString());
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReference",pxUniqueStreamHash+"_197");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_197");
	modePage1.put("clintValidAttrs",clientValidationAttributes);
	modePage1.put("pyID","pyDynaUIPropertyReference");
	...
	modePage1.put("pySpecifySize","auto");
	String spxUniqueStreamHash198 = getUIActionsMetaData_3();
	...
	pyDataPage.addMetadataInArray("pyAdditionalFields",pyAdditionalField);
	pyListDataSource.putMetadata("pyDataPage",pyDataPage);
	String dataAttributes = "[\"EXPANDEDSubSectionDynamicUIForCalculatedca156706_7f53_42db_a41e_c1ccd7d608a0_pyDynaUIPropertyReference\",0,170,{\"WorkGroup\" : \"pxRequestor.pxWorkGroup\"},\""+pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getStepPage().getReference(),"",false)+"\",0,false]";
	...
	String spxUniqueStreamHash199 = getUIActionsMetaData_1();
	if(spxUniqueStreamHash199 != null && !"".equals(spxUniqueStreamHash199)){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addActionString(spxUniqueStreamHash199,pxUniqueStreamHash+"_199");
	modePage2.put("pyActionStringID",pxUniqueStreamHash+"_199");
	}
	cellPage.addMetadataInArray("pyModes",modePage1);
	cellPage.addMetadataInArray("pyModes",modePage2);
	metadataPage.putMetadata("pyCell",cellPage);
...
cellChangeTracker.trackValueChanges("pxRequestor.pxWorkGroup", -1);
		...
		tools.appendString("]' ");
				...
				tools.appendString("data-ac-numeric-prop = true");
					...
					tools.appendString(" data-attributes='[ \"EXPANDEDSubSectionDynamicUIForCalculatedca156706_7f53_42db_a41e_c1ccd7d608a0_pyDynaUIPropertyReference\",0,0,{\"WorkGroup\" : \"pxRequestor.pxWorkGroup\"},\"" + tools.getStepPage().getReference() + "\",0,false]' />");
					if(!isMobilePhone){
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_212")){inclFormattedVal_28(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_194",".pyDynaUISectionReference", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellDynamicUIForCalculated577","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_191",".pyDynaUISectionReference", secInfo);
}
...
tools.appendString("</P>");
	  ...
	  if(securedPropValue != null && pzAuto.getUIComponentRuntime().getTemplatingUIStatus() != 'Y') { 
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_182")){
		 tools.appendString("<span>" + securedPropValue + "</span>");
			 }pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	  } else { 
	if(isEditable) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyDynaUIPropertyReference", ".pyCaption");
	modePage1.put("styleOther","");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReference",pxUniqueStreamHash+"_183");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_183");
	String placeHolderR="";
	modePage1.put("pyMin","");
...
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	String propID ="pyDynaUIPropertyReference";
	...
	String spxUniqueStreamHash184 = getUIActionsMetaData_2();
	...
	modePage1.put("pyActionStringID",pxUniqueStreamHash+"_184");
	}
	if(expressionId !=null && expressionId.length() > 0){
	modePage1.put("pyExpressionId",expressionId);
	}
	...
	String spxUniqueStreamHash185 = getUIActionsMetaData_1();
	if(spxUniqueStreamHash185 != null && !"".equals(spxUniqueStreamHash185)){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addActionString(spxUniqueStreamHash185,pxUniqueStreamHash+"_185");
	modePage2.put("pyActionStringID",pxUniqueStreamHash+"_185");
	}
	cellPage.addMetadataInArray("pyModes",modePage1);
	cellPage.addMetadataInArray("pyModes",modePage2);
	metadataPage.putMetadata("pyCell",cellPage);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_186")){inclFormattedVal_32(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString(">");
	if(securedPropValue == null){inclFormattedVal_29(isSecuredProp, activePropValue, isDisplayTextWithParam, displayTextParamName);
	  } else  { 
		 tools.appendString(securedPropValue);
	 }
tools.appendString("</P>");
	  ...
	  if(securedPropValue != null && pzAuto.getUIComponentRuntime().getTemplatingUIStatus() != 'Y') { 
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_172")){
		 tools.appendString("<span>" + securedPropValue + "</span>");
			 }pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	  } else { 
	if(isEditable) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReferenceTime",pxUniqueStreamHash+"_173");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_173");
	String spxUniqueStreamHash174 = getUIActionsMetaData_2();
...
pzStatic_pzDatePickerAdvancedIncludes.emitContent();
	...
	tools.appendString(" tabindex='0' ");
			...
			tools.appendString("<span id='"+curProp.getEntryHandle()+"' role='group'"+outerSpanClass+" aria-label='");try {

/*
 * reference tag
 * Cannot inline because: mode is "normal"
 */
if (_jspx_meth_p_r__1(pageContext, ".pyDynaUILabel", "normal")) {
	return;
}
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_176")){inclFormattedVal_30(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	  ...
	  if(securedPropValue != null && pzAuto.getUIComponentRuntime().getTemplatingUIStatus() != 'Y') { 
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_163")){
		 tools.appendString("<span>" + securedPropValue + "</span>");
			 }pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	  } else { 
	if(isEditable) {
		 tools.putParamValue("REQUIRED_WHEN","");
		 tools.putParamValue("REQUIRED_WHEN_ROC","");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_164")){
		textInputIncludes_1();boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering(); boolean doAutoFormatting = false;
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_165")){inclFormattedVal_27(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	  ...
	  if(securedPropValue != null && pzAuto.getUIComponentRuntime().getTemplatingUIStatus() != 'Y') { 
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_159")){
		 tools.appendString("<span>" + securedPropValue + "</span>");
			 }pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	  } else { 
	if(isEditable) {
		 tools.putParamValue("REQUIRED_WHEN","");
		 tools.putParamValue("REQUIRED_WHEN_ROC","");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_160")){
		textInputIncludes_1();boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering(); boolean doAutoFormatting = false;
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_161")){inclFormattedVal_27(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	  ...
	  if(securedPropValue != null && pzAuto.getUIComponentRuntime().getTemplatingUIStatus() != 'Y') { 
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_155")){
		 tools.appendString("<span>" + securedPropValue + "</span>");
			 }pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	  } else { 
	if(isEditable) {
		 tools.putParamValue("REQUIRED_WHEN","");
		 tools.putParamValue("REQUIRED_WHEN_ROC","");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_156")){
		textInputIncludes_1();boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering(); boolean doAutoFormatting = false;
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_157")){inclFormattedVal_27(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	  ...
	  if(securedPropValue != null && pzAuto.getUIComponentRuntime().getTemplatingUIStatus() != 'Y') { 
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_151")){
		 tools.appendString("<span>" + securedPropValue + "</span>");
			 }pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	  } else { 
	if(isEditable) {
		 tools.putParamValue("REQUIRED_WHEN","");
		 tools.putParamValue("REQUIRED_WHEN_ROC","");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_152")){
		textInputIncludes_1();boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering(); boolean doAutoFormatting = false;
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_153")){inclFormattedVal_27(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	  ...
	  if(securedPropValue != null && pzAuto.getUIComponentRuntime().getTemplatingUIStatus() != 'Y') { 
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_147")){
		 tools.appendString("<span>" + securedPropValue + "</span>");
			 }pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	  } else { 
	if(isEditable) {
		 tools.putParamValue("REQUIRED_WHEN","");
		 tools.putParamValue("REQUIRED_WHEN_ROC","");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_148")){
		textInputIncludes_1();boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering(); boolean doAutoFormatting = false;
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_149")){inclFormattedVal_27(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
public void inclFormattedVal_27(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {
...
tools.appendString("</P>");
	  ...
	  if(securedPropValue != null && pzAuto.getUIComponentRuntime().getTemplatingUIStatus() != 'Y') { 
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_143")){
		 tools.appendString("<span>" + securedPropValue + "</span>");
			 }pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	  } else { 
	if(isEditable) {
		 tools.putParamValue("REQUIRED_WHEN","");
		 tools.putParamValue("REQUIRED_WHEN_ROC","");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_144")){
		textInputIncludes_1();boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering(); boolean doAutoFormatting = false;
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_145")){inclFormattedVal_27(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
gridBeginLayout_2
 ...
 Set filteredIndicesSet_pyDropdownListL7 = null;
	 ...
	 String strFCPage = "pyFilterCriteria_"+tools.getStepPage().getReference()+".pyDropdownList_DynamicUIForCalculated_2";
...
gFCritPage_pyDropdownListL7.getProperty("pyRowVisibleWhenCondition").setValue("pzACRowVisibleWhen");
 ...
 tools.putParamValue("populateSelectedUIValues", "");
					...
					tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyDropdownList");tools.appendString("_DynamicUIForCalculated_2'");
...
String expandParameter = "EXPANDEDSubSectionDynamicUIForCalculated7d22d3b9_2faf_4bf9_830f_fa05287dcc1c_pyDynaUIPropertyReference";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\"><tr><td>");
...
tools.appendString("</P>");
	...
	ddPropEntryHandle = pzAuto.getUIComponentRuntime().getRepeatingReference(ddPropEntryHandle , "entryHandle",false);
	String clientValidationAttributes = pzAuto.getCell().getClientValidationAttributes(pyOnInput, pyEditValidate, pyStringType,pegaValidation.toString());
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReference",pxUniqueStreamHash+"_139");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_139");
	modePage1.put("clintValidAttrs",clientValidationAttributes);
	modePage1.put("pyID","pyDynaUIPropertyReference");
	modePage1.put("styleOther","");
	modePage1.put("pyDisplayAsComboBox","true");
	...
	boolean is4Offline = pega_uiengine_offlinesupport.pzIsForOfflineTemplate();
	modePage1.put("pySpecifySize","auto");
	String spxUniqueStreamHash140 = getUIActionsMetaData_3();
	...
	String dataAttributes = "[\"EXPANDEDSubSectionDynamicUIForCalculated7d22d3b9_2faf_4bf9_830f_fa05287dcc1c_pyDynaUIPropertyReference\",0,170,{},\""+pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getStepPage().getReference(),"",false)+"\",0,false]";
	modePage1.put("dataAttributes",dataAttributes);
	modePage1.putMetadata("pyListDataSource",pyListDataSource);
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015111210511107196565",true));
	String pyValueR = "";
	...
	modePage2.put("pyAutoPrepend",pyAutoPrepend);
	modePage2.put("pyAutoAppend",pyAutoAppend);
	String spxUniqueStreamHash141 = getUIActionsMetaData_1();
	...
	modePage2.put("pyActionStringID",pxUniqueStreamHash+"_141");
	}
	cellPage.addMetadataInArray("pyModes",modePage1);
	cellPage.addMetadataInArray("pyModes",modePage2);
	metadataPage.putMetadata("pyCell",cellPage);
	 ...
	 boolean isMobilePhone = tools.evaluateWhen(keys);
		...
		tools.appendString("]' ");
			...
			tools.appendString("data-ac-numeric-prop = true");
				...
				tools.appendString(" data-attributes='[ \"EXPANDEDSubSectionDynamicUIForCalculated7d22d3b9_2faf_4bf9_830f_fa05287dcc1c_pyDynaUIPropertyReference\",0,0,{},\"" + tools.getStepPage().getReference() + "\",0,false]' />");
				if(!isMobilePhone){
					tools.appendString("<button onclick='pd(event);' data-active='false' tabindex='-1' data-ctl='Button' type='button' data-click='[[\"runScript\", [\"p.c.IAutoCompleteAG.prototype.searchWithComboBox()\"]]]' " + disabled_ctrl + " ><i data-click='.' class='pi pi-caret-down'></i></button></div>");
					}else{
						tools.appendString("<span class='autocomplete_span' ><div class='autocomplete_icon' id='acspin'  ></div></span>");
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_166")){inclFormattedVal_28(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	tools.putParamValue("pyTempUIJSPFragmentData",returnString);
}
...
if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y' && !isOffline){
	...
	getUIJSPFragmentData_1();
	cellPage.put("pyLabelFor",tools.getParamValue("pyTempUIJSPFragmentData"));
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_132")){inclFormattedVal_25(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
public void inclFormattedVal_23(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {if (isSecuredProp) { tools.putParamValue("proSecurity_isSecuredProp", isSecuredProp);tools.putParamValue("proSecurity_activePropValue", activePropValue);}
		pega.checkIfActivePropertyMissing();
...
public void inclFormattedVal_22(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam, String displayTextParamName) {
		pega.checkIfActivePropertyMissing();
...
tools.appendString(" data-bindprops='value' ");} else{			tools.appendString(ddPropEntryHandle);
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_120")){inclFormattedVal_23(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString(">");
	if(securedPropValue == null){inclFormattedVal_20(isSecuredProp, activePropValue, isDisplayTextWithParam, displayTextParamName);
	  } else  { 
		 tools.appendString(securedPropValue);
	 }
tools.appendString("</P>");
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_108")){inclFormattedVal_21(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
public void inclFormattedVal_19(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {
		pega.checkIfActivePropertyMissing();tools.putParamValue("styleText","");
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_98")){inclFormattedVal_19(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyDynaUIPropertyReference", ".pyCaption");
	modePage1.put("styleOther","");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReference",pxUniqueStreamHash+"_35");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_38")){
		textIncludes_1();		
		tools.appendString("\n<span  " + pzCell.getTestIdIfEnabled("2015111210511107196565") + "  data-ctl='Text' ");
...
public void pxTextInput_1() {String key="6269af62-9c08-4035-a107-6ba211c18ac1||RULE-HTML-SECTION EMBED-FIELDS DYNAMICUIFORCALCULATED #20210506T204027.314 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","pxUseSourceValidate","Text","true","6269af62-9c08-4035-a107-6ba211c18ac1"};oCellRuntimeParamsMap.put("6269af62-9c08-4035-a107-6ba211c18ac1||RULE-HTML-SECTION EMBED-FIELDS DYNAMICUIFORCALCULATED #20210506T204027.314 GMT",paramValues);oControlPathsMap.put("6269af62-9c08-4035-a107-6ba211c18ac1||RULE-HTML-SECTION EMBED-FIELDS DYNAMICUIFORCALCULATED #20210506T204027.314 GMT",".pyRegions(1).pyCells(1)||.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2== rx.pyPropertyType cqText:pxTextInput o2== rx.pyStreamName rx.pyHTMLControl",".pyPropertyType=\'Text:pxTextInput\' && .pyStreamName == .pyHTMLControl","cell", "visible" )) {
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rx.pyPropertyType cqText:pxTextInput o2== rx.pyStreamName rx.pyHTMLControl",pxUniqueStreamHash+"_4");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_4");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType='Text:pxTextInput' && .pyStreamName == .pyHTMLControl");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rx.pyPropertyType cqText:pxTextInput o2== rx.pyStreamName rx.pyHTMLControl", pxUniqueStreamHash+"_4"); 
	}
	...
	pxTextInput_1();if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2== rx.pyPropertyType cqText:Paragraph o2== rx.pyParagraphControlType cqpxTextArea",".pyPropertyType =\'Text:Paragraph\' && .pyParagraphControlType==\'pxTextArea\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rx.pyPropertyType cqText:Paragraph o2== rx.pyParagraphControlType cqpxTextArea",pxUniqueStreamHash+"_14");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_14");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType ='Text:Paragraph' && .pyParagraphControlType=='pxTextArea'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_14");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rx.pyPropertyType cqText:Paragraph o2== rx.pyParagraphControlType cqpxTextArea", pxUniqueStreamHash+"_14"); 
	}
	if(pyDLCellVisibility) {
	...
	pxTextArea_1(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_16")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_3( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2== rx.pyPropertyType cqText:Paragraph o2== rx.pyParagraphControlType cqpxRichTextEditor",".pyPropertyType =\'Text:Paragraph\' && .pyParagraphControlType==\'pxRichTextEditor\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rx.pyPropertyType cqText:Paragraph o2== rx.pyParagraphControlType cqpxRichTextEditor",pxUniqueStreamHash+"_21");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_21");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType ='Text:Paragraph' && .pyParagraphControlType=='pxRichTextEditor'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_21");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rx.pyPropertyType cqText:Paragraph o2== rx.pyParagraphControlType cqpxRichTextEditor", pxUniqueStreamHash+"_21"); 
	}
	if(pyDLCellVisibility) {
	...
	pxRichTextEditor_1(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_23")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_4( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyPropertyType cqTrueFalse:pxCheckbox",".pyPropertyType =\'TrueFalse:pxCheckbox\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyPropertyType cqTrueFalse:pxCheckbox",pxUniqueStreamHash+"_31");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_31");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType ='TrueFalse:pxCheckbox'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_31");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyPropertyType cqTrueFalse:pxCheckbox", pxUniqueStreamHash+"_31"); 
	}
	if(pyDLCellVisibility) {
	...
	pxCheckbox_1(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");}
	if (!isExpression && isOffline) {
	// do nothing
	} else {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().endVisibleWhen();
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_41");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_41");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyPropertyType cqDecimal:pxCurrency",pxUniqueStreamHash+"_40");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyPropertyType cqDecimal:pxCurrency", pxUniqueStreamHash+"_40"); 
	}
	if(pyDLCellVisibility) {
	...
	pxCurrency_1(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_42")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_6( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyStringType cqDateTime",".pyStringType = \'DateTime\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyStringType cqDateTime",pxUniqueStreamHash+"_50");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_50");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyStringType = 'DateTime'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_50");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyStringType cqDateTime", pxUniqueStreamHash+"_50"); 
	}
	if(pyDLCellVisibility) {
	...
	pxDateTime_1(".pyDynaUIPropertyReferenceDateTime",0,"","pxUseSourceValidate","Date Time");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_52")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_7( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyPropertyType cqDate:pxDateTime",".pyPropertyType=\'Date:pxDateTime\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyPropertyType cqDate:pxDateTime",pxUniqueStreamHash+"_60");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_60");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType='Date:pxDateTime'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_60");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyPropertyType cqDate:pxDateTime", pxUniqueStreamHash+"_60"); 
	}
	if(pyDLCellVisibility) {
	...
	pxDateTime_2(".pyDynaUIPropertyReferenceDate",0,"","pxUseSourceValidate","Date");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_62")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_8( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyPropertyType cqDecimal:pxNumber",".pyPropertyType = \'Decimal:pxNumber\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyPropertyType cqDecimal:pxNumber",pxUniqueStreamHash+"_70");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_70");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType = 'Decimal:pxNumber'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_70");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyPropertyType cqDecimal:pxNumber", pxUniqueStreamHash+"_70"); 
	}
	if(pyDLCellVisibility) {
	...
	pxNumber_1(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_72")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_9( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyPropertyType cqInteger:pxInteger",".pyPropertyType =\'Integer:pxInteger\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_9( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyPropertyType cqInteger:pxInteger",pxUniqueStreamHash+"_80");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_80");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType ='Integer:pxInteger'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_80");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyPropertyType cqInteger:pxInteger", pxUniqueStreamHash+"_80"); 
	}
	if(pyDLCellVisibility) {
	...
	pxInteger_1(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_82")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_10( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyPropertyType cqDecimal:pxPercentage",".pyPropertyType = \'Decimal:pxPercentage\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_10( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyPropertyType cqDecimal:pxPercentage",pxUniqueStreamHash+"_90");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_90");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType = 'Decimal:pxPercentage'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_90");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyPropertyType cqDecimal:pxPercentage", pxUniqueStreamHash+"_90"); 
	}
	if(pyDLCellVisibility) {
	...
	pxNumber_2(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_92")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_11( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyPropertyType cqText:pxEmail",".pyPropertyType =\'Text:pxEmail\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_11( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyPropertyType cqText:pxEmail",pxUniqueStreamHash+"_100");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_100");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType ='Text:pxEmail'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_100");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyPropertyType cqText:pxEmail", pxUniqueStreamHash+"_100"); 
	}
	if(pyDLCellVisibility) {
	...
	pxEmail_1(".pyDynaUIPropertyReferenceEmail",0,"","pzValidEmailAddressAddMessage","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_102")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_12( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyPropertyType cqText:pxPhone",".pyPropertyType =\'Text:pxPhone\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_12( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyPropertyType cqText:pxPhone",pxUniqueStreamHash+"_110");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_110");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType ='Text:pxPhone'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_110");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyPropertyType cqText:pxPhone", pxUniqueStreamHash+"_110"); 
	}
	if(pyDLCellVisibility) {
	...
	pxPhone_1(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_112")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_13( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2== rx.pyPropertyType cqText:Picklist o2== rx.pyStreamName cqpxDropdown",".pyPropertyType=\'Text:Picklist\' && .pyStreamName=\'pxDropdown\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_13( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rx.pyPropertyType cqText:Picklist o2== rx.pyStreamName cqpxDropdown",pxUniqueStreamHash+"_122");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_122");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType='Text:Picklist' && .pyStreamName='pxDropdown'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_122");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rx.pyPropertyType cqText:Picklist o2== rx.pyStreamName cqpxDropdown", pxUniqueStreamHash+"_122"); 
	}
	if(pyDLCellVisibility) {
	...
	pxDropdown_1(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_124")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutTemplateCell_14( int index) {
	...
	pxRadioButtons_1(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_136")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_15( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2== rx.pyPropertyType cqText:Picklist o2== rx.pyStreamName cqpxAutoComplete",".pyPropertyType=\'Text:Picklist\' && .pyStreamName=\'pxAutoComplete\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_15( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_169");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_169");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rx.pyPropertyType cqText:Picklist o2== rx.pyStreamName cqpxAutoComplete",pxUniqueStreamHash+"_168");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_168");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType='Text:Picklist' && .pyStreamName='pxAutoComplete'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_168");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rx.pyPropertyType cqText:Picklist o2== rx.pyStreamName cqpxAutoComplete", pxUniqueStreamHash+"_168"); 
	}
	if(pyDLCellVisibility) {
	...
	pxAutoComplete_1(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_170")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_16( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyStringType cqTimeOfDay",".pyStringType =\'TimeOfDay\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_16( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_179");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_179");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyStringType cqTimeOfDay",pxUniqueStreamHash+"_178");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_178");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyStringType ='TimeOfDay'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_178");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyStringType cqTimeOfDay", pxUniqueStreamHash+"_178"); 
	}
	if(pyDLCellVisibility) {
	...
	pxDateTime_3(".pyDynaUIPropertyReferenceTime",0,"","pxUseSourceValidate","TimeOfDay");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_180")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_17( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyPropertyType cqText:pxURL",".pyPropertyType==\'Text:pxURL\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_17( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_189");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_189");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyPropertyType cqText:pxURL",pxUniqueStreamHash+"_188");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_188");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType=='Text:pxURL'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_188");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyPropertyType cqText:pxURL", pxUniqueStreamHash+"_188"); 
	}
	if(pyDLCellVisibility) {
	...
	pxURL_1(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_190")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutTemplateCell_18( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2&& o2== rx.pyPropertyMode cqPage o2!= rx.pyDynaUIPageReference cq o2!= rx.pyDynaUISectionReference cq",pxUniqueStreamHash+"_193");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_193");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2&& o2== rx.pyPropertyMode cqPage o2!= rx.pyDynaUIPageReference cq o2!= rx.pyDynaUISectionReference cq", pxUniqueStreamHash+"_193"); 
	}
	if(pyDLCellVisibility) {
	...
	tools.putParamValue("RenderSingle", "");
	pzLayout_1();
 if(tools.getParamValue("RenderSingle").equals("EXPANDEDSubSectionDynamicUIForCalculated7d22d3b9_2faf_4bf9_830f_fa05287dcc1c_pyDynaUIPropertyReference")){
gridLayout_1();
 } 
...
public int simpleLayoutCell_19( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2== rx.pyPropertyType cqText:UserReference o2== rx.pyStreamName cqpxAutoComplete",".pyPropertyType =\'Text:UserReference\' && .pyStreamName =\'pxAutoComplete\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_19( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_215");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_215");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rx.pyPropertyType cqText:UserReference o2== rx.pyStreamName cqpxAutoComplete",pxUniqueStreamHash+"_214");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_214");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType ='Text:UserReference' && .pyStreamName ='pxAutoComplete'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_214");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rx.pyPropertyType cqText:UserReference o2== rx.pyStreamName cqpxAutoComplete", pxUniqueStreamHash+"_214"); 
	}
	if(pyDLCellVisibility) {
	...
	pxAutoComplete_2(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_216")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
public int simpleLayoutCell_20( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2== rx.pyPropertyType cqText:UserReference o2== rx.pyStreamName cqpxDropdown",".pyPropertyType =\'Text:UserReference\' && .pyStreamName =\'pxDropdown\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_20( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_228");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_228");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rx.pyPropertyType cqText:UserReference o2== rx.pyStreamName cqpxDropdown",pxUniqueStreamHash+"_227");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_227");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType ='Text:UserReference' && .pyStreamName ='pxDropdown'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_227");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rx.pyPropertyType cqText:UserReference o2== rx.pyStreamName cqpxDropdown", pxUniqueStreamHash+"_227"); 
	}
	if(pyDLCellVisibility) {
	...
	pxDropdown_2(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_229")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
tools.appendString("'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_230")) {field_pzReferencePropertyControl_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_21( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_233");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_233");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rx.pyPropertyType cqText:pxTextInput o2!= rx.pyStreamName rx.pyHTMLControl",pxUniqueStreamHash+"_232");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_232");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyPropertyType='Text:pxTextInput' && .pyStreamName != .pyHTMLControl");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-Fields");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rx.pyPropertyType cqText:pxTextInput o2!= rx.pyStreamName rx.pyHTMLControl", pxUniqueStreamHash+"_232"); 
	}
	if(pyDLCellVisibility) {
...
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_234")) {	field_pzReferencePropertyControl_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_235")){
	GeneralLabelJSPFragment_1();
	} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
	}
	if (!isExpression && isOffline) {
...
pzSection.getLayout().setExpandParam("SubSectionDynamicUIForCalculatedB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionDynamicUIForCalculatedB";
...
private void performStream_1() throws Throwable {
 if("EXPANDEDSubSectionDynamicUIForCalculated7d22d3b9_2faf_4bf9_830f_fa05287dcc1c_pyDynaUIPropertyReference".equals(tools.getParamValue("RenderSingle")) ){ 
 tools.putParamValue("rowVisibleWhen",".pyStandardValue:.pyLocalizedValue:contains"); 
 tools.putParamValue("AC_BestBetsProp",""); 
 } 
 if("EXPANDEDSubSectionDynamicUIForCalculatedca156706_7f53_42db_a41e_c1ccd7d608a0_pyDynaUIPropertyReference".equals(tools.getParamValue("RenderSingle")) ){ 
 tools.putParamValue("rowVisibleWhen",".pyUserIdentifier:contains"); 
 tools.putParamValue("AC_BestBetsProp",""); 
 setDpParamasForAc_1();  
 } 
 if("InitialRender_EXPANDEDSubSectionDynamicUIForCalculated7d22d3b9_2faf_4bf9_830f_fa05287dcc1c_pyDynaUIPropertyReference".equals(tools.getParamValue("RenderSingle")) ){ 
 tools.putParamValue("rowVisibleWhen",".pyStandardValue:.pyLocalizedValue:contains"); 
 tools.putParamValue("AC_BestBetsProp",""); 
 { 
...
buildWhiteList_1();
 if("InitialRender_EXPANDEDSubSectionDynamicUIForCalculatedca156706_7f53_42db_a41e_c1ccd7d608a0_pyDynaUIPropertyReference".equals(tools.getParamValue("RenderSingle")) ){ 
 tools.putParamValue("rowVisibleWhen",".pyUserIdentifier:contains"); 
 tools.putParamValue("AC_BestBetsProp",""); 
 setDpParamasForAc_1();  
 { 
...
tools.appendString(" ");
if(tools.getParamValue("RenderSingle").equals("EXPANDEDSubSectionDynamicUIForCalculatedca156706_7f53_42db_a41e_c1ccd7d608a0_pyDynaUIPropertyReference")){
gridLayout_2();
 } 
tools.appendString(" ");
...
static {
	...
	oPropDefinitions_1.put("Embed-Fields.pyDynaUILabel", new LiteweightPropertyDefinition("Embed-Fields", "pyDynaUILabel", "sTN", false, true, "pxTextInput", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-FIELDS DYNAMICUIFORCALCULATED #20210506T204027.314 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "DynamicUIForCalculated");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-FIELDS DYNAMICUIFORCALCULATED #20210506T204027.314 GMT", "Embed-Fields DynamicUIForCalculated", "Theme-Cosmos", "04-01-01", "20210506T204027.314 GMT");
}
