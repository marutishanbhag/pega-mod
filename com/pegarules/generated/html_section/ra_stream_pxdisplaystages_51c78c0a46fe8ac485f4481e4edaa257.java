...
/**
 * Builds JSP stream WORK-!PXDISPLAYSTAGES.
 */
public class ra_stream_pxdisplaystages_51c78c0a46fe8ac485f4481e4edaa257 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pxDisplayStages.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1414533222;
 ...
 */
	public ra_stream_pxdisplaystages_51c78c0a46fe8ac485f4481e4edaa257(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "b5c4728ad7098d5a1555083cb5b798d965a764cb";
...
{
/* Instance RULE-HTML-SECTION WORK- PXDISPLAYSTAGES #20210506T204027.847 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "b5c4728ad7098d5a1555083cb5b798d965a764cb";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pxDisplayStages",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- PXDISPLAYSTAGES #20210506T204027.847 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PXDISPLAYSTAGES #20210506T204027.847 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PXDISPLAYSTAGES #20210506T204027.847 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PXDISPLAYSTAGES"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXDISPLAYSTAGES","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION WORK- PXDISPLAYSTAGES #20210506T204027.847 GMT","!PXDISPLAYSTAGES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1414533222)
	};
...
//	RULE-HTML-SECTION WORK- PXDISPLAYSTAGES #20210506T204027.847 GMT:20211119T125622.524 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "7c0c891dffde7175b1d01ceabed45f4f";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pxDisplayStages",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pxDisplayStages','insKey':'RULE-HTML-SECTION WORK- PXDISPLAYSTAGES #20210506T204027.847 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_3();
pzLayout_5();
...
public void getNextPage_2(String listSource, int listStartIndex, int listEndIndex) {
	...
	map.put("pxDataSourceId", pxUniqueStreamHash+"_22");
	...
	nextPageMetadata.put("datasrcid",pxUniqueStreamHash+"_22");
...
public void buildSection_5() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_19","pzStageName", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pzStageName"; 
	...
	tools.putParamValue("section_actions_string", getUIActionsMetaData_2());
...
pzSection.getLayout().setExpandParam("SubSectionCellpxDisplayStages479","",false);
}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		String offlineUsingPage = "pyWorkPage";
		strLAClassName = "Work-";
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("pxDisplayStages",
				...
				String usingPage = "pyWorkPage";
				if(("").equals(usingPage)) { usingPage = tools.getStepPage().getReference(); }
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pxDisplaySteps\",\"overlay\",\":event\",\"pyWorkPage\",\""+streamType+"\",\"pz-po-c-list\",\"pzModalTemplate\",\"%7B%22isCustomMobileAnim%22%3A%22true%22%2C%22desktop%22%3A%7B%22reveal%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22anim-grow-open%22%2C%22speed%22%3A%22default%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22reverse-anim-grow-open%22%2C%22speed%22%3A%22default%22%7D%7D%2C%22mobile%22%3A%7B%22reveal%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22anim-offbottom-open%22%2C%22speed%22%3A%22default%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22reverse-anim-offbottom-open%22%2C%22speed%22%3A%22default%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"true\",\"false\",\"\",\"\"]");
					} else {
...
public void buildSection_4() { 
	...
	secInfo.put("secActionStringID", pxUniqueStreamHash+"_16");
	}
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_15","pzStageName", secInfo);
}
...
public int simpleLayoutCell_2(  int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzStageName",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing remove-right-spacing   flex flex-row ' ");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzStageName",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
String pyInstanceId ="";
char mode = tools.getProperty("D_CaseStages.pxResults").getMode();
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  "D_CaseStages.pxResults AddDelete", expressionId, true);
expressionId = expression.getId();
}
ClipboardProperty rdlPageListProp = tools.getProperty("D_CaseStages.pxResults");
String rdlPageListPropRef = "D_CaseStages.pxResults";
if(rdlPageListProp != null) {
rdlPageListPropRef = rdlPageListProp.getReference();
}
String rdlRefreshWhenStr = "D_CaseStages.pxResults AddDelete";
rdlRefreshWhenStr = rdlRefreshWhenStr.replace("D_CaseStages.pxResults",rdlPageListPropRef);
if(!StringUtils.isBlank(expressionId)) {
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStages.pxResults").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
} else {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStages.pxResults").getReference(),"",false)); 
}
...
pgSectionBody.put("datasrcid",pxUniqueStreamHash+"_23");
pyRDDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();
paramsMap.put("InsHandle", ".pzInsKey");
pyRDDataPageParams.put("pyName","InsHandle");
...
pgSectionBody.put("dpname","D_CaseStages");
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
...
pgRDMetadata.put("ariaLabel","Stages");
...
map.put("pyContext", "D_CaseStages.pxResults");
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStages.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStages.pxResults").getReference(),"", false),pyInstanceId);
}
tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
ClipboardProperty cpSource = tools.getProperty("D_CaseStages.pxResults");
...
dummyPageName = "DummyD_CaseStages_pxResults";
}
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStages.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
itemPage = tools.createPage("Embed-Stage",dummyPageName);
PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
simpleLayoutCell_2(1);
	pega.popStackFrame(itemFrame, false);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStages.pxResults").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
}
}else{
if(mode =='L' || mode =='G'){
Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStages.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_CaseStages.pxResults").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
...
pzSection.getLayout().setExpandParam("SubSectionpxDisplayStagesBBB","",false);
}
...
public void simpleLayout_2() {
	...
	tools.appendString(tools.getProperty("D_CaseStages.pxResults").getReference()+ "' ");
	tools.appendString(" " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(3)'}") + "  class=' flex content   layout-content-inline content-inline stages ' ");
	String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
	ClipboardProperty rdlPageListProperty = tools.getProperty("D_CaseStages.pxResults");
	String rdlPageListPropRef = "D_CaseStages.pxResults";
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	rdlPageListProp = tools.getProperty("D_CaseStages.pxResults");
...
String paramName = "EXPANDEDSubSectionpxDisplayStagesBBB";
...
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& wxShowDisplayStages wxpyIsMobilePhone", pxUniqueStreamHash+"_25");metadataPage.put("lMode","Flexbox");
metadataPage.put("contCustom","padding-0 stages-container");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& wxShowDisplayStages wxpyIsMobilePhone","ShowDisplayStages  && pyIsMobilePhone", "layout", "visible" )) {pzSetExpandParam_4();
...
public void buildSection_3() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_13","pyDisplayStagesAndSteps", secInfo);
}
public void buildWhiteList_1() {
Map<String, String> config;
config = new HashMap<String, String>();
config.put("pySectionName", "pxDisplayStages");
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pyDisplayStagesAndSteps";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_3() {
pzSection.getLayout().setExpandParam("SubSectionpxDisplayStagesBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpxDisplayStagesBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pyDisplayStagesAndSteps'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
IUIComponent containerComponent = pzAuto.getUIComponent();
com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2&& wxShowStepsInsideContainer wxShowDisplayStages o1! wxpyIsMobilePhone", pxUniqueStreamHash+"_14");metadataPage.put("isSectionIncl","true");
IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2&& wxShowStepsInsideContainer wxShowDisplayStages o1! wxpyIsMobilePhone","ShowStepsInsideContainer && ShowDisplayStages && !pyIsMobilePhone", "layout", "visible" )) {boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pyDisplayStagesAndSteps'}") + ">");
}
pzSetExpandParam_3();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_2() { 
	...
	secInfo.put("secActionStringID", pxUniqueStreamHash+"_7");
	}
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzStageName", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	tools.putParamValue("section_actions_string", getUIActionsMetaData_1());
	pzAuto.emitIncludeStreamReference(sectionName, null, inputType, "Rule-HTML-Section",null );
	tools.putParamValue("section_actions_string", "");
		tools.putParamValue("section_base_ref","");
	tools.putParamValue("RenderSingle",tempRenderSingle);
...
pzSection.getLayout().setExpandParam("SubSectionCellpxDisplayStages204","",false);
}
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				...
				if(("").equals(usingPage)) { usingPage = tools.getStepPage().getReference(); }
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pxDisplaySteps\",\"overlay\",\":event\",\"pyWorkPage\",\""+streamType+"\",\"pz-po-c-list\",\"pzModalTemplate\",\"%7B%22isCustomMobileAnim%22%3A%22true%22%2C%22desktop%22%3A%7B%22reveal%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22anim-grow-open%22%2C%22speed%22%3A%22default%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22reverse-anim-grow-open%22%2C%22speed%22%3A%22default%22%7D%7D%2C%22mobile%22%3A%7B%22reveal%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22anim-offbottom-open%22%2C%22speed%22%3A%22default%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22reverse-anim-offbottom-open%22%2C%22speed%22%3A%22default%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
					} else {
						tools.appendString("[\"processAction\", [\"You are not authorized to perform this Flow or Local action\"]");
						}
						}
...
public void buildSection_1() { 
	...
	secInfo.put("secActionStringID", pxUniqueStreamHash+"_3");
	}
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_2","pzStageName", secInfo);
}
...
public int simpleLayoutCell_1(  int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzStageName",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing remove-right-spacing   flex flex-row ' ");
	boolean prevState = (tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails")))  ? true : false ;
	tools.putParamValue("bRDLShowDetails","false");
	tools.appendString("NAME='BASE_REF' BASE_REF='");
	if( pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'N'){
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzStageName",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpxDisplayStagesB","",false);
}


public void putRDLDPParams_1() {
	if(tools.getIfPresent(".pzInsKey") != null)
	tools.putParamValue("InsHandle",tools.getProperty(".pzInsKey").getStringValue());
	}
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	String paramName = "EXPANDEDSubSectionpxDisplayStagesB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2&& o1! wxShowStepsInsideContainer wxShowDisplayStages o1! wxpyIsMobilePhone", pxUniqueStreamHash+"_12");metadataPage.put("lMode","Flexbox");
	metadataPage.put("contCustom","padding-0 stages-container");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2&& o1! wxShowStepsInsideContainer wxShowDisplayStages o1! wxpyIsMobilePhone","!ShowStepsInsideContainer && ShowDisplayStages && !pyIsMobilePhone", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- PXDISPLAYSTAGES #20210506T204027.847 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pxDisplayStages");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PXDISPLAYSTAGES #20210506T204027.847 GMT", "Work- pxDisplayStages", "Theme-Cosmos", "04-01-01", "20211119T125622.524 GMT");
}
