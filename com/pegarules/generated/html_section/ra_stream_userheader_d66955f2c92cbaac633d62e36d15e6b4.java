 ...
 */
public class ra_stream_userheader_d66955f2c92cbaac633d62e36d15e6b4 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
 ...
 */
	public ra_stream_userheader_d66955f2c92cbaac633d62e36d15e6b4(com.pega.pegarules.priv.PegaAPI aContext) {
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "7bce7ff1c21cfbaf72c56942e61fbb2f";
	}
...
pzSection.getLayout().setExpandParam("SubSectionCellUserHeader838","",false);
}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771840270468");
	if(pzAuto.isOffline() || false) {
	try{
	pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771840270468","", false, false, false, false);
	...
	tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771840270469");
	if(pzAuto.isOffline() || false) {
	try{
	pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771840270469","", false, false, false, false);
	}catch(Exception e){oLog.error(e);}
	}
	tools.appendString("\"},\":event\"]");
...
pzStatic_ControlMenu.emitContent();
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771840270470");
		if(pzAuto.isOffline() || false) {
		try{
		pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771840270470","", false, false, false, false);
		}catch(Exception e){oLog.error(e);}
		}
		tools.appendString("\"},\":event\"]");
		...
		tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771840270471");
		if(pzAuto.isOffline() || false) {
		try{
		pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771840270471","", false, false, false, false);
		}catch(Exception e){oLog.error(e);}
		}
		tools.appendString("\"},\":event\"]");
...
pzSection.getLayout().setExpandParam("SubSectionCellUserHeader659","",false);
}
