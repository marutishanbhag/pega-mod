...
/**
 * Builds JSP stream RULE-OBJ-CASETYPE!PZDISPLAYCASETYPEVIEWS.
 */
public class ra_stream_pzdisplaycasetypeviews_802ffa348b724bcd0ab869467adbf75c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzDisplayCaseTypeViews.Rule_Obj_CaseType.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1464313290;
 ...
 */
	public ra_stream_pzdisplaycasetypeviews_802ffa348b724bcd0ab869467adbf75c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "84718c77989666f2701de2a6af89c2303dcee6bc";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-CASETYPE PZDISPLAYCASETYPEVIEWS #20230618T001742.495 GMT	Pega-ProcessArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "84718c77989666f2701de2a6af89c2303dcee6bc";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzDisplayCaseTypeViews",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-CASETYPE PZDISPLAYCASETYPEVIEWS #20230618T001742.495 GMT
 * Set up context.
 */
final String prevRuleKey_2 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-CASETYPE PZDISPLAYCASETYPEVIEWS #20230618T001742.495 GMT";final String prevClass_2 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-CASETYPE PZDISPLAYCASETYPEVIEWS #20230618T001742.495 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	"Rule-File-Text:WEBWB!PZPEGA_UI_CONSTELLATION_BRIDGE!JS", 
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-HTML-Section:PZDISPLAYCASETYPEVIEWS", 
	"Rule-Obj-Property:PYTEMPLATEINPUTBOX", 
	"Rule-HTML-Property:PZUIVIEWS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		new DependentRuleInfo("WEBWB!PZPEGA_UI_CONSTELLATION_BRIDGE!JS","Rule-File-Text","",false,"","Pega-UIEngine","","RULE-FILE-TEXT WEBWB PZPEGA_UI_CONSTELLATION_BRIDGE!JS #20230618T001610.369 GMT","WEBWB!PZPEGA_UI_CONSTELLATION_BRIDGE!JS",true,false,"ABSOLUTE_CLASSLESS",1), 
		...
		new DependentRuleInfo("PZDISPLAYCASETYPEVIEWS","Rule-HTML-Section","RULE-OBJ-CASETYPE",false,"","Pega-ProcessArchitect","08-23-01","RULE-HTML-SECTION RULE-OBJ-CASETYPE PZDISPLAYCASETYPEVIEWS #20230618T001742.495 GMT","!PZDISPLAYCASETYPEVIEWS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1464313290), 
		...
		new DependentRuleInfo("PZUIVIEWS","Rule-HTML-Property","",false,"","Pega-ProcessArchitect","08-23-01","RULE-HTML-PROPERTY PZUIVIEWS #20230618T001732.278 GMT","PZUIVIEWS",true,false,"ABSOLUTE_CLASSLESS",-224430893)
	};
...
//	RULE-HTML-SECTION RULE-OBJ-CASETYPE PZDISPLAYCASETYPEVIEWS #20230618T001742.495 GMT:20230618T001742.495 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT:20180713T133539.879 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT:20180713T133539.879 GMT
//	RULE-HTML-PROPERTY PZUIVIEWS #20230618T001732.278 GMT:20230703T053320.223 GMT
//	RULE-OBJ-ACTIVITY RULE- PZASSEMBLEPREPROCESS #20180713T132655.315 GMT:20180713T132655.315 GMT
//	RULE-FILE-TEXT WEBWB PZPEGA_UI_CONSTELLATION_BRIDGE!JS #20230618T001610.369 GMT:20230720T120719.669 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT:20180713T133539.879 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT:20180713T133539.879 GMT
//	RULE-HTML-PROPERTY PZUIVIEWS #20230618T001732.278 GMT:20230703T053320.223 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "74bffa8c22a2e2d2a7fed0b642e912ac";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzDisplayCaseTypeViews",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzDisplayCaseTypeViews','insKey':'RULE-HTML-SECTION RULE-OBJ-CASETYPE PZDISPLAYCASETYPEVIEWS #20230618T001742.495 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
pzLayout_10();
pzLayout_11();
...
params_2.putString("currentClass", pega.getValue("CaseTypeStages.pyClassName"));
params_2.putString("displayWarningMessage", pega.getValue(".pyDisplayWarningMessage"));
...
params_2.putString("bLocalize", "true");
	...
	if (currentProperty_2 != null && currentProperty_2.getParentPage().getClassName().equals("Rule-Obj-CaseType")) {
		...
		final PRStackFrame stack_2 = ((PegaAPI) tools).pushStackFrame( params_2, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pzUIViews" );
		try {
...
property_Rule_Obj_CaseType_pzUIViews();
			}
		} finally {
...
if (_jspx_meth_pega_reference__1(pageContext, ".pyTemplateInputBox", "input", "pzUIViews")) {
	return;
}
	}} catch(Throwable t) {
...
if (_jspx_meth_pega_param__1(pageContext, "currentClass", "CaseTypeStages.pyClassName")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "displayWarningMessage", ".pyDisplayWarningMessage")) {
	return true;
}
...
tools.appendString("\n        ");
	...
	pzStatic__2.addFile("pzpega_ui_constellation_bridge", "14049271631", "js");
tools.appendString("\n     ");
mParentTag = prevParentTag;
...
tools.appendString("\n  ");
if (!foundChoice_1 && (pega.isPreviewMode() || ((invokeWhenRule(tools, "pzIsCosmosUISupported"))))) {
tools.appendString("\n    ");

      String uniqueId = "UIViews-" + java.util.UUID.randomUUID().toString();
      String staticContentServer = pega_rules_utilities.pyGetC11NSvcURL();
      String currentClass = tools.getParamValue("currentClass");     
      // Check if we need to pass a warning message for display
      String displayWarningMessage = null;
      String displayWarningMessageSetting = tools.getParamValue("displayWarningMessage");
      boolean isWorkClass = pega_rules_default.pxIsAncestorOf(currentClass, "Work-");
      boolean isConstellationCase = tools.getPrimaryPage().getBoolean("pyIsConstellationCase");
    
      if(isWorkClass && "RuleSetsLocked".equals(displayWarningMessageSetting)) {
         displayWarningMessage = tools.getLocalizedTextForString("pyCaption", "pyAllRuleSetVersionsAreLocked");
      } else if (!isWorkClass) {
        // data designer scenario, use D_pzManageDataModel[ClassName:.pyClassName].pyHasAvailableRuleSet
        ClipboardPage manageDataModel = ((PegaAPI)tools).findDataPage("D_pzManageDataModel", true, "ClassName", currentClass);
        
        if (manageDataModel != null) {
          String hasAvailableRuleset = manageDataModel.getStringIfPresent(".pyHasAvailableRuleSet");
        
          if (!"true".equals(hasAvailableRuleset)) {
            displayWarningMessage = tools.getLocalizedTextForString("pyCaption", "pyAllRuleSetVersionsAreLocked");
          } 
        }        
      } 
      ...
      activityMap.putString("pyClassName", "@baseclass");
      activityMap.putString("pyActivityName", "pzGetUIViews");
      ParameterPage paramPage = new ParameterPage();
      paramPage.putString("className", currentClass);
      tools.doActivity(activityMap, null, paramPage);
      String viewsList = java.util.Base64.getEncoder().encodeToString(paramPage.getString("uiViews").getBytes());
      StringMap pyIsHybridAppMap = new HashStringMap();
  	  pyIsHybridAppMap.putString("pxObjClass", "Rule-Obj-When");
   	  pyIsHybridAppMap.putString("pyClassName", "@baseclass");
  	  pyIsHybridAppMap.putString("pyBlockName", "pzIsHybridApp");
  	  boolean bIsHybridApp = tools.evaluateWhen(pyIsHybridAppMap);
    
tools.appendString("\n    <div id=\"");
out.print(uniqueId);
tools.appendString("\"></div>\n    ");
onlyOnce_1();
tools.appendString("\n    <script>\n      (function() {\n        // BUG-651845: Helper function to decode Base64-encoded strings into UTF-8 instead of pure ASCII (i.e., https://stackoverflow.com/questions/30106476/using-javascripts-atob-to-decode-base64-doesnt-properly-decode-utf-8-strings)\n        function b64DecodeUnicode(str) {\n          return decodeURIComponent(Array.prototype.map.call(atob(str), function(c) {\n            return '%' + ('00' + c.charCodeAt(0).toString(16)).slice(-2);\n          }).join(''));\n        }\n        \n        let loadingIndicator;\n        const UIViews = {};\n        UIViews.load = function() {\n          const payload = ");
out.print( pega_rules_utilities.pyGetC11NBootstrapConfig() );
tools.appendString(";\n          payload.componentName = \"UIViews\"; // Nebula component name\n          payload.dependencies = [];\n          payload.staticContentServer = \"");
out.print(staticContentServer);
tools.appendString("\";\n          payload.rootId = '");
out.print(uniqueId);
tools.appendString("';\n          payload.props = {};\n          payload.props.currentClass = pega.tools.Security.decodeCrossScriptingFilter('");
out.print(StringUtils.crossScriptingFilter(currentClass));
tools.appendString("');\n          payload.props.isInWorkClass = ");
out.print(isWorkClass);
tools.appendString(";\n          payload.props.isHybridApp = ");
out.print(bIsHybridApp);
tools.appendString(";                                                                 \n          payload.props.isConstellationCase = '");
out.print(isConstellationCase);
tools.appendString("'\n          \n          ");
 if(displayWarningMessage != null) { 
tools.appendString("  \n            payload.props.displayWarningMessage = pega.tools.Security.decodeCrossScriptingFilter('");
out.print(StringUtils.crossScriptingFilter(displayWarningMessage));
tools.appendString("');\n          ");
 } 
tools.appendString("\n                                                                                   \n          let viewsList = '");
out.print(viewsList);
tools.appendString("';\n          try {                                                                                  \n            viewsList = JSON.parse(b64DecodeUnicode(viewsList));\n            payload.props.viewsList = viewsList;\n          } catch(e) {\n            console.error(\"Unable to parse views list!\");\n            console.log(viewsList);\n            loadingIndicator.hide();\n            return;\n          }\n          \n          pega.c11nBridge.dispatch(pega.c11nBridge.ACTIONS.RENDERACOMPONENT, payload).then(function() {\n            loadingIndicator.hide();\n          }).catch(function() {\n            loadingIndicator.hide();\n          });\n        };\n\n        UIViews.nullify = function() {\n          loadingIndicator.hide();\n          loadingIndicator = null;\n          const payload = {};\n          payload.rootId = '");
out.print(uniqueId);
tools.appendString("';\n          pega.c11nBridge.dispatch(pega.c11nBridge.ACTIONS.UNMOUNTACOMPONENT, payload).then(function() {\n            // Nothing for now\n          }).catch(function(){});\n        };\n\n        $(document).ready(function() {\n          loadingIndicator = new pega.ui.busyIndicator(\"\", true, document.body, 250);\n          loadingIndicator.show(false, true);\n          pega.u.d.registerAsHarnessElement(UIViews, pega.u.d.getContainerSectionElement(\"");
out.print(uniqueId);
tools.appendString("\"));\n          UIViews.load();\n        }, true);\n      })();\n    </script>\n  ");
...
if (!foundChoice_1) {
tools.appendString("   \n    ");
pzAuto.emitIncludeStreamReference("pzCosmosUIUnsupported", null, null, "Rule-HTML-Section", null);
tools.appendString("\n  ");
}
tools.appendString("\n");
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-PROPERTY PZUIVIEWS #20230618T001732.278 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzUIViews");
	oStreamProperties_1.put("pyRuleSetVersion", "08-23-01");
}
/**
 * Generates stream property_Rule_Obj_CaseType_pzUIViews
 */
private void property_Rule_Obj_CaseType_pzUIViews() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
/* Instance RULE-HTML-PROPERTY PZUIVIEWS #20230618T001732.278 GMT	Pega-ProcessArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-PROPERTY PZUIVIEWS #20230618T001732.278 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-PROPERTY PZUIVIEWS #20230618T001732.278 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-PROPERTY PZUIVIEWS #20230618T001732.278 GMT */
}
}


public void field_pzUIViews_1() { 
String mode1 = getActionsForCustomControls_1();
tools.putSaveValue("mode1Action",mode1);
String mode2 = getActionsForCustomControls_1();
tools.putSaveValue("mode2Action",mode2);
...
params_1.putString("currentClass", pega.getValue("CaseTypeStages.pyClassName"));
params_1.putString("displayWarningMessage", pega.getValue(".pyDisplayWarningMessage"));
...
params_1.putString("bLocalize", "true");
	...
	if (currentProperty_1 != null && currentProperty_1.getParentPage().getClassName().equals("Rule-Obj-CaseType")) {
		...
		final PRStackFrame stack_1 = ((PegaAPI) tools).pushStackFrame( params_1, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pzUIViews" );
		try {
...
public int simpleLayoutCell_8( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzUIViews",".pyTemplateInputBox",".pySections(4).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_37")) {	field_pzUIViews_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202012181208550587161-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzUIViews");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pzUIViews",".pyTemplateInputBox",".pySections(4).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_40")) {	field_pzUIViews_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzDisplayCaseTypeViewsBBBBBBBB","",false);
}
...
public void simpleLayout_6() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202012181208550572608") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzDisplayCaseTypeViewsBBBBBBBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzConstellationCase", pxUniqueStreamHash+"_41");metadataPage.put("lMode","SimpleDiv");
...
if(pzAuto.handleEvaluateWhen(" wxpzConstellationCase","pzConstellationCase", "layout", "visible" )) {pzSetExpandParam_11();
...
tools.appendString("<div class='layout layout-noheader layout-noheader-page_canvas'>");
...
public void buildSection_8() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_31","pzDisplayDataViews", secInfo);
}
...
public void sectionBodyIncludeInCell_6() { 
	...
	String sectionName = "pzDisplayDataViews"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzDisplayCaseTypeViews782","",false);
}
...
public void buildSection_7() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_28","pzDisplayDataViews", secInfo);
}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzDisplayDataViews",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzDisplayCaseTypeViewsBBBBBBB","",false);
}
...
public void simpleLayout_4() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806191433240134399") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default padding-t-2x" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","padding-t-2x");
		pg_dlmeta.put("format","default");
	...
	String paramName = "EXPANDEDSubSectionpzDisplayCaseTypeViewsBBBBBBB";
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzToggle_ToggleForDataView20171205T125054", pxUniqueStreamHash+"_32");metadataPage.put("dlChild","true");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzToggle_ToggleForDataView20171205T125054","pzToggle_ToggleForDataView20171205T125054", "layout", "visible" )) {pzSetExpandParam_9();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void getNextPage_1(String listSource, int listStartIndex, int listEndIndex) {
	...
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201806191433240134477" ) + "");
...
public void buildSection_6() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_18",".pyViewType", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = tools.getProperty(".pyViewType").getStringValue();
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpzDisplayCaseTypeViews815","",false);
}
...
public void buildSection_5() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_15",".pyViewType", secInfo);
}
...
public int simpleLayoutCell_3(  int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION",".pyViewType",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row ' ");
	...
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201806191433240134477-" + rowTestID) + " ");
	}else {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION",".pyViewType",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
String pyInstanceId ="";
char mode = tools.getProperty("D_pzLoadViewsForAClass.pxResults").getMode();
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
pgSection.put("liveUI","" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + ""); 
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  "D_pzLoadViewsForAClass.pxResults AddDelete", expressionId, true);
expressionId = expression.getId();
}
ClipboardProperty rdlPageListProp = tools.getProperty("D_pzLoadViewsForAClass.pxResults");
String rdlPageListPropRef = "D_pzLoadViewsForAClass.pxResults";
if(rdlPageListProp != null) {
rdlPageListPropRef = rdlPageListProp.getReference();
}
String rdlRefreshWhenStr = "D_pzLoadViewsForAClass.pxResults AddDelete";
rdlRefreshWhenStr = rdlRefreshWhenStr.replace("D_pzLoadViewsForAClass.pxResults",rdlPageListPropRef);
if(!StringUtils.isBlank(expressionId)) {
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzLoadViewsForAClass.pxResults").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
} else {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzLoadViewsForAClass.pxResults").getReference(),"",false)); 
}
...
paramsMap.put("InitializeWhenMissing", "true");
pyRDDataPageParams.put("pyName","InitializeWhenMissing");
pyRDDataPageParams.put("pyValue","{\"value\":\"true\",\"isLiteral\":true}");
pgSectionBody.addMetadataInArray("rdparamslst",pyRDDataPageParams);
pyRDDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();
paramsMap.put("RecordType", "Rule-HTML-Section");
pyRDDataPageParams.put("pyName","RecordType");
pyRDDataPageParams.put("pyValue","{\"value\":\"Rule-HTML-Section\",\"isLiteral\":true}");
pgSectionBody.addMetadataInArray("rdparamslst",pyRDDataPageParams);
pyRDDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();
paramsMap.put("ContextClass", ".pyClassName");
pyRDDataPageParams.put("pyName","ContextClass");
 { String propertyRef=".pyClassName";if(propertyRef.startsWith(".")){		propertyRef = tools.getStepPage().getReference() + propertyRef;}
pyRDDataPageParams.put("pyValue","{\"value\":\""+propertyRef+"\",\"isLiteral\":false}"); } 
pgSectionBody.addMetadataInArray("rdparamslst",pyRDDataPageParams);
pgSectionBody.put("dpname","D_pzLoadViewsForAClass");
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
...
pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201806191433240134477" ) + "");
...
map.put("pyContext", "D_pzLoadViewsForAClass.pxResults");
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzLoadViewsForAClass.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzLoadViewsForAClass.pxResults").getReference(),"", false),pyInstanceId);
}
tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
ClipboardProperty cpSource = tools.getProperty("D_pzLoadViewsForAClass.pxResults");
...
dummyPageName = "DummyD_pzLoadViewsForAClass_pxResults";
}
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzLoadViewsForAClass.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
itemPage = tools.createPage("Data-Tag-RelevantRecord",dummyPageName);
PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
simpleLayoutCell_3(1);
	pega.popStackFrame(itemFrame, false);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzLoadViewsForAClass.pxResults").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
}
}else{
if(mode =='L' || mode =='G'){
Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzLoadViewsForAClass.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pzLoadViewsForAClass.pxResults").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("pzDisplayCaseTypeViews",
...
pzSection.getLayout().setExpandParam("SubSectionpzDisplayCaseTypeViewsBBBBBB","",false);
}


public void putRDLDPParams_1() {
	tools.putParamValue("InitializeWhenMissing","true");
	tools.putParamValue("RecordType","Rule-HTML-Section");
	if(tools.getIfPresent(".pyClassName") != null)
	tools.putParamValue("ContextClass",tools.getProperty(".pyClassName").getStringValue());
	}
...
public void simpleLayout_2() {
		...
		tools.appendString(tools.getProperty("D_pzLoadViewsForAClass.pxResults").getReference()+ "' ");
		tools.appendString(" " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + "  class=' flex content   layout-content-inline content-inline  ' ");
		String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
		ClipboardProperty rdlPageListProperty = tools.getProperty("D_pzLoadViewsForAClass.pxResults");
		String rdlPageListPropRef = "D_pzLoadViewsForAClass.pxResults";
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201806191433240134477" ) + " ");
		tools.appendString(">");
		int index = 1;
		...
		rdlPageListProp = tools.getProperty("D_pzLoadViewsForAClass.pxResults");
	...
	String paramName = "EXPANDEDSubSectionpzDisplayCaseTypeViewsBBBBBB";
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}");
	if(!inspectorLayoutData.isEmpty()) {
	metadataPage.put("liveUI", inspectorLayoutData);
	}
	String pyPrefix = null;
...
pzSection.getLayout().setExpandParam("SubSectionpzDisplayCaseTypeViewsBBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806191433240133651") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  layout-content-inline content-inline " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzDisplayCaseTypeViewsBBBBB";
...
public void buildSection_4() { 
	...
	secParams.put("MoreInformationContentID","5052");
	secParams.put("HelpContentID","5051");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pxHelpSnippetGadget", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String strSectionPageProp = "";
	tools.putParamValue("MoreInformationContentID","5052");tools.putParamValue("HelpContentID","5051");tools.putParamValue("section_params","");
...
pzSection.getLayout().setExpandParam("SubSectionCellpzDisplayCaseTypeViews37","",false);
}
...
public void buildSection_3() { 
	...
	secParams.put("HelpContentID","5051");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_8","pxHelpSnippetGadget", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pxHelpSnippetGadget",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pxHelpSnippetGadget",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzDisplayCaseTypeViewsBBBB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806191433240133187") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-inline content-inline " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzDisplayCaseTypeViewsBBBB";
...
public int simpleLayoutCell_7( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpzToggle_ToggleForDataView20171205T125054","pzToggle_ToggleForDataView20171205T125054","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzToggle_ToggleForDataView20171205T125054",pxUniqueStreamHash+"_34");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_34");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzToggle_ToggleForDataView20171205T125054");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Obj-CaseType");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzToggle_ToggleForDataView20171205T125054", pxUniqueStreamHash+"_34"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzDisplayCaseTypeViewsBBB","",false);
}
...
public void simpleLayout_5() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20180619143324013372") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3)'}") + " class='" + "flex  content  auto-width-column layout-content-default content-default abrakadabra" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","abrakadabra");
	...
	String paramName = "EXPANDEDSubSectionpzDisplayCaseTypeViewsBBB";
	...
	String pyPrefix = null;
	metadataPage.put("prefix","-page_canvas");
	metadataPage.put("sectionIndex","3");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpzConstellationCase", pxUniqueStreamHash+"_35");metadataPage.put("lMode","Flexbox");
	metadataPage.put("contCustom","padding-t-0");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpzConstellationCase","!pzConstellationCase", "layout", "visible" )) {pzSetExpandParam_3();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pzEditViewScripts", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "pzEditViewScripts";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_2() {
pzSection.getLayout().setExpandParam("SubSectionpzDisplayCaseTypeViewsBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzDisplayCaseTypeViewsBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzEditViewScripts'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
IUIComponent containerComponent = pzAuto.getUIComponent();
com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzConstellationCase", pxUniqueStreamHash+"_5");metadataPage.put("isSectionIncl","true");
IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzConstellationCase","pzConstellationCase", "layout", "visible" )) {boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzEditViewScripts'}") + ">");
}
pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_2","pzC11nComponentGenAIConfig", secInfo);
}
...
config.put("pySectionName", "pzDisplayCaseTypeViews");
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzC11nComponentGenAIConfig";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzDisplayCaseTypeViewsB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzDisplayCaseTypeViewsB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzC11nComponentGenAIConfig'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
IUIComponent containerComponent = pzAuto.getUIComponent();
com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpyEnableC11nGenAI", pxUniqueStreamHash+"_3");metadataPage.put("isSectionIncl","true");
IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpyEnableC11nGenAI","pyEnableC11nGenAI", "layout", "visible" )) {boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzC11nComponentGenAIConfig'}") + ">");
}
pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	oPropDefinitions_2.put("Rule-Obj-CaseType.pyTemplateInputBox", new LiteweightPropertyDefinition("Rule-Obj-CaseType", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_2.put("pyClassName", "Rule-Obj-CaseType");
	oStreamProperties_2.put("pyCircumstanceProp", "");
	oStreamProperties_2.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-CASETYPE PZDISPLAYCASETYPEVIEWS #20230618T001742.495 GMT");
	...
	oStreamProperties_2.put("pyStreamName", "pzDisplayCaseTypeViews");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-CASETYPE PZDISPLAYCASETYPEVIEWS #20230618T001742.495 GMT", "Rule-Obj-CaseType pzDisplayCaseTypeViews", "Pega-ProcessArchitect", "08-23-01", "20230618T001742.495 GMT");
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_1 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY PZUIVIEWS #20230618T001732.278 GMT", "pzUIViews", "Pega-ProcessArchitect", "08-23-01", "20230703T053320.223 GMT");
}
