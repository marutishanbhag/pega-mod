...
/**
 * Builds JSP stream RULE-!PZMODALTEMPLATE.
 */
public class ra_stream_pzmodaltemplate_7c7c423ac2e6179a57600dc26440a627 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzModalTemplate.Rule_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 691844162;
 ...
 */
	public ra_stream_pzmodaltemplate_7c7c423ac2e6179a57600dc26440a627(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "3f6d55d5dd509c7aaddf8c02b13fef6eb28857ec";
...
{
/* Instance RULE-HTML-SECTION RULE- PZMODALTEMPLATE #20200826T182805.478 GMT	Pega-Desktop:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "3f6d55d5dd509c7aaddf8c02b13fef6eb28857ec";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzModalTemplate",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE- PZMODALTEMPLATE #20200826T182805.478 GMT
 * Set up context.
 */
final String prevRuleKey_4 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE- PZMODALTEMPLATE #20200826T182805.478 GMT";final String prevClass_4 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE- PZMODALTEMPLATE #20200826T182805.478 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-HTML-Section:PZMODALTEMPLATE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZMODALTEMPLATE","Rule-HTML-Section","RULE-",false,"","Pega-Desktop","08-06-01","RULE-HTML-SECTION RULE- PZMODALTEMPLATE #20200826T182805.478 GMT","!PZMODALTEMPLATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",691844162), 
...
//	RULE-HTML-SECTION RULE- PZMODALTEMPLATE #20200826T182805.478 GMT:20200826T182805.478 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "4a09c1c6af0f5920e1d38a9232dd5918";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzModalTemplate",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzModalTemplate','insKey':'RULE-HTML-SECTION RULE- PZMODALTEMPLATE #20200826T182805.478 GMT','sectionType':'standard'}");
...
params_4.putString("Id", "ModalButtonSubmit");
...
property_Rule_Application_pzModalButton();
			}
		} finally {
...
params_3.putString("Id", "ModalButtonSubmit");
...
params_2.putString("Id", "ModalButtonCancel");
...
/**
 * Generates stream property_Rule_Application_pzModalButton
 */
private void property_Rule_Application_pzModalButton() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
params_1.putString("Id", "ModalButtonCancel");
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzModalButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_5")) {	field_pzModalButton_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015021207042708209917-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8")) {	field_pzModalButton_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzModalButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-right-spacing    " + pzSection.getCustomStyle(false, "","margin-l-auto","margin-l-auto")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_9")) {	field_pzModalButton_3();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015021207042708211270-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzModalButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
...
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_12")) {	field_pzModalButton_4();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzModalTemplateBB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20191027064341033582") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzModalTemplateBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== pxparam.includedStreamName cq", pxUniqueStreamHash+"_13");metadataPage.put("lMode","Flexbox");
...
if(pzAuto.handleEvaluateWhen(" o2== pxparam.includedStreamName cq","param.includedStreamName == \'\'", "layout", "visible" )) {pzSetExpandParam_2();
...
sectionBodyIncludeInCell_1(false,false,"","pzModalAction");elementModel_1("pzModalAction","pzModalTemplate","BAR","");
 } 
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("SUB_SECTION","pzModalAction",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"   ColSpan=2 ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "width:56%;width:100%;min-width:250px;",false,"","");sectionIncludeInCell_pzModalAction_1(); pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>");
 } 
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzModalTemplateB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpzModalTemplateB";
...
static {
	...
	oStreamProperties_4.put("pzInsKey", "RULE-HTML-SECTION RULE- PZMODALTEMPLATE #20200826T182805.478 GMT");
	...
	oStreamProperties_4.put("pyStreamName", "pzModalTemplate");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE- PZMODALTEMPLATE #20200826T182805.478 GMT", "Rule- pzModalTemplate", "Pega-Desktop", "08-06-01", "20200826T182805.478 GMT");
