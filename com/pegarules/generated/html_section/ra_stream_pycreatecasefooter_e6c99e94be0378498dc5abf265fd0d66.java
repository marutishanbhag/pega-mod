...
/**
 * Builds JSP stream WORK-!PYCREATECASEFOOTER.
 */
public class ra_stream_pycreatecasefooter_e6c99e94be0378498dc5abf265fd0d66 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyCreateCaseFooter.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 937419751;
 ...
 */
	public ra_stream_pycreatecasefooter_e6c99e94be0378498dc5abf265fd0d66(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "b52f89207ed0d7b9ff887cf696cf6ef40f7434eb";
...
{
/* Instance RULE-HTML-SECTION WORK- PYCREATECASEFOOTER #20210506T204028.652 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "b52f89207ed0d7b9ff887cf696cf6ef40f7434eb";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyCreateCaseFooter",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- PYCREATECASEFOOTER #20210506T204028.652 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PYCREATECASEFOOTER #20210506T204028.652 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PYCREATECASEFOOTER #20210506T204028.652 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYCREATECASEFOOTER", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCREATECASEFOOTER","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION WORK- PYCREATECASEFOOTER #20210506T204028.652 GMT","!PYCREATECASEFOOTER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",937419751), 
...
//	RULE-HTML-SECTION WORK- PYCREATECASEFOOTER #20210506T204028.652 GMT:20210910T132303.945 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "8af00609460bf21e1ed6fb411e7bd2d6";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyCreateCaseFooter",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyCreateCaseFooter','insKey':'RULE-HTML-SECTION WORK- PYCREATECASEFOOTER #20210506T204028.652 GMT','templated':'true','editable':'true','sectionType':'standard'}");
pzLayout_2();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pyCaseActionAreaButtons", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCreateCaseFooter302","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pyCaseActionAreaButtons", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= pxparam.pyShowFAButtons cqtrue","param.pyShowFAButtons != \'true\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyCaseActionAreaButtons",".pyRegions(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","padding-2x margin-0","padding-2x margin-0")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("customROStyles","padding-2x margin-0");
	pgCells.put("customRWStyles","padding-2x margin-0");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= pxparam.pyShowFAButtons cqtrue",pxUniqueStreamHash+"_5");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_5");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","param.pyShowFAButtons != 'true'");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= pxparam.pyShowFAButtons cqtrue", pxUniqueStreamHash+"_5"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyCaseActionAreaButtons",".pyRegions(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpyCreateCaseFooterB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)','region':'A'}") + " class='" + "flex  content  layout-content-stacked content-stacked " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpyCreateCaseFooterB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- PYCREATECASEFOOTER #20210506T204028.652 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyCreateCaseFooter");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PYCREATECASEFOOTER #20210506T204028.652 GMT", "Work- pyCreateCaseFooter", "Theme-Cosmos", "04-01-01", "20210910T132303.945 GMT");
}
