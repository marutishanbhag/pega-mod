...
/**
 * Builds JSP stream RULE-OBJ-FLOWACTION!PYCATEGORYITEMLISTENTRY.
 */
public class ra_stream_pycategoryitemlistentry_dfdaddf5b5e0c416cf2910ac6c383622 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyCategoryItemListEntry.Rule_Obj_FlowAction.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -296251101;
 ...
 */
	public ra_stream_pycategoryitemlistentry_dfdaddf5b5e0c416cf2910ac6c383622(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "68a63f1e5beaa79e8c4b3023fec077fae3c250e0";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-FLOWACTION PYCATEGORYITEMLISTENTRY #20180713T140924.846 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "68a63f1e5beaa79e8c4b3023fec077fae3c250e0";
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-FLOWACTION PYCATEGORYITEMLISTENTRY #20180713T140924.846 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-FLOWACTION PYCATEGORYITEMLISTENTRY #20180713T140924.846 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-FLOWACTION PYCATEGORYITEMLISTENTRY #20180713T140924.846 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCATEGORYITEMLISTENTRY","Rule-HTML-Section","RULE-OBJ-FLOWACTION",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION RULE-OBJ-FLOWACTION PYCATEGORYITEMLISTENTRY #20180713T140924.846 GMT","!PYCATEGORYITEMLISTENTRY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-296251101)
	};
...
//	RULE-HTML-SECTION RULE-OBJ-FLOWACTION PYCATEGORYITEMLISTENTRY #20180713T140924.846 GMT:20180713T140924.846 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "d34922a6d13d78cfa70d2f22389e57a6";
	}

	public String getDefinitionAppliesToClass() {
		return "Rule-Obj-FlowAction";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyCategoryItemListEntry",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyCategoryItemListEntry','insKey':'RULE-HTML-SECTION RULE-OBJ-FLOWACTION PYCATEGORYITEMLISTENTRY #20180713T140924.846 GMT','sectionType':'standard'}");
pzLayout_9();
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCategoryItemListEntry141","",false);
}
...
public void simpleLayout_4() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806190540150921319") + " ");
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxNever", pxUniqueStreamHash+"_31");metadataPage.put("dlChild","true");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxNever","Never", "layout", "visible" )) {pzSetExpandParam_8();
...
public void getNextPage_1(String listSource, int listStartIndex, int listEndIndex) {
	...
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201806190540150921520" ) + "");
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCategoryItemListEntry43","",false);
}
...
public int simpleLayoutCell_4(  int index) {
	...
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201806190540150921520-" + rowTestID) + " ");
	}else {
...
pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201806190540150921520" ) + "");
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201806190540150921520" ) + " ");
	tools.appendString(">");
	int index = 1;
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCategoryItemListEntry990","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806190540150920226") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCategoryItemListEntry443","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20180619054015092086") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxNever",pxUniqueStreamHash+"_33");
	...
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Obj-FlowAction");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxNever", pxUniqueStreamHash+"_33"); 
	}
...
public void simpleLayout_5() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806190540150919705") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Rule-Obj-FlowAction");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-FLOWACTION PYCATEGORYITEMLISTENTRY #20180713T140924.846 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-FLOWACTION PYCATEGORYITEMLISTENTRY #20180713T140924.846 GMT", "Rule-Obj-FlowAction pyCategoryItemListEntry", "Pega-ProcessArchitect", "08-01-01", "20180713T140924.846 GMT");
}
