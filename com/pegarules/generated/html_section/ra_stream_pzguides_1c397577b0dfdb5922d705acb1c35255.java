...
/**
 * Builds JSP stream RULE-APPLICATION!PZGUIDES.
 */
public class ra_stream_pzguides_1c397577b0dfdb5922d705acb1c35255 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzGuides.Rule_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 746334114;
 ...
 */
	public ra_stream_pzguides_1c397577b0dfdb5922d705acb1c35255(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "6aa80e7d87946f369e8a79da63facfd832a269c2";
...
{
/* Instance RULE-HTML-SECTION RULE-APPLICATION PZGUIDES #20180713T141808.936 GMT	Pega-AppDefinition:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "6aa80e7d87946f369e8a79da63facfd832a269c2";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzGuides",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-APPLICATION PZGUIDES #20180713T141808.936 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-APPLICATION PZGUIDES #20180713T141808.936 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-APPLICATION PZGUIDES #20180713T141808.936 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZGUIDES","Rule-HTML-Section","RULE-APPLICATION",false,"","Pega-AppDefinition","08-01-01","RULE-HTML-SECTION RULE-APPLICATION PZGUIDES #20180713T141808.936 GMT","!PZGUIDES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",746334114), 
...
//	RULE-HTML-SECTION RULE-APPLICATION PZGUIDES #20180713T141808.936 GMT:20180713T141808.936 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "1d509e7fa7df1c34b3f092dcdb92f48c";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzGuides",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzGuides','insKey':'RULE-HTML-SECTION RULE-APPLICATION PZGUIDES #20180713T141808.936 GMT','sectionType':'standard'}");
...
config.put("StreamName", "pzGuides");
...
config = new HashMap<String, String>();
config.put("pzActivity", "pzAvailablePortalsPreProcessing");
...
config.put("NewTaskStatus", "pzAvailableIn");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_10")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzGuides_"+ referenceString+ "_25'";
	 String securedPropValue = null;
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Add guide",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "height:31px;width:182px;",false,"","");tools.putSaveValue("parentLayouttype","ACTION");pxLink_4();
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead gridActionAlignCenter","dataLabelWrite gridActionAlignCenter"), "height:31px;width:187px;",false,"","");labelIncludeInCell_1("","","","",false,"",true,false,"Standard",false);
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(3)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead gridActionAlignRight","dataLabelWrite gridActionAlignRight"), "height:31px;width:187px;",false,"","");labelIncludeInCell_2("","","","",false,"",true,false,"Standard",false);
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>\n\n\t\t\t\t\t\t</div>");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_9")){
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzGuides_"+ referenceString+ "_19'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzGuides_"+ referenceString+ "_18'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20170327023508070427742") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }tools.appendString("[\"doGridAction\",[\":event\",\"FLOWACTION\",\"pzAvailableIn\",{\"noThreadProcess\":\"false\",\"templateName\":\"pzModalTemplate\"},\"null\",\"false\"]");
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","pzGuideAvailablePortalsCount",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString("</a>");}pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
		tools.putParamValue("pega_attributes","");
	tools.appendString("</span>");tools.putParamValue("doAutoFormatting", "false");
tools.putParamValue("isControlEditableOriginal", true);
...
try {
tools.appendString(" data-importance='secondary' data-attribute-name='");
 String columnHeaderValue = "Available in"; if(!columnHeaderValue.contains(" ") && pega_procom_harness.IsParam(columnHeaderValue) && tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1)) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1))); }  else if(!columnHeaderValue.contains(" ") && columnHeaderValue.matches(".*[.][a-zA-Z]+.*") && !columnHeaderValue.endsWith(".") && tools.getIfPresent(columnHeaderValue) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getIfPresent(columnHeaderValue).getStringValue()); }  else { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", columnHeaderValue, StreamBuilder.FMT_NORMAL); }  tools.appendString(StringUtils.crossScriptingFilter(columnHeaderValue)); 
tools.appendString("' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)")); tools.appendString("headers='a2'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:35px;'");}tools.appendString("class='");
	tools.appendString(" gridCell");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
...
public void repeatingDataCell_8() {
	...
	String strFieldValue = ".pyTemplateInputBox";
		tools.appendString("<td title='");
		tools.appendString("'    ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("201703010613500605992334") + " ");
try {
tools.appendString(" data-importance='secondary' data-attribute-name='");
 String columnHeaderValue = ""; if(!columnHeaderValue.contains(" ") && pega_procom_harness.IsParam(columnHeaderValue) && tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1)) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1))); }  else if(!columnHeaderValue.contains(" ") && columnHeaderValue.matches(".*[.][a-zA-Z]+.*") && !columnHeaderValue.endsWith(".") && tools.getIfPresent(columnHeaderValue) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getIfPresent(columnHeaderValue).getStringValue()); }  else { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", columnHeaderValue, StreamBuilder.FMT_NORMAL); }  tools.appendString(StringUtils.crossScriptingFilter(columnHeaderValue)); 
tools.appendString("' ");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(pzSection.getCustomStyle(true,"","standard_dataLabelRead","standard_dataLabelWrite"));tools.appendString(" gridCell");tools.appendString(" ");tools.appendString("' pyCellType = 'static' ");
		tools.appendString("");
		
		tools.appendString(" bSortable = 'false'");
		
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyGuides1colWidthCache3").equals("")){ tools.appendParamCSF("PpyGuides1colWidthCache3"); } else { tools.appendString("29"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
...
public void repeatingDataCell_7() {
	...
	String strFieldValue = ".pyTemplateInputBox";
		tools.appendString("<td title='");
		tools.appendString("'    ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20170327023508070426489") + " ");
try {
tools.appendString(" data-importance='secondary' data-attribute-name='");
 String columnHeaderValue = "Available in"; if(!columnHeaderValue.contains(" ") && pega_procom_harness.IsParam(columnHeaderValue) && tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1)) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1))); }  else if(!columnHeaderValue.contains(" ") && columnHeaderValue.matches(".*[.][a-zA-Z]+.*") && !columnHeaderValue.endsWith(".") && tools.getIfPresent(columnHeaderValue) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getIfPresent(columnHeaderValue).getStringValue()); }  else { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", columnHeaderValue, StreamBuilder.FMT_NORMAL); }  tools.appendString(StringUtils.crossScriptingFilter(columnHeaderValue)); 
tools.appendString("' ");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(pzSection.getCustomStyle(false,"","heading_2_dataLabelRead ","heading_2_dataLabelWrite "));tools.appendString(" gridCell");tools.appendString(" ");tools.appendString("' pyCellType = 'static' ");
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyGuides1colWidthCache2").equals("")){ tools.appendParamCSF("PpyGuides1colWidthCache2"); } else { tools.appendString("202"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:25px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont '");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc454242378'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "Available in", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
...
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc454242378' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc454242378' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc454242378' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyGuides1colWidthCache1").equals("")){ tools.appendParamCSF("PpyGuides1colWidthCache1"); } else { tools.appendString("260"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:25px;'"); } 
									tools.appendString(">"); } 
									...
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "Application guide", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<span style='position:absolute; top:0px; right: 0px;'>&nbsp;</span>"); } if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
...
pzSection.getLayout().setExpandParam("SubSectionpzGuidesB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpzGuidesB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pyGuidesL3=null;

 Map selUniqMap_pyGuidesL3 = null;
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyGuides");tools.appendString("_pzGuides_1'");
...
tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201703010523540109854") + " ");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pyGuides");

					}

					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList='.pyLabel .pyTemplateInputBox .pyTemplateInputBox  ' class='yui-skin-sam gPXAuto grid-responsive-default ");

					if(pega_uiengine_harness.pzInStandardsMode()) {tools.appendString(" floated ");

					}tools.appendString("' style='");

					if(!pega_uiengine_harness.pzInStandardsMode()) {tools.appendString("display:"); if(pzAuto.getBrowserUtils().isIE()) {  tools.appendString(" inline; "); } else {  tools.appendString("inline-block;"); } }tools.appendString("' gPropIndex='PpyGuides1' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201703010523540109854-layout") + " ");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' ><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpyGuides1colWidthGBL\" id=\"PpyGuides1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyGuides1colWidthGBL"));tools.appendString("\" />");

					
						 tools.putParamValue("expandRL","false"); 

					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpyGuides1colWidthGBR\" id=\"PpyGuides1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyGuides1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpyGuides1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' style='width:");

					 if(!tools.getParamValue("PpyGuides1colWidthGBL").equals("")) { tools.appendParamCSF("PpyGuides1colWidthGBL"); } else { 

					tools.appendString("518.0"); } 

					tools.appendString("px;' cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='' PL_PROP='");

					
tools.appendString(".pyGuides");

					tools.appendString("' PL_PROP_CLASS='Embed-Guide' PRIM_PAGE='");
					...
					tools.appendString("'>\n\t\t\t\t\t\t\t\t\t\t<tr class='cellCont' ><td class='cellCont rowHandleHead  ' style='height:27px;width:27px;'>");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pyGuides").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pyGuides\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201703010523540109854-" + rowTestID) + " ");
					...
					tools.appendString("draggableCell ");tools.appendString("rowHandle  ' style='height:39px;width:27px;' primaryExists = 'true' >");
					...
					tools.appendString("style='height:39px;'");
					...
					tools.appendString("<div class=\"divCont\" ><span class=\"wspan\"></span><div class=\"cellIn\"></div></div>");
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"4\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("Embed-Guide", "tempNoRespg");
 ...
 tempNoRespg.removeFromClipboard();
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pyGuides1") && tools.getParamValue("partialRefresh").equals("false")) {
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");generateClientWhenDiv_1();pxLink_2();
									tools.appendString("</div>");
									tools.appendString("</DIV>"); } else { generateClientWhenDiv_1();pxLink_2();
									tools.appendString("</div>");}
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyLabel\"  SHOW_WHEN=\".pyLabel !=''\"");
if(pzAuto.evaluateWhen(".pyLabel !=''",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyLabel", -1);
	}
}catch(Exception e){}
}
...
if (_jspx_meth_pega_param__1(pageContext, "CustomQuery", "&pyActivity=Rule-Application.pzGetGuidesFromApplicationContext")) {
	return true;
}
...
if (_jspx_meth_pega_param__1(pageContext, "OtherKeyValuePairs", "pyPurpose=[pyLabel]")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "DisplayProperty", "pyPurpose")) {
	return true;
}
...
if (_jspx_meth_pega_param__1(pageContext, "Class", "Rule-Application-Guide")) {
	return true;
}
 ...
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyLabel", "input", "OpenRuleAdvanced")) {
	return;
}
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
getActionsForCustomControls_1() {
	...
	String currentStream = tools.getCurrentStream();
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzAvailablePortalsPreProcessing");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }				{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
					com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
						...
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzGuides"));
...
throw new RuntimeException("Problem in JSP fragment", t);
	 ...
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyLabel", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyGuides1")|| tools.getParamValue("partialTrigger").equals("editRow.pyGuides1") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pyGuides");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pyGuides\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pyGuides1")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty(".pyGuides");
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyGuides1") ){
...
static {
	oPropDefinitions_1.put("Rule-Application.pyLabel", new LiteweightPropertyDefinition("Rule-Application", "pyLabel", "sTN64", false, true, "FixedSizeForInput", true));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-APPLICATION PZGUIDES #20180713T141808.936 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzGuides");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-APPLICATION PZGUIDES #20180713T141808.936 GMT", "Rule-Application pzGuides", "Pega-AppDefinition", "08-01-01", "20180713T141808.936 GMT");
}
