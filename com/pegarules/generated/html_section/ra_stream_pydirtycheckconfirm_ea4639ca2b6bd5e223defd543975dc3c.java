...
/**
 * Builds JSP stream WORK-!PYDIRTYCHECKCONFIRM.
 */
public class ra_stream_pydirtycheckconfirm_ea4639ca2b6bd5e223defd543975dc3c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyDirtyCheckConfirm.Work_ProjectManagement_New.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1633134814;
 ...
 */
	public ra_stream_pydirtycheckconfirm_ea4639ca2b6bd5e223defd543975dc3c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "bff59e77743f80ce985822d22592d409986d0787";
...
{
/* Instance RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20210506T204028.728 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "bff59e77743f80ce985822d22592d409986d0787";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyDirtyCheckConfirm",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20210506T204028.728 GMT
 * Set up context.
 */
final String prevRuleKey_2 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20210506T204028.728 GMT";final String prevClass_2 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20210506T204028.728 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	"Rule-Obj-HTML:PYMODALHEADERDIRTY", 
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-HTML-Section:PYDIRTYCHECKCONFIRM", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		new DependentRuleInfo("PYMODALHEADERDIRTY","Rule-Obj-HTML","@BASECLASS",false,"","Pega-UIEngine","08-23-01","RULE-OBJ-HTML @BASECLASS PYMODALHEADERDIRTY #20230618T001617.866 GMT","!PYMODALHEADERDIRTY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1596550395), 
		...
		new DependentRuleInfo("PYDIRTYCHECKCONFIRM","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20210506T204028.728 GMT","!PYDIRTYCHECKCONFIRM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1633134814), 
...
//	RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20210506T204028.728 GMT:20230330T101842.138 GMT
//	RULE-OBJ-HTML @BASECLASS PYMODALHEADERDIRTY #20230618T001617.866 GMT:20230618T001617.866 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "7f50dead1955718a0cb16ba9d1848fd4";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyDirtyCheckConfirm",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyDirtyCheckConfirm','insKey':'RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20210506T204028.728 GMT','sectionType':'standard'}");
pzLayout_3();
...
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.u.d.discardHandler");
pega.getUIEngine().getUIAction("runScript", config).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.desktop.infinity.clearCaseActionParams");
pega.getUIEngine().getUIAction("runScript", config).register();
pega.getUIEngine().getUIAction("save", null).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.u.d.discardHandler");
pega.getUIEngine().getUIAction("runScript", config).register();
}
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("201503040434250575277530") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyDirtyCheckConfirm_$CTX$_8");
		String repeatIndx = "";
	String pyTooltip = "";
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","OK\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("OK", ".pyButtonLabel");
	}
	pyLabel = "OK";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyDirtyCheckConfirm_"+ referenceString+ "_8'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("201503040434250575277530") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.u.d.discardHandler()\"]");
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="OK".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		...
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","OK",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.infinity.clearCaseActionParams(\\\"true\\\")\"]");

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"setUserStart\",[\"SAVE\"]],[\"doSave\",[false,\":event\",false]");
	{
		com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();
		actionRequest.registerFixedParameter("pyActivity", "ReloadHarness");
		actionRequest.registerFixedParameter("TaskIndex", tools.getParamValue("TaskIndex"));
		actionRequest.registerFixedParameter("HarnessPurpose", tools.getParamValue("Purpose"));
		String primaryPageName = tools.getPrimaryPage()==null?"":tools.getPrimaryPage().getName();
		actionRequest.registerFixedParameter("pzPrimaryPageName", primaryPageName);
		String fromFrame = tools.getThread().getThreadPage().getString("pyHTMLFrame");
		actionRequest.registerFixedParameter("pzFromFrame", fromFrame);
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202004130740410264583") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyDirtyCheckConfirm_$CTX$_7");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Save\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Save", ".pyButtonLabel");
	}
	pyLabel = "Save";
	modePage2.put("label",pyLabel);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDirtyCheckConfirm_"+ referenceString+ "_7'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202004130740410264583") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.infinity.clearCaseActionParams(\\\"true\\\")\"]");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"setUserStart\",[\"SAVE\"]],[\"doSave\",[false,\":event\",false]");
	{
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Save".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		tools.appendString("<span class='pzbtn-label'  data-click='.' ");}if(bOptimizedMarkup && hasLineBreaks){
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Save",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString("</button>");	}
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20140827063747489") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyDirtyCheckConfirm_$CTX$_6");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Discard\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Discard", ".pyButtonLabel");
	}
	pyLabel = "Discard";
	modePage2.put("label",pyLabel);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDirtyCheckConfirm_"+ referenceString+ "_6'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20140827063747489") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.u.d.discardHandler()\"]");
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Discard".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		tools.appendString("<span class='pzbtn-label'  data-click='.' ");}if(bOptimizedMarkup && hasLineBreaks){
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Discard",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString("</button>");}
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20140827063652581") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyDirtyCheckConfirm_$CTX$_5");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Cancel\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Cancel", ".pyButtonLabel");
	}
	pyLabel = "Cancel";
	modePage2.put("label",pyLabel);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyDirtyCheckConfirm_"+ referenceString+ "_5'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20140827063652581") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	{
		com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();
		...
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Cancel",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString("</button>");	}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140827063652581-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","margin-r-auto");
	pgCells.put("customRWStyles","margin-r-auto");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_4( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& wxpxShowSaveButton o1! o2&& wxpzIsPerform o1! wxpzIsAJAXContainerContext","pxShowSaveButton && !(pzIsPerform && !pzIsAJAXContainerContext)","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140827063747489-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxpxShowSaveButton o1! o2&& wxpzIsPerform o1! wxpzIsAJAXContainerContext",pxUniqueStreamHash+"_18");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_18");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pxShowSaveButton && !(pzIsPerform && !pzIsAJAXContainerContext)");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxpxShowSaveButton o1! o2&& wxpzIsPerform o1! wxpzIsAJAXContainerContext", pxUniqueStreamHash+"_18"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxButton_2();}
...
public int simpleLayoutCell_5( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","margin-r-0","margin-r-0")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202004130740410264583-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","margin-r-0");
	pgCells.put("customRWStyles","margin-r-0");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxpxShowSaveButton o1! o2&& wxpzIsPerform o1! wxpzIsAJAXContainerContext",pxUniqueStreamHash+"_22");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxpxShowSaveButton o1! o2&& wxpzIsPerform o1! wxpzIsAJAXContainerContext", pxUniqueStreamHash+"_22"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxButton_3();}
...
public int simpleLayoutCell_6( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2|| wxpxHideSaveButton o2&& wxpzIsPerform o1! wxpzIsAJAXContainerContext","pxHideSaveButton || (pzIsPerform && !pzIsAJAXContainerContext)","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","margin-r-0","margin-r-0")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201503040434250575277530-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2|| wxpxHideSaveButton o2&& wxpzIsPerform o1! wxpzIsAJAXContainerContext",pxUniqueStreamHash+"_26");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_26");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pxHideSaveButton || (pzIsPerform && !pzIsAJAXContainerContext)");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Work-");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_26");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2|| wxpxHideSaveButton o2&& wxpzIsPerform o1! wxpzIsAJAXContainerContext", pxUniqueStreamHash+"_26"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxButton_4();}
...
pzSection.getLayout().setExpandParam("SubSectionpyDirtyCheckConfirmBB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201807061118070851846") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle padding-2x" + "'  ");
		...
		pg_dlmeta.put("customClassName","padding-2x");
	...
	String paramName = "EXPANDEDSubSectionpyDirtyCheckConfirmBB";
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_9","pyDirtyModalCon", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pyDirtyModalCon"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpyDirtyCheckConfirm693","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pyDirtyModalCon", secInfo);
}
...
"", "", "", "", "@baseclass", "", "04-02", "", "Rule-Obj-HTML", "Yes", "", "Pega-UIEngine", "08-23-01", "", "pyModalHeaderDirty", "", "RULE-OBJ-HTML @BASECLASS PYMODALHEADERDIRTY #20230618T001617.866 GMT" };
private void performStream_1() throws Throwable {
tools.appendString("<div class=\"hd\" id=\"modaldialog_hd_dirty\">\n\t<span>");
out.print(tools.getLocalizedTextForParameterizedString("pyCaption", "Unsaved changes"));
tools.appendString("</span>\n\t<button type=\"button\" class='container-close' id='container_close' onclick=\"doModalAction('', event);\" aria-label=\"");
out.print(tools.getLocalizedTextForParameterizedString("pyCaption", "dirtyModalClose"));
tools.appendString("\"></button>\n</div>");
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-OBJ-HTML @BASECLASS PYMODALHEADERDIRTY #20230618T001617.866 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyModalHeaderDirty");
	oStreamProperties_1.put("pyRuleSetVersion", "08-23-01");
}
/**
 * Build stream RULE-OBJ-HTML @BASECLASS PYMODALHEADERDIRTY #20230618T001617.866 GMT
 */
...
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
/* Instance RULE-OBJ-HTML @BASECLASS PYMODALHEADERDIRTY #20230618T001617.866 GMT	Pega-UIEngine:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
/*
 * Begin RULE-OBJ-HTML @BASECLASS PYMODALHEADERDIRTY #20230618T001617.866 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-OBJ-HTML @BASECLASS PYMODALHEADERDIRTY #20230618T001617.866 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-OBJ-HTML @BASECLASS PYMODALHEADERDIRTY #20230618T001617.866 GMT */
}
...
try {
/* Include stream RULE-OBJ-HTML @BASECLASS PYMODALHEADERDIRTY #20230618T001617.866 GMT */
include_1();
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-all-spacing   ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("20161017050536045940661")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20161017050536045940661")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyDirtyModalCon",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","padding-2x","padding-2x")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("partialClass","remove-all-spacing flex flex-row");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","padding-2x");
	pgCells.put("customRWStyles","padding-2x");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyDirtyModalCon",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyDirtyCheckConfirmB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20180706111807085081") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-stacked content-stacked " + "'  " + "role='alertdialog'");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		pg_dlmeta.put("ariaRole","alertdialog");
	...
	String paramName = "EXPANDEDSubSectionpyDirtyCheckConfirmB";
...
static {
	...
	oStreamProperties_2.put("pzInsKey", "RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20210506T204028.728 GMT");
	...
	oStreamProperties_2.put("pyStreamName", "pyDirtyCheckConfirm");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PYDIRTYCHECKCONFIRM #20210506T204028.728 GMT", "Work- pyDirtyCheckConfirm", "Theme-Cosmos", "04-01-01", "20230330T101842.138 GMT");
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_1 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-HTML @BASECLASS PYMODALHEADERDIRTY #20230618T001617.866 GMT", "@baseclass pyModalHeaderDirty", "Pega-UIEngine", "08-23-01", "20230618T001617.866 GMT");
}
