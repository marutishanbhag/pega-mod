...
/**
 * Builds JSP stream EMBED-FIELDS!DYNAMICUINONCALCOFFLINE.
 */
public class ra_stream_dynamicuinoncalcoffline_d9210e9e3ed2abf2445d885722c8a827 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.DynamicUINonCalcOffline.Embed_Fields.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1553437926;
 ...
 */
	public ra_stream_dynamicuinoncalcoffline_d9210e9e3ed2abf2445d885722c8a827(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "c49c828d5e09c11ddc3768c37ab0abd915674020";
...
{
/* Instance RULE-HTML-SECTION EMBED-FIELDS DYNAMICUINONCALCOFFLINE #20210813T054405.789 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "c49c828d5e09c11ddc3768c37ab0abd915674020";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("DynamicUINonCalcOffline",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-FIELDS DYNAMICUINONCALCOFFLINE #20210813T054405.789 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-FIELDS DYNAMICUINONCALCOFFLINE #20210813T054405.789 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-FIELDS DYNAMICUINONCALCOFFLINE #20210813T054405.789 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:DYNAMICUINONCALCOFFLINE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("DYNAMICUINONCALCOFFLINE","Rule-HTML-Section","EMBED-FIELDS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION EMBED-FIELDS DYNAMICUINONCALCOFFLINE #20210813T054405.789 GMT","!DYNAMICUINONCALCOFFLINE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1553437926), 
...
//	RULE-HTML-SECTION EMBED-FIELDS DYNAMICUINONCALCOFFLINE #20210813T054405.789 GMT:20210813T054757.893 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "8542e32d5b817e1fa74f3fc2c696bb4b";
	}
...
config = new HashMap<String, String>();
config.put("StreamName", "DynamicUINonCalcOffline");
...
else if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyDynaUIPropertyReferenceURL").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
	pzAuto.getUIComponentRuntime().setTemplatingUIStatus('Y');
}pxURL_1(".pyDynaUIPropertyReferenceURL",0,"","pxUseSourceValidate","Text");pzAuto.getUIComponentRuntime().insertTemplateScripts();}
else if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyDynaUIPropertyReference").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
	pzAuto.getUIComponentRuntime().setTemplatingUIStatus('Y');
...
public void generateClientWhenDiv_20() {
...
tools.appendString(" data-bindprops='value' ");} else{			tools.appendString(ddPropEntryHandle);
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_225")){inclFormattedVal_36(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_211")){inclFormattedVal_29(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_207")){inclFormattedVal_29(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_203")){inclFormattedVal_29(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
gridBeginLayout_3
 ...
 String returnTotalCount = ""; 
					...
					if (tmpDeclarePageParams != null && tmpDeclarePageParams.getProperty("D_pzOperatorsByWorkGroup_pxResults_DynamicUINonCalcOffline_2") != null) {

					
					ClipboardPage paramList = tmpDeclarePageParams.getProperty("D_pzOperatorsByWorkGroup_pxResults_DynamicUINonCalcOffline_2").getPageValue();
 ...
 Set filteredIndicesSetD_pzOperatorsByWorkGroup_pxResultsL7 = null;
	 ...
	 String strFCPage = "pyFilterCriteria_D_pzOperatorsByWorkGroup.pxResults_DynamicUINonCalcOffline_2";
...
gFCritPageD_pzOperatorsByWorkGroup_pxResultsL7.getProperty("pyRowVisibleWhenCondition").setValue("pzACRowVisibleWhen");
 ...
 tools.putParamValue("populateSelectedUIValues", "");
					...
					tools.appendString(" dataSource='");if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_pzOperatorsByWorkGroup.pxResults").getReference());tools.appendString("_DynamicUINonCalcOffline_2'");
					...
					tools.appendString(" bRangeFilterByFormat='false' bRowVisibleWhen = 'true' DPSectionID=\"SubSectionDynamicUINonCalcOffline91849c9a_f512_4a0c_9ce8_a6f5d27c1d8b_pyDynaUIPropertyReference\"  openOnDblClick='false' OAFunc='openRuleByKeys' ");
...
String expandParameter = "EXPANDEDSubSectionDynamicUINonCalcOffline91849c9a_f512_4a0c_9ce8_a6f5d27c1d8b_pyDynaUIPropertyReference";
...
if(!actionName.equals("PostValue") && !actionName.equals("ReadonlyFormat")){tools.putSaveValue("sectionUniqueID", "SID" + (((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique())+ "");
	pzSection.includeExpressions();
	  pzSection.beginSection("DynamicUINonCalcOffline",1,"Rule-HTML-Section","{'type':'Section','ruleName':'DynamicUINonCalcOffline','insKey':'RULE-HTML-SECTION EMBED-FIELDS DYNAMICUINONCALCOFFLINE #20210813T054405.789 GMT','templated':'true','sectionType':'standard'}");
...
tools.appendString("<div style=\"display:none;\" data-postvalue-url=\"" + StringUtils.escapeIntoJSONString(pega_rules_utilities.pzEncryptURLActionString(tools, "Thread", "pyActivity=ReloadCell&StreamName=DynamicUINonCalcOffline")) + "\"></div>");
}
...
tools.appendString("</P>");
	...
	pyDataPage.addMetadataInArray("pyAdditionalFields",pyAdditionalField);
	pyListDataSource.putMetadata("pyDataPage",pyDataPage);
	String dataAttributes = "[\"EXPANDEDSubSectionDynamicUINonCalcOffline91849c9a_f512_4a0c_9ce8_a6f5d27c1d8b_pyDynaUIPropertyReference\",0,170,{\"WorkGroup\" : \"pxRequestor.pxWorkGroup\"},\""+pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getStepPage().getReference(),"",false)+"\",0,false]";
...
cellChangeTracker.trackValueChanges("pxRequestor.pxWorkGroup", -1);
		 ...
		 boolean isMobilePhone = tools.evaluateWhen(keys);
			if(!isMobilePhone){
				...
				tools.appendString("data-ac-numeric-prop = true");
					...
					tools.appendString(" data-attributes='[ \"EXPANDEDSubSectionDynamicUINonCalcOffline91849c9a_f512_4a0c_9ce8_a6f5d27c1d8b_pyDynaUIPropertyReference\",0,0,{\"WorkGroup\" : \"pxRequestor.pxWorkGroup\"},\"" + tools.getStepPage().getReference() + "\",0,false]' />");
					if(!isMobilePhone){
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_212")){inclFormattedVal_30(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
pzSection.getLayout().setExpandParam("SubSectionCellDynamicUINonCalcOffline210","",false);
}
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_186")){inclFormattedVal_35(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
pzStatic_pzDatePickerAdvancedIncludes.emitContent();
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_176")){inclFormattedVal_32(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_165")){inclFormattedVal_29(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_161")){inclFormattedVal_29(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_157")){inclFormattedVal_29(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_153")){inclFormattedVal_29(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_149")){inclFormattedVal_29(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_145")){inclFormattedVal_29(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
gridBeginLayout_2
 ...
 Set filteredIndicesSet_pyDropdownListL7 = null;
	 ...
	 String strFCPage = "pyFilterCriteria_"+tools.getStepPage().getReference()+".pyDropdownList_DynamicUINonCalcOffline_2";
...
gFCritPage_pyDropdownListL7.getProperty("pyRowVisibleWhenCondition").setValue("pzACRowVisibleWhen");
 ...
 tools.putParamValue("populateSelectedUIValues", "");
					...
					tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyDropdownList");tools.appendString("_DynamicUINonCalcOffline_2'");
...
String expandParameter = "EXPANDEDSubSectionDynamicUINonCalcOfflinec810fdbc_81e0_4d68_948b_65529a0edd75_pyDynaUIPropertyReference";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\"><tr><td>");
...
tools.appendString("</P>");
	...
	String dataAttributes = "[\"EXPANDEDSubSectionDynamicUINonCalcOfflinec810fdbc_81e0_4d68_948b_65529a0edd75_pyDynaUIPropertyReference\",0,170,{},\""+pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getStepPage().getReference(),"",false)+"\",0,false]";
	modePage1.put("dataAttributes",dataAttributes);
	modePage1.putMetadata("pyListDataSource",pyListDataSource);
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015111210511107196565",true));
	String pyValueR = "";
	 ...
	 boolean isMobilePhone = tools.evaluateWhen(keys);
		if(!isMobilePhone){
			...
			tools.appendString("data-ac-numeric-prop = true");
				...
				tools.appendString(" data-attributes='[ \"EXPANDEDSubSectionDynamicUINonCalcOfflinec810fdbc_81e0_4d68_948b_65529a0edd75_pyDynaUIPropertyReference\",0,0,{},\"" + tools.getStepPage().getReference() + "\",0,false]' />");
				if(!isMobilePhone){
					tools.appendString("<button onclick='pd(event);' data-active='false' tabindex='-1' data-ctl='Button' type='button' data-click='[[\"runScript\", [\"p.c.IAutoCompleteAG.prototype.searchWithComboBox()\"]]]' " + disabled_ctrl + " ><i data-click='.' class='pi pi-caret-down'></i></button></div>");
					}else{
						tools.appendString("<span class='autocomplete_span' ><div class='autocomplete_icon' id='acspin'  ></div></span>");
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_166")){inclFormattedVal_30(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y' && !isOffline){
	...
	String spxUniqueStreamHash128 = getUIActionsMetaData_1();
	...
	modePage1.put("pyActionStringID",pxUniqueStreamHash+"_128");
	}
	cellPage.put("pzPrimaryPage",tools.getPrimaryPage().getReference());
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReference",pxUniqueStreamHash+"_129");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_129");
	String clientValidationAttributes = pzAuto.getCell().getClientValidationAttributes(pyOnInput, pyEditValidate, pyStringType,pegaValidation.toString());
	modePage1.put("clintValidAttrs",clientValidationAttributes);
	modePage1.put("pyID","pyDynaUIPropertyReference");
	...
	modePage1.put("pyResultsUniqueID",pxUniqueStreamHash+"_130");
	Map<String, Object> listSourceInfo = new HashMap<String, Object>();
	tools.putParamValue("bListOptionsLocalize","true");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadClipboardPage(".pyDropdownList", listProperties, pxUniqueStreamHash+"_130", listSourceInfo);
	tools.putParamValue("bListOptionsLocalize","");
	...
	ctrlComponent.endComponent();
			...
			String disabled_ctrl = "";
					...
					String strPropName= tools.getActive().getName();
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_132");}if(beginNonTemplate){					String strClassName = "Embed-Fields";
...
strCells[i][j] += strReferenceName;strCells[i][j] += "'"; radiogrpName = strReferenceName; 								strCells[i][j] += "aria-describedby='" + radiogrpName + "Error' ";
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_133")){inclFormattedVal_27(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y' && !isOffline){
	...
	modePage1.put("pyNoSelectionText",pyNoSelectionText);
	String clientValidationAttributes = pzAuto.getCell().getClientValidationAttributes(pyOnInput, pyEditValidate, pyStringType,pegaValidation.toString());
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReference",pxUniqueStreamHash+"_116");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_116");
	modePage1.put("clintValidAttrs",clientValidationAttributes);
	modePage1.put("pyID","pyDynaUIPropertyReference");
	modePage1.put("pyControlLoadMode","auto");
	modePage1.put("pyEnableGrouping","false");
	...
	modePage1.put("pyResultsUniqueID",pxUniqueStreamHash+"_117");
	Map<String, Object> listSourceInfo = new HashMap<String, Object>();
	tools.putParamValue("bListOptionsLocalize","true");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadClipboardPage(".pyDropdownList", listProperties, pxUniqueStreamHash+"_117", listSourceInfo);
	tools.putParamValue("bListOptionsLocalize","");
	...
	modePage1.put("pyActionStringID",pxUniqueStreamHash+"_118");
	}
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015111210511107196565",true));
	String pyValueR = "";
	String pyValueOrig = "";
	...
	String disabled_ctrl = "";
			...
			ClipboardPage cbpRes=null;
			ClipboardProperty cbpResults=null;
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_120");}if(beginNonTemplate){			HashStringMap params = new HashStringMap();
			String pageName =".pyDropdownList";
			if(pageName.indexOf(".")==0) {
...
tools.appendString(" data-bindprops='value' ");} else{			tools.appendString(ddPropEntryHandle);
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_121")){inclFormattedVal_25(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyDynaUIPropertyReference", ".pyCaption");
	modePage1.put("styleOther","");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReference",pxUniqueStreamHash+"_106");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_106");
	String placeHolderR="";
	modePage1.put("pyMin","");
	boolean isDecimalOrDouble = false;
	modePage1.put("isDecimalOrDouble",isDecimalOrDouble);
...
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	String propID ="pyDynaUIPropertyReference";
	...
	modePage1.put("pyActionStringID",pxUniqueStreamHash+"_107");
	}
	if(expressionId !=null && expressionId.length() > 0){
	modePage1.put("pyExpressionId",expressionId);
	}
	...
	String spxUniqueStreamHash108 = getUIActionsMetaData_1();
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_109")){inclFormattedVal_23(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-change='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						pzPackageRuntime.packageSection("DynamicUINonCalcOffline",
						...
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"DynamicUINonCalcOffline"));
...
tools.appendString("</P>");
	...
	modePage1.put("styleOther","");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReferenceEmail",pxUniqueStreamHash+"_96");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_96");
	String placeHolderR="";
	modePage1.put("pyMin","");
	boolean isDecimalOrDouble = false;
	modePage1.put("isDecimalOrDouble",isDecimalOrDouble);
...
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	String propID ="pyDynaUIPropertyReferenceEmail";
	...
	modePage1.put("helpertype",pyHelperTextType);
	modePage1.put("pyWidth","");
	String spxUniqueStreamHash97 = getUIActionsMetaData_2();
	...
	modePage1.put("pyActionStringID",pxUniqueStreamHash+"_97");
	}
	if(expressionId !=null && expressionId.length() > 0){
	modePage1.put("pyExpressionId",expressionId);
	}
	...
	String spxUniqueStreamHash98 = getUIActionsMetaData_1();
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_99")){inclFormattedVal_20(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyDynaUIPropertyReference", ".pyCaption");
	modePage1.put("styleOther","");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReference",pxUniqueStreamHash+"_86");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_86");
	String placeHolderR="";
	modePage1.put("pyMin","");
	boolean isDecimalOrDouble = false;
	modePage1.put("isDecimalOrDouble",isDecimalOrDouble);
...
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	String propID ="pyDynaUIPropertyReference";
	...
	modePage1.put("pyActionStringID",pxUniqueStreamHash+"_87");
	}
	if(expressionId !=null && expressionId.length() > 0){
	modePage1.put("pyExpressionId",expressionId);
	}
...
tools.appendString("</P>");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyDynaUIPropertyReference", ".pyCaption");
	modePage1.put("styleOther","");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReference",pxUniqueStreamHash+"_76");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_76");
	String placeHolderR="";
	modePage1.put("pyMin","");
	boolean isDecimalOrDouble = false;
	modePage1.put("isDecimalOrDouble",isDecimalOrDouble);
...
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	String propID ="pyDynaUIPropertyReference";
	...
	modePage2.put("pyActionStringID",pxUniqueStreamHash+"_78");
	}
	cellPage.addMetadataInArray("pyModes",modePage1);
	cellPage.addMetadataInArray("pyModes",modePage2);
	metadataPage.putMetadata("pyCell",cellPage);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_79")){
		textIncludes_1();		
		tools.appendString("\n<span  " + pzCell.getTestIdIfEnabled("2015111210511107196565") + "  data-ctl='Text' ");
...
tools.appendString("</P>");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyDynaUIPropertyReference", ".pyCaption");
	modePage1.put("styleOther","");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReference",pxUniqueStreamHash+"_66");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_66");
	String placeHolderR="";
	modePage1.put("pyMin","");
	boolean isDecimalOrDouble = false;
	modePage1.put("isDecimalOrDouble",isDecimalOrDouble);
...
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	String propID ="pyDynaUIPropertyReference";
	...
	modePage2.put("pyActionStringID",pxUniqueStreamHash+"_68");
	}
	cellPage.addMetadataInArray("pyModes",modePage1);
	cellPage.addMetadataInArray("pyModes",modePage2);
	metadataPage.putMetadata("pyCell",cellPage);
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,"entryHandle");}
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + "");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_69")){
		textIncludes_1();		
		tools.appendString("\n<span  " + pzCell.getTestIdIfEnabled("2015111210511107196565") + "  data-ctl='Text' ");
...
tools.appendString("</P>");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReferenceDate",pxUniqueStreamHash+"_56");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_56");
	String pyHelperTextType = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyHelperTextType","none\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
...
pzStatic_pzDatePickerAdvancedIncludes.emitContent();
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_59")){inclFormattedVal_11(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
tools.appendString("</P>");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDynaUIPropertyReferenceDateTime",pxUniqueStreamHash+"_46");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_46");
	String pyHelperTextType = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyHelperTextType","none\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
	...
	modePage1.put("pyActionStringID",pxUniqueStreamHash+"_47");
	}
...
pzStatic_pzDatePickerAdvancedIncludes.emitContent();
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015111210511107196565") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_49")){inclFormattedVal_9(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyPropertyType\"  SHOW_WHEN=\".pyPropertyType ='Decimal:pxCurrency'\"");
if(pzAuto.evaluateWhen(".pyPropertyType ='Decimal:pxCurrency'",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
public void pxTextInput_1() {String key="d8c83176-8b8a-4fd3-9645-54d49e3d01db||RULE-HTML-SECTION EMBED-FIELDS DYNAMICUINONCALCOFFLINE #20210813T054405.789 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","pxUseSourceValidate","Text","true","d8c83176-8b8a-4fd3-9645-54d49e3d01db"};oCellRuntimeParamsMap.put("d8c83176-8b8a-4fd3-9645-54d49e3d01db||RULE-HTML-SECTION EMBED-FIELDS DYNAMICUINONCALCOFFLINE #20210813T054405.789 GMT",paramValues);oControlPathsMap.put("d8c83176-8b8a-4fd3-9645-54d49e3d01db||RULE-HTML-SECTION EMBED-FIELDS DYNAMICUINONCALCOFFLINE #20210813T054405.789 GMT",".pyRegions(1).pyCells(1)||.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pyPropertyType ='Decimal:pxCurrency'", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
	String dataFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
	...
	pxCurrency_1(".pyDynaUIPropertyReference",0,"","pxUseSourceValidate","Text");try{
	labelName = ".pyDynaUILabel";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(labelName);
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_52");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_52");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	String disExpressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
	expressionId = pxUniqueStreamHash+"_63";
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_62");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_62");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_72");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_72");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
...
public int simpleLayoutTemplateCell_9( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_82");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_82");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
...
public int simpleLayoutTemplateCell_10( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_92");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_92");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
...
public int simpleLayoutTemplateCell_11( int index) {
	...
	String disExpressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
	expressionId = pxUniqueStreamHash+"_103";
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_102");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_102");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
...
public int simpleLayoutTemplateCell_12( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_112");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_112");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
...
public int simpleLayoutTemplateCell_13( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_124");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_124");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
...
public int simpleLayoutTemplateCell_14( int index) {
	...
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " rx.pyModeReadOnly");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyModeReadOnly",pxUniqueStreamHash+"_136");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.putMetadata("pxWhenIdentifiers",pxWhenIdentifiers);
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_136");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rx.pyPropertyType cqText:Picklist o2== rx.pyStreamName cqpxRadioButtons",pxUniqueStreamHash+"_135");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rx.pyPropertyType cqText:Picklist o2== rx.pyStreamName cqpxRadioButtons", pxUniqueStreamHash+"_135"); 
	}
...
public int simpleLayoutTemplateCell_15( int index) {
	...
	String disExpressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
	expressionId = pxUniqueStreamHash+"_170";
...
public int simpleLayoutTemplateCell_16( int index) {
	...
	String disExpressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
	expressionId = pxUniqueStreamHash+"_180";
...
public int simpleLayoutTemplateCell_17( int index) {
	...
	String disExpressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
	expressionId = pxUniqueStreamHash+"_190";
	...
	pxURL_1(".pyDynaUIPropertyReferenceURL",0,"","pxUseSourceValidate","Text");try{
	labelName = ".pyDynaUILabel";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(labelName);
...
public int simpleLayoutTemplateCell_18( int index) {
	...
	tools.putParamValue("RenderSingle", "");
	pzLayout_1();
 if(tools.getParamValue("RenderSingle").equals("EXPANDEDSubSectionDynamicUINonCalcOfflinec810fdbc_81e0_4d68_948b_65529a0edd75_pyDynaUIPropertyReference")){
gridLayout_1();
 } 
...
public int simpleLayoutTemplateCell_19( int index) {
	...
	String disExpressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
	expressionId = pxUniqueStreamHash+"_216";
...
public int simpleLayoutTemplateCell_20( int index) {
	...
	String disExpressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
	expressionId = pxUniqueStreamHash+"_229";
...
public int simpleLayoutTemplateCell_21( int index) {
	...
	String disExpressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
	expressionId = pxUniqueStreamHash+"_234";
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pyPropertyType='Text:pxTextInput' && .pyStreamName != .pyHTMLControl", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
...
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_235")) {	field_pzReferencePropertyControl_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();try{
	labelName = ".pyDynaUILabel";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(labelName);
...
pzSection.getLayout().setExpandParam("SubSectionDynamicUINonCalcOfflineB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionDynamicUINonCalcOfflineB";
...
private void performStream_1() throws Throwable {
 if("EXPANDEDSubSectionDynamicUINonCalcOfflinec810fdbc_81e0_4d68_948b_65529a0edd75_pyDynaUIPropertyReference".equals(tools.getParamValue("RenderSingle")) ){ 
 tools.putParamValue("rowVisibleWhen",".pyStandardValue:.pyLocalizedValue:contains"); 
 tools.putParamValue("AC_BestBetsProp",""); 
 } 
 if("EXPANDEDSubSectionDynamicUINonCalcOffline91849c9a_f512_4a0c_9ce8_a6f5d27c1d8b_pyDynaUIPropertyReference".equals(tools.getParamValue("RenderSingle")) ){ 
 tools.putParamValue("rowVisibleWhen",".pyUserIdentifier:contains"); 
 tools.putParamValue("AC_BestBetsProp",""); 
 setDpParamasForAc_1();  
 } 
 if("InitialRender_EXPANDEDSubSectionDynamicUINonCalcOfflinec810fdbc_81e0_4d68_948b_65529a0edd75_pyDynaUIPropertyReference".equals(tools.getParamValue("RenderSingle")) ){ 
 tools.putParamValue("rowVisibleWhen",".pyStandardValue:.pyLocalizedValue:contains"); 
 tools.putParamValue("AC_BestBetsProp",""); 
 { 
...
buildWhiteList_1();
 if("InitialRender_EXPANDEDSubSectionDynamicUINonCalcOffline91849c9a_f512_4a0c_9ce8_a6f5d27c1d8b_pyDynaUIPropertyReference".equals(tools.getParamValue("RenderSingle")) ){ 
 tools.putParamValue("rowVisibleWhen",".pyUserIdentifier:contains"); 
 tools.putParamValue("AC_BestBetsProp",""); 
 setDpParamasForAc_1();  
 { 
...
tools.appendString(" ");
if(tools.getParamValue("RenderSingle").equals("EXPANDEDSubSectionDynamicUINonCalcOffline91849c9a_f512_4a0c_9ce8_a6f5d27c1d8b_pyDynaUIPropertyReference")){
gridLayout_2();
 } 
tools.appendString(" ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-FIELDS DYNAMICUINONCALCOFFLINE #20210813T054405.789 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "DynamicUINonCalcOffline");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-FIELDS DYNAMICUINONCALCOFFLINE #20210813T054405.789 GMT", "Embed-Fields DynamicUINonCalcOffline", "Theme-Cosmos", "04-01-01", "20210813T054757.893 GMT");
}
