...
/**
 * Builds JSP stream @BASECLASS!PYMODALTEMPLATE.
 */
public class ra_stream_pymodaltemplate_ed795f4c3cc611efdc21e3b7601c691a extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyModalTemplate.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1487457356;
 ...
 */
	public ra_stream_pymodaltemplate_ed795f4c3cc611efdc21e3b7601c691a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "93ace9adf5502501ad783f6f2f916a6e62c8b3dd";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYMODALTEMPLATE #20190507T061115.951 GMT	Pega-UIEngine:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "93ace9adf5502501ad783f6f2f916a6e62c8b3dd";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyModalTemplate",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYMODALTEMPLATE #20190507T061115.951 GMT
 * Set up context.
 */
final String prevRuleKey_4 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYMODALTEMPLATE #20190507T061115.951 GMT";final String prevClass_4 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYMODALTEMPLATE #20190507T061115.951 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-HTML-Section:PYMODALTEMPLATE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYMODALTEMPLATE","Rule-HTML-Section","@BASECLASS",false,"","Pega-UIEngine","08-03-01","RULE-HTML-SECTION @BASECLASS PYMODALTEMPLATE #20190507T061115.951 GMT","!PYMODALTEMPLATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1487457356), 
...
//	RULE-HTML-SECTION @BASECLASS PYMODALTEMPLATE #20190507T061115.951 GMT:20190507T061115.951 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "3fc259bb184061faa0c52d19530b2288";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyModalTemplate",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyModalTemplate','insKey':'RULE-HTML-SECTION @BASECLASS PYMODALTEMPLATE #20190507T061115.951 GMT','sectionType':'standard'}");
...
property_Data_Admin_Operator_ID_pzModalButton();
...
pzSection.getLayout().setExpandParam("SubSectionpyModalTemplateBBBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201905070144430611460") + " ");
	...
	String paramName = "EXPANDEDSubSectionpyModalTemplateBBBB";
...
/**
 * Generates stream property_Data_Admin_Operator_ID_Button
 */
private void property_Data_Admin_Operator_ID_Button() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_2() {
	final Map streamProperties = pega.getStreamProperties();
	try {
property_Data_Admin_Operator_ID_Button();
...
/**
 * Generates stream property_Data_Admin_Operator_ID_pzModalButton
 */
private void property_Data_Admin_Operator_ID_pzModalButton() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
pzSection.getLayout().setExpandParam("SubSectionpyModalTemplateBBB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201905070144430611437") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
	...
	String paramName = "EXPANDEDSubSectionpyModalTemplateBBB";
	metadataPage.put("paramName", paramName);
...
pzSection.getLayout().setExpandParam("SubSectionpyModalTemplateBB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201905070144430610302") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
	...
	String paramName = "EXPANDEDSubSectionpyModalTemplateBB";
	metadataPage.put("paramName", paramName);
...
sectionBodyIncludeInCell_1(false,false,"","pzModalAction");elementModel_1("pzModalAction","pyModalTemplate","","");
 } 
...
pzSection.getLayout().setExpandParam("SubSectionpyModalTemplateB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpyModalTemplateB";
...
static {
	oPropDefinitions_4.put("Data-Admin-Operator-ID.pyTemplateInputBox", new LiteweightPropertyDefinition("Data-Admin-Operator-ID", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_4.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYMODALTEMPLATE #20190507T061115.951 GMT");
	...
	oStreamProperties_4.put("pyStreamName", "pyModalTemplate");
	oStreamProperties_4.put("pyRuleSetVersion", "08-03-01");
}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYMODALTEMPLATE #20190507T061115.951 GMT", "@baseclass pyModalTemplate", "Pega-UIEngine", "08-03-01", "20190507T061115.951 GMT");
