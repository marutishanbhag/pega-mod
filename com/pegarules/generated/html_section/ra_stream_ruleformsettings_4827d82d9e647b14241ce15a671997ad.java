 ...
 */
public class ra_stream_ruleformsettings_4827d82d9e647b14241ce15a671997ad extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.RuleFormSettings.Rule_Obj_Model.Stream");
 ...
 */
	public ra_stream_ruleformsettings_4827d82d9e647b14241ce15a671997ad(com.pega.pegarules.priv.PegaAPI aContext) {
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "db9ca865659696924a738b13eac3a850";
	}
...
static {
	oPropDefinitions_2.put("Rule-Obj-Model.pxInstanceLockedRuleSet", new LiteweightPropertyDefinition("Rule-Obj-Model", "pxInstanceLockedRuleSet", "sTY", true, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pxCreateDateTime", new LiteweightPropertyDefinition("Rule-Obj-Model", "pxCreateDateTime", "sMY", true, true, "DateTime-Medium", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pyRuleSetVersion", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyRuleSetVersion", "sTN", false, true, "RuleAttributes", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pyBaseRule", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyBaseRule", "sSN", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pyClassName", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyClassName", "siN", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pyMethodStatus ", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyMethodStatus ", "stN10", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pxUpdateDateTime", new LiteweightPropertyDefinition("Rule-Obj-Model", "pxUpdateDateTime", "sMY", true, true, "DateTime-Long", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pyRuleAvailable", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyRuleAvailable", "siN", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pyInterface", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyInterface", "siN64", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pyRuleSet", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyRuleSet", "sTN", false, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pzDocumentKey", new LiteweightPropertyDefinition("Rule-Obj-Model", "pzDocumentKey", "sTN", false, true, "pxTextInput", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pxInstanceLockedRuleSetVersion", new LiteweightPropertyDefinition("Rule-Obj-Model", "pxInstanceLockedRuleSetVersion", "sTY", true, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pzIsPrivateCheckOut", new LiteweightPropertyDefinition("Rule-Obj-Model", "pzIsPrivateCheckOut", "sTN", false, true, "pxTextInput", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pxObjClass", new LiteweightPropertyDefinition("Rule-Obj-Model", "pxObjClass", "sIY", true, true, "Default", false));
	oPropDefinitions_2.put("Rule-Obj-Model.pyRuleName", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyRuleName", "sTN255", false, true, "Default", false));
}
...
static {
	oPropDefinitions_1.put("Rule-Obj-Model.pyCircumstanceTemplate", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyCircumstanceTemplate", "sTN", false, true, "Default", false));
	oPropDefinitions_1.put("Rule-Obj-Model.pyCircumstanceDate", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyCircumstanceDate", "sMN", false, true, "Default", false));
	oPropDefinitions_1.put("Rule-Obj-Model.pyCircumstanceDateProp", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyCircumstanceDateProp", "sIN32", false, true, "Default", false));
	oPropDefinitions_1.put("Rule-Obj-Model.pyCircumstanceProp", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyCircumstanceProp", "sTN64", false, true, "Default", false));
	oPropDefinitions_1.put("Rule-Obj-Model.pyCircumstanceVal", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyCircumstanceVal", "sTN64", false, true, "Default", false));
	oPropDefinitions_1.put("Rule-Obj-Model.pyCircumstanceDefinition", new LiteweightPropertyDefinition("Rule-Obj-Model", "pyCircumstanceDefinition", "sTN", false, true, "SmartPromptForCirumDefintion", false));
}
