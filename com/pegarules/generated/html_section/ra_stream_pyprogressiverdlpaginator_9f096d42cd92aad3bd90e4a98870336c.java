...
/**
 * Builds JSP stream @BASECLASS!PYPROGRESSIVERDLPAGINATOR.
 */
public class ra_stream_pyprogressiverdlpaginator_9f096d42cd92aad3bd90e4a98870336c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyProgressiveRDLPaginator.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1447283896;
 ...
 */
	public ra_stream_pyprogressiverdlpaginator_9f096d42cd92aad3bd90e4a98870336c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "4e6c63f98fea512c9c94ed6e0b19eade3bc89482";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATOR #20210506T204029.638 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "4e6c63f98fea512c9c94ed6e0b19eade3bc89482";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyProgressiveRDLPaginator",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATOR #20210506T204029.638 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATOR #20210506T204029.638 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATOR #20210506T204029.638 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYPROGRESSIVERDLPAGINATOR", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYPROGRESSIVERDLPAGINATOR","Rule-HTML-Section","@BASECLASS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATOR #20210506T204029.638 GMT","!PYPROGRESSIVERDLPAGINATOR",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1447283896), 
...
//	RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATOR #20210506T204029.638 GMT:20210506T204029.638 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "5c314d6872e0d3635206143b19905dac";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyProgressiveRDLPaginator",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyProgressiveRDLPaginator','insKey':'RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATOR #20210506T204029.638 GMT','templated':'true','sectionType':'standard'}");
pzLayout_1();
...
config.put("pyFunctionName", "pega.desktop.infinity.rdlLoadAll");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.infinity.rdlLoadAll(event)\"]");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2015110410023706663712") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyProgressiveRDLPaginator_$CTX$_6f678065-9461-4ae5-a47c-2ca2865b722d");
		String repeatIndx = "";
	String pyTooltip = "";
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","View all\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("View all", ".pyButtonLabel");
	}
	pyLabel = "View all";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyProgressiveRDLPaginator_"+ referenceString+ "_6f678065-9461-4ae5-a47c-2ca2865b722d'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2015110410023706663712") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="View all".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		...
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","View all",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015110410023706663712-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpyProgressiveRDLPaginatorB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpyProgressiveRDLPaginatorB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATOR #20210506T204029.638 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyProgressiveRDLPaginator");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYPROGRESSIVERDLPAGINATOR #20210506T204029.638 GMT", "@baseclass pyProgressiveRDLPaginator", "Theme-Cosmos", "04-01-01", "20210506T204029.638 GMT");
}
