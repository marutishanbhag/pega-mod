...
/**
 * Builds JSP stream @BASECLASS!PZNOTIFICATIONSCOUNT.
 */
public class ra_stream_pznotificationscount_7642578411512c236f81ee6069f8ca8c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzNotificationsCount.Code_Pega_List.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1329753605;
 ...
 */
	public ra_stream_pznotificationscount_7642578411512c236f81ee6069f8ca8c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "cafbed87308256c9d9229215e19c534989d796ab";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "cafbed87308256c9d9229215e19c534989d796ab";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzNotificationsCount",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZNOTIFICATIONSCOUNT", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZNOTIFICATIONSCOUNT","Rule-HTML-Section","@BASECLASS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT","!PZNOTIFICATIONSCOUNT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1329753605), 
...
//	RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT:20210506T204030.745 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "3135d73f9fdf0802de4509b9b506624a";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_12","pzSubscribeDesktopNotifications", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionpzNotificationsCountBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzNotificationsCountBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzSubscribeDesktopNotifications'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzSubscribeDesktopNotifications'}") + ">");
}
pzSetExpandParam_2();
...
tools.appendString("\" value=\"");if(bUITemplatized){
	...
	tools.appendString(" data-ctl ");
		...
		tools.appendString(" data-change='[");if(isBehaviorAdded && true){ tools.appendString(","); }{String strStreamName="";String strPropertyTarget ="";String strPageName ="";strStreamName="pzNotificationsCount";if(tools.getPrimaryPage() != null){ strPageName = tools.getPrimaryPage().getName();}if(tools.getActive() != null){strPropertyTarget = tools.getActive().getEntryHandle();}com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();actionRequest.registerFixedParameter("pyActivity", "ReloadCell"); actionRequest.registerFixedParameter("pyPropertyTarget", strPropertyTarget ); actionRequest.registerFixedParameter("StreamName", strStreamName); actionRequest.registerFixedParameter("pzPrimaryPageName", strPageName); pzAuto.registerActionRequest(actionRequest);}		tools.appendString("[\"postValue\",[\":event\"]");
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyUnreadNotificationsCount\"  SHOW_WHEN=\".pyUnreadNotificationsCount >= 100\"");
if(pzAuto.evaluateWhen(".pyUnreadNotificationsCount >= 100",null,true)){
	if(currentTemplatingStatus =='N')
...
public void pxDisplayText_2() {String key="2||RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","N","false","0","","","Integer","true","2"};oCellRuntimeParamsMap.put("2||RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT",paramValues);oControlPathsMap.put("2||RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyUnreadNotificationsCount\"  SHOW_WHEN=\".pyUnreadNotificationsCount > 0 && .pyUnreadNotificationsCount < 100\"");
if(pzAuto.evaluateWhen(".pyUnreadNotificationsCount > 0 && .pyUnreadNotificationsCount < 100",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
public void pxDisplayText_1() {String key="1||RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","N","false","0","","","Integer","true","1"};oCellRuntimeParamsMap.put("1||RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT",paramValues);oControlPathsMap.put("1||RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyUnreadNotificationsCount",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " data-tour-id='UnreadNotificationsCount' class='content-item content-field item-" + Integer.toString(index) + "   notification-count dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pyUnreadNotificationsCount > 0 && .pyUnreadNotificationsCount < 100", expressionId);
...
public int simpleLayoutCell_2( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyUnreadNotificationsCount",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " data-tour-id='UnreadNotificationsCount' class='content-item content-field item-" + Integer.toString(index) + "   notification-count dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pyUnreadNotificationsCount >= 100", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
	String dataFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyUnreadNotificationsCount",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzNotificationsCountB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201902261431150713970") + " ");
	...
	if(!"".equals(conditionVal) && conditionVal.indexOf(",") != -1) {
		...
		if(currentTemplatingStatus != 'Y'){
			...
			tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-simple_list content-simple_list " + "'  ");
...
isBehaviorAdded = false;
		...
		String paramName = "EXPANDEDSubSectionpzNotificationsCountB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzNotificationsCount");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZNOTIFICATIONSCOUNT #20210506T204030.745 GMT", "@baseclass pzNotificationsCount", "Theme-Cosmos", "04-01-01", "20210506T204030.745 GMT");
}
