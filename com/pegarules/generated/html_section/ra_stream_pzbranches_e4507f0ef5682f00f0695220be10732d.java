...
/**
 * Builds JSP stream RULE-APPLICATION!PZBRANCHES.
 */
public class ra_stream_pzbranches_e4507f0ef5682f00f0695220be10732d extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzBranches.Rule_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1505820505;
 ...
 */
	public ra_stream_pzbranches_e4507f0ef5682f00f0695220be10732d(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a64e98cd1d9a5c886bc18b99557bdd3d4ff5f248";
...
{
/* Instance RULE-HTML-SECTION RULE-APPLICATION PZBRANCHES #20180713T135651.642 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "a64e98cd1d9a5c886bc18b99557bdd3d4ff5f248";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzBranches",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-APPLICATION PZBRANCHES #20180713T135651.642 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-APPLICATION PZBRANCHES #20180713T135651.642 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-APPLICATION PZBRANCHES #20180713T135651.642 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZBRANCHES","Rule-HTML-Section","RULE-APPLICATION",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION RULE-APPLICATION PZBRANCHES #20180713T135651.642 GMT","!PZBRANCHES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1505820505), 
...
//	RULE-HTML-SECTION RULE-APPLICATION PZBRANCHES #20180713T135651.642 GMT:20180713T135651.642 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "0d551d971ae4c5aae7325fc2d93429fa";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzBranches",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzBranches','insKey':'RULE-HTML-SECTION RULE-APPLICATION PZBRANCHES #20180713T135651.642 GMT','sectionType':'standard'}");
...
config.put("NewTaskStatus", "pzAddABranch");
...
config = new HashMap<String, String>();
config.put("pyPreDataTransform.pyName", "pzClearIfEditAtRuntime");
pega.getUIEngine().getUIAction("runDataTransform", config).register();
config = new HashMap<String, String>();
config.put("pySectionName", "pzBranches");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_7")){
		 ...
		 String buttonUID = "name='pzBranches_"+ referenceString+ "_12'";
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20170320075143097221961") + "  href='"+hrefValue+"' ");
	...
	actionRequestD.registerFixedParameter("pyModelName","pzClearIfEditAtRuntime");
		String usingPageString = "";
		usingPageString = "";
		tools.appendString("[\"runDataTransform\", [\"pzClearIfEditAtRuntime\", \"=");
		...
		pzPackageRuntime.packageDataTransform(contextClass, "pzClearIfEditAtRuntime");
		}
...
throw new RuntimeException("Problem in JSP fragment", t);
	 ...
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateGeneric", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)")); tools.appendString("headers='a2'");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzCell.getTestIdIfEnabled("2017032007515403979936") + " ");
try {
tools.appendString(" data-importance='secondary' data-attribute-name='");
 String columnHeaderValue = ""; if(!columnHeaderValue.contains(" ") && pega_procom_harness.IsParam(columnHeaderValue) && tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1)) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1))); }  else if(!columnHeaderValue.contains(" ") && columnHeaderValue.matches(".*[.][a-zA-Z]+.*") && !columnHeaderValue.endsWith(".") && tools.getIfPresent(columnHeaderValue) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getIfPresent(columnHeaderValue).getStringValue()); }  else { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", columnHeaderValue, StreamBuilder.FMT_NORMAL); }  tools.appendString(StringUtils.crossScriptingFilter(columnHeaderValue)); 
tools.appendString("' ");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyBranchList1colWidthCache2").equals("")) { tools.appendParamCSF("PpyBranchList1colWidthCache2");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyBranchList1colWidthCache1").equals("")) { tools.appendParamCSF("PpyBranchList1colWidthCache1");} else { tools.appendString("96.73913043478261"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:24px;'"); } 
									tools.appendString(">"); } 
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzBranches_"+ referenceString+ "_3'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20140905010443911") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
	...
	keyMap.putString("pyActionName", "pzAddABranch");
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
	pzPackageRuntime.packageLocalAction("pzAddABranch", offlineUsingPage , strLAClassName);
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			pzPackageRuntime.packageSection("pzBranches",
			...
			if("true".equals(bHasPrivilege )) {
				tools.appendString("[\"processAction\", [\"pzAddABranch\",\"true\",\":event\",\"\",\""+streamType+"\",\"\",\"\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-null%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22effect%22%3A%22anim-null%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
				} else {
							...
							com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
								...
								if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
									try{
										...
										staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzBranches"));
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Add branch",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "width:100%;",false,"","");tools.appendString("<nobr>");
...
pzSection.getLayout().setExpandParam("SubSectionpzBranchesB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpzBranchesB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pyBranchListL3=null;

 Map selUniqMap_pyBranchListL3 = null;
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyBranchList");tools.appendString("_pzBranches_1'");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pyBranchList");

					}

					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList=' .pyTemplateGeneric  ' class='yui-skin-sam gPercent grid-responsive-default ");

					if(pega_uiengine_harness.pzInStandardsMode()) {tools.appendString("  ");

					}tools.appendString("' style='");

					tools.appendString("' gPropIndex='PpyBranchList1' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201702060826380188220-layout") + " ");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpyBranchList1colWidthGBL\" id=\"PpyBranchList1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyBranchList1colWidthGBL"));tools.appendString("\" />");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpyBranchList1colWidthGBR\" id=\"PpyBranchList1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyBranchList1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpyBranchList1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='' PL_PROP='");

					
tools.appendString(".pyBranchList");

					tools.appendString("' PL_PROP_CLASS='Embed-RuleSetBranch' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pyBranchList").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pyBranchList\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals(".pyBranchList")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodes.pyBranchList1") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 

					if (tempTestID != null && !tempTestID.isEmpty() && !tempTestID.equals("")){

					String strEntryHandlePLProp = "";

					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle(".pyBranchList"); } catch (Exception ex) { }
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201702060826380188220-" + rowTestID) + " ");
					...
					tools.appendString("draggableCell ");tools.appendString("rowHandle  ' style='height:34px;width:1%;'>");
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"3\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("Embed-RuleSetBranch", "tempNoRespg");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pyBranchList1") && tools.getParamValue("partialRefresh").equals("false")) {
...
public void pzBranchesLabel_1() {
pzAuto.emitIncludeStreamReference("pzBranchesLabel", null, !tools.hasInputEnabled()?"NoInput":"Input", "Rule-HTML-Section", null);
}
...
throw new RuntimeException("Problem in JSP fragment", t);
	 ...
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("SUB_SECTION","pzBranchesLabel", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString(" class='");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyBranchList1")|| tools.getParamValue("partialTrigger").equals("editRow.pyBranchList1") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pyBranchList");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pyBranchList\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pyBranchList1")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty(".pyBranchList");
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyBranchList1") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-APPLICATION PZBRANCHES #20180713T135651.642 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzBranches");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-APPLICATION PZBRANCHES #20180713T135651.642 GMT", "Rule-Application pzBranches", "Pega-SystemArchitect", "08-01-01", "20180713T135651.642 GMT");
}
