...
/**
 * Builds JSP stream RULE-OBJ-MODEL!PZENTERDATATRANSFORMNAME.
 */
public class ra_stream_pzenterdatatransformname_8c1adb2a281f7bc0793e1433b3b48d6d extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzEnterDataTransformName.Rule_Obj_Model.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1507973417;
 ...
 */
	public ra_stream_pzenterdatatransformname_8c1adb2a281f7bc0793e1433b3b48d6d(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "3665c9149b2ef5d54664aafcfb23792b6c786e69";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001744.531 GMT	Pega-ProcessArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "3665c9149b2ef5d54664aafcfb23792b6c786e69";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzEnterDataTransformName",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001744.531 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001744.531 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001744.531 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZENTERDATATRANSFORMNAME", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZENTERDATATRANSFORMNAME","Rule-HTML-Section","RULE-OBJ-MODEL",false,"","Pega-ProcessArchitect","08-23-01","RULE-HTML-SECTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001744.531 GMT","!PZENTERDATATRANSFORMNAME",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1507973417), 
		new DependentRuleInfo("PYLABEL","Rule-Obj-Property","@BASECLASS",true,"Rule-Obj-Model","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYLABEL #20180713T131156.327 GMT","!PYLABEL",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001744.531 GMT:20230618T001744.531 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "ed693d70d67bacb6bae2c99c388eff04";
	}
...
config.put("pyFunctionName", "pega.datatransform.refreshSection");
...
config.put("pyActivity", "pzCreateNewDataTransform");
...
getControlMarkup_1() {
try {
if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyLabel").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						pzPackageRuntime.packageSection("pzEnterDataTransformName",
						...
						refreshActionRequest.registerFixedParameter("PreActivity", "pzCreateNewDataTransform");
						staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzEnterDataTransformName"));
						staticURLStr.append("&PreActivity=pzCreateNewDataTransform");
						tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"pzCreateNewDataTransform\", \"");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }									tools.appendString("[\"runScript\", [\"pega.datatransform.refreshSection(event,");
									String strPropReference52 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pySectionName")+"~#";
									...
									tools.appendString(",");
									String strPropReference53 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyTransientText")+"~#";
									...
									tools.appendString(",");
									String strPropReference54 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyModelName")+"~#";
									...
									tools.appendString(",");
									String strPropReference55 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyClassName")+"~#";
									String strFormattedPropReference55 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference55);
									if(strPropReference55.equals(strFormattedPropReference55)) {
									tools.appendString("\\\"");
									tools.appendFormatted(strFormattedPropReference55.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
									tools.appendString("\\\"");
									} else {
									tools.appendFormatted(strFormattedPropReference55.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
									}
									tools.appendString(",");
									String strPropReference56 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyAdditionalSection")+"~#";
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			...
			ct_controlAction.trackValueChanges(tools.getProperty(".pySectionName"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyTransientText"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyModelName"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyClassName"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyAdditionalSection"), -1);
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202004061146340799834") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzEnterDataTransformName_$CTX$_9");
		String repeatIndx = "";
	String pyTooltip = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzEnterDataTransformName_"+ referenceString+ "_9'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202004061146340799834") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Create".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202004061146340799834-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzEnterDataTransformNameBBBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202004061146340795439") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  layout-content-stacked content-stacked " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzEnterDataTransformNameBBBB";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.datatransform.refreshSection(event,");
	String strPropReference22 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pySectionName")+"~#";
	...
	tools.appendString(",");
	String strPropReference23 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyTransientText")+"~#";
	...
	tools.appendString(",\\\"\\\",");
	String strPropReference25 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyClassName")+"~#";
	String strFormattedPropReference25 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference25);
	if(strPropReference25.equals(strFormattedPropReference25)) {
	tools.appendString("\\\"");
	tools.appendFormatted(strFormattedPropReference25.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
	tools.appendString("\\\"");
	} else {
	tools.appendFormatted(strFormattedPropReference25.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
	}
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202212021109500391830") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzEnterDataTransformName_$CTX$_6");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzEnterDataTransformName_"+ referenceString+ "_6'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202212021109500391830") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.datatransform.refreshSection(event,");
	String strPropReference22 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pySectionName")+"~#";
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202212021109500391830-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzEnterDataTransformNameBBB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202212021109500391364") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
	...
	String paramName = "EXPANDEDSubSectionpzEnterDataTransformNameBBB";
...
public int simpleLayoutCell_5( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " float-right   flex flex-row  align-end'  STRING_TYPE='layout' RESERVE_SPACE='false'>");
	pzLayout_2();
 tools.putSaveValue("ContainerID", "");tools.appendString("</div>");
	index++;
	return index;
...
pzSection.getLayout().setExpandParam("SubSectionpzEnterDataTransformNameBB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20221202110950039066") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-inline content-inline " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzEnterDataTransformNameBB";
...
public void pxTextInput_1() {String key="1||RULE-HTML-SECTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001744.531 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","64","","","Text","true","1"};oCellRuntimeParamsMap.put("1||RULE-HTML-SECTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001744.531 GMT",paramValues);oControlPathsMap.put("1||RULE-HTML-SECTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001744.531 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","data-object-name","data-object-name")  + " flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("202004060759120481747-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Data Transform Name") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("202004060759120481747-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Data Transform Name") + "</label>");
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202004060759120481747-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxTextInput");
	pgCells.put("forLabel",".pyLabel");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","data-object-name");
	pgCells.put("customRWStyles","data-object-name");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	pxTextInput_1();labelName = "Data Transform Name";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_6( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " set-width-auto   flex flex-row '  STRING_TYPE='layout' RESERVE_SPACE='false'>");
	pzLayout_3();
 tools.putSaveValue("ContainerID", "");tools.appendString("</div>");
	index++;
	return index;
...
pzSection.getLayout().setExpandParam("SubSectionpzEnterDataTransformNameB","",false);
}
...
public void simpleLayout_4() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-stacked content-stacked padding-lr-1x padding-t-1x" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","padding-lr-1x padding-t-1x");
		pg_dlmeta.put("class","set-width-auto");
		pg_dlmeta.put("format","stacked");
	...
	String paramName = "EXPANDEDSubSectionpzEnterDataTransformNameB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001744.531 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzEnterDataTransformName");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-MODEL PZENTERDATATRANSFORMNAME #20230618T001744.531 GMT", "Rule-Obj-Model pzEnterDataTransformName", "Pega-ProcessArchitect", "08-23-01", "20230618T001744.531 GMT");
}
