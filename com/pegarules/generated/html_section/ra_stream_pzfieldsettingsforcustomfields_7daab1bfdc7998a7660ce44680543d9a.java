...
/**
 * Builds JSP stream EMBED-FIELDS!PZFIELDSETTINGSFORCUSTOMFIELDS.
 */
public class ra_stream_pzfieldsettingsforcustomfields_7daab1bfdc7998a7660ce44680543d9a extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzFieldSettingsForCustomFields.Embed_Fields.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -957839518;
 ...
 */
	public ra_stream_pzfieldsettingsforcustomfields_7daab1bfdc7998a7660ce44680543d9a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "6ef501db7518503107f54993ecaab337bdb32188";
...
{
/* Instance RULE-HTML-SECTION EMBED-FIELDS PZFIELDSETTINGSFORCUSTOMFIELDS #20180713T140830.512 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "6ef501db7518503107f54993ecaab337bdb32188";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzFieldSettingsForCustomFields",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-FIELDS PZFIELDSETTINGSFORCUSTOMFIELDS #20180713T140830.512 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-FIELDS PZFIELDSETTINGSFORCUSTOMFIELDS #20180713T140830.512 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-FIELDS PZFIELDSETTINGSFORCUSTOMFIELDS #20180713T140830.512 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZFIELDSETTINGSFORCUSTOMFIELDS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZFIELDSETTINGSFORCUSTOMFIELDS","Rule-HTML-Section","EMBED-FIELDS",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION EMBED-FIELDS PZFIELDSETTINGSFORCUSTOMFIELDS #20180713T140830.512 GMT","!PZFIELDSETTINGSFORCUSTOMFIELDS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-957839518), 
...
//	RULE-HTML-SECTION EMBED-FIELDS PZFIELDSETTINGSFORCUSTOMFIELDS #20180713T140830.512 GMT:20180713T140830.512 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "aa97497805e0733f334a14823438f3c2";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzFieldSettingsForCustomFields",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzFieldSettingsForCustomFields','insKey':'RULE-HTML-SECTION EMBED-FIELDS PZFIELDSETTINGSFORCUSTOMFIELDS #20180713T140830.512 GMT','sectionType':'standard'}");
pzLayout_1();
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.cd.setDirtyState()\"]");
		...
		keyMap.putString("pyActionName", "pzConfigureAttachment");
		...
		try{
		pzPackageRuntime.packageLocalAction("pzConfigureAttachment", offlineUsingPage , strLAClassName);
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("pzFieldSettingsForCustomFields",
				...
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pzConfigureAttachment\",\"overlay\",\":event\",\"\",\""+streamType+"\",\"\",\"pzModalTemplate\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-bottom%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"true\",\"false\",\"\",\"\"]");
					} else {
...
try {
	...
	cellPage.put("pyStreamName","pzFieldSettingsForCustomFields");
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Click to choose attachment category\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Click to choose attachment category", ".pyActionPrompt");
	}
	pyTooltip = "Click to choose attachment category";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2014112800242806173157") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzFieldSettingsForCustomFields_"+ referenceString+ "_3'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Click to choose attachment category\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2014112800242806173157") + "  href='"+hrefValue+"' ");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2014112800242806173157-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldSettingsForCustomFieldsB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  layout-content-inline_middle content-inline_middle form-field-gear" + "'  ");
		...
		pg_dlmeta.put("customClassName","form-field-gear");
	...
	String paramName = "EXPANDEDSubSectionpzFieldSettingsForCustomFieldsB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzIsAttachmentField", pxUniqueStreamHash+"_7");metadataPage.put("lMode","Inline-block");
...
if(pzAuto.handleEvaluateWhen(" wxpzIsAttachmentField","pzIsAttachmentField", "layout", "visible" )) {pzSetExpandParam_1();
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-FIELDS PZFIELDSETTINGSFORCUSTOMFIELDS #20180713T140830.512 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzFieldSettingsForCustomFields");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-FIELDS PZFIELDSETTINGSFORCUSTOMFIELDS #20180713T140830.512 GMT", "Embed-Fields pzFieldSettingsForCustomFields", "Pega-ProcessArchitect", "08-01-01", "20180713T140830.512 GMT");
}
