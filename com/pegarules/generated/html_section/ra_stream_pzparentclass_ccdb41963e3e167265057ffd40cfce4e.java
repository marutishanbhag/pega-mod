...
/**
 * Builds JSP stream RULE-OBJ-CLASS!PZPARENTCLASS.
 */
public class ra_stream_pzparentclass_ccdb41963e3e167265057ffd40cfce4e extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzParentClass.Rule_Obj_Class.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 283760926;
 ...
 */
	public ra_stream_pzparentclass_ccdb41963e3e167265057ffd40cfce4e(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "caea94dbf9134154e9bb96c4ac2f6b534035fc74";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-CLASS PZPARENTCLASS #20180713T135657.823 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "caea94dbf9134154e9bb96c4ac2f6b534035fc74";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzParentClass",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-CLASS PZPARENTCLASS #20180713T135657.823 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-CLASS PZPARENTCLASS #20180713T135657.823 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-CLASS PZPARENTCLASS #20180713T135657.823 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZPARENTCLASS", 
	"Rule-Obj-Property:PYDERIVESFROM"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZPARENTCLASS","Rule-HTML-Section","RULE-OBJ-CLASS",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION RULE-OBJ-CLASS PZPARENTCLASS #20180713T135657.823 GMT","!PZPARENTCLASS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",283760926), 
		new DependentRuleInfo("PYDERIVESFROM","Rule-Obj-Property","RULE-OBJ-CLASS",false,"","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYDERIVESFROM #20180713T131301.506 GMT","!PYDERIVESFROM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0)
	};
...
//	RULE-HTML-SECTION RULE-OBJ-CLASS PZPARENTCLASS #20180713T135657.823 GMT:20180713T135657.823 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYDERIVESFROM #20180713T131301.506 GMT:20180713T131301.506 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYDERIVESFROM #20180713T131301.506 GMT:20180713T131301.506 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYDERIVESFROM #20180713T131301.506 GMT:20180713T131301.506 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-CLASS PYDERIVESFROM #20180713T131301.506 GMT:20180713T131301.506 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "4fe99afc57db32a3325fb09a90eed39b";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzParentClass",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzParentClass','insKey':'RULE-HTML-SECTION RULE-OBJ-CLASS PZPARENTCLASS #20180713T135657.823 GMT','sectionType':'null'}");
pzLayout_1();
...
tools.putSaveValue("attributes", " PN =.pyDerivesFrom ONCHANGE= \"handleClientEvent(\'CLIENT\', \'\',\'\' ");
 ...
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyDerivesFrom", "input", "OpenRuleAdvanced")) {
	return;
}
} catch(Throwable t) {
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyDerivesFrom",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("2014092305513304181722-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyDerivesFrom" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString("Parent class (Directed)</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2014092305513304181722-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyDerivesFrom" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString("Parent class (Directed)</label>");
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2014092305513304181722-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","OpenRuleAdvanced");
	pgCells.put("forLabel",".pyDerivesFrom");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyDerivesFrom",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")) {	field_OpenRuleAdvanced_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "Parent class (Directed)";
...
pzSection.getLayout().setExpandParam("SubSectionpzParentClassB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzParentClassB";
...
static {
	oPropDefinitions_1.put("Rule-Obj-Class.pyDerivesFrom", new LiteweightPropertyDefinition("Rule-Obj-Class", "pyDerivesFrom", "sIN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-CLASS PZPARENTCLASS #20180713T135657.823 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzParentClass");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-CLASS PZPARENTCLASS #20180713T135657.823 GMT", "Rule-Obj-Class pzParentClass", "Pega-SystemArchitect", "08-01-01", "20180713T135657.823 GMT");
}
