...
/**
 * Builds JSP stream DATA-PORTAL-PEGAADMINSTUDIO-JOBSCHEDULINGWIDGET!PYDASHBOARDWIDGET.
 */
public class ra_stream_pydashboardwidget_903a42d772678729bdf7e0acc6a2754a extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyDashboardWidget.Data_Portal_PegaAdminStudio_JobSchedulingWidget.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1972817105;
 ...
 */
	public ra_stream_pydashboardwidget_903a42d772678729bdf7e0acc6a2754a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "87e07921fbfbff5cf404dc004cd85ce3789d4788";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-JOBSCHEDULINGWIDGET PYDASHBOARDWIDGET #20190327T100827.555 GMT	Pega-Desktop:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "87e07921fbfbff5cf404dc004cd85ce3789d4788";
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-JOBSCHEDULINGWIDGET PYDASHBOARDWIDGET #20190327T100827.555 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-JOBSCHEDULINGWIDGET PYDASHBOARDWIDGET #20190327T100827.555 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-JOBSCHEDULINGWIDGET PYDASHBOARDWIDGET #20190327T100827.555 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDASHBOARDWIDGET","Rule-HTML-Section","DATA-PORTAL-PEGAADMINSTUDIO-JOBSCHEDULINGWIDGET",false,"","Pega-Desktop","08-03-01","RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-JOBSCHEDULINGWIDGET PYDASHBOARDWIDGET #20190327T100827.555 GMT","!PYDASHBOARDWIDGET",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1972817105)
	};
...
//	RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-JOBSCHEDULINGWIDGET PYDASHBOARDWIDGET #20190327T100827.555 GMT:20190327T100827.555 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "f8661f8c0ebe39e623797de183054782";
	}

	public String getDefinitionAppliesToClass() {
		return "Data-Portal-PegaAdminStudio-JobSchedulingWidget";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyDashboardWidget",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyDashboardWidget','insKey':'RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-JOBSCHEDULINGWIDGET PYDASHBOARDWIDGET #20190327T100827.555 GMT','sectionType':'standard'}");
pzLayout_3();
pzLayout_5();
...
config.put("harnessName", "pzJobsMain");
config.put("className", "Pega-Ext-AdminStudio-Explorer-Resources-Jobs");
...
public int simpleLayoutCell_5( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Not privileged for Jobs") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	labelName = "Not privileged for Jobs";
...
public void simpleLayout_5() {
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpzCanManageJobs", pxUniqueStreamHash+"_20");metadataPage.put("lMode","Flexbox");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpzCanManageJobs","!pzCanManageJobs", "layout", "visible" )) {pzSetExpandParam_4();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public int simpleLayoutCell_2( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Jobs") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutCell_1( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	try{
	tools.appendString(StringUtils.crossScriptingFilter(tools.getLocalizedTextForParameterizedString("pyCaption",tools.getProperty(".pyTotalJobs").getStringValue())));
	}catch(Exception ex){
	if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() !='N' ){
	labelName =  ".pyTotalJobs";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	}else{
	tools.appendString(tools.getLocalizedTextForString(".pyCaption",".pyTotalJobs"));
	}
	}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	tools.appendString("],[\"showHarnessWrapper\",[\"newDocument\",\"");
		...
		tools.appendFormatted("Pega-Ext-AdminStudio-Explorer-Resources-Jobs",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");

		tools.appendFormatted("pzJobsMain",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");
		...
		tools.appendFormatted(tools.getLocalizedTextForString("pyCaption", "Jobs"),StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzPackageRuntime.packageHarness("pzJobsMain",
	"Pega-Ext-AdminStudio-Explorer-Resources-Jobs"
	,"Display","0");
	}
...
public void simpleLayout_3() {
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzCanManageJobs", pxUniqueStreamHash+"_13");metadataPage.put("lMode","Flexbox");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzCanManageJobs","pzCanManageJobs", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Data-Portal-PegaAdminStudio-JobSchedulingWidget");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-JOBSCHEDULINGWIDGET PYDASHBOARDWIDGET #20190327T100827.555 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-JOBSCHEDULINGWIDGET PYDASHBOARDWIDGET #20190327T100827.555 GMT", "Data-Portal-PegaAdminStudio-JobSchedulingWidget pyDashboardWidget", "Pega-Desktop", "08-03-01", "20190327T100827.555 GMT");
}
