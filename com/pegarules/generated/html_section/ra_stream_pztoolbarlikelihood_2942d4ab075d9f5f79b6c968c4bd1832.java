...
/**
 * Builds JSP stream RULE-OBJ-FLOW!PZTOOLBARLIKELIHOOD.
 */
public class ra_stream_pztoolbarlikelihood_2942d4ab075d9f5f79b6c968c4bd1832 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzToolbarLikelihood.Rule_Obj_Flow.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1803426743;
 ...
 */
	public ra_stream_pztoolbarlikelihood_2942d4ab075d9f5f79b6c968c4bd1832(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "798e49b3d5680cf40a39dbb9f3099ae5b85704ea";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARLIKELIHOOD #20180713T140929.580 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "798e49b3d5680cf40a39dbb9f3099ae5b85704ea";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzToolbarLikelihood",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARLIKELIHOOD #20180713T140929.580 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARLIKELIHOOD #20180713T140929.580 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARLIKELIHOOD #20180713T140929.580 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZTOOLBARLIKELIHOOD", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZTOOLBARLIKELIHOOD","Rule-HTML-Section","RULE-OBJ-FLOW",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARLIKELIHOOD #20180713T140929.580 GMT","!PZTOOLBARLIKELIHOOD",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1803426743), 
...
//	RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARLIKELIHOOD #20180713T140929.580 GMT:20180713T140929.580 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "42b946c8bc2d947df306c4205141315b";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzToolbarLikelihood",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzToolbarLikelihood','insKey':'RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARLIKELIHOOD #20180713T140929.580 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
...
config.put("pyActivity", "pzToggleLikelihoodDisplay");
config.put("StaticActivityParams", "resultVal=");
...
try {
	...
	cellPage.put("pyStreamName","pzToolbarLikelihood");
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Hide Likelihood\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Hide Likelihood", ".pyActionPrompt");
	}
	pyTooltip = "Hide Likelihood";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("201509220855010401795") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzToolbarLikelihood_"+ referenceString+ "_3'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Hide Likelihood\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
			if(com.pega.pegarules.jsptags.WhenTag.evaluateWhen(pega, "pyIsReadOnly", null, false)){
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("201509220855010401795") + "  ");
		...
		tools.appendString(") no-repeat;background-position:-104px -52px; width:26px; height:26px;' ");
			tools.appendString(" title= '");
			tools.appendString(tempText+" ' ");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-hover='[");if(isBehaviorAdded && true){ tools.appendString(","); }		tools.appendString("[\"changeStyle\",[\":event\",\"background-position:-104px -26px&#59;\", \"1\"]");

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }		tools.appendString("[\"changeStyle\",[\":event\",\"background-position:-104px -26px&#59;\", \"1\"]");
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }			{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
				com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
					...
					if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
						try{
							pzPackageRuntime.packageSection("pzToolbarLikelihood",
							...
							refreshActionRequest.registerFixedParameter("PreActivity", "pzToggleLikelihoodDisplay");
							staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
							staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzToolbarLikelihood"));
							staticURLStr.append("&PreActivity=pzToggleLikelihoodDisplay");
							tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"pzToggleLikelihoodDisplay\", \"");
							refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
							preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"resultVal\":\"\"");
							tools.appendString("\", \"\", \",");
							refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
		...
		tools.appendString(") no-repeat;background-position:-104px top; width:26px; height:26px;' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" title= '");
			tools.appendString(tempText+" ' ");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-hover='[");if(isBehaviorAdded && true){ tools.appendString(","); }									tools.appendString("[\"changeStyle\",[\":event\",\"background-position:-104px -26px&#59;\", \"1\"]");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201509220855010401795-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzToolbarLikelihoodBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201807101430500743740") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzToolbarLikelihoodBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rx.pyShowLikelihoods cqShow", pxUniqueStreamHash+"_15");metadataPage.put("lMode","Inline-block");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if(pzAuto.handleEvaluateWhen(" o2== rx.pyShowLikelihoods cqShow",".pyShowLikelihoods==\'Show\'", "layout", "visible" )) {pzSetExpandParam_2();
...
try {
	...
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Display Likelihood\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Display Likelihood", ".pyActionPrompt");
	}
	pyTooltip = "Display Likelihood";
	modePage1.put("tooltip",pyTooltip);
	modePage1.put("helpertype","tooltip");
	modePage1.put("isActionabale","true");
	modePage1.put("isClickable","true");
	...
	modePage1.put("iconSrc","image");
	modePage1.put("pyFormatTypeActionable","none");
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2015092208550104003198") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzToolbarLikelihood_"+ referenceString+ "_1'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Display Likelihood\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
			if(com.pega.pegarules.jsptags.WhenTag.evaluateWhen(pega, "pyIsReadOnly", null, false)){
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015092208550104003198") + "  ");
		tools.appendString("onclick_func='pd(event);' href='' ");
		tools.appendString(" data-ctl='Icon' "); tools.appendString(" IsSprite='true' href_original='' class='cursordefault' disabled='disabled' style='overflow:hidden;background: url(");
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing remove-left-spacing remove-right-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015092208550104003198-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxIcon");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
...
pzSection.getLayout().setExpandParam("SubSectionpzToolbarLikelihoodB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20180710143050074337") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
	...
	String paramName = "EXPANDEDSubSectionpzToolbarLikelihoodB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= rx.pyShowLikelihoods cqShow", pxUniqueStreamHash+"_8");metadataPage.put("lMode","Inline-block");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= rx.pyShowLikelihoods cqShow",".pyShowLikelihoods!=\'Show\'", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARLIKELIHOOD #20180713T140929.580 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzToolbarLikelihood");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARLIKELIHOOD #20180713T140929.580 GMT", "Rule-Obj-Flow pzToolbarLikelihood", "Pega-ProcessArchitect", "08-01-01", "20180713T140929.580 GMT");
}
