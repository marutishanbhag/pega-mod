...
/**
 * Builds JSP stream PEGAACCEL-TASK-BUILDAPPLICATION!PZAPPCONFIGTOOLBAR.
 */
public class ra_stream_pzappconfigtoolbar_c38af9a74c7a62c206e00420907c63df extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzAppConfigToolbar.PegaAccel_Task_BuildApplication.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 607445576;
 ...
 */
	public ra_stream_pzappconfigtoolbar_c38af9a74c7a62c206e00420907c63df(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "2b3423cda6994b624cdf629bf3d41575e0928a89";
...
{
/* Instance RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZAPPCONFIGTOOLBAR #20180713T140850.131 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "2b3423cda6994b624cdf629bf3d41575e0928a89";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzAppConfigToolbar",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZAPPCONFIGTOOLBAR #20180713T140850.131 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZAPPCONFIGTOOLBAR #20180713T140850.131 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZAPPCONFIGTOOLBAR #20180713T140850.131 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZAPPCONFIGTOOLBAR", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPCONFIGTOOLBAR","Rule-HTML-Section","PEGAACCEL-TASK-BUILDAPPLICATION",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZAPPCONFIGTOOLBAR #20180713T140850.131 GMT","!PZAPPCONFIGTOOLBAR",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",607445576), 
...
//	RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZAPPCONFIGTOOLBAR #20180713T140850.131 GMT:20180713T140850.131 GMT
...
//	RULE-UTILITY-FUNCTION PZCONTROL PZACTIONLOGOFF #20180713T133343.173 GMT:20180713T133343.173 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "228ba61e0d0339eea885aeac50f536c1";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzAppConfigToolbar",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzAppConfigToolbar','insKey':'RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZAPPCONFIGTOOLBAR #20180713T140850.131 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("navName", "pySetupUserMenu");
pega.getUIEngine().getUIAction("showMenu", config).register();
config = new HashMap<String, String>();
config.put("navName", "pySetupUserMenu");
pega.getUIEngine().getUIAction("showMenu", config).register();
pega.getUIEngine().getUIAction("logOff", null).register();
config = new HashMap<String, String>();
config.put("dataTransform", "");
config.put("newClass", "Data-Portal");
config.put("pzActivityStaticParams", "pageName&dataTransform&newClass");
config.put("pzActivity", "pzCreatePage");
config.put("pageName", "operatorPrefPage");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("ActionSection", "pyModalTemplate");
config.put("NewTaskStatus", "pzPreferences");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.support.showHelpTopic(\\\"procomhelpmain.htm\\\")\"]");
...
try {
	...
	cellPage.put("pyStreamName","pzAppConfigToolbar");
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20171113170223093381376") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzAppConfigToolbar_"+ referenceString+ "_4'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		String classProp = "";
		 classProp ="hotkey-help";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("20171113170223093381376") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzCreatePage");
		tools.appendString("[\"runActivity\", [\"\", \"");
		ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"pageName\":\"operatorPrefPage\"");
		ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"dataTransform\":\"\"");
		ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"newClass\":\"Data-Portal\"");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }			{
				...
				keyMap.putString("pyActionName", "pzPreferences");
				String strLAClassName = "";
				String offlineUsingPage = "operatorPrefPage";
				strLAClassName = "Data-Portal";
				...
				try{
				pzPackageRuntime.packageLocalAction("pzPreferences", offlineUsingPage , strLAClassName);
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						pzPackageRuntime.packageSection("pzAppConfigToolbar",
						...
						String usingPage = "operatorPrefPage";
						if(("").equals(usingPage)) { usingPage = tools.getStepPage().getReference(); }
						if("true".equals(bHasPrivilege )) {
							tools.appendString("[\"processAction\", [\"pzPreferences\",\"true\",\":event\",\"operatorPrefPage\",\""+streamType+"\",\"\",\"\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-bottom%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
							} else {
...
try {
	...
	whenHc.putString("pyBlockName", "pyIsHybridClient");
	String classProp = "";
	classProp ="hotkey-operator-prefs";
	modePage1.put("class",classProp);
	if(disable){
	modePage1.put("pyDisabled",disable+"");
	}
	modePage1.put("iconSrc","styleclass");
	modePage1.put("pyFormatTypeActionable","none");
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20171113170223093280432") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzAppConfigToolbar_"+ referenceString+ "_3'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
		...
		String classProp = "";
		 classProp ="hotkey-operator-prefs";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("20171113170223093280432") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
		tools.appendString(" icons "+classProp+"' ");
		tools.appendString("tabindex='0' role='link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" alt= ''");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"logOff\",[\":event\"]");
...
try {
	...
	modePage1.put("iconSrc","styleclass");
	modePage1.put("pyFormatTypeActionable","none");
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20171113170223093279110") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzAppConfigToolbar_"+ referenceString+ "_2'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
		...
		String classProp = "";
		 classProp ="hotkey-logoff";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("20171113170223093279110") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
		tools.appendString(" icons "+classProp+"' ");
		tools.appendString("tabindex='0' role='link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" alt= ''");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
getActionsForCustomControls_3() {
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString("[\"showMenu\",[{\"dataSource\":\"pySetupUserMenu\", \"isNavNLDeferLoaded\":\"false\", \"isNavTypeCustom\":\"false\", \"className\":\"" + tools.getStepPage().getClassName());
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1713510007886");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pySetupUserMenu", "", "pyNavigation1713510007886","", false, false, false, false);
		...
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }			if(pega_uiengine_pznavigation.pzUseNewMenu() && true) {
			...
			if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
				try{
					...
					tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1713510007898");
					if(pzAuto.isOffline() || false) {
					try{
					pega_uiengine_pzcontrol.pzGetMenu("pySetupUserMenu", "", "pyNavigation1713510007898","", false, false, false, false);
					}catch(Exception e){oLog.error(e);}
					}
					tools.appendString("\"},\":event\"]");
...
public void field_pxOperatorImage_2() { 
...
getActionsForCustomControls_1() {
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1713510007833");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pySetupUserMenu", "", "pyNavigation1713510007833","", false, false, false, false);
			}catch(Exception e){oLog.error(e);}
			}
			tools.appendString("\"},\":event\"]");
		...
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }			if(pega_uiengine_pznavigation.pzUseNewMenu() && true) {
			...
			if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
				try{
					...
					tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1713510007836");
					if(pzAuto.isOffline() || false) {
					try{
					pega_uiengine_pzcontrol.pzGetMenu("pySetupUserMenu", "", "pyNavigation1713510007836","", false, false, false, false);
					}catch(Exception e){oLog.error(e);}
					}
					tools.appendString("\"},\":event\"]");
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxOperatorImage",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " data-tour-id='20140927131516034856137' class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","operator-icon","operator-icon")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_3")) {	field_pxOperatorImage_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxOperatorImage",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")) {	field_pxOperatorImage_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","hidden","hidden")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-left-spacing remove-right-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20171113170223093279110-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","hidden","hidden")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-left-spacing remove-right-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20171113170223093280432-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxIcon");
	pgCells.put("forLabel",".pyTemplateGeneric");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","hidden","hidden")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-left-spacing remove-right-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20171113170223093381376-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxIcon");
	pgCells.put("forLabel",".pyTemplateGeneric");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzAppConfigToolbarB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-inline_middle content-inline_middle header-layout" + "'  " + "role='navigation' tabindex='-1'  data-skip-target ='navigation' ");
		...
		pg_dlmeta.put("customClassName","header-layout");
	...
	String paramName = "EXPANDEDSubSectionpzAppConfigToolbarB";
...
static {
	oPropDefinitions_1.put("PegaAccel-Task-BuildApplication.pyTemplateInputBox", new LiteweightPropertyDefinition("PegaAccel-Task-BuildApplication", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZAPPCONFIGTOOLBAR #20180713T140850.131 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzAppConfigToolbar");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGAACCEL-TASK-BUILDAPPLICATION PZAPPCONFIGTOOLBAR #20180713T140850.131 GMT", "PegaAccel-Task-BuildApplication pzAppConfigToolbar", "Pega-ProcessArchitect", "08-01-01", "20180713T140850.131 GMT");
}
