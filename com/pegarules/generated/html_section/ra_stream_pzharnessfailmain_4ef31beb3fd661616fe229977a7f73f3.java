...
/**
 * Builds JSP stream @BASECLASS!PZHARNESSFAILMAIN.
 */
public class ra_stream_pzharnessfailmain_4ef31beb3fd661616fe229977a7f73f3 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzHarnessFailMain._baseclass.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1785430021;
 ...
 */
	public ra_stream_pzharnessfailmain_4ef31beb3fd661616fe229977a7f73f3(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "55c8a29a528e83322ba2d32e7401ef961a26d68a";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZHARNESSFAILMAIN #20210506T204030.717 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "55c8a29a528e83322ba2d32e7401ef961a26d68a";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzHarnessFailMain",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZHARNESSFAILMAIN #20210506T204030.717 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZHARNESSFAILMAIN #20210506T204030.717 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZHARNESSFAILMAIN #20210506T204030.717 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZHARNESSFAILMAIN", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZHARNESSFAILMAIN","Rule-HTML-Section","@BASECLASS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION @BASECLASS PZHARNESSFAILMAIN #20210506T204030.717 GMT","!PZHARNESSFAILMAIN",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1785430021), 
...
//	RULE-HTML-SECTION @BASECLASS PZHARNESSFAILMAIN #20210506T204030.717 GMT:20230321T152559.352 GMT
...
//	RULE-UTILITY-FUNCTION PZCONTROL PZACTIONREVIEW #20180713T133344.599 GMT:20180713T133344.599 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "3695f9a0cb99df27a6d85c056730cf7c";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzHarnessFailMain",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzHarnessFailMain','insKey':'RULE-HTML-SECTION @BASECLASS PZHARNESSFAILMAIN #20210506T204030.717 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("Action", "Review");
pega.getUIEngine().getUIAction("review", config).register();
}
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzHarnessFailMainB"));
...
String sectionTitle = "A processing error has occurred";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("A processing error has occurred", "pyCaption");
...
metadataPage.put("uniqueid", "202602211414350185");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("202303211113480159252") + " ");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"setUserStart\",[\"REVIEW\"]],[\"doFormSubmit\",[\"pyActivity=Open&Action=Review&AllowInput=false&HarnessPurpose=Review&skipClientValidations=true\",\":this\",\"" + tools.getLocalizedTextForString(".pyStatusLabel", "Opening", StreamBuilder.FMT_NORMAL) + "...\",\":event\"]");
	{
		com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();
		actionRequest.registerFixedParameter("pyActivity", "Open");
		actionRequest.registerFixedParameter("Action", "Review");
		actionRequest.registerFixedParameter("AllowInput", "false");
		actionRequest.registerFixedParameter("skipClientValidations", "true");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("201909040249200016365404") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzHarnessFailMain_$CTX$_96");
		String repeatIndx = "";
	String pyTooltip = "";
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Open in review\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Open in review", ".pyButtonLabel");
	}
	pyLabel = "Open in review";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzHarnessFailMain_"+ referenceString+ "_96'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("201909040249200016365404") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"setUserStart\",[\"REVIEW\"]],[\"doFormSubmit\",[\"pyActivity=Open&Action=Review&AllowInput=false&HarnessPurpose=Review&skipClientValidations=true\",\":this\",\"" + tools.getLocalizedTextForString(".pyStatusLabel", "Opening", StreamBuilder.FMT_NORMAL) + "...\",\":event\"]");
	{
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Open in review".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		...
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Open in review",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= rxpxThread.pzACName cqactertiary","pxThread.pzACName!=\'actertiary\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201909040249200016365404-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rxpxThread.pzACName cqactertiary",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pxThread.pzACName!='actertiary'");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rxpxThread.pzACName cqactertiary", pxUniqueStreamHash+"_6"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzHarnessFailMainB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpzHarnessFailMainB";
...
l_sectionTitle=StringUtils.escapeIntoJavaString(tools.getLocalizedTextForParameterizedString("pyCaption","A processing error has occurred"));
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='1' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel8546' data-layout-id='202602211414350175" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h1  class='header-title' id='headerlabel8546'>" + l_sectionTitle + "</h1><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzHarnessFailMainB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202303211113480159252") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzHarnessFailMainB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZHARNESSFAILMAIN #20210506T204030.717 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzHarnessFailMain");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZHARNESSFAILMAIN #20210506T204030.717 GMT", "@baseclass pzHarnessFailMain", "Theme-Cosmos", "04-01-01", "20230321T152559.352 GMT");
}
