...
/**
 * Builds JSP stream DATA-PORTAL!PYPORTALCONTENT.
 */
public class ra_stream_pyportalcontent_0bb058a44f37ec4f29c3d2c493d4f1a0 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyPortalContent.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1110064207;
 ...
 */
	public ra_stream_pyportalcontent_0bb058a44f37ec4f29c3d2c493d4f1a0(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "39822ece9348e354231ac8d680ecd6a8368a1ca2";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PYPORTALCONTENT #20180713T134755.088 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "39822ece9348e354231ac8d680ecd6a8368a1ca2";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyPortalContent",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PYPORTALCONTENT #20180713T134755.088 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PYPORTALCONTENT #20180713T134755.088 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PYPORTALCONTENT #20180713T134755.088 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYPORTALCONTENT"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYPORTALCONTENT","Rule-HTML-Section","DATA-PORTAL",false,"","Pega-EndUserUI","08-01-01","RULE-HTML-SECTION DATA-PORTAL PYPORTALCONTENT #20180713T134755.088 GMT","!PYPORTALCONTENT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1110064207)
	};
...
//	RULE-HTML-SECTION DATA-PORTAL PYPORTALCONTENT #20180713T134755.088 GMT:20180713T134755.088 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "93ec899dea42edd81426c351f47503c8";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyPortalContent",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyPortalContent','insKey':'RULE-HTML-SECTION DATA-PORTAL PYPORTALCONTENT #20180713T134755.088 GMT','sectionType':'null'}");

tools.putParamValue("pyIsDCSPA","false");tools.putParamValue("pyIsMultiSession","false");elementModel_1("f9e64470-c4fa-4e63-b814-0a50f75d0647","88d0292e-17d9-4ddd-9c1a-7e474fd0068c","Title","true","1","Harness","Loaded","NoHeader","true");pzLayout_1();
...
public void includeSectionBody_1() { 
	...
	dcMetadata.put("liveUI","" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pyDashboard7'}") + "");
	dcMetadata.put("DCMode","Multiple");
	dcMetadata.put("tabGrpName","f9e64470-c4fa-4e63-b814-0a50f75d0647");
	dcMetadata.put("isFrameless","false");
	...
	dcMetadata.put("isDCSPA","false");
	dcMetadata.put("DT","");
	dcMetadata.put("streamName","pyDashboard7");
	dcMetadata.put("streamObjClass","RULE-HTML-HARNESS");
	dcMetadata.put("ariaRole","");
	...
	((PegaAPI)tools).getUIEngine().getDCInstance().registerActionsForMultiDocPortals(false,false);
	dcMetadata.put("maxDocs","16");
	dcMetadata.put("eleName","88d0292e-17d9-4ddd-9c1a-7e474fd0068c");
	dcMetadata.put("FVMaxTabsAlert",tools.getLocalizedTextForString("pyMessageLabel", "MaximumTabsAlert"));
	dcMetadata.put("FVWOOpenCaption",tools.getLocalizedTextForString("pyCaption","Work Item Already Open"));
	dcMetadata.put("FVWOOpenLabel",tools.getLocalizedTextForString("pxRequestor.pyMessageLabel", "Work Object Already Open"));
	dcMetadata.put("FVApp",tools.getLocalizedTextForString("pxRequestor.pyCaption", "Application"));
	dcMetadata.put("FVIsopen",tools.getLocalizedTextForString("pxRequestor.pyMessageLabel", "is already open"));
	dcMetadata.put("FVUnsavedChanges",tools.getLocalizedTextForString("pxRequestor.pyMessageLabel", "Would you like to reopen the item and lose any unsaved changes"));
	dcMetadata.put("FVRecentDirty",tools.getLocalizedTextForString("pxRequestor.pyMessageLabel", "RecentItemDirty"));
	dcMetadata.put("FVRecentsDirty",tools.getLocalizedTextForString("pxRequestor.pyMessageLabel", "RecentItemsDirty"));
	...
	dcMetadata.put("FVLoading",tools.getLocalizedTextForString("pyCaption", "Loading"));
	{ String strHarnessName = dcMetadata.getString(com.pega.pegarules.priv.runtime.ui.UIComponentConstants.PYSTREAMNAME.getNormalizedName());
	 String strHarnessClass = dcMetadata.getString(com.pega.pegarules.priv.runtime.ui.UIComponentConstants.STREAMCLASS.getNormalizedName());
	 String strDTName = dcMetadata.getString(com.pega.pegarules.priv.runtime.ui.UIComponentConstants.DT.getNormalizedName());
	((PegaAPI)tools).getUIEngine().getDCInstance().registerStaticHarness(strHarnessName,strHarnessClass,strDTName);}
	...
	if(!("true").equals(tools.findPage("pxRequestor").getStringIfPresent("pyPegaDesignMode"))) {
		...
		if (!pzAuto.hasStaticContentJSOptimization()) {
		dcComponent.addAdditionalFragment("pzFramedDcScripts","pzDynamicContainerScript");
	}
	}
...
if(dcComponent!=null) {
	...
	if (pzAuto.doOnlyOnce("pxWorkAreaTabsContainer")) {
		...
		pzAuto.emitIncludeStreamReference("pzDynamicContainerScript", null, "null","Rule-HTML-Fragment",null);
	}
}
}
}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpyPortalContentB","",false);
}
...
String paramName = "EXPANDEDSubSectionpyPortalContentB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pyDashboard7'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pyDashboard7'}") + ">");
}
pzSetExpandParam_1();
...
ClipboardProperty cp_DCList = pg_displayTemp.getProperty("pyContainerList");
 ...
 cp_DCList.getPropertyValue(1).setValue(tgName);
	...
	pg_SectionTab = tools.findPage("pyDisplayTemp").getProperty("pyElements").getPageValue("pyPortalContent");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PYPORTALCONTENT #20180713T134755.088 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyPortalContent");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PYPORTALCONTENT #20180713T134755.088 GMT", "Data-Portal pyPortalContent", "Pega-EndUserUI", "08-01-01", "20180713T134755.088 GMT");
}
