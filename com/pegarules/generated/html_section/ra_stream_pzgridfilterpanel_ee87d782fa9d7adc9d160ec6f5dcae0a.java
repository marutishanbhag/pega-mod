...
/**
 * Builds JSP stream @BASECLASS!PZGRIDFILTERPANEL.
 */
public class ra_stream_pzgridfilterpanel_ee87d782fa9d7adc9d160ec6f5dcae0a extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzGridFilterPanel.Data_Admin_System_Settings.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1829692299;
 ...
 */
	public ra_stream_pzgridfilterpanel_ee87d782fa9d7adc9d160ec6f5dcae0a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "ff6c5d49b2b56177d92dd19dcccca4172281187d";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZGRIDFILTERPANEL #20230618T002004.920 GMT	Pega-Gadgets:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "ff6c5d49b2b56177d92dd19dcccca4172281187d";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzGridFilterPanel",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZGRIDFILTERPANEL #20230618T002004.920 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZGRIDFILTERPANEL #20230618T002004.920 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZGRIDFILTERPANEL #20230618T002004.920 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	"Rule-Obj-FieldValue:PYCAPTION!CLEARFILTER", 
	"Rule-Obj-FieldValue:PYTOOLTIP!ENTER TO CLEAR FILTER", 
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-HTML-Section:PZGRIDFILTERPANEL", 
	"Rule-Obj-Property:PYTOOLTIP", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		new DependentRuleInfo("PYCAPTION!CLEARFILTER","Rule-Obj-FieldValue","@BASECLASS",false,"","Pega-EndUserUI","08-01-01","RULE-OBJ-FIELDVALUE @BASECLASS PYCAPTION!CLEARFILTER #20180713T134906.250 GMT","!PYCAPTION!CLEARFILTER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
		new DependentRuleInfo("PYTOOLTIP!ENTER TO CLEAR FILTER","Rule-Obj-FieldValue","@BASECLASS",false,"","Pega-UIEngine","08-01-01","RULE-OBJ-FIELDVALUE @BASECLASS PYTOOLTIP!ENTER TO CLEAR FILTER #20180713T133320.667 GMT","!PYTOOLTIP!ENTER TO CLEAR FILTER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
		new DependentRuleInfo("PZASSEMBLEPREPROCESS","Rule-Obj-Activity","RULE-HTML-SECTION",true,"Rule-HTML-Section","Pega-UIEngine","08-03-01","RULE-OBJ-ACTIVITY RULE-HTML-SECTION PZASSEMBLEPREPROCESS #20190207T102426.651 GMT","!PZASSEMBLEPREPROCESS",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PZGRIDFILTERPANEL","Rule-HTML-Section","@BASECLASS",false,"","Pega-Gadgets","08-23-01","RULE-HTML-SECTION @BASECLASS PZGRIDFILTERPANEL #20230618T002004.920 GMT","!PZGRIDFILTERPANEL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1829692299), 
		new DependentRuleInfo("PYTOOLTIP","Rule-Obj-Property","@BASECLASS",false,"","Pega-SystemArchitect","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYTOOLTIP #20180713T135622.454 GMT","!PYTOOLTIP",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1), 
...
//	RULE-HTML-SECTION @BASECLASS PZGRIDFILTERPANEL #20230618T002004.920 GMT:20230618T002004.920 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT:20180713T133539.879 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT:20180713T133539.879 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTOOLTIP #20180713T135622.454 GMT:20180713T135622.454 GMT
//	RULE-OBJ-FIELDVALUE @BASECLASS PYTOOLTIP!ENTER TO CLEAR FILTER #20180713T133320.667 GMT:20180713T133320.667 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYCAPTION #20180713T131156.091 GMT:20180713T131156.091 GMT
//	RULE-OBJ-FIELDVALUE @BASECLASS PYCAPTION!CLEARFILTER #20180713T134906.250 GMT:20180713T134906.250 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "f43246031caf7cf1cbc52d68ce46c174";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzGridFilterPanel",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzGridFilterPanel','insKey':'RULE-HTML-SECTION @BASECLASS PZGRIDFILTERPANEL #20230618T002004.920 GMT','sectionType':'standard'}");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzGridFilterRangeSearch", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzGridFilterRangeSearch";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_4() {
pzSection.getLayout().setExpandParam("SubSectionpzGridFilterPanelBBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzGridFilterPanelBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(4)','clipboardPath':'pzGridFilterRangeSearch'}");
...
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2|| o2== pxparam.filterType cqtrue o2== pxparam.filterType cqsearch", pxUniqueStreamHash+"_8");metadataPage.put("isSectionIncl","true");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2|| o2== pxparam.filterType cqtrue o2== pxparam.filterType cqsearch","param.filterType == \'true\' || param.filterType == \'search\'", "layout", "visible" )) {boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(4)','clipboardPath':'pzGridFilterRangeSearch'}") + ">");
}
pzSetExpandParam_4();
...
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20141201130834008815599") + "  ");
...
String rlIndex=tools.getParamValueCSF("pega_RLindex");
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20141201130834008714787") + "  ");
if(!labelForAttribute.equals("")){tools.appendString(" for='" + labelForAttribute + rlIndex + "' ");
}String labelForError="";if(!propertyName.equals("")){try { labelForError = pzSection.getCell().getLabelForError(pageName,propertyName);}catch(Exception e) {} }tools.appendString(labelForError);
if(!accessKey.equals("")){tools.appendString(accessKey);
}else if(bRuntimeAccesskey){String aKey = pega_uiengine_harness.pzGetAKey(".pyCaption",labelValue,pega_procom_harness.IsParam(labelValue) );tools.appendString(aKey);
...
public void layoutBody_3() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:17px;width:22px;",false,"","");tools.appendString("<nobr>");
	labelIncludeInCell_2("","","","",false,"",true,false,"Standard",false);
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:17px;width:143px;",false,"","");tools.appendString("<nobr>");
	labelIncludeInCell_3("","","","",false,"",true,false,"Standard",false);
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
...
pzSection.getLayout().setExpandParam("SubSectionpzGridFilterPanelBBB","",false);
}
public void pzLayout_3() {
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2|| o2!= pxparam.filterType cqtrue o2!= pxparam.filterType cqsearch","param.filterType != \'true\' || param.filterType != \'search\'", "layout", "visible" )) {pzSetExpandParam_3();
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_5","pzGridFilterCriteria", secInfo);
}
...
public void sectionIncludeInCell_pzGridFilterCriteria_1(){

sectionBodyIncludeInCell_1(false,false,"","pzGridFilterCriteria");elementModel_1("pzGridFilterCriteria","pzGridFilterPanel","COLLAPSIBLE","");
 } 
...
public void layoutBody_2() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("SUB_SECTION","pzGridFilterCriteria",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:18px;width:195px;",false,"","");sectionIncludeInCell_pzGridFilterCriteria_1(); pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>");
 } 
public void pzSetExpandParam_2() {
pzSection.getLayout().setExpandParam("SubSectionpzGridFilterPanelBB","",false);
}
public void pzLayout_2() {
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2|| o2== pxparam.filterType cqtrue o2== pxparam.filterType cqlist","param.filterType ==\'true\' || param.filterType == \'list\'", "layout", "visible" )) {pzSetExpandParam_2();
...
"RULE-OBJ-FIELDVALUE @BASECLASS PYTOOLTIP!ENTER TO CLEAR FILTER #20180713T133320.667 GMT", "Rule-Obj-FieldValue", "Pega-UIEngine", "pyToolTip", "Data-Admin-System-Settings", "Enter to clear filter" };
/**
...
"RULE-OBJ-FIELDVALUE @BASECLASS PYCAPTION!CLEARFILTER #20180713T134906.250 GMT", "Rule-Obj-FieldValue", "Pega-EndUserUI", "pyCaption", "Data-Admin-System-Settings", "ClearFilter" };
public void 
...
String rlIndex=tools.getParamValueCSF("pega_RLindex");
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2014120113083400865158") + "  ");
if(!labelForAttribute.equals("")){tools.appendString(" for='" + labelForAttribute + rlIndex + "' ");
}String labelForError="";if(!propertyName.equals("")){try { labelForError = pzSection.getCell().getLabelForError(pageName,propertyName);}catch(Exception e) {} }tools.appendString(labelForError);
if(!accessKey.equals("")){tools.appendString(accessKey);
}else if(bRuntimeAccesskey){String aKey = pega_uiengine_harness.pzGetAKey(".pyCaption",labelValue,pega_procom_harness.IsParam(labelValue) );tools.appendString(aKey);
...
try {
tools.appendString("<a id='clearFilter' href='#' tabindex='0' title='");

/* Field value Data-Admin-System-Settings .pyToolTip Enter to clear filter */
if(tools.getStepPage() != null && "Data-Admin-System-Settings".equals(tools.getStepPage().getClassName())){
out.write("Enter to clear filter");
}else{
if (_jspx_meth_pega_lookup__1(pageContext, ".pyToolTip", "Enter to clear filter")) {
	return;
}

}	pzAuto.implementShowMe(IAutoStreamRuntime.SHOWME_FIELDVALUE, showMeParams_1);
tools.appendString("' style='text-decoration: underline;'>");

/* Field value Data-Admin-System-Settings .pyCaption ClearFilter */
if(tools.getStepPage() != null && "Data-Admin-System-Settings".equals(tools.getStepPage().getClassName())){
out.write("Clear Filter");
}else{
if (_jspx_meth_pega_lookup__1(pageContext, ".pyCaption", "ClearFilter")) {
	return;
}
...
public void field_pzGridFilterCriteriaForA11y_1() { 
try {
...
_jspx_th_pega_reference__1.setFormat("pzGridFilterCriteriaForA11y");
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pzGridFilterCriteriaForA11y",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "height:23px;width:53px;",false,"","");tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_3")) {	field_pzGridFilterCriteriaForA11y_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:23px;width:88px;",false,"","");tools.appendString("<nobr>");
...
pzSection.getLayout().setExpandParam("SubSectionpzGridFilterPanelB","",false);
}
...
static {
	oPropDefinitions_1.put("Data-Admin-System-Settings.pyTemplateInputBox", new LiteweightPropertyDefinition("Data-Admin-System-Settings", "pyTemplateInputBox", "sTN", false, true, "Default", false));
	...
	oPropDefinitions_1.put("Data-Admin-System-Settings.pyToolTip", new LiteweightPropertyDefinition("Data-Admin-System-Settings", "pyToolTip", "stN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZGRIDFILTERPANEL #20230618T002004.920 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzGridFilterPanel");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZGRIDFILTERPANEL #20230618T002004.920 GMT", "@baseclass pzGridFilterPanel", "Pega-Gadgets", "08-23-01", "20230618T002004.920 GMT");
}
