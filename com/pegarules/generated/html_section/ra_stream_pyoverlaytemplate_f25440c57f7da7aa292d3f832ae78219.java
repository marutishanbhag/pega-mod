...
/**
 * Builds JSP stream @BASECLASS!PYOVERLAYTEMPLATE.
 */
public class ra_stream_pyoverlaytemplate_f25440c57f7da7aa292d3f832ae78219 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyOverlayTemplate.Data_Portal_DesignerStudio.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 575857345;
 ...
 */
	public ra_stream_pyoverlaytemplate_f25440c57f7da7aa292d3f832ae78219(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "621dcc48afee6714154c80204607cac5dba54c44";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20180830T125418.348 GMT	Pega-EndUserUI:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "621dcc48afee6714154c80204607cac5dba54c44";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyOverlayTemplate",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20180830T125418.348 GMT
 * Set up context.
 */
final String prevRuleKey_4 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20180830T125418.348 GMT";final String prevClass_4 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20180830T125418.348 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-HTML-Section:PYOVERLAYTEMPLATE", 
	"Rule-Obj-Property:PYTEMPLATEINPUTBOX", 
	"Rule-HTML-Property:BUTTON", 
	"Rule-HTML-Property:PZOVERLAYBUTTON", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYOVERLAYTEMPLATE","Rule-HTML-Section","@BASECLASS",false,"","Pega-EndUserUI","08-02-01","RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20180830T125418.348 GMT","!PYOVERLAYTEMPLATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",575857345), 
		...
		new DependentRuleInfo("PZOVERLAYBUTTON","Rule-HTML-Property","",false,"","Pega-UIEngine","08-01-01","RULE-HTML-PROPERTY PZOVERLAYBUTTON #20180713T133246.178 GMT","PZOVERLAYBUTTON",true,false,"ABSOLUTE_CLASSLESS",422287858), 
...
//	RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20180830T125418.348 GMT:20181010T094056.136 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT:20180713T133539.879 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT:20180713T133539.879 GMT
//	RULE-HTML-PROPERTY PZOVERLAYBUTTON #20180713T133246.178 GMT:20180713T133246.178 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "654eab42b7fe8d21587a00873869550d";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyOverlayTemplate",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyOverlayTemplate','insKey':'RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20180830T125418.348 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_5();
...
params_4.putString("bLocalize", "false");
	...
	if (currentProperty_4 != null && currentProperty_4.getParentPage().getClassName().equals("Data-Portal-DesignerStudio")) {
		...
		final PRStackFrame stack_4 = ((PegaAPI) tools).pushStackFrame( params_4, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pzOverlayButton" );
		try {
...
property_Data_Portal_DesignerStudio_pzOverlayButton();
...
if (_jspx_meth_pega_reference__4(pageContext, ".pyTemplateInputBox", "input", "pzOverlayButton")) {
	return;
}
	}} catch(Throwable t) {
...
public void field_pzOverlayButton_3() { 
try {
final ParameterPage params_3 = new ParameterPage();
params_3.putString("Action", "Cancel");
...
params_3.putString("bLocalize", "false");
	...
	if (currentProperty_3 != null && currentProperty_3.getParentPage().getClassName().equals("Data-Portal-DesignerStudio")) {
		...
		final PRStackFrame stack_3 = ((PegaAPI) tools).pushStackFrame( params_3, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pzOverlayButton" );
		try {
...
public int simpleLayoutCell_4( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzOverlayButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20141008112347009417393-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20141008112347009417393-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyTemplateInputBox" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
...
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_16")) {field_pzOverlayButton_3();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20141008112347009417393-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzOverlayButton");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pzOverlayButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_19")) {	field_pzOverlayButton_4();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyOverlayTemplateBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806220515190534453") + " ");
	...
	String paramName = "EXPANDEDSubSectionpyOverlayTemplateBBBB";
...
public void field_pzOverlayButton_2() { 
try {
final ParameterPage params_2 = new ParameterPage();
params_2.putString("Action", "Submit");
params_2.putString("Disabled", "0");
params_2.putString("ButtonStyle", "Strong");
params_2.putString("Caption", "Submit");
...
params_2.putString("bLocalize", "false");
	...
	if (currentProperty_2 != null && currentProperty_2.getParentPage().getClassName().equals("Data-Portal-DesignerStudio")) {
		...
		final PRStackFrame stack_2 = ((PegaAPI) tools).pushStackFrame( params_2, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pzOverlayButton" );
		try {
...
if (_jspx_meth_pega_reference__3(pageContext, ".pyTemplateInputBox", "input", "pzOverlayButton")) {
	return;
}
	}} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
"", "", "", "", "", "", "04-02", "Internal", "Rule-HTML-Property", "Final", "", "Pega-UIEngine", "08-01-01", "", "pzOverlayButton", "", "RULE-HTML-PROPERTY PZOVERLAYBUTTON #20180713T133246.178 GMT" };
...
/**
 * Generates stream property_Data_Portal_DesignerStudio_ClientValidation
 */
private void property_Data_Portal_DesignerStudio_ClientValidation() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_1() {
	...
	try {
property_Data_Portal_DesignerStudio_ClientValidation();
	} finally {
...
/**
 * Generates stream property_Data_Portal_DesignerStudio_Button
 */
private void property_Data_Portal_DesignerStudio_Button() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_2() {
	final Map streamProperties = pega.getStreamProperties();
	try {
property_Data_Portal_DesignerStudio_Button();
...
if(tools.getParamValue("Action").toUpperCase().equals("SUBMIT")){
    if(tools.getParamValue("OnClick").equals(""))
		tools.putParamValue("OnClick", "doOverlayAction(pega.u.d.submitModalDlgParam,event)");

	if(bCustomizeLabels){
		tools.putParamValue("Caption", tools.getSaveValue("pySubmitLabel"));	
		tools.putParamValue("ToolTip", tools.getSaveValue("pySubmitLabel"));	
	}else if(tools.getParamValue("Caption").equals("")){
		tools.putParamValue("Caption", "Ok");
	}
}else if(tools.getParamValue("Action").toUpperCase().equals("CANCEL")){
    if(bCustomizeLabels){
		tools.putParamValue("Caption", tools.getSaveValue("pyCancelLabel"));	
		tools.putParamValue("ToolTip", tools.getSaveValue("pyCancelLabel"));	
	}else if(tools.getParamValue("Caption").equals("")){
		tools.putParamValue("Caption", "Cancel");
	}
         if(tools.getParamValue("OnClick").equals(""))
 		tools.putParamValue("OnClick", "doOverlayAction('',event)");
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-PROPERTY PZOVERLAYBUTTON #20180713T133246.178 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzOverlayButton");
	oStreamProperties_1.put("pyRuleSetVersion", "08-01-01");
}
/**
 * Generates stream property_Data_Portal_DesignerStudio_pzOverlayButton
 */
private void property_Data_Portal_DesignerStudio_pzOverlayButton() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
/* Instance RULE-HTML-PROPERTY PZOVERLAYBUTTON #20180713T133246.178 GMT	Pega-UIEngine:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-PROPERTY PZOVERLAYBUTTON #20180713T133246.178 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-PROPERTY PZOVERLAYBUTTON #20180713T133246.178 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
mStreamResponse.setJspBaseClass("Rule-HTML-Property");
...
/* end RULE-HTML-PROPERTY PZOVERLAYBUTTON #20180713T133246.178 GMT */
}
}


public void field_pzOverlayButton_1() { 
try {
final ParameterPage params_1 = new ParameterPage();
params_1.putString("Action", "Submit");
...
params_1.putString("bLocalize", "false");
	...
	if (currentProperty_1 != null && currentProperty_1.getParentPage().getClassName().equals("Data-Portal-DesignerStudio")) {
		...
		final PRStackFrame stack_1 = ((PegaAPI) tools).pushStackFrame( params_1, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pzOverlayButton" );
		try {
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzOverlayButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20141008112347009114506-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyTemplateInputBox" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20141008112347009114506-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	tools.appendString("for='pyTemplateInputBox" + tools.getParamValueCSF("pega_RLindex") + "'");
	}
	tools.appendString(">");
...
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_9")) {field_pzOverlayButton_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("localize","false");
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20141008112347009114506-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzOverlayButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pzOverlayButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_12")) {	field_pzOverlayButton_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	pgCells.put("pyLabelValue",labelName);
	String uiFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData();
	if(!"".equals(uiFieldValueMeta)){
	pgCells.put("stopFV",uiFieldValueMeta);
...
pzSection.getLayout().setExpandParam("SubSectionpyOverlayTemplateBBB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806220515190533948") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
	...
	String paramName = "EXPANDEDSubSectionpyOverlayTemplateBBB";
	metadataPage.put("paramName", paramName);
...
pzSection.getLayout().setExpandParam("SubSectionpyOverlayTemplateBB","",false);
}
...
public void simpleLayout_4() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806220515190531587") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + " content  set-width-auto auto-width-column layout-content-default content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("class","set-width-auto auto-width-column");
	...
	String paramName = "EXPANDEDSubSectionpyOverlayTemplateBB";
	metadataPage.put("paramName", paramName);
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& wxpzShowFAButtons o2== pxparam.includedStreamName cq", pxUniqueStreamHash+"_22");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& wxpzShowFAButtons o2== pxparam.includedStreamName cq","pzShowFAButtons && param.includedStreamName = \'\'", "layout", "visible" )) {pzSetExpandParam_3();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzModalAction", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzModalAction"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpyOverlayTemplate115","",false);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzModalAction",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzModalAction",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyOverlayTemplateB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806220519310250718") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpyOverlayTemplateB";
...
static {
	oPropDefinitions_4.put("Data-Portal-DesignerStudio.pyTemplateInputBox", new LiteweightPropertyDefinition("Data-Portal-DesignerStudio", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_4.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20180830T125418.348 GMT");
	...
	oStreamProperties_4.put("pyRuleSet", "Pega-EndUserUI");
	oStreamProperties_4.put("pyCorrType", "");
	oStreamProperties_4.put("pyStreamName", "pyOverlayTemplate");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20180830T125418.348 GMT", "@baseclass pyOverlayTemplate", "Pega-EndUserUI", "08-02-01", "20181010T094056.136 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_1 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY PZOVERLAYBUTTON #20180713T133246.178 GMT", "pzOverlayButton", "Pega-UIEngine", "08-01-01", "20180713T133246.178 GMT");
}
