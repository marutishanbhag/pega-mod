...
/**
 * Builds JSP stream DATA-ADMIN-WORKBASKET!PYWORKBASKETASSGNCOUNT.
 */
public class ra_stream_pyworkbasketassgncount_5350c2176a5bdad8c1bfc061a32a0c54 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyWorkBasketAssgnCount.Data_Admin_WorkBasket.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -195331528;
 ...
 */
	public ra_stream_pyworkbasketassgncount_5350c2176a5bdad8c1bfc061a32a0c54(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "9891ad847a37bdbcce083100926892b9f1846387";
...
{
/* Instance RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETASSGNCOUNT #20180713T134746.335 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "9891ad847a37bdbcce083100926892b9f1846387";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyWorkBasketAssgnCount",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETASSGNCOUNT #20180713T134746.335 GMT
 * Set up context.
 */
final String prevRuleKey_4 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETASSGNCOUNT #20180713T134746.335 GMT";final String prevClass_4 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETASSGNCOUNT #20180713T134746.335 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-HTML-Section:PYWORKBASKETASSGNCOUNT", 
	"Rule-Obj-Property:PYSUMMARYCOUNT(1)", 
	"Rule-Obj-Property:PYSUMMARYCOUNT", 
	"Rule-HTML-Property:FORMATNUMBER", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYWORKBASKETASSGNCOUNT","Rule-HTML-Section","DATA-ADMIN-WORKBASKET",false,"","Pega-EndUserUI","08-01-01","RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETASSGNCOUNT #20180713T134746.335 GMT","!PYWORKBASKETASSGNCOUNT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-195331528), 
		new DependentRuleInfo("PYSUMMARYCOUNT(1)","Rule-Obj-Property","@BASECLASS",false,"","Pega-WB","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYSUMMARYCOUNT #20180713T131448.985 GMT","!PYSUMMARYCOUNT(1)",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1), 
		new DependentRuleInfo("PYSUMMARYCOUNT","Rule-Obj-Property","@BASECLASS",false,"","Pega-WB","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYSUMMARYCOUNT #20180713T131448.985 GMT","!PYSUMMARYCOUNT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
		new DependentRuleInfo("FORMATNUMBER","Rule-HTML-Property","",false,"","Pega-Gadgets","08-01-01","RULE-HTML-PROPERTY FORMATNUMBER #20180713T133433.065 GMT","FORMATNUMBER",true,false,"ABSOLUTE_CLASSLESS",1480669824), 
...
//	RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETASSGNCOUNT #20180713T134746.335 GMT:20180713T134746.335 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYSUMMARYCOUNT #20180713T131448.985 GMT:20180713T131448.985 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYSUMMARYCOUNT #20180713T131448.985 GMT:20180713T131448.985 GMT
//	RULE-HTML-PROPERTY FORMATNUMBER #20180713T133433.065 GMT:20180713T133433.065 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "10eed6698290ee2863f51222a001e9d4";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyWorkBasketAssgnCount",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyWorkBasketAssgnCount','insKey':'RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETASSGNCOUNT #20180713T134746.335 GMT','sectionType':'null'}");
pzLayout_4();
...
try {
	final ClipboardProperty currentProperty_6 = tools.getProperty(".pySummaryCount(1)");
	if (currentProperty_6 != null && currentProperty_6.getParentPage().getClassName().equals("Data-Admin-WorkBasket")) {
...
property_Data_Admin_WorkBasket_formatNumber();
...
if (_jspx_meth_pega_reference__1(pageContext, ".pySummaryCount(1)", "input")) {
	return;
}
	}} catch(Throwable t) {
...
try {
	final ClipboardProperty currentProperty_5 = tools.getProperty(".pySummaryCount(1)");
	if (currentProperty_5 != null && currentProperty_5.getParentPage().getClassName().equals("Data-Admin-WorkBasket")) {
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("forLabel",".pySummaryCount(1)");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("",".pySummaryCount(1)",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_23")) {	field__6();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkBasketAssgnCountBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + " class='" + " content  set-width-auto layout-content-simple_list content-simple_list urgency urgency-sidebar urgency-low" + "'  ");
		...
		pg_dlmeta.put("customClassName","urgency urgency-sidebar urgency-low");
	...
	String paramName = "EXPANDEDSubSectionpyWorkBasketAssgnCountBBBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2== rx.pySummaryCount(2) ci0 o2== rx.pySummaryCount(3) ci0", pxUniqueStreamHash+"_24");metadataPage.put("dlChild","true");
...
if(pzAuto.handleEvaluateWhen(" o2&& o2== rx.pySummaryCount(2) ci0 o2== rx.pySummaryCount(3) ci0",".pySummaryCount(2)=0 && .pySummaryCount(3)=0", "layout", "visible" )) {pzSetExpandParam_4();
...
try {
	final ClipboardProperty currentProperty_4 = tools.getProperty(".pySummaryCount(1)");
	if (currentProperty_4 != null && currentProperty_4.getParentPage().getClassName().equals("Data-Admin-WorkBasket")) {
...
try {
	final ClipboardProperty currentProperty_3 = tools.getProperty(".pySummaryCount(1)");
	if (currentProperty_3 != null && currentProperty_3.getParentPage().getClassName().equals("Data-Admin-WorkBasket")) {
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("",".pySummaryCount(1)",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_12")) {	field__3();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("",".pySummaryCount(1)",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_15")) {	field__4();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkBasketAssgnCountBBB","",false);
}
...
public void simpleLayout_2() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + " content  set-width-auto layout-content-simple_list content-simple_list urgency urgency-sidebar urgency-medium" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","urgency urgency-sidebar urgency-medium");
		pg_dlmeta.put("class","set-width-auto");
		pg_dlmeta.put("format","simple_list");
	...
	String paramName = "EXPANDEDSubSectionpyWorkBasketAssgnCountBBB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2== rx.pySummaryCount(2) ci0 o2> rx.pySummaryCount(3) ci0", pxUniqueStreamHash+"_16");metadataPage.put("dlChild","true");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2== rx.pySummaryCount(2) ci0 o2> rx.pySummaryCount(3) ci0",".pySummaryCount(2)=0 && .pySummaryCount(3)>0", "layout", "visible" )) {pzSetExpandParam_3();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
try {
	final ClipboardProperty currentProperty_2 = tools.getProperty(".pySummaryCount(1)");
	if (currentProperty_2 != null && currentProperty_2.getParentPage().getClassName().equals("Data-Admin-WorkBasket")) {
...
"", "", "", "", "", "", "04-02", "", "Rule-HTML-Property", "Yes", "", "Pega-Gadgets", "08-01-01", "", "formatNumber", "", "RULE-HTML-PROPERTY FORMATNUMBER #20180713T133433.065 GMT" };
/**
...
/**
 * Generates stream property_Data_Admin_WorkBasket_ClientValidation
 */
private void property_Data_Admin_WorkBasket_ClientValidation() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_2() {
	...
	try {
property_Data_Admin_WorkBasket_ClientValidation();
	} finally {
...
/**
 * Generates stream property_Data_Admin_WorkBasket_Messages
 */
private void property_Data_Admin_WorkBasket_Messages() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_1() {
	final Map streamProperties = pega.getStreamProperties();
	try {
property_Data_Admin_WorkBasket_Messages();
	} finally {
		pega.setStreamProperties(streamProperties);
	}
}
private void performStream_3() throws Throwable {
   ...
   if (tools.getActiveValue().length() > 0 && curProp.hasValidValue()) {  
    if ( curProp.getType() == PropertyInfo.TYPE_DECIMAL || curProp.getType() == PropertyInfo.TYPE_NUMBER ||
         curProp.getType() == PropertyInfo.TYPE_DOUBLE ) {
        int iPrecision = 0;
        boolean bGrouping = false;

        String precisionParam = tools.getParamValue("Precision");
        if (!precisionParam.equals("")) {
            try {
                iPrecision = Integer.parseInt(precisionParam);
            }
            catch (NumberFormatException nfe) {
                iPrecision = curProp.getDecimalPrecision();            
            }
        }
        else {
            iPrecision = curProp.getDecimalPrecision();
	...
	com.pega.ibm.icu.math.BigDecimal value = curProp.toBigDecimal();
        bGrouping = tools.getParamAsBoolean(PropertyInfo.TYPE_TRUEFALSE, "GroupWithSeparator");
        tools.putSaveValue("result", PRNumberFormat.format(null, PRNumberFormat.DEFAULT_DECIMAL, bGrouping, null, iPrecision, value )); 
    } 
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-PROPERTY FORMATNUMBER #20180713T133433.065 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "formatNumber");
	oStreamProperties_1.put("pyRuleSetVersion", "08-01-01");
}
/**
 * Generates stream property_Data_Admin_WorkBasket_formatNumber
 */
private void property_Data_Admin_WorkBasket_formatNumber() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
/* Instance RULE-HTML-PROPERTY FORMATNUMBER #20180713T133433.065 GMT	Pega-Gadgets:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
/*
 * Begin RULE-HTML-PROPERTY FORMATNUMBER #20180713T133433.065 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-PROPERTY FORMATNUMBER #20180713T133433.065 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
mStreamResponse.setJspBaseClass("Rule-HTML-Property");
...
/* end RULE-HTML-PROPERTY FORMATNUMBER #20180713T133433.065 GMT */
}
}
...
try {
	final ClipboardProperty currentProperty_1 = tools.getProperty(".pySummaryCount(1)");
	if (currentProperty_1 != null && currentProperty_1.getParentPage().getClassName().equals("Data-Admin-WorkBasket")) {
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("",".pySummaryCount(1)",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_4")) {	field__1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("",".pySummaryCount(1)",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_7")) {	field__2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkBasketAssgnCountBB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + " content  set-width-auto layout-content-simple_list content-simple_list urgency urgency-sidebar urgency-high" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","urgency urgency-sidebar urgency-high");
		pg_dlmeta.put("class","set-width-auto");
		pg_dlmeta.put("format","simple_list");
	...
	String paramName = "EXPANDEDSubSectionpyWorkBasketAssgnCountBB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2> rx.pySummaryCount(2) ci0", pxUniqueStreamHash+"_8");metadataPage.put("dlChild","true");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2> rx.pySummaryCount(2) ci0",".pySummaryCount(2)>0", "layout", "visible" )) {pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2> rx.pySummaryCount(2) ci0",".pySummaryCount(2)>0","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2> rx.pySummaryCount(2) ci0",pxUniqueStreamHash+"_10");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_10");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pySummaryCount(2)>0");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Data-Admin-WorkBasket");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2> rx.pySummaryCount(2) ci0", pxUniqueStreamHash+"_10"); 
	}
...
public int simpleLayoutCell_4( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2== rx.pySummaryCount(2) ci0 o2> rx.pySummaryCount(3) ci0",".pySummaryCount(2)=0 && .pySummaryCount(3)>0","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rx.pySummaryCount(2) ci0 o2> rx.pySummaryCount(3) ci0",pxUniqueStreamHash+"_18");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_18");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pySummaryCount(2)=0 && .pySummaryCount(3)>0");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Data-Admin-WorkBasket");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_18");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rx.pySummaryCount(2) ci0 o2> rx.pySummaryCount(3) ci0", pxUniqueStreamHash+"_18"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_2();
 tools.putSaveValue("ContainerID", "");}
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2== rx.pySummaryCount(2) ci0 o2== rx.pySummaryCount(3) ci0",pxUniqueStreamHash+"_26");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2== rx.pySummaryCount(2) ci0 o2== rx.pySummaryCount(3) ci0", pxUniqueStreamHash+"_26"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_3();
 tools.putSaveValue("ContainerID", "");}
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkBasketAssgnCountB","",false);
}
...
public void simpleLayout_4() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  auto-width-column layout-content-default content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpyWorkBasketAssgnCountB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= rxpxRequestor.pyPegaDesignMode cqtrue", pxUniqueStreamHash+"_27");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= rxpxRequestor.pyPegaDesignMode cqtrue","pxRequestor.pyPegaDesignMode != \'true\'", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	oPropDefinitions_4.put("Data-Admin-WorkBasket.pySummaryCount(1)", new LiteweightPropertyDefinition("Data-Admin-WorkBasket", "pySummaryCount(1)", "sNN", false, true, "formatNumber", false));
}
...
static {
	...
	oStreamProperties_4.put("pyClassName", "Data-Admin-WorkBasket");
	oStreamProperties_4.put("pyCircumstanceProp", "");
	oStreamProperties_4.put("pzInsKey", "RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETASSGNCOUNT #20180713T134746.335 GMT");
	...
	oStreamProperties_4.put("pyStreamName", "pyWorkBasketAssgnCount");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-ADMIN-WORKBASKET PYWORKBASKETASSGNCOUNT #20180713T134746.335 GMT", "Data-Admin-WorkBasket pyWorkBasketAssgnCount", "Pega-EndUserUI", "08-01-01", "20180713T134746.335 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_1 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY FORMATNUMBER #20180713T133433.065 GMT", "formatNumber", "Pega-Gadgets", "08-01-01", "20180713T133433.065 GMT");
}
