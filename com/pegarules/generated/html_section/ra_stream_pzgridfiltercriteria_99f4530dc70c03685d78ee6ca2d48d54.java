...
/**
 * Builds JSP stream @BASECLASS!PZGRIDFILTERCRITERIA.
 */
public class ra_stream_pzgridfiltercriteria_99f4530dc70c03685d78ee6ca2d48d54 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzGridFilterCriteria.Pega_Landing_System_ToggleManagement.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 2067569878;
 ...
 */
	public ra_stream_pzgridfiltercriteria_99f4530dc70c03685d78ee6ca2d48d54(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "208ffebc05482236da84ea37daa592af479b417c";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZGRIDFILTERCRITERIA #20180713T133440.551 GMT	Pega-Gadgets:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "208ffebc05482236da84ea37daa592af479b417c";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzGridFilterCriteria",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZGRIDFILTERCRITERIA #20180713T133440.551 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZGRIDFILTERCRITERIA #20180713T133440.551 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZGRIDFILTERCRITERIA #20180713T133440.551 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZGRIDFILTERCRITERIA"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZGRIDFILTERCRITERIA","Rule-HTML-Section","@BASECLASS",false,"","Pega-Gadgets","08-01-01","RULE-HTML-SECTION @BASECLASS PZGRIDFILTERCRITERIA #20180713T133440.551 GMT","!PZGRIDFILTERCRITERIA",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",2067569878)
	};
...
//	RULE-HTML-SECTION @BASECLASS PZGRIDFILTERCRITERIA #20180713T133440.551 GMT:20180713T133440.551 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "9fb97b22020eb4aa11b1e4fa4e235229";
	}
...
tools.appendString(" Unique Values Displayed Here.. ");
...
tools.appendString(" <div name=\"BASE_REF\" BASE_REF=\"");
out.print( tools.getStepPage().getReference());
tools.appendString("\"> ");
pzAuto.emitIncludeStreamReference("pyUniqueValuesGrid", null, null, "Rule-HTML-Section", null);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZGRIDFILTERCRITERIA #20180713T133440.551 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzGridFilterCriteria");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZGRIDFILTERCRITERIA #20180713T133440.551 GMT", "@baseclass pzGridFilterCriteria", "Pega-Gadgets", "08-01-01", "20180713T133440.551 GMT");
}
