...
/**
 * Builds JSP stream DATA-PORTAL!USERPORTAL.
 */
public class ra_stream_userportal_5b31280e08c3985cab5afe912bcb65b7 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.UserPortal.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1862212901;
 ...
 */
	public ra_stream_userportal_5b31280e08c3985cab5afe912bcb65b7(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "5962ffcbd1a100991f30a49cbf882f63c545a76e";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL USERPORTAL #20210506T204031.087 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "5962ffcbd1a100991f30a49cbf882f63c545a76e";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("UserPortal",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL USERPORTAL #20210506T204031.087 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL USERPORTAL #20210506T204031.087 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL USERPORTAL #20210506T204031.087 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("USERPORTAL","Rule-HTML-Section","DATA-PORTAL",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION DATA-PORTAL USERPORTAL #20210506T204031.087 GMT","!USERPORTAL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1862212901)
	};
...
//	RULE-HTML-SECTION DATA-PORTAL USERPORTAL #20210506T204031.087 GMT:20210506T204031.087 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "46085fee4798f881c88b484b12de0e88";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("UserPortal",1,"Rule-HTML-Section","{'type':'Section','ruleName':'UserPortal','insKey':'RULE-HTML-SECTION DATA-PORTAL USERPORTAL #20210506T204031.087 GMT','sectionType':'standard'}");

tools.putParamValue("pyIsDCSPA","true");tools.putParamValue("pyIsMultiSession","true");elementModel_1("c3e3a9a1-f2a3-4899-b30c-54238b475731","e3bd14e1-af31-4f4c-9613-72ed5dab48f3","Title","true","1","Harness","Loaded","NoIFrame","true");pzLayout_1();
...
tools.putParamValue("pyIsMultiSession","true");
}
...
public void includeSectionBody_1() { 
	...
	String strIncludedScripts = tools.getParamValue("strIncludedScripts");
		pega_uiengine_portal.pzGeneratePortalElementModel(tools, strSectionDetails, "UserPortal", strIncludedScripts);
	}
	IUIComponentMetadata dcMetadata = pzAuto.getUIComponentRuntime().createMetadata();
	java.util.HashMap dcParamsMap = null;
	dcMetadata.put("liveUI","" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'Home'}") + "");
	dcMetadata.put("DCMode","Single");
	dcMetadata.put("tabGrpName","c3e3a9a1-f2a3-4899-b30c-54238b475731");
	...
	dcMetadata.put("DT","");
	dcMetadata.put("streamName","Home");
	dcMetadata.put("streamObjClass","RULE-HTML-HARNESS");
	dcMetadata.put("ariaRole","presentation");
	...
	if(!("true").equals(tools.findPage("pxRequestor").getStringIfPresent("pyPegaDesignMode"))) {
		...
		if (!skipWorkAreaContent) {
			...
			portalKeys.putString("pyStreamName","Home");
			tools.putParamValue("skipPortalChrome","true");
			tools.putParamValue("innerHarnessName","Home");
...
pzSection.getLayout().setExpandParam("SubSectionUserPortalB","",false);
}
...
String paramName = "EXPANDEDSubSectionUserPortalB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'Home'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'Home'}") + ">");
}
pzSetExpandParam_1();
...
ClipboardProperty cp_DCList = pg_displayTemp.getProperty("pyContainerList");
 ...
 cp_DCList.getPropertyValue(1).setValue(tgName);
	...
	pg_SectionTab = tools.findPage("pyDisplayTemp").getProperty("pyElements").getPageValue("UserPortal");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL USERPORTAL #20210506T204031.087 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "UserPortal");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL USERPORTAL #20210506T204031.087 GMT", "Data-Portal UserPortal", "Theme-Cosmos", "04-01-01", "20210506T204031.087 GMT");
}
