...
/**
 * Builds JSP stream RULE-OBJ-FLOW!PZDISPLAYPROCESSMODELERPROPERTIES.
 */
public class ra_stream_pzdisplayprocessmodelerproperties_ce2af559632d906b20e803a766764ec4 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzDisplayProcessModelerProperties.Rule_Obj_Flow.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1692551423;
 ...
 */
	public ra_stream_pzdisplayprocessmodelerproperties_ce2af559632d906b20e803a766764ec4(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "fcffb19ae2035efe154a3f5159d0989453a1711a";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELERPROPERTIES #20180713T140929.135 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "fcffb19ae2035efe154a3f5159d0989453a1711a";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzDisplayProcessModelerProperties",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELERPROPERTIES #20180713T140929.135 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELERPROPERTIES #20180713T140929.135 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELERPROPERTIES #20180713T140929.135 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZDISPLAYPROCESSMODELERPROPERTIES"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZDISPLAYPROCESSMODELERPROPERTIES","Rule-HTML-Section","RULE-OBJ-FLOW",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELERPROPERTIES #20180713T140929.135 GMT","!PZDISPLAYPROCESSMODELERPROPERTIES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1692551423)
	};
...
//	RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELERPROPERTIES #20180713T140929.135 GMT:20180713T140929.135 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "eb41425feffd4d5c8bddeb3c2f6dfed3";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzDisplayProcessModelerProperties",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzDisplayProcessModelerProperties','insKey':'RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELERPROPERTIES #20180713T140929.135 GMT','sectionType':'standard'}");
pzLayout_4();
...
public void buildSection_4() { 
	...
	secInfo.put("usingPage","CaseTypeStages");
	secInfo.put("isUsingPagePropertyRef",false);
	secInfo.put("doNotConsiderDecParams",false);
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	Map<String, String> secParams = new HashMap<String, String>();
	secParams.put("sectionName","pzDisplayProcessModelerProperties");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pzDisableCDPropertiesProxySection", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	tools.putParamValue("sectionName","pzDisplayProcessModelerProperties");tools.putParamValue("section_params","");
	...
	String sectionName = "pzDisableCDPropertiesProxySection"; 
	String usingPage = null;
	usingPage = "CaseTypeStages";
...
pzSection.getLayout().setExpandParam("SubSectionCellpzDisplayProcessModelerProperties398","",false);
}
...
public void buildSection_3() { 
	...
	secParams.put("sectionName","pzDisplayProcessModelerProperties");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_8","pzDisableCDPropertiesProxySection", secInfo);
}
...
public int simpleLayoutCell_2( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzDisableCDPropertiesProxySection",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing remove-bottom-spacing remove-right-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzDisableCDPropertiesProxySection",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzDisplayProcessModelerPropertiesBB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805171823240748620") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzDisplayProcessModelerPropertiesBB";
...
public void buildSection_2() { 
	Map<String, Object> secInfo = new HashMap<String, Object>();
	secInfo.put("usingPage","SelectedFlowReferences.pzShapePageRefPMView");
	secInfo.put("isUsingPagePropertyRef",false);
	secInfo.put("doNotConsiderDecParams",false);
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzPropertyPanelWrapper", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String strSectionPageProp = "";
	try { ClipboardProperty cbSecPage = tools.getIfPresent("SelectedFlowReferences.pzShapePageRefPMView");if(cbSecPage != null && cbSecPage.isScalar()){ strSectionPageProp = cbSecPage.getStringValue(); } else { strSectionPageProp = "SelectedFlowReferences.pzShapePageRefPMView"; } }catch(Exception e){ strSectionPageProp = "SelectedFlowReferences.pzShapePageRefPMView"; }
	...
	String sectionName = "pzPropertyPanelWrapper"; 
	String usingPage = null;
...
pzSection.getLayout().setExpandParam("SubSectionCellpzDisplayProcessModelerProperties375","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzPropertyPanelWrapper", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzPropertyPanelWrapper",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","express-pm-propertypanel-top","express-pm-propertypanel-top")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","express-pm-propertypanel-top");
	pgCells.put("customRWStyles","express-pm-propertypanel-top");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzPropertyPanelWrapper",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzDisplayProcessModelerPropertiesB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805171823240746345") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
	...
	String paramName = "EXPANDEDSubSectionpzDisplayProcessModelerPropertiesB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELERPROPERTIES #20180713T140929.135 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzDisplayProcessModelerProperties");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELERPROPERTIES #20180713T140929.135 GMT", "Rule-Obj-Flow pzDisplayProcessModelerProperties", "Pega-ProcessArchitect", "08-01-01", "20180713T140929.135 GMT");
}
