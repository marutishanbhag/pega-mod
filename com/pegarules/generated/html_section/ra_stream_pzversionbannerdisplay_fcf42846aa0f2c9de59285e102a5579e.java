...
/**
 * Builds JSP stream PEGA-API-RELEASE!PZVERSIONBANNERDISPLAY.
 */
public class ra_stream_pzversionbannerdisplay_fcf42846aa0f2c9de59285e102a5579e extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzVersionBannerDisplay.Pega_API_Release.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -142894858;
 ...
 */
	public ra_stream_pzversionbannerdisplay_fcf42846aa0f2c9de59285e102a5579e(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "5f7584ec21ad22bfd204b5d98c0cd6e57d3aeccb";
...
{
/* Instance RULE-HTML-SECTION PEGA-API-RELEASE PZVERSIONBANNERDISPLAY #20210604T165825.256 GMT	Pega-Desktop:08-07-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "5f7584ec21ad22bfd204b5d98c0cd6e57d3aeccb";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzVersionBannerDisplay",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-API-RELEASE PZVERSIONBANNERDISPLAY #20210604T165825.256 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-API-RELEASE PZVERSIONBANNERDISPLAY #20210604T165825.256 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-API-RELEASE PZVERSIONBANNERDISPLAY #20210604T165825.256 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZVERSIONBANNERDISPLAY", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZVERSIONBANNERDISPLAY","Rule-HTML-Section","PEGA-API-RELEASE",false,"","Pega-Desktop","08-07-01","RULE-HTML-SECTION PEGA-API-RELEASE PZVERSIONBANNERDISPLAY #20210604T165825.256 GMT","!PZVERSIONBANNERDISPLAY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-142894858), 
...
//	RULE-HTML-SECTION PEGA-API-RELEASE PZVERSIONBANNERDISPLAY #20210604T165825.256 GMT:20210604T165825.256 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "e81c24fe5a906a281ec95307fdd7b897";
	}

	public String getDefinitionAppliesToClass() {
		return "Pega-API-Release";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzVersionBannerDisplay",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzVersionBannerDisplay','insKey':'RULE-HTML-SECTION PEGA-API-RELEASE PZVERSIONBANNERDISPLAY #20210604T165825.256 GMT','sectionType':'standard'}");
pzLayout_2();
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pxUpgradeURL")+"~#");	tools.appendString("\", \"\", \"location=0,menubar=0,toolbar=0,status=0,resizable=0,location=0,scrollbars=0\", \"false\",\":event\",\"true\", \"false\"]");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty(".pxUpgradeURL"), -1);
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("202102241551120021337",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzVersionBannerDisplay_$CTX$_4");
		String repeatIndx = "";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","pyViewDetailsAvailableVersion\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("pyViewDetailsAvailableVersion", ".pyButtonLabel");
	}
	pyLabel = "pyViewDetailsAvailableVersion";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzVersionBannerDisplay_"+ referenceString+ "_4'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("202102241551120021337") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","pyViewDetailsAvailableVersion",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing    " + pzSection.getCustomStyle(false, "","standard_dataLabelRead","standard_dataLabelWrite")  + " ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("202102231657140261451")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","pyNewVersionAvailable") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202102231657140261451")).append(" ").toString().replace("data-test-id=","").trim());
	...
	labelName = "pyNewVersionAvailable";
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202102241551120021337-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzVersionBannerDisplayBB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202102231652000830540") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzVersionBannerDisplayBB";
...
pzSection.getLayout().setExpandParam("SubSectionpzVersionBannerDisplayB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpzVersionBannerDisplayB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" rx.pxHasUpgrade", pxUniqueStreamHash+"_12");metadataPage.put("lMode","Flexbox");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" rx.pxHasUpgrade",".pxHasUpgrade", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Pega-API-Release");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-API-RELEASE PZVERSIONBANNERDISPLAY #20210604T165825.256 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzVersionBannerDisplay");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-API-RELEASE PZVERSIONBANNERDISPLAY #20210604T165825.256 GMT", "Pega-API-Release pzVersionBannerDisplay", "Pega-Desktop", "08-07-01", "20210604T165825.256 GMT");
}
