...
/**
 * Builds JSP stream RULE-OBJ-FLOW!PZTOOLBARPREVIEW.
 */
public class ra_stream_pztoolbarpreview_03784d0d4b0b1dae646c0756d59e2775 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzToolbarPreview.Rule_Obj_Flow.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -489356643;
 ...
 */
	public ra_stream_pztoolbarpreview_03784d0d4b0b1dae646c0756d59e2775(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "4afc1e29378e4531f25db213e401393697cbff57";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARPREVIEW #20180713T140929.586 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "4afc1e29378e4531f25db213e401393697cbff57";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzToolbarPreview",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARPREVIEW #20180713T140929.586 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARPREVIEW #20180713T140929.586 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARPREVIEW #20180713T140929.586 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZTOOLBARPREVIEW", 
	"Rule-HTML-Property:PXICON", 
	"Rule-File-Binary:MXGRAPHCORE!PZMXGEDITOR_TOOLBARICONS_SPACER!GIF", 
	"Rule-File-Binary:WEBWB!PZMXGEDITOR_TOOLBARICONS_UNSELECTED!PNG", 
	"Rule-File-Binary:WEBWB!PZMXGEDITOR_TOOLBARICONS_SPACER!GIF", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZTOOLBARPREVIEW","Rule-HTML-Section","RULE-OBJ-FLOW",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARPREVIEW #20180713T140929.586 GMT","!PZTOOLBARPREVIEW",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-489356643), 
		...
		new DependentRuleInfo("MXGRAPHCORE!PZMXGEDITOR_TOOLBARICONS_SPACER!GIF","Rule-File-Binary","",false,"","","","","MXGRAPHCORE!PZMXGEDITOR_TOOLBARICONS_SPACER!GIF",true,false,"ABSOLUTE_CLASSLESS",1), 
		...
		new DependentRuleInfo("WEBWB!PZMXGEDITOR_TOOLBARICONS_SPACER!GIF","Rule-File-Binary","",false,"","","","","WEBWB!PZMXGEDITOR_TOOLBARICONS_SPACER!GIF",true,false,"ABSOLUTE_CLASSLESS",1), 
		...
		new DependentRuleInfo("WEBWB!PZMXGEDITOR_TOOLBARICONS_SPACER!GIF","Rule-File-Binary","",false,"","Pega-ProcessArchitect","","RULE-FILE-BINARY WEBWB PZMXGEDITOR_TOOLBARICONS_SPACER!GIF #20180713T140748.275 GMT","WEBWB!PZMXGEDITOR_TOOLBARICONS_SPACER!GIF",true,false,"ABSOLUTE_CLASSLESS",1), 
...
//	RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARPREVIEW #20180713T140929.586 GMT:20180713T140929.586 GMT
...
//	RULE-FILE-BINARY WEBWB PZMXGEDITOR_TOOLBARICONS_UNSELECTED!PNG #20180713T140748.296 GMT:20180713T140748.296 GMT
//	RULE-HTML-PROPERTY PXICON #20190131T183501.575 GMT:20190131T183501.575 GMT
//	RULE-FILE-BINARY WEBWB PZMXGEDITOR_TOOLBARICONS_SPACER!GIF #20180713T140748.275 GMT:20180713T140748.275 GMT
//	RULE-FILE-BINARY WEBWB PZMXGEDITOR_TOOLBARICONS_SPACER!GIF #20180713T140748.275 GMT:20180713T140748.275 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "6bba83d281496794e4745df81519d59e";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzToolbarPreview",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzToolbarPreview','insKey':'RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARPREVIEW #20180713T140929.586 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
...
try {
	...
	cellPage.put("pyStreamName","pzToolbarPreview");
	...
	src = "data:image/gif;base64,R0lGODlhGAAYAJEAAAAAAP///////wAAACH5BAEAAAIALAAAAAAYABgAAAIWlI+py+0Po5y02ouz3rz7D4biSJZTAQA7";
	
		}
	
		else{
	src = "webwb/pzmxgeditor_toolbaricons_spacer_11507321010.gif!!.gif";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20160504175016094960934") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzToolbarPreview_"+ referenceString+ "_3'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		tools.appendString("<i class='icons'>");tools.appendString("<img   " + pzCell.getTestIdIfEnabled("20160504175016094960934") + "   data-ctl='Icon' ");tools.appendString(" src='");
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		
		tools.appendString("data:image/gif;base64,R0lGODlhGAAYAJEAAAAAAP///////wAAACH5BAEAAAIALAAAAAAYABgAAAIWlI+py+0Po5y02ouz3rz7D4biSJZTAQA7");
		}
		else{
		
		tools.appendString("webwb/pzmxgeditor_toolbaricons_spacer_11507321010.gif!!.gif");
		}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20160504175016094960934-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzToolbarPreviewBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201807101429570646701") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzToolbarPreviewBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpzDisplayPreviewIcon", pxUniqueStreamHash+"_13");metadataPage.put("lMode","Inline-block");
...
if(pzAuto.handleEvaluateWhen(" o1! wxpzDisplayPreviewIcon","!pzDisplayPreviewIcon", "layout", "visible" )) {pzSetExpandParam_2();
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-hover='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"changeStyle\",[\":event\",\"background-position:-598px -26px&#59;\", \"1\"]");

		tools.appendString("]");isBehaviorAdded = true;
		tools.appendString("]' ");isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"ViewerManager.executeAction(\\\"openPreview\\\")\"]");
...
try {
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Preview harness for selected Start or Assignment shape\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Preview harness for selected Start or Assignment shape", ".pyActionPrompt");
	}
	pyTooltip = "Preview harness for selected Start or Assignment shape";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2016050417470403913961") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzToolbarPreview_"+ referenceString+ "_1'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Preview harness for selected Start or Assignment shape\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2016050417470403913961") + "  ");
		...
		tools.appendString(") no-repeat;background-position:-598px top; width:26px; height:26px;' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" title= '");
			tools.appendString(tempText+" ' ");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-hover='[");if(isBehaviorAdded && true){ tools.appendString(","); }		tools.appendString("[\"changeStyle\",[\":event\",\"background-position:-598px -26px&#59;\", \"1\"]");

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }		tools.appendString("[\"changeStyle\",[\":event\",\"background-position:-598px -26px&#59;\", \"1\"]");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing remove-right-spacing remove-left-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2016050417470403913961-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxIcon");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
...
pzSection.getLayout().setExpandParam("SubSectionpzToolbarPreviewB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201807101429570646565") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
	...
	String paramName = "EXPANDEDSubSectionpzToolbarPreviewB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzDisplayPreviewIcon", pxUniqueStreamHash+"_7");metadataPage.put("lMode","Inline-block");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzDisplayPreviewIcon","pzDisplayPreviewIcon", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARPREVIEW #20180713T140929.586 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzToolbarPreview");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-FLOW PZTOOLBARPREVIEW #20180713T140929.586 GMT", "Rule-Obj-Flow pzToolbarPreview", "Pega-ProcessArchitect", "08-01-01", "20180713T140929.586 GMT");
}
