...
/**
 * Builds JSP stream RULE-OBJ-FLOW!PZDISPLAYPROCESSMODELER.
 */
public class ra_stream_pzdisplayprocessmodeler_67ce5dddcdf5da711c5f58ec0cd9e4b4 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzDisplayProcessModeler.Rule_Obj_Flow.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1242807006;
 ...
 */
	public ra_stream_pzdisplayprocessmodeler_67ce5dddcdf5da711c5f58ec0cd9e4b4(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "75ee488c7fd6e318caaa2b8199f3ff7d0b23b9e9";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELER #20180713T140929.124 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "75ee488c7fd6e318caaa2b8199f3ff7d0b23b9e9";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzDisplayProcessModeler",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELER #20180713T140929.124 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELER #20180713T140929.124 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELER #20180713T140929.124 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZDISPLAYPROCESSMODELER"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZDISPLAYPROCESSMODELER","Rule-HTML-Section","RULE-OBJ-FLOW",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELER #20180713T140929.124 GMT","!PZDISPLAYPROCESSMODELER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1242807006)
	};
...
//	RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELER #20180713T140929.124 GMT:20180713T140929.124 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "41a21b90eea07a12b31776fdee26ac89";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzDisplayProcessModeler",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzDisplayProcessModeler','insKey':'RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELER #20180713T140929.124 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_7();
...
public void buildSection_6() { 
	...
	secInfo.put("packageSectionClass", "Rule-Obj-Flow");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_22","pzDisplayProcessModelerPropertiesWrapper", secInfo);
}
...
public void sectionBodyIncludeInCell_6() { 
	...
	"pzDisplayProcessModelerPropertiesWrapper", tools.getStepPage().getReference(),"Rule-Obj-Flow");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	...
	String sectionName = "pzDisplayProcessModelerPropertiesWrapper"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzDisplayProcessModeler214","",false);
}
...
public void buildSection_5() { 
	...
	secInfo.put("packageSection", true);
	secInfo.put("packageSectionClass", "Rule-Obj-Flow");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_18","pzDisplayProcessModelerPropertiesWrapper", secInfo);
}
...
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pzCurrentFlowPageRef\" RW=\"SelectedFlowReferences.pzCurrentFlowPageRef Changes\"");
} catch(Throwable t) {
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking("SelectedFlowReferences.pzCurrentFlowPageRef"), -1);
	}
}catch(Exception e){}
}
...
public int simpleLayoutCell_4( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzDisplayProcessModelerPropertiesWrapper",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  "SelectedFlowReferences.pzCurrentFlowPageRef Changes",expressionId);
		...
		String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzDisplayProcessModelerPropertiesWrapper",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzDisplayProcessModelerBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen", "SelectedFlowReferences.pzShapePageRefPMView != \'\'", expressionId);
	...
	String paramName = "EXPANDEDSubSectionpzDisplayProcessModelerBBBB";
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pzShapePageRefPMView\"  SHOW_WHEN=\"SelectedFlowReferences.pzShapePageRefPMView != ''\"");
if(pzAuto.evaluateWhen("SelectedFlowReferences.pzShapePageRefPMView != ''",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges("SelectedFlowReferences.pzShapePageRefPMView", -1);
	}
}catch(Exception e){}
}
...
public void buildSection_4() { 
	...
	secParams.put("HideNavigation","false");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_14","pzDisplayProcessModelerInner", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String strSectionPageProp = "";
	tools.putParamValue("HideNavigation","false");
	...
	String sectionName = "pzDisplayProcessModelerInner"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpzDisplayProcessModeler355","",false);
}
...
public void buildSection_3() { 
	...
	secParams.put("HideNavigation","false");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pzDisplayProcessModelerInner", secInfo);
}
...
public int simpleLayoutCell_2( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzDisplayProcessModelerInner",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzDisplayProcessModelerInner",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzDisplayProcessModelerBBB","",false);
}
...
public void simpleLayout_2() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  layout-content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzDisplayProcessModelerBBB";
	metadataPage.put("paramName", paramName);
...
pzSection.getLayout().setExpandParam("SubSectionpzDisplayProcessModelerBB","",false);
}
...
public void simpleLayout_4() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICCOLUMN','pgRef':'.pySections(2)'}") + " class='" + "flex  content  two-col-main-sidebar " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzDisplayProcessModelerBB";
	metadataPage.put("paramName", paramName);
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzDisplayCaseTypeWarningMessages", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	try{
	pzPackageRuntime.packageSection(
	"pzDisplayCaseTypeWarningMessages", "CaseTypeStages","Rule-Obj-CaseType");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	...
	String sectionName = "pzDisplayCaseTypeWarningMessages"; 
	String usingPage = null;
...
pzSection.getLayout().setExpandParam("SubSectionCellpzDisplayProcessModeler180","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("packageSection", true);
	secInfo.put("packageSectionClass", "Rule-Obj-CaseType");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzDisplayCaseTypeWarningMessages", secInfo);
}
...
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pyDisplayWarningMessage\" RW=\"CaseTypeStages.pyDisplayWarningMessage Changes\"");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
}
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking("CaseTypeStages.pyDisplayWarningMessage"), -1);
	}
}catch(Exception e){}
}
public String 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzDisplayCaseTypeWarningMessages",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  "CaseTypeStages.pyDisplayWarningMessage Changes",expressionId);
		 String pyCustomRequireFormat= "";
		pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
		String baseRef ="";
		boolean pyDLCellVisibility = false;
		...
		boolean isOffline = false;
		cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
		String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzDisplayCaseTypeWarningMessages",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
		if(!inspectorData.isEmpty()) {
		pgCells.put("liveUI",inspectorData);
		}
		String tempRenderSingle = "";
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyDisplayWarningMessage\"  SHOW_WHEN=\"CaseTypeStages.pyDisplayWarningMessage != ''\"");
if(currentTemplatingStatus =='N')
tools.appendString(" data-simplelayout = \"true\" ");
else
clientWhenAttr += "data-simplelayout=true ";
if(pzAuto.evaluateWhen("CaseTypeStages.pyDisplayWarningMessage != ''",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges("CaseTypeStages.pyDisplayWarningMessage", -1);
	}
}catch(Exception e){}
}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzDisplayProcessModelerB","",false);
}
...
public void simpleLayout_1() {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen", "CaseTypeStages.pyDisplayWarningMessage != \'\'", expressionId);
	expressionId = expression.getId();
	String expressionId_BV = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression_BV = null;
	if(!StringUtils.isBlank(expressionId)) {
	...
	String paramName = "EXPANDEDSubSectionpzDisplayProcessModelerB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELER #20180713T140929.124 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzDisplayProcessModeler");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-FLOW PZDISPLAYPROCESSMODELER #20180713T140929.124 GMT", "Rule-Obj-Flow pzDisplayProcessModeler", "Pega-ProcessArchitect", "08-01-01", "20180713T140929.124 GMT");
}
