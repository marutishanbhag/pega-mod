...
/**
 * Builds JSP stream ASSIGN-!PYSHOWERRORSONASSIGNMENTPAGE.
 */
public class ra_stream_pyshowerrorsonassignmentpage_1f0be44a1923f6e104e315a61c910f72 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyShowErrorsOnAssignmentPage.Assign_Worklist.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 420572576;
 ...
 */
	public ra_stream_pyshowerrorsonassignmentpage_1f0be44a1923f6e104e315a61c910f72(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "2ff6ba020e4e0c6e043db68fe0f0c770d4f8f8ce";
...
{
/* Instance RULE-HTML-SECTION ASSIGN- PYSHOWERRORSONASSIGNMENTPAGE #20210506T204030.025 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "2ff6ba020e4e0c6e043db68fe0f0c770d4f8f8ce";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyShowErrorsOnAssignmentPage",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION ASSIGN- PYSHOWERRORSONASSIGNMENTPAGE #20210506T204030.025 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION ASSIGN- PYSHOWERRORSONASSIGNMENTPAGE #20210506T204030.025 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION ASSIGN- PYSHOWERRORSONASSIGNMENTPAGE #20210506T204030.025 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYSHOWERRORSONASSIGNMENTPAGE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYSHOWERRORSONASSIGNMENTPAGE","Rule-HTML-Section","ASSIGN-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION ASSIGN- PYSHOWERRORSONASSIGNMENTPAGE #20210506T204030.025 GMT","!PYSHOWERRORSONASSIGNMENTPAGE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",420572576), 
...
//	RULE-HTML-SECTION ASSIGN- PYSHOWERRORSONASSIGNMENTPAGE #20210506T204030.025 GMT:20210506T204030.025 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "8423bc33a83caa354de9c26ce7f32ac5";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyShowErrorsOnAssignmentPage",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyShowErrorsOnAssignmentPage','insKey':'RULE-HTML-SECTION ASSIGN- PYSHOWERRORSONASSIGNMENTPAGE #20210506T204030.025 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_3();
...
config.put("pzActivity", "resetAssignmentStatus");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_15","HarnessErrorList", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpyShowErrorsOnAssignmentPage365","",false);
}
...
public void buildSection_1() { 
	...
	secParams.put("hideWarnings","false");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_12","HarnessErrorList", secInfo);
}
...
public int simpleLayoutCell_3( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","HarnessErrorList",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","HarnessErrorList",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpyShowErrorsOnAssignmentPageBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806191354050065534") + " ");
	...
	String paramName = "EXPANDEDSubSectionpyShowErrorsOnAssignmentPageBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxhasMessages", pxUniqueStreamHash+"_16");metadataPage.put("lMode","Flexbox");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=resetAssignmentStatus");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }				{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
					com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
						...
						if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
							try{
								pzPackageRuntime.packageSection("pyShowErrorsOnAssignmentPage",
								...
								staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pyShowErrorsOnAssignmentPage"));
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2014112705170909652475",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pyShowErrorsOnAssignmentPage_$CTX$_7");
		String repeatIndx = "";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Clear Error\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Clear Error", ".pyButtonLabel");
	}
	pyLabel = "Clear Error";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyShowErrorsOnAssignmentPage_"+ referenceString+ "_7'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2014112705170909652475") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Clear Error",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
try {
out.print(tools.getLocalizedTextForString("pyMessageLabel",tools.getPrimaryPage().getString("pyErrorMessage")));
} catch(Throwable t) {
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("2014112705170909641160")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2014112705170909641160")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpzHasPrivilegeToClearAssignmentErrors","pzHasPrivilegeToClearAssignmentErrors","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2014112705170909652475-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzHasPrivilegeToClearAssignmentErrors",pxUniqueStreamHash+"_9");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_9");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzHasPrivilegeToClearAssignmentErrors");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzHasPrivilegeToClearAssignmentErrors", pxUniqueStreamHash+"_9"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionpyShowErrorsOnAssignmentPageB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806191354050064780") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
	...
	String paramName = "EXPANDEDSubSectionpyShowErrorsOnAssignmentPageB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzHasAssignmentErrors", pxUniqueStreamHash+"_10");metadataPage.put("lMode","Flexbox");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzHasAssignmentErrors","pzHasAssignmentErrors", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION ASSIGN- PYSHOWERRORSONASSIGNMENTPAGE #20210506T204030.025 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyShowErrorsOnAssignmentPage");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION ASSIGN- PYSHOWERRORSONASSIGNMENTPAGE #20210506T204030.025 GMT", "Assign- pyShowErrorsOnAssignmentPage", "Theme-Cosmos", "04-01-01", "20210506T204030.025 GMT");
}
