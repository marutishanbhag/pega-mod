...
/**
 * Builds JSP stream EMBED-ACTIVITYSTEPS!PZREMOVEDPARAMS.
 */
public class ra_stream_pzremovedparams_cffb7e7123825abb91907fd71d0207c0 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzRemovedParams.Embed_ActivitySteps.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -781958727;
 ...
 */
	public ra_stream_pzremovedparams_cffb7e7123825abb91907fd71d0207c0(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "23a4c77699efc56c8a7f67201512ac1ad35b4ece";
...
{
/* Instance RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZREMOVEDPARAMS #20180713T135209.119 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "23a4c77699efc56c8a7f67201512ac1ad35b4ece";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzRemovedParams",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZREMOVEDPARAMS #20180713T135209.119 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZREMOVEDPARAMS #20180713T135209.119 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZREMOVEDPARAMS #20180713T135209.119 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZREMOVEDPARAMS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZREMOVEDPARAMS","Rule-HTML-Section","EMBED-ACTIVITYSTEPS",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZREMOVEDPARAMS #20180713T135209.119 GMT","!PZREMOVEDPARAMS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-781958727)
	};
...
//	RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZREMOVEDPARAMS #20180713T135209.119 GMT:20180713T135209.119 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "3f10e0baa0785495e9ad96cad1c9fed9";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzRemovedParams",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzRemovedParams','insKey':'RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZREMOVEDPARAMS #20180713T135209.119 GMT','sectionType':'null'}");
pzLayout_1();
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzRemovedParamsB"));
...
metadataPage.put("title","Removed Parameters");
metadataPage.put("uniqueid", "202602230423260807");
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_2","pzRemovedParamsCustom", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzRemovedParamsCustom";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzHeaderCellContent_1() {
}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzRemovedParamsB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzRemovedParamsCustom'}") + " class='layout layout-outline layout-outline-default' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpzRemovedParamsB";
...
l_sectionTitle="Removed Parameters";
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel8789' data-layout-id='202602230423260803" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel8789'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzRemovedParamsB","tdRightStyle");}
if(showContainerIcons){
...
String paramName = "EXPANDEDSubSectionpzRemovedParamsB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzRemovedParamsCustom'}");
...
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzHasRemovedParams", pxUniqueStreamHash+"_3");metadataPage.put("isSectionIncl","true");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzHasRemovedParams","pzHasRemovedParams", "layout", "visible" )) {pzSetExpandParam_1();
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZREMOVEDPARAMS #20180713T135209.119 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzRemovedParams");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZREMOVEDPARAMS #20180713T135209.119 GMT", "Embed-ActivitySteps pzRemovedParams", "Pega-Desktop", "08-01-01", "20180713T135209.119 GMT");
}
