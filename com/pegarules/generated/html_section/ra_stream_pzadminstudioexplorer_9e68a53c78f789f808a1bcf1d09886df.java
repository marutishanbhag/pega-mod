...
/**
 * Builds JSP stream PEGA-EXT-ADMINSTUDIO-EXPLORER!PZADMINSTUDIOEXPLORER.
 */
public class ra_stream_pzadminstudioexplorer_9e68a53c78f789f808a1bcf1d09886df extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzAdminStudioExplorer.Pega_Ext_AdminStudio_Explorer.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 130709492;
 ...
 */
	public ra_stream_pzadminstudioexplorer_9e68a53c78f789f808a1bcf1d09886df(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "de0b67b7986b13fdd9d7a6a5c0a0f126ba36f29";
...
{
/* Instance RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PZADMINSTUDIOEXPLORER #20180713T135230.457 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "de0b67b7986b13fdd9d7a6a5c0a0f126ba36f29";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzAdminStudioExplorer",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PZADMINSTUDIOEXPLORER #20180713T135230.457 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PZADMINSTUDIOEXPLORER #20180713T135230.457 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PZADMINSTUDIOEXPLORER #20180713T135230.457 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZADMINSTUDIOEXPLORER", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZADMINSTUDIOEXPLORER","Rule-HTML-Section","PEGA-EXT-ADMINSTUDIO-EXPLORER",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PZADMINSTUDIOEXPLORER #20180713T135230.457 GMT","!PZADMINSTUDIOEXPLORER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",130709492), 
...
//	RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PZADMINSTUDIOEXPLORER #20180713T135230.457 GMT:20180713T135230.457 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "24f7f7d00a537ed806b7f3df68f22498";
	}

	public String getDefinitionAppliesToClass() {
		return "Pega-Ext-AdminStudio-Explorer";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzAdminStudioExplorer",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzAdminStudioExplorer','insKey':'RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PZADMINSTUDIOEXPLORER #20180713T135230.457 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzAdminStudioExplorerPanel", secInfo);
}
public void buildWhiteList_1() {
Map<String, String> config;
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("navName", "pzMainExplorer");
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzAdminStudioExplorerPanel";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_2() {
pzSection.getLayout().setExpandParam("SubSectionpzAdminStudioExplorerBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzAdminStudioExplorerBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzAdminStudioExplorerPanel'}");
...
containerComponent.addPropertyToMetadata("rwclass", "workspace-panel");
containerComponent.addPropertyToMetadata("roclass", "workspace-panel");
pzLayoutBody_2();
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzAdminStudioExplorerPanel'}") + ">");
}
pzSetExpandParam_2();
...
String RWClasses = "";
RWClasses += " ";
RWClasses += pzSection.getCustomStyle(false, "","workspace-panel","workspace-panel") ;
RWClasses += " ";
...
RWClassesHelper += " ";
RWClassesHelper += pzSection.getCustomStyle(false, "","workspace-panel","workspace-panel") ;
RWClassesHelper += " ";
...
String uniqueMenuId = "";
uniqueMenuId = "PegaExtAdminStudioExplorerpzMainExplorer1";
{
...
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("pzAdminStudioExplorer",
		...
		modePage.put("styleOther","menu-format-transparent");
		modePage.put("nav","pzMainExplorer");
		...
		if(pzAuto.isOffline()) {
		pega_uiengine_pzcontrol.pzGetMenu("pzMainExplorer", "", navPageName,"", true , false,  (pzAuto.isOffline() ? false :false), true);
		} else {
		...
		options.put(com.pega.pegarules.priv.runtime.IControlRuntime.B_IS_REMOVE_NAV_PAGE, true);
			pzAuto.getControl().executeNavRule("pzMainExplorer", navPageName, "", navPageRef, options);
		}
			cc.endComponent();
		} else {
			pega_uiengine_pzcontrol.pzGetMenu("pzMainExplorer", "", navPageName,"", true , false,  (pzAuto.isOffline() ? false :false), true);
...
pzStatic_ControlMenu.emitContent();
			...
			tools.appendString("<div id='div-menu-" + uniqueTS + "' style='display:none;'></div><script type=\"text/javascript\">pega.control.menu.pxMenuManager.schedule(\"menu-" + uniqueTS + "\", {\"type\": \"vertical\", \"format\": \"menu-format-transparent\", \"menuID\": \"menu-" + uniqueTS + "\", \"navName\": \"pzMainExplorer\", \"navPage\": \"" + navPageName + "\", \"navUID\": \"pzMainExplorer_1\", \"isMobile\": \"" + pzAuto.isMobile() + "\", \"usingPage\": \"" + tools.getStepPage().getReference() + "\"");
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxMenu",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2018012211174407637672-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxMenu",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzAdminStudioExplorerB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201801221117440762343") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default explorer-menu" + "'  ");
		...
		pg_dlmeta.put("customClassName","explorer-menu");
	...
	String paramName = "EXPANDEDSubSectionpzAdminStudioExplorerB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Pega-Ext-AdminStudio-Explorer");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PZADMINSTUDIOEXPLORER #20180713T135230.457 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzAdminStudioExplorer");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER PZADMINSTUDIOEXPLORER #20180713T135230.457 GMT", "Pega-Ext-AdminStudio-Explorer pzAdminStudioExplorer", "Pega-Desktop", "08-01-01", "20180713T135230.457 GMT");
}
