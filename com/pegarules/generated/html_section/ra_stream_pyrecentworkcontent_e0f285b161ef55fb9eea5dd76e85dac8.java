...
/**
 * Builds JSP stream SYSTEM-USER-RECENTS!PYRECENTWORKCONTENT.
 */
public class ra_stream_pyrecentworkcontent_e0f285b161ef55fb9eea5dd76e85dac8 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyRecentWorkContent.System_User_Recents.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1756305292;
 ...
 */
	public ra_stream_pyrecentworkcontent_e0f285b161ef55fb9eea5dd76e85dac8(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "c997615995fa4b4d08a546afcb9a1149f78543ec";
...
{
/* Instance RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "c997615995fa4b4d08a546afcb9a1149f78543ec";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyRecentWorkContent",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYRECENTWORKCONTENT", 
	"Rule-Obj-Property:PYRECORDID", 
	"Rule-Obj-Property:PYRULETYPELABEL", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYRECENTWORKCONTENT","Rule-HTML-Section","SYSTEM-USER-RECENTS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT","!PYRECENTWORKCONTENT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1756305292), 
		new DependentRuleInfo("PYRECORDID","Rule-Obj-Property","SYSTEM-USER-RECENTS",true,"System-User-Recents","Pega-UIEngine","08-01-01","RULE-OBJ-PROPERTY SYSTEM-USER-RECENTS PYRECORDID #20180713T133217.606 GMT","!PYRECORDID",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYRULETYPELABEL","Rule-Obj-Property","SYSTEM-USER-RECENTS",true,"System-User-Recents","Pega-UIEngine","08-01-01","RULE-OBJ-PROPERTY SYSTEM-USER-RECENTS PYRULETYPELABEL #20180713T133217.647 GMT","!PYRULETYPELABEL",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT:20210506T204029.800 GMT
//	RULE-HTML-PROPERTY PXLINK #20190131T183501.590 GMT:20190131T183501.590 GMT
//	RULE-OBJ-PROPERTY SYSTEM-USER-RECENTS PYRECORDID #20180713T133217.606 GMT:20180713T133217.606 GMT
//	RULE-OBJ-PROPERTY SYSTEM-USER-RECENTS PYRULETYPELABEL #20180713T133217.647 GMT:20180713T133217.647 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "d48586963b38daf0141e043405fca102";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 ...
 pzSection.includeGadget("PegaGadget-RecentList","<?xml version=\"1.0\"?><pagedata><pyListSize>10</pyListSize><pxObjClass>PegaGadget-RecentList</pxObjClass><pxCreateOperator>jalds</pxCreateOperator><pxCreateDateTime>20121227T075123.705 GMT</pxCreateDateTime><pxCreateSystemID>sde</pxCreateSystemID><pyAppliesTo>@baseclass</pyAppliesTo><pxCreateOpName>Sreekanth Jaldi</pxCreateOpName></pagedata>",1,"{'type':'Section','ruleName':'pyRecentWorkContent','insKey':'RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT','sectionType':'standard'}"); 
pzLayout_4();
 pzSection.endGadget(); 
...
pega.getUIEngine().getUIAction("runScript", config).register();
config = new HashMap<String, String>();
config.put("pzActivity", "SetAsFavourite");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.u.d.skipToContent(\\\"navigation\\\")\"]");
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=SetAsFavourite");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }				{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
					com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
						...
						refreshActionRequest.registerFixedParameter("StreamList", "pyDisplayRecents|Rule-HTML-Section|:");
						staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
						tools.appendString("[\"refresh\", [\"otherSection\",\"pyDisplayRecents\", \"\", \"");
		...
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }								tools.appendString("[\"runScript\", [\"pega.u.d.skipToContent(\\\"navigation\\\")\"]");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20190726132613055252724") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyRecentWorkContent_$CTX$_10");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Bookmark this item\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Bookmark this item", ".pyActionPrompt");
	}
	pyTooltip = "Bookmark this item";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","tooltip");
	modePage2.put("styles","Icon");
	modePage2.put("imgSrc","styleclass");
	String pyIconStyle = "";
	pyIconStyle = "pi pi-bookmark pi-light";
	...
	String spxUniqueStreamHash21 = getUIActionsMetaData_4();
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyRecentWorkContent_"+ referenceString+ "_10'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20190726132613055252724") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Bookmark this item\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
		...
		tools.appendString(" >");
		String classProp = "";
		 classProp ="pi pi-bookmark pi-light";
...
public void pxDisplayText_2() {String key="9||RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","9"};oCellRuntimeParamsMap.put("9||RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT",paramValues);oControlPathsMap.put("9||RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}


public void pxDisplayText_1() {String key="8||RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","8"};oCellRuntimeParamsMap.put("8||RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT",paramValues);oControlPathsMap.put("8||RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyContentType cqWork",".pyContentType == \'Work\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyRecordID",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201902191102450482152750-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel",".pyRecordID");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyContentType cqWork",pxUniqueStreamHash+"_13");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_13");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyContentType == 'Work'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","System-User-Recents");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyContentType cqWork", pxUniqueStreamHash+"_13"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyRecordID",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_4( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyContentType cqRule",".pyContentType == \'Rule\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyRuleTypeLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-all-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201902191102450482153748-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel",".pyRuleTypeLabel");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyContentType cqRule",pxUniqueStreamHash+"_15");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_15");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyContentType == 'Rule'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","System-User-Recents");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_15");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyContentType cqRule", pxUniqueStreamHash+"_15"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyRuleTypeLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_2();}
...
pzSection.getLayout().setExpandParam("SubSectionpyRecentWorkContentBBBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201902191102450482430") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  layout-content-mimic_a_sentence content-mimic_a_sentence " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpyRecentWorkContentBBBB";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }if(pzAuto.getUIComponentRuntime().isTemplateRendering()){pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();}pega_uiengine_pzcontrol.pzActionInvoke(".pyExecute",false,false, pzAuto, true);
		tools.appendString("]");isBehaviorAdded = true;
		tools.appendString("]' ");isBehaviorAdded = false;
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }if(pzAuto.getUIComponentRuntime().isTemplateRendering()){pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();}pega_uiengine_pzcontrol.pzActionInvoke(".pyExecute",false,false, pzAuto, true);
		tools.appendString(",");
		tools.appendString(",\"enter\"");
		tools.appendString("]");isBehaviorAdded = true;
		tools.appendString("]' ");
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("201902191102450481149739",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pyRecentWorkContent_$CTX$_5");
		String repeatIndx = "";
	...
	String spxUniqueStreamHash6 = getUIActionsMetaData_3();
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyRecentWorkContent_"+ referenceString+ "_5'";
	 String securedPropValue = null;
	 ...
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("201902191102450481149739") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }if(pzAuto.getUIComponentRuntime().isTemplateRendering()){pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();}pega_uiengine_pzcontrol.pzActionInvoke(".pyExecute",false,false, pzAuto, true);
		tools.appendString("]");isBehaviorAdded = true;
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","navigation-content-message case-title","navigation-content-message case-title")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-all-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201902191102450481149739-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxLink");
	pgCells.put("forLabel",".pyLabel");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","navigation-content-message case-title");
	pgCells.put("customRWStyles","navigation-content-message case-title");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_1();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyRecentWorkContentBBB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201902191102450481559") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-simple_list content-simple_list " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpyRecentWorkContentBBB";
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-all-spacing set-width-auto   flex flex-row '  STRING_TYPE='layout' RESERVE_SPACE='false'>");
	pzLayout_1();
...
pzSection.getLayout().setExpandParam("SubSectionpyRecentWorkContentBB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201902191102450480695") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  pointer has-action auto-width-column layout-content-simple_list content-simple_list margin-r-auto" + "'  " + "role='listbox' tabindex='0' ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		...
		tools.appendString("]' ");
				...
				pg_dlmeta.put("customClassName","margin-r-auto");
				...
				pg_dlmeta.put("ariaRole","listbox");
			...
			String paramName = "EXPANDEDSubSectionpyRecentWorkContentBB";
...
public int simpleLayoutCell_7( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o1! wxIsFavourite","!IsFavourite","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-right-spacing    " + pzSection.getCustomStyle(false, "","visible-on-hover flex-shrink-0","visible-on-hover flex-shrink-0")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20190726132613055252724-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","visible-on-hover flex-shrink-0");
	pgCells.put("customRWStyles","visible-on-hover flex-shrink-0");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxIsFavourite",pxUniqueStreamHash+"_23");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_23");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","!IsFavourite");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","System-User-Recents");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_23");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxIsFavourite", pxUniqueStreamHash+"_23"); 
	}
	if(pyDLCellVisibility) {
...
pzSection.getLayout().setExpandParam("SubSectionpyRecentWorkContentB","",false);
}
...
public void simpleLayout_4() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20190726132613055037") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle padding-b-2x flex-grow-1-item-1 flex-nowrap" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","padding-b-2x flex-grow-1-item-1 flex-nowrap");
	...
	String paramName = "EXPANDEDSubSectionpyRecentWorkContentB";
...
static {
	...
	oStreamProperties_1.put("pyClassName", "System-User-Recents");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyRecentWorkContent");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION SYSTEM-USER-RECENTS PYRECENTWORKCONTENT #20210506T204029.800 GMT", "System-User-Recents pyRecentWorkContent", "Theme-Cosmos", "04-01-01", "20210506T204029.800 GMT");
}
