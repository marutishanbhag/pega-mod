...
/**
 * Builds JSP stream RULE-OBJ-PROPERTY!PZPROPERTYMODE.
 */
public class ra_stream_pzpropertymode_51a683d8cbe01e3d2ddb3c5c567f0ce1 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzPropertyMode.Rule_Obj_Property.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -298598407;
 ...
 */
	public ra_stream_pzpropertymode_51a683d8cbe01e3d2ddb3c5c567f0ce1(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "527309c80a2a8a3bc3d2a4e249e3d3421905f9df";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-PROPERTY PZPROPERTYMODE #20180713T135658.269 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "527309c80a2a8a3bc3d2a4e249e3d3421905f9df";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzPropertyMode",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-PROPERTY PZPROPERTYMODE #20180713T135658.269 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-PROPERTY PZPROPERTYMODE #20180713T135658.269 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-PROPERTY PZPROPERTYMODE #20180713T135658.269 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZPROPERTYMODE", 
	"Rule-Obj-Property:PYPROPERTYMODELABEL", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZPROPERTYMODE","Rule-HTML-Section","RULE-OBJ-PROPERTY",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION RULE-OBJ-PROPERTY PZPROPERTYMODE #20180713T135658.269 GMT","!PZPROPERTYMODE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-298598407), 
		new DependentRuleInfo("PYPROPERTYMODELABEL","Rule-Obj-Property","RULE-OBJ-PROPERTY",true,"Rule-Obj-Property","Pega-SystemArchitect","08-01-01","RULE-OBJ-PROPERTY RULE-OBJ-PROPERTY PYPROPERTYMODELABEL #20180713T135630.681 GMT","!PYPROPERTYMODELABEL",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE-OBJ-PROPERTY PZPROPERTYMODE #20180713T135658.269 GMT:20180713T135658.269 GMT
//	RULE-OBJ-PROPERTY RULE-OBJ-PROPERTY PYPROPERTYMODELABEL #20180713T135630.681 GMT:20180713T135630.681 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "ddf7eb37446628822948cbb2e13c6b3c";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzPropertyMode",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzPropertyMode','insKey':'RULE-HTML-SECTION RULE-OBJ-PROPERTY PZPROPERTYMODE #20180713T135658.269 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("pyPreDataTransform.pyName", "pzSetCircumstanceProperty");
pega.getUIEngine().getUIAction("runDataTransform", config).register();
config = new HashMap<String, String>();
config.put("ActionSection", "pyOverlayTemplate");
config.put("NewTaskStatus", "pzControlMenu_PropertyModes");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		actionRequestD.registerFixedParameter("pyModelName","pzSetCircumstanceProperty");
			String usingPageString = "";
			usingPageString = pzAuto.getUIComponentRuntime().generateActionTokenForPage();
			tools.appendString("[\"runDataTransform\", [\"pzSetCircumstanceProperty\", \"=");
			...
			pzPackageRuntime.packageDataTransform(contextClass, "pzSetCircumstanceProperty");
			}
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }				{
					...
					keyMap.putString("pyActionName", "pzControlMenu_PropertyModes");
					...
					if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
					pzPackageRuntime.packageLocalAction("pzControlMenu_PropertyModes", offlineUsingPage , strLAClassName);
					...
					if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
						try{
							pzPackageRuntime.packageSection("pzPropertyMode",
							...
							if("true".equals(bHasPrivilege )) {
								tools.appendString("[\"processAction\", [\"pzControlMenu_PropertyModes\",\"overlay\",\":event\",\"\",\""+streamType+"\",\"\",\"\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-null%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22effect%22%3A%22anim-null%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
								} else {
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("propertymode_change",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzPropertyMode_$CTX$_3");
		String repeatIndx = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzPropertyMode_"+ referenceString+ "_3'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("propertymode_change") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false; checkForScriptTags_1("change"); 
...
public void pxDisplayText_1() {String key="1||RULE-HTML-SECTION RULE-OBJ-PROPERTY PZPROPERTYMODE #20180713T135658.269 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","false","1"};oCellRuntimeParamsMap.put("1||RULE-HTML-SECTION RULE-OBJ-PROPERTY PZPROPERTYMODE #20180713T135658.269 GMT",paramValues);oControlPathsMap.put("1||RULE-HTML-SECTION RULE-OBJ-PROPERTY PZPROPERTYMODE #20180713T135658.269 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyPropertyModeLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-right-spacing remove-left-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item dataValueRead'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("partialClass","remove-right-spacing remove-left-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015052004094804451246-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel",".pyPropertyModeLabel");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyPropertyModeLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-right-spacing    " + pzSection.getCustomStyle(false, "","standard_dataLabelRead","standard_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("2015052004094804462969") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + "' >");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015052004094804462969")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pzInsKey cq",pxUniqueStreamHash+"_6");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pzInsKey cq", pxUniqueStreamHash+"_6"); 
	}
...
public int simpleLayoutCell_3( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-right-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("localize","false");
	pgCells.put("partialClass","remove-right-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("propertymode_change-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pzInsKey cq",pxUniqueStreamHash+"_10");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pzInsKey cq", pxUniqueStreamHash+"_10"); 
	}
	if(pyDLCellVisibility) {
...
public int simpleLayoutCell_4( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-right-spacing    " + pzSection.getCustomStyle(false, "","standard_dataLabelRead","standard_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("2015052004094804474874") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + "' >");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("localize","false");
	pgCells.put("partialClass","remove-right-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015052004094804474874")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("labelReadClass","dataLabelRead");
	pgCells.put("labelWriteClass","dataLabelWrite");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pzInsKey cq",pxUniqueStreamHash+"_12");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pzInsKey cq", pxUniqueStreamHash+"_12"); 
	}
	if(pyDLCellVisibility) {
...
pzSection.getLayout().setExpandParam("SubSectionpzPropertyModeB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzPropertyModeB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-PROPERTY PZPROPERTYMODE #20180713T135658.269 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzPropertyMode");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-PROPERTY PZPROPERTYMODE #20180713T135658.269 GMT", "Rule-Obj-Property pzPropertyMode", "Pega-SystemArchitect", "08-01-01", "20180713T135658.269 GMT");
}
