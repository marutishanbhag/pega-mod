...
/**
 * Builds JSP stream RULE-!PZPAGESANDCLASSESNOMODE.
 */
public class ra_stream_pzpagesandclassesnomode_db92549312cfa4acfbe5518ab06059ef extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzPagesAndClassesNoMode.Rule_Obj_Model.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -78605826;
 ...
 */
	public ra_stream_pzpagesandclassesnomode_db92549312cfa4acfbe5518ab06059ef(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "49b2e9a128440e2545a892dd8b06b58fb84b3149";
...
{
/* Instance RULE-HTML-SECTION RULE- PZPAGESANDCLASSESNOMODE #20181210T195226.829 GMT	Pega-Desktop:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "49b2e9a128440e2545a892dd8b06b58fb84b3149";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzPagesAndClassesNoMode",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE- PZPAGESANDCLASSESNOMODE #20181210T195226.829 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE- PZPAGESANDCLASSESNOMODE #20181210T195226.829 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE- PZPAGESANDCLASSESNOMODE #20181210T195226.829 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZPAGESANDCLASSESNOMODE", 
	"Rule-Obj-Property:PYPAGESANDCLASSESPAGE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZPAGESANDCLASSESNOMODE","Rule-HTML-Section","RULE-",false,"","Pega-Desktop","08-02-01","RULE-HTML-SECTION RULE- PZPAGESANDCLASSESNOMODE #20181210T195226.829 GMT","!PZPAGESANDCLASSESNOMODE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-78605826), 
		new DependentRuleInfo("PYPAGESANDCLASSESPAGE","Rule-Obj-Property","EMBED-PAGESANDCLASSES",true,"Embed-PagesAndClasses","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY EMBED-PAGESANDCLASSES PYPAGESANDCLASSESPAGE #20180713T131237.692 GMT","!PYPAGESANDCLASSESPAGE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE- PZPAGESANDCLASSESNOMODE #20181210T195226.829 GMT:20181210T195226.829 GMT
//	RULE-OBJ-PROPERTY EMBED-PAGESANDCLASSES PYPAGESANDCLASSESPAGE #20180713T131237.692 GMT:20180713T131237.692 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "7e99536a38bb060eda6b35a148604966";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzPagesAndClassesNoMode",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzPagesAndClassesNoMode','insKey':'RULE-HTML-SECTION RULE- PZPAGESANDCLASSESNOMODE #20181210T195226.829 GMT','sectionType':'standard'}");
pzLayout_1();
...
getControlMarkup_1() {
try {
if(tools.getParamValueCSF("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyPagesAndClassesClass").getEntryHandle())){

/*
 * reference tag
 * Cannot inline because: included stream is too big: 38240 bytes
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyPagesAndClassesClass", "input", "OpenRuleAdvanced")) {
	return;
}
}
else if(tools.getParamValueCSF("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyPagesAndClassesClass").getEntryHandle())){
...
else if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyPagesAndClassesPage").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8")){
		 String referenceString = tools.getStepPage().getReference();
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzPagesAndClassesNoMode_"+ referenceString+ "_23'";
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20141006170745036923595") + "  href='"+hrefValue+"' ");
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxAddListItem",".pyTemplateInputBox",".pySections(2).pySectionBody(3).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "width:100%;",false,"","");tools.appendString("<nobr>");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_7")){
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzPagesAndClassesNoMode_"+ referenceString+ "_19'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20141006170745036819299") + "  href='"+hrefValue+"' ");
		tools.appendString("onclick='pd(event);' ");
		tools.appendString("data-ctl='Icon'"); tools.appendString(" class='");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }tools.appendString("[\"runScript\", [\"pagesClassesNoModeTabClickCallback(\\\"Object\\\")\"]");
...
throw new RuntimeException("Problem in JSP fragment", t);
	 ...
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxDeleteListItem",".pyTemplateInputBox", ".pySections(2).pySectionBody(2).pyTable.pyRows(2).pyCells(3)")); tools.appendString("headers='a3'");
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "",".pyPagesAndClasses","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","0","","","Text","true","17"};oCellRuntimeParamsMap.put("17||RULE-HTML-SECTION RULE- PZPAGESANDCLASSESNOMODE #20181210T195226.829 GMT",paramValues);oControlPathsMap.put("17||RULE-HTML-SECTION RULE- PZPAGESANDCLASSESNOMODE #20181210T195226.829 GMT",".pySections(2).pySectionBody(2).pyTable.pyRows(2).pyCells(1)");}
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20141006170745036415530") + " ");
try {
tools.appendString(" data-importance='secondary' data-attribute-name='");
 String columnHeaderValue = ""; if(!columnHeaderValue.contains(" ") && pega_procom_harness.IsParam(columnHeaderValue) && tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1)) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1))); }  else if(!columnHeaderValue.contains(" ") && columnHeaderValue.matches(".*[.][a-zA-Z]+.*") && !columnHeaderValue.endsWith(".") && tools.getIfPresent(columnHeaderValue) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getIfPresent(columnHeaderValue).getStringValue()); }  else { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", columnHeaderValue, StreamBuilder.FMT_NORMAL); }  tools.appendString(StringUtils.crossScriptingFilter(columnHeaderValue)); 
tools.appendString("' ");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyPagesAndClasses2colWidthCache3").equals("")) { tools.appendParamCSF("PpyPagesAndClasses2colWidthCache3");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
...
public void repeatingHeaderCell_2() {
	...
	String strFieldValue = "";
		...
		tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='Class' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20141006170745036214718") + " ");
try {
tools.appendString(" data-importance='secondary' data-attribute-name='");
 String columnHeaderValue = "Class"; if(!columnHeaderValue.contains(" ") && pega_procom_harness.IsParam(columnHeaderValue) && tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1)) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1))); }  else if(!columnHeaderValue.contains(" ") && columnHeaderValue.matches(".*[.][a-zA-Z]+.*") && !columnHeaderValue.endsWith(".") && tools.getIfPresent(columnHeaderValue) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getIfPresent(columnHeaderValue).getStringValue()); }  else { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", columnHeaderValue, StreamBuilder.FMT_NORMAL); }  tools.appendString(StringUtils.crossScriptingFilter(columnHeaderValue)); 
tools.appendString("' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyPagesAndClasses2colWidthCache2").equals("")) { tools.appendParamCSF("PpyPagesAndClasses2colWidthCache2");} else { tools.appendString("61.920529801324506"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:24px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont '");tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "Class", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<span style='position:absolute; top:0px; right: 0px;'>&nbsp;</span>"); } if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
...
public void repeatingHeaderCell_1() {
	...
	String strFieldValue = "";
		...
		tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='Page name' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20140822140429129") + " ");
try {
tools.appendString(" data-importance='secondary' data-attribute-name='");
 String columnHeaderValue = "Page name"; if(!columnHeaderValue.contains(" ") && pega_procom_harness.IsParam(columnHeaderValue) && tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1)) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getParamValueCSF(columnHeaderValue.substring(columnHeaderValue.indexOf(".")+1))); }  else if(!columnHeaderValue.contains(" ") && columnHeaderValue.matches(".*[.][a-zA-Z]+.*") && !columnHeaderValue.endsWith(".") && tools.getIfPresent(columnHeaderValue) != null) { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", tools.getIfPresent(columnHeaderValue).getStringValue()); }  else { columnHeaderValue = tools.getLocalizedTextForString("pyCaption", columnHeaderValue, StreamBuilder.FMT_NORMAL); }  tools.appendString(StringUtils.crossScriptingFilter(columnHeaderValue)); 
tools.appendString("' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("height:26px;");tools.appendString("width:"); if(!tools.getParamValueCSF("PpyPagesAndClasses2colWidthCache1").equals("")) { tools.appendParamCSF("PpyPagesAndClasses2colWidthCache1");} else { tools.appendString("34.437086092715234"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:24px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont '");tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "Page name", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<span style='position:absolute; top:0px; right: 0px;'>&nbsp;</span>"); } if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
...
pzSection.getLayout().setExpandParam("SubSectionpzPagesAndClassesNoModeBB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpzPagesAndClassesNoModeBB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pyPagesAndClassesL4=null;

 Map selUniqMap_pyPagesAndClassesL4 = null;
tools.appendString("<div  section_index='2' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyPagesAndClasses");tools.appendString("_pzPagesAndClassesNoMode_2'");
...
tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201702160751440209608") + " ");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pyPagesAndClasses");

					}

					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList='.pyPagesAndClassesPage .pyPagesAndClassesClass .pyTemplateInputBox  ' class='yui-skin-sam gPercent grid-responsive-default ");

					if(pega_uiengine_harness.pzInStandardsMode()) {tools.appendString("  ");

					}tools.appendString("' style='");

					tools.appendString("' gPropIndex='PpyPagesAndClasses2' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201702160751440209608-layout") + " ");

					tools.appendString(" class='gridTable ");

					tools.appendString(pzSection.getRepeatStyle());String strSummary = "Pages and Classes";
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpyPagesAndClasses2colWidthGBL\" id=\"PpyPagesAndClasses2colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyPagesAndClasses2colWidthGBL"));tools.appendString("\" />");

					
						 tools.putParamValue("expandRL","false"); 

					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpyPagesAndClasses2colWidthGBR\" id=\"PpyPagesAndClasses2colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyPagesAndClasses2colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpyPagesAndClasses2colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='Pages and Classes' PL_PROP='");

					
tools.appendString(".pyPagesAndClasses");

					tools.appendString("' PL_PROP_CLASS='Embed-PagesAndClasses' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pyPagesAndClasses").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pyPagesAndClasses\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals(".pyPagesAndClasses")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodes.pyPagesAndClasses2") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 

					if (tempTestID != null && !tempTestID.isEmpty() && !tempTestID.equals("")){

					String strEntryHandlePLProp = "";

					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle(".pyPagesAndClasses"); } catch (Exception ex) { }
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201702160751440209608-" + rowTestID) + " ");
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"3\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("Embed-PagesAndClasses", "tempNoRespg");
 ...
 tempNoRespg.removeFromClipboard();
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pyPagesAndClasses2") && tools.getParamValue("partialRefresh").equals("false")) {
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_5","pzPagesAndClassesScriptNoMode", secInfo);
}
...
config = new HashMap<String, String>();
config.put("pyFunctionName", "pagesClassesNoModeTabClickCallback");
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzPagesAndClassesScriptNoMode";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzPagesAndClassesNoModeB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzPagesAndClassesNoModeB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzPagesAndClassesScriptNoMode'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzPagesAndClassesScriptNoMode'}") + ">");
}
pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
throw new RuntimeException("Problem in JSP fragment", t);
	 ...
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyPagesAndClassesClass", ".pySections(2).pySectionBody(2).pyTable.pyRows(2).pyCells(2)")); tools.appendString("headers='a2'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:35px;'");}tools.appendString("class='");
	tools.appendString(" gridCell");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
...
public void pxTextInput_1() {String key="17||RULE-HTML-SECTION RULE- PZPAGESANDCLASSESNOMODE #20181210T195226.829 GMT";
...
throw new RuntimeException("Problem in JSP fragment", t);
	 ...
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxTextInput",".pyPagesAndClassesPage", ".pySections(2).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
...
public void pyPagesAndClasses_1() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyPagesAndClasses2")|| tools.getParamValue("partialTrigger").equals("editRow.pyPagesAndClasses2") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pyPagesAndClasses");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pyPagesAndClasses\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pyPagesAndClasses2")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty(".pyPagesAndClasses");
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyPagesAndClasses2") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE- PZPAGESANDCLASSESNOMODE #20181210T195226.829 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzPagesAndClassesNoMode");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE- PZPAGESANDCLASSESNOMODE #20181210T195226.829 GMT", "Rule- pzPagesAndClassesNoMode", "Pega-Desktop", "08-02-01", "20181210T195226.829 GMT");
}
