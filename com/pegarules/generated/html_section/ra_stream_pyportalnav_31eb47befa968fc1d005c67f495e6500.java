...
/**
 * Builds JSP stream DATA-PORTAL!PYPORTALNAV.
 */
public class ra_stream_pyportalnav_31eb47befa968fc1d005c67f495e6500 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyPortalNav.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -283357780;
 ...
 */
	public ra_stream_pyportalnav_31eb47befa968fc1d005c67f495e6500(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "2c9921b0c31a15ead4459cb56459c6ecd5e80b62";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PYPORTALNAV #20190409T165836.033 GMT	Pega-EndUserUI:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "2c9921b0c31a15ead4459cb56459c6ecd5e80b62";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyPortalNav",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PYPORTALNAV #20190409T165836.033 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PYPORTALNAV #20190409T165836.033 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PYPORTALNAV #20190409T165836.033 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYPORTALNAV","Rule-HTML-Section","DATA-PORTAL",false,"","Pega-EndUserUI","08-03-01","RULE-HTML-SECTION DATA-PORTAL PYPORTALNAV #20190409T165836.033 GMT","!PYPORTALNAV",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-283357780), 
...
//	RULE-HTML-SECTION DATA-PORTAL PYPORTALNAV #20190409T165836.033 GMT:20190409T165836.033 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "75977b8f016d3ff0fb154bf7466bc8cc";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyPortalNav",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyPortalNav','insKey':'RULE-HTML-SECTION DATA-PORTAL PYPORTALNAV #20190409T165836.033 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_3();
pzLayout_4();
pzLayout_5();
...
tools.appendString("<div class='layout layout-noheader layout-noheader-section_divider'>");
...
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pyFollowUnFollowCount\" RW=\"pxRequestor.pyFollowUnFollowCount Changes\"");
} catch(Throwable t) {
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking("pxRequestor.pyFollowUnFollowCount"), -1);
	}
}catch(Exception e){}
}
public void buildSection_4() { 
	...
	secInfo.put("packageSectionClass", "Data-Portal");
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  "pxRequestor.pyFollowUnFollowCount Changes", expressionId);
		if(StringUtils.isBlank(expressionId)) {
			...
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_15","pyFavorites", secInfo);
		}
...
public void includeSectionBody_2() { 
	...
	"pyFavorites", tools.getStepPage().getReference(),"Data-Portal");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	generateClientWhenDiv_3();
	tools.putParamValue("section_params","");
	
	String includedSectionName = "";includedSectionName = "pyFavorites";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
pzSection.getLayout().setExpandParam("SubSectionpyPortalNavBBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpyPortalNavBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(4)','clipboardPath':'pyFavorites'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
metadataPage.put("prefix","-section_divider");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(4)','clipboardPath':'pyFavorites'}") + ">");
}
pzSetExpandParam_5();
...
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pxUpdateDateTime\" RW=\"Declare_pzRecentsCache.pxUpdateDateTime Changes\"");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
}
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking("Declare_pzRecentsCache.pxUpdateDateTime"), -1);
	}
}catch(Exception e){}
}
public void buildSection_3() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  "Declare_pzRecentsCache.pxUpdateDateTime Changes", expressionId);
		if(StringUtils.isBlank(expressionId)) {
			...
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pyRecents", secInfo);
		}
...
config.put("navName", "pyCaseManagerLinks");
...
public void includeSectionBody_1() { 
	...
	try{
	pzPackageRuntime.packageSection(
	"pyRecents", tools.getStepPage().getReference(),"Data-Portal");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	generateClientWhenDiv_2();
	tools.putParamValue("section_params","");
	
	String includedSectionName = "";includedSectionName = "pyRecents";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
	tools.appendString("\n\t\t\t\t\t\t</div>");
	}
}
public void pzSetExpandParam_4() {
pzSection.getLayout().setExpandParam("SubSectionpyPortalNavBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpyPortalNavBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(3)','clipboardPath':'pyRecents'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(3)','clipboardPath':'pyRecents'}") + ">");
}
pzSetExpandParam_4();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
String uniqueMenuId = "";
uniqueMenuId = "DataPortalpyCaseManagerLinks3";
{
...
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("pyPortalNav",
		...
		modePage.put("nav","pyCaseManagerLinks");
		modePage.put("pyUniqueMenuID",uniqueMenuId);
		modePage.put("navPage",navPageName);
		String navPageRef = pxUniqueStreamHash+"_8";
		...
		if(pzAuto.isOffline()) {
		pega_uiengine_pzcontrol.pzGetMenu("pyCaseManagerLinks", "", navPageName,"", false , false,  (pzAuto.isOffline() ? false :false), true);
		} else {
		Map<String, Boolean> options = new HashMap<String, Boolean>();
		options.put(com.pega.pegarules.priv.runtime.IControlRuntime.B_LOCALIZE, false);
		...
		options.put(com.pega.pegarules.priv.runtime.IControlRuntime.B_IS_REMOVE_NAV_PAGE, true);
			pzAuto.getControl().executeNavRule("pyCaseManagerLinks", navPageName, "", navPageRef, options);
		}
			cc.endComponent();
		} else {
			pega_uiengine_pzcontrol.pzGetMenu("pyCaseManagerLinks", "", navPageName,"", false , false,  (pzAuto.isOffline() ? false :false), true);
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2016040813481108793323-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxMenu",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpyPortalNavBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20180810115111050338") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + "flex  content  layout-content-default content-default primary-nav" + "'  ");
		...
		pg_dlmeta.put("customClassName","primary-nav");
	...
	String paramName = "EXPANDEDSubSectionpyPortalNavBB";
...
public void buildSection_2() { 
	...
	secInfo.put("preserveParamState",false);
	Map<String, String> secParams = new HashMap<String, String>();
	secParams.put("FindWorkDisplay","V6Search");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","FindWork", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String strSectionPageProp = "";
	tools.putParamValue("FindWorkDisplay","V6Search");
...
pzSection.getLayout().setExpandParam("SubSectionCellpyPortalNav679","",false);
}
...
public void buildSection_1() { 
	...
	secParams.put("FindWorkDisplay","V6Search");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","FindWork", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","FindWork",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","system-search","system-search")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","system-search");
	pgCells.put("customRWStyles","system-search");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","FindWork",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyPortalNavB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201808101151110452698") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default mobile-search" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","mobile-search");
		pg_dlmeta.put("format","default");
	...
	String paramName = "EXPANDEDSubSectionpyPortalNavB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PYPORTALNAV #20190409T165836.033 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyPortalNav");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PYPORTALNAV #20190409T165836.033 GMT", "Data-Portal pyPortalNav", "Pega-EndUserUI", "08-03-01", "20190409T165836.033 GMT");
}
