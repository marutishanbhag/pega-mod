...
/**
 * Builds JSP stream EMBED-CASEPERSONA!PZCDSTAGECONTENT.
 */
public class ra_stream_pzcdstagecontent_62e36c4b74d4156089453f5f470b73e4 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzCDStageContent.Embed_CasePersona.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -287447802;
 ...
 */
	public ra_stream_pzcdstagecontent_62e36c4b74d4156089453f5f470b73e4(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "2f412b675b5a460d19ed168f78731ce2284883c3";
...
{
/* Instance RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENT #20200511T122744.251 GMT	Pega-AppDefinition:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "2f412b675b5a460d19ed168f78731ce2284883c3";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzCDStageContent",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENT #20200511T122744.251 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENT #20200511T122744.251 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENT #20200511T122744.251 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZCDSTAGECONTENT", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCDSTAGECONTENT","Rule-HTML-Section","EMBED-CASEPERSONA",false,"","Pega-AppDefinition","08-05-01","RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENT #20200511T122744.251 GMT","!PZCDSTAGECONTENT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-287447802), 
...
//	RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENT #20200511T122744.251 GMT:20200511T122744.251 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "fecc37c781385ff99952fa389e5c69a8";
	}

	public String getDefinitionAppliesToClass() {
		return "Embed-CasePersona";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzCDStageContent",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzCDStageContent','insKey':'RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENT #20200511T122744.251 GMT','sectionType':'standard'}");
pzLayout_6();
...
config = new HashMap<String, String>();
config.put("pzActivity", "pzDeletePersona");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }						{
							...
							ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzDeletePersona");
...
try {
	...
	cellPage.put("pyStreamName","pzCDStageContent");
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Remove persona\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Remove persona", ".pyActionPrompt");
	}
	pyTooltip = "Remove persona";
	...
	modePage1.put("pyActionStringID",pxUniqueStreamHash+"_23");
	}
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzCDStageContent_"+ referenceString+ "_9'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Remove persona\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
		String alttempText = tools.getLocalizedTextForString(".pyActionPrompt","Remove persona\t" + repeatIndx ,StreamBuilder.FMT_LITERAL);
		String classProp = "";
		 classProp ="pi pi-trash";
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxpzIsSelectedContextDisabled",pxUniqueStreamHash+"_25");
	...
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-CasePersona");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpzIsSelectedContextDisabled", pxUniqueStreamHash+"_25"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateButton",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzCDStageContentBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	spxUniqueStreamHash21 = getUIActionsMetaData_2();
	...
	String paramName = "EXPANDEDSubSectionpzCDStageContentBBBB";
...
public void buildSection_4() { 
	...
	secInfo.put("usingPage","D_pxPersonaDetails");
	secInfo.put("isUsingPagePropertyRef",false);
	secInfo.put("doNotConsiderDecParams",false);
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	Map<String, String> secParams = new HashMap<String, String>();
	secParams.put("SkipEllipsis","false");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	Map<String, String> declareParams = new HashMap<String, String>();
	declareParams.put("pyPurpose",".pyPersona");
	secInfo.put("decParamList","{'pyPurpose':'"+ "#~"+pzAuto.getUIComponentRuntime().generateActionToken(tools.getProperty(".pyPersona").getReference())+"~#" +"'}");
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  ".pyPersona Changes", expressionId);
		if(!StringUtils.isBlank(expressionId)) {
			secInfo.put("pyExpressionId", expressionId);
		}
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_17","pzPersonaName", secInfo);
	}
...
public void sectionBodyIncludeInCell_4() { 
	...
	"pzPersonaName", "D_pxPersonaDetails","");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	generateClientWhenDiv_2();
	tools.putParamValue("SkipEllipsis","false");tools.putParamValue("section_params","");
	{tools.putParamValue("pyPurpose",tools.getProperty(".pyPersona").getStringValue());tools.putParamValue("decParamList","{'pyPurpose':'"+ "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyPersona")+"~#" +"'}");tools.putParamValue("sectionPageNameBase","D_pxPersonaDetails");}try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));	ct_controlAction.trackValueChanges(tools.getProperty(".pyPersona"), -1);}}catch(Exception e){}
	...
	String sectionName = "pzPersonaName"; 
	String usingPage = null;
	usingPage = "D_pxPersonaDetails";
...
pzSection.getLayout().setExpandParam("SubSectionCellpzCDStageContent560","",false);
}
...
public void buildSection_3() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_13","pzPersonaName", secInfo);
	}
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzPersonaName",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing remove-bottom-spacing remove-right-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzPersonaName",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzCDStageContentBBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpzCDStageContentBBB";
...
public void buildSection_2() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_8","pzPersonaAvatar", secInfo);
	}
...
public void sectionBodyIncludeInCell_2() { 
	...
	try{
	pzPackageRuntime.packageSection(
	"pzPersonaAvatar", "D_pxPersonaDetails","");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	generateClientWhenDiv_2();
	...
	String sectionName = "pzPersonaAvatar"; 
	String usingPage = null;
	usingPage = "D_pxPersonaDetails";
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
...
pzSection.getLayout().setExpandParam("SubSectionCellpzCDStageContent214","",false);
}
...
if(currentTemplatingStatus =='N'){
try {
tools.appendString(" data-dprw=\".pyPersona Changes\" ");
} catch(Throwable t) {
...
public void buildSection_1() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pzPersonaAvatar", secInfo);
	}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzPersonaAvatar",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzPersonaAvatar",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzCDStageContentBB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-inline_middle content-inline_middle " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzCDStageContentBB";
...
public int simpleLayoutCell_6( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-all-spacing set-width-auto   flex flex-row  align-end'  STRING_TYPE='layout' RESERVE_SPACE='false'>");
	pzLayout_5();
 tools.putSaveValue("ContainerID", "");tools.appendString("</div>");
	index++;
	return index;
...
pzSection.getLayout().setExpandParam("SubSectionpzCDStageContentB","",false);
}
...
public void simpleLayout_4() {
	...
	String paramName = "EXPANDEDSubSectionpzCDStageContentB";
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Embed-CasePersona");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENT #20200511T122744.251 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzCDStageContent");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-CASEPERSONA PZCDSTAGECONTENT #20200511T122744.251 GMT", "Embed-CasePersona pzCDStageContent", "Pega-AppDefinition", "08-05-01", "20200511T122744.251 GMT");
}
