...
/**
 * Builds JSP stream PEGA-HELPCONTENT!PZAPPUPGRADEHELPLINK.
 */
public class ra_stream_pzappupgradehelplink_c3e17cbaaea739d1d527f7709827d9ba extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzAppUpgradeHelpLink.Pega_HelpContent.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 561872272;
 ...
 */
	public ra_stream_pzappupgradehelplink_c3e17cbaaea739d1d527f7709827d9ba(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "c9228b6f514ef1fdbe57520eeef2d04a32f71625";
...
{
/* Instance RULE-HTML-SECTION PEGA-HELPCONTENT PZAPPUPGRADEHELPLINK #20200205T063629.198 GMT	Pega-AppDefinition:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "c9228b6f514ef1fdbe57520eeef2d04a32f71625";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzAppUpgradeHelpLink",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-HELPCONTENT PZAPPUPGRADEHELPLINK #20200205T063629.198 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-HELPCONTENT PZAPPUPGRADEHELPLINK #20200205T063629.198 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-HELPCONTENT PZAPPUPGRADEHELPLINK #20200205T063629.198 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZAPPUPGRADEHELPLINK", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPUPGRADEHELPLINK","Rule-HTML-Section","PEGA-HELPCONTENT",false,"","Pega-AppDefinition","08-05-01","RULE-HTML-SECTION PEGA-HELPCONTENT PZAPPUPGRADEHELPLINK #20200205T063629.198 GMT","!PZAPPUPGRADEHELPLINK",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",561872272), 
...
//	RULE-HTML-SECTION PEGA-HELPCONTENT PZAPPUPGRADEHELPLINK #20200205T063629.198 GMT:20200205T063629.198 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "641e59d4b7bcb847ca29c17137c95248";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzAppUpgradeHelpLink",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzAppUpgradeHelpLink','insKey':'RULE-HTML-SECTION PEGA-HELPCONTENT PZAPPUPGRADEHELPLINK #20200205T063629.198 GMT','sectionType':'standard'}");
pzLayout_1();
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyContentURL")+"~#");	tools.appendString("\", \"Pega7 Help\", \"height=600,width=800,location=0,menubar=0,toolbar=0,status=0,resizable=1,location=0,scrollbars=1\", \"false\",\":event\",\"true\", \"false\"]");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty(".pyContentURL"), -1);
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015021716133403377630",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzAppUpgradeHelpLink_$CTX$_3");
		String repeatIndx = "";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","guide\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("guide", ".pyButtonLabel");
	}
	pyLabel = "guide";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzAppUpgradeHelpLink_"+ referenceString+ "_3'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015021716133403377630") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","guide",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","text-size-standard","text-size-standard")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015021716133403377630-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzAppUpgradeHelpLinkB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202001300604480668647") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzAppUpgradeHelpLinkB";
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Pega-HelpContent");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-HELPCONTENT PZAPPUPGRADEHELPLINK #20200205T063629.198 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzAppUpgradeHelpLink");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-HELPCONTENT PZAPPUPGRADEHELPLINK #20200205T063629.198 GMT", "Pega-HelpContent pzAppUpgradeHelpLink", "Pega-AppDefinition", "08-05-01", "20200205T063629.198 GMT");
}
