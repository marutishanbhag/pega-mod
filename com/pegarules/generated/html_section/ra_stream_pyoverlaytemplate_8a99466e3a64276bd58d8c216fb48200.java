 ...
 */
public class ra_stream_pyoverlaytemplate_8a99466e3a64276bd58d8c216fb48200 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyOverlayTemplate.Pega_DataModel_Manage.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 251585112;
 ...
 */
	public ra_stream_pyoverlaytemplate_8a99466e3a64276bd58d8c216fb48200(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "bbd80c90cc04c28d46916f4128327608ff17f13d";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20210506T204029.520 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "bbd80c90cc04c28d46916f4128327608ff17f13d";
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20210506T204029.520 GMT
 * Set up context.
 */
final String prevRuleKey_4 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20210506T204029.520 GMT";final String prevClass_4 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20210506T204029.520 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYOVERLAYTEMPLATE","Rule-HTML-Section","@BASECLASS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20210506T204029.520 GMT","!PYOVERLAYTEMPLATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",251585112), 
...
//	RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20210506T204029.520 GMT:20210506T204029.520 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "4976cdaf5aa1ef05b00a628d838b28dc";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyOverlayTemplate",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyOverlayTemplate','insKey':'RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20210506T204029.520 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_3();
...
params_4.putString("Action", "Submit");
params_4.putString("Caption", "Submit");
params_4.putString("Id", "Submit");
...
params_4.putString("bLocalize", "false");
	...
	if (currentProperty_4 != null && currentProperty_4.getParentPage().getClassName().equals("Pega-DataModel-Manage")) {
...
property_Pega_DataModel_Manage_pzOverlayButton();
...
if (_jspx_meth_pega_param__1(pageContext, "Id", "Submit")) {
	return true;
}
...
params_3.putString("Action", "Submit");
params_3.putString("Caption", "Submit");
params_3.putString("Id", "Submit");
params_3.putString("Disabled", "0");
params_3.putString("ButtonStyle", "Strong");
...
params_3.putString("bLocalize", "false");
	...
	if (currentProperty_3 != null && currentProperty_3.getParentPage().getClassName().equals("Pega-DataModel-Manage")) {
...
params_2.putString("bLocalize", "false");
	...
	if (currentProperty_2 != null && currentProperty_2.getParentPage().getClassName().equals("Pega-DataModel-Manage")) {
...
if (_jspx_meth_pega_param__1(pageContext, "Id", "cancel")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "Disabled", "0")) {
	return true;
...
/**
 * Generates stream property_Pega_DataModel_Manage_ClientValidation
 */
private void property_Pega_DataModel_Manage_ClientValidation() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_1() {
	...
	try {
property_Pega_DataModel_Manage_ClientValidation();
	} finally {
...
/**
 * Generates stream property_Pega_DataModel_Manage_Button
 */
private void property_Pega_DataModel_Manage_Button() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_2() {
	final Map streamProperties = pega.getStreamProperties();
	try {
property_Pega_DataModel_Manage_Button();
...
/**
 * Generates stream property_Pega_DataModel_Manage_pzOverlayButton
 */
private void property_Pega_DataModel_Manage_pzOverlayButton() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
params_1.putString("Action", "Cancel");
params_1.putString("Caption", "Cancel");
params_1.putString("Id", "cancel");
params_1.putString("Disabled", "0");
params_1.putString("ButtonStyle", "Simple");
...
params_1.putString("bLocalize", "false");
	...
	if (currentProperty_1 != null && currentProperty_1.getParentPage().getClassName().equals("Pega-DataModel-Manage")) {
...
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8")) {	field_pzOverlayButton_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pzOverlayButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_11")) {	field_pzOverlayButton_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzOverlayButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","margin-l-auto","margin-l-auto")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_12")) {	field_pzOverlayButton_3();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pzOverlayButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_15")) {	field_pzOverlayButton_4();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	pgCells.put("pyLabelValue",labelName);
	String uiFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData();
	if(!"".equals(uiFieldValueMeta)){
	pgCells.put("stopFV",uiFieldValueMeta);
...
public void simpleLayout_2() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + "flex  content  set-width-auto layout-content-inline_middle content-inline_middle " + "'  ");
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& wxpzShowFAButtons o2== pxparam.includedStreamName cq", pxUniqueStreamHash+"_16");metadataPage.put("lMode","SimpleDiv");
...
pzSection.getLayout().setExpandParam("SubSectionCellpyOverlayTemplate449","",false);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzModalAction",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
static {
	oPropDefinitions_4.put("Pega-DataModel-Manage.pyTemplateInputBox", new LiteweightPropertyDefinition("Pega-DataModel-Manage", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_4.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20210506T204029.520 GMT");
	...
	oStreamProperties_4.put("pyRuleSet", "Theme-Cosmos");
	oStreamProperties_4.put("pyCorrType", "");
	oStreamProperties_4.put("pyStreamName", "pyOverlayTemplate");
	oStreamProperties_4.put("pyRuleSetVersion", "04-01-01");
}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYOVERLAYTEMPLATE #20210506T204029.520 GMT", "@baseclass pyOverlayTemplate", "Theme-Cosmos", "04-01-01", "20210506T204029.520 GMT");
