...
/**
 * Builds JSP stream PEGA-LANDING!PZLPCONTEXTSENSITIVEHELP.
 */
public class ra_stream_pzlpcontextsensitivehelp_e8bec3f3d231008e66b3d2d83d3594b0 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzLPContextSensitiveHelp.Pega_Landing_Org.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1023395683;
 ...
 */
	public ra_stream_pzlpcontextsensitivehelp_e8bec3f3d231008e66b3d2d83d3594b0(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "202daa2d83b731feac90c0ca59d1ad066dddf52b";
...
{
/* Instance RULE-HTML-SECTION PEGA-LANDING PZLPCONTEXTSENSITIVEHELP #20220405T114803.375 GMT	Pega-LP:08-08-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "202daa2d83b731feac90c0ca59d1ad066dddf52b";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzLPContextSensitiveHelp",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-LANDING PZLPCONTEXTSENSITIVEHELP #20220405T114803.375 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-LANDING PZLPCONTEXTSENSITIVEHELP #20220405T114803.375 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-LANDING PZLPCONTEXTSENSITIVEHELP #20220405T114803.375 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZLPCONTEXTSENSITIVEHELP", 
	"Rule-Obj-Property:PXHELPURI", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZLPCONTEXTSENSITIVEHELP","Rule-HTML-Section","PEGA-LANDING",false,"","Pega-LP","08-08-01","RULE-HTML-SECTION PEGA-LANDING PZLPCONTEXTSENSITIVEHELP #20220405T114803.375 GMT","!PZLPCONTEXTSENSITIVEHELP",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1023395683), 
		new DependentRuleInfo("PXHELPURI","Rule-Obj-Property","@BASECLASS",true,"Pega-Landing","Pega-ProcessArchitect","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PXHELPURI #20180713T140650.651 GMT","!PXHELPURI",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION PEGA-LANDING PZLPCONTEXTSENSITIVEHELP #20220405T114803.375 GMT:20220405T114803.375 GMT
...
//	RULE-OBJ-PROPERTY @BASECLASS PXHELPURI #20180713T140650.651 GMT:20180713T140650.651 GMT
//	RULE-HTML-PROPERTY PXHIDDEN #20180713T133435.722 GMT:20180713T133435.722 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PXHELPURI #20180713T140650.651 GMT:20180713T140650.651 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "9f5e1714e3d593e7654881ad0478c3bc";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzLPContextSensitiveHelp",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzLPContextSensitiveHelp','insKey':'RULE-HTML-SECTION PEGA-LANDING PZLPCONTEXTSENSITIVEHELP #20220405T114803.375 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
...
tools.putParamValue("isControlEditableOriginal", true);
	...
	cellPage.put("pyValue",".pxHelpURI");
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	cellPage.put("pyID","pxHelpURI");
	modePage2.put("pyContent","associated");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2017083002592107392803",true));
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pxHelpURI");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pxHelpURI", ".pyCaption");
...
boolean bUITemplatized = pzAuto.getUIComponentRuntime().isTemplateRendering();pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);
	tools.appendString("<input  type=\"hidden\"  " + pzCell.getTestIdIfEnabled("2017083002592107392803") + "  id=\"");
		tools.appendString(tools.getHTMLIDForProperty(true,"hidden"));
tools.appendString("\" value=\"");if(bUITemplatized){
	tools.appendString(pzAuto.getUIComponentRuntime().getRuntimeContextTree().generateContextToken("pxHelpURI"));}else {
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("202204051219250874914",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzLPContextSensitiveHelp_$CTX$_4");
		String repeatIndx = "";
	...
	modePage2.put("image","pi pi-help");
	modePage2.put("actionImgPos","left");
	String customStyles = null;
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Help\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Help", ".pyButtonLabel");
	}
	pyLabel = "Help";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzLPContextSensitiveHelp_"+ referenceString+ "_4'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("202204051219250874914") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"openUrlInWindow\", [\"");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pxHelpURI")+"~#");	tools.appendString("\", \"ShowHelp\", \"height=780,width=960,top=0,left=0,location=0,menubar=0,toolbar=0,status=0,resizable=1,location=0,scrollbars=1\", \"false\",\":event\",\"true\", \"false\"]");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty(".pxHelpURI"), -1);
		}}catch(Exception e){}
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Help",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202204051219250874914-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutCell_4( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_3(".pxHelpURI",0,"","","Text");
	return index;
}
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	String reqExpressionId = null;
	String disExpressionId = null;
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_4(".pxHelpURI",0,"","","Text");
	index++;
	return index;
}
public void pzSetExpandParam_2() {
pzSection.getLayout().setExpandParam("SubSectionpzLPContextSensitiveHelpBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201803051732010177327") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzLPContextSensitiveHelpBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzIsPredictionStudio", pxUniqueStreamHash+"_17");metadataPage.put("lMode","Inline-block");
...
if(pzAuto.handleEvaluateWhen(" wxpzIsPredictionStudio","pzIsPredictionStudio", "layout", "visible" )) {pzSetExpandParam_2();
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("201708300259210738176") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzLPContextSensitiveHelp_$CTX$_1");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzLPContextSensitiveHelp_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("201708300259210738176") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"openUrlInWindow\", [\"");
		...
		tools.appendString("<i aria-hidden='true'  data-click='.' class='" + classProp + "'></i>");
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Help".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-all-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201708300259210738176-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_1(".pxHelpURI",0,"","","Text");
	return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	String reqExpressionId = null;
	String disExpressionId = null;
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_2(".pxHelpURI",0,"","","Text");
	index++;
	return index;
}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzLPContextSensitiveHelpB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzLPContextSensitiveHelpB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpzIsPredictionStudio", pxUniqueStreamHash+"_9");metadataPage.put("lMode","Inline-block");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpzIsPredictionStudio","!pzIsPredictionStudio", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-LANDING PZLPCONTEXTSENSITIVEHELP #20220405T114803.375 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzLPContextSensitiveHelp");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-LANDING PZLPCONTEXTSENSITIVEHELP #20220405T114803.375 GMT", "Pega-Landing pzLPContextSensitiveHelp", "Pega-LP", "08-08-01", "20220405T114803.375 GMT");
}
