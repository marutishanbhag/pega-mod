...
/**
 * Builds JSP stream @BASECLASS!PYCATEGORYITEMLISTENTRY.
 */
public class ra_stream_pycategoryitemlistentry_63df35ba3adee653b525ef8bf8a670f9 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyCategoryItemListEntry.Rule_Obj_Flow.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1276766137;
 ...
 */
	public ra_stream_pycategoryitemlistentry_63df35ba3adee653b525ef8bf8a670f9(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "f832c8cf905fe652f1899a138842a79de9315358";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYCATEGORYITEMLISTENTRY #20180713T140801.438 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "f832c8cf905fe652f1899a138842a79de9315358";
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYCATEGORYITEMLISTENTRY #20180713T140801.438 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYCATEGORYITEMLISTENTRY #20180713T140801.438 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYCATEGORYITEMLISTENTRY #20180713T140801.438 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCATEGORYITEMLISTENTRY","Rule-HTML-Section","@BASECLASS",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION @BASECLASS PYCATEGORYITEMLISTENTRY #20180713T140801.438 GMT","!PYCATEGORYITEMLISTENTRY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1276766137)
	};
...
//	RULE-HTML-SECTION @BASECLASS PYCATEGORYITEMLISTENTRY #20180713T140801.438 GMT:20180713T140801.438 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "191223468578fe62eecd9bf2d5f934eb";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyCategoryItemListEntry",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyCategoryItemListEntry','insKey':'RULE-HTML-SECTION @BASECLASS PYCATEGORYITEMLISTENTRY #20180713T140801.438 GMT','sectionType':'standard'}");
pzLayout_9();
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCategoryItemListEntry881","",false);
}
...
public void simpleLayout_4() {
	...
	spxUniqueStreamHash26 = getUIActionsMetaData_2();
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806190610100645708") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + " class='" + " content  set-width-auto layout-content-simple_list content-simple_list  clearfix" + "'  ");
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& wxpyDisplayNav o2!= rx.pyUsage cqsearch", pxUniqueStreamHash+"_31");metadataPage.put("dlChild","true");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& wxpyDisplayNav o2!= rx.pyUsage cqsearch","pyDisplayNav && .pyUsage != \'search\'", "layout", "visible" )) {pzSetExpandParam_8();
...
public void getNextPage_1(String listSource, int listStartIndex, int listEndIndex) {
	...
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201806190610100644886" ) + "");
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCategoryItemListEntry563","",false);
}
...
public int simpleLayoutCell_4(  int index) {
	...
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201806190610100644886-" + rowTestID) + " ");
	}else {
...
pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("201806190610100644886" ) + "");
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201806190610100644886" ) + " ");
	tools.appendString(">");
	int index = 1;
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCategoryItemListEntry976","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806190610100644120") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCategoryItemListEntry391","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806190610100643573") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
...
public int simpleLayoutCell_8( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& wxpyDisplayNav o2!= rx.pyUsage cqsearch","pyDisplayNav && .pyUsage != \'search\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxpyDisplayNav o2!= rx.pyUsage cqsearch",pxUniqueStreamHash+"_33");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_33");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pyDisplayNav && .pyUsage != 'search'");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxpyDisplayNav o2!= rx.pyUsage cqsearch", pxUniqueStreamHash+"_33"); 
	}
...
public void simpleLayout_5() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806190610100643141") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYCATEGORYITEMLISTENTRY #20180713T140801.438 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYCATEGORYITEMLISTENTRY #20180713T140801.438 GMT", "@baseclass pyCategoryItemListEntry", "Pega-ProcessArchitect", "08-01-01", "20180713T140801.438 GMT");
}
