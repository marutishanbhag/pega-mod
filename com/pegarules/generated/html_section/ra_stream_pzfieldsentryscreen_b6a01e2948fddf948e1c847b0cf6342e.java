...
/**
 * Builds JSP stream RULE-HTML-SECTION!PZFIELDSENTRYSCREEN.
 */
public class ra_stream_pzfieldsentryscreen_b6a01e2948fddf948e1c847b0cf6342e extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzFieldsEntryScreen.Rule_HTML_Section.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -2004810474;
 ...
 */
	public ra_stream_pzfieldsentryscreen_b6a01e2948fddf948e1c847b0cf6342e(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "b209cc2f1d02fedd59ffbe5bf333a73737d5b9ed";
...
{
/* Instance RULE-HTML-SECTION RULE-HTML-SECTION PZFIELDSENTRYSCREEN #20200521T222404.893 GMT	Pega-ProcessArchitect:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "b209cc2f1d02fedd59ffbe5bf333a73737d5b9ed";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzFieldsEntryScreen",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-HTML-SECTION PZFIELDSENTRYSCREEN #20200521T222404.893 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-HTML-SECTION PZFIELDSENTRYSCREEN #20200521T222404.893 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-HTML-SECTION PZFIELDSENTRYSCREEN #20200521T222404.893 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZFIELDSENTRYSCREEN", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZFIELDSENTRYSCREEN","Rule-HTML-Section","RULE-HTML-SECTION",false,"","Pega-ProcessArchitect","08-05-01","RULE-HTML-SECTION RULE-HTML-SECTION PZFIELDSENTRYSCREEN #20200521T222404.893 GMT","!PZFIELDSENTRYSCREEN",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2004810474), 
...
//	RULE-HTML-SECTION RULE-HTML-SECTION PZFIELDSENTRYSCREEN #20200521T222404.893 GMT:20200624T141602.864 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "40799b8c264622f5f3cc79c66bbe9adf";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzFieldsEntryScreen",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzFieldsEntryScreen','insKey':'RULE-HTML-SECTION RULE-HTML-SECTION PZFIELDSENTRYSCREEN #20200521T222404.893 GMT','sectionType':'standard'}");
pzLayout_8();
pzLayout_10();
pzLayout_12();
...
config.put("pyActivity", "pzSwitchBackToAutomaticMode");
pega.getUIEngine().getUIAction("refresh", config).register();
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
config.put("pyActivity", "pzSetSectionEditable");
config.put("StaticActivityParams", "IsAutoSourced=false&IsFormReadOnly=false");
pega.getUIEngine().getUIAction("refresh", config).register();
pega.getUIEngine().getUIAction("refresh", null).register();
pega.getUIEngine().getUIAction("refresh", null).register();
pega.getUIEngine().getUIAction("refresh", null).register();
...
config.put("pyActivity", "pzAppendNewField");
config.put("DeferLoadActivity", "");
pega.getUIEngine().getUIAction("refresh", config).register();
pega.getUIEngine().getUIAction("nonTemplateGridActions", null).register();
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
config.put("pyPreDataTransform.pyName", "pzUpdateFieldEditability");
config.put("reloadType", "multipleSections");
config.put("pyActivity", "");
config.put("DeferLoadActivity", "");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("pyPreDataTransform.pyName", "pzAddNewFieldToDataModel");
config.put("Mode", "TopLevel");
config.put("pzDataTransformStaticParams", "Mode");
pega.getUIEngine().getUIAction("runDataTransform", config).register();
config = new HashMap<String, String>();
config.put("ActionSection", "pyOverlayTemplate");
config.put("NewTaskStatus", "pzAddField");
...
public void repeatingDataCell_6() {
	...
	tools.appendString("'  ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("SUB_SECTION","pzFieldsEntryRow", ".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString(" class='");
	...
	tools.appendString("height:45px;");if(Integer.parseInt(tools.getSaveValue("rowsDisplayed")) == 1) {tools.appendString("width:"); if(!tools.getParamValueCSF("PpyEmbeddedFields1colWidthCache1").equals("")) { tools.appendParamCSF("PpyEmbeddedFields1colWidthCache1");} else { tools.appendString("auto;"); }}tools.appendString(""); tools.appendString("'>");
	...
	tools.putParamValue("AllowComplexTypes","false");
...
public void repeatingDataCell_5() {
	...
	String strFieldValue = "";
		tools.appendString("<td title='");
		tools.appendString("'    ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("2014110411534009431134") + " ");
		 tools.appendString(' ' + pzCell.getInspectorData("Label",null, null, ".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(1)")); tools.appendString(" class='");
		tools.appendString(" gridCell");tools.appendString(" ");tools.appendString("  ");tools.appendString("' pyCellType = 'static' ");
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("height:21px;");tools.appendString("width:"); if(!tools.getParamValueCSF("PpyEmbeddedFields1colWidthCache1").equals("")) { tools.appendParamCSF("PpyEmbeddedFields1colWidthCache1");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldsEntryScreenBBBBBBBBBB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpzFieldsEntryScreenBBBBBBBBBB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pyEmbeddedFieldsL79=null;

 Map selUniqMap_pyEmbeddedFieldsL79 = null;
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyEmbeddedFields");tools.appendString("_pzFieldsEntryScreen_1'");
...
tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201702271256390288629") + " ");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pyEmbeddedFields");
					...
					tools.appendString("' gPropIndex='PpyEmbeddedFields1' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201702271256390288629-layout") + " ");

					tools.appendString(" class='gridTable ");

					tools.appendString(pzSection.getRepeatStyle());String strSummary = "pyEmbeddedFields";
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpyEmbeddedFields1colWidthGBL\" id=\"PpyEmbeddedFields1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyEmbeddedFields1colWidthGBL"));tools.appendString("\" />");

					
						 tools.putParamValue("expandRL","false"); 

					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpyEmbeddedFields1colWidthGBR\" id=\"PpyEmbeddedFields1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyEmbeddedFields1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpyEmbeddedFields1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='pyEmbeddedFields' PL_PROP='");

					
tools.appendString(".pyEmbeddedFields");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pyEmbeddedFields").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pyEmbeddedFields\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals(".pyEmbeddedFields")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodes.pyEmbeddedFields1") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 

					if (tempTestID != null && !tempTestID.isEmpty() && !tempTestID.equals("")){

					String strEntryHandlePLProp = "";

					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle(".pyEmbeddedFields"); } catch (Exception ex) { }
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201702271256390288629-" + rowTestID) + " ");
 ...
 tempNoRespg.removeFromClipboard();
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pyEmbeddedFields1") && tools.getParamValue("partialRefresh").equals("false")) {
...
public int simpleLayoutCell_14( int index) {
	...
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing remove-right-spacing remove-bottom-spacing   '  STRING_TYPE='layout' RESERVE_SPACE='false'><div class='content-inner '>");
	
pxIsNonTemplateStream = true;
if(( pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_54")) ){pzLayout_11();
}
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldsEntryScreenBBBBBBBBB","",false);
}
...
public void simpleLayout_8() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805240314160317946") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(3)'}") + " class='" + " content  layout-content-simple_list content-simple_list  clearfix" + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzFieldsEntryScreenBBBBBBBBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rx.pyIsContentAutomaticallySourced cttrue", pxUniqueStreamHash+"_57");metadataPage.put("lMode","Inline-block");
...
if(pzAuto.handleEvaluateWhen(" o2== rx.pyIsContentAutomaticallySourced cttrue",".pyIsContentAutomaticallySourced = true", "layout", "visible" )) {pzSetExpandParam_11();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_50")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzFieldsEntryScreen_"+ referenceString+ "_269'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("202005151159180266596") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
	...
	actionRequestD.registerFixedParameter("pyModelName","pzAddNewFieldToDataModel");
		String usingPageString = "";
		usingPageString = pzAuto.getUIComponentRuntime().generateActionTokenForPage();
		tools.appendString("[\"runDataTransform\", [\"pzAddNewFieldToDataModel\", \"ClassName=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyClassName")+"~#");		tools.appendString("&Mode=TopLevel");
		actionRequestD.registerFixedParameter("Mode","TopLevel");
		...
		pzPackageRuntime.packageDataTransform(contextClass, "pzAddNewFieldToDataModel");
		}
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }			{
				...
				keyMap.putString("pyActionName", "pzAddField");
				String strLAClassName = "";
				String offlineUsingPage = "pyTempManageDataModel";
				strLAClassName = "Pega-DataModel-Manage";
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
				try{
				pzPackageRuntime.packageLocalAction("pzAddField", offlineUsingPage , strLAClassName);
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						pzPackageRuntime.packageSection("pzFieldsEntryScreen",
						...
						String usingPage = "pyTempManageDataModel";
						if(("").equals(usingPage)) { usingPage = tools.getStepPage().getReference(); }
						if("true".equals(bHasPrivilege )) {
							tools.appendString("[\"processAction\", [\"pzAddField\",\"overlay\",\":event\",\"pyTempManageDataModel\",\""+streamType+"\",\"\",\"pzModalTemplate\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-null%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22effect%22%3A%22anim-null%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"true\",\"\",\"\"]");
							} else {
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Add field",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
throw new RuntimeException("Problem in JSP fragment", t);
	 ...
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("SUB_SECTION","pzFieldsEntryRow", ".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString(" class='");
	tools.appendString(" gridCell");tools.appendString("  ");tools.appendString(" ' NAME='BASE_REF' BASE_REF='" + tools.getStepPage().getReference() + "' style='");
	tools.appendString("height:45px;");if(Integer.parseInt(tools.getSaveValue("rowsDisplayed")) == 1) {tools.appendString("width:"); if(!tools.getParamValueCSF("PpyEmbeddedFields1colWidthCache1").equals("")) { tools.appendParamCSF("PpyEmbeddedFields1colWidthCache1");} else { tools.appendString("auto;"); }}tools.appendString(""); tools.appendString("'>");
	if(tools.getIfPresent("pyRowStatus") != null){ tools.appendProperty(tools.getProperty(".pyRowStatus"),"Messages",false); }
	generateClientWhenDiv_1();
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("height:35px;");tools.appendString("width:"); if(!tools.getParamValueCSF("PpyEmbeddedFields1colWidthCache1").equals("")) { tools.appendParamCSF("PpyEmbeddedFields1colWidthCache1");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldsEntryScreenBBBBBBBB","",false);
}
...
String gridLayoutMethodName = tools.getParamValue("gridLayoutMethodName");
String expandParameter = "EXPANDEDSubSectionpzFieldsEntryScreenBBBBBBBB";
tools.appendString("PARAM_NAME=\"" + expandParameter);
if(!gridLayoutMethodName.equals("")){
tools.appendString("~" + gridLayoutMethodName);
}
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pyEmbeddedFieldsL74=null;

 Map selUniqMap_pyEmbeddedFieldsL74 = null;
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyEmbeddedFields");tools.appendString("_pzFieldsEntryScreen_1'");
tools.appendString(" bRowHovering='false' deferLoadAct='' class=\"");
tools.appendString("repeatContainer gridDefault    ");if(tools.hasInputEnabled()){tools.appendString("readOnlyGrid ");}tools.appendString("");
if(pzAuto.isMobile()) { tools.appendString(" grid-mobile "); }tools.appendString("\" id='PEGA_GRID' ");
tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201702271256390285881") + " ");
tools.appendString("bEditable='");tools.appendString(tools.getSaveValue("bEditable"));tools.appendString("'");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201702271256390285881-layout") + " ");
...
tools.appendString(".pyEmbeddedFields");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201702271256390285881-" + rowTestID) + " ");
...
tools.putParamValue("pyCallStreamMethod","");}
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= rx.pyIsContentAutomaticallySourced cttrue",".pyIsContentAutomaticallySourced != true", "layout", "visible" )) {pzSetExpandParam_10();
tools.putParamValue("RWClasses","");
...
public int simpleLayoutCell_13( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= rx.pyIsContentAutomaticallySourced cttrue",".pyIsContentAutomaticallySourced != true","cell", "visible" )) {
		return index;
	}
	generateClientWhenDiv_2();
...
pxIsNonTemplateStream = true;
if(( pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_49")) ){pzLayout_9();
}
pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
...
public int simpleLayoutTemplateCell_13( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pyIsContentAutomaticallySourced cttrue",pxUniqueStreamHash+"_52");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_52");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyIsContentAutomaticallySourced != true");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pyIsContentAutomaticallySourced cttrue", pxUniqueStreamHash+"_52"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldsEntryScreenBBBBBBB","",false);
}
...
public void simpleLayout_7() {
	...
	refreshAttributes +="\""; 
	refreshAttributes += " RWP=\".pxResultCount\" RW=\"pyTempManageDataModel.pxResultCount Changes\" ";
	String strRWPreActivity = "";
	strRWPreActivity = "pzAppendNewField,";
	
	refreshAttributes += " RWA=\""+strRWPreActivity+"\" ";
	...
	try{
		if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
			...
			changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking("pyTempManageDataModel.pxResultCount"), -1);
		}
	}catch(Exception e){}
	IUIComponent cc_dl = null;
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202005151510330164185") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		...
		try{
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  "pyTempManageDataModel.pxResultCount Changes", expressionId);
		expressionId = expression.getId();
		expression.addActivity("refreshWhen", "pzAppendNewField", null, null);
		}
	...
	String paramName = "EXPANDEDSubSectionpzFieldsEntryScreenBBBBBBB";
...
public void buildSection_4() { 
	...
	secParams.put("MoreInformationContentID","5046");
	secParams.put("HelpContentID","5045");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_44","pxHelpSnippetGadget", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	tools.putParamValue("MoreInformationContentID","5046");tools.putParamValue("HelpContentID","5045");
	...
	String sectionName = "pxHelpSnippetGadget"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzFieldsEntryScreen884","",false);
}
...
public void buildSection_3() { 
	...
	secParams.put("HelpContentID","5045");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_41","pxHelpSnippetGadget", secInfo);
}
...
public int simpleLayoutCell_11( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pxHelpSnippetGadget",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_11( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pxHelpSnippetGadget",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldsEntryScreenBBBBBB","",false);
}
...
public void simpleLayout_5() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805240314160316132") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-simple_list content-simple_list " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzFieldsEntryScreenBBBBBB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("sectionIndex","247");
	IUIComponent containerComponent = pzAuto.getUIComponent();
...
public void buildSection_2() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_34","pzConfigureFieldsBreadcrumb", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzConfigureFieldsBreadcrumb"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpzFieldsEntryScreen722","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_31","pzConfigureFieldsBreadcrumb", secInfo);
}
...
public int simpleLayoutCell_8( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzConfigureFieldsBreadcrumb",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzConfigureFieldsBreadcrumb",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldsEntryScreenBBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805240314160316173") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + " class='" + "flex  content  layout-content-inline content-inline " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzFieldsEntryScreenBBBBB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("sectionIndex","244");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzIsEmbeddedView", pxUniqueStreamHash+"_35");metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzIsEmbeddedView","pzIsEmbeddedView", "layout", "visible" )) {pzSetExpandParam_5();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
tools.appendString("<div class='layout layout-noheader layout-noheader-modal_header'>");
 String clsScroll= "";tools.appendString("<div section_index='1' class='" + clsScroll + " layout-body clearfix'>");
tools.putParamValue("LAYOUT_METHOD_NAME","simpleLayout_2");simpleLayout_2();
tools.appendString("</div></div>");
tools.putSaveValue("rowClass","");
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				refreshActionRequest.registerFixedParameter("StreamList", "pzSectionEditingView|Rule-HTML-Section|:");
				staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
				staticURLStr.append("&PreActivity=pzSetSectionEditable");
				tools.appendString("[\"refresh\", [\"otherSection\",\"pzSectionEditingView\", \"pzSetSectionEditable\", \"");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"IsAutoSourced\":\"false\"");
				refreshActionRequestD.registerFixedParameter("IsAutoSourced","false");
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"IsFormReadOnly\":\"false\"");
				refreshActionRequestD.registerFixedParameter("IsFormReadOnly","false");
				tools.appendString("\", \"\", \",");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
				tools.appendString("\",\":event\",\"\",[\"");
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20151020174944040536765",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzFieldsEntryScreen_$CTX$_243");
		String repeatIndx = "";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","pzEditConfigureView\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("pzEditConfigureView", ".pyButtonLabel");
	}
	pyLabel = "pzEditConfigureView";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzFieldsEntryScreen_"+ referenceString+ "_243'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20151020174944040536765") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","pzEditConfigureView",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
try {
	...
	cellPage.put("pyStreamName","pzFieldsEntryScreen");
	cellPage.put("pyCellID","241");
	...
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","pyViewIsDynamicallySourced\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("pyViewIsDynamicallySourced", ".pyActionPrompt");
	}
	pyTooltip = "pyViewIsDynamicallySourced";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("201511161744510622129570") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzFieldsEntryScreen_"+ referenceString+ "_241'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","pyViewIsDynamicallySourced\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
		String alttempText = tools.getLocalizedTextForString(".pyActionPrompt","pyViewIsDynamicallySourced\t" + repeatIndx ,StreamBuilder.FMT_LITERAL);
		String classProp = "";
		 classProp ="pi pi-refresh";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("201511161744510622129570") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201511161744510622129570-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxIcon_1();labelName = "";
...
public int simpleLayoutCell_5( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-bottom-spacing   ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("20151021120619039120235")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","pyEditViewManually") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("partialClass","remove-bottom-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20151021120619039120235")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	labelName = "pyEditViewManually";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_6( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-bottom-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20151020174944040536765-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_2();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldsEntryScreenBBBB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805240314160315193") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-inline_middle content-inline_middle switch-to-auto" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","switch-to-auto");
		pg_dlmeta.put("class","set-width-auto");
	...
	String paramName = "EXPANDEDSubSectionpzFieldsEntryScreenBBBB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("prefix","-modal_header");
	metadataPage.put("sectionIndex","239");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& wxpzIsCurrentSectionAnAutoConfigureSection o2== rx.pyIsContentAutomaticallySourced cttrue", pxUniqueStreamHash+"_27");metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& wxpzIsCurrentSectionAnAutoConfigureSection o2== rx.pyIsContentAutomaticallySourced cttrue","pzIsCurrentSectionAnAutoConfigureSection && .pyIsContentAutomaticallySourced = true", "layout", "visible" )) {pzSetExpandParam_4();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				refreshActionRequest.registerFixedParameter("StreamList", "pzSectionEditingView|Rule-HTML-Section|:");
				staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
				staticURLStr.append("&PreActivity=pzSwitchBackToAutomaticMode");
				tools.appendString("[\"refresh\", [\"otherSection\",\"pzSectionEditingView\", \"pzSwitchBackToAutomaticMode\", \"");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
				tools.appendString("=\", \"\", \",");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
				tools.appendString("\",\":event\",\"\",[\"");
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20151021121125091943510",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzFieldsEntryScreen_$CTX$_238");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","pzConfigureReviewRestore\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("pzConfigureReviewRestore", ".pyButtonLabel");
	}
	pyLabel = "pzConfigureReviewRestore";
	modePage2.put("pyLabel",pyLabel);
	modePage2.put("captionType","text");
	if(expressionId !=null && expressionId.length() > 0){
	modePage2.put("pyExpressionId",expressionId);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzFieldsEntryScreen_"+ referenceString+ "_238'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20151021121125091943510") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","pzConfigureReviewRestore",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString("</a>");					}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-bottom-spacing   ");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","pzReviewConfigureViewInstructions") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	labelName = "pzReviewConfigureViewInstructions";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-bottom-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20151021121125091943510-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxLink");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldsEntryScreenBBB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805240314160315869") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-inline_middle content-inline_middle switch-to-auto" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzFieldsEntryScreenBBB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("prefix","-modal_header");
	metadataPage.put("sectionIndex","235");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& wxpzIsCurrentSectionAnAutoConfigureSection o2!= rx.pyIsContentAutomaticallySourced cqtrue", pxUniqueStreamHash+"_13");metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& wxpzIsCurrentSectionAnAutoConfigureSection o2!= rx.pyIsContentAutomaticallySourced cqtrue","pzIsCurrentSectionAnAutoConfigureSection && .pyIsContentAutomaticallySourced != \'true\'", "layout", "visible" )) {pzSetExpandParam_3();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public int simpleLayoutCell_3( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& wxpzIsCurrentSectionAnAutoConfigureSection o2!= rx.pyIsContentAutomaticallySourced cqtrue","pzIsCurrentSectionAnAutoConfigureSection && .pyIsContentAutomaticallySourced != \'true\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_2();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing float-left set-width-auto   flex flex-row '  STRING_TYPE='layout' RESERVE_SPACE='false'>");
	pzLayout_1();
 tools.putSaveValue("ContainerID", "");tools.appendString("</div>");
	index++;
	return index;
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxpzIsCurrentSectionAnAutoConfigureSection o2!= rx.pyIsContentAutomaticallySourced cqtrue",pxUniqueStreamHash+"_15");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_15");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzIsCurrentSectionAnAutoConfigureSection && .pyIsContentAutomaticallySourced != 'true'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-HTML-Section");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_15");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxpzIsCurrentSectionAnAutoConfigureSection o2!= rx.pyIsContentAutomaticallySourced cqtrue", pxUniqueStreamHash+"_15"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_1();
 tools.putSaveValue("ContainerID", "");}
...
public int simpleLayoutCell_7( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& wxpzIsCurrentSectionAnAutoConfigureSection o2== rx.pyIsContentAutomaticallySourced cttrue","pzIsCurrentSectionAnAutoConfigureSection && .pyIsContentAutomaticallySourced = true","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_2();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing float-left set-width-auto   flex flex-row '  STRING_TYPE='layout' RESERVE_SPACE='false'>");
	pzLayout_2();
 tools.putSaveValue("ContainerID", "");tools.appendString("</div>");
	index++;
	return index;
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	pgCells.put("pyType","layout");
	pgCells.put("RWActive","false");
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing set-width-auto flex flex-row");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxpzIsCurrentSectionAnAutoConfigureSection o2== rx.pyIsContentAutomaticallySourced cttrue",pxUniqueStreamHash+"_29");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxpzIsCurrentSectionAnAutoConfigureSection o2== rx.pyIsContentAutomaticallySourced cttrue", pxUniqueStreamHash+"_29"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_2();
 tools.putSaveValue("ContainerID", "");}
...
public int simpleLayoutCell_9( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpzIsEmbeddedView","pzIsEmbeddedView","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_2();
...
public int simpleLayoutTemplateCell_9( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzIsEmbeddedView",pxUniqueStreamHash+"_37");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_37");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzIsEmbeddedView");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-HTML-Section");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_37");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzIsEmbeddedView", pxUniqueStreamHash+"_37"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_4();
 tools.putSaveValue("ContainerID", "");}
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldsEntryScreenBB","",false);
}
...
public void simpleLayout_4() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805240314160314536") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  auto-width-column layout-content-simple_list content-simple_list " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzFieldsEntryScreenBB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("sectionIndex","233");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
...
pzSection.getLayout().setExpandParam("SubSectionpzFieldsEntryScreenB","",false);
}
...
public void simpleLayout_6() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805240314160199603") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-inline content-inline flex-nowrap" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzFieldsEntryScreenB";
	metadataPage.put("paramName", paramName);
...
if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_3")){pzLayoutBodyWrapper_3();
}pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
tools.putSaveValue("rowClass","");
}
...
public void pzFieldsEntryRow_1() {
pzAuto.emitIncludeStreamReference("pzFieldsEntryRow", null, !tools.hasInputEnabled()?"NoInput":"Input", "Rule-HTML-Section", null);
}
...
String strDTransform = "";
strDTransform = "pzUpdateFieldEditability";
if(currentTemplatingStatus =='N'){

}
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pyDataPageName\" RW=\".pyDataPageName Changes\" PDT=\"");
tools.appendString("pzUpdateFieldEditability");
tools.appendString("\" ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyDataPageName"), -1);
	}
}catch(Exception e){}
}
...
public void pyEmbeddedFields_1() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyEmbeddedFields1")|| tools.getParamValue("partialTrigger").equals("editRow.pyEmbeddedFields1") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pyEmbeddedFields");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pyEmbeddedFields\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pyEmbeddedFields1")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty(".pyEmbeddedFields");
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyEmbeddedFields1") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-HTML-SECTION PZFIELDSENTRYSCREEN #20200521T222404.893 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzFieldsEntryScreen");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-HTML-SECTION PZFIELDSENTRYSCREEN #20200521T222404.893 GMT", "Rule-HTML-Section pzFieldsEntryScreen", "Pega-ProcessArchitect", "08-05-01", "20200624T141602.864 GMT");
}
