...
/**
 * Builds JSP stream DATA-PORTAL!PORTALNAVIGATION.
 */
public class ra_stream_portalnavigation_7d04e3a37de11ce6dd37a1c2610489be extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.PortalNavigation.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1466598812;
 ...
 */
	public ra_stream_portalnavigation_7d04e3a37de11ce6dd37a1c2610489be(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "6f1409bdb3d78ab28a506bb47499f7ceed4dd5d3";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PORTALNAVIGATION #20210506T204027.659 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "6f1409bdb3d78ab28a506bb47499f7ceed4dd5d3";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("PortalNavigation",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PORTALNAVIGATION #20210506T204027.659 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PORTALNAVIGATION #20210506T204027.659 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PORTALNAVIGATION #20210506T204027.659 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PORTALNAVIGATION", 
	"Rule-HTML-Section:PZPORTALNAVIGATION", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PORTALNAVIGATION","Rule-HTML-Section","DATA-PORTAL",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION DATA-PORTAL PORTALNAVIGATION #20210506T204027.659 GMT","!PORTALNAVIGATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1466598812), 
		new DependentRuleInfo("PZPORTALNAVIGATION","Rule-HTML-Section","DATA-PORTAL",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION DATA-PORTAL PZPORTALNAVIGATION #20210506T204030.752 GMT","!PZPORTALNAVIGATION",false,false,"MISSING",1742514509), 
		new DependentRuleInfo("PYUSERNAME","Rule-Obj-Property","@BASECLASS",true,"Data-Portal","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYUSERNAME #20180713T131156.594 GMT","!PYUSERNAME",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION DATA-PORTAL PORTALNAVIGATION #20210506T204027.659 GMT:20220502T142227.722 GMT
//	RULE-HTML-SECTION DATA-PORTAL PZPORTALNAVIGATION #20210506T204030.752 GMT:20230608T090135.168 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "4f16dcfa04b8f07007743ac93c8676d4";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("PortalNavigation",1,"Rule-HTML-Section","{'type':'Section','ruleName':'PortalNavigation','insKey':'RULE-HTML-SECTION DATA-PORTAL PORTALNAVIGATION #20210506T204027.659 GMT','templated':'true','sectionType':'standard'}");
pzLayout_3();
pzLayout_11();
pzLayout_12();
pzLayout_13();
...
public void buildSection_14() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_59","pyAppLauncher", secInfo);
}
...
public void includeSectionBody_4() { 
	...
	String includedSectionName = "";includedSectionName = "pyAppLauncher";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_15() {
pzSection.getLayout().setExpandParam("SubSectionPortalNavigationBBBBBBBBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionPortalNavigationBBBBBBBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(6)','clipboardPath':'pyAppLauncher'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(6)','clipboardPath':'pyAppLauncher'}") + ">");
}
pzSetExpandParam_15();
...
public void buildSection_13() { 
	Map<String, Object> secInfo = new HashMap<String, Object>();
	secInfo.put("usingPage","D_NotificationTemp");
	secInfo.put("isUsingPagePropertyRef",false);
	secInfo.put("doNotConsiderDecParams",false);
	secInfo.put("keepStreamProperties",false);
	secInfo.put("preserveParamState",false);
	...
	secParams.put("skipCounterReset","\"true\"");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_58","pyDisplayNotificationGadgetDetails", secInfo);
}
...
public void includeSectionBody_3() { 
	...
	String strSectionPageProp = "";
	tools.putParamValue("pyCategoryList","Default");tools.putParamValue("skipCounterReset","true");if(tools.getIfPresent("OperatorID.pyUserIdentifier") != null){tools.putParamValue("recipientOperatorID",tools.getIfPresent("OperatorID.pyUserIdentifier").getStringValue());}else{tools.putParamValue("recipientOperatorID","OperatorID.pyUserIdentifier");}
	...
	{tools.putParamValue("decParamList","{}");tools.putParamValue("sectionPageNameBase","D_NotificationTemp");}
	String includedSectionName = "";includedSectionName = "pyDisplayNotificationGadgetDetails";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"D_NotificationTemp",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_14() {
pzSection.getLayout().setExpandParam("SubSectionPortalNavigationBBBBBBBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionPortalNavigationBBBBBBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(5)','clipboardPath':'pyDisplayNotificationGadgetDetails'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(5)','clipboardPath':'pyDisplayNotificationGadgetDetails'}") + ">");
}
pzSetExpandParam_14();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_12() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_57","pyDisplayRecents", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "pyDisplayRecents";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_13() {
pzSection.getLayout().setExpandParam("SubSectionPortalNavigationBBBBBBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionPortalNavigationBBBBBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(4)','clipboardPath':'pyDisplayRecents'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(4)','clipboardPath':'pyDisplayRecents'}") + ">");
}
pzSetExpandParam_13();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_11() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_56","UserHeaderInc", secInfo);
}
...
config.put("navName", "pyCreateCaseMenu");
pega.getUIEngine().getUIAction("showMenu", config).register();
config = new HashMap<String, String>();
config.put("navName", "MainNavigation");
pega.getUIEngine().getUIAction("showMenu", config).register();
pega.getUIEngine().getUIAction("refresh", null).register();
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("navName", "FixedNavigation");
pega.getUIEngine().getUIAction("showMenu", config).register();
pega.getUIEngine().getUIAction("refresh", null).register();
pega.getUIEngine().getUIAction("refresh", null).register();
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("navName", "OperatorMenu");
pega.getUIEngine().getUIAction("showMenu", config).register();
config = new HashMap<String, String>();
config.put("navName", "OperatorMenu");
pega.getUIEngine().getUIAction("showMenu", config).register();
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "UserHeaderInc";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_12() {
pzSection.getLayout().setExpandParam("SubSectionPortalNavigationBBBBBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionPortalNavigationBBBBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(3)','clipboardPath':'UserHeaderInc'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(3)','clipboardPath':'UserHeaderInc'}") + ">");
}
pzSetExpandParam_12();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
tools.appendString("</P>");
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("20190128160146073932497") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	...
	String repeatIndx = "";
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20190128160146073932497",true));
	String pyValueR = "";
	String pyValueOrig = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty("OperatorID.pyUserName");
	pyValueR = "OperatorID.pyUserName";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty("OperatorID.pyUserName");
	pyValueOrig = "OperatorID.pyUserName";
...
if (_jspx_meth_pega_param__1(pageContext, "ShowMiniProfile", "0")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "width", "30")) {
	return true;
}
if (_jspx_meth_pega_param__2(pageContext, "OperatorID", "OperatorID.pyUserIdentifier")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "height", "30")) {
	return true;
}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	tools.appendString("[\"showMenu\",[{\"dataSource\":\"OperatorMenu\", \"isNavNLDeferLoaded\":\"false\", \"isNavTypeCustom\":\"false\", \"className\":\"" + tools.getStepPage().getClassName());
	...
	tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771834610946");
	if(pzAuto.isOffline() || false) {
	try{
	pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771834610946","", false, false, false, false);
	...
	tools.appendString("\"},\":event\"]");
		...
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }	if(pega_uiengine_pznavigation.pzUseNewMenu() && true) {
	  IActionRequest actionRequest = pzAuto.getActionRequest();
	  actionRequest.registerFixedParameter("pyActivity", "pzGetMenu");
	  pzAuto.registerActionRequest(actionRequest);
	}
	...
	tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771834610947");
	if(pzAuto.isOffline() || false) {
	try{
	pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771834610947","", false, false, false, false);
	}catch(Exception e){oLog.error(e);}
	}
	tools.appendString("\"},\":event\"]");
...
public int simpleLayoutCell_11( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxOperatorImage",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing remove-top-spacing remove-left-spacing    " + pzSection.getCustomStyle(false, "","image-wrapper","image-wrapper")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_42")) {	field_pxOperatorImage_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_11( int index) {
	...
	pgCells.put("partialClass","remove-bottom-spacing remove-right-spacing remove-top-spacing remove-left-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2019012815340903894081-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pgCells.put("customROStyles","image-wrapper");
	pgCells.put("customRWStyles","image-wrapper");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxOperatorImage",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_45")) {	field_pxOperatorImage_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
public int simpleLayoutCell_12( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput","OperatorID.pyUserName",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing   text-color-inherit text-bold dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxTextInput_1("OperatorID.pyUserName",0,"","","Text");
...
public int simpleLayoutTemplateCell_12( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20190128160146073932497-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("forLabel","OperatorID.pyUserName");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","text-color-inherit text-bold");
	pgCells.put("customRWStyles","text-color-inherit text-bold");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextInput","OperatorID.pyUserName",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxTextInput_1("OperatorID.pyUserName",0,"","","Text");labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionPortalNavigationBBBBBB","",false);
}
...
pzStatic_ControlMenu.emitContent();
	...
	spxUniqueStreamHash41 = getUIActionsMetaData_2();
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201901281552550130778") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1)'}") + " class='" + "flex  content  pointer has-action layout-content-inline_middle content-inline_middle operator-avatar" + "'  " + "role='button' tabindex='0' " + " aria-label = '"+tools.getLocalizedTextForString(".pyCaption", StringUtils.escapeCrossScriptingFilter("Operator Menu"))+"'" );
		...
		tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771834610948");
		if(pzAuto.isOffline() || false) {
		try{
		pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771834610948","", false, false, false, false);
		}catch(Exception e){oLog.error(e);}
		}
		tools.appendString("\"},\":event\"]");
		...
		tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771834610949");
		if(pzAuto.isOffline() || false) {
		try{
		pega_uiengine_pzcontrol.pzGetMenu("OperatorMenu", "", "pyNavigation1771834610949","", false, false, false, false);
		}catch(Exception e){oLog.error(e);}
		}
		tools.appendString("\"},\":event\"]");
		...
		pg_dlmeta.put("customClassName","operator-avatar");
		pg_dlmeta.put("class","pointer has-action");
		pg_dlmeta.put("format","inline_middle");
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1)'}") + "").append("\"").toString();
		if(!inspectorData.equals("\"\"")) {
		pg_dlmeta.put("liveUI",inspectorData);
		}
		pg_dlmeta.put("ariaRole","button");
		pg_dlmeta.put("ariaLabel",""+tools.getLocalizedTextForString(".pyCaption", StringUtils.escapeCrossScriptingFilter("Operator Menu")));
		...
		cc_dl.addAdditionalBundles("ControlMenu","pzPega_control_menu_scripts");
		cc_dl.addAdditionalFragment("MenuBarOld","pzMenuBarInclude");
		}
		int index = 1;
		if(currentTemplatingStatus != 'Y') {
	...
	String paramName = "EXPANDEDSubSectionPortalNavigationBBBBBB";
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1)'}");
	if(!inspectorLayoutData.isEmpty()) {
	metadataPage.put("liveUI", inspectorLayoutData);
	}
	String pyPrefix = null;
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= rxpyPortal.pyShowAppHeaderBar cqtrue", pxUniqueStreamHash+"_51");metadataPage.put("dlChild","true");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= rxpyPortal.pyShowAppHeaderBar cqtrue","pyPortal.pyShowAppHeaderBar != \'true\'", "layout", "visible" )) {pzSetExpandParam_11();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_10() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_40","pzNotificationGadget", secInfo);
}
...
public void sectionBodyIncludeInCell_10() { 
	...
	String sectionName = "pzNotificationGadget"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellPortalNavigation577","",false);
}
...
public void buildSection_9() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_37","pzNotificationGadget", secInfo);
}
...
String uniqueMenuId = "";
uniqueMenuId = "DataPortalFixedNavigation14";
{
  IActionRequest actionRequest = pzAuto.getActionRequest();
  actionRequest.registerFixedParameter("pyActivity", "pzGetMenu");
...
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("PortalNavigation",
		...
		modePage.put("styleOther","menu-format-fixed-navigation");
		modePage.put("nav","FixedNavigation");
		modePage.put("pyUniqueMenuID",uniqueMenuId);
		modePage.put("navPage",navPageName);
		String navPageRef = pxUniqueStreamHash+"_34";
		...
		if(pzAuto.isOffline()) {
		pega_uiengine_pzcontrol.pzGetMenu("FixedNavigation", "", navPageName,"", true , false,  (pzAuto.isOffline() ? false :false), true);
		} else {
		...
		options.put(com.pega.pegarules.priv.runtime.IControlRuntime.B_IS_REMOVE_NAV_PAGE, true);
			pzAuto.getControl().executeNavRule("FixedNavigation", navPageName, "", navPageRef, options);
		}
			cc.endComponent();
		} else {
			pega_uiengine_pzcontrol.pzGetMenu("FixedNavigation", "", navPageName,"", true , false,  (pzAuto.isOffline() ? false :false), true);
...
pzStatic_ControlMenu.emitContent();
			...
			tools.appendString("<div id='div-menu-" + uniqueTS + "' style='display:none;'></div><script type=\"text/javascript\">pega.control.menu.pxMenuManager.schedule(\"menu-" + uniqueTS + "\", {\"type\": \"vertical\", \"format\": \"menu-format-fixed-navigation\", \"menuID\": \"menu-" + uniqueTS + "\", \"navName\": \"FixedNavigation\", \"navPage\": \"" + navPageName + "\", \"navUID\": \"FixedNavigation_14\", \"isMobile\": \"" + pzAuto.isMobile() + "\", \"usingPage\": \"" + tools.getStepPage().getReference() + "\"");
			if(!pzAuto.isOffline() && false) {
...
public void pxMenu_3() {boolean isDisplayTextWithParam = false;
String displayTextParamName = "";
String displayTextParamValue = "";
...
pzSection.getLayout().setExpandParam("SubSectionPortalNavigationBBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201808131910220992111") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)','region':'MISC'}") + " class='" + "flex  content  layout-content-stacked_with_labels_left content-stacked_with_labels_left nav-extra-actions" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","nav-extra-actions");
		pg_dlmeta.put("format","stacked_with_labels_left");
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)','region':'MISC'}") + "").append("\"").toString();
		if(!inspectorData.equals("\"\"")) {
		pg_dlmeta.put("liveUI",inspectorData);
		}
		pg_dlmeta.put("isDLChild","true");
	...
	String paramName = "EXPANDEDSubSectionPortalNavigationBBBBB";
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)','region':'MISC'}");
	if(!inspectorLayoutData.isEmpty()) {
	metadataPage.put("liveUI", inspectorLayoutData);
	}
	String pyPrefix = null;
...
public int simpleLayoutCell_9( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxMenu",".pyTemplateGeneric",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxMenu_3();
	tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_9( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20190701121900064058794-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxMenu",".pyTemplateGeneric",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxMenu_3();labelName = "Menu";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_10( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzNotificationGadget",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_10( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzNotificationGadget",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
public int simpleLayoutCell_13( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= rxpyPortal.pyShowAppHeaderBar cqtrue","pyPortal.pyShowAppHeaderBar != \'true\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_13( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rxpyPortal.pyShowAppHeaderBar cqtrue",pxUniqueStreamHash+"_53");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_53");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pyPortal.pyShowAppHeaderBar != 'true'");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rxpyPortal.pyShowAppHeaderBar cqtrue", pxUniqueStreamHash+"_53"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionPortalNavigationBBBB","",false);
}
...
public void simpleLayout_5() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201901281534090388410") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1)'}") + " class='" + "flex  content  layout-content-simple_list content-simple_list user-menu" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","user-menu");
		pg_dlmeta.put("format","simple_list");
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1)'}") + "").append("\"").toString();
		if(!inspectorData.equals("\"\"")) {
		pg_dlmeta.put("liveUI",inspectorData);
		}
		pg_dlmeta.put("isDLChild","true");
	...
	String paramName = "EXPANDEDSubSectionPortalNavigationBBBB";
	...
	metadataPage.put("dlChild","true");
	metadataPage.put("lMode","SimpleDiv");
	metadataPage.put("contCustom","user-menu");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
	pzLayoutBody_5();
	containerComponent.endComponent();
	}
...
String navPageName = "pyNavigation"+uniqueTS;
String uniqueMenuId = "";
uniqueMenuId = "DataPortalMainNavigation9";
{
  IActionRequest actionRequest = pzAuto.getActionRequest();
  actionRequest.registerFixedParameter("pyActivity", "pzGetMenu");
  actionRequest.registerFixedParameter("navPageName", navPageName);
...
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		...
		IUIComponentMetadata cellPage = pzAuto.getUIComponentRuntime().createMetadata();
		IUIComponentMetadata modePage = pzAuto.getUIComponentRuntime().createMetadata();
		modePage.put("styleOther","menu-format-primary-navigation");
		modePage.put("nav","MainNavigation");
		modePage.put("pyUniqueMenuID",uniqueMenuId);
		modePage.put("navPage",navPageName);
		String navPageRef = pxUniqueStreamHash+"_25";
		modePage.put("navPageRef",navPageRef);
		modePage.put("navDefer",(pzAuto.isOffline() ? "false" : "false"));
		modePage.put("navCache","true");
		modePage.put("MenuType","vertical");
		...
		metadataPage.putMetadata("pyCell",cellPage);
			...
			cc.addDependentBundles("pzPega_control_menu_scripts");
		if(pzAuto.isOffline()) {
		pega_uiengine_pzcontrol.pzGetMenu("MainNavigation", "", navPageName,"", true , false,  (pzAuto.isOffline() ? false :false), true);
		} else {
		Map<String, Boolean> options = new HashMap<String, Boolean>();
		options.put(com.pega.pegarules.priv.runtime.IControlRuntime.B_LOCALIZE, true);
		options.put(com.pega.pegarules.priv.runtime.IControlRuntime.B_IS_GRID, false);
		options.put(com.pega.pegarules.priv.runtime.IControlRuntime.B_IS_DEFER_LOAD, false);
		options.put(com.pega.pegarules.priv.runtime.IControlRuntime.B_IS_REMOVE_NAV_PAGE, true);
			pzAuto.getControl().executeNavRule("MainNavigation", navPageName, "", navPageRef, options);
		}
			cc.endComponent();
		} else {
			pega_uiengine_pzcontrol.pzGetMenu("MainNavigation", "", navPageName,"", true , false,  (pzAuto.isOffline() ? false :false), true);
...
pzStatic_ControlMenu.emitContent();
			...
			tools.appendString("<div id='div-menu-" + uniqueTS + "' style='display:none;'></div><script type=\"text/javascript\">pega.control.menu.pxMenuManager.schedule(\"menu-" + uniqueTS + "\", {\"type\": \"vertical\", \"format\": \"menu-format-primary-navigation\", \"menuID\": \"menu-" + uniqueTS + "\", \"navName\": \"MainNavigation\", \"navPage\": \"" + navPageName + "\", \"navUID\": \"MainNavigation_9\", \"isMobile\": \"" + pzAuto.isMobile() + "\", \"usingPage\": \"" + tools.getStepPage().getReference() + "\"");
			if(!pzAuto.isOffline() && false) {
			tools.appendString(", \"deferLoad\": \"false\", \"enableCache\": \"true\"");
			}
		tools.appendString("});</script>");
...
String navPageName = "pyNavigation"+uniqueTS;
String uniqueMenuId = "";
uniqueMenuId = "DataPortalpyCreateCaseMenu8";
{
  IActionRequest actionRequest = pzAuto.getActionRequest();
  actionRequest.registerFixedParameter("pyActivity", "pzGetMenu");
  actionRequest.registerFixedParameter("navPageName", navPageName);
...
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		...
		IUIComponentMetadata cellPage = pzAuto.getUIComponentRuntime().createMetadata();
		IUIComponentMetadata modePage = pzAuto.getUIComponentRuntime().createMetadata();
		modePage.put("styleOther","menu-format-create-case-menu");
		modePage.put("nav","pyCreateCaseMenu");
		modePage.put("pyUniqueMenuID",uniqueMenuId);
		modePage.put("navPage",navPageName);
		String navPageRef = pxUniqueStreamHash+"_22";
		modePage.put("navPageRef",navPageRef);
		modePage.put("navDefer",(pzAuto.isOffline() ? "false" : "false"));
		modePage.put("navCache","true");
		modePage.put("MenuType","vertical");
		...
		metadataPage.putMetadata("pyCell",cellPage);
			...
			cc.addDependentBundles("pzPega_control_menu_scripts");
		if(pzAuto.isOffline()) {
		pega_uiengine_pzcontrol.pzGetMenu("pyCreateCaseMenu", "", navPageName,"", true , false,  (pzAuto.isOffline() ? false :false), true);
		} else {
		Map<String, Boolean> options = new HashMap<String, Boolean>();
		options.put(com.pega.pegarules.priv.runtime.IControlRuntime.B_LOCALIZE, true);
		options.put(com.pega.pegarules.priv.runtime.IControlRuntime.B_IS_GRID, false);
		options.put(com.pega.pegarules.priv.runtime.IControlRuntime.B_IS_DEFER_LOAD, false);
		options.put(com.pega.pegarules.priv.runtime.IControlRuntime.B_IS_REMOVE_NAV_PAGE, true);
			pzAuto.getControl().executeNavRule("pyCreateCaseMenu", navPageName, "", navPageRef, options);
		}
			cc.endComponent();
		} else {
			pega_uiengine_pzcontrol.pzGetMenu("pyCreateCaseMenu", "", navPageName,"", true , false,  (pzAuto.isOffline() ? false :false), true);
...
pzStatic_ControlMenu.emitContent();
			...
			tools.appendString("<div id='div-menu-" + uniqueTS + "' style='display:none;'></div><script type=\"text/javascript\">pega.control.menu.pxMenuManager.schedule(\"menu-" + uniqueTS + "\", {\"type\": \"vertical\", \"format\": \"menu-format-create-case-menu\", \"menuID\": \"menu-" + uniqueTS + "\", \"navName\": \"pyCreateCaseMenu\", \"navPage\": \"" + navPageName + "\", \"navUID\": \"pyCreateCaseMenu_8\", \"isMobile\": \"" + pzAuto.isMobile() + "\", \"usingPage\": \"" + tools.getStepPage().getReference() + "\"");
			if(!pzAuto.isOffline() && false) {
			tools.appendString(", \"deferLoad\": \"false\", \"enableCache\": \"true\"");
			}
		tools.appendString("});</script>");
...
public int simpleLayoutCell_5( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxMenu",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " data-tour-id='cm-create-case-menu' class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("tourId"," data-tour-id='cm-create-case-menu'");
	pgCells.put("partialClass","remove-top-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201707190606220717d7a918c0-c2c5-49d4-b739-e69e8dca931a598-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxMenu");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxMenu",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxMenu_1();labelName = "";
...
public int simpleLayoutCell_6( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxMenu",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " data-tour-id='cm-worker-primary-navigation' class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("tourId"," data-tour-id='cm-worker-primary-navigation'");
	pgCells.put("partialClass","remove-bottom-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2017071906071304280a485d7b-68b2-4db9-b06f-fcb1dc0cdd73987-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxMenu");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxMenu",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxMenu_2();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionPortalNavigationBBB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201808081157350664772") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + " class='" + "flex  content  layout-content-simple_list content-simple_list main-navigation flex-none" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","main-navigation flex-none");
		pg_dlmeta.put("format","simple_list");
	...
	String paramName = "EXPANDEDSubSectionPortalNavigationBBB";
...
public void buildSection_8() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_20","WorkSearchGadget", secInfo);
}
...
public void sectionBodyIncludeInCell_8() { 
	...
	String sectionName = "WorkSearchGadget"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellPortalNavigation649","",false);
}
...
public void buildSection_7() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_17","WorkSearchGadget", secInfo);
}
...
public void buildSection_6() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_16","pyPortalNavigationHeader", secInfo);
}
...
public void sectionBodyIncludeInCell_6() { 
	...
	String sectionName = "pyPortalNavigationHeader"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellPortalNavigation375","",false);
}
...
public void buildSection_5() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_13","pyPortalNavigationHeader", secInfo);
}
...
public int simpleLayoutCell_3( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyPortalNavigationHeader",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rxpyPortal.pyShowAppHeaderBar cqtrue",pxUniqueStreamHash+"_15");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rxpyPortal.pyShowAppHeaderBar cqtrue", pxUniqueStreamHash+"_15"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyPortalNavigationHeader",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
public int simpleLayoutCell_4( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","WorkSearchGadget",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","border-b-1x app-search flex-none","border-b-1x app-search flex-none")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","border-b-1x app-search flex-none");
	pgCells.put("customRWStyles","border-b-1x app-search flex-none");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rxpyPortal.pyShowAppHeaderBar cqtrue",pxUniqueStreamHash+"_19");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rxpyPortal.pyShowAppHeaderBar cqtrue", pxUniqueStreamHash+"_19"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","WorkSearchGadget",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionPortalNavigationBB","",false);
}
...
public void simpleLayout_6() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201902130456540931644") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + "flex  content  layout-content-simple_list content-simple_list portal-navigation" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","portal-navigation");
		pg_dlmeta.put("format","simple_list");
	...
	String paramName = "EXPANDEDSubSectionPortalNavigationBB";
...
public void buildSection_4() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_10","pzC11nPreviewSection", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pzC11nPreviewSection"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellPortalNavigation844","",false);
}
...
public void buildSection_3() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzC11nPreviewSection", secInfo);
}
...
public void buildSection_2() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzCoexistenceCaseMap", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzCoexistenceCaseMap"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellPortalNavigation330","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzCoexistenceCaseMap", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzCoexistenceCaseMap",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzCoexistenceCaseMap",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzC11nPreviewSection",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzC11nPreviewSection",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionPortalNavigationB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20230524110054076351") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default coexistence-preview" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","coexistence-preview");
	...
	String paramName = "EXPANDEDSubSectionPortalNavigationB";
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpyEnableCoexistence", pxUniqueStreamHash+"_11");metadataPage.put("lMode","SimpleDiv");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpyEnableCoexistence","pyEnableCoexistence", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	oPropDefinitions_1.put("Data-Portal.pyTemplateInputBox", new LiteweightPropertyDefinition("Data-Portal", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PORTALNAVIGATION #20210506T204027.659 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "PortalNavigation");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PORTALNAVIGATION #20210506T204027.659 GMT", "Data-Portal PortalNavigation", "Theme-Cosmos", "04-01-01", "20220502T142227.722 GMT");
}
