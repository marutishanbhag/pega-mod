...
/**
 * Builds JSP stream PEGA-DESIGNER-CASETYPE!PZMODALEDITORBUTTONS.
 */
public class ra_stream_pzmodaleditorbuttons_9567c13db50a8b3fb84062b56c90ad7c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzModalEditorButtons.Pega_Designer_CaseType.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 113549156;
 ...
 */
	public ra_stream_pzmodaleditorbuttons_9567c13db50a8b3fb84062b56c90ad7c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "d9bf97a984e1950e1ecf420fe15832049193622d";
...
{
/* Instance RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITORBUTTONS #20200826T182825.905 GMT	Pega-ProcessArchitect:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "d9bf97a984e1950e1ecf420fe15832049193622d";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzModalEditorButtons",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITORBUTTONS #20200826T182825.905 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITORBUTTONS #20200826T182825.905 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITORBUTTONS #20200826T182825.905 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZMODALEDITORBUTTONS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZMODALEDITORBUTTONS","Rule-HTML-Section","PEGA-DESIGNER-CASETYPE",false,"","Pega-ProcessArchitect","08-06-01","RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITORBUTTONS #20200826T182825.905 GMT","!PZMODALEDITORBUTTONS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",113549156), 
...
//	RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITORBUTTONS #20200826T182825.905 GMT:20200826T182825.905 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "f66c054d2d6f8807bf4d2132c17b0cc3";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzModalEditorButtons",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzModalEditorButtons','insKey':'RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITORBUTTONS #20200826T182825.905 GMT','sectionType':'standard'}");
pzLayout_2();
...
config.put("pzActivity", "pzCaseTypeConfigCleanup");
...
config.put("pyActivity", "pzCreateCaseTypeWrapper");
config.put("StaticActivityParams", "skipStages=true&skipCreateView=false");
...
config.put("pyTarget", "thisSection");
config.put("pyActivity", "pzCreateCaseTypeWrapper");
config.put("StaticActivityParams", "skipStages=true&skipCreateView=true");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.p.doClearActions ");
pega.getUIEngine().getUIAction("runScript", config).register();
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				refreshActionRequest.registerFixedParameter("StreamList", "pzEnterCaseTypeInformation|Rule-HTML-Section|:");
				...
				tools.appendString("[\"refresh\", [\"otherSection\",\"pzEnterCaseTypeInformation\", \"pzCreateCaseTypeWrapper\", \"");
				...
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"skipCreateView\":\"true\"");
				refreshActionRequestD.registerFixedParameter("skipCreateView","true");
				tools.appendString("\", \"\", \",");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }						tools.appendString("[\"runScript\", [\"pega.p.doClearActions (");
						String strPropReference31 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken("NewCaseTypeStages.pyDoClearActions")+"~#";
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty("NewCaseTypeStages.pyDoClearActions"), -1);
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20150317121334023740966") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzModalEditorButtons_$CTX$_96");
		String repeatIndx = "";
	String pyTooltip = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzModalEditorButtons_"+ referenceString+ "_96'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20150317121334023740966") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"skipStages\":\"true\"");
				refreshActionRequestD.registerFixedParameter("skipStages","true");
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"skipCreateView\":\"false\"");
				refreshActionRequestD.registerFixedParameter("skipCreateView","false");
				tools.appendString("\", \"\", \",");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
				tools.appendString("\",\":event\",\"\",[\"");
				if(!"".equals(preActParamStr.toString())) {
...
try {
	...
	modePage2.put("pyName","pzModalEditorButtons_$CTX$_95");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzModalEditorButtons_"+ referenceString+ "_95'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20150317121334023740966") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o1! wxpzIsSurveyLPContext","!pzIsSurveyLPContext","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","margin-r-0","margin-r-0")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20150317121334023740966-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxpzIsSurveyLPContext",pxUniqueStreamHash+"_12");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_12");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","!pzIsSurveyLPContext");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Pega-Designer-CaseType");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpzIsSurveyLPContext", pxUniqueStreamHash+"_12"); 
	}
...
public int simpleLayoutCell_3( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpzIsSurveyLPContext","pzIsSurveyLPContext","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-right-spacing    " + pzSection.getCustomStyle(false, "","margin-r-0","margin-r-0")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzIsSurveyLPContext",pxUniqueStreamHash+"_16");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzIsSurveyLPContext", pxUniqueStreamHash+"_16"); 
	}
	if(pyDLCellVisibility) {
...
pzSection.getLayout().setExpandParam("SubSectionpzModalEditorButtonsBB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20190102145054089897") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle margin-l-auto" + "'  ");
		...
		if(StringUtils.isBlank(expressionId)) {
			...
			expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  "D_pzCaseTypeConfiguration.pzCaseTypeEditMode == 'Create' || D_pzCaseTypeConfiguration.pzCaseTypeEditMode == 'CreateChild'",expressionId);
			...
			pg_dlmeta.put("customClassName","margin-l-auto");
		...
		String paramName = "EXPANDEDSubSectionpzModalEditorButtonsBB";
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pzCaseTypeEditMode\"  SHOW_WHEN=\"D_pzCaseTypeConfiguration.pzCaseTypeEditMode == 'Create' || D_pzCaseTypeConfiguration.pzCaseTypeEditMode == 'CreateChild'\"");
if(pzAuto.evaluateWhen("D_pzCaseTypeConfiguration.pzCaseTypeEditMode == 'Create' || D_pzCaseTypeConfiguration.pzCaseTypeEditMode == 'CreateChild'",null,true)){
	if(currentTemplatingStatus =='N')
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges("D_pzCaseTypeConfiguration.pzCaseTypeEditMode", -1);
	}
}catch(Exception e){}
}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzCaseTypeConfigCleanup");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }				tools.appendString("[\"runScript\", [\"pega.p.doClearActions(\\\"true\\\")\"]");
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2015060208354400537979") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzModalEditorButtons_$CTX$_80");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzModalEditorButtons_"+ referenceString+ "_80'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2015060208354400537979") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	{
		StringBuffer ractURLStr = new StringBuffer();
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing    " + pzSection.getCustomStyle(false, "","margin-r-auto","margin-r-auto")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015060208354400537979-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
...
pzSection.getLayout().setExpandParam("SubSectionpzModalEditorButtonsB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201901021450540896413") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
	...
	String paramName = "EXPANDEDSubSectionpzModalEditorButtonsB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpzIsPegaExpress", pxUniqueStreamHash+"_21");metadataPage.put("lMode","Flexbox");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITORBUTTONS #20200826T182825.905 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzModalEditorButtons");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITORBUTTONS #20200826T182825.905 GMT", "Pega-Designer-CaseType pzModalEditorButtons", "Pega-ProcessArchitect", "08-06-01", "20200826T182825.905 GMT");
}
