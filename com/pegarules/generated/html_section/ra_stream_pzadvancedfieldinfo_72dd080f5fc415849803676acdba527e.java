...
/**
 * Builds JSP stream PEGA-FIELDS-SCALAR-TEXT!PZADVANCEDFIELDINFO.
 */
public class ra_stream_pzadvancedfieldinfo_72dd080f5fc415849803676acdba527e extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzAdvancedFieldInfo.Pega_Fields_Scalar_Text.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1725768835;
 ...
 */
	public ra_stream_pzadvancedfieldinfo_72dd080f5fc415849803676acdba527e(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "5687129aa4d7afd02bbbf11a22e3e938c0b39329";
...
{
/* Instance RULE-HTML-SECTION PEGA-FIELDS-SCALAR-TEXT PZADVANCEDFIELDINFO #20230618T001733.722 GMT	Pega-ProcessArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "5687129aa4d7afd02bbbf11a22e3e938c0b39329";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzAdvancedFieldInfo",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-FIELDS-SCALAR-TEXT PZADVANCEDFIELDINFO #20230618T001733.722 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-FIELDS-SCALAR-TEXT PZADVANCEDFIELDINFO #20230618T001733.722 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-FIELDS-SCALAR-TEXT PZADVANCEDFIELDINFO #20230618T001733.722 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZADVANCEDFIELDINFO"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZADVANCEDFIELDINFO","Rule-HTML-Section","PEGA-FIELDS-SCALAR-TEXT",false,"","Pega-ProcessArchitect","08-23-01","RULE-HTML-SECTION PEGA-FIELDS-SCALAR-TEXT PZADVANCEDFIELDINFO #20230618T001733.722 GMT","!PZADVANCEDFIELDINFO",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1725768835)
	};
...
//	RULE-HTML-SECTION PEGA-FIELDS-SCALAR-TEXT PZADVANCEDFIELDINFO #20230618T001733.722 GMT:20230618T001733.722 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "66c6fdd8d2b8884c704488c6a9309de6";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzAdvancedFieldInfo",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzAdvancedFieldInfo','insKey':'RULE-HTML-SECTION PEGA-FIELDS-SCALAR-TEXT PZADVANCEDFIELDINFO #20230618T001733.722 GMT','sectionType':'standard'}");
pzLayout_3();
...
public void buildSection_4() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_10","pzConfigureExpectedSize", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pzConfigureExpectedSize"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzAdvancedFieldInfo805","",false);
}
...
public void buildSection_3() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzConfigureExpectedSize", secInfo);
}
...
public void buildSection_2() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzConfigureMaxLength", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzConfigureMaxLength"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpzAdvancedFieldInfo517","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzConfigureMaxLength", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzConfigureMaxLength",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing remove-top-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzConfigureMaxLength",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzConfigureExpectedSize",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing remove-bottom-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzConfigureExpectedSize",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzAdvancedFieldInfoB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzAdvancedFieldInfoB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-FIELDS-SCALAR-TEXT PZADVANCEDFIELDINFO #20230618T001733.722 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzAdvancedFieldInfo");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-FIELDS-SCALAR-TEXT PZADVANCEDFIELDINFO #20230618T001733.722 GMT", "Pega-Fields-Scalar-Text pzAdvancedFieldInfo", "Pega-ProcessArchitect", "08-23-01", "20230618T001733.722 GMT");
}
