...
/**
 * Builds JSP stream EMBED-APPLICATION-METADATA!PZAPPLICATIONBUSINESSOBJECTIVES.
 */
public class ra_stream_pzapplicationbusinessobjectives_3006b7e3091893b9b8597d760247cd6c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzApplicationBusinessObjectives.Embed_Application_MetaData.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1813627184;
 ...
 */
	public ra_stream_pzapplicationbusinessobjectives_3006b7e3091893b9b8597d760247cd6c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "48879f9b4b7d84008cbf252c7f58ff75f6bfda4f";
...
{
/* Instance RULE-HTML-SECTION EMBED-APPLICATION-METADATA PZAPPLICATIONBUSINESSOBJECTIVES #20200914T112529.655 GMT	Pega-LP-Application:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "48879f9b4b7d84008cbf252c7f58ff75f6bfda4f";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzApplicationBusinessObjectives",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-APPLICATION-METADATA PZAPPLICATIONBUSINESSOBJECTIVES #20200914T112529.655 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-APPLICATION-METADATA PZAPPLICATIONBUSINESSOBJECTIVES #20200914T112529.655 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-APPLICATION-METADATA PZAPPLICATIONBUSINESSOBJECTIVES #20200914T112529.655 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZAPPLICATIONBUSINESSOBJECTIVES", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZAPPLICATIONBUSINESSOBJECTIVES","Rule-HTML-Section","EMBED-APPLICATION-METADATA",false,"","Pega-LP-Application","08-06-01","RULE-HTML-SECTION EMBED-APPLICATION-METADATA PZAPPLICATIONBUSINESSOBJECTIVES #20200914T112529.655 GMT","!PZAPPLICATIONBUSINESSOBJECTIVES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1813627184), 
...
//	RULE-HTML-SECTION EMBED-APPLICATION-METADATA PZAPPLICATIONBUSINESSOBJECTIVES #20200914T112529.655 GMT:20200914T112529.655 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "f6ceac1aef8522472736f830b0bcdbda";
	}

	public String getDefinitionAppliesToClass() {
		return "Embed-Application-MetaData";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzApplicationBusinessObjectives",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzApplicationBusinessObjectives','insKey':'RULE-HTML-SECTION EMBED-APPLICATION-METADATA PZAPPLICATIONBUSINESSOBJECTIVES #20200914T112529.655 GMT','sectionType':'standard'}");
pzLayout_1();
...
tools.appendString("</P>");
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2016091903121102512738") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	...
	String repeatIndx = "";
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2016091903121102512738",true));
	String pyValueR = "";
	String pyValueOrig = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyName");
	pyValueR = ".pyName";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyName");
	pyValueOrig = ".pyName";
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextArea",".pyName",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item dataValueRead'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxTextArea_1(".pyName",0,"","","Text");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2016091903121102512738-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxTextArea");
	pgCells.put("forLabel",".pyName");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextArea",".pyName",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxTextArea_1(".pyName",0,"","","Text");labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzApplicationBusinessObjectivesB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202009071350390977432") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  set-width-auto layout-content-inline content-inline " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzApplicationBusinessObjectivesB";
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Embed-Application-MetaData");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-APPLICATION-METADATA PZAPPLICATIONBUSINESSOBJECTIVES #20200914T112529.655 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzApplicationBusinessObjectives");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-APPLICATION-METADATA PZAPPLICATIONBUSINESSOBJECTIVES #20200914T112529.655 GMT", "Embed-Application-MetaData pzApplicationBusinessObjectives", "Pega-LP-Application", "08-06-01", "20200914T112529.655 GMT");
}
