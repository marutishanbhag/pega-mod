...
/**
 * Builds JSP stream PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM!PZSYSTEMMAINTOP.
 */
public class ra_stream_pzsystemmaintop_2252bcf9452ab4c5ff60128a525911b9 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSystemMainTop.Pega_Ext_AdminStudio_Explorer_Settings_System.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 653046275;
 ...
 */
	public ra_stream_pzsystemmaintop_2252bcf9452ab4c5ff60128a525911b9(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "53d149004888e2974bb76c690971f04302482c45";
...
{
/* Instance RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAINTOP #20190508T125133.141 GMT	Pega-Desktop:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "53d149004888e2974bb76c690971f04302482c45";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSystemMainTop",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAINTOP #20190508T125133.141 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAINTOP #20190508T125133.141 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAINTOP #20190508T125133.141 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZSYSTEMMAINTOP", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSYSTEMMAINTOP","Rule-HTML-Section","PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM",false,"","Pega-Desktop","08-03-01","RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAINTOP #20190508T125133.141 GMT","!PZSYSTEMMAINTOP",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",653046275), 
		new DependentRuleInfo("PYLABEL","Rule-Obj-Property","@BASECLASS",true,"Pega-Ext-AdminStudio-Explorer-Settings-System","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYLABEL #20180713T131156.327 GMT","!PYLABEL",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAINTOP #20190508T125133.141 GMT:20190508T125133.141 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "f77b042c823f863d2f6bdbe2977ab75a";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSystemMainTop",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSystemMainTop','insKey':'RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAINTOP #20190508T125133.141 GMT','sectionType':'standard'}");
pzLayout_2();
...
config = new HashMap<String, String>();
config.put("navName", "pzSystemActions");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			pzPackageRuntime.packageSection("pzSystemMainTop",
			...
			tools.appendString("[\"showMenu\",[{\"dataSource\":\"pzSystemActions\", \"isNavNLDeferLoaded\":\"false\", \"isNavTypeCustom\":\"false\", \"className\":\"" + tools.getStepPage().getClassName());
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1713510314001");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzSystemActions", "", "pyNavigation1713510314001","", false, false, false, false);
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("201804130839460250197982",true));
	if(false || (pzAuto.isOffline() && true) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzSystemMainTop_$CTX$_19");
		String repeatIndx = "";
	...
	modePage2.put("image","pi pi-caret-down");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzSystemMainTop_"+ referenceString+ "_19'";
	 String securedPropValue = null;String localizedValForMenu = ""; String ariaLabel = "";try {localizedValForMenu = tools.getLocalizedTextForString(".pyCaption","menu");ariaLabel = StringUtils.filterRichText("Actions");} catch(Exception e) {}
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("201804130839460250197982") + " role='link' aria-haspopup='true' href='"+hrefValue+"'");tools.appendString(" aria-label='"+localizedValForMenu+" "+ariaLabel+"' ");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1713510314004");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzSystemActions", "", "pyNavigation1713510314004","", false, false, false, false);
			}catch(Exception e){oLog.error(e);}
			}
			tools.appendString("\"},\":event\"]");
...
public void pxDisplayText_1() {String key="18||RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAINTOP #20190508T125133.141 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","64","","","Text","true","18"};oCellRuntimeParamsMap.put("18||RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAINTOP #20190508T125133.141 GMT",paramValues);oControlPathsMap.put("18||RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAINTOP #20190508T125133.141 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pyBackControl", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pyBackControl"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzSystemMainTop442","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pyBackControl", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyBackControl",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyBackControl",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "   standard_dataLabelRead flex-grow-1 header-title-main dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20180409131808092129783-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pgCells.put("customROStyles","standard_dataLabelRead flex-grow-1 header-title-main");
	pgCells.put("customRWStyles","standard_dataLabelWrite flex-grow-1 header-title-main");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201804130839460250197982-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzSystemMainTopB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201804091314590022126") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  auto-width-column layout-content-inline_middle content-inline_middle layout-box-shadow" + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzSystemMainTopB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAINTOP #20190508T125133.141 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzSystemMainTop");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAINTOP #20190508T125133.141 GMT", "Pega-Ext-AdminStudio-Explorer-Settings-System pzSystemMainTop", "Pega-Desktop", "08-03-01", "20190508T125133.141 GMT");
}
