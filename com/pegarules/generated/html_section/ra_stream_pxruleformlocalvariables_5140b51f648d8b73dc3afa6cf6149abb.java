...
/**
 * Builds JSP stream RULE-!PXRULEFORMLOCALVARIABLES.
 */
public class ra_stream_pxruleformlocalvariables_5140b51f648d8b73dc3afa6cf6149abb extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pxRuleFormLocalVariables.Rule_Obj_Activity.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 284613649;
 ...
 */
	public ra_stream_pxruleformlocalvariables_5140b51f648d8b73dc3afa6cf6149abb(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a00e54347c83a0e239ec8114266bbcc2e22ecb15";
...
{
/* Instance RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT	Pega-Desktop:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "a00e54347c83a0e239ec8114266bbcc2e22ecb15";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pxRuleFormLocalVariables",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PXRULEFORMLOCALVARIABLES", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXRULEFORMLOCALVARIABLES","Rule-HTML-Section","RULE-",false,"","Pega-Desktop","08-02-01","RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT","!PXRULEFORMLOCALVARIABLES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",284613649), 
...
//	RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT:20181031T140645.654 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "a5512b624494eda5006a8ef59301bee5";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pxRuleFormLocalVariables",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pxRuleFormLocalVariables','insKey':'RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT','sectionType':'standard'}");
pzLayout_1();
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8")){
		 ...
		 String buttonUID = "name='pxRuleFormLocalVariables_"+ referenceString+ "_26'";
		...
		if(!(sectionIsReadOnly && true && false)){ 
			String repeatIndx = "";
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20150611074921076626365") + "  href='"+hrefValue+"' ");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_7")){
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pxRuleFormLocalVariables_"+ referenceString+ "_41'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
		...
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("2015061107492107662272") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
public void repeatingDataCell_8() {
	...
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox", ".pySections(2).pySectionBody(2).pyTable.pyRows(2).pyCells(4)")); tools.appendString("headers='a4'");
...
/*
 * reference tag
 * Cannot inline because: cannot identify property ".pyParametersParamType" at assembly time
 */
/* pega:reference */
...
_jspx_th_pega_reference__3.setName(".pyParametersParamType");
_jspx_th_pega_reference__3.setMode("input");
_jspx_th_pega_reference__3.setFormat("pzPromptSelectDataTypeLocal");
...
public void repeatingDataCell_7() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pzPromptSelectDataTypeLocal",".pyParametersParamType", ".pySections(2).pySectionBody(2).pyTable.pyRows(2).pyCells(3)")); tools.appendString("headers='a3'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:47px;'");}tools.appendString("class='");
	tools.appendString(" gridCell");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "",".pyLocalParameters","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","0","","","Text","false","39"};oCellRuntimeParamsMap.put("39||RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT",paramValues);oControlPathsMap.put("39||RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT",".pySections(2).pySectionBody(2).pyTable.pyRows(2).pyCells(2)");}
static{String[] paramValues = new String[]{"text", "pxTextInput", "",".pyLocalParameters","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","0","","pzValidParameterPageName","Text","false","38"};oCellRuntimeParamsMap.put("38||RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT",paramValues);oControlPathsMap.put("38||RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT",".pySections(2).pySectionBody(2).pyTable.pyRows(2).pyCells(1)");}
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20150611074921076417409") + " ");
		...
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyLocalParameters2colWidthCache4").equals("")){ tools.appendParamCSF("PpyLocalParameters2colWidthCache4"); } else { tools.appendString("22"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									...
									tools.appendString("style='height:37px;'"); } 
									tools.appendString(">"); } 
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20150611074921076316588") + " ");
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyLocalParameters2colWidthCache3").equals("")){ tools.appendParamCSF("PpyLocalParameters2colWidthCache3"); } else { tools.appendString("143"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:37px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont '");tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("Data type");if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}
									tools.appendString("</div>");if(pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<span style='position:absolute; top:0px; right: 0px;'>&nbsp;</span>"); } if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20150611074921076315746") + " ");
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyLocalParameters2colWidthCache2").equals("")){ tools.appendParamCSF("PpyLocalParameters2colWidthCache2"); } else { tools.appendString("199"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:37px;'"); } 
									tools.appendString(">"); } 
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20150611074921076214704") + " ");
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyLocalParameters2colWidthCache1").equals("")){ tools.appendParamCSF("PpyLocalParameters2colWidthCache1"); } else { tools.appendString("199"); } tools.appendString("px;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:37px;'"); } 
									tools.appendString(">"); } 
...
pzSection.getLayout().setExpandParam("SubSectionpxRuleFormLocalVariablesBB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpxRuleFormLocalVariablesBB";
...
String labelName = "Local variables";
labelName =  tools.getLocalizedTextForString(".pyCaption","Local variables");
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel1904' data-layout-id='202602230422420026" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel1904'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpxRuleFormLocalVariablesBB","tdRightStyle");}
if(showContainerIcons){
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pyLocalParametersL4=null;

 Map selUniqMap_pyLocalParametersL4 = null;
tools.appendString("<div ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyLocalParameters");tools.appendString("_pxRuleFormLocalVariables_2'");
...
tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201702170138510942864") + " ");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pyLocalParameters");

					}

					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList='.pyParametersParamName .pyParametersParamDesc .pyParametersParamType .pyTemplateInputBox  ' class='yui-skin-sam gPXAuto");

					if(pega_uiengine_harness.pzInStandardsMode()) {tools.appendString(" floated ");

					}tools.appendString("' style='");

					if(!pega_uiengine_harness.pzInStandardsMode()) {tools.appendString("display:"); if(pzAuto.getBrowserUtils().isIE()) {  tools.appendString(" inline; "); } else {  tools.appendString("inline-block;"); } }tools.appendString("' gPropIndex='PpyLocalParameters2' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201702170138510942864-layout") + " ");

					tools.appendString(" class='gridTable ");

					tools.appendString(pzSection.getRepeatStyle());String strSummary = "pyLocalParameters";
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' ><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpyLocalParameters2colWidthGBL\" id=\"PpyLocalParameters2colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyLocalParameters2colWidthGBL"));tools.appendString("\" />");

					
						 tools.putParamValue("expandRL","false"); 

					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpyLocalParameters2colWidthGBR\" id=\"PpyLocalParameters2colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyLocalParameters2colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpyLocalParameters2colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' style='width:");

					 if(!tools.getParamValue("PpyLocalParameters2colWidthGBL").equals("")) { tools.appendParamCSF("PpyLocalParameters2colWidthGBL"); } else { 

					tools.appendString("590.0"); } 

					tools.appendString("px;' cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='pyLocalParameters' PL_PROP='");

					
tools.appendString(".pyLocalParameters");
					...
					tools.appendString("'>\n\t\t\t\t\t\t\t\t\t\t<tr class='cellCont' ><td class='cellCont rowHandleHead  ' style='height:39px;'>");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pyLocalParameters").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pyLocalParameters\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals(".pyLocalParameters")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodes.pyLocalParameters2") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 

					if (tempTestID != null && !tempTestID.isEmpty() && !tempTestID.equals("")){

					String strEntryHandlePLProp = "";

					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle(".pyLocalParameters"); } catch (Exception ex) { }
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201702170138510942864-" + rowTestID) + " ");
					...
					tools.appendString("rowHandle  ' style='height:51px;'>");
					...
					tools.appendString("style='height:51px;'");
 ...
 tempNoRespg.removeFromClipboard();
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pyLocalParameters2") && tools.getParamValue("partialRefresh").equals("false")) {
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_5","pzRuleFormLocalParametersScript", secInfo);
}
...
pega.getUIEngine().getUIAction("addRow", config).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "LocalparametersTabClickCallback");
pega.getUIEngine().getUIAction("runScript", config).register();
config = new HashMap<String, String>();
config.put("pySectionName", "pxRuleFormLocalVariables");
config.put("pySectionClass", "Rule-");
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzRuleFormLocalParametersScript";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpxRuleFormLocalVariablesB","",false);
}
...
String paramName = "EXPANDEDSubSectionpxRuleFormLocalVariablesB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzRuleFormLocalParametersScript'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pzRuleFormLocalParametersScript'}") + ">");
}
pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
_jspx_th_pega_reference__2.setName(".pyParametersParamType");
_jspx_th_pega_reference__2.setMode("input");
_jspx_th_pega_reference__2.setFormat("pzPromptSelectDataTypeLocal");
...
_jspx_th_pega_reference__1.setName(".pyParametersParamType");
_jspx_th_pega_reference__1.setMode("input");
_jspx_th_pega_reference__1.setFormat("pzPromptSelectDataTypeLocal");
...
getActionsForCustomControls_1() {
	...
	String currentStream = tools.getCurrentStream();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-change='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"LocalparametersTabClickCallback(\\\"Objects\\\")\"]");
...
public void pxTextInput_2() {String key="39||RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT";
...
public void repeatingDataCell_2() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxTextInput",".pyParametersParamDesc", ".pySections(2).pySectionBody(2).pyTable.pyRows(2).pyCells(2)")); tools.appendString("headers='a2'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:47px;'");}tools.appendString("class='");
	tools.appendString(" gridCell");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
...
public void pxTextInput_1() {String key="38||RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","true");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxTextInput", assemblyParams);
...
public void repeatingDataCell_1() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxTextInput",".pyParametersParamName", ".pySections(2).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
...
public void pyLocalParameters_1() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyLocalParameters2")|| tools.getParamValue("partialTrigger").equals("editRow.pyLocalParameters2") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pyLocalParameters");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pyLocalParameters\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pyLocalParameters2")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty(".pyLocalParameters");
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyLocalParameters2") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pxRuleFormLocalVariables");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE- PXRULEFORMLOCALVARIABLES #20181004T152057.399 GMT", "Rule- pxRuleFormLocalVariables", "Pega-Desktop", "08-02-01", "20181031T140645.654 GMT");
}
