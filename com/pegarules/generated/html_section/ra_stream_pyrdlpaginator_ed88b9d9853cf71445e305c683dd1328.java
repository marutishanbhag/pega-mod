...
/**
 * Builds JSP stream @BASECLASS!PYRDLPAGINATOR.
 */
public class ra_stream_pyrdlpaginator_ed88b9d9853cf71445e305c683dd1328 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyRDLPaginator.Pega_Landing_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -708187714;
 ...
 */
	public ra_stream_pyrdlpaginator_ed88b9d9853cf71445e305c683dd1328(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "9d936c98d726f80c701f924a5dea076ccec621a4";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYRDLPAGINATOR #20190430T225359.311 GMT	Theme-Cosmos:01-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "9d936c98d726f80c701f924a5dea076ccec621a4";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyRDLPaginator",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYRDLPAGINATOR #20190430T225359.311 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYRDLPAGINATOR #20190430T225359.311 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYRDLPAGINATOR #20190430T225359.311 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYRDLPAGINATOR", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYRDLPAGINATOR","Rule-HTML-Section","@BASECLASS",false,"","Theme-Cosmos","01-01-01","RULE-HTML-SECTION @BASECLASS PYRDLPAGINATOR #20190430T225359.311 GMT","!PYRDLPAGINATOR",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-708187714), 
...
//	RULE-HTML-SECTION @BASECLASS PYRDLPAGINATOR #20190430T225359.311 GMT:20190430T225359.311 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "2ce324ae999ca4de7e38f207611933e3";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyRDLPaginator",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyRDLPaginator','insKey':'RULE-HTML-SECTION @BASECLASS PYRDLPAGINATOR #20190430T225359.311 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("pyFunctionName", "loadMoreData");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"loadMoreData(event)\"]");
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015110410023706663712",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pyRDLPaginator_$CTX$_5");
		String repeatIndx = "";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Load more\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Load more", ".pyButtonLabel");
	}
	pyLabel = "Load more";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyRDLPaginator_"+ referenceString+ "_5'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015110410023706663712") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Load more",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","centered","centered")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
...
pzSection.getLayout().setExpandParam("SubSectionpyRDLPaginatorB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201812261648300452390") + " ");
	...
	String paramName = "EXPANDEDSubSectionpyRDLPaginatorB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYRDLPAGINATOR #20190430T225359.311 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyRDLPaginator");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYRDLPAGINATOR #20190430T225359.311 GMT", "@baseclass pyRDLPaginator", "Theme-Cosmos", "01-01-01", "20190430T225359.311 GMT");
}
