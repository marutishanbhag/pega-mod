...
/**
 * Builds JSP stream PEGA-DESIGNER-CASETYPE!PZMODALEDITOR.
 */
public class ra_stream_pzmodaleditor_c33289dd87c83a4b6dc0caa9c56944ff extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzModalEditor.Pega_Designer_CaseType.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 616063335;
 ...
 */
	public ra_stream_pzmodaleditor_c33289dd87c83a4b6dc0caa9c56944ff(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "7ed58aad2662e99855bf3a0b0689675994223fda";
...
{
/* Instance RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITOR #20180713T140850.724 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "7ed58aad2662e99855bf3a0b0689675994223fda";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzModalEditor",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITOR #20180713T140850.724 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITOR #20180713T140850.724 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITOR #20180713T140850.724 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZMODALEDITOR"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZMODALEDITOR","Rule-HTML-Section","PEGA-DESIGNER-CASETYPE",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITOR #20180713T140850.724 GMT","!PZMODALEDITOR",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",616063335)
	};
...
//	RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITOR #20180713T140850.724 GMT:20180713T140850.724 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "8bc7f5fbdef124340a2963b5d1065e46";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzModalEditor",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzModalEditor','insKey':'RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITOR #20180713T140850.724 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_3();
...
public void buildSection_3() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzModalEditorButtons", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzModalEditorButtons";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_3() {
pzSection.getLayout().setExpandParam("SubSectionpzModalEditorBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzModalEditorBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzModalEditorButtons'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzModalEditorButtons'}") + ">");
}
pzSetExpandParam_3();
...
pzSection.getLayout().setExpandParam("SubSectionCellpzModalEditor143","",false);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzModalAction",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-bottom-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
pzSection.getLayout().setExpandParam("SubSectionpzModalEditorB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzModalEditorB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITOR #20180713T140850.724 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzModalEditor");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-DESIGNER-CASETYPE PZMODALEDITOR #20180713T140850.724 GMT", "Pega-Designer-CaseType pzModalEditor", "Pega-ProcessArchitect", "08-01-01", "20180713T140850.724 GMT");
}
