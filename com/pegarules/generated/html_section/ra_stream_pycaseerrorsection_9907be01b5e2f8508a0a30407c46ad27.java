...
/**
 * Builds JSP stream @BASECLASS!PYCASEERRORSECTION.
 */
public class ra_stream_pycaseerrorsection_9907be01b5e2f8508a0a30407c46ad27 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyCaseErrorSection.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -514832316;
 ...
 */
	public ra_stream_pycaseerrorsection_9907be01b5e2f8508a0a30407c46ad27(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "44e2fb347efdbf17888ef1d821f997edbc684eb";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYCASEERRORSECTION #20210506T204028.337 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "44e2fb347efdbf17888ef1d821f997edbc684eb";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyCaseErrorSection",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYCASEERRORSECTION #20210506T204028.337 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYCASEERRORSECTION #20210506T204028.337 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYCASEERRORSECTION #20210506T204028.337 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYCASEERRORSECTION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCASEERRORSECTION","Rule-HTML-Section","@BASECLASS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION @BASECLASS PYCASEERRORSECTION #20210506T204028.337 GMT","!PYCASEERRORSECTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-514832316)
	};
...
//	RULE-HTML-SECTION @BASECLASS PYCASEERRORSECTION #20210506T204028.337 GMT:20210506T204028.337 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "954224c5fd66bb03eea502357cd8c17f";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyCaseErrorSection",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyCaseErrorSection','insKey':'RULE-HTML-SECTION @BASECLASS PYCASEERRORSECTION #20210506T204028.337 GMT','sectionType':'standard'}");
pzLayout_2();
...
public void buildSection_2() { 
	...
	secParams.put("hideWarnings","false");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","HarnessErrorList", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	tools.putParamValue("hideWarnings","false");
	...
	String sectionName = "HarnessErrorList"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCaseErrorSection760","",false);
}
...
public void buildSection_1() { 
	...
	secParams.put("hideWarnings","false");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","HarnessErrorList", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","HarnessErrorList",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","HarnessErrorList",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpyCaseErrorSectionB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806191352060317785") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default banner banner-urgent margin-b-2x" + "'  " + "role='alert'");
		...
		pg_dlmeta.put("customClassName","banner banner-urgent margin-b-2x");
	...
	String paramName = "EXPANDEDSubSectionpyCaseErrorSectionB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& wxhasMessages o2!= pxparam.ShowConflict cqtrue", pxUniqueStreamHash+"_7");metadataPage.put("lMode","SimpleDiv");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& wxhasMessages o2!= pxparam.ShowConflict cqtrue","hasMessages && param.ShowConflict!=\'true\'", "layout", "visible" )) {pzSetExpandParam_1();
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYCASEERRORSECTION #20210506T204028.337 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyCaseErrorSection");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYCASEERRORSECTION #20210506T204028.337 GMT", "@baseclass pyCaseErrorSection", "Theme-Cosmos", "04-01-01", "20210506T204028.337 GMT");
}
