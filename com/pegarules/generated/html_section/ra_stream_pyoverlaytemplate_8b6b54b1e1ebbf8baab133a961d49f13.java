...
/**
 * Builds JSP stream RULE-!PYOVERLAYTEMPLATE.
 */
public class ra_stream_pyoverlaytemplate_8b6b54b1e1ebbf8baab133a961d49f13 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyOverlayTemplate.Rule_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1570986125;
 ...
 */
	public ra_stream_pyoverlaytemplate_8b6b54b1e1ebbf8baab133a961d49f13(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "11b77f20be1ffce5fdb1ef6c0652a82ee4d4cd04";
...
{
/* Instance RULE-HTML-SECTION RULE- PYOVERLAYTEMPLATE #20230618T002046.591 GMT	Pega-EndUserUI:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "11b77f20be1ffce5fdb1ef6c0652a82ee4d4cd04";
...
/*
 * Begin RULE-HTML-SECTION RULE- PYOVERLAYTEMPLATE #20230618T002046.591 GMT
 * Set up context.
 */
final String prevRuleKey_4 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE- PYOVERLAYTEMPLATE #20230618T002046.591 GMT";final String prevClass_4 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE- PYOVERLAYTEMPLATE #20230618T002046.591 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYOVERLAYTEMPLATE","Rule-HTML-Section","RULE-",false,"","Pega-EndUserUI","08-23-01","RULE-HTML-SECTION RULE- PYOVERLAYTEMPLATE #20230618T002046.591 GMT","!PYOVERLAYTEMPLATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1570986125), 
...
//	RULE-HTML-SECTION RULE- PYOVERLAYTEMPLATE #20230618T002046.591 GMT:20230618T002046.591 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "cd43086bc7c466ccbe991fa90c47f016";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyOverlayTemplate",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyOverlayTemplate','insKey':'RULE-HTML-SECTION RULE- PYOVERLAYTEMPLATE #20230618T002046.591 GMT','sectionType':'standard'}");
...
params_4.putString("Caption", "Ok");
params_4.putString("DisabledWhen", pega.getValue("Param.DisableSubmitButton"));
params_4.putString("Id", "overlay-submit");
...
property_Rule_Application_pzOverlayButton();
...
try {
tools.appendString("<input type=\"hidden\" name=\"DisableSubmitButton\" value='");

/*
 * reference tag
 * Cannot inline because: parameter reference
 */
if (_jspx_meth_pega_reference__1(pageContext, "Param.DisableSubmitButton")) {
	return;
}
tools.appendString("'>");
} catch(Throwable t) {
...
if (_jspx_meth_pega_param__2(pageContext, "DisabledWhen", "Param.DisableSubmitButton")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "Id", "overlay-submit")) {
	return true;
}
...
params_3.putString("Caption", "Ok");
params_3.putString("DisabledWhen", pega.getValue("Param.DisableSubmitButton"));
params_3.putString("Id", "overlay-submit");
...
params_2.putString("ButtonStyle", "Standard");
...
if (_jspx_meth_pega_param__1(pageContext, "ButtonStyle", "Standard")) {
	return true;
}
if (_jspx_meth_pega_param__2(pageContext, "AJAXTrackID", "param.AJAXTrackID")) {
	return true;
...
/**
 * Generates stream property_Rule_Application_Button
 */
private void property_Rule_Application_Button() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_2() {
	final Map streamProperties = pega.getStreamProperties();
	try {
property_Rule_Application_Button();
...
/**
 * Generates stream property_Rule_Application_pzOverlayButton
 */
private void property_Rule_Application_pzOverlayButton() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
params_1.putString("ButtonStyle", "Standard");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015021904414400302335-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8")) {	field_pzOverlayButton_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= pxparam.ShowOnlyCancel cqtrue","param.ShowOnlyCancel!=\'true\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	...
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_9")) {	field_pzOverlayButton_3();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("localize","false");
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20150219044144002925525-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzOverlayButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= pxparam.ShowOnlyCancel cqtrue",pxUniqueStreamHash+"_11");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_11");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","param.ShowOnlyCancel!='true'");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= pxparam.ShowOnlyCancel cqtrue", pxUniqueStreamHash+"_11"); 
	}
...
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_12")) {	field_pzOverlayButton_4();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();}
	if (!isExpression && isOffline) {
	// do nothing
	} else {
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202009160316320246370") + " ");
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& wxpzShowFAButtons o2== pxparam.includedStreamName cq", pxUniqueStreamHash+"_13");metadataPage.put("lMode","SimpleDiv");
...
if(pzAuto.handleEvaluateWhen(" o2&& wxpzShowFAButtons o2== pxparam.includedStreamName cq","pzShowFAButtons && param.includedStreamName = \'\'", "layout", "visible" )) {pzSetExpandParam_2();
...
sectionBodyIncludeInCell_1(false,false,"","pzModalAction");elementModel_1("pzModalAction","pyOverlayTemplate","BAR","");
 } 
...
static {
	oPropDefinitions_4.put("Rule-Application.pyTemplateInputBox", new LiteweightPropertyDefinition("Rule-Application", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_4.put("pzInsKey", "RULE-HTML-SECTION RULE- PYOVERLAYTEMPLATE #20230618T002046.591 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE- PYOVERLAYTEMPLATE #20230618T002046.591 GMT", "Rule- pyOverlayTemplate", "Pega-EndUserUI", "08-23-01", "20230618T002046.591 GMT");
