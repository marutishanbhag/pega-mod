...
/**
 * Builds JSP stream EMBED-STAGEPROCESS-ADDSTEP!PYCATEGORYLISTENTRY.
 */
public class ra_stream_pycategorylistentry_616660b585df52d443e48bfc5d40eab8 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyCategoryListEntry.Embed_StageProcess_AddStep.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -955912683;
 ...
 */
	public ra_stream_pycategorylistentry_616660b585df52d443e48bfc5d40eab8(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "7782315a8442299409dc1ca3cde46d3a2df1d97d";
...
{
/* Instance RULE-HTML-SECTION EMBED-STAGEPROCESS-ADDSTEP PYCATEGORYLISTENTRY #20180713T140840.144 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "7782315a8442299409dc1ca3cde46d3a2df1d97d";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyCategoryListEntry",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-STAGEPROCESS-ADDSTEP PYCATEGORYLISTENTRY #20180713T140840.144 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-STAGEPROCESS-ADDSTEP PYCATEGORYLISTENTRY #20180713T140840.144 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-STAGEPROCESS-ADDSTEP PYCATEGORYLISTENTRY #20180713T140840.144 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYCATEGORYLISTENTRY"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCATEGORYLISTENTRY","Rule-HTML-Section","EMBED-STAGEPROCESS-ADDSTEP",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION EMBED-STAGEPROCESS-ADDSTEP PYCATEGORYLISTENTRY #20180713T140840.144 GMT","!PYCATEGORYLISTENTRY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-955912683)
	};
...
//	RULE-HTML-SECTION EMBED-STAGEPROCESS-ADDSTEP PYCATEGORYLISTENTRY #20180713T140840.144 GMT:20180713T140840.144 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "a89d541efb33cf6d5691feecde231113";
	}

	public String getDefinitionAppliesToClass() {
		return "Embed-StageProcess-AddStep";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyCategoryListEntry",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyCategoryListEntry','insKey':'RULE-HTML-SECTION EMBED-STAGEPROCESS-ADDSTEP PYCATEGORYLISTENTRY #20180713T140840.144 GMT','sectionType':'standard'}");
pzLayout_7();
...
config.put("skipSelCatCopy", "false");
config.put("pzActivityStaticParams", "contextPage&skipSelCatCopy");
...
public void buildSection_6() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_21","pyCategoryListEntryAction", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCategoryListEntry436","",false);
}
...
public void buildSection_5() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_18","pyCategoryListEntryAction", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionpyCategoryListEntryBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	spxUniqueStreamHash17 = getUIActionsMetaData_2();
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201712270724550289759") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + " class='" + " content  set-width-auto layout-content-simple_list content-simple_list " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpyCategoryListEntryBBBB";
...
public void buildSection_4() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_14","pyCategoryEntryLabel", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pyCategoryEntryLabel"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCategoryListEntry30","",false);
}
...
public void buildSection_3() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pyCategoryEntryLabel", secInfo);
}
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyCategoryEntryLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyCategoryEntryLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyCategoryListEntryBBB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201712270724550289532") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
	...
	String paramName = "EXPANDEDSubSectionpyCategoryListEntryBBB";
	metadataPage.put("paramName", paramName);
...
public void buildSection_2() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pyCategoryEntryIcon", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pyCategoryEntryIcon"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCategoryListEntry615","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pyCategoryEntryIcon", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyCategoryEntryIcon",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyCategoryEntryIcon",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyCategoryListEntryBB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201712270724550288181") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
	...
	String paramName = "EXPANDEDSubSectionpyCategoryListEntryBB";
	metadataPage.put("paramName", paramName);
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"skipSelCatCopy\":\"false\"");
...
public int simpleLayoutCell_6( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " float-right set-width-auto   flex flex-row '  STRING_TYPE='layout' RESERVE_SPACE='false'>");
	pzLayout_6();
 tools.putSaveValue("ContainerID", "");tools.appendString("</div>");
	index++;
	return index;
...
pzSection.getLayout().setExpandParam("SubSectionpyCategoryListEntryB","",false);
}
...
public void simpleLayout_4() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20171227072455028830") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  pointer  auto-width-column layout-content-inline_middle content-inline_middle clearfix flex-grow-1-item-2 flex-nowrap" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		...
		tools.appendString("]' ");
									...
									if(!"".equals(strMethodName))
									pg_dlmeta.put("methodnm",strMethodName);
									pg_dlmeta.put("customClassName","clearfix flex-grow-1-item-2 flex-nowrap");
								...
								String paramName = "EXPANDEDSubSectionpyCategoryListEntryB";
								metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Embed-StageProcess-AddStep");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-STAGEPROCESS-ADDSTEP PYCATEGORYLISTENTRY #20180713T140840.144 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyCategoryListEntry");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-STAGEPROCESS-ADDSTEP PYCATEGORYLISTENTRY #20180713T140840.144 GMT", "Embed-StageProcess-AddStep pyCategoryListEntry", "Pega-ProcessArchitect", "08-01-01", "20180713T140840.144 GMT");
}
