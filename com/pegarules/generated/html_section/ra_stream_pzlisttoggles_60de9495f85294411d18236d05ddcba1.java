...
/**
 * Builds JSP stream PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT!PZLISTTOGGLES.
 */
public class ra_stream_pzlisttoggles_60de9495f85294411d18236d05ddcba1 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzListToggles.Pega_Landing_System_ToggleManagement.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 310147197;
 ...
 */
	public ra_stream_pzlisttoggles_60de9495f85294411d18236d05ddcba1(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "f85f735904a48fcb5864bbeaa6b718d299aeeb19";
...
{
/* Instance RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT	Pega-Desktop:08-23-02	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "f85f735904a48fcb5864bbeaa6b718d299aeeb19";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzListToggles",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZLISTTOGGLES", 
	"Rule-Obj-Property:PXCREATEOPERATOR", 
	"Rule-Obj-Property:PYTOGGLESTATUS", 
	"Rule-Obj-Property:PYTOGGLEIDENTIFIER", 
	"Rule-Obj-Property:PYTOGGLETYPE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZLISTTOGGLES","Rule-HTML-Section","PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT",false,"","Pega-Desktop","08-23-02","RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT","!PZLISTTOGGLES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",310147197), 
		new DependentRuleInfo("PXCREATEOPERATOR","Rule-Obj-Property","@BASECLASS",true,"Data-Admin-Toggle","Pega-RULES","08-07-01","RULE-OBJ-PROPERTY @BASECLASS PXCREATEOPERATOR #20210608T194027.403 GMT","!PXCREATEOPERATOR",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYTOGGLESTATUS","Rule-Obj-Property","@BASECLASS",true,"Data-Admin-Toggle","Pega-Desktop","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYTOGGLESTATUS #20180713T135013.373 GMT","!PYTOGGLESTATUS",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYTOGGLEIDENTIFIER","Rule-Obj-Property","DATA-ADMIN-TOGGLE",true,"Data-Admin-Toggle","Pega-RulesEngine","08-01-01","RULE-OBJ-PROPERTY DATA-ADMIN-TOGGLE PYTOGGLEIDENTIFIER #20180713T132518.183 GMT","!PYTOGGLEIDENTIFIER",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYTOGGLETYPE","Rule-Obj-Property","DATA-ADMIN-TOGGLE",true,"Data-Admin-Toggle","Pega-RulesEngine","08-01-01","RULE-OBJ-PROPERTY DATA-ADMIN-TOGGLE PYTOGGLETYPE #20180713T132518.192 GMT","!PYTOGGLETYPE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYDESCRIPTION","Rule-Obj-Property","@BASECLASS",true,"Data-Admin-Toggle","Pega-RULES","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYDESCRIPTION #20180713T131156.222 GMT","!PYDESCRIPTION",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT:20231113T211337.048 GMT
//	RULE-OBJ-PROPERTY DATA-ADMIN-TOGGLE PYTOGGLETYPE #20180713T132518.192 GMT:20180713T132518.192 GMT
//	RULE-OBJ-PROPERTY DATA-ADMIN-TOGGLE PYTOGGLEIDENTIFIER #20180713T132518.183 GMT:20180713T132518.183 GMT
...
//	RULE-OBJ-PROPERTY @BASECLASS PYTOGGLESTATUS #20180713T135013.373 GMT:20180713T135013.373 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "18a1dd8c13ea729932819be9e696bf87";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzListToggles",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzListToggles','insKey':'RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_4();
...
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("pxObjClass", "Rule-Obj-When");
config.put("pyClassName", "@baseclass");
config.put("dynamicKey", "true");
pega.getUIEngine().getUIAction("openRuleByKeys", config).register();
config = new HashMap<String, String>();
config.put("ActionSection", "pzModalTemplate");
config.put("NewTaskStatus", "pzDeleteToggle");
pega.getUIEngine().getUIAction("localAction", config).register();
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
config.put("pyPreDataTransform.pyName", "pzGetListOfAvailableToggles");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_26")){
		 ...
		 String buttonUID = "name='pzListToggles_"+ referenceString+ "_39'";
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("202311102332330044109") + "  href='"+hrefValue+"' ");
	...
	keyMap.putString("pyActionName", "pzDeleteToggle");
	...
	try{
	pzPackageRuntime.packageLocalAction("pzDeleteToggle", offlineUsingPage , strLAClassName);
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			pzPackageRuntime.packageSection("pzListToggles",
			...
			if("true".equals(bHasPrivilege )) {
				tools.appendString("[\"processAction\", [\"pzDeleteToggle\",\"true\",\":event\",\"\",\""+streamType+"\",\"\",\"pzModalTemplate\",\"%7B%22isCustomMobileAnim%22%3A%22true%22%2C%22desktop%22%3A%7B%22reveal%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22none%22%2C%22speed%22%3A%22default%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%2C%22mobile%22%3A%7B%22reveal%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22anim-offright-open%22%2C%22speed%22%3A%22default%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
				} else {
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }						{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
							com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
								...
								staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzListToggles"));
								staticURLStr.append("&PreDataTransform=pzGetListOfAvailableToggles");
								tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"\", \"");
								refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
								tools.appendString("=\", \"\", \"pzGetListOfAvailableToggles,");
								refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
								preDTParamStr.append((!"".equals(preDTParamStr.toString())?",":"") + "\"decoy\":\"\"");
								...
								if(!"".equals(preActParamStr.toString())) {
									...
									if(!"".equals(preDTParamStr.toString())) {
										...
										if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
										pzPackageRuntime.packageDataTransform(tools.getStepPage().getString("pxObjClass"), "pzGetListOfAvailableToggles");
										}
...
public void repeatingDataCell_14() {
	...
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox", ".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(8)")); tools.appendString("headers='a8'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:25px;'");}tools.appendString("class='");
	...
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");if(pzAuto.handleEvaluateWhen(" axpzCanDeleteToggle","pzCanDeleteToggle", "cell", "visible" )) {pxIcon_3(); } 
									tools.appendString("</DIV>"); } else { if(pzAuto.handleEvaluateWhen(" axpzCanDeleteToggle","pzCanDeleteToggle", "cell", "visible" )) {pxIcon_3(); } }
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_25")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		 String pyFormatValue = "";
		 String toolTipVal = "";
		String hrefValue = "#";
		 String referenceString = tools.getStepPage().getReference();
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzListToggles_"+ referenceString+ "_38'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20160629051411037646957") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }tools.appendString("[\"editRepeatItem\",[\":event\"]");
...
public void repeatingDataCell_13() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox", ".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(7)")); tools.appendString("headers='a7'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:25px;'");}tools.appendString("class='");
	tools.appendString(" gridCell");tools.appendString("  wrapText");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_24")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzListToggles_"+ referenceString+ "_37'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20160629051325028042733") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }tools.appendString("[\"openRuleByKey\",[\"Rule-Obj-When\",\"");

		tools.appendString(XMLUtils.encodeString("pyClassName") + "=");
		tools.appendFormatted("@baseclass",StreamBuilder.FMT_NORMAL);tools.appendString("&amp;");

		tools.appendString(XMLUtils.encodeString("pyBlockName") + "=");
		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyRuleName")+"~#");tools.appendString("\",\"");

		tools.appendFormatted("df432594-1347-4943-9cde-c7eb9af5f0fe",StreamBuilder.FMT_NORMAL);tools.appendString("\",\"");
		...
		tools.appendString("  title= '");
		 toolTipVal = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt",tools.getProperty(".pyRuleName").getStringValue()+"\t"+repeatIndx,StreamBuilder.FMT_LITERAL)) + "' ";
		tools.appendString(toolTipVal);tools.appendString(" class='");tools.appendString("'");
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Open When",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString("</a>");}pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
		tools.putParamValue("pega_attributes","");
	tools.appendString("</span>");tools.putParamValue("doAutoFormatting", "false");
tools.putParamValue("isControlEditableOriginal", true);
...
public void repeatingDataCell_12() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox", ".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(6)")); tools.appendString("headers='a6'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:25px;'");}tools.appendString("class='");
	tools.appendString(" gridCell");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");generateClientWhenDiv_1();pxLink_5();
									tools.appendString("</div>");
									tools.appendString("</DIV>"); } else { generateClientWhenDiv_1();pxLink_5();
									tools.appendString("</div>");}
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "",".pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","0","","","Text","true","36"};oCellRuntimeParamsMap.put("36||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT",paramValues);oControlPathsMap.put("36||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(5)");}
static{String[] paramValues = new String[]{"label", "pxDisplayText", "",".pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","T","true","0","","","Text","true","35"};oCellRuntimeParamsMap.put("35||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT",paramValues);oControlPathsMap.put("35||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(4)");}
static{String[] paramValues = new String[]{"label", "pxDisplayText", "",".pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","0","","","Text","true","34"};oCellRuntimeParamsMap.put("34||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT",paramValues);oControlPathsMap.put("34||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(3)");}
static{String[] paramValues = new String[]{"label", "pxDisplayText", "",".pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","I","false","0","","","Identifier","true","33"};oCellRuntimeParamsMap.put("33||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT",paramValues);oControlPathsMap.put("33||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)");}
static{String[] paramValues = new String[]{"label", "pxDisplayText", "",".pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","I","false","0","","","Identifier","true","32"};oCellRuntimeParamsMap.put("32||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT",paramValues);oControlPathsMap.put("32||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)");}
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20160629051437018144356") + " ");
		...
		tools.appendString(pzSection.getCustomStyle(true,"","standard_dataLabelRead","standard_dataLabelWrite"));tools.appendString(" cellCont");tools.appendString(" gridCell");tools.appendString("  wrapText");tools.appendString(" highlight-ele ");tools.appendString(" ");tools.appendString("' pyCellType = 'static' ");
		tools.appendString("");
		
		tools.appendString(" bSortable = 'false'");
		
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpxResults1colWidthCache8").equals("")) { tools.appendParamCSF("PpxResults1colWidthCache8");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("201611300520210906181166") + " ");
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpxResults1colWidthCache7").equals("")) { tools.appendParamCSF("PpxResults1colWidthCache7");} else { tools.appendString("2.028397565922921"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:22px;'"); } 
									tools.appendString(">"); } 
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20160629051437018040281") + " ");
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpxResults1colWidthCache6").equals("")) { tools.appendParamCSF("PpxResults1colWidthCache6");} else { tools.appendString("8.113590263691684"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:22px;'"); } 
									tools.appendString(">"); } 
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20160629051437017928730") + " ");
		...
		if(!bSecured){
		tools.appendString(" bSortable = 'true' sortField = '.pyToggleStatus' ");
		}
		if(!bSecured){
		tools.appendString(" pyShowFilterUIBy = 'value'  bformattedControl ='true'");
		}
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpxResults1colWidthCache5").equals("")) { tools.appendParamCSF("PpxResults1colWidthCache5");} else { tools.appendString("9.22920892494929"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:22px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc534782816'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
...
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc534782816' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc534782816' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc534782816' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
...
public void repeatingHeaderCell_4() {
	...
	int lastDotIndex = 0;
	dataPropClass = "Data-Admin-Toggle";
	dataColumnProp = "pxCreateOperator";
	bSecured = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().isPropertySecured(dataPropClass, dataColumnProp,tools);
	
	String sortImgHTML = "";
	String sortNoHTML = "";
	String strFieldValue = ".pxCreateOperator";
		tools.appendString("<th title='");
		 tools.appendString(tools.getLocalizedTextForString("pyCaption", "Click to sort by" ,StreamBuilder.FMT_NORMAL)); tools.appendString("'  ");
try {
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20161124120355022765258") + " ");
		...
		tools.appendString(" title= '");  if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))) { tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText")) + " "); } tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Click to sort by", StreamBuilder.FMT_NORMAL)); tools.appendString("'");
		if(!bSecured){
		tools.appendString(" bSortable = 'true' sortField = '.pxCreateOperator' ");
		}
		if(!bSecured){
		tools.appendString(" pyShowFilterUIBy = 'value'  bformattedControl ='true'");
		}
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpxResults1colWidthCache4").equals("")) { tools.appendParamCSF("PpxResults1colWidthCache4");} else { tools.appendString("11.76470588235294"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:22px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc1996807207'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc1996807207' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc1996807207' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc1996807207' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
} 
tools.appendString("class='highlight-ele  pointerStyle "); if(tools.getParamValueCSF("sortProperty").equals(".pxCreateOperator")){tools.appendParamCSF("sortType"); } tools.appendString("'  title= '");  if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))) { tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText")) + " "); } tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Click to sort by", StreamBuilder.FMT_NORMAL)); tools.appendString("'>");if(pzAuto.getBrowserUtils().isIE() && ("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder")))){tools.appendString("<span id='titleDesc1996807207' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}tools.appendString("</span>");
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPage_pxResultsL6 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOperator4").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOperator4").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOperator4").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle1996807207\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOperator4").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOperator4").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOperator4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle1996807207\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOperator4").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOperator4").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOperator4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOperator4").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOperator4").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOperator4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOperator4").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOperator4").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOperator4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
public void repeatingHeaderCell_3() {
	...
	int lastDotIndex = 0;
	dataPropClass = "Data-Admin-Toggle";
	dataColumnProp = "pyDescription";
	bSecured = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().isPropertySecured(dataPropClass, dataColumnProp,tools);
	
	String sortImgHTML = "";
	String sortNoHTML = "";
	String strFieldValue = ".pyDescription";
		tools.appendString("<th title='");
		 tools.appendString(tools.getLocalizedTextForString("pyCaption", "Click to sort by" ,StreamBuilder.FMT_NORMAL)); tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='Additional details' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("202310021105580582776") + " ");
		...
		tools.appendString(" title= '");  if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))) { tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText")) + " "); } tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Click to sort by", StreamBuilder.FMT_NORMAL)); tools.appendString("'");
		if(!bSecured){
		tools.appendString(" bSortable = 'true' sortField = '.pyDescription' ");
		}
		if(!bSecured){
		tools.appendString(" pyShowFilterUIBy = 'value'  bformattedControl ='true'");
		}
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpxResults1colWidthCache3").equals("")) { tools.appendParamCSF("PpxResults1colWidthCache3");} else { tools.appendString("44.9290060851927"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:22px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc887642560'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "Additional details", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(!bSecured){if("".equals(tools.getParamValue("sortProperty"))){ 
tools.putParamValue("columnSortOrder","");
}else{
if(strFieldValue.equals(tools.getParamValue("sortProperty"))){
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc887642560' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc887642560' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc887642560' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
} 
tools.appendString("class='highlight-ele  pointerStyle "); if(tools.getParamValueCSF("sortProperty").equals(".pyDescription")){tools.appendParamCSF("sortType"); } tools.appendString("'  title= '");  if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))) { tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText")) + " "); } tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Click to sort by", StreamBuilder.FMT_NORMAL)); tools.appendString("'>");if(pzAuto.getBrowserUtils().isIE() && ("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder")))){tools.appendString("<span id='titleDesc887642560' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}tools.appendString("</span>");
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPage_pxResultsL6 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyDescription3").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyDescription3").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyDescription3").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle887642560\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyDescription3").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyDescription3").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyDescription3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle887642560\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyDescription3").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyDescription3").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyDescription3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyDescription3").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyDescription3").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyDescription3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyDescription3").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyDescription3").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyDescription3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
public void repeatingHeaderCell_2() {
	...
	int lastDotIndex = 0;
	dataPropClass = "Data-Admin-Toggle";
	dataColumnProp = "pyToggleIdentifier";
	bSecured = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().isPropertySecured(dataPropClass, dataColumnProp,tools);
	
	String sortImgHTML = "";
	String sortNoHTML = "";
	String strFieldValue = ".pyToggleIdentifier";
		tools.appendString("<th title='");
		 tools.appendString(tools.getLocalizedTextForString("pyCaption", "Click to sort by" ,StreamBuilder.FMT_NORMAL)); tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='Identifier' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20160629051437017824881") + " ");
		...
		tools.appendString(" title= '");  if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))) { tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText")) + " "); } tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Click to sort by", StreamBuilder.FMT_NORMAL)); tools.appendString("'");
		if(!bSecured){
		tools.appendString(" bSortable = 'true' sortField = '.pyToggleIdentifier' ");
		}
		if(!bSecured){
		tools.appendString(" pyShowFilterUIBy = 'value'  bformattedControl ='true'");
		}
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpxResults1colWidthCache2").equals("")) { tools.appendParamCSF("PpxResults1colWidthCache2");} else { tools.appendString("11.967545638945234"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:22px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc492374731'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "Identifier", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(!bSecured){if("".equals(tools.getParamValue("sortProperty"))){ 
tools.putParamValue("columnSortOrder","");
}else{
if(strFieldValue.equals(tools.getParamValue("sortProperty"))){
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc492374731' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc492374731' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc492374731' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
} 
tools.appendString("class='highlight-ele  pointerStyle "); if(tools.getParamValueCSF("sortProperty").equals(".pyToggleIdentifier")){tools.appendParamCSF("sortType"); } tools.appendString("'  title= '");  if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))) { tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText")) + " "); } tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Click to sort by", StreamBuilder.FMT_NORMAL)); tools.appendString("'>");if(pzAuto.getBrowserUtils().isIE() && ("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder")))){tools.appendString("<span id='titleDesc492374731' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}tools.appendString("</span>");
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPage_pxResultsL6 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyToggleIdentifier2").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleIdentifier2").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleIdentifier2").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle492374731\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyToggleIdentifier2").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleIdentifier2").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleIdentifier2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle492374731\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyToggleIdentifier2").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleIdentifier2").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleIdentifier2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyToggleIdentifier2").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleIdentifier2").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleIdentifier2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyToggleIdentifier2").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleIdentifier2").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleIdentifier2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
public void repeatingHeaderCell_1() {
	...
	int lastDotIndex = 0;
	dataPropClass = "Data-Admin-Toggle";
	dataColumnProp = "pyToggleType";
	bSecured = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().isPropertySecured(dataPropClass, dataColumnProp,tools);
	
	String sortImgHTML = "";
	String sortNoHTML = "";
	String strFieldValue = ".pyToggleType";
		tools.appendString("<th title='");
		 tools.appendString(tools.getLocalizedTextForString("pyCaption", "Click to sort by" ,StreamBuilder.FMT_NORMAL)); tools.appendString("'  ");
try {
tools.appendString(" role='columnheader' aria-label='App context' ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("201612080751570865422202") + " ");
		...
		tools.appendString(" title= '");  if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))) { tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText")) + " "); } tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Click to sort by", StreamBuilder.FMT_NORMAL)); tools.appendString("'");
		if(!bSecured){
		tools.appendString(" bSortable = 'true' sortField = '.pyToggleType' ");
		}
		if(!bSecured){
		tools.appendString(" pyShowFilterUIBy = 'value'  bformattedControl ='true'");
		}
		tools.appendString("  style='");
		tools.appendString("height:24px;");tools.appendString("width:"); if(!tools.getParamValueCSF("PpxResults1colWidthCache1").equals("")) { tools.appendParamCSF("PpxResults1colWidthCache1");} else { tools.appendString("9.533468559837727"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:22px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc855647906'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString(tools.getLocalizedTextForString("pyCaption", "App context", StreamBuilder.FMT_LITERAL));if(!pzAuto.getBrowserUtils().isIE()){
									tools.appendString("</div>");}if(!bSecured){if("".equals(tools.getParamValue("sortProperty"))){ 
tools.putParamValue("columnSortOrder","");
}else{
if(strFieldValue.equals(tools.getParamValue("sortProperty"))){
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc855647906' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc855647906' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc855647906' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
} 
tools.appendString("class='highlight-ele  pointerStyle "); if(tools.getParamValueCSF("sortProperty").equals(".pyToggleType")){tools.appendParamCSF("sortType"); } tools.appendString("'  title= '");  if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))) { tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText")) + " "); } tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Click to sort by", StreamBuilder.FMT_NORMAL)); tools.appendString("'>");if(pzAuto.getBrowserUtils().isIE() && ("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder")))){tools.appendString("<span id='titleDesc855647906' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}tools.appendString("</span>");
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPage_pxResultsL6 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyToggleType1").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleType1").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleType1").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle855647906\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyToggleType1").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleType1").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleType1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle855647906\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyToggleType1").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleType1").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleType1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyToggleType1").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleType1").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleType1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPage_pxResultsL6!=null && !gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPageValue("pyToggleType1").isEmpty() && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleType1").getStringValue("pyFilterCriteriaType")!="" && gFCritPage_pxResultsL6.getProperty("pyColumnFilterCriteria").getPropertyValue("pyToggleType1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_23","pyGridPaginator", secInfo);
}
...
sectionBodyIncludeInCell_2(false,false,"","pyGridPaginator");elementModel_1("pyGridPaginator","pzListToggles","BAR","");
 } 
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_22","pzListTogglesFilter", secInfo);
}
...
public void sectionIncludeInCell_pzListTogglesFilter_1(){

sectionBodyIncludeInCell_1(false,false,"","pzListTogglesFilter");elementModel_1("pzListTogglesFilter","pzListToggles","","");
 } 
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("SUB_SECTION","pzListTogglesFilter",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "width:86%;",false,"","");sectionIncludeInCell_pzListTogglesFilter_1(); pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("SUB_SECTION","pyGridPaginator",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead gridActionAlignRight","dataLabelWrite gridActionAlignRight"), "width:13%;",false,"","");sectionIncludeInCell_pyGridPaginator_1(); pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>\n\n\t\t\t\t\t\t</div>");
 } 
public void pzSetExpandParam_4() {
pzSection.getLayout().setExpandParam("SubSectionpzListTogglesBBBB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpzListTogglesBBBB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pxResultsL6=null;

 Map selUniqMap_pxResultsL6 = null;

 Set filteredIndicesSet_pxResultsL6 = null;

	 String strFCPage = "pyFilterCriteria_"+tools.getStepPage().getReference()+".pxResults_pzListToggles_1";
...
gFCritPage_pxResultsL6=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));

  selUniqMap_pxResultsL6 = null; // reset the variable

 if(gFCritPage_pxResultsL6 != null){ 

 		 filteredIndicesSet_pxResultsL6 = pega_uiengine_uiengine.pzPopulateFilteredindicesMap(gFCritPage_pxResultsL6, ".pxResults");

 		 tools.getParameterPage().put("filteredIndicesSet", filteredIndicesSet_pxResultsL6);

 tools.putParamValue("populateSelectedUIValues", "true");

 		 selUniqMap_pxResultsL6 = pega_uiengine_uiengine.pzPopulateSelectedValues(gFCritPage_pxResultsL6); 

 		 tools.getParameterPage().put("selUniqMap_pxResultsL6", selUniqMap_pxResultsL6);

 tools.putParamValue("populateSelectedUIValues", "");

 }
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pxResults");tools.appendString("_pzListToggles_1'");
...
pageListProp = tools.getProperty(".pxResults");
 ...
 tools.putParamValue("PageListProperty",".pxResults");}
...
ClipboardProperty propActivePrev = tools.getActive(); 
	...
	Iterator itr = tools.getProperty(".pxResults").iterator();
		Set filteredResultsSet = new HashSet();
			while(itr.hasNext()){
				...
				if(gFCritPage_pxResultsL6!= null){
				bFilterResult = pega_uiengine_uiengine.pzMatchesGridFilterCriteria(gFCritPage_pxResultsL6, selUniqMap_pxResultsL6);
				}
				if(bFilterResult){
 			 ...
 			 if (gFCritPage_pxResultsL6== null || bFilterResult) {
 ...
 if(pageListProp==null && !Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) {
 	   ...
 	   int totalRecords = 0; 
					...
					tools.appendString("<div  id='PEGA_GRID_SKIN' class='Default_Multi_Breakpoint'>");
					}
...
public void gridCentreLayout_1() {/*gridCentreLayout*/
					...
					selUniqMap_pxResultsL6 = null; // reset the variable
					gFCritPage_pxResultsL6=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));
							 selUniqMap_pxResultsL6 = (Map)tools.getParameterPage().getObject("selUniqMap_pxResultsL6");
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pxResults");
					...
					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList='.pyToggleType .pyToggleIdentifier .pyDescription .pxCreateOperator .pyToggleStatus .pyTemplateInputBox .pyTemplateInputBox .pyTemplateInputBox  ' class='yui-skin-sam gPercent");
					...
					tools.appendString("' gPropIndex='PpxResults1' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201702010106240676790-layout") + " ");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpxResults1colWidthGBL\" id=\"PpxResults1colWidthGBL\" value=\"");
					...
					tools.appendString(tools.getParamValueCSF("PpxResults1colWidthGBL"));tools.appendString("\" />");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpxResults1colWidthGBR\" id=\"PpxResults1colWidthGBR\" value=\"");
					...
					tools.appendString(tools.getParamValueCSF("PpxResults1colWidthGBR"));
					...
					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");
					 ...
					 if(!("".equals(tools.getParamValue("PpxResults1colWidthGBR") ))) { tools.appendString("resizedTable"); } 
...
tools.appendString(".pxResults");
					...
					tools.appendString("' PL_PROP_CLASS='Data-Admin-Toggle' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pxResults").iterator(); 
					...
					Set filteredResultsSet = (HashSet)tools.getParameterPage().getObject("filteredResultsSet");boolean bFilterResult = false;
										 ...
										 } else if(gFCritPage_pxResultsL6!= null){ 
													 bFilterResult = pega_uiengine_uiengine.pzMatchesGridFilterCriteria(gFCritPage_pxResultsL6, selUniqMap_pxResultsL6);
										 }
										 if (gFCritPage_pxResultsL6== null || 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals(".pxResults")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodes.pxResults1") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 
					...
					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle(".pxResults"); } catch (Exception ex) { }
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201702010106240676790-" + rowTestID) + " ");
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"8\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("Data-Admin-Toggle", "tempNoRespg");
					...
					tools.appendString(tools.getLocalizedTextForString("pyCaption","GridNoResultsOnLoad"));
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pxResults1") && tools.getParamValue("partialRefresh").equals("false")) {
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		actionRequestD.registerFixedParameter("pyModelName","pzInitializeToggle");
			String usingPageString = "";
			usingPageString = pzAuto.getUIComponentRuntime().generateActionTokenForPage();
			tools.appendString("[\"runDataTransform\", [\"pzInitializeToggle\", \"=");
			...
			pzPackageRuntime.packageDataTransform(contextClass, "pzInitializeToggle");
			}
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }				{
					StringMap keyMap = new HashStringMap();
					keyMap.putString("pxObjClass", "Rule-Obj-FlowAction");
					keyMap.putString("pyActionName", "pzCreateToggle");
					String strLAClassName = "";
					String offlineUsingPage = "pyToggle";
					strLAClassName = "Data-Admin-Toggle";
					keyMap.putString("pyClassName", strLAClassName);
					ParameterPage newParamsPage = new ParameterPage();
					newParamsPage.putString("pyFlowActionPurpose", "GETSTREAMTYPE");
					try { tools.doAction(keyMap, tools.getStepPage(), newParamsPage); } catch(Exception e) { oLog.error(e.getMessage()); }
					...
					if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
					pzPackageRuntime.packageLocalAction("pzCreateToggle", offlineUsingPage , strLAClassName);
					pzPackageRuntime.packageSection("pzModalTemplate", offlineUsingPage , strLAClassName, true);
					}catch(Exception e1){oLog.error("Error generating local action package - " + e1.getMessage());}
					if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
						try{
							...
							if(streamType.equals("")) { streamType = "Rule-Obj-FlowAction"; }
							String usingPage = "pyToggle";
							if(("").equals(usingPage)) { usingPage = tools.getStepPage().getReference(); }
							if("true".equals(bHasPrivilege )) {
								tools.appendString("[\"processAction\", [\"pzCreateToggle\",\"true\",\":event\",\"pyToggle\",\""+streamType+"\",\"\",\"pzModalTemplate\",\"%7B%22isCustomMobileAnim%22%3A%22true%22%2C%22desktop%22%3A%7B%22reveal%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22none%22%2C%22speed%22%3A%22default%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%2C%22mobile%22%3A%7B%22reveal%22%3A%7B%22ease%22%3A%22standard%22%2C%22effect%22%3A%22anim-offbottom-open%22%2C%22speed%22%3A%22default%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
								} else {
									tools.appendString("[\"processAction\", [\"You are not authorized to perform this Flow or Local action\"]");
									}
									}
											...
											com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
												...
												if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
													try{
														...
														refreshActionRequest.registerFixedParameter("pyActivity", "ReloadSection");
														refreshActionRequest.registerFixedParameter("SectionName", "ListToggles");
														staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
														staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzListToggles"));
														staticURLStr.append("&PreDataTransform=pzGetListOfAvailableToggles");
														tools.appendString("[\"refresh\", [\"thisSection\",\"ListToggles\", \"\", \"");
														refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
														tools.appendString("=\", \"\", \"pzGetListOfAvailableToggles,");
														refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
														preDTParamStr.append((!"".equals(preDTParamStr.toString())?",":"") + "\"decoy\":\"\"");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20161124045146097462916") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzListToggles_$CTX$_5");
		String repeatIndx = "";
	String pyTooltip = "";
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Create new toggle\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Create new toggle", ".pyButtonLabel");
	}
	pyLabel = "Create new toggle";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzListToggles_"+ referenceString+ "_5'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20161124045146097462916") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	{
		com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Create new toggle".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		tools.appendString("<span class='pzbtn-label'  data-click='.' ");}if(bOptimizedMarkup && hasLineBreaks){
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Create new toggle",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o1! wxpzDisableToggleCreation","!pzDisableToggleCreation","cell", "visible" )) {
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20161124045146097462916-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxpzDisableToggleCreation",pxUniqueStreamHash+"_18");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_18");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","!pzDisableToggleCreation");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Pega-Landing-System-ToggleManagement");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpzDisableToggleCreation", pxUniqueStreamHash+"_18"); 
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzListTogglesBBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20231013175902063451") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzListTogglesBBB";
...
if(( pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_21")) ){pzLayout_3();
}
pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
 tools.putSaveValue("ContainerID", "");tools.appendString("</div>");
	index++;
...
pzSection.getLayout().setExpandParam("SubSectionpzListTogglesBB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202307210950520418975") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
	...
	String paramName = "EXPANDEDSubSectionpzListTogglesBB";
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("Paragraph","pzToggleDescription",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-paragraph item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   flex '  STRING_TYPE='paragraph' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
	...
	if( pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y' && pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		...
		keys.putString("pyStreamName","pzToggleDescription" );
		...
		try{
			...
			if(m.find()){
				tools.appendString("<span style=display:none;  " + pzCell.getTestIdIfEnabled("20160527111704080783960") + " ></span>");
				keys.putString("pxObjClass", "Rule-HTML-Paragraph");
				keys.putString("pyStreamName","pzToggleDescription" );
			...
			catch(DatabaseException e){oLog.error("ENGIN API:Could not found Paragraph rule - Pega-Landing-System-ToggleManagement!pzToggleDescription ", e);}
		}else{
			tools.appendString("<span style=display:none;  " + pzCell.getTestIdIfEnabled("20160527111704080783960") + " ></span>");
			keys.putString("pxObjClass", "Rule-HTML-Paragraph");
			keys.putString("pyStreamName","pzToggleDescription" );
...
public int simpleLayoutTemplateCell_1( int index) {
			...
			pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20160527111704080783960-Label")).append(" ").toString().replace("data-test-id=","").trim());
			pgCells.put("spanClass","iconRequired standard_iconRequired");
			pgCells.put("cstmreqfor",pyCustomRequireFormat);
			if(!StringUtils.isBlank(expressionId)) 
			pgCells.put("pyExpressionId",expressionId);
			...
			boolean isOffline = false;
			cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
			String inspectorData=pzCell.getInspectorDataDynamic("Paragraph","pzToggleDescription",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
			if(!inspectorData.isEmpty()) {
			pgCells.put("liveUI",inspectorData);
			}
			boolean nonTemplateBegin = true;
			if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
				 nonTemplateBegin = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_12");
				}
				if(nonTemplateBegin){
				StringMap keys = new HashStringMap();
				if( pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y' && pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
...
pzSection.getLayout().setExpandParam("SubSectionpzListTogglesB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202307210950520411208") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-inline content-inline " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzListTogglesB";
	metadataPage.put("paramName", paramName);
...
if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8")){pzLayoutBodyWrapper_1();
}pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
tools.putSaveValue("rowClass","");
}
...
public void repeatingDataCell_11() {
	...
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");if(pzAuto.handleEvaluateWhen(" axpzCanDeleteToggle","pzCanDeleteToggle", "cell", "visible" )) {pxIcon_2(); } 
									tools.appendString("</DIV>"); } else { if(pzAuto.handleEvaluateWhen(" axpzCanDeleteToggle","pzCanDeleteToggle", "cell", "visible" )) {pxIcon_2(); } }
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
} 
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_5")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
	 ...
	 String securedPropValue = null;
		...
		tools.appendFormatted("faa0a3cb-b03e-46f4-a2ff-eec5152686a3",StreamBuilder.FMT_NORMAL);tools.appendString("\",\"");
...
public void repeatingDataCell_9() {
	...
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");generateClientWhenDiv_1();pxLink_3();
									tools.appendString("</div>");
									tools.appendString("</DIV>"); } else { generateClientWhenDiv_1();pxLink_3();
									tools.appendString("</div>");}
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_4")){
		 String referenceString = tools.getStepPage().getReference();
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzListToggles_"+ referenceString+ "_39'";
...
public void repeatingDataCell_8() {
	...
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");if(pzAuto.handleEvaluateWhen(" axpzCanDeleteToggle","pzCanDeleteToggle", "cell", "visible" )) {pxIcon_1(); } 
									tools.appendString("</DIV>"); } else { if(pzAuto.handleEvaluateWhen(" axpzCanDeleteToggle","pzCanDeleteToggle", "cell", "visible" )) {pxIcon_1(); } }
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
} 
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_2")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
	 ...
	 String securedPropValue = null;
		...
		tools.appendFormatted("be5da2f6-84f6-4f80-be89-121a643b0d49",StreamBuilder.FMT_NORMAL);tools.appendString("\",\"");
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyTrimmedWhenRuleName,.pyIsWhenEnabled\"  SHOW_WHEN=\".pyIsWhenEnabled && .pyTrimmedWhenRuleName != ''\"");
if(pzAuto.evaluateWhen(".pyIsWhenEnabled && .pyTrimmedWhenRuleName != ''",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyTrimmedWhenRuleName", -1);
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyIsWhenEnabled", -1);
	}
}catch(Exception e){}
}
public void repeatingDataCell_6() {
	...
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");generateClientWhenDiv_1();pxLink_1();
									tools.appendString("</div>");
									tools.appendString("</DIV>"); } else { generateClientWhenDiv_1();pxLink_1();
									tools.appendString("</div>");}
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
...
public void pxDisplayText_5() {String key="36||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT";
...
public void repeatingDataCell_5() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxDisplayText",".pyToggleStatus", ".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(5)")); tools.appendString("headers='a5'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:25px;'");}tools.appendString("class='");
...
public void pxDisplayText_4() {String key="35||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","true");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
public void repeatingDataCell_4() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxDisplayText",".pxCreateOperator", ".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(4)")); tools.appendString("headers='a4'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:25px;'");}tools.appendString("class='");
	tools.appendString(pzSection.getCustomStyle(true,"","dataValueRead",""));tools.appendString(" gridCell");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");if(pzAuto.handleEvaluateWhen(" o2!= rx.pxCreateOperator cq",".pxCreateOperator!=\'\'", "cell", "visible" )) {pxDisplayText_4(); } 
									tools.appendString("</DIV>"); } else { if(pzAuto.handleEvaluateWhen(" o2!= rx.pxCreateOperator cq",".pxCreateOperator!=\'\'", "cell", "visible" )) {pxDisplayText_4(); } }
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
} 
...
public void pxDisplayText_3() {String key="34||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","true");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
public void repeatingDataCell_3() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxDisplayText",".pyDescription", ".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(3)")); tools.appendString("headers='a3'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:25px;'");}tools.appendString("class='");
	tools.appendString(pzSection.getCustomStyle(true,"","wrap","wrap"));tools.appendString(" gridCell");tools.appendString("  wrapText");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");if(pzAuto.handleEvaluateWhen(" o2!= rx.pyDescription cq",".pyDescription!=\'\'", "cell", "visible" )) {pxDisplayText_3(); } 
									tools.appendString("</DIV>"); } else { if(pzAuto.handleEvaluateWhen(" o2!= rx.pyDescription cq",".pyDescription!=\'\'", "cell", "visible" )) {pxDisplayText_3(); } }
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
} 
...
public void pxDisplayText_2() {String key="33||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","true");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
public void repeatingDataCell_2() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxDisplayText",".pyToggleIdentifier", ".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)")); tools.appendString("headers='a2'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:25px;'");}tools.appendString("class='");
	tools.appendString(pzSection.getCustomStyle(true,"","dataValueRead",""));tools.appendString(" gridCell");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>");if(pzAuto.handleEvaluateWhen(" o2!= rx.pyToggleIdentifier cq",".pyToggleIdentifier!=\'\'", "cell", "visible" )) {pxDisplayText_2(); } 
									tools.appendString("</DIV>"); } else { if(pzAuto.handleEvaluateWhen(" o2!= rx.pyToggleIdentifier cq",".pyToggleIdentifier!=\'\'", "cell", "visible" )) {pxDisplayText_2(); } }
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
} 
...
public void pxDisplayText_1() {String key="32||RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","true");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
public void repeatingDataCell_1() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxDisplayText",".pyToggleType", ".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
	tools.appendString("height:27px;");tools.appendString(""); tools.appendString("'class='");
	...
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
									tools.appendString("<DIV class='oflowDivM '>"); if(tools.getIfPresent("pyRowStatus") != null){ tools.appendProperty(tools.getProperty(".pyRowStatus"),"Messages",false); }if(pzAuto.handleEvaluateWhen(" o2!= rx.pyToggleType cq",".pyToggleType!=\'\'", "cell", "visible" )) {pxDisplayText_1(); } 
									tools.appendString("</DIV>"); } else {  if(tools.getIfPresent("pyRowStatus") != null){ tools.appendProperty(tools.getProperty(".pyRowStatus"),"Messages",false); }if(pzAuto.handleEvaluateWhen(" o2!= rx.pyToggleType cq",".pyToggleType!=\'\'", "cell", "visible" )) {pxDisplayText_1(); } }
	tools.putParamValue("pega_RLindex","");
	if(!bSuppressTD){ 
tools.appendString("</td>");
} 
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pxResults1")|| tools.getParamValue("partialTrigger").equals("editRow.pxResults1") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pxResults");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pxResults1")) {
 ...
 if(tools.getParamValue("partialTrigger").equals("filterpopup.pxResults1")) { 
			...
			int dynamicColumnIndex = tools.getParamAsInteger(ImmutablePropertyInfo.TYPE_INTEGER, "dynamicColumnIndex");
			 ...
			 if(subScriptForColumn.equals("pyToggleType1") && strCellType.equals("static")) { 
			 ...
			 if(subScriptForColumn.equals("pyToggleIdentifier2") && strCellType.equals("static")) { 
			 ...
			 if(subScriptForColumn.equals("pyDescription3") && strCellType.equals("static")) { 
			 ...
			 if(subScriptForColumn.equals("pxCreateOperator4") && strCellType.equals("static")) { 
			 ...
			 if(subScriptForColumn.equals("pyToggleStatus5") && strCellType.equals("static")) { 
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pxResults1") ){
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Pega-Landing-System-ToggleManagement");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzListToggles");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZLISTTOGGLES #20231113T211337.048 GMT", "Pega-Landing-System-ToggleManagement pzListToggles", "Pega-Desktop", "08-23-02", "20231113T211337.048 GMT");
}
