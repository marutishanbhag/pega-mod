...
/**
 * Builds JSP stream RULE-APPLICATION!PZCREATEAPPSETTINGSFORRENDERING.
 */
public class ra_stream_pzcreateappsettingsforrendering_b4170fbc3f0a5ae4ff7180f682e6927a extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzCreateAppSettingsForRendering.Rule_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 2079725152;
 ...
 */
	public ra_stream_pzcreateappsettingsforrendering_b4170fbc3f0a5ae4ff7180f682e6927a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "f0c6537c7330fb30a11565e4a7d9e2b12b5a3565";
...
{
/* Instance RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT	Pega-ProcessArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "f0c6537c7330fb30a11565e4a7d9e2b12b5a3565";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzCreateAppSettingsForRendering",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZCREATEAPPSETTINGSFORRENDERING", 
	"Rule-Obj-Property:PYISCONSTELLATIONAPP", 
	"Rule-Obj-Property:PYROUTINGTABLEUPDATESTATUS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCREATEAPPSETTINGSFORRENDERING","Rule-HTML-Section","RULE-APPLICATION",false,"","Pega-ProcessArchitect","08-23-01","RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT","!PZCREATEAPPSETTINGSFORRENDERING",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",2079725152), 
		new DependentRuleInfo("PYISCONSTELLATIONAPP","Rule-Obj-Property","RULE-APPLICATION",true,"Rule-Application","Pega-AppDefinition","08-04-01","RULE-OBJ-PROPERTY RULE-APPLICATION PYISCONSTELLATIONAPP #20190829T093214.215 GMT","!PYISCONSTELLATIONAPP",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYROUTINGTABLEUPDATESTATUS","Rule-Obj-Property","RULE-APPLICATION",true,"Rule-Application","Pega-RULES","08-05-01","RULE-OBJ-PROPERTY RULE-APPLICATION PYROUTINGTABLEUPDATESTATUS #20200518T131714.906 GMT","!PYROUTINGTABLEUPDATESTATUS",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYTEMPLATEINPUTBOX","Rule-Obj-Property","@BASECLASS",true,"Rule-Application","Pega-UIDesign","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT","!PYTEMPLATEINPUTBOX",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT:20230618T001738.912 GMT
//	RULE-HTML-PROPERTY PXRADIOBUTTONS #20190131T183501.652 GMT:20190131T183501.652 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYISCONSTELLATIONAPP #20190829T093214.215 GMT:20190829T093214.215 GMT
...
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYROUTINGTABLEUPDATESTATUS #20200518T131714.906 GMT:20200518T131714.906 GMT
//	RULE-HTML-PROPERTY PXHIDDEN #20180713T133435.722 GMT:20180713T133435.722 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYROUTINGTABLEUPDATESTATUS #20200518T131714.906 GMT:20200518T131714.906 GMT
//	RULE-HTML-PROPERTY PXICON #20190131T183501.575 GMT:20190131T183501.575 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "2bde89867b3dc1490c0fb23bba3e16d4";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzCreateAppSettingsForRendering",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzCreateAppSettingsForRendering','insKey':'RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT','sectionType':'standard'}");
pzLayout_8();
...
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("ActionSection", "pzEnableDXAPIButtons");
config.put("NewTaskStatus", "pzEnableDXAPIForUIRendering");
...
config.put("pyActivity", "pxCheckForAvailableRuleset");
config.put("DeferLoadActivity", "pxCheckForAvailableRuleset");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
config.put("pyPreDataTransform.pyName", "");
config.put("reloadType", "multipleSections");
config.put("pyActivity", "pxUpdateRoutingTableWrapper");
...
metadataPage.put("headCustom","padding-0 margin-0");
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzCreateAppSettingsForRenderingB"));
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("UI Runtime", "pyCaption");
...
metadataPage.put("title","UI Runtime");
metadataPage.put("uniqueid", "202602211403200990");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("202006032245510507249") + " ");
...
tools.putParamValue("LAYOUT_METHOD_NAME","simpleLayout_6");if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate() && !"true".equals(tools.getParamValue("pyPegaDesignMode"))) {tools.appendString("<div class='lazyload-layout' data-deferinvoke='simpleLayout_6'>");pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage("pyLoadingMessage");pzAuto.emitIncludeStreamReference("pyLoadingMessage",null,null,"Rule-HTML-Section",null);tools.appendString("</div>");}else{simpleLayout_6();}
}else {
Map<String, Object> loadingSectionInfo = new HashMap<String, Object>();
pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_71", "pyLoadingMessage", loadingSectionInfo);
}
}
...
public void pxDisplayText_3() {String key="29||RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","29"};oCellRuntimeParamsMap.put("29||RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT",paramValues);oControlPathsMap.put("29||RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5)");}
public String 
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"setValue\", [[\"" + pzAuto.getUIComponentRuntime().generateActionToken(".pyRoutingTableUpdateStatus") + "\", \"\", \"\", \"\", \"saving\"]]");
...
try {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(".pyRoutingTableUpdateStatus != ''",pxUniqueStreamHash+"_62");
	...
	pxWhenIdentifiers.put("pyDisabledWhenId",pxUniqueStreamHash+"_62");
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202005120859480662217") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzCreateAppSettingsForRendering_$CTX$_28");
		String repeatIndx = "";
	String pyTooltip = "";
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Generate routing table\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Generate routing table", ".pyButtonLabel");
	}
	pyLabel = "Generate routing table";
	modePage2.put("label",pyLabel);
	String spxUniqueStreamHash63 = getUIActionsMetaData_4();
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzCreateAppSettingsForRendering_"+ referenceString+ "_28'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202005120859480662217") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		tools.appendString("]' ");
			...
			String repeatIndx = "";
		if(com.pega.pegarules.jsptags.WhenTag.evaluateWhen(pega, ".pyRoutingTableUpdateStatus != ''", null, false)){
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Generate routing table".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		...
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Generate routing table",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public void pxDisplayText_2() {String key="27||RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","27"};oCellRuntimeParamsMap.put("27||RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT",paramValues);oControlPathsMap.put("27||RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
...
try {
	...
	cellPage.put("pyStreamName","pzCreateAppSettingsForRendering");
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202005120859480665323") + " ");
	...
	modePage1.put("pyActionStringID",pxUniqueStreamHash+"_53");
	}
	cellPage.addMetadataInArray("pyModes",modePage1);
	cellPage.addMetadataInArray("pyModes",modePage2);
	metadataPage.putMetadata("pyCell",cellPage);
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzCreateAppSettingsForRendering_"+ referenceString+ "_26'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		String classProp = "";
		 classProp ="pi pi-error-filled";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("202005120859480665323") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
public int simpleLayoutCell_11( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing    " + pzSection.getCustomStyle(false, "","margin-0 flex-justify-end","margin-0 flex-justify-end")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_11( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202005120859480665323-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxIcon");
	pgCells.put("forLabel",".pyTemplateGeneric");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","margin-0 flex-justify-end");
	pgCells.put("customRWStyles","margin-0 flex-justify-end");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_12( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_12( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202005150737110028901-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzCreateAppSettingsForRenderingBBBBBBBB","",false);
}
...
public void simpleLayout_4() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202005150535510003851") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + " class='" + "flex  content  layout-content-inline content-inline margin-0 labelError" + "'  " + "role='alert'");
		...
		pg_dlmeta.put("customClassName","margin-0 labelError");
		pg_dlmeta.put("format","inline");
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + "").append("\"").toString();
	...
	String paramName = "EXPANDEDSubSectionpzCreateAppSettingsForRenderingBBBBBBBB";
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}");
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" cffalse", pxUniqueStreamHash+"_58");metadataPage.put("dlChild","true");
...
if(pzAuto.handleEvaluateWhen(" cffalse","false", "layout", "visible" )) {pzSetExpandParam_8();
...
public void pxDisplayText_1() {String key="23||RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","23"};oCellRuntimeParamsMap.put("23||RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT",paramValues);oControlPathsMap.put("23||RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
...
try {
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzCreateAppSettingsForRendering_"+ referenceString+ "_22'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
...
public int simpleLayoutCell_9( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
pzSection.getLayout().setExpandParam("SubSectionpzCreateAppSettingsForRenderingBBBBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	String paramName = "EXPANDEDSubSectionpzCreateAppSettingsForRenderingBBBBBBB";
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rx.pyRoutingTableUpdateStatus cqblocked", pxUniqueStreamHash+"_48");metadataPage.put("dlChild","true");
	metadataPage.put("lMode","SimpleDiv");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2== rx.pyRoutingTableUpdateStatus cqblocked",".pyRoutingTableUpdateStatus = \'blocked\'", "layout", "visible" )) {pzSetExpandParam_7();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
tools.putParamValue("isControlEditableOriginal", true);
	...
	cellPage.put("pyValue",".pyRoutingTableUpdateStatus");
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	cellPage.put("pyID","pyRoutingTableUpdateStatus");
	modePage2.put("pyContent","associated");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("202005121117520755943",true));
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyRoutingTableUpdateStatus");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyRoutingTableUpdateStatus", ".pyCaption");
...
boolean bUITemplatized = pzAuto.getUIComponentRuntime().isTemplateRendering();pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);
	tools.appendString("<input  type=\"hidden\"  " + pzCell.getTestIdIfEnabled("202005121117520755943") + "  id=\"");
		tools.appendString(tools.getHTMLIDForProperty(true,"hidden"));
tools.appendString("\" value=\"");if(bUITemplatized){
	tools.appendString(pzAuto.getUIComponentRuntime().getRuntimeContextTree().generateContextToken("pyRoutingTableUpdateStatus"));}else {
...
public int simpleLayoutCell_7( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_1(".pyRoutingTableUpdateStatus",0,"","","Text");
	return index;
}
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	String reqExpressionId = null;
	String disExpressionId = null;
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_2(".pyRoutingTableUpdateStatus",0,"","","Text");
	index++;
	return index;
}
...
public int simpleLayoutCell_10( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyRoutingTableUpdateStatus cqblocked",".pyRoutingTableUpdateStatus = \'blocked\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_10( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyRoutingTableUpdateStatus cqblocked",pxUniqueStreamHash+"_50");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_50");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyRoutingTableUpdateStatus = 'blocked'");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyRoutingTableUpdateStatus cqblocked", pxUniqueStreamHash+"_50"); 
	}
...
public int simpleLayoutTemplateCell_13( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" cffalse",pxUniqueStreamHash+"_60");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" cffalse", pxUniqueStreamHash+"_60"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_4();
 tools.putSaveValue("ContainerID", "");}
...
public int simpleLayoutCell_14( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_14( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202005120859480662217-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
public int simpleLayoutCell_15( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyRoutingTableUpdateStatus cqsuccess",".pyRoutingTableUpdateStatus == \'success\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_15( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-bottom-spacing remove-right-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202005150601460926379-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyRoutingTableUpdateStatus cqsuccess",pxUniqueStreamHash+"_67");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_67");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyRoutingTableUpdateStatus == 'success'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Application");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_67");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyRoutingTableUpdateStatus cqsuccess", pxUniqueStreamHash+"_67"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5)");
	if(!inspectorData.isEmpty()) {
...
pzSection.getLayout().setExpandParam("SubSectionpzCreateAppSettingsForRenderingBBBBBB","",false);
}
...
public void simpleLayout_5() {
	...
	refreshAttributes +="\""; 
	refreshAttributes += " RWP=\".pyRoutingTableUpdateStatus\" RW=\".pyRoutingTableUpdateStatus Changes\" ";
	String strRWPreActivity = "";
	strRWPreActivity = "pxUpdateRoutingTableWrapper,";
	...
	try{
		if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
			...
			changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyRoutingTableUpdateStatus"), -1);
		}
	}catch(Exception e){}
	IUIComponent cc_dl = null;
	boolean bIsIe = (pzAuto.getBrowserUtils().isIE());
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202005120853110552912") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		try{
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  ".pyRoutingTableUpdateStatus Changes", expressionId);
		expressionId = expression.getId();
		expression.addActivity("refreshWhen", "pxUpdateRoutingTableWrapper", null, null);
		}
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","padding-l-3x");
	...
	String paramName = "EXPANDEDSubSectionpzCreateAppSettingsForRenderingBBBBBB";
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}");
	if(!inspectorLayoutData.isEmpty()) {
	metadataPage.put("liveUI", inspectorLayoutData);
	}
	String pyPrefix = null;
...
pzSection.getLayout().setExpandParam("SubSectionpzCreateAppSettingsForRenderingBBBBB","",false);
}
...
public void simpleLayout_6() {
	...
	keys.putString("pyActivityName", "pxCheckForAvailableRuleset");
	try{
	...
	refreshAttributes += strMethodName;
	refreshAttributes +="\""; 
	refreshAttributes += " RWP=\".pyIsConstellationApp\" RW=\".pyIsConstellationApp Changes || .pyIsConstellationApp = \'true\'\" ";
	String strRWPreActivity = "";
	strRWPreActivity = "pxCheckForAvailableRuleset,";
	...
	try{
		if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
			com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyIsConstellationApp"), -1);
		}
	}catch(Exception e){}
	IUIComponent cc_dl = null;
	boolean bIsIe = (pzAuto.getBrowserUtils().isIE());
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202005180714430602342") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		try{
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  ".pyIsConstellationApp Changes || .pyIsConstellationApp = \'true\'", expressionId);
		expressionId = expression.getId();
		expression.addActivity("refreshWhen", "pxCheckForAvailableRuleset", null, null);
		}
		catch(ClassCastException e){
		expressionId = "";
		}
		if(StringUtils.isBlank(expressionId)) {
			...
			expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pyIsConstellationApp = 'true'",expressionId);
		...
		String paramName = "EXPANDEDSubSectionpzCreateAppSettingsForRenderingBBBBB";
		...
		String pyPrefix = null;
		if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
		metadataPage.put("methodnm", "simpleLayout_6");
		}
		IUIComponent containerComponent = pzAuto.getUIComponent();
		metadataPage.put("dlChild","true");
		metadataPage.put("lMode","SimpleDiv");
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyIsConstellationApp\"  SHOW_WHEN=\".pyIsConstellationApp = 'true'\"");
if(pzAuto.evaluateWhen(".pyIsConstellationApp = 'true'",null,true)){
	if(currentTemplatingStatus =='N')
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyIsConstellationApp", -1);
	}
}catch(Exception e){}
}
...
try {
	...
	modePage1.put("iconSrc","styleclass");
	modePage1.put("pyFormatTypeActionable","none");
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20200603120232030041") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzCreateAppSettingsForRendering_"+ referenceString+ "_13'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
		...
		String classProp = "";
		 classProp ="pi pi-box-check";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("20200603120232030041") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
		tools.appendString("cursordefault ");
		tools.appendString(" icons "+classProp+"' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" alt= ''");
			tools.appendString(" ></i>");
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-top-spacing remove-left-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20200603120232030041-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxIcon");
	pgCells.put("forLabel",".pyTemplateGeneric");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
public int simpleLayoutCell_5( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","","padding-l-0")  + " ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("202006031202320301419")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Use Constellation UI to render landing pages") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("partialClass","remove-bottom-spacing remove-right-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202006031202320301419")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("spanClass","iconRequired _iconRequired");
	pgCells.put("labelReadClass","dataLabelRead");
	pgCells.put("labelWriteClass","dataLabelWrite");
	pgCells.put("customRWStyles","padding-l-0");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	labelName = "Use Constellation UI to render landing pages";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzCreateAppSettingsForRenderingBBBB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202006031202320297901") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		if(StringUtils.isBlank(expressionId)) {
			...
			expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pxUseDXAPI = true && .pyIsConstellationApp == false",expressionId);
			...
			if(!"".equals(strMethodName))
			pg_dlmeta.put("methodnm",strMethodName);
			pg_dlmeta.put("customClassName","padding-0 margin-0 flex-align-end react-comp-checked");
			pg_dlmeta.put("format","inline");
		...
		String paramName = "EXPANDEDSubSectionpzCreateAppSettingsForRenderingBBBB";
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyIsConstellationApp,.pxUseDXAPI\"  SHOW_WHEN=\".pxUseDXAPI = true && .pyIsConstellationApp == false\"");
if(pzAuto.evaluateWhen(".pxUseDXAPI = true && .pyIsConstellationApp == false",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyIsConstellationApp", -1);
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pxUseDXAPI", -1);
	}
}catch(Exception e){}
}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		keyMap.putString("pyActionName", "pzEnableDXAPIForUIRendering");
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
		pzPackageRuntime.packageLocalAction("pzEnableDXAPIForUIRendering", offlineUsingPage , strLAClassName);
		pzPackageRuntime.packageSection("pzEnableDXAPIButtons", offlineUsingPage , strLAClassName, true);
		}catch(Exception e1){oLog.error("Error generating local action package - " + e1.getMessage());}
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("pzCreateAppSettingsForRendering",
				...
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pzEnableDXAPIForUIRendering\",\"true\",\":event\",\"\",\""+streamType+"\",\"\",\"pzEnableDXAPIButtons\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-null%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22effect%22%3A%22anim-null%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
					} else {
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyIsConstellationApp,.pxUseDXAPI\"  SHOW_WHEN=\".pxUseDXAPI = false && .pyIsConstellationApp == false\"");
if(pzAuto.evaluateWhen(".pxUseDXAPI = false && .pyIsConstellationApp == false",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
try {
	...
	modePage2.put("pyName","pzCreateAppSettingsForRendering_$CTX$_10");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Use Constellation UI to render landing pages\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Use Constellation UI to render landing pages", ".pyButtonLabel");
	}
	pyLabel = "Use Constellation UI to render landing pages";
	modePage2.put("label",pyLabel);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzCreateAppSettingsForRendering_"+ referenceString+ "_10'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("202005120859480662217") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Use Constellation UI to render landing pages".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		tools.appendString("<span class='pzbtn-label'  data-click='.' ");}if(bOptimizedMarkup && hasLineBreaks){
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Use Constellation UI to render landing pages",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString("</button>");					}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pxUseDXAPI = false && .pyIsConstellationApp == false", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
	String dataFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
	...
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","react-comp");
	pgCells.put("customRWStyles","react-comp");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
...
pzSection.getLayout().setExpandParam("SubSectionpzCreateAppSettingsForRenderingBBB","",false);
}
...
public void simpleLayout_7() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202006032245510509672") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default padding-0 margin-0 flex-align-end" + "'  " + "role='alert'");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","padding-0 margin-0 flex-align-end");
		pg_dlmeta.put("format","default");
	...
	String paramName = "EXPANDEDSubSectionpzCreateAppSettingsForRenderingBBB";
...
public void inclFormattedVal_2(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {if (isSecuredProp) { tools.putParamValue("proSecurity_isSecuredProp", isSecuredProp);tools.putParamValue("proSecurity_activePropValue", activePropValue);}
		...
		tools.appendString(pega_uiengine_formatter.pxFormatText(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzPopulateAppSettingsForRendering","","","D_pzPopulateAppSettingsForRendering",".pyLabel",".pyIsSelected",true,(PegaStreamAPI)tools),pzAuto.handleEvaluateWhen(" cffalse","false","cell", "disable" ),"","",true,"caption"));
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzPopulateAppSettingsForRendering","","","D_pzPopulateAppSettingsForRendering",".pyLabel",".pyIsSelected",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("isControlEditableOriginal"))) {
		...
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzPopulateAppSettingsForRendering","","","D_pzPopulateAppSettingsForRendering",".pyLabel",".pyIsSelected",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("FORMAT_PLAIN_TXT")) && ((pzAuto.getBrowserUtils().isIE() && !pega_uiengine_harness.pzInStandardsMode()) || "true".equals(tools.getParamValue("fromAPI"))) ){
			tools.appendString("&nbsp;");
			...
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						...
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzCreateAppSettingsForRendering"));
...
tools.appendString("</P>");
	...
	if(isEditable) {
		 tools.putParamValue("REQUIRED_WHEN","");
		 tools.putParamValue("REQUIRED_WHEN_ROC","");String pyListSource = "datapage";
if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'){
	IUIComponentMetadata metadataPage = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata cellPage = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata modePage1 = pzAuto.getUIComponentRuntime().createMetadata();
	...
	String repeatIndx = "";
	IUIComponentMetadata pyUserData = pzAuto.getUIComponentRuntime().createMetadata();
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20141106051811053911753",true));
	cellPage.put("pyValue",".pyIsConstellationApp");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyIsConstellationApp");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyIsConstellationApp", ".pyCaption");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyIsConstellationApp",pxUniqueStreamHash+"_7");
	...
	modePage1.put("pyID","pyIsConstellationApp");
	...
	if(listProperties.containsKey(".pyIsSelected")){
	Set<String> currentPropFieldNames = (Set<String>)listProperties.get(".pyIsSelected");
	listProperties.put(".pyIsSelected",currentPropFieldNames);
	}else{
	Set<String> fieldNames = new HashSet<String>();
	listProperties.put(".pyIsSelected",fieldNames);
	}
	modePage1.put("pyResultsUniqueID",pxUniqueStreamHash+"_8");
	modePage1.put("pySourceName","D_pzPopulateAppSettingsForRendering");
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
	tools.findPage("D_pzPopulateAppSettingsForRendering");
	}
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadDataPage("D_pzPopulateAppSettingsForRendering", listProperties, pxUniqueStreamHash+"_8", sourceDPParams);
	tools.putParamValue("bListOptionsLocalize","");
	modePage1.put("pyValue",".pyIsSelected");
	...
	modePage2.put("pySourceName","D_pzPopulateAppSettingsForRendering");
	modePage2.put("pyPrompt",".pyLabel");
	modePage2.put("pyValue",".pyIsSelected");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20141106051811053911753",true));
	String pyValueR = "";
	String pyValueOrig = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyIsConstellationApp");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyIsConstellationApp", ".pyCaption");
	pyValueR = ".pyIsConstellationApp";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyIsConstellationApp");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyIsConstellationApp", ".pyCaption");
	pyValueOrig = ".pyIsConstellationApp";
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_10");}if(beginNonTemplate){					String strClassName = "Rule-Application";
					String pageName ="D_pzPopulateAppSettingsForRendering";
					...
					if (cbpResults!= null && cbpResults.size() > 0) {
						...
						for (int k = 0; k < iListSize; k++) {
							...
							try{
								...
								try{
								radioValue=cbpRow.getStringIfPresent(".pyIsSelected");
							}catch(Exception ex){}
...
strCells[i][j] += strReferenceName;strCells[i][j] += "'"; radiogrpName = strReferenceName; 								strCells[i][j] += "aria-describedby='" + radiogrpName + "Error' ";
								...
								tools.appendString("<div class='radioTable wrap-radio-labels"+errorClass+"' role='radiogroup'  " + pzCell.getTestIdIfEnabled("20141106051811053911753") + "  aria-label='");
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("20141106051811053911753") + " ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_11")){inclFormattedVal_2(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxRadioButtons",".pyIsConstellationApp",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","padding-0 margin-0","padding-0 margin-0")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxRadioButtons_1(".pyIsConstellationApp",0,"","","True-False");
	tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20141106051811053911753-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxRadioButtons");
	pgCells.put("forLabel",".pyIsConstellationApp");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","padding-0 margin-0");
	pgCells.put("customRWStyles","padding-0 margin-0");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxRadioButtons",".pyIsConstellationApp",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxRadioButtons_1(".pyIsConstellationApp",0,"","","True-False");labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpzCreateAppSettingsForRenderingBB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201802221514370963273") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  layout-content-stacked content-stacked padding-0 margin-0" + "'  " + "role='alert'");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","padding-0 margin-0");
	...
	String paramName = "EXPANDEDSubSectionpzCreateAppSettingsForRenderingBB";
	metadataPage.put("paramName", paramName);
	...
	metadataPage.put("dlChild","true");
	metadataPage.put("lMode","Flexbox");
	metadataPage.put("contCustom","padding-0 margin-0");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
	pzLayoutBody_1();
	containerComponent.endComponent();
	}
...
sectionDefaultValues_1() {
	...
	if(pzAuto.handleEvaluateWhen(" o2== rx.pyIsConstellationApp cq",".pyIsConstellationApp", "cell", "active" )) {
		 tools.getProperty(".pyIsConstellationApp").setValue(false);if (pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'){String tempDefault=tools.getProperty(".pyIsConstellationApp").toString();
		 tools.getProperty(".pyIsConstellationApp").setValue("");pzAuto.getUIComponentRuntime().getRuntimeContextTree().addDefaultValue(".pyIsConstellationApp",tempDefault);}
}
...
pzSection.getLayout().setExpandParam("SubSectionpzCreateAppSettingsForRenderingB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpzCreateAppSettingsForRenderingB";
...
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","UI Runtime");
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel7083' data-layout-id='202602211403200894" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel7083'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzCreateAppSettingsForRenderingB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_8() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202006032245510507249") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString(" class='" + "flex  content  layout-content-inline_grid_double content-inline_grid_double react-app-setting" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","react-app-setting");
	...
	String paramName = "EXPANDEDSubSectionpzCreateAppSettingsForRenderingB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzCreateAppSettingsForRendering");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-APPLICATION PZCREATEAPPSETTINGSFORRENDERING #20230618T001738.912 GMT", "Rule-Application pzCreateAppSettingsForRendering", "Pega-ProcessArchitect", "08-23-01", "20230618T001738.912 GMT");
}
