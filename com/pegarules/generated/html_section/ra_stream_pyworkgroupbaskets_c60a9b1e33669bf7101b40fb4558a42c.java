...
/**
 * Builds JSP stream DATA-PORTAL!PYWORKGROUPBASKETS.
 */
public class ra_stream_pyworkgroupbaskets_c60a9b1e33669bf7101b40fb4558a42c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyWorkGroupBaskets.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 770731418;
 ...
 */
	public ra_stream_pyworkgroupbaskets_c60a9b1e33669bf7101b40fb4558a42c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "4c094ca80186231638e90f3549d851bf1a5574a3";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPBASKETS #20180713T134755.650 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "4c094ca80186231638e90f3549d851bf1a5574a3";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyWorkGroupBaskets",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPBASKETS #20180713T134755.650 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPBASKETS #20180713T134755.650 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPBASKETS #20180713T134755.650 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYWORKGROUPBASKETS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYWORKGROUPBASKETS","Rule-HTML-Section","DATA-PORTAL",false,"","Pega-EndUserUI","08-01-01","RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPBASKETS #20180713T134755.650 GMT","!PYWORKGROUPBASKETS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",770731418), 
...
//	RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPBASKETS #20180713T134755.650 GMT:20180713T134755.650 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "dc9658234b6621b29a27ba827e205bfd";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyWorkGroupBaskets",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyWorkGroupBaskets','insKey':'RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPBASKETS #20180713T134755.650 GMT','sectionType':'standard'}");
...
config.put("StaticDataTransformParams", "Basket=true");
...
config.put("NewTaskStatus", "pyWorkGroupBasketsShowAll");
...
try {
tools.appendString("(");
out.print(tools.findPage("D_pyWorkbasketsInMyWorkGroup").getString("pxResultCount"));
tools.appendString(")");
} catch(Throwable t) {
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		keyMap.putString("pyActionName", "pyWorkGroupBasketsShowAll");
		...
		try{
		pzPackageRuntime.packageLocalAction("pyWorkGroupBasketsShowAll", offlineUsingPage , strLAClassName);
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("pyWorkGroupBaskets",
				...
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pyWorkGroupBasketsShowAll\",\"true\",\":event\",\"\",\""+streamType+"\",\"fixed_sized_modal\",\"pzModalTemplate\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-null%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22effect%22%3A%22anim-null%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
					} else {
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20160219061459008123853",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pyWorkGroupBaskets_$CTX$_23");
		String repeatIndx = "";
	modePage2.put("styles","Strong");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Click here to see all members\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Click here to see all members", ".pyActionPrompt");
	}
	pyTooltip = "Click here to see all members";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyWorkGroupBaskets_"+ referenceString+ "_23'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20160219061459008123853") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Click here to see all members\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20160219061459008123853-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("partialClass","remove-bottom-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20160219061459008224359")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkGroupBasketsBB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpyWorkGroupBasketsBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2> rxD_pyWorkbasketsInMyWorkGroup.pxResultCount ci10", pxUniqueStreamHash+"_12");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if(pzAuto.handleEvaluateWhen(" o2> rxD_pyWorkbasketsInMyWorkGroup.pxResultCount ci10","D_pyWorkbasketsInMyWorkGroup.pxResultCount > 10", "layout", "visible" )) {pzSetExpandParam_2();
...
public void repeatingDataCell_3() {
	...
	tools.appendString("'  ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("SUB_SECTION","pyWorkBasketDetail", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString(" class='");
	...
	tools.appendString("height:30px;");if(Integer.parseInt(tools.getSaveValue("rowsDisplayed")) == 1) {tools.appendString("width:"); if(!tools.getParamValueCSF("D_pyWorkbasketsInMyWorkGroupPpxResults1colWidthCache1").equals("")) { tools.appendParamCSF("D_pyWorkbasketsInMyWorkGroupPpxResults1colWidthCache1");} else { tools.appendString("auto;"); }}tools.appendString(""); tools.appendString("'>");
...
public void repeatingDataCell_2() {
	...
	String strFieldValue = "";
		tools.appendString("<td title='");
		tools.appendString("'    ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20160219061459007711333") + " ");
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("height:21px;");tools.appendString("width:"); if(!tools.getParamValueCSF("D_pyWorkbasketsInMyWorkGroupPpxResults1colWidthCache1").equals("")) { tools.appendParamCSF("D_pyWorkbasketsInMyWorkGroupPpxResults1colWidthCache1");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkGroupBasketsB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpyWorkGroupBasketsB";
...
if (tmpDeclarePageParams != null && tmpDeclarePageParams.getProperty("D_pyWorkbasketsInMyWorkGroup_pxResults_pyWorkGroupBaskets_1") != null) {
ClipboardPage paramList = tmpDeclarePageParams.getProperty("D_pyWorkbasketsInMyWorkGroup_pxResults_pyWorkGroupBaskets_1").getPageValue();
...
oLog.error("ReloadSections:Expection : "+e.getMessage());
 ...
 ClipboardPage gFCritPageD_pyWorkbasketsInMyWorkGroup_pxResultsL3=null;

 Map selUniqMapD_pyWorkbasketsInMyWorkGroup_pxResultsL3 = null;
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_pyWorkbasketsInMyWorkGroup.pxResults").getReference());tools.appendString("_pyWorkGroupBaskets_1'");
tools.appendString(" hashed-dp-page='");
if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_pyWorkbasketsInMyWorkGroup.pxResults").getReference());tools.appendString("' bRowHovering='true' deferLoadAct='' class=\"");
...
tools.appendString(" fixedRow='false' fixedCol='false' bValueList='false' bPageGroup='false' appendAct='' deleteAct='' bTree='false' repeatType='row' editConfig='readOnly' editFormat='' template-name='' bGrid='true' bDragDrop='false' bTreegrid='false' bSorting='false' bReportDefinition='false' bLoadActivity='false' bDataObject='true' bCBOptimize='true' DPSectionID=\"SubSectionpyWorkGroupBasketsB\"  openOnDblClick='false' OAFunc='openRuleByKeys' ");
D_pyWorkbasketsInMyWorkGroup_pxResults_1();
tools.appendString(">");
...
if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) {
 ...
 pageListProp = tools.getProperty("D_pyWorkbasketsInMyWorkGroup.pxResults"); 
...
if(startIndex<=0) { startIndex = 1; }
 ...
 tools.putParamValue("PageListProperty","D_pyWorkbasketsInMyWorkGroup.pxResults");}
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getProperty("D_pyWorkbasketsInMyWorkGroup.pxResults");
					...
					tools.appendString("' gPropIndex='D_pyWorkbasketsInMyWorkGroupPpxResults1' editRowIndex='");
					...
					tools.appendString("pyTargetSection=\"\"  threadProcessing=\"false\" bFiltering=\"false\" bRODetails=\"false\" showExpandedAll=\"false\" focusibleGrid = \"true\" dpParams=\"\" pyPageSize = '");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"D_pyWorkbasketsInMyWorkGroupPpxResults1colWidthGBL\" id=\"D_pyWorkbasketsInMyWorkGroupPpxResults1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("D_pyWorkbasketsInMyWorkGroupPpxResults1colWidthGBL"));tools.appendString("\" />");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"D_pyWorkbasketsInMyWorkGroupPpxResults1colWidthGBR\" id=\"D_pyWorkbasketsInMyWorkGroupPpxResults1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("D_pyWorkbasketsInMyWorkGroupPpxResults1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("D_pyWorkbasketsInMyWorkGroupPpxResults1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='' PL_PROP='D_pyWorkbasketsInMyWorkGroup.pxResults' PL_PROP_CLASS='Data-Admin-WorkBasket' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
					...
					if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) {
								 ...
								 itr_3 = tools.getProperty("D_pyWorkbasketsInMyWorkGroup.pxResults").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData.D_pyWorkbasketsInMyWorkGroup.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 ct_gridAction.trackValueChanges(tools.getProperty(".pyWorkBasket"),-1);
					...
					tools.appendString("\"");tools.appendString(StringUtils.escapeCrossScriptingFilter(tools.getProperty(".pyWorkBasket").getStringValue()) );tools.appendString("\"");tools.appendString("");tools.appendString("]' ");
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"1\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("Data-Admin-WorkBasket", "tempNoRespg");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodesD_pyWorkbasketsInMyWorkGroup.pxResults1") && tools.getParamValue("partialRefresh").equals("false")) {
...
public void pyWorkBasketDetail_1() {
pzAuto.emitIncludeStreamReference("pyWorkBasketDetail", null, !tools.hasInputEnabled()?"NoInput":"Input", "Rule-HTML-Section", null);
}
...
public void D_pyWorkbasketsInMyWorkGroup_pxResults_1() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		...
		tools.appendString("#~.pyWorkBasket$0$~#");			refreshActionRequestD.registerFixedParameter("CurrentUser",".pyWorkBasket");
			preDTParamStr.append((!"".equals(preDTParamStr.toString())?",":"") + "\"Basket\":\"true\"");
			refreshActionRequestD.registerFixedParameter("Basket","true");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendToD_pyWorkbasketsInMyWorkGroup.pxResults1")|| tools.getParamValue("partialTrigger").equals("editRowD_pyWorkbasketsInMyWorkGroup.pxResults1") ){
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData.D_pyWorkbasketsInMyWorkGroup.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdropD_pyWorkbasketsInMyWorkGroup.pxResults1")) {
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendToD_pyWorkbasketsInMyWorkGroup.pxResults1") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPBASKETS #20180713T134755.650 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyWorkGroupBaskets");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PYWORKGROUPBASKETS #20180713T134755.650 GMT", "Data-Portal pyWorkGroupBaskets", "Pega-EndUserUI", "08-01-01", "20180713T134755.650 GMT");
}
