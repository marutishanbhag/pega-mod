...
/**
 * Builds JSP stream DATA-PORTAL-PEGAADMINSTUDIO!PYADMINSTUDIODASHBOARDHEADER.
 */
public class ra_stream_pyadminstudiodashboardheader_dbea86b88ab0308a9bb4a2fa9e1b57a9 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyAdminStudioDashboardHeader.Data_Portal_PegaAdminStudio.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 53005904;
 ...
 */
	public ra_stream_pyadminstudiodashboardheader_dbea86b88ab0308a9bb4a2fa9e1b57a9(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "9b7c586121d61d706f61fff9e407dacb286efc24";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARDHEADER #20181119T092437.658 GMT	Pega-Desktop:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "9b7c586121d61d706f61fff9e407dacb286efc24";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyAdminStudioDashboardHeader",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARDHEADER #20181119T092437.658 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARDHEADER #20181119T092437.658 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARDHEADER #20181119T092437.658 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYADMINSTUDIODASHBOARDHEADER", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYADMINSTUDIODASHBOARDHEADER","Rule-HTML-Section","DATA-PORTAL-PEGAADMINSTUDIO",false,"","Pega-Desktop","08-02-01","RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARDHEADER #20181119T092437.658 GMT","!PYADMINSTUDIODASHBOARDHEADER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",53005904), 
...
//	RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARDHEADER #20181119T092437.658 GMT:20181206T110733.219 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "9dffe70e775bd72ebc90ac985295f179";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyAdminStudioDashboardHeader",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyAdminStudioDashboardHeader','insKey':'RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARDHEADER #20181119T092437.658 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("pzActivity", "pyOnBackAction");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "historyBack");
...
public void pxDisplayText_1() {String key="2||RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARDHEADER #20181119T092437.658 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","2"};oCellRuntimeParamsMap.put("2||RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARDHEADER #20181119T092437.658 GMT",paramValues);oControlPathsMap.put("2||RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARDHEADER #20181119T092437.658 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pyOnBackAction");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }			tools.appendString("[\"runScript\", [\"historyBack()\"]");
...
try {
	...
	modePage2.put("pyName","pyAdminStudioDashboardHeader_$CTX$_1");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Back previous page\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Back previous page", ".pyActionPrompt");
	}
	pyTooltip = "Back previous page";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyAdminStudioDashboardHeader_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Back previous page\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","express-back","express-back")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing   header-title-main dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2014100814395204501592-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired app_heading_iconRequired");
	pgCells.put("labelReadClass","dataLabelForRead app_heading_dataLabelForRead");
	pgCells.put("labelWriteClass","dataLabelForWrite app_heading_dataLabelForWrite");
	pgCells.put("customROStyles","header-title-main");
	pgCells.put("customRWStyles","header-title-main");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
pzSection.getLayout().setExpandParam("SubSectionpyAdminStudioDashboardHeaderB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20180123115650037215") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle layout-box-shadow" + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpyAdminStudioDashboardHeaderB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARDHEADER #20181119T092437.658 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyAdminStudioDashboardHeader");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARDHEADER #20181119T092437.658 GMT", "Data-Portal-PegaAdminStudio pyAdminStudioDashboardHeader", "Pega-Desktop", "08-02-01", "20181206T110733.219 GMT");
}
