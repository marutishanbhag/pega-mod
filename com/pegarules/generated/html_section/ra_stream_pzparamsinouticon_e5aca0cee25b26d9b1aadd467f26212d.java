...
/**
 * Builds JSP stream EMBED-ACTIVITYSTEPS!PZPARAMSINOUTICON.
 */
public class ra_stream_pzparamsinouticon_e5aca0cee25b26d9b1aadd467f26212d extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzParamsInOutIcon.Embed_ActivitySteps.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -813472259;
 ...
 */
	public ra_stream_pzparamsinouticon_e5aca0cee25b26d9b1aadd467f26212d(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "56aa87eeb8c600be2bbe504bbd6477cad7b9f541";
...
{
/* Instance RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPARAMSINOUTICON #20180713T135209.091 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "56aa87eeb8c600be2bbe504bbd6477cad7b9f541";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzParamsInOutIcon",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPARAMSINOUTICON #20180713T135209.091 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPARAMSINOUTICON #20180713T135209.091 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPARAMSINOUTICON #20180713T135209.091 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZPARAMSINOUTICON", 
	"Rule-HTML-Property:PXICON", 
	"Rule-File-Binary:WEBWB!ZSTEPVALUEIN!GIF", 
	"Rule-File-Binary:WEBWB!ZSTEPVALUEOUT!GIF", 
	"Rule-File-Binary:WEBWB!ZSTEPVALUEOUT!GIF"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZPARAMSINOUTICON","Rule-HTML-Section","EMBED-ACTIVITYSTEPS",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPARAMSINOUTICON #20180713T135209.091 GMT","!PZPARAMSINOUTICON",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-813472259), 
		...
		new DependentRuleInfo("WEBWB!ZSTEPVALUEIN!GIF","Rule-File-Binary","",false,"","","","","WEBWB!ZSTEPVALUEIN!GIF",true,false,"ABSOLUTE_CLASSLESS",1), 
		new DependentRuleInfo("WEBWB!ZSTEPVALUEOUT!GIF","Rule-File-Binary","",false,"","","","","WEBWB!ZSTEPVALUEOUT!GIF",true,false,"ABSOLUTE_CLASSLESS",1), 
		new DependentRuleInfo("WEBWB!ZSTEPVALUEOUT!GIF","Rule-File-Binary","",false,"","Pega-RULES","","RULE-FILE-BINARY WEBWB ZSTEPVALUEOUT!GIF #20180713T131323.145 GMT","WEBWB!ZSTEPVALUEOUT!GIF",true,false,"ABSOLUTE_CLASSLESS",1)
	};
...
//	RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPARAMSINOUTICON #20180713T135209.091 GMT:20180713T135209.091 GMT
//	RULE-HTML-PROPERTY PXICON #20190131T183501.575 GMT:20190131T183501.575 GMT
//	RULE-HTML-PROPERTY PXICON #20190131T183501.575 GMT:20190131T183501.575 GMT
//	RULE-FILE-BINARY WEBWB ZSTEPVALUEOUT!GIF #20180713T131323.145 GMT:20180713T131323.145 GMT
//	RULE-FILE-BINARY WEBWB ZSTEPVALUEOUT!GIF #20180713T131323.145 GMT:20180713T131323.145 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "0ffecb209e841375ec06d8be369299e9";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzParamsInOutIcon",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzParamsInOutIcon','insKey':'RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPARAMSINOUTICON #20180713T135209.091 GMT','sectionType':'null'}");
pzLayout_1();
pzLayout_2();
...
try {
	...
	cellPage.put("pyStreamName","pzParamsInOutIcon");
	...
	src = "data:image/gif;base64,";
	
		}
	
		else{
	src = "webwb/zstepvalueout_13640091031.gif!!.gif";
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzParamsInOutIcon_"+ referenceString+ "_3'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		tools.appendString("data:image/gif;base64,");
		}
		else{
		
		tools.appendString("webwb/zstepvalueout_13640091031.gif!!.gif");
		}
		tools.appendString("' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			...
			tools.appendString(" title = 'Out Parameter"+ " "+repeatIndx+"' ");
			tools.appendString(" alt = 'Out Parameter"+ " "+repeatIndx+"' ");
...
pzSection.getLayout().setExpandParam("SubSectionpzParamsInOutIconBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpzParamsInOutIconBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= pxparam.InParameter cqtrue", pxUniqueStreamHash+"_13");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if(pzAuto.handleEvaluateWhen(" o2!= pxparam.InParameter cqtrue","param.InParameter!=\'true\'", "layout", "visible" )) {pzSetExpandParam_2();
...
try {
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzParamsInOutIcon_"+ referenceString+ "_1'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
		...
		tools.appendString("webwb/zstepvaluein.gif");
		}
		tools.appendString("' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" class ='cursordefault' ");
			tools.appendString(" title = 'In Parameter"+ " "+repeatIndx+"' ");
			tools.appendString(" alt = 'In Parameter"+ " "+repeatIndx+"' ");
			tools.appendString(" /></i>");
		}		}
...
pzSection.getLayout().setExpandParam("SubSectionpzParamsInOutIconB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzParamsInOutIconB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxNever", pxUniqueStreamHash+"_7");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxNever","Never", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPARAMSINOUTICON #20180713T135209.091 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzParamsInOutIcon");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZPARAMSINOUTICON #20180713T135209.091 GMT", "Embed-ActivitySteps pzParamsInOutIcon", "Pega-Desktop", "08-01-01", "20180713T135209.091 GMT");
}
