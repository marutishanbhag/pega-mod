...
/**
 * Builds JSP stream EMBED-EXPLORERNODE-CLASS!PZBRANCHEXPLORERNODE.
 */
public class ra_stream_pzbranchexplorernode_af952d8908ea4aa7c01c312c7bd1ab85 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzBranchExplorerNode.Embed_ExplorerNode_Class.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1827572773;
 ...
 */
	public ra_stream_pzbranchexplorernode_af952d8908ea4aa7c01c312c7bd1ab85(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "14b704da92374f493ecfbb9032b5c36343ed406a";
...
{
/* Instance RULE-HTML-SECTION EMBED-EXPLORERNODE-CLASS PZBRANCHEXPLORERNODE #20180713T135213.828 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "14b704da92374f493ecfbb9032b5c36343ed406a";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzBranchExplorerNode",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-EXPLORERNODE-CLASS PZBRANCHEXPLORERNODE #20180713T135213.828 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-EXPLORERNODE-CLASS PZBRANCHEXPLORERNODE #20180713T135213.828 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-EXPLORERNODE-CLASS PZBRANCHEXPLORERNODE #20180713T135213.828 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZBRANCHEXPLORERNODE", 
	"Rule-HTML-Property:PXLINK", 
	"Rule-HTML-Property:PXICON", 
	"Rule-File-Binary:WEBWB!PZBRANCHLOCK!PNG", 
	"Rule-File-Binary:WEBWB!PZBRANCHLOCK!PNG"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZBRANCHEXPLORERNODE","Rule-HTML-Section","EMBED-EXPLORERNODE-CLASS",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION EMBED-EXPLORERNODE-CLASS PZBRANCHEXPLORERNODE #20180713T135213.828 GMT","!PZBRANCHEXPLORERNODE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1827572773), 
		...
		new DependentRuleInfo("WEBWB!PZBRANCHLOCK!PNG","Rule-File-Binary","",false,"","","","","WEBWB!PZBRANCHLOCK!PNG",true,false,"ABSOLUTE_CLASSLESS",1), 
		new DependentRuleInfo("WEBWB!PZBRANCHLOCK!PNG","Rule-File-Binary","",false,"","Pega-Desktop","","RULE-FILE-BINARY WEBWB PZBRANCHLOCK!PNG #20180713T135100.412 GMT","WEBWB!PZBRANCHLOCK!PNG",true,false,"ABSOLUTE_CLASSLESS",1)
	};
...
//	RULE-HTML-SECTION EMBED-EXPLORERNODE-CLASS PZBRANCHEXPLORERNODE #20180713T135213.828 GMT:20180713T135213.828 GMT
...
//	RULE-FILE-BINARY WEBWB PZBRANCHLOCK!PNG #20180713T135100.412 GMT:20180713T135100.412 GMT
//	RULE-FILE-BINARY WEBWB PZBRANCHLOCK!PNG #20180713T135100.412 GMT:20180713T135100.412 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "bda13c3d8a5bc09caae5107c2c1cc87f";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzBranchExplorerNode",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzBranchExplorerNode','insKey':'RULE-HTML-SECTION EMBED-EXPLORERNODE-CLASS PZBRANCHEXPLORERNODE #20180713T135213.828 GMT','sectionType':'standard'}");
pzLayout_2();
...
config.put("objClass", "Rule-Application");
...
try {
	...
	cellPage.put("pyStreamName","pzBranchExplorerNode");
	...
	src = "data:image/png;base64,";
	
		}
	
		else{
	src = "webwb/pzbranchlock_11397514810.png!!.png";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20170817031715074912798") + " ");
	...
	modePage1.put("pyActionStringID",pxUniqueStreamHash+"_9");
	}
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzBranchExplorerNode_"+ referenceString+ "_4'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		tools.appendString("<i class='icons'>");tools.appendString("<img   " + pzCell.getTestIdIfEnabled("20170817031715074912798") + "   data-ctl='Icon' ");tools.appendString(" src='");
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		
		tools.appendString("data:image/png;base64,");
		}
		else{
		
		tools.appendString("webwb/pzbranchlock_11397514810.png!!.png");
		}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendFormatted("Rule-Application",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20170119225522022966948",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzBranchExplorerNode_$CTX$_3");
		String repeatIndx = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzBranchExplorerNode_"+ referenceString+ "_3'";
	 ...
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20170119225522022966948") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing    " + pzSection.getCustomStyle(false, "","App-explorer-classname-ellipsis","App-explorer-classname-ellipsis")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20170119225522022966948-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o1! wxpzCanModifyApplication","!pzCanModifyApplication","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20170817031715074912798-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxpzCanModifyApplication",pxUniqueStreamHash+"_11");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_11");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","!pzCanModifyApplication");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpzCanModifyApplication", pxUniqueStreamHash+"_11"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateGeneric",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxIcon_1();}
...
pzSection.getLayout().setExpandParam("SubSectionpzBranchExplorerNodeBB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzBranchExplorerNodeBB";
...
pzSection.getLayout().setExpandParam("SubSectionpzBranchExplorerNodeB","",false);
}
...
public void simpleLayout_2() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-inline_list content-inline_list app-class" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		pg_dlmeta.put("format","inline_list");
	...
	String paramName = "EXPANDEDSubSectionpzBranchExplorerNodeB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-EXPLORERNODE-CLASS PZBRANCHEXPLORERNODE #20180713T135213.828 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzBranchExplorerNode");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-EXPLORERNODE-CLASS PZBRANCHEXPLORERNODE #20180713T135213.828 GMT", "Embed-ExplorerNode-Class pzBranchExplorerNode", "Pega-Desktop", "08-01-01", "20180713T135213.828 GMT");
}
