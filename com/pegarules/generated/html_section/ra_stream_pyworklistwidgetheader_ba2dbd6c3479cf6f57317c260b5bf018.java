...
/**
 * Builds JSP stream DATA-PORTAL!PYWORKLISTWIDGETHEADER.
 */
public class ra_stream_pyworklistwidgetheader_ba2dbd6c3479cf6f57317c260b5bf018 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyWorkListWidgetHeader.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1908922675;
 ...
 */
	public ra_stream_pyworklistwidgetheader_ba2dbd6c3479cf6f57317c260b5bf018(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "da370a51a2dcc82f7744aa7498bac91956201ed5";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PYWORKLISTWIDGETHEADER #20210506T204030.619 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "da370a51a2dcc82f7744aa7498bac91956201ed5";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyWorkListWidgetHeader",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PYWORKLISTWIDGETHEADER #20210506T204030.619 GMT
 * Set up context.
 */
final String prevRuleKey_2 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PYWORKLISTWIDGETHEADER #20210506T204030.619 GMT";final String prevClass_2 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PYWORKLISTWIDGETHEADER #20210506T204030.619 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-HTML-Section:PYWORKLISTWIDGETHEADER", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYWORKLISTWIDGETHEADER","Rule-HTML-Section","DATA-PORTAL",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION DATA-PORTAL PYWORKLISTWIDGETHEADER #20210506T204030.619 GMT","!PYWORKLISTWIDGETHEADER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1908922675), 
...
//	RULE-HTML-SECTION DATA-PORTAL PYWORKLISTWIDGETHEADER #20210506T204030.619 GMT:20221216T064646.660 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "98c64cd094f1e1b8511ddd04fd0d9bcc";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyWorkListWidgetHeader",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyWorkListWidgetHeader','insKey':'RULE-HTML-SECTION DATA-PORTAL PYWORKLISTWIDGETHEADER #20210506T204030.619 GMT','sectionType':'standard'}");
pzLayout_3();
pzLayout_6();
...
config.put("NewTaskStatus", "pyAllWorkItemOwnerFA");
...
public void buildSection_4() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_38","pyWorkListWidgetHeaderInner", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pyWorkListWidgetHeaderInner"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpyWorkListWidgetHeader93","",false);
}
...
public void buildSection_3() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",true);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_35","pyWorkListWidgetHeaderInner", secInfo);
}
...
public void field_pxInitials_4() { 
...
params_4.putString("name", pega.getValue("D_PortalContext.pyLabel"));
params_4.putString("width", "40");
params_4.putString("height", "40");
...
params_4.putString("bLocalize", "true");
	...
	if (currentProperty_4 != null && currentProperty_4.getParentPage().getClassName().equals("Data-Portal")) {
		...
		final PRStackFrame stack_4 = ((PegaAPI) tools).pushStackFrame( params_4, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pxInitials" );
		try {
				pega.checkIfActivePropertyMissing();
property_Data_Portal_pxInitials();
...
if (_jspx_meth_pega_reference__2(pageContext, ".pyTemplateInputBox", "display", "pxInitials")) {
	return;
}
	}} catch(Throwable t) {
...
public void field_pxInitials_3() { 
String mode1 = getActionsForCustomControls_1();
tools.putSaveValue("mode1Action",mode1);
String mode2 = getActionsForCustomControls_1();
tools.putSaveValue("mode2Action",mode2);
...
params_3.putString("name", pega.getValue("D_PortalContext.pyLabel"));
params_3.putString("width", "40");
params_3.putString("height", "40");
...
params_3.putString("bLocalize", "true");
	...
	if (currentProperty_3 != null && currentProperty_3.getParentPage().getClassName().equals("Data-Portal")) {
		...
		pega.setEditable(false);
		pega.setModeInput(false);
		final PRStackFrame stack_3 = ((PegaAPI) tools).pushStackFrame( params_3, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pxInitials" );
		try {
				pega.checkIfActivePropertyMissing();
property_Data_Portal_pxInitials();
	pzAuto.implementShowMe(IAutoStreamRuntime.SHOWME_PROPERTY, showMeParams_1);
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  "D_PortalContext.pyIsBasket == 'false'", expressionId);
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201911150917090943fa37ba0b-ae35-49b7-b038-e68213ad3bf2941-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxOperatorImage",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_6( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxInitials",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-right-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_28")) {	field_pxInitials_3();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  "D_PortalContext.pyIsBasket == 'true'", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
	String dataFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxInitials",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_32")) {	field_pxInitials_4();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkListWidgetHeaderBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	spxUniqueStreamHash22 = getUIActionsMetaData_2();
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-inline_middle content-inline_middle flex-shrink-0" + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpyWorkListWidgetHeaderBBBB";
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyWorkListWidgetHeaderInner",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkListWidgetHeaderBBB","",false);
}
...
public void simpleLayout_4() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + "flex  content  auto-width-column layout-content-inline_middle content-inline_middle flex-grow-1-item-2 flex-nowrap flex-none-item-1 flex-none-item-3" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpyWorkListWidgetHeaderBBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= pxparam.bShowTeamAssignments cqtrue", pxUniqueStreamHash+"_39");metadataPage.put("lMode","SimpleDiv");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= pxparam.bShowTeamAssignments cqtrue","param.bShowTeamAssignments != \'true\'", "layout", "visible" )) {pzSetExpandParam_4();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_2() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",true);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_19","pyWorkListWidgetHeaderInner", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpyWorkListWidgetHeader107","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",true);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_16","pyWorkListWidgetHeaderInner", secInfo);
}
...
params_2.putString("name", pega.getValue("D_PortalContext.pyLabel"));
...
if (_jspx_meth_pega_param__2(pageContext, "name", "D_PortalContext.pyLabel")) {
	return true;
}
...
/**
 * Generates stream property_Data_Portal_pxInitials
 */
private void property_Data_Portal_pxInitials() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
params_1.putString("name", pega.getValue("D_PortalContext.pyLabel"));
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyIsBasket\"  SHOW_WHEN=\"D_PortalContext.pyIsBasket == 'true'\"");
if(pzAuto.evaluateWhen("D_PortalContext.pyIsBasket == 'true'",null,true)){
	if(currentTemplatingStatus =='N')
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges("D_PortalContext.pyIsBasket", -1);
	}
}catch(Exception e){}
}
/**
...
if (_jspx_meth_pega_param__2(pageContext, "OperatorID", "D_PortalContext.pyLabel")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "height", "40")) {
	return true;
 ...
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyTemplateInputBox", "display", "pxOperatorImage")) {
	return;
}
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyIsBasket\"  SHOW_WHEN=\"D_PortalContext.pyIsBasket == 'false'\"");
if(pzAuto.evaluateWhen("D_PortalContext.pyIsBasket == 'false'",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_2();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxOperatorImage",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-right-spacing remove-left-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxOperatorImage",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_3();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxInitials",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-right-spacing   dataValueRead flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_9")) {	field_pxInitials_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxInitials",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_13")) {	field_pxInitials_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkListWidgetHeaderBB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-inline_middle content-inline_middle flex-shrink-0" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpyWorkListWidgetHeaderBB";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		keyMap.putString("pyActionName", "pyAllWorkItemOwnerFA");
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
		pzPackageRuntime.packageLocalAction("pyAllWorkItemOwnerFA", offlineUsingPage , strLAClassName);
		...
		if("true".equals(bHasPrivilege )) {
			tools.appendString("[\"processAction\", [\"pyAllWorkItemOwnerFA\",\"overlay\",\":event\",\"\",\""+streamType+"\",\"pz-po-c-list\",\"pzModalTemplate\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-null%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22effect%22%3A%22anim-null%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
			} else {
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyWorkListWidgetHeaderInner",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing remove-right-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyWorkListWidgetHeaderInner",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyWorkListWidgetHeaderB","",false);
}
...
public void simpleLayout_2() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("]' ");
							...
							String paramName = "EXPANDEDSubSectionpyWorkListWidgetHeaderB";
							...
							IUIComponent containerComponent = pzAuto.getUIComponent();
							com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
							boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== pxparam.bShowTeamAssignments cqtrue", pxUniqueStreamHash+"_20");metadataPage.put("lMode","SimpleDiv");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2== pxparam.bShowTeamAssignments cqtrue","param.bShowTeamAssignments = \'true\'", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	oPropDefinitions_2.put("Data-Portal.pyTemplateInputBox", new LiteweightPropertyDefinition("Data-Portal", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_2.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PYWORKLISTWIDGETHEADER #20210506T204030.619 GMT");
	...
	oStreamProperties_2.put("pyStreamName", "pyWorkListWidgetHeader");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PYWORKLISTWIDGETHEADER #20210506T204030.619 GMT", "Data-Portal pyWorkListWidgetHeader", "Theme-Cosmos", "04-01-01", "20221216T064646.660 GMT");
