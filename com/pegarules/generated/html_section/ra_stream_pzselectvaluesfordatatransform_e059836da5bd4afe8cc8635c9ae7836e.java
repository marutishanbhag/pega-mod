...
/**
 * Builds JSP stream @BASECLASS!PZSELECTVALUESFORDATATRANSFORM.
 */
public class ra_stream_pzselectvaluesfordatatransform_e059836da5bd4afe8cc8635c9ae7836e extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSelectValuesForDataTransform.Embed_ModelParams.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1860925988;
 ...
 */
	public ra_stream_pzselectvaluesfordatatransform_e059836da5bd4afe8cc8635c9ae7836e(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "67dc4e9477ee872c2b9dba8151e24281e112742b";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZSELECTVALUESFORDATATRANSFORM #20181114T185909.312 GMT	Pega-Gadgets:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "67dc4e9477ee872c2b9dba8151e24281e112742b";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSelectValuesForDataTransform",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZSELECTVALUESFORDATATRANSFORM #20181114T185909.312 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZSELECTVALUESFORDATATRANSFORM #20181114T185909.312 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZSELECTVALUESFORDATATRANSFORM #20181114T185909.312 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZSELECTVALUESFORDATATRANSFORM", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSELECTVALUESFORDATATRANSFORM","Rule-HTML-Section","@BASECLASS",false,"","Pega-Gadgets","08-02-01","RULE-HTML-SECTION @BASECLASS PZSELECTVALUESFORDATATRANSFORM #20181114T185909.312 GMT","!PZSELECTVALUESFORDATATRANSFORM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1860925988), 
...
//	RULE-HTML-SECTION @BASECLASS PZSELECTVALUESFORDATATRANSFORM #20181114T185909.312 GMT:20181114T185909.312 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "e370b8bd61d9678d25652a716d89a807";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSelectValuesForDataTransform",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSelectValuesForDataTransform','insKey':'RULE-HTML-SECTION @BASECLASS PZSELECTVALUESFORDATATRANSFORM #20181114T185909.312 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("pzActivity", "pzSetClassLookupReference");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("pzActivity", "pzSelectValues_SetupValuesOverlay");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("ActionSection", "pyOverlayTemplate");
config.put("NewTaskStatus", "pzSelectValues_PickerFA");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzSetClassLookupReference");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }			{
				StringBuffer ractURLStr = new StringBuffer();
				StringBuffer ractParamStr = new StringBuffer();
				ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzSelectValues_SetupValuesOverlay");
				tools.appendString("[\"runActivity\", [\"\", \"");
				ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"ClassLookupReference\":\"").append(pega_uiengine_pzcontrol.pzURLEncodeString(tools.getParamValue(pzAuto.getUIComponentRuntime().generateActionToken("param.ClassLookupReference")))).append("\"");
				ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"IsMultiSelect\":\"").append(pega_uiengine_pzcontrol.pzURLEncodeString(tools.getParamValue(pzAuto.getUIComponentRuntime().generateActionToken("Param.IsMultiSelect")))).append("\"");
				ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"PropertyLookupReference\":\"").append(pega_uiengine_pzcontrol.pzURLEncodeString(tools.getParamValue(pzAuto.getUIComponentRuntime().generateActionToken("Param.PropertyLookupReference")))).append("\"");
				ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"PropertyToUpdateAfterSelection\":\"").append(pega_uiengine_pzcontrol.pzURLEncodeString(tools.getParamValue(pzAuto.getUIComponentRuntime().generateActionToken("param.PropertyToUpdateAfterSelection")))).append("\"");
				ractParamStr.append(!"".equals(ractParamStr.toString())? ",pyReturnsResponse:false": "pyReturnsResponse:false");
				tools.appendString("\", \"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \":event\", \"\", \"\", \"\", \"");
				if(!"".equals(ractParamStr.toString())) {
					ractURLStr.append("&pzActivityParamsEncrypted=" + pega_uiengine_pzcontrol.pzURLEncodeString("{" + ractParamStr.toString() + "}"));
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }					{
						...
						keyMap.putString("pyActionName", "pzSelectValues_PickerFA");
						String strLAClassName = "";
						String offlineUsingPage = "D_pzSelectValues_RuntimeInformation";
						strLAClassName = "PegaGadget-SelectValues";
						...
						try{
						pzPackageRuntime.packageLocalAction("pzSelectValues_PickerFA", offlineUsingPage , strLAClassName);
						...
						if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
							try{
								pzPackageRuntime.packageSection("pzSelectValuesForDataTransform",
								...
								String usingPage = "D_pzSelectValues_RuntimeInformation";
								if(("").equals(usingPage)) { usingPage = tools.getStepPage().getReference(); }
								if("true".equals(bHasPrivilege )) {
									tools.appendString("[\"processAction\", [\"pzSelectValues_PickerFA\",\"overlay\",\":event\",\"D_pzSelectValues_RuntimeInformation\",\""+streamType+"\",\"\",\"pzModalTemplate\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-bottom%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
									} else {
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2017080311423504263940",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzSelectValuesForDataTransform_$CTX$_3");
		String repeatIndx = "";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Select Values\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Select Values", ".pyButtonLabel");
	}
	pyLabel = "Select Values";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzSelectValuesForDataTransform_"+ referenceString+ "_3'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2017080311423504263940") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Select Values",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","nowrap","nowrap")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2017080311423504263940-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzSelectValuesForDataTransformB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201811121740060536721") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzSelectValuesForDataTransformB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZSELECTVALUESFORDATATRANSFORM #20181114T185909.312 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzSelectValuesForDataTransform");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZSELECTVALUESFORDATATRANSFORM #20181114T185909.312 GMT", "@baseclass pzSelectValuesForDataTransform", "Pega-Gadgets", "08-02-01", "20181114T185909.312 GMT");
}
