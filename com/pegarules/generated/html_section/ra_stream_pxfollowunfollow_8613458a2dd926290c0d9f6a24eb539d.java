...
/**
 * Builds JSP stream WORK-!PXFOLLOWUNFOLLOW.
 */
public class ra_stream_pxfollowunfollow_8613458a2dd926290c0d9f6a24eb539d extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pxFollowUnfollow.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 874223130;
 ...
 */
	public ra_stream_pxfollowunfollow_8613458a2dd926290c0d9f6a24eb539d(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "be1b2c6cead38f58a1ed54d1f99730709f47186";
...
{
/* Instance RULE-HTML-SECTION WORK- PXFOLLOWUNFOLLOW #20210506T204027.876 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "be1b2c6cead38f58a1ed54d1f99730709f47186";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pxFollowUnfollow",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- PXFOLLOWUNFOLLOW #20210506T204027.876 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PXFOLLOWUNFOLLOW #20210506T204027.876 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PXFOLLOWUNFOLLOW #20210506T204027.876 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PXFOLLOWUNFOLLOW", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXFOLLOWUNFOLLOW","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION WORK- PXFOLLOWUNFOLLOW #20210506T204027.876 GMT","!PXFOLLOWUNFOLLOW",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",874223130), 
...
//	RULE-HTML-SECTION WORK- PXFOLLOWUNFOLLOW #20210506T204027.876 GMT:20210506T204027.876 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "ac5f37cb817a2a1a39a63d5fc7d60cb5";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pxFollowUnfollow",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pxFollowUnfollow','insKey':'RULE-HTML-SECTION WORK- PXFOLLOWUNFOLLOW #20210506T204027.876 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
...
config.put("pyActivity", "pxUnfollow");
config.put("StaticActivityParams", "Context=&ContextClass=&ReferenceFrom=&Commit=true&ContextType=&AuditMemo=&AuditPageName=&FilterHistory=");
...
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
config.put("pyActivity", "pxFollow");
config.put("StaticActivityParams", "Context=&ContextClass=&ContextType=case&Commit=true");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("pyTarget", "thisSection");
pega.getUIEngine().getUIAction("refresh", config).register();
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2015010100412006652201") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pxFollowUnfollow_$CTX$_5");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Follow\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Follow", ".pyActionPrompt");
	}
	pyTooltip = "Follow";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pxFollowUnfollow_"+ referenceString+ "_5'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2015010100412006652201") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						pzPackageRuntime.packageSection("pxFollowUnfollow",
						...
						refreshActionRequest.registerFixedParameter("PreActivity", "pxFollow");
						staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pxFollowUnfollow"));
						staticURLStr.append("&PreActivity=pxFollow");
						tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"pxFollow\", \"");
						refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"Context\":\"\"");
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"ContextClass\":\"\"");
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"ContextType\":\"case\"");
						refreshActionRequestD.registerFixedParameter("ContextType","case");
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"Commit\":\"true\"");
						refreshActionRequestD.registerFixedParameter("Commit","true");
						tools.appendString("\", \"\", \",");
						refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }									{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
										com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
											...
											StringBuffer preDTParamStr = new StringBuffer();
											refreshActionRequest.registerFixedParameter("pyActivity", "ReloadSection");
											refreshActionRequest.registerFixedParameter("StreamList", "CaseFollowers|Rule-HTML-Section|:");
											staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
											tools.appendString("[\"refresh\", [\"otherSection\",\"CaseFollowers\", \"\", \"");
											refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
											tools.appendString("=\", \"\", \",");
											refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Follow\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
		tools.appendString(toolTipVal);tools.appendString("class='Header_icon pzhc pzbutton");tools.appendString("'");if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		tools.appendString(" >");
		String classProp = "";
		 classProp ="pi pi-star";
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2015010100412006641404") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pxFollowUnfollow_$CTX$_4");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Unfollow\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Unfollow", ".pyActionPrompt");
	}
	pyTooltip = "Unfollow";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","tooltip");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pxFollowUnfollow_"+ referenceString+ "_4'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2015010100412006641404") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						...
						refreshActionRequest.registerFixedParameter("pyActivity", "ReloadSection");
						refreshActionRequest.registerFixedParameter("SectionName", "");
						refreshActionRequest.registerFixedParameter("PreActivity", "pxUnfollow");
						staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pxFollowUnfollow"));
						staticURLStr.append("&PreActivity=pxUnfollow");
						tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"pxUnfollow\", \"");
						refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"Context\":\"\"");
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"ContextClass\":\"\"");
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"ReferenceFrom\":\"\"");
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"Commit\":\"true\"");
						refreshActionRequestD.registerFixedParameter("Commit","true");
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"ContextType\":\"\"");
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"AuditMemo\":\"\"");
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"AuditPageName\":\"\"");
						preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"FilterHistory\":\"\"");
						tools.appendString("\", \"\", \",");
						refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
						tools.appendString("\",\":event\",\"1\",[\"");
						if(!"".equals(preActParamStr.toString())) {
		...
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Unfollow\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
		tools.appendString(toolTipVal);tools.appendString("class='Header_icon pzhc pzbutton");tools.appendString("'");if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		tools.appendString(" >");
		String classProp = "";
		 classProp ="pi pi-star-filled";
		tools.appendString("<i aria-hidden='true'  data-click='.' class='" + classProp + "'></i>");
		boolean hasLineBreaks = false;
		 hasLineBreaks ="".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015010100412006641404-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","margin-0");
	pgCells.put("customRWStyles","margin-0");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpxIsAFollower",pxUniqueStreamHash+"_16");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_16");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pxIsAFollower");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpxIsAFollower", pxUniqueStreamHash+"_16"); 
	}
...
public int simpleLayoutCell_4( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o1! wxpxIsAFollower","!pxIsAFollower","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","margin-0","margin-0")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-all-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015010100412006652201-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxpxIsAFollower",pxUniqueStreamHash+"_20");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpxIsAFollower", pxUniqueStreamHash+"_20"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxButton_4();}
...
pzSection.getLayout().setExpandParam("SubSectionpxFollowUnfollowBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201809180846540118509") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle flex-justify-end" + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpxFollowUnfollowBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpxIsMobileDevice", pxUniqueStreamHash+"_21");metadataPage.put("lMode","SimpleDiv");
...
if(pzAuto.handleEvaluateWhen(" wxpxIsMobileDevice","pxIsMobileDevice", "layout", "visible" )) {pzSetExpandParam_2();
...
try {
	...
	modePage2.put("pyName","pxFollowUnfollow_$CTX$_2");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Follow\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pxFollowUnfollow_"+ referenceString+ "_2'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2015010100412006652201") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
try {
	...
	modePage2.put("pyName","pxFollowUnfollow_$CTX$_1");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Unfollow\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pxFollowUnfollow_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2015010100412006641404") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
public int simpleLayoutCell_1( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","margin-0","margin-0")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpxIsAFollower",pxUniqueStreamHash+"_6");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpxIsAFollower", pxUniqueStreamHash+"_6"); 
	}
	if(pyDLCellVisibility) {
...
public int simpleLayoutCell_2( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","margin-0","margin-0")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxpxIsAFollower",pxUniqueStreamHash+"_10");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpxIsAFollower", pxUniqueStreamHash+"_10"); 
	}
	if(pyDLCellVisibility) {
...
pzSection.getLayout().setExpandParam("SubSectionpxFollowUnfollowB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle flex-justify-end" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpxFollowUnfollowB";
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpxIsMobileDevice", pxUniqueStreamHash+"_11");metadataPage.put("lMode","SimpleDiv");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpxIsMobileDevice","!pxIsMobileDevice", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- PXFOLLOWUNFOLLOW #20210506T204027.876 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pxFollowUnfollow");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PXFOLLOWUNFOLLOW #20210506T204027.876 GMT", "Work- pxFollowUnfollow", "Theme-Cosmos", "04-01-01", "20210506T204027.876 GMT");
}
