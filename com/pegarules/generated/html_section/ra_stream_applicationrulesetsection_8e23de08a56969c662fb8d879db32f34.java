...
/**
 * Builds JSP stream RULE-APPLICATION!APPLICATIONRULESETSECTION.
 */
public class ra_stream_applicationrulesetsection_8e23de08a56969c662fb8d879db32f34 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.ApplicationRuleSetSection.Rule_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -2127536739;
 ...
 */
	public ra_stream_applicationrulesetsection_8e23de08a56969c662fb8d879db32f34(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "fd2a6e86141b4e48a430d2e1919411815c572164";
...
{
/* Instance RULE-HTML-SECTION RULE-APPLICATION APPLICATIONRULESETSECTION #20180713T135646.848 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "fd2a6e86141b4e48a430d2e1919411815c572164";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("ApplicationRuleSetSection",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-APPLICATION APPLICATIONRULESETSECTION #20180713T135646.848 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-APPLICATION APPLICATIONRULESETSECTION #20180713T135646.848 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-APPLICATION APPLICATIONRULESETSECTION #20180713T135646.848 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:APPLICATIONRULESETSECTION", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("APPLICATIONRULESETSECTION","Rule-HTML-Section","RULE-APPLICATION",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-SECTION RULE-APPLICATION APPLICATIONRULESETSECTION #20180713T135646.848 GMT","!APPLICATIONRULESETSECTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2127536739), 
...
//	RULE-HTML-SECTION RULE-APPLICATION APPLICATIONRULESETSECTION #20180713T135646.848 GMT:20180713T135646.848 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "64008773861566af0f6a5cb250fcc24f";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("ApplicationRuleSetSection",1,"Rule-HTML-Section","{'type':'Section','ruleName':'ApplicationRuleSetSection','insKey':'RULE-HTML-SECTION RULE-APPLICATION APPLICATIONRULESETSECTION #20180713T135646.848 GMT','sectionType':'standard'}");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_7")){
		 ...
		 String buttonUID = "name='ApplicationRuleSetSection_"+ referenceString+ "_14'";
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20140925080329022514581") + "  href='"+hrefValue+"' ");
...
public void repeatingDataCell_7() {
	...
	if(Integer.parseInt(tools.getSaveValue("rowsDisplayed")) == 1) {tools.appendString("width:"); if(!tools.getParamValueCSF("PpyRuleSetList1colWidthCache2").equals("")) { tools.appendParamCSF("PpyRuleSetList1colWidthCache2");} else { tools.appendString("auto;"); }}tools.appendString(""); tools.appendString("'class='");
...
public void repeatingDataCell_6() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("",".pyRuleSetList", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
	if(Integer.parseInt(tools.getSaveValue("rowsDisplayed")) == 1) {tools.appendString("width:"); if(!tools.getParamValueCSF("PpyRuleSetList1colWidthCache1").equals("")) { tools.appendParamCSF("PpyRuleSetList1colWidthCache1");} else { tools.appendString("97.25274725274726"); }tools.appendString("%;");}tools.appendString(""); tools.appendString("'class='");
	tools.appendString(" gridCell");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
	if(!pzAuto.getBrowserUtils().isIE()){ 
...
public void repeatingDataCell_5() {
	...
	String strFieldValue = "";
		tools.appendString("<td title='");
		tools.appendString("'    ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20140925080329022211839") + " ");
		...
		tools.appendString(pzSection.getCustomStyle(true,"","dataLabelRead",""));tools.appendString(" gridCell");tools.appendString(" ");tools.appendString("' pyCellType = 'static' ");
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyRuleSetList1colWidthCache2").equals("")) { tools.appendParamCSF("PpyRuleSetList1colWidthCache2");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
...
public void repeatingDataCell_4() {
	...
	String strFieldValue = "";
		tools.appendString("<td title='");
		tools.appendString("'    ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20140821182825995") + " ");
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyRuleSetList1colWidthCache1").equals("")) { tools.appendParamCSF("PpyRuleSetList1colWidthCache1");} else { tools.appendString("97.25274725274726"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:22px;'"); } 
									tools.appendString(">"); } 
...
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20141013065357074318223") + "  ");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='ApplicationRuleSetSection_"+ referenceString+ "_5'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20140925080329022618554") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Add ruleset",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "",false,"","");tools.appendString("<nobr>");
...
pzSection.getLayout().setExpandParam("SubSectionApplicationRuleSetSectionB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionApplicationRuleSetSectionB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pyRuleSetListL3=null;

 Map selUniqMap_pyRuleSetListL3 = null;
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyRuleSetList");tools.appendString("_ApplicationRuleSetSection_1'");
...
tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201704201123370230903") + " ");
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pyRuleSetList");

					}

					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList='.pyRuleSetList .pyTemplateInputBox  ' class='yui-skin-sam gPercent");

					if(pega_uiengine_harness.pzInStandardsMode()) {tools.appendString("  ");

					}tools.appendString("' style='");

					tools.appendString("' gPropIndex='PpyRuleSetList1' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201704201123370230903-layout") + " ");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpyRuleSetList1colWidthGBL\" id=\"PpyRuleSetList1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyRuleSetList1colWidthGBL"));tools.appendString("\" />");

					
						 tools.putParamValue("expandRL","false"); 

					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpyRuleSetList1colWidthGBR\" id=\"PpyRuleSetList1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyRuleSetList1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpyRuleSetList1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='pyRuleSetList' PL_PROP='");

					
tools.appendString(".pyRuleSetList");

					tools.appendString("' PL_PROP_CLASS='@baseclass' PRIM_PAGE='");
					...
					tools.appendString("'>\n\t\t\t\t\t\t\t\t\t\t<tr class='cellCont' style=\"display:none;\"><td class='cellCont rowHandleHead  ' style='height:24px;width:1%'>");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pyRuleSetList").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pyRuleSetList\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals(".pyRuleSetList")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodes.pyRuleSetList1") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 

					if (tempTestID != null && !tempTestID.isEmpty() && !tempTestID.equals("")){

					String strEntryHandlePLProp = "";

					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle(".pyRuleSetList"); } catch (Exception ex) { }
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201704201123370230903-" + rowTestID) + " ");
					...
					tools.appendString("draggableCell ");tools.appendString("rowHandle  ' style='height:33px;width:1%;'>");
 ...
 tempNoRespg.removeFromClipboard();
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pyRuleSetList1") && tools.getParamValue("partialRefresh").equals("false")) {
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyRuleSetList1")|| tools.getParamValue("partialTrigger").equals("editRow.pyRuleSetList1") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pyRuleSetList");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pyRuleSetList\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pyRuleSetList1")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty(".pyRuleSetList");
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyRuleSetList1") ){
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-APPLICATION APPLICATIONRULESETSECTION #20180713T135646.848 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "ApplicationRuleSetSection");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-APPLICATION APPLICATIONRULESETSECTION #20180713T135646.848 GMT", "Rule-Application ApplicationRuleSetSection", "Pega-SystemArchitect", "08-01-01", "20180713T135646.848 GMT");
}
