 ...
 */
public class ra_stream_pzrundatatransform_0ff9ac5692880839c925a892430c45ea extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzRunDataTransform.OLFHF9_Onboaring_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1477387234;
 ...
 */
	public ra_stream_pzrundatatransform_0ff9ac5692880839c925a892430c45ea(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a6de31ab690ba47bc2a67e3d2bde4a0b77856e5e";
...
{
/* Instance RULE-HTML-SECTION WORK- PZRUNDATATRANSFORM #20230618T001747.910 GMT	Pega-ProcessArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "a6de31ab690ba47bc2a67e3d2bde4a0b77856e5e";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzRunDataTransform",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- PZRUNDATATRANSFORM #20230618T001747.910 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PZRUNDATATRANSFORM #20230618T001747.910 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PZRUNDATATRANSFORM #20230618T001747.910 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRUNDATATRANSFORM","Rule-HTML-Section","WORK-",false,"","Pega-ProcessArchitect","08-23-01","RULE-HTML-SECTION WORK- PZRUNDATATRANSFORM #20230618T001747.910 GMT","!PZRUNDATATRANSFORM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1477387234), 
		...
		new DependentRuleInfo("PYSTEPPAGEREFERENCE","Rule-Obj-Property","@BASECLASS",true,"Work-","Pega-AppDefinition","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYSTEPPAGEREFERENCE #20180713T141555.338 GMT","!PYSTEPPAGEREFERENCE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYTEMPVALUE","Rule-Obj-Property","@BASECLASS",true,"Work-","Pega-UIEngine","08-07-01","RULE-OBJ-PROPERTY @BASECLASS PYTEMPVALUE #20211104T181118.767 GMT","!PYTEMPVALUE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION WORK- PZRUNDATATRANSFORM #20230618T001747.910 GMT:20230618T001747.910 GMT
//	RULE-HTML-PROPERTY PXDROPDOWN #20191010T062311.436 GMT:20191010T062311.436 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYTEMPVALUE #20211104T181118.767 GMT:20211104T181118.767 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "2e04add73b41428ec81d42581aa90343";
	}
...
config.put("pyPreDataTransform.pyName", "pzSetDataTransformValue");
config.put("pzDataTransformStaticParams", "PropertyToSet");
config.put("PropertyToSet", "pyRunDataTransform");
pega.getUIEngine().getUIAction("runDataTransform", config).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.datatransform.displayDefineNewDataTransformOverlay");
pega.getUIEngine().getUIAction("runScript", config).register();
config = new HashMap<String, String>();
config.put("ActionSection", "pyOverlayTemplate");
config.put("NewTaskStatus", "pzEnterDataTransformName");
pega.getUIEngine().getUIAction("localAction", config).register();
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("pzActivity", "pzLoadDataTransform");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("ActionSection", "pyOverlayTemplate");
config.put("NewTaskStatus", "pzEditDefinition");
pega.getUIEngine().getUIAction("localAction", config).register();
config = new HashMap<String, String>();
config.put("pxObjClass", "Rule-Obj-Model");
config.put("dynamicKey", "true");
pega.getUIEngine().getUIAction("openRuleByKeys", config).register();
config = new HashMap<String, String>();
config.put("pySectionName", "pzRunDataTransform");
...
getControlMarkup_1() {
try {
if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyTempValue").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
	pzAuto.getUIComponentRuntime().setTemplatingUIStatus('Y');
}pxDropdown_1(".pyTempValue",0,"","","Text");pzAuto.getUIComponentRuntime().insertTemplateScripts();}
} catch(Throwable t) {
...
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	cellPage.put("pyID","pyStepPageReference");
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("202212201541180264492",true));
...
boolean bUITemplatized = pzAuto.getUIComponentRuntime().isTemplateRendering();pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);
	tools.appendString("<input  type=\"hidden\"  " + pzCell.getTestIdIfEnabled("202212201541180264492") + "  id=\"");
...
public void field_pzDataTransformActions_2() { 
...
_jspx_th_pega_reference__2.setFormat("pzDataTransformActions");
...
public void field_pzDataTransformActions_1() { 
String mode1 = getActionsForCustomControls_1();
tools.putSaveValue("mode1Action",mode1);
String mode2 = getActionsForCustomControls_1();
tools.putSaveValue("mode2Action",mode2);
...
_jspx_th_pega_reference__1.setFormat("pzDataTransformActions");
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzRunDataTransformBBBB"));
if("".equals(tools.getParamValue("EXPANDEDSubSectionpzRunDataTransformBBBB"))) {
metadataPage.put("expanded",true);
} else {
metadataPage.put("expanded",Boolean.parseBoolean(tools.getParamValue("EXPANDEDSubSectionpzRunDataTransformBBBB")));
}
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Parameters", "pyCaption");
...
metadataPage.put("uniqueid", "202602230417590032");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("202301191520060036344") + " ");
...
expandedSecId="EXPANDEDSubSectionpzRunDataTransformBBBB" + expandRLExprValue;
...
public void getNextPage_1(String listSource, int listStartIndex, int listEndIndex) {
	...
	map.put("pxDataSourceId", pxUniqueStreamHash+"_35");
	...
	nextPageMetadata.put("datasrcid",pxUniqueStreamHash+"_35");
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("202301191520060036344" ) + "");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_33","pzDataTransformParameters", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzDataTransformParameters"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzRunDataTransform778","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_30","pzDataTransformParameters", secInfo);
}
...
public int simpleLayoutCell_6(  int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzDataTransformParameters",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row ' ");
	...
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("202301191520060036344-" + rowTestID) + " ");
	}else {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzDataTransformParameters",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
String pyInstanceId ="";
char mode = tools.getProperty(".pyDOParamList").getMode();
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
pgSection.put("class","content    flex  layout-content-stacked content-stacked overflow-y-auto"); 
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  ".pyDOParamList AddDelete", expressionId, true);
expressionId = expression.getId();
}
pgRDMetadata.put("rdlheight","500");
ClipboardProperty rdlPageListProp = tools.getProperty(".pyDOParamList");
String rdlPageListPropRef = ".pyDOParamList";
if(rdlPageListProp != null) {
rdlPageListPropRef = rdlPageListProp.getReference();
}
String rdlRefreshWhenStr = ".pyDOParamList AddDelete";
rdlRefreshWhenStr = rdlRefreshWhenStr.replace(".pyDOParamList",rdlPageListPropRef);
if(!StringUtils.isBlank(expressionId)) {
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyDOParamList").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
} else {
pgSectionBody.put("pageListProp", ".pyDOParamList");
}
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pzPackageRuntime.packageProperty(tools.getProperty(".pyDOParamList").getReference(), null);
}
...
pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("202301191520060036344" ) + "");
...
map.put("pyContext", ".pyDOParamList");
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyDOParamList").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyDOParamList").getReference(),"", false),pyInstanceId);
}
tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
ClipboardProperty cpSource = tools.getProperty(".pyDOParamList");
...
dummyPageName = "Dummy_pyDOParamList";
}
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyDOParamList").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
itemPage = tools.createPage("Embed-NameValuePair",dummyPageName);
PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
simpleLayoutCell_6(1);
	pega.popStackFrame(itemFrame, false);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyDOParamList").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
}
}else{
if(mode =='L' || mode =='G'){
Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyDOParamList").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty(".pyDOParamList").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("pzRunDataTransform",
...
pzSection.getLayout().setExpandParam("SubSectionpzRunDataTransformBBBB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='layout layout-outline layout-outline-nested' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpzRunDataTransformBBBB";
...
pzLayout.createECImgForDivHeader(true,"Expanded", l_sectionTitle, false,false,true,"",false,true,"202602230417590027","aria-level=2");
} else {
 tools.putSaveValue("EXPAND_COLLAPSE" ,"");
pzLayout.createECImgForDivHeader(false,"Collapsed", l_sectionTitle, false,false,true,"",false,true,"202602230417590027","aria-level=2");
}
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzRunDataTransformBBBB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_3() {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplateComponent(pxUniqueStreamHash+"_36");
	}
	int totalRecords=0;
	...
	tools.appendString(tools.getProperty(".pyDOParamList").getReference()+ "' ");
	tools.appendString("   class=' flex content   layout-content-stacked content-stacked overflow-y-auto layout-fixed-height '  style='max-height:500px'");
	String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
	ClipboardProperty rdlPageListProperty = tools.getProperty(".pyDOParamList");
	String rdlPageListPropRef = ".pyDOParamList";
...
try {
tools.appendString("RWP=\".pyDOParamList\" RW=\"");
tools.appendString(rdlRefreshWhenStr);
tools.appendString("\"");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
	tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("202301191520060036344" ) + " ");
	tools.appendString(">");
	int index = 1;
	...
	rdlPageListProp = tools.getProperty(".pyDOParamList");
...
String paramName = "EXPANDEDSubSectionpzRunDataTransformBBBB";
...
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzDataTransformHasParameters", pxUniqueStreamHash+"_37");metadataPage.put("dlChild","true");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzDataTransformHasParameters","pzDataTransformHasParameters", "layout", "visible" )) {pzSetExpandParam_4();
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"openRuleByKey\",[\"Rule-Obj-Model\",\"");
		...
		tools.appendString(XMLUtils.encodeString("pyModelName") + "=");
		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyRunDataTransform")+"~#");	tools.appendString("\",\"");

		tools.appendFormatted("8fe27020-af9f-4312-b044-a5364b82ea8b",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			...
			ct_controlAction.trackValueChanges(tools.getProperty(".pyRunDataTransform"), -1);
...
try {
	...
	cellPage.put("pyStreamName","pzRunDataTransform");
	...
	String classProp = "";
	classProp ="pi pi-target";
	modePage1.put("class",classProp);
	if(disable){
	modePage1.put("pyDisabled",disable+"");
	}
	modePage1.put("iconSrc","styleclass");
	modePage1.put("pyFormatTypeActionable","url");
	modePage1.put("pyFormatValue",pyFormatValue);
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20221115152440092565") + " ");
	String spxUniqueStreamHash22 = getUIActionsMetaData_4();
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzRunDataTransform_"+ referenceString+ "_7'";
		 String pyFormatValue = "";
		String hrefValue = "";
		hrefValue = pyFormatValue;
		String proprefAttr = "";
		...
		String classProp = "";
		 classProp ="pi pi-target";
		tools.appendString("<a href='"+hrefValue+"' href_original='' tabindex='-1' fromicon");
		tools.appendString(" target='_blank'");
		tools.appendString(">");
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("20221115152440092565") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzLoadDataTransform");
		tools.appendString("[\"runActivity\", [\"\", \"pyClassName=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pxObjClass")+"~#");		tools.appendString("&pyModelName=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyRunDataTransform")+"~#");		ractParamStr.append(!"".equals(ractParamStr.toString())? ",pyReturnsResponse:false": "pyReturnsResponse:false");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }			{
				...
				keyMap.putString("pyActionName", "pzEditDefinition");
				String strLAClassName = "";
				String offlineUsingPage = "pyDataTransformPage";
				strLAClassName = "Rule-Obj-Model";
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
				try{
				pzPackageRuntime.packageLocalAction("pzEditDefinition", offlineUsingPage , strLAClassName);
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						...
						String usingPage = "pyDataTransformPage";
						if(("").equals(usingPage)) { usingPage = tools.getStepPage().getReference(); }
						if("true".equals(bHasPrivilege )) {
							tools.appendString("[\"processAction\", [\"pzEditDefinition\",\"overlay\",\":event\",\"pyDataTransformPage\",\""+streamType+"\",\"\",\"pzModalTemplate\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-null%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22effect%22%3A%22anim-null%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"true\",\"true\",\"\",\"\"]");
							} else {
...
try {
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Edit Data Transform\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Edit Data Transform", ".pyActionPrompt");
	}
	pyTooltip = "Edit Data Transform";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("202301191536350132514") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzRunDataTransform_"+ referenceString+ "_6'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		boolean sectionIsReadOnly = !(tools.getParamValue("SectionReadOnly") !="-1" && tools.hasInputEnabled());
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		String tempText = StringUtils.crossScriptingFilter(tools.getLocalizedTextForString(".pyActionPrompt","Edit Data Transform\t" + repeatIndx ,StreamBuilder.FMT_LITERAL));
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("202301191536350132514") + "  href='"+hrefValue+"' ");
...
public int simpleLayoutCell_2( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("202301191536350132514-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("202301191536350132514-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202301191536350132514-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzIsPegaExpress",pxUniqueStreamHash+"_20");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzIsPegaExpress", pxUniqueStreamHash+"_20"); 
	}
...
public int simpleLayoutCell_3( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","max-width-100-pct width-100-pct","max-width-100-pct width-100-pct")  + " flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20221115152440092565-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20221115152440092565-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","remove-all-spacing flex");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20221115152440092565-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxIcon");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","max-width-100-pct width-100-pct");
	pgCells.put("customRWStyles","max-width-100-pct width-100-pct");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxpzIsPegaExpress",pxUniqueStreamHash+"_24");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpzIsPegaExpress", pxUniqueStreamHash+"_24"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxIcon_2();}
...
pzSection.getLayout().setExpandParam("SubSectionpzRunDataTransformBBB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202211151440130594994") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  layout-content-inline content-inline minimum-height-zero margin-0" + "'  ");
		...
		pg_dlmeta.put("customClassName","minimum-height-zero margin-0");
	...
	String paramName = "EXPANDEDSubSectionpzRunDataTransformBBB";
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2!= rx.pyRunDataTransform cq o2!= rx.pyRunDataTransform cqCREATE_NEW", pxUniqueStreamHash+"_25");metadataPage.put("dlChild","true");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2!= rx.pyRunDataTransform cq o2!= rx.pyRunDataTransform cqCREATE_NEW",".pyRunDataTransform != \'\' && .pyRunDataTransform != \'CREATE_NEW\'", "layout", "visible" )) {pzSetExpandParam_3();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void inclFormattedVal_2(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {if (isSecuredProp) { tools.putParamValue("proSecurity_isSecuredProp", isSecuredProp);tools.putParamValue("proSecurity_activePropValue", activePropValue);}
		...
		tools.appendString(pega_uiengine_formatter.pxFormatText(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzGetCaseStepDataTransforms","","","D_pzGetCaseStepDataTransforms:ContextClass$.pxObjClass",".pyLabel",".pyRuleName",true,(PegaStreamAPI)tools),false,"","",true,"caption"));
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzGetCaseStepDataTransforms","","","D_pzGetCaseStepDataTransforms:ContextClass$.pxObjClass",".pyLabel",".pyRuleName",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("isControlEditableOriginal"))) {
		...
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzGetCaseStepDataTransforms","","","D_pzGetCaseStepDataTransforms:ContextClass$.pxObjClass",".pyLabel",".pyRuleName",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("FORMAT_PLAIN_TXT")) && ((pzAuto.getBrowserUtils().isIE() && !pega_uiengine_harness.pzInStandardsMode()) || "true".equals(tools.getParamValue("fromAPI"))) ){
			tools.appendString("&nbsp;");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		actionRequestD.registerFixedParameter("pyModelName","pzSetDataTransformValue");
			String usingPageString = "";
			usingPageString = pzAuto.getUIComponentRuntime().generateActionTokenForPage();
			tools.appendString("[\"runDataTransform\", [\"pzSetDataTransformValue\", \"PropertyToSet=pyRunDataTransform");
			actionRequestD.registerFixedParameter("PropertyToSet","pyRunDataTransform");
			tools.appendString("&Value=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyTempValue")+"~#");			tools.appendString("\", \"" + usingPageString);
			if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			...
			pzPackageRuntime.packageDataTransform(contextClass, "pzSetDataTransformValue");
			}
				pzAuto.registerActionRequest(actionRequest);
				}
				tools.appendString("\",\":event\"]");

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }				tools.appendString("[\"runScript\", [\"pega.datatransform.displayDefineNewDataTransformOverlay(event,");
				String strPropReference32 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyTempValue")+"~#";
				String strFormattedPropReference32 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference32);
				if(strPropReference32.equals(strFormattedPropReference32)) {
				tools.appendString("\\\"");
				tools.appendFormatted(strFormattedPropReference32.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
				tools.appendString("\\\"");
				} else {
				tools.appendFormatted(strFormattedPropReference32.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
				}
				tools.appendString(",");
				String strPropReference33 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pxObjClass")+"~#";
				String strFormattedPropReference33 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference33);
				if(strPropReference33.equals(strFormattedPropReference33)) {
				tools.appendString("\\\"");
				tools.appendFormatted(strFormattedPropReference33.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
				tools.appendString("\\\"");
				} else {
				tools.appendFormatted(strFormattedPropReference33.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
				}
				tools.appendString(",");
				String strPropReference34 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyStepPageReference")+"~#";
				String strFormattedPropReference34 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference34);
				if(strPropReference34.equals(strFormattedPropReference34)) {
				tools.appendString("\\\"");
				tools.appendFormatted(strFormattedPropReference34.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
				tools.appendString("\\\"");
				} else {
				tools.appendFormatted(strFormattedPropReference34.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
				}
				tools.appendString(",\\\"pzRunDataTransform\\\",\\\"pyRunDataTransform\\\")\"]");
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
					...
					StringMap keyMap = new HashStringMap();
					keyMap.putString("pxObjClass", "Rule-Obj-FlowAction");
					keyMap.putString("pyActionName", "pzEnterDataTransformName");
					String strLAClassName = "";
					String offlineUsingPage = "pyDefineNewDataTransform";
					strLAClassName = "Rule-Obj-Model";
					keyMap.putString("pyClassName", strLAClassName);
					ParameterPage newParamsPage = new ParameterPage();
					newParamsPage.putString("pyFlowActionPurpose", "GETSTREAMTYPE");
					...
					if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
					pzPackageRuntime.packageLocalAction("pzEnterDataTransformName", offlineUsingPage , strLAClassName);
					pzPackageRuntime.packageSection("pyOverlayTemplate", offlineUsingPage, strLAClassName, true);
					}catch(Exception e1){oLog.error("Error generating local action package - " + e1.getMessage());}
					if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
						try{
							...
							if(streamType.equals("")) { streamType = "Rule-Obj-FlowAction"; }
							String usingPage = "pyDefineNewDataTransform";
							if(("").equals(usingPage)) { usingPage = tools.getStepPage().getReference(); }
							if("true".equals(bHasPrivilege )) {
								tools.appendString("[\"processAction\", [\"pzEnterDataTransformName\",\"overlay\",\":event\",\"pyDefineNewDataTransform\",\""+streamType+"\",\"pz-po-c-fixed_size\",\"pzModalTemplate\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-null%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22effect%22%3A%22anim-null%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"true\",\"false\",\"\",\"\"]");
								} else {
									tools.appendString("[\"processAction\", [\"You are not authorized to perform this Flow or Local action\"]");
									}
									}
		...
		tools.appendString("=");
		tools.appendString("\",\"CREATE_NEW\"");
		tools.appendString(",\"");		if(com.pegarules.generated.pega_uiengine_expressionevaluators.pzCompareValues(tools.getActive().getStringValue(),"=","CREATE_NEW") == true){
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty(".pyTempValue"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pxObjClass"), -1);
...
tools.appendString("</P>");
	...
	String repeatIndx = "";
	IUIComponentMetadata pyUserData = pzAuto.getUIComponentRuntime().createMetadata();
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("202012021445130533360",true));
	cellPage.put("pyValue",".pyTempValue");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyTempValue");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyTempValue", ".pyCaption");
	...
	String clientValidationAttributes = pzAuto.getCell().getClientValidationAttributes(pyOnInput, pyEditValidate, pyStringType,pegaValidation.toString());
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyTempValue",pxUniqueStreamHash+"_6");
	...
	modePage1.put("pyID","pyTempValue");
	...
	tools.getProperty(".pxObjClass").getStringValue()
	);
	Map<String, String> sourceDPParams = new HashMap<String, String>();
	sourceDPParams.put("ContextClass", ".pxObjClass");
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
	tools.findPage("D_pzGetCaseStepDataTransforms");
	}
	tools.putParamValue("bListOptionsLocalize","true");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadDataPage("D_pzGetCaseStepDataTransforms", listProperties, pxUniqueStreamHash+"_7", sourceDPParams);
	...
	pyDataPageParams.put("pyValue","#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pxObjClass")+"~#");
	...
	String pageName = "D_pzGetCaseStepDataTransforms";
	String dataPageName = "D_pzGetCaseStepDataTransforms";
	if(tools.findPage("D_pzGetCaseStepDataTransforms") != null){
	pageName = tools.findPage("D_pzGetCaseStepDataTransforms").getReference();
	}
	modePage1.put("pySourceName",dataPageName);
	modePage1.put("pyHashedDataPage",pageName);
	pageName = "D_pzGetCaseStepDataTransforms";
	...
	try{
		if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){ 
		 ...
		 expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("cellRefreshWhen",  ".pxObjClass Changes", expressionId);
	...
	modePage2.put("pySourceName","D_pzGetCaseStepDataTransforms");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyTempValue");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyTempValue", ".pyCaption");
	pyValueR = ".pyTempValue";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyTempValue");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyTempValue", ".pyCaption");
	pyValueOrig = ".pyTempValue";
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_11");}if(beginNonTemplate){			HashStringMap params = new HashStringMap();
	...
	pageName = tools.getStepPage().getName()+pageName;
			...
			tools.appendString("<div id='CT'  RCW = '.pxObjClass' RC = '.pxObjClass Changes' CellId = '3");
	...
	if(tools.getThread().getName().indexOf("/$WorkProcessing") != -1 || tools.getThread().getName().indexOf("/$FlowModalProcess") != -1 ) {
			...
			try{
				if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
					...
					cellChangeTracker.trackValueChanges(tools.getStepPage().getReference()+".pxObjClass", -1);
				}
			}catch(Exception e){}
		...
		String strActiveValue = isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true);			String strValue = isSecuredProp ? activePropValue : tools.getProperty(ddPropRef).getStringValue();
			...
			if(!isAccessible) {
				...
				tools.appendString(" " + pzCell.getTestIdIfEnabled("202012021445130533360") + " ");
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("202012021445130533360") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
...
if(pegaValidation != null) {
	...
	tools.putActive(propActivePrev); 									} catch (Exception e) {
	 ...
	 if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'									&& pzAuto.getUIComponentRuntime().getRuntimeContextTree().isLiveDesignViewMode()){
		...
		IUIComponentMetadata metadata = pzAuto.getUIComponentRuntime().createMetadata();
		IUIComponent ctrlComponent = pzAuto.getUIComponent();
		metadata.put("cellInfo", "Run Data Transform");
		metadata.put("msgText", "config issue");
		ctrlComponent.addDependentScripts("pzpega_ui_template_designview.js");
		ctrlComponent.beginComponent("pxDesignViewError", metadata);
		tools.putParamValue("isControlEditableOriginal", true);
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDropdown",".pyTempValue",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-left-spacing   flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("202012021445130533360-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	
	ClipboardProperty propActivePrev = tools.getActive();
	tools.putActive(tools.getStepPage().getProperty(".pyTempValue"));
	tools.appendString("for='" + tools.getHTMLIDForProperty(true,"label") + "'");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString(spanAttr + "='iconRequired standard (label for field)_iconRequired' ");
	}
	tools.appendString(">" + tools.getLocalizedTextForString("pyCaption","Run Data Transform") + "</span>");
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("202012021445130533360-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");pxDropdown_1(".pyTempValue",0,"","","Text");
tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202012021445130533360-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDropdown");
	pgCells.put("forLabel",".pyTempValue");
	pgCells.put("pyAutoHTML","true");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen("",pxUniqueStreamHash+"_15");
	pxWhenIdentifiersForCell.put("pyRequiredWhenId",pxUniqueStreamHash+"_15");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDropdown",".pyTempValue",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDropdown_1(".pyTempValue",0,"","","Text");labelName = "Run Data Transform";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_4( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2!= rx.pyRunDataTransform cq o2!= rx.pyRunDataTransform cqCREATE_NEW",".pyRunDataTransform != \'\' && .pyRunDataTransform != \'CREATE_NEW\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2!= rx.pyRunDataTransform cq o2!= rx.pyRunDataTransform cqCREATE_NEW",pxUniqueStreamHash+"_27");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_27");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyRunDataTransform != '' && .pyRunDataTransform != 'CREATE_NEW'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Work-");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_27");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2!= rx.pyRunDataTransform cq o2!= rx.pyRunDataTransform cqCREATE_NEW", pxUniqueStreamHash+"_27"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_1();
 tools.putSaveValue("ContainerID", "");}
...
pzSection.getLayout().setExpandParam("SubSectionpzRunDataTransformBB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202212061358490213154") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  set-width-auto layout-content-inline content-inline nowrap" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzRunDataTransformBB";
...
public int simpleLayoutCell_5( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing set-width-auto   flex flex-row '  STRING_TYPE='layout' RESERVE_SPACE='false'>");
	pzLayout_2();
 tools.putSaveValue("ContainerID", "");tools.appendString("</div>");
	index++;
	return index;
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("pyType","layout");
	pgCells.put("RWActive","false");
	pgCells.put("partialClass","remove-left-spacing remove-right-spacing set-width-auto flex flex-row");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	...
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	pzLayout_2();
 tools.putSaveValue("ContainerID", "");labelName = "Run data transform";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_7( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpzDataTransformHasParameters","pzDataTransformHasParameters","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzDataTransformHasParameters",pxUniqueStreamHash+"_40");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_40");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzDataTransformHasParameters");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Work-");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_40");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzDataTransformHasParameters", pxUniqueStreamHash+"_40"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_4();
 tools.putSaveValue("ContainerID", "");}
...
public int simpleLayoutCell_8( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzDataTransformActions",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","margin-0 min-height-0","margin-0 min-height-0")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_41")) {	field_pzDataTransformActions_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString(pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-left-spacing remove-right-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202211301239080140583-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzDataTransformActions");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","false");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","margin-0 min-height-0");
	pgCells.put("customRWStyles","margin-0 min-height-0");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pzDataTransformActions",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_44")) {	field_pzDataTransformActions_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_9( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_1(".pyStepPageReference",0,"","","Text");
	return index;
}
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	String reqExpressionId = null;
	String disExpressionId = null;
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_2(".pyStepPageReference",0,"","","Text");
	index++;
	return index;
}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpzRunDataTransformB","",false);
}
...
public void simpleLayout_4() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  auto-width-column layout-content-stacked content-stacked content-items-maxwidth" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzRunDataTransformB";
...
static {
	oPropDefinitions_1.put("OLFHF9-Onboaring-Work-Onboarding.pyTemplateInputBox", new LiteweightPropertyDefinition("OLFHF9-Onboaring-Work-Onboarding", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- PZRUNDATATRANSFORM #20230618T001747.910 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PZRUNDATATRANSFORM #20230618T001747.910 GMT", "Work- pzRunDataTransform", "Pega-ProcessArchitect", "08-23-01", "20230618T001747.910 GMT");
}
