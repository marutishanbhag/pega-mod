...
/**
 * Builds JSP stream @BASECLASS!PZNOEXPLORERCASETYPES.
 */
public class ra_stream_pznoexplorercasetypes_e6b09e86f19405e45a64475c099e61e5 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzNoExplorerCaseTypes.Pega_Ext_ExpExplorer_Case.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1607461559;
 ...
 */
	public ra_stream_pznoexplorercasetypes_e6b09e86f19405e45a64475c099e61e5(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "82520aa7377d77feef50e194fc790b53d13bde65";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZNOEXPLORERCASETYPES #20191118T143107.160 GMT	Pega-ProcessArchitect:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "82520aa7377d77feef50e194fc790b53d13bde65";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzNoExplorerCaseTypes",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZNOEXPLORERCASETYPES #20191118T143107.160 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZNOEXPLORERCASETYPES #20191118T143107.160 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZNOEXPLORERCASETYPES #20191118T143107.160 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZNOEXPLORERCASETYPES", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZNOEXPLORERCASETYPES","Rule-HTML-Section","@BASECLASS",false,"","Pega-ProcessArchitect","08-04-01","RULE-HTML-SECTION @BASECLASS PZNOEXPLORERCASETYPES #20191118T143107.160 GMT","!PZNOEXPLORERCASETYPES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1607461559), 
...
//	RULE-HTML-SECTION @BASECLASS PZNOEXPLORERCASETYPES #20191118T143107.160 GMT:20191127T135040.016 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "d2e79627a63bf29fee99d205c94556ea";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzNoExplorerCaseTypes",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzNoExplorerCaseTypes','insKey':'RULE-HTML-SECTION @BASECLASS PZNOEXPLORERCASETYPES #20191118T143107.160 GMT','templated':'true','editable':'true','sectionType':'standard'}");
pzLayout_3();
...
public void buildSection_4() { 
	...
	secInfo.put("usingPage","D_pzCaseTypeConfiguration");
	secInfo.put("isUsingPagePropertyRef",false);
	secInfo.put("doNotConsiderDecParams",false);
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	Map<String, String> secParams = new HashMap<String, String>();
	secParams.put("Context","EmptyTemplate");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_18","pzCreatNewCaseType", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	tools.putParamValue("Context","EmptyTemplate");tools.putParamValue("section_params","");
	{tools.putParamValue("decParamList","{}");tools.putParamValue("sectionPageNameBase","D_pzCaseTypeConfiguration");}
	...
	String sectionName = "pzCreatNewCaseType"; 
	String usingPage = null;
	usingPage = "D_pzCaseTypeConfiguration";
...
pzSection.getLayout().setExpandParam("SubSectionCellpzNoExplorerCaseTypes949","",false);
}
...
public void buildSection_3() { 
	...
	secParams.put("Context","EmptyTemplate");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_15","pzCreatNewCaseType", secInfo);
}
...
try {
	...
	cellPage.put("pyStreamName","pzNoExplorerCaseTypes");
	cellPage.put("pyCellID","2eeac6b4-1aad-43c6-86e8-c6a6163ce4d4");
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2019110106362001172eeac6b4-1aad-43c6-86e8-c6a6163ce4d4564") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzNoExplorerCaseTypes_"+ referenceString+ "_2eeac6b4-1aad-43c6-86e8-c6a6163ce4d4'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		String classProp = "";
		 classProp ="pi pi-3x pi-chevron";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("2019110106362001172eeac6b4-1aad-43c6-86e8-c6a6163ce4d4564") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
public void buildSection_2() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzFormClean", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzFormClean"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpzNoExplorerCaseTypes997","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzFormClean", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzFormClean",".pyRegions(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzFormClean",".pyRegions(1).pyCells(1)");
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pyRegions(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-left-spacing remove-right-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2019110106362001172eeac6b4-1aad-43c6-86e8-c6a6163ce4d4564-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pyRegions(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxIcon_1();labelName = "";
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pyRegions(1).pyCells(3)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","centered","centered")  + " ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("2019110106401001127bf9cf6f-5815-4cdb-9cde-d09714b5afd4512")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Nocasetypes") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("partialClass","remove-left-spacing remove-right-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2019110106401001127bf9cf6f-5815-4cdb-9cde-d09714b5afd4512")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("Label",null,".pyRegions(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	labelName = "Nocasetypes";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pyRegions(1).pyCells(4)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","centered","centered")  + " ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("2019110106401001120a0f5ede-d459-4858-94ce-55ba83de9ade425")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Acaserepresents") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("useLabel","true");
	pgCells.put("partialClass","remove-left-spacing remove-right-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2019110106401001120a0f5ede-d459-4858-94ce-55ba83de9ade425")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("pyAutoHTML","false");
	pgCells.put("spanClass","iconRequired _iconRequired");
	pgCells.put("customROStyles","centered");
	pgCells.put("customRWStyles","centered");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("Label",null,".pyRegions(1).pyCells(4)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	labelName = "Acaserepresents";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutCell_5( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpzCanCreateWorkTypesForExplorer","pzCanCreateWorkTypesForExplorer","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzCreatNewCaseType",".pyRegions(1).pyCells(5)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzCanCreateWorkTypesForExplorer",pxUniqueStreamHash+"_17");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_17");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzCanCreateWorkTypesForExplorer");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzCanCreateWorkTypesForExplorer", pxUniqueStreamHash+"_17"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzCreatNewCaseType",".pyRegions(1).pyCells(5)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzNoExplorerCaseTypesB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)','region':'A'}") + " class='" + "flex  content  layout-content-stacked content-stacked centered margin-tb-3x" + "'  ");
		...
		pg_dlmeta.put("customClassName","centered margin-tb-3x");
	...
	String paramName = "EXPANDEDSubSectionpzNoExplorerCaseTypesB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZNOEXPLORERCASETYPES #20191118T143107.160 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzNoExplorerCaseTypes");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZNOEXPLORERCASETYPES #20191118T143107.160 GMT", "@baseclass pzNoExplorerCaseTypes", "Pega-ProcessArchitect", "08-04-01", "20191127T135040.016 GMT");
}
