...
/**
 * Builds JSP stream PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM!PZSYSTEMDETAILSMAIN.
 */
public class ra_stream_pzsystemdetailsmain_3263db1e961fdf5515bfa3c2bafc674c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSystemDetailsMain.Pega_Ext_AdminStudio_Explorer_Settings_System.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 269910121;
 ...
 */
	public ra_stream_pzsystemdetailsmain_3263db1e961fdf5515bfa3c2bafc674c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "dbcfd26b9f50b609de88c118f796959d54b7aeb3";
...
{
/* Instance RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMDETAILSMAIN #20200116T114436.662 GMT	Pega-Desktop:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "dbcfd26b9f50b609de88c118f796959d54b7aeb3";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSystemDetailsMain",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMDETAILSMAIN #20200116T114436.662 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMDETAILSMAIN #20200116T114436.662 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMDETAILSMAIN #20200116T114436.662 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZSYSTEMDETAILSMAIN"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSYSTEMDETAILSMAIN","Rule-HTML-Section","PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM",false,"","Pega-Desktop","08-05-01","RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMDETAILSMAIN #20200116T114436.662 GMT","!PZSYSTEMDETAILSMAIN",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",269910121)
	};
...
//	RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMDETAILSMAIN #20200116T114436.662 GMT:20200116T114436.662 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "19aad4b2504cb912f315a6b9d0868f63";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSystemDetailsMain",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSystemDetailsMain','insKey':'RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMDETAILSMAIN #20200116T114436.662 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_4();
pzLayout_6();
...
metadataPage.put("pyStyle","height:34px;width:235px;");
metadataPage.put("pyInspectorData",pzCell.getInspectorDataDynamic("SUB_SECTION","",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pyHeaderTable.pyRows(1).pyCells(1)"));
metadataPage.put("pyWrap","false");
metadataPage.put("pyRenderedStyle",pzSection.getCustomStyle(false, "", "", ""));
boolean pyVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpyIsNodeAgnosticAdminStudio", pxUniqueStreamHash+"_18");
...
if(pyVisibility){
sectionBodyIncludeInCell_6(false,false,"","pzNodesActionsWrapper");
} else {
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
}
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionCellpzSystemDetailsMain109"));
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Nodes", "pyCaption");
...
metadataPage.put("title","Nodes");
metadataPage.put("uniqueid", "202404190305130836");
...
public void buildSection_7() { 
	...
	secInfo.put("usingPage","D_pzNodesList");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_17","pzNodesList", secInfo);
}
...
public void sectionBodyIncludeInCell_7() { 
	...
	{tools.putParamValue("decParamList","{}");tools.putParamValue("sectionPageNameBase","D_pzNodesList");}
	...
	String sectionName = "pzNodesList"; 
	String usingPage = null;
	usingPage = "D_pzNodesList";
...
public void buildSection_6() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_16","pzNodesActionsWrapper", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzSystemDetailsMain109","",true);
}
public void LayoutWrapperTableStart_4() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)','clipboardPath':'pzNodesList'}") + " class='layout layout-outline layout-outline-default' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionCellpzSystemDetailsMain109";
...
String labelName = "Nodes";
labelName =  tools.getLocalizedTextForString(".pyCaption","Nodes");
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel68' data-layout-id='202404190305130830" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel68'>" + l_sectionTitle + "</h2>");
...
try {
tools.appendString("height:34px;width:235px;");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
tools.appendString("'>");

sectionBodyIncludeInCell_6(false,false,"","pzNodesActionsWrapper");tools.appendString("</span>");
}
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionCellpzSystemDetailsMain109","tdRightStyle");}
if(showContainerIcons){
...
String paramName = "EXPANDEDSubSectionCellpzSystemDetailsMain109";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)','clipboardPath':'pzNodesList'}");
...
public void buildSection_5() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_13","pzNodesList", secInfo);
}
...
tools.appendString("<div  class='layout layout-outline layout-outline-default' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionCellpzSystemDetailsMain579";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\">");
...
String l_sectionTitleFVMeta = "";
l_sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","Nodes");
String sectionImageTitle="";
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");


	/***-- Grid HeaderElements: Begin --**/
tools.appendString("<div class='header header-bar test clearfix' id='RULE_KEY' node_type='HEADER' tabindex='0' role='heading' aria-level='2' aria-label='Nodes'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2 class='header-title'>" + l_sectionTitle + "</h2><span class='header-element header-title-table'><table cellspacing='0' cellpadding='0'><tr></tr></table></span>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div><div class='header-right'></div></div>");
...
public int simpleLayoutCell_3( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzNodesList",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	...
	tools.putParamValue("RenderSingle","");
	tools.appendString("<div section_index='9' id='INNERDIV' class='layout-body' > ");
	sectionBodyIncludeInCell_5();tools.appendString("</div>");
	 LayoutWrapperTableEnd_1(); tools.putParamValue("RenderSingle",tempRenderSingle);
	tools.appendString("</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzNodesList",".pySections(3).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzSystemDetailsMainBBB","",false);
}
...
public void simpleLayout_3() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201804130645080056170") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzSystemDetailsMainBBB";
...
IUIComponentMetadata metadataPage = pzAuto.getUIComponentRuntime().createMetadata();
IUIComponent headerComponent = pzAuto.getUIComponent();
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionCellpzSystemDetailsMain647"));
String sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
if(!"".equals(sectionTitleFVMeta)){
metadataPage.put("fieldValueMeta",sectionTitleFVMeta);
}
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("System details", "pyCaption");
String inspectorFVData = pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData();
if(!"".equals(inspectorFVData)){
metadataPage.put("fieldValueInspectorData",inspectorFVData);
}
metadataPage.put("title","System details");
metadataPage.put("uniqueid", "202404190305130824");
metadataPage.put("automationId", "");
headerComponent.beginComponent("pxLayoutHeader",metadataPage);
headerComponent.endComponent();
}
...
public void buildSection_4() { 
	Map<String, Object> secInfo = new HashMap<String, Object>();
	secInfo.put("usingPage","SystemRecord");
	secInfo.put("isUsingPagePropertyRef",false);
	secInfo.put("doNotConsiderDecParams",false);
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pzSystemDetails", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pzSystemDetails"; 
	String usingPage = null;
	usingPage = "SystemRecord";
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
	}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzSystemDetailsMain647","",true);
}
public void LayoutWrapperTableStart_2() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)','clipboardPath':'pzSystemDetails'}") + " class='layout layout-outline layout-outline-default' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionCellpzSystemDetailsMain647";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\">");
...
String l_sectionTitleFVMeta = "";
l_sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
String labelName = "System details";
labelName =  tools.getLocalizedTextForString(".pyCaption","System details");
l_sectionTitle = labelName;
String sectionImageTitle="";
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");
	...
	/***-- Grid HeaderElements: Begin --**/
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel7203' data-layout-id='202404190305130821" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel7203'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionCellpzSystemDetailsMain647","tdRightStyle");}
if(showContainerIcons){
tools.appendString("</tr></table>");
}
tools.appendString("</span>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div><div class='header-right'></div></div>");
...
String paramName = "EXPANDEDSubSectionCellpzSystemDetailsMain647";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)','clipboardPath':'pzSystemDetails'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
public void buildSection_3() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_8","pzSystemDetails", secInfo);
}
...
tools.appendString("<div  class='layout layout-outline layout-outline-default' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionCellpzSystemDetailsMain386";
if("true".equals(tools.getParamValue("expandRL"))) {
expandParameter += StringUtils.crossScriptingFilter(tools.getParamValue("index"));
}
tools.appendString("PARAM_NAME=\"" + expandParameter + "\">");
...
String l_sectionTitleFVMeta = "";
l_sectionTitleFVMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","System details");
String sectionImageTitle="";
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");


	/***-- Grid HeaderElements: Begin --**/
tools.appendString("<div class='header header-bar test clearfix' id='RULE_KEY' node_type='HEADER' tabindex='0' role='heading' aria-level='2' aria-label='System details'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2 class='header-title'>" + l_sectionTitle + "</h2><span class='header-element header-title-table'><table cellspacing='0' cellpadding='0'><tr></tr></table></span>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div><div class='header-right'></div></div>");
...
public int simpleLayoutCell_2( int index) {
	...
	tempRenderSingle = tools.getParamValue("RenderSingle");
	tools.putParamValue("RenderSingle","");
	tools.appendString("<div section_index='3' id='INNERDIV' class='layout-body' > ");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzSystemDetails",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzSystemDetailsMainBB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201810171610140715158") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
	...
	String paramName = "EXPANDEDSubSectionpzSystemDetailsMainBB";
...
public void buildSection_2() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzSystemMainTop", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzSystemMainTop"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpzSystemDetailsMain939","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzSystemMainTop", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzSystemMainTop",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzSystemMainTop",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzSystemDetailsMainB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201804130739340724967") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
	...
	String paramName = "EXPANDEDSubSectionpzSystemDetailsMainB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMDETAILSMAIN #20200116T114436.662 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzSystemDetailsMain");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMDETAILSMAIN #20200116T114436.662 GMT", "Pega-Ext-AdminStudio-Explorer-Settings-System pzSystemDetailsMain", "Pega-Desktop", "08-05-01", "20200116T114436.662 GMT");
}
