...
/**
 * Builds JSP stream DATA-PORTAL!PZMYAPPS.
 */
public class ra_stream_pzmyapps_a429552e2ae6618047887f8550afcba1 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzMyApps.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 829095087;
 ...
 */
	public ra_stream_pzmyapps_a429552e2ae6618047887f8550afcba1(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "fe536b10b783a71dca42eb6cbd3cc619c4d8872e";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PZMYAPPS #20210506T204030.730 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "fe536b10b783a71dca42eb6cbd3cc619c4d8872e";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzMyApps",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PZMYAPPS #20210506T204030.730 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PZMYAPPS #20210506T204030.730 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PZMYAPPS #20210506T204030.730 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZMYAPPS","Rule-HTML-Section","DATA-PORTAL",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION DATA-PORTAL PZMYAPPS #20210506T204030.730 GMT","!PZMYAPPS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",829095087), 
...
//	RULE-HTML-SECTION DATA-PORTAL PZMYAPPS #20210506T204030.730 GMT:20221122T130612.556 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "970670858f7c37addb3b1694fcaab467";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzMyApps",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzMyApps','insKey':'RULE-HTML-SECTION DATA-PORTAL PZMYAPPS #20210506T204030.730 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_4();
pzLayout_5();
...
public void buildSection_3() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_18","pzEncryptAppSwitch", secInfo);
}
...
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("pySectionName", "pzMyApps");
...
config.put("pyActivity", "pzFlushDataPage");
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzEncryptAppSwitch";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_5() {
pzSection.getLayout().setExpandParam("SubSectionpzMyAppsBBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzMyAppsBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(3)','clipboardPath':'pzEncryptAppSwitch'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(3)','clipboardPath':'pzEncryptAppSwitch'}") + ">");
}
pzSetExpandParam_5();
...
public void getNextPage_1(String listSource, int listStartIndex, int listEndIndex) {
	...
	map.put("pxDataSourceId", pxUniqueStreamHash+"_15");
	...
	nextPageMetadata.put("datasrcid",pxUniqueStreamHash+"_15");
	nextPageMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("20190222045707055989" ) + "");
...
public void buildSection_2() { 
	...
	secInfo.put("preserveParamState",false);
	Map<String, String> secParams = new HashMap<String, String>();
	secParams.put("ShowRole","false");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_13","pyAppDetails", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String strSectionPageProp = "";
	tools.putParamValue("ShowRole","false");tools.putParamValue("section_params","");
	...
	String sectionName = "pyAppDetails"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzMyApps132","",false);
}
...
public void buildSection_1() { 
	...
	secParams.put("ShowRole","false");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_10","pyAppDetails", secInfo);
}
...
public int simpleLayoutCell_3(  int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyAppDetails",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-bottom-spacing    " + pzSection.getCustomStyle(false, "","switchapps-listitem","switchapps-listitem")  + " flex flex-row ' ");
	...
	tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("20190222045707055989-" + rowTestID) + " ");
	}else {
	...
	pgCells.put("customROStyles","switchapps-listitem");
	pgCells.put("customRWStyles","switchapps-listitem");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyAppDetails",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
String pyInstanceId ="";
char mode = tools.getProperty("D_pxMyApps.pxResults").getMode();
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
pgSection.put("class","content    flex  layout-content-default content-default switchapps-launcher-grid padding-lr-2x"); 
...
expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("refreshWhen",  ".pyAppSearchText Changes || D_pxMyApps.pxResults AddDelete", expressionId, true);
expressionId = expression.getId();
expression.addActivity("refreshWhen", "pzFlushDataPage", "", "ParamName3=&ParamName5=&ParamValue3=&ParamName1=&DataPageName=D_pxMyApps&ParamName4=&ParamValue2=&ParamValue5=&ParamName2=&ParamValue4=&FlushAllInstances=true&ParamValue1=");
}
ClipboardProperty rdlPageListProp = tools.getProperty("D_pxMyApps.pxResults");
String rdlPageListPropRef = "D_pxMyApps.pxResults";
if(rdlPageListProp != null) {
rdlPageListPropRef = rdlPageListProp.getReference();
}
String rdlRefreshWhenStr = ".pyAppSearchText Changes || D_pxMyApps.pxResults AddDelete";
rdlRefreshWhenStr = rdlRefreshWhenStr.replace("D_pxMyApps.pxResults",rdlPageListPropRef);
if(!StringUtils.isBlank(expressionId)) {
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxMyApps.pxResults").getReference(),"", false).replaceFirst("_pa[0-9]+pz","")); 
} else {
pgSectionBody.put("pageListProp",pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxMyApps.pxResults").getReference(),"",false)); 
}
pgSectionBody.put("sourcetype","Data Object");
Map map = new HashMap();
Map paramsMap = new HashMap();
map.put("params", paramsMap);
map.put("pxDataSourceId", pxUniqueStreamHash+"_16");
pgSectionBody.put("datasrcid",pxUniqueStreamHash+"_16");
pyRDDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();
paramsMap.put("Search", ".pyAppSearchText");
pyRDDataPageParams.put("pyName","Search");
 { String propertyRef=".pyAppSearchText";if(propertyRef.startsWith(".")){		propertyRef = tools.getStepPage().getReference() + propertyRef;}
...
pgSectionBody.put("dpname","D_pxMyApps");
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
...
pgRDMetadata.put("automationId", "" + pzSection.getLayout().getTestIdIfEnabled("20190222045707055989" ) + "");
...
map.put("pyContext", "D_pxMyApps.pxResults");
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxMyApps.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""), "RDL" + pyInstanceId);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxMyApps.pxResults").getReference(),"", false),pyInstanceId);
}
tools.getParameterPage().putObject("pzRepeatProperties",repeatMap);
ClipboardProperty cpSource = tools.getProperty("D_pxMyApps.pxResults");
...
dummyPageName = "DummyD_pxMyApps_pxResults";
}
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxMyApps.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""),"RDL" + pyInstanceId + ":" + dummyPageName);
itemPage = tools.createPage("Rule-Application",dummyPageName);
PRStackFrame itemFrame = pega.pushStackFrame("DynamicItem", null, itemPage, true, false);
simpleLayoutCell_3(1);
	pega.popStackFrame(itemFrame, false);
} else {
repeatMap.put(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxMyApps.pxResults").getReference(),"",false),pyInstanceId + ":" + dummyPageName);
}
}else{
if(mode =='L' || mode =='G'){
Iterator itemPages = cpSource.iterator();
...
if (pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxMyApps.pxResults").getReference(),"",false).replaceFirst("_pa[0-9]+pz",""));
} else {
repeatMap.remove(pzAuto.getUIComponentRuntime().getRepeatingReference(tools.getProperty("D_pxMyApps.pxResults").getReference(),"", false));
}
cc.endComponent();
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	try{
		pzPackageRuntime.packageSection("pzMyApps",
...
pzSection.getLayout().setExpandParam("SubSectionpzMyAppsBBB","",false);
}


public void putRDLDPParams_1() {
	if(tools.getIfPresent(".pyAppSearchText") != null)
	tools.putParamValue("Search",tools.getProperty(".pyAppSearchText").getStringValue());
	}
...
public void simpleLayout_3() {
		...
		strRWPreActivity = "pzFlushDataPage,,ParamName3=&ParamName5=&ParamValue3=&ParamName1=&DataPageName=D_pxMyApps&ParamName4=&ParamValue2=&ParamValue5=&ParamName2=&ParamValue4=&FlushAllInstances=true&ParamValue1=";
		...
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplateComponent(pxUniqueStreamHash+"_17");
		}
		int totalRecords=0;
		...
		tools.appendString(tools.getProperty("D_pxMyApps.pxResults").getReference()+ "' ");
		tools.appendString(" " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICREPEATING','pgRef':'.pySections(2)'}") + "  class=' flex content   layout-content-default content-default switchapps-launcher-grid padding-lr-2x ' ");
		String strMethodName = tools.getParamValue("LAYOUT_METHOD_NAME");
		ClipboardProperty rdlPageListProperty = tools.getProperty("D_pxMyApps.pxResults");
		String rdlPageListPropRef = "D_pxMyApps.pxResults";
...
try {
tools.appendString("RWP=\".pyAppSearchText,.pxResults\" RW=\"");
tools.appendString(rdlRefreshWhenStr);
tools.appendString("\" RWA=\"");
tools.appendString("pzFlushDataPage,,ParamName3=&ParamName5=&ParamValue3=&ParamName1=&DataPageName=D_pxMyApps&ParamName4=&ParamValue2=&ParamValue5=&ParamName2=&ParamValue4=&FlushAllInstances=true&ParamValue1=");
tools.appendString("\" ");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
		...
		try{
			if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
				...
				changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyAppSearchText"), -1);
			}
		}catch(Exception e){}
		tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("20190222045707055989" ) + " ");
		tools.appendString(">");
		int index = 1;
		...
		rdlPageListProp = tools.getProperty("D_pxMyApps.pxResults");
	...
	String paramName = "EXPANDEDSubSectionpzMyAppsBBB";
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzMyAppsBB"));
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("My applications", "pyCaption");
...
metadataPage.put("title","My applications");
metadataPage.put("uniqueid", "202602210142210802");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("202211220751520489433") + " ");
...
pzSection.getLayout().setExpandParam("SubSectionpzMyAppsBB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='layout layout-outline layout-outline' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpzMyAppsBB";
...
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","My applications");
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel3154' data-layout-id='202602210142210801" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel3154'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzMyAppsBB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202211220751520489433") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzMyAppsBB";
	metadataPage.put("paramName", paramName);
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20190322061558008171493") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzMyApps_$CTX$_1");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Close My applications list\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Close My applications list", ".pyActionPrompt");
	}
	pyTooltip = "Close My applications list";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzMyApps_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20190322061558008171493") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Close My applications list\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20190322061558008171493-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzMyAppsB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201903220615580079900") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle navigation-slidein-header padding-2x" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzMyAppsB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PZMYAPPS #20210506T204030.730 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzMyApps");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PZMYAPPS #20210506T204030.730 GMT", "Data-Portal pzMyApps", "Theme-Cosmos", "04-01-01", "20221122T130612.556 GMT");
}
