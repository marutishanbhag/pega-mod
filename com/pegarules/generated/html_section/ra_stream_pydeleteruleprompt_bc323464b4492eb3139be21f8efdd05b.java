...
/**
 * Builds JSP stream RULE-RULESET-NAME!PYDELETERULEPROMPT.
 */
public class ra_stream_pydeleteruleprompt_bc323464b4492eb3139be21f8efdd05b extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyDeleteRulePrompt.Rule_RuleSet_Name.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 884351012;
 ...
 */
	public ra_stream_pydeleteruleprompt_bc323464b4492eb3139be21f8efdd05b(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "8dcfcb24d8446bfa92bb025d0f3799c2eb5c171d";
...
{
/* Instance RULE-HTML-SECTION RULE-RULESET-NAME PYDELETERULEPROMPT #20200109T153219.768 GMT	Pega-SystemArchitect:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "8dcfcb24d8446bfa92bb025d0f3799c2eb5c171d";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyDeleteRulePrompt",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-RULESET-NAME PYDELETERULEPROMPT #20200109T153219.768 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-RULESET-NAME PYDELETERULEPROMPT #20200109T153219.768 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-RULESET-NAME PYDELETERULEPROMPT #20200109T153219.768 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYDELETERULEPROMPT", 
	"Rule-Obj-Property:PYDELETEMEMO", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDELETERULEPROMPT","Rule-HTML-Section","RULE-RULESET-NAME",false,"","Pega-SystemArchitect","08-05-01","RULE-HTML-SECTION RULE-RULESET-NAME PYDELETERULEPROMPT #20200109T153219.768 GMT","!PYDELETERULEPROMPT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",884351012), 
		new DependentRuleInfo("PYDELETEMEMO","Rule-Obj-Property","RULE-",true,"Rule-RuleSet-Name","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY RULE- PYDELETEMEMO #20180713T131933.960 GMT","!PYDELETEMEMO",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE-RULESET-NAME PYDELETERULEPROMPT #20200109T153219.768 GMT:20200109T153219.768 GMT
//	RULE-HTML-PROPERTY PXTEXTAREA #20190131T183501.680 GMT:20190131T183501.680 GMT
//	RULE-OBJ-PROPERTY RULE- PYDELETEMEMO #20180713T131933.960 GMT:20180713T131933.960 GMT
...
//	RULE-UTILITY-FUNCTION PZCONTROL PZACTIONSPELLCHECKER #20180713T133344.687 GMT:20180713T133344.687 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "b0ed64e136bf69044168d0275bff2fa5";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyDeleteRulePrompt",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyDeleteRulePrompt','insKey':'RULE-HTML-SECTION RULE-RULESET-NAME PYDELETERULEPROMPT #20200109T153219.768 GMT','sectionType':'standard'}");
...
public void pzLayoutBodyWrapper_2() {
 String clsScroll= "";tools.appendString("<div section_index='2' class='" + clsScroll + " noHeadExpandInnerDivStyle'>");
...
public void scInclude_1() {
pzAuto.emitIncludeStreamReference("SpellCheckerScriptInclude", null, !tools.hasInputEnabled()?"NoInput":"NoInput", "Rule-HTML-Fragment", null);
}
public void inclFormattedVal_2(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {
		...
		tools.appendString(pega_uiengine_formatter.pxFormatText((isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true)),false,"","",false,"associated"));
...
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("202001061533370499863") + "  ");
...
String rlIndex=tools.getParamValueCSF("pega_RLindex");
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("202001061533370498935") + "  ");
if(!labelForAttribute.equals("")){tools.appendString(" for='" + labelForAttribute + rlIndex + "' ");
}String labelForError="";if(!propertyName.equals("")){try { labelForError = pzSection.getCell().getLabelForError(pageName,propertyName);}catch(Exception e) {} }tools.appendString(labelForError);
if(!accessKey.equals("")){tools.appendString(accessKey);
}else if(bRuntimeAccesskey){String aKey = pega_uiengine_harness.pzGetAKey(".pyCaption",labelValue,pega_procom_harness.IsParam(labelValue) );tools.appendString(aKey);
...
tools.appendString("</P>");
	...
	if(isEditable) {
		pegaValidation.append("required, auto_format");
		addedValidation = true;
		 tools.putParamValue("REQUIRED_WHEN","");
		 tools.putParamValue("REQUIRED_WHEN_ROC","");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")){String errorClass = "";
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();
		String placeHolderR = "";
		placeHolderR = "Please enter a short reason for why you are deleting this record";
		...
		tools.appendString("<span  class=\"textAreaExpandStyle set-width-auto "+errorClass+"\" id=\"CTRL_TA\" >");
		String activeValue = pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true);
		 if(isSecuredProp){
			...
			if(activeValue.length() > 80) {
				activeValue = activeValue.substring(0,80);
			}
		}
		tools.appendString("<textarea  " + pzCell.getTestIdIfEnabled("20200106153337049969") + "  id=\"");
		...
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }tools.appendString("[\"setUserStart\",[\"FINISHASSIGNMENT\"]],[\"doFormSubmit\",[\"pyActivity=FinishAssignment\",\":this\",\"");
{
	...
	tools.appendString("\",\":event\"]");
		...
		pegaValidation.append("minchars");
		tools.appendString(" minchars=1 ");
		...
		tools.appendString("'");
		tools.appendString("style=\"width: auto;overflow: auto;\" ");
		tools.appendString("data-exp='Enter to Collapse'");
		tools.appendString("data-col='Enter to Expand'");
		tools.appendString(" title='Enter Short Description' ");
		tools.appendString(" cols=\"75\"  rows=\"1\" ");
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,pyOnInput,pyEditValidate,pyStringType,pegaValidation.toString());
		tools.appendString("maxLength= \"80\" ");	tools.appendString(disabled_ctrl);
if(bOptimizedMarkup){
		tools.appendString(" data-bindprops='title,value,data-cdb-innerHTML' ");}
		tools.appendString(" data-ctl='[\"TextArea\",{\"height\":\"custom|1|\",\"scroll\":\"yes\"}] ' ");if(bOptimizedMarkup){
		if(!pzAuto.getBrowserUtils().isIE() || activeValue.length() >0){
		tools.appendString(" data-cdb-innerHTML=\"");
		tools.appendCSF(pzAuto.getUIComponentRuntime().getRuntimeContextTree().getDataBindingToken(tools.getProperty(".pyDeleteMemo").getReference()));
		tools.appendString("\" >");
		} else{
		tools.appendString(">");
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("20200106153337049969") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
...
boolean addedValidation = false;
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_8")){
		 ...
		 String buttonUID = "name='pyDeleteRulePrompt_"+ referenceString+ "_14'";
		...
		if(!(sectionIsReadOnly && false && false)){ 
			String repeatIndx = "";
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2020010615333705006") + "  href='"+hrefValue+"' ");
		tools.appendString("onclick='pd(event);' ");
		tools.appendString("data-ctl='Icon'"); tools.appendString(" class='");
		tools.appendString("iconSpellChecker' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" title = 'Check Spelling"+ " "+repeatIndx+"' ");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runSpellChecker\",[\":event\"]");
		...
		scInclude_1();scInclude_1();}pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
		tools.putParamValue("pega_attributes","");
...
public void layoutBody_2() { 
	tools.appendString("<table role='presentation' " + pzSection.getLayout().getInspectorData("FREEFORM",".pySections(2)") + "  cellpadding='0' cellspacing='0' ID=''>");
	
	/*Row Begin*/
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","standard_dataLabelForRead","standard_dataLabelWrite".replaceAll(pzSection.getLabelStyle(),pzSection.getLabelForStyle())), "height:21px;width:402px;",false,"","");tools.appendString("<nobr>");
	labelIncludeInCell_3("pyDeleteMemo","","pyDeleteMemo","",false,"Reason",false,true,"Standard",false);
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:21px;",false,"","");tools.appendString("<nobr>");
	labelIncludeInCell_4("","","","",false,"",false,false,"Standard",false);
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxTextArea",".pyDeleteMemo",".pySections(2).pySectionBody(1).pyTable.pyRows(2).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "height:30px;width:402px;",false,"","");tools.putSaveValue("parentLayouttype","");pxTextArea_1(".pyDeleteMemo",80,"","","Text");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(2).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "height:30px;",false,"","");tools.appendString("<nobr>");
...
pzSection.getLayout().setExpandParam("SubSectionpyDeleteRulePromptBB","",false);
}
public void pzLayout_2() {
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzCanDeleteRule","pzCanDeleteRule", "layout", "visible" )) {pzSetExpandParam_2();
...
String rlIndex=tools.getParamValueCSF("pega_RLindex");
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20200106153337049836") + "  ");
if(!labelForAttribute.equals("")){tools.appendString(" for='" + labelForAttribute + rlIndex + "' ");
}String labelForError="";if(!propertyName.equals("")){try { labelForError = pzSection.getCell().getLabelForError(pageName,propertyName);}catch(Exception e) {} }tools.appendString(labelForError);
if(!accessKey.equals("")){tools.appendString(accessKey);
}else if(bRuntimeAccesskey){String aKey = pega_uiengine_harness.pzGetAKey(".pyCaption",labelValue,pega_procom_harness.IsParam(labelValue) );tools.appendString(aKey);
...
String rlIndex=tools.getParamValueCSF("pega_RLindex");
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("202001061533370498988") + "  ");
if(!labelForAttribute.equals("")){tools.appendString(" for='" + labelForAttribute + rlIndex + "' ");
}String labelForError="";if(!propertyName.equals("")){try { labelForError = pzSection.getCell().getLabelForError(pageName,propertyName);}catch(Exception e) {} }tools.appendString(labelForError);
if(!accessKey.equals("")){tools.appendString(accessKey);
}else if(bRuntimeAccesskey){String aKey = pega_uiengine_harness.pzGetAKey(".pyCaption",labelValue,pega_procom_harness.IsParam(labelValue) );tools.appendString(aKey);
...
try {
out.print( tools.getLocalizedTextForString("pyMessageLabel","IfDeletingNoRecordsPresent"));
} catch(Throwable t) {
...
public void layoutBody_1() { 
	tools.appendString("<table role='presentation' " + pzSection.getLayout().getInspectorData("FREEFORM",".pySections(1)") + "  cellpadding='0' cellspacing='0' ID=''>");
	
	/*Row Begin*/
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:21px;width:587px;",false,"","");tools.appendString("<nobr>");
	labelIncludeInCell_1("","","","",false,"",false,false,"Standard",false);
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:21px;",false,"","");tools.appendString("<nobr>");
...
pzSection.getLayout().setExpandParam("SubSectionpyDeleteRulePromptB","",false);
}
public void pzLayout_1() {
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpzCanDeleteRule","!pzCanDeleteRule", "layout", "visible" )) {pzSetExpandParam_1();
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-RULESET-NAME PYDELETERULEPROMPT #20200109T153219.768 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyDeleteRulePrompt");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-RULESET-NAME PYDELETERULEPROMPT #20200109T153219.768 GMT", "Rule-RuleSet-Name pyDeleteRulePrompt", "Pega-SystemArchitect", "08-05-01", "20200109T153219.768 GMT");
}
