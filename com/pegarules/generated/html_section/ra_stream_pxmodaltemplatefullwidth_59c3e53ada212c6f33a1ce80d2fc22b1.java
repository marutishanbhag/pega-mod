...
/**
 * Builds JSP stream @BASECLASS!PXMODALTEMPLATEFULLWIDTH.
 */
public class ra_stream_pxmodaltemplatefullwidth_59c3e53ada212c6f33a1ce80d2fc22b1 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pxModalTemplateFullWidth.Rule_.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 997434520;
 ...
 */
	public ra_stream_pxmodaltemplatefullwidth_59c3e53ada212c6f33a1ce80d2fc22b1(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "bdd7fed14b2190e8666586e36a3bbb23fc6fb1cd";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PXMODALTEMPLATEFULLWIDTH #20181119T214445.177 GMT	Pega-UIEngine:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "bdd7fed14b2190e8666586e36a3bbb23fc6fb1cd";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pxModalTemplateFullWidth",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PXMODALTEMPLATEFULLWIDTH #20181119T214445.177 GMT
 * Set up context.
 */
final String prevRuleKey_4 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PXMODALTEMPLATEFULLWIDTH #20181119T214445.177 GMT";final String prevClass_4 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PXMODALTEMPLATEFULLWIDTH #20181119T214445.177 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-HTML-Section:PXMODALTEMPLATEFULLWIDTH", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXMODALTEMPLATEFULLWIDTH","Rule-HTML-Section","@BASECLASS",false,"","Pega-UIEngine","08-02-01","RULE-HTML-SECTION @BASECLASS PXMODALTEMPLATEFULLWIDTH #20181119T214445.177 GMT","!PXMODALTEMPLATEFULLWIDTH",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",997434520), 
...
//	RULE-HTML-SECTION @BASECLASS PXMODALTEMPLATEFULLWIDTH #20181119T214445.177 GMT:20181119T214445.177 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "9cafb876fe1460b9e25d36068630ebad";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pxModalTemplateFullWidth",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pxModalTemplateFullWidth','insKey':'RULE-HTML-SECTION @BASECLASS PXMODALTEMPLATEFULLWIDTH #20181119T214445.177 GMT','sectionType':'standard'}");
...
tools.appendString("<div class='layout layout-noheader layout-noheader-modal_button_array set-width-auto'>");
...
params_4.putString("BindKeyupOnly", "0");
params_4.putString("Caption", "Cancel");
params_4.putString("Id", "ModalButtonCancel");
...
params_4.putString("bLocalize", "false");
	...
	if (currentProperty_4 != null && currentProperty_4.getParentPage().getClassName().equals("Rule-")) {
		...
		final PRStackFrame stack_4 = ((PegaAPI) tools).pushStackFrame( params_4, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pzModalButton" );
		try {
...
if (_jspx_meth_pega_param__1(pageContext, "Id", "ModalButtonCancel")) {
	return true;
}
...
params_3.putString("BindKeyupOnly", "0");
params_3.putString("Caption", "Cancel");
params_3.putString("Id", "ModalButtonCancel");
...
params_3.putString("bLocalize", "false");
	...
	if (currentProperty_3 != null && currentProperty_3.getParentPage().getClassName().equals("Rule-")) {
		...
		final PRStackFrame stack_3 = ((PegaAPI) tools).pushStackFrame( params_3, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pzModalButton" );
		try {
...
public int simpleLayoutCell_3( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzModalButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_13")) {	field_pzModalButton_3();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20141008114147018317877-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pzModalButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_16")) {	field_pzModalButton_4();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpxModalTemplateFullWidthBBBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201811071618160361579") + " ");
	...
	String paramName = "EXPANDEDSubSectionpxModalTemplateFullWidthBBBB";
...
params_2.putString("bLocalize", "false");
	...
	if (currentProperty_2 != null && currentProperty_2.getParentPage().getClassName().equals("Rule-")) {
...
/**
 * Generates stream property_Rule__ClientValidation
 */
private void property_Rule__ClientValidation() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_1() {
	...
	try {
property_Rule__ClientValidation();
	} finally {
...
/**
 * Generates stream property_Rule__Button
 */
private void property_Rule__Button() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
/**
 * Generates stream property_Rule__pzModalButton
 */
private void property_Rule__pzModalButton() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
params_1.putString("bLocalize", "false");
	...
	if (currentProperty_1 != null && currentProperty_1.getParentPage().getClassName().equals("Rule-")) {
...
public int simpleLayoutCell_1( int index) {
	...
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")) {	field_pzModalButton_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("localize","false");
	pgCells.put("partialClass","remove-all-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20141008114147016914523-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzModalButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
...
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_9")) {	field_pzModalButton_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
	pgCells.put("pyLabelValue",labelName);
	String uiFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData();
	if(!"".equals(uiFieldValueMeta)){
	pgCells.put("stopFV",uiFieldValueMeta);
...
pzSection.getLayout().setExpandParam("SubSectionpxModalTemplateFullWidthBBB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201811071618160360818") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
	...
	String paramName = "EXPANDEDSubSectionpxModalTemplateFullWidthBBB";
	metadataPage.put("paramName", paramName);
...
pzSection.getLayout().setExpandParam("SubSectionpxModalTemplateFullWidthBB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201811071618160359197") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + " content  set-width-auto auto-width-column layout-content-stacked content-stacked " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpxModalTemplateFullWidthBB";
	metadataPage.put("paramName", paramName);
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2== pxparam.includedStreamName cq o2!= pxparam.pyShowFAButtons cttrue", pxUniqueStreamHash+"_19");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2== pxparam.includedStreamName cq o2!= pxparam.pyShowFAButtons cttrue","param.includedStreamName == \'\' && param.pyShowFAButtons != true", "layout", "visible" )) {pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
sectionBodyIncludeInCell_1(false,false,"","pzModalAction");elementModel_1("pzModalAction","pxModalTemplateFullWidth","","");
 } 
...
pzSection.getLayout().setExpandParam("SubSectionpxModalTemplateFullWidthB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpxModalTemplateFullWidthB";
...
static {
	oPropDefinitions_4.put("Rule-.pyTemplateInputBox", new LiteweightPropertyDefinition("Rule-", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_4.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PXMODALTEMPLATEFULLWIDTH #20181119T214445.177 GMT");
	...
	oStreamProperties_4.put("pyStreamName", "pxModalTemplateFullWidth");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PXMODALTEMPLATEFULLWIDTH #20181119T214445.177 GMT", "@baseclass pxModalTemplateFullWidth", "Pega-UIEngine", "08-02-01", "20181119T214445.177 GMT");
