...
/**
 * Builds JSP stream RULE-OBJ-ACTIVITY!PZSTEPS.
 */
public class ra_stream_pzsteps_b7466ce9b682efaa4b92363077cd403c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSteps.Rule_Obj_Activity.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 2138895154;
 ...
 */
	public ra_stream_pzsteps_b7466ce9b682efaa4b92363077cd403c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "8535bbba791df6d3acee4df0722f1fd3a2670fb3";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZSTEPS #20180713T135246.155 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "8535bbba791df6d3acee4df0722f1fd3a2670fb3";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSteps",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZSTEPS #20180713T135246.155 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZSTEPS #20180713T135246.155 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZSTEPS #20180713T135246.155 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZSTEPS", 
	"Rule-Obj-Property:PYJAVAGENERATEAPIVERSION", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSTEPS","Rule-HTML-Section","RULE-OBJ-ACTIVITY",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZSTEPS #20180713T135246.155 GMT","!PZSTEPS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",2138895154), 
		new DependentRuleInfo("PYJAVAGENERATEAPIVERSION","Rule-Obj-Property","RULE-OBJ-ACTIVITY",true,"Rule-Obj-Activity","Pega-Desktop","08-01-01","RULE-OBJ-PROPERTY RULE-OBJ-ACTIVITY PYJAVAGENERATEAPIVERSION #20180713T135038.869 GMT","!PYJAVAGENERATEAPIVERSION",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZSTEPS #20180713T135246.155 GMT:20180713T135246.155 GMT
...
//	RULE-OBJ-PROPERTY RULE-OBJ-ACTIVITY PYJAVAGENERATEAPIVERSION #20180713T135038.869 GMT:20180713T135038.869 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "b3cc3f2c9bf583cb328bd9ec220c389f";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSteps",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSteps','insKey':'RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZSTEPS #20180713T135246.155 GMT','sectionType':'standard'}");
pzLayout_3();
pzLayout_4();
...
config.put("navName", "pzActivityStepMenu");
...
config.put("pyActivity", "pzCollapseAllSteps");
...
tools.appendString("</P>");
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20141121003237044749737",true));
	cellPage.put("pyValue",".pyJavaGenerateAPIVersion");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyJavaGenerateAPIVersion");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyJavaGenerateAPIVersion", ".pyCaption");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyJavaGenerateAPIVersion",pxUniqueStreamHash+"_24");
	...
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_24");
	modePage1.put("clintValidAttrs",clientValidationAttributes);
	modePage1.put("pyID","pyJavaGenerateAPIVersion");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyJavaGenerateAPIVersion");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyJavaGenerateAPIVersion", ".pyCaption");
	pyValueR = ".pyJavaGenerateAPIVersion";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyJavaGenerateAPIVersion");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyJavaGenerateAPIVersion", ".pyCaption");
	pyValueOrig = ".pyJavaGenerateAPIVersion";
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_27");}if(beginNonTemplate){			HashStringMap params = new HashStringMap();
			String strClassName = tools.getDictionary().fromDefinition(tools.getActive(), "pyClassName");
			if("".equals(strClassName)){
			strClassName = "Rule-Obj-Activity";
			}
		...
		String strActiveValue = isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true);			String strValue = isSecuredProp ? activePropValue : tools.getProperty(ddPropRef).getStringValue();
			...
			if(!isAccessible) {
				...
				tools.appendString(" " + pzCell.getTestIdIfEnabled("20141121003237044749737") + " ");
...
tools.appendString(" data-bindprops='value' ");} else{			tools.appendString(ddPropEntryHandle);
		...
		tools.appendString(" style='width:70px' >");
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("20141121003237044749737") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
	 tools.appendString("data-propref='" + sEntryHandle + "'" );}tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_28")){inclFormattedVal_2(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
if(pegaValidation != null) {
	...
	tools.putActive(propActivePrev); } catch (Exception e) {
	 ...
	 if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'&& pzAuto.getUIComponentRuntime().getRuntimeContextTree().isLiveDesignViewMode()){
		...
		IUIComponent ctrlComponent = pzAuto.getUIComponent();
		metadata.put("cellInfo", "Api version");
...
public int simpleLayoutCell_7( int index) {
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20141121003237044749737-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	
	ClipboardProperty propActivePrev = tools.getActive();
	tools.putActive(tools.getStepPage().getProperty(".pyJavaGenerateAPIVersion"));
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Java API version") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20141121003237044749737-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Java API version") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");pxDropdown_1(".pyJavaGenerateAPIVersion",0,"","","Text");
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20141121003237044749737-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDropdown");
	pgCells.put("forLabel",".pyJavaGenerateAPIVersion");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxDropdown",".pyJavaGenerateAPIVersion",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDropdown_1(".pyJavaGenerateAPIVersion",0,"","","Text");labelName = "Java API version";
...
pzSection.getLayout().setExpandParam("SubSectionpzStepsBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	String paramName = "EXPANDEDSubSectionpzStepsBBBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= rx.pyJavaGenerateAPIVersion cq03-02", pxUniqueStreamHash+"_31");IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if(pzAuto.handleEvaluateWhen(" o2!= rx.pyJavaGenerateAPIVersion cq03-02",".pyJavaGenerateAPIVersion != \'03-02\'", "layout", "visible" )) {pzSetExpandParam_4();
...
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20150304111649039826568") + "  ");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_16")){
		 ...
		 String buttonUID = "name='pzSteps_"+ referenceString+ "_158'";
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_17")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzSteps_"+ referenceString+ "_159'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20141121003237044445448") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Add a step",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_18")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		 String pyFormatValue = "";
		 String toolTipVal = "";
		String hrefValue = "#";
		 String referenceString = tools.getStepPage().getReference();
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzSteps_"+ referenceString+ "_160'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20141121003237044546824") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		...
		com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
			...
			if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
				try{
					pzPackageRuntime.packageSection("pzSteps",
					...
					refreshActionRequest.registerFixedParameter("PreActivity", "pzCollapseAllSteps");
					staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
					staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzSteps"));
					staticURLStr.append("&PreActivity=pzCollapseAllSteps");
					tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"pzCollapseAllSteps\", \"");
		...
		tools.appendString("]' ");
			...
			String repeatIndx = "";tools.appendString("class='pzhc");tools.appendString("'");if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		tools.appendString(" >");
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Collapse all steps".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		...
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Collapse all steps",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(true,"","dataValueRead",pzSection.getValueStyle()), "",false,"","");tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","ACTION");	pxIcon_1();
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","bottom-add-button","bottom-add-button"), "",false,"","");tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","ACTION");	pxLink_1();
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(3)"),"  ",pzSection.getCustomStyle(false,""," dataLabelRead gridActionAlignCenter"," dataLabelWrite gridActionAlignCenter"), "",false,"","");tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","ACTION");	pxButton_1();
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(3).pyTable.pyRows(1).pyCells(4)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "width:100%;",false,"","");tools.appendString("<nobr>");
...
public void repeatingDataCell_5() {
	...
	tools.appendString("height:26px;");tools.appendString("");getInlineStyle_2(); tools.appendString(""); if(!pzAuto.isOrientationRTL())    {tools.appendString(";left:");}else{tools.appendString(";right:");} int level = 0; try {int indentationLevel = level;tools.appendString( (indentationLevel*18)+"px");}catch(Exception e){tools.appendString("0");} ;tools.appendString("' >");
	if(!pzAuto.getBrowserUtils().isIE()){
	tools.appendString("<DIV class='oflowDiv' style='height:26px;'>");
	}else{
	...
	if(!(tools.getStepPage().getIfPresent(".pySteps") != null && tools.getStepPage().getProperty(".pySteps").size()>0)){ tools.appendString(" tabIndex='-1' ");
	}tools.appendString(" class=\"");
	if(tools.getStepPage().getIfPresent(".pySteps") != null && tools.getStepPage().getProperty(".pySteps").size()>0){ if(tools.getStepPage().getIfPresent("pyExpanded") != null && tools.getStepPage().getString("pyExpanded").equals("true")){tools.appendString("collapseNode\" tabIndex='0' title='");
...
public void repeatingDataCell_4() {
		tools.appendString("<li title='");
		tools.appendString("'    ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20141121003237044034884") + " ");
		 tools.appendString(' ' + pzCell.getInspectorData("Label",null, null, ".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(2)")); tools.appendString(" class='");
 ...
 if(!pzAuto.getBrowserUtils().isIE()){ 
									...
									tools.appendString("<span class='wspan'></span><div class='cellIn'>");
									tools.appendString("&nbsp;");}if("".equals(tools.getParamValue("sortProperty"))){       tools.putParamValue("columnSortOrder","");  }else{      if("".equals(tools.getParamValue("sortProperty"))){          tools.putParamValue("columnSortOrder",tools.getParamValue("sortType"));     }   }       if("ASC".equals(tools.getParamValue("columnSortOrder"))){       tools.putParamValue("sortTitleText","columnsorted_asc");    }else if("DESC".equals(tools.getParamValue("columnSortOrder"))){        tools.putParamValue("sortTitleText","columnsorted_desc");   }else{      tools.putParamValue("sortTitleText","Enter to sort");   }tools.appendString("<div id='titleDesc1166344217' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");tools.appendString("<span id='sort'"); if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){  tools.appendString("tabIndex='0'"); } tools.appendString("class='highlight-ele ' >&nbsp;</span>");tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");tools.appendString("</div>");
									tools.appendString("</div>");
...
public void repeatingDataCell_3() {
		tools.appendString("<li title='");
		tools.appendString("'    ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20141121003237043933862") + " ");
		 tools.appendString(' ' + pzCell.getInspectorData("Label",null, null, ".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(1)")); tools.appendString(" class='");
 ...
 if(!pzAuto.getBrowserUtils().isIE()){ 
									...
									tools.appendString("<span class='wspan'></span><div class='cellIn'>"); if(tools.getIfPresent("pyRowStatus") != null){ tools.appendProperty(tools.getProperty(".pyRowStatus"),"Messages",false); }}if("".equals(tools.getParamValue("sortProperty"))){       tools.putParamValue("columnSortOrder","");  }else{      if("".equals(tools.getParamValue("sortProperty"))){          tools.putParamValue("columnSortOrder",tools.getParamValue("sortType"));     }   }       if("ASC".equals(tools.getParamValue("columnSortOrder"))){       tools.putParamValue("sortTitleText","columnsorted_asc");    }else if("DESC".equals(tools.getParamValue("columnSortOrder"))){        tools.putParamValue("sortTitleText","columnsorted_desc");   }else{      tools.putParamValue("sortTitleText","Enter to sort");   }tools.appendString("<div id='titleDesc1449170052' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");tools.appendString("<span id='sort'"); if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){  tools.appendString("tabIndex='0'"); } tools.appendString("class='highlight-ele ' >&nbsp;</span>");tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");tools.appendString("</div>");
									tools.appendString("</div>");
	tools.appendString("</li>");
	}
...
tools.appendString("[\"showMenu\",[{\"dataSource\":\"pzActivityStepMenu\", \"isNavNLDeferLoaded\":\"false\", \"isNavTypeCustom\":\"false\", \"className\":\"");
...
tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771838559161");
if(pzAuto.isOffline() || false) {
try{
ClipboardPage pg_tempPrimPg = tools.createPage("Embed-ActivitySteps","tempNavStepPg");
tools.putParamValue("tempNavStepPg",pg_tempPrimPg.getName());
pega_uiengine_pzcontrol.pzGetMenu("pzActivityStepMenu", "", "pyNavigation1771838559161","", false, true, false, false);
...
pzSection.getLayout().setExpandParam("SubSectionpzStepsBBB","",false);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<table role='presentation' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'REPEATTREE','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + "style='width:100%' cellspacing='0' cellpadding='0' id='EXPAND-OUTERFRAME' ");
String gridLayoutMethodName = tools.getParamValue("gridLayoutMethodName");
String expandParameter = "EXPANDEDSubSectionpzStepsBBB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pyStepsL33=null;

 Map selUniqMap_pyStepsL33 = null;
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pySteps");tools.appendString("_pzSteps_1'");
tools.appendString(" bRowHovering='false' deferLoadAct='' class=\"");
tools.appendString("repeatContainer gridDefault  Tree  draggablegrid ");if(tools.hasInputEnabled()){tools.appendString("readOnlyGrid ");}tools.appendString("");
...
tools.appendString(" fixedRow='false' fixedCol='false' bValueList='false' bPageGroup='false' appendAct='' deleteAct='' bTree='true' repeatType='row' editConfig='readWrite' editFormat='' template-name='' bGrid='true' bDragDrop='true' bTreegrid='true' bSorting='false' grid-postactivity='pyResetCodeEditor' bReportDefinition='false' bLoadActivity='false' bDataObject='false' bCBOptimize='false' OAFunc='openRuleByKeys' ");
pySteps_2();
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pySteps");
					...
					tools.appendString("' gPropIndex='PpySteps1' editRowIndex='");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' width='100%'><input type=\"hidden\" name=\"PpySteps1colWidthGBL\" id=\"PpySteps1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpySteps1colWidthGBL"));tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<table cellpadding='0' id='bodyTbl_gbl' cellspacing='0' border='0' width='100%' style='width: ");

					if(!tools.getParamValue("PpySteps1colWidthGBL").equals("")) { tools.appendParamCSF("PpySteps1colWidthGBL"); } 
 ...
 {int counter = 0; int rowsDisplayed = 0;
								...
								{Iterator itr_2 = tools.getStepPage().getProperty(".pySteps").iterator(); 
					...
					if((pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()) && !pega_uiengine_harness.pzInStandardsMode()){tools.appendString("style='height:27px;");}else{tools.appendString("style='height:26px;");}getInlineStyle_2(); if(!pzAuto.isOrientationRTL())    {tools.appendString(";padding-left:");}else{tools.appendString(";padding-right:");} try { int level = 0;tools.appendString(18 + (level * 18)+ "px");}catch(Exception e){tools.appendString("18px");} tools.appendString("'");tools.appendString(" >");
					...
					tools.putParamValue("pyPropRef",tools.getActive().getReference()+".pySteps");
							 ...
							 StringMap keys = new HashStringMap();
								 ...
								 keys.putString("pyStreamName","pzSteps");

					
								 keys.putString("pyClassName","Rule-Obj-Activity" );
								 ...
								 tools.putParamValue("partialTrigger","getChildNodes.pySteps1");
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t<li id=\"Grid_NoResults\" class=\"gridRow\" ><ul class=\"rowContent\"><li>");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("Embed-ActivitySteps", "tempNoRespg");
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</ul>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t</td></tr></table></td><td valign='top' class='mainGridTableCell' width='0.0%'><input type=\"hidden\" name=\"PpySteps1colWidthGBR\" id=\"PpySteps1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpySteps1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpySteps1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right' PL_PROP='");

					
tools.appendString(".pySteps");

					tools.appendString("' PL_PROP_CLASS='Embed-ActivitySteps' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pySteps").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pySteps\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 ct_gridAction.trackValueChanges(tools.getProperty(".pxObjClass"),-1);
					...
					menubarIncludes_1(); 
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pySteps1") && tools.getParamValue("partialRefresh").equals("false")) {
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","uber_readable_dataLabelRead","uber_readable_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("201510161134170122604675") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + "' >");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Label") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201510161134170122604675")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pgCells.put("customROStyles","uber_readable_dataLabelRead");
	pgCells.put("customRWStyles","uber_readable_dataLabelWrite");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-all-spacing   '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("201510161134170123605874") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + "' >");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Method") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","remove-all-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201510161134170123605874")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("spanClass","iconRequired standard (label)_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("labelReadClass","dataLabelRead");
	pgCells.put("labelWriteClass","dataLabelWrite");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	labelName = "Method";
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","uber_readable_dataLabelRead","uber_readable_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("201510161134170124606482") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + "' >");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Step page") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","remove-all-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201510161134170124606482")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("spanClass","iconRequired standard (label)_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("labelReadClass","dataLabelRead");
	pgCells.put("labelWriteClass","dataLabelWrite");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	labelName = "Step page";
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","uber_readable_dataLabelRead","uber_readable_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("201510161134170124606482") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + "' >");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Description") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
pzSection.getLayout().setExpandParam("SubSectionpzStepsBB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + " content  layout-content-inline_middle content-inline_middle activity-header" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","activity-header");
	...
	String paramName = "EXPANDEDSubSectionpzStepsBB";
	metadataPage.put("paramName", paramName);
	...
	String pyPrefix = null;
	metadataPage.put("sectionIndex","132");
	IUIComponent containerComponent = pzAuto.getUIComponent();
...
if(( pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_15")) ){pzLayout_2();
}
pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
 tools.putSaveValue("ContainerID", "");tools.appendString("</div></div>");
	index++;
...
pzSection.getLayout().setExpandParam("SubSectionpzStepsB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionpzStepsB";
	metadataPage.put("paramName", paramName);
...
public void pzActivityStep_1() {
pzAuto.emitIncludeStreamReference("pzActivityStep", null, !tools.hasInputEnabled()?"NoInput":"Input", "Rule-HTML-Section", null);
}
public void repeatingDataCell_2() {
	...
	tools.appendString("<li  title='");
	tools.appendString("'  ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("SUB_SECTION","pzActivityStep", ".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)")); tools.appendString(" headers='a2' class='");
	...
	tools.appendString("height:26px;");tools.appendString("");getInlineStyle_2(); tools.appendString(""); tools.appendString("'>");
	if(!pzAuto.getBrowserUtils().isIE()){
	tools.appendString("<DIV class='oflowDiv' style='height:26px;'>");
	}else{
	tools.appendString("<span class='wspan'></span><div class='cellIn'>");
...
public void repeatingDataCell_1() {
	...
	tools.appendString("'   class='");
	tools.appendString(" cellCont");tools.appendString(" ");tools.appendString(" rowHandle ");tools.appendString(" gridColumn");tools.appendString(" ' style='width:16px;");
	tools.appendString("height:26px;");tools.appendString("");getInlineStyle_2(); tools.appendString(""); if(!pzAuto.isOrientationRTL())    {tools.appendString(";left:");}else{tools.appendString(";right:");} int level = 0; try {String pyPropRef = tools.getParamValueCSF("pyPropRef"); if("".equals(pyPropRef))level=0; else if(!"".equals(tools.getParamValueCSF("pzLevelParam"))) level = pyPropRef.split("\\.").length-Integer.parseInt(tools.getParamValueCSF("pzLevelParam")); else level = pyPropRef.split("\\.").length-2; if(("").equals(tools.getParamValueCSF("pzLevelParam")) && !"".equals(tools.getParamValueCSF("BaseReference")) && tools.getParamValueCSF("BaseReference").indexOf(".")>=0) {level = level - (tools.getParamValueCSF("BaseReference").split("\\.").length-1);}int indentationLevel = level;tools.appendString( (indentationLevel*18)+"px");}catch(Exception e){tools.appendString("0");} ;tools.appendString("' >");
	if(!pzAuto.getBrowserUtils().isIE()){
	tools.appendString("<DIV class='oflowDiv' style='height:26px;'>");
	}else{
	tools.appendString("<span class='wspan'></span><div class='cellIn'>");
...
getInlineStyle_2() {
try {
tools.appendString("height:auto !important; overflow: visible;");
} catch(Throwable t) {
...
tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771838559145");
if(pzAuto.isOffline() || false) {
try{
ClipboardPage pg_tempPrimPg = tools.createPage("Embed-ActivitySteps","tempNavStepPg");
tools.putParamValue("tempNavStepPg",pg_tempPrimPg.getName());
pega_uiengine_pzcontrol.pzGetMenu("pzActivityStepMenu", "", "pyNavigation1771838559145","", false, true, false, false);
tools.getParameterPage().remove("tempNavStepPg");
pg_tempPrimPg.removeFromClipboard();
}catch(Exception e){oLog.error(e);}
}
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pySteps1")|| tools.getParamValue("partialTrigger").equals("editRow.pySteps1") || tools.getParamValue("partialTrigger").equals("getChildNodes.pySteps1") ){

					if(!tools.getParamValue("partialTrigger").equals("getChildNodes.pySteps1"))

					tools.putParamValue("partialRefresh", "false");

					if(!tools.getParamValue("partialTrigger").equals("getChildNodes.pySteps1") && !tools.getParamValue("gridAction").toLowerCase().equals("refreshrows")) {
					...
					if(tools.getParamValue("partialRefresh").equals("true") && tools.getParamValue("table").equals("left") && tools.getParamValue("partialTrigger").equals("getChildNodes.pySteps1") && tools.getStepPage().getProperty(tools.getParamValue("pyPropRef")).size()>0 ){
 ...
 if(tools.getParamValue("partialTrigger").equals("getChildNodes.pySteps1")) tools.putParamValue("partialRefresh", "false");

					
 while(iterPageListProp.hasNext()){ if(tools.getParamValue("partialTrigger").equals("getChildNodes.pySteps1")){ ClipboardProperty prop = (ClipboardProperty)iterPageListProp.next(); tools.putActive(prop);}
					...
					tools.appendString("\n\t\t\t\t\t\t\t<li class='gridRow' isWrapEnabled=false  id='");
					 ...
					 if(tools.getParamValue("partialTrigger").equals("getChildNodes.pySteps1")) { tools.appendString(tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")")); } else { tools.appendString(tools.getActiveName()); } 
					...
					tools.appendString("</ul>");
					 ...
					 if(tools.getParamValue("partialTrigger").equals("") || tools.getParamValue("partialTrigger").equals("getChildNodes.pySteps1")) { 

					 if( (tools.getStepPage().getIfPresent("pyExpanded") != null && tools.getStepPage().getString("pyExpanded").equals("true")) || tools.getParamValue("pyPrintTreeGrid").equals("true")){ String strTempProp = tools.getParamValue("pyPropRef");

					
							 tools.putParamValue("pyPropRef",strTempProp+"("+tools.getActive().indexOf()+").pySteps");
					...
					if(!tools.getParamValue("partialTrigger").equals("getChildNodes.pySteps1"))break;
  ...
  if(tools.getParamValue("table").equals("left") && tools.getParamValue("partialTrigger").equals("getChildNodes.pySteps1")  && tools.getStepPage().getProperty(tools.getParamValue("pyPropRef")).size()>0) { 
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pySteps\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 ct_gridAction.trackValueChanges(tools.getProperty(".pxObjClass"),-1);
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pySteps1")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 if("".equals(strPageName)) {
			 ...
			 pageListProp = tools.getProperty(".pySteps");

					
		 } else {

					
			 pageListProp = tools.getProperty(strPageName+".pySteps");
...
pzStatic_ControlMenu.emitContent();
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pySteps1") ){
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pySteps\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\" id='");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZSTEPS #20180713T135246.155 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzSteps");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-ACTIVITY PZSTEPS #20180713T135246.155 GMT", "Rule-Obj-Activity pzSteps", "Pega-Desktop", "08-01-01", "20180713T135246.155 GMT");
}
