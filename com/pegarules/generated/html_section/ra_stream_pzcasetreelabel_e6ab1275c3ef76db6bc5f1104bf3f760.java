...
/**
 * Builds JSP stream RULE-OBJ-CLASS!PZCASETREELABEL.
 */
public class ra_stream_pzcasetreelabel_e6ab1275c3ef76db6bc5f1104bf3f760 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzCaseTreeLabel.Rule_Obj_Class.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -2003596097;
 ...
 */
	public ra_stream_pzcasetreelabel_e6ab1275c3ef76db6bc5f1104bf3f760(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a3713422d5135fae353aae7a1b7b1ca8a5cb98cc";
...
{
/* Instance RULE-HTML-SECTION RULE-OBJ-CLASS PZCASETREELABEL #20180713T140919.560 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "a3713422d5135fae353aae7a1b7b1ca8a5cb98cc";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzCaseTreeLabel",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-OBJ-CLASS PZCASETREELABEL #20180713T140919.560 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-OBJ-CLASS PZCASETREELABEL #20180713T140919.560 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-OBJ-CLASS PZCASETREELABEL #20180713T140919.560 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZCASETREELABEL", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCASETREELABEL","Rule-HTML-Section","RULE-OBJ-CLASS",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION RULE-OBJ-CLASS PZCASETREELABEL #20180713T140919.560 GMT","!PZCASETREELABEL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2003596097), 
...
//	RULE-HTML-SECTION RULE-OBJ-CLASS PZCASETREELABEL #20180713T140919.560 GMT:20180713T140919.560 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "2707afeabb6d665588bd161268c6cb1b";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzCaseTreeLabel",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzCaseTreeLabel','insKey':'RULE-HTML-SECTION RULE-OBJ-CLASS PZCASETREELABEL #20180713T140919.560 GMT','sectionType':'standard'}");
pzLayout_2();
...
config.put("navName", "pzOptionsMenuForCaseExplorerForLP");
...
config = new HashMap<String, String>();
config.put("paramKeys", "lpParampyClassName&lpParamImmediateParent&lpParamTopMostParent&lpParampyCircumstanceVal&lpTitle");
config.put("harnessName", "pzCaseTypeFromExplorer");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			pzPackageRuntime.packageSection("pzCaseTreeLabel",
			...
			tools.appendString("[\"showMenu\",[{\"dataSource\":\"pzOptionsMenuForCaseExplorerForLP\", \"isNavNLDeferLoaded\":\"false\", \"isNavTypeCustom\":\"false\", \"className\":\"" + tools.getStepPage().getClassName());
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771700005084");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzOptionsMenuForCaseExplorerForLP", "", "pyNavigation1771700005084","", false, false, false, false);
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("2015032005424105893545") + " ");
	if(false || (pzAuto.isOffline() && true) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzCaseTreeLabel_$CTX$_7");
		String repeatIndx = "";
	String pyTooltip = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzCaseTreeLabel_"+ referenceString+ "_7'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("2015032005424105893545") + "  data-ctl='Button'  type='button' role='button' aria-haspopup='true' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771700005087");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzOptionsMenuForCaseExplorerForLP", "", "pyNavigation1771700005087","", false, false, false, false);
			}catch(Exception e){oLog.error(e);}
			}
			tools.appendString("\"},\":event\"]");
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015032005424105893545-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","explorer-row-menu");
	pgCells.put("customRWStyles","explorer-row-menu");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzCaseTreeLabelBB","",false);
}
...
public void simpleLayout_1() {
	...
	spxUniqueStreamHash15 = getUIActionsMetaData_2();
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201807030615310925435") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5).pySections(1)'}") + " class='" + "flex  content  layout-content-inline content-inline " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpzCaseTreeLabelBB";
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015032005424105917852",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzCaseTreeLabel_$CTX$_2");
		String repeatIndx = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzCaseTreeLabel_"+ referenceString+ "_2'";
	 String securedPropValue = null;
	 ...
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015032005424105917852") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		...
		tools.appendString(toolTipVal);tools.appendString(" class='explorer_primary");tools.appendString("'");
		tools.appendString(" >");
		boolean hasLineBreaks = false;
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015032005424105906535",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzCaseTreeLabel_$CTX$_1");
		String repeatIndx = "";
	modePage2.put("styles","explorer_primary");
	String pyTooltip = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyLabel");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzCaseTreeLabel_"+ referenceString+ "_1'";
	 String securedPropValue = null;
	 com.pega.pegarules.pub.security.PropertySecurityInfo propSecInfo = tools.getAuthorizationHandle().getABACSecurityPolicyEngine().getPropertyInfoForDisplay(tools.getStepPage(),tools.getProperty(".pyLabel"), tools);
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
		 securedPropValue = propSecInfo.getPropValue();
	  ...
	  if(securedPropValue == null) {
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015032005424105906535") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
			String repeatIndx = "";if(bOptimizedMarkup){
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		tools.appendString("  title= '");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771700005040");
	if(pzAuto.isOffline() || false) {
	try{
	pega_uiengine_pzcontrol.pzGetMenu("pzOptionsMenuForCaseExplorerForLP", "", "pyNavigation1771700005040","", false, false, false, false);
	}catch(Exception e){oLog.error(e);}
	}
	tools.appendString("\"},\":event\"]");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }			tools.appendString("[\"openLandingPage\",[\"");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyProjectIDLabel")+"~#");			tools.appendString("\",\"Display\",{\"harnessName\":\"pzCaseTypeFromExplorer\",\"className\":\"Rule-Obj-Class\",\"model\":\"pzSetDocumentKey\",\"page\":\"\",\"readOnly\":\"false\",\"contentID\":\"");

		tools.appendFormatted("52ce66a7-5aa3-408c-99b5-e66fd4e60e19",StreamBuilder.FMT_NORMAL);			tools.appendString("\",\"dynamicContainerID\":\"");

		tools.appendFormatted("",StreamBuilder.FMT_NORMAL);			tools.appendString("\",\"customParam\":{\"lpParampyClassName\":\"");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyClassName")+"~#");			tools.appendString("\",\"lpParamImmediateParent\":\"");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyParentLabel")+"~#");			tools.appendString("\",\"lpParamTopMostParent\":\"");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyTopLevelClassName")+"~#");			tools.appendString("\",\"lpParampyCircumstanceVal\":\"");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyCircumstanceVal")+"~#");			tools.appendString("\",\"lpTitle\":\"");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyLabel")+"~#");			tools.appendString("\"}},{\"levelA\":\"");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			ct_controlAction.trackValueChanges(tools.getProperty(".pyProjectIDLabel"), -1);
...
public int simpleLayoutCell_1( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2|| o2== rx.pyUsage cqCircumstance o2== rx.pyUsage cqFederatedCase",".pyUsage = \'Circumstance\' || .pyUsage = \'FederatedCase\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","specialized flex-grow-1","specialized flex-grow-1")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015032005424105906535-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxLink");
	pgCells.put("forLabel",".pyLabel");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","specialized flex-grow-1");
	pgCells.put("customRWStyles","specialized flex-grow-1");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2|| o2== rx.pyUsage cqCircumstance o2== rx.pyUsage cqFederatedCase",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyUsage = 'Circumstance' || .pyUsage = 'FederatedCase'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Obj-Class");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2|| o2== rx.pyUsage cqCircumstance o2== rx.pyUsage cqFederatedCase", pxUniqueStreamHash+"_6"); 
	}
...
public int simpleLayoutCell_2( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","flex-grow-1","flex-grow-1")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015032005424105917852-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxLink");
	pgCells.put("forLabel",".pyLabel");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2!= rx.pyUsage cqCircumstance o2!= rx.pyUsage cqFederatedCase",pxUniqueStreamHash+"_10");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2!= rx.pyUsage cqCircumstance o2!= rx.pyUsage cqFederatedCase", pxUniqueStreamHash+"_10"); 
	}
	if(pyDLCellVisibility) {
...
public int simpleLayoutCell_3( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyUsage cqCircumstance",".pyUsage = \'Circumstance\'","cell", "visible" )) {
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-label item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","explorer_secondary_dataLabelRead flex-grow-1","explorer_secondary_dataLabelWrite flex-grow-1")  + " ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelRead explorer_secondary_dataLabelRead","dataLabelWrite explorer_secondary_dataLabelWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("2015032005424105918707")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Specialized") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015032005424105918707")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("pyAutoHTML","true");
	...
	pgCells.put("customROStyles","explorer_secondary_dataLabelRead flex-grow-1");
	pgCells.put("customRWStyles","explorer_secondary_dataLabelWrite flex-grow-1");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyUsage cqCircumstance",pxUniqueStreamHash+"_12");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_12");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyUsage = 'Circumstance'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Obj-Class");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_12");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyUsage cqCircumstance", pxUniqueStreamHash+"_12"); 
	}
	if(pyDLCellVisibility) {
...
public int simpleLayoutCell_4( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyUsage cqFederatedCase",".pyUsage = \'FederatedCase\'","cell", "visible" )) {
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-label item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","explorer_secondary_dataLabelRead flex-grow-1","explorer_secondary_dataLabelWrite flex-grow-1")  + " ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelRead explorer_secondary_dataLabelRead","dataLabelWrite explorer_secondary_dataLabelWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("201503200542410592963")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Remote") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("pyType","label");
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201503200542410592963")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired _iconRequired");
	pgCells.put("labelReadClass","dataLabelRead explorer_secondary_dataLabelRead");
	pgCells.put("labelWriteClass","dataLabelWrite explorer_secondary_dataLabelWrite");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyUsage cqFederatedCase",pxUniqueStreamHash+"_14");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_14");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyUsage = 'FederatedCase'");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Obj-Class");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_14");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyUsage cqFederatedCase", pxUniqueStreamHash+"_14"); 
	}
	if(pyDLCellVisibility) {
...
pzSection.getLayout().setExpandParam("SubSectionpzCaseTreeLabelB","",false);
}
...
pzStatic_ControlMenu.emitContent();
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201806281759200325399") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  pointer has-action layout-content-mimic_a_sentence content-mimic_a_sentence nowrap exp-explorer-row explorer-case-label" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		...
		tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771700005041");
		if(pzAuto.isOffline() || false) {
		try{
		pega_uiengine_pzcontrol.pzGetMenu("pzOptionsMenuForCaseExplorerForLP", "", "pyNavigation1771700005041","", false, false, false, false);
		}catch(Exception e){oLog.error(e);}
		}
		tools.appendString("\"},\":event\"]");
		...
		tools.appendFormatted("22036617-78fe-4a1d-9222-d75c294b72a0",StreamBuilder.FMT_NORMAL);				tools.appendString("\",\"dynamicContainerID\":\"");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			...
			ct_controlAction.trackValueChanges(tools.getProperty(".pyLabel"), -1);
				...
				if(!"".equals(strMethodName))
				pg_dlmeta.put("methodnm",strMethodName);
				pg_dlmeta.put("customClassName","nowrap exp-explorer-row explorer-case-label");
			...
			String paramName = "EXPANDEDSubSectionpzCaseTreeLabelB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-OBJ-CLASS PZCASETREELABEL #20180713T140919.560 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzCaseTreeLabel");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-OBJ-CLASS PZCASETREELABEL #20180713T140919.560 GMT", "Rule-Obj-Class pzCaseTreeLabel", "Pega-ProcessArchitect", "08-01-01", "20180713T140919.560 GMT");
}
