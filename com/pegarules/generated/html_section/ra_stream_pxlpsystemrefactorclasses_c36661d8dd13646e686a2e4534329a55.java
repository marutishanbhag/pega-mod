...
/**
 * Builds JSP stream PEGA-LANDING-SYSTEM-REFACTORCLASSES!PXLPSYSTEMREFACTORCLASSES.
 */
public class ra_stream_pxlpsystemrefactorclasses_c36661d8dd13646e686a2e4534329a55 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pxLPSystemRefactorClasses.Pega_Landing_System_RefactorClasses.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 50340902;
 ...
 */
	public ra_stream_pxlpsystemrefactorclasses_c36661d8dd13646e686a2e4534329a55(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "5e946598443a4e4f50877cb8d9c0e9126596f47e";
...
{
/* Instance RULE-HTML-SECTION PEGA-LANDING-SYSTEM-REFACTORCLASSES PXLPSYSTEMREFACTORCLASSES #20180713T142931.627 GMT	Pega-LP-SystemSettings:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "5e946598443a4e4f50877cb8d9c0e9126596f47e";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pxLPSystemRefactorClasses",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-LANDING-SYSTEM-REFACTORCLASSES PXLPSYSTEMREFACTORCLASSES #20180713T142931.627 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-LANDING-SYSTEM-REFACTORCLASSES PXLPSYSTEMREFACTORCLASSES #20180713T142931.627 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-LANDING-SYSTEM-REFACTORCLASSES PXLPSYSTEMREFACTORCLASSES #20180713T142931.627 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PXLPSYSTEMREFACTORCLASSES", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXLPSYSTEMREFACTORCLASSES","Rule-HTML-Section","PEGA-LANDING-SYSTEM-REFACTORCLASSES",false,"","Pega-LP-SystemSettings","08-01-01","RULE-HTML-SECTION PEGA-LANDING-SYSTEM-REFACTORCLASSES PXLPSYSTEMREFACTORCLASSES #20180713T142931.627 GMT","!PXLPSYSTEMREFACTORCLASSES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",50340902), 
...
//	RULE-HTML-SECTION PEGA-LANDING-SYSTEM-REFACTORCLASSES PXLPSYSTEMREFACTORCLASSES #20180713T142931.627 GMT:20180713T142931.627 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "8b3d6e1d432c9d17d3759f1d0a09ce62";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pxLPSystemRefactorClasses",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pxLPSystemRefactorClasses','insKey':'RULE-HTML-SECTION PEGA-LANDING-SYSTEM-REFACTORCLASSES PXLPSYSTEMREFACTORCLASSES #20180713T142931.627 GMT','sectionType':'standard'}");
...
config.put("InsClass", "PegaAccel-Management-Refactor-Class");
config.put("className", "PegaAccel-Management-Refactor-Class");
config.put("FlowType", "RefactorClass");
config.put("wizardLabel", "Rename a Class");
pega.getUIEngine().getUIAction("openWizard", config).register();
config = new HashMap<String, String>();
config.put("targetActivity", "New");
config.put("InsClass", "PegaAccel-Management-Delete-Class");
config.put("className", "PegaAccel-Management-Delete-Class");
config.put("FlowType", "DeleteClass");
config.put("wizardLabel", "Delete a Class");
pega.getUIEngine().getUIAction("openWizard", config).register();
...
pzSection.getLayout().setExpandParam("SubSectionpxLPSystemRefactorClassesBBB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpxLPSystemRefactorClassesBBB";
...
tools.appendString("<span style=display:none;  " + pzCell.getTestIdIfEnabled("20150416141621030611922") + " ></span>");tools.appendString("<span style=display:none;  " + pzCell.getTestIdIfEnabled("20150416141621030714209") + " ></span>");layoutBody_2();
}
tools.putSaveValue("rowClass","");
}
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_4")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pxLPSystemRefactorClasses_"+ referenceString+ "_10'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20150416141604076210227") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendFormatted("PegaAccel-Management-Refactor-Class",StreamBuilder.FMT_NORMAL);tools.appendString("\",");
{com.google.gson.JsonObject jObject = new com.google.gson.JsonObject();jObject.addProperty("targetActivity", "PegaAccel-Management-Refactor-Class.New");jObject.addProperty("InsClass", "PegaAccel-Management-Refactor-Class");jObject.addProperty("FlowType", "RefactorClass");{jObject.addProperty("className", "PegaAccel-Management-Refactor-Class");}
		tools.appendFormatted(jObject.toString(),StreamBuilder.FMT_NORMAL);}tools.appendString(", \"Rename a Class\"]");
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false; checkForScriptTags_1("Rename a Class"); 
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_5")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pxLPSystemRefactorClasses_"+ referenceString+ "_13'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20150416141621030713773") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }tools.appendString("[\"openWizard\", [\"");

		tools.appendFormatted("PegaAccel-Management-Delete-Class",StreamBuilder.FMT_NORMAL);tools.appendString("\",");
{com.google.gson.JsonObject jObject = new com.google.gson.JsonObject();jObject.addProperty("targetActivity", "PegaAccel-Management-Delete-Class.New");jObject.addProperty("InsClass", "PegaAccel-Management-Delete-Class");jObject.addProperty("FlowType", "DeleteClass");{jObject.addProperty("className", "PegaAccel-Management-Delete-Class");}
		tools.appendFormatted(jObject.toString(),StreamBuilder.FMT_NORMAL);}tools.appendString(", \"Delete a Class\"]");
		...
		tools.appendString("]' ");
			...
			String repeatIndx = "";tools.appendString(" class='");tools.appendString("'");
		tools.appendString(" >");
		boolean hasLineBreaks = false; checkForScriptTags_1("Delete a Class"); 
		tools.appendString("</a>");}pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
		tools.putParamValue("pega_attributes","");
	tools.appendString("</span>");tools.putParamValue("doAutoFormatting", "false");
tools.putParamValue("isControlEditableOriginal", true);
...
public void layoutBody_2() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "height:21px;width:130px;",false," wxpzHasSystemOperationsAdministratorPrivilege","pzHasSystemOperationsAdministratorPrivilege");if(pzAuto.handleEvaluateWhen(" wxpzHasSystemOperationsAdministratorPrivilege","pzHasSystemOperationsAdministratorPrivilege", "cell", "visible" )) {tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","");	pxLink_1();
	tools.appendString("</nobr>");
	}
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Paragraph","pxRenameAClassDescription",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:21px;width:1066px;",false,"","");tools.appendString("<nobr>");
	pzAuto.emitIncludeStreamReference("pxRenameAClassDescription", null,!tools.hasInputEnabled() ? "NoInput" : "null" , "Rule-HTML-PARAGRAPH",null);
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(2).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "height:39px;width:130px;",false," wxpzHasSystemOperationsAdministratorPrivilege","pzHasSystemOperationsAdministratorPrivilege");if(pzAuto.handleEvaluateWhen(" wxpzHasSystemOperationsAdministratorPrivilege","pzHasSystemOperationsAdministratorPrivilege", "cell", "visible" )) {tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","");	pxLink_2();
	tools.appendString("</nobr>");
	}
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Paragraph","pxDeleteAClassDescription",".pySections(2).pySectionBody(1).pyTable.pyRows(2).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataLabelRead",pzSection.getLabelStyle()), "height:39px;width:1066px;",false,"","");tools.appendString("<nobr>");
	pzAuto.emitIncludeStreamReference("pxDeleteAClassDescription", null,!tools.hasInputEnabled() ? "NoInput" : "null" , "Rule-HTML-PARAGRAPH",null);
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
...
pzSection.getLayout().setExpandParam("SubSectionpxLPSystemRefactorClassesBB","",false);
}
...
if(pzSection.getLayout().loadLayoutBody()) {
tools.appendString("<span style=display:none;  " + pzCell.getTestIdIfEnabled("2015041614162103053695") + " ></span>");layoutBody_1();
}
tools.putSaveValue("rowClass","");
}
public void 
...
tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2015041614162103065439") + "  ");
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("Paragraph","pxRefactorClassUtilities",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","heading_3_dataLabelRead ","heading_3_dataLabelWrite "), "height:24px;width:207px;",false,"","");tools.appendString("<nobr>");
	pzAuto.emitIncludeStreamReference("pxRefactorClassUtilities", null,!tools.hasInputEnabled() ? "NoInput" : "null" , "Rule-HTML-PARAGRAPH",null);
	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
...
pzSection.getLayout().setExpandParam("SubSectionpxLPSystemRefactorClassesB","",false);
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-LANDING-SYSTEM-REFACTORCLASSES PXLPSYSTEMREFACTORCLASSES #20180713T142931.627 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pxLPSystemRefactorClasses");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-LANDING-SYSTEM-REFACTORCLASSES PXLPSYSTEMREFACTORCLASSES #20180713T142931.627 GMT", "Pega-Landing-System-RefactorClasses pxLPSystemRefactorClasses", "Pega-LP-SystemSettings", "08-01-01", "20180713T142931.627 GMT");
}
