 ...
 */
public class ra_stream_pydirtycheckconfirm_2667f3f7fb5b1bfb590e6c388f98883a extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyDirtyCheckConfirm.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1767340730;
 ...
 */
	public ra_stream_pydirtycheckconfirm_2667f3f7fb5b1bfb590e6c388f98883a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "2b2ab5288feecca29c550e365a982833c06f91bf";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYDIRTYCHECKCONFIRM #20210506T204028.721 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "2b2ab5288feecca29c550e365a982833c06f91bf";
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYDIRTYCHECKCONFIRM #20210506T204028.721 GMT
 * Set up context.
 */
final String prevRuleKey_2 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYDIRTYCHECKCONFIRM #20210506T204028.721 GMT";final String prevClass_2 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYDIRTYCHECKCONFIRM #20210506T204028.721 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDIRTYCHECKCONFIRM","Rule-HTML-Section","@BASECLASS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION @BASECLASS PYDIRTYCHECKCONFIRM #20210506T204028.721 GMT","!PYDIRTYCHECKCONFIRM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1767340730), 
...
//	RULE-HTML-SECTION @BASECLASS PYDIRTYCHECKCONFIRM #20210506T204028.721 GMT:20210506T204028.721 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "804e5cc6fe2a01875368a14855a665b0";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyDirtyCheckConfirm",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyDirtyCheckConfirm','insKey':'RULE-HTML-SECTION @BASECLASS PYDIRTYCHECKCONFIRM #20210506T204028.721 GMT','sectionType':'standard'}");
pzLayout_3();
...
pzSection.getLayout().setExpandParam("SubSectionCellpyDirtyCheckConfirm184","",false);
}
...
static {
	...
	oStreamProperties_2.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYDIRTYCHECKCONFIRM #20210506T204028.721 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYDIRTYCHECKCONFIRM #20210506T204028.721 GMT", "@baseclass pyDirtyCheckConfirm", "Theme-Cosmos", "04-01-01", "20210506T204028.721 GMT");
