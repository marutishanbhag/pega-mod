...
/**
 * Builds JSP stream WORK-!PYCASEMAINPAGENOTIFICATION.
 */
public class ra_stream_pycasemainpagenotification_855de80e07da148e511d22e7a4851430 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyCaseMainPageNotification.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1383012602;
 ...
 */
	public ra_stream_pycasemainpagenotification_855de80e07da148e511d22e7a4851430(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "69b4cc2dfa3f50b01a0ad1d926e4691a71a431f1";
...
{
/* Instance RULE-HTML-SECTION WORK- PYCASEMAINPAGENOTIFICATION #20210506T204028.481 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "69b4cc2dfa3f50b01a0ad1d926e4691a71a431f1";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyCaseMainPageNotification",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- PYCASEMAINPAGENOTIFICATION #20210506T204028.481 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- PYCASEMAINPAGENOTIFICATION #20210506T204028.481 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- PYCASEMAINPAGENOTIFICATION #20210506T204028.481 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYCASEMAINPAGENOTIFICATION", 
	"Rule-Obj-Property:PYCONFIRMATIONNOTE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCASEMAINPAGENOTIFICATION","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION WORK- PYCASEMAINPAGENOTIFICATION #20210506T204028.481 GMT","!PYCASEMAINPAGENOTIFICATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1383012602), 
		new DependentRuleInfo("PYCONFIRMATIONNOTE","Rule-Obj-Property","WORK-",false,"","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY WORK- PYCONFIRMATIONNOTE #20180713T131935.800 GMT","!PYCONFIRMATIONNOTE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1), 
...
//	RULE-HTML-SECTION WORK- PYCASEMAINPAGENOTIFICATION #20210506T204028.481 GMT:20210506T204028.481 GMT
//	RULE-OBJ-PROPERTY WORK- PYCONFIRMATIONNOTE #20180713T131935.800 GMT:20180713T131935.800 GMT
//	RULE-OBJ-PROPERTY WORK- PYCONFIRMATIONNOTE #20180713T131935.800 GMT:20180713T131935.800 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "9f2cac8d615312a68e92b07c1a385c2c";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyCaseMainPageNotification",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyCaseMainPageNotification','insKey':'RULE-HTML-SECTION WORK- PYCASEMAINPAGENOTIFICATION #20210506T204028.481 GMT','sectionType':'standard'}");
pzLayout_2();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						pzPackageRuntime.packageSection("pyCaseMainPageNotification",
						...
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pyCaseMainPageNotification"));
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20161025093458029886575") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pyCaseMainPageNotification_$CTX$_5");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","close\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("close", ".pyActionPrompt");
	}
	pyTooltip = "close";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyCaseMainPageNotification_"+ referenceString+ "_5'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20161025093458029886575") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","close\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendFormatted("5fd81225-f919-476b-a73d-a736d545c8e7",StreamBuilder.FMT_NORMAL);		tools.appendString("\",\"");
...
try {
	...
	String uid=String.valueOf(((com.pega.pegarules.priv.context.PegaRequestor)tools.getRequestor()).currentTimeUnique());
	String navPage="pyNavigation"+uid;
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20161025093458029886575",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pyCaseMainPageNotification_$CTX$_4");
		String repeatIndx = "";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Get next\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Get next", ".pyButtonLabel");
	}
	pyLabel = "Get next";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyCaseMainPageNotification_"+ referenceString+ "_4'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20161025093458029886575") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		{
		com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();
		...
		tools.appendFormatted("3a80b690-2dfd-4401-a627-48030df612cf",StreamBuilder.FMT_NORMAL);		tools.appendString("\",\"");
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Get next",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
 ...
 */private boolean _jspx_meth_pega_lookup__1(PageContext aPageContext, java.lang.String aProperty) throws Throwable {
/* pega:lookup */
...
try {
if (_jspx_meth_pega_lookup__1(pageContext, ".pyConfirmationNote")) {
	return;
}
} catch(Throwable t) {
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-bottom-spacing remove-top-spacing remove-left-spacing   ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelRead","dataLabelWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("2015012615503109611417")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("partialClass","remove-bottom-spacing remove-top-spacing remove-left-spacing flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015012615503109611417")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing   " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20161025093458029886575-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpyCaseMainPageNotificationBB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202011042325080521889") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle padding-2x" + "'  ");
	...
	String paramName = "EXPANDEDSubSectionpyCaseMainPageNotificationBB";
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing remove-top-spacing remove-left-spacing   flex flex-row '  STRING_TYPE='layout' RESERVE_SPACE='false'>");
	pzLayout_1();
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","flex-align-start margin-l-auto margin-t-1x","flex-align-start margin-l-auto margin-t-1x")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","flex-align-start margin-l-auto margin-t-1x");
	pgCells.put("customRWStyles","flex-align-start margin-l-auto margin-t-1x");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
...
pzSection.getLayout().setExpandParam("SubSectionpyCaseMainPageNotificationB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202011020429280074262") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle banner banner-success flex-nowrap" + "'  " + "role='alert'");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","banner banner-success flex-nowrap");
		pg_dlmeta.put("format","inline_middle");
	...
	String paramName = "EXPANDEDSubSectionpyCaseMainPageNotificationB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpyOnConfirmHarness", pxUniqueStreamHash+"_17");metadataPage.put("lMode","Flexbox");
	metadataPage.put("contCustom","margin-b-0 padding-0");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpyOnConfirmHarness","pyOnConfirmHarness", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	oPropDefinitions_1.put("OFON2J-ProcessO-Work-Onboarding.pyConfirmationNote", new LiteweightPropertyDefinition("OFON2J-ProcessO-Work-Onboarding", "pyConfirmationNote", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- PYCASEMAINPAGENOTIFICATION #20210506T204028.481 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyCaseMainPageNotification");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- PYCASEMAINPAGENOTIFICATION #20210506T204028.481 GMT", "Work- pyCaseMainPageNotification", "Theme-Cosmos", "04-01-01", "20210506T204028.481 GMT");
}
