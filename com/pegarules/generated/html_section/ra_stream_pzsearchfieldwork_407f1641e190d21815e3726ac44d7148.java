...
/**
 * Builds JSP stream DATA-PORTAL!PZSEARCHFIELDWORK.
 */
public class ra_stream_pzsearchfieldwork_407f1641e190d21815e3726ac44d7148 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSearchFieldWork.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 224758780;
 ...
 */
	public ra_stream_pzsearchfieldwork_407f1641e190d21815e3726ac44d7148(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "ff2c29afcaf0d6f1c2c17e5d17bd6b096b658acd";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PZSEARCHFIELDWORK #20181112T184200.845 GMT	Pega-SearchEngine:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "ff2c29afcaf0d6f1c2c17e5d17bd6b096b658acd";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSearchFieldWork",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PZSEARCHFIELDWORK #20181112T184200.845 GMT
 * Set up context.
 */
final String prevRuleKey_4 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PZSEARCHFIELDWORK #20181112T184200.845 GMT";final String prevClass_4 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PZSEARCHFIELDWORK #20181112T184200.845 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZSEARCHFIELDWORK", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSEARCHFIELDWORK","Rule-HTML-Section","DATA-PORTAL",false,"","Pega-SearchEngine","08-02-01","RULE-HTML-SECTION DATA-PORTAL PZSEARCHFIELDWORK #20181112T184200.845 GMT","!PZSEARCHFIELDWORK",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",224758780), 
...
//	RULE-HTML-SECTION DATA-PORTAL PZSEARCHFIELDWORK #20181112T184200.845 GMT:20181112T184200.845 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "35c67163cc3ca6bcd3308629015d8417";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSearchFieldWork",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSearchFieldWork','insKey':'RULE-HTML-SECTION DATA-PORTAL PZSEARCHFIELDWORK #20181112T184200.845 GMT','sectionType':'standard'}");
...
params_3.putString("RegisterTypeahead", "");
params_3.putString("BeforeSearchPanel", "0");
...
params_3.putString("bLocalize", "false");
	...
	if (currentProperty_2 != null && currentProperty_2.getParentPage().getClassName().equals("Data-Portal")) {
		...
		final PRStackFrame stack_2 = ((PegaAPI) tools).pushStackFrame( params_3, false, false, PRStackFrame.Type.APPEND_STREAM, "Rule-HTML-Property", "pzSearchFieldScriptWork" );
		try {
...
if (_jspx_meth_pega_reference__3(pageContext, ".pyTemplateInputBox", "input", "pzSearchFieldScriptWork")) {
	return;
}
	}} catch(Throwable t) {
...
public void field_pzSearchContextButtonWork_1() { 
try {
...
_jspx_th_pega_reference__1.setFormat("pzSearchContextButtonWork");
...
if (_jspx_meth_pega_reference__2(pageContext, ".pyTemplateInputBox", "input", "searchPanelWork")) {
	return;
}
	}} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
public void layoutBody_1() { 
	tools.appendString("<table role='presentation' " + pzSection.getLayout().getInspectorData("FREEFORM",".pySections(1)") + "  section_index='1'  cellpadding='0' cellspacing='0' ID='SearchBoxV6'>");
	
	/*Row Begin*/
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("searchPanelWork",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead","SearchInputBoxV6"), "",false,"","");tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_3")) {	field_searchPanelWork_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pzSearchContextButtonWork",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead","SearchButtonV6"), "",false,"","");tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_4")) {	field_pzSearchContextButtonWork_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pzSearchFieldScriptWork",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "width:103px;display:none;",false,"","");tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_5")) {	field_pzSearchFieldScriptWork_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</nobr>");
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>");
...
pzSection.getLayout().setExpandParam("SubSectionpzSearchFieldWorkB","",false);
}
...
static {
	...
	oStreamProperties_4.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PZSEARCHFIELDWORK #20181112T184200.845 GMT");
	...
	oStreamProperties_4.put("pyStreamName", "pzSearchFieldWork");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PZSEARCHFIELDWORK #20181112T184200.845 GMT", "Data-Portal pzSearchFieldWork", "Pega-SearchEngine", "08-02-01", "20181112T184200.845 GMT");
