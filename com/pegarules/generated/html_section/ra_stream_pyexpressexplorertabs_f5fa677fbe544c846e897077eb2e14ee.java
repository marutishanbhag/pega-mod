...
/**
 * Builds JSP stream PEGA-EXT-EXPEXPLORER-LIBRARY!PYEXPRESSEXPLORERTABS.
 */
public class ra_stream_pyexpressexplorertabs_f5fa677fbe544c846e897077eb2e14ee extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyExpressExplorerTabs.Pega_Ext_ExpExplorer_Library.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 816731012;
 ...
 */
	public ra_stream_pyexpressexplorertabs_f5fa677fbe544c846e897077eb2e14ee(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "ef933c9a570596093bfd691f0130c6409180239f";
...
{
/* Instance RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-LIBRARY PYEXPRESSEXPLORERTABS #20230618T002046.053 GMT	Pega-EndUserUI:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "ef933c9a570596093bfd691f0130c6409180239f";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyExpressExplorerTabs",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-LIBRARY PYEXPRESSEXPLORERTABS #20230618T002046.053 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-LIBRARY PYEXPRESSEXPLORERTABS #20230618T002046.053 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-LIBRARY PYEXPRESSEXPLORERTABS #20230618T002046.053 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYEXPRESSEXPLORERTABS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYEXPRESSEXPLORERTABS","Rule-HTML-Section","PEGA-EXT-EXPEXPLORER-LIBRARY",false,"","Pega-EndUserUI","08-23-01","RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-LIBRARY PYEXPRESSEXPLORERTABS #20230618T002046.053 GMT","!PYEXPRESSEXPLORERTABS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",816731012), 
...
//	RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-LIBRARY PYEXPRESSEXPLORERTABS #20230618T002046.053 GMT:20230618T002046.053 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "62ce8856c44fdad3a0681963cb149747";
	}

	public String getDefinitionAppliesToClass() {
		return "Pega-Ext-ExpExplorer-Library";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyExpressExplorerTabs",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyExpressExplorerTabs','insKey':'RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-LIBRARY PYEXPRESSEXPLORERTABS #20230618T002046.053 GMT','sectionType':'standard'}");
pzLayout_1();
...
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.ui.composer.sendEvent");
pega.getUIEngine().getUIAction("runScript", config).register();
config = new HashMap<String, String>();
config.put("harnessName", "pzExpressLPHarness");
config.put("className", "Pega-Ext-ExpExplorer-Library");
config.put("target", "newDocument");
pega.getUIEngine().getUIAction("showHarness", config).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.ui.composer.formfactor.reloadPreview");
pega.getUIEngine().getUIAction("runScript", config).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.ui.developerAssistantPanelExpress.reloadDevAssistPanel");
pega.getUIEngine().getUIAction("runScript", config).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "ExpressExtSlider.closeSlider");
pega.getUIEngine().getUIAction("runScript", config).register();
...
tools.appendString("<div class='layout layout-none set-width-auto has-action '>");
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("202302071359080360455",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pyExpressExplorerTabs_$CTX$_1");
		String repeatIndx = "";
	...
	String pyImageR = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyIconClass");
	pyImageR = ".pyIconClass";
	modePage2.put("image",pyImageR);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyExpressExplorerTabs_"+ referenceString+ "_1'";
	 ...
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("202302071359080360455") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString(toolTipVal);tools.appendString(" class='Header_nav");tools.appendString("'");
		tools.appendString(" >");
		String classProp = "";
		classProp = tools.getProperty(".pyIconClass").getStringValue();
		tools.appendString("<i aria-hidden='true'  class='" + classProp + "'></i>");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"ExpressExtSlider.closeSlider()\"]");

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.ui.composer.sendEvent(\\\"LiveComposer.stateChange\\\")\"]");
	...
	tools.appendString("],[\"showHarnessWrapper\",[\"newDocument\",\"");
		...
		tools.appendFormatted("Pega-Ext-ExpExplorer-Library",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");
...
{com.google.gson.JsonObject jObject = new com.google.gson.JsonObject();com.google.gson.JsonObject propRefJSON = new com.google.gson.JsonObject();if(!"{}".equals(propRefJSON.toString())){jObject.add("preActivityDynamicParams",propRefJSON);}
		...
		tools.appendFormatted(tools.getLocalizedTextForString("pyCaption", "LibraryLandingPage"),StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");
	...
	"Pega-Ext-ExpExplorer-Library"
	,"Display","0");
	}

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.ui.composer.formfactor.reloadPreview(\\\"\\\")\"]");

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.ui.developerAssistantPanelExpress.reloadDevAssistPanel()\"]");

		tools.appendString("]");isBehaviorAdded = true;
		tools.appendString("]' ");isBehaviorAdded = false;
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"doListAction\",[\":event\",\"SETFOCUS\",null,{\"offset\":0}]");
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","no-menu icon-tile centered","no-menu icon-tile centered")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202302071359080360455-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxLink");
	pgCells.put("forLabel",".pyLabel");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("customROStyles","no-menu icon-tile centered");
	pgCells.put("customRWStyles","no-menu icon-tile centered");
...
pzSection.getLayout().setExpandParam("SubSectionpyExpressExplorerTabsB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  set-width-auto pointer  layout-content-inline content-inline content-items-maxwidth clearfix" + "'  ");
...
{com.google.gson.JsonObject jObject = new com.google.gson.JsonObject();com.google.gson.JsonObject propRefJSON = new com.google.gson.JsonObject();if(!"{}".equals(propRefJSON.toString())){jObject.add("preActivityDynamicParams",propRefJSON);}
	...
	String paramName = "EXPANDEDSubSectionpyExpressExplorerTabsB";
	metadataPage.put("paramName", paramName);
	metadataPage.put("floatClass"," set-width-auto has-action ");
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Pega-Ext-ExpExplorer-Library");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-LIBRARY PYEXPRESSEXPLORERTABS #20230618T002046.053 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyExpressExplorerTabs");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION PEGA-EXT-EXPEXPLORER-LIBRARY PYEXPRESSEXPLORERTABS #20230618T002046.053 GMT", "Pega-Ext-ExpExplorer-Library pyExpressExplorerTabs", "Pega-EndUserUI", "08-23-01", "20230618T002046.053 GMT");
}
