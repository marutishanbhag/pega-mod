...
/**
 * Builds JSP stream DATA-PORTAL!PYDASHBOARDMIDDLE.
 */
public class ra_stream_pydashboardmiddle_ca87fce8da790084866d60d41615baef extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyDashboardMiddle.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1807682522;
 ...
 */
	public ra_stream_pydashboardmiddle_ca87fce8da790084866d60d41615baef(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "364df00dceadea3a58bc11ac9e2b7d02a4fb6724";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDMIDDLE #20180713T134751.428 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "364df00dceadea3a58bc11ac9e2b7d02a4fb6724";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyDashboardMiddle",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDMIDDLE #20180713T134751.428 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDMIDDLE #20180713T134751.428 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDMIDDLE #20180713T134751.428 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYDASHBOARDMIDDLE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDASHBOARDMIDDLE","Rule-HTML-Section","DATA-PORTAL",false,"","Pega-EndUserUI","08-01-01","RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDMIDDLE #20180713T134751.428 GMT","!PYDASHBOARDMIDDLE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1807682522)
	};
...
//	RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDMIDDLE #20180713T134751.428 GMT:20180713T134751.428 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "fc581340c1780c3c5bc2b309b0817746";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyDashboardMiddle",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyDashboardMiddle','insKey':'RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDMIDDLE #20180713T134751.428 GMT','sectionType':'standard'}");
pzLayout_5();
pzLayout_7();
...
tools.putParamValue("LAYOUT_METHOD_NAME","simpleLayout_4");simpleLayout_4();tools.putParamValue("LAYOUT_METHOD_NAME","simpleLayout_5");simpleLayout_5();
}
...
public void buildSection_6() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_22","pyWGUserWorkList", secInfo);
}
...
public void sectionBodyIncludeInCell_6() { 
	...
	String sectionName = "pyWGUserWorkList"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpyDashboardMiddle982","",false);
}
...
public void buildSection_5() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_19","pyWGUserWorkList", secInfo);
}
...
public int simpleLayoutCell_5( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyWGUserWorkList",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyWGUserWorkList",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpyDashboardMiddleBBBB","",false);
}
...
public void simpleLayout_4() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201804020350020526416") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + " content  set-width-auto layout-content-default content-default sortable-item clearfix" + "'  ");
		...
		pg_dlmeta.put("customClassName","sortable-item");
...
public void simpleLayout_5() {
		...
		if(currentTemplatingStatus != 'Y'){
			...
			tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + " content  set-width-auto layout-content-default sortable-item clearfix" + "'  ");
			if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
			tools.appendString(" ");
			}
			tools.appendString(" " + refreshAttributes + ">");
		...
		String paramName = "EXPANDEDSubSectionpyDashboardMiddleBBBB";
		...
		boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= rxD_PortalContext.pyContext cqDashboard", pxUniqueStreamHash+"_24");metadataPage.put("lMode","Inline-block");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= rxD_PortalContext.pyContext cqDashboard","D_PortalContext.pyContext!=\'Dashboard\'", "layout", "visible" )) {pzSetExpandParam_6();
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyDashboardMiddleBBB"));
...
metadataPage.put("title", ".pyUrgentWorkHeader");
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyUrgentWorkHeader", "pyCaption");
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyUrgentWorkHeader");
...
metadataPage.put("uniqueid", "202602210109340841");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("201804020350020525801") + " ");
...
public void buildSection_4() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_14","pyUserWorkList", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pyUserWorkList"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpyDashboardMiddle190","",false);
}
...
public void buildSection_3() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_11","pyUserWorkList", secInfo);
}
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyUserWorkList",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-right-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyUserWorkList",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyDashboardMiddleBBB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='layout layout-outline layout-outline-nested' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpyDashboardMiddleBBB";
...
l_sectionTitle=StringUtils.crossScriptingFilter(tools.getLocalizedTextForParameterizedString("pyCaption",tools.getProperty(".pyUrgentWorkHeader").getStringValue()));
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel6566' data-layout-id='202602210109340825" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel6566'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyDashboardMiddleBBB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201804020350020525801") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
		...
		tools.appendString(" class='" + " content  layout-content-default content-default sortable-item work-grid" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","sortable-item work-grid");
		pg_dlmeta.put("format","default");
		pg_dlmeta.put("isFlex","false");
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		cc_dl.beginComponent("DynamicLayout",pg_dlmeta);
	...
	String paramName = "EXPANDEDSubSectionpyDashboardMiddleBBB";
	metadataPage.put("paramName", paramName);
...
public void buildSection_2() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pxDisplayStagesReport", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pxDisplayStagesReport"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpyDashboardMiddle871","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pxDisplayStagesReport", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pxDisplayStagesReport",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-right-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pxDisplayStagesReport",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyDashboardMiddleBB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201804020350020524879") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + " content  layout-content-default content-default sortable-item" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpyDashboardMiddleBB";
	metadataPage.put("paramName", paramName);
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing remove-top-spacing   '  STRING_TYPE='layout' RESERVE_SPACE='false'><div class='content-inner '>");
	pzLayout_2();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("partialClass","remove-bottom-spacing remove-right-spacing remove-top-spacing");
	pgCells.put("format","label");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-bottom-spacing remove-right-spacing   '  STRING_TYPE='layout' RESERVE_SPACE='false'><div class='content-inner '>");
	pzLayout_4();
 tools.putSaveValue("ContainerID", "");tools.appendString("</div></div>");
	index++;
	return index;
...
pzSection.getLayout().setExpandParam("SubSectionpyDashboardMiddleB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201804020350020523331") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  layout-content-stacked_for_layouts content-stacked_for_layouts dashboard clearfix" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","dashboard");
		pg_dlmeta.put("class","clearfix");
		pg_dlmeta.put("format","stacked_for_layouts");
	...
	String paramName = "EXPANDEDSubSectionpyDashboardMiddleB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rxD_PortalContext.pyContext cqDashboard", pxUniqueStreamHash+"_17");metadataPage.put("lMode","Inline-block");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2== rxD_PortalContext.pyContext cqDashboard","D_PortalContext.pyContext==\'Dashboard\'", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDMIDDLE #20180713T134751.428 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyDashboardMiddle");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDMIDDLE #20180713T134751.428 GMT", "Data-Portal pyDashboardMiddle", "Pega-EndUserUI", "08-01-01", "20180713T134751.428 GMT");
}
