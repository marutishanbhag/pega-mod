...
/**
 * Builds JSP stream RULE-APPLICATION!PZRARECORDCONFIGURATION.
 */
public class ra_stream_pzrarecordconfiguration_1277ca973c47a52a340bde516b59f62b extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzRARecordConfiguration.Rule_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1224434372;
 ...
 */
	public ra_stream_pzrarecordconfiguration_1277ca973c47a52a340bde516b59f62b(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "cdf5fc9a440b26999f154b817f30ab3647f74c62";
...
{
/* Instance RULE-HTML-SECTION RULE-APPLICATION PZRARECORDCONFIGURATION #20180713T135240.905 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "cdf5fc9a440b26999f154b817f30ab3647f74c62";
...
/*
 * Begin RULE-HTML-SECTION RULE-APPLICATION PZRARECORDCONFIGURATION #20180713T135240.905 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-APPLICATION PZRARECORDCONFIGURATION #20180713T135240.905 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-APPLICATION PZRARECORDCONFIGURATION #20180713T135240.905 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRARECORDCONFIGURATION","Rule-HTML-Section","RULE-APPLICATION",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION RULE-APPLICATION PZRARECORDCONFIGURATION #20180713T135240.905 GMT","!PZRARECORDCONFIGURATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1224434372), 
		new DependentRuleInfo("PYMODE","Rule-Obj-Property","RULE-APPLICATION",false,"","Pega-Desktop","08-01-01","RULE-OBJ-PROPERTY RULE-APPLICATION PYMODE #20180713T135036.925 GMT","!PYMODE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0)
	};
...
//	RULE-HTML-SECTION RULE-APPLICATION PZRARECORDCONFIGURATION #20180713T135240.905 GMT:20180713T135240.905 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYMODE #20180713T135036.925 GMT:20180713T135036.925 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION PYMODE #20180713T135036.925 GMT:20180713T135036.925 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "3728bbbd66b33c8adc927b3c31c3d36b";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzRARecordConfiguration",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzRARecordConfiguration','insKey':'RULE-HTML-SECTION RULE-APPLICATION PZRARECORDCONFIGURATION #20180713T135240.905 GMT','sectionType':'standard'}");
pzLayout_2();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pzRARecordConfigurationInner", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzRARecordConfiguration78","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pzRARecordConfigurationInner", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzRARecordConfigurationInner",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-bottom-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzRARecordConfigurationInner",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel8236' data-layout-id='202602230406520180" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel8236'>");
try {
 ...
 */
if (_jspx_meth_p_r__1(pageContext, ".pyMode")) {
	return;
}
tools.appendString(" Record Configuration");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
tools.appendString("</h2><nobr>");
...
pzLayoutBodyWrapper_2();
 LayoutWrapperTableEnd_1(); } pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
}
...
static {
	oPropDefinitions_1.put("Rule-Application.pyMode", new LiteweightPropertyDefinition("Rule-Application", "pyMode", "stN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-APPLICATION PZRARECORDCONFIGURATION #20180713T135240.905 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-APPLICATION PZRARECORDCONFIGURATION #20180713T135240.905 GMT", "Rule-Application pzRARecordConfiguration", "Pega-Desktop", "08-01-01", "20180713T135240.905 GMT");
}
