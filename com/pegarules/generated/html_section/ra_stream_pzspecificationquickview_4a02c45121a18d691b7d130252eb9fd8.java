...
/**
 * Builds JSP stream RULE-APPLICATION-USECASE!PZSPECIFICATIONQUICKVIEW.
 */
public class ra_stream_pzspecificationquickview_4a02c45121a18d691b7d130252eb9fd8 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzSpecificationQuickView.Rule_Application_UseCase.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -2032526416;
 ...
 */
	public ra_stream_pzspecificationquickview_4a02c45121a18d691b7d130252eb9fd8(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a3b00a729749ff573dd2f3e9fe5d89e998596bd7";
...
{
/* Instance RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "a3b00a729749ff573dd2f3e9fe5d89e998596bd7";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzSpecificationQuickView",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSPECIFICATIONQUICKVIEW","Rule-HTML-Section","RULE-APPLICATION-USECASE",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT","!PZSPECIFICATIONQUICKVIEW",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2032526416), 
		new DependentRuleInfo("PYTEMPLATEDISPLAYTEXT","Rule-Obj-Property","@BASECLASS",true,"Rule-Application-UseCase","Pega-UIDesign","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEDISPLAYTEXT #20180713T133539.875 GMT","!PYTEMPLATEDISPLAYTEXT",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYTEMPLATEINPUTBOX","Rule-Obj-Property","@BASECLASS",true,"Rule-Application-UseCase","Pega-UIDesign","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYTEMPLATEINPUTBOX #20180713T133539.879 GMT","!PYTEMPLATEINPUTBOX",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		...
		new DependentRuleInfo("PZSHOWRTETOOLBAR","Rule-Obj-Property","RULE-APPLICATION-USECASE",true,"Rule-Application-UseCase","Pega-ProcessArchitect","08-01-01","RULE-OBJ-PROPERTY RULE-APPLICATION-USECASE PZSHOWRTETOOLBAR #20180713T140723.139 GMT","!PZSHOWRTETOOLBAR",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		...
		new DependentRuleInfo("WEBWB!AP_DROPDOWN!PNG","Rule-File-Binary","",false,"","Pega-AppDefinition","","RULE-FILE-BINARY WEBWB AP_DROPDOWN!PNG #20180713T141652.141 GMT","WEBWB!AP_DROPDOWN!PNG",true,false,"ABSOLUTE_CLASSLESS",1), 
		new DependentRuleInfo("WEBWB!AP_DROPDOWN!PNG","Rule-File-Binary","",false,"","","","","WEBWB!AP_DROPDOWN!PNG",true,false,"ABSOLUTE_CLASSLESS",1)
	};
...
//	RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT:20180713T140901.070 GMT
//	RULE-HTML-PROPERTY PXLINK #20190131T183501.590 GMT:20190131T183501.590 GMT
//	RULE-FILE-BINARY WEBWB AP_DROPDOWN!PNG #20180713T141652.141 GMT:20180713T141652.141 GMT
//	RULE-FILE-BINARY WEBWB AP_DROPDOWN!PNG #20180713T141652.141 GMT:20180713T141652.141 GMT
...
//	RULE-OBJ-PROPERTY RULE-APPLICATION-USECASE PZSHOWRTETOOLBAR #20180713T140723.139 GMT:20180713T140723.139 GMT
//	RULE-HTML-PROPERTY PXHIDDEN #20180713T133435.722 GMT:20180713T133435.722 GMT
//	RULE-OBJ-PROPERTY RULE-APPLICATION-USECASE PZSHOWRTETOOLBAR #20180713T140723.139 GMT:20180713T140723.139 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "3f030b0b0e7e5ffe33cf80705fcf3265";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzSpecificationQuickView",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzSpecificationQuickView','insKey':'RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT','sectionType':'standard'}");
pzLayout_7();
pzLayout_8();
...
public void buildSection_5() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_51","pzSpecificationDescriptionForOutlineView", secInfo);
}
...
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("navName", "pzSpecificationActionsFromFlowShape");
...
config = new HashMap<String, String>();
config.put("theFlow", "");
config.put("CopyOrSpecialize", "Specialize");
config.put("pxLinkedRefFrom", "");
config.put("pzActivityStaticParams", "pxLinkedRefFrom&theFlow&modelPage&CopyOrSpecialize");
config.put("pzActivity", "pzSaveAsSpec");
config.put("modelPage", "");
...
config = new HashMap<String, String>();
config.put("theFlow", "");
config.put("CopyOrSpecialize", "Copy");
config.put("pxLinkedRefFrom", "");
config.put("pzActivityStaticParams", "pxLinkedRefFrom&theFlow&modelPage&CopyOrSpecialize");
config.put("pzActivity", "pzSaveAsSpec");
config.put("modelPage", "");
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzSpecificationDescriptionForOutlineView";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_8() {
pzSection.getLayout().setExpandParam("SubSectionpzSpecificationQuickViewBBBBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpzSpecificationQuickViewBBBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzSpecificationDescriptionForOutlineView'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pzSpecificationDescriptionForOutlineView'}") + ">");
}
pzSetExpandParam_8();
...
tools.putParamValue("isControlEditableOriginal", true);
	...
	cellPage.put("pyValue",".pzShowRTEToolbar");
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	cellPage.put("pyID","pzShowRTEToolbar");
	modePage2.put("pyContent","associated");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20140918085737046022568",true));
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pzShowRTEToolbar");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pzShowRTEToolbar", ".pyCaption");
	String spxUniqueStreamHash48 = getUIActionsMetaData_3();
...
boolean bUITemplatized = pzAuto.getUIComponentRuntime().isTemplateRendering();pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);
	tools.appendString("<input  type=\"hidden\"  " + pzCell.getTestIdIfEnabled("20140918085737046022568") + "  id=\"");
		tools.appendString(tools.getHTMLIDForProperty(true,"hidden"));
tools.appendString("\" value=\"");if(bUITemplatized){
	tools.appendString(pzAuto.getUIComponentRuntime().getRuntimeContextTree().generateContextToken("pzShowRTEToolbar"));}else {
	...
	tools.appendString(" data-ctl ");
		...
		tools.appendString(" data-change='[");if(isBehaviorAdded && true){ tools.appendString(","); }		tools.appendString("[\"fireACOnElem\",[\":event\"]");
...
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);	cellPage.put("pyID","pzShowRTEToolbar");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pzShowRTEToolbar");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pzShowRTEToolbar", ".pyCaption");
	String spxUniqueStreamHash47 = getUIActionsMetaData_3();
...
public void field_pzShowHideRTEToolbar_2() { 
try {
...
_jspx_th_pega_reference__2.setFormat("pzShowHideRTEToolbar");
...
public void field_pzShowHideRTEToolbar_1() { 
try {
...
_jspx_th_pega_reference__1.setFormat("pzShowHideRTEToolbar");
...
public int simpleLayoutCell_13( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpzIsRTEToolbarDisabled","pzIsRTEToolbarDisabled","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzShowHideRTEToolbar",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_43")) {	field_pzShowHideRTEToolbar_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_13( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140918085737046021732-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pzShowHideRTEToolbar");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzIsRTEToolbarDisabled",pxUniqueStreamHash+"_45");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_45");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzIsRTEToolbarDisabled");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzIsRTEToolbarDisabled", pxUniqueStreamHash+"_45"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pzShowHideRTEToolbar",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_46")) {	field_pzShowHideRTEToolbar_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();}
	if (!isExpression && isOffline) {
	// do nothing
	} else {
...
public int simpleLayoutCell_14( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_1(".pzShowRTEToolbar",0,"","","True-False");
	return index;
}
...
public int simpleLayoutTemplateCell_14( int index) {
	...
	String reqExpressionId = null;
	String disExpressionId = null;
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");	pxHidden_2(".pzShowRTEToolbar",0,"","","True-False");
	index++;
	return index;
}
public void pzSetExpandParam_7() {
pzSection.getLayout().setExpandParam("SubSectionpzSpecificationQuickViewBBBBB","",false);
}
...
public void simpleLayout_4() {
	...
	String paramName = "EXPANDEDSubSectionpzSpecificationQuickViewBBBBB";
	metadataPage.put("paramName", paramName);
...
sectionDefaultValues_1() {
	...
	if(pzAuto.handleEvaluateWhen(" o2== rx.pzShowRTEToolbar cq",".pzShowRTEToolbar", "cell", "active" )) {
		 tools.getProperty(".pzShowRTEToolbar").setValue(false);if (pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'){String tempDefault=tools.getProperty(".pzShowRTEToolbar").toString();
		 tools.getProperty(".pzShowRTEToolbar").setValue("");pzAuto.getUIComponentRuntime().getRuntimeContextTree().addDefaultValue(".pzShowRTEToolbar",tempDefault);}
}
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_36")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pzSpecificationQuickView_"+ referenceString+ "_17'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20140918085737045918757") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
	...
	ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzSaveAsSpec");
	tools.appendString("[\"runActivity\", [\"\", \"");
	ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"pxLinkedRefFrom\":\"\"");
	ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"theFlow\":\"\"");
	ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"modelPage\":\"\"");
	ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"CopyOrSpecialize\":\"Copy\"");
	...
	if(!"".equals(ractParamStr.toString())) {
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }			{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
				com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
					...
					if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
						try{
							pzPackageRuntime.packageSection("pzSpecificationQuickView",
							...
							refreshActionRequest.registerFixedParameter("SectionName", "pzShapeNodeTabsFromOutline");
							staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
							staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzSpecificationQuickView"));
							tools.appendString("[\"refresh\", [\"thisSection\",\"pzShapeNodeTabsFromOutline\", \"\", \"");
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Click to copy in a higher version\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Copy".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		tools.appendString("<span class='pzbtn-label'  data-click='.....' ");}if(bOptimizedMarkup && hasLineBreaks){
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Copy",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public void pxDisplayText_4() {String key="16||RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT";
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","16"};oCellRuntimeParamsMap.put("16||RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT",paramValues);oControlPathsMap.put("16||RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}


public void pxDisplayText_3() {String key="15||RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","15"};oCellRuntimeParamsMap.put("15||RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT",paramValues);oControlPathsMap.put("15||RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
...
public int simpleLayoutCell_9( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" rx.pyIsFlowReadOnly",".pyIsFlowReadOnly","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_9( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140918085737045816948-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyIsFlowReadOnly",pxUniqueStreamHash+"_33");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_33");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyIsFlowReadOnly");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Application-UseCase");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_33");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" rx.pyIsFlowReadOnly", pxUniqueStreamHash+"_33"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_3();}
...
public int simpleLayoutCell_10( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyIsFlowReadOnly cffalse",".pyIsFlowReadOnly == false","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_10( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140918085737045917987-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyIsFlowReadOnly cffalse",pxUniqueStreamHash+"_35");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_35");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyIsFlowReadOnly == false");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Application-UseCase");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_35");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyIsFlowReadOnly cffalse", pxUniqueStreamHash+"_35"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_4();}
...
public int simpleLayoutCell_11( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& wxpzIsSpecificationCanBeSaveAsd o2== rx.pyIsFlowReadOnly cffalse","pzIsSpecificationCanBeSaveAsd && .pyIsFlowReadOnly == false","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_11( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140918085737045918757-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxpzIsSpecificationCanBeSaveAsd o2== rx.pyIsFlowReadOnly cffalse",pxUniqueStreamHash+"_38");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_38");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzIsSpecificationCanBeSaveAsd && .pyIsFlowReadOnly == false");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Application-UseCase");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_38");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxpzIsSpecificationCanBeSaveAsd o2== rx.pyIsFlowReadOnly cffalse", pxUniqueStreamHash+"_38"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxButton_2();}
...
pzSection.getLayout().setExpandParam("SubSectionpzSpecificationQuickViewBBBB","",false);
}
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1)'}") + " class='" + " content  layout-content-inline_middle content-inline_middle " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzSpecificationQuickViewBBBB";
	metadataPage.put("paramName", paramName);
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& wxpzIsSpecificationLocked o2== rx.pyProductName rxApplication.pyProductName", pxUniqueStreamHash+"_39");metadataPage.put("dlChild","true");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& wxpzIsSpecificationLocked o2== rx.pyProductName rxApplication.pyProductName","pzIsSpecificationLocked && .pyProductName == Application.pyProductName", "layout", "visible" )) {pzSetExpandParam_6();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
tools.putParamValue("LAYOUT_METHOD_NAME","simpleLayout_2");simpleLayout_2();layoutBody_2();
}
...
tools.appendString("<table role='presentation' " + pzSection.getLayout().getInspectorData("DYNAMICLAYOUT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)") + "  section_index='1'   cellpadding='0' cellspacing='0' ID='' width='100%'>\n\t\t\t\t\t\t\t</table>");
 } 
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_25")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzSpecificationQuickView_"+ referenceString+ "_11'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20140918085737045812694") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }{
	StringBuffer ractURLStr = new StringBuffer();
	...
	ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"theFlow\":\"\"");
	ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"modelPage\":\"\"");
	ractParamStr.append((!"".equals(ractParamStr.toString())?",":"") + "\"CopyOrSpecialize\":\"Specialize\"");
	ractParamStr.append(!"".equals(ractParamStr.toString())? ",pyReturnsResponse:false": "pyReturnsResponse:false");
	tools.appendString("\", \"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \":event\", \"\", \"\", \"\", \"");
	if(!"".equals(ractParamStr.toString())) {
		ractURLStr.append("&pzActivityParamsEncrypted=" + pega_uiengine_pzcontrol.pzURLEncodeString("{" + ractParamStr.toString() + "}"));
		...
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Click to specialize in current layer\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
		tools.appendString(toolTipVal);tools.appendString("class='pzhc");tools.appendString("'");if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		tools.appendString(" >");
		tools.appendString("<div class='pzbtn-rnd'  data-click='.'><div class='pzbtn-lft'  data-click='..' ");
		tools.appendString(" ><div class='pzbtn-rgt'  data-click='...'><div class='pzbtn-mid' ");if(bOptimizedMarkup){tools.appendString("data-bindprops='innerHTML,title' ");}tools.appendString(" data-click='....'>");
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Specialize".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		tools.appendString("<span class='pzbtn-label'  data-click='.....' ");}if(bOptimizedMarkup && hasLineBreaks){
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Specialize",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString("<img alt='' src='webwb/zblankimage.gif' class='pzbtn-i'/>");
		tools.appendString("</div></div></div></div>");
		tools.appendString("</button>");}pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
		tools.putParamValue("pega_attributes","");
...
public void pxDisplayText_2() {String key="10||RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","10"};oCellRuntimeParamsMap.put("10||RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT",paramValues);oControlPathsMap.put("10||RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");}


public void pxDisplayText_1() {String key="9||RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","9"};oCellRuntimeParamsMap.put("9||RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT",paramValues);oControlPathsMap.put("9||RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140918085737045710639-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyIsFlowReadOnly",pxUniqueStreamHash+"_22");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" rx.pyIsFlowReadOnly", pxUniqueStreamHash+"_22"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_1();}
...
public int simpleLayoutTemplateCell_6( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140918085737045711264-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDisplayText");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyIsFlowReadOnly cffalse",pxUniqueStreamHash+"_24");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyIsFlowReadOnly cffalse", pxUniqueStreamHash+"_24"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDisplayText",".pyTemplateDisplayText",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDisplayText_2();}
...
public int simpleLayoutCell_7( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + "   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	IUIComponentMetadata pg_dlCellMeta = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140918085737045812694-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxButton");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxpzIsSpecificationCanBeSaveAsd o2== rx.pyIsFlowReadOnly cffalse",pxUniqueStreamHash+"_27");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxpzIsSpecificationCanBeSaveAsd o2== rx.pyIsFlowReadOnly cffalse", pxUniqueStreamHash+"_27"); 
	}
	if(pyDLCellVisibility) {
...
pzSection.getLayout().setExpandParam("SubSectionpzSpecificationQuickViewBBB","",false);
}
...
public void simpleLayout_2() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + " class='" + " content  layout-content-inline_middle content-inline_middle " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzSpecificationQuickViewBBB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2!= rx.pyProductName rxApplication.pyProductName o2!= rx.pzInsKey cq", pxUniqueStreamHash+"_28");metadataPage.put("dlChild","true");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2!= rx.pyProductName rxApplication.pyProductName o2!= rx.pzInsKey cq",".pyProductName != Application.pyProductName && .pzInsKey != \'\'", "layout", "visible" )) {pzSetExpandParam_5();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_4() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_19","pzStepLabelAndSpecLink", secInfo);
}
...
public void sectionBodyIncludeInCell_4() { 
	...
	String sectionName = "pzStepLabelAndSpecLink"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzSpecificationQuickView680","",false);
}
...
public void buildSection_3() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_16","pzStepLabelAndSpecLink", secInfo);
}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString("[\"showMenu\",[{\"dataSource\":\"pzSpecificationActionsFromFlowShape\", \"isNavNLDeferLoaded\":\"false\", \"isNavTypeCustom\":\"false\", \"className\":\"" + tools.getStepPage().getClassName());
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771656592252");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzSpecificationActionsFromFlowShape", "", "pyNavigation1771656592252","", false, false, false, false);
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2014091808573704564274",true));
	if(false || (pzAuto.isOffline() && true) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzSpecificationQuickView_$CTX$_4");
		String repeatIndx = "";
	...
	modePage2.put("image","webwb/ap_dropdown_12996906232.png!!.png");
	modePage2.put("actionImgPos","right");
	String customStyles = null;
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Specification actions\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Specification actions", ".pyButtonLabel");
	}
	pyLabel = "Specification actions";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzSpecificationQuickView_"+ referenceString+ "_4'";
	 String securedPropValue = null;String localizedValForMenu = ""; String ariaLabel = "";try {localizedValForMenu = tools.getLocalizedTextForString(".pyCaption","menu");ariaLabel = StringUtils.filterRichText("Specification actions");} catch(Exception e) {}
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2014091808573704564274") + " role='link' aria-haspopup='true' href='"+hrefValue+"'");tools.appendString(" aria-label='"+localizedValForMenu+" "+ariaLabel+"' ");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	if(pega_uiengine_pznavigation.pzUseNewMenu() && true) {
	  IActionRequest actionRequest = pzAuto.getActionRequest();
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771656592255");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzSpecificationActionsFromFlowShape", "", "pyNavigation1771656592255","", false, false, false, false);
			}catch(Exception e){oLog.error(e);}
			}
			tools.appendString("\"},\":event\"]");
		...
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Specification actions",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString(" <img alt='"+toolTipVal+"' aria-hidden='true' src='");
		tools.appendString("webwb/ap_dropdown_12996906232.png!!.png");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_8","pzDisplayCommentsForOutLine", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	"pzDisplayCommentsForOutLine", tools.getStepPage().getReference(),"Rule-Application-UseCase");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	...
	String sectionName = "pzDisplayCommentsForOutLine"; 
	String usingPage = null;
	ClipboardPage pg_usingPage = null;
	if(usingPage != null && !"".equals(usingPage)){
		pg_usingPage = tools.findPage(usingPage);
...
pzSection.getLayout().setExpandParam("SubSectionCellpzSpecificationQuickView104","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("packageSection", true);
	secInfo.put("packageSectionClass", "Rule-Application-UseCase");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pzDisplayCommentsForOutLine", secInfo);
}
...
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pyCommentsCount\" RW=\".pyCommentsCount Changes\"");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
}
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyCommentsCount"), -1);
	}
}catch(Exception e){}
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzDisplayCommentsForOutLine",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  ".pyCommentsCount Changes",expressionId);
		 String pyCustomRequireFormat= "";
		pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
		String baseRef ="";
		boolean pyDLCellVisibility = false;
		...
		if(pyDLCellVisibility) {
		String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzDisplayCommentsForOutLine",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
		if(!inspectorData.isEmpty()) {
		pgCells.put("liveUI",inspectorData);
		}
		String tempRenderSingle = "";
...
public int simpleLayoutCell_2( int index) {
		...
		String ariahiddenString = "";
		String baseRef ="";
		if(!pzAuto.handleEvaluateWhen(" o2|| wxpzIfSpecificationExists o2== rx.pyIsFlowReadOnly cffalse","pzIfSpecificationExists || .pyIsFlowReadOnly == false","cell", "visible" )) {
			pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
			return index;
		}
		generateClientWhenDiv_1();
		tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
		...
		IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
		pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing");
		pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2014091808573704564274-Label")).append(" ").toString().replace("data-test-id=","").trim());
		...
		isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
		if (!isExpression && isOffline) {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2|| wxpzIfSpecificationExists o2== rx.pyIsFlowReadOnly cffalse",pxUniqueStreamHash+"_12");
		pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_12");
		pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzIfSpecificationExists || .pyIsFlowReadOnly == false");
		pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Application-UseCase");
		pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
		} else {
		pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_12");
		...
		pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2|| wxpzIfSpecificationExists o2== rx.pyIsFlowReadOnly cffalse", pxUniqueStreamHash+"_12"); 
		}
		if(pyDLCellVisibility) {
...
pzSection.getLayout().setExpandParam("SubSectionpzSpecificationQuickViewBB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionpzSpecificationQuickViewBB";
	metadataPage.put("paramName", paramName);
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= rx.pyShapeName cq", pxUniqueStreamHash+"_13");metadataPage.put("dlChild","true");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= rx.pyShapeName cq",".pyShapeName != \'\'", "layout", "visible" )) {pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public int simpleLayoutCell_3( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= rx.pyShapeName cq",".pyShapeName != \'\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing float-right set-width-auto   '  STRING_TYPE='layout' RESERVE_SPACE='false'><div class='content-inner set-width-auto'>");
	pzLayout_2();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing remove-left-spacing float-right set-width-auto");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pyShapeName cq",pxUniqueStreamHash+"_15");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_15");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyShapeName != ''");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Application-UseCase");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_15");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pyShapeName cq", pxUniqueStreamHash+"_15"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_2();
 tools.putSaveValue("ContainerID", "");}
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzStepLabelAndSpecLink",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
	String tempRenderSingle = "";
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzStepLabelAndSpecLink",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	String tempRenderSingle = "";
...
public int simpleLayoutCell_8( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& o2!= rx.pyProductName rxApplication.pyProductName o2!= rx.pzInsKey cq",".pyProductName != Application.pyProductName && .pzInsKey != \'\'","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& o2!= rx.pyProductName rxApplication.pyProductName o2!= rx.pzInsKey cq",pxUniqueStreamHash+"_30");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_30");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyProductName != Application.pyProductName && .pzInsKey != ''");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Application-UseCase");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_30");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& o2!= rx.pyProductName rxApplication.pyProductName o2!= rx.pzInsKey cq", pxUniqueStreamHash+"_30"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_4();
 tools.putSaveValue("ContainerID", "");}
...
public int simpleLayoutCell_12( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2&& wxpzIsSpecificationLocked o2== rx.pyProductName rxApplication.pyProductName","pzIsSpecificationLocked && .pyProductName == Application.pyProductName","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_12( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxpzIsSpecificationLocked o2== rx.pyProductName rxApplication.pyProductName",pxUniqueStreamHash+"_41");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_41");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzIsSpecificationLocked && .pyProductName == Application.pyProductName");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Rule-Application-UseCase");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_41");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxpzIsSpecificationLocked o2== rx.pyProductName rxApplication.pyProductName", pxUniqueStreamHash+"_41"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_5();
 tools.putSaveValue("ContainerID", "");}
...
public int simpleLayoutCell_15( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-right-spacing float-right set-width-auto   '  STRING_TYPE='layout' RESERVE_SPACE='false'><div class='content-inner set-width-auto'>");
	sectionDefaultValues_1();pzLayout_6();
 tools.putSaveValue("ContainerID", "");tools.appendString("</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_15( int index) {
	...
	pgCells.put("pyType","layout");
	pgCells.put("RWActive","false");
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing remove-right-spacing float-right set-width-auto");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
...
pzSection.getLayout().setExpandParam("SubSectionpzSpecificationQuickViewB","",false);
}
...
public void simpleLayout_5() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + " content  auto-width-column layout-content-inline_middle content-inline_middle " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpzSpecificationQuickViewB";
	metadataPage.put("paramName", paramName);
...
static {
	oPropDefinitions_1.put("Rule-Application-UseCase.pyTemplateInputBox", new LiteweightPropertyDefinition("Rule-Application-UseCase", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzSpecificationQuickView");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-APPLICATION-USECASE PZSPECIFICATIONQUICKVIEW #20180713T140901.070 GMT", "Rule-Application-UseCase pzSpecificationQuickView", "Pega-ProcessArchitect", "08-01-01", "20180713T140901.070 GMT");
}
