...
/**
 * Builds JSP stream EMBED-STAGEPROCESS!PYPROCESSSLACONFIGWRAPPER.
 */
public class ra_stream_pyprocessslaconfigwrapper_e25290e59b423f4e382474196cf0f069 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyProcessSLAConfigWrapper.Embed_StageProcess.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1224335013;
 ...
 */
	public ra_stream_pyprocessslaconfigwrapper_e25290e59b423f4e382474196cf0f069(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "f21ca2f036dfbb179f2be18996be25c088750be0";
...
{
/* Instance RULE-HTML-SECTION EMBED-STAGEPROCESS PYPROCESSSLACONFIGWRAPPER #20181219T124740.751 GMT	Pega-ProcessArchitect:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "f21ca2f036dfbb179f2be18996be25c088750be0";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyProcessSLAConfigWrapper",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-STAGEPROCESS PYPROCESSSLACONFIGWRAPPER #20181219T124740.751 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-STAGEPROCESS PYPROCESSSLACONFIGWRAPPER #20181219T124740.751 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-STAGEPROCESS PYPROCESSSLACONFIGWRAPPER #20181219T124740.751 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYPROCESSSLACONFIGWRAPPER", 
	"Rule-Obj-Property:PYSLATYPE", 
	"Rule-Obj-Property:PYSTEPSLA", 
	"Rule-Obj-Property:PYSTEPSLA", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYPROCESSSLACONFIGWRAPPER","Rule-HTML-Section","EMBED-STAGEPROCESS",false,"","Pega-ProcessArchitect","08-03-01","RULE-HTML-SECTION EMBED-STAGEPROCESS PYPROCESSSLACONFIGWRAPPER #20181219T124740.751 GMT","!PYPROCESSSLACONFIGWRAPPER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1224335013), 
		new DependentRuleInfo("PYSLATYPE","Rule-Obj-Property","@BASECLASS",true,"Embed-StageProcess","Pega-ProcessArchitect","08-02-01","RULE-OBJ-PROPERTY @BASECLASS PYSLATYPE #20181015T143007.696 GMT","!PYSLATYPE",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYSTEPSLA","Rule-Obj-Property","EMBED-STAGEPROCESS",false,"","Pega-ProcessEngine","08-01-01","RULE-OBJ-PROPERTY EMBED-STAGEPROCESS PYSTEPSLA #20180713T132912.230 GMT","!PYSTEPSLA",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
		new DependentRuleInfo("PYSTEPSLA","Rule-Obj-Property","EMBED-STAGEPROCESS",true,"Embed-StageProcess","Pega-ProcessEngine","08-01-01","RULE-OBJ-PROPERTY EMBED-STAGEPROCESS PYSTEPSLA #20180713T132912.230 GMT","!PYSTEPSLA",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-HTML-SECTION EMBED-STAGEPROCESS PYPROCESSSLACONFIGWRAPPER #20181219T124740.751 GMT:20190503T124411.172 GMT
//	RULE-HTML-PROPERTY PXDROPDOWN #20191010T062311.436 GMT:20191010T062311.436 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYSLATYPE #20181015T143007.696 GMT:20181015T143007.696 GMT
//	RULE-OBJ-PROPERTY EMBED-STAGEPROCESS PYSTEPSLA #20180713T132912.230 GMT:20180713T132912.230 GMT
//	RULE-OBJ-PROPERTY EMBED-STAGEPROCESS PYSTEPSLA #20180713T132912.230 GMT:20180713T132912.230 GMT
//	RULE-OBJ-PROPERTY EMBED-STAGEPROCESS PYSTEPSLA #20180713T132912.230 GMT:20180713T132912.230 GMT
//	RULE-OBJ-PROPERTY EMBED-STAGEPROCESS PYSTEPSLA #20180713T132912.230 GMT:20180713T132912.230 GMT
//	RULE-HTML-PROPERTY PXDROPDOWN #20191010T062311.436 GMT:20191010T062311.436 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "edde1e73aec3bc9ccab8ca6f994f9c79";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyProcessSLAConfigWrapper",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyProcessSLAConfigWrapper','insKey':'RULE-HTML-SECTION EMBED-STAGEPROCESS PYPROCESSSLACONFIGWRAPPER #20181219T124740.751 GMT','sectionType':'standard'}");
...
getControlMarkup_1() {
try {
if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pySLAType").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
	pzAuto.getUIComponentRuntime().setTemplatingUIStatus('Y');
}pxDropdown_1(".pySLAType",0,"","","Text");pzAuto.getUIComponentRuntime().insertTemplateScripts();}
else if(tools.getParamValue("pyPropertyTarget").equals(tools.getStepPage().getProperty(".pyStepSLA").getEntryHandle())){if(tools.getParamValue("UITemplatingStatus").equals("Y")) {
	pzAuto.getUIComponentRuntime().setTemplatingUIStatus('Y');
}pxDropdown_2(".pyStepSLA",0,"","","Text");pzAuto.getUIComponentRuntime().insertTemplateScripts();}
} catch(Throwable t) {
...
public void buildSection_4() { 
	...
	secParams.put("sectionName","pzDisplayProcessConfiguration");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_83","pzEnableDisableProxySection", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	tools.putParamValue("sectionName","pzDisplayProcessConfiguration");tools.putParamValue("section_params","");
	
	String includedSectionName = "";includedSectionName = "pzEnableDisableProxySection";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_12() {
pzSection.getLayout().setExpandParam("SubSectionpyProcessSLAConfigWrapperBBBBBBBBBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpyProcessSLAConfigWrapperBBBBBBBBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(5)','clipboardPath':'pzEnableDisableProxySection'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(5)','clipboardPath':'pzEnableDisableProxySection'}") + ">");
}
pzSetExpandParam_12();
...
public void buildSection_3() { 
	Map<String, Object> secInfo = new HashMap<String, Object>();
	secInfo.put("usingPage",".pySLAPage");
	secInfo.put("isUsingPagePropertyRef",false);
	secInfo.put("doNotConsiderDecParams",false);
	secInfo.put("keepStreamProperties",false);
	secInfo.put("preserveParamState",false);
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_81","pyConfigSLA", secInfo);
}
...
config.put("pyPreDataTransform.pyName", "pzSetSLAConfigProperties");
config.put("pyActivity", "pzClearSLAErrorMessages");
pega.getUIEngine().getUIAction("refresh", config).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.cd.setDirtyOverride");
...
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("pxObjClass", "Rule-Obj-ServiceLevel");
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pyConfigSLA";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,".pySLAPage",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_11() {
pzSection.getLayout().setExpandParam("SubSectionpyProcessSLAConfigWrapperBBBBBBBBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpyProcessSLAConfigWrapperBBBBBBBBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(4)','clipboardPath':'pyConfigSLA'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& rx.pyConsiderSLA o2== rx.pySLAType cqCustom", pxUniqueStreamHash+"_82");metadataPage.put("isSectionIncl","true");
metadataPage.put("lMode","Inline-block");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& rx.pyConsiderSLA o2== rx.pySLAType cqCustom",".pyConsiderSLA && .pySLAType == \'Custom\'", "layout", "visible" )) {boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(4)','clipboardPath':'pyConfigSLA'}") + ">");
}
pzSetExpandParam_11();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void buildSection_2() { 
	...
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_79","pxDiscoverGadget", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpyProcessSLAConfigWrapper37","",false);
}
...
public void buildSection_1() { 
	...
	secParams.put("DarkBackground","false");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_76","pxDiscoverGadget", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionpyProcessSLAConfigWrapperBBBBBBBBB","",false);
}
...
public void simpleLayout_9() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201811201236190467387") + " ");
	...
	String paramName = "EXPANDEDSubSectionpyProcessSLAConfigWrapperBBBBBBBBB";
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2== rx.pySLAType cqCustom o2!= rx.pySLAPage.pzInsKey cq", pxUniqueStreamHash+"_80");metadataPage.put("lMode","SimpleDiv");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& o2== rx.pySLAType cqCustom o2!= rx.pySLAPage.pzInsKey cq",".pySLAType == \'Custom\' && .pySLAPage.pzInsKey != \'\'", "layout", "visible" )) {pzSetExpandParam_9();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"openRuleByKey\",[\"Rule-Obj-ServiceLevel\",\"");
		...
		tools.appendString(XMLUtils.encodeString("pyServiceLevelName") + "=");
		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyStepSLA")+"~#");	tools.appendString("\",\"");

		tools.appendFormatted("4ff60558-0b33-47a2-b31c-42053838d777",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");

		tools.appendFormatted("",StreamBuilder.FMT_NORMAL);	tools.appendString("\"]");

		tools.appendString("]");isBehaviorAdded = true;
		tools.appendString("]' ");isBehaviorAdded = false;
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"openRuleByKey\",[\"Rule-Obj-ServiceLevel\",\"");
		...
		tools.appendFormatted("3e311b2a-789c-47ec-8781-bcd2a0b28425",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			...
			ct_controlAction.trackValueChanges(tools.getProperty(".pyStepSLA"), -1);
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pySLAType,.pySLAPage.pzInsKey\"  SHOW_WHEN=\".pySLAType == 'Custom' && .pySLAPage.pzInsKey != ''\"");
if(pzAuto.evaluateWhen(".pySLAType == 'Custom' && .pySLAPage.pzInsKey != ''",null,true)){
	if(currentTemplatingStatus =='N')
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pySLAType", -1);
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pySLAPage.pzInsKey", -1);
	}
}catch(Exception e){}
}
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20181010034501043681507",true));
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pyProcessSLAConfigWrapper_$CTX$_410");
		String repeatIndx = "";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Open SLA\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Open SLA", ".pyButtonLabel");
	}
	pyLabel = "Open SLA";
	...
	String spxUniqueStreamHash64 = getUIActionsMetaData_5();
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='pyProcessSLAConfigWrapper_"+ referenceString+ "_410'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20181010034501043681507") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendFormatted("52e0c928-4113-4311-a0a9-e2aa33839bb3",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");
		...
		tools.appendFormatted("1fe8676c-e6fa-4421-a182-0f761842d5ae",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Open SLA",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public int simpleLayoutTemplateCell_11( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pySLAType == 'Custom' && .pySLAPage.pzInsKey != ''", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20181010034501043681507-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxLink");
	pgCells.put("forLabel",".pyTemplateInputBox");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","padding-t-0_5x");
	pgCells.put("customRWStyles","padding-t-0_5x");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_3();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyProcessSLAConfigWrapperBBBBBBBB","",false);
}
...
public void simpleLayout_6() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20181010035445060985") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  layout-content-stacked content-stacked " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(StringUtils.isBlank(expressionId)) {
			...
			expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pyStepSLA !=''",expressionId);
		...
		String paramName = "EXPANDEDSubSectionpyProcessSLAConfigWrapperBBBBBBBB";
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pyStepSLA\"  SHOW_WHEN=\".pyStepSLA !=''\"");
if(pzAuto.evaluateWhen(".pyStepSLA !=''",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
		changeTracker.trackValueChanges(tools.getStepPage().getReference()+".pyStepSLA", -1);
	}
}catch(Exception e){}
}
...
pzSection.getLayout().setExpandParam("SubSectionpyProcessSLAConfigWrapperBBBBBBB","",false);
}
...
public void simpleLayout_7() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201810091034160052649") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(4).pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpyProcessSLAConfigWrapperBBBBBBB";
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpzIsPegaExpress", pxUniqueStreamHash+"_72");metadataPage.put("dlChild","true");
	metadataPage.put("lMode","SimpleDiv");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpzIsPegaExpress","!pzIsPegaExpress", "layout", "visible" )) {pzSetExpandParam_7();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
try {
	...
	modePage2.put("pyName","pyProcessSLAConfigWrapper_$CTX$_405");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","pyOpenRuleInDevStudio\t SLA\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("pyOpenRuleInDevStudio\t SLA", ".pyButtonLabel");
	}
	pyLabel = "pyOpenRuleInDevStudio\t SLA";
	modePage2.put("pyLabel",pyLabel);
	modePage2.put("captionType","text");
	if(expressionId !=null && expressionId.length() > 0){
	modePage2.put("pyExpressionId",expressionId);
	...
	String pyFormatValue = "";
	modePage2.put("pyFormatValue",pyFormatValue);
	String spxUniqueStreamHash49 = getUIActionsMetaData_4();
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyProcessSLAConfigWrapper_"+ referenceString+ "_405'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20181010034501043681507") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.wks.openRule(\\\"Developer\\\",\\\"Rule-Obj-ServiceLevel\\\",");
	String strPropReference23 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyStepSLA")+"~#";
	...
	tools.appendString(",\\\"true\\\")\"]");
		...
		tools.appendString("]");isBehaviorAdded = true;
		tools.appendString("]' ");isBehaviorAdded = false;
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.wks.openRule(\\\"Developer\\\",\\\"Rule-Obj-ServiceLevel\\\",");
	String strPropReference43 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyStepSLA")+"~#";
	...
	tools.appendString(",\\\"true\\\")\"]");
		...
		String classProp = "";
		 classProp ="pi pi-open";
		boolean hasLineBreaks = false;
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","pyOpenRuleInDevStudio\t SLA",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
		tools.appendString(" <i aria-hidden='true'  data-keyboard='.' data-click='.' class='" + classProp  +"'></i>");
		tools.appendString("</a>");}
...
try {
	...
	modePage2.put("pyName","pyProcessSLAConfigWrapper_$CTX$_404");
		String repeatIndx = "";
	modePage2.put("styles","");
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
	...
	String pyFormatValue = "";
	modePage2.put("pyFormatValue",pyFormatValue);
	String spxUniqueStreamHash44 = getUIActionsMetaData_4();
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pyProcessSLAConfigWrapper_"+ referenceString+ "_404'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20181010034501043681507") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
public int simpleLayoutCell_7( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","padding-t-0_5x","padding-t-0_5x")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_1();labelName = "";
...
public int simpleLayoutCell_8( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + "    " + pzSection.getCustomStyle(false, "","padding-t-0_5x","padding-t-0_5x")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("showWhen",  ".pySLAType == 'Use existing'", expressionId);
	if(expression != null) { expressionId = expression.getId(); }
	 String pyCustomRequireFormat= "";
	pyCustomRequireFormat=  tools.getLocalizedTextForString("pyCaption","pyRequired");
	String dataFieldValueMeta = pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData();
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxLink_2();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyProcessSLAConfigWrapperBBBBBB","",false);
}
...
public void simpleLayout_4() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  layout-content-stacked content-stacked " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		String paramName = "EXPANDEDSubSectionpyProcessSLAConfigWrapperBBBBBB";
...
pzSection.getLayout().setExpandParam("SubSectionpyProcessSLAConfigWrapperBBBBB","",false);
}
...
public void simpleLayout_5() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(3).pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpyProcessSLAConfigWrapperBBBBB";
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& wxpzIsPegaExpress wxpxUserHasDeveloperPortalAccess", pxUniqueStreamHash+"_57");metadataPage.put("dlChild","true");
	metadataPage.put("lMode","SimpleDiv");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2&& wxpzIsPegaExpress wxpxUserHasDeveloperPortalAccess","pzIsPegaExpress && pxUserHasDeveloperPortalAccess", "layout", "visible" )) {pzSetExpandParam_5();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public void inclFormattedVal_3(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {if (isSecuredProp) { tools.putParamValue("proSecurity_isSecuredProp", isSecuredProp);tools.putParamValue("proSecurity_activePropValue", activePropValue);}
		...
		tools.appendString(pega_uiengine_formatter.pxFormatText(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzGetRelRecordList","","","D_pzGetRelRecordList:ClassName$CaseTypeStages.pyClassName~RecordType$Rule-Obj-ServiceLevel",".pyLabel",".pyRuleName",true,(PegaStreamAPI)tools),false,"","",true,"caption"));
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzGetRelRecordList","","","D_pzGetRelRecordList:ClassName$CaseTypeStages.pyClassName~RecordType$Rule-Obj-ServiceLevel",".pyLabel",".pyRuleName",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("isControlEditableOriginal"))) {
		...
		if("".equals(pega_uiengine_pzcontrol.pzGetCaptionValue("datapage","null","D_pzGetRelRecordList","","","D_pzGetRelRecordList:ClassName$CaseTypeStages.pyClassName~RecordType$Rule-Obj-ServiceLevel",".pyLabel",".pyRuleName",true,(PegaStreamAPI)tools)) && !"true".equals(tools.getParamValue("FORMAT_PLAIN_TXT")) && ((pzAuto.getBrowserUtils().isIE() && !pega_uiengine_harness.pzInStandardsMode()) || "true".equals(tools.getParamValue("fromAPI"))) ){
			tools.appendString("&nbsp;");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-change='[");if(isBehaviorAdded && true){ tools.appendString(","); }{String strStreamName="";String strPropertyTarget ="";String strPageName ="";strStreamName="pyProcessSLAConfigWrapper";if(tools.getPrimaryPage() != null){ strPageName = tools.getPrimaryPage().getName();}if(tools.getActive() != null){strPropertyTarget = tools.getActive().getEntryHandle();}com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();actionRequest.registerFixedParameter("pyActivity", "ReloadCell"); actionRequest.registerFixedParameter("pyPropertyTarget", strPropertyTarget ); actionRequest.registerFixedParameter("StreamName", strStreamName); actionRequest.registerFixedParameter("pzPrimaryPageName", strPageName); pzAuto.registerActionRequest(actionRequest);}	tools.appendString("[\"postValue\",[\":event\"]");
...
tools.appendString("</P>");
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20181010025519070281612",true));
	cellPage.put("pyValue",".pyStepSLA");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyStepSLA");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyStepSLA", ".pyCaption");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyStepSLA",pxUniqueStreamHash+"_24");
	...
	modePage1.put("pyResultsUniqueID",pxUniqueStreamHash+"_25");
	tools.putParamValue("ClassName", 
	tools.getProperty("CaseTypeStages.pyClassName").getStringValue()
	);
	tools.putParamValue("RecordType", 
	"Rule-Obj-ServiceLevel"
	);
	Map<String, String> sourceDPParams = new HashMap<String, String>();
	sourceDPParams.put("ClassName", "CaseTypeStages.pyClassName");
	sourceDPParams.put("RecordType", "Rule-Obj-ServiceLevel");
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
	tools.findPage("D_pzGetRelRecordList");
	}
	tools.putParamValue("bListOptionsLocalize","true");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadDataPage("D_pzGetRelRecordList", listProperties, pxUniqueStreamHash+"_25", sourceDPParams);
	...
	pyDataPageParams.put("pyValue","#~"+pzAuto.getUIComponentRuntime().generateActionToken("CaseTypeStages.pyClassName")+"~#");
	pyDataPage.addMetadataInArray("pyDataPageParams",pyDataPageParams);
	pyDataPageParams = pzAuto.getUIComponentRuntime().createMetadata();  
	pyDataPageParams.put("pyName","RecordType");
	pyDataPageParams.put("pyValue","Rule-Obj-ServiceLevel");
	pyDataPage.addMetadataInArray("pyDataPageParams",pyDataPageParams);
	...
	try{
		if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){ 
			com.pega.pegarules.priv.runtime.IStreamChangeTracker changeTracker = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			changeTracker.trackValueChanges("CaseTypeStages.pyClassName", -1);
		}
		 ...
		 expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("cellRefreshWhen",  "CaseTypeStages.pyClassName Changes", expressionId);
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_29");}if(beginNonTemplate){			HashStringMap params = new HashStringMap();
	...
	pageName = tools.getStepPage().getName()+pageName;
			...
			tools.appendString("<div id='CT'  RCW = '.pyClassName' RC = 'CaseTypeStages.pyClassName Changes' CellId = '399");
	...
	if(tools.getThread().getName().indexOf("/$WorkProcessing") != -1 || tools.getThread().getName().indexOf("/$FlowModalProcess") != -1 ) {
			...
			try{
				if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
					...
					cellChangeTracker.trackValueChanges("CaseTypeStages.pyClassName", -1);
				}
			}catch(Exception e){}
		...
		String strActiveValue = isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true);			String strValue = isSecuredProp ? activePropValue : tools.getProperty(ddPropRef).getStringValue();
			...
			if(!isAccessible) {
				...
				tools.appendString(" " + pzCell.getTestIdIfEnabled("20181010025519070281612") + " ");
...
tools.appendString(" data-bindprops='value' ");} else{			tools.appendString(ddPropEntryHandle);
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("20181010025519070281612") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20181010025519070281612-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDropdown");
	pgCells.put("forLabel",".pyStepSLA");
	pgCells.put("pyAutoHTML","true");
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzAppendStepSLARule",pxUniqueStreamHash+"_32");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_32");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pzAppendStepSLARule");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzAppendStepSLARule", pxUniqueStreamHash+"_32"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxDropdown",".pyStepSLA",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDropdown_2(".pyStepSLA",0,"","","Text");}
	if (!isExpression && isOffline) {
	// do nothing
	} else {
...
pzSection.getLayout().setExpandParam("SubSectionpyProcessSLAConfigWrapperBBBB","",false);
}
...
public void simpleLayout_2() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1)'}") + " class='" + "flex  content  layout-content-stacked content-stacked " + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpyProcessSLAConfigWrapperBBBB";
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzIsPegaExpress", pxUniqueStreamHash+"_33");metadataPage.put("dlChild","true");
	metadataPage.put("lMode","SimpleDiv");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (_jspx_meth_pega_param__1(pageContext, "TextBoxTooltip", "Select service level agreement")) {
	return true;
}
...
if (_jspx_meth_pega_param__1(pageContext, "Class", "Rule-Obj-ServiceLevel")) {
	return true;
}
...
getActionsForCustomControls_1() {
	...
	String currentStream = tools.getCurrentStream();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-change='[");if(isBehaviorAdded && true){ tools.appendString(","); }{String strStreamName="";String strPropertyTarget ="";String strPageName ="";strStreamName="pyProcessSLAConfigWrapper";if(tools.getPrimaryPage() != null){ strPageName = tools.getPrimaryPage().getName();}if(tools.getActive() != null){strPropertyTarget = tools.getActive().getEntryHandle();}Map<String, String> config = new HashMap<String, String>();config.put("pyActivity", "pzRunActionWrapper");config.put("pzActivity", "ReloadCell");config.put("StreamName", strStreamName);config.put("pyPropertyTarget", strPropertyTarget ); config.put("pySubAction","runAct");config.put("inStandardsMode","true");pega.getUIEngine().getUIAction("runActivity", config).register();com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();actionRequest.registerFixedParameter("pyActivity", "ReloadCell"); actionRequest.registerFixedParameter("pyPropertyTarget", strPropertyTarget ); actionRequest.registerFixedParameter("StreamName", strStreamName); actionRequest.registerFixedParameter("pzPrimaryPageName", strPageName); pzAuto.registerActionRequest(actionRequest);}	tools.appendString("[\"postValue\",[\":event\"]");
 ...
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyStepSLA", "input", "OpenRuleAdvanced")) {
	return;
}
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201511091357390500577951-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxpzIsPegaExpress",pxUniqueStreamHash+"_19");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpzIsPegaExpress", pxUniqueStreamHash+"_19"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyStepSLA",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpzIsPegaExpress",pxUniqueStreamHash+"_35");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpzIsPegaExpress", pxUniqueStreamHash+"_35"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_2();
 tools.putSaveValue("ContainerID", "");}
...
pzSection.getLayout().setExpandParam("SubSectionpyProcessSLAConfigWrapperBBB","",false);
}
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		String paramName = "EXPANDEDSubSectionpyProcessSLAConfigWrapperBBB";
...
if(currentTemplatingStatus =='N')
tools.appendString(" SWP=\".pySLAType\"  SHOW_WHEN=\".pySLAType == 'Use existing'\"");
if(pzAuto.evaluateWhen(".pySLAType == 'Use existing'",null,true)){
	if(currentTemplatingStatus =='N')
	tools.appendString(" style=' ");
	else
	clientWhenAttr += "style= '";
	...
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }		{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
			com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
				...
				if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
					try{
						pzPackageRuntime.packageSection("pyProcessSLAConfigWrapper",
						...
						refreshActionRequest.registerFixedParameter("PreActivity", "pzClearSLAErrorMessages");
						staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
						staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pyProcessSLAConfigWrapper"));
						staticURLStr.append("&PreActivity=pzClearSLAErrorMessages");
						staticURLStr.append("&PreDataTransform=pzSetSLAConfigProperties");
						tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"pzClearSLAErrorMessages\", \"");
						refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
						tools.appendString("=\", \"\", \"pzSetSLAConfigProperties,");
						refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
						...
						if(!"".equals(preActParamStr.toString())) {
							...
							if(!"".equals(preDTParamStr.toString())) {
								...
								if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
								pzPackageRuntime.packageDataTransform(tools.getStepPage().getString("pxObjClass"), "pzSetSLAConfigProperties");
								}
								pzAuto.registerActionRequest(refreshActionRequest);}

		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }								tools.appendString("[\"runScript\", [\"pega.cd.setDirtyOverride()\"]");
...
tools.appendString("</P>");
	...
	String repeatIndx = "";
	IUIComponentMetadata pyUserData = pzAuto.getUIComponentRuntime().createMetadata();
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("201511091357390499576649",true));
	cellPage.put("pyValue",".pySLAType");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pySLAType");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pySLAType", ".pyCaption");
	String pyHelperTextType="";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyHelperTextType","none\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
	...
	String ddPropRef = tools.getActive().getReference();
	String clientValidationAttributes = pzAuto.getCell().getClientValidationAttributes(pyOnInput, pyEditValidate, pyStringType,pegaValidation.toString());
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pySLAType",pxUniqueStreamHash+"_8");
	IUIComponentMetadata pxErrorIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
	modePage1.putMetadata("pxErrorIdentifiers",pxErrorIdentifiers);
	pxErrorIdentifiers.put("pyErrorId",pxUniqueStreamHash+"_8");
	modePage1.put("clintValidAttrs",clientValidationAttributes);
	modePage1.put("pyID","pySLAType");
	modePage1.put("pyControlLoadMode","auto");
	String strPropName= tools.getActive().getName();
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();boolean beginNonTemplate = true;if(bOptimizedMarkup){beginNonTemplate = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_11");}if(beginNonTemplate){			HashStringMap params = new HashStringMap();
		...
		String strActiveValue = isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true);			String strValue = isSecuredProp ? activePropValue : tools.getProperty(ddPropRef).getStringValue();
			...
			if(!isAccessible) {
				tools.appendString("<select data-ctl='[\"Dropdown\"]' ");
				tools.appendString(" " + pzCell.getTestIdIfEnabled("201511091357390499576649") + " ");
				tools.appendString(styleAttribute + disabled_ctrl + " id='");
				tools.appendString(tools.getHTMLIDForProperty(true,"dropdown"));
			tools.appendString("'");
			} else {
...
tools.appendString(" data-bindprops='value' ");			tools.appendString(" data-bindDefaultValue='Never'");
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("201511091357390499576649") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
...
if(pegaValidation != null) {
	...
	tools.putActive(propActivePrev); 							} catch (Exception e) {
	 ...
	 if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'							&& pzAuto.getUIComponentRuntime().getRuntimeContextTree().isLiveDesignViewMode()){
		...
		IUIComponentMetadata metadata = pzAuto.getUIComponentRuntime().createMetadata();
		IUIComponent ctrlComponent = pzAuto.getUIComponent();
		metadata.put("cellInfo", "pyUseServiceLevelAgreement");
		metadata.put("msgText", "config issue");
		ctrlComponent.addDependentScripts("pzpega_ui_template_designview.js");
		ctrlComponent.beginComponent("pxDesignViewError", metadata);
		tools.putParamValue("isControlEditableOriginal", true);
...
public int simpleLayoutCell_2( int index) {
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("201511091357390499576649-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
	
	ClipboardProperty propActivePrev = tools.getActive();
	tools.putActive(tools.getStepPage().getProperty(".pySLAType"));
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","pyUseServiceLevelAgreement") + "</span>");
	tools.putParamValue("pzIsCellReadOnly","false");
	}else {
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("201511091357390499576649-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","pyUseServiceLevelAgreement") + "</label>");
}
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");pxDropdown_1(".pySLAType",0,"","","Text");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201511091357390499576649-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxDropdown");
	pgCells.put("forLabel",".pySLAType");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("pyGenerateUniqueIdForLabel","false");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxDropdown",".pySLAType",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxDropdown_1(".pySLAType",0,"","","Text");labelName = "pyUseServiceLevelAgreement";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
public int simpleLayoutTemplateCell_10( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2&& wxpzIsPegaExpress wxpxUserHasDeveloperPortalAccess",pxUniqueStreamHash+"_59");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2&& wxpzIsPegaExpress wxpxUserHasDeveloperPortalAccess", pxUniqueStreamHash+"_59"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_5();
 tools.putSaveValue("ContainerID", "");}
...
public int simpleLayoutTemplateCell_13( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o1! wxpzIsPegaExpress",pxUniqueStreamHash+"_74");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o1! wxpzIsPegaExpress", pxUniqueStreamHash+"_74"); 
	}
	if(pyDLCellVisibility) {
	pzLayout_7();
 tools.putSaveValue("ContainerID", "");}
...
pzSection.getLayout().setExpandParam("SubSectionpyProcessSLAConfigWrapperBB","",false);
}
...
public void simpleLayout_8() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805240252560147374") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
	...
	String paramName = "EXPANDEDSubSectionpyProcessSLAConfigWrapperBB";
	metadataPage.put("paramName", paramName);
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("20141209060430029152775")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","CompletionTimesForThisProcess") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","flex flex-row");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20141209060430029152775")).append(" ").toString().replace("data-test-id=","").trim());
	...
	labelName = "CompletionTimesForThisProcess";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionpyProcessSLAConfigWrapperB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805240252560146828") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
	...
	String paramName = "EXPANDEDSubSectionpyProcessSLAConfigWrapperB";
...
sectionDefaultValues_1() {
	...
	if(pzAuto.handleEvaluateWhen(" o2== rx.pySLAType cq",".pySLAType", "cell", "active" )) {
		 tools.getProperty(".pySLAType").setValue("Never");if (pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'){String tempDefault=tools.getProperty(".pySLAType").toString();
		 tools.getProperty(".pySLAType").setValue("");pzAuto.getUIComponentRuntime().getRuntimeContextTree().addDefaultValue(".pySLAType",tempDefault);}
}
...
static {
	oPropDefinitions_1.put("Embed-StageProcess.pyStepSLA", new LiteweightPropertyDefinition("Embed-StageProcess", "pyStepSLA", "sTN", false, true, "OpenRuleAdvanced", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-STAGEPROCESS PYPROCESSSLACONFIGWRAPPER #20181219T124740.751 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyProcessSLAConfigWrapper");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-STAGEPROCESS PYPROCESSSLACONFIGWRAPPER #20181219T124740.751 GMT", "Embed-StageProcess pyProcessSLAConfigWrapper", "Pega-ProcessArchitect", "08-03-01", "20190503T124411.172 GMT");
}
