...
/**
 * Builds JSP stream EMBED-STAGEPROCESS!PYOVERLAYTEMPLATE.
 */
public class ra_stream_pyoverlaytemplate_25177abfd8bc188e237d38c4cda83d8c extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyOverlayTemplate.Embed_StageProcess.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1698846326;
 ...
 */
	public ra_stream_pyoverlaytemplate_25177abfd8bc188e237d38c4cda83d8c(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "dc484f11a4ebf9dda30085387a51963f38597776";
...
{
/* Instance RULE-HTML-SECTION EMBED-STAGEPROCESS PYOVERLAYTEMPLATE #20180713T134807.036 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "dc484f11a4ebf9dda30085387a51963f38597776";
...
/*
 * Begin RULE-HTML-SECTION EMBED-STAGEPROCESS PYOVERLAYTEMPLATE #20180713T134807.036 GMT
 * Set up context.
 */
final String prevRuleKey_4 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-STAGEPROCESS PYOVERLAYTEMPLATE #20180713T134807.036 GMT";final String prevClass_4 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-STAGEPROCESS PYOVERLAYTEMPLATE #20180713T134807.036 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYOVERLAYTEMPLATE","Rule-HTML-Section","EMBED-STAGEPROCESS",false,"","Pega-EndUserUI","08-01-01","RULE-HTML-SECTION EMBED-STAGEPROCESS PYOVERLAYTEMPLATE #20180713T134807.036 GMT","!PYOVERLAYTEMPLATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1698846326), 
...
//	RULE-HTML-SECTION EMBED-STAGEPROCESS PYOVERLAYTEMPLATE #20180713T134807.036 GMT:20180713T134807.036 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "2ab03199aa7e38d9efe16ca16b1f82ef";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyOverlayTemplate",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyOverlayTemplate','insKey':'RULE-HTML-SECTION EMBED-STAGEPROCESS PYOVERLAYTEMPLATE #20180713T134807.036 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_5();
...
params_4.putString("bLocalize", "false");
	...
	if (currentProperty_4 != null && currentProperty_4.getParentPage().getClassName().equals("Embed-StageProcess")) {
...
property_Embed_StageProcess_pzOverlayButton();
...
params_3.putString("bLocalize", "false");
	...
	if (currentProperty_3 != null && currentProperty_3.getParentPage().getClassName().equals("Embed-StageProcess")) {
...
params_2.putString("bLocalize", "false");
	...
	if (currentProperty_2 != null && currentProperty_2.getParentPage().getClassName().equals("Embed-StageProcess")) {
...
/**
 * Generates stream property_Embed_StageProcess_ClientValidation
 */
private void property_Embed_StageProcess_ClientValidation() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_1() {
	...
	try {
property_Embed_StageProcess_ClientValidation();
	} finally {
...
/**
 * Generates stream property_Embed_StageProcess_Button
 */
private void property_Embed_StageProcess_Button() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_2() {
	final Map streamProperties = pega.getStreamProperties();
	try {
property_Embed_StageProcess_Button();
...
/**
 * Generates stream property_Embed_StageProcess_pzOverlayButton
 */
private void property_Embed_StageProcess_pzOverlayButton() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
params_1.putString("bLocalize", "false");
	...
	if (currentProperty_1 != null && currentProperty_1.getParentPage().getClassName().equals("Embed-StageProcess")) {
...
public void simpleLayout_2() {
	...
	String pyPrefix = null;
	metadataPage.put("sectionIndex","28");
	IUIComponent containerComponent = pzAuto.getUIComponent();
	metadataPage.put("dlChild","true");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
	pzLayoutBody_2();
...
pzSection.getLayout().setExpandParam("SubSectionCellpyOverlayTemplate247","",false);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzModalAction",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + "   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
static {
	oPropDefinitions_4.put("Embed-StageProcess.pyTemplateInputBox", new LiteweightPropertyDefinition("Embed-StageProcess", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_4.put("pyClassName", "Embed-StageProcess");
	oStreamProperties_4.put("pyCircumstanceProp", "");
	oStreamProperties_4.put("pzInsKey", "RULE-HTML-SECTION EMBED-STAGEPROCESS PYOVERLAYTEMPLATE #20180713T134807.036 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-STAGEPROCESS PYOVERLAYTEMPLATE #20180713T134807.036 GMT", "Embed-StageProcess pyOverlayTemplate", "Pega-EndUserUI", "08-01-01", "20180713T134807.036 GMT");
