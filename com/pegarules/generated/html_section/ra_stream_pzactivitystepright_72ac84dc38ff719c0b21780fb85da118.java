...
/**
 * Builds JSP stream EMBED-ACTIVITYSTEPS!PZACTIVITYSTEPRIGHT.
 */
public class ra_stream_pzactivitystepright_72ac84dc38ff719c0b21780fb85da118 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzActivityStepRight.Embed_ActivitySteps.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 2102764268;
 ...
 */
	public ra_stream_pzactivitystepright_72ac84dc38ff719c0b21780fb85da118(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "96c635c153461ad48eecab6714697cdfae3a6992";
...
{
/* Instance RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZACTIVITYSTEPRIGHT #20181004T152057.424 GMT	Pega-Desktop:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "96c635c153461ad48eecab6714697cdfae3a6992";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzActivityStepRight",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZACTIVITYSTEPRIGHT #20181004T152057.424 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZACTIVITYSTEPRIGHT #20181004T152057.424 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZACTIVITYSTEPRIGHT #20181004T152057.424 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZACTIVITYSTEPRIGHT", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZACTIVITYSTEPRIGHT","Rule-HTML-Section","EMBED-ACTIVITYSTEPS",false,"","Pega-Desktop","08-02-01","RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZACTIVITYSTEPRIGHT #20181004T152057.424 GMT","!PZACTIVITYSTEPRIGHT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",2102764268), 
...
//	RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZACTIVITYSTEPRIGHT #20181004T152057.424 GMT:20181004T152057.424 GMT
...
//	RULE-UTILITY-FUNCTION UIENGINE PZGETANIMATIONSJSONSTRING--(CLIPBOARDPAGE) #20190417T070159.744 GMT:20190430T131934.330 GMT
	...
	public static String getFUAContentHash() {
		return "6717136bdc363ef644af077aae1e943e";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzActivityStepRight",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzActivityStepRight','insKey':'RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZACTIVITYSTEPRIGHT #20181004T152057.424 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("NewTaskStatus", "pzTransition");
...
pega.getUIEngine().getUIAction("localAction", config).register();
config = new HashMap<String, String>();
config.put("pySectionName", "pzActivityStepRight");
config.put("pySectionClass", "Embed-ActivitySteps");
...
try {
	...
	cellPage.put("pyStreamName","pzActivityStepRight");
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20140922152225011720216") + " ");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzActivityStepRight_"+ referenceString+ "_3'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		String classProp = "";
		 classProp ="pi pi-trash pi-link";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("20140922152225011720216") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20140922152225011619612") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","pzActivityStepRight_$CTX$_2");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Open transition step\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Open transition step", ".pyActionPrompt");
	}
	pyTooltip = "Open transition step";
	...
	String pyLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyButtonLabel","Jump\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Jump", ".pyButtonLabel");
	}
	pyLabel = "Jump";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzActivityStepRight_"+ referenceString+ "_2'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20140922152225011619612") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		keyMap.putString("pyActionName", "pzTransition");
		...
		try{
		pzPackageRuntime.packageLocalAction("pzTransition", offlineUsingPage , strLAClassName);
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("pzActivityStepRight",
				...
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pzTransition\",\"overlay\",\":event\",\"\",\""+streamType+"\",\"pz-po-c-fluid\",\"\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-bottom%22%7D%2C%22isCustomDismiss%22%3A%22false%22%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
					} else {
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Open transition step\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
		...
		boolean hasLineBreaks = false;
		 hasLineBreaks ="Jump".matches("(.*)<([Bb][Rr])\\s*\\/*\\s*>(.*)");
		if(hasLineBreaks) {
		tools.appendString("<span class='pzbtn-label'  data-click='.' ");}if(bOptimizedMarkup && hasLineBreaks){
		tools.appendString("  data-bindprops='title,innerHTML' ");}
		if(hasLineBreaks) {
		tools.appendString("  > "); }
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Jump",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
try {
	...
	modePage2.put("pyName","pzActivityStepRight_$CTX$_1");
		String repeatIndx = "";
	String pyTooltip = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Open transition step\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzActivityStepRight_"+ referenceString+ "_1'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20140922152225011619612") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2!= rx.pyStepsTransition cqTRUE",".pyStepsTransition != \'TRUE\'","cell", "visible" )) {
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140922152225011619612-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pyStepsTransition cqTRUE",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_6");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyStepsTransition != 'TRUE'");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pyStepsTransition cqTRUE", pxUniqueStreamHash+"_6"); 
	}
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" rx.pyStepsTransition",".pyStepsTransition","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" rx.pyStepsTransition",pxUniqueStreamHash+"_10");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_10");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyStepsTransition");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","Embed-ActivitySteps");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_10");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" rx.pyStepsTransition", pxUniqueStreamHash+"_10"); 
	}
	if(pyDLCellVisibility) {
...
public int simpleLayoutCell_3( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing remove-right-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20140922152225011720216-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
pzSection.getLayout().setExpandParam("SubSectionpzActivityStepRightB","",false);
}
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201805250947280614516") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzActivityStepRightB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZACTIVITYSTEPRIGHT #20181004T152057.424 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzActivityStepRight");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION EMBED-ACTIVITYSTEPS PZACTIVITYSTEPRIGHT #20181004T152057.424 GMT", "Embed-ActivitySteps pzActivityStepRight", "Pega-Desktop", "08-02-01", "20181004T152057.424 GMT");
}
