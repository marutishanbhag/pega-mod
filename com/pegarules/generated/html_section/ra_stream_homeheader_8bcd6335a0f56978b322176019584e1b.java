...
/**
 * Builds JSP stream DATA-PORTAL!HOMEHEADER.
 */
public class ra_stream_homeheader_8bcd6335a0f56978b322176019584e1b extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.HomeHeader.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1302102001;
 ...
 */
	public ra_stream_homeheader_8bcd6335a0f56978b322176019584e1b(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "5c1a52dd298a9ed79bf2484991587e1fa0b90732";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL HOMEHEADER #20210506T204027.445 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "5c1a52dd298a9ed79bf2484991587e1fa0b90732";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("HomeHeader",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL HOMEHEADER #20210506T204027.445 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL HOMEHEADER #20210506T204027.445 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL HOMEHEADER #20210506T204027.445 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PXPAGEHEADER", 
	"Rule-HTML-Section:HOMEHEADER"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXPAGEHEADER","Rule-HTML-Section","@BASECLASS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION @BASECLASS PXPAGEHEADER #20210506T204027.941 GMT","!PXPAGEHEADER",false,false,"MISSING",-596623190), 
		new DependentRuleInfo("HOMEHEADER","Rule-HTML-Section","DATA-PORTAL",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION DATA-PORTAL HOMEHEADER #20210506T204027.445 GMT","!HOMEHEADER",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1302102001)
	};
...
//	RULE-HTML-SECTION DATA-PORTAL HOMEHEADER #20210506T204027.445 GMT:20210506T204027.445 GMT
//	RULE-HTML-SECTION @BASECLASS PXPAGEHEADER #20210506T204027.941 GMT:20210506T204027.941 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "ee62de06d6427dec769fbc98d8e1fa23";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("HomeHeader",1,"Rule-HTML-Section","{'type':'Section','ruleName':'HomeHeader','insKey':'RULE-HTML-SECTION DATA-PORTAL HOMEHEADER #20210506T204027.445 GMT','templated':'true','editable':'true','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pxMainPageSideInContainer", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionHomeHeaderBB","",false);
}
...
String paramName = "EXPANDEDSubSectionHomeHeaderBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pxMainPageSideInContainer'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pxMainPageSideInContainer'}") + ">");
}
pzSetExpandParam_2();
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionHomeHeaderB"));
...
metadataPage.put("title", "Application.pyLabel");
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Application.pyLabel", "pyCaption");
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty("Application.pyLabel");
...
metadataPage.put("uniqueid", "202602210142230333");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("20180814100925014850") + " ");
...
pzSection.getLayout().setExpandParam("SubSectionHomeHeaderB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)','region':'Actions'}") + " class='layout layout-outline layout-outline' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionHomeHeaderB";
...
l_sectionTitle=StringUtils.crossScriptingFilter(tools.getLocalizedTextForParameterizedString("pyCaption",tools.getProperty("Application.pyLabel").getStringValue()));
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='1' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel4751' data-layout-id='202602210142230324" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h1  class='header-title' id='headerlabel4751'>" + l_sectionTitle + "</h1><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionHomeHeaderB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_1() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20180814100925014850") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString(" class='" + "flex  content  set-width-auto layout-content-inline_middle content-inline_middle " + "'  ");
	...
	String paramName = "EXPANDEDSubSectionHomeHeaderB";
	metadataPage.put("paramName", paramName);
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)','region':'Actions'}");
	if(!inspectorLayoutData.isEmpty()) {
	metadataPage.put("liveUI", inspectorLayoutData);
	}
	String pyPrefix = null;
	...
	metadataPage.put("contCustom","page-header");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
	pzLayoutHeader_1();
	pzLayoutBody_1();
	containerComponent.endComponent();
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL HOMEHEADER #20210506T204027.445 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "HomeHeader");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL HOMEHEADER #20210506T204027.445 GMT", "Data-Portal HomeHeader", "Theme-Cosmos", "04-01-01", "20210506T204027.445 GMT");
}
