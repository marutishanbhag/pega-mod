 ...
 */
public class ra_stream_pzviewinstancestoolbar_511cad506ada0f6d729ea9a9201f7b71 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzViewInstancesToolbar.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 629628793;
 ...
 */
	public ra_stream_pzviewinstancestoolbar_511cad506ada0f6d729ea9a9201f7b71(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "548d127539d6bb4c7fd6b1ab77ae4f516f5293c0";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135141.938 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "548d127539d6bb4c7fd6b1ab77ae4f516f5293c0";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzViewInstancesToolbar",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135141.938 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135141.938 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135141.938 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZVIEWINSTANCESTOOLBAR", 
	"Rule-Obj-Property:PYVIEWINSTANCESCLASSSELECTOR", 
	"Rule-Obj-Property:PYCLASSLABEL", 
	"Rule-HTML-Property:PXLINK", 
	"Rule-HTML-Property:PXICON", 
	"Rule-HTML-Property:PXCHECKBOX", 
	"Rule-HTML-Property:PXBUTTON", 
	"Rule-File-Binary:WEBWB!PZ-ARROW-WHITE-DOWN!PNG", 
	"Rule-File-Binary:WEBWB!PZ-ARROW-WHITE-DOWN!PNG"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZVIEWINSTANCESTOOLBAR","Rule-HTML-Section","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135141.938 GMT","!PZVIEWINSTANCESTOOLBAR",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",629628793), 
		new DependentRuleInfo("PYVIEWINSTANCESCLASSSELECTOR","Rule-Obj-Property","@BASECLASS",true,"@baseclass","Pega-Desktop","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PYVIEWINSTANCESCLASSSELECTOR #20180713T135013.434 GMT","!PYVIEWINSTANCESCLASSSELECTOR",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYCLASSLABEL","Rule-Obj-Property","@BASECLASS",true,"@baseclass","Pega-UIEngine","08-04-01","RULE-OBJ-PROPERTY @BASECLASS PYCLASSLABEL #20191111T070931.644 GMT","!PYCLASSLABEL",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		...
		new DependentRuleInfo("WEBWB!PZ-ARROW-WHITE-DOWN!PNG","Rule-File-Binary","",false,"","","","","WEBWB!PZ-ARROW-WHITE-DOWN!PNG",true,false,"ABSOLUTE_CLASSLESS",1), 
		new DependentRuleInfo("WEBWB!PZ-ARROW-WHITE-DOWN!PNG","Rule-File-Binary","",false,"","Pega-Desktop","","RULE-FILE-BINARY WEBWB PZ-ARROW-WHITE-DOWN!PNG #20180713T135100.352 GMT","WEBWB!PZ-ARROW-WHITE-DOWN!PNG",true,false,"ABSOLUTE_CLASSLESS",1)
	};
...
//	RULE-HTML-SECTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135141.938 GMT:20180713T135141.938 GMT
//	RULE-HTML-PROPERTY PXLINK #20190131T183501.590 GMT:20190131T183501.590 GMT
//	RULE-FILE-BINARY WEBWB PZ-ARROW-WHITE-DOWN!PNG #20180713T135100.352 GMT:20180713T135100.352 GMT
//	RULE-FILE-BINARY WEBWB PZ-ARROW-WHITE-DOWN!PNG #20180713T135100.352 GMT:20180713T135100.352 GMT
...
//	RULE-OBJ-PROPERTY @BASECLASS PYCLASSLABEL #20191111T070931.644 GMT:20191111T070931.644 GMT
...
//	RULE-OBJ-PROPERTY @BASECLASS PYVIEWINSTANCESCLASSSELECTOR #20180713T135013.434 GMT:20180713T135013.434 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "a2310f2e095fcc8c67a5b44b485b7dec";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzViewInstancesToolbar",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzViewInstancesToolbar','insKey':'RULE-HTML-SECTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135141.938 GMT','sectionType':'standard'}");
pzLayout_4();
...
try {
	...
	cellPage.put("pyStreamName","pzViewInstancesToolbar");
	...
	String classProp = "";
	classProp ="pi pi-close-circle pi-light";
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("20150128015843062812924") + " ");
	String spxUniqueStreamHash34 = getUIActionsMetaData_4();
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pzViewInstancesToolbar_"+ referenceString+ "_12'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		String classProp = "";
		 classProp ="pi pi-close-circle pi-light";
		tools.appendString("<i  " + pzCell.getTestIdIfEnabled("20150128015843062812924") + "  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_30")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzViewInstancesToolbar_"+ referenceString+ "_11'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("20150128015843062711563") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
			...
			refreshActionRequest.registerFixedParameter("StreamList", "pzViewInstances|Rule-HTML-Section|:");
			staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
			staticURLStr.append("&PreActivity=pzLoadViewInstances");
			tools.appendString("[\"refresh\", [\"otherSection\",\"pzViewInstances\", \"pzLoadViewInstances\", \"");
			refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
			tools.appendString("RuleClass=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pxObjClass")+"~#");			refreshActionRequestD.registerFixedParameter("RuleClass",".pxObjClass");
			tools.appendString("&AppliesToClass=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyClassName")+"~#");			refreshActionRequestD.registerFixedParameter("AppliesToClass",".pyClassName");
			tools.appendString("&Action=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyViewInstancesClassSelector")+"~#");			refreshActionRequestD.registerFixedParameter("Action",".pyViewInstancesClassSelector");
			tools.appendString("&ShowInstances=");

		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyViewInstancesShowInstances")+"~#");			refreshActionRequestD.registerFixedParameter("ShowInstances",".pyViewInstancesShowInstances");
			preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"Label\":\"\"");
			tools.appendString("\", \"\", \",");
			refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			...
			ct_controlAction.trackValueChanges(tools.getProperty(".pyViewInstancesClassSelector"), -1);
			ct_controlAction.trackValueChanges(tools.getProperty(".pyViewInstancesShowInstances"), -1);
		}}catch(Exception e){}
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_29","pzRuleFormToolbarNew", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "pzRuleFormToolbarNew"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellpzViewInstancesToolbar978","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("keepStreamProperties",true);
	secInfo.put("preserveParamState",false);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_26","pzRuleFormToolbarNew", secInfo);
}
...
public int simpleLayoutCell_7( int index) {
	...
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" wxpxCanWriteInstances","pxCanWriteInstances","cell", "visible" )) {
		pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzRuleFormToolbarNew",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_7( int index) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxpxCanWriteInstances",pxUniqueStreamHash+"_28");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_28");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName","pxCanWriteInstances");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpxCanWriteInstances", pxUniqueStreamHash+"_28"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzRuleFormToolbarNew",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
public int simpleLayoutCell_8( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20150128015843062711563-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20150128015843062711563-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
public int simpleLayoutTemplateCell_8( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20150128015843062711563-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutCell_9( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","hotkey-ruleform-close","hotkey-ruleform-close")  + " '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_9( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20150128015843062812924-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxIcon",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxIcon_1();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpzViewInstancesToolbarBBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201802090237280342694") + " ");
	...
	String paramName = "EXPANDEDSubSectionpzViewInstancesToolbarBBB";
...
public void inclFormattedVal_2(boolean isSecuredProp, String activePropValue, boolean isDisplayTextWithParam , String displayTextParamName) {
		...
		String formattedValue = pega_uiengine_formatter.pxFormatTrueFalse((isSecuredProp ? activePropValue : pega_uiengine_pzcontrol.pzGetActiveValue((PegaStreamAPI)tools,true)),"forceruninherited","forcerun",true,"text","","");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendString("#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyViewInstancesClassSelector")+"~#");				refreshActionRequestD.registerFixedParameter("Action",".pyViewInstancesClassSelector");
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"ShowInstances\":\"\"");
				preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"Label\":\"\"");
				tools.appendString("\", \"\", \",");
				refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
				tools.appendString("\",\":event\",\"\",[\"");
...
inclCalVal_1("pxCheckbox","TF&&text&&false&&forceruninherited&&forcerun","leftJustifyStyle");inclAction_1();
tools.appendString(">");
...
tools.appendString("</P>");
	...
	pzAuto.getUIComponentRuntime().getExpressionEvaluator().addDefaultValue(".pyViewInstancesClassSelector",  "false");
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015012801584306267860",true));
	cellPage.put("pyValue",".pyViewInstancesClassSelector");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyViewInstancesClassSelector");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pyViewInstancesClassSelector", ".pyCaption");
	...
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyActionPrompt","Include inherited\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Include inherited", ".pyActionPrompt");
	}
	pyTooltip = "Include inherited";
	modePage1.put("tooltip",pyTooltip);
	String pyCheckboxCaption = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyCaption","pzIncludeInherited\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("pzIncludeInherited", ".pyCaption");
	}
	pyCheckboxCaption = "pzIncludeInherited";
	modePage1.put("pyCheckboxCaption",pyCheckboxCaption);
	cellPage.put("pyID","pyViewInstancesClassSelector");
	...
	modePage1.put("styleOther","cb_explorer_secondary");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyViewInstancesClassSelector",pxUniqueStreamHash+"_18");
	...
	String pyValueOrig = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyViewInstancesClassSelector");
	pyValueR = ".pyViewInstancesClassSelector";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pyViewInstancesClassSelector");
	pyValueOrig = ".pyViewInstancesClassSelector";
	cellPage.put("pyValue",pyValueOrig);
	cellPage.put("pyValueRO",pyValueR);
	modePage2.put("pyContent","associated");
	modePage2.put("styleOther","explorer_secondary");
	...
	String pyFalseLabel = "";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyCaption","forceruninherited\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("forceruninherited", ".pyCaption");
	}
	pyTrueLabel = "forceruninherited";
	if(pega.getPackageRuntime().canPackage()){
		tools.getLocalizedTextForString(".pyCaption","forcerun\t"+repeatIndx,StreamBuilder.FMT_LITERAL);
	} else {
		pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("forcerun", ".pyCaption");
	}
	pyFalseLabel = "forcerun";
...
pzStatic_pzCheckboxScripts.emitContent();
		...
		tools.appendString(tools.getLocalizedTextForString(".pyActionPrompt","Include inherited",StreamBuilder.FMT_LITERAL));
		tools.appendString("' ");
		tools.appendString(">");
		...
		tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyViewInstancesClassSelector").getEntryHandle(),"entryHandle"));} else{
		tools.appendString(tools.getActive().getEntryHandle());}
		tools.appendString("' ");							tools.appendString(disabled_ctrl);

		tools.appendString(" />");
		String checkboxName = "";
		tools.appendString("<input type='checkbox'  " + pzCell.getTestIdIfEnabled("2015012801584306267860") + "  class='cb_explorer_secondary checkbox chkBxCtl"+errorClass+"' value='true' name='");if(bOptimizedMarkup){
		tools.appendString(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyViewInstancesClassSelector").getEntryHandle(),"entryHandle"));
		tools.appendString("' data-bindprops='value'");
		checkboxName = StringUtils.crossScriptingFilter(pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyViewInstancesClassSelector").getEntryHandle(),"entryHandle"));} else{
		tools.appendString(tools.getActive().getEntryHandle());
		tools.appendString("'");
		...
		tools.appendString(propName.substring(propName.lastIndexOf(".")+1)+pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyViewInstancesClassSelector").getReference(),"",true)+"' ");} else{
		...
		tools.appendString(" />");
		tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2015012801584306267860-Label") + "  class='cb_explorer_secondary cb_standard' for='");if(bOptimizedMarkup){
		tools.appendString(propName.substring(propName.lastIndexOf(".")+1)+pzAuto.getUIComponentRuntime().changeTrackProperty(tools.getProperty(".pyViewInstancesClassSelector").getReference(),"",true)+"' ");} else{
		tools.appendString(tools.getHTMLIDForProperty(true,"checkbox")+"' ");}
		tools.appendString("data-change='.' "); 
	tools.appendString("class='chkbxCaptionRight'>");
		tools.appendString(tools.getLocalizedTextForString(".pyCaption","pzIncludeInherited"));
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("2015012801584306267860") + " ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_20")){inclFormattedVal_2(isSecuredProp, activePropValue, isDisplayTextWithParam , displayTextParamName);
...
if(pegaValidation != null) {
	...
	tools.putActive(propActivePrev); 							} catch (Exception e) {
	 ...
	 if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'							&& pzAuto.getUIComponentRuntime().getRuntimeContextTree().isLiveDesignViewMode()){
		...
		IUIComponentMetadata metadata = pzAuto.getUIComponentRuntime().createMetadata();
		IUIComponent ctrlComponent = pzAuto.getUIComponent();
		metadata.put("cellInfo", ".pyClassLabel");
		metadata.put("msgText", "config issue");
		ctrlComponent.addDependentScripts("pzpega_ui_template_designview.js");
		ctrlComponent.beginComponent("pxDesignViewError", metadata);
		tools.putParamValue("isControlEditableOriginal", true);
...
public void pxTextInput_1() {String key="6||RULE-HTML-SECTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135141.938 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","0","","","Text","true","6"};oCellRuntimeParamsMap.put("6||RULE-HTML-SECTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135141.938 GMT",paramValues);oControlPathsMap.put("6||RULE-HTML-SECTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135141.938 GMT",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			pzPackageRuntime.packageSection("pzViewInstancesToolbar",
			...
			tools.appendString("[\"showMenu\",[{\"dataSource\":\"pzViewInstancesMenu\", \"isNavNLDeferLoaded\":\"false\", \"isNavTypeCustom\":\"false\", \"className\":\"" + tools.getStepPage().getClassName());
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771653728273");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzViewInstancesMenu", "", "pyNavigation1771653728273","", false, false, false, false);
...
try {
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("2015012801584306233855",true));
	if(false || (pzAuto.isOffline() && true) ){ 
	modePage2.put("pyNavigation",navPage);
	}
	modePage2.put("pyName","pzViewInstancesToolbar_$CTX$_3");
		String repeatIndx = "";
	modePage2.put("styles","workarea_header_primary");
	String pyTooltip = "";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addProperty(".pxObjClass");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(".pxObjClass", ".pyActionPrompt");
	pyTooltip = ".pxObjClass";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("imgSrc","image");
	modePage2.put("image","webwb/pz-arrow-white-down_1975318362.png!!.png");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzViewInstancesToolbar_"+ referenceString+ "_3'";
	 String securedPropValue = null;
	 ...
	 if(propSecInfo != null && !"UNSECURED".equalsIgnoreCase(propSecInfo.getPropType().toString())) {
	  ...
	  if(securedPropValue == null) {
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("2015012801584306233855") + " role='link' aria-haspopup='true' href='"+hrefValue+"'");tools.appendString(" aria-label='"+localizedValForMenu+" "+ariaLabel+"' ");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	if(pega_uiengine_pznavigation.pzUseNewMenu() && true) {
	  IActionRequest actionRequest = pzAuto.getActionRequest();
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
		try{
			...
			tools.appendString(", \"ellipsisAfter\":\"999\",\"usingPage\":\"" + pzAuto.getUIComponentRuntime().generateActionTokenForPage() + "\", \"useNewMenu\":\"" + pega_uiengine_pznavigation.pzUseNewMenu() + "\", \"isMobile\":\"" + pega_uiengine_pznavigation.pzIsMobile() + "\", \"navPageName\":\"pyNavigation1771653728276");
			if(pzAuto.isOffline() || false) {
			try{
			pega_uiengine_pzcontrol.pzGetMenu("pzViewInstancesMenu", "", "pyNavigation1771653728276","", false, false, false, false);
			}catch(Exception e){oLog.error(e);}
			}
			tools.appendString("\"},\":event\"]");
		...
		tools.appendString("  title= '");if(bOptimizedMarkup){
		 toolTipVal = pzAuto.getUIComponentRuntime().getRuntimeContextTree().getDataBindingToken(tools.getProperty(".pxObjClass").getReference());
		tools.appendCSF(toolTipVal);
		tools.appendString("'");} else {
		 toolTipVal = tools.getProperty(".pxObjClass").getStringValue();
		tools.appendCSF(toolTipVal);
		tools.appendString("'");}tools.appendString(" class='workarea_header_primary");tools.appendString("'");
		tools.appendString(" >");
		boolean hasLineBreaks = false;
		...
		tools.appendString("webwb/pz-arrow-white-down_1975318362.png!!.png");
...
public int simpleLayoutCell_1( int index) {
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("2015012801584306233855-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("2015012801584306233855-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing remove-left-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015012801584306233855-Label")).append(" ").toString().replace("data-test-id=","").trim());
...
public int simpleLayoutCell_2( int index) {
	...
	String ariahiddenString = "";
	String baseRef ="";
	if(!pzAuto.handleEvaluateWhen(" o2== rx.pyViewInstancesShowInstances cttrue",".pyViewInstancesShowInstances  = true","cell", "visible" )) {
		return index;
	}
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing    " + pzSection.getCustomStyle(false, "","heading_1_dataLabelRead h4_dataLabelRead explorer_secondary_dataLabelRead standard_dataLabelRead","heading_1_dataLabelWrite h4_dataLabelWrite explorer_secondary_dataLabelWrite standard_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("2015012801584306244455") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead heading_1_dataLabelRead","dataLabelWrite heading_1_dataLabelWrite") + "' >");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","of") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015012801584306244455")).append(" ").toString().replace("data-test-id=","").trim());
	...
	pgCells.put("customROStyles","heading_1_dataLabelRead h4_dataLabelRead explorer_secondary_dataLabelRead standard_dataLabelRead");
	pgCells.put("customRWStyles","heading_1_dataLabelWrite h4_dataLabelWrite explorer_secondary_dataLabelWrite standard_dataLabelWrite");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2== rx.pyViewInstancesShowInstances cttrue",pxUniqueStreamHash+"_9");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_9");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenName",".pyViewInstancesShowInstances  = true");
	pxWhenIdentifiersForCell.put("pyVisibilityWhenClass","@baseclass");
	pg_dlCellMeta.putMetadata("pxWhenIdentifiers",pxWhenIdentifiersForCell);
	} else {
	pxWhenIdentifiersForCell.put("pyVisibilityWhenId",pxUniqueStreamHash+"_9");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2== rx.pyViewInstancesShowInstances cttrue", pxUniqueStreamHash+"_9"); 
	}
	if(pyDLCellVisibility) {
...
public int simpleLayoutCell_3( int index) {
	...
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(3)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing    " + pzSection.getCustomStyle(false, "","heading_1_dataLabelRead h4_dataLabelRead explorer_secondary_dataLabelRead standard_dataLabelRead","heading_1_dataLabelWrite h4_dataLabelWrite explorer_secondary_dataLabelWrite standard_dataLabelWrite")  + " '  STRING_TYPE='label' RESERVE_SPACE='false'><div class='content-inner '>" + "<div  " + pzCell.getTestIdIfEnabled("2015012801584306255104") + "  class='field-item " + pzSection.getCustomStyle(false, "","dataLabelRead heading_1_dataLabelRead","dataLabelWrite heading_1_dataLabelWrite") + "' >");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
	
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","pzRecordsIn") + "</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div></div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("pyLabelReserveSpace","true");
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015012801584306255104")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("spanClass","iconRequired heading_1_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("labelReadClass","dataLabelRead heading_1_dataLabelRead");
	pgCells.put("labelWriteClass","dataLabelWrite heading_1_dataLabelWrite");
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pyViewInstancesShowInstances cttrue",pxUniqueStreamHash+"_11");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pyViewInstancesShowInstances cttrue", pxUniqueStreamHash+"_11"); 
	}
	if(pyDLCellVisibility) {
...
public int simpleLayoutCell_4( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput",".pyClassLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing   '  STRING_TYPE='field' RESERVE_SPACE='false'><div class='content-inner '><div class='field-item ");
	if(pzAuto.handleEvaluateWhen(" wxAlways","Always","cell", "visible")) {
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	IUIComponentMetadata pgCells = pzAuto.getUIComponentRuntime().createMetadata();
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015012801584306256809-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxTextInput");
	pgCells.put("forLabel",".pyClassLabel");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	tools.putParamValue("editModeReadonlyCondition", " wxAlways");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" wxAlways",pxUniqueStreamHash+"_14");
	...
	pxWhenIdentifiers.put("pyReadOnlyWhenId",pxUniqueStreamHash+"_14");
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
	pgCells.put("pyBaseRef",String.valueOf(baseRef));
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextInput",".pyClassLabel",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(4)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	pgCells.put("partialClass","remove-top-spacing remove-bottom-spacing remove-right-spacing");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("2015012801584306267860-Label")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("format","pxCheckbox");
	pgCells.put("forLabel",".pyViewInstancesClassSelector");
	pgCells.put("pyAutoHTML","true");
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("isFlex","false");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	isOffline = pzAuto.getUIComponentRuntime().getRuntimeContextTree().isOfflinePackaging();
	if (!isExpression && isOffline) {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addWhen(" o2!= rx.pyViewInstancesShowInstances cttrue",pxUniqueStreamHash+"_22");
	...
	pyDLCellVisibility = pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" o2!= rx.pyViewInstancesShowInstances cttrue", pxUniqueStreamHash+"_22"); 
	}
	if(pyDLCellVisibility) {
	String inspectorData=pzCell.getInspectorDataDynamic("pxCheckbox",".pyViewInstancesClassSelector",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(5)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxCheckbox_1(".pyViewInstancesClassSelector",0,"","","Text");}
	if (!isExpression && isOffline) {
	// do nothing
	} else {
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().endVisibleWhen();
...
pzSection.getLayout().setExpandParam("SubSectionpzViewInstancesToolbarBB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201802090237280341551") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
	...
	String paramName = "EXPANDEDSubSectionpzViewInstancesToolbarBB";
	metadataPage.put("paramName", paramName);
...
pzSection.getLayout().setExpandParam("SubSectionpzViewInstancesToolbarB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201802090237280340452") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
	...
	String paramName = "EXPANDEDSubSectionpzViewInstancesToolbarB";
	metadataPage.put("paramName", paramName);
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135141.938 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PZVIEWINSTANCESTOOLBAR #20180713T135141.938 GMT", "@baseclass pzViewInstancesToolbar", "Pega-Desktop", "08-01-01", "20180713T135141.938 GMT");
}
