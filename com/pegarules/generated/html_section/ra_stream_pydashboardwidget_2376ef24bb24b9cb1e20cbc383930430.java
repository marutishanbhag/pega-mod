...
/**
 * Builds JSP stream DATA-PORTAL-PEGAADMINSTUDIO-REQUESTORSWIDGET!PYDASHBOARDWIDGET.
 */
public class ra_stream_pydashboardwidget_2376ef24bb24b9cb1e20cbc383930430 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyDashboardWidget.Data_Portal_PegaAdminStudio_RequestorsWidget.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1394095290;
 ...
 */
	public ra_stream_pydashboardwidget_2376ef24bb24b9cb1e20cbc383930430(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "1b4e28b56a0d2e25ea692cfd93c386c77a1a36a9";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-REQUESTORSWIDGET PYDASHBOARDWIDGET #20190327T100827.578 GMT	Pega-Desktop:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "1b4e28b56a0d2e25ea692cfd93c386c77a1a36a9";
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-REQUESTORSWIDGET PYDASHBOARDWIDGET #20190327T100827.578 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-REQUESTORSWIDGET PYDASHBOARDWIDGET #20190327T100827.578 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-REQUESTORSWIDGET PYDASHBOARDWIDGET #20190327T100827.578 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDASHBOARDWIDGET","Rule-HTML-Section","DATA-PORTAL-PEGAADMINSTUDIO-REQUESTORSWIDGET",false,"","Pega-Desktop","08-03-01","RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-REQUESTORSWIDGET PYDASHBOARDWIDGET #20190327T100827.578 GMT","!PYDASHBOARDWIDGET",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1394095290)
	};
...
//	RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-REQUESTORSWIDGET PYDASHBOARDWIDGET #20190327T100827.578 GMT:20190327T100827.578 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "5080956621e0e1fd8bbf95ab83d95b94";
	}

	public String getDefinitionAppliesToClass() {
		return "Data-Portal-PegaAdminStudio-RequestorsWidget";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyDashboardWidget",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyDashboardWidget','insKey':'RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-REQUESTORSWIDGET PYDASHBOARDWIDGET #20190327T100827.578 GMT','sectionType':'standard'}");
pzLayout_3();
pzLayout_5();
...
config.put("harnessName", "pzRequestorMain");
config.put("className", "Pega-Ext-AdminStudio-Explorer-Resources-Requestors");
config.put("preActivity", "pzInitializeRequestorManagementPage");
config.put("preActivityParams", "{\"IsClusterView\":\"true\"}");
...
public int simpleLayoutCell_5( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Not privileged for Requestors") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_5( int index) {
	...
	labelName = "Not privileged for Requestors";
...
public void simpleLayout_5() {
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpzCanManageRequestors", pxUniqueStreamHash+"_20");metadataPage.put("lMode","Flexbox");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpzCanManageRequestors","!pzCanManageRequestors", "layout", "visible" )) {pzSetExpandParam_4();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
public int simpleLayoutCell_2( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Users") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutCell_1( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	try{
	tools.appendString(StringUtils.crossScriptingFilter(tools.getLocalizedTextForParameterizedString("pyCaption",tools.getProperty(".pyNumberOfUsers").getStringValue())));
	}catch(Exception ex){
	if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() !='N' ){
	labelName =  ".pyNumberOfUsers";
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	}else{
	tools.appendString(tools.getLocalizedTextForString(".pyCaption",".pyNumberOfUsers"));
	}
	}
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	...
	tools.appendString("],[\"showHarnessWrapper\",[\"newDocument\",\"");
		...
		tools.appendFormatted("Pega-Ext-AdminStudio-Explorer-Resources-Requestors",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");

		tools.appendFormatted("pzRequestorMain",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");

		tools.appendFormatted("pzInitializeRequestorManagementPage",StreamBuilder.FMT_NORMAL);	tools.appendString("\",");
{com.google.gson.JsonObject jObject = new com.google.gson.JsonObject();com.google.gson.JsonObject propRefJSON = new com.google.gson.JsonObject();{jObject.addProperty("IsClusterView", "true");}if(!"{}".equals(propRefJSON.toString())){jObject.add("preActivityDynamicParams",propRefJSON);}
		...
		tools.appendFormatted(tools.getLocalizedTextForString("pyCaption", "Requestors"),StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"");
	...
	if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzPackageRuntime.packageHarness("pzRequestorMain",
	"Pega-Ext-AdminStudio-Explorer-Resources-Requestors"
	,"Display","0");
	}
...
{com.google.gson.JsonObject jObject = new com.google.gson.JsonObject();com.google.gson.JsonObject propRefJSON = new com.google.gson.JsonObject();{jObject.addProperty("IsClusterView", "true");}if(!"{}".equals(propRefJSON.toString())){jObject.add("preActivityDynamicParams",propRefJSON);}
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpzCanManageRequestors", pxUniqueStreamHash+"_13");metadataPage.put("lMode","Flexbox");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpzCanManageRequestors","pzCanManageRequestors", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
static {
	...
	oStreamProperties_1.put("pyClassName", "Data-Portal-PegaAdminStudio-RequestorsWidget");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-REQUESTORSWIDGET PYDASHBOARDWIDGET #20190327T100827.578 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL-PEGAADMINSTUDIO-REQUESTORSWIDGET PYDASHBOARDWIDGET #20190327T100827.578 GMT", "Data-Portal-PegaAdminStudio-RequestorsWidget pyDashboardWidget", "Pega-Desktop", "08-03-01", "20190327T100827.578 GMT");
}
