...
/**
 * Builds JSP stream DATA-PORTAL!PYDASHBOARDRIGHT.
 */
public class ra_stream_pydashboardright_fed6f5d8fab9917b1bc59cc4d0f0e2f9 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyDashboardRight.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -459602984;
 ...
 */
	public ra_stream_pydashboardright_fed6f5d8fab9917b1bc59cc4d0f0e2f9(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a1b2c7ce580036a6087e0a87073226d201302016";
...
{
/* Instance RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDRIGHT #20180713T135202.536 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "a1b2c7ce580036a6087e0a87073226d201302016";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyDashboardRight",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDRIGHT #20180713T135202.536 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDRIGHT #20180713T135202.536 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDRIGHT #20180713T135202.536 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PYDASHBOARDRIGHT"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYDASHBOARDRIGHT","Rule-HTML-Section","DATA-PORTAL",false,"","Pega-Desktop","08-01-01","RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDRIGHT #20180713T135202.536 GMT","!PYDASHBOARDRIGHT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-459602984)
	};
...
//	RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDRIGHT #20180713T135202.536 GMT:20180713T135202.536 GMT
//	RULE-OBJ-ACTIVITY RULE-HTML-SECTION PZASSEMBLEPREPROCESS #20190207T102426.651 GMT:20190430T113026.575 GMT
//	pzLayoutBody_1( {"lazyLoadToken", "String", "deferLoad"}
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "b8e83e1ab2242370a478b06534b19ba4";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyDashboardRight",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyDashboardRight','insKey':'RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDRIGHT #20180713T135202.536 GMT','sectionType':'null'}");
pzLayout_1();
pzLayout_2();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pyWorkGroupList", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "pyWorkGroupList";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_2() {
pzSection.getLayout().setExpandParam("SubSectionpyDashboardRightBB","",false);
}
...
String paramName = "EXPANDEDSubSectionpyDashboardRightBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pyWorkGroupList'}");
...
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(2)','clipboardPath':'pyWorkGroupList'}") + ">");
}
pzSetExpandParam_2();
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyDashboardRightB"));
if("".equals(tools.getParamValue("EXPANDEDSubSectionpyDashboardRightB"))) {
metadataPage.put("expanded",false);
} else {
metadataPage.put("expanded",Boolean.parseBoolean(tools.getParamValue("EXPANDEDSubSectionpyDashboardRightB")));
}
...
String sectionTitle = "PEGA PULSE";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("PEGA PULSE", "pyCaption");
...
metadataPage.put("uniqueid", "202602210109360240");
...
expandedSecId="EXPANDEDSubSectionpyDashboardRightB" + expandRLExprValue;
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_2","pxActivityStreamWrapper", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pxActivityStreamWrapper";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzHeaderCellContent_1() {
}
public void pzSetExpandParam_1() {
pzSection.getLayout().setExpandParam("SubSectionpyDashboardRightB","",false);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pxActivityStreamWrapper'}") + " class='layout layout-outline layout-outline-default' id='EXPAND-OUTERFRAME' PARAM_NAME='");
tools.appendString(tools.getSaveValue("expandParam"));tools.appendString("'");
if(tools.getParamValue("expandRL").equals("true")) {tools.appendString("INDEX='");
tools.appendParamCSF("index");tools.appendString("'");
}
tools.appendString(">");
}
...
l_sectionTitle=StringUtils.escapeIntoJavaString(tools.getLocalizedTextForParameterizedString("pyCaption","PEGA PULSE"));
...
pzLayout.createECImgForDivHeader(true,"Expanded", l_sectionTitle, false,true,true,"",false,true,"202602210109360231","aria-level=2");
} else {
 tools.putSaveValue("EXPAND_COLLAPSE" ,"");
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
pzLayout.createECImgForDivHeader(false,"Collapsed", l_sectionTitle, false,false,true,"",false,true,"202602210109360231","aria-level=2");
} else {
pzLayout.createECImgForDivHeader(true,"Collapsed", l_sectionTitle, false,true,true,"",true,true,"202602210109360231","aria-level=2");
}
}
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyDashboardRightB","tdRightStyle");}
if(showContainerIcons){
...
String paramName = "EXPANDEDSubSectionpyDashboardRightB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'.pySections(1)','clipboardPath':'pxActivityStreamWrapper'}");
if(!inspectorLayoutData.isEmpty()) {
metadataPage.put("liveUI", inspectorLayoutData);
}
String pyPrefix = null;
...
metadataPage.put("isSectionDeferLoaded","true");
containerComponent.beginComponent("pxLayoutContainer",metadataPage);
if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()) {
methodName = "";
}
pzLayoutHeader_1();
containerComponent.addPropertyToMetadata("methodnm", "pzLayoutBody_1");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDRIGHT #20180713T135202.536 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyDashboardRight");
...
static {
pzExternalMethodMapping.put("pzLayoutBody_1", new String[][] { {"lazyLoadToken", "String", "deferLoad"}});
}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION DATA-PORTAL PYDASHBOARDRIGHT #20180713T135202.536 GMT", "Data-Portal pyDashboardRight", "Pega-Desktop", "08-01-01", "20180713T135202.536 GMT");
}
