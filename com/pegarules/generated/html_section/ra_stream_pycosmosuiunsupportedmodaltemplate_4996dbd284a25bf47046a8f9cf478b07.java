...
/**
 * Builds JSP stream @BASECLASS!PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE.
 */
public class ra_stream_pycosmosuiunsupportedmodaltemplate_4996dbd284a25bf47046a8f9cf478b07 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pyCosmosUIUnsupportedModalTemplate.Data_MO_Connector_Transition.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -869573530;
 ...
 */
	public ra_stream_pycosmosuiunsupportedmodaltemplate_4996dbd284a25bf47046a8f9cf478b07(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "cfd608c622d7910eebff9bb54ff654bb2d0bb9bc";
...
{
/* Instance RULE-HTML-SECTION @BASECLASS PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE #20200817T150639.184 GMT	Pega-UIEngine:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "cfd608c622d7910eebff9bb54ff654bb2d0bb9bc";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pyCosmosUIUnsupportedModalTemplate",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION @BASECLASS PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE #20200817T150639.184 GMT
 * Set up context.
 */
final String prevRuleKey_4 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION @BASECLASS PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE #20200817T150639.184 GMT";final String prevClass_4 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION @BASECLASS PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE #20200817T150639.184 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Activity:PZASSEMBLEPREPROCESS", 
	"Rule-HTML-Section:PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE","Rule-HTML-Section","@BASECLASS",false,"","Pega-UIEngine","08-06-01","RULE-HTML-SECTION @BASECLASS PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE #20200817T150639.184 GMT","!PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-869573530), 
...
//	RULE-HTML-SECTION @BASECLASS PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE #20200817T150639.184 GMT:20200817T150639.184 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "359959073f6109133f6d501a5fadd406";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pyCosmosUIUnsupportedModalTemplate",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pyCosmosUIUnsupportedModalTemplate','insKey':'RULE-HTML-SECTION @BASECLASS PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE #20200817T150639.184 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_4();
...
params_2.putString("BindKeyupOnly", "0");
params_2.putString("Caption", "Ok");
params_2.putString("Id", "ModalButtonSubmit");
...
params_2.putString("bLocalize", "true");
	...
	if (currentProperty_2 != null && currentProperty_2.getParentPage().getClassName().equals("Data-MO-Connector-Transition")) {
...
property_Data_MO_Connector_Transition_pzModalButton();
...
if (_jspx_meth_pega_param__1(pageContext, "BindKeyupOnly", "0")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "Caption", "Ok")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "Id", "ModalButtonSubmit")) {
	return true;
}
...
/**
 * Generates stream property_Data_MO_Connector_Transition_ClientValidation
 */
private void property_Data_MO_Connector_Transition_ClientValidation() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_1() {
	...
	try {
property_Data_MO_Connector_Transition_ClientValidation();
	} finally {
...
/**
 * Generates stream property_Data_MO_Connector_Transition_Button
 */
private void property_Data_MO_Connector_Transition_Button() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_2() {
	final Map streamProperties = pega.getStreamProperties();
	try {
property_Data_MO_Connector_Transition_Button();
...
/**
 * Generates stream property_Data_MO_Connector_Transition_pzModalButton
 */
private void property_Data_MO_Connector_Transition_pzModalButton() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
params_1.putString("BindKeyupOnly", "0");
params_1.putString("Caption", "Ok");
params_1.putString("Id", "ModalButtonSubmit");
...
params_1.putString("bLocalize", "true");
	...
	if (currentProperty_1 != null && currentProperty_1.getParentPage().getClassName().equals("Data-MO-Connector-Transition")) {
...
public int simpleLayoutCell_2( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pzModalButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-all-spacing   flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
...
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_11")) {field_pzModalButton_1();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pzModalButton",".pyTemplateInputBox",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");if (pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_14")) {	field_pzModalButton_2();} pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();labelName = "";
...
pzSection.getLayout().setExpandParam("SubSectionpyCosmosUIUnsupportedModalTemplateBBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("20180121055915083919") + " ");
	...
	String paramName = "EXPANDEDSubSectionpyCosmosUIUnsupportedModalTemplateBBB";
...
pzSection.getLayout().setExpandParam("SubSectionpyCosmosUIUnsupportedModalTemplateBB","",false);
}
...
public void simpleLayout_3() {
	...
	if(currentTemplatingStatus != 'N'){
	spxUniqueStreamHash9 = getUIActionsMetaData_2();
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201801210559150837575") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		tools.appendString("<div bSimpleLayout='true' ");
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(2)'}") + " class='" + " content  auto-width-column layout-content-stacked content-stacked  clearfix" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionpyCosmosUIUnsupportedModalTemplateBB";
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2&& o2== pxparam.includedStreamName cq o2!= pxparam.pyShowFAButtons cttrue", pxUniqueStreamHash+"_17");metadataPage.put("lMode","Inline-block");
...
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
metadataPage.put("pyStyle","height:25px;width:105px;");
...
metadataPage.put("pyRenderedStyle",pzSection.getCustomStyle(false, "", "padding-r-2x padding-t-2x", "padding-r-2x padding-t-2x"));
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpyCosmosUIUnsupportedModalTemplateB"));
...
metadataPage.put("uniqueid", "202602230416160775");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("202004271417170647516") + " ");
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_8","pzModalAction", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpyCosmosUIUnsupportedModalTemplate287","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_5","pzModalAction", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzModalAction",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-all-spacing    " + pzSection.getCustomStyle(false, "","overflow-none","overflow-none")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("spanClass","iconRequired standard_iconRequired");
	pgCells.put("customROStyles","overflow-none");
	pgCells.put("customRWStyles","overflow-none");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	if(!StringUtils.isBlank(expressionId)) 
	pgCells.put("pyExpressionId",expressionId);
	if(!"".equals(baseRef))
...
try {
	...
	cellPage.put("pyStreamName","pyCosmosUIUnsupportedModalTemplate");
	...
	ctrlComponent.endComponent();
		 ...
		 String buttonUID = "name='pyCosmosUIUnsupportedModalTemplate_"+ referenceString+ "_14'";
		 String pyFormatValue = "";
		String hrefValue = "";
		String proprefAttr = "";
		...
		String classProp = "";
		 classProp ="pi pi-close";
		tools.appendString("<i  href='' onclick='pd(event);' data-ctl='Icon' "); tools.appendString(" class='");
...
pzSection.getLayout().setExpandParam("SubSectionpyCosmosUIUnsupportedModalTemplateB","",true);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='layout layout-outline layout-outline' id='EXPAND-OUTERFRAME' ");
String expandParameter = "EXPANDEDSubSectionpyCosmosUIUnsupportedModalTemplateB";
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel2862' data-layout-id='202602230416160764" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><span class='header-element header-title-table " + pzSection.getCustomStyle(false, "", "padding-r-2x padding-t-2x", "padding-r-2x padding-t-2x") + "' style='");
try {
tools.appendString("height:25px;width:105px;");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpyCosmosUIUnsupportedModalTemplateB","tdRightStyle");}
if(showContainerIcons){
tools.appendString("</tr></table>");
}
tools.appendString("</span></div><div class='header-right'></div></div>");
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("202004271417170647516") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString(" class='" + "flex  content  layout-content-default content-default listview-display border-0" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","listview-display border-0");
	...
	String paramName = "EXPANDEDSubSectionpyCosmosUIUnsupportedModalTemplateB";
	metadataPage.put("paramName", paramName);
	...
	metadataPage.put("contCustom","overflow-y-auto border-0");
	containerComponent.beginComponent("pxLayoutContainer",metadataPage);
	pzLayoutHeader_1();
	pzLayoutBody_1();
	containerComponent.endComponent();
...
static {
	oPropDefinitions_4.put("Data-MO-Connector-Transition.pyTemplateInputBox", new LiteweightPropertyDefinition("Data-MO-Connector-Transition", "pyTemplateInputBox", "sTN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_4.put("pzInsKey", "RULE-HTML-SECTION @BASECLASS PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE #20200817T150639.184 GMT");
	...
	oStreamProperties_4.put("pyStreamName", "pyCosmosUIUnsupportedModalTemplate");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION @BASECLASS PYCOSMOSUIUNSUPPORTEDMODALTEMPLATE #20200817T150639.184 GMT", "@baseclass pyCosmosUIUnsupportedModalTemplate", "Pega-UIEngine", "08-06-01", "20200817T150639.184 GMT");
