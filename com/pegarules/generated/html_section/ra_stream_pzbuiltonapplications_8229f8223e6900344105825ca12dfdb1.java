...
/**
 * Builds JSP stream RULE-APPLICATION!PZBUILTONAPPLICATIONS.
 */
public class ra_stream_pzbuiltonapplications_8229f8223e6900344105825ca12dfdb1 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzBuiltOnApplications.Rule_Application.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 402751666;
 ...
 */
	public ra_stream_pzbuiltonapplications_8229f8223e6900344105825ca12dfdb1(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "171b8e4f7b7400dca99c26e12c329d72be67cd30";
...
{
/* Instance RULE-HTML-SECTION RULE-APPLICATION PZBUILTONAPPLICATIONS #20180713T140855.696 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "171b8e4f7b7400dca99c26e12c329d72be67cd30";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("pzBuiltOnApplications",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION RULE-APPLICATION PZBUILTONAPPLICATIONS #20180713T140855.696 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-APPLICATION PZBUILTONAPPLICATIONS #20180713T140855.696 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-APPLICATION PZBUILTONAPPLICATIONS #20180713T140855.696 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZBUILTONAPPLICATIONS", 
	"Rule-Obj-Property:PYAPPVERSION", 
	"Rule-Obj-Property:PYAPPNAME", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZBUILTONAPPLICATIONS","Rule-HTML-Section","RULE-APPLICATION",false,"","Pega-ProcessArchitect","08-01-01","RULE-HTML-SECTION RULE-APPLICATION PZBUILTONAPPLICATIONS #20180713T140855.696 GMT","!PZBUILTONAPPLICATIONS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",402751666), 
		new DependentRuleInfo("PYAPPVERSION","Rule-Obj-Property","@BASECLASS",false,"","Pega-NLP","08-07-01","RULE-OBJ-PROPERTY @BASECLASS PYAPPVERSION #20210511T163848.907 GMT","!PYAPPVERSION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
		new DependentRuleInfo("PYAPPNAME","Rule-Obj-Property","@BASECLASS",false,"","Pega-NLP","08-07-01","RULE-OBJ-PROPERTY @BASECLASS PYAPPNAME #20210511T163848.898 GMT","!PYAPPNAME",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",0), 
...
//	RULE-HTML-SECTION RULE-APPLICATION PZBUILTONAPPLICATIONS #20180713T140855.696 GMT:20180713T140855.696 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYAPPNAME #20210511T163848.898 GMT:20210511T163848.898 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYAPPNAME #20210511T163848.898 GMT:20210511T163848.898 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYAPPVERSION #20210511T163848.907 GMT:20210511T163848.907 GMT
//	RULE-OBJ-PROPERTY @BASECLASS PYAPPVERSION #20210511T163848.907 GMT:20210511T163848.907 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE #20180713T131446.065 GMT:20180713T131446.065 GMT
	...
	public static String getFUAContentHash() {
		return "6b6133caeb67c62482979aa771727d61";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzBuiltOnApplications",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzBuiltOnApplications','insKey':'RULE-HTML-SECTION RULE-APPLICATION PZBUILTONAPPLICATIONS #20180713T140855.696 GMT','sectionType':'standard'}");
...
config.put("pyActivity", "pzUpdateDependsOnList");
...
config = new HashMap<String, String>();
config.put("pzActivity", "pzUpdateDependsOnList");
...
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("pzActivity", "pzUpdateCompnentsStatus");
pega.getUIEngine().getUIAction("runActivity", config).register();
config = new HashMap<String, String>();
config.put("ActionSection", "pzPegaExchangeModalTemplate");
config.put("NewTaskStatus", "pzExchangeModalAction");
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_7")){
		 ...
		 String buttonUID = "name='pzBuiltOnApplications_"+ referenceString+ "_17'";
		...
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("20150618050957016376204") + "  href='"+hrefValue+"' ");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("201506180513050620123711") + " ");
		 tools.appendString(' ' + pzCell.getInspectorData("",null, null, ".pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(3)")); tools.appendString(" id='a3' class='");
		...
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyDependsOnApplication1colWidthCache3").equals("")) { tools.appendParamCSF("PpyDependsOnApplication1colWidthCache3");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzCell.getTestIdIfEnabled("201506180516570250260690") + " ");
		...
		tools.appendString(pzSection.getCustomStyle(false,"","standard_dataLabelRead ","standard_dataLabelWrite "));tools.appendString(" cellCont");tools.appendString(" gridCell");tools.appendString(" highlight-ele ");tools.appendString(" ");tools.appendString("' pyCellType = 'static' ");
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyDependsOnApplication1colWidthCache2").equals("")) { tools.appendParamCSF("PpyDependsOnApplication1colWidthCache2");} else { tools.appendString("23.181257706535142"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:24px;'"); } 
									tools.appendString(">"); } 
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  data-alignWithData=\"true\"  ");
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20150619071736013846108") + " ");
		...
		tools.appendString("");
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("PpyDependsOnApplication1colWidthCache1").equals("")) { tools.appendParamCSF("PpyDependsOnApplication1colWidthCache1");} else { tools.appendString("70.77681874229347"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:24px;'"); } 
									tools.appendString(">"); } 
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_6")){boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='pzBuiltOnApplications_"+ referenceString+ "_5'";
	 String securedPropValue = null;
		tools.appendString("<a  " + pzCell.getTestIdIfEnabled("add_application") + " href='"+hrefValue+"'");tools.appendString("onclick='pd(event);'  data-ctl='Link' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		...
		tools.appendString("  title= '");
		 toolTipVal = tools.getLocalizedTextForString(".pyActionPrompt","Add application\t"+repeatIndx ,StreamBuilder.FMT_LITERAL) + "' ";
		...
		tools.appendString("");pega_uiengine_harness.pzGenAKey(tools.getLocalizedTextForString(".pyButtonLabel","Add application",StreamBuilder.FMT_LITERAL)); checkForScriptTags_1(tools.getParamValue("pzULabel")); 
...
public void layoutBody_1() { 
	...
	tools.appendString("\n\t\t\t\t\t\t\t<tr>");
	 ...
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("","",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "",false,"","");tools.appendString("<nobr>");
tools.putSaveValue("parentLayouttype","ACTION");	tools.appendString("</nobr>");
	 pzCell.endCell("td");
	
	 pzCell.beginCellWhen("td",pzCell.getInspectorDataDynamic("pxLink",".pyTemplateInputBox",".pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)"),"  ",pzSection.getCustomStyle(false,"","dataValueRead",pzSection.getValueStyle()), "width:100%;",false,"","");tools.putSaveValue("parentLayouttype","ACTION");pxLink_1();
	 pzCell.endCell("td");
	tools.appendString("\n\t\t\t\t\t\t\t</tr>");
	/*Row end*/
tools.appendString("\n\t\t\t\t\t\t\t</table>\n\n\t\t\t\t\t\t</div>");
...
pzSection.getLayout().setExpandParam("SubSectionpzBuiltOnApplicationsB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionpzBuiltOnApplicationsB";
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
 ...
 ClipboardPage gFCritPage_pyDependsOnApplicationL3=null;

 Map selUniqMap_pyDependsOnApplicationL3 = null;
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");tools.appendString(tools.getStepPage().getReference());tools.appendString(".pyDependsOnApplication");tools.appendString("_pzBuiltOnApplications_1'");
...
tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201704201112120839264") + " ");
tools.appendString("bEditable='");tools.appendString(tools.getSaveValue("bEditable"));tools.appendString("'");
tools.appendString(" fixedRow='false' fixedCol='false' bValueList='false' bPageGroup='false' appendAct='' deleteAct='pzPostDependsOnAppGridDelete' bTree='false' repeatType='row' editConfig='readWrite' editFormat='' template-name='' bGrid='true' bDragDrop='true' bTreegrid='false' bSorting='false' grid-postactivity='pzUpdateDependsOnList' bReportDefinition='false' bLoadActivity='false' bDataObject='false' bCBOptimize='true' OAFunc='openRuleByKeys' ");
pyDependsOnApplication_1();
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					ClipboardProperty prop = tools.getStepPage().getProperty(".pyDependsOnApplication");

					}

					tools.appendString("\n\t\t\t\t\t\t<div id='PEGA_GRID_CONTENT' ParitalRefresh='" + true + "' pyDisplaySelectedValuesFirst='false ' columnList='.pyAppName .pyAppVersion .pyTemplateInputBox  ' class='yui-skin-sam gPercent");

					if(pega_uiengine_harness.pzInStandardsMode()) {tools.appendString("  ");

					}tools.appendString("' style='");

					tools.appendString("' gPropIndex='PpyDependsOnApplication1' editRowIndex='");
					...
					tools.appendString(" " + pzSection.getLayout().getTestIdIfEnabled("201704201112120839264-layout") + " ");

					tools.appendString(" class='gridTable ");

					tools.appendString(pzSection.getRepeatStyle());String strSummary = "pyRuleSetList";
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"PpyDependsOnApplication1colWidthGBL\" id=\"PpyDependsOnApplication1colWidthGBL\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyDependsOnApplication1colWidthGBL"));tools.appendString("\" />");

					
						 tools.putParamValue("expandRL","false"); 

					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"PpyDependsOnApplication1colWidthGBR\" id=\"PpyDependsOnApplication1colWidthGBR\" value=\"");

					tools.appendString(tools.getParamValueCSF("PpyDependsOnApplication1colWidthGBR"));

					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");

					 if(!("".equals(tools.getParamValue("PpyDependsOnApplication1colWidthGBR") ))) { tools.appendString("resizedTable"); } 

					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='pyRuleSetList' PL_PROP='");

					
tools.appendString(".pyDependsOnApplication");

					tools.appendString("' PL_PROP_CLASS='Embed-DependsOnApp' PRIM_PAGE='");
					...
					tools.appendString("'>\n\t\t\t\t\t\t\t\t\t\t<tr class='cellCont' ><td class='cellCont rowHandleHead  ' style='height:26px;width:1%'>");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
								 ...
								 itr_3 = tools.getProperty(".pyDependsOnApplication").iterator(); 
					...
					tools.appendString(" ng-repeat=\"Item in rootData..pyDependsOnApplication\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals(".pyDependsOnApplication")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodes.pyDependsOnApplication1") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 

					if (tempTestID != null && !tempTestID.isEmpty() && !tempTestID.equals("")){

					String strEntryHandlePLProp = "";

					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle(".pyDependsOnApplication"); } catch (Exception ex) { }
					...
					tools.appendString( " " + pzSection.getLayout().getTestIdIfEnabled("201704201112120839264-" + rowTestID) + " ");
					...
					tools.appendString("draggableCell ");tools.appendString("rowHandle  ' style='height:35px;width:1%;'>");
					...
					tools.appendString("style='height:35px;'");
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"4\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("Embed-DependsOnApp", "tempNoRespg");
 ...
 tempNoRespg.removeFromClipboard();
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodes.pyDependsOnApplication1") && tools.getParamValue("partialRefresh").equals("false")) {
...
if (_jspx_meth_pega_param__1(pageContext, "AdditionalParams", "&p1=pyProductName&v1=[pyAppName]")) {
	return true;
}
...
if (_jspx_meth_pega_param__1(pageContext, "ApplyTo", "pyAppName")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "Width", "95%")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "ListName", "AppVersions")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "TextBoxTooltip", "Open Rule")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "FieldType", "RULEKEY")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "DisplayProperty", "pyProductVersion")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "NoOpenRule", "0")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "ShowGroups", "OFF")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "DisplayPropertyTooltip", "pyProductVersion")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "ClassGroupInstances", "0")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "Class", "Rule-Application")) {
	return true;
}
 ...
 */
if (_jspx_meth_pega_reference__2(pageContext, ".pyAppVersion", "input", "OpenRuleAdvanced")) {
	return;
}
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
public void repeatingDataCell_2() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyAppVersion", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)")); tools.appendString("headers='a2'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:31px;'");}tools.appendString("class='");
...
final Tag prevParentTag = mParentTag;
mParentTag = _jspx_th_pega_reference_;
if (_jspx_meth_pega_param__1(pageContext, "CustomQuery", "&pyActivity=@baseclass.pzGetApplicationsOrComponents&mode=Application")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "NoSmartPrompt", "0")) {
	return true;
...
if (_jspx_meth_pega_param__1(pageContext, "DisplayProperty", "pyProductName")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "NoOpenRule", "-1")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "DisplayPropertyTooltip", "pyLabel")) {
	return true;
}
if (_jspx_meth_pega_param__1(pageContext, "ClassGroupInstances", "0")) {
	return true;
 ...
 * Cannot inline because: included stream is too big: 38240 bytes
 */
if (_jspx_meth_pega_reference__1(pageContext, ".pyAppName", "input", "OpenRuleAdvanced")) {
	return;
}
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
...
getActionsForCustomControls_1() {
	...
	String currentStream = tools.getCurrentStream();
		...
		ractURLStr.append("pyActivity=pzRunActionWrapper&pzActivity=pzUpdateDependsOnList");
...
public void repeatingDataCell_1() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("OpenRuleAdvanced",".pyAppName", ".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
...
public void pyDependsOnApplication_1() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyDependsOnApplication1")|| tools.getParamValue("partialTrigger").equals("editRow.pyDependsOnApplication1") ){
					...
					ClipboardProperty pageListProp = tools.getProperty(".pyDependsOnApplication");
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData..pyDependsOnApplication\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdrop.pyDependsOnApplication1")) {
  ...
  if(tools.getParamValue("partialTrigger").equals("delete")) { 
	 ...
	 if(tools instanceof StreamBuilderToolKit) {
		 ...
		 pageListProp = tools.getProperty(".pyDependsOnApplication");
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendTo.pyDependsOnApplication1") ){
...
static {
	oPropDefinitions_1.put("Rule-Application.pyAppVersion", new LiteweightPropertyDefinition("Rule-Application", "pyAppVersion", "sTN", false, true, "pxTextInput", false));
	oPropDefinitions_1.put("Rule-Application.pyAppName", new LiteweightPropertyDefinition("Rule-Application", "pyAppName", "sTN", false, true, "pxTextInput", false));
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-APPLICATION PZBUILTONAPPLICATIONS #20180713T140855.696 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzBuiltOnApplications");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-APPLICATION PZBUILTONAPPLICATIONS #20180713T140855.696 GMT", "Rule-Application pzBuiltOnApplications", "Pega-ProcessArchitect", "08-01-01", "20180713T140855.696 GMT");
}
