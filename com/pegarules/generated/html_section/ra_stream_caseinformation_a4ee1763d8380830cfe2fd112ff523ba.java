...
/**
 * Builds JSP stream WORK-!CASEINFORMATION.
 */
public class ra_stream_caseinformation_a4ee1763d8380830cfe2fd112ff523ba extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.CaseInformation.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 149187635;
 ...
 */
	public ra_stream_caseinformation_a4ee1763d8380830cfe2fd112ff523ba(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "dd14fab1792017f9b8f3239d1da131fd5aa1fc45";
...
{
/* Instance RULE-HTML-SECTION WORK- CASEINFORMATION #20210506T204027.052 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
pxUniqueStreamHash = "dd14fab1792017f9b8f3239d1da131fd5aa1fc45";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("CaseInformation",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- CASEINFORMATION #20210506T204027.052 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- CASEINFORMATION #20210506T204027.052 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- CASEINFORMATION #20210506T204027.052 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Section:PZDESIGNTEMPLATECASEINFO", 
	"Rule-HTML-Section:CASEINFORMATION"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZDESIGNTEMPLATECASEINFO","Rule-HTML-Section","@BASECLASS",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION @BASECLASS PZDESIGNTEMPLATECASEINFO #20210506T204030.691 GMT","!PZDESIGNTEMPLATECASEINFO",false,false,"MISSING",236277433), 
		new DependentRuleInfo("CASEINFORMATION","Rule-HTML-Section","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-SECTION WORK- CASEINFORMATION #20210506T204027.052 GMT","!CASEINFORMATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",149187635)
	};
...
//	RULE-HTML-SECTION WORK- CASEINFORMATION #20210506T204027.052 GMT:20210506T204027.052 GMT
//	RULE-HTML-SECTION @BASECLASS PZDESIGNTEMPLATECASEINFO #20210506T204030.691 GMT:20210506T204030.691 GMT
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "5fe16c4085ad4bc1732e0a85e0b2e40b";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("CaseInformation",1,"Rule-HTML-Section","{'type':'Section','ruleName':'CaseInformation','insKey':'RULE-HTML-SECTION WORK- CASEINFORMATION #20210506T204027.052 GMT','templated':'true','editable':'true','sectionType':'standard'}");
pzLayout_4();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_9","pyCaseInformation", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	"pyCaseInformation", tools.getStepPage().getReference(),"Work-");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	...
	String sectionName = "pyCaseInformation"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellCaseInformation858","",false);
}
...
public void buildSection_1() { 
	...
	secInfo.put("packageSection", true);
	secInfo.put("packageSectionClass", "Work-");
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_5","pyCaseInformation", secInfo);
}
...
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pxUpdateDateTime,.pxSaveDateTime\" RW=\".pxUpdateDateTime Changes || .pxSaveDateTime Changes\"");
} catch(Throwable t) {
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pyCaseInformation",".pyRegions(2).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing remove-top-spacing remove-bottom-spacing   flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  ".pxUpdateDateTime Changes  || .pxSaveDateTime Changes",expressionId);
		...
		String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pyCaseInformation",".pyRegions(2).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionCaseInformationBBB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)','region':'A'}") + " class='" + "flex  content  layout-content-stacked_with_labels_left content-stacked_with_labels_left " + "'  ");
		...
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)','region':'A'}") + "").append("\"").toString();
	...
	String paramName = "EXPANDEDSubSectionCaseInformationBBB";
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)','region':'A'}");
...
public int simpleLayoutCell_2( int index) {
	...
	tools.appendString("'  class='content-item content-layout item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-right-spacing remove-left-spacing   flex flex-row '  STRING_TYPE='layout' RESERVE_SPACE='false'>");
	pzLayout_2();
...
pzSection.getLayout().setExpandParam("SubSectionCaseInformationBB","",false);
}
...
public void simpleLayout_2() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201912171342510217942") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1).pySections(1)'}") + " class='" + "flex  content  layout-content-inline content-inline flex-2col-350min" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		if(!"".equals(strMethodName))
		pg_dlmeta.put("methodnm",strMethodName);
		pg_dlmeta.put("customClassName","flex-2col-350min");
	...
	String paramName = "EXPANDEDSubSectionCaseInformationBB";
...
pzSection.getLayout().setExpandParam("SubSectionCaseInformationB","",false);
}
...
public void simpleLayout_3() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201912171342510213322") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'.pySections(1)'}") + " class='" + "flex  content  layout-content-default content-default min-height-0-item-2" + "'  ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
	...
	String paramName = "EXPANDEDSubSectionCaseInformationB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- CASEINFORMATION #20210506T204027.052 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "CaseInformation");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- CASEINFORMATION #20210506T204027.052 GMT", "Work- CaseInformation", "Theme-Cosmos", "04-01-01", "20210506T204027.052 GMT");
}
