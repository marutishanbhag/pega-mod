...
/**
 * Builds JSP stream RULE-HTML-SECTION!PZRARECORDCONFIGURATION.
 */
public class ra_stream_pzrarecordconfiguration_3e4a0d1caa2d6e8358fc6f30ceb84df2 extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.pzRARecordConfiguration.Rule_Obj_FlowAction.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1092946739;
 ...
 */
	public ra_stream_pzrarecordconfiguration_3e4a0d1caa2d6e8358fc6f30ceb84df2(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "395c1faceb30271efb44280fd7ab18a1e5534b6";
...
{
/* Instance RULE-HTML-SECTION RULE-HTML-SECTION PZRARECORDCONFIGURATION #20181031T190931.644 GMT	Pega-Desktop:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
pxUniqueStreamHash = "395c1faceb30271efb44280fd7ab18a1e5534b6";
...
/*
 * Begin RULE-HTML-SECTION RULE-HTML-SECTION PZRARECORDCONFIGURATION #20181031T190931.644 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION RULE-HTML-SECTION PZRARECORDCONFIGURATION #20181031T190931.644 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION RULE-HTML-SECTION PZRARECORDCONFIGURATION #20181031T190931.644 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRARECORDCONFIGURATION","Rule-HTML-Section","RULE-HTML-SECTION",false,"","Pega-Desktop","08-02-01","RULE-HTML-SECTION RULE-HTML-SECTION PZRARECORDCONFIGURATION #20181031T190931.644 GMT","!PZRARECORDCONFIGURATION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1092946739)
	};
...
//	RULE-HTML-SECTION RULE-HTML-SECTION PZRARECORDCONFIGURATION #20181031T190931.644 GMT:20181031T190931.644 GMT
...
//	RULE-UTILITY-FUNCTION STRING TRIM #20180713T131442.833 GMT:20180713T131442.833 GMT
	...
	public static String getFUAContentHash() {
		return "a375a0d2a226cfc3812f243058f98f64";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("pzRARecordConfiguration",1,"Rule-HTML-Section","{'type':'Section','ruleName':'pzRARecordConfiguration','insKey':'RULE-HTML-SECTION RULE-HTML-SECTION PZRARECORDCONFIGURATION #20181031T190931.644 GMT','sectionType':'standard'}");
pzLayout_2();
pzLayout_4();
...
metadataPage.put("inputhiddenparam", tools.getParamValueCSF("EXPANDEDSubSectionpzRARecordConfigurationBB"));
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue("Scorecard Record Configuration", "pyCaption");
...
metadataPage.put("title","Scorecard Record Configuration");
metadataPage.put("uniqueid", "202602210150200194");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("201809262115050944704") + " ");
...
public void buildSection_4() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_12","pzRARecordConfigurationInner", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzRARecordConfiguration280","",false);
}
...
public void buildSection_3() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_9","pzRARecordConfigurationInner", secInfo);
}
...
public int simpleLayoutCell_2( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","pzRARecordConfigurationInner",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-bottom-spacing   '  STRING_TYPE='sub_section' RESERVE_SPACE='false'><div class='content-inner '>");
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","pzRARecordConfigurationInner",".pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionpzRARecordConfigurationBB","",true);
}
...
String expandParameter = "EXPANDEDSubSectionpzRARecordConfigurationBB";
...
l_sectionTitle=tools.getLocalizedTextForParameterizedString("pyCaption","Scorecard Record Configuration");
...
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel7827' data-layout-id='202602210150200191" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel7827'>" + l_sectionTitle + "</h2><nobr>");
...
if(showContainerIcons){
pzLayout.includeHeaderIcon("SubSectionpzRARecordConfigurationBB","tdRightStyle");}
if(showContainerIcons){
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201809262115050944704") + " ");
	...
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2== rx.pyIsScoreCard cttrue", pxUniqueStreamHash+"_13");metadataPage.put("lMode","Inline-block");
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2== rx.pyIsScoreCard cttrue",".pyIsScoreCard == true", "layout", "visible" )) {pzSetExpandParam_3();
...
metadataPage.put("uniqueid", "202602210150200190");
metadataPage.put("automationId", " " + pzCell.getTestIdIfEnabled("201809262115050944704") + " ");
headerComponent.beginComponent("pxLayoutHeader",metadataPage);
headerComponent.endComponent();
}
...
public void buildSection_2() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pzRARecordConfigurationInner", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellpzRARecordConfiguration273","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzRARecordConfigurationInner", secInfo);
}
...
sectionImageTitle=tools.getLocalizedTextForParameterizedString("pyCaption","");
	...
	/***-- Grid HeaderElements: Begin --**/
tools.appendString("<div class='header header-bar test clearfix' role='heading' aria-level='2' id='RULE_KEY' node_type='HEADER' aria-labelledby='headerlabel4674' data-layout-id='202602210150200185" + rptDynamicIdx + "'><div class='header-left'><i class='icon icon-openclose'></i></div><div class='header-content' " + l_sectionTitleFVMeta + " ><h2  class='header-title' id='headerlabel4674'>" + l_sectionTitle + "</h2><nobr>");
pzHeaderCellContent_1();
tools.appendString("</nobr>");
boolean showContainerIcons=tools.getParamValue("showContainerIcons").equals("true")?true:false;
tools.appendString("<span class='header-element header-title-table'>");
...
public void simpleLayout_1() {
	...
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o2!= rx.pyIsScoreCard cttrue", pxUniqueStreamHash+"_7");metadataPage.put("lMode","Inline-block");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o2!= rx.pyIsScoreCard cttrue",".pyIsScoreCard != true", "layout", "visible" )) {pzSetExpandParam_1();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
tools.putParamValue("RWClasses","");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION RULE-HTML-SECTION PZRARECORDCONFIGURATION #20181031T190931.644 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION RULE-HTML-SECTION PZRARECORDCONFIGURATION #20181031T190931.644 GMT", "Rule-HTML-Section pzRARecordConfiguration", "Pega-Desktop", "08-02-01", "20181031T190931.644 GMT");
}
