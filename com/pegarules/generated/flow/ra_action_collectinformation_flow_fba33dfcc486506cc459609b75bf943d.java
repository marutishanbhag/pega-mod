...
import java.util.*;
public class ra_action_collectinformation_flow_fba33dfcc486506cc459609b75bf943d  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Flow.CollectInformation_Flow.OFON2J_ProcessO_Work_Onboarding.Action");
	public ra_action_collectinformation_flow_fba33dfcc486506cc459609b75bf943d(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION_FLOW #20260223T094431.395 GMT	ProcessO:01-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "ProcessO";
		mFlowHandle = "RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION_FLOW #20260223T094431.395 GMT";
		
		flowType = "CollectInformation_Flow";
		...
		if (GetFlowInfo != null && GetFlowInfo.equals("true"))
		{
			...
			tools.putParamValue("FlowInsName", "OFON2J-PROCESSO-WORK-ONBOARDING!COLLECTINFORMATION_FLOW");
			return;
		}
		...
		if (strCheckFlowSecurity != null && strCheckFlowSecurity.equals("true"))
		{
			...
			tools.putParamValue("pyLabel", "Collect Information");
			return;
		}
		...
		if (pyLastFlowStep.length() == 0 && pyNextFlowStep.length() == 0)
		{
			...
			if (pyCurrentFlowStep.equals(""))
			{
				...
				currentFlow.putString(".pxFlowInsKey", mFlowHandle);
				currentFlow.putString(".pyFlowTypeLabel", "Collect Information");
...
// Expression: 
		...
		if (!strIssuedFromStage.equals("")){
			...
			ParamsPg.putString("CurrentProcess", "CollectInformation_Flow");
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Flow:COLLECTINFORMATION_FLOW"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("COLLECTINFORMATION_FLOW","Rule-Obj-Flow","OFON2J-PROCESSO-WORK-ONBOARDING",false,"","ProcessO","01-01-01","RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION_FLOW #20260223T094431.395 GMT","!COLLECTINFORMATION_FLOW",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-245886036)
	};
...
//	RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION_FLOW #20260223T094431.395 GMT:20260223T094743.905 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ISORINHERITSFROM #20180713T131444.415 GMT:20180713T131444.415 GMT
	...
	public static String getFUAContentHash() {
		return "5759f692146df0413ce4f7b4138bd2c0";
	}
...
// Expression: pyStepRoutedConfirmation
		...
		pg_newAssignPage.putString("pxProcessName", "Collect Information");
	...
	private void GetCoordinates_circum0(String pageName)
	{
		...
		pgFlow.putString("pyFlowType", "CollectInformation_Flow");
		...
		pgConnector.putString("pyMOName", "Collect Information");
		...
		pgShape.putString("pyCoordX", "4.08");
		...
		pgShape.putString("pyMOId", "Assignment1");
		pgShape.putString("pyMOName", "Collect Information");
		pgShape.putString("pyCoordX", "2.08");
		pgShape.putString("pyCoordY", "0.096");
		pgShape.putString("pyWidth", "");
		pgShape.putString("pyHeight", "");
		cpShapes.add("Assignment1", pgShape);
	...
	private void GetNavigationPath_circum0(String pageName, String parentFlowPath, boolean deferredLoad)
	{
		...
		pgNavPath.putString("pyFlowType", "CollectInformation_Flow");
		pgNavPath.putString("pyClassName", "OFON2J-ProcessO-Work-Onboarding");
		pgNavPath.putString("pyLabel", "Collect Information");
		...
		bIsInFlowPath = pega_procom_breadcrumbtrail.isInFlowPath2(tools, "Assignment1", "CollectInformation_Flow", parentFlowPath, flowNameToSearchForTaskIn, interestPage.getTopLevelPage());
		if (bIsInFlowPath)
		{
			if (!bFoundFlowPath)
			{
			...
			if (newAssignPage.getString("pxTaskName").equals("Assignment1") && newAssignPage.getString("pyFlowType").equals("CollectInformation_Flow") && newAssignPage.getString("pyParentFlowPath").equals(parentFlowPath))
	...
	private boolean CheckFlowSecurity_circum0()
	{
		...
		if (!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools, "AM:RULE-OBJ-FLOW:OFON2J-PROCESSO-WORK-ONBOARDING!COLLECTINFORMATION_FLOW",primaryPageClassName, interestPage)) 
			 hasSecurity = true;
			 if(!hasSecurity) {
			 if(tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOW:OFON2J-PROCESSO-WORK-ONBOARDING!COLLECTINFORMATION_FLOW",primaryPageClassName, interestPage,true))
			 isAllowedAccess = true;
			 else return false;
		}
			 if(isAllowedAccess && !hasSecurity) {		com.pega.pegarules.priv.tracer.RuleTraceInfo ruleTraceInfo = new com.pega.pegarules.priv.tracer.RuleTraceInfo                                                                   ("RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING COLLECTINFORMATION_FLOW #20260223T094431.395 GMT","CollectInformation_Flow","ProcessO","","20260223T094743.905 GMT");
