...
import java.util.*;
public class ra_action_pzopen_09508ee98d0a62a375da3f0a4ba98e91  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Flow.pzOpen.Pega_Application_Guide_Work.Action");
	public ra_action_pzopen_09508ee98d0a62a375da3f0a4ba98e91(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOW PEGA-APPLICATION-GUIDE-WORK PZOPEN #20180713T142020.213 GMT	Pega-AppDefinition:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
		mTraceInfo = oTraceInfo_0;
		mRuleSet = "Pega-AppDefinition";
		mFlowHandle = "RULE-OBJ-FLOW PEGA-APPLICATION-GUIDE-WORK PZOPEN #20180713T142020.213 GMT";
...
tools.getStepStatus().backoutWorst();
		...
		{
			tools.putParamValue("FlowHandle", mFlowHandle);
			tools.putParamValue("FlowInsName", "PEGA-APPLICATION-GUIDE-WORK!PZOPEN");
			return;
		}
		...
		{
			tools.putParamValue("StructureType", "SimpConversation");
			return;
		}
		...
		if (strCheckFlowSecurity != null && strCheckFlowSecurity.equals("true"))
		{
			...
			tools.putParamValue("pyLabel", "Open");
			return;
		}
		...
		if (pyLastFlowStep.length() == 0 && pyNextFlowStep.length() == 0)
		{
			...
			if (pyCurrentFlowStep.equals(""))
			{
				...
				currentFlow.putString(".pxFlowInsKey", mFlowHandle);
				currentFlow.putString(".pyFlowTypeLabel", "Open");
...
// Expression: 
		...
		else if (pyLastFlowStep.length() > 0 && pyNextFlowStep.length() == 0)
		{
			...
			if (pyLastFlowStep.equals("Start1"))
		...
		if (!strIssuedFromStage.equals("")){
			...
			ParamsPg.putString("CurrentProcess", "pzOpen");
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZOPEN","Rule-Obj-Flow","PEGA-APPLICATION-GUIDE-WORK",false,"","Pega-AppDefinition","08-01-01","RULE-OBJ-FLOW PEGA-APPLICATION-GUIDE-WORK PZOPEN #20180713T142020.213 GMT","!PZOPEN",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1277019062)
	};
...
//	RULE-OBJ-FLOW PEGA-APPLICATION-GUIDE-WORK PZOPEN #20180713T142020.213 GMT:20180713T142020.213 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ISORINHERITSFROM #20180713T131444.415 GMT:20180713T131444.415 GMT
	...
	public static String getFUAContentHash() {
		return "fa28d6dfece379ddc492aad4a4d35515";
	}
...
return "Action";
	...
	private void GetCoordinates_circum0(String pageName)
	{
		...
		pgFlow.putString("pyFlowType", "pzOpen");
		pgFlow.putString("pyClassName", "Pega-Application-Guide-Work");
		pgFlow.putString("pyVisioScaleFactor", "100");
		pgFlow.putString("pzInsKey", mFlowHandle);
		pgFlow.putString("pyVisioJpegName", "visioimages/pega_application_guide_workpzopen20180713t142020_216_gmt.jpg");
		pgFlow.putString("pyVisioRFB", "RULE-FILE-BINARY WEBWB PEGA_APPLICATION_GUIDE_WORKPZOPEN20180713T142020_216_GMT!JPG #20180713T142020.215 GMT");
	...
	private void GetNavigationPath_circum0(String pageName, String parentFlowPath, boolean deferredLoad)
	{
		...
		pgNavPath.putString("pyFlowType", "pzOpen");
		pgNavPath.putString("pyClassName", "Pega-Application-Guide-Work");
		pgNavPath.putString("pyLabel", "Open");
	...
	private boolean CheckFlowSecurity_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "Pega-Application-Guide-Work";
		 }
		...
		if (!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools, "AM:RULE-OBJ-FLOW:PEGA-APPLICATION-GUIDE-WORK!PZOPEN",primaryPageClassName, interestPage)) 
			 hasSecurity = true;
			 if(!hasSecurity) {
			 if(tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOW:PEGA-APPLICATION-GUIDE-WORK!PZOPEN",primaryPageClassName, interestPage,true))
			 isAllowedAccess = true;
			 else return false;
		}
			 if(isAllowedAccess && !hasSecurity) {		com.pega.pegarules.priv.tracer.RuleTraceInfo ruleTraceInfo = new com.pega.pegarules.priv.tracer.RuleTraceInfo                                                                   ("RULE-OBJ-FLOW PEGA-APPLICATION-GUIDE-WORK PZOPEN #20180713T142020.213 GMT","pzOpen","Pega-AppDefinition","","20180713T142020.213 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOW PEGA-APPLICATION-GUIDE-WORK PZOPEN #20180713T142020.213 GMT", "Pega-Application-Guide-Work pzOpen", "Pega-AppDefinition", "08-01-01", "20180713T142020.213 GMT");
}
