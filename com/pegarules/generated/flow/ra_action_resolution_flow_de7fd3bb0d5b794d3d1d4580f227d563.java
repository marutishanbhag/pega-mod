...
import java.util.*;
public class ra_action_resolution_flow_de7fd3bb0d5b794d3d1d4580f227d563  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Flow.Resolution_Flow.OFON2J_ProcessO_Work_Onboarding.Action");
	public ra_action_resolution_flow_de7fd3bb0d5b794d3d1d4580f227d563(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING RESOLUTION_FLOW #20260223T094722.891 GMT	ProcessO:01-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("RESOLUTION_FLOW","Rule-Obj-Flow","OFON2J-PROCESSO-WORK-ONBOARDING",false,"","ProcessO","01-01-01","RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING RESOLUTION_FLOW #20260223T094722.891 GMT","!RESOLUTION_FLOW",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1559935833)
	};
...
//	RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING RESOLUTION_FLOW #20260223T094722.891 GMT:20260223T095005.288 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ISORINHERITSFROM #20180713T131444.415 GMT:20180713T131444.415 GMT
	...
	public static String getFUAContentHash() {
		return "3ded3daa69afb35ae038dff241e23aa8";
	}
...
// Expression: pyStepRoutedConfirmation
	...
	private void GetCoordinates_circum0(String pageName)
	{
		...
		pgFlow.putString("pyFlowType", "Resolution_Flow");
		...
		pgConnector.putString("pyMOName", "pyResolveAndCloseCase");
		...
		pgShape.putString("pyMOName", "Resolve case");
	...
	private boolean CheckFlowSecurity_circum0()
	{
		...
		if (!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools, "AM:RULE-OBJ-FLOW:OFON2J-PROCESSO-WORK-ONBOARDING!RESOLUTION_FLOW",primaryPageClassName, interestPage)) 
			 ...
			 if(isAllowedAccess && !hasSecurity) {		com.pega.pegarules.priv.tracer.RuleTraceInfo ruleTraceInfo = new com.pega.pegarules.priv.tracer.RuleTraceInfo                                                                   ("RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING RESOLUTION_FLOW #20260223T094722.891 GMT","Resolution_Flow","ProcessO","","20260223T095005.288 GMT");
