...
import java.util.*;
public class ra_action_createform_default_07bf68327d6e3715ed9924ed78a05939  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	...
	public ra_action_createform_default_07bf68327d6e3715ed9924ed78a05939(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
{
/* Instance RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING CREATEFORM_DEFAULT #20260223T094402.309 GMT	ProcessO:01-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
...
tools.getStepStatus().backoutWorst();
		...
		{
			tools.putParamValue("StructureType", "Simple");
			return;
		}
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Flow:CREATEFORM_DEFAULT"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("CREATEFORM_DEFAULT","Rule-Obj-Flow","OFON2J-PROCESSO-WORK-ONBOARDING",false,"","ProcessO","01-01-01","RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING CREATEFORM_DEFAULT #20260223T094402.309 GMT","!CREATEFORM_DEFAULT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1291685341)
	};
...
//	RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING CREATEFORM_DEFAULT #20260223T094402.309 GMT:20260223T094743.738 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ISORINHERITSFROM #20180713T131444.415 GMT:20180713T131444.415 GMT
	...
	public static String getFUAContentHash() {
		return "eb55e8ee5552a05622894eb12a3cff40";
	}
...
// Expression: 
	...
	private void GetCoordinates_circum0(String pageName)
	{
		...
		pgFlow.putString("pyFlowType", "CreateForm_Default");
		pgFlow.putString("pyClassName", "OFON2J-ProcessO-Work-Onboarding");
		pgFlow.putString("pyVisioScaleFactor", "100");
		pgFlow.putString("pzInsKey", mFlowHandle);
		pgFlow.putString("pyVisioJpegName", "");
		pgFlow.putString("pyVisioRFB", "");
		...
		pgConnector.putString("pyMOName", "Create");
		pgConnector.putString("pyCoordX", "");
		pgConnector.putString("pyCoordY", "");
		pgConnector.putString("pyWidth", "");
		pgConnector.putString("pyHeight", "");
		...
		pgShape.putString("pyMOId", "END66");
		pgShape.putString("pyMOName", "");
		pgShape.putString("pyCoordX", "4.24");
		pgShape.putString("pyCoordY", "0");
		pgShape.putString("pyWidth", "0.48");
		pgShape.putString("pyHeight", "0.48");
		cpShapes.add("END66", pgShape);
		
		pgShape = tools.createPage("Data-MO-Activity-Assignment-WorkAction", "");
		pgShape.putString("pyMOId", "AssignmentSF1");
		pgShape.putString("pyMOName", "Create");
		pgShape.putString("pyCoordX", "2.24");
		pgShape.putString("pyCoordY", "0");
		pgShape.putString("pyWidth", "");
		pgShape.putString("pyHeight", "");
		...
		pgShape.putString("pyMOName", "");
		pgShape.putString("pyCoordX", "0.24");
		pgShape.putString("pyCoordY", "0");
		pgShape.putString("pyWidth", "0.48");
		pgShape.putString("pyHeight", "0.48");
	...
	private boolean CheckFlowSecurity_circum0()
	{
		...
		if (!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools, "AM:RULE-OBJ-FLOW:OFON2J-PROCESSO-WORK-ONBOARDING!CREATEFORM_DEFAULT",primaryPageClassName, interestPage)) 
			 ...
			 if(isAllowedAccess && !hasSecurity) {		com.pega.pegarules.priv.tracer.RuleTraceInfo ruleTraceInfo = new com.pega.pegarules.priv.tracer.RuleTraceInfo                                                                   ("RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING CREATEFORM_DEFAULT #20260223T094402.309 GMT","CreateForm_Default","ProcessO","","20260223T094743.738 GMT");
