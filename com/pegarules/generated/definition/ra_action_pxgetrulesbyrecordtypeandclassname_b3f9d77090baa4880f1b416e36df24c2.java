...
public class ra_action_pxgetrulesbyrecordtypeandclassname_b3f9d77090baa4880f1b416e36df24c2  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pxGetRulesByRecordTypeAndClassName.Rule_HTML_Section.Action");
	public ra_action_pxgetrulesbyrecordtypeandclassname_b3f9d77090baa4880f1b416e36df24c2(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION RULE-HTML-SECTION PXGETRULESBYRECORDTYPEANDCLASSNAME #20180713T135531.166 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXGETRULESBYRECORDTYPEANDCLASSNAME","Rule-Obj-Report-Definition","RULE-HTML-SECTION",false,"","Pega-Desktop","08-01-01","RULE-OBJ-REPORT-DEFINITION RULE-HTML-SECTION PXGETRULESBYRECORDTYPEANDCLASSNAME #20180713T135531.166 GMT","!PXGETRULESBYRECORDTYPEANDCLASSNAME",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1159943211)
	};
...
//	RULE-OBJ-REPORT-DEFINITION RULE-HTML-SECTION PXGETRULESBYRECORDTYPEANDCLASSNAME #20180713T135531.166 GMT:20180713T135531.166 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "2d8f1bfc1817d5fb57f91e12d3722184";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION RULE-HTML-SECTION PXGETRULESBYRECORDTYPEANDCLASSNAME #20180713T135531.166 GMT", "Rule-HTML-Section pxGetRulesByRecordTypeAndClassName", "Pega-Desktop", "08-01-01", "20180713T135531.166 GMT");
}
