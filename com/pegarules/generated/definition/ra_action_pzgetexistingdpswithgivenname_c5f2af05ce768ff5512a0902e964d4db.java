...
public class ra_action_pzgetexistingdpswithgivenname_c5f2af05ce768ff5512a0902e964d4db  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pzGetExistingDPsWithGivenName.Rule_Declare_Pages.Action");
	public ra_action_pzgetexistingdpswithgivenname_c5f2af05ce768ff5512a0902e964d4db(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION RULE-DECLARE-PAGES PZGETEXISTINGDPSWITHGIVENNAME #20180713T141251.303 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PZGETEXISTINGDPSWITHGIVENNAME"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZGETEXISTINGDPSWITHGIVENNAME","Rule-Obj-Report-Definition","RULE-DECLARE-PAGES",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-REPORT-DEFINITION RULE-DECLARE-PAGES PZGETEXISTINGDPSWITHGIVENNAME #20180713T141251.303 GMT","!PZGETEXISTINGDPSWITHGIVENNAME",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",87726865)
	};
...
//	RULE-OBJ-REPORT-DEFINITION RULE-DECLARE-PAGES PZGETEXISTINGDPSWITHGIVENNAME #20180713T141251.303 GMT:20180713T141251.303 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "a10ad7e363d32d850af45186fb4054f4";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION RULE-DECLARE-PAGES PZGETEXISTINGDPSWITHGIVENNAME #20180713T141251.303 GMT", "Rule-Declare-Pages pzGetExistingDPsWithGivenName", "Pega-ProcessArchitect", "08-01-01", "20180713T141251.303 GMT");
}
