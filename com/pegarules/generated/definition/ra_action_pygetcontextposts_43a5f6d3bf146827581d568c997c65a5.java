...
public class ra_action_pygetcontextposts_43a5f6d3bf146827581d568c997c65a5  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pyGetContextPosts.PegaSocial_Post_Private.Action");
	public ra_action_pygetcontextposts_43a5f6d3bf146827581d568c997c65a5(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION PEGASOCIAL-POST-PRIVATE PYGETCONTEXTPOSTS #20200205T093650.430 GMT	Pega-Social:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYGETCONTEXTPOSTS","Rule-Obj-Report-Definition","PEGASOCIAL-POST-PRIVATE",false,"","Pega-Social","08-05-01","RULE-OBJ-REPORT-DEFINITION PEGASOCIAL-POST-PRIVATE PYGETCONTEXTPOSTS #20200205T093650.430 GMT","!PYGETCONTEXTPOSTS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",992866412)
	};
...
//	RULE-OBJ-REPORT-DEFINITION PEGASOCIAL-POST-PRIVATE PYGETCONTEXTPOSTS #20200205T093650.430 GMT:20200522T132246.116 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "2b7731da6c14212b33c7344c7b8e029d";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION PEGASOCIAL-POST-PRIVATE PYGETCONTEXTPOSTS #20200205T093650.430 GMT", "PegaSocial-Post-Private pyGetContextPosts", "Pega-Social", "08-05-01", "20200522T132246.116 GMT");
}
