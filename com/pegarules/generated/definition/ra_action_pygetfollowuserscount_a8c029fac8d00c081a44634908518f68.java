...
public class ra_action_pygetfollowuserscount_a8c029fac8d00c081a44634908518f68  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pyGetFollowUsersCount.Link_Association_Follow.Action");
	public ra_action_pygetfollowuserscount_a8c029fac8d00c081a44634908518f68(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION LINK-ASSOCIATION-FOLLOW PYGETFOLLOWUSERSCOUNT #20210203T073429.502 GMT	Pega-ProcessEngine:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PYGETFOLLOWUSERSCOUNT"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYGETFOLLOWUSERSCOUNT","Rule-Obj-Report-Definition","LINK-ASSOCIATION-FOLLOW",false,"","Pega-ProcessEngine","08-06-01","RULE-OBJ-REPORT-DEFINITION LINK-ASSOCIATION-FOLLOW PYGETFOLLOWUSERSCOUNT #20210203T073429.502 GMT","!PYGETFOLLOWUSERSCOUNT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1839244590)
	};
...
//	RULE-OBJ-REPORT-DEFINITION LINK-ASSOCIATION-FOLLOW PYGETFOLLOWUSERSCOUNT #20210203T073429.502 GMT:20210203T073429.502 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "67d3a49f4f1a030668fd43b7cc61fcd0";
	}

	public String getDefinitionAppliesToClass() {
		return "Link-Association-Follow";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION LINK-ASSOCIATION-FOLLOW PYGETFOLLOWUSERSCOUNT #20210203T073429.502 GMT", "Link-Association-Follow pyGetFollowUsersCount", "Pega-ProcessEngine", "08-06-01", "20210203T073429.502 GMT");
}
