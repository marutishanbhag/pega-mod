...
public class ra_action_pyoperatorsbyworkgroup_0af00e5db9d757912fed6787403da93b  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pyOperatorsByWorkGroup.Data_Admin_Operator_ID.Action");
	public ra_action_pyoperatorsbyworkgroup_0af00e5db9d757912fed6787403da93b(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PYOPERATORSBYWORKGROUP #20180713T134937.063 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PYOPERATORSBYWORKGROUP"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYOPERATORSBYWORKGROUP","Rule-Obj-Report-Definition","DATA-ADMIN-OPERATOR-ID",false,"","Pega-EndUserUI","08-01-01","RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PYOPERATORSBYWORKGROUP #20180713T134937.063 GMT","!PYOPERATORSBYWORKGROUP",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1371757522)
	};
...
//	RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PYOPERATORSBYWORKGROUP #20180713T134937.063 GMT:20180713T134937.063 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "7696e666ea5a3bf03178c6322f016bd7";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PYOPERATORSBYWORKGROUP #20180713T134937.063 GMT", "Data-Admin-Operator-ID pyOperatorsByWorkGroup", "Pega-EndUserUI", "08-01-01", "20180713T134937.063 GMT");
}
