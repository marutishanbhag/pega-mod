...
public class ra_action_pzgetmentioneduserposts_c758b9b22da038dd5337b8f665e9643d  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pzGetMentionedUserPosts.Data_Social_References.Action");
	public ra_action_pzgetmentioneduserposts_c758b9b22da038dd5337b8f665e9643d(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION DATA-SOCIAL-REFERENCES PZGETMENTIONEDUSERPOSTS #20180713T134545.640 GMT	Pega-Social:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PZGETMENTIONEDUSERPOSTS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZGETMENTIONEDUSERPOSTS","Rule-Obj-Report-Definition","DATA-SOCIAL-REFERENCES",false,"","Pega-Social","08-01-01","RULE-OBJ-REPORT-DEFINITION DATA-SOCIAL-REFERENCES PZGETMENTIONEDUSERPOSTS #20180713T134545.640 GMT","!PZGETMENTIONEDUSERPOSTS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-316692356)
	};
...
//	RULE-OBJ-REPORT-DEFINITION DATA-SOCIAL-REFERENCES PZGETMENTIONEDUSERPOSTS #20180713T134545.640 GMT:20180713T134545.640 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "0c94d832a1664d1308599663443f8bbb";
	}

	public String getDefinitionAppliesToClass() {
		return "Data-Social-References";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION DATA-SOCIAL-REFERENCES PZGETMENTIONEDUSERPOSTS #20180713T134545.640 GMT", "Data-Social-References pzGetMentionedUserPosts", "Pega-Social", "08-01-01", "20180713T134545.640 GMT");
}
