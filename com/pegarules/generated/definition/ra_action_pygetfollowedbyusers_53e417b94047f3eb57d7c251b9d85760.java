...
public class ra_action_pygetfollowedbyusers_53e417b94047f3eb57d7c251b9d85760  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pyGetFollowedByUsers.Data_Admin_Operator_ID.Action");
	public ra_action_pygetfollowedbyusers_53e417b94047f3eb57d7c251b9d85760(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PYGETFOLLOWEDBYUSERS #20210203T073429.439 GMT	Pega-ProcessEngine:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PYGETFOLLOWEDBYUSERS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYGETFOLLOWEDBYUSERS","Rule-Obj-Report-Definition","DATA-ADMIN-OPERATOR-ID",false,"","Pega-ProcessEngine","08-06-01","RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PYGETFOLLOWEDBYUSERS #20210203T073429.439 GMT","!PYGETFOLLOWEDBYUSERS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1555797340)
	};
...
//	RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PYGETFOLLOWEDBYUSERS #20210203T073429.439 GMT:20210203T073429.439 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "f84eab400eccf17a7e81447d9fadbcc7";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PYGETFOLLOWEDBYUSERS #20210203T073429.439 GMT", "Data-Admin-Operator-ID pyGetFollowedByUsers", "Pega-ProcessEngine", "08-06-01", "20210203T073429.439 GMT");
}
