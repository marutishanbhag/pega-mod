...
public class ra_action_pzorganizationlisting_298a0de64e3aee3e23644469423a8a88  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pzOrganizationListing.Data_Admin_Organization.Action");
	public ra_action_pzorganizationlisting_298a0de64e3aee3e23644469423a8a88(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-ORGANIZATION PZORGANIZATIONLISTING #20180713T142056.982 GMT	Pega-AppDefinition:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PZORGANIZATIONLISTING"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZORGANIZATIONLISTING","Rule-Obj-Report-Definition","DATA-ADMIN-ORGANIZATION",false,"","Pega-AppDefinition","08-01-01","RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-ORGANIZATION PZORGANIZATIONLISTING #20180713T142056.982 GMT","!PZORGANIZATIONLISTING",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-551812967)
	};
...
//	RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-ORGANIZATION PZORGANIZATIONLISTING #20180713T142056.982 GMT:20180713T142056.982 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "13cc67365a213090f384500f71ccfa7d";
	}

	public String getDefinitionAppliesToClass() {
		return "Data-Admin-Organization";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-ORGANIZATION PZORGANIZATIONLISTING #20180713T142056.982 GMT", "Data-Admin-Organization pzOrganizationListing", "Pega-AppDefinition", "08-01-01", "20180713T142056.982 GMT");
}
