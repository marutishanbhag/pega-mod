...
public class ra_action_pzgettotalrulecount_798027c68d8e7860ef61004e2183f36f  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pzgetTotalRuleCount.Data_Rule_Summary.Action");
	public ra_action_pzgettotalrulecount_798027c68d8e7860ef61004e2183f36f(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION DATA-RULE-SUMMARY PZGETTOTALRULECOUNT #20180713T135732.928 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PZGETTOTALRULECOUNT"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZGETTOTALRULECOUNT","Rule-Obj-Report-Definition","DATA-RULE-SUMMARY",false,"","Pega-SystemArchitect","08-01-01","RULE-OBJ-REPORT-DEFINITION DATA-RULE-SUMMARY PZGETTOTALRULECOUNT #20180713T135732.928 GMT","!PZGETTOTALRULECOUNT",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-237006770)
	};
...
//	RULE-OBJ-REPORT-DEFINITION DATA-RULE-SUMMARY PZGETTOTALRULECOUNT #20180713T135732.928 GMT:20180713T135732.928 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "4086c57a6a80ee5507d5e3ae5c22a681";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION DATA-RULE-SUMMARY PZGETTOTALRULECOUNT #20180713T135732.928 GMT", "Data-Rule-Summary pzgetTotalRuleCount", "Pega-SystemArchitect", "08-01-01", "20180713T135732.928 GMT");
}
