...
public class ra_action_pyworklistall_b122964271bd713acd2448981860fc37  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pyWorkListAll.Assign_Worklist.Action");
	public ra_action_pyworklistall_b122964271bd713acd2448981860fc37(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION ASSIGN-WORKLIST PYWORKLISTALL #20180713T134936.997 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PYWORKLISTALL"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYWORKLISTALL","Rule-Obj-Report-Definition","ASSIGN-WORKLIST",false,"","Pega-EndUserUI","08-01-01","RULE-OBJ-REPORT-DEFINITION ASSIGN-WORKLIST PYWORKLISTALL #20180713T134936.997 GMT","!PYWORKLISTALL",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",243420958)
	};
...
//	RULE-OBJ-REPORT-DEFINITION ASSIGN-WORKLIST PYWORKLISTALL #20180713T134936.997 GMT:20180713T134936.997 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "cc4d61b5f7ac2c600762bbe43fb81324";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION ASSIGN-WORKLIST PYWORKLISTALL #20180713T134936.997 GMT", "Assign-Worklist pyWorkListAll", "Pega-EndUserUI", "08-01-01", "20180713T134936.997 GMT");
}
