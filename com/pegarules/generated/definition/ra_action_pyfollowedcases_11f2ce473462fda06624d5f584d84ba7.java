...
public class ra_action_pyfollowedcases_11f2ce473462fda06624d5f584d84ba7  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pyFollowedCases.Work_.Action");
	public ra_action_pyfollowedcases_11f2ce473462fda06624d5f584d84ba7(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION WORK- PYFOLLOWEDCASES #20180713T134941.721 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PYFOLLOWEDCASES"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYFOLLOWEDCASES","Rule-Obj-Report-Definition","WORK-",false,"","Pega-EndUserUI","08-01-01","RULE-OBJ-REPORT-DEFINITION WORK- PYFOLLOWEDCASES #20180713T134941.721 GMT","!PYFOLLOWEDCASES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",970859882)
	};
...
//	RULE-OBJ-REPORT-DEFINITION WORK- PYFOLLOWEDCASES #20180713T134941.721 GMT:20180713T134941.721 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "aed0133c05dec84ba81c41dbf5007bc9";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION WORK- PYFOLLOWEDCASES #20180713T134941.721 GMT", "Work- pyFollowedCases", "Pega-EndUserUI", "08-01-01", "20180713T134941.721 GMT");
}
