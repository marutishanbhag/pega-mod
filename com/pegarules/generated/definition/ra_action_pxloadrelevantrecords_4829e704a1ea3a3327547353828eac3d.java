...
public class ra_action_pxloadrelevantrecords_4829e704a1ea3a3327547353828eac3d  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pxLoadRelevantRecords.Rule_Obj_ServiceLevel.Action");
	public ra_action_pxloadrelevantrecords_4829e704a1ea3a3327547353828eac3d(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION RULE-OBJ-SERVICELEVEL PXLOADRELEVANTRECORDS #20181012T065945.811 GMT	Pega-Desktop:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXLOADRELEVANTRECORDS","Rule-Obj-Report-Definition","RULE-OBJ-SERVICELEVEL",false,"","Pega-Desktop","08-02-01","RULE-OBJ-REPORT-DEFINITION RULE-OBJ-SERVICELEVEL PXLOADRELEVANTRECORDS #20181012T065945.811 GMT","!PXLOADRELEVANTRECORDS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-704105539)
	};
...
//	RULE-OBJ-REPORT-DEFINITION RULE-OBJ-SERVICELEVEL PXLOADRELEVANTRECORDS #20181012T065945.811 GMT:20181012T065945.811 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "7d588cdcf64d633fba087c65ac0c882c";
	}

	public String getDefinitionAppliesToClass() {
		return "Rule-Obj-ServiceLevel";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION RULE-OBJ-SERVICELEVEL PXLOADRELEVANTRECORDS #20181012T065945.811 GMT", "Rule-Obj-ServiceLevel pxLoadRelevantRecords", "Pega-Desktop", "08-02-01", "20181012T065945.811 GMT");
}
