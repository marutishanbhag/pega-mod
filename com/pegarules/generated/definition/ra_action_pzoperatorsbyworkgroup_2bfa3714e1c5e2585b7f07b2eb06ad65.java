...
public class ra_action_pzoperatorsbyworkgroup_2bfa3714e1c5e2585b7f07b2eb06ad65  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pzOperatorsByWorkGroup.Data_Admin_Operator_ID.Action");
	public ra_action_pzoperatorsbyworkgroup_2bfa3714e1c5e2585b7f07b2eb06ad65(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PZOPERATORSBYWORKGROUP #20200916T124419.085 GMT	Pega-LP-Application:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PZOPERATORSBYWORKGROUP"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZOPERATORSBYWORKGROUP","Rule-Obj-Report-Definition","DATA-ADMIN-OPERATOR-ID",false,"","Pega-LP-Application","08-06-01","RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PZOPERATORSBYWORKGROUP #20200916T124419.085 GMT","!PZOPERATORSBYWORKGROUP",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-111346944)
	};
...
//	RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PZOPERATORSBYWORKGROUP #20200916T124419.085 GMT:20200916T124419.085 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "08d200e8a7b2f080d74b781f9ce38994";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PZOPERATORSBYWORKGROUP #20200916T124419.085 GMT", "Data-Admin-Operator-ID pzOperatorsByWorkGroup", "Pega-LP-Application", "08-06-01", "20200916T124419.085 GMT");
}
