...
public class ra_action_pzorgdivisionsfororg_c3b9558d91acc16848aeaa4b9e3759d4  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pzOrgDivisionsForOrg.Data_Admin_OrgDivision.Action");
	public ra_action_pzorgdivisionsfororg_c3b9558d91acc16848aeaa4b9e3759d4(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-ORGDIVISION PZORGDIVISIONSFORORG #20180713T141250.518 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PZORGDIVISIONSFORORG"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZORGDIVISIONSFORORG","Rule-Obj-Report-Definition","DATA-ADMIN-ORGDIVISION",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-ORGDIVISION PZORGDIVISIONSFORORG #20180713T141250.518 GMT","!PZORGDIVISIONSFORORG",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-724054197)
	};
...
//	RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-ORGDIVISION PZORGDIVISIONSFORORG #20180713T141250.518 GMT:20180713T141250.518 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "fe47f26ddb455120827199f91ffb4d32";
	}

	public String getDefinitionAppliesToClass() {
		return "Data-Admin-OrgDivision";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-ORGDIVISION PZORGDIVISIONSFORORG #20180713T141250.518 GMT", "Data-Admin-OrgDivision pzOrgDivisionsForOrg", "Pega-ProcessArchitect", "08-01-01", "20180713T141250.518 GMT");
}
