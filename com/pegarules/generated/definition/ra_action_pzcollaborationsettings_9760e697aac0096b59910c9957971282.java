...
public class ra_action_pzcollaborationsettings_9760e697aac0096b59910c9957971282  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pzCollaborationSettings.Data_Collaboration.Action");
	public ra_action_pzcollaborationsettings_9760e697aac0096b59910c9957971282(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION DATA-COLLABORATION PZCOLLABORATIONSETTINGS #20190910T090200.217 GMT	Pega-ProcessEngine:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PZCOLLABORATIONSETTINGS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZCOLLABORATIONSETTINGS","Rule-Obj-Report-Definition","DATA-COLLABORATION",false,"","Pega-ProcessEngine","08-04-01","RULE-OBJ-REPORT-DEFINITION DATA-COLLABORATION PZCOLLABORATIONSETTINGS #20190910T090200.217 GMT","!PZCOLLABORATIONSETTINGS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-693633972)
	};
...
//	RULE-OBJ-REPORT-DEFINITION DATA-COLLABORATION PZCOLLABORATIONSETTINGS #20190910T090200.217 GMT:20190910T090200.217 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "d084238bc206a092b9e38b13386103f9";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION DATA-COLLABORATION PZCOLLABORATIONSETTINGS #20190910T090200.217 GMT", "Data-Collaboration pzCollaborationSettings", "Pega-ProcessEngine", "08-04-01", "20190910T090200.217 GMT");
}
