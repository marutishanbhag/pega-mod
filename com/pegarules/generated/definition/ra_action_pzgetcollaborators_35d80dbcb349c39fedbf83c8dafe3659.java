...
public class ra_action_pzgetcollaborators_35d80dbcb349c39fedbf83c8dafe3659  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pzGetCollaborators.Log_Collaboration.Action");
	public ra_action_pzgetcollaborators_35d80dbcb349c39fedbf83c8dafe3659(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION LOG-COLLABORATION PZGETCOLLABORATORS #20180713T141250.884 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PZGETCOLLABORATORS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZGETCOLLABORATORS","Rule-Obj-Report-Definition","LOG-COLLABORATION",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-REPORT-DEFINITION LOG-COLLABORATION PZGETCOLLABORATORS #20180713T141250.884 GMT","!PZGETCOLLABORATORS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1008867661)
	};
...
//	RULE-OBJ-REPORT-DEFINITION LOG-COLLABORATION PZGETCOLLABORATORS #20180713T141250.884 GMT:20180713T141250.884 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "f1bf3cb1443e615d5584d4c7e445f96f";
	}

	public String getDefinitionAppliesToClass() {
		return "Log-Collaboration";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION LOG-COLLABORATION PZGETCOLLABORATORS #20180713T141250.884 GMT", "Log-Collaboration pzGetCollaborators", "Pega-ProcessArchitect", "08-01-01", "20180713T141250.884 GMT");
}
