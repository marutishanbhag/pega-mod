...
public class ra_action_pxadduserstoapplicationsearch_6fe40fe952b3ac71e495248ac9b9a156  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pxAddUsersToApplicationSearch.Data_Admin_Operator_ID.Action");
	public ra_action_pxadduserstoapplicationsearch_6fe40fe952b3ac71e495248ac9b9a156(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PXADDUSERSTOAPPLICATIONSEARCH #20180713T141250.493 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PXADDUSERSTOAPPLICATIONSEARCH"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXADDUSERSTOAPPLICATIONSEARCH","Rule-Obj-Report-Definition","DATA-ADMIN-OPERATOR-ID",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PXADDUSERSTOAPPLICATIONSEARCH #20180713T141250.493 GMT","!PXADDUSERSTOAPPLICATIONSEARCH",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1748016702)
	};
...
//	RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PXADDUSERSTOAPPLICATIONSEARCH #20180713T141250.493 GMT:20180713T141250.493 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "69e49b38470f24767904a2c56123a804";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION DATA-ADMIN-OPERATOR-ID PXADDUSERSTOAPPLICATIONSEARCH #20180713T141250.493 GMT", "Data-Admin-Operator-ID pxAddUsersToApplicationSearch", "Pega-ProcessArchitect", "08-01-01", "20180713T141250.493 GMT");
}
