...
public class ra_action_pyavailableworkstatus_bf7db5a1c57b25a94a904f6978aaee8c  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pyAvailableWorkStatus.Rule_Obj_FieldValue.Action");
	public ra_action_pyavailableworkstatus_bf7db5a1c57b25a94a904f6978aaee8c(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION RULE-OBJ-FIELDVALUE PYAVAILABLEWORKSTATUS #20180713T141251.777 GMT	Pega-ProcessArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Report-Definition:PYAVAILABLEWORKSTATUS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYAVAILABLEWORKSTATUS","Rule-Obj-Report-Definition","RULE-OBJ-FIELDVALUE",false,"","Pega-ProcessArchitect","08-01-01","RULE-OBJ-REPORT-DEFINITION RULE-OBJ-FIELDVALUE PYAVAILABLEWORKSTATUS #20180713T141251.777 GMT","!PYAVAILABLEWORKSTATUS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1405197440)
	};
...
//	RULE-OBJ-REPORT-DEFINITION RULE-OBJ-FIELDVALUE PYAVAILABLEWORKSTATUS #20180713T141251.777 GMT:20180713T141251.777 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "9ef86d3c13efdcd0e72f719d983f8892";
	}

	public String getDefinitionAppliesToClass() {
		return "Rule-Obj-FieldValue";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION RULE-OBJ-FIELDVALUE PYAVAILABLEWORKSTATUS #20180713T141251.777 GMT", "Rule-Obj-FieldValue pyAvailableWorkStatus", "Pega-ProcessArchitect", "08-01-01", "20180713T141251.777 GMT");
}
