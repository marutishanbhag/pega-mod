...
public class ra_action_pxloadrelevantrecords_692cb84196417643fb968ce27324624a  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pxLoadRelevantRecords.Rule_Obj_When.Action");
	public ra_action_pxloadrelevantrecords_692cb84196417643fb968ce27324624a(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
{
/* Instance RULE-OBJ-REPORT-DEFINITION RULE-OBJ-WHEN PXLOADRELEVANTRECORDS #20180817T095339.566 GMT	Pega-Desktop:08-02-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	try {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXLOADRELEVANTRECORDS","Rule-Obj-Report-Definition","RULE-OBJ-WHEN",false,"","Pega-Desktop","08-02-01","RULE-OBJ-REPORT-DEFINITION RULE-OBJ-WHEN PXLOADRELEVANTRECORDS #20180817T095339.566 GMT","!PXLOADRELEVANTRECORDS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",126049262)
	};
...
//	RULE-OBJ-REPORT-DEFINITION RULE-OBJ-WHEN PXLOADRELEVANTRECORDS #20180817T095339.566 GMT:20180817T095339.566 GMT
...
//	RULE-UTILITY-FUNCTION DATAACCESSFUA DATAACCESSMETHODINIT #20180713T132723.131 GMT:20180713T132723.131 GMT
	...
	public static String getFUAContentHash() {
		return "8b5b2f8a6e788c7c501976daf0029099";
	}

	public String getDefinitionAppliesToClass() {
		return "Rule-Obj-When";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION RULE-OBJ-WHEN PXLOADRELEVANTRECORDS #20180817T095339.566 GMT", "Rule-Obj-When pxLoadRelevantRecords", "Pega-Desktop", "08-02-01", "20180817T095339.566 GMT");
}
