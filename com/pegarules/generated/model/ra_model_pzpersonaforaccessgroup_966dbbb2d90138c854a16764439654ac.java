...
public class ra_model_pzpersonaforaccessgroup_966dbbb2d90138c854a16764439654ac extends AbstractModel implements Activity, FUASupport, FUAReusable, MetadataAvail {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Model.pzPersonaForAccessGroup.Rule_Persona.Model");
	public ra_model_pzpersonaforaccessgroup_966dbbb2d90138c854a16764439654ac(PegaAPI aContext) {
...
{
/* Instance RULE-OBJ-MODEL RULE-PERSONA PZPERSONAFORACCESSGROUP #20200504T123201.866 GMT	Pega-AppDefinition:08-05-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
ClipboardProperty pz_1 = pega.findPageWithException("D_pxPersonas", "Rule-Persona").getIfPresent("pxResults");
foreach_prop_1 = pz_1;
...
try {
/* push '"D_pxPersonas.pxResults(<CURRENT>)"' to scope TARGET */
ClipboardPage ctxt_page_target_1 = null;
ctxt_page_target_1 = ctxt_page_1;
pop_ctxt_page_1 = pega.pushScopedStepContext("TARGET", "D_pxPersonas.pxResults(<CURRENT>)", ctxt_page_target_1);
/* push '"D_pxPersonas.pxResults(<CURRENT>)"' to scope SOURCE */
ClipboardPage ctxt_page_source_1 = null;
ctxt_page_source_1 = ctxt_page_1;
pop_ctxt_page_2 = pega.pushScopedStepContext("SOURCE", "D_pxPersonas.pxResults(<CURRENT>)", ctxt_page_source_1);
...
try {	// When
pega.activityStepWhenExpressionProlog(pz_CurrentTraceInfo, ".pyAccessGroup==Param.AccessGroup");
try {
boolean pz_3 = (scalarValueQuery_2.resolveToString(tools, myStepPage, ImmutablePropertyInfo.TYPE_TEXT).equals(tools.getParamValue("AccessGroup")));
pega.activityStepWhenExpressionEpilog(pz_CurrentTraceInfo, ".pyAccessGroup==Param.AccessGroup",pz_3);
return pz_3;
} catch (RuntimeException anyException) {
oLog.error("Exception caught while evaluating when", anyException);
throw new IndeterminateConditionalException(".pyAccessGroup==Param.AccessGroup " + anyException.getMessage(), anyException);
}
} finally {
...
actionProlog(pz_CurrentTraceInfo,"1.1.1", "Set Primary.pyPurpose", source_1, target_2);
{
    String pzSourceVar4 = "";
    ...
    try {
        ...
        pega.setViaPropRef(".pyPurpose", pRef_6, tools.getPrimaryPage(), pzSourceVar4, "sTN64", false, true);
    } finally {
        myStepPage = pega.popStackFrameAndReturnStepPage(ctxt_frame_4);
    }
}

actionEpilog(pz_CurrentTraceInfo,"1.1.1", "Set Primary.pyPurpose", source_1, target_2);
...
actionProlog(pz_CurrentTraceInfo,"1.1.2", "Set Primary.pyLabel", source_2, target_3);
{
    String pzSourceVar8 = "";
    ...
    try {
        ...
        pega.setViaPropRef(".pyLabel", pRef_10, tools.getPrimaryPage(), pzSourceVar8, "sTN64", false, true);
    } finally {
        myStepPage = pega.popStackFrameAndReturnStepPage(ctxt_frame_8);
    }
}

actionEpilog(pz_CurrentTraceInfo,"1.1.2", "Set Primary.pyLabel", source_2, target_3);
actionProlog(pz_CurrentTraceInfo,"1.1.3", "Exit Data Transform", null, null);
actionEpilog(pz_CurrentTraceInfo,"1.1.3", "Exit Data Transform", null, null);
// Exit model
return CODE_EXIT_MODEL;
...
private static final String oDependencies [] = {
	"Rule-Obj-Model:PZPERSONAFORACCESSGROUP"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		new DependentRuleInfo("PZPERSONAFORACCESSGROUP","Rule-Obj-Model","RULE-PERSONA",false,"","Pega-AppDefinition","08-05-01","RULE-OBJ-MODEL RULE-PERSONA PZPERSONAFORACCESSGROUP #20200504T123201.866 GMT","!PZPERSONAFORACCESSGROUP",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2030228496)
	};
...
//	RULE-OBJ-MODEL RULE-PERSONA PZPERSONAFORACCESSGROUP #20200504T123201.866 GMT:20200504T123201.866 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES PXGETTREESUBSCRIPT #20180713T132724.923 GMT:20180713T132724.923 GMT
	...
	public static String getFUAContentHash() {
		return "1de9116905e4e22f7b3a6b78c3bfcf06";
	}
...
public static final String[] pRef_6 = new String[] { "", "", "pyPurpose", "" };
...
private static final ScalarValueQuery scalarValueQuery_2 = FUAUtil.createQueryBuilder().scalarProperty("pyAccessGroup").buildScalarValueQuery();
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-MODEL RULE-PERSONA PZPERSONAFORACCESSGROUP #20200504T123201.866 GMT", "Rule-Persona pzPersonaForAccessGroup", "Pega-AppDefinition", "08-05-01", "20200504T123201.866 GMT");
}
