...
public class ra_model_pzpostrmaction_030165086a6cf357926cf5f6a4fe65d7 extends AbstractModel implements Activity, FUASupport, FUAReusable, MetadataAvail {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Model.pzPostRMAction.Rule_.Model");
	public ra_model_pzpostrmaction_030165086a6cf357926cf5f6a4fe65d7(PegaAPI aContext) {
...
{
/* Instance RULE-OBJ-MODEL RULE- PZPOSTRMACTION #20180713T135526.346 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
...
actionProlog(pz_CurrentTraceInfo,"1.1.3", "Set .pzDocumentKey", source_1, target_3);
{
    pega.setViaPropRef(".pzDocumentKey", pRef_8, myStepPage, scalarValueQuery_9.resolveToString(tools, pega.findPageWithException("pyWorkPage", "Work-ProjectManagement"), ImmutablePropertyInfo.TYPE_TEXT), "sTN", false, true);
}

actionEpilog(pz_CurrentTraceInfo,"1.1.3", "Set .pzDocumentKey", source_1, target_3);
return CODE_CONTINUE;
...
actionProlog(pz_CurrentTraceInfo,"1.1.1.1", "Set .pyRecover", source_2, target_4);
{
    ...
    try {
        ...
        pega.setViaPropRef(".pyRecover", pRef_12, myStepPage, pzSourceVar11, "sSN", false, true);
    } finally {
        myStepPage = pega.popStackFrameAndReturnStepPage(ctxt_frame_4);
    }
}

actionEpilog(pz_CurrentTraceInfo,"1.1.1.1", "Set .pyRecover", source_2, target_4);
...
actionProlog(pz_CurrentTraceInfo,"1.1.1.2", "Set .pyRefresh", source_3, target_5);
{
    ...
    try {
        ...
        pega.setViaPropRef(".pyRefresh", pRef_15, myStepPage, pzSourceVar14, "sSN", false, true);
    } finally {
        myStepPage = pega.popStackFrameAndReturnStepPage(ctxt_frame_6);
    }
}

actionEpilog(pz_CurrentTraceInfo,"1.1.1.2", "Set .pyRefresh", source_3, target_5);
...
actionProlog(pz_CurrentTraceInfo,"1.1.1.3", "Set .pyBranchOut", source_4, target_6);
{
    ...
    try {
        ...
        pega.setViaPropRef(".pyBranchOut", pRef_18, myStepPage, pzSourceVar17, "sSN", false, true);
    } finally {
        myStepPage = pega.popStackFrameAndReturnStepPage(ctxt_frame_8);
    }
}

actionEpilog(pz_CurrentTraceInfo,"1.1.1.3", "Set .pyBranchOut", source_4, target_6);
return CODE_CONTINUE;
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		new DependentRuleInfo("PZPOSTRMACTION","Rule-Obj-Model","RULE-",false,"","Pega-Desktop","08-01-01","RULE-OBJ-MODEL RULE- PZPOSTRMACTION #20180713T135526.346 GMT","!PZPOSTRMACTION",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1529739292)
	};
...
//	RULE-OBJ-MODEL RULE- PZPOSTRMACTION #20180713T135526.346 GMT:20180713T135526.346 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES PXGETTREESUBSCRIPT #20180713T132724.923 GMT:20180713T132724.923 GMT
	...
	public static String getFUAContentHash() {
		return "cb8d8e3cc74469ad947ffe57e5b1ba27";
	}
...
public static final String[] pRef_10 = new String[] { "", "", "pyRulePage", "", "pzDocumentKey", "" };
public static final String[] pRef_15 = new String[] { "", "", "pyRefresh", "" };
public static final String[] pRef_18 = new String[] { "", "", "pyBranchOut", "" };
public static final String[] pRef_8 = new String[] { "", "", "pzDocumentKey", "" };
public static final String[] pRef_12 = new String[] { "", "", "pyRecover", "" };
...
private static final ScalarValueQuery scalarValueQuery_9 = FUAUtil.createQueryBuilder().page("pyRulePage").scalarProperty("pzDocumentKey").buildScalarValueQuery();

private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-MODEL RULE- PZPOSTRMACTION #20180713T135526.346 GMT", "Rule- pzPostRMAction", "Pega-Desktop", "08-01-01", "20180713T135526.346 GMT");
}
