...
/**
 * Builds JSP stream PZPROMPTSELECTPARAMREQ.
 */
public class ra_stream_pzpromptselectparamreq_8db6c599aafd02a80d613bbe7a566adf extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Property.pzPromptSelectParamReq.Stream");
 ...
 */
	public ra_stream_pzpromptselectparamreq_8db6c599aafd02a80d613bbe7a566adf(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "6d204fa3cbfc117fc62580fc1c4161081fa5410c";
...
{
/* Instance RULE-HTML-PROPERTY PZPROMPTSELECTPARAMREQ #20180713T133635.612 GMT	Pega-UIDesign:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-PROPERTY PZPROMPTSELECTPARAMREQ #20180713T133635.612 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-PROPERTY PZPROMPTSELECTPARAMREQ #20180713T133635.612 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-PROPERTY PZPROMPTSELECTPARAMREQ #20180713T133635.612 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Property:PZPROMPTSELECTPARAMREQ"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZPROMPTSELECTPARAMREQ","Rule-HTML-Property","",false,"","Pega-UIDesign","08-01-01","RULE-HTML-PROPERTY PZPROMPTSELECTPARAMREQ #20180713T133635.612 GMT","PZPROMPTSELECTPARAMREQ",true,false,"ABSOLUTE_CLASSLESS",-2020673056)
	};
...
//	RULE-HTML-PROPERTY PZPROMPTSELECTPARAMREQ #20180713T133635.612 GMT:20180713T133635.612 GMT
//	RULE-OBJ-ACTIVITY RULE- PZASSEMBLEPREPROCESS #20180713T132655.315 GMT:20180713T132655.315 GMT
	...
	public static String getFUAContentHash() {
		return "ab3f0bf82d61de81960869b1d9d86b1a";
	}
...
tools.appendString("<SELECT SIZE=\"1\" STYLE=\"width: 60px\" TITLE='Is this Parameter required?' name=\"");
...
tools.appendString("\" > <OPTION VALUE='-1' ");
	if (when_1("-1")) {
tools.appendString("selected");
	}
tools.appendString(">Yes</OPTION> <OPTION VALUE='0' ");
	if (when_2("0", "")) {
tools.appendString("selected");
	}
tools.appendString(">No</OPTION> </select>");
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-PROPERTY PZPROMPTSELECTPARAMREQ #20180713T133635.612 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzPromptSelectParamReq");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY PZPROMPTSELECTPARAMREQ #20180713T133635.612 GMT", "pzPromptSelectParamReq", "Pega-UIDesign", "08-01-01", "20180713T133635.612 GMT");
}
