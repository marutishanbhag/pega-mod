...
/**
 * Builds JSP stream PZRULESET_POPULATERULESETTYPE.
 */
public class ra_stream_pzruleset_populaterulesettype_db256c3e87eeb839c168c748e719f573 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Property.pzRuleSet_PopulateRuleSetType.Stream");
 ...
 */
	public ra_stream_pzruleset_populaterulesettype_db256c3e87eeb839c168c748e719f573(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "d1bb2b1a3ab0095adb4a9a2b3977b7010ebc6916";
...
{
/* Instance RULE-HTML-PROPERTY PZRULESET_POPULATERULESETTYPE #20180713T135639.684 GMT	Pega-SystemArchitect:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-PROPERTY PZRULESET_POPULATERULESETTYPE #20180713T135639.684 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-PROPERTY PZRULESET_POPULATERULESETTYPE #20180713T135639.684 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-PROPERTY PZRULESET_POPULATERULESETTYPE #20180713T135639.684 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Property:PZRULESET_POPULATERULESETTYPE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZRULESET_POPULATERULESETTYPE","Rule-HTML-Property","",false,"","Pega-SystemArchitect","08-01-01","RULE-HTML-PROPERTY PZRULESET_POPULATERULESETTYPE #20180713T135639.684 GMT","PZRULESET_POPULATERULESETTYPE",true,false,"ABSOLUTE_CLASSLESS",1496974637), 
...
//	RULE-HTML-PROPERTY PZRULESET_POPULATERULESETTYPE #20180713T135639.684 GMT:20180713T135639.684 GMT
...
//	RULE-OBJ-ACTIVITY RULE- PZASSEMBLEPREPROCESS #20180713T132655.315 GMT:20180713T132655.315 GMT
	...
	public static String getFUAContentHash() {
		return "b409689b8d74dafeb55bdf680f1e3b2d";
	}
...
private boolean when_4(String aParam1) throws Throwable {
...
private void choose_2() throws Throwable {
	boolean foundChoice = false;
tools.appendString(" ");
if (!foundChoice && when_1(".pyRuleSetType", "PEGA")) {
tools.appendString(" <select style=\"WIDTH: 80px\" ");
/* Include stream RULE-HTML-PROPERTY CLIENTVALIDATION #20181008T083757.252 GMT */
include_1();

tools.appendString(" id =\"pyRuleSetType\" name='");
 ...
 */
if (_jspx_meth_pega_reference__2(pageContext, "$this-value")) {
	return;
}
tools.appendString("'disabled> <option value=\"PEGA\" selected>Pega</option> </select> ");

foundChoice = !pega.isPreviewMode();
}
tools.appendString(" ");
if (!foundChoice && when_1(".pyRuleSetType", "PEGAFW")) {
tools.appendString(" <select style=\"WIDTH: 80px\" ");
/* Include stream RULE-HTML-PROPERTY CLIENTVALIDATION #20181008T083757.252 GMT */
include_1();
...
tools.appendString("'disabled> <option value=\"PEGAFW\" selected>Pega Framework</option> </select> ");

foundChoice = !pega.isPreviewMode();
}
tools.appendString(" ");
if (!foundChoice && when_1(".pyRuleSetType", "BRANCH")) {
tools.appendString(" <select style=\"WIDTH: 80px\" ");
/* Include stream RULE-HTML-PROPERTY CLIENTVALIDATION #20181008T083757.252 GMT */
include_1();
...
tools.appendString("'disabled> <option value=\"BRANCH\" selected>Branch</option> </select> ");
...
tools.appendString("'> <option value=\"STANDARD\" ");
	if (when_4("STANDARD")) {
tools.appendString("selected");
	}
tools.appendString(">Standard</option> <option value=\"COMPONENT\" ");
	if (when_4("COMPONENT")) {
tools.appendString("selected");
	}
tools.appendString(">Component</option> <option value=\"SHARED\" ");
	if (when_4("SHARED")) {
tools.appendString("selected");
	}
tools.appendString(">Shared</option> ");
	if (when_4("OVERRIDE")) {
tools.appendString(" <option value=\"OVERRIDE\" selected>Override</option> ");
	}
tools.appendString(" </select> ");
}
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-PROPERTY PZRULESET_POPULATERULESETTYPE #20180713T135639.684 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pzRuleSet_PopulateRuleSetType");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY PZRULESET_POPULATERULESETTYPE #20180713T135639.684 GMT", "pzRuleSet_PopulateRuleSetType", "Pega-SystemArchitect", "08-01-01", "20180713T135639.684 GMT");
