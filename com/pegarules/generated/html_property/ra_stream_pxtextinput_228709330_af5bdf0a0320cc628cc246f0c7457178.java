...
public class ra_stream_pxtextinput_228709330_af5bdf0a0320cc628cc246f0c7457178 extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_pxtextinput_228709330_af5bdf0a0320cc628cc246f0c7457178(com.pega.pegarules.priv.PegaAPI aContext) {
							...
							com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
								...
								if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
									try{
										...
										staticURLStr.append("&PreDataTransform=pzSetPropertyNameChangedByUser");
										tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"\", \"");
										refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
										tools.appendString("=\", \"\", \"pzSetPropertyNameChangedByUser,");
										refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
										...
										if(!"".equals(preActParamStr.toString())) {
											...
											if(!"".equals(preDTParamStr.toString())) {
												...
												if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
												pzPackageRuntime.packageDataTransform(tools.getStepPage().getString("pxObjClass"), "pzSetPropertyNameChangedByUser");
												}
