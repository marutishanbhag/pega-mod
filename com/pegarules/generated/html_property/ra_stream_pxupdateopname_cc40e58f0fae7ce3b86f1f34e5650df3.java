...
/**
 * Builds JSP stream PXUPDATEOPNAME.
 */
public class ra_stream_pxupdateopname_cc40e58f0fae7ce3b86f1f34e5650df3 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Property.pxUpdateOpName.Stream");
 ...
 */
	public ra_stream_pxupdateopname_cc40e58f0fae7ce3b86f1f34e5650df3(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "89b7c4eb0a1ec57aa0636256e56251dd5fb0e09f";
...
{
/* Instance RULE-HTML-PROPERTY PXUPDATEOPNAME #20180713T134733.946 GMT	Pega-EndUserUI:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-PROPERTY PXUPDATEOPNAME #20180713T134733.946 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-PROPERTY PXUPDATEOPNAME #20180713T134733.946 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-PROPERTY PXUPDATEOPNAME #20180713T134733.946 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Property:PXUPDATEOPNAME"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXUPDATEOPNAME","Rule-HTML-Property","",false,"","Pega-EndUserUI","08-01-01","RULE-HTML-PROPERTY PXUPDATEOPNAME #20180713T134733.946 GMT","PXUPDATEOPNAME",true,false,"ABSOLUTE_CLASSLESS",-254836377)
	};
...
//	RULE-HTML-PROPERTY PXUPDATEOPNAME #20180713T134733.946 GMT:20180713T134733.946 GMT
//	RULE-OBJ-ACTIVITY RULE- PZASSEMBLEPREPROCESS #20180713T132655.315 GMT:20180713T132655.315 GMT
	...
	public static String getFUAContentHash() {
		return "d8258372d6eb13e98f532a08ea39d346";
	}
...
private void performStream_1() throws Throwable {
	...
	{
		thisValue = tools.getLocalizedTextForString("pxRequestor.pyUserName", thisValue);
	}
	tools.putSaveValue("thisValue", thisValue);


tools.appendString("\n\n\n<label title='");
 tools.appendString(tools.getActive().getParentPage().getString(".pxUpdateOperator")); 
tools.appendString("' >");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-PROPERTY PXUPDATEOPNAME #20180713T134733.946 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pxUpdateOpName");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY PXUPDATEOPNAME #20180713T134733.946 GMT", "pxUpdateOpName", "Pega-EndUserUI", "08-01-01", "20180713T134733.946 GMT");
}
