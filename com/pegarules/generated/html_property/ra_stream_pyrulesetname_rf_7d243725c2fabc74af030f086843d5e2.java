...
/**
 * Builds JSP stream PYRULESETNAME_RF.
 */
public class ra_stream_pyrulesetname_rf_7d243725c2fabc74af030f086843d5e2 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Property.pyRuleSetName_RF.Stream");
 ...
 */
	public ra_stream_pyrulesetname_rf_7d243725c2fabc74af030f086843d5e2(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "b530b185ec851405c7264e91afa66215ce6b50e8";
...
{
/* Instance RULE-HTML-PROPERTY PYRULESETNAME_RF #20180713T132012.986 GMT	Pega-ProCom:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
/*
 * Begin RULE-HTML-PROPERTY PYRULESETNAME_RF #20180713T132012.986 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-PROPERTY PYRULESETNAME_RF #20180713T132012.986 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-PROPERTY PYRULESETNAME_RF #20180713T132012.986 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Property:PYRULESETNAME_RF"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYRULESETNAME_RF","Rule-HTML-Property","",false,"","Pega-ProCom","08-01-01","RULE-HTML-PROPERTY PYRULESETNAME_RF #20180713T132012.986 GMT","PYRULESETNAME_RF",true,false,"ABSOLUTE_CLASSLESS",-1497460338)
	};
...
//	RULE-HTML-PROPERTY PYRULESETNAME_RF #20180713T132012.986 GMT:20180713T132012.986 GMT
//	RULE-OBJ-ACTIVITY RULE- PZASSEMBLEPREPROCESS #20180713T132655.315 GMT:20180713T132655.315 GMT
	...
	public static String getFUAContentHash() {
		return "1a753329df008ba4bcf937dcd75f3518";
	}
...
tools.appendString(" <label>RuleSetName</label> ");

foundChoice_1 = !pega.isPreviewMode();
}
tools.appendString(" ");
if (!foundChoice_1) {
tools.appendString(" <INPUT id=\"pyRuleSetName\" name=\"");
...
tools.appendString("\" value='");
 tools.appendString(StringUtils.crossScriptingFilter(tools.getStepPage().getString("pyRuleSet")));
tools.appendString("'> ");
}
tools.appendString(" ");
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-PROPERTY PYRULESETNAME_RF #20180713T132012.986 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pyRuleSetName_RF");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY PYRULESETNAME_RF #20180713T132012.986 GMT", "pyRuleSetName_RF", "Pega-ProCom", "08-01-01", "20180713T132012.986 GMT");
}
