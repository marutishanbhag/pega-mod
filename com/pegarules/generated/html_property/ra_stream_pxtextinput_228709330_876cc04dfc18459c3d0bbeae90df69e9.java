...
public class ra_stream_pxtextinput_228709330_876cc04dfc18459c3d0bbeae90df69e9 extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_pxtextinput_228709330_876cc04dfc18459c3d0bbeae90df69e9(com.pega.pegarules.priv.PegaAPI aContext) {
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,nameType);}
		...
		tools.appendString(" data-focus='[");if(isBehaviorAdded && true){ tools.appendString(","); }					tools.appendString("[\"showSmartTip\",[\":event\",\"\",\"" + tools.getRuleMessage("pyUpdateURLWarning\t","Rule-Application").replaceAll("\n","<br>").replace("\"","\\\"").replaceAll("'","&#39;") + "\"]");
...
//	RULE-UTILITY-FUNCTION STRING ISLITERAL #20180713T131441.656 GMT:20180713T131441.656 GMT
	...
	public static String getFUAContentHash() {
		return "5b0cf829dc812586a5cd90c9dd08a665";
	}
