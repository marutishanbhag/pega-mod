...
public class ra_stream_pxtextinput_228709330_c7260f84731fa8a61395d53a3a18f6c2 extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_pxtextinput_228709330_c7260f84731fa8a61395d53a3a18f6c2(com.pega.pegarules.priv.PegaAPI aContext) {
		...
		tools.appendString(" data-change='[");if(isBehaviorAdded && true){ tools.appendString(","); }						{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
							com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
								...
								if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
									try{
										pzPackageRuntime.packageSection("pzPicklistPromptTableListInput",
										...
										staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzPicklistPromptTableListInput"));
										staticURLStr.append("&PreDataTransform=pzSetStandardValue");
										tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"\", \"");
										refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
										tools.appendString("=\", \"\", \"pzSetStandardValue,");
										refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
										...
										if(!"".equals(preActParamStr.toString())) {
											...
											if(!"".equals(preDTParamStr.toString())) {
												...
												if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
												pzPackageRuntime.packageDataTransform(tools.getStepPage().getString("pxObjClass"), "pzSetStandardValue");
												}
...
//	RULE-UTILITY-FUNCTION STRING ISLITERAL #20180713T131441.656 GMT:20180713T131441.656 GMT
	...
	public static String getFUAContentHash() {
		return "fbabc4d111591c92a5fdd2c6a08c9806";
	}
