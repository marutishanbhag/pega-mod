...
public class ra_stream_pxtextinput_228709330_4facfb39fbe1fe1cc579d1b2557f734d extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_pxtextinput_228709330_4facfb39fbe1fe1cc579d1b2557f734d(com.pega.pegarules.priv.PegaAPI aContext) {
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,nameType);}
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }												tools.appendString("[\"runScript\", [\"pega.p.highlightPulseSearchKeyword(");
												String strPropReference81 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pySearchText")+"~#";
												...
												tools.appendString(",");
												String strPropReference82 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyCount")+"~#";
												String strFormattedPropReference82 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference82);
												if(strPropReference82.equals(strFormattedPropReference82)) {
												tools.appendString("\\\"");
												tools.appendFormatted(strFormattedPropReference82.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
												tools.appendString("\\\"");
												} else {
												tools.appendFormatted(strFormattedPropReference82.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
												}
...
//	RULE-UTILITY-FUNCTION STRING ISLITERAL #20180713T131441.656 GMT:20180713T131441.656 GMT
	...
	public static String getFUAContentHash() {
		return "f8f2aaab65a5b3630f983a700d729a05";
	}
