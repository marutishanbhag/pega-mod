...
public class ra_stream_pxtextinput_228709330_25f2b246d8173ad3ad78846e86baecaa extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_pxtextinput_228709330_25f2b246d8173ad3ad78846e86baecaa(com.pega.pegarules.priv.PegaAPI aContext) {
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,nameType);}
		...
		tools.appendString(" data-keyup='[");if(isBehaviorAdded && true){ tools.appendString(","); }					tools.appendString("[\"runScript\", [\"pega.ui.TemplateGrids.toggleClearButton(event)\"]");

		tools.appendString(",");
		tools.appendString(",\"any\"");
		tools.appendString("]");isBehaviorAdded = true;
		tools.appendString("]' ");isBehaviorAdded = false;
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }					tools.appendString("[\"runScript\", [\"pega.ui.TemplateGrids.searchGrid(event,");
					String strPropReference42 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyID")+"~#";
					...
					tools.appendString(",");
					String strPropReference43 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pySearchKeyword")+"~#";
		...
		try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_controlAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
			...
			ct_controlAction.trackValueChanges(tools.getProperty(".pySearchKeyword"), -1);
...
//	RULE-UTILITY-FUNCTION STRING ISLITERAL #20180713T131441.656 GMT:20180713T131441.656 GMT
	...
	public static String getFUAContentHash() {
		return "40742b0ff3ddbdf2d9addeae9c5b6687";
	}
