...
public class ra_stream_pxtextinput_228709330_2c021faf26df5f0dc7de16961a9217e9 extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_pxtextinput_228709330_2c021faf26df5f0dc7de16961a9217e9(com.pega.pegarules.priv.PegaAPI aContext) {
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
							...
							com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
								...
								if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
									try{
										pzPackageRuntime.packageSection("pzViewAndEditLabelInHeader",
										...
										refreshActionRequest.registerFixedParameter("PreActivity", "pxFPSaveApp");
										staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
										staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzViewAndEditLabelInHeader"));
										staticURLStr.append("&PreActivity=pxFPSaveApp");
										staticURLStr.append("&PreDataTransform=pzSetEditLabelFalse");
										tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"pxFPSaveApp\", \"");
										refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
										preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"editedSection\":\"pzViewAndEditLabelInHeader\"");
										refreshActionRequestD.registerFixedParameter("editedSection","pzViewAndEditLabelInHeader");
										preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"accessGroup\":\"\"");
										preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"pyReportName\":\"\"");
										preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"pyReportClass\":\"\"");
										tools.appendString("\", \"\", \"pzSetEditLabelFalse,");
										refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
										...
										if(!"".equals(preActParamStr.toString())) {
											...
											if(!"".equals(preDTParamStr.toString())) {
												...
												if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
												pzPackageRuntime.packageDataTransform(tools.getStepPage().getString("pxObjClass"), "pzSetEditLabelFalse");
												}
		...
		tools.appendString("!=");
		tools.appendString("\",\"\"");
		tools.appendString(",\"");		if(com.pegarules.generated.pega_uiengine_expressionevaluators.pzCompareValues(tools.getActive().getStringValue(),"!=","") == true){
			tools.appendString("true");}else{
			tools.appendString("false");}
		tools.appendString("\"]");
		tools.appendString("]");
		tools.appendString("]");
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }												tools.appendString("[\"runScript\", [\"pega.u.d.clearDirtyState()\"]");
...
//	RULE-UTILITY-FUNCTION STRING ISLITERAL #20180713T131441.656 GMT:20180713T131441.656 GMT
	...
	public static String getFUAContentHash() {
		return "a372d3f30d299c0279b7a26b2ac6c643";
	}
