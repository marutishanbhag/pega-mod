...
public class ra_stream_pxtextinput_228709330_9ac388631dc0ed896aa97addc9b75987 extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_pxtextinput_228709330_9ac388631dc0ed896aa97addc9b75987(com.pega.pegarules.priv.PegaAPI aContext) {
...
{
/* Instance RULE-HTML-PROPERTY PXTEXTINPUT #20190131T183501.688 GMT	Pega-Gadgets:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=	baserule=true */
...
pzAuto.getPropertyActionRequest().registerClientParameter(sEntryHandle);		}
		...
		String spxUniqueStreamHash2 = getUIActionsMetaData_1();
			...
			String spxUniqueStreamHash3 = getUIActionsMetaData_2();
				tools.putParamValue("runTimeSecStreamName", "");
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,nameType);}
		...
		tools.appendString(" data-change='[");if(isBehaviorAdded && true){ tools.appendString(","); }{String strStreamName="";String strPropertyTarget ="";String strPageName ="";strStreamName="pzEnterCaseTypeInformation";if(tools.getPrimaryPage() != null){ strPageName = tools.getPrimaryPage().getName();}if(tools.getActive() != null){strPropertyTarget = tools.getActive().getEntryHandle();}com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();actionRequest.registerFixedParameter("pyActivity", "ReloadCell"); actionRequest.registerFixedParameter("pyPropertyTarget", strPropertyTarget ); actionRequest.registerFixedParameter("StreamName", strStreamName); actionRequest.registerFixedParameter("pzPrimaryPageName", strPageName); pzAuto.registerActionRequest(actionRequest);}					tools.appendString("[\"postValue\",[\":event\"]");
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
}if(isBehaviorAdded && true){ tools.appendString(","); }					tools.appendString("[\"setValue\", [[\"" + pzAuto.getUIComponentRuntime().generateActionToken(".pyDescription") + "\", \"\", \"" + pzAuto.getUIComponentRuntime().generateActionToken(".pyLabel") + "\", \"\",\"");
		...
		tools.appendString(",[");
		tools.appendString("\"");
		tools.appendString(tools.getProperty(".pyDescription").getEntryHandle(true));
		tools.appendString("\",\"=\",");
		tools.appendString("\"\"");
		tools.appendString(",\"");
		if(com.pegarules.generated.pega_uiengine_expressionevaluators.pzCompareValues(tools.getProperty(".pyDescription").getStringValue(),"=","")){
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }						{com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequest = pzAuto.getActionRequest();
							com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
								...
								if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
									try{
										pzPackageRuntime.packageSection("pzEnterCaseTypeInformation",
										...
										refreshActionRequest.registerFixedParameter("PreActivity", "pzValidateCaseTypeInfoWrapper");
										staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
										staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzEnterCaseTypeInformation"));
										staticURLStr.append("&PreActivity=pzValidateCaseTypeInfoWrapper");
										tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"pzValidateCaseTypeInfoWrapper\", \"");
		...
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }												tools.appendString("[\"runScript\", [\"pega.p.doClearActions (");
												String strPropReference81 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyDoClearActions")+"~#";
		...
		tools.appendFormatted("pega.mobile.transitions.NONE",StreamBuilder.FMT_NORMAL);												tools.appendString("\"]");
												tools.appendString("],[\"setUserStart\",[\"FINISHASSIGNMENT\"]],[\"doFormSubmit\",[\"pyActivity=FinishAssignment\",\":this\",\"");
												{
													com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();
													actionRequest.registerFixedParameter("pyActivity", "FinishAssignment");
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
															...
															com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
																...
																if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
																	try{
																		...
																		refreshActionRequest.registerFixedParameter("pyActivity", "ReloadSection");
																		refreshActionRequest.registerFixedParameter("SectionName", "pzEnterCaseTypeInformation");
																		refreshActionRequest.registerFixedParameter("PreActivity", "pzCreateCaseTypeWrapper");
																		staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
																		staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzEnterCaseTypeInformation"));
																		staticURLStr.append("&PreActivity=pzCreateCaseTypeWrapper");
																		tools.appendString("[\"refresh\", [\"thisSection\",\"pzEnterCaseTypeInformation\", \"pzCreateCaseTypeWrapper\", \"");
																		refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
																		preActParamStr.append((!"".equals(preActParamStr.toString())?",":"") + "\"skipStages\":\"true\"");
																		refreshActionRequestD.registerFixedParameter("skipStages","true");
																		tools.appendString("\", \"\", \",");
																		refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
																		tools.appendString("\",\":event\",\"\",[\"");
																		if(!"".equals(preActParamStr.toString())) {
		...
		tools.appendString(",\"enter\"");
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }																				tools.appendString("[\"runScript\", [\"pega.p.doClearActions (");
																				String strPropReference131 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyDoClearActions")+"~#";
																				String strFormattedPropReference131 = pega_uiengine_pzcontrol.pzScriptTagFormatting(strPropReference131);
																				if(strPropReference131.equals(strFormattedPropReference131)) {
																				tools.appendString("\\\"");
																				tools.appendFormatted(strFormattedPropReference131.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
																				tools.appendString("\\\"");
																				} else {
																				tools.appendFormatted(strFormattedPropReference131.replaceAll("\"","").replaceAll("\'", ""), StreamBuilder.FMT_NORMAL);
																				}
		...
		tools.appendString(",");
		tools.appendString(",\"enter\"");
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }																					tools.appendString("[\"runScript\", [\"pega.desktop.closeAllDocuments(event)\"]");
...
{com.google.gson.JsonObject jObject = new com.google.gson.JsonObject();com.google.gson.JsonObject propRefJSON = new com.google.gson.JsonObject();com.google.gson.JsonObject jObjectWithParam = new com.google.gson.JsonObject();if(!"{}".equals(propRefJSON.toString())){jObjectWithParam.add("pyDataTransformDynamicParams",propRefJSON);}jObjectWithParam.addProperty("pyDataTransform", "pzSetExpressSkinForEditMode");jObjectWithParam.add("pyDataTransformParams", jObject);
		...
		}}catch(Exception e){}String defaultValue = StringUtils.escapeCrossScriptingFilter(runTimeParamPage.getPage("pyUserData").getString("pyDefaultValue"));if (!StringUtils.isBlank(defaultValue)) {
...
if(pegaValidation != null) {
	...
	tools.putActive(propActivePrev); 																					} catch (Exception e) {
	 ...
	 if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'																					&& pzAuto.getUIComponentRuntime().getRuntimeContextTree().isLiveDesignViewMode()){
		...
		IUIComponent ctrlComponent = pzAuto.getUIComponent();
		metadata.put("cellInfo", "Create Case Type");
...
//	RULE-HTML-PROPERTY PXTEXTINPUT #20190131T183501.688 GMT:
...
//	RULE-UTILITY-FUNCTION PZCONTROL PZACTIONFINISHASSIGNMENT--(CLIPB4281A841AE2C9D90A1C4923B41464152 #20180713T133343.075 GMT:20180713T133343.075 GMT
...
//	RULE-UTILITY-FUNCTION STRING ISLITERAL #20180713T131441.656 GMT:20180713T131441.656 GMT
	...
	public static String getFUAContentHash() {
		return "eaf31f061c312f15612a9cf0edb31021";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY PXTEXTINPUT #20190131T183501.688 GMT", "pxTextInput", "Pega-Gadgets", "08-03-01", null);
}
