...
/**
 * Builds JSP stream GETLOCALIZEDVALUE.
 */
public class ra_stream_getlocalizedvalue_9c2452f546afcf44ed810616a3a3fc07 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Property.GetLocalizedValue.Stream");
 ...
 */
	public ra_stream_getlocalizedvalue_9c2452f546afcf44ed810616a3a3fc07(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "ef1bc2b13b9a916eea1611fd7ae8d44daa3a9d1c";
...
pz_CurrentRuleKey = "RULE-HTML-PROPERTY GETLOCALIZEDVALUE #20180713T133433.079 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
//	RULE-OBJ-ACTIVITY RULE- PZASSEMBLEPREPROCESS #20180713T132655.315 GMT:20180713T132655.315 GMT
	...
	public static String getFUAContentHash() {
		return "7738af147b31895db6683fa07ec3ce1a";
	}
...
/**
 * Generates stream property_Embed_Stage_Messages
 */
private void property_Embed_Stage_Messages() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
 ...
 */
if (_jspx_meth_pega_reference__1(pageContext, "$save(result)")) {
	return;
}
tools.appendString(" ");
 ...
 */
if (_jspx_meth_pega_reference__1(pageContext, "$this-name")) {
	return;
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-PROPERTY GETLOCALIZEDVALUE #20180713T133433.079 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "GetLocalizedValue");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY GETLOCALIZEDVALUE #20180713T133433.079 GMT", "GetLocalizedValue", "Pega-Gadgets", "08-01-01", "20180713T133433.079 GMT");
