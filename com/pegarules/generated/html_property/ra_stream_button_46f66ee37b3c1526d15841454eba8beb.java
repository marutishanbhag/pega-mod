...
/**
 * Builds JSP stream BUTTON.
 */
public class ra_stream_button_46f66ee37b3c1526d15841454eba8beb extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Property.Button.Stream");
 ...
 */
	public ra_stream_button_46f66ee37b3c1526d15841454eba8beb(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "21e44e7e93e7d963733597acdc572727d6c7c3fd";
...
pz_CurrentRuleKey = "RULE-HTML-PROPERTY BUTTON #20210706T092242.273 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
//	RULE-OBJ-ACTIVITY RULE- PZASSEMBLEPREPROCESS #20180713T132655.315 GMT:20180713T132655.315 GMT
	...
	public static String getFUAContentHash() {
		return "f53d3b19065501105372a799139178ed";
	}
...
/**
 * Generates stream property_Rule_Obj_ListView_ClientValidation
 */
private void property_Rule_Obj_ListView_ClientValidation() {
/* handling 1 of 1 definitions (isLast)  (isOnly) */
{
...
private void include_1() {
	...
	try {
property_Rule_Obj_ListView_ClientValidation();
	} finally {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-PROPERTY BUTTON #20210706T092242.273 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "Button");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY BUTTON #20210706T092242.273 GMT", "Button", "Pega-Gadgets", "08-07-01", "20210728T105250.178 GMT");
