...
public class ra_stream_pxtextinput_228709330_e73d0d1442c3608f32c3f24fbf51c02b extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_pxtextinput_228709330_e73d0d1442c3608f32c3f24fbf51c02b(com.pega.pegarules.priv.PegaAPI aContext) {
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
							...
							com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
								...
								if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
									try{
										pzPackageRuntime.packageSection("pzGeneralFields",
										...
										staticURLStr.append("&StreamName=" + ((!StringUtils.isBlank(runTimeSecStreamName))?runTimeSecStreamName:"pzGeneralFields"));
										staticURLStr.append("&PreDataTransform=pzSetUserNameLast");
										tools.appendString("[\"refresh\", [\"thisSection\",\"\", \"\", \"");
										refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
										tools.appendString("=\", \"\", \"pzSetUserNameLast,");
										refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
										...
										if(!"".equals(preActParamStr.toString())) {
											...
											if(!"".equals(preDTParamStr.toString())) {
												...
												if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
												pzPackageRuntime.packageDataTransform(tools.getStepPage().getString("pxObjClass"), "pzSetUserNameLast");
												}
		...
		tools.appendString(",[");
		tools.appendString("\"");
		tools.appendString(tools.getProperty(".pyUserName").getEntryHandle(true));
		tools.appendString("\",\"=\",");
		tools.appendString("\"\"");
		tools.appendString(",\"");
		if(com.pegarules.generated.pega_uiengine_expressionevaluators.pzCompareValues(tools.getProperty(".pyUserName").getStringValue(),"=","")){
		...
		tools.appendString(",[");
		tools.appendString("\"");
		tools.appendString(tools.getProperty(".pyFirstName").getEntryHandle(true));
		tools.appendString("\",\"!=\",");
		tools.appendString("\"\"");
		tools.appendString(",\"");
		if(com.pegarules.generated.pega_uiengine_expressionevaluators.pzCompareValues(tools.getProperty(".pyFirstName").getStringValue(),"!=","")){
			tools.appendString("true");}else{
			tools.appendString("false");}
		tools.appendString("\"]");
		tools.appendString("]");
...
if(pegaValidation != null) {
	...
	tools.putActive(propActivePrev); 												} catch (Exception e) {
	 ...
	 if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'												&& pzAuto.getUIComponentRuntime().getRuntimeContextTree().isLiveDesignViewMode()){
		...
		IUIComponent ctrlComponent = pzAuto.getUIComponent();
		metadata.put("cellInfo", "Last Name");
...
//	RULE-UTILITY-FUNCTION STRING ISLITERAL #20180713T131441.656 GMT:20180713T131441.656 GMT
	...
	public static String getFUAContentHash() {
		return "be85f7c2ebc8e67bf5f43821973f8922";
	}
