...
/**
 * Builds JSP stream RF_OPENCLASSKEYS.
 */
public class ra_stream_rf_openclasskeys_60c142f56f71297938fd80827f08da1d extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Property.RF_OpenClassKeys.Stream");
 ...
 */
	public ra_stream_rf_openclasskeys_60c142f56f71297938fd80827f08da1d(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "43c38e78a372216d2e3466bba56e16e44e0442f9";
...
{
/* Instance RULE-HTML-PROPERTY RF_OPENCLASSKEYS #20180713T135131.814 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-PROPERTY RF_OPENCLASSKEYS #20180713T135131.814 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-PROPERTY RF_OPENCLASSKEYS #20180713T135131.814 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-PROPERTY RF_OPENCLASSKEYS #20180713T135131.814 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Property:RF_OPENCLASSKEYS"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("RF_OPENCLASSKEYS","Rule-HTML-Property","",false,"","Pega-Desktop","08-01-01","RULE-HTML-PROPERTY RF_OPENCLASSKEYS #20180713T135131.814 GMT","RF_OPENCLASSKEYS",true,false,"ABSOLUTE_CLASSLESS",1578054055)
	};
...
//	RULE-HTML-PROPERTY RF_OPENCLASSKEYS #20180713T135131.814 GMT:20180713T135131.814 GMT
//	RULE-OBJ-ACTIVITY RULE- PZASSEMBLEPREPROCESS #20180713T132655.315 GMT:20180713T132655.315 GMT
	...
	public static String getFUAContentHash() {
		return "a653a52f3812bcdf86fc567150731e2a";
	}
...
tools.appendString(" ");
		...
		String strProp = ".pyKeyName";
	
tools.appendString(" ");
	boolean foundChoice_2 = false;
tools.appendString(" ");
if (!foundChoice_2 && (pega.isPreviewMode() || tools.getPrimaryPage().getProperty(".pxUpdateDateTime").getStringValue().equals(""))) {
tools.appendString(" ");
tools.putSaveValue("ApplyTo", "pyDerivesFrom");
tools.appendString(" ");
...
if (!foundChoice_2) {
tools.appendString(" ");
tools.putSaveValue("ApplyTo", "pyClassName");
tools.appendString(" ");
}
tools.appendString("  ");
...
_jspx_th_pega_reference__1.setName(strProp);
_jspx_th_pega_reference__1.setMode("input");
_jspx_th_pega_reference__1.setFormat("OpenRuleAdvanced");
...
if (_jspx_meth_pega_param__2(pageContext, "ApplyTo", "$save(ApplyTo)")) {
	return;
}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-PROPERTY RF_OPENCLASSKEYS #20180713T135131.814 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "RF_OpenClassKeys");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY RF_OPENCLASSKEYS #20180713T135131.814 GMT", "RF_OpenClassKeys", "Pega-Desktop", "08-01-01", "20180713T135131.814 GMT");
}
