...
public class ra_stream_default_1270549771_a5a0435fee53579442f536f441868254 extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_default_1270549771_a5a0435fee53579442f536f441868254(com.pega.pegarules.priv.PegaAPI aContext) {
...
{
/* Instance RULE-HTML-PROPERTY DEFAULT #20190614T125129.697 GMT	Pega-Gadgets:08-04-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=	baserule=true */
...
inclCalVal_1("Default", controlFormat, styleClass);inclAction_1();
tools.appendString(">");
...
if(layoutFormatType.equalsIgnoreCase("SIMPLELAYOUT")) {
	...
	if(!isEditable) {
		if(!pzAuto.getBrowserUtils().isFF()) {
			tools.putParamValue("pxControlName", "Default");
		}					String atmtionID = "";
...
//	RULE-HTML-PROPERTY DEFAULT #20190614T125129.697 GMT:
...
//	RULE-UTILITY-FUNCTION PZCONTROL PZGETPROPERTYCLASS #20180713T133346.414 GMT:20180713T133346.414 GMT
	...
	public static String getFUAContentHash() {
		return "fa3354e0a16944e43243014ea34b524a";
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY DEFAULT #20190614T125129.697 GMT", "Default", "Pega-Gadgets", "08-04-01", null);
}
