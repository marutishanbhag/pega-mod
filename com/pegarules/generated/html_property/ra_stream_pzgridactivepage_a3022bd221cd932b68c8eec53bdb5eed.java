 ...
 */
public class ra_stream_pzgridactivepage_a3022bd221cd932b68c8eec53bdb5eed extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
 ...
 */
	public ra_stream_pzgridactivepage_a3022bd221cd932b68c8eec53bdb5eed(com.pega.pegarules.priv.PegaAPI aContext) {
...
//	RULE-OBJ-FIELDVALUE @BASECLASS PYCAPTION!OF #20180713T132852.693 GMT:20180713T132852.693 GMT
	...
	public static String getFUAContentHash() {
		return "e7f5e61151f82e792ecf1be049a9ca6f";
	}
...
"RULE-OBJ-FIELDVALUE @BASECLASS PYCAPTION!PAGE #20180713T131650.958 GMT", "Rule-Obj-FieldValue", "Pega-WB", "pyCaption", "Rule-RuleSet-Name", "Page" };
/**
...
"RULE-OBJ-FIELDVALUE @BASECLASS PYCAPTION!OF #20180713T132852.693 GMT", "Rule-Obj-FieldValue", "Pega-SearchEngine", "pyCaption", "Rule-RuleSet-Name", "of" };
private static final String[] showMeParams_3 = {
"", "Rule-Obj-FieldValue", "", "pyCaption", "Rule-RuleSet-Name", "Current Page. Page" };
...
/* Field value Rule-RuleSet-Name .pyCaption Page */
...
/* Field value Rule-RuleSet-Name .pyCaption of */
if(tools.getStepPage() != null && "Rule-RuleSet-Name".equals(tools.getStepPage().getClassName())){
out.write("of");
}else{
...
/* Field value Rule-RuleSet-Name .pyCaption Current Page. Page */
...
static {
	oPropDefinitions_1.put("Rule-RuleSet-Name.pyCaption", new LiteweightPropertyDefinition("Rule-RuleSet-Name", "pyCaption", "siN", false, true, "Default", false));
}
