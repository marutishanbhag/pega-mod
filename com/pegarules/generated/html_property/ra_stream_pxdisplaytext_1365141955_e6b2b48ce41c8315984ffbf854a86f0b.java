...
public class ra_stream_pxdisplaytext_1365141955_e6b2b48ce41c8315984ffbf854a86f0b extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_pxdisplaytext_1365141955_e6b2b48ce41c8315984ffbf854a86f0b(com.pega.pegarules.priv.PegaAPI aContext) {
...
{
/* Instance RULE-HTML-PROPERTY PXDISPLAYTEXT #20190131T183501.550 GMT	Pega-Gadgets:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=	baserule=true */
...
tools.putParamValue("isControlEditableOriginal", true);	boolean isEditable = controlRuntimeUtilities.isControlEditable(ctrlEditiablity, pzAuto, cellReadOnlyCond_cell, modePageData2, propName, tools);
	...
	sEntryHandle = controlRuntimeUtilities.getEntryHandle(false, tools);tools.putParamValue("isControlEditableOriginal", false);
	 ...
	 pega_rules_utilities.pzRegisterActivity(tools,"GetTargets");
			 if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(controlUniqueHash+ "_8")){	boolean isActionConfigured = true;
...
String pyTextAlign = modePageData2.getStringIfPresent("pyTextAlign");			String pyFormatType = modePageData2.getStringIfPresent("pyFormatType");
			...
			boolean isActionConfigured = true;
...
//	RULE-HTML-PROPERTY PXDISPLAYTEXT #20190131T183501.550 GMT:
...
//	RULE-UTILITY-FUNCTION STRING ISLITERAL #20180713T131441.656 GMT:20180713T131441.656 GMT
	...
	public static String getFUAContentHash() {
		return "862362f2c6f7dfb1c39331bfa0af00c4";
	}
...
public void inclAction_2() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }tools.appendString("[\"openLandingPage\",[\"");

		tools.appendFormatted("Application - Profile",StreamBuilder.FMT_NORMAL);tools.appendString("\",\"Display\",{\"harnessName\":\"pzLPApplicationBusinessSettings\",\"className\":\"Pega-Landing-Application\",\"model\":\"\",\"page\":\"\",\"readOnly\":\"false\",\"contentID\":\"");

		tools.appendFormatted("721a59c2-6bb4-4ab7-9a90-7f2c72ea30dd",StreamBuilder.FMT_NORMAL);tools.appendString("\",\"dynamicContainerID\":\"");
		...
		tools.appendFormatted("Specifications",StreamBuilder.FMT_NORMAL);tools.appendString("\"}]");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendFormatted("07b738f4-4f5b-4bc3-8f07-bb641e4f045b",StreamBuilder.FMT_NORMAL);	tools.appendString("\",\"dynamicContainerID\":\"");
...
public void inclAction_1() {
		...
		tools.appendFormatted("0492cbca-184a-4d62-b753-4af48386282e",StreamBuilder.FMT_NORMAL);tools.appendString("\",\"dynamicContainerID\":\"");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY PXDISPLAYTEXT #20190131T183501.550 GMT", "pxDisplayText", "Pega-Gadgets", "08-03-01", null);
}
