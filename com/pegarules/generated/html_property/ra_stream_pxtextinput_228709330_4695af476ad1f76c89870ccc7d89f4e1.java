...
public class ra_stream_pxtextinput_228709330_4695af476ad1f76c89870ccc7d89f4e1 extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_pxtextinput_228709330_4695af476ad1f76c89870ccc7d89f4e1(com.pega.pegarules.priv.PegaAPI aContext) {
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,nameType);}
		...
		tools.appendString(" data-keydown='[");if(isBehaviorAdded && true){ tools.appendString(","); }					tools.appendString("[\"doListAction\",[\":event\",[\"ADDITEM\",\"\", \"INSERTAFTER\",\"\",\"pyNextGenGridModalTemplate\"],[\"INSERTAFTER\"]]");

		tools.appendString(",");
		tools.appendString(",\"enter\"");
		tools.appendString("]");isBehaviorAdded = true;if(isBehaviorAdded && true){ tools.appendString(","); }					tools.appendString("[\"runScript\", [\"putFocusOnNextRow(");
					String strPropReference31 = "#~"+pzAuto.getUIComponentRuntime().generateActionToken(".pyStepPageReference")+"~#";
					...
					tools.appendString(",\\\"2014092215222501182395\\\")\"]");
...
//	RULE-UTILITY-FUNCTION STRING ISLITERAL #20180713T131441.656 GMT:20180713T131441.656 GMT
	...
	public static String getFUAContentHash() {
		return "7f9f2c65554fb0e908e7716bc200d792";
	}
