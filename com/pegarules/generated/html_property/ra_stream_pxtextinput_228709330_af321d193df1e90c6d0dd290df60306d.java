...
public class ra_stream_pxtextinput_228709330_af321d193df1e90c6d0dd290df60306d extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_pxtextinput_228709330_af321d193df1e90c6d0dd290df60306d(com.pega.pegarules.priv.PegaAPI aContext) {
...
controlRuntimeUtilities.markUpForReadOnlyFormatting(bOptimizedMarkup, ref, activeValue, tools, pzAuto);if(bOptimizedMarkup){propertyHandle = pzAuto.getUIComponentRuntime().changeTrackProperty(propertyHandle,nameType);}
		...
		tools.appendString(" data-change='[");if(isBehaviorAdded && true){ tools.appendString(","); }{String strStreamName="";String strPropertyTarget ="";String strPageName ="";strStreamName="pzRARecordConfigurationInner";if(tools.getPrimaryPage() != null){ strPageName = tools.getPrimaryPage().getName();}if(tools.getActive() != null){strPropertyTarget = tools.getActive().getEntryHandle();}com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();actionRequest.registerFixedParameter("pyActivity", "ReloadCell"); actionRequest.registerFixedParameter("pyPropertyTarget", strPropertyTarget ); actionRequest.registerFixedParameter("StreamName", strStreamName); actionRequest.registerFixedParameter("pzPrimaryPageName", strPageName); pzAuto.registerActionRequest(actionRequest);}					tools.appendString("[\"postValue\",[\":event\"]");
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
							...
							com.pega.pegarules.priv.runtime.IActionRequest refreshActionRequestD = null;
								...
								refreshActionRequest.registerFixedParameter("StreamList", "pzRARecordName|Rule-HTML-Section|:");
								staticURLStr.append("pyActivity=ReloadSection&StreamClass=Rule-HTML-Section");
								staticURLStr.append("&PreDataTransform=pzSetFocusKeyFromLabel");
								tools.appendString("[\"refresh\", [\"otherSection\",\"pzRARecordName\", \"\", \"");
								refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
								tools.appendString("=\", \"\", \"pzSetFocusKeyFromLabel,");
								refreshActionRequestD = refreshActionRequest.createDispatchedActionRequest();
								preDTParamStr.append((!"".equals(preDTParamStr.toString())?",":"") + "\"sOnlyUpdatePrefix\":\"\"");
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
		...
		if((com.pega.pegarules.jsptags.WhenTag.evaluateWhen(pega,"pzIsQuickConfigureToggled",null,false)
		)){if(isBehaviorAdded && true){ tools.appendString(","); }															tools.appendString("[\"runScript\", [\"doSubmit(\\\"pyActivity=FinishAssignment&QuickCreate=true\\\")\"]");
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().markAsDynamic();
		...
		if((com.pega.pegarules.jsptags.WhenTag.evaluateWhen(pega,"!pzIsQuickConfigureToggled",null,false)
		)){if(isBehaviorAdded && true){ tools.appendString(","); }															tools.appendString("[\"runScript\", [\"doSubmit()\"]");
...
//	RULE-UTILITY-FUNCTION STRING ISLITERAL #20180713T131441.656 GMT:20180713T131441.656 GMT
	...
	public static String getFUAContentHash() {
		return "c340eab98f0bf9355ded6bc07553bdb6";
	}
