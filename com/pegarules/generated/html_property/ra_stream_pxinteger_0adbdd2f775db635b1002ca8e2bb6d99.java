...
/**
 * Builds JSP stream PXINTEGER.
 */
public class ra_stream_pxinteger_0adbdd2f775db635b1002ca8e2bb6d99 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Property.pxInteger.Stream");
 ...
 */
	public ra_stream_pxinteger_0adbdd2f775db635b1002ca8e2bb6d99(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "76dfb778ee98f6c9893b40d121d2c663d669f8b4";
...
{
/* Instance RULE-HTML-PROPERTY PXINTEGER #20190131T183501.583 GMT	Pega-Gadgets:08-03-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-PROPERTY PXINTEGER #20190131T183501.583 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-PROPERTY PXINTEGER #20190131T183501.583 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
tools.appendString(pega_uiengine_formatter.pxFormatNumber(tools.getActiveValue(),null, true,0,"none","minusStyle","NegativeNumber","none","null") );
...
/* end RULE-HTML-PROPERTY PXINTEGER #20190131T183501.583 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
//	RULE-UTILITY-FUNCTION PZCONTROL PZGENERATEFORMAT #20180713T133344.942 GMT:20180713T133344.942 GMT
	...
	public static String getFUAContentHash() {
		return "b6c61f6fbb232592d068bfb699b86090";
	}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-PROPERTY PXINTEGER #20190131T183501.583 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "pxInteger");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-PROPERTY PXINTEGER #20190131T183501.583 GMT", "pxInteger", "Pega-Gadgets", "08-03-01", "20190131T183501.583 GMT");
}
