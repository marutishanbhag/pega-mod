...
public class ra_stream_pxdisplaytext_1365141955_154c8d0debc4a2d6d5dd5190e31cd548 extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public ra_stream_pxdisplaytext_1365141955_154c8d0debc4a2d6d5dd5190e31cd548(com.pega.pegarules.priv.PegaAPI aContext) {
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		keyMap.putString("pyActionName", "pzApplicationActors");
		...
		try{
		pzPackageRuntime.packageLocalAction("pzApplicationActors", offlineUsingPage , strLAClassName);
		...
		if(pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
			try{
				pzPackageRuntime.packageSection("pzAppOverviewActors",
				...
				if("true".equals(bHasPrivilege )) {
					tools.appendString("[\"processAction\", [\"pzApplicationActors\",\"true\",\":event\",\"\",\""+streamType+"\",\"\",\"\",\"%7B%22mobile%22%3A%7B%22reveal%22%3A%7B%22effect%22%3A%22anim-null%22%7D%2C%22isCustomDismiss%22%3A%22true%22%2C%22dismiss%22%3A%7B%22effect%22%3A%22anim-null%22%7D%7D%7D\",\"true\",\""+strLAClassName+"\",\""+strLAClassName+"\",\"false\",\"false\",\"\",\"\"]");
					} else {
