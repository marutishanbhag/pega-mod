...
/**
 * Builds JSP stream EMBED-USERFUNCTION!PXCONCATENATE.
 */
public class ra_stream_pxconcatenate_84e97459b6e076e5cc32fe8f4c52106a extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Alias_Function.pxConcatenate.Embed_UserFunction.Stream");
 ...
 */
	public ra_stream_pxconcatenate_84e97459b6e076e5cc32fe8f4c52106a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "7a838b1a9f45d9a77a9de2f83c45e501bef6d377";
...
if (ruleChooser_1.ruleApplies(new RuleCharacteristicsImpl(".pyProductType", "SQLSERVER", null, RuleResolutionStatistics.CircumstanceType.valueOf("PROPERTY") ,null, null, null, tools))) {
/* Instance RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210727T214131.071 GMT	Pega-RulesEngine:08-07-01	.pyProductType=SQLSERVER	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
executeStream_1();
...
/* Instance RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20180713T132607.790 GMT	Pega-RulesEngine:08-01-01	.pyProductType=POSTGRESQL	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
executeStream_2();
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		new DependentRuleInfo("PXCONCATENATE","Rule-Alias-Function","EMBED-USERFUNCTION",false,"","Pega-RulesEngine","08-01-01","RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20180713T132607.790 GMT","!PXCONCATENATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-172988062), 
		new DependentRuleInfo("PXCONCATENATE","Rule-Alias-Function","EMBED-USERFUNCTION",false,"","Pega-RulesEngine","08-07-01","RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210727T214131.071 GMT","!PXCONCATENATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",90121922), 
...
//	RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210727T214131.071 GMT:20210727T214131.071 GMT
//	RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20180713T132607.790 GMT:20180713T132607.790 GMT
...
//	RULE-OBJ-ACTIVITY RULE- PZASSEMBLEPREPROCESS #20180713T132655.315 GMT:20180713T132655.315 GMT
	...
	public static String getFUAContentHash() {
		return "ff32b0bb529efe9cc4cbd795ccb5fd11";
	}
...
String parameter3 = tools.getStepPage().getString(".pyParameters(3).pyParametersParamValue").replaceAll("\"","").replaceAll("'","");

tools.appendString("\n");
	boolean foundChoice_3 = false;
tools.appendString("  ");
if (!foundChoice_3 && (pega.isPreviewMode() || parameter3.equals(""))) {
tools.appendString("\nCONCAT({1},{2})\n");
...
static {
	...
	oStreamProperties_3.put("pzInsKey", "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210721T200142.792 GMT");
...
tools.appendString("  ");
if (!foundChoice_2 && (pega.isPreviewMode() || parameter3.equals(""))) {
tools.appendString("\nCONCAT({1},{2})\n");
...
static {
	...
	oStreamProperties_2.put("pyCircumstanceVal", "POSTGRESQL");
	...
	oStreamProperties_2.put("pzInsKey", "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20180713T132607.790 GMT");
...
tools.appendString("  ");
if (!foundChoice_1 && (pega.isPreviewMode() || parameter3.equals(""))) {
tools.appendString("\nCONCAT({1},{2})\n");
...
static {
	...
	oStreamProperties_1.put("pyCircumstanceVal", "SQLSERVER");
	oStreamProperties_1.put("pyMethodStatus", "");
	oStreamProperties_1.put("pyClassName", "Embed-UserFunction");
	oStreamProperties_1.put("pyCircumstanceProp", ".pyProductType");
	oStreamProperties_1.put("pzInsKey", "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210727T214131.071 GMT");
...
/*
 * Begin RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210727T214131.071 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210727T214131.071 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210727T214131.071 GMT */
}
private void executeStream_2() {
/*
 * Begin RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20180713T132607.790 GMT
 * Set up context.
 */
final String prevRuleKey_2 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20180713T132607.790 GMT";final String prevClass_2 = mStreamResponse.getJspBaseClass();
mStreamResponse.setJspBaseClass("Rule-Alias-Function");
...
/* end RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20180713T132607.790 GMT */
}
private void executeStream_3() {
/*
 * Begin RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210721T200142.792 GMT
 * Set up context.
 */
final String prevRuleKey_3 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210721T200142.792 GMT";final String prevClass_3 = mStreamResponse.getJspBaseClass();
mStreamResponse.setJspBaseClass("Rule-Alias-Function");
...
/* end RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210721T200142.792 GMT */
}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210727T214131.071 GMT", "Embed-UserFunction pxConcatenate", "Pega-RulesEngine", "08-07-01", "20210727T214131.071 GMT");
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_2 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20210721T200142.792 GMT", "Embed-UserFunction pxConcatenate", "Pega-RulesEngine", "08-07-01", "20210721T230546.301 GMT");
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_1 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXCONCATENATE #20180713T132607.790 GMT", "Embed-UserFunction pxConcatenate", "Pega-RulesEngine", "08-01-01", "20180713T132607.790 GMT");
}
