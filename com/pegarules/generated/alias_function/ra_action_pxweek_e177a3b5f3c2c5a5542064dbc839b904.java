...
public class ra_action_pxweek_e177a3b5f3c2c5a5542064dbc839b904  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Alias_Function.pxWeek.Embed_UserFunction.Action");
	public ra_action_pxweek_e177a3b5f3c2c5a5542064dbc839b904(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
/* Instance RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXWEEK #20180713T132610.988 GMT	Pega-RulesEngine:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	...
	paramPage.put("D_pxWeek", fData0);
	paramPage.put("P_pxWeek", fParams0);
...
//	RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXWEEK #20180713T132610.988 GMT:20180713T132610.988 GMT
	...
	public static String getFUAContentHash() {
		return "8d2ee3370e1befc4fdc0c6d15e87a921";
	}
...
static {
	fData0.putString("pyLabel", "Week");
	fData0.putString("pyReturnType", "Date");
	fData0.putString("pyUsage", "@@pxWeek(DateTime property), @@pxWeek(Date property)");
	fData0.putString("pyDescription", "Returns the Start date of the week of a Date or DateTime value ");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXWEEK #20180713T132610.988 GMT", "Embed-UserFunction pxWeek", "Pega-RulesEngine", "08-01-01", "20180713T132610.988 GMT");
}
