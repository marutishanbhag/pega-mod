...
public class ra_action_pxmonth_85bab3a73cab2cf08a08699cb7aca5dc  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Alias_Function.pxMonth.Embed_UserFunction.Action");
	public ra_action_pxmonth_85bab3a73cab2cf08a08699cb7aca5dc(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
/* Instance RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXMONTH #20180713T132608.782 GMT	Pega-RulesEngine:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	...
	paramPage.put("D_pxMonth", fData0);
	paramPage.put("P_pxMonth", fParams0);
...
//	RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXMONTH #20180713T132608.782 GMT:20180713T132608.782 GMT
	...
	public static String getFUAContentHash() {
		return "b28533cc189a8e1f72cba48eebc46525";
	}
...
static {
	fData0.putString("pyLabel", "Month");
	fData0.putString("pyReturnType", "Date");
	fData0.putString("pyUsage", "@@pxMonth(.datetimeproperty) OR @@pxMonth(.dateproperty) ");
	fData0.putString("pyDescription", "Returns the month portion of a  Date or DateTime value as a Date value which is the first day of that month  (useful for sorting and grouping across multiple  years).");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXMONTH #20180713T132608.782 GMT", "Embed-UserFunction pxMonth", "Pega-RulesEngine", "08-01-01", "20180713T132608.782 GMT");
}
