...
/**
 * Builds JSP stream EMBED-USERFUNCTION!PXMULTIPLY.
 */
public class ra_stream_pxmultiply_3b37323f724e6025fd6d8e743e5c4b45 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Alias_Function.pxMultiply.Embed_UserFunction.Stream");
 ...
 */
	public ra_stream_pxmultiply_3b37323f724e6025fd6d8e743e5c4b45(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "b07abbe8f104ef28d04e68c944ad667bebc2b344";
...
/*
 * Begin RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXMULTIPLY #20180713T134047.959 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXMULTIPLY #20180713T134047.959 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXMULTIPLY #20180713T134047.959 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
//	RULE-OBJ-ACTIVITY RULE- PZASSEMBLEPREPROCESS #20180713T132655.315 GMT:20180713T132655.315 GMT
	...
	public static String getFUAContentHash() {
		return "c904e8b64162bbe68ec2b286f36d9467";
	}
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXMULTIPLY #20180713T134047.959 GMT");
