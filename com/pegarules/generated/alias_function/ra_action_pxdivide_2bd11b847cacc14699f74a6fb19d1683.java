...
public class ra_action_pxdivide_2bd11b847cacc14699f74a6fb19d1683  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Alias_Function.pxDivide.Embed_UserFunction.Action");
	public ra_action_pxdivide_2bd11b847cacc14699f74a6fb19d1683(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
/* Instance RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDIVIDE #20180713T134047.916 GMT	Pega-Reporting:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
	...
	paramPage.put("D_pxDivide", fData0);
	paramPage.put("P_pxDivide", fParams0);
...
//	RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDIVIDE #20180713T134047.916 GMT:20180713T134047.916 GMT
	...
	public static String getFUAContentHash() {
		return "28dad1c3c2d32f525eadb6f4542dbd27";
	}
...
static {
	fData0.putString("pyLabel", "Divide");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDIVIDE #20180713T134047.916 GMT", "Embed-UserFunction pxDivide", "Pega-Reporting", "08-01-01", "20180713T134047.916 GMT");
}
