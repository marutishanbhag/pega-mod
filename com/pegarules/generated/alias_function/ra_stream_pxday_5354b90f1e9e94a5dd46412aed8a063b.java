...
/**
 * Builds JSP stream EMBED-USERFUNCTION!PXDAY.
 */
public class ra_stream_pxday_5354b90f1e9e94a5dd46412aed8a063b extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_Alias_Function.pxDay.Embed_UserFunction.Stream");
 ...
 */
	public ra_stream_pxday_5354b90f1e9e94a5dd46412aed8a063b(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "492c4a5012ae20ad6776de734e7c05b20d246cf3";
...
/* Instance RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.212 GMT	Pega-RulesEngine:08-01-01	.pyProductType=TERADATA	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
executeStream_1();
...
/* Instance RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.204 GMT	Pega-RulesEngine:08-01-01	.pyProductType=SQLSERVER	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
executeStream_2();
...
/* Instance RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.194 GMT	Pega-RulesEngine:08-01-01	.pyProductType=POSTGRESQL	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
executeStream_3();
...
/* Instance RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.185 GMT	Pega-RulesEngine:08-01-01	.pyProductType=ORACLE	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
executeStream_4();
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXDAY","Rule-Alias-Function","EMBED-USERFUNCTION",false,"","Pega-RulesEngine","08-01-01","RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.185 GMT","!PXDAY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",161137173), 
		new DependentRuleInfo("PXDAY","Rule-Alias-Function","EMBED-USERFUNCTION",false,"","Pega-RulesEngine","08-01-01","RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.212 GMT","!PXDAY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1299954605), 
		new DependentRuleInfo("PXDAY","Rule-Alias-Function","EMBED-USERFUNCTION",false,"","Pega-RulesEngine","08-01-01","RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.194 GMT","!PXDAY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-988151340), 
		new DependentRuleInfo("PXDAY","Rule-Alias-Function","EMBED-USERFUNCTION",false,"","Pega-RulesEngine","08-01-01","RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.204 GMT","!PXDAY",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-218700540), 
...
//	RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.212 GMT:20180713T132608.212 GMT
//	RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.204 GMT:20180713T132608.204 GMT
//	RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.194 GMT:20180713T132608.194 GMT
//	RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.185 GMT:20180713T132608.185 GMT
...
//	RULE-OBJ-ACTIVITY RULE- PZASSEMBLEPREPROCESS #20180713T132655.315 GMT:20180713T132655.315 GMT
	...
	public static String getFUAContentHash() {
		return "e0633de2791daf69ffa614d2cd1ba952";
	}
...
static {
	...
	oStreamProperties_5.put("pzInsKey", "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.221 GMT");
...
static {
	...
	oStreamProperties_4.put("pzInsKey", "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.185 GMT");
...
tools.appendString("\n\t");
if (!foundChoice && when_1(".pyParameters(1).pyDBDataType", "TIMESTAMP")) {
tools.appendString("\n\t\tTO_CHAR(DATE_TRUNC('day', {1}::TIMESTAMP), 'YYYYMMDD')\n         ");

foundChoice = !pega.isPreviewMode();
}
tools.appendString("\n\t");
if (!foundChoice) {
tools.appendString("\n\t(CASE WHEN {1} IS NOT NULL \n          THEN \tSUBSTRING({1},1,8)\n          END)\n\t");
}
}
/**
 * Handles a choose tag.
...
static {
	...
	oStreamProperties_3.put("pzInsKey", "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.194 GMT");
...
tools.appendString("\n\t\t    SUBSTRING(REPLACE(CONVERT(VARCHAR(30),{1},126),'-',''),1,8)\n         ");
...
static {
	...
	oStreamProperties_2.put("pzInsKey", "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.204 GMT");
...
tools.appendString("\n\t");
if (!foundChoice && when_1(".pyParameters(1).pyDBDataType", "TIMESTAMP")) {
tools.appendString("\n\t\tCAST(CAST({1} AS FORMAT 'YYYYMMDD') AS CHAR(8))\t\t\n         ");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.212 GMT");
...
/*
 * Begin RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.212 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.212 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.212 GMT */
}
private void executeStream_2() {
/*
 * Begin RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.204 GMT
 * Set up context.
 */
final String prevRuleKey_2 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.204 GMT";final String prevClass_2 = mStreamResponse.getJspBaseClass();
mStreamResponse.setJspBaseClass("Rule-Alias-Function");
...
/* end RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.204 GMT */
}
private void executeStream_3() {
/*
 * Begin RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.194 GMT
 * Set up context.
 */
final String prevRuleKey_3 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.194 GMT";final String prevClass_3 = mStreamResponse.getJspBaseClass();
mStreamResponse.setJspBaseClass("Rule-Alias-Function");
...
/* end RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.194 GMT */
}
private void executeStream_4() {
/*
 * Begin RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.185 GMT
 * Set up context.
 */
final String prevRuleKey_4 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.185 GMT";final String prevClass_4 = mStreamResponse.getJspBaseClass();
mStreamResponse.setJspBaseClass("Rule-Alias-Function");
...
/* end RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.185 GMT */
}
private void executeStream_5() {
/*
 * Begin RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.221 GMT
 * Set up context.
 */
final String prevRuleKey_5 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.221 GMT";final String prevClass_5 = mStreamResponse.getJspBaseClass();
mStreamResponse.setJspBaseClass("Rule-Alias-Function");
...
/* end RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.221 GMT */
}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_4 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.221 GMT", "Embed-UserFunction pxDay", "Pega-RulesEngine", "08-01-01", "20180713T132608.221 GMT");
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_3 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.185 GMT", "Embed-UserFunction pxDay", "Pega-RulesEngine", "08-01-01", "20180713T132608.185 GMT");
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.212 GMT", "Embed-UserFunction pxDay", "Pega-RulesEngine", "08-01-01", "20180713T132608.212 GMT");
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_2 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.194 GMT", "Embed-UserFunction pxDay", "Pega-RulesEngine", "08-01-01", "20180713T132608.194 GMT");
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_1 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-ALIAS-FUNCTION EMBED-USERFUNCTION PXDAY #20180713T132608.204 GMT", "Embed-UserFunction pxDay", "Pega-RulesEngine", "08-01-01", "20180713T132608.204 GMT");
}
