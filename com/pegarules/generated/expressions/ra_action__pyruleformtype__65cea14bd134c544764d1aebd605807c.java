...
public class ra_action__pyruleformtype__65cea14bd134c544764d1aebd605807c extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport, FUAReusable {
	private static final LogHelper  oLog = new LogHelper("Rule_Declare_Expressions._pyRuleFormType.._baseclass.Action");
	public ra_action__pyruleformtype__65cea14bd134c544764d1aebd605807c(PegaAPI aContext) {
...
{
/* Instance RULE-DECLARE-EXPRESSIONS @BASECLASS .PYRULEFORMTYPE! #20180713T135046.092 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */

// Pega-RULES Declarative Processing Rule Instance

// Expression: .pyRuleFormType
...
pega.logTraceEvent("Declare Expression", "Expression", null, oTraceInfo_0, "RULE-DECLARE-EXPRESSIONS @BASECLASS .PYRULEFORMTYPE! #20180713T135046.092 GMT", "@pxGetFormType(.pxObjClass)", false, myStepPage, null, null);
}
if (oLog.isDebugEnabled()) oLog.debug("@pxGetFormType(.pxObjClass)");
// Expression: @pxGetFormType(.pxObjClass)
String pz_6 = pega.<String>resolveMethodCall("pxGetFormType--(String)", "pxGetFormType", null, null, new Object[] { scalarValueQuery_5.resolveToString(tools, myStepPage, ImmutablePropertyInfo.TYPE_TEXT) });
pz_4.setValue(pz_6);
...
if ((thrCause == null) || (!(thrCause instanceof InvalidValueException))) {
	...
	if (cpPrimary != null) {
		cpPrimary.addMessage("Declarative-NotExecuted\tRULE-DECLARE-EXPRESSIONS @BASECLASS .PYRULEFORMTYPE! #20180713T135046.092 GMT\t" + thrCause.getMessage());
		if (oLog.isWarnEnabled()) {			oLog.warn("Declarative-NotExecuted\tRULE-DECLARE-EXPRESSIONS @BASECLASS .PYRULEFORMTYPE! #20180713T135046.092 GMT\t" + thrCause.getMessage(), ice);		}	} else {
		oLog.error("Declarative-NotExecuted\tRULE-DECLARE-EXPRESSIONS @BASECLASS .PYRULEFORMTYPE! #20180713T135046.092 GMT\t" + thrCause.getMessage(), ice);	}
}
} catch (RuntimeException re) {
...
String message = "ChainingException	Rule-Declare-Expressions	@baseclass..pyRuleFormType.	" + re.toString();
...
String message = "ChainingException	Rule-Declare-Expressions	@baseclass..pyRuleFormType.	" + se.toString();
tools.getInfEngUtils().addConstraintMessage(currentProperty, null, message, null);
...
private static final String oDependencies [] = {
	"Rule-Declare-Expressions:.PYRULEFORMTYPE!"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		new DependentRuleInfo(".PYRULEFORMTYPE!","Rule-Declare-Expressions","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-DECLARE-EXPRESSIONS @BASECLASS .PYRULEFORMTYPE! #20180713T135046.092 GMT","!.PYRULEFORMTYPE!",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2137446053)
	};
...
//	RULE-DECLARE-EXPRESSIONS @BASECLASS .PYRULEFORMTYPE! #20180713T135046.092 GMT:20190514T131041.637 GMT
	...
	public static String getFUAContentHash() {
		return "ae4c8c7f225d7957834a7ebcdb700b8b";
	}
...
private static final PropertyQuery propertyQuery_1 = FUAUtil.createQueryBuilder().allowMissingPropertyException().scalarProperty("pyRuleFormType").buildPropertyQuery();
private static final PropertyQuery propertyQuery_3 = FUAUtil.createQueryBuilder().scalarProperty("pyRuleFormType").buildPropertyQuery();
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-DECLARE-EXPRESSIONS @BASECLASS .PYRULEFORMTYPE! #20180713T135046.092 GMT", "@baseclass .pyRuleFormType ", "Pega-Desktop", "08-01-01", "20190514T131041.637 GMT");
}
