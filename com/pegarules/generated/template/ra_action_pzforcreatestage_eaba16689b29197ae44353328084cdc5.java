...
public class ra_action_pzforcreatestage_eaba16689b29197ae44353328084cdc5  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Circumstance_Template.pzForCreateStage.OFON2J_ProcessO_Work_Onboarding.Action");
	public ra_action_pzforcreatestage_eaba16689b29197ae44353328084cdc5(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
try {
		 bConditions_circum0 = new boolean[2];
...
private static final String oDependencies [] = {
	...
	"Rule-Obj-Property:PZACNAME", 
	"Rule-Obj-Property:PXDEVICETYPE", 
	"Rule-Circumstance-Template:PZFORCREATESTAGE", 
	"Rule-Circumstance-Definition:PZFORCREATESTAGE!PZDEFINITIONFORACCREATESTAGE", 
	"Rule-Circumstance-Definition:PZFORCREATESTAGE!PZDEFINITIONFORCREATESTAGE", 
	"Rule-Circumstance-Definition:PZFORCREATESTAGE!PZDEFINITIONFORDESKTOPCREATESTAGE"
	};
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZACNAME","Rule-Obj-Property","CODE-PEGA-THREAD",true,"Code-Pega-Thread","Pega-RULES","08-02-01","RULE-OBJ-PROPERTY CODE-PEGA-THREAD PZACNAME #20181015T130125.296 GMT","!PZACNAME",true,false,"ABSOLUTE_IS_NOT_PRIMARY",0), 
		...
		new DependentRuleInfo("PZFORCREATESTAGE","Rule-Circumstance-Template","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-CIRCUMSTANCE-TEMPLATE WORK- PZFORCREATESTAGE #20210506T204025.620 GMT","!PZFORCREATESTAGE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1990809814), 
		new DependentRuleInfo("PZFORCREATESTAGE!PZDEFINITIONFORACCREATESTAGE","Rule-Circumstance-Definition","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-CIRCUMSTANCE-DEFINITION WORK- PZFORCREATESTAGE!PZDEFINITIONFORACCREATESTAGE #20210506T204025.586 GMT","!PZFORCREATESTAGE!PZDEFINITIONFORACCREATESTAGE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1026189309), 
		new DependentRuleInfo("PZFORCREATESTAGE!PZDEFINITIONFORCREATESTAGE","Rule-Circumstance-Definition","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-CIRCUMSTANCE-DEFINITION WORK- PZFORCREATESTAGE!PZDEFINITIONFORCREATESTAGE #20210506T204025.595 GMT","!PZFORCREATESTAGE!PZDEFINITIONFORCREATESTAGE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1102312875), 
		new DependentRuleInfo("PZFORCREATESTAGE!PZDEFINITIONFORDESKTOPCREATESTAGE","Rule-Circumstance-Definition","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-CIRCUMSTANCE-DEFINITION WORK- PZFORCREATESTAGE!PZDEFINITIONFORDESKTOPCREATESTAGE #20210506T204025.603 GMT","!PZFORCREATESTAGE!PZDEFINITIONFORDESKTOPCREATESTAGE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-189984998)
	};
...
//	RULE-CIRCUMSTANCE-TEMPLATE WORK- PZFORCREATESTAGE #20210506T204025.620 GMT:20210506T204025.620 GMT
//	RULE-CIRCUMSTANCE-DEFINITION WORK- PZFORCREATESTAGE!PZDEFINITIONFORACCREATESTAGE #20210506T204025.586 GMT:20210506T204025.586 GMT
//	RULE-CIRCUMSTANCE-DEFINITION WORK- PZFORCREATESTAGE!PZDEFINITIONFORCREATESTAGE #20210506T204025.595 GMT:20210506T204025.595 GMT
//	RULE-CIRCUMSTANCE-DEFINITION WORK- PZFORCREATESTAGE!PZDEFINITIONFORDESKTOPCREATESTAGE #20210506T204025.603 GMT:20230704T151616.028 GMT
//	RULE-OBJ-PROPERTY CODE-PEGA-THREAD PZACNAME #20181015T130125.296 GMT:20181015T130125.296 GMT
//	RULE-OBJ-PROPERTY CODE-PEGA-THREAD PZACNAME #20181015T130125.296 GMT:20181015T130125.296 GMT
...
//	RULE-UTILITY-FUNCTION UTILITIES ISINPAGELIST #20180713T131444.398 GMT:20180713T131444.398 GMT
	...
	public static String getFUAContentHash() {
		return "a7973822fe604875c1785c306f8fb13a";
	}
...
public void evaluateDecisionTable_circum0(){
		...
		mRuleHandle = "RULE-DECLARE-DECISIONTABLE WORK- PZFORCREATESTAGE #20260223T095009.375 GMT";
...
{	runRuleProp = runPathPage.getProperty("pyDecisionRules");
	...
	runRulePage.putString("pyAppliesToClass", "Work-");
	runRulePage.putString("pyDecisionName", "pzForCreateStage");
...
for(int i = 0; i < 1; i++){
	for(int j = 0; j < 1000 && ((i * 1000) + j) < 4; j++){
...
switch(row){
		case 0:
			if(evaluateRow_circum0(0, "pzDefinitionForDesktopCreateStage", bDoDecisionPath, pathProp, runRuleProp))
			{
				tools.putParamValue("DecisionResult", "pzDefinitionForDesktopCreateStage");
			return true;			}
			return false;		case 1:
			if(evaluateRow_circum0(1, "pzDefinitionForACCreateStage", bDoDecisionPath, pathProp, runRuleProp))
			{
				tools.putParamValue("DecisionResult", "pzDefinitionForACCreateStage");
			return true;			}
			return false;		case 2:
			if(evaluateRow_circum0(2, "pzDefinitionForCreateStage", bDoDecisionPath, pathProp, runRuleProp))
			{
				tools.putParamValue("DecisionResult", "pzDefinitionForCreateStage");
			return true;			}
			return false;		case 3:
			if(evaluateRow_circum0(3, "pzDefinitionForACCreateStage", bDoDecisionPath, pathProp, runRuleProp))
			{
				tools.putParamValue("DecisionResult", "pzDefinitionForACCreateStage");
			return true;			}
...
if(colVar1Set == false) {			setColVar1_circum0();
		...
		bConditions_circum0[0] = (!(colVar1_circum0.equals("actertiary")));
if(!bConditions_circum0[0]) {		return;
	}
if(colVar2Set == false) {			setColVar2_circum0();
	}
		bConditions_circum0[1] = (!(colVar2_circum0.equals("phone")));
if(!bConditions_circum0[1]) {		return;
	}
		break;
			case 1:
if(colVar1Set == false) {			setColVar1_circum0();
...
if(!bConditions_circum0[0]) {		return;
		...
		bConditions_circum0[1] = true;if(!bConditions_circum0[1]){		return;
	}
		break;
			case 2:
if(colVar1Set == false) {			setColVar1_circum0();
	}
		bConditions_circum0[0] = (colVar1_circum0.equals("acprimary"));
if(!bConditions_circum0[0]) {		return;
	}
if(colVar2Set == false) {			setColVar2_circum0();
	}
...
if(!bConditions_circum0[1]) {		return;
		...
		break;
			case 3:
		bConditions_circum0[0] = true;if(!bConditions_circum0[0]){		return;
	}
if(colVar2Set == false) {			setColVar2_circum0();
	}
		bConditions_circum0[1] = (colVar2_circum0.equals("phone"));
if(!bConditions_circum0[1]) {		return;
	...
	{
		String pz_4 = scalarValueQuery_3.resolveToString(tools, pega.findPageWithException("pxThread", "Code-Pega-Thread"), ImmutablePropertyInfo.TYPE_TEXT);
		colVar1_circum0 = pz_4;
		colVar1Set = true;
	}
	
	void setColVar2_circum0()
	{
		String pz_8 = scalarValueQuery_7.resolveToString(tools, pega.findPageWithException("pxRequestor", "Code-Pega-Requestor"), ImmutablePropertyInfo.TYPE_TEXT);
		colVar2_circum0 = pz_8;
		colVar2Set = true;
	}
...
rowBlocks_circum0[rowBlockIndex].doRows_circum0(row);
		...
		if (!bConditions_circum0[1]) {return false; }
...
private double cellDateValue = 0;
		String colVar2_circum0 = "";
		String colVar1_circum0 = "";
		boolean colVar1Set = false;
		boolean colVar2Set = false;
		public boolean[] bConditions_circum0;		public String[] propSetValues_circum0;public void invokeBaseDecision() {

}

private static final PropertyQuery propertyQuery_1 = FUAUtil.createQueryBuilder().allowMissingPropertyException().scalarProperty("pzACName").buildPropertyQuery();
private static final PropertyQuery propertyQuery_5 = FUAUtil.createQueryBuilder().allowMissingPropertyException().scalarProperty("pxDeviceType").buildPropertyQuery();
private static final ScalarValueQuery scalarValueQuery_3 = FUAUtil.createQueryBuilder().allowMissingPropertyException().scalarProperty("pzACName").buildScalarValueQuery();
private static final ScalarValueQuery scalarValueQuery_7 = FUAUtil.createQueryBuilder().allowMissingPropertyException().scalarProperty("pxDeviceType").buildScalarValueQuery();

private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "Work- pzForCreateStage", "Theme-Cosmos", "04-01-01", null);
}
