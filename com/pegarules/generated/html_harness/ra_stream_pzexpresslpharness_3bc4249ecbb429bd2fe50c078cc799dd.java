...
/**
 * Builds JSP stream PEGA-EXT-EXPEXPLORER-NEWAPPWIZARD!PZEXPRESSLPHARNESS.
 */
public class ra_stream_pzexpresslpharness_3bc4249ecbb429bd2fe50c078cc799dd extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.pzExpressLPHarness.Pega_Ext_ExpExplorer_NewAppWizard.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1643094177;
 ...
 */
	public ra_stream_pzexpresslpharness_3bc4249ecbb429bd2fe50c078cc799dd(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "842200fd8b955790d67c1e4d7c854bb6499fd0d0";
...
{
/* Instance RULE-HTML-HARNESS PEGA-EXT-EXPEXPLORER-NEWAPPWIZARD PZEXPRESSLPHARNESS #20210927T131613.084 GMT	Pega-Desktop:08-07-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-HARNESS PEGA-EXT-EXPEXPLORER-NEWAPPWIZARD PZEXPRESSLPHARNESS #20210927T131613.084 GMT
 * Set up context.
 */
final String prevRuleKey_19 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS PEGA-EXT-EXPEXPLORER-NEWAPPWIZARD PZEXPRESSLPHARNESS #20210927T131613.084 GMT";final String prevClass_19 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-HARNESS PEGA-EXT-EXPEXPLORER-NEWAPPWIZARD PZEXPRESSLPHARNESS #20210927T131613.084 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-File-Text:WEBWB!PZEXPRESSLPSCRIPTS!JS", 
	...
	"Rule-File-Text:WEBWB!PZ-APPLICATION-CONFIG-OVERRIDES!CSS", 
	"Rule-File-Text:WEBWB!PYEXPRESSLPSTYLES!CSS", 
	"Rule-File-Text:WEBWB!PZPEGA-EXPRESS-OVERRIDES!CSS", 
	"Rule-File-Text:WEBWB!PZPEGA_UI_AWPANEL_EXPRESS!JS", 
	"Rule-File-Text:WEBWB!PY-APPLICATION-CONFIG-EXTENSIBLE-STYLES!CSS", 
	"Rule-File-Text:WEBWB!PZPEGA_UI_JITJ_INIT!JS", 
	"Rule-File-Text:WEBWB!PZPEGA_APP!JS", 
	...
	"Rule-HTML-Harness:PZEXPRESSLPHARNESS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("WEBWB!PZEXPRESSLPSCRIPTS!JS","Rule-File-Text","",false,"","Pega-EndUserUI","","RULE-FILE-TEXT WEBWB PZEXPRESSLPSCRIPTS!JS #20201127T131826.458 GMT","WEBWB!PZEXPRESSLPSCRIPTS!JS",true,false,"ABSOLUTE_CLASSLESS",1), 
		...
		new DependentRuleInfo("WEBWB!PZ-APPLICATION-CONFIG-OVERRIDES!CSS","Rule-File-Text","",false,"","Pega-ProcessArchitect","08-07-01","RULE-FILE-TEXT WEBWB PZ-APPLICATION-CONFIG-OVERRIDES!CSS #20210413T203307.317 GMT","WEBWB!PZ-APPLICATION-CONFIG-OVERRIDES!CSS",true,false,"ABSOLUTE_CLASSLESS",1938125982), 
		new DependentRuleInfo("WEBWB!PYEXPRESSLPSTYLES!CSS","Rule-File-Text","",false,"","Pega-EndUserUI","08-23-01","RULE-FILE-TEXT WEBWB PYEXPRESSLPSTYLES!CSS #20230803T192645.975 GMT","WEBWB!PYEXPRESSLPSTYLES!CSS",true,false,"ABSOLUTE_CLASSLESS",555374398), 
		new DependentRuleInfo("WEBWB!PZPEGA-EXPRESS-OVERRIDES!CSS","Rule-File-Text","",false,"","Pega-Desktop","08-08-01","RULE-FILE-TEXT WEBWB PZPEGA-EXPRESS-OVERRIDES!CSS #20220510T074719.069 GMT","WEBWB!PZPEGA-EXPRESS-OVERRIDES!CSS",true,false,"ABSOLUTE_CLASSLESS",-30523040), 
		...
		new DependentRuleInfo("WEBWB!PY-APPLICATION-CONFIG-EXTENSIBLE-STYLES!CSS","Rule-File-Text","",false,"","Pega-ProcessArchitect","08-01-01","RULE-FILE-TEXT WEBWB PY-APPLICATION-CONFIG-EXTENSIBLE-STYLES!CSS #20180713T140751.468 GMT","WEBWB!PY-APPLICATION-CONFIG-EXTENSIBLE-STYLES!CSS",true,false,"ABSOLUTE_CLASSLESS",-743932011), 
		...
		new DependentRuleInfo("WEBWB!PZPEGA_APP!JS","Rule-File-Text","",false,"","Pega-Desktop","","RULE-FILE-TEXT WEBWB PZPEGA_APP!JS #20190710T105702.968 GMT","WEBWB!PZPEGA_APP!JS",true,false,"ABSOLUTE_CLASSLESS",1), 
		...
		new DependentRuleInfo("PZEXPRESSLPHARNESS","Rule-HTML-Harness","PEGA-EXT-EXPEXPLORER-NEWAPPWIZARD",false,"","Pega-Desktop","08-07-01","RULE-HTML-HARNESS PEGA-EXT-EXPEXPLORER-NEWAPPWIZARD PZEXPRESSLPHARNESS #20210927T131613.084 GMT","!PZEXPRESSLPHARNESS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1643094177), 
...
//	RULE-HTML-HARNESS PEGA-EXT-EXPEXPLORER-NEWAPPWIZARD PZEXPRESSLPHARNESS #20210927T131613.084 GMT:20210927T150940.266 GMT
...
//	RULE-FILE-TEXT WEBWB PZEXPRESSLPSCRIPTS!JS #20201127T131826.458 GMT:20201127T131826.458 GMT
//	RULE-FILE-TEXT WEBWB PZPEGA_APP!JS #20190710T105702.968 GMT:20190717T133325.575 GMT
//	RULE-FILE-TEXT WEBWB PYEXPRESSLPSTYLES!CSS #20230803T192645.975 GMT:20230803T192645.975 GMT
//	RULE-FILE-TEXT WEBWB PZPEGA-EXPRESS-OVERRIDES!CSS #20220510T074719.069 GMT:20220512T134323.366 GMT
//	RULE-FILE-TEXT WEBWB PZ-APPLICATION-CONFIG-OVERRIDES!CSS #20210413T203307.317 GMT:20211101T131518.271 GMT
//	RULE-FILE-TEXT WEBWB PY-APPLICATION-CONFIG-EXTENSIBLE-STYLES!CSS #20180713T140751.468 GMT:20180713T140751.468 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "15ccb75343a46da63518bbeecaffa3a5";
	}

	public String getDefinitionAppliesToClass() {
		return "Pega-Ext-ExpExplorer-NewAppWizard";
	}
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pyExpressLPContentTemplate", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "pyExpressLPContentTemplate";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzExpressLPHeaderSection", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzExpressLPHeaderSection";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
...
generateContainerMetaData_1() {
	...
	pg_harnesscontainer.put("containerStyle","Default");
...
public void pzGenerateHarnessHeaderAndFooter_2() {
}
...
public void createFormElement_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		pg_form.put("streamName","pzExpressLPHarness");
		pg_form.put("RO",StringUtils.crossScriptingFilter(tools.getParamValue("ReadOnly")));
		pg_form.put("customErrorSection","pzBlankErrorSection");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		pzGenerateHarnessHeaderAndFooter_2();
		if(pzHarness.getBuilder().isTemplatingEnabled()){
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
		}
...
try { 
Iterator cssIter; 
ArrayList cssFileList = new ArrayList(); 
String generatedCssHash = null; 
String pyCustomStyleName = null; 
StringBuffer insKeyStr = new StringBuffer(); 
String className = this.getClass().getName(); 
insKeyStr.append(className); 
insKeyStr.append(" "); 
boolean generateOneHarnessCSS = tools.getSaveValue("generateOneHarnessCSS").equals("true");
if(generateOneHarnessCSS) { 
String skinCSSFileStr = tools.getSaveValue("skinCSSFileList"); 
if(skinCSSFileStr == null || skinCSSFileStr.length() == 0) { 
oLog.debug("skinCSSFileStr is null or empty");
} 
if(skinCSSFileStr != null && skinCSSFileStr.length() > 0) { 
String[] cssFileArr = skinCSSFileStr.split("\\$"); 
for(int i = 0; i< cssFileArr.length; i++) { 
if(cssFileArr[i].trim().length() > 0) { 
int lastPathIndex = cssFileArr[i].lastIndexOf("/"); 
if(lastPathIndex != -1){ 
cssFileArr[i] = cssFileArr[i].substring(lastPathIndex+1, cssFileArr[i].length()); 
}
int dotIndex = cssFileArr[i].indexOf('.'); 
if (dotIndex > 0) { 
cssFileArr[i] = cssFileArr[i].substring(0,dotIndex); 
} 
cssFileList.add(cssFileArr[i].trim()); 
} 
} 
} 
} 
boolean bUseRTL = false; 
if((tools.getRequestor().getTextOrientation() == PRRequestor.ORIENTATION_RIGHT_TO_LEFT) && (tools.findPage("pxRequestor").getString("pyDesktopType").equals("User") || tools.findPage("pxRequestor").getString("pyDesktopType").equals("Composite"))) bUseRTL = true; 
if(!bUseRTL){ 

cssFileList.add("pyExpressLpStyles");
cssFileList.add("pzpega-express-overrides");
cssFileList.add("pz-application-config-overrides");
cssFileList.add("py-application-config-extensible-styles");
} else {
cssFileList.add("pyExpressLpStyles");
cssFileList.add("pzpega-express-overrides");
cssFileList.add("pz-application-config-overrides");
...
oLog.debug("cssFileList is empty or null");
}
cssIter = cssFileList.iterator(); 
while(cssIter.hasNext()) { 
String cssFileNm = (String)cssIter.next(); 
if (cssFileNm.length() > 0) { insKeyStr.append(cssFileNm); insKeyStr.append(" "); } 
}
if(insKeyStr == null || insKeyStr.length() == 0) { 
oLog.debug("insKeyStr is empty or null");
}
generatedCssHash = tools.getPRCrypto().digestString(insKeyStr.toString(),null); 
pyCustomStyleName = "pzharnessv2_pzexpresslpharness" + generatedCssHash; 
oLog.debug("[includeGeneratedCSS] - Before calling GenerateCSS pyCustomStyleName=" + pyCustomStyleName);
	String staticContentFilename = com.pega.pegarules.priv.ui.skin.GenerateCSS.isStaticFileGenerated(cssFileList, pyCustomStyleName, null);

	 if(staticContentFilename==null) staticContentFilename = com.pega.pegarules.priv.ui.skin.GenerateCSS.generateStaticContent(cssFileList, pyCustomStyleName, className, null, null, ((PegaAPI)tools).getUIEngine().isOrientationRTL(),null); 

String[] cssFileNamesArr = staticContentFilename.split(";"); 
for(int cssFileIndex = 0; cssFileIndex < cssFileNamesArr.length; cssFileIndex++) { 
com.pega.pegarules.jsptags.StaticTag staticTag = (com.pega.pegarules.jsptags.StaticTag) JSPTagHandlerPool.getInstance().get(com.pega.pegarules.jsptags.StaticTag.class); 
staticTag.setPageContext(pageContext); 
staticTag.setParent(mParentTag);
staticTag.setType("style"); 
staticTag.setApp("webwb"); 
staticTag.setPath(""); 
int eval_staticTag = staticTag.doStartTag(); 
if (eval_staticTag != javax.servlet.jsp.tagext.Tag.SKIP_BODY) { 
do { 
final javax.servlet.jsp.tagext.Tag prevParentTag_1 = mParentTag; 
mParentTag = staticTag; 
com.pega.pegarules.jsptags.FileTag fileTag = (com.pega.pegarules.jsptags.FileTag) JSPTagHandlerPool.getInstance().get(com.pega.pegarules.jsptags.FileTag.class); 
fileTag.setPageContext(pageContext); 
fileTag.setParent(mParentTag); 
fileTag.setName(cssFileNamesArr[cssFileIndex] + ".css"); 
int eval_fileTag = fileTag.doStartTag(); 
if (fileTag.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) { return; } 
JSPTagHandlerPool.getInstance().reuse(fileTag); 
mParentTag = prevParentTag_1; 
int evalDoAfterBody = staticTag.doAfterBody(); 
if (evalDoAfterBody != javax.servlet.jsp.tagext.BodyTag.EVAL_BODY_AGAIN) { break; } 
} while (true); } 
if (staticTag.doEndTag() == javax.servlet.jsp.tagext.Tag.SKIP_PAGE) { return; } 
JSPTagHandlerPool.getInstance().reuse(staticTag); 
}
} catch(Exception ex) {oLog.error(ex);} 
} 
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","pzExpressLPHarness");
...
public void setHarnessConfigurations_1() {
	...
	tools.putParamValue("KeepFixedVisible", "false"); 
	tools.putParamValue("pyCustomError", "pzBlankErrorSection");
...
IStaticContentRuntime pzStatic__1 = pzAuto.getStaticBlock("script");
	pzStatic__1.addFile("pzexpresslpscripts", "11108614680", "js");
	pzStatic__1.addFile("pzpega_app", "14035301684", "js");
...
public void createPegaHarnessDIV_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","pzExpressLPHarness");
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("pzExpressLPHarness",true));
					tools.appendString("</title>");
try {
...
static {
	...
	oStreamProperties_19.put("pyClassName", "Pega-Ext-ExpExplorer-NewAppWizard");
	oStreamProperties_19.put("pyCircumstanceProp", "");
	oStreamProperties_19.put("pzInsKey", "RULE-HTML-HARNESS PEGA-EXT-EXPEXPLORER-NEWAPPWIZARD PZEXPRESSLPHARNESS #20210927T131613.084 GMT");
	...
	oStreamProperties_19.put("pyStreamName", "pzExpressLPHarness");
	oStreamProperties_19.put("pyRuleSetVersion", "08-07-01");
}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS PEGA-EXT-EXPEXPLORER-NEWAPPWIZARD PZEXPRESSLPHARNESS #20210927T131613.084 GMT", "Pega-Ext-ExpExplorer-NewAppWizard pzExpressLPHarness", "Pega-Desktop", "08-07-01", "20210927T150940.266 GMT");
