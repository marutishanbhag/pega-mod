...
/**
 * Builds JSP stream WORK-!PERFORM.
 */
public class ra_stream_perform_13526c2a0fb339ff932846a41a45edf7 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.Perform.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1061641964;
 ...
 */
	public ra_stream_perform_13526c2a0fb339ff932846a41a45edf7(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "2fc2e48c10f2144d2db7d3f07dec96fec1d5b3db";
...
{
/* Instance RULE-HTML-HARNESS WORK- PERFORM #20210506T204026.419 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
/*
 * Begin RULE-HTML-HARNESS WORK- PERFORM #20210506T204026.419 GMT
 * Set up context.
 */
final String prevRuleKey_19 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS WORK- PERFORM #20210506T204026.419 GMT";final String prevClass_19 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-HARNESS WORK- PERFORM #20210506T204026.419 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PERFORM","Rule-HTML-Harness","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-HARNESS WORK- PERFORM #20210506T204026.419 GMT","!PERFORM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1061641964), 
...
//	RULE-HTML-HARNESS WORK- PERFORM #20210506T204026.419 GMT:20210506T204026.419 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "3c23d3d0c5be0905691bfc214e6fb42e";
	}
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pxCaseMain", secInfo);
}
...
public void buildSection_1() { 
	if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginVisibleWhen(" wxpxIsMobileDevice", pxUniqueStreamHash+"_4")) {
	Map<String, Object> secInfo = new HashMap<String, Object>();
	secInfo.put("usingPage","");
	secInfo.put("isUsingPagePropertyRef",false);
	secInfo.put("doNotConsiderDecParams",false);
...
public void includeSectionBody_1() { 
	...
	String strSectionPageProp = "";
	if(pzAuto.handleEvaluateWhen(" wxpxIsMobileDevice","pxIsMobileDevice", "layout", "visible" )) {
...
public void createFormElement_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		pg_form.put("streamName","Perform");
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","Perform");
...
IStaticContentRuntime pzStatic__1 = pzAuto.getStaticBlock("script");
	pzStatic__1.addBundle("pz-cosmos-ui-scripts", "13253080290");
...
public void createPegaHarnessDIV_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","Perform");
		...
		pg_harnesscnt.put("CSSClass","workarea-view-harness flat-menu");
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("Perform",true));
					tools.appendString("</title>");
try {
...
static {
	...
	oStreamProperties_19.put("pyMethodStatus", "Extension");
	oStreamProperties_19.put("pyClassName", "Work-");
	oStreamProperties_19.put("pyCircumstanceProp", "");
	oStreamProperties_19.put("pzInsKey", "RULE-HTML-HARNESS WORK- PERFORM #20210506T204026.419 GMT");
	...
	oStreamProperties_19.put("pyStreamName", "Perform");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS WORK- PERFORM #20210506T204026.419 GMT", "Work- Perform", "Theme-Cosmos", "04-01-01", "20210506T204026.419 GMT");
