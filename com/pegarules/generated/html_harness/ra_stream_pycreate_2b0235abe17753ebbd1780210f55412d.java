...
/**
 * Builds JSP stream WORK-!PYCREATE.
 */
public class ra_stream_pycreate_2b0235abe17753ebbd1780210f55412d extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.pyCreate.OFON2J_ProcessO_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1575842671;
 ...
 */
	public ra_stream_pycreate_2b0235abe17753ebbd1780210f55412d(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "2c9ce00d027ec903df9656054ca275eb9879fa0d";
...
/* handling 1 of 4 definitions  */
if (ruleChooser_1.ruleApplies(new RuleCharacteristicsImpl("pzForCreateStage", "pzDefinitionForDesktopCreateStage", null, RuleResolutionStatistics.CircumstanceType.valueOf("TEMPLATE") ,null, null, null, tools))) {
/* Instance RULE-HTML-HARNESS WORK- PYCREATE #20210819T090017.859 GMT	Theme-Cosmos:04-01-01	pzForCreateStage=pzDefinitionForDesktopCreateStage	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
executeStream_1();
/* handling 2 of 4 definitions  */
} else if (ruleChooser_1.ruleApplies(new RuleCharacteristicsImpl("pzForCreateStage", "pzDefinitionForCreateStage", null, RuleResolutionStatistics.CircumstanceType.valueOf("TEMPLATE") ,null, null, null, tools))) {
/* Instance RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.460 GMT	Theme-Cosmos:04-01-01	pzForCreateStage=pzDefinitionForCreateStage	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
executeStream_2();
/* handling 3 of 4 definitions  */
} else if (ruleChooser_1.ruleApplies(new RuleCharacteristicsImpl("pzForCreateStage", "pzDefinitionForACCreateStage", null, RuleResolutionStatistics.CircumstanceType.valueOf("TEMPLATE") ,null, null, null, tools))) {
/* Instance RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.453 GMT	Theme-Cosmos:04-01-01	pzForCreateStage=pzDefinitionForACCreateStage	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
executeStream_3();
/* handling 4 of 4 definitions (isLast)  */
} else {
/* Instance RULE-HTML-HARNESS WORK- PYCREATE #20210903T103024.156 GMT	Pega-EndUserUI:08-07-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
executeStream_4();
}
	} catch (Throwable ex) {
		handleError(ex);
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYCREATE","Rule-HTML-Harness","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.453 GMT","!PYCREATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-63435754), 
		new DependentRuleInfo("PYCREATE","Rule-HTML-Harness","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.460 GMT","!PYCREATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",706274451), 
		new DependentRuleInfo("PYCREATE","Rule-HTML-Harness","WORK-",false,"","Theme-Cosmos","04-01-01","RULE-HTML-HARNESS WORK- PYCREATE #20210819T090017.859 GMT","!PYCREATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-932801470), 
		new DependentRuleInfo("PYCREATE","Rule-HTML-Harness","WORK-",false,"","Pega-EndUserUI","08-07-01","RULE-HTML-HARNESS WORK- PYCREATE #20210903T103024.156 GMT","!PYCREATE",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1575842671), 
...
//	RULE-HTML-HARNESS WORK- PYCREATE #20210819T090017.859 GMT:20210903T104224.450 GMT
//	RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.460 GMT:20211116T064510.674 GMT
//	RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.453 GMT:20210903T104224.616 GMT
//	RULE-HTML-HARNESS WORK- PYCREATE #20210903T103024.156 GMT:20210903T103024.156 GMT
...
//	generateWorkAreaLayouts_3(
//	includeSectionBody_5(
//	generateWorkAreaLayouts_2(
//	generateWorkAreaLayouts_1(
//	includeSectionBody_1(
//	generateWorkAreaLayouts_4(
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "4de2f3880acae953015d662446750431";
	}
...
boolean whenResult_31 = pega.invokeWhen("recordEvent", "", "");
...
public void buildSection_8() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pyCaseActionAreaButtons", secInfo);
}
...
public void includeSectionBody_8() { 
	...
	String includedSectionName = "";includedSectionName = "pyCaseActionAreaButtons";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
public void buildSection_7() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pyCreateMain", secInfo);
}
...
public void includeSectionBody_7() { 
	...
	String includedSectionName = "";includedSectionName = "pyCreateMain";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public IUIComponentMetadata 
generateWorkAreaMetaData_4() {
	IUIComponentMetadata pg_workarea = pzAuto.getUIComponentRuntime().createMetadata();
	pg_workarea.put("isHeaderFixed","false");
	pg_workarea.put("isFooterFixed","true");
...
public IUIComponentMetadata 
generateWorkAreaContentMetaData_4() {
	IUIComponentMetadata pg_workarea = pzAuto.getUIComponentRuntime().createMetadata();
...
public void generateWorkAreaLayouts_4(){
	IUIComponentMetadata workAreaMetadata = generateWorkAreaMetaData_4();
	IUIComponentMetadata workAreaHeaderMetadata = generateWorkAreaHeaderMetaData_2();
	IUIComponentMetadata workAreaLeftMetadata = generateWorkAreaLeftMetaData_1();
	IUIComponentMetadata workAreaContentMetadata = generateWorkAreaContentMetaData_4();
	IUIComponentMetadata workAreaRightMetadata = generateWorkAreaRightMetaData_1();
	IUIComponentMetadata workAreaFooterMetadata = generateWorkAreaFooterMetaData_2();
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	tools.putParamValue("pySectionIncludeHeight", "Auto");
	uiBuilder.beginFooter(workAreaFooterMetadata);
	tools.putParamValue("bIsScreenLayout", "true");
try {
includeSectionBody_8();
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
	...
	uiBuilder.endFooter(workAreaFooterMetadata);
	uiBuilder.end(workAreaMetadata);
	}
}
public void processWorkAreaLayouts_4() {
	generateWorkAreaLayouts_4();
}
public void createFormElement_4() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		pg_form.put("streamName","pyCreate");
...
public void setHarnessConfigurations_2() {
	 tools.putSaveValue("bClientValidation", "true");
	tools.putSaveValue("bExpressionCalculation", "true");
...
IStaticContentRuntime pzStatic__27 = pzAuto.getStaticBlock("script");
	}
}
public void createPegaHarnessDIV_4() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","pyCreate");
...
public void includePortalPanel_4(String position) {
...
public void includePegaHarnessContent_4() {
	if(pzHarness.getBuilder().isSDMSelfNavigation()){
		...
		if(pyLayouts != null){
			...
			includePortalPanel_4("TOP");
			includePortalPanel_4("LEFT");
			includePortalPanel_4("CENTER");
			includePortalPanel_4("RIGHT");
			includePortalPanel_4("BOTTOM");
...
public void buildHarnessMarkup_4() {
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("Create",true));
					tools.appendString("</title>");
try {
...
buildHarnessMarkup_4();
}
private static final Map oPropDefinitions_22 = null;
private static final Map oStreamProperties_22 = new HashMap();
static {
	oStreamProperties_22.put("pyRuleAvailable", "Yes");
	oStreamProperties_22.put("pyCircumstanceDateProp", "");
	oStreamProperties_22.put("pyCircumstanceVal", "");
	oStreamProperties_22.put("pyMethodStatus", "");
	oStreamProperties_22.put("pyClassName", "Work-");
	oStreamProperties_22.put("pyCircumstanceProp", "");
	oStreamProperties_22.put("pzInsKey", "RULE-HTML-HARNESS WORK- PYCREATE #20210903T103024.156 GMT");
	oStreamProperties_22.put("pxObjClass", "Rule-HTML-Harness");
	...
	oStreamProperties_22.put("pyRuleSet", "Pega-EndUserUI");
	oStreamProperties_22.put("pyCorrType", "");
	oStreamProperties_22.put("pyStreamName", "pyCreate");
	oStreamProperties_22.put("pyRuleSetVersion", "08-07-01");
}
private boolean when_17() throws Throwable {
boolean whenResult_29 = pega.invokeWhen("recordEvent", "", "");
...
public void buildSection_6() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pyCreateCaseFooter", secInfo);
}
...
public void includeSectionBody_6() { 
	...
	String includedSectionName = "";includedSectionName = "pyCreateCaseFooter";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void buildSection_5() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pyCreateMain", secInfo);
}
...
public void buildSection_4() { 
	...
	secInfo.put("packageSectionClass", "Work-");
	String expressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
	if(StringUtils.isBlank(expressionId)) {
		expressionId = pxUniqueStreamHash+"_4";
	}
		expression = pzAuto.getUIComponentRuntime().getExpressionEvaluator().addExpression("sectionRefreshWhen",  ".pyID Changes", expressionId);
		if(StringUtils.isBlank(expressionId)) {
			...
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pxCreateCaseTopHeaderWrapper", secInfo);
		}
...
public void includeSectionBody_4() { 
	...
	"pxCreateCaseTopHeaderWrapper", tools.getStepPage().getReference(),"Work-");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	generateClientWhenDiv_1();
	
	
	String includedSectionName = "";includedSectionName = "pxCreateCaseTopHeaderWrapper";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
	tools.appendString("\n\t\t\t\t\t\t</div>");
	}
}
public IUIComponentMetadata 
generateWorkAreaMetaData_3() {
	IUIComponentMetadata pg_workarea = pzAuto.getUIComponentRuntime().createMetadata();
...
public IUIComponentMetadata 
generateWorkAreaContentMetaData_3() {
	IUIComponentMetadata pg_workarea = pzAuto.getUIComponentRuntime().createMetadata();
	pg_workarea.put("scrollClass","workarea-view-content-enable-scroll");
	pg_workarea.put("centerInspectorData",pzHarness.getInspectorDataForPanel("CENTER"));
	pg_workarea.put("ariaLabelCenterPanel",tools.getLocalizedTextForString(".pyCaption", "Center Panel"));
	pg_workarea.put("startWrapperDiv","true");
	pg_workarea.put("endWrapperDiv","true");
...
public IUIComponentMetadata 
generateWorkAreaFooterMetaData_2() {
	IUIComponentMetadata pg_workarea = pzAuto.getUIComponentRuntime().createMetadata();
	pg_workarea.put("finalFooterClass","workarea-view-footer workarea-view-footer-fixed");
...
public void generateWorkAreaLayouts_3(){
	IUIComponentMetadata workAreaMetadata = generateWorkAreaMetaData_3();
	IUIComponentMetadata workAreaHeaderMetadata = generateWorkAreaHeaderMetaData_1();
	IUIComponentMetadata workAreaLeftMetadata = generateWorkAreaLeftMetaData_1();
	IUIComponentMetadata workAreaContentMetadata = generateWorkAreaContentMetaData_3();
	IUIComponentMetadata workAreaRightMetadata = generateWorkAreaRightMetaData_1();
	IUIComponentMetadata workAreaFooterMetadata = generateWorkAreaFooterMetaData_2();
	if(workAreaMetadata!= null){
	com.pega.pegarules.priv.runtime.IHarnessWorkAreaUIBuilder uiBuilder = pzHarness.getWorkAreaSLBuilder();
...
public void processWorkAreaLayouts_3() {
	generateWorkAreaLayouts_3();
}
public void createFormElement_3() {
	IUIComponentMetadata pg_form = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata hcMetdata = pzAuto.getUIComponentRuntime().createMetadata();
	pg_form.put("target",StringUtils.crossScriptingFilter(tools.getRootParamValue("target")));
	pg_form.put("pzHarnessID",tools.getParamValue("pzHarnessID"));
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		pg_form.put("streamName","pyCreate");
		pg_form.put("RO",StringUtils.crossScriptingFilter(tools.getParamValue("ReadOnly")));
		pg_form.put("customErrorSection","pyCaseErrorSection");
		pg_form.put("folderKey",StringUtils.crossScriptingFilter(tools.getParamValue("FolderKey")));
		pg_form.put("inputEnabled",String.valueOf(tools.hasInputEnabled()));
		pg_form.put("formPost",tools.getPrimaryPage().getProperty("pyFormPost").getEntryHandle());
		StringMap keys =  new HashStringMap();
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	processWorkAreaLayouts_3();
	if("".equals(tools.getParamValue("RenderSingle"))){
		if(pzHarness.getBuilder().isTemplatingEnabled()){
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplateComponent(pxUniqueStreamHash+"_8");
		}
		if(!"ACTION".equals(tools.getParamValue("HarnessMode"))){
try {
/* Include stream RULE-HTML-FRAGMENT FORMERRORMARKER #20180713T133243.506 GMT */
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		pzHarness.getBuilder().endHarnessContent(hcMetdata);
		if(pzHarness.getBuilder().isTemplatingEnabled()){
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplateComponent(pxUniqueStreamHash+"_9");
		}
		if(pzHarness.getBuilder().isTemplatingEnabled()){
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().endNonTemplateComponent();
		}
...
public void includeScripts_3() {
	String bRemoteCase = pzHarness.getBuilder().getParameterFromRootStackFrame("isRemoteCase");
	if(("").equals(bRemoteCase) || bRemoteCase == null) {
IStaticContentRuntime pzStatic__26 = pzAuto.getStaticBlock("script");
	}
}
public void createPegaHarnessDIV_3() {
	IUIComponentMetadata pg_harnesscnt = pzAuto.getUIComponentRuntime().createMetadata();
	if("".equals(tools.getParamValue("RenderSingle"))){
		if(pzAuto.isInspectMode()){
			pg_harnesscnt.put("liveUI",pzHarness.getInspectorData());
...
public void includePortalPanel_3(String position) {
	if(pzHarness.getBuilder().hasLayout(position)){
		ClipboardProperty cp_Layout = pzHarness.getBuilder().getLayout(position);
		pzHarness.getBuilder().createPortalChrome(cp_Layout,position,true, pzHarness.getInspectorDataForPanel(position));
		if(cp_Layout != null && cp_Layout.getPageValue().getBoolean("pyHasDynamicContainer")){
			createPegaHarnessDIV_3();
		}else{
	pzHarness.getBuilder().includePanelSection(cp_Layout);
}
pzHarness.getBuilder().createPortalChrome(cp_Layout,position,false, null);
...
public void includePegaHarnessContent_3() {
	if(pzHarness.getBuilder().isSDMSelfNavigation()){
		pzHarness.getBuilder().createHTMLElementForDataModel();
		ClipboardProperty pyLayouts = pzHarness.getBuilder().getPortalLayout();
		if(pyLayouts != null){
			pzHarness.getBuilder().createPortalChrome(null,"MAIN",true, pzHarness.getInspectorData());
			includePortalPanel_3("TOP");
			includePortalPanel_3("LEFT");
			includePortalPanel_3("CENTER");
			includePortalPanel_3("RIGHT");
			includePortalPanel_3("BOTTOM");
			pzHarness.getBuilder().createPortalChrome(null,"MAIN",false, null);
		}else{
			createPegaHarnessDIV_3();
		}
...
public void buildHarnessMarkup_3() {
	if(!pzHarness.getBuilder().canProcessStream()){
		return;
	}
	pzHarness.getBuilder().setTools();
...
throw new RuntimeException("Problem in JSP fragment", t);
			...
			includePegaHarnessContent_3();
			pzGenerateElementModel_1();
			tools.putSaveValue("AutoDocInfoInclude", "true");
			pzHarness.getBuilder().includeLazyLoadInfo();
			if("".equals(tools.getParamValue("RenderSingle"))){
try {
boolean whenResult_30 = pega.invokeWhen("recordEvent", "", "");
	if (whenResult_30) {
/* Include stream RULE-HTML-FRAGMENT PYINCLUDEUWT #20180713T133243.549 GMT */
include_6();
...
buildHarnessMarkup_3();
}
private static final Map oPropDefinitions_21 = null;
private static final Map oStreamProperties_21 = new HashMap();
static {
	oStreamProperties_21.put("pyRuleAvailable", "Yes");
	oStreamProperties_21.put("pyCircumstanceDateProp", "");
	oStreamProperties_21.put("pyCircumstanceVal", "pzDefinitionForACCreateStage");
	oStreamProperties_21.put("pyMethodStatus", "");
	oStreamProperties_21.put("pyClassName", "Work-");
	oStreamProperties_21.put("pyCircumstanceProp", "pzForCreateStage");
	oStreamProperties_21.put("pzInsKey", "RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.453 GMT");
	oStreamProperties_21.put("pxObjClass", "Rule-HTML-Harness");
	...
	oStreamProperties_21.put("pyRuleSet", "Theme-Cosmos");
	oStreamProperties_21.put("pyCorrType", "");
	oStreamProperties_21.put("pyStreamName", "pyCreate");
	oStreamProperties_21.put("pyRuleSetVersion", "04-01-01");
}
private boolean when_16() throws Throwable {
boolean whenResult_27 = pega.invokeWhen("recordEvent", "", "");
return whenResult_27;
}
public void buildSection_3() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pxCreateMainWrapper", secInfo);
}
...
public void includeSectionBody_3() { 
	...
	String includedSectionName = "";includedSectionName = "pxCreateMainWrapper";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public IUIComponentMetadata 
generateWorkAreaMetaData_2() {
	IUIComponentMetadata pg_workarea = pzAuto.getUIComponentRuntime().createMetadata();
	pg_workarea.put("isHeaderFixed","false");
...
public IUIComponentMetadata 
generateWorkAreaHeaderMetaData_2() {
	IUIComponentMetadata pg_workarea = pzAuto.getUIComponentRuntime().createMetadata();
	pg_workarea.put("finalHeaderClass","");
...
public IUIComponentMetadata 
generateWorkAreaContentMetaData_2() {
	IUIComponentMetadata pg_workarea = pzAuto.getUIComponentRuntime().createMetadata();
	pg_workarea.put("scrollClass","");
	pg_workarea.put("centerInspectorData",pzHarness.getInspectorDataForPanel("CENTER"));
	pg_workarea.put("ariaLabelCenterPanel",tools.getLocalizedTextForString(".pyCaption", "Center Panel"));
...
public void generateWorkAreaLayouts_2(){
	IUIComponentMetadata workAreaMetadata = generateWorkAreaMetaData_2();
	IUIComponentMetadata workAreaHeaderMetadata = generateWorkAreaHeaderMetaData_2();
	IUIComponentMetadata workAreaLeftMetadata = generateWorkAreaLeftMetaData_1();
	IUIComponentMetadata workAreaContentMetadata = generateWorkAreaContentMetaData_2();
	IUIComponentMetadata workAreaRightMetadata = generateWorkAreaRightMetaData_1();
...
public void processWorkAreaLayouts_2() {
	generateWorkAreaLayouts_2();
}
public void createFormElement_2() {
	IUIComponentMetadata pg_form = pzAuto.getUIComponentRuntime().createMetadata();
	IUIComponentMetadata hcMetdata = pzAuto.getUIComponentRuntime().createMetadata();
	pg_form.put("target",StringUtils.crossScriptingFilter(tools.getRootParamValue("target")));
	pg_form.put("pzHarnessID",tools.getParamValue("pzHarnessID"));
...
public void includeScripts_2() {
	String bRemoteCase = pzHarness.getBuilder().getParameterFromRootStackFrame("isRemoteCase");
	if(("").equals(bRemoteCase) || bRemoteCase == null) {
IStaticContentRuntime pzStatic__25 = pzAuto.getStaticBlock("script");
	}
}
public void createPegaHarnessDIV_2() {
	IUIComponentMetadata pg_harnesscnt = pzAuto.getUIComponentRuntime().createMetadata();
	if("".equals(tools.getParamValue("RenderSingle"))){
		if(pzAuto.isInspectMode()){
			pg_harnesscnt.put("liveUI",pzHarness.getInspectorData());
...
public void includePortalPanel_2(String position) {
	if(pzHarness.getBuilder().hasLayout(position)){
		ClipboardProperty cp_Layout = pzHarness.getBuilder().getLayout(position);
		pzHarness.getBuilder().createPortalChrome(cp_Layout,position,true, pzHarness.getInspectorDataForPanel(position));
		if(cp_Layout != null && cp_Layout.getPageValue().getBoolean("pyHasDynamicContainer")){
			createPegaHarnessDIV_2();
		}else{
	pzHarness.getBuilder().includePanelSection(cp_Layout);
}
pzHarness.getBuilder().createPortalChrome(cp_Layout,position,false, null);
...
public void includePegaHarnessContent_2() {
	if(pzHarness.getBuilder().isSDMSelfNavigation()){
		pzHarness.getBuilder().createHTMLElementForDataModel();
		ClipboardProperty pyLayouts = pzHarness.getBuilder().getPortalLayout();
		if(pyLayouts != null){
			pzHarness.getBuilder().createPortalChrome(null,"MAIN",true, pzHarness.getInspectorData());
			includePortalPanel_2("TOP");
			includePortalPanel_2("LEFT");
			includePortalPanel_2("CENTER");
			includePortalPanel_2("RIGHT");
			includePortalPanel_2("BOTTOM");
			pzHarness.getBuilder().createPortalChrome(null,"MAIN",false, null);
		}else{
			createPegaHarnessDIV_2();
		}
...
public void buildHarnessMarkup_2() {
	if(!pzHarness.getBuilder().canProcessStream()){
		return;
	}
	pzHarness.getBuilder().setTools();
...
throw new RuntimeException("Problem in JSP fragment", t);
			...
			includePegaHarnessContent_2();
			pzGenerateElementModel_1();
			tools.putSaveValue("AutoDocInfoInclude", "true");
			pzHarness.getBuilder().includeLazyLoadInfo();
			if("".equals(tools.getParamValue("RenderSingle"))){
try {
boolean whenResult_28 = pega.invokeWhen("recordEvent", "", "");
	if (whenResult_28) {
/* Include stream RULE-HTML-FRAGMENT PYINCLUDEUWT #20180713T133243.549 GMT */
include_6();
...
buildHarnessMarkup_2();
}
private static final Map oPropDefinitions_20 = null;
private static final Map oStreamProperties_20 = new HashMap();
static {
	oStreamProperties_20.put("pyRuleAvailable", "Yes");
	oStreamProperties_20.put("pyCircumstanceDateProp", "");
	oStreamProperties_20.put("pyCircumstanceVal", "pzDefinitionForCreateStage");
	oStreamProperties_20.put("pyMethodStatus", "");
	oStreamProperties_20.put("pyClassName", "Work-");
	oStreamProperties_20.put("pyCircumstanceProp", "pzForCreateStage");
	oStreamProperties_20.put("pzInsKey", "RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.460 GMT");
	oStreamProperties_20.put("pxObjClass", "Rule-HTML-Harness");
	...
	oStreamProperties_20.put("pyRuleSet", "Theme-Cosmos");
	oStreamProperties_20.put("pyCorrType", "");
	oStreamProperties_20.put("pyStreamName", "pyCreate");
	oStreamProperties_20.put("pyRuleSetVersion", "04-01-01");
}
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","pxCaseMain", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "pxCaseMain";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
...
if(currentTemplatingStatus =='N') {
try {
tools.appendString("RWP=\".pyID\" RW=\".pyID Changes\"");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
}
...
try{
	if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){
		...
		changeTracker.trackValueChanges(pega_uiengine_harness.pzGetPropertyNameForTracking(".pyID"), -1);
	}
}catch(Exception e){}
}
public void buildSection_1() { 
	...
	if(StringUtils.isBlank(expressionId)) {
		...
		if(StringUtils.isBlank(expressionId)) {
			...
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pxCaseTopHeaderWrapper", secInfo);
		}
...
public void includeSectionBody_1() { 
	...
	try{
	pzPackageRuntime.packageSection(
	"pxCaseTopHeaderWrapper", tools.getStepPage().getReference(),"Work-");}catch(Exception e1){oLog.error("Error generating package - " + e1.getMessage());}
	}
	generateClientWhenDiv_1();
	
	
	String includedSectionName = "";includedSectionName = "pxCaseTopHeaderWrapper";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
	tools.appendString("\n\t\t\t\t\t\t</div>");
	}
}
...
throw new RuntimeException("Problem in JSP fragment", t);
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		if(pzHarness.getBuilder().isTemplatingEnabled()){
			pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplateComponent(pxUniqueStreamHash+"_7");
		}
		if(!"ACTION".equals(tools.getParamValue("HarnessMode"))){
try {
/* Include stream RULE-HTML-FRAGMENT FORMERRORMARKER #20180713T133243.506 GMT */
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","pyCreate");
...
public void setHarnessConfigurations_1() {
	...
	tools.putParamValue("FieldError", "");
	tools.putParamValue("AlwaysShowFormLevelErrors", "true");
	tools.putParamValue("KeepFixedVisible", "true"); 
	tools.putParamValue("pyCustomError", "pyCaseErrorSection");
	tools.putParamValue("IgnoreDirty", "false");
	tools.putParamValue("enableTemplate", "default");
	pzHarness.getBuilder().setTarget();
	tools.putParamValue("bExcludeLegacyJS", "true");
...
static {
	oStreamProperties_19.put("pyRuleAvailable", "Yes");
	oStreamProperties_19.put("pyCircumstanceDateProp", "");
	oStreamProperties_19.put("pyCircumstanceVal", "pzDefinitionForDesktopCreateStage");
	oStreamProperties_19.put("pyMethodStatus", "");
	oStreamProperties_19.put("pyClassName", "Work-");
	oStreamProperties_19.put("pyCircumstanceProp", "pzForCreateStage");
	oStreamProperties_19.put("pzInsKey", "RULE-HTML-HARNESS WORK- PYCREATE #20210819T090017.859 GMT");
	...
	oStreamProperties_19.put("pyRuleSet", "Theme-Cosmos");
	oStreamProperties_19.put("pyCorrType", "");
	oStreamProperties_19.put("pyStreamName", "pyCreate");
	oStreamProperties_19.put("pyRuleSetVersion", "04-01-01");
}
private void executeStream_1() {
/*
 * Begin RULE-HTML-HARNESS WORK- PYCREATE #20210819T090017.859 GMT
 * Set up context.
 */
final String prevRuleKey_19 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS WORK- PYCREATE #20210819T090017.859 GMT";final String prevClass_19 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-HARNESS WORK- PYCREATE #20210819T090017.859 GMT */
}
private void executeStream_2() {
/*
 * Begin RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.460 GMT
 * Set up context.
 */
final String prevRuleKey_20 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.460 GMT";final String prevClass_20 = mStreamResponse.getJspBaseClass();
mStreamResponse.setJspBaseClass("Rule-HTML-Harness");
...
if (!pzDispatchToInvokedMethod()) {
	...
	((com.pega.pegarules.priv.runtime.PegaStreamAPI)pega).streamEpilog(oTraceInfo_19,false);
}
/* end RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.460 GMT */
}
private void executeStream_3() {
/*
 * Begin RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.453 GMT
 * Set up context.
 */
final String prevRuleKey_21 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.453 GMT";final String prevClass_21 = mStreamResponse.getJspBaseClass();
mStreamResponse.setJspBaseClass("Rule-HTML-Harness");
...
if (!pzDispatchToInvokedMethod()) {
	...
	((com.pega.pegarules.priv.runtime.PegaStreamAPI)pega).streamEpilog(oTraceInfo_20,false);
}
/* end RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.453 GMT */
}
private void executeStream_4() {
/*
 * Begin RULE-HTML-HARNESS WORK- PYCREATE #20210903T103024.156 GMT
 * Set up context.
 */
final String prevRuleKey_22 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS WORK- PYCREATE #20210903T103024.156 GMT";final String prevClass_22 = mStreamResponse.getJspBaseClass();
mStreamResponse.setJspBaseClass("Rule-HTML-Harness");
...
if (!pzDispatchToInvokedMethod()) {
	...
	((com.pega.pegarules.priv.runtime.PegaStreamAPI)pega).streamEpilog(oTraceInfo_21,false);
}
/* end RULE-HTML-HARNESS WORK- PYCREATE #20210903T103024.156 GMT */
}
public com.pega.pegarules.priv.tracer.RuleTraceInfo getTraceInfoForUnqualifiedVersion() {
	return oTraceInfo_21;
}
public static String[] getRuleSetForUnqualifiedVersion() { return new String[] { oTraceInfo_21.getRuleSetName(), oTraceInfo_21.getRuleSetVersion() };}
...
static {
pzExternalMethodMapping.put("includeSectionBody_7", new String[][] {});
pzExternalMethodMapping.put("generateWorkAreaLayouts_3", new String[][] {});
pzExternalMethodMapping.put("includeSectionBody_5", new String[][] {});
pzExternalMethodMapping.put("generateWorkAreaLayouts_2", new String[][] {});
...
pzExternalMethodMapping.put("generateWorkAreaLayouts_4", new String[][] {});
pzExternalMethodMapping.put("includeSectionBody_2", new String[][] {});
pzExternalMethodMapping.put("includeSectionBody_3", new String[][] {});
pzExternalMethodMapping.put("includeSectionBody_6", new String[][] {});
pzExternalMethodMapping.put("includeSectionBody_8", new String[][] {});
pzExternalMethodMapping.put("includeSectionBody_4", new String[][] {});
}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_19 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.460 GMT", "Work- pyCreate", "Theme-Cosmos", "04-01-01", "20211116T064510.674 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS WORK- PYCREATE #20210819T090017.859 GMT", "Work- pyCreate", "Theme-Cosmos", "04-01-01", "20210903T104224.450 GMT");
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_20 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS WORK- PYCREATE #20210506T204026.453 GMT", "Work- pyCreate", "Theme-Cosmos", "04-01-01", "20210903T104224.616 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_21 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS WORK- PYCREATE #20210903T103024.156 GMT", "Work- pyCreate", "Pega-EndUserUI", "08-07-01", "20210903T103024.156 GMT");
