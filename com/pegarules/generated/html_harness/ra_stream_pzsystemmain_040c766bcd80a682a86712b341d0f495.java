...
/**
 * Builds JSP stream PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM!PZSYSTEMMAIN.
 */
public class ra_stream_pzsystemmain_040c766bcd80a682a86712b341d0f495 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.pzSystemMain.Pega_Ext_AdminStudio_Explorer_Settings_System.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 2037487351;
 ...
 */
	public ra_stream_pzsystemmain_040c766bcd80a682a86712b341d0f495(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "3b9d780491d17e52e473bb049cb492ea53916f75";
...
{
/* Instance RULE-HTML-HARNESS PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAIN #20180713T135118.011 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-HARNESS PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAIN #20180713T135118.011 GMT
 * Set up context.
 */
final String prevRuleKey_19 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAIN #20180713T135118.011 GMT";final String prevClass_19 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-HARNESS PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAIN #20180713T135118.011 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Harness:PZSYSTEMMAIN", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZSYSTEMMAIN","Rule-HTML-Harness","PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM",false,"","Pega-Desktop","08-01-01","RULE-HTML-HARNESS PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAIN #20180713T135118.011 GMT","!PZSYSTEMMAIN",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",2037487351), 
...
//	RULE-HTML-HARNESS PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAIN #20180713T135118.011 GMT:20180713T135118.011 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "f6f07a60bf1596e122438d584dc4ec34";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pzSystemDetailsMain", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzSystemDetailsMain";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
public void createFormElement_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		pg_form.put("streamName","pzSystemMain");
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","pzSystemMain");
...
public void createPegaHarnessDIV_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","pzSystemMain");
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("System & nodes",true));
					tools.appendString("</title>");
try {
...
static {
	...
	oStreamProperties_19.put("pyClassName", "Pega-Ext-AdminStudio-Explorer-Settings-System");
	oStreamProperties_19.put("pyCircumstanceProp", "");
	oStreamProperties_19.put("pzInsKey", "RULE-HTML-HARNESS PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAIN #20180713T135118.011 GMT");
	...
	oStreamProperties_19.put("pyStreamName", "pzSystemMain");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS PEGA-EXT-ADMINSTUDIO-EXPLORER-SETTINGS-SYSTEM PZSYSTEMMAIN #20180713T135118.011 GMT", "Pega-Ext-AdminStudio-Explorer-Settings-System pzSystemMain", "Pega-Desktop", "08-01-01", "20180713T135118.011 GMT");
