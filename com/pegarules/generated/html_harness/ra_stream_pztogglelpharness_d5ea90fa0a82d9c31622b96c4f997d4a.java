...
/**
 * Builds JSP stream PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT!PZTOGGLELPHARNESS.
 */
public class ra_stream_pztogglelpharness_d5ea90fa0a82d9c31622b96c4f997d4a extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.pzToggleLPHarness.Pega_Landing_System_ToggleManagement.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1001222450;
 ...
 */
	public ra_stream_pztogglelpharness_d5ea90fa0a82d9c31622b96c4f997d4a(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a59ab1a7983d732605a2b442e3b1cee2d71e41df";
...
{
/* Instance RULE-HTML-HARNESS PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZTOGGLELPHARNESS #20210225T172447.867 GMT	Pega-LP:08-06-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-HARNESS PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZTOGGLELPHARNESS #20210225T172447.867 GMT
 * Set up context.
 */
final String prevRuleKey_19 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZTOGGLELPHARNESS #20210225T172447.867 GMT";final String prevClass_19 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-HARNESS PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZTOGGLELPHARNESS #20210225T172447.867 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-File-Text:WEBWB!PZ-RELEASE-TOGGLES-OVERRIDES!CSS", 
	...
	"Rule-HTML-Harness:PZTOGGLELPHARNESS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("WEBWB!PZ-RELEASE-TOGGLES-OVERRIDES!CSS","Rule-File-Text","",false,"","Pega-Desktop","08-01-01","RULE-FILE-TEXT WEBWB PZ-RELEASE-TOGGLES-OVERRIDES!CSS #20180713T135112.418 GMT","WEBWB!PZ-RELEASE-TOGGLES-OVERRIDES!CSS",true,false,"ABSOLUTE_CLASSLESS",-1011828647), 
		...
		new DependentRuleInfo("PZTOGGLELPHARNESS","Rule-HTML-Harness","PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT",false,"","Pega-LP","08-06-01","RULE-HTML-HARNESS PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZTOGGLELPHARNESS #20210225T172447.867 GMT","!PZTOGGLELPHARNESS",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1001222450), 
...
//	RULE-HTML-HARNESS PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZTOGGLELPHARNESS #20210225T172447.867 GMT:20210225T172447.867 GMT
...
//	RULE-FILE-TEXT WEBWB PZ-RELEASE-TOGGLES-OVERRIDES!CSS #20180713T135112.418 GMT:20180713T135112.418 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "6793555f008017add6830e8e194c1f3f";
	}
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pzTogglesLPContent", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "pzTogglesLPContent";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
public void buildSection_1() { 
	...
	secInfo.put("preserveParamState",false);
	Map<String, String> secParams = new HashMap<String, String>();
	secParams.put("HelpURL","\"system/sys-toggle-management-landing-page-con\"");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	String expressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
	if(!StringUtils.isBlank(expressionId)) {
...
public void includeSectionBody_1() { 
	...
	String strSectionPageProp = "";
	tools.putParamValue("HelpURL","system/sys-toggle-management-landing-page-con");
...
public void createFormElement_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		pg_form.put("streamName","pzToggleLPHarness");
...
cssFileList.add("pz-release-toggles-overrides");
} else {
cssFileList.add("pz-release-toggles-overrides");
}
...
pyCustomStyleName = "pzharnessv2_pztogglelpharness" + generatedCssHash; 
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","pzToggleLPHarness");
...
public void createPegaHarnessDIV_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","pzToggleLPHarness");
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("Toggle LP Harness",true));
					tools.appendString("</title>");
try {
...
static {
	...
	oStreamProperties_19.put("pyClassName", "Pega-Landing-System-ToggleManagement");
	oStreamProperties_19.put("pyCircumstanceProp", "");
	oStreamProperties_19.put("pzInsKey", "RULE-HTML-HARNESS PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZTOGGLELPHARNESS #20210225T172447.867 GMT");
	...
	oStreamProperties_19.put("pyRuleSet", "Pega-LP");
	oStreamProperties_19.put("pyCorrType", "");
	oStreamProperties_19.put("pyStreamName", "pzToggleLPHarness");
	oStreamProperties_19.put("pyRuleSetVersion", "08-06-01");
}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS PEGA-LANDING-SYSTEM-TOGGLEMANAGEMENT PZTOGGLELPHARNESS #20210225T172447.867 GMT", "Pega-Landing-System-ToggleManagement pzToggleLPHarness", "Pega-LP", "08-06-01", "20210225T172447.867 GMT");
