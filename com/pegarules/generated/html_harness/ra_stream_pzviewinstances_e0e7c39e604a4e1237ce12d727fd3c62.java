 ...
 */
public class ra_stream_pzviewinstances_e0e7c39e604a4e1237ce12d727fd3c62 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.pzViewInstances._baseclass.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1056681298;
 ...
 */
	public ra_stream_pzviewinstances_e0e7c39e604a4e1237ce12d727fd3c62(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "431681c025cc4f61b48e7bf6074fc240f8b4812b";
...
{
/* Instance RULE-HTML-HARNESS @BASECLASS PZVIEWINSTANCES #20180713T135116.487 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-HARNESS @BASECLASS PZVIEWINSTANCES #20180713T135116.487 GMT
 * Set up context.
 */
final String prevRuleKey_19 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS @BASECLASS PZVIEWINSTANCES #20180713T135116.487 GMT";final String prevClass_19 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-HARNESS @BASECLASS PZVIEWINSTANCES #20180713T135116.487 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Harness:PZVIEWINSTANCES", 
	...
	"Rule-HTML-Property:PXICONCANCEL", 
	"Rule-HTML-Property:PXICONHISTORY", 
	"Rule-HTML-Property:PXICONATTACHMENTS", 
	"Rule-HTML-Property:PXICONEXPANDCOLLAPSE", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PZVIEWINSTANCES","Rule-HTML-Harness","@BASECLASS",false,"","Pega-Desktop","08-01-01","RULE-HTML-HARNESS @BASECLASS PZVIEWINSTANCES #20180713T135116.487 GMT","!PZVIEWINSTANCES",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1056681298), 
		...
		new DependentRuleInfo("PXICONCANCEL","Rule-HTML-Property","",false,"","Pega-Gadgets","08-01-01","RULE-HTML-PROPERTY PXICONCANCEL #20180713T133435.737 GMT","PXICONCANCEL",true,false,"ABSOLUTE_CLASSLESS",-1316667377), 
		new DependentRuleInfo("PXICONHISTORY","Rule-HTML-Property","",false,"","Pega-Gadgets","08-01-01","RULE-HTML-PROPERTY PXICONHISTORY #20180713T133435.763 GMT","PXICONHISTORY",true,false,"ABSOLUTE_CLASSLESS",1516294995), 
		new DependentRuleInfo("PXICONATTACHMENTS","Rule-HTML-Property","",false,"","Pega-Gadgets","08-01-01","RULE-HTML-PROPERTY PXICONATTACHMENTS #20180713T133435.734 GMT","PXICONATTACHMENTS",true,false,"ABSOLUTE_CLASSLESS",2111868457), 
		new DependentRuleInfo("PXICONEXPANDCOLLAPSE","Rule-HTML-Property","",false,"","Pega-Gadgets","08-01-01","RULE-HTML-PROPERTY PXICONEXPANDCOLLAPSE #20180713T133435.752 GMT","PXICONEXPANDCOLLAPSE",true,false,"ABSOLUTE_CLASSLESS",1669928403), 
...
//	RULE-HTML-HARNESS @BASECLASS PZVIEWINSTANCES #20180713T135116.487 GMT:20180713T135116.487 GMT
...
//	RULE-HTML-PROPERTY PXICONHISTORY #20180713T133435.763 GMT:20180713T133435.763 GMT
//	RULE-HTML-PROPERTY PXICONATTACHMENTS #20180713T133435.734 GMT:20180713T133435.734 GMT
//	RULE-HTML-PROPERTY PXICONEXPANDCOLLAPSE #20180713T133435.752 GMT:20180713T133435.752 GMT
//	RULE-HTML-PROPERTY PXICONCANCEL #20180713T133435.737 GMT:20180713T133435.737 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "fc19604225b2d1f1fc35924ab5a0aa32";
	}
...
tools.appendString(" ");
if (!foundChoice && when_6("bFlowAction", "true")) {
...
private void choose_6() throws Throwable {
	boolean foundChoice = false;
tools.appendString(" ");
if (!foundChoice && when_8("HarnessType", "")) {
...
private void choose_2() throws Throwable {
	boolean foundChoice = false;
tools.appendString(" ");
if (!foundChoice && when_9("IndexInList", "")) {
...
tools.appendString(" ");
	if (when_5(".pyIncludeAtMiddle", "true")) {
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_8","pzViewInstances", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "pzViewInstances";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
public void buildSection_1() { 
	...
	secInfo.put("preserveParamState",false);
	Map<String, String> secParams = new HashMap<String, String>();
	secParams.put("avoidSubmitOnEnter","true");
	secParams.put("showSubmit","false");
	secParams.put("closeWindow","0");
	secParams.put("actionName","pzViewInstancesToolbar");
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	String expressionId = null;
	com.pega.pegarules.priv.runtime.ui.IExpression expression = null;
	if(!StringUtils.isBlank(expressionId)) {
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_7","pxLocalAction", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String strSectionPageProp = "";
	tools.putParamValue("avoidSubmitOnEnter","true");tools.putParamValue("showSubmit","false");tools.putParamValue("closeWindow","0");tools.putParamValue("actionName","pzViewInstancesToolbar");
...
public void pxIconHistory_1() {boolean isDisplayTextWithParam = false;
...
try {
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_2")){
		 ...
		 String buttonUID = "name='pzViewInstances_"+ referenceString+ "_'";
		...
		tools.appendString("iconHistory' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" title = 'View history"+ " "+repeatIndx+"' ");
			tools.appendString(" alt = 'View history"+ " "+repeatIndx+"' ");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }tools.appendString("[\"openUrlInWindow\", [\"" + tools.findPage("pxThread").getString("pxReqURI") + "?pyActivity=HistoryAndAttachments&HistoryOrAttach=History&CustomFrameName=historyFrame&pzPrimaryPageName=" + tools.getPrimaryPage().getTopLevelPage().getName() + "&PageName=" + tools.getPrimaryPage().getTopLevelPage().getName());
{try{ClipboardPage actionAPI = ((PegaAPI)tools).getUIEngine().getUIActionPage("openUrlInWindow");actionAPI.getPage("pyActionAPI").putString("pyActivity","HistoryAndAttachments");((PegaAPI)tools).getUIEngine().getUIAction(actionAPI).register();actionAPI.removeFromClipboard();}catch(Exception e){}}tools.appendString("\",\"HistoryAndAttachments\",\"\",\"\",\":event\"]");
{
String primaryPageName = tools.getPrimaryPage().getTopLevelPage().getName();
	com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();
	actionRequest.registerFixedParameter("pyActivity", "HistoryAndAttachments");
	actionRequest.registerFixedParameter("HistoryOrAttach", "History");
	actionRequest.registerFixedParameter("CustomFrameName", "historyFrame");
	actionRequest.registerFixedParameter("pzPrimaryPageName", primaryPageName);
	actionRequest.registerFixedParameter("PageName", primaryPageName);
	actionRequest.registerFixedParameter("target", "popup");
...
public void pxIconAttachments_1() {	boolean isDisplayTextWithParam = false;
	String displayTextParamName = "";
	String displayTextParamValue = "";
...
boolean addedValidation = false;
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_3")){
		...
		tools.appendString("onclick='pd(event);' ");
		tools.appendString("data-ctl='Icon'"); tools.appendString(" class='");
		tools.appendString("iconAttachment' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" title = 'Attachments"+ " "+repeatIndx+"' ");
			tools.appendString(" alt = 'Attachments"+ " "+repeatIndx+"' ");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
{try{ClipboardPage actionAPI = ((PegaAPI)tools).getUIEngine().getUIActionPage("openUrlInWindow");actionAPI.getPage("pyActionAPI").putString("pyActivity","HistoryAndAttachments");((PegaAPI)tools).getUIEngine().getUIAction(actionAPI).register();actionAPI.removeFromClipboard();}catch(Exception e){}}	tools.appendString("\",\"HistoryAndAttachments\",\"\",\"\",\":event\"]");
	...
	String primaryPageName = tools.getPrimaryPage().getTopLevelPage().getName();
		com.pega.pegarules.priv.runtime.IActionRequest actionRequest = pzAuto.getActionRequest();
		actionRequest.registerFixedParameter("pyActivity", "HistoryAndAttachments");
		actionRequest.registerFixedParameter("HistoryOrAttach", "Attach");
		actionRequest.registerFixedParameter("CustomFrameName", "historyFrame");
		actionRequest.registerFixedParameter("pzPrimaryPageName", primaryPageName);
		actionRequest.registerFixedParameter("PageName", primaryPageName);
		actionRequest.registerFixedParameter("target", "popup");
...
public void pxIconExpandCollapse_1() {		boolean isDisplayTextWithParam = false;
		String displayTextParamName = "";
		String displayTextParamValue = "";
...
boolean addedValidation = false;
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_4")){
		...
		tools.appendString("onclick='pd(event);' ");
		tools.appendString("data-ctl='Icon'"); tools.appendString(" class='");
		tools.appendString("iconExpandAll' ");
		tools.appendString("id='expandIcon' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" title = 'Expand all"+ " "+repeatIndx+"' ");
			tools.appendString(" alt = 'Expand all"+ " "+repeatIndx+"' ");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }		tools.appendString("[\"toggleExpandCollapse\",[\":event\"]");
...
public void pxIconCancel_1() {		boolean isDisplayTextWithParam = false;
		String displayTextParamName = "";
		String displayTextParamValue = "";
...
boolean addedValidation = false;
	...
	tools.appendString("<span ");tools.appendString(">");if(pzAuto.getUIComponentRuntime().getRuntimeContextTree().beginNonTemplate(pxUniqueStreamHash+"_5")){
		...
		tools.appendString("onclick='pd(event);' ");
		tools.appendString("data-ctl='Icon'"); tools.appendString(" class='");
		tools.appendString("iconClose' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
			tools.appendString(" title = 'Cancel"+ " "+repeatIndx+"' ");
			tools.appendString(" alt = 'Cancel"+ " "+repeatIndx+"' ");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
try {
tools.appendString(" ");
tools.putParamValue("showContainerIcons","true");
tools.appendString(" ");
 buildWhiteList_1();
tools.appendString(" <table cellPadding='0' cellSpacing='0' align='right'> <tr align='right' style='vertical-align:middle'> ");
	if (when_3(".pyID", "")) {
tools.appendString("<td style='padding-left:0px;padding-right:3px;height:20px;width:20px;'> ");
	}
tools.appendString(" ");
	if (pega.isPreviewMode() || (!areValsEqual(getPropertyVal(tools, ".pyID"), ""))) {
tools.appendString("<nobr>");
pxIconHistory_1();
tools.appendString("</nobr></td> ");
	}
tools.appendString(" ");
	if (when_3(".pyID", "")) {
tools.appendString("<td style='padding-left:0px;padding-right:3px;height:20px;width:20px;'> ");
...
tools.appendString("<td style='padding-left:0px;padding-right:3px;height:20px;width:20px;'><nobr>");
pxIconExpandCollapse_1();
tools.appendString("</nobr></td><td style='padding-left:0px;padding-right:3px;height:20px;width:20px;'><nobr>");
pxIconCancel_1();
tools.appendString("</nobr></td> </tr> </table>");
} catch(Throwable t) {
throw new RuntimeException("Problem in JSP fragment", t);
}
}
public void createFormElement_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		pg_form.put("streamName","pzViewInstances");
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","pzViewInstances");
...
IStaticContentRuntime pzStatic__1 = pzAuto.getStaticBlock("script");
	pzStatic__1.addFile("pzhandletransitionsscript", "1972413627", "js");
...
public void createPegaHarnessDIV_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","pzViewInstances");
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("pzViewInstances",false));
					tools.appendString("</title>");
try {
...
static {
	...
	oStreamProperties_19.put("pyClassName", "@baseclass");
	oStreamProperties_19.put("pyCircumstanceProp", "");
	oStreamProperties_19.put("pzInsKey", "RULE-HTML-HARNESS @BASECLASS PZVIEWINSTANCES #20180713T135116.487 GMT");
	...
	oStreamProperties_19.put("pyStreamName", "pzViewInstances");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS @BASECLASS PZVIEWINSTANCES #20180713T135116.487 GMT", "@baseclass pzViewInstances", "Pega-Desktop", "08-01-01", "20180713T135116.487 GMT");
