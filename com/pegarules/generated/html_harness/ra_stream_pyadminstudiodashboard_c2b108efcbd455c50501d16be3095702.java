...
/**
 * Builds JSP stream DATA-PORTAL-PEGAADMINSTUDIO!PYADMINSTUDIODASHBOARD.
 */
public class ra_stream_pyadminstudiodashboard_c2b108efcbd455c50501d16be3095702 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.pyAdminStudioDashboard.Data_Portal_PegaAdminStudio.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 438060511;
 ...
 */
	public ra_stream_pyadminstudiodashboard_c2b108efcbd455c50501d16be3095702(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "b3bc4ba3e10d3feaa1f595d53a2e0d9030d816f5";
...
{
/* Instance RULE-HTML-HARNESS DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARD #20180713T135116.681 GMT	Pega-Desktop:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
/*
 * Begin RULE-HTML-HARNESS DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARD #20180713T135116.681 GMT
 * Set up context.
 */
final String prevRuleKey_19 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARD #20180713T135116.681 GMT";final String prevClass_19 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-HARNESS DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARD #20180713T135116.681 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-HTML-Harness:PYADMINSTUDIODASHBOARD", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYADMINSTUDIODASHBOARD","Rule-HTML-Harness","DATA-PORTAL-PEGAADMINSTUDIO",false,"","Pega-Desktop","08-01-01","RULE-HTML-HARNESS DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARD #20180713T135116.681 GMT","!PYADMINSTUDIODASHBOARD",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",438060511), 
...
//	RULE-HTML-HARNESS DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARD #20180713T135116.681 GMT:20180713T135116.681 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "8d2361d402d5c467f5245baf33d55264";
	}
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pyAdminStudioDashboardMain", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "pyAdminStudioDashboardMain";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pyAdminStudioDashboardHeader", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pyAdminStudioDashboardHeader";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
...
public void createFormElement_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		pg_form.put("streamName","pyAdminStudioDashboard");
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","pyAdminStudioDashboard");
...
public void createPegaHarnessDIV_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","pyAdminStudioDashboard");
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("Admin Studio Dashboard",true));
					tools.appendString("</title>");
try {
...
static {
	...
	oStreamProperties_19.put("pyClassName", "Data-Portal-PegaAdminStudio");
	oStreamProperties_19.put("pyCircumstanceProp", "");
	oStreamProperties_19.put("pzInsKey", "RULE-HTML-HARNESS DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARD #20180713T135116.681 GMT");
	...
	oStreamProperties_19.put("pyStreamName", "pyAdminStudioDashboard");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS DATA-PORTAL-PEGAADMINSTUDIO PYADMINSTUDIODASHBOARD #20180713T135116.681 GMT", "Data-Portal-PegaAdminStudio pyAdminStudioDashboard", "Pega-Desktop", "08-01-01", "20180713T135116.681 GMT");
