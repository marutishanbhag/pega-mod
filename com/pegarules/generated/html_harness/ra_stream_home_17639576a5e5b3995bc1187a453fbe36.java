...
/**
 * Builds JSP stream DATA-PORTAL!HOME.
 */
public class ra_stream_home_17639576a5e5b3995bc1187a453fbe36 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.Home.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -2091925082;
 ...
 */
	public ra_stream_home_17639576a5e5b3995bc1187a453fbe36(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "ffc87a211bb813617e89faed07f45655ae75b426";
...
{
/* Instance RULE-HTML-HARNESS DATA-PORTAL HOME #20210506T204026.337 GMT	Theme-Cosmos:04-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
/*
 * Begin RULE-HTML-HARNESS DATA-PORTAL HOME #20210506T204026.337 GMT
 * Set up context.
 */
final String prevRuleKey_19 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS DATA-PORTAL HOME #20210506T204026.337 GMT";final String prevClass_19 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-HARNESS DATA-PORTAL HOME #20210506T204026.337 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("HOME","Rule-HTML-Harness","DATA-PORTAL",false,"","Theme-Cosmos","04-01-01","RULE-HTML-HARNESS DATA-PORTAL HOME #20210506T204026.337 GMT","!HOME",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-2091925082), 
...
//	RULE-HTML-HARNESS DATA-PORTAL HOME #20210506T204026.337 GMT:20210506T204026.337 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "4f47aeb98e51c9d8ff5cfdfb6c9d2ddd";
	}
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","HomeMain", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "HomeMain";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pxHomeHeaderWrapper", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pxHomeHeaderWrapper";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","Home");
...
public void setHarnessConfigurations_1() {
	...
	tools.putParamValue("IgnoreDirty", "true");
...
public void createPegaHarnessDIV_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","Home");
		...
		pg_harnesscnt.put("CSSClass","workarea-view-harness dashboard");
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("Home",true));
					tools.appendString("</title>");
try {
...
static {
	...
	oStreamProperties_19.put("pzInsKey", "RULE-HTML-HARNESS DATA-PORTAL HOME #20210506T204026.337 GMT");
	...
	oStreamProperties_19.put("pyStreamName", "Home");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS DATA-PORTAL HOME #20210506T204026.337 GMT", "Data-Portal Home", "Theme-Cosmos", "04-01-01", "20210506T204026.337 GMT");
