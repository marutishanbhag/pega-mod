...
/**
 * Builds JSP stream DATA-PORTAL!PYDASHBOARD7.
 */
public class ra_stream_pydashboard7_4a8b305d1ad18d51f855e4e00cf78738 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.pyDashboard7.Data_Portal.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1241839863;
 ...
 */
	public ra_stream_pydashboard7_4a8b305d1ad18d51f855e4e00cf78738(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a27433304d6bdd8608d68cd9219828002de5d7e7";
...
{
/* Instance RULE-HTML-HARNESS DATA-PORTAL PYDASHBOARD7 #20210823T131316.785 GMT	Pega-EndUserUI:08-07-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Yes	baserule=false */
/*
 * Begin RULE-HTML-HARNESS DATA-PORTAL PYDASHBOARD7 #20210823T131316.785 GMT
 * Set up context.
 */
final String prevRuleKey_19 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS DATA-PORTAL PYDASHBOARD7 #20210823T131316.785 GMT";final String prevClass_19 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-HARNESS DATA-PORTAL PYDASHBOARD7 #20210823T131316.785 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-File-Text:WEBWB!PYDASHBOARDSTYLES!CSS", 
	...
	"Rule-File-Text:WEBWB!PXCASEMGRSTYLES!CSS", 
	"Rule-HTML-Harness:PYDASHBOARD7", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("WEBWB!PYDASHBOARDSTYLES!CSS","Rule-File-Text","",false,"","Pega-EndUserUI","08-01-01","RULE-FILE-TEXT WEBWB PYDASHBOARDSTYLES!CSS #20180713T134720.631 GMT","WEBWB!PYDASHBOARDSTYLES!CSS",true,false,"ABSOLUTE_CLASSLESS",313808213), 
		...
		new DependentRuleInfo("WEBWB!PXCASEMGRSTYLES!CSS","Rule-File-Text","",false,"","Pega-EndUserUI","08-01-01","RULE-FILE-TEXT WEBWB PXCASEMGRSTYLES!CSS #20180713T134720.556 GMT","WEBWB!PXCASEMGRSTYLES!CSS",true,false,"ABSOLUTE_CLASSLESS",697561603), 
		new DependentRuleInfo("PYDASHBOARD7","Rule-HTML-Harness","DATA-PORTAL",false,"","Pega-EndUserUI","08-07-01","RULE-HTML-HARNESS DATA-PORTAL PYDASHBOARD7 #20210823T131316.785 GMT","!PYDASHBOARD7",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",1241839863), 
...
//	RULE-HTML-HARNESS DATA-PORTAL PYDASHBOARD7 #20210823T131316.785 GMT:20210823T131316.785 GMT
...
//	RULE-FILE-TEXT WEBWB PXCASEMGRSTYLES!CSS #20180713T134720.556 GMT:20180713T134720.556 GMT
//	RULE-FILE-TEXT WEBWB PYDASHBOARDSTYLES!CSS #20180713T134720.631 GMT:20180713T134720.631 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "f5c39b912e53440d5f98c9231a890eb4";
	}
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pyDashboard7", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pyDashboard7";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
public void createFormElement_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		pg_form.put("streamName","pyDashboard7");
...
cssFileList.add("pxCaseMgrStyles");
cssFileList.add("pyDashboardStyles");
} else {
cssFileList.add("pxCaseMgrStyles");
cssFileList.add("pyDashboardStyles");
}
...
pyCustomStyleName = "pzharnessv2_pydashboard7" + generatedCssHash; 
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","pyDashboard7");
...
public void createPegaHarnessDIV_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","pyDashboard7");
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("Dashboard tab of Case Manager portal",true));
					tools.appendString("</title>");
try {
...
static {
	...
	oStreamProperties_19.put("pyClassName", "Data-Portal");
	oStreamProperties_19.put("pyCircumstanceProp", "");
	oStreamProperties_19.put("pzInsKey", "RULE-HTML-HARNESS DATA-PORTAL PYDASHBOARD7 #20210823T131316.785 GMT");
	...
	oStreamProperties_19.put("pyRuleSet", "Pega-EndUserUI");
	oStreamProperties_19.put("pyCorrType", "");
	oStreamProperties_19.put("pyStreamName", "pyDashboard7");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS DATA-PORTAL PYDASHBOARD7 #20210823T131316.785 GMT", "Data-Portal pyDashboard7", "Pega-EndUserUI", "08-07-01", "20210823T131316.785 GMT");
