...
/**
 * Builds JSP stream DATA-ADMIN-OPERATOR-ID!RULEFORM.
 */
public class ra_stream_ruleform_737c069d341dd4df178d9036d51c7dea extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.RuleForm.Data_Admin_Operator_ID.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -172742823;
 ...
 */
	public ra_stream_ruleform_737c069d341dd4df178d9036d51c7dea(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "2b6d829c223efc091e888582e36606d2b34a7a85";
...
{
/* Instance RULE-HTML-HARNESS DATA-ADMIN-OPERATOR-ID RULEFORM #20230618T001711.078 GMT	Pega-SystemArchitect:08-23-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-HARNESS DATA-ADMIN-OPERATOR-ID RULEFORM #20230618T001711.078 GMT
 * Set up context.
 */
final String prevRuleKey_19 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS DATA-ADMIN-OPERATOR-ID RULEFORM #20230618T001711.078 GMT";final String prevClass_19 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-HARNESS DATA-ADMIN-OPERATOR-ID RULEFORM #20230618T001711.078 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-File-Text:WEBWB!PZOPERATORIDHIGHLIGHTBREADCRUMBS!JS", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("WEBWB!PZOPERATORIDHIGHLIGHTBREADCRUMBS!JS","Rule-File-Text","",false,"","Pega-Desktop","","RULE-FILE-TEXT WEBWB PZOPERATORIDHIGHLIGHTBREADCRUMBS!JS #20180713T135110.013 GMT","WEBWB!PZOPERATORIDHIGHLIGHTBREADCRUMBS!JS",true,false,"ABSOLUTE_CLASSLESS",1), 
		...
		new DependentRuleInfo("RULEFORM","Rule-HTML-Harness","DATA-ADMIN-OPERATOR-ID",false,"","Pega-SystemArchitect","08-23-01","RULE-HTML-HARNESS DATA-ADMIN-OPERATOR-ID RULEFORM #20230618T001711.078 GMT","!RULEFORM",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-172742823), 
...
//	RULE-HTML-HARNESS DATA-ADMIN-OPERATOR-ID RULEFORM #20230618T001711.078 GMT:20230618T001711.078 GMT
...
//	RULE-FILE-TEXT WEBWB PZOPERATORIDHIGHLIGHTBREADCRUMBS!JS #20180713T135110.013 GMT:20180713T135110.013 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "99294079301c4718da28ea01f25253ac";
	}
...
IStaticContentRuntime pzStatic__1 = pzAuto.getStaticBlock("script");
	...
	pzStatic__1.addFile("pzoperatoridhighlightbreadcrumbs", "11636720475", "js");
...
static {
	...
	oStreamProperties_19.put("pyClassName", "Data-Admin-Operator-ID");
	oStreamProperties_19.put("pyCircumstanceProp", "");
	oStreamProperties_19.put("pzInsKey", "RULE-HTML-HARNESS DATA-ADMIN-OPERATOR-ID RULEFORM #20230618T001711.078 GMT");
	...
	oStreamProperties_19.put("pyRuleSetVersion", "08-23-01");
}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS DATA-ADMIN-OPERATOR-ID RULEFORM #20230618T001711.078 GMT", "Data-Admin-Operator-ID RuleForm", "Pega-SystemArchitect", "08-23-01", "20230618T001711.078 GMT");
