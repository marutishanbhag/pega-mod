...
/**
 * Builds JSP stream PEGA-LANDING-SYSTEM!PZLPSYSTEMREFACTOR.
 */
public class ra_stream_pzlpsystemrefactor_17bcc629d458fb08f7c94f7740402ef7 extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.pzLPSystemRefactor.Pega_Landing_System.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1655224794;
 ...
 */
	public ra_stream_pzlpsystemrefactor_17bcc629d458fb08f7c94f7740402ef7(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "4ff56224bbe7fab020eb885b6b89d9e6e22843a7";
...
{
/* Instance RULE-HTML-HARNESS PEGA-LANDING-SYSTEM PZLPSYSTEMREFACTOR #20180713T142917.980 GMT	Pega-LP-SystemSettings:08-01-01	<no Circumstance>	<no Circumstance Date>	<no date range>	available=Final	baserule=false */
/*
 * Begin RULE-HTML-HARNESS PEGA-LANDING-SYSTEM PZLPSYSTEMREFACTOR #20180713T142917.980 GMT
 * Set up context.
 */
final String prevRuleKey_19 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS PEGA-LANDING-SYSTEM PZLPSYSTEMREFACTOR #20180713T142917.980 GMT";final String prevClass_19 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-HARNESS PEGA-LANDING-SYSTEM PZLPSYSTEMREFACTOR #20180713T142917.980 GMT */
}
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
...
private static final String oDependencies [] = {
	...
	"Rule-File-Text:WEBWB!PALSTYLESHEET!CSS", 
	...
	"Rule-File-Text:WEBWB!PZPALSAVEDATASCRIPTS!JS", 
	"Rule-HTML-Harness:PZLPSYSTEMREFACTOR", 
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("WEBWB!PALSTYLESHEET!CSS","Rule-File-Text","",false,"","Pega-LP-SystemSettings","08-01-01","RULE-FILE-TEXT WEBWB PALSTYLESHEET!CSS #20180713T142917.496 GMT","WEBWB!PALSTYLESHEET!CSS",true,false,"ABSOLUTE_CLASSLESS",-1367508732), 
		...
		new DependentRuleInfo("WEBWB!PZPALSAVEDATASCRIPTS!JS","Rule-File-Text","",false,"","Pega-Desktop","","RULE-FILE-TEXT WEBWB PZPALSAVEDATASCRIPTS!JS #20190212T131827.387 GMT","WEBWB!PZPALSAVEDATASCRIPTS!JS",true,false,"ABSOLUTE_CLASSLESS",1), 
		new DependentRuleInfo("PZLPSYSTEMREFACTOR","Rule-HTML-Harness","PEGA-LANDING-SYSTEM",false,"","Pega-LP-SystemSettings","08-01-01","RULE-HTML-HARNESS PEGA-LANDING-SYSTEM PZLPSYSTEMREFACTOR #20180713T142917.980 GMT","!PZLPSYSTEMREFACTOR",true,false,"ABSOLUTE_ULTIMATE_STEP_PAGE",-1655224794), 
...
//	RULE-HTML-HARNESS PEGA-LANDING-SYSTEM PZLPSYSTEMREFACTOR #20180713T142917.980 GMT:20180713T142917.980 GMT
...
//	RULE-FILE-TEXT WEBWB PZPALSAVEDATASCRIPTS!JS #20190212T131827.387 GMT:20190212T131827.387 GMT
//	RULE-FILE-TEXT WEBWB PALSTYLESHEET!CSS #20180713T142917.496 GMT:20180713T142917.496 GMT
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "9598c3c45b31c85c49ba5536afc82465";
	}
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","pzLPSystemRefactorInner", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "pzLPSystemRefactorInner";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","pxLPHeader", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pxLPHeader";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
...
public void createFormElement_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		pg_form.put("streamName","pzLPSystemRefactor");
...
pyCustomStyleName = "pzharnessv2_pzlpsystemrefactor" + generatedCssHash; 
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","pzLPSystemRefactor");
...
IStaticContentRuntime pzStatic__1 = pzAuto.getStaticBlock("script");
	pzStatic__1.addFile("pzpalsavedatascripts", "1199361512", "js");
...
public void createPegaHarnessDIV_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","pzLPSystemRefactor");
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("pzLPSystemRefactor",true));
					tools.appendString("</title>");
try {
...
static {
	...
	oStreamProperties_19.put("pyClassName", "Pega-Landing-System");
	oStreamProperties_19.put("pyCircumstanceProp", "");
	oStreamProperties_19.put("pzInsKey", "RULE-HTML-HARNESS PEGA-LANDING-SYSTEM PZLPSYSTEMREFACTOR #20180713T142917.980 GMT");
	...
	oStreamProperties_19.put("pyRuleSet", "Pega-LP-SystemSettings");
	oStreamProperties_19.put("pyCorrType", "");
	oStreamProperties_19.put("pyStreamName", "pzLPSystemRefactor");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS PEGA-LANDING-SYSTEM PZLPSYSTEMREFACTOR #20180713T142917.980 GMT", "Pega-Landing-System pzLPSystemRefactor", "Pega-LP-SystemSettings", "08-01-01", "20180713T142917.980 GMT");
