...
public class Rule_Obj_Report_Definition_OOD4NM_Loan_Work_Loan_pyDefaultSummaryReport_Action_20260221T064329_330_GMT  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pyDefaultSummaryReport.OOD4NM_Loan_Work_Loan.Action");
	public Rule_Obj_Report_Definition_OOD4NM_Loan_Work_Loan_pyDefaultSummaryReport_Action_20260221T064329_330_GMT(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OOD4NM-Loan-Work-Loan pyDefaultSummaryReport", "Loan", "01-01-01", "20180713T134313.322 GMT");
}
