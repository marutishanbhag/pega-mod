...
import java.util.*;
public class Rule_Obj_CaseType_LTM_BFS_Work_Enrollment_pyDefault_Action_20260221T185851_497_GMT  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_CaseType.pyDefault.LTM_BFS_Work_Enrollment.Action");
	public Rule_Obj_CaseType_LTM_BFS_Work_Enrollment_pyDefault_Action_20260221T185851_497_GMT(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-CASETYPE LTM-BFS-WORK-ENROLLMENT PYDEFAULT #20260221T185851.497 GMT", "LTM-BFS-Work-Enrollment pyDefault", "Enrollment", "01-01-01", "20260221T185852.114 GMT");
}
