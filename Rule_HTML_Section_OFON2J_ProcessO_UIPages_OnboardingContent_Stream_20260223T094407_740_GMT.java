 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Section_OFON2J_ProcessO_UIPages_OnboardingContent_Stream_20260223T094407_740_GMT extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.OnboardingContent.OFON2J_ProcessO_UIPages.Stream");
 ...
 */
	public Rule_HTML_Section_OFON2J_ProcessO_UIPages_OnboardingContent_Stream_20260223T094407_740_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("OnboardingContent",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("OnboardingContent",1,"Rule-HTML-Section","{'type':'Section','ruleName':'OnboardingContent','insKey':'null','templated':'true','editable':'true','sectionType':'standard'}");
pzLayout_2();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","OnboardingList", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "OnboardingList"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellOnboardingContent173","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","OnboardingList", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","OnboardingList",".pyRegions(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","padding-r-1x","padding-r-1x")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","OnboardingList",".pyRegions(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionOnboardingContentB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionOnboardingContentB";
...
static {
	...
	oStreamProperties_1.put("pyStreamName", "OnboardingContent");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OFON2J-ProcessO-UIPages OnboardingContent", "ProcessO", "01-01-01", "20210506T204028.525 GMT");
}
