 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Harness_OLFHF9_Onboaring_Work_OnboaringProcess_Perform_Stream_20260223T094047_862_GMT extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.Perform.OLFHF9_Onboaring_Work_OnboaringProcess.Stream");
 ...
 */
	public Rule_HTML_Harness_OLFHF9_Onboaring_Work_OnboaringProcess_Perform_Stream_20260223T094047_862_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
tools.putParamValue("mainPanelSection","OLFHF9-Onboaring-Work-OnboaringProcess!pzC11nPerformSection");
}
...
tools.appendString(" data-portalHarnessInsName = \"OLFHF9-Onboaring-Work-OnboaringProcess!Perform\" class=\"flex screen-layout screen-layout-modern screen-layout-content_only \" style=''> ");
...
tools.appendString(">");
 tools.putParamValue("sectionsDetails", "PortalStyles:pyPortalInlineStyle=,pyPortalInlineClass=,pyPortalLayoutMode=Flexbox&CENTER:pzC11nPerformSection,OLFHF9-Onboaring-Work-OnboaringProcess,false,content_only,\"\",\"\",default,main&OLFHF9-Onboaring-Work-OnboaringProcess!Perform"); 
...
tools.appendString("<div class='lazyload-harness' bIsScreenLayout ='true' sectionsDetails='PortalStyles:pyPortalInlineStyle=,pyPortalInlineClass=,pyPortalLayoutMode=Flexbox&CENTER:pzC11nPerformSection,OLFHF9-Onboaring-Work-OnboaringProcess,false,content_only,\\\"\\\",\\\"\\\",default,main&OLFHF9-Onboaring-Work-OnboaringProcess!Perform' strIncludedScripts='' data-localStoreId='OLFHF9-ONBOARING-WORK-ONBOARINGPROCESS!PZC11NPERFORMSECTION' data-deferinvoke='includeSectionBody_1'>");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OLFHF9-Onboaring-Work-OnboaringProcess Perform", "OnboaringProcess", "01-01-01", "20210114T162756.099 GMT");
}
