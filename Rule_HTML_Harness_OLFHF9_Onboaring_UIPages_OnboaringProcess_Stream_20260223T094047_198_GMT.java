 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Harness_OLFHF9_Onboaring_UIPages_OnboaringProcess_Stream_20260223T094047_198_GMT extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.OnboaringProcess.OLFHF9_Onboaring_UIPages.Stream");
 ...
 */
	public Rule_HTML_Harness_OLFHF9_Onboaring_UIPages_OnboaringProcess_Stream_20260223T094047_198_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","OnboaringProcessContent", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "OnboaringProcessContent";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","OnboaringProcessHeader", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "OnboaringProcessHeader";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
...
public void createFormElement_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		pg_form.put("streamName","OnboaringProcess");
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","OnboaringProcess");
...
public void createPegaHarnessDIV_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","OnboaringProcess");
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("OnboaringProcess",true));
					tools.appendString("</title>");
try {
...
static {
	...
	oStreamProperties_1.put("pyStreamName", "OnboaringProcess");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OLFHF9-Onboaring-UIPages OnboaringProcess", "OnboaringProcess", "01-01-01", "20180713T135116.739 GMT");
}
