...
import java.util.*;
public class Rule_Obj_Flow_OFON2J_ProcessO_Work_Onboarding_CollectInformation_Flow_Action_20260223T094431_395_GMT  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	...
	public Rule_Obj_Flow_OFON2J_ProcessO_Work_Onboarding_CollectInformation_Flow_Action_20260223T094431_395_GMT(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
// Expression: pyStepRoutedConfirmation
	...
	private boolean CheckFlowSecurity_circum0()
	{
		...
		if (!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools, "",primaryPageClassName, interestPage)) 
			 ...
			 if(isAllowedAccess && !hasSecurity) {		com.pega.pegarules.priv.tracer.RuleTraceInfo ruleTraceInfo = new com.pega.pegarules.priv.tracer.RuleTraceInfo                                                                   ("","","ProcessO","","");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OFON2J-ProcessO-Work-Onboarding CollectInformation_Flow", "ProcessO", "01-01-01", null);
}
