...
import java.util.*;
public class Rule_Obj_Flow_LTM_Enrollment_Work_Enrollment_CreateForm_Default_Action_20260221T185851_535_GMT  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Flow.CreateForm_Default.LTM_Enrollment_Work_Enrollment.Action");
	public Rule_Obj_Flow_LTM_Enrollment_Work_Enrollment_CreateForm_Default_Action_20260221T185851_535_GMT(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
public void perform() {
		mTraceInfo = null;
		mRuleSet = "Enrollment";
		mFlowHandle = "RULE-OBJ-FLOW LTM-ENROLLMENT-WORK-ENROLLMENT CREATEFORM_DEFAULT #20260221T185851.535 GMT";
...
//	RULE-UTILITY-FUNCTION UTILITIES ISORINHERITSFROM #20180713T131444.415 GMT:20180713T131444.415 GMT
	...
	public String getDefinitionAppliesToClass() {
		return "LTM-Enrollment-Work-Enrollment";
	}
...
// Expression: pyStepRoutedConfirmation
	...
	private void GetNavigationPath_circum0(String pageName, String parentFlowPath, boolean deferredLoad)
	{
		...
		pgNavPath.putString("pyClassName", "LTM-Enrollment-Work-Enrollment");
	...
	private boolean CheckFlowSecurity_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "LTM-Enrollment-Work-Enrollment";
		 }
		...
		if (!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools, "",primaryPageClassName, interestPage)) 
			 ...
			 if(isAllowedAccess && !hasSecurity) {		com.pega.pegarules.priv.tracer.RuleTraceInfo ruleTraceInfo = new com.pega.pegarules.priv.tracer.RuleTraceInfo                                                                   ("","","Enrollment","","");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "LTM-Enrollment-Work-Enrollment CreateForm_Default", "Enrollment", "01-01-01", null);
}
