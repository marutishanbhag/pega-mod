...
import java.util.*;
public class Rule_Obj_Flow_LTM_Onboarding_Work_Onboarding_CreateForm_Default_Action_20260223T083635_668_GMT  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Flow.CreateForm_Default.LTM_Onboarding_Work_Onboarding.Action");
	public Rule_Obj_Flow_LTM_Onboarding_Work_Onboarding_CreateForm_Default_Action_20260223T083635_668_GMT(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
public void perform() {
		mTraceInfo = null;
		mRuleSet = "Onboarding";
		mFlowHandle = "RULE-OBJ-FLOW LTM-ONBOARDING-WORK-ONBOARDING CREATEFORM_DEFAULT #20260223T083635.668 GMT";
...
//	RULE-UTILITY-FUNCTION UTILITIES ISORINHERITSFROM #20180713T131444.415 GMT:20180713T131444.415 GMT
	...
	public String getDefinitionAppliesToClass() {
		return "LTM-Onboarding-Work-Onboarding";
	}
...
// Expression: pyStepRoutedConfirmation
	...
	private void GetNavigationPath_circum0(String pageName, String parentFlowPath, boolean deferredLoad)
	{
		...
		pgNavPath.putString("pyClassName", "LTM-Onboarding-Work-Onboarding");
	...
	private boolean CheckFlowSecurity_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "LTM-Onboarding-Work-Onboarding";
		 }
		...
		if (!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools, "",primaryPageClassName, interestPage)) 
			 ...
			 if(isAllowedAccess && !hasSecurity) {		com.pega.pegarules.priv.tracer.RuleTraceInfo ruleTraceInfo = new com.pega.pegarules.priv.tracer.RuleTraceInfo                                                                   ("","","Onboarding","","");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "LTM-Onboarding-Work-Onboarding CreateForm_Default", "Onboarding", "01-01-01", null);
}
