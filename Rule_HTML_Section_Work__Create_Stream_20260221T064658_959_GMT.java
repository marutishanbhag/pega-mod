...
/**
 * Builds JSP stream WORK-!CREATE.
 */
public class Rule_HTML_Section_Work__Create_Stream_20260221T064658_959_GMT extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.Create.Work_.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1887613688;
 ...
 */
	public Rule_HTML_Section_Work__Create_Stream_20260221T064658_959_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "31e0afccfc07b8e4eab1eb3352275d56f240d05c";
...
try {
pxUniqueStreamHash = "31e0afccfc07b8e4eab1eb3352275d56f240d05c";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("Create",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION WORK- CREATE #20260221T064658.959 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION WORK- CREATE #20260221T064658.959 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION WORK- CREATE #20260221T064658.959 GMT */
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
		pzAuto.finishStream();
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYLABEL","Rule-Obj-Property","WORK-",true,"Work-","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY WORK- PYLABEL #20180713T131937.372 GMT","!PYLABEL",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "de5ff2993eadb97d0df13417252993db";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("Create",1,"Rule-HTML-Section","{'type':'Section','ruleName':'Create','insKey':'RULE-HTML-SECTION WORK- CREATE #20260221T064658.959 GMT','templated':'true','editable':'true','sectionType':'standard'}");
pzLayout_1();
...
tools.appendString("</P>");
	...
	cellPage.put("automationId",pzCell.getTestIdIfEnabled("20210212150707052153",true));
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addErrors(".pyDescription",pxUniqueStreamHash+"_7");
...
boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isTemplateRendering();
		...
		tools.appendString("<textarea  " + pzCell.getTestIdIfEnabled("20210212150707052153") + "  id=\"");
...
if(bOptimizedMarkup){
	...
	tools.appendString("<span " + ((pzAuto.isAccessible() && true)?"tabindex='0' ":"") + " " + pzCell.getTestIdIfEnabled("20210212150707052153") + " ");if(tools.getParamValue("bRDLShowDetails") != null && "true".equals(tools.getParamValue("bRDLShowDetails"))){
...
public void pxTextInput_1() {String key="15604224-f17b-4781-ba0d-05c878d6550e||RULE-HTML-SECTION WORK- CREATE #20260221T064658.959 GMT";
...
static{String[] paramValues = new String[]{"text", "pxTextInput", "","","","","","SIMPLELAYOUT","SIMPLELAYOUT","",""," cffalse","T","false","64","","","Text","true","15604224-f17b-4781-ba0d-05c878d6550e"};oCellRuntimeParamsMap.put("15604224-f17b-4781-ba0d-05c878d6550e||RULE-HTML-SECTION WORK- CREATE #20260221T064658.959 GMT",paramValues);oControlPathsMap.put("15604224-f17b-4781-ba0d-05c878d6550e||RULE-HTML-SECTION WORK- CREATE #20260221T064658.959 GMT",".pyRegions(1).pyCells(1)||.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");}
public String 
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextInput",".pyLabel",".pyRegions(1).pyCells(1)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
 ...
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("202102121507070521788-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("202102121507070521788-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
tools.appendString(tools.getLocalizedTextForString("pyCaption","Label") + "</label>");
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("202102121507070521788-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextInput",".pyLabel",".pyRegions(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxTextInput_1();labelName = "Label";
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxTextArea",".pyDescription",".pyRegions(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing   flex '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	boolean isCellReadOnly = false;
	
 isCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	if(isCellReadOnly){
	tools.putParamValue("pzIsCellReadOnly","true");
	tools.appendString("<span  " + pzCell.getTestIdIfEnabled("20210212150707052153-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	...
	tools.appendString("<label  " + pzCell.getTestIdIfEnabled("20210212150707052153-Label") + "  class='field-caption " + pzSection.getCustomStyle(false, "","dataLabelForRead","dataLabelForWrite") + "' ");
	if(!"true".equals(tools.getParamValue("pzIsCellReadOnly"))){
...
tools.appendString("<div class='field-item " + pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite") + "'>");
pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
tools.putSaveValue("parentLayouttype","SIMPLELAYOUT");pxTextArea_1(".pyDescription",0,"","","Text");
tools.appendString("</div>" + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
index++;
return index;
}
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	pgCells.put("useLabel","true");
	pgCells.put("partialClass","remove-left-spacing remove-right-spacing flex");
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20210212150707052153-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxTextArea",".pyDescription",".pyRegions(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	pxTextArea_1(".pyDescription",0,"","","Text");labelName = "Description";
	if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate()){
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().addLocalizedValue(labelName, "pyCaption");
	} else {
	StringUtils.crossScriptingFilter(tools.getLocalizedTextForString("pyCaption",labelName));
...
pzSection.getLayout().setExpandParam("SubSectionCreateB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionCreateB";
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION WORK- CREATE #20260221T064658.959 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "Create");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION WORK- CREATE #20260221T064658.959 GMT", "Work- Create", "Loan", "01-01-01", "20260221T064658.959 GMT");
}
