 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Section_OLFHF9_Onboaring_UIPages_OnboaringProcessHeader_Stream_20260223T094045_751_GMT extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.OnboaringProcessHeader.OLFHF9_Onboaring_UIPages.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1872207964;
 ...
 */
	public Rule_HTML_Section_OLFHF9_Onboaring_UIPages_OnboaringProcessHeader_Stream_20260223T094045_751_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "590ae2fc1783069a80f19461c40cb001ca643427";
...
try {
pxUniqueStreamHash = "590ae2fc1783069a80f19461c40cb001ca643427";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("OnboaringProcessHeader",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("OnboaringProcessHeader",1,"Rule-HTML-Section","{'type':'Section','ruleName':'OnboaringProcessHeader','insKey':'null','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
pzLayout_3();
...
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("className", "OLFHF9-Onboaring-Work-OnboaringProcess");
...
pzSection.getLayout().setExpandParam("SubSectionOnboaringProcessHeaderBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionOnboaringProcessHeaderBBB";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendFormatted("OLFHF9-Onboaring-Work-OnboaringProcess",StreamBuilder.FMT_NORMAL);		tools.appendString("\",\"\",\"");
...
try {
	...
	modePage2.put("pyName","OnboaringProcessHeader_$CTX$_5");
		String repeatIndx = "";
	String pyTooltip = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='OnboaringProcessHeader_"+ referenceString+ "_5'";
...
public int simpleLayoutCell_3( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","OnboaringProcess Summary") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	labelName = "OnboaringProcess Summary";
...
pzSection.getLayout().setExpandParam("SubSectionOnboaringProcessHeaderBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionOnboaringProcessHeaderBB";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.infinity.createNewWorkInDialogContainer(\\\"OLFHF9-Onboaring-Work-OnboaringProcess\\\",\\\"pyStartCase\\\")\"]");
...
try {
	...
	modePage2.put("pyName","OnboaringProcessHeader_$CTX$_2");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='OnboaringProcessHeader_"+ referenceString+ "_2'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("201511051022210843267245") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
pzSection.getLayout().setExpandParam("SubSectionOnboaringProcessHeaderB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionOnboaringProcessHeaderB";
...
static {
	...
	oStreamProperties_1.put("pyStreamName", "OnboaringProcessHeader");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OLFHF9-Onboaring-UIPages OnboaringProcessHeader", "OnboaringProcess", "01-01-01", "20191117T132225.227 GMT");
}
