 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Harness_OLFHF9_Onboaring_Work_Onboarding_pyCreate_Stream_20260223T091527_427_GMT extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.pyCreate.OLFHF9_Onboaring_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 237922338;
 ...
 */
	public Rule_HTML_Harness_OLFHF9_Onboaring_Work_Onboarding_pyCreate_Stream_20260223T091527_427_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "f810857a35ca81b23d04c550630b1a810ad27b76";
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_1","pzC11nCreateSection", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzC11nCreateSection";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
pzPackageRuntime.packageSection("pzC11nCreateSection", strSectionPageProp, null);
strSectionPageProp = "";
strSectionPageClass = "";
...
tools.putParamValue("mainPanelSection","OLFHF9-Onboaring-Work-Onboarding!pzC11nCreateSection");
}
...
StringMap parameters = new HashStringMap();parameters.putString("pyHarnessNameForUpdate","pyCreate");parameters.putString("pyHarnessShortDesc","create work object");pzHarness.updateClipboardModels(parameters);
tools.appendString(" ");
...
tools.appendString(" ");
 tools.putParamValue("titleOnPortalLaunch", "create work object"); 
tools.appendString(" ");
if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate() || isOfflineMobileClient) {
tools.appendString(" ");
...
if (_jspx_meth_pega_lookup__1(pageContext, ".pyCaption", "create work object")) {
	return;
}
tools.appendString("</title> ");
choose_1();
...
tools.appendString(" data-portalHarnessInsName = \"OLFHF9-Onboaring-Work-Onboarding!pyCreate\" class=\"flex screen-layout screen-layout-modern screen-layout-content_only \" style=''> ");
...
tools.appendString(">");
 tools.putParamValue("sectionsDetails", "PortalStyles:pyPortalInlineStyle=,pyPortalInlineClass=,pyPortalLayoutMode=Flexbox&CENTER:pzC11nCreateSection,OLFHF9-Onboaring-Work-Onboarding,false,content_only,\"\",\"\",default,main&OLFHF9-Onboaring-Work-Onboarding!pyCreate"); 
...
tools.appendString("<div class='lazyload-harness' bIsScreenLayout ='true' sectionsDetails='PortalStyles:pyPortalInlineStyle=,pyPortalInlineClass=,pyPortalLayoutMode=Flexbox&CENTER:pzC11nCreateSection,OLFHF9-Onboaring-Work-Onboarding,false,content_only,\\\"\\\",\\\"\\\",default,main&OLFHF9-Onboaring-Work-Onboarding!pyCreate' strIncludedScripts='' data-localStoreId='OLFHF9-ONBOARING-WORK-ONBOARDING!PZC11NCREATESECTION' data-deferinvoke='includeSectionBody_1'>");
...
static {
	...
	oStreamProperties_1.put("pyStreamName", "pyCreate");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OLFHF9-Onboaring-Work-Onboarding pyCreate", "Onboaring", "01-01-01", "20210114T162756.092 GMT");
}
