...
/**
 * Builds JSP stream LTM-ENROLLMENT-UIPAGES!ENROLLMENTCONTENT.
 */
public class Rule_HTML_Section_LTM_Enrollment_UIPages_EnrollmentContent_Stream_20260221T185855_897_GMT extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.EnrollmentContent.LTM_Enrollment_UIPages.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1717716552;
 ...
 */
	public Rule_HTML_Section_LTM_Enrollment_UIPages_EnrollmentContent_Stream_20260221T185855_897_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "f0819f559784e8432431558b826d74709b408d3c";
...
try {
pxUniqueStreamHash = "f0819f559784e8432431558b826d74709b408d3c";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("EnrollmentContent",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTCONTENT #20260221T185855.897 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTCONTENT #20260221T185855.897 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTCONTENT #20260221T185855.897 GMT */
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
		pzAuto.finishStream();
...
//	RULE-UTILITY-FUNCTION STRING STRIPSPECIALCHARS #20180713T131442.797 GMT:20180713T131442.797 GMT
	...
	public static String getFUAContentHash() {
		return "7281c0f7663f4e5505012464489d00aa";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("EnrollmentContent",1,"Rule-HTML-Section","{'type':'Section','ruleName':'EnrollmentContent','insKey':'RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTCONTENT #20260221T185855.897 GMT','templated':'true','editable':'true','sectionType':'standard'}");
pzLayout_2();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","EnrollmentList", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "EnrollmentList"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellEnrollmentContent253","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","EnrollmentList", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","EnrollmentList",".pyRegions(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","padding-r-1x","padding-r-1x")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("customROStyles","padding-r-1x");
	pgCells.put("customRWStyles","padding-r-1x");
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","EnrollmentList",".pyRegions(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionEnrollmentContentB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'resaveInstancePage.pySections(1)','region':'A'}") + " class='" + "flex  content  layout-content-stacked content-stacked content-items-maxwidth" + "'  ");
		...
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'resaveInstancePage.pySections(1)','region':'A'}") + "").append("\"").toString();
	...
	String paramName = "EXPANDEDSubSectionEnrollmentContentB";
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'resaveInstancePage.pySections(1)','region':'A'}");
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTCONTENT #20260221T185855.897 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "EnrollmentContent");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTCONTENT #20260221T185855.897 GMT", "LTM-Enrollment-UIPages EnrollmentContent", "Enrollment", "01-01-01", "20260221T185855.897 GMT");
}
