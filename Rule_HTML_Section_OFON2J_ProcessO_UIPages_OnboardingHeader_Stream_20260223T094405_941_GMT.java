 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Section_OFON2J_ProcessO_UIPages_OnboardingHeader_Stream_20260223T094405_941_GMT extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.OnboardingHeader.OFON2J_ProcessO_UIPages.Stream");
 ...
 */
	public Rule_HTML_Section_OFON2J_ProcessO_UIPages_OnboardingHeader_Stream_20260223T094405_941_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("className", "OFON2J-ProcessO-Work-Onboarding");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendFormatted("OFON2J-ProcessO-Work-Onboarding",StreamBuilder.FMT_NORMAL);		tools.appendString("\",\"\",\"");
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.infinity.createNewWorkInDialogContainer(\\\"OFON2J-ProcessO-Work-Onboarding\\\",\\\"pyStartCase\\\")\"]");
