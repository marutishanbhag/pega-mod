...
/**
 * Builds JSP stream LTM-ENROLLMENT-UIPAGES!ENROLLMENTLIST.
 */
public class Rule_HTML_Section_LTM_Enrollment_UIPages_EnrollmentList_Stream_20260221T185855_221_GMT extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.EnrollmentList.LTM_Enrollment_UIPages.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1158271026;
 ...
 */
	public Rule_HTML_Section_LTM_Enrollment_UIPages_EnrollmentList_Stream_20260221T185855_221_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "e322dad2bf3dae7cfbd44b62c50818a6afb9380d";
...
try {
pxUniqueStreamHash = "e322dad2bf3dae7cfbd44b62c50818a6afb9380d";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("EnrollmentList",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT */
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
		pzAuto.finishStream();
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PXCREATEOPNAME","Rule-Obj-Property","@BASECLASS",true,"LTM-BFS-Work-Enrollment","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PXCREATEOPNAME #20180713T131841.211 GMT","!PXCREATEOPNAME",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYSTATUSWORK","Rule-Obj-Property","WORK-",true,"LTM-BFS-Work-Enrollment","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY WORK- PYSTATUSWORK #20180713T131937.564 GMT","!PYSTATUSWORK",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYID","Rule-Obj-Property","WORK-COVER-",true,"LTM-BFS-Work-Enrollment","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY WORK-COVER- PYID #20180713T131935.559 GMT","!PYID",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PXCREATEDATETIME","Rule-Obj-Property","WORK-",true,"LTM-BFS-Work-Enrollment","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY WORK- PXCREATEDATETIME #20180713T131935.660 GMT","!PXCREATEDATETIME",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "d8ee34e55196ef6a21816a6241b7ac52";
	}

	public String getDefinitionAppliesToClass() {
		return "LTM-Enrollment-UIPages";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("EnrollmentList",1,"Rule-HTML-Section","{'type':'Section','ruleName':'EnrollmentList','insKey':'RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT','sectionType':'standard'}");
pzLayout_1();
...
config.put("StreamName", "EnrollmentList");
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_EnrollmentList.pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","32","","","Text","true","59"};oCellRuntimeParamsMap.put("59||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT",paramValues);oControlPathsMap.put("59||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(5)");}
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_EnrollmentList.pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","T","true","0","","","Text","true","58"};oCellRuntimeParamsMap.put("58||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT",paramValues);oControlPathsMap.put("58||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(4)");}
...
public void repeatingDataCell_9() {
	...
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxDisplayText",".pxCreateDateTime", "resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(3)")); tools.appendString("headers='a3'");
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_EnrollmentList.pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","32","","","Text","true","56"};oCellRuntimeParamsMap.put("56||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT",paramValues);oControlPathsMap.put("56||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)");}
...
try {
	...
	modePage2.put("pyName","EnrollmentList_$CTX$_55");
		String repeatIndx = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='EnrollmentList_"+ referenceString+ "_55'";
	 String securedPropValue = null;
...
public void repeatingDataCell_8() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxLink",".pyLabel", "resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)")); tools.appendString("style='");
...
public void repeatingHeaderCell_5() {
	...
	int lastDotIndex = 0;
	dataPropClass = "LTM-BFS-Work-Enrollment";
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzCell.getTestIdIfEnabled("201501141440410808136652") + " ");
		 tools.appendString(' ' + pzCell.getInspectorData("Label",null, null, "resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(5)")); tools.appendString(" id='a5' class='");
		...
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_EnrollmentListPpxResults1colWidthCache5").equals("")) { tools.appendParamCSF("D_EnrollmentListPpxResults1colWidthCache5");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									...
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc295386817'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_EnrollmentListPpxResults1colWidthCache5' id='D_EnrollmentListPpxResults1colWidthCache5' value='" + tools.getParamValueCSF("D_EnrollmentListPpxResults1colWidthCache5") + "' />");
...
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc295386817' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc295386817' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc295386817' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
								...
								ClipboardPage gFCritPageD_EnrollmentList_pxResultsL7 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyStatusWork5").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle295386817\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyStatusWork5").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle295386817\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyStatusWork5").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyStatusWork5").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20180720120041074059300") + " ");
		 tools.appendString(' ' + pzCell.getInspectorData("Label",null, null, "resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(4)")); tools.appendString(" id='a4' class='");
		tools.appendString(pzSection.getCustomStyle(false,"","standard_dataLabelRead","standard_dataLabelWrite"));tools.appendString(" cellCont");tools.appendString(" gridCell");tools.appendString(" highlight-ele ");tools.appendString(" colResize");if(!bSecured){tools.appendString(" pointerStyle ");}tools.appendString("' pyCellType = 'static' ");
		tools.appendString(" title= '");  if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))) { tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText")) + " "); } tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Click to sort by", StreamBuilder.FMT_NORMAL)); tools.appendString("'");
		if(!bSecured){
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_EnrollmentListPpxResults1colWidthCache4").equals("")) { tools.appendParamCSF("D_EnrollmentListPpxResults1colWidthCache4");} else { tools.appendString("14.912280701754385"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:21px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc747288071'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_EnrollmentListPpxResults1colWidthCache4' id='D_EnrollmentListPpxResults1colWidthCache4' value='" + tools.getParamValueCSF("D_EnrollmentListPpxResults1colWidthCache4") + "' />");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc747288071' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc747288071' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc747288071' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_EnrollmentList_pxResultsL7 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle747288071\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle747288071\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20180720120041074053517") + " ");
		 tools.appendString(' ' + pzCell.getInspectorData("Label",null, null, "resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(3)")); tools.appendString(" id='a3' class='");
		tools.appendString(pzSection.getCustomStyle(false,"","standard_dataLabelRead","standard_dataLabelWrite"));tools.appendString(" cellCont");tools.appendString(" gridCell");tools.appendString(" highlight-ele ");tools.appendString(" colResize");if(!bSecured){tools.appendString(" pointerStyle ");}tools.appendString("' pyCellType = 'static' ");
		tools.appendString(" title= '");  if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))) { tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText")) + " "); } tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Click to sort by", StreamBuilder.FMT_NORMAL)); tools.appendString("'");
		if(!bSecured){
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_EnrollmentListPpxResults1colWidthCache3").equals("")) { tools.appendParamCSF("D_EnrollmentListPpxResults1colWidthCache3");} else { tools.appendString("28.947368421052634"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:21px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc30788541'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_EnrollmentListPpxResults1colWidthCache3' id='D_EnrollmentListPpxResults1colWidthCache3' value='" + tools.getParamValueCSF("D_EnrollmentListPpxResults1colWidthCache3") + "' />");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc30788541' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc30788541' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc30788541' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_EnrollmentList_pxResultsL7 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle30788541\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle30788541\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20160721093355058239712") + " ");
		 tools.appendString(' ' + pzCell.getInspectorData("Label",null, null, "resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(2)")); tools.appendString(" id='a2' class='");
		tools.appendString(pzSection.getCustomStyle(false,"","standard_dataLabelRead","standard_dataLabelWrite"));tools.appendString(" cellCont");tools.appendString(" gridCell");tools.appendString(" highlight-ele ");tools.appendString(" colResize");if(!bSecured){tools.appendString(" pointerStyle ");}tools.appendString("' pyCellType = 'static' ");
		tools.appendString(" title= '");  if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))) { tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText")) + " "); } tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Click to sort by", StreamBuilder.FMT_NORMAL)); tools.appendString("'");
		if(!bSecured){
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_EnrollmentListPpxResults1colWidthCache2").equals("")) { tools.appendParamCSF("D_EnrollmentListPpxResults1colWidthCache2");} else { tools.appendString("12.280701754385964"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:21px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc1592895387'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_EnrollmentListPpxResults1colWidthCache2' id='D_EnrollmentListPpxResults1colWidthCache2' value='" + tools.getParamValueCSF("D_EnrollmentListPpxResults1colWidthCache2") + "' />");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc1592895387' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc1592895387' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc1592895387' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_EnrollmentList_pxResultsL7 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle1592895387\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle1592895387\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString(" " + pzCell.getTestIdIfEnabled("20180720120041074047624") + " ");
		 tools.appendString(' ' + pzCell.getInspectorData("Label",null, null, "resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(1)")); tools.appendString(" id='a1' class='");
		...
		tools.appendString("  style='");
		tools.appendString("height:23px;");tools.appendString("width:"); if(!tools.getParamValueCSF("D_EnrollmentListPpxResults1colWidthCache1").equals("")) { tools.appendParamCSF("D_EnrollmentListPpxResults1colWidthCache1");} else { tools.appendString("28.947368421052634"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:21px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc1048354737'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_EnrollmentListPpxResults1colWidthCache1' id='D_EnrollmentListPpxResults1colWidthCache1' value='" + tools.getParamValueCSF("D_EnrollmentListPpxResults1colWidthCache1") + "' />");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc1048354737' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc1048354737' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc1048354737' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_EnrollmentList_pxResultsL7 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle1048354737\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle1048354737\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_EnrollmentList_pxResultsL7!=null && !gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_EnrollmentList_pxResultsL7.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
String pySectionInsName= "LTM-ENROLLMENT-UIPAGES!ENROLLMENTLIST";
...
public void pxDisplayText_7() {	String key="56||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT";
	...
	static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_EnrollmentList.pxResults","","","false","FREEFORM","REPEATING","",""," cffalse","T","false","32","","","Text","true","56"};oCellRuntimeParamsMap.put("56||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT",paramValues);oControlPathsMap.put("56||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)");}
...
public void pxDisplayText_9() {	String key="58||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT";
	String pzFromGrid = tools.getParamValue("pzFromGrid");
	tools.putParamValue("pzFromGrid","false");
	AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
	((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
	...
	static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_EnrollmentList.pxResults","","","false","FREEFORM","REPEATING","",""," cffalse","T","true","0","","","Text","true","58"};oCellRuntimeParamsMap.put("58||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT",paramValues);oControlPathsMap.put("58||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(4)");}


public void pxDisplayText_10() {	String key="59||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT";
	String pzFromGrid = tools.getParamValue("pzFromGrid");
	tools.putParamValue("pzFromGrid","false");
	AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
	((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
String sectionBodyPath = "resaveInstancePage.pySections(1).pySectionBody(2)";
...
headermetadata_1.put("data-ui-meta",pzCell.getInspectorDataDynamic("","Name","resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(1)"));
} 
} 
...
headermetadata_2.put("data-ui-meta",pzCell.getInspectorDataDynamic("","ID","resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(2)"));
} 
} 
headerHtmlComp = pzAuto.getUIComponent(); 
...
headermetadata_3.put("data-ui-meta",pzCell.getInspectorDataDynamic("","Creation date/time","resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(3)"));
} 
} 
headerHtmlComp = pzAuto.getUIComponent(); 
...
headermetadata_4.put("data-ui-meta",pzCell.getInspectorDataDynamic("","Created by","resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(4)"));
} 
} 
headerHtmlComp = pzAuto.getUIComponent(); 
...
headermetadata_5.put("data-ui-meta",pzCell.getInspectorDataDynamic("","Status","resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(1).pyCells(5)"));
} 
} 
headerHtmlComp = pzAuto.getUIComponent(); 
...
cellMetaData_1.put("data-ui-meta",pzCell.getInspectorDataDynamic("pxLink",".pyLabel","resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(1)"));
} 
} 
...
cellMetaData_2.put("data-ui-meta",pzCell.getInspectorDataDynamic("pxDisplayText",".pyID","resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)"));
} 
} 
cellHtmlComp = pzAuto.getUIComponent(); 
...
cellMetaData_3.put("data-ui-meta",pzCell.getInspectorDataDynamic("pxDisplayText",".pxCreateDateTime","resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(3)"));
} 
} 
cellHtmlComp = pzAuto.getUIComponent(); 
...
cellMetaData_4.put("data-ui-meta",pzCell.getInspectorDataDynamic("pxDisplayText",".pxCreateOpName","resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(4)"));
} 
} 
cellHtmlComp = pzAuto.getUIComponent(); 
...
cellMetaData_5.put("data-ui-meta",pzCell.getInspectorDataDynamic("pxDisplayText",".pyStatusWork","resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(5)"));
} 
} 
cellHtmlComp = pzAuto.getUIComponent(); 
...
public void D_EnrollmentList_pxResults_2() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
gridWrapper.put("DPName","D_EnrollmentList.pxResults");
gridWrapper.put("propType","Data Object");
gridWrapper.put("resultsClass","LTM-BFS-Work-Enrollment");
...
gridWrapper.put("sectionName","EnrollmentList");
gridWrapper.put("sectionClass","LTM-Enrollment-UIPages");
...
gridMetadataPage.putString(".pySectionClass","LTM-Enrollment-UIPages");
gridMetadataPage.putString(".pySectionName","EnrollmentList");
configMap.put("pxGridMetadataPage", gridMetadataPage); 
...
pzSection.getLayout().setExpandParam("SubSectionEnrollmentListB","",false);
}
public void LayoutWrapperTableStart_1() {
tools.appendString("<div " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'REPEATGRID','pgRef':'resaveInstancePage.pySections(1)','editable':'true'}") + " class='layout layout-outline layout-outline-default' id='EXPAND-OUTERFRAME' ");
String gridLayoutMethodName = tools.getParamValue("gridLayoutMethodName");
String expandParameter = "EXPANDEDSubSectionEnrollmentListB";
...
if (tmpDeclarePageParams != null && tmpDeclarePageParams.getProperty("D_EnrollmentList_pxResults_EnrollmentList_1") != null) {
ClipboardPage paramList = tmpDeclarePageParams.getProperty("D_EnrollmentList_pxResults_EnrollmentList_1").getPageValue();
...
oLog.error("ReloadSections:Expection : "+e.getMessage());
 ...
 ClipboardPage gFCritPageD_EnrollmentList_pxResultsL7=null;

 Map selUniqMapD_EnrollmentList_pxResultsL7 = null;

 Set filteredIndicesSetD_EnrollmentList_pxResultsL7 = null;

	 String strFCPage = "pyFilterCriteria_D_EnrollmentList.pxResults_EnrollmentList_1";
...
gFCritPageD_EnrollmentList_pxResultsL7=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));

  selUniqMapD_EnrollmentList_pxResultsL7 = null; // reset the variable

 if(gFCritPageD_EnrollmentList_pxResultsL7 != null){ 

 		 filteredIndicesSetD_EnrollmentList_pxResultsL7 = pega_uiengine_uiengine.pzPopulateFilteredindicesMap(gFCritPageD_EnrollmentList_pxResultsL7, "D_EnrollmentList.pxResults");

 		 tools.getParameterPage().put("filteredIndicesSet", filteredIndicesSetD_EnrollmentList_pxResultsL7);

 tools.putParamValue("populateSelectedUIValues", "true");

 		 selUniqMapD_EnrollmentList_pxResultsL7 = pega_uiengine_uiengine.pzPopulateSelectedValues(gFCritPageD_EnrollmentList_pxResultsL7); 

 		 tools.getParameterPage().put("selUniqMapD_EnrollmentList_pxResultsL7", selUniqMapD_EnrollmentList_pxResultsL7);

 tools.putParamValue("populateSelectedUIValues", "");

 }
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_EnrollmentList.pxResults").getReference());tools.appendString("_EnrollmentList_1'");
tools.appendString(" hashed-dp-page='");
if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_EnrollmentList.pxResults").getReference());tools.appendString("' bRowHovering='false' deferLoadAct='' class=\"");
...
tools.appendString(" bRangeFilterByFormat='false' DPSectionID=\"SubSectionEnrollmentListB\"  OAFunc='openWorkByHandle' ");
D_EnrollmentList_pxResults_1();
tools.appendString(">");
...
if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) {
 ...
 pageListProp = tools.getProperty("D_EnrollmentList.pxResults"); 
...
if(startIndex<=0) { startIndex = 1; }
 ...
 tools.putParamValue("PageListProperty","D_EnrollmentList.pxResults");}
...
ClipboardProperty propActivePrev = tools.getActive(); 
	...
	Iterator itr = tools.getProperty("D_EnrollmentList.pxResults").iterator();
		Set filteredResultsSet = new HashSet();
			while(itr.hasNext()){
				...
				if(gFCritPageD_EnrollmentList_pxResultsL7!= null){
				bFilterResult = pega_uiengine_uiengine.pzMatchesGridFilterCriteria(gFCritPageD_EnrollmentList_pxResultsL7, selUniqMapD_EnrollmentList_pxResultsL7);
				}
				if(bFilterResult){
 			 ...
 			 if (gFCritPageD_EnrollmentList_pxResultsL7== null || bFilterResult) {
...
public void gridCentreLayout_1() {/*gridCentreLayout*/
					...
					selUniqMapD_EnrollmentList_pxResultsL7 = null; // reset the variable
					gFCritPageD_EnrollmentList_pxResultsL7=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));
							 selUniqMapD_EnrollmentList_pxResultsL7 = (Map)tools.getParameterPage().getObject("selUniqMapD_EnrollmentList_pxResultsL7");
					...
					ClipboardProperty prop = tools.getProperty("D_EnrollmentList.pxResults");
					...
					tools.appendString("' gPropIndex='D_EnrollmentListPpxResults1' editRowIndex='");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"D_EnrollmentListPpxResults1colWidthGBL\" id=\"D_EnrollmentListPpxResults1colWidthGBL\" value=\"");
					...
					tools.appendString(tools.getParamValueCSF("D_EnrollmentListPpxResults1colWidthGBL"));tools.appendString("\" />");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"D_EnrollmentListPpxResults1colWidthGBR\" id=\"D_EnrollmentListPpxResults1colWidthGBR\" value=\"");
					...
					tools.appendString(tools.getParamValueCSF("D_EnrollmentListPpxResults1colWidthGBR"));
					...
					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");
					 ...
					 if(!("".equals(tools.getParamValue("D_EnrollmentListPpxResults1colWidthGBR") ))) { tools.appendString("resizedTable"); } 
					...
					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='' bColumnResize=\"true\" PL_PROP='D_EnrollmentList.pxResults' PL_PROP_CLASS='LTM-BFS-Work-Enrollment' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
					...
					if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) {
								 ...
								 itr_3 = tools.getProperty("D_EnrollmentList.pxResults").iterator(); 
					...
					Set filteredResultsSet = (HashSet)tools.getParameterPage().getObject("filteredResultsSet");boolean bFilterResult = false;
										 ...
										 } else if(gFCritPageD_EnrollmentList_pxResultsL7!= null){ 
													 bFilterResult = pega_uiengine_uiengine.pzMatchesGridFilterCriteria(gFCritPageD_EnrollmentList_pxResultsL7, selUniqMapD_EnrollmentList_pxResultsL7);
										 }
										 if (gFCritPageD_EnrollmentList_pxResultsL7== null || 
					...
					tools.appendString(" ng-repeat=\"Item in rootData.D_EnrollmentList.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals("D_EnrollmentList.pxResults")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodesD_EnrollmentList.pxResults1") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 
					...
					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle("D_EnrollmentList.pxResults"); } catch (Exception ex) { }
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"5\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("LTM-BFS-Work-Enrollment", "tempNoRespg");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodesD_EnrollmentList.pxResults1") && tools.getParamValue("partialRefresh").equals("false")) {
...
gridEndLayout_1
 ...
 tools.getParameterPage().remove("pyGridFilterCriteriaPage"); 
					...
					String paramName = "EXPANDEDSubSectionEnrollmentListB";
					...
					String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'REPEATGRID','pgRef':'resaveInstancePage.pySections(1)','editable':'true'}");
...
public void pxDisplayText_4() {String key="59||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
...
public void repeatingDataCell_5() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxDisplayText",".pyStatusWork", "resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(5)")); tools.appendString("headers='a5'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:20px;'");}tools.appendString("class='");
	tools.appendString(pzSection.getCustomStyle(true,"","dataValueRead",""));tools.appendString(" gridCell");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
...
public void pxDisplayText_3() {String key="58||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","true");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
public void repeatingDataCell_4() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxDisplayText",".pxCreateOpName", "resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(4)")); tools.appendString("headers='a4'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:20px;'");}tools.appendString("class='");
	tools.appendString(pzSection.getCustomStyle(true,"","dataValueRead",""));tools.appendString(" gridCell");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
...
public void pxDisplayText_1() {String key="56||RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","true");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
public void repeatingDataCell_2() {
	...
	tools.appendString("<td  title='");
	tools.appendString("'   ");
	 tools.appendString(' ' + pzCell.getInspectorDataDynamic("pxDisplayText",".pyID", "resaveInstancePage.pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)")); tools.appendString("headers='a2'");
	if(!pzAuto.getBrowserUtils().isIE()){ tools.appendString("style='height:20px;'");}tools.appendString("class='");
	tools.appendString(pzSection.getCustomStyle(true,"","dataValueRead",""));tools.appendString(" gridCell");tools.appendString(" '>");
	} 
	tools.putParamValue("pega_RLindex",tools.getSaveValue("index"));
...
public void D_EnrollmentList_pxResults_1() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendToD_EnrollmentList.pxResults1")|| tools.getParamValue("partialTrigger").equals("editRowD_EnrollmentList.pxResults1") ){
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData.D_EnrollmentList.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdropD_EnrollmentList.pxResults1")) {
 ...
 if(tools.getParamValue("partialTrigger").equals("filterpopupD_EnrollmentList.pxResults1")) { 
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendToD_EnrollmentList.pxResults1") ){
...
static {
	...
	oStreamProperties_1.put("pyClassName", "LTM-Enrollment-UIPages");
	oStreamProperties_1.put("pyCircumstanceProp", "");
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT");
	...
	oStreamProperties_1.put("pyRuleSet", "Enrollment");
	oStreamProperties_1.put("pyCorrType", "");
	oStreamProperties_1.put("pyStreamName", "EnrollmentList");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTLIST #20260221T185855.221 GMT", "LTM-Enrollment-UIPages EnrollmentList", "Enrollment", "01-01-01", "20260221T185855.221 GMT");
}
