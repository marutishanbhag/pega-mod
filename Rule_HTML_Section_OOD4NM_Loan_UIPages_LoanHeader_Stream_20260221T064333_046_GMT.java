 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Section_OOD4NM_Loan_UIPages_LoanHeader_Stream_20260221T064333_046_GMT extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.LoanHeader.OOD4NM_Loan_UIPages.Stream");
 ...
 */
	public Rule_HTML_Section_OOD4NM_Loan_UIPages_LoanHeader_Stream_20260221T064333_046_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("LoanHeader",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("LoanHeader",1,"Rule-HTML-Section","{'type':'Section','ruleName':'LoanHeader','insKey':'null','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
pzLayout_3();
...
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("className", "OOD4NM-Loan-Work-Loan");
...
pzSection.getLayout().setExpandParam("SubSectionLoanHeaderBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionLoanHeaderBBB";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendFormatted("OOD4NM-Loan-Work-Loan",StreamBuilder.FMT_NORMAL);		tools.appendString("\",\"\",\"");
...
try {
	...
	modePage2.put("pyName","LoanHeader_$CTX$_5");
		String repeatIndx = "";
	String pyTooltip = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='LoanHeader_"+ referenceString+ "_5'";
...
public int simpleLayoutCell_3( int index) {
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Loan Summary") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
pzSection.getLayout().setExpandParam("SubSectionLoanHeaderBB","",false);
}
...
public void simpleLayout_2() {
	...
	String paramName = "EXPANDEDSubSectionLoanHeaderBB";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.infinity.createNewWorkInDialogContainer(\\\"OOD4NM-Loan-Work-Loan\\\",\\\"pyStartCase\\\")\"]");
...
try {
	...
	modePage2.put("pyName","LoanHeader_$CTX$_2");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='LoanHeader_"+ referenceString+ "_2'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("201511051022210843267245") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
pzSection.getLayout().setExpandParam("SubSectionLoanHeaderB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionLoanHeaderB";
...
static {
	...
	oStreamProperties_1.put("pyStreamName", "LoanHeader");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OOD4NM-Loan-UIPages LoanHeader", "Loan", "01-01-01", "20210903T090257.610 GMT");
}
