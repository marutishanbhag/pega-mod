 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Harness_OLFHF9_Onboaring_Work_Onboarding_Perform_Stream_20260223T091524_241_GMT extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.Perform.OLFHF9_Onboaring_Work_Onboarding.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1721326865;
 ...
 */
	public Rule_HTML_Harness_OLFHF9_Onboaring_Work_Onboarding_Perform_Stream_20260223T091524_241_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "52f7fca4fe0f89f0724a478dc4b75ad6bce31822";
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_1","pzC11nPerformSection", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pzC11nPerformSection";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
pzPackageRuntime.packageSection("pzC11nPerformSection", strSectionPageProp, null);
strSectionPageProp = "";
strSectionPageClass = "";
...
tools.putParamValue("mainPanelSection","OLFHF9-Onboaring-Work-Onboarding!pzC11nPerformSection");
}
...
StringMap parameters = new HashStringMap();parameters.putString("pyHarnessNameForUpdate","Perform");parameters.putString("pyHarnessShortDesc","Perform work object");pzHarness.updateClipboardModels(parameters);
tools.appendString(" ");
...
tools.appendString(" ");
 tools.putParamValue("titleOnPortalLaunch", "Perform work object"); 
tools.appendString(" ");
if(!pega_uiengine_offlinesupport.pzIsForOfflineTemplate() || isOfflineMobileClient) {
tools.appendString(" ");
...
if (_jspx_meth_pega_lookup__1(pageContext, ".pyCaption", "Perform work object")) {
	return;
}
tools.appendString("</title> ");
choose_1();
...
tools.appendString(" data-portalHarnessInsName = \"OLFHF9-Onboaring-Work-Onboarding!Perform\" class=\"flex screen-layout screen-layout-modern screen-layout-content_only \" style=''> ");
...
tools.appendString(">");
 tools.putParamValue("sectionsDetails", "PortalStyles:pyPortalInlineStyle=,pyPortalInlineClass=,pyPortalLayoutMode=Flexbox&CENTER:pzC11nPerformSection,OLFHF9-Onboaring-Work-Onboarding,false,content_only,\"\",\"\",default,main&OLFHF9-Onboaring-Work-Onboarding!Perform"); 
...
tools.appendString("<div class='lazyload-harness' bIsScreenLayout ='true' sectionsDetails='PortalStyles:pyPortalInlineStyle=,pyPortalInlineClass=,pyPortalLayoutMode=Flexbox&CENTER:pzC11nPerformSection,OLFHF9-Onboaring-Work-Onboarding,false,content_only,\\\"\\\",\\\"\\\",default,main&OLFHF9-Onboaring-Work-Onboarding!Perform' strIncludedScripts='' data-localStoreId='OLFHF9-ONBOARING-WORK-ONBOARDING!PZC11NPERFORMSECTION' data-deferinvoke='includeSectionBody_1'>");
...
static {
	oPropDefinitions_1.put("OLFHF9-Onboaring-Work-Onboarding.pyCaption", new LiteweightPropertyDefinition("OLFHF9-Onboaring-Work-Onboarding", "pyCaption", "siN", false, true, "Default", false));
}
...
static {
	...
	oStreamProperties_1.put("pyClassName", "OLFHF9-Onboaring-Work-Onboarding");
	...
	oStreamProperties_1.put("pyStreamName", "Perform");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OLFHF9-Onboaring-Work-Onboarding Perform", "Onboaring", "01-01-01", "20210114T162756.099 GMT");
}
