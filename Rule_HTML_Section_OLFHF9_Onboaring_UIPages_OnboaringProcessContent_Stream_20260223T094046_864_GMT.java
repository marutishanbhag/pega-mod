 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Section_OLFHF9_Onboaring_UIPages_OnboaringProcessContent_Stream_20260223T094046_864_GMT extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.OnboaringProcessContent.OLFHF9_Onboaring_UIPages.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -1364177446;
 ...
 */
	public Rule_HTML_Section_OLFHF9_Onboaring_UIPages_OnboaringProcessContent_Stream_20260223T094046_864_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a7ff98e1a70732a0f19a3800aed84554b8687a4c";
...
try {
pxUniqueStreamHash = "a7ff98e1a70732a0f19a3800aed84554b8687a4c";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("OnboaringProcessContent",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("OnboaringProcessContent",1,"Rule-HTML-Section","{'type':'Section','ruleName':'OnboaringProcessContent','insKey':'null','templated':'true','editable':'true','sectionType':'standard'}");
pzLayout_2();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","OnboaringProcessList", secInfo);
}
...
public void sectionBodyIncludeInCell_2() { 
	...
	String sectionName = "OnboaringProcessList"; 
...
pzSection.getLayout().setExpandParam("SubSectionCellOnboaringProcessContent948","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","OnboaringProcessList", secInfo);
}
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","OnboaringProcessList",".pyRegions(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionOnboaringProcessContentB","",false);
}
...
public void simpleLayout_1() {
	...
	String paramName = "EXPANDEDSubSectionOnboaringProcessContentB";
...
static {
	...
	oStreamProperties_1.put("pyStreamName", "OnboaringProcessContent");
