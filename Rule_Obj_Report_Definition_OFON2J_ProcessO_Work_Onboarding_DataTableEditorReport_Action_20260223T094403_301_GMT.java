...
public class Rule_Obj_Report_Definition_OFON2J_ProcessO_Work_Onboarding_DataTableEditorReport_Action_20260223T094403_301_GMT  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.DataTableEditorReport.OFON2J_ProcessO_Work_Onboarding.Action");
	public Rule_Obj_Report_Definition_OFON2J_ProcessO_Work_Onboarding_DataTableEditorReport_Action_20260223T094403_301_GMT(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-REPORT-DEFINITION OFON2J-PROCESSO-WORK-ONBOARDING DATATABLEEDITORREPORT #20260223T094403.301 GMT", "OFON2J-ProcessO-Work-Onboarding DataTableEditorReport", "ProcessO", "01-01-01", "20260223T094635.451 GMT");
}
