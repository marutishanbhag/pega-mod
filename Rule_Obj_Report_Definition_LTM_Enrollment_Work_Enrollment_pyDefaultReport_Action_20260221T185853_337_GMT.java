...
public class Rule_Obj_Report_Definition_LTM_Enrollment_Work_Enrollment_pyDefaultReport_Action_20260221T185853_337_GMT  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pyDefaultReport.LTM_Enrollment_Work_Enrollment.Action");
	public Rule_Obj_Report_Definition_LTM_Enrollment_Work_Enrollment_pyDefaultReport_Action_20260221T185853_337_GMT(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "LTM-Enrollment-Work-Enrollment pyDefaultReport", "Enrollment", "01-01-01", "20210129T200622.654 GMT");
}
