 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Section_OLFHF9_Onboaring_UIPages_OnboaringProcessList_Stream_20260223T094046_173_GMT extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.OnboaringProcessList.OLFHF9_Onboaring_UIPages.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -372946423;
 ...
 */
	public Rule_HTML_Section_OLFHF9_Onboaring_UIPages_OnboaringProcessList_Stream_20260223T094046_173_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "23199da24b55e6be1229111b270efab49e87441a";
...
try {
pxUniqueStreamHash = "23199da24b55e6be1229111b270efab49e87441a";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("OnboaringProcessList",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
private static final String oDependencies [] = {
	...
	private static final DependentRuleInfo[] oDependentRuleInfos = {
		...
		new DependentRuleInfo("PYID","Rule-Obj-Property","WORK-COVER-",true,"OLFHF9-Onboaring-Work-OnboaringProcess","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY WORK-COVER- PYID #20180713T131935.559 GMT","!PYID",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PXCREATEOPNAME","Rule-Obj-Property","@BASECLASS",true,"OLFHF9-Onboaring-Work-OnboaringProcess","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY @BASECLASS PXCREATEOPNAME #20180713T131841.211 GMT","!PXCREATEOPNAME",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PXCREATEDATETIME","Rule-Obj-Property","WORK-",true,"OLFHF9-Onboaring-Work-OnboaringProcess","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY WORK- PXCREATEDATETIME #20180713T131935.660 GMT","!PXCREATEDATETIME",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
		new DependentRuleInfo("PYSTATUSWORK","Rule-Obj-Property","WORK-",true,"OLFHF9-Onboaring-Work-OnboaringProcess","Pega-ProCom","08-01-01","RULE-OBJ-PROPERTY WORK- PYSTATUSWORK #20180713T131937.564 GMT","!PYSTATUSWORK",true,false,"ABSOLUTE_IS_NOT_PRIMARY",1), 
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("OnboaringProcessList",1,"Rule-HTML-Section","{'type':'Section','ruleName':'OnboaringProcessList','insKey':'null','sectionType':'standard'}");
pzLayout_1();
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_OnboaringProcessList.pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","32","","","Text","true","93"};oCellRuntimeParamsMap.put("93||",paramValues);oControlPathsMap.put("93||",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(5)");}
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_OnboaringProcessList.pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","T","true","0","","","Text","true","92"};oCellRuntimeParamsMap.put("92||",paramValues);oControlPathsMap.put("92||",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(4)");}
...
static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_OnboaringProcessList.pxResults","","","true","FREEFORM","REPEATING","",""," cffalse","T","false","32","","","Text","true","90"};oCellRuntimeParamsMap.put("90||",paramValues);oControlPathsMap.put("90||",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)");}
...
try {
	...
	modePage2.put("pyName","OnboaringProcessList_$CTX$_89");
		String repeatIndx = "";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='OnboaringProcessList_"+ referenceString+ "_89'";
	 String securedPropValue = null;
...
public void repeatingHeaderCell_5() {
	...
	int lastDotIndex = 0;
	dataPropClass = "OLFHF9-Onboaring-Work-OnboaringProcess";
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_OnboaringProcessListPpxResults1colWidthCache5").equals("")) { tools.appendParamCSF("D_OnboaringProcessListPpxResults1colWidthCache5");} else { tools.appendString("auto;"); }tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									...
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc1309020725'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_OnboaringProcessListPpxResults1colWidthCache5' id='D_OnboaringProcessListPpxResults1colWidthCache5' value='" + tools.getParamValueCSF("D_OnboaringProcessListPpxResults1colWidthCache5") + "' />");
...
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc1309020725' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc1309020725' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc1309020725' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
								...
								ClipboardPage gFCritPageD_OnboaringProcessList_pxResultsL25 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyStatusWork5").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle1309020725\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyStatusWork5").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle1309020725\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyStatusWork5").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyStatusWork5").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyStatusWork5").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_OnboaringProcessListPpxResults1colWidthCache4").equals("")) { tools.appendParamCSF("D_OnboaringProcessListPpxResults1colWidthCache4");} else { tools.appendString("14.912280701754385"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:21px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc1542850903'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_OnboaringProcessListPpxResults1colWidthCache4' id='D_OnboaringProcessListPpxResults1colWidthCache4' value='" + tools.getParamValueCSF("D_OnboaringProcessListPpxResults1colWidthCache4") + "' />");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc1542850903' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc1542850903' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc1542850903' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_OnboaringProcessList_pxResultsL25 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle1542850903\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle1542850903\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateOpName4").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateOpName4").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_OnboaringProcessListPpxResults1colWidthCache3").equals("")) { tools.appendParamCSF("D_OnboaringProcessListPpxResults1colWidthCache3");} else { tools.appendString("28.947368421052634"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:21px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc158534624'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_OnboaringProcessListPpxResults1colWidthCache3' id='D_OnboaringProcessListPpxResults1colWidthCache3' value='" + tools.getParamValueCSF("D_OnboaringProcessListPpxResults1colWidthCache3") + "' />");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc158534624' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc158534624' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc158534624' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_OnboaringProcessList_pxResultsL25 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle158534624\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle158534624\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pxCreateDateTime3").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pxCreateDateTime3").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  style='");
		tools.appendString("width:"); if(!tools.getParamValueCSF("D_OnboaringProcessListPpxResults1colWidthCache2").equals("")) { tools.appendParamCSF("D_OnboaringProcessListPpxResults1colWidthCache2");} else { tools.appendString("12.280701754385964"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:21px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc662851887'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_OnboaringProcessListPpxResults1colWidthCache2' id='D_OnboaringProcessListPpxResults1colWidthCache2' value='" + tools.getParamValueCSF("D_OnboaringProcessListPpxResults1colWidthCache2") + "' />");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc662851887' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc662851887' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc662851887' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_OnboaringProcessList_pxResultsL25 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle662851887\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle662851887\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyID2").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyID2").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
throw new RuntimeException("Problem in JSP fragment", t);
		...
		tools.appendString("  style='");
		tools.appendString("height:23px;");tools.appendString("width:"); if(!tools.getParamValueCSF("D_OnboaringProcessListPpxResults1colWidthCache1").equals("")) { tools.appendParamCSF("D_OnboaringProcessListPpxResults1colWidthCache1");} else { tools.appendString("28.947368421052634"); }tools.appendString("%;");tools.appendString(""); tools.appendString("'>");
		if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){
									tools.appendString("<DIV class='oflowDiv'"); if(pzAuto.getBrowserUtils().isSafari() || pzAuto.getBrowserUtils().isChrome()){ 
									tools.appendString("style='height:21px;'"); } 
									tools.appendString(">"); } 
									tools.appendString("<div tabindex=0 "); 
									tools.appendString("class='divCont  filterapplied'");if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("aria-describedby='titleDesc741551'");}tools.appendString("><span class='wspan'></span><div class='cellIn '");tools.appendString(">");
									tools.appendString("<input type='hidden' name='D_OnboaringProcessListPpxResults1colWidthCache1' id='D_OnboaringProcessListPpxResults1colWidthCache1' value='" + tools.getParamValueCSF("D_OnboaringProcessListPpxResults1colWidthCache1") + "' />");
...
if("DESC".equals(tools.getParamValue("columnSortOrder"))){    
  ...
  tools.putParamValue("sortTitleText","Enter to sort");   
}if(!pzAuto.getBrowserUtils().isIE()){tools.appendString("<div id='titleDesc741551' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</div>");}if(pzAuto.getBrowserUtils().isIE()){ if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){tools.appendString("<span id='titleDesc741551' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}else{tools.appendString("<span id='titleDesc741551' class='gridSortTitleDesc' aria-live='assertive'>");tools.appendString(tools.getLocalizedTextForString(".pyCaption", tools.getParamCSF("sortTitleText"), StreamBuilder.FMT_NORMAL));tools.appendString("</span>");}
									tools.appendString("</div>");}
tools.appendString("<span id='sort'"); 
if("ASC".equals(tools.getParamValue("columnSortOrder")) || "DESC".equals(tools.getParamValue("columnSortOrder"))){ 
 tools.appendString("tabIndex='0'"); 
...
tools.appendString(sortImgHTML+sortNoHTML);tools.putParamValue("columnSortOrder","");tools.putParamValue("sortTitleText","");}
									tools.appendString("</div>");if(!bSecured){
								ClipboardPage gFCritPageD_OnboaringProcessList_pxResultsL25 = tools.findPage(tools.getParamValueCSF("pyGridFilterCriteriaPage"));if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.putParamValue("filterState","FILTERED");}else{ tools.putParamValue("filterState","NOTFILTERED"); }if(pzAuto.evaluateWhen("BrowserIsFireFox",null, true)){tools.appendString("<span><span aria-describedby=\"filterTitle741551\" id='pui_filter' tabIndex='0' title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span><span id=\"filterTitle741551\" style=\"display:none;\">");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("</span></span>");tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}else{if(pzAuto.evaluateWhen("isAccessible",null, true)){tools.appendString("<span><span id='pui_filter' tabindex = '0'  title='");if("FILTERED".equals(tools.getParamValue("filterState"))){tools.appendString(tools.getLocalizedTextForString(".pyCaption", "filteredcolumn", StreamBuilder.FMT_NORMAL));}else{tools.appendString(tools.getLocalizedTextForString(".pyCaption", "Enter to filter", StreamBuilder.FMT_NORMAL));}tools.appendString("' "); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></span></span>");}else{
String bFilterExposedCols = "false" ; 
if(!"unexposed".equals(tools.getParamValue("pzPropertyType")) || bFilterExposedCols.equals("true")){tools.appendString("<span><a id='pui_filter' tabIndex='0' title='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"'aria-label='"+tools.getLocalizedTextForString(".pyCaption", "Click to filter", StreamBuilder.FMT_NORMAL)+"' role='link'"); if(gFCritPageD_OnboaringProcessList_pxResultsL25!=null && !gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPageValue("pyLabel1").isEmpty() && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="" && gFCritPageD_OnboaringProcessList_pxResultsL25.getProperty("pyColumnFilterCriteria").getPropertyValue("pyLabel1").getStringValue("pyFilterCriteriaType")!="none"){tools.appendString("class='filtered highlight-ele'");tools.putParamValue("columnMenuPrefix","move");}else{tools.appendString("class='filter highlight-ele'");} tools.appendString(" filterType=true></a></span>");}tools.putParamValue("pzPropertyType","");}}}if(!(pzAuto.getBrowserUtils().isIE() || pzAuto.getBrowserUtils().isEdge())){ 
									tools.appendString("</DIV>"); }
	tools.appendString("</th>");
...
public void pxDisplayText_7() {	String key="90||";
	...
	static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_OnboaringProcessList.pxResults","","","false","FREEFORM","REPEATING","",""," cffalse","T","false","32","","","Text","true","90"};oCellRuntimeParamsMap.put("90||",paramValues);oControlPathsMap.put("90||",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(2)");}
...
public void pxDisplayText_9() {	String key="92||";
	String pzFromGrid = tools.getParamValue("pzFromGrid");
	tools.putParamValue("pzFromGrid","false");
	AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
	((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
	...
	static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_OnboaringProcessList.pxResults","","","false","FREEFORM","REPEATING","",""," cffalse","T","true","0","","","Text","true","92"};oCellRuntimeParamsMap.put("92||",paramValues);oControlPathsMap.put("92||",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(4)");}


public void pxDisplayText_10() {	String key="93||";
	String pzFromGrid = tools.getParamValue("pzFromGrid");
	tools.putParamValue("pzFromGrid","false");
	AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
	((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
	...
	static{String[] paramValues = new String[]{"label", "pxDisplayText", "","D_OnboaringProcessList.pxResults","","","false","FREEFORM","REPEATING","",""," cffalse","T","false","32","","","Text","true","93"};oCellRuntimeParamsMap.put("93||",paramValues);oControlPathsMap.put("93||",".pySections(1).pySectionBody(2).pyTable.pyRows(2).pyCells(5)");}
...
public void D_OnboaringProcessList_pxResults_2() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
getGridActions_1() {
	...
	D_OnboaringProcessList_pxResults_2();
...
gridWrapper.put("DPName","D_OnboaringProcessList.pxResults");
gridWrapper.put("propType","Data Object");
gridWrapper.put("resultsClass","OLFHF9-Onboaring-Work-OnboaringProcess");
...
gridWrapper.put("sectionName","OnboaringProcessList");
...
gridMetadataPage.putString(".pySectionName","OnboaringProcessList");
configMap.put("pxGridMetadataPage", gridMetadataPage); 
...
pzSection.getLayout().setExpandParam("SubSectionOnboaringProcessListB","",false);
}
...
String expandParameter = "EXPANDEDSubSectionOnboaringProcessListB";
...
if (tmpDeclarePageParams != null && tmpDeclarePageParams.getProperty("D_OnboaringProcessList_pxResults_OnboaringProcessList_1") != null) {
ClipboardPage paramList = tmpDeclarePageParams.getProperty("D_OnboaringProcessList_pxResults_OnboaringProcessList_1").getPageValue();
...
oLog.error("ReloadSections:Expection : "+e.getMessage());
 ...
 ClipboardPage gFCritPageD_OnboaringProcessList_pxResultsL25=null;

 Map selUniqMapD_OnboaringProcessList_pxResultsL25 = null;

 Set filteredIndicesSetD_OnboaringProcessList_pxResultsL25 = null;

	 String strFCPage = "pyFilterCriteria_D_OnboaringProcessList.pxResults_OnboaringProcessList_1";
...
gFCritPageD_OnboaringProcessList_pxResultsL25=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));

  selUniqMapD_OnboaringProcessList_pxResultsL25 = null; // reset the variable

 if(gFCritPageD_OnboaringProcessList_pxResultsL25 != null){ 

 		 filteredIndicesSetD_OnboaringProcessList_pxResultsL25 = pega_uiengine_uiengine.pzPopulateFilteredindicesMap(gFCritPageD_OnboaringProcessList_pxResultsL25, "D_OnboaringProcessList.pxResults");

 		 tools.getParameterPage().put("filteredIndicesSet", filteredIndicesSetD_OnboaringProcessList_pxResultsL25);

 tools.putParamValue("populateSelectedUIValues", "true");

 		 selUniqMapD_OnboaringProcessList_pxResultsL25 = pega_uiengine_uiengine.pzPopulateSelectedValues(gFCritPageD_OnboaringProcessList_pxResultsL25); 

 		 tools.getParameterPage().put("selUniqMapD_OnboaringProcessList_pxResultsL25", selUniqMapD_OnboaringProcessList_pxResultsL25);

 tools.putParamValue("populateSelectedUIValues", "");

 }
tools.appendString("<div  section_index='1' ");
tools.appendString(" dataSource='");if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_OnboaringProcessList.pxResults").getReference());tools.appendString("_OnboaringProcessList_1'");
tools.appendString(" hashed-dp-page='");
if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) tools.appendString(tools.getProperty("D_OnboaringProcessList.pxResults").getReference());tools.appendString("' bRowHovering='false' deferLoadAct='' class=\"");
...
tools.appendString(" bRangeFilterByFormat='false' DPSectionID=\"SubSectionOnboaringProcessListB\"  OAFunc='openWorkByHandle' ");
D_OnboaringProcessList_pxResults_1();
tools.appendString(">");
...
if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) {
 ...
 pageListProp = tools.getProperty("D_OnboaringProcessList.pxResults"); 
...
if(startIndex<=0) { startIndex = 1; }
 ...
 tools.putParamValue("PageListProperty","D_OnboaringProcessList.pxResults");}
...
ClipboardProperty propActivePrev = tools.getActive(); 
	...
	Iterator itr = tools.getProperty("D_OnboaringProcessList.pxResults").iterator();
		Set filteredResultsSet = new HashSet();
			while(itr.hasNext()){
				...
				if(gFCritPageD_OnboaringProcessList_pxResultsL25!= null){
				bFilterResult = pega_uiengine_uiengine.pzMatchesGridFilterCriteria(gFCritPageD_OnboaringProcessList_pxResultsL25, selUniqMapD_OnboaringProcessList_pxResultsL25);
				}
				if(bFilterResult){
 			 ...
 			 if (gFCritPageD_OnboaringProcessList_pxResultsL25== null || bFilterResult) {
...
public void gridCentreLayout_1() {/*gridCentreLayout*/
					...
					selUniqMapD_OnboaringProcessList_pxResultsL25 = null; // reset the variable
					gFCritPageD_OnboaringProcessList_pxResultsL25=tools.findPage(tools.getParamValue("pyGridFilterCriteriaPage"));
							 selUniqMapD_OnboaringProcessList_pxResultsL25 = (Map)tools.getParameterPage().getObject("selUniqMapD_OnboaringProcessList_pxResultsL25");
					...
					ClipboardProperty prop = tools.getProperty("D_OnboaringProcessList.pxResults");
					...
					tools.appendString("' gPropIndex='D_OnboaringProcessListPpxResults1' editRowIndex='");
					...
					tools.appendString(" cellspacing='0' cellpadding='0' id='' width='100%'><tr><td valign='top' class='mainGridTableCell' ><input type=\"hidden\" name=\"D_OnboaringProcessListPpxResults1colWidthGBL\" id=\"D_OnboaringProcessListPpxResults1colWidthGBL\" value=\"");
					...
					tools.appendString(tools.getParamValueCSF("D_OnboaringProcessListPpxResults1colWidthGBL"));tools.appendString("\" />");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("</td><td valign='top' class='mainGridTableCell'><input type=\"hidden\" name=\"D_OnboaringProcessListPpxResults1colWidthGBR\" id=\"D_OnboaringProcessListPpxResults1colWidthGBR\" value=\"");
					...
					tools.appendString(tools.getParamValueCSF("D_OnboaringProcessListPpxResults1colWidthGBR"));
					...
					tools.appendString("\" />\n\t\t\t\t\t\t\t\t\t<div id='gridBody_right' style='' ruleNav=\"\" formatNav=\"\" >\n\t\t\t\t\t\t\t\t\t\t<table class='gridTable ");
					 ...
					 if(!("".equals(tools.getParamValue("D_OnboaringProcessListPpxResults1colWidthGBR") ))) { tools.appendString("resizedTable"); } 
					...
					tools.appendString("' width='100%'  cellspacing=0 cellpadding=0 id='bodyTbl_right'  summary='' bColumnResize=\"true\" PL_PROP='D_OnboaringProcessList.pxResults' PL_PROP_CLASS='OLFHF9-Onboaring-Work-OnboaringProcess' PRIM_PAGE='");
 ...
 {int counter = 0; int rowsDisplayed = 0; 
					...
					if(!Boolean.valueOf(tools.getParamValue("pyPegaDesignMode")).booleanValue()) {
								 ...
								 itr_3 = tools.getProperty("D_OnboaringProcessList.pxResults").iterator(); 
					...
					Set filteredResultsSet = (HashSet)tools.getParameterPage().getObject("filteredResultsSet");boolean bFilterResult = false;
										 ...
										 } else if(gFCritPageD_OnboaringProcessList_pxResultsL25!= null){ 
													 bFilterResult = pega_uiengine_uiengine.pzMatchesGridFilterCriteria(gFCritPageD_OnboaringProcessList_pxResultsL25, selUniqMapD_OnboaringProcessList_pxResultsL25);
										 }
										 if (gFCritPageD_OnboaringProcessList_pxResultsL25== null || 
					...
					tools.appendString(" ng-repeat=\"Item in rootData.D_OnboaringProcessList.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 try{if(tools.getParamValue("AJAXTrackID") != null && !tools.getParamValue("AJAXTrackID").equals("")){com.pega.pegarules.priv.runtime.IStreamChangeTracker ct_gridAction = pzAuto.getChangeTracker(tools.getParamValue("AJAXTrackID"));
					...
					String rowTestID = "R";
					 ...
					 if(!"".equals(tools.getParamValue("pyChildPropRef")) && tools.getParamValue("pyChildPropRef").equals("D_OnboaringProcessList.pxResults")) { tempTestID = tools.getActiveName(); } else if(tools.getParamValue("partialTrigger").equals("getChildNodesD_OnboaringProcessList.pxResults1") && !"".equals(tools.getParamValue("pyPropRef"))) { try{tempTestID = tools.getStepPage().getEntryHandle(tools.getParamValue("pyPropRef")+"("+tools.getActive().indexOf()+")");}catch(Exception e){tempTestID = tools.getActiveName();} } else { tempTestID = tools.getActiveName(); } 
					...
					try { strEntryHandlePLProp = tools.getStepPage().getEntryHandle("D_OnboaringProcessList.pxResults"); } catch (Exception ex) { }
 	...
 	tools.putParamValue("showOnLoadMsg", "showOnLoadMsg");
					...
					tools.appendString("\n \t<tr id=\"Grid_NoResults\" class=\"cellCont\" >\n \t\t <td colspan=\"5\" class=\"dataLabelRead gridCell\" >");
								 ...
								 tools.putParamValue("RenderSingle",""); 
									 ...
									 ClipboardPage tempNoRespg = tools.createPage("OLFHF9-Onboaring-Work-OnboaringProcess", "tempNoRespg");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
					...
					tools.appendString("\n\t\t\t\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t\t\t\t</div></td></tr>\n\t\t\t\t\t\t\t</table>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t<div style='clear:left;' ></div>");
					 ...
					 if( tools.getParamValue("partialTrigger").equals("getChildNodesD_OnboaringProcessList.pxResults1") && tools.getParamValue("partialRefresh").equals("false")) {
...
gridEndLayout_1
 ...
 tools.getParameterPage().remove("pyGridFilterCriteriaPage"); 
					...
					String paramName = "EXPANDEDSubSectionOnboaringProcessListB";
...
public void pxDisplayText_4() {String key="93||";
String pzFromGrid = tools.getParamValue("pzFromGrid");
...
public void pxDisplayText_3() {String key="92||";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","true");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
public void pxDisplayText_1() {String key="90||";
String pzFromGrid = tools.getParamValue("pzFromGrid");
tools.putParamValue("pzFromGrid","true");
AssemblyParameters assemblyParams = oAssemblyParamsMap.get(key);
((PegaAPI) tools).appendControlMarkup("pxDisplayText", assemblyParams);
...
public void D_OnboaringProcessList_pxResults_1() {
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
tools.putSaveValue("bEditable", "" + tools.hasInputEnabled());
					...
					if(tools.getParamValue("partialTrigger").equals("appendToD_OnboaringProcessList.pxResults1")|| tools.getParamValue("partialTrigger").equals("editRowD_OnboaringProcessList.pxResults1") ){
 ...
 if(!"".equals(tools.getParamValue("curRowNum"))) { tools.putSaveValue("curRowNum",""+tools.getParamValue("curRowNum")); } else {tools.putSaveValue("curRowNum",""+tools.getActive().indexOf());}
					...
					tools.appendString(" cellCont'  ng-repeat=\"Item in rootData.D_OnboaringProcessList.pxResults\" ng-class-odd=\"'oddRow'\" ng-class-even=\"'evenRow'\"");
 ...
 if(!tools.getParamValue("EditRow").equals("true")) tools.setInput(Boolean.parseBoolean(tools.getSaveValue("bEditable"))); 
	 ...
	 if(tools.getParamValue("partialTrigger").equals("dragdropD_OnboaringProcessList.pxResults1")) {
 ...
 if(tools.getParamValue("partialTrigger").equals("filterpopupD_OnboaringProcessList.pxResults1")) { 
...
public void gridLastRow_1() { /*gridLastRow*/
					...
					if(tools.getParamValue("partialTrigger").equals("appendToD_OnboaringProcessList.pxResults1") ){
...
static {
	...
	oStreamProperties_1.put("pyStreamName", "OnboaringProcessList");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OLFHF9-Onboaring-UIPages OnboaringProcessList", "OnboaringProcess", "01-01-01", "20190824T051057.615 GMT");
}
