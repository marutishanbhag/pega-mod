...
public class sh_stream_pxtextinput_228709330_932270d635af6891a1998732e5e3d595_20260223T094650_812_GMT extends StreamBuilderSection implements ControlBuilder, FUASupport, FUAReusable, WebAllowable {
...
public sh_stream_pxtextinput_228709330_932270d635af6891a1998732e5e3d595_20260223T094650_812_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
if(pegaValidation != null) {
	...
	tools.putActive(propActivePrev); 					} catch (Exception e) {
	 ...
	 if(pzAuto.getUIComponentRuntime().getTemplatingUIStatus() == 'Y'					&& pzAuto.getUIComponentRuntime().getRuntimeContextTree().isLiveDesignViewMode()){
		...
		IUIComponent ctrlComponent = pzAuto.getUIComponent();
		metadata.put("cellInfo", " LastName");
