 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Harness_OOD4NM_Loan_UIPages_Loan_Stream_20260221T064335_971_GMT extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.Loan.OOD4NM_Loan_UIPages.Stream");
 ...
 */
	public Rule_HTML_Harness_OOD4NM_Loan_UIPages_Loan_Stream_20260221T064335_971_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","LoanContent", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "LoanContent";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","LoanHeader", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "LoanHeader";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","Loan");
...
public void createPegaHarnessDIV_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","Loan");
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("Loan",true));
					tools.appendString("</title>");
try {
...
static {
	...
	oStreamProperties_1.put("pyStreamName", "Loan");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OOD4NM-Loan-UIPages Loan", "Loan", "01-01-01", "20180713T135116.739 GMT");
}
