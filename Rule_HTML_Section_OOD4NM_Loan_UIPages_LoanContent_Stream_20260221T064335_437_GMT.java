 ...
 * Builds JSP stream .
 */
public class Rule_HTML_Section_OOD4NM_Loan_UIPages_LoanContent_Stream_20260221T064335_437_GMT extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.LoanContent.OOD4NM_Loan_UIPages.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -2106198679;
 ...
 */
	public Rule_HTML_Section_OOD4NM_Loan_UIPages_LoanContent_Stream_20260221T064335_437_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "54c402b35e79a000a4ee368fdb73facb5b807629";
...
try {
pxUniqueStreamHash = "54c402b35e79a000a4ee368fdb73facb5b807629";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("LoanContent",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("LoanContent",1,"Rule-HTML-Section","{'type':'Section','ruleName':'LoanContent','insKey':'null','templated':'true','editable':'true','sectionType':'standard'}");
pzLayout_2();
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_6","LoanList", secInfo);
}
...
pzSection.getLayout().setExpandParam("SubSectionCellLoanContent22","",false);
}
...
public void buildSection_1() { 
	...
	Map<String, String> secParams = new HashMap<String, String>();
	secInfo.put(com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree.PARAMETERS, secParams);
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","LoanList", secInfo);
}
...
public int simpleLayoutCell_1( int index) {
	...
	tools.appendString("' " + pzCell.getInspectorDataDynamic("SUB_SECTION","LoanList",".pyRegions(1).pyCells(1)") + " class='content-item content-sub_section item-" + Integer.toString(index) + " remove-left-spacing remove-right-spacing    " + pzSection.getCustomStyle(false, "","padding-r-1x","padding-r-1x")  + " flex flex-row '  STRING_TYPE='sub_section' RESERVE_SPACE='false'>");
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	String inspectorData=pzCell.getInspectorDataDynamic("SUB_SECTION","LoanList",".pyRegions(1).pyCells(1)");
...
pzSection.getLayout().setExpandParam("SubSectionLoanContentB","",false);
}
...
public void simpleLayout_1() {
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'ContentTemplate.pySections(1)','region':'A'}") + " class='" + "flex  content  layout-content-stacked content-stacked content-items-maxwidth" + "'  ");
		...
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'ContentTemplate.pySections(1)','region':'A'}") + "").append("\"").toString();
	...
	String paramName = "EXPANDEDSubSectionLoanContentB";
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'ContentTemplate.pySections(1)','region':'A'}");
...
static {
	...
	oStreamProperties_1.put("pyStreamName", "LoanContent");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OOD4NM-Loan-UIPages LoanContent", "Loan", "01-01-01", "20210506T204028.525 GMT");
}
