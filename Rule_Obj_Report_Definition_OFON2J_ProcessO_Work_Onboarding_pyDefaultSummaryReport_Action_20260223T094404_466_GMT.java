...
public class Rule_Obj_Report_Definition_OFON2J_ProcessO_Work_Onboarding_pyDefaultSummaryReport_Action_20260223T094404_466_GMT  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Report_Definition.pyDefaultSummaryReport.OFON2J_ProcessO_Work_Onboarding.Action");
	public Rule_Obj_Report_Definition_OFON2J_ProcessO_Work_Onboarding_pyDefaultSummaryReport_Action_20260223T094404_466_GMT(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
public void perform() {
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "OFON2J-ProcessO-Work-Onboarding pyDefaultSummaryReport", "ProcessO", "01-01-01", "20180713T134313.322 GMT");
}
