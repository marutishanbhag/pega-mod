...
/**
 * Builds JSP stream LTM-ENROLLMENT-UIPAGES!ENROLLMENT.
 */
public class Rule_HTML_Harness_LTM_Enrollment_UIPages_Enrollment_Stream_20260221T185856_273_GMT extends StreamBuilderBase implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Harness.Enrollment.LTM_Enrollment_UIPages.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = 1949634417;
 ...
 */
	public Rule_HTML_Harness_LTM_Enrollment_UIPages_Enrollment_Stream_20260221T185856_273_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "3f968b63c2c67391988021a6fc8bddf59f3cbd86";
...
try {
/*
 * Begin RULE-HTML-HARNESS LTM-ENROLLMENT-UIPAGES ENROLLMENT #20260221T185856.273 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-HARNESS LTM-ENROLLMENT-UIPAGES ENROLLMENT #20260221T185856.273 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-HARNESS LTM-ENROLLMENT-UIPAGES ENROLLMENT #20260221T185856.273 GMT */
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
		pzAuto.finishStream();
...
//	RULE-UTILITY-FUNCTION STRING EQUALS #20180713T131441.596 GMT:20180713T131441.596 GMT
	...
	public static String getFUAContentHash() {
		return "6f46eb074610398036e68053c18d0051";
	}
...
public void buildSection_2() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_4","EnrollmentContent", secInfo);
}
...
public void includeSectionBody_2() { 
	...
	String includedSectionName = "";includedSectionName = "EnrollmentContent";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_3","EnrollmentHeader", secInfo);
}
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "EnrollmentHeader";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
...
public void createFormElement_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		pg_form.put("streamName","Enrollment");
...
public void updateClipboardModel_1() {
	...
	parameters.putString("pyHarnessNameForUpdate","Enrollment");
...
public void createPegaHarnessDIV_1() {
	...
	if("".equals(tools.getParamValue("RenderSingle"))){
		...
		pg_harnesscnt.put("streamName","Enrollment");
		...
		boolean isOfflineMobileClient = pzAuto.isOffline() && pxIsMobileClient;
			...
			if("".equals(tools.getParamValue("RenderSingle"))){
				...
				if(!(pzAuto.isOffline() && pega.getPackageRuntime().canPackage()) || isPMCScriptInclusion){
					...
					tools.appendString(pzHarness.getBuilder().getTitle("Enrollment",true));
					tools.appendString("</title>");
try {
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-HARNESS LTM-ENROLLMENT-UIPAGES ENROLLMENT #20260221T185856.273 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "Enrollment");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-HARNESS LTM-ENROLLMENT-UIPAGES ENROLLMENT #20260221T185856.273 GMT", "LTM-Enrollment-UIPages Enrollment", "Enrollment", "01-01-01", "20260221T185856.273 GMT");
}
