...
import java.util.*;
public class Rule_Obj_Flow_LTM_BFS_Work_Enrollment_CreateForm_Default_Action_20260221T185851_535_GMT  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Flow.CreateForm_Default.LTM_BFS_Work_Enrollment.Action");
	public Rule_Obj_Flow_LTM_BFS_Work_Enrollment_CreateForm_Default_Action_20260221T185851_535_GMT(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
public void perform() {
		...
		mRuleSet = "Enrollment";
		mFlowHandle = "RULE-OBJ-FLOW LTM-BFS-WORK-ENROLLMENT CREATEFORM_DEFAULT #20260221T185851.535 GMT";
...
tools.getStepStatus().backoutWorst();
		...
		{
			tools.putParamValue("FlowHandle", mFlowHandle);
			tools.putParamValue("FlowInsName", "LTM-BFS-WORK-ENROLLMENT!CREATEFORM_DEFAULT");
			return;
		}
...
//	RULE-UTILITY-FUNCTION UTILITIES ISORINHERITSFROM #20180713T131444.415 GMT:20180713T131444.415 GMT
	...
	public String getDefinitionAppliesToClass() {
		return "LTM-BFS-Work-Enrollment";
	}
...
// Expression: 
	...
	private void GetCoordinates_circum0(String pageName)
	{
		...
		pgFlow.putString("pyClassName", "LTM-BFS-Work-Enrollment");
		...
		pgShape.putString("pyCoordX", "4.272");
	...
	private void GetNavigationPath_circum0(String pageName, String parentFlowPath, boolean deferredLoad)
	{
		...
		pgNavPath.putString("pyClassName", "LTM-BFS-Work-Enrollment");
	...
	private boolean CheckFlowSecurity_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "LTM-BFS-Work-Enrollment";
		 }
		...
		if (!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools, "AM:RULE-OBJ-FLOW:LTM-BFS-WORK-ENROLLMENT!CREATEFORM_DEFAULT",primaryPageClassName, interestPage)) 
			 hasSecurity = true;
			 if(!hasSecurity) {
			 if(tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOW:LTM-BFS-WORK-ENROLLMENT!CREATEFORM_DEFAULT",primaryPageClassName, interestPage,true))
			 isAllowedAccess = true;
			 else return false;
		}
			 if(isAllowedAccess && !hasSecurity) {		com.pega.pegarules.priv.tracer.RuleTraceInfo ruleTraceInfo = new com.pega.pegarules.priv.tracer.RuleTraceInfo                                                                   ("RULE-OBJ-FLOW LTM-BFS-WORK-ENROLLMENT CREATEFORM_DEFAULT #20260221T185851.535 GMT","CreateForm_Default","Enrollment","","20260221T185851.749 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOW LTM-BFS-WORK-ENROLLMENT CREATEFORM_DEFAULT #20260221T185851.535 GMT", "LTM-BFS-Work-Enrollment CreateForm_Default", "Enrollment", "01-01-01", "20260221T185851.749 GMT");
}
