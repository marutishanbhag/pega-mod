...
import java.util.*;
public class Rule_PortalSkin_Enrollment_Action_  extends com.pega.pegarules.priv.runtime.AbstractSkin implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_PortalSkin.Enrollment.Action");
	public Rule_PortalSkin_Enrollment_Action_(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("", "Enrollment", "Enrollment", "01-01-01", "20180713T134954.507 GMT");
}
