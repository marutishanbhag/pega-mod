...
/**
 * Builds JSP stream LTM-ENROLLMENT-UIPAGES!ENROLLMENTHEADER.
 */
public class Rule_HTML_Section_LTM_Enrollment_UIPages_EnrollmentHeader_Stream_20260221T185854_581_GMT extends StreamBuilderSection implements StreamBuilder, FUASupport, FUAReusable, WebAllowable {
	private static final LogHelper  oLog = new LogHelper("Rule_HTML_Section.EnrollmentHeader.LTM_Enrollment_UIPages.Stream");
private static Map<String,String[]> oCellRuntimeParamsMap = new HashMap<String,String[]>();
private static Map<String, String> oControlPathsMap = new HashMap<String, String>();
private static Map<String, AssemblyParameters> oAssemblyParamsMap = null;
private static final int pzChecksum = -263857563;
 ...
 */
	public Rule_HTML_Section_LTM_Enrollment_UIPages_EnrollmentHeader_Stream_20260221T185854_581_GMT(com.pega.pegarules.priv.PegaAPI aContext) {
...
private static String pxUniqueStreamHash = "a9fc2c2023135683f6a9f6a2d408f02d885f360c";
...
try {
pxUniqueStreamHash = "a9fc2c2023135683f6a9f6a2d408f02d885f360c";
pzAuto.getUIComponentRuntime().getRuntimeContextTree().pushSection("EnrollmentHeader",pxUniqueStreamHash);pxIsNonTemplateStream = hasNonTemplateMethod_1();
...
/*
 * Begin RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTHEADER #20260221T185854.581 GMT
 * Set up context.
 */
final String prevRuleKey_1 = pz_CurrentRuleKey;
pz_CurrentRuleKey = "RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTHEADER #20260221T185854.581 GMT";final String prevClass_1 = mStreamResponse.getJspBaseClass();
...
/* end RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTHEADER #20260221T185854.581 GMT */
	} catch (Throwable ex) {
		handleError(ex);
	} finally {
		pzAuto.finishStream();
...
//	RULE-UTILITY-FUNCTION UTILITIES VALIDATERULEEXISTENCE2 #20180713T131446.070 GMT:20180713T131446.070 GMT
	...
	public static String getFUAContentHash() {
		return "a5aacfbb5566c53ae58fe7f95086aa70";
	}
...
tools.putSaveValue("sectionUniqueID", ((new StringBuilder("SID")).append((((com.pega.pegarules.priv.context.PegaRequestor) tools.getRequestor()).currentTimeUnique()))).toString());
 if(pzAuto.isForOfflineTemplate()) {
  ...
  pzSection.beginSection("EnrollmentHeader",1,"Rule-HTML-Section","{'type':'Section','ruleName':'EnrollmentHeader','insKey':'RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTHEADER #20260221T185854.581 GMT','sectionType':'standard'}");
pzLayout_1();
pzLayout_2();
pzLayout_3();
...
public void buildSection_1() { 
	...
	pzAuto.getUIComponentRuntime().getRuntimeContextTree().loadSection(pxUniqueStreamHash+"_18","pxMainPageSideInContainer", secInfo);
}
public void buildWhiteList_1() {
Map<String, String> config;
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("pyFunctionName", "pega.desktop.infinity.createNewWorkInDialogContainer");
pega.getUIEngine().getUIAction("runScript", config).register();
pega.getUIEngine().getUIAction("refresh", null).register();
config = new HashMap<String, String>();
config.put("className", "LTM-BFS-Work-Enrollment");
config.put("flowName", "pyStartCase");
...
public void includeSectionBody_1() { 
	...
	String includedSectionName = "";includedSectionName = "pxMainPageSideInContainer";if(!"".equals(includedSectionName.trim())){tools.appendString(pzAuto.getSection().getSectionStream(includedSectionName,"",false,""));
	}else{oLog.warn("Section name must be provided.");}}
public void pzSetExpandParam_3() {
pzSection.getLayout().setExpandParam("SubSectionEnrollmentHeaderBBB","",false);
}
...
String paramName = "EXPANDEDSubSectionEnrollmentHeaderBBB";
metadataPage.put("paramName", paramName);
String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'resaveInstancePage.pySections(3)','clipboardPath':'pxMainPageSideInContainer'}");
...
boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpxIsMobileDevice", pxUniqueStreamHash+"_19");metadataPage.put("isSectionIncl","true");
...
if(pyVisibility) {
containerComponent.addPropertyToMetadata("rwclass", "slide-in-summary");
containerComponent.addPropertyToMetadata("roclass", "slide-in-summary");
pzLayoutBody_3();
}
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" o1! wxpxIsMobileDevice","!pxIsMobileDevice", "layout", "visible" )) {boolean bWrapIncSection = (!pzAuto.getBrowserUtils().isIE() || !"8.0".equals(pzAuto.getBrowserUtils().getBrowserVersion())) && !pzAuto.getUIComponentRuntime().isTemplatingUIEnabled();
if(bWrapIncSection){
tools.appendString("<span class='inspector-span' " + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'SECTIONINCLUDE','pgRef':'resaveInstancePage.pySections(3)','clipboardPath':'pxMainPageSideInContainer'}") + ">");
}
pzSetExpandParam_3();
...
String RWClasses = "";
RWClasses += " ";
RWClasses += pzSection.getCustomStyle(false, "","slide-in-summary","slide-in-summary") ;
RWClasses += " ";
...
RWClassesHelper += " ";
RWClassesHelper += pzSection.getCustomStyle(false, "","slide-in-summary","slide-in-summary") ;
RWClassesHelper += " ";
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		tools.appendFormatted("LTM-BFS-Work-Enrollment",StreamBuilder.FMT_NORMAL);		tools.appendString("\",\"\",\"");

		tools.appendFormatted("pyStartCase",StreamBuilder.FMT_NORMAL);		tools.appendString("\",\"&=");
...
try {
	...
	cellPage.put("automationId"," " + pzCell.getTestIdIfEnabled("201511051022210843267245") + " ");
	if(false || (pzAuto.isOffline() && false) ){ 
	modePage2.put("nav",navPage);
	}
	modePage2.put("pyName","EnrollmentHeader_$CTX$_5");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
	modePage2.put("styles","Header_icon");
	modePage2.put("imgSrc","styleclass");
	String pyIconStyle = "";
	pyIconStyle = "pi pi-plus";
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 String buttonUID = "name='EnrollmentHeader_"+ referenceString+ "_5'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("201511051022210843267245") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		...
		tools.appendString("]' ");
			...
			String repeatIndx = "";tools.appendString("class='Header_icon pzhc pzbutton");tools.appendString("'");if(bOptimizedMarkup){tools.appendString(" data-bindprops='innerHTML,title' ");}
		tools.appendString(" >");
		String classProp = "";
...
public int simpleLayoutCell_3( int index) {
	...
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,"resaveInstancePage.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-top-spacing remove-bottom-spacing remove-left-spacing   ");
	...
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("20180329112350046250992")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
 ...
 isSecCellReadOnly = !pzAuto.getSection().getControl().isControlEditable(false, null);
	tools.appendString(tools.getLocalizedTextForString("pyCaption","Enrollment Summary") + pega.getUIEngine().getFVInspectorUtils().stopCollectingFieldValueData() + "</div>");
	index++;
	return index;
}
...
public int simpleLayoutTemplateCell_3( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20180329112350046250992")).append(" ").toString().replace("data-test-id=","").trim());
	...
	String inspectorData=pzCell.getInspectorDataDynamic("Label",null,"resaveInstancePage.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	labelName = "Enrollment Summary";
...
public int simpleLayoutTemplateCell_4( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("201511051022210843267245-Label")).append(" ").toString().replace("data-test-id=","").trim());
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox","resaveInstancePage.pySections(2).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
pzSection.getLayout().setExpandParam("SubSectionEnrollmentHeaderBB","",false);
}
...
public void simpleLayout_2() {
	...
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201803291112140911129") + " ");
	...
	if(currentTemplatingStatus != 'Y'){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'resaveInstancePage.pySections(2)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle padding-lr-2x padding-t-2x padding-b-1x" + "'  " + "role='heading' tabindex='-1' ");
		...
		pg_dlmeta.put("customClassName","padding-lr-2x padding-t-2x padding-b-1x");
		pg_dlmeta.put("format","inline_middle");
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'resaveInstancePage.pySections(2)'}") + "").append("\"").toString();
		if(!inspectorData.equals("\"\"")) {
		pg_dlmeta.put("liveUI",inspectorData);
		}
		pg_dlmeta.put("ariaRole","heading");
	...
	String paramName = "EXPANDEDSubSectionEnrollmentHeaderBB";
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'resaveInstancePage.pySections(2)'}");
	if(!inspectorLayoutData.isEmpty()) {
	metadataPage.put("liveUI", inspectorLayoutData);
	}
	String pyPrefix = null;
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" wxpyIsMobilePhone", pxUniqueStreamHash+"_17");metadataPage.put("lMode","SimpleDiv");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
if (!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
if(pzAuto.handleEvaluateWhen(" wxpyIsMobilePhone","pyIsMobilePhone", "layout", "visible" )) {pzSetExpandParam_2();
tools.putParamValue("RWClasses","");
if(!pzAuto.getUIComponentRuntime().isTemplatingUIEnabled()) {
...
StringBuilder actionsStringBuilder = tools.pushStreamBody();
	((PegaStreamAPI)tools).disableDirectStreaming();
		...
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
		tools.appendString(" data-click='[");if(isBehaviorAdded && true){ tools.appendString(","); }	tools.appendString("[\"runScript\", [\"pega.desktop.infinity.createNewWorkInDialogContainer(\\\"LTM-BFS-Work-Enrollment\\\",\\\"pyStartCase\\\")\"]");
...
try {
	...
	modePage2.put("pyName","EnrollmentHeader_$CTX$_2");
		String repeatIndx = "";
	String pyTooltip = "";
	modePage2.put("tooltip",pyTooltip);
	modePage2.put("helpertype","none");
...
boolean bDisabled = false;boolean bOptimizedMarkup = pzAuto.getUIComponentRuntime().isHarnessTemplatized() && pzAuto.isOffline();
		...
		String hrefValue = "#";
		 ...
		 boolean isParameterizedDeclarePage =  pega.getDeclarativePageUtils().isParameterizedDPName(referenceString);
		 if(isParameterizedDeclarePage){ referenceString = tools.getStepPage().getString("pzPageNameBase"); }
		 String buttonUID = "name='EnrollmentHeader_"+ referenceString+ "_2'";
	 String securedPropValue = null;
		tools.appendString("<button " + pzCell.getTestIdIfEnabled("201511051022210843267245") + "  data-ctl='Button'  type='button' ");if(!"true".equals(tools.getParamValue("pxAvoidUniqueAttribute")))tools.appendString(buttonUID);
		pega_uiengine_pzcontrol.pzAddClientValidation(tools,"","","","");
		{boolean isBehaviorAdded = false;isBehaviorAdded = false;
...
public int simpleLayoutCell_1( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("Label",null,"resaveInstancePage.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)") + " class='content-item content-label item-" + Integer.toString(index) + " remove-right-spacing   ");
	 
	tools.appendString(pzSection.getCustomStyle(false, "","dataLabelRead heading_1_dataLabelRead","dataLabelWrite heading_1_dataLabelWrite") + " ");
	 
	tools.appendString("flex flex-row ' " +   pzCell.getTestIdIfEnabled("20180329112350046244132")   + " STRING_TYPE='label' RESERVE_SPACE='false'>");
	boolean showstar = true;
	boolean isSecCellReadOnly = false;
...
public int simpleLayoutTemplateCell_1( int index) {
	...
	pgCells.put("automationId",new StringBuilder(" ").append(pzCell.getTestIdIfEnabled("20180329112350046244132")).append(" ").toString().replace("data-test-id=","").trim());
	pgCells.put("spanClass","iconRequired _iconRequired");
	pgCells.put("labelReadClass","dataLabelRead heading_1_dataLabelRead");
	pgCells.put("labelWriteClass","dataLabelWrite heading_1_dataLabelWrite");
	pgCells.put("cstmreqfor",pyCustomRequireFormat);
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("Label",null,"resaveInstancePage.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(1)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
	labelName = "Enrollment Summary";
...
public int simpleLayoutCell_2( int index) {
	...
	String baseRef ="";
	generateClientWhenDiv_1();
	tools.appendString("' " + pega.getUIEngine().getFVInspectorUtils().startCollectingFieldValueData() + pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox","resaveInstancePage.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)") + " class='content-item content-field item-" + Integer.toString(index) + " remove-right-spacing    " + pzSection.getCustomStyle(false, "","margin-l-auto","margin-l-auto")  + " " +  pzSection.getCustomStyle(false, "","dataValueRead","dataValueWrite")  + " flex flex-row '  STRING_TYPE='field' RESERVE_SPACE='false'>");
	pzAuto.getUIComponentRuntime().insertComponentPlaceholderPage();
...
public int simpleLayoutTemplateCell_2( int index) {
	...
	boolean isOffline = false;
	cc_dlCell.beginComponent("DynamicLayoutCell", pg_dlCellMeta);
	String inspectorData=pzCell.getInspectorDataDynamic("pxButton",".pyTemplateInputBox","resaveInstancePage.pySections(1).pySectionBody(1).pyTable.pyRows(1).pyCells(2)");
	if(!inspectorData.isEmpty()) {
	pgCells.put("liveUI",inspectorData);
	}
...
pzSection.getLayout().setExpandParam("SubSectionEnrollmentHeaderB","",false);
}
...
public void simpleLayout_1() {
	...
	cc_dl = pzAuto.getUIComponent();
	IUIComponentMetadata pg_dlmeta = pzAuto.getUIComponentRuntime().createMetadata();
	pg_dlmeta.put("automationId"," " + pzCell.getTestIdIfEnabled("201803291106090190725") + " ");
	String subscriptionID = null;
	String ackEnabled = null;
	if(currentTemplatingStatus != 'Y'){
		if(bIsIe && "true".equals(bIsGridLayout)&&!"true".equals(bIsWrapperAdded)){
		...
		tools.appendString("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'resaveInstancePage.pySections(1)'}") + " class='" + "flex  content  layout-content-inline_middle content-inline_middle padding-lr-2x padding-t-2x padding-b-1x" + "'  " + "role='heading' tabindex='-1' ");
		if(!tools.getParamValue("pyPegaDesignMode").equals("true")){
		tools.appendString(" ");
		}
		tools.appendString(" " + refreshAttributes + ">");
		...
		pg_dlmeta.put("customClassName","padding-lr-2x padding-t-2x padding-b-1x");
		pg_dlmeta.put("format","inline_middle");
		String inspectorData= new StringBuilder("\"").append("" + pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'resaveInstancePage.pySections(1)'}") + "").append("\"").toString();
		if(!inspectorData.equals("\"\"")) {
		pg_dlmeta.put("liveUI",inspectorData);
		}
		pg_dlmeta.put("ariaRole","heading");
	...
	String paramName = "EXPANDEDSubSectionEnrollmentHeaderB";
	String inspectorLayoutData = pzAuto.getDataUIMetaAttribute("{'type':'Layout','subType':'DYNAMICLAYOUT','pgRef':'resaveInstancePage.pySections(1)'}");
	if(!inspectorLayoutData.isEmpty()) {
	metadataPage.put("liveUI", inspectorLayoutData);
	}
	String pyPrefix = null;
	IUIComponent containerComponent = pzAuto.getUIComponent();
	com.pega.pegarules.priv.runtime.ui.IRuntimeContextTree runtimeContextTree = pzAuto.getUIComponentRuntime().getRuntimeContextTree();
	boolean pyVisibility = false;pyVisibility = runtimeContextTree.beginVisibleWhen(" o1! wxpyIsMobilePhone", pxUniqueStreamHash+"_9");metadataPage.put("lMode","SimpleDiv");
	IUIComponentMetadata pxWhenIdentifiers = pzAuto.getUIComponentRuntime().createMetadata();
...
static {
	...
	oStreamProperties_1.put("pzInsKey", "RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTHEADER #20260221T185854.581 GMT");
	...
	oStreamProperties_1.put("pyStreamName", "EnrollmentHeader");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-HTML-SECTION LTM-ENROLLMENT-UIPAGES ENROLLMENTHEADER #20260221T185854.581 GMT", "LTM-Enrollment-UIPages EnrollmentHeader", "Enrollment", "01-01-01", "20260221T185854.581 GMT");
}
