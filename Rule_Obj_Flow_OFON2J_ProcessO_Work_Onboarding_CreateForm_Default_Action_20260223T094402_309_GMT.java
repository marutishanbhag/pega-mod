...
import java.util.*;
public class Rule_Obj_Flow_OFON2J_ProcessO_Work_Onboarding_CreateForm_Default_Action_20260223T094402_309_GMT  extends com.pega.pegarules.priv.AbstractFUASupport implements Activity, FUASupport {
	private static final LogHelper  oLog = new LogHelper("Rule_Obj_Flow.CreateForm_Default.OFON2J_ProcessO_Work_Onboarding.Action");
	public Rule_Obj_Flow_OFON2J_ProcessO_Work_Onboarding_CreateForm_Default_Action_20260223T094402_309_GMT(PegaAPI aContext) {
		tools = aContext;
		pega = aContext;
	}
...
public void perform() {
		...
		mRuleSet = "ProcessO";
		mFlowHandle = "RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING CREATEFORM_DEFAULT #20260223T094402.309 GMT";
...
tools.getStepStatus().backoutWorst();
		...
		{
			tools.putParamValue("FlowHandle", mFlowHandle);
			tools.putParamValue("FlowInsName", "OFON2J-PROCESSO-WORK-ONBOARDING!CREATEFORM_DEFAULT");
			return;
		}
...
// Expression: pyStepRoutedConfirmation
	...
	private void GetNavigationPath_circum0(String pageName, String parentFlowPath, boolean deferredLoad)
	{
		...
		pgNavPath.putString("pyClassName", "OFON2J-ProcessO-Work-Onboarding");
	...
	private boolean CheckFlowSecurity_circum0()
	{
		boolean hasSecurity = false;
		 ...
		 primaryPageClassName = "OFON2J-ProcessO-Work-Onboarding";
		 }
		...
		if (!hasSecurity && tools.getAuthorizationHandle().havePrivilege(tools, "AM:RULE-OBJ-FLOW:OFON2J-PROCESSO-WORK-ONBOARDING!CREATEFORM_DEFAULT",primaryPageClassName, interestPage)) 
			 hasSecurity = true;
			 if(!hasSecurity) {
			 if(tools.getAuthorizationHandle().havePrivilege(tools,  "AM:RULE-OBJ-FLOW:OFON2J-PROCESSO-WORK-ONBOARDING!CREATEFORM_DEFAULT",primaryPageClassName, interestPage,true))
			 isAllowedAccess = true;
			 else return false;
		}
			 if(isAllowedAccess && !hasSecurity) {		com.pega.pegarules.priv.tracer.RuleTraceInfo ruleTraceInfo = new com.pega.pegarules.priv.tracer.RuleTraceInfo                                                                   ("RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING CREATEFORM_DEFAULT #20260223T094402.309 GMT","CreateForm_Default","ProcessO","","20260223T094402.734 GMT");
...
private static final com.pega.pegarules.priv.tracer.RuleTraceInfo oTraceInfo_0 = new com.pega.pegarules.priv.tracer.RuleTraceInfo("RULE-OBJ-FLOW OFON2J-PROCESSO-WORK-ONBOARDING CREATEFORM_DEFAULT #20260223T094402.309 GMT", "OFON2J-ProcessO-Work-Onboarding CreateForm_Default", "ProcessO", "01-01-01", "20260223T094402.734 GMT");
}
